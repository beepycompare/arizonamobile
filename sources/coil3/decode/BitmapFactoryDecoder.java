...
public final class BitmapFactoryDecoder implements Decoder {
    ...
    */
    ...
    private final void configureScale(BitmapFactory.Options options, ExifData exifData) {
        ...
        long m9098computeDstSizesEdh43o = DecodeUtils.m9098computeDstSizesEdh43o(i, i2, this.options.getSize(), this.options.getScale(), ImageRequestsKt.getMaxBitmapSize(this.options));
        int m9156getFirstimpl = IntPair.m9156getFirstimpl(m9098computeDstSizesEdh43o);
        int m9157getSecondimpl = IntPair.m9157getSecondimpl(m9098computeDstSizesEdh43o);
        options.inSampleSize = DecodeUtils.calculateInSampleSize(i, i2, m9156getFirstimpl, m9157getSecondimpl, this.options.getScale());
        double computeSizeMultiplier = DecodeUtils.computeSizeMultiplier(i / options.inSampleSize, i2 / options.inSampleSize, m9156getFirstimpl, m9157getSecondimpl, this.options.getScale());
