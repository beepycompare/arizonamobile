...
public final class BitmapFactoryDecoder implements Decoder {
    ...
    */
            ...
            if (continuation instanceof BitmapFactoryDecoder$decode$1) {
                ...
                if ((bitmapFactoryDecoder$decode$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        bitmapFactoryDecoder$decode$1.I$0 = 0;
                        ...
                        if (i == 2) {
                            int i3 = bitmapFactoryDecoder$decode$1.I$1;
                            int i4 = bitmapFactoryDecoder$decode$1.I$0;
                        ...
                        i2 = bitmapFactoryDecoder$decode$1.I$0;
                        ResultKt.throwOnFailure(obj);
                    ...
                    bitmapFactoryDecoder$decode$1.L$0 = semaphore;
                    bitmapFactoryDecoder$decode$1.I$0 = i2;
                    bitmapFactoryDecoder$decode$1.I$1 = 0;
    ...
    private final void configureScale(BitmapFactory.Options options, ExifData exifData) {
        ...
        long m7788computeDstSizesEdh43o = DecodeUtils.m7788computeDstSizesEdh43o(i, i2, this.options.getSize(), this.options.getScale(), ImageRequestsKt.getMaxBitmapSize(this.options));
        int m7846getFirstimpl = IntPair.m7846getFirstimpl(m7788computeDstSizesEdh43o);
        int m7847getSecondimpl = IntPair.m7847getSecondimpl(m7788computeDstSizesEdh43o);
        options.inSampleSize = DecodeUtils.calculateInSampleSize(i, i2, m7846getFirstimpl, m7847getSecondimpl, this.options.getScale());
        double computeSizeMultiplier = DecodeUtils.computeSizeMultiplier(i / options.inSampleSize, i2 / options.inSampleSize, m7846getFirstimpl, m7847getSecondimpl, this.options.getScale());
    ...
    /* compiled from: BitmapFactoryDecoder.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0080T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lcoil3/decode/BitmapFactoryDecoder$Companion;", "", "<init>", "()V", "DEFAULT_MAX_PARALLELISM", "", "coil-core_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes3.dex */
