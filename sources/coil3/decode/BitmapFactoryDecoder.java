...
public final class BitmapFactoryDecoder implements Decoder {
    ...
    */
    ...
    private final void configureScale(BitmapFactory.Options options, ExifData exifData) {
        ...
        long m9417computeDstSizesEdh43o = DecodeUtils.m9417computeDstSizesEdh43o(i, i2, this.options.getSize(), this.options.getScale(), ImageRequestsKt.getMaxBitmapSize(this.options));
        ...
        options.inSampleSize = DecodeUtils.calculateInSampleSize(i, i2, m9475getFirstimpl, m9476getSecondimpl, this.options.getScale());
        double computeSizeMultiplier = DecodeUtils.computeSizeMultiplier(i / options.inSampleSize, i2 / options.inSampleSize, m9475getFirstimpl, m9476getSecondimpl, this.options.getScale());
