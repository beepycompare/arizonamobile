...
public final class DecodeUtils {
    ...
    public static final long m7788computeDstSizesEdh43o(int i, int i2, Size size, Scale scale, Size size2) {
        ...
        if ((size2.getWidth() instanceof Dimension.Pixels) && !UtilsKt.isMinOrMax(i)) {
            i = RangesKt.coerceAtMost(i, ((Dimension.Pixels) size2.getWidth()).m7837unboximpl());
        }
        if ((size2.getHeight() instanceof Dimension.Pixels) && !UtilsKt.isMinOrMax(i2)) {
            i2 = RangesKt.coerceAtMost(i2, ((Dimension.Pixels) size2.getHeight()).m7837unboximpl());
        }
        return IntPair.m7842constructorimpl(i, i2);
    }

    private final int toPx(Dimension dimension, Scale scale) {
        if (dimension instanceof Dimension.Pixels) {
            return ((Dimension.Pixels) dimension).m7837unboximpl();
        }
        int i = WhenMappings.$EnumSwitchMapping$0[scale.ordinal()];
        if (i != 1) {
            if (i == 2) {
