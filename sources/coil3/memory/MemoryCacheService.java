...
public final class MemoryCacheService {
    ...
    private final boolean isCacheValueValidForSize(ImageRequest imageRequest, MemoryCache.Key key, MemoryCache.Value value, Size size, Scale scale) {
        ...
        if (str != null) {
            ...
            int m8403unboximpl = width2 instanceof Dimension.Pixels ? ((Dimension.Pixels) width2).m8403unboximpl() : Integer.MAX_VALUE;
            Dimension width3 = size2.getWidth();
            int min = Math.min(m8403unboximpl, width3 instanceof Dimension.Pixels ? ((Dimension.Pixels) width3).m8403unboximpl() : Integer.MAX_VALUE);
            Dimension height2 = size.getHeight();
            int m8403unboximpl2 = height2 instanceof Dimension.Pixels ? ((Dimension.Pixels) height2).m8403unboximpl() : Integer.MAX_VALUE;
            Dimension height3 = size2.getHeight();
            int min2 = Math.min(m8403unboximpl2, height3 instanceof Dimension.Pixels ? ((Dimension.Pixels) height3).m8403unboximpl() : Integer.MAX_VALUE);
            double d = min / width;
