...
public interface ViewSizeResolver<T extends View> extends SizeResolver {
            ...
            public boolean onPreDraw() {
                ...
                if (size2 != null) {
                    ...
                    if (!this.isResumed) {
                        ...
                        cancellableContinuationImpl2.resumeWith(Result.m9084constructorimpl(size2));
                    }
                }
                return true;
            }
    ...
    private default Dimension getDimension(int i, int i2, int i3) {
        ...
        int i4 = i - i3;
        if (i4 > 0) {
            return Dimension.Pixels.m8399boximpl(DimensionKt.Dimension(i4));
        }
        int i5 = i2 - i3;
        if (i5 > 0) {
            return Dimension.Pixels.m8399boximpl(DimensionKt.Dimension(i5));
        }
        return null;
    }
