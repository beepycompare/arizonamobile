...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m9274boximpl(int i) {
            return new Pixels(i);
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m9276equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m9280unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m9277equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m9278hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m9279toStringimpl(int i) {
            return "Pixels(px=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m9276equalsimpl(this.px, obj);
        }

        public int hashCode() {
            return m9278hashCodeimpl(this.px);
        }

        public String toString() {
            return m9279toStringimpl(this.px);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m9280unboximpl() {
            return this.px;
        }
        ...
        public static int m9275constructorimpl(int i) {
            if (i > 0) {
                return i;
            }
