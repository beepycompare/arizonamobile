...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m9222boximpl(int i) {
            return new Pixels(i);
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m9224equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m9228unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m9225equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m9226hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m9227toStringimpl(int i) {
            return "Pixels(px=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m9224equalsimpl(this.px, obj);
        }

        public int hashCode() {
            return m9226hashCodeimpl(this.px);
        }

        public String toString() {
            return m9227toStringimpl(this.px);
        }
        ...
        public static int m9223constructorimpl(int i) {
            if (i > 0) {
                return i;
            }
