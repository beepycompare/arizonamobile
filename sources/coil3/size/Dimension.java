...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m7816boximpl(int i) {
            return new Pixels(i);
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m7818equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m7822unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m7819equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m7820hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m7821toStringimpl(int i) {
            return "Pixels(px=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m7818equalsimpl(this.px, obj);
        }

        public int hashCode() {
            return m7820hashCodeimpl(this.px);
        }

        public String toString() {
            return m7821toStringimpl(this.px);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m7822unboximpl() {
            return this.px;
        }
        ...
        public static int m7817constructorimpl(int i) {
            if (i > 0) {
                return i;
            }
