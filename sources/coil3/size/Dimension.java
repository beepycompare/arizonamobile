...
public interface Dimension {
    ...
    public static final class Pixels implements Dimension {
        ...
        public static final /* synthetic */ Pixels m9141boximpl(int i) {
            return new Pixels(i);
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m9143equalsimpl(int i, Object obj) {
            return (obj instanceof Pixels) && i == ((Pixels) obj).m9147unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m9144equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m9145hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m9146toStringimpl(int i) {
            return "Pixels(px=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m9143equalsimpl(this.px, obj);
        }

        public int hashCode() {
            return m9145hashCodeimpl(this.px);
        }

        public String toString() {
            return m9146toStringimpl(this.px);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m9147unboximpl() {
            return this.px;
        }
        ...
        public static int m9142constructorimpl(int i) {
            if (i > 0) {
                return i;
            }
