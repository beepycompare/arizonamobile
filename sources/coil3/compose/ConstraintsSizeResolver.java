...
public final class ConstraintsSizeResolver implements SizeResolver, LayoutModifier {
    ...
    */
        ...
        if (continuation instanceof ConstraintsSizeResolver$size$1) {
            ...
            if ((constraintsSizeResolver$size$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    return UtilsKt.m9096toSizeBRTryo0(this.latestConstraints);
                } else if (i != 1) {
    ...
    public final void m9068setConstraintsBRTryo0(long j) {
        ...
        while (it.hasNext()) {
            ...
            ((Continuation) it.next()).resumeWith(Result.m9847constructorimpl(Unit.INSTANCE));
        }
    }
}
