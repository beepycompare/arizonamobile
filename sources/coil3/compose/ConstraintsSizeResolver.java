...
public final class ConstraintsSizeResolver implements SizeResolver, LayoutModifier {
    ...
    */
        ...
        if (continuation instanceof ConstraintsSizeResolver$size$1) {
            ...
            if ((constraintsSizeResolver$size$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (Constraints.m7208isZeroimpl(this.latestConstraints)) {
                    ...
                    return UtilsKt.m8354toSizeBRTryo0(this.latestConstraints);
                } else if (i != 1) {
    ...
    public MeasureResult mo738measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        m8326setConstraintsBRTryo0(j);
        final Placeable mo5954measureBRTryo0 = measurable.mo5954measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo5954measureBRTryo0.getWidth(), mo5954measureBRTryo0.getHeight(), null, new Function1() { // from class: coil3.compose.ConstraintsSizeResolver$$ExternalSyntheticLambda0
    ...
    public final void m8326setConstraintsBRTryo0(long j) {
        this.latestConstraints = j;
        if (Constraints.m7208isZeroimpl(j)) {
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            ((Continuation) it.next()).resumeWith(Result.m9084constructorimpl(Unit.INSTANCE));
        }
    }
}
