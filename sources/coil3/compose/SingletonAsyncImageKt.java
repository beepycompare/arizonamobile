...
public final class SingletonAsyncImageKt {
    ...
    public static final void m9380AsyncImagex1rPTaM(Object obj, String str, Modifier modifier, Painter painter, Painter painter2, Painter painter3, Function1<? super AsyncImagePainter.State.Loading, Unit> function1, Function1<? super AsyncImagePainter.State.Success, Unit> function12, Function1<? super AsyncImagePainter.State.Error, Unit> function13, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, boolean z, Composer composer, int i2, int i3, int i4) {
        ...
        int m6008getDefaultFilterQualityfv9h1I = (i4 & 8192) != 0 ? DrawScope.Companion.m6008getDefaultFilterQualityfv9h1I() : i;
        ...
        AsyncImageKt.m9360AsyncImagenc27qi8(obj, str, imageLoader, modifier3, painter7, painter5, painter8, function14, function15, function16, alignment2, fit, f2, colorFilter3, m6008getDefaultFilterQualityfv9h1I, z2, composer, i6, i8, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m9379AsyncImage10Xjiaw(Object obj, String str, Modifier modifier, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, boolean z, Composer composer, int i2, int i3, int i4) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        int i5 = i2 << 3;
        AsyncImageKt.m9361AsyncImagesKDTAoQ(obj, str, SingletonImageLoader.get((Context) consume), companion, defaultTransform, function13, center, fit, f2, colorFilter2, m6008getDefaultFilterQualityfv9h1I, z2, composer, (i2 & WebSocketProtocol.PAYLOAD_SHORT) | (i5 & 7168) | (57344 & i5) | (458752 & i5) | (3670016 & i5) | (29360128 & i5) | (234881024 & i5) | (i5 & 1879048192), ((i2 >> 27) & 14) | ((i3 << 3) & 112), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
