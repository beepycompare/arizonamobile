...
public final class CrossfadePainter extends Painter {
    ...
    */
    ...
    public final long m8341getDurationUwyO8pc() {
    ...
    private CrossfadePainter(Painter painter, Painter painter2, ContentScale contentScale, long j, TimeSource timeSource, boolean z, boolean z2) {
        ...
        this.maxAlpha = 1.0f;
        this.start = painter;
        this.intrinsicSize = m8340computeIntrinsicSizexjbvk4A(painter, painter2);
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        float m10474getInWholeMillisecondsimpl = ((float) Duration.m10474getInWholeMillisecondsimpl(timeMark.mo10453elapsedNowUwyO8pc())) / ((float) Duration.m10474getInWholeMillisecondsimpl(this.duration));
        float coerceIn = RangesKt.coerceIn(m10474getInWholeMillisecondsimpl, 0.0f, 1.0f);
        float f = this.maxAlpha;
        float f2 = coerceIn * f;
        if (this.fadeStart) {
            f -= f2;
        }
        this.isDone = m10474getInWholeMillisecondsimpl >= 1.0f;
    ...
    private final long m8340computeIntrinsicSizexjbvk4A(Painter painter, Painter painter2) {
        long mo5248getIntrinsicSizeNHjbRc = painter != null ? painter.mo5248getIntrinsicSizeNHjbRc() : Size.Companion.m4383getZeroNHjbRc();
        long mo5248getIntrinsicSizeNHjbRc2 = painter2 != null ? painter2.mo5248getIntrinsicSizeNHjbRc() : Size.Companion.m4383getZeroNHjbRc();
        boolean z = mo5248getIntrinsicSizeNHjbRc != InlineClassHelperKt.UnspecifiedPackedFloats;
        boolean z2 = mo5248getIntrinsicSizeNHjbRc2 != InlineClassHelperKt.UnspecifiedPackedFloats;
        if (z && z2) {
            return Size.m4365constructorimpl((Float.floatToRawIntBits(Math.max(Float.intBitsToFloat((int) (mo5248getIntrinsicSizeNHjbRc & 4294967295L)), Float.intBitsToFloat((int) (mo5248getIntrinsicSizeNHjbRc2 & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(Math.max(Float.intBitsToFloat((int) (mo5248getIntrinsicSizeNHjbRc >> 32)), Float.intBitsToFloat((int) (mo5248getIntrinsicSizeNHjbRc2 >> 32)))) << 32));
        }
        if (this.preferExactIntrinsicSize) {
            if (z) {
                return mo5248getIntrinsicSizeNHjbRc;
            }
            if (z2) {
                return mo5248getIntrinsicSizeNHjbRc2;
            }
        }
    ...
    private final void drawPainter(DrawScope drawScope, Painter painter, float f) {
        ...
        long m8339computeDrawSizex8L_9b0 = m8339computeDrawSizex8L_9b0(painter.mo5248getIntrinsicSizeNHjbRc(), mo5128getSizeNHjbRc);
        if (mo5128getSizeNHjbRc == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4376isEmptyimpl(mo5128getSizeNHjbRc)) {
            painter.m5254drawx_KDEd0(drawScope, m8339computeDrawSizex8L_9b0, f, this.colorFilter);
            return;
        }
        float f2 = 2;
        float intBitsToFloat = (Float.intBitsToFloat((int) (mo5128getSizeNHjbRc >> 32)) - Float.intBitsToFloat((int) (m8339computeDrawSizex8L_9b0 >> 32))) / f2;
        float intBitsToFloat2 = (Float.intBitsToFloat((int) (mo5128getSizeNHjbRc & 4294967295L)) - Float.intBitsToFloat((int) (m8339computeDrawSizex8L_9b0 & 4294967295L))) / f2;
    ...
    private final long m8339computeDrawSizex8L_9b0(long j, long j2) {
        return (j == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4376isEmptyimpl(j) || j2 == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4376isEmptyimpl(j2)) ? j2 : ScaleFactorKt.m6072timesUQTWf7w(j, this.contentScale.mo5960computeScaleFactorH7hwNQA(j, j2));
    }
}
