...
public final class CrossfadePainter extends Painter {
    ...
    */
    ...
    public final long m7746getDurationUwyO8pc() {
    ...
    private CrossfadePainter(Painter painter, Painter painter2, ContentScale contentScale, long j, TimeSource timeSource, boolean z, boolean z2) {
        ...
        this.maxAlpha = 1.0f;
        this.start = painter;
        this.intrinsicSize = m7745computeIntrinsicSizexjbvk4A(painter, painter2);
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        float m9841getInWholeMillisecondsimpl = ((float) Duration.m9841getInWholeMillisecondsimpl(timeMark.mo9820elapsedNowUwyO8pc())) / ((float) Duration.m9841getInWholeMillisecondsimpl(this.duration));
        float coerceIn = RangesKt.coerceIn(m9841getInWholeMillisecondsimpl, 0.0f, 1.0f);
        float f = this.maxAlpha;
        float f2 = coerceIn * f;
        if (this.fadeStart) {
            f -= f2;
        }
        this.isDone = m9841getInWholeMillisecondsimpl >= 1.0f;
    ...
    private final long m7745computeIntrinsicSizexjbvk4A(Painter painter, Painter painter2) {
    ...
    private final void drawPainter(DrawScope drawScope, Painter painter, float f) {
        ...
        long m7744computeDrawSizex8L_9b0 = m7744computeDrawSizex8L_9b0(painter.mo4761getIntrinsicSizeNHjbRc(), mo4640getSizeNHjbRc);
        if (mo4640getSizeNHjbRc == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m3908isEmptyimpl(mo4640getSizeNHjbRc)) {
            painter.m4767drawx_KDEd0(drawScope, m7744computeDrawSizex8L_9b0, f, this.colorFilter);
            return;
        }
        float f2 = 2;
        float intBitsToFloat = (Float.intBitsToFloat((int) (mo4640getSizeNHjbRc >> 32)) - Float.intBitsToFloat((int) (m7744computeDrawSizex8L_9b0 >> 32))) / f2;
        float intBitsToFloat2 = (Float.intBitsToFloat((int) (mo4640getSizeNHjbRc & 4294967295L)) - Float.intBitsToFloat((int) (m7744computeDrawSizex8L_9b0 & 4294967295L))) / f2;
    ...
    private final long m7744computeDrawSizex8L_9b0(long j, long j2) {
