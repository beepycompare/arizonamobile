        ...
        if (continuation instanceof AsyncImagePreviewHandler$Companion$Default$1$handle$1) {
            ...
            if ((asyncImagePreviewHandler$Companion$Default$1$handle$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (!(imageResult instanceof SuccessResult)) {
                    ...
                    return new AsyncImagePainter.State.Success(ImagePainter_androidKt.m9166asPainter55t9rM$default(successResult.getImage(), imageRequest.getContext(), 0, 2, null), successResult);
                } else if (imageResult instanceof ErrorResult) {
                    ErrorResult errorResult = (ErrorResult) imageResult;
                    Image image = errorResult.getImage();
                    return new AsyncImagePainter.State.Error(image != null ? ImagePainter_androidKt.m9166asPainter55t9rM$default(image, imageRequest.getContext(), 0, 2, null) : null, errorResult);
                } else {
