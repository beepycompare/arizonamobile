...
public final class ContentPainterElement extends ModifierNodeElement<ContentPainterNode> {
    ...
    private final int m9097component6fv9h1I() {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode + (function1 == null ? 0 : function1.hashCode())) * 31) + FilterQuality.m5377hashCodeimpl(this.filterQuality)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31;
    ...
    public String toString() {
        ...
        String m5378toStringimpl = FilterQuality.m5378toStringimpl(this.filterQuality);
        ...
        AsyncImagePreviewHandler asyncImagePreviewHandler = this.previewHandler;
        return "ContentPainterElement(request=" + imageRequest + ", imageLoader=" + imageLoader + ", modelEqualityDelegate=" + asyncImageModelEqualityDelegate + ", transform=" + function1 + ", onState=" + function12 + ", filterQuality=" + m5378toStringimpl + ", alignment=" + alignment + ", contentScale=" + contentScale + ", alpha=" + f + ", colorFilter=" + colorFilter + ", clipToBounds=" + z + ", previewHandler=" + asyncImagePreviewHandler + ", contentDescription=" + this.contentDescription + ")";
    }
    ...
    public ContentPainterNode create() {
        ...
        asyncImagePainter.m9070setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
    ...
    public void update(ContentPainterNode contentPainterNode) {
        long mo5979getIntrinsicSizeNHjbRc = contentPainterNode.getPainter().mo5979getIntrinsicSizeNHjbRc();
        ...
        painter.m9070setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
        painter.setPreviewHandler$coil_compose_core_release(this.previewHandler);
        painter.set_input$coil_compose_core_release(input);
        boolean m5101equalsimpl0 = Size.m5101equalsimpl0(mo5979getIntrinsicSizeNHjbRc, painter.mo5979getIntrinsicSizeNHjbRc());
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("filterQuality", FilterQuality.m5373boximpl(this.filterQuality));
