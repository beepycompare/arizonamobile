...
public final class ContentPainterElement extends ModifierNodeElement<ContentPainterNode> {
    ...
    private final int m7779component6fv9h1I() {
    ...
    public ContentPainterNode create() {
        ...
        asyncImagePainter.m7752setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
    ...
    public void update(ContentPainterNode contentPainterNode) {
        ...
        painter.m7752setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
