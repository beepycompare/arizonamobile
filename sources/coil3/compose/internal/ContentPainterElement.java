...
public final class ContentPainterElement extends ModifierNodeElement<ContentPainterNode> {
    ...
    private final int m9085component6fv9h1I() {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode + (function1 == null ? 0 : function1.hashCode())) * 31) + FilterQuality.m5376hashCodeimpl(this.filterQuality)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31;
    ...
    public String toString() {
        ...
        String m5377toStringimpl = FilterQuality.m5377toStringimpl(this.filterQuality);
        ...
        AsyncImagePreviewHandler asyncImagePreviewHandler = this.previewHandler;
        return "ContentPainterElement(request=" + imageRequest + ", imageLoader=" + imageLoader + ", modelEqualityDelegate=" + asyncImageModelEqualityDelegate + ", transform=" + function1 + ", onState=" + function12 + ", filterQuality=" + m5377toStringimpl + ", alignment=" + alignment + ", contentScale=" + contentScale + ", alpha=" + f + ", colorFilter=" + colorFilter + ", clipToBounds=" + z + ", previewHandler=" + asyncImagePreviewHandler + ", contentDescription=" + this.contentDescription + ")";
    }
    ...
    public ContentPainterNode create() {
        ...
        asyncImagePainter.m9058setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
    ...
    public void update(ContentPainterNode contentPainterNode) {
        long mo5978getIntrinsicSizeNHjbRc = contentPainterNode.getPainter().mo5978getIntrinsicSizeNHjbRc();
        ...
        painter.m9058setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
        painter.setPreviewHandler$coil_compose_core_release(this.previewHandler);
        painter.set_input$coil_compose_core_release(input);
        boolean m5100equalsimpl0 = Size.m5100equalsimpl0(mo5978getIntrinsicSizeNHjbRc, painter.mo5978getIntrinsicSizeNHjbRc());
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("filterQuality", FilterQuality.m5372boximpl(this.filterQuality));
