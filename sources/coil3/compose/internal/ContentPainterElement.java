...
public final class ContentPainterElement extends ModifierNodeElement<ContentPainterNode> {
    ...
    private final int m9392component6fv9h1I() {
    ...
    public ContentPainterNode create() {
        ...
        asyncImagePainter.m9365setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
    ...
    public void update(ContentPainterNode contentPainterNode) {
        ...
        painter.m9365setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
