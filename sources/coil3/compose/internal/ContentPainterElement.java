...
public final class ContentPainterElement extends ModifierNodeElement<ContentPainterNode> {
    ...
    private final int m8359component6fv9h1I() {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode + (function1 == null ? 0 : function1.hashCode())) * 31) + FilterQuality.m4646hashCodeimpl(this.filterQuality)) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.hashCode(this.alpha)) * 31;
    ...
    public String toString() {
        ...
        String m4647toStringimpl = FilterQuality.m4647toStringimpl(this.filterQuality);
        ...
        AsyncImagePreviewHandler asyncImagePreviewHandler = this.previewHandler;
        return "ContentPainterElement(request=" + imageRequest + ", imageLoader=" + imageLoader + ", modelEqualityDelegate=" + asyncImageModelEqualityDelegate + ", transform=" + function1 + ", onState=" + function12 + ", filterQuality=" + m4647toStringimpl + ", alignment=" + alignment + ", contentScale=" + contentScale + ", alpha=" + f + ", colorFilter=" + colorFilter + ", clipToBounds=" + z + ", previewHandler=" + asyncImagePreviewHandler + ", contentDescription=" + this.contentDescription + ")";
    }
    ...
    public ContentPainterNode create() {
        ...
        asyncImagePainter.m8332setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
    ...
    public void update(ContentPainterNode contentPainterNode) {
        long mo5248getIntrinsicSizeNHjbRc = contentPainterNode.getPainter().mo5248getIntrinsicSizeNHjbRc();
        ...
        painter.m8332setFilterQualityvDHp3xo$coil_compose_core_release(this.filterQuality);
        painter.setPreviewHandler$coil_compose_core_release(this.previewHandler);
        painter.set_input$coil_compose_core_release(input);
        boolean m4370equalsimpl0 = Size.m4370equalsimpl0(mo5248getIntrinsicSizeNHjbRc, painter.mo5248getIntrinsicSizeNHjbRc());
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("filterQuality", FilterQuality.m4642boximpl(this.filterQuality));
