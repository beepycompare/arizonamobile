...
public final class UtilsKt {
    ...
    public static final Size m9104toSizeBRTryo0(long j) {
        return new Size(toDimension(Constraints.m7949getMaxWidthimpl(j)), toDimension(Constraints.m7948getMaxHeightimpl(j)));
    }

    /* renamed from: toSizeOrNull-uvyYCjk  reason: not valid java name */
    public static final Size m9105toSizeOrNulluvyYCjk(long j) {
        if (j == InlineClassHelperKt.UnspecifiedPackedFloats) {
            return Size.ORIGINAL;
        }
        if (m9102isPositiveuvyYCjk(j)) {
    ...
    private static final Dimension toDimension(int i) {
        return i != Integer.MAX_VALUE ? Dimension.Pixels.m9149boximpl(DimensionKt.Dimension(i)) : Dimension.Undefined.INSTANCE;
    }

    private static final Dimension toDimension(float f) {
        return Math.abs(f) <= Float.MAX_VALUE ? Dimension.Pixels.m9149boximpl(DimensionKt.Dimension(MathKt.roundToInt(f))) : Dimension.Undefined.INSTANCE;
    }

    /* renamed from: constrainWidth-K40F9xA  reason: not valid java name */
    public static final float m9101constrainWidthK40F9xA(long j, float f) {
        return RangesKt.coerceIn(f, Constraints.m7951getMinWidthimpl(j), Constraints.m7949getMaxWidthimpl(j));
    }

    /* renamed from: constrainHeight-K40F9xA  reason: not valid java name */
    public static final float m9100constrainHeightK40F9xA(long j, float f) {
        return RangesKt.coerceIn(f, Constraints.m7950getMinHeightimpl(j), Constraints.m7948getMaxHeightimpl(j));
    }
    ...
    public static final long m9103toIntSizeuvyYCjk(long j) {
        int roundToInt = MathKt.roundToInt(Float.intBitsToFloat((int) (j >> 32)));
        return IntSize.m8162constructorimpl((MathKt.roundToInt(Float.intBitsToFloat((int) (j & 4294967295L))) & 4294967295L) | (roundToInt << 32));
    }

    /* renamed from: isPositive-uvyYCjk  reason: not valid java name */
    public static final boolean m9102isPositiveuvyYCjk(long j) {
