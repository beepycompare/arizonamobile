...
public final class AsyncImagePainterKt {
    ...
    public static final AsyncImagePainter m9063rememberAsyncImagePainter3HmZ8SU(Object obj, ImageLoader imageLoader, Painter painter, Painter painter2, Painter painter3, Function1<? super AsyncImagePainter.State.Loading, Unit> function1, Function1<? super AsyncImagePainter.State.Success, Unit> function12, Function1<? super AsyncImagePainter.State.Error, Unit> function13, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        int m5861getDefaultFilterQualityfv9h1I = (i3 & 512) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        AsyncImagePainter m9065rememberAsyncImagePainterGSdzBsE = m9065rememberAsyncImagePainterGSdzBsE(asyncImageState, UtilsKt.transformOf(painter4, painter5, painter6), UtilsKt.onStateOf(function14, function15, function16), fit, m5861getDefaultFilterQualityfv9h1I, composer, (i2 >> 15) & 64512);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m9065rememberAsyncImagePainterGSdzBsE;
    }

    /* renamed from: rememberAsyncImagePainter-5jETZwI  reason: not valid java name */
    public static final AsyncImagePainter m9064rememberAsyncImagePainter5jETZwI(Object obj, ImageLoader imageLoader, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        if ((i3 & 32) != 0) {
            i = DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I();
        }
        int i4 = i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        AsyncImageState asyncImageState = new AsyncImageState(obj, (AsyncImageModelEqualityDelegate) consume, imageLoader);
        ComposerKt.sourceInformationMarkerEnd(composer);
        AsyncImagePainter m9065rememberAsyncImagePainterGSdzBsE = m9065rememberAsyncImagePainterGSdzBsE(asyncImageState, function13, function12, contentScale2, i4, composer, (i2 >> 3) & 65520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    private static final AsyncImagePainter m9065rememberAsyncImagePainterGSdzBsE(AsyncImageState asyncImageState, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, ContentScale contentScale, int i, Composer composer, int i2) {
        ...
        try {
            ...
            asyncImagePainter.m9062setFilterQualityvDHp3xo$coil_compose_core_release(i);
