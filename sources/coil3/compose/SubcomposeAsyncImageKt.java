...
public final class SubcomposeAsyncImageKt {
    ...
    public static final void m9084SubcomposeAsyncImageMokUVwQ(Object obj, String str, ImageLoader imageLoader, Modifier modifier, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Loading, ? super Composer, ? super Integer, Unit> function4, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Success, ? super Composer, ? super Integer, Unit> function42, Function4<? super SubcomposeAsyncImageScope, ? super AsyncImagePainter.State.Error, ? super Composer, ? super Integer, Unit> function43, Function1<? super AsyncImagePainter.State.Loading, Unit> function12, Function1<? super AsyncImagePainter.State.Success, Unit> function13, Function1<? super AsyncImagePainter.State.Error, Unit> function14, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, boolean z, Composer composer, int i2, int i3, int i4) {
        ...
        int m5861getDefaultFilterQualityfv9h1I = (i4 & 32768) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i;
        ...
        m9086SubcomposeAsyncImagegl8XCv8(asyncImageState, str, modifier3, function18, UtilsKt.onStateOf(function15, function16, function17), alignment2, fit, f2, colorFilter2, m5861getDefaultFilterQualityfv9h1I, z2, contentOf(function44, function45, function46), composer, i6 | (458752 & i7) | (3670016 & i7) | (29360128 & i7) | (234881024 & i7) | (i7 & 1879048192), (i3 >> 18) & 14, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m9085SubcomposeAsyncImageQgsmV_s(Object obj, String str, ImageLoader imageLoader, Modifier modifier, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, boolean z, Function3<? super SubcomposeAsyncImageScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, int i2, int i3, int i4) {
        ...
        int m5861getDefaultFilterQualityfv9h1I = (i4 & 1024) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i;
        ...
        AsyncImageState asyncImageState = new AsyncImageState(obj, (AsyncImageModelEqualityDelegate) consume, imageLoader);
        ComposerKt.sourceInformationMarkerEnd(composer);
        m9086SubcomposeAsyncImagegl8XCv8(asyncImageState, str, companion, defaultTransform, function13, center, fit, f2, colorFilter2, m5861getDefaultFilterQualityfv9h1I, z2, function3, composer, ((i3 << 27) & 1879048192) | (i5 & 234881024) | (i2 & 112) | (i5 & 896) | (i5 & 7168) | (57344 & i5) | (458752 & i5) | (3670016 & i5) | (29360128 & i5), (i3 >> 3) & WebSocketProtocol.PAYLOAD_SHORT, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    */
    private static final void m9086SubcomposeAsyncImagegl8XCv8(final AsyncImageState asyncImageState, final String str, Modifier modifier, final Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, final Function1<? super AsyncImagePainter.State, Unit> function12, final Alignment alignment, final ContentScale contentScale, final float f, final ColorFilter colorFilter, final int i, final boolean z, final Function3<? super SubcomposeAsyncImageScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i2, final int i3, final int i4) {
        ...
        if (i8 != 0) {
            ...
            if (startRestartGroup.shouldExecute((306783379 & i5) == 306783378 || (i7 & 19) != 18, i5 & 1)) {
                ...
                int i9 = i5 >> 6;
                int i10 = i5 >> 12;
                final AsyncImagePainter m9064rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m9064rememberAsyncImagePainter5jETZwI(requestOfWithSizeResolver, asyncImageState.getImageLoader(), obj, function12, contentScale, i, startRestartGroup, ((i5 >> 3) & 8064) | (i9 & 57344) | (i10 & 458752), 0);
                ...
                if (sizeResolver instanceof ConstraintsSizeResolver) {
                    ...
                    BoxWithConstraintsKt.BoxWithConstraints(modifier3, alignment, true, ComposableLambdaKt.rememberComposableLambda(-374957172, true, new Function3() { // from class: coil3.compose.SubcomposeAsyncImageKt$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke(Object obj2, Object obj3, Object obj4) {
                            ...
                            SubcomposeAsyncImage_gl8XCv8$lambda$1 = SubcomposeAsyncImageKt.SubcomposeAsyncImage_gl8XCv8$lambda$1(SizeResolver.this, function3, m9064rememberAsyncImagePainter5jETZwI, str, alignment, contentScale, f, colorFilter, z, (BoxWithConstraintsScope) obj2, (Composer) obj3, ((Integer) obj4).intValue());
                    ...
                    function3.invoke(new RealSubcomposeAsyncImageScope(BoxScopeInstance.INSTANCE, m9064rememberAsyncImagePainter5jETZwI, str, alignment, contentScale, f, colorFilter, z), startRestartGroup, Integer.valueOf(i7 & 112));
    ...
    public static final Unit SubcomposeAsyncImage_gl8XCv8$lambda$1(SizeResolver sizeResolver, Function3 function3, AsyncImagePainter asyncImagePainter, String str, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, boolean z, BoxWithConstraintsScope boxWithConstraintsScope, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            ((ConstraintsSizeResolver) sizeResolver).m9068setConstraintsBRTryo0(boxWithConstraintsScope.mo728getConstraintsmsEJaDk());
    ...
    public static final void SubcomposeAsyncImageContent(final SubcomposeAsyncImageScope subcomposeAsyncImageScope, Modifier modifier, Painter painter, String str, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, boolean z, Composer composer, final int i, final int i2) {
        ...
        if (i11 != 0) {
            ...
            if (!startRestartGroup.shouldExecute((38347923 & i3) == 38347922, i3 & 1)) {
                ...
                Composer m4597constructorimpl = Updater.m4597constructorimpl(startRestartGroup);
                Updater.m4604setimpl(m4597constructorimpl, useMinConstraintsMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
                Updater.m4604setimpl(m4597constructorimpl, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                Updater.m4604setimpl(m4597constructorimpl, materializeModifier, ComposeUiNode.Companion.getSetModifier());
                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.Companion.getSetCompositeKeyHash();
                if (m4597constructorimpl.getInserting() || !Intrinsics.areEqual(m4597constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
