...
public final class LocalAsyncImagePreviewHandlerKt$AsyncImagePreviewHandler$1 implements AsyncImagePreviewHandler {
    ...
    */
    public final Object handle(ImageLoader imageLoader, ImageRequest imageRequest, Continuation<? super AsyncImagePainter.State> continuation) {
        ...
        if (continuation instanceof LocalAsyncImagePreviewHandlerKt$AsyncImagePreviewHandler$1$handle$1) {
            ...
            if ((localAsyncImagePreviewHandlerKt$AsyncImagePreviewHandler$1$handle$1.label & Integer.MIN_VALUE) != 0) {
                ...
                return new AsyncImagePainter.State.Success(ImagePainter_androidKt.m8557asPainter55t9rM$default(image, imageRequest2.getContext(), 0, 2, null), new SuccessResult(image, imageRequest2, null, null, null, false, false, 124, null));
            }
        }
        ...
        return new AsyncImagePainter.State.Success(ImagePainter_androidKt.m8557asPainter55t9rM$default(image2, imageRequest22.getContext(), 0, 2, null), new SuccessResult(image2, imageRequest22, null, null, null, false, false, 124, null));
    }
    ...
    public final Object handle$$forInline(ImageLoader imageLoader, ImageRequest imageRequest, Continuation<? super AsyncImagePainter.State> continuation) {
        ...
        return new AsyncImagePainter.State.Success(ImagePainter_androidKt.m8557asPainter55t9rM$default(image, imageRequest.getContext(), 0, 2, null), new SuccessResult(image, imageRequest, null, null, null, false, false, 124, null));
    }
}
