...
public final class SingletonAsyncImagePainterKt {
    ...
    public static final AsyncImagePainter m9398rememberAsyncImagePainterMqRF_0(Object obj, Painter painter, Painter painter2, Painter painter3, Function1<? super AsyncImagePainter.State.Loading, Unit> function1, Function1<? super AsyncImagePainter.State.Success, Unit> function12, Function1<? super AsyncImagePainter.State.Error, Unit> function13, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        int m6008getDefaultFilterQualityfv9h1I = (i3 & 256) != 0 ? DrawScope.Companion.m6008getDefaultFilterQualityfv9h1I() : i;
        ...
        int i4 = i2 << 3;
        AsyncImagePainter m9382rememberAsyncImagePainter3HmZ8SU = AsyncImagePainterKt.m9382rememberAsyncImagePainter3HmZ8SU(obj, SingletonImageLoader.get((Context) consume), painter4, painter2, painter5, function14, function15, function16, fit, m6008getDefaultFilterQualityfv9h1I, composer, (i2 & 14) | (i4 & 896) | (i4 & 7168) | (57344 & i4) | (458752 & i4) | (3670016 & i4) | (29360128 & i4) | (234881024 & i4) | (i4 & 1879048192), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m9382rememberAsyncImagePainter3HmZ8SU;
    }

    /* renamed from: rememberAsyncImagePainter-19ie5dc  reason: not valid java name */
    public static final AsyncImagePainter m9397rememberAsyncImagePainter19ie5dc(Object obj, Function1<? super AsyncImagePainter.State, ? extends AsyncImagePainter.State> function1, Function1<? super AsyncImagePainter.State, Unit> function12, ContentScale contentScale, int i, Composer composer, int i2, int i3) {
        ...
        int m6008getDefaultFilterQualityfv9h1I = (i3 & 16) != 0 ? DrawScope.Companion.m6008getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        int i4 = i2 << 3;
        AsyncImagePainter m9383rememberAsyncImagePainter5jETZwI = AsyncImagePainterKt.m9383rememberAsyncImagePainter5jETZwI(obj, SingletonImageLoader.get((Context) consume), defaultTransform, function13, fit, m6008getDefaultFilterQualityfv9h1I, composer, (i2 & 14) | (i4 & 896) | (i4 & 7168) | (57344 & i4) | (i4 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m9383rememberAsyncImagePainter5jETZwI;
    }
}
