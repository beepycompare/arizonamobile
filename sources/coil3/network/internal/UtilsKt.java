...
public final class UtilsKt {
    ...
    */
            ...
            if ((utilsKt$readBuffer$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        utilsKt$readBuffer$1.L$0 = SpillingKt.nullOutSpilledVariable(networkResponseBody);
                        utilsKt$readBuffer$1.L$1 = networkResponseBody2;
                        utilsKt$readBuffer$1.L$2 = SpillingKt.nullOutSpilledVariable(networkResponseBody3);
                        utilsKt$readBuffer$1.L$3 = buffer2;
                        utilsKt$readBuffer$1.I$0 = 0;
                        utilsKt$readBuffer$1.label = 1;
                        if (networkResponseBody3.writeTo(buffer2, utilsKt$readBuffer$1) == coroutine_suspended) {
                    ...
                    int i2 = utilsKt$readBuffer$1.I$0;
                    buffer = (Buffer) utilsKt$readBuffer$1.L$3;
                    NetworkResponseBody networkResponseBody4 = (NetworkResponseBody) utilsKt$readBuffer$1.L$2;
                    autoCloseable = (AutoCloseable) utilsKt$readBuffer$1.L$1;
                    NetworkResponseBody networkResponseBody5 = (NetworkResponseBody) utilsKt$readBuffer$1.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                    } catch (Throwable th2) {
                        th = th2;
    ...
    public static final void closeQuietly(AutoCloseable autoCloseable) {
        try {
            UByte$$ExternalSyntheticBackport0.m10316m((Object) autoCloseable);
