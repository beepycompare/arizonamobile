...
public final class ContinuationCallback implements Callback, Function1<Throwable, Unit> {
    ...
    public void onResponse(Call call, Response response) {
        ...
        this.continuation.resumeWith(Result.m9904constructorimpl(response));
    }
    ...
    public void onFailure(Call call, IOException iOException) {
        ...
        Result.Companion companion = Result.Companion;
        this.continuation.resumeWith(Result.m9904constructorimpl(ResultKt.createFailure(iOException)));
    }
