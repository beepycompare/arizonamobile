...
public final class AndroidSystemCallbacks implements SystemCallbacks, ComponentCallbacks2 {
    ...
    /* compiled from: SystemCallbacks.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lcoil3/util/AndroidSystemCallbacks$Companion;", "", "<init>", "()V", "TAG", "", "coil-core_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes3.dex */
        ...
        if (realImageLoader != null) {
            ...
            if (logger != null) {
                ...
                if (logger.getMinLevel().compareTo(level) <= 0) {
                    logger.log(TAG, level, "trimMemory, level=" + i, null);
                }
            }
            if (i >= 40) {
