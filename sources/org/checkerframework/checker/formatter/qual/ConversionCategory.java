...
public enum ConversionCategory {
    ...
    static {
        r5 = CHAR;
        ConversionCategory conversionCategory = INT;
        ConversionCategory conversionCategory2 = FLOAT;
        ConversionCategory conversionCategory3 = TIME;
        ConversionCategory conversionCategory4 = CHAR_AND_INT;
        ConversionCategory conversionCategory5 = INT_AND_TIME;
        ConversionCategory conversionCategory6 = NULL;
        conversionCategoriesWithChar = new ConversionCategory[]{r0, r5, conversionCategory, conversionCategory2, conversionCategory3};
        conversionCategoriesForIntersect = new ConversionCategory[]{r5, conversionCategory, conversionCategory2, conversionCategory3, conversionCategory4, conversionCategory5, conversionCategory6};
        conversionCategoriesForUnion = new ConversionCategory[]{conversionCategory6, conversionCategory4, conversionCategory5, r5, conversionCategory, conversionCategory2, conversionCategory3};
    }
