        ...
        if (continuation instanceof KotlinExtensions$suspendAndThrow$1) {
            ...
            if ((kotlinExtensions$suspendAndThrow$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Dispatchers.getDefault().mo11783dispatch(kotlinExtensions$suspendAndThrow$12.getContext(), new Runnable() { // from class: retrofit2.KotlinExtensions$suspendAndThrow$2$1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Continuation intercepted = IntrinsicsKt.intercepted(kotlinExtensions$suspendAndThrow$12);
                            Result.Companion companion = Result.Companion;
                            intercepted.resumeWith(Result.m10199constructorimpl(ResultKt.createFailure(th)));
                        }
                    });
    ...
    public static final <T> Object await(final Call<T> call, Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (body == null) {
                        ...
                        Result.Companion companion = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    Result.Companion companion2 = Result.Companion;
                    cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(body));
                    return;
                }
                Result.Companion companion3 = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(ResultKt.createFailure(new HttpException(response))));
            }
            ...
            public void onFailure(Call<T> call2, Throwable t) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(ResultKt.createFailure(t)));
            }
        });
    ...
    public static final <T> Object awaitNullable(final Call<T> call, Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    Result.Companion companion = Result.Companion;
                    cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(response.body()));
                    return;
                }
                Result.Companion companion2 = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(ResultKt.createFailure(new HttpException(response))));
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                Intrinsics.checkNotNullParameter(response, "response");
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m10199constructorimpl(response));
            }
