...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m10419containsWZ4Q5Ns(((UInt) obj).m10054unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UInt.m9996boximpl(m10420getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m10421indexOfWZ4Q5Ns(((UInt) obj).m10054unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m10422lastIndexOfWZ4Q5Ns(((UInt) obj).m10054unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m10063getSizeimpl(this.f70$$v$c$kotlinUIntArray$$this$asList$0);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m10065isEmptyimpl(this.f70$$v$c$kotlinUIntArray$$this$asList$0);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m10419containsWZ4Q5Ns(int i) {
        return UIntArray.m10058containsWZ4Q5Ns(this.f70$$v$c$kotlinUIntArray$$this$asList$0, i);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public int m10420getpVg5ArA(int i) {
        return UIntArray.m10062getpVg5ArA(this.f70$$v$c$kotlinUIntArray$$this$asList$0, i);
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m10421indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.f70$$v$c$kotlinUIntArray$$this$asList$0, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m10422lastIndexOfWZ4Q5Ns(int i) {
