...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m10358containsWZ4Q5Ns(((UInt) obj).m9994unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UInt.m9936boximpl(m10359getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m10360indexOfWZ4Q5Ns(((UInt) obj).m9994unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m10361lastIndexOfWZ4Q5Ns(((UInt) obj).m9994unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m10003getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m10005isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m10358containsWZ4Q5Ns(int i) {
        return UIntArray.m9998containsWZ4Q5Ns(this.$this_asList, i);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public int m10359getpVg5ArA(int i) {
        return UIntArray.m10002getpVg5ArA(this.$this_asList, i);
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m10360indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m10361lastIndexOfWZ4Q5Ns(int i) {
