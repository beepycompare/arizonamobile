...
public final class UShortArrayKt {
    ...
    private static final short[] m10252ushortArrayOfrL5Bavg(short... elements) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = init.invoke(Integer.valueOf(i2)).m10233unboximpl();
        }
        return UShortArray.m10236constructorimpl(sArr);
    }
}
