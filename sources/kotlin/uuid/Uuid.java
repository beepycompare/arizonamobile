...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10388boximpl(ULong.m10394constructorimpl(getMostSignificantBits())), ULong.m10388boximpl(ULong.m10394constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11709toUByteArrayTcUX1vc() {
        return UByteArray.m10291constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10394constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10394constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10394constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10394constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11711fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11710fromUByteArrayGBYM_sE(byte[] bArr) {
