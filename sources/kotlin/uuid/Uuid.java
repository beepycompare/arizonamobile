...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m9279boximpl(ULong.m9285constructorimpl(getMostSignificantBits())), ULong.m9279boximpl(ULong.m9285constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m10600toUByteArrayTcUX1vc() {
        return UByteArray.m9182constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m9285constructorimpl(j) ^ Long.MIN_VALUE, ULong.m9285constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m9285constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m9285constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m10602fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m10601fromUByteArrayGBYM_sE(byte[] bArr) {
