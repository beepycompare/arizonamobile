...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10074boximpl(ULong.m10080constructorimpl(getMostSignificantBits())), ULong.m10074boximpl(ULong.m10080constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11395toUByteArrayTcUX1vc() {
        return UByteArray.m9977constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10080constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10080constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10080constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10080constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11397fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11396fromUByteArrayGBYM_sE(byte[] bArr) {
