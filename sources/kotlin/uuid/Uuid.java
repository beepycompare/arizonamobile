...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10070boximpl(ULong.m10076constructorimpl(getMostSignificantBits())), ULong.m10070boximpl(ULong.m10076constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11414toUByteArrayTcUX1vc() {
        return UByteArray.m9973constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10076constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10076constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10076constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10076constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11416fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11415fromUByteArrayGBYM_sE(byte[] ubyteArray) {
