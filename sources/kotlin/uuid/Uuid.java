...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10093boximpl(ULong.m10099constructorimpl(getMostSignificantBits())), ULong.m10093boximpl(ULong.m10099constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11437toUByteArrayTcUX1vc() {
        return UByteArray.m9996constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10099constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10099constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10099constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10099constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11439fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11438fromUByteArrayGBYM_sE(byte[] ubyteArray) {
