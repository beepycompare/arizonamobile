...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10090boximpl(ULong.m10096constructorimpl(getMostSignificantBits())), ULong.m10090boximpl(ULong.m10096constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11434toUByteArrayTcUX1vc() {
        return UByteArray.m9993constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10096constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10096constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10096constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10096constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11436fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11435fromUByteArrayGBYM_sE(byte[] ubyteArray) {
