...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m8651boximpl(ULong.m8657constructorimpl(getMostSignificantBits())), ULong.m8651boximpl(ULong.m8657constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m9967toUByteArrayTcUX1vc() {
        return UByteArray.m8554constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m8657constructorimpl(j) ^ Long.MIN_VALUE, ULong.m8657constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m8657constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m8657constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m9969fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m9968fromUByteArrayGBYM_sE(byte[] ubyteArray) {
