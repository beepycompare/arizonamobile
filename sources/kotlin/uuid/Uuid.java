...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10075boximpl(ULong.m10081constructorimpl(getMostSignificantBits())), ULong.m10075boximpl(ULong.m10081constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11396toUByteArrayTcUX1vc() {
        return UByteArray.m9978constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10081constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10081constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10081constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10081constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11398fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11397fromUByteArrayGBYM_sE(byte[] bArr) {
