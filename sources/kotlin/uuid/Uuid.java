...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10077boximpl(ULong.m10083constructorimpl(getMostSignificantBits())), ULong.m10077boximpl(ULong.m10083constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11398toUByteArrayTcUX1vc() {
        return UByteArray.m9980constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10083constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10083constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10083constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10083constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11400fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11399fromUByteArrayGBYM_sE(byte[] bArr) {
