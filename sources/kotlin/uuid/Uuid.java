...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10372boximpl(ULong.m10378constructorimpl(getMostSignificantBits())), ULong.m10372boximpl(ULong.m10378constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11693toUByteArrayTcUX1vc() {
        return UByteArray.m10275constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10378constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10378constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10378constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10378constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11695fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11694fromUByteArrayGBYM_sE(byte[] bArr) {
