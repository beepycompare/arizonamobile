...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m10095boximpl(ULong.m10101constructorimpl(getMostSignificantBits())), ULong.m10095boximpl(ULong.m10101constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m11439toUByteArrayTcUX1vc() {
        return UByteArray.m9998constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m10101constructorimpl(j) ^ Long.MIN_VALUE, ULong.m10101constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m10101constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m10101constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m11441fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m11440fromUByteArrayGBYM_sE(byte[] ubyteArray) {
