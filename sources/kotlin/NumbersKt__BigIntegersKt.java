...
class NumbersKt__BigIntegersKt extends NumbersKt__BigDecimalsKt {
    ...
    private static final BigInteger m9916toBigIntegerWZ4Q5Ns(int i) {
    ...
    public static final BigInteger m9915toBigIntegerVKZWuLQ(long j) {
        if (j >= 0) {
            BigInteger valueOf = BigInteger.valueOf(j);
            Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(...)");
            return valueOf;
        }
        BigInteger valueOf2 = BigInteger.valueOf(UByte$$ExternalSyntheticBackport0.m9989m(j, 2L));
