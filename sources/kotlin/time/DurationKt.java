...
public final class DurationKt {
    ...
    private static final long m10660timesmvk6XK0(int i, long j) {
        return Duration.m10589timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m10659timeskIfJnKk(double d, long j) {
        return Duration.m10588timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z, boolean z2) {
        ...
        if (str.length() == 0) {
            ...
            return Duration.Companion.m10651getINVALIDUwyO8pc$kotlin_stdlib();
        }
        ...
        if (str.charAt(i2) == 'P') {
            ...
            parseDefaultStringFormat = Duration.Companion.m10650getINFINITEUwyO8pc();
        } else {
            parseDefaultStringFormat = parseDefaultStringFormat(str, i2, z3, z2);
        }
        return (i == 0 || Duration.m10563equalsimpl0(parseDefaultStringFormat, Duration.Companion.m10651getINVALIDUwyO8pc$kotlin_stdlib())) ? parseDefaultStringFormat : Duration.m10602unaryMinusUwyO8pc(parseDefaultStringFormat);
    }
    ...
    */
    private static final long parseIsoStringFormat(String str, int i, boolean z) {
        ...
        return Duration.m10587plusLRDsOJo(toDuration(j2, DurationUnit.MILLISECONDS), toDuration(j3, DurationUnit.NANOSECONDS));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:262:0x00e7, code lost:
        return kotlin.time.Duration.Companion.m10651getINVALIDUwyO8pc$kotlin_stdlib();
     */
    ...
    */
    private static final long parseDefaultStringFormat(String str, int i, boolean z, boolean z2) {
        ...
        return Duration.m10587plusLRDsOJo(toDuration(j3, DurationUnit.MILLISECONDS), toDuration(j4, DurationUnit.NANOSECONDS));
    }
    ...
    private static final Duration m10658onInvalidge6A_vg(long j, Function0<Duration> function0) {
        return Duration.m10563equalsimpl0(j, Duration.Companion.m10651getINVALIDUwyO8pc$kotlin_stdlib()) ? function0.invoke() : Duration.m10556boximpl(j);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.Companion.m10649fromRawValueUwyO8pc$kotlin_stdlib(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.Companion.m10649fromRawValueUwyO8pc$kotlin_stdlib((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.Companion.m10649fromRawValueUwyO8pc$kotlin_stdlib((j << 1) + i);
    }
