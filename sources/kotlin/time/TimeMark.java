...
public interface TimeMark {
    ...
    TimeMark mo11287minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11289plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11414plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11413minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11289plusLRDsOJo(Duration.m11342unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11324isNegativeimpl(timeMark.mo11286elapsedNowUwyO8pc());
        }
