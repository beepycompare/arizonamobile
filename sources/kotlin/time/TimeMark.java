...
public interface TimeMark {
    ...
    TimeMark mo11564minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11566plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11685plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11684minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11566plusLRDsOJo(Duration.m11617unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11599isNegativeimpl(timeMark.mo11563elapsedNowUwyO8pc());
        }
