...
public interface TimeMark {
    ...
    TimeMark mo11281minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11283plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11408plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11407minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11283plusLRDsOJo(Duration.m11336unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11318isNegativeimpl(timeMark.mo11280elapsedNowUwyO8pc());
        }
