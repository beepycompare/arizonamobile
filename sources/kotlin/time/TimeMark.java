...
public interface TimeMark {
    ...
    TimeMark mo11188minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11190plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11315plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11314minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11190plusLRDsOJo(Duration.m11243unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11225isNegativeimpl(timeMark.mo11187elapsedNowUwyO8pc());
        }
