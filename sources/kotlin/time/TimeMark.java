...
public interface TimeMark {
    ...
    TimeMark mo11563minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11565plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11684plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11683minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11565plusLRDsOJo(Duration.m11616unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11598isNegativeimpl(timeMark.mo11562elapsedNowUwyO8pc());
        }
