...
public interface TimeMark {
    ...
    TimeMark mo11191minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo11193plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m11312plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m11311minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo11193plusLRDsOJo(Duration.m11244unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m11226isNegativeimpl(timeMark.mo11190elapsedNowUwyO8pc());
        }
