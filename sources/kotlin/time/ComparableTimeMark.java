...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo10439minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo10440minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo10441plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m10443minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo10441plusLRDsOJo(Duration.m10492unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m10447compareToLRDsOJo(comparableTimeMark.mo10440minusUwyO8pc(other), Duration.Companion.m10539getZEROUwyO8pc());
        }
    }
}
