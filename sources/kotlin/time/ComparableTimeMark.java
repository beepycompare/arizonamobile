...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo10547minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo10548minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo10549plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m10551minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo10549plusLRDsOJo(Duration.m10602unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m10557compareToLRDsOJo(comparableTimeMark.mo10548minusUwyO8pc(other), Duration.Companion.m10653getZEROUwyO8pc());
        }
    }
}
