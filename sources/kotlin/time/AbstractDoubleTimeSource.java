...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo10546elapsedNowUwyO8pc() {
            return Duration.m10586minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo10549plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m10587plusLRDsOJo(this.offset, j), null);
        }
        ...
        public long mo10548minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m10563equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m10583isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m10653getZEROUwyO8pc();
                    }
                    long m10586minusLRDsOJo = Duration.m10586minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m10563equalsimpl0(duration, Duration.m10602unaryMinusUwyO8pc(m10586minusLRDsOJo)) ? Duration.Companion.m10653getZEROUwyO8pc() : Duration.m10587plusLRDsOJo(duration, m10586minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) obj).timeSource) && Duration.m10563equalsimpl0(mo10548minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m10653getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m10579hashCodeimpl(Duration.m10587plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m10598toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m10653getZEROUwyO8pc(), null);
    }
}
