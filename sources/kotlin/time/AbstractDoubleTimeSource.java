...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo11546elapsedNowUwyO8pc() {
            return Duration.m11584minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo11549plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m11585plusLRDsOJo(this.offset, j), null);
        }
        ...
        public long mo11548minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m11561equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m11581isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m11647getZEROUwyO8pc();
                    }
                    long m11584minusLRDsOJo = Duration.m11584minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m11561equalsimpl0(duration, Duration.m11600unaryMinusUwyO8pc(m11584minusLRDsOJo)) ? Duration.Companion.m11647getZEROUwyO8pc() : Duration.m11585plusLRDsOJo(duration, m11584minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) obj).timeSource) && Duration.m11561equalsimpl0(mo11548minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m11647getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m11577hashCodeimpl(Duration.m11585plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m11596toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m11647getZEROUwyO8pc(), null);
    }
}
