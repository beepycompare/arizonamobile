...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m11597getAdjustmentUwyO8pc() {
    ...
    public /* bridge */ TimeMark mo11594minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m11721minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo11593elapsedNowUwyO8pc() {
        return Duration.m11633minusLRDsOJo(this.mark.mo11593elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo11596plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m11634plusLRDsOJo(this.adjustment, j), null);
    }
}
