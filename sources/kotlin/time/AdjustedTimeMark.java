...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m9847getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo9844minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9964minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo9843elapsedNowUwyO8pc() {
        return Duration.m9881minusLRDsOJo(this.mark.mo9843elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo9846plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m9882plusLRDsOJo(this.adjustment, j), null);
    }
}
