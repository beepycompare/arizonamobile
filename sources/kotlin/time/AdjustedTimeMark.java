...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m9824getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo9821minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9941minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo9820elapsedNowUwyO8pc() {
        return Duration.m9858minusLRDsOJo(this.mark.mo9820elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo9823plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m9859plusLRDsOJo(this.adjustment, j), null);
    }
}
