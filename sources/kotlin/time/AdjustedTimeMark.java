...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m10442getAdjustmentUwyO8pc() {
    ...
    public /* bridge */ TimeMark mo10439minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m10559minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo10438elapsedNowUwyO8pc() {
        return Duration.m10476minusLRDsOJo(this.mark.mo10438elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo10441plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m10477plusLRDsOJo(this.adjustment, j), null);
    }
}
