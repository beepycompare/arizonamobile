...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m11166getEndExclusivepVg5ArA$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(UInt uInt) {
        return m11167containsWZ4Q5Ns(uInt.m10051unboximpl());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ UInt getEndExclusive() {
        return UInt.m9993boximpl(m11168getEndExclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getEndInclusive() {
        return UInt.m9993boximpl(m11169getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getStart() {
        return UInt.m9993boximpl(m11170getStartpVg5ArA());
    }

    /* renamed from: getStart-pVg5ArA  reason: not valid java name */
    public int m11170getStartpVg5ArA() {
        return m11162getFirstpVg5ArA();
    }

    /* renamed from: getEndInclusive-pVg5ArA  reason: not valid java name */
    public int m11169getEndInclusivepVg5ArA() {
        return m11163getLastpVg5ArA();
    }

    /* renamed from: getEndExclusive-pVg5ArA  reason: not valid java name */
    public int m11168getEndExclusivepVg5ArA() {
        if (m11163getLastpVg5ArA() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return UInt.m9999constructorimpl(m11163getLastpVg5ArA() + 1);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m11167containsWZ4Q5Ns(int i) {
        int compare;
        int compare2;
        compare = Integer.compare(m11162getFirstpVg5ArA() ^ Integer.MIN_VALUE, i ^ Integer.MIN_VALUE);
        if (compare <= 0) {
            compare2 = Integer.compare(i ^ Integer.MIN_VALUE, m11163getLastpVg5ArA() ^ Integer.MIN_VALUE);
            return compare2 <= 0;
        }
        return false;
    }
    ...
    public boolean isEmpty() {
        int compare;
        compare = Integer.compare(m11162getFirstpVg5ArA() ^ Integer.MIN_VALUE, m11163getLastpVg5ArA() ^ Integer.MIN_VALUE);
        return compare > 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UIntRange) {
            ...
            return m11162getFirstpVg5ArA() == uIntRange.m11162getFirstpVg5ArA() && m11163getLastpVg5ArA() == uIntRange.m11163getLastpVg5ArA();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (m11162getFirstpVg5ArA() * 31) + m11163getLastpVg5ArA();
    }

    @Override // kotlin.ranges.UIntProgression
    public String toString() {
        return ((Object) UInt.m10045toStringimpl(m11162getFirstpVg5ArA())) + ".." + ((Object) UInt.m10045toStringimpl(m11163getLastpVg5ArA()));
    }
