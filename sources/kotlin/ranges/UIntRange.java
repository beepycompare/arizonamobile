...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m11189getEndExclusivepVg5ArA$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(UInt uInt) {
        return m11190containsWZ4Q5Ns(uInt.m10074unboximpl());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ UInt getEndExclusive() {
        return UInt.m10016boximpl(m11191getEndExclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getEndInclusive() {
        return UInt.m10016boximpl(m11192getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getStart() {
        return UInt.m10016boximpl(m11193getStartpVg5ArA());
    }

    /* renamed from: getStart-pVg5ArA  reason: not valid java name */
    public int m11193getStartpVg5ArA() {
        return m11185getFirstpVg5ArA();
    }

    /* renamed from: getEndInclusive-pVg5ArA  reason: not valid java name */
    public int m11192getEndInclusivepVg5ArA() {
        return m11186getLastpVg5ArA();
    }

    /* renamed from: getEndExclusive-pVg5ArA  reason: not valid java name */
    public int m11191getEndExclusivepVg5ArA() {
        if (m11186getLastpVg5ArA() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return UInt.m10022constructorimpl(m11186getLastpVg5ArA() + 1);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m11190containsWZ4Q5Ns(int i) {
        int compare;
        int compare2;
        compare = Integer.compare(m11185getFirstpVg5ArA() ^ Integer.MIN_VALUE, i ^ Integer.MIN_VALUE);
        if (compare <= 0) {
            compare2 = Integer.compare(i ^ Integer.MIN_VALUE, m11186getLastpVg5ArA() ^ Integer.MIN_VALUE);
            return compare2 <= 0;
        }
        return false;
    }
    ...
    public boolean isEmpty() {
        int compare;
        compare = Integer.compare(m11185getFirstpVg5ArA() ^ Integer.MIN_VALUE, m11186getLastpVg5ArA() ^ Integer.MIN_VALUE);
        return compare > 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UIntRange) {
            ...
            return m11185getFirstpVg5ArA() == uIntRange.m11185getFirstpVg5ArA() && m11186getLastpVg5ArA() == uIntRange.m11186getLastpVg5ArA();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (m11185getFirstpVg5ArA() * 31) + m11186getLastpVg5ArA();
    }

    @Override // kotlin.ranges.UIntProgression
    public String toString() {
        return ((Object) UInt.m10068toStringimpl(m11185getFirstpVg5ArA())) + ".." + ((Object) UInt.m10068toStringimpl(m11186getLastpVg5ArA()));
    }
