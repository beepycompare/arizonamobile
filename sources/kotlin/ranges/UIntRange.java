...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m11183getEndExclusivepVg5ArA$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(UInt uInt) {
        return m11184containsWZ4Q5Ns(uInt.m10068unboximpl());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ UInt getEndExclusive() {
        return UInt.m10010boximpl(m11185getEndExclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getEndInclusive() {
        return UInt.m10010boximpl(m11186getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getStart() {
        return UInt.m10010boximpl(m11187getStartpVg5ArA());
    }

    /* renamed from: getStart-pVg5ArA  reason: not valid java name */
    public int m11187getStartpVg5ArA() {
        return m11179getFirstpVg5ArA();
    }

    /* renamed from: getEndInclusive-pVg5ArA  reason: not valid java name */
    public int m11186getEndInclusivepVg5ArA() {
        return m11180getLastpVg5ArA();
    }

    /* renamed from: getEndExclusive-pVg5ArA  reason: not valid java name */
    public int m11185getEndExclusivepVg5ArA() {
        if (m11180getLastpVg5ArA() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return UInt.m10016constructorimpl(m11180getLastpVg5ArA() + 1);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m11184containsWZ4Q5Ns(int i) {
        int compare;
        int compare2;
        compare = Integer.compare(m11179getFirstpVg5ArA() ^ Integer.MIN_VALUE, i ^ Integer.MIN_VALUE);
        if (compare <= 0) {
            compare2 = Integer.compare(i ^ Integer.MIN_VALUE, m11180getLastpVg5ArA() ^ Integer.MIN_VALUE);
            return compare2 <= 0;
        }
        return false;
    }
    ...
    public boolean isEmpty() {
        int compare;
        compare = Integer.compare(m11179getFirstpVg5ArA() ^ Integer.MIN_VALUE, m11180getLastpVg5ArA() ^ Integer.MIN_VALUE);
        return compare > 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UIntRange) {
            ...
            return m11179getFirstpVg5ArA() == uIntRange.m11179getFirstpVg5ArA() && m11180getLastpVg5ArA() == uIntRange.m11180getLastpVg5ArA();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (m11179getFirstpVg5ArA() * 31) + m11180getLastpVg5ArA();
    }

    @Override // kotlin.ranges.UIntProgression
    public String toString() {
        return ((Object) UInt.m10062toStringimpl(m11179getFirstpVg5ArA())) + ".." + ((Object) UInt.m10062toStringimpl(m11180getLastpVg5ArA()));
    }
