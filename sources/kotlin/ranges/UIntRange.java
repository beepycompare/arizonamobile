...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m11164getEndExclusivepVg5ArA$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(UInt uInt) {
        return m11165containsWZ4Q5Ns(uInt.m10049unboximpl());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ UInt getEndExclusive() {
        return UInt.m9991boximpl(m11166getEndExclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getEndInclusive() {
        return UInt.m9991boximpl(m11167getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ UInt getStart() {
        return UInt.m9991boximpl(m11168getStartpVg5ArA());
    }

    /* renamed from: getStart-pVg5ArA  reason: not valid java name */
    public int m11168getStartpVg5ArA() {
        return m11160getFirstpVg5ArA();
    }

    /* renamed from: getEndInclusive-pVg5ArA  reason: not valid java name */
    public int m11167getEndInclusivepVg5ArA() {
        return m11161getLastpVg5ArA();
    }

    /* renamed from: getEndExclusive-pVg5ArA  reason: not valid java name */
    public int m11166getEndExclusivepVg5ArA() {
        if (m11161getLastpVg5ArA() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return UInt.m9997constructorimpl(m11161getLastpVg5ArA() + 1);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m11165containsWZ4Q5Ns(int i) {
        int compare;
        int compare2;
        compare = Integer.compare(m11160getFirstpVg5ArA() ^ Integer.MIN_VALUE, i ^ Integer.MIN_VALUE);
        if (compare <= 0) {
            compare2 = Integer.compare(i ^ Integer.MIN_VALUE, m11161getLastpVg5ArA() ^ Integer.MIN_VALUE);
            return compare2 <= 0;
        }
        return false;
    }
    ...
    public boolean isEmpty() {
        int compare;
        compare = Integer.compare(m11160getFirstpVg5ArA() ^ Integer.MIN_VALUE, m11161getLastpVg5ArA() ^ Integer.MIN_VALUE);
        return compare > 0;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UIntRange) {
            ...
            return m11160getFirstpVg5ArA() == uIntRange.m11160getFirstpVg5ArA() && m11161getLastpVg5ArA() == uIntRange.m11161getLastpVg5ArA();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (m11160getFirstpVg5ArA() * 31) + m11161getLastpVg5ArA();
    }

    @Override // kotlin.ranges.UIntProgression
    public String toString() {
        return ((Object) UInt.m10043toStringimpl(m11160getFirstpVg5ArA())) + ".." + ((Object) UInt.m10043toStringimpl(m11161getLastpVg5ArA()));
    }
