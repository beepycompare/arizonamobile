...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m8572boximpl(m9717nextpVg5ArA());
    }
    ...
    */
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m8578constructorimpl(i3);
    ...
    public int m9717nextpVg5ArA() {
        ...
        this.next = UInt.m8578constructorimpl(this.step + i);
        return i;
    }
}
