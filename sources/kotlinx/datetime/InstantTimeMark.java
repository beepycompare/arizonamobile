...
final class InstantTimeMark implements ComparableTimeMark {
    ...
    public long mo10546elapsedNowUwyO8pc() {
        return m10800saturatingDiff3nIYWDw(this.clock.now(), this.instant);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public ComparableTimeMark mo10549plusLRDsOJo(long j) {
        return new InstantTimeMark(m10799saturatingAddHG0u8IE(this.instant, j), this.clock);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: minus-LRDsOJo */
    public ComparableTimeMark mo10547minusLRDsOJo(long j) {
        return new InstantTimeMark(m10799saturatingAddHG0u8IE(this.instant, Duration.m10602unaryMinusUwyO8pc(j)), this.clock);
    }
    ...
    public long mo10548minusUwyO8pc(ComparableTimeMark other) {
        ...
        if (other instanceof InstantTimeMark) {
            ...
            if (Intrinsics.areEqual(instantTimeMark.clock, this.clock)) {
                return m10800saturatingDiff3nIYWDw(this.instant, instantTimeMark.instant);
            }
        }
    ...
    private final boolean isSaturated(Instant instant) {
        ...
        if (!Intrinsics.areEqual(instant.m10663plusLRDsOJo(DurationKt.toDuration(1, DurationUnit.SECONDS)), instant)) {
    ...
    private final Instant m10799saturatingAddHG0u8IE(Instant instant, long j) {
        if (isSaturated(instant)) {
            if (Duration.m10583isInfiniteimpl(j)) {
                if (Duration.m10585isPositiveimpl(j) != (instant.compareTo(Instant.Companion.getDISTANT_FUTURE()) >= 0)) {
                    throw new IllegalArgumentException("Summing infinities of different signs");
                }
            }
            return instant;
        }
        return instant.m10663plusLRDsOJo(j);
    }

    /* renamed from: saturatingDiff-3nIYWDw  reason: not valid java name */
    private final long m10800saturatingDiff3nIYWDw(Instant instant, Instant instant2) {
        ...
        if (isSaturated(instant) || isSaturated(instant2)) {
            return Duration.m10588timesUwyO8pc(instant.m10662minusUwyO8pc(instant2), Double.POSITIVE_INFINITY);
        }
        return instant.m10662minusUwyO8pc(instant2);
    }
}
