...
public final class DateTimeUnitSerializer extends AbstractPolymorphicSerializer<DateTimeUnit> {
    ...
    private static final Lazy impl$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<SealedClassSerializer<DateTimeUnit>>() { // from class: kotlinx.datetime.serializers.DateTimeUnitSerializer$impl$2
    ...
    public DeserializationStrategy<DateTimeUnit> findPolymorphicSerializerOrNull(CompositeDecoder decoder, String str) {
