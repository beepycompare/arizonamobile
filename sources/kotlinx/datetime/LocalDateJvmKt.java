...
public final class LocalDateJvmKt {
    ...
    public static final long m11875until(LocalDate localDate, LocalDate other, DateTimeUnit.DateBased unit) {
        Intrinsics.checkNotNullParameter(localDate, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        Intrinsics.checkNotNullParameter(unit, "unit");
    ...
    public static final int until(LocalDate localDate, LocalDate other, DateTimeUnit.DateBased unit) {
        ...
        Intrinsics.checkNotNullParameter(other, "other");
        Intrinsics.checkNotNullParameter(unit, "unit");
        return MathKt.clampToInt(m11875until(localDate, other, unit));
    }
