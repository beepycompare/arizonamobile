            ...
            if (unicodeFormat instanceof UnicodeFormat.OptionalGroup) {
                DateTimeFormatBuilderKt.alternativeParsing(dateTimeFormatBuilder, new Function1[]{new Function1() { // from class: kotlinx.datetime.format.UnicodeKt$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return UnicodeKt.byUnicodePattern$rec$lambda$1((DateTimeFormatBuilder) obj);
                    }
                }}, new Function1() { // from class: kotlinx.datetime.format.UnicodeKt$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return UnicodeKt.byUnicodePattern$rec$lambda$2(UnicodeFormat.this, (DateTimeFormatBuilder) obj);
                    }
                });
                ...
                if (directive instanceof UnicodeFormat.Directive.TimeBased) {
                    ...
                    ((UnicodeFormat.Directive.TimeBased) unicodeFormat).mo11529addToFormat((DateTimeFormatBuilder.WithTime) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.YearMonthBased) unicodeFormat).mo11530addToFormat((DateTimeFormatBuilder.WithYearMonth) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.DateBased) unicodeFormat).mo11527addToFormat((DateTimeFormatBuilder.WithDate) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.ZoneBased) unicodeFormat).mo11531addToFormat((DateTimeFormatBuilder.WithDateTimeComponents) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.OffsetBased) unicodeFormat).mo11528addToFormat((DateTimeFormatBuilder.WithUtcOffset) dateTimeFormatBuilder);
