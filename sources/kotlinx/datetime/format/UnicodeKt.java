        ...
        if (unicodeFormat instanceof UnicodeFormat.StringLiteral) {
            ...
            if (unicodeFormat instanceof UnicodeFormat.OptionalGroup) {
                ...
                if (directive instanceof UnicodeFormat.Directive.TimeBased) {
                    ...
                    ((UnicodeFormat.Directive.TimeBased) unicodeFormat).mo11452addToFormat((DateTimeFormatBuilder.WithTime) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.YearMonthBased) unicodeFormat).mo11453addToFormat((DateTimeFormatBuilder.WithYearMonth) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.DateBased) unicodeFormat).mo11450addToFormat((DateTimeFormatBuilder.WithDate) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.ZoneBased) unicodeFormat).mo11454addToFormat((DateTimeFormatBuilder.WithDateTimeComponents) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.OffsetBased) unicodeFormat).mo11451addToFormat((DateTimeFormatBuilder.WithUtcOffset) dateTimeFormatBuilder);
