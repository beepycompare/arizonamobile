        ...
        if (unicodeFormat instanceof UnicodeFormat.StringLiteral) {
            ...
            if (unicodeFormat instanceof UnicodeFormat.OptionalGroup) {
                ...
                if (directive instanceof UnicodeFormat.Directive.TimeBased) {
                    ...
                    ((UnicodeFormat.Directive.TimeBased) unicodeFormat).mo10108addToFormat((DateTimeFormatBuilder.WithTime) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.YearMonthBased) unicodeFormat).mo10109addToFormat((DateTimeFormatBuilder.WithYearMonth) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.DateBased) unicodeFormat).mo10106addToFormat((DateTimeFormatBuilder.WithDate) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.ZoneBased) unicodeFormat).mo10110addToFormat((DateTimeFormatBuilder.WithDateTimeComponents) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.OffsetBased) unicodeFormat).mo10107addToFormat((DateTimeFormatBuilder.WithUtcOffset) dateTimeFormatBuilder);
