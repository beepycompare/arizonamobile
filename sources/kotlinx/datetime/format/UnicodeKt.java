        ...
        if (unicodeFormat instanceof UnicodeFormat.StringLiteral) {
            ...
            if (unicodeFormat instanceof UnicodeFormat.OptionalGroup) {
                ...
                if (directive instanceof UnicodeFormat.Directive.TimeBased) {
                    ...
                    ((UnicodeFormat.Directive.TimeBased) unicodeFormat).mo11527addToFormat((DateTimeFormatBuilder.WithTime) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.YearMonthBased) unicodeFormat).mo11528addToFormat((DateTimeFormatBuilder.WithYearMonth) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.DateBased) unicodeFormat).mo11525addToFormat((DateTimeFormatBuilder.WithDate) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.ZoneBased) unicodeFormat).mo11529addToFormat((DateTimeFormatBuilder.WithDateTimeComponents) dateTimeFormatBuilder);
                    ...
                    ((UnicodeFormat.Directive.OffsetBased) unicodeFormat).mo11526addToFormat((DateTimeFormatBuilder.WithUtcOffset) dateTimeFormatBuilder);
