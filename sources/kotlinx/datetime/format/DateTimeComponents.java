...
public final class DateTimeComponents {
    ...
    public static final class Formats {
        ...
        public static final Unit ISO_DATE_TIME_OFFSET$lambda$5(DateTimeFormatBuilder.WithDateTimeComponents Format) {
            ...
            DateTimeFormatBuilderKt.m11534char(withDateTimeComponents, AbstractJsonLexerKt.COLON);
        ...
        public static final Unit ISO_DATE_TIME_OFFSET$lambda$5$lambda$0(DateTimeFormatBuilder.WithDateTimeComponents alternativeParsing) {
            ...
            DateTimeFormatBuilderKt.m11534char(alternativeParsing, 't');
            return Unit.INSTANCE;
        }
        ...
        public static final Unit ISO_DATE_TIME_OFFSET$lambda$5$lambda$2(DateTimeFormatBuilder.WithDateTimeComponents optional) {
            ...
            DateTimeFormatBuilderKt.m11534char(optional, '.');
        ...
        public static final Unit RFC_1123$lambda$13(DateTimeFormatBuilder.WithDateTimeComponents Format) {
            ...
            DateTimeFormatBuilderKt.m11534char(withDateTimeComponents, ' ');
        ...
        public static final Unit RFC_1123$lambda$13$lambda$8(DateTimeFormatBuilder.WithDateTimeComponents optional) {
            Intrinsics.checkNotNullParameter(optional, "$this$optional");
            DateTimeFormatBuilderKt.m11534char(optional, AbstractJsonLexerKt.COLON);
    ...
    public final Month getMonth() {
        ...
        if (monthNumber != null) {
            return MonthKt.m11527Month(monthNumber.intValue());
        }
        return null;
    }
    ...
    public final DayOfWeek getDayOfWeek() {
        ...
        if (dayOfWeek != null) {
            return DayOfWeekKt.m11517DayOfWeek(dayOfWeek.intValue());
        }
        return null;
    }
    ...
    public final Instant toInstantUsingOffset(OverloadMarker youShallNotPass) {
        ...
        try {
            Integer year = getYear();
            Intrinsics.checkNotNull(year);
            long safeAdd = MathJvmKt.safeAdd(MathJvmKt.safeMultiply(year.intValue() / 10000, (long) DateCalculationsKt.SECONDS_PER_10000_YEARS), ((copy.toLocalDate().m11523toEpochDays() * 86400) + localTime.toSecondOfDay()) - utcOffset.getTotalSeconds());
