...
public final class DateTimeComponents {
    ...
    public static final class Formats {
        ...
        public static final Unit ISO_DATE_TIME_OFFSET$lambda$5(DateTimeFormatBuilder.WithDateTimeComponents Format) {
            ...
            DateTimeFormatBuilderKt.m10723char(withDateTimeComponents, AbstractJsonLexerKt.COLON);
        ...
        public static final Unit ISO_DATE_TIME_OFFSET$lambda$5$lambda$0(DateTimeFormatBuilder.WithDateTimeComponents alternativeParsing) {
            ...
            DateTimeFormatBuilderKt.m10723char(alternativeParsing, 't');
            return Unit.INSTANCE;
        }
        ...
        public static final Unit RFC_1123$lambda$13(DateTimeFormatBuilder.WithDateTimeComponents Format) {
            ...
            DateTimeFormatBuilderKt.m10723char(withDateTimeComponents, ' ');
        ...
        public static final Unit RFC_1123$lambda$13$lambda$8(DateTimeFormatBuilder.WithDateTimeComponents optional) {
            Intrinsics.checkNotNullParameter(optional, "$this$optional");
            DateTimeFormatBuilderKt.m10723char(optional, AbstractJsonLexerKt.COLON);
    ...
    public final Month getMonth() {
        ...
        if (monthNumber != null) {
            return MonthKt.m10716Month(monthNumber.intValue());
        }
        return null;
    }
    ...
    public final DayOfWeek getDayOfWeek() {
        ...
        if (dayOfWeek != null) {
            return DayOfWeekKt.m10706DayOfWeek(dayOfWeek.intValue());
        }
        return null;
    }
    ...
    public final Instant toInstantUsingOffset(OverloadMarker youShallNotPass) {
        ...
        try {
            Integer year = getYear();
            Intrinsics.checkNotNull(year);
            long safeAdd = MathJvmKt.safeAdd(MathJvmKt.safeMultiply(year.intValue() / 10000, (long) DateCalculationsKt.SECONDS_PER_10000_YEARS), ((copy.toLocalDate().m10712toEpochDays() * 86400) + localTime.toSecondOfDay()) - utcOffset.getTotalSeconds());
