...
public interface UnicodeFormat {
    ...
    public static abstract class Directive implements UnicodeFormat {
        ...
        public static abstract class YearMonthBased extends DateBased {
            ...
            public abstract void mo11544addToFormat(DateTimeFormatBuilder.WithYearMonth withYearMonth);
            ...
            /* renamed from: addToFormat */
            public void mo11541addToFormat(DateTimeFormatBuilder.WithDate builder) {
                Intrinsics.checkNotNullParameter(builder, "builder");
                mo11544addToFormat((DateTimeFormatBuilder.WithYearMonth) builder);
            }
            ...
            public static final class Era extends YearMonthBased {
                ...
                /* renamed from: addToFormat */
                public Void mo11544addToFormat(DateTimeFormatBuilder.WithYearMonth builder) {
                    Intrinsics.checkNotNullParameter(builder, "builder");
        ...
        public static abstract class DateBased extends Directive {
            ...
            /* renamed from: addToFormat */
            public abstract void mo11541addToFormat(DateTimeFormatBuilder.WithDate withDate);
        ...
        public static abstract class TimeBased extends Directive {
            ...
            /* renamed from: addToFormat */
            public abstract void mo11543addToFormat(DateTimeFormatBuilder.WithTime withTime);
            ...
            public static final class AmPmMarker extends TimeBased {
                ...
                /* renamed from: addToFormat */
                public Void mo11543addToFormat(DateTimeFormatBuilder.WithTime builder) {
                    Intrinsics.checkNotNullParameter(builder, "builder");
                    UnicodeKt.localizedDirective$default(this, null, 1, null);
                    throw new KotlinNothingValueException();
                }
        ...
        public static abstract class ZoneBased extends Directive {
            ...
            /* renamed from: addToFormat */
            public abstract void mo11545addToFormat(DateTimeFormatBuilder.WithDateTimeComponents withDateTimeComponents);
            ...
            public static final class TimeZoneId extends ZoneBased {
                ...
                /* renamed from: addToFormat */
                public void mo11545addToFormat(DateTimeFormatBuilder.WithDateTimeComponents builder) {
                    Intrinsics.checkNotNullParameter(builder, "builder");
        ...
        public static abstract class OffsetBased extends Directive {
            ...
            /* renamed from: addToFormat */
            public abstract void mo11542addToFormat(DateTimeFormatBuilder.WithUtcOffset withUtcOffset);
            ...
            public static final class LocalizedZoneOffset extends OffsetBased {
                ...
                /* renamed from: addToFormat */
                public Void mo11542addToFormat(DateTimeFormatBuilder.WithUtcOffset builder) {
                    Intrinsics.checkNotNullParameter(builder, "builder");
                    UnicodeKt.localizedDirective$default(this, null, 1, null);
                    throw new KotlinNothingValueException();
                }
            ...
            public static final class ZoneOffset3 extends OffsetBased {
                ...
                public void mo11542addToFormat(DateTimeFormatBuilder.WithUtcOffset builder) {
                    ...
                    if (formatLength == 1 || formatLength == 2 || formatLength == 3) {
                        ...
                        new LocalizedZoneOffset(4).mo11542addToFormat(builder);
                        throw new KotlinNothingValueException();
                    } else if (formatLength != 5) {
                        UnicodeKt.unknownLength(this);
                        throw new KotlinNothingValueException();
