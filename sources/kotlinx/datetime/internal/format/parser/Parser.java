...
public final class Parser<Output extends Copyable<Output>> {
    ...
    public static final /* synthetic */ Parser m10809boximpl(ParserStructure parserStructure) {
        return new Parser(parserStructure);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: constructor-impl */
    public static <Output extends Copyable<Output>> ParserStructure<Output> m10810constructorimpl(ParserStructure<? super Output> commands) {
        Intrinsics.checkNotNullParameter(commands, "commands");
        return commands;
    }

    /* renamed from: equals-impl */
    public static boolean m10811equalsimpl(ParserStructure<? super Output> parserStructure, Object obj) {
        return (obj instanceof Parser) && Intrinsics.areEqual(parserStructure, ((Parser) obj).m10820unboximpl());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m10812equalsimpl0(ParserStructure<? super Output> parserStructure, ParserStructure<? super Output> parserStructure2) {
        return Intrinsics.areEqual(parserStructure, parserStructure2);
    }

    /* renamed from: hashCode-impl */
    public static int m10813hashCodeimpl(ParserStructure<? super Output> parserStructure) {
        return parserStructure.hashCode();
    }

    /* renamed from: toString-impl */
    public static String m10819toStringimpl(ParserStructure<? super Output> parserStructure) {
        return "Parser(commands=" + parserStructure + ')';
    }

    public boolean equals(Object obj) {
        return m10811equalsimpl(this.commands, obj);
    }

    public int hashCode() {
        return m10813hashCodeimpl(this.commands);
    }

    public String toString() {
        return m10819toStringimpl(this.commands);
    }

    /* renamed from: unbox-impl */
    public final /* synthetic */ ParserStructure m10820unboximpl() {
    ...
    private static final void m10818parseimpl(ParserStructure<? super Output> parserStructure, CharSequence charSequence, int i, Output output, boolean z, Function1<? super ParseError, Unit> function1, Function2<? super Integer, ? super Output, Unit> function2) {
        ...
        while (true) {
            ...
            while (true) {
                if (i2 < size) {
                    Object mo10797consumeFANa98k = ((ParserOperation) parserStructure2.getOperations().get(i2)).mo10797consumeFANa98k(copyable, charSequence, inputPosition);
                    if (mo10797consumeFANa98k instanceof Integer) {
                        inputPosition = ((Number) mo10797consumeFANa98k).intValue();
                        i2++;
                    } else if (mo10797consumeFANa98k instanceof ParseError) {
                        function1.invoke((ParseError) mo10797consumeFANa98k);
                    } else {
                        throw new IllegalStateException(("Unexpected parse result: " + mo10797consumeFANa98k).toString());
                    }
    ...
    public static /* synthetic */ Copyable m10815matchimpl$default(ParserStructure parserStructure, CharSequence charSequence, Copyable copyable, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 0;
        }
        return m10814matchimpl(parserStructure, charSequence, copyable, i);
    }

    /* renamed from: match-impl */
    public static final Output m10814matchimpl(ParserStructure<? super Output> parserStructure, CharSequence input, Output initialContainer, int i) {
        ...
        while (true) {
            ...
            if (parserState != null) {
                ...
                while (true) {
                    if (i2 < size) {
                        Object mo10797consumeFANa98k = ((ParserOperation) parserStructure2.getOperations().get(i2)).mo10797consumeFANa98k(output, input, inputPosition);
                        if (mo10797consumeFANa98k instanceof Integer) {
                            inputPosition = ((Number) mo10797consumeFANa98k).intValue();
                            i2++;
                        } else if (mo10797consumeFANa98k instanceof ParseError) {
                            arrayList.add((ParseError) mo10797consumeFANa98k);
                        } else {
                            throw new IllegalStateException(("Unexpected parse result: " + mo10797consumeFANa98k).toString());
                        }
                    } else if (parserStructure2.getFollowedBy().isEmpty()) {
    ...
    public static /* synthetic */ Copyable m10817matchOrNullimpl$default(ParserStructure parserStructure, CharSequence charSequence, Copyable copyable, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = 0;
        }
        return m10816matchOrNullimpl(parserStructure, charSequence, copyable, i);
    }
    ...
    public static final Output m10816matchOrNullimpl(ParserStructure<? super Output> parserStructure, CharSequence input, Output initialContainer, int i) {
        Intrinsics.checkNotNullParameter(input, "input");
        Intrinsics.checkNotNullParameter(initialContainer, "initialContainer");
        List mutableListOf = CollectionsKt.mutableListOf(new ParserState(initialContainer, parserStructure, i));
        while (true) {
            ...
            while (true) {
                if (i2 < size) {
                    ...
                    if (mo10797consumeFANa98k instanceof Integer) {
                        ...
                        ParseError parseError = (ParseError) mo10797consumeFANa98k;
                    }
                } else if (parserStructure2.getFollowedBy().isEmpty()) {
                    if (inputPosition == input.length()) {
                        return output;
