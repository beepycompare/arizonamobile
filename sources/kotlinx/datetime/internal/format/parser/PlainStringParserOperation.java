...
public final class PlainStringParserOperation<Output> implements ParserOperation<Output> {
    ...
    public Object mo10760consumeFANa98k(Output output, final CharSequence input, final int i) {
        Intrinsics.checkNotNullParameter(input, "input");
        if (this.string.length() + i > input.length()) {
            return ParseResult.Companion.m10770ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.PlainStringParserOperation$$ExternalSyntheticLambda0
        ...
        for (final int i2 = 0; i2 < length; i2++) {
            if (input.charAt(i + i2) != this.string.charAt(i2)) {
                return ParseResult.Companion.m10770ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.PlainStringParserOperation$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
        ...
        return ParseResult.Companion.m10771OkQi1bsqg(i + this.string.length());
    }
