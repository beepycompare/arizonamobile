...
public final class SignParser<Output> implements ParserOperation<Output> {
    ...
    public Object mo10733consumeFANa98k(Output output, CharSequence input, int i) {
        ...
        if (charAt == '-') {
            ...
            return ParseResult.Companion.m10744OkQi1bsqg(i + 1);
        } else if (charAt == '+' && this.withPlusSign) {
            this.isNegativeSetter.invoke(output, false);
            return ParseResult.Companion.m10744OkQi1bsqg(i + 1);
        } else {
            return ParseResult.Companion.m10743ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.SignParser$$ExternalSyntheticLambda0
