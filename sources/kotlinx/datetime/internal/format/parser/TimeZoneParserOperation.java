...
public final class TimeZoneParserOperation<Output> implements ParserOperation<Output> {
    ...
    public Object mo11456consumeFANa98k(Output output, CharSequence input, int i) {
        ...
        if (validateTimeZone > i) {
            ...
            return ParseResult.Companion.m11467OkQi1bsqg(validateTimeZone);
        }
        return ParseResult.Companion.m11466ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.TimeZoneParserOperation$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return TimeZoneParserOperation.consume_FANa98k$lambda$0();
            }
        });
    }
