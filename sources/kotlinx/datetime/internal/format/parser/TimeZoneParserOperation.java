...
public final class TimeZoneParserOperation<Output> implements ParserOperation<Output> {
    ...
    public Object mo11870consumeFANa98k(Output output, CharSequence input, int i) {
        ...
        if (validateTimeZone > i) {
            ...
            return ParseResult.Companion.m11881OkQi1bsqg(validateTimeZone);
        }
        return ParseResult.Companion.m11880ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.TimeZoneParserOperation$$ExternalSyntheticLambda0
