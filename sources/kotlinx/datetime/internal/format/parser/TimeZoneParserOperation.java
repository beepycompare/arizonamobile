...
public final class TimeZoneParserOperation<Output> implements ParserOperation<Output> {
    ...
    public Object mo11551consumeFANa98k(Output output, CharSequence input, int i) {
        ...
        if (validateTimeZone > i) {
            ...
            return ParseResult.Companion.m11562OkQi1bsqg(validateTimeZone);
        }
        return ParseResult.Companion.m11561ErrorRg3Co2E(i, new Function0() { // from class: kotlinx.datetime.internal.format.parser.TimeZoneParserOperation$$ExternalSyntheticLambda0
