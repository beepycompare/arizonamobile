        ...
        if (bool.booleanValue()) {
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
                            return new KmAnnotationArgument.ULongValue(ULong.m8680constructorimpl(value.getIntValue()), null);
                        }
                        throw new IllegalStateException(("Cannot read value of unsigned type: " + value.getType()).toString());
                    }
                    return new KmAnnotationArgument.UIntValue(UInt.m8601constructorimpl((int) value.getIntValue()), null);
                }
                return new KmAnnotationArgument.UShortValue(UShort.m8787constructorimpl((short) value.getIntValue()), null);
            }
            return new KmAnnotationArgument.UByteValue(UByte.m8518constructorimpl((byte) value.getIntValue()), null);
        }
