        ...
        if (bool.booleanValue()) {
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
                            return new KmAnnotationArgument.ULongValue(ULong.m10081constructorimpl(value.getIntValue()), null);
                        }
                        throw new IllegalStateException(("Cannot read value of unsigned type: " + value.getType()).toString());
                    }
                    return new KmAnnotationArgument.UIntValue(UInt.m10002constructorimpl((int) value.getIntValue()), null);
                }
                return new KmAnnotationArgument.UShortValue(UShort.m10188constructorimpl((short) value.getIntValue()), null);
            }
            return new KmAnnotationArgument.UByteValue(UByte.m9920constructorimpl((byte) value.getIntValue()), null);
        }
