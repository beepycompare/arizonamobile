...
public class UnmodifiableLazyStringList extends AbstractList<String> implements LazyStringList, RandomAccess {
    ...
    public ListIterator<String> listIterator(int i) {
        return new ListIterator<String>(i) { // from class: kotlinx.metadata.internal.protobuf.UnmodifiableLazyStringList.1
    ...
    public Iterator<String> iterator() {
        return new Iterator<String>() { // from class: kotlinx.metadata.internal.protobuf.UnmodifiableLazyStringList.2
