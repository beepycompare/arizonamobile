...
public final class ClassMapperLite {
    ...
    private static final String f1434kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        linkedHashMap.put(f1434kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) strArr3)) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f1434kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f1434kotlin + '/' + str, "L" + str2 + ';');
    }
