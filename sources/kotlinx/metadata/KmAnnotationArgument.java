...
public abstract class KmAnnotationArgument {
    ...
    public static final class UByteValue extends LiteralValue<UByte> {
        ...
        public static /* synthetic */ UByteValue m10158copy7apg3OU$default(UByteValue uByteValue, byte b, int i, Object obj) {
            if ((i & 1) != 0) {
                b = uByteValue.value;
            }
            return uByteValue.m10160copy7apg3OU(b);
        }

        /* renamed from: component1-w2LRezQ  reason: not valid java name */
        public final byte m10159component1w2LRezQ() {
            return this.value;
        }

        /* renamed from: copy-7apg3OU  reason: not valid java name */
        public final UByteValue m10160copy7apg3OU(byte b) {
        ...
        public int hashCode() {
            return UByte.m8508hashCodeimpl(this.value);
        }
        ...
        public /* bridge */ /* synthetic */ UByte getValue() {
            return UByte.m8490boximpl(m10161getValuew2LRezQ());
        }

        /* renamed from: getValue-w2LRezQ  reason: not valid java name */
        public byte m10161getValuew2LRezQ() {
            return this.value;
        }
    }
    ...
    public static final class UShortValue extends LiteralValue<UShort> {
        ...
        public static /* synthetic */ UShortValue m10170copyxj2QHRw$default(UShortValue uShortValue, short s, int i, Object obj) {
            if ((i & 1) != 0) {
                s = uShortValue.value;
            }
            return uShortValue.m10172copyxj2QHRw(s);
        }

        /* renamed from: component1-Mh2AYeg  reason: not valid java name */
        public final short m10171component1Mh2AYeg() {
            return this.value;
        }

        /* renamed from: copy-xj2QHRw  reason: not valid java name */
        public final UShortValue m10172copyxj2QHRw(short s) {
        ...
        public int hashCode() {
            return UShort.m8776hashCodeimpl(this.value);
        }
        ...
        public /* bridge */ /* synthetic */ UShort getValue() {
            return UShort.m8758boximpl(m10173getValueMh2AYeg());
        }

        /* renamed from: getValue-Mh2AYeg  reason: not valid java name */
        public short m10173getValueMh2AYeg() {
            return this.value;
        }
    }
    ...
    public static final class UIntValue extends LiteralValue<UInt> {
        ...
        public static /* synthetic */ UIntValue m10162copyWZ4Q5Ns$default(UIntValue uIntValue, int i, int i2, Object obj) {
            if ((i2 & 1) != 0) {
                i = uIntValue.value;
            }
            return uIntValue.m10164copyWZ4Q5Ns(i);
        }

        /* renamed from: component1-pVg5ArA  reason: not valid java name */
        public final int m10163component1pVg5ArA() {
            return this.value;
        }

        /* renamed from: copy-WZ4Q5Ns  reason: not valid java name */
        public final UIntValue m10164copyWZ4Q5Ns(int i) {
        ...
        public int hashCode() {
            return UInt.m8590hashCodeimpl(this.value);
        }
        ...
        public /* bridge */ /* synthetic */ UInt getValue() {
            return UInt.m8572boximpl(m10165getValuepVg5ArA());
        }

        /* renamed from: getValue-pVg5ArA  reason: not valid java name */
        public int m10165getValuepVg5ArA() {
            return this.value;
        }
    }
    ...
    public static final class ULongValue extends LiteralValue<ULong> {
        ...
        public static /* synthetic */ ULongValue m10166copyVKZWuLQ$default(ULongValue uLongValue, long j, int i, Object obj) {
            if ((i & 1) != 0) {
                j = uLongValue.value;
            }
            return uLongValue.m10168copyVKZWuLQ(j);
        }

        /* renamed from: component1-s-VKNKU  reason: not valid java name */
        public final long m10167component1sVKNKU() {
            return this.value;
        }

        /* renamed from: copy-VKZWuLQ  reason: not valid java name */
        public final ULongValue m10168copyVKZWuLQ(long j) {
        ...
        public int hashCode() {
            return ULong.m8669hashCodeimpl(this.value);
        }
        ...
        public /* bridge */ /* synthetic */ ULong getValue() {
            return ULong.m8651boximpl(m10169getValuesVKNKU());
        }

        /* renamed from: getValue-s-VKNKU  reason: not valid java name */
        public long m10169getValuesVKNKU() {
            return this.value;
        }
    }
