...
final class ClassValueCache<T> implements SerializerCache<T> {
    ...
    public KSerializer<T> get(final KClass<Object> key) {
        ...
        if (t == null) {
            t = (T) mutableSoftReference.getOrSetWithLock((Function0) ((Function0<T>) new Function0<T>() { // from class: kotlinx.serialization.internal.ClassValueCache$get$$inlined$getOrSet$1
