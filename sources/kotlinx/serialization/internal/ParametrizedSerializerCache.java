...
public interface ParametrizedSerializerCache<T> {
    ...
    Object mo10786getgIAlus(KClass<Object> kClass, List<? extends KType> list);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object m10793getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    list = CollectionsKt.emptyList();
                }
                return parametrizedSerializerCache.mo10786getgIAlus(kClass, list);
            }
