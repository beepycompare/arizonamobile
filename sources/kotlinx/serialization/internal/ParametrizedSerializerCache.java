...
public interface ParametrizedSerializerCache<T> {
    ...
    Object mo11609getgIAlus(KClass<Object> kClass, List<? extends KType> list);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object m11616getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    list = CollectionsKt.emptyList();
                }
                return parametrizedSerializerCache.mo11609getgIAlus(kClass, list);
            }
