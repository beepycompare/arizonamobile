...
public final class UShortArraySerializer extends PrimitiveArraySerializer<UShort, UShortArray, UShortArrayBuilder> implements KSerializer<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m10238collectionSizerL5Bavg(((UShortArray) obj).m8854unboximpl());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ UShortArray empty() {
        return UShortArray.m8838boximpl(m10239emptyamswpOA());
    }

    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m10240toBuilderrL5Bavg(((UShortArray) obj).m8854unboximpl());
    }

    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, UShortArray uShortArray, int i) {
        m10241writeContenteny0XGE(compositeEncoder, uShortArray.m8854unboximpl(), i);
    }
    ...
    protected int m10238collectionSizerL5Bavg(short[] collectionSize) {
        Intrinsics.checkNotNullParameter(collectionSize, "$this$collectionSize");
        return UShortArray.m8846getSizeimpl(collectionSize);
    }

    /* renamed from: toBuilder-rL5Bavg  reason: not valid java name */
    protected UShortArrayBuilder m10240toBuilderrL5Bavg(short[] toBuilder) {
        Intrinsics.checkNotNullParameter(toBuilder, "$this$toBuilder");
        return new UShortArrayBuilder(toBuilder, null);
    }

    /* renamed from: empty-amswpOA  reason: not valid java name */
    protected short[] m10239emptyamswpOA() {
        return UShortArray.m8839constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder decoder, int i, UShortArrayBuilder builder, boolean z) {
        ...
        builder.m10236appendxj2QHRw$kotlinx_serialization_core(UShort.m8787constructorimpl(decoder.decodeInlineElement(getDescriptor(), i).decodeShort()));
    }

    /* renamed from: writeContent-eny0XGE  reason: not valid java name */
    protected void m10241writeContenteny0XGE(CompositeEncoder encoder, short[] content, int i) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(content, "content");
        for (int i2 = 0; i2 < i; i2++) {
            encoder.encodeInlineElement(getDescriptor(), i2).encodeShort(UShortArray.m8845getMh2AYeg(content, i2));
        }
    }
}
