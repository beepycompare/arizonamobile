    ...
    private final Triple<A, B, C> decodeStructure(CompositeDecoder compositeDecoder) {
        ...
        while (true) {
            ...
            if (decodeElementIndex == 0) {
                ...
                obj = CompositeDecoder.decodeSerializableElement$default(compositeDecoder2, getDescriptor(), 0, this.aSerializer, null, 8, null);
            } else if (decodeElementIndex == 1) {
                compositeDecoder2 = compositeDecoder;
                obj2 = CompositeDecoder.decodeSerializableElement$default(compositeDecoder2, getDescriptor(), 1, this.bSerializer, null, 8, null);
