...
public final class UByteSerializer implements KSerializer<UByte> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UByte.m10255boximpl(m11975deserializeWa3L5BU(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m11976serializeEK6454(encoder, ((UByte) obj).m10311unboximpl());
    }
    ...
    public void m11976serializeEK6454(Encoder encoder, byte b) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeByte(b);
    }

    /* renamed from: deserialize-Wa3L5BU  reason: not valid java name */
    public byte m11975deserializeWa3L5BU(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UByte.m10261constructorimpl(decoder.decodeInline(getDescriptor()).decodeByte());
    }
}
