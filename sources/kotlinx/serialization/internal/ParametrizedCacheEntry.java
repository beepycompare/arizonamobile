...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m11504computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            ...
            obj = Result.m9842boximpl(m9843constructorimpl);
