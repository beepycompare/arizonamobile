...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m11601computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m9919constructorimpl = Result.m9919constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m9919constructorimpl = Result.m9919constructorimpl(ResultKt.createFailure(th));
            }
            obj = Result.m9918boximpl(m9919constructorimpl);
