...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m11602computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                m9920constructorimpl = Result.m9920constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m9920constructorimpl = Result.m9920constructorimpl(ResultKt.createFailure(th));
            }
            obj = Result.m9919boximpl(m9920constructorimpl);
