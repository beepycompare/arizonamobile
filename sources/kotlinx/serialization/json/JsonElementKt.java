...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m11639JsonPrimitive7apg3OU(byte b) {
        return m11640JsonPrimitiveVKZWuLQ(ULong.m10101constructorimpl(b & 255));
    }

    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m11642JsonPrimitivexj2QHRw(short s) {
        return m11640JsonPrimitiveVKZWuLQ(ULong.m10101constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m11641JsonPrimitiveWZ4Q5Ns(int i) {
        return m11640JsonPrimitiveVKZWuLQ(ULong.m10101constructorimpl(i & 4294967295L));
    }

    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m11640JsonPrimitiveVKZWuLQ(long j) {
        String m;
