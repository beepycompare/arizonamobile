...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m11948JsonPrimitive7apg3OU(byte b) {
        return m11949JsonPrimitiveVKZWuLQ(ULong.m10378constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m11951JsonPrimitivexj2QHRw(short s) {
        return m11949JsonPrimitiveVKZWuLQ(ULong.m10378constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m11950JsonPrimitiveWZ4Q5Ns(int i) {
        return m11949JsonPrimitiveVKZWuLQ(ULong.m10378constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m11949JsonPrimitiveVKZWuLQ(long j) {
        String m;
