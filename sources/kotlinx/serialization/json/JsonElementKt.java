...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m10809JsonPrimitive7apg3OU(byte b) {
        return m10810JsonPrimitiveVKZWuLQ(ULong.m9244constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m10812JsonPrimitivexj2QHRw(short s) {
        return m10810JsonPrimitiveVKZWuLQ(ULong.m9244constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m10811JsonPrimitiveWZ4Q5Ns(int i) {
        return m10810JsonPrimitiveVKZWuLQ(ULong.m9244constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m10810JsonPrimitiveVKZWuLQ(long j) {
        String m;
