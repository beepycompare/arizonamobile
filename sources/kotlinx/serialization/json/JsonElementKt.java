...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m11653JsonPrimitive7apg3OU(byte b) {
        return m11654JsonPrimitiveVKZWuLQ(ULong.m10083constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m11656JsonPrimitivexj2QHRw(short s) {
        return m11654JsonPrimitiveVKZWuLQ(ULong.m10083constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m11655JsonPrimitiveWZ4Q5Ns(int i) {
        return m11654JsonPrimitiveVKZWuLQ(ULong.m10083constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m11654JsonPrimitiveVKZWuLQ(long j) {
        String m;
