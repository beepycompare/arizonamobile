...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m12002JsonPrimitive7apg3OU(byte b) {
        return m12003JsonPrimitiveVKZWuLQ(ULong.m10422constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m12005JsonPrimitivexj2QHRw(short s) {
        return m12003JsonPrimitiveVKZWuLQ(ULong.m10422constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m12004JsonPrimitiveWZ4Q5Ns(int i) {
        return m12003JsonPrimitiveVKZWuLQ(ULong.m10422constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m12003JsonPrimitiveVKZWuLQ(long j) {
        String m;
