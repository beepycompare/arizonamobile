...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m11964JsonPrimitive7apg3OU(byte b) {
        return m11965JsonPrimitiveVKZWuLQ(ULong.m10394constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m11967JsonPrimitivexj2QHRw(short s) {
        return m11965JsonPrimitiveVKZWuLQ(ULong.m10394constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m11966JsonPrimitiveWZ4Q5Ns(int i) {
        return m11965JsonPrimitiveVKZWuLQ(ULong.m10394constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m11965JsonPrimitiveVKZWuLQ(long j) {
        String m;
