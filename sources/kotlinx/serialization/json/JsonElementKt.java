...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m10899JsonPrimitive7apg3OU(byte b) {
        return m10900JsonPrimitiveVKZWuLQ(ULong.m9381constructorimpl(b & 255));
    }

    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m10902JsonPrimitivexj2QHRw(short s) {
        return m10900JsonPrimitiveVKZWuLQ(ULong.m9381constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m10901JsonPrimitiveWZ4Q5Ns(int i) {
        return m10900JsonPrimitiveVKZWuLQ(ULong.m9381constructorimpl(i & 4294967295L));
    }

    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m10900JsonPrimitiveVKZWuLQ(long j) {
        String m;
