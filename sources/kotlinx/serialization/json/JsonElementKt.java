...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m11651JsonPrimitive7apg3OU(byte b) {
        return m11652JsonPrimitiveVKZWuLQ(ULong.m10081constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m11654JsonPrimitivexj2QHRw(short s) {
        return m11652JsonPrimitiveVKZWuLQ(ULong.m10081constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m11653JsonPrimitiveWZ4Q5Ns(int i) {
        return m11652JsonPrimitiveVKZWuLQ(ULong.m10081constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m11652JsonPrimitiveVKZWuLQ(long j) {
        String m;
