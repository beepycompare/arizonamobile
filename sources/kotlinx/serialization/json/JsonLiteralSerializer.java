...
public final class JsonLiteralSerializer implements KSerializer<JsonLiteral> {
    ...
    public void serialize(Encoder encoder, JsonLiteral value) {
        ...
        if (value.isString()) {
            ...
            if (uLongOrNull != null) {
                encoder.encodeInline(BuiltinSerializersKt.serializer(ULong.Companion).getDescriptor()).encodeLong(uLongOrNull.m10074unboximpl());
                return;
            }
    ...
    public JsonLiteral deserialize(Decoder decoder) {
        ...
        String str = "Unexpected JSON element, expected JsonLiteral, had " + Reflection.getOrCreateKotlinClass(decodeJsonElement.getClass());
        String obj = asJsonDecoder.getJson().getConfiguration().getExceptionsWithDebugInfo() ? JsonExceptionsKt.minify$default(decodeJsonElement.toString(), 0, 1, null).toString() : null;
        throw new JsonDecodingException(JsonExceptionsKt.formatDecodingException(-1, str, null, null, obj), str, -1, null, obj, null);
    }
}
