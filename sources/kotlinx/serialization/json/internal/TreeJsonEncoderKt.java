...
public final class TreeJsonEncoderKt {
    ...
    public static final /* synthetic */ <T extends JsonElement> T cast(JsonDecoder jsonDecoder, JsonElement value, String serialName, Function0<String> path) {
        ...
        String obj = jsonDecoder.getJson().getConfiguration().getExceptionsWithDebugInfo() ? JsonExceptionsKt.minify$default(value.toString(), 0, 1, null).toString() : null;
        throw new JsonDecodingException(JsonExceptionsKt.formatDecodingException(-1, sb2, invoke, null, obj), sb2, -1, invoke, obj, null);
    }
}
