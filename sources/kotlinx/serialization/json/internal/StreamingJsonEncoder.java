    ...
    */
    ...
    public void encodeFloat(float f) {
        ...
        if (!this.configuration.getAllowSpecialFloatingPointValues() && Math.abs(f) > Float.MAX_VALUE) {
            throw JsonExceptionsKt.InvalidFloatingPointEncoded$default(Float.valueOf(f), null, 2, null);
        }
    }
    ...
    public void encodeDouble(double d) {
        ...
        if (!this.configuration.getAllowSpecialFloatingPointValues() && Math.abs(d) > Double.MAX_VALUE) {
            throw JsonExceptionsKt.InvalidFloatingPointEncoded$default(Double.valueOf(d), null, 2, null);
        }
    }
