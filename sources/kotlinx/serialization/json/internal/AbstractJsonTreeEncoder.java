...
public abstract class AbstractJsonTreeEncoder extends NamedValueEncoder implements JsonEncoder {
    ...
    public void encodeTaggedFloat(String tag, float f) {
        ...
        if (!this.configuration.getAllowSpecialFloatingPointValues() && Math.abs(f) > Float.MAX_VALUE) {
            throw JsonExceptionsKt.InvalidFloatingPointEncoded(Float.valueOf(f), tag);
        }
    }
    ...
    */
    public <T> void encodeSerializableValue(SerializationStrategy<? super T> serializer, T t) {
        ...
        if (z) {
            ...
            serializationStrategy = PolymorphicSerializerKt.findPolymorphicSerializer(abstractPolymorphicSerializer, abstractJsonTreeEncoder, t);
        ...
        if (classDiscriminator != null) {
            PolymorphicKt.checkEncodingConflicts(abstractJsonTreeEncoder.getJson(), serializer, serializationStrategy, classDiscriminator);
        ...
        serializationStrategy.serialize(abstractJsonTreeEncoder, t);
    }
    ...
    public void encodeTaggedDouble(String tag, double d) {
        ...
        if (!this.configuration.getAllowSpecialFloatingPointValues() && Math.abs(d) > Double.MAX_VALUE) {
            throw JsonExceptionsKt.InvalidFloatingPointEncoded(Double.valueOf(d), tag);
        }
    }
    ...
    private final AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1 inlineUnsignedNumberEncoder(final String str) {
        return new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder$inlineUnsignedNumberEncoder$1
            ...
            public void encodeInt(int i) {
                String m9985m;
                m9985m = UByte$$ExternalSyntheticBackport0.m9985m(UInt.m10016constructorimpl(i), 10);
                putUnquotedString(m9985m);
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long j) {
                String m;
                m = UByte$$ExternalSyntheticBackport0.m(ULong.m10095constructorimpl(j), 10);
                putUnquotedString(m);
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte b) {
                putUnquotedString(UByte.m9977toStringimpl(UByte.m9933constructorimpl(b)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short s) {
                putUnquotedString(UShort.m10246toStringimpl(UShort.m10202constructorimpl(s)));
            }
        };
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        Function1<JsonElement, Unit> function1 = getCurrentTagOrNull() == null ? this.nodeConsumer : new Function1() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return AbstractJsonTreeEncoder.beginStructure$lambda$0(AbstractJsonTreeEncoder.this, (JsonElement) obj);
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static final Unit beginStructure$lambda$0(AbstractJsonTreeEncoder abstractJsonTreeEncoder, JsonElement node) {
