...
public final class PersistentOrderedMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public PersistentMap<K, V> build() {
        ...
        if (persistentOrderedMap != null) {
            CommonFunctionsKt.m11417assert(this.hashMapBuilder.getBuiltMap$kotlinx_collections_immutable() != null);
            CommonFunctionsKt.m11417assert(this.firstKey == persistentOrderedMap.getFirstKey$kotlinx_collections_immutable());
            CommonFunctionsKt.m11417assert(this.lastKey == persistentOrderedMap.getLastKey$kotlinx_collections_immutable());
    ...
    public V put(K k, V v) {
        ...
        if (isEmpty()) {
            ...
            CommonFunctionsKt.m11417assert(!linkedValue3.getHasNext());
