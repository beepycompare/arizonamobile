...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        if (persistentOrderedSet != null) {
            ...
            CommonFunctionsKt.m11754assert(this.firstElement == persistentOrderedSet.getFirstElement$kotlinx_collections_immutable());
            CommonFunctionsKt.m11754assert(this.lastElement == persistentOrderedSet.getLastElement$kotlinx_collections_immutable());
