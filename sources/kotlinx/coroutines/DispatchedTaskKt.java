...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, boolean z) {
        ...
        Object m10216constructorimpl = Result.m10216constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(m10216constructorimpl);
        ...
        continuation.resumeWith(m10216constructorimpl);
    }
    ...
    public static final void resumeWithStackTrace(Continuation<?> continuation, Throwable th) {
        ...
        continuation.resumeWith(Result.m10216constructorimpl(ResultKt.createFailure(th)));
    }
}
