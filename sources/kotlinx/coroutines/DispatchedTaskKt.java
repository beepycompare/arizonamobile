...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, boolean z) {
        ...
        Object m9843constructorimpl = Result.m9843constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(m9843constructorimpl);
        ...
        continuation.resumeWith(m9843constructorimpl);
    }
