...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, boolean z) {
        ...
        Object m9091constructorimpl = Result.m9091constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(m9091constructorimpl);
        ...
        continuation.resumeWith(m9091constructorimpl);
    }
    ...
    public static final void resumeWithStackTrace(Continuation<?> continuation, Throwable th) {
        ...
        continuation.resumeWith(Result.m9091constructorimpl(ResultKt.createFailure(th)));
    }
}
