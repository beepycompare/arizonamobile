...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo10721receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo10721receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo10722tryReceivePtdJZtk() {
        return this._channel.mo10722tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo8396trySendJP2dKIU(E e) {
        return this._channel.mo8396trySendJP2dKIU(e);
    }
