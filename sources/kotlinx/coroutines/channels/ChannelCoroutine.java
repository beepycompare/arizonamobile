...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo11529invokeOnClose(Function1<? super Throwable, Unit> function1) {
        this._channel.mo11529invokeOnClose(function1);
    }
    ...
    public Object mo11462receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo11462receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo11463tryReceivePtdJZtk() {
        return this._channel.mo11463tryReceivePtdJZtk();
    }
