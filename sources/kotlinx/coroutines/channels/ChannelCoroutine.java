...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo11799invokeOnClose(Function1<? super Throwable, Unit> function1) {
        this._channel.mo11799invokeOnClose(function1);
    }
    ...
    public Object mo11722receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo11722receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo11723tryReceivePtdJZtk() {
        return this._channel.mo11723tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo9143trySendJP2dKIU(E e) {
        return this._channel.mo9143trySendJP2dKIU(e);
    }
