            ...
            if (continuation instanceof ProduceKt$awaitClose$1) {
                ...
                if ((produceKt$awaitClose$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        producerScope.mo11504invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.channels.ProduceKt$awaitClose$4$1
                        ...
                        int i2 = produceKt$awaitClose$1.I$0;
