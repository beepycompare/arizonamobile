...
public final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo9005trySendJP2dKIU = sendChannel.mo9005trySendJP2dKIU(e);
        if (mo9005trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlockingK$default).m11381unboximpl();
        }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) {
        if (ChannelResult.m11379isSuccessimpl(sendChannel.mo9005trySendJP2dKIU(obj))) {
            return;
        }
