...
public interface ReceiveChannel<E> {
    ...
    Object mo11424receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo11425tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo11425tryReceivePtdJZtk = receiveChannel.mo11425tryReceivePtdJZtk();
            if (ChannelResult.m11442isSuccessimpl(mo11425tryReceivePtdJZtk)) {
                return (E) ChannelResult.m11438getOrThrowimpl(mo11425tryReceivePtdJZtk);
            }
            Throwable m11436exceptionOrNullimpl = ChannelResult.m11436exceptionOrNullimpl(mo11425tryReceivePtdJZtk);
            if (m11436exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m11436exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo11424receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo11424receiveCatchingJP2dKIU = receiveChannel.mo11424receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo11424receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo11424receiveCatchingJP2dKIU = ((ChannelResult) obj).m11444unboximpl();
                    }
                    return ChannelResult.m11437getOrNullimpl(mo11424receiveCatchingJP2dKIU);
                }
            }
