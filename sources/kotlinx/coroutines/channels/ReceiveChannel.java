...
public interface ReceiveChannel<E> {
    ...
    Object mo10721receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo10722tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo10722tryReceivePtdJZtk = receiveChannel.mo10722tryReceivePtdJZtk();
            if (ChannelResult.m10739isSuccessimpl(mo10722tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10735getOrThrowimpl(mo10722tryReceivePtdJZtk);
            }
            Throwable m10733exceptionOrNullimpl = ChannelResult.m10733exceptionOrNullimpl(mo10722tryReceivePtdJZtk);
            if (m10733exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m10733exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo10721receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo10721receiveCatchingJP2dKIU = receiveChannel.mo10721receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo10721receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo10721receiveCatchingJP2dKIU = ((ChannelResult) obj).m10741unboximpl();
                    }
                    return ChannelResult.m10734getOrNullimpl(mo10721receiveCatchingJP2dKIU);
                }
            }
