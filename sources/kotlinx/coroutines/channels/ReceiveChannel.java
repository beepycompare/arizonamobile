...
public interface ReceiveChannel<E> {
    ...
    Object mo11457receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo11458tryReceivePtdJZtk();
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    default E poll() {
        Object mo11458tryReceivePtdJZtk = mo11458tryReceivePtdJZtk();
        if (ChannelResult.m11474isSuccessimpl(mo11458tryReceivePtdJZtk)) {
            return (E) ChannelResult.m11470getOrThrowimpl(mo11458tryReceivePtdJZtk);
        }
        Throwable m11468exceptionOrNullimpl = ChannelResult.m11468exceptionOrNullimpl(mo11458tryReceivePtdJZtk);
        if (m11468exceptionOrNullimpl == null) {
            return null;
        }
        throw StackTraceRecoveryKt.recoverStackTrace(m11468exceptionOrNullimpl);
    }
    ...
    */
    static /* synthetic */ <E> Object receiveOrNull$suspendImpl(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
        ...
        int i;
        Object mo11457receiveCatchingJP2dKIU;
        if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
            ...
            if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    mo11457receiveCatchingJP2dKIU = receiveChannel.mo11457receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    if (mo11457receiveCatchingJP2dKIU == coroutine_suspended) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    mo11457receiveCatchingJP2dKIU = ((ChannelResult) obj).m11476unboximpl();
                }
                return ChannelResult.m11469getOrNullimpl(mo11457receiveCatchingJP2dKIU);
            }
        }
