...
public interface ReceiveChannel<E> {
    ...
    Object mo10614receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo10615tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo10615tryReceivePtdJZtk = receiveChannel.mo10615tryReceivePtdJZtk();
            if (ChannelResult.m10632isSuccessimpl(mo10615tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10628getOrThrowimpl(mo10615tryReceivePtdJZtk);
            }
            Throwable m10626exceptionOrNullimpl = ChannelResult.m10626exceptionOrNullimpl(mo10615tryReceivePtdJZtk);
            if (m10626exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m10626exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo10614receiveCatchingJP2dKIU = receiveChannel.mo10614receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo10614receiveCatchingJP2dKIU == coroutine_suspended) {
                    ...
                    return ChannelResult.m10627getOrNullimpl(mo10614receiveCatchingJP2dKIU);
                }
            }
