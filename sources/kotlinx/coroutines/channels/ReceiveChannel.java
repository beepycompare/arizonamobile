...
public interface ReceiveChannel<E> {
    ...
    Object mo11437receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo11438tryReceivePtdJZtk();
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    default E poll() {
        Object mo11438tryReceivePtdJZtk = mo11438tryReceivePtdJZtk();
        if (ChannelResult.m11454isSuccessimpl(mo11438tryReceivePtdJZtk)) {
            return (E) ChannelResult.m11450getOrThrowimpl(mo11438tryReceivePtdJZtk);
        }
        Throwable m11448exceptionOrNullimpl = ChannelResult.m11448exceptionOrNullimpl(mo11438tryReceivePtdJZtk);
    ...
    */
    static /* synthetic */ <E> Object receiveOrNull$suspendImpl(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
        ...
        int i;
        Object mo11437receiveCatchingJP2dKIU;
        if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
            ...
            if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    mo11437receiveCatchingJP2dKIU = receiveChannel.mo11437receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    if (mo11437receiveCatchingJP2dKIU == coroutine_suspended) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    mo11437receiveCatchingJP2dKIU = ((ChannelResult) obj).m11456unboximpl();
                }
                return ChannelResult.m11449getOrNullimpl(mo11437receiveCatchingJP2dKIU);
            }
        }
