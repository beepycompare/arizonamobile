...
public interface ReceiveChannel<E> {
    ...
    Object mo10602receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo10603tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo10603tryReceivePtdJZtk = receiveChannel.mo10603tryReceivePtdJZtk();
            if (ChannelResult.m10620isSuccessimpl(mo10603tryReceivePtdJZtk)) {
                return (E) ChannelResult.m10616getOrThrowimpl(mo10603tryReceivePtdJZtk);
            }
            Throwable m10614exceptionOrNullimpl = ChannelResult.m10614exceptionOrNullimpl(mo10603tryReceivePtdJZtk);
            if (m10614exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m10614exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo10602receiveCatchingJP2dKIU = receiveChannel.mo10602receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo10602receiveCatchingJP2dKIU == coroutine_suspended) {
                    ...
                    return ChannelResult.m10615getOrNullimpl(mo10602receiveCatchingJP2dKIU);
                }
            }
