...
public interface ReceiveChannel<E> {
    ...
    Object mo11427receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo11428tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo11428tryReceivePtdJZtk = receiveChannel.mo11428tryReceivePtdJZtk();
            if (ChannelResult.m11445isSuccessimpl(mo11428tryReceivePtdJZtk)) {
                return (E) ChannelResult.m11441getOrThrowimpl(mo11428tryReceivePtdJZtk);
            }
            Throwable m11439exceptionOrNullimpl = ChannelResult.m11439exceptionOrNullimpl(mo11428tryReceivePtdJZtk);
            if (m11439exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m11439exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo11427receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo11427receiveCatchingJP2dKIU = receiveChannel.mo11427receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo11427receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo11427receiveCatchingJP2dKIU = ((ChannelResult) obj).m11447unboximpl();
                    }
                    return ChannelResult.m11440getOrNullimpl(mo11427receiveCatchingJP2dKIU);
                }
            }
