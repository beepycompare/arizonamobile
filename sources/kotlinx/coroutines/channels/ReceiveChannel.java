...
public interface ReceiveChannel<E> {
    ...
    Object mo11776receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo11777tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo11777tryReceivePtdJZtk = receiveChannel.mo11777tryReceivePtdJZtk();
            if (ChannelResult.m11794isSuccessimpl(mo11777tryReceivePtdJZtk)) {
                return (E) ChannelResult.m11790getOrThrowimpl(mo11777tryReceivePtdJZtk);
            }
            Throwable m11788exceptionOrNullimpl = ChannelResult.m11788exceptionOrNullimpl(mo11777tryReceivePtdJZtk);
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo11776receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo11776receiveCatchingJP2dKIU = receiveChannel.mo11776receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo11776receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo11776receiveCatchingJP2dKIU = ((ChannelResult) obj).m11796unboximpl();
                    }
                    return ChannelResult.m11789getOrNullimpl(mo11776receiveCatchingJP2dKIU);
                }
            }
