...
public interface ReceiveChannel<E> {
    ...
    Object mo11425receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo11426tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo11426tryReceivePtdJZtk = receiveChannel.mo11426tryReceivePtdJZtk();
            if (ChannelResult.m11443isSuccessimpl(mo11426tryReceivePtdJZtk)) {
                return (E) ChannelResult.m11439getOrThrowimpl(mo11426tryReceivePtdJZtk);
            }
            Throwable m11437exceptionOrNullimpl = ChannelResult.m11437exceptionOrNullimpl(mo11426tryReceivePtdJZtk);
            if (m11437exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m11437exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo11425receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo11425receiveCatchingJP2dKIU = receiveChannel.mo11425receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo11425receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo11425receiveCatchingJP2dKIU = ((ChannelResult) obj).m11445unboximpl();
                    }
                    return ChannelResult.m11438getOrNullimpl(mo11425receiveCatchingJP2dKIU);
                }
            }
