...
public interface ReceiveChannel<E> {
    ...
    Object mo11362receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    default Object receiveOrNull(Continuation<? super E> continuation) {
        return receiveOrNull$suspendImpl(this, continuation);
    }

    /* renamed from: tryReceive-PtdJZtk */
    Object mo11363tryReceivePtdJZtk();
    ...
    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* synthetic */ default void cancel() {
        cancel((CancellationException) null);
    }

    static /* synthetic */ boolean cancel$default(ReceiveChannel receiveChannel, Throwable th, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                th = null;
            }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    default E poll() {
        Object mo11363tryReceivePtdJZtk = mo11363tryReceivePtdJZtk();
        if (ChannelResult.m11379isSuccessimpl(mo11363tryReceivePtdJZtk)) {
            return (E) ChannelResult.m11375getOrThrowimpl(mo11363tryReceivePtdJZtk);
        }
        Throwable m11373exceptionOrNullimpl = ChannelResult.m11373exceptionOrNullimpl(mo11363tryReceivePtdJZtk);
        if (m11373exceptionOrNullimpl == null) {
            return null;
        }
        throw StackTraceRecoveryKt.recoverStackTrace(m11373exceptionOrNullimpl);
    }
    ...
    */
    static /* synthetic */ <E> Object receiveOrNull$suspendImpl(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
        ReceiveChannel$receiveOrNull$1 receiveChannel$receiveOrNull$1;
        int i;
        Object mo11362receiveCatchingJP2dKIU;
        if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
            ...
            if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    receiveChannel$receiveOrNull$1.L$0 = SpillingKt.nullOutSpilledVariable(receiveChannel);
                    receiveChannel$receiveOrNull$1.label = 1;
                    mo11362receiveCatchingJP2dKIU = receiveChannel.mo11362receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    if (mo11362receiveCatchingJP2dKIU == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                } else {
                    ReceiveChannel receiveChannel2 = (ReceiveChannel) receiveChannel$receiveOrNull$1.L$0;
                    ResultKt.throwOnFailure(obj);
                    mo11362receiveCatchingJP2dKIU = ((ChannelResult) obj).m11381unboximpl();
                }
                return ChannelResult.m11374getOrNullimpl(mo11362receiveCatchingJP2dKIU);
            }
        }
        receiveChannel$receiveOrNull$1 = new ReceiveChannel$receiveOrNull$1(receiveChannel, continuation);
    ...
    default SelectClause1<E> getOnReceiveOrNull() {
