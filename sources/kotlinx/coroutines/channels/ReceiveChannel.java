...
public interface ReceiveChannel<E> {
    ...
    Object mo11363receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo11364tryReceivePtdJZtk();
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    default E poll() {
        Object mo11364tryReceivePtdJZtk = mo11364tryReceivePtdJZtk();
        if (ChannelResult.m11380isSuccessimpl(mo11364tryReceivePtdJZtk)) {
            return (E) ChannelResult.m11376getOrThrowimpl(mo11364tryReceivePtdJZtk);
        }
        Throwable m11374exceptionOrNullimpl = ChannelResult.m11374exceptionOrNullimpl(mo11364tryReceivePtdJZtk);
    ...
    */
    static /* synthetic */ <E> Object receiveOrNull$suspendImpl(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
        ...
        int i;
        Object mo11363receiveCatchingJP2dKIU;
        if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
            ...
            if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    mo11363receiveCatchingJP2dKIU = receiveChannel.mo11363receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    if (mo11363receiveCatchingJP2dKIU == coroutine_suspended) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    mo11363receiveCatchingJP2dKIU = ((ChannelResult) obj).m11382unboximpl();
                }
                return ChannelResult.m11375getOrNullimpl(mo11363receiveCatchingJP2dKIU);
            }
        }
