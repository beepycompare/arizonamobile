...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m10019trySendImplMj0NB7M = conflatedBufferedChannel.m10019trySendImplMj0NB7M(e, true);
        if (m10019trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m10004exceptionOrNullimpl(m10019trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m10019trySendImplMj0NB7M = conflatedBufferedChannel.m10019trySendImplMj0NB7M(e, true);
        if (!(m10019trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m10019trySendImplMj0NB7M;
    ...
    public Object mo7544trySendJP2dKIU(E e) {
        return m10019trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m10019trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m10018trySendDropLatestMj0NB7M(e, z) : m9994trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m10018trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo7544trySendJP2dKIU = super.mo7544trySendJP2dKIU(e);
        if (ChannelResult.m10010isSuccessimpl(mo7544trySendJP2dKIU) || ChannelResult.m10008isClosedimpl(mo7544trySendJP2dKIU)) {
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        ...
        if (!(mo7544trySendJP2dKIU instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m10004exceptionOrNullimpl(mo7544trySendJP2dKIU);
