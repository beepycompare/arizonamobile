...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m11485trySendImplMj0NB7M = conflatedBufferedChannel.m11485trySendImplMj0NB7M(e, true);
        if (m11485trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m11471exceptionOrNullimpl(m11485trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m11485trySendImplMj0NB7M = conflatedBufferedChannel.m11485trySendImplMj0NB7M(e, true);
        if (!(m11485trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m11485trySendImplMj0NB7M;
    ...
    public Object mo9057trySendJP2dKIU(E e) {
        return m11485trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m11485trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m11483trySendDropLatestMj0NB7M(e, z) : m11484trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m11483trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo9057trySendJP2dKIU = super.mo9057trySendJP2dKIU(e);
        if (ChannelResult.m11477isSuccessimpl(mo9057trySendJP2dKIU) || ChannelResult.m11475isClosedimpl(mo9057trySendJP2dKIU)) {
    ...
    private final Object m11484trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m11480closedJP2dKIU(getSendException());
                }
            }
            E e2 = e;
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        ...
        if (!(mo9057trySendJP2dKIU instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m11471exceptionOrNullimpl(mo9057trySendJP2dKIU);
