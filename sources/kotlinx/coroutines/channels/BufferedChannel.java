...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo9992receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m9990receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E e, CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        cancellableContinuation2.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public Object mo7544trySendJP2dKIU(E e) {
        ...
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.Companion.m10014failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegment != null) {
                    ...
                    return ChannelResult.Companion.m10013closedJP2dKIU(getSendException());
                }
            } else {
                channelSegment = channelSegment2;
                i = i2;
            ...
            if (updateCellSend == 0) {
                ...
                return ChannelResult.Companion.m10015successJP2dKIU(Unit.INSTANCE);
            } else if (updateCellSend == 1) {
                return ChannelResult.Companion.m10015successJP2dKIU(Unit.INSTANCE);
            } else {
                if (updateCellSend == 2) {
    ...
    public final Object m9994trySendDropOldestJP2dKIU(E e) {
        ChannelSegment channelSegment;
        int i;
        BufferedChannel<E> bufferedChannel;
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m10000boximpl = ChannelResult.m10000boximpl(ChannelResult.Companion.m10015successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m10000boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
            return tryResume02;
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    public static /* synthetic */ <E> Object m9990receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i == 0) {
                    if (i == 1) {
                        ...
                        return ((ChannelResult) obj).m10012unboximpl();
                    }
                    ...
                    if (updateCellReceive != symbol) {
                        ...
                        if (updateCellReceive != symbol2) {
                            ...
                            if (updateCellReceive == symbol3) {
                                ...
                                Object m9991receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel2.m9991receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                                return m9991receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : m9991receiveCatchingOnNoWaiterSuspendGKJJFZk;
                            }
                            channelSegment.cleanPrev();
                            return ChannelResult.Companion.m10015successJP2dKIU(updateCellReceive);
                        }
                        if (andIncrement < bufferedChannel2.getSendersCounter$kotlinx_coroutines_core()) {
                            channelSegment.cleanPrev();
                        }
                ...
                return ChannelResult.Companion.m10013closedJP2dKIU(bufferedChannel.getCloseCause());
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m9991receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        int i2;
        Symbol symbol;
        Symbol symbol2;
        ChannelResult m10000boximpl;
        Function3 function3;
        ChannelSegment channelSegment2;
        Symbol symbol3;
        Symbol symbol4;
                            ...
                            try {
                                ...
                                if (updateCellReceive != symbol) {
                                    ...
                                    if (updateCellReceive == symbol2) {
                                        ...
                                        while (true) {
                                            ...
                                            if (updateCellReceive2 != symbol3) {
                                                ...
                                                if (updateCellReceive2 != symbol4) {
                                                    ...
                                                    channelSegment2.cleanPrev();
                                                    m10000boximpl = ChannelResult.m10000boximpl(ChannelResult.Companion.m10015successJP2dKIU(updateCellReceive2));
                                                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                                        ...
                                        channelSegment.cleanPrev();
                                        m10000boximpl = ChannelResult.m10000boximpl(ChannelResult.Companion.m10015successJP2dKIU(updateCellReceive));
                                        Function1<E, Unit> function12 = this.onUndeliveredElement;
                                        function3 = (Function3) (function12 != null ? bindCancellationFunResult(function12) : null);
                                    }
                                    orCreateCancellableContinuation.resume((CancellableContinuationImpl) m10000boximpl, (Function3<? super Throwable, ? super CancellableContinuationImpl, ? super CoroutineContext, Unit>) function3);
                                } else {
        ...
        return ((ChannelResult) obj2).m10012unboximpl();
    }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m8474constructorimpl(ChannelResult.m10000boximpl(ChannelResult.Companion.m10013closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public Object mo9993tryReceivePtdJZtk() {
        Symbol symbol;
        ChannelSegment channelSegment;
        Symbol symbol2;
        Symbol symbol3;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.Companion.m10013closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object obj, Object obj2) {
        return ChannelResult.m10000boximpl(obj2 == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.Companion.m10013closedJP2dKIU(getCloseCause()) : ChannelResult.Companion.m10015successJP2dKIU(obj2));
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m8474constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    public void mo10069invokeOnClose(Function1<? super Throwable, Unit> function1) {
        Symbol symbol;
        Symbol symbol2;
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> channelSegment) {
        ...
        Object m10044constructorimpl$default = InlineList.m10044constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core == symbol) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol2 || state$kotlinx_coroutines_core == null) {
                            ...
                            if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                m10044constructorimpl$default = InlineList.m10049plusFjFbRPM(m10044constructorimpl$default, waiter);
                                channelSegment.cleanElement$kotlinx_coroutines_core(i);
                                channelSegment.onSlotCleaned();
                            }
                        }
        ...
        if (m10044constructorimpl$default != null) {
            if (!(m10044constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) m10044constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(m10044constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) m10044constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> channelSegment, long j) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core != null) {
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m10044constructorimpl$default = InlineList.m10049plusFjFbRPM(m10044constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                    channelSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            } else if (!(state$kotlinx_coroutines_core instanceof Waiter)) {
                                ...
                                m10044constructorimpl$default = InlineList.m10049plusFjFbRPM(m10044constructorimpl$default, state$kotlinx_coroutines_core);
                                channelSegment.onCancelledRequest(i, true);
                                break;
                            }
                        }
        ...
        if (m10044constructorimpl$default != null) {
            if (!(m10044constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m10044constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m10044constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) m10044constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            Result.Companion companion = Result.Companion;
            ((SendBroadcast) waiter).getCont().resumeWith(Result.m8474constructorimpl(false));
        } else if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
        } else if (waiter instanceof ReceiveCatching) {
            Result.Companion companion3 = Result.Companion;
            ((ReceiveCatching) waiter).cont.resumeWith(Result.m8474constructorimpl(ChannelResult.m10000boximpl(ChannelResult.Companion.m10013closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long j, ChannelSegment<E> channelSegment) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m10061isClosedimpl(findSegmentInternal)) {
                Segment m10059getSegmentimpl = SegmentOrClosed.m10059getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m10059getSegmentimpl.id) {
                        break loop0;
                    } else if (!m10059getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m10059getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m10059getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m10059getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment2 = (ChannelSegment) SegmentOrClosed.m10059getSegmentimpl(findSegmentInternal);
        if (channelSegment2.id > j) {
    ...
    */
    ...
    public final void m9989onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object m10005getOrNullimpl = ChannelResult.m10005getOrNullimpl(obj);
        Intrinsics.checkNotNull(m10005getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, m10005getOrNullimpl, coroutineContext);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m8474constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            try {
                ...
                cancellableContinuationImpl.resumeWith(m8474constructorimpl);
                result = orCreateCancellableContinuation.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                }
                if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b2, code lost:
        ...
        r1.resumeWith(kotlin.Result.m8474constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        cancellableContinuationImpl2.resumeWith(Result.m8474constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
