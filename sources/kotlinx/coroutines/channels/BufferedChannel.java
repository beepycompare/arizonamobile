...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo11457receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m11455receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
        ...
        if (i >= 0) {
            ...
            this.onUndeliveredElementReceiveCancellationConstructor = function1 != 0 ? new Function3() { // from class: kotlinx.coroutines.channels.BufferedChannel$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    Function3 onUndeliveredElementReceiveCancellationConstructor$lambda$0$0;
                    onUndeliveredElementReceiveCancellationConstructor$lambda$0$0 = BufferedChannel.onUndeliveredElementReceiveCancellationConstructor$lambda$0$0(BufferedChannel.this, (SelectInstance) obj, obj2, obj3);
                    return onUndeliveredElementReceiveCancellationConstructor$lambda$0$0;
                }
            } : null;
    ...
    public /* bridge */ boolean offer(E e) {
        return super.offer(e);
    }

    @Override // kotlinx.coroutines.channels.ReceiveChannel
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    public /* bridge */ E poll() {
        return (E) super.poll();
    }

    @Override // kotlinx.coroutines.channels.ReceiveChannel
    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    public /* bridge */ Object receiveOrNull(Continuation<? super E> continuation) {
        return super.receiveOrNull(continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E e, CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        cancellableContinuation2.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public Object mo9057trySendJP2dKIU(E e) {
        ...
        if (shouldSendSuspend(sendersAndCloseStatus$volatile$FU.get(this))) {
            return ChannelResult.Companion.m11478failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegment != null) {
                    ...
                    return ChannelResult.Companion.m11477closedJP2dKIU(this.getSendException());
                }
            } else {
            ...
            if (updateCellSend == 0) {
                ...
                return ChannelResult.Companion.m11479successJP2dKIU(Unit.INSTANCE);
                ...
                if (updateCellSend == 2) {
                    if (isClosedForSend0) {
                        ...
                        return ChannelResult.Companion.m11477closedJP2dKIU(bufferedChannel2.getSendException());
                    }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m11464boximpl = ChannelResult.m11464boximpl(ChannelResult.Companion.m11479successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m11464boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
            return tryResume02;
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    public static /* synthetic */ <E> Object m11455receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (continuation instanceof BufferedChannel$receiveCatching$1) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i == 0) {
                    if (i == 1) {
                        int i2 = bufferedChannel$receiveCatching$12.I$3;
                        int i3 = bufferedChannel$receiveCatching$12.I$2;
                        long j = bufferedChannel$receiveCatching$12.J$2;
                        int i4 = bufferedChannel$receiveCatching$12.I$1;
                        long j2 = bufferedChannel$receiveCatching$12.J$1;
                        long j3 = bufferedChannel$receiveCatching$12.J$0;
                        int i5 = bufferedChannel$receiveCatching$12.I$0;
                        ChannelSegment channelSegment = (ChannelSegment) bufferedChannel$receiveCatching$12.L$4;
                        Object obj2 = bufferedChannel$receiveCatching$12.L$3;
                        ChannelSegment channelSegment2 = (ChannelSegment) bufferedChannel$receiveCatching$12.L$2;
                        BufferedChannel bufferedChannel2 = (BufferedChannel) bufferedChannel$receiveCatching$12.L$1;
                        BufferedChannel bufferedChannel3 = (BufferedChannel) bufferedChannel$receiveCatching$12.L$0;
                        ResultKt.throwOnFailure(obj);
                        return ((ChannelResult) obj).m11476unboximpl();
                    }
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                ResultKt.throwOnFailure(obj);
                ChannelSegment<E> channelSegment3 = (ChannelSegment) access$getReceiveSegment$volatile$FU().get(bufferedChannel);
                while (!bufferedChannel.isClosedForReceive()) {
                    ...
                    if (channelSegment3.id != j4) {
                        ChannelSegment<E> findSegmentReceive = bufferedChannel.findSegmentReceive(j4, channelSegment3);
                    ...
                    Object updateCellReceive = bufferedChannel.updateCellReceive(channelSegment3, i6, andIncrement, null);
                    ...
                    if (updateCellReceive != symbol) {
                        ...
                        if (updateCellReceive != symbol2) {
                            ...
                            if (updateCellReceive == symbol3) {
                                ...
                                bufferedChannel$receiveCatching$12.L$2 = SpillingKt.nullOutSpilledVariable(channelSegment3);
                                bufferedChannel$receiveCatching$12.L$3 = SpillingKt.nullOutSpilledVariable(updateCellReceive);
                                bufferedChannel$receiveCatching$12.L$4 = SpillingKt.nullOutSpilledVariable(channelSegment3);
                                bufferedChannel$receiveCatching$12.I$0 = 0;
                                bufferedChannel$receiveCatching$12.J$0 = andIncrement;
                                bufferedChannel$receiveCatching$12.J$1 = j4;
                                bufferedChannel$receiveCatching$12.I$1 = i6;
                                bufferedChannel$receiveCatching$12.J$2 = andIncrement;
                                bufferedChannel$receiveCatching$12.I$2 = i6;
                                bufferedChannel$receiveCatching$12.I$3 = 0;
                                bufferedChannel$receiveCatching$12.label = 1;
                                Object m11456receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m11456receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment3, i6, andIncrement, bufferedChannel$receiveCatching$12);
                                return m11456receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : m11456receiveCatchingOnNoWaiterSuspendGKJJFZk;
                            }
                            channelSegment3.cleanPrev();
                            return ChannelResult.Companion.m11479successJP2dKIU(updateCellReceive);
                ...
                return ChannelResult.Companion.m11477closedJP2dKIU(bufferedChannel.getCloseCause());
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m11456receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        int i2;
        Symbol symbol;
        Symbol symbol2;
        ChannelResult m11464boximpl;
        ChannelSegment channelSegment2;
        Symbol symbol3;
        Symbol symbol4;
        Symbol symbol5;
        if (continuation instanceof BufferedChannel$receiveCatchingOnNoWaiterSuspend$1) {
            ...
            if ((bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i2 != 0) {
                    ResultKt.throwOnFailure(obj);
                    bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.L$0 = channelSegment;
                                ...
                                while (true) {
                                    ...
                                    if (updateCellReceive2 != symbol3) {
                                        ...
                                        if (updateCellReceive2 != symbol4) {
                                            ...
                                            m11464boximpl = ChannelResult.m11464boximpl(ChannelResult.Companion.m11479successJP2dKIU(updateCellReceive2));
                                            Function1<E, Unit> function1 = this.onUndeliveredElement;
                                            if (function1 != null) {
                                        ...
                                        if (!(receiveCatching instanceof Waiter)) {
                                            receiveCatching = null;
                                        }
                                        if (receiveCatching != null) {
                                            prepareReceiverForSuspension(receiveCatching, channelSegment4, i3);
                                        }
                                    }
                                }
                            } else {
                                channelSegment.cleanPrev();
                                m11464boximpl = ChannelResult.m11464boximpl(ChannelResult.Companion.m11479successJP2dKIU(updateCellReceive));
                                Function1<E, Unit> function12 = this.onUndeliveredElement;
                                if (function12 != null) {
                                    kFunction = bindCancellationFunResult(function12);
                                }
                            }
                            orCreateCancellableContinuation.resume((CancellableContinuationImpl) m11464boximpl, (Function3<? super Throwable, ? super CancellableContinuationImpl, ? super CoroutineContext, Unit>) kFunction);
                        } else {
                    ...
                    int i4 = bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.I$1;
                    long j3 = bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.J$0;
                    int i5 = bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.I$0;
                    ChannelSegment channelSegment5 = (ChannelSegment) bufferedChannel$receiveCatchingOnNoWaiterSuspend$1.L$0;
                    ResultKt.throwOnFailure(obj);
                }
                return ((ChannelResult) obj).m11476unboximpl();
            }
        ...
        return ((ChannelResult) obj2).m11476unboximpl();
    }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m9916constructorimpl(ChannelResult.m11464boximpl(ChannelResult.Companion.m11477closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public Object mo11458tryReceivePtdJZtk() {
        Symbol symbol;
        ChannelSegment channelSegment;
        int i;
        BufferedChannel<E> bufferedChannel;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.Companion.m11477closedJP2dKIU(getCloseCause());
        }
        if (j < (j2 & 1152921504606846975L)) {
            ...
            while (!this.isClosedForReceive()) {
                ...
                Object updateCellReceive = bufferedChannel.updateCellReceive(channelSegment, i, andIncrement, symbol);
            ...
            return ChannelResult.Companion.m11477closedJP2dKIU(this.getCloseCause());
        }
        return ChannelResult.Companion.m11478failurePtdJZtk();
    }
    ...
    public final void dropFirstElementUntilTheSpecifiedCellIsInTheBuffer(long j) {
        ...
        while (true) {
            ...
            if (j < Math.max(this.capacity + j2, this.getBufferEndCounter())) {
                return;
            }
            BufferedChannel<E> bufferedChannel = this;
            if (receivers$volatile$FU.compareAndSet(bufferedChannel, j2, 1 + j2)) {
                long j3 = j2 / BufferedChannelKt.SEGMENT_SIZE;
    ...
    private final <R> R receiveImpl(Object obj, Function1<? super E, ? extends R> function1, Function3<? super ChannelSegment<E>, ? super Integer, ? super Long, ? extends R> function3, Function0<? extends R> function0, Function3<? super ChannelSegment<E>, ? super Integer, ? super Long, ? extends R> function32) {
        ...
        while (!this.isClosedForReceive()) {
            ...
            BufferedChannel<E> bufferedChannel = this;
            Object obj2 = obj;
            Object obj3 = (Object) bufferedChannel.updateCellReceive(channelSegment, i, andIncrement, obj2);
            channelSegment2 = channelSegment;
            symbol = BufferedChannelKt.SUSPEND;
            if (obj3 != symbol) {
                symbol2 = BufferedChannelKt.FAILED;
    ...
    public final Object processResultSelectReceiveCatching(Object obj, Object obj2) {
        return ChannelResult.m11464boximpl(obj2 == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.Companion.m11477closedJP2dKIU(getCloseCause()) : ChannelResult.Companion.m11479successJP2dKIU(obj2));
    }
    ...
    public static final Function3 onUndeliveredElementReceiveCancellationConstructor$lambda$0$0(final BufferedChannel bufferedChannel, final SelectInstance selectInstance, Object obj, final Object obj2) {
        return new Function3() { // from class: kotlinx.coroutines.channels.BufferedChannel$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj3, Object obj4, Object obj5) {
                Unit onUndeliveredElementReceiveCancellationConstructor$lambda$0$0$0;
                onUndeliveredElementReceiveCancellationConstructor$lambda$0$0$0 = BufferedChannel.onUndeliveredElementReceiveCancellationConstructor$lambda$0$0$0(obj2, bufferedChannel, selectInstance, (Throwable) obj3, obj4, (CoroutineContext) obj5);
                return onUndeliveredElementReceiveCancellationConstructor$lambda$0$0$0;
            }
        };
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public /* bridge */ /* synthetic */ Object next(Continuation continuation) {
            return super.next(continuation);
        }
        ...
        */
        public final Object hasNextOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super Boolean> continuation) {
            ...
            try {
                ...
                BufferedChannelIterator bufferedChannelIterator = this;
                Object updateCellReceive = bufferedChannel.updateCellReceive(channelSegment, i, j, bufferedChannelIterator);
                symbol = BufferedChannelKt.SUSPEND;
                if (updateCellReceive != symbol) {
                    symbol2 = BufferedChannelKt.FAILED;
                    ...
                    if (updateCellReceive == symbol2) {
                        ...
                        while (true) {
                            ...
                            updateCellReceive = bufferedChannel.updateCellReceive(channelSegment2, i2, andIncrement, bufferedChannelIterator);
                            symbol3 = BufferedChannelKt.SUSPEND;
                            if (updateCellReceive != symbol3) {
                                symbol4 = BufferedChannelKt.FAILED;
                                if (updateCellReceive != symbol4) {
                                ...
                                if (!(bufferedChannelIterator instanceof Waiter)) {
                    ...
                    bufferedChannel.prepareReceiverForSuspension(bufferedChannelIterator, channelSegment, i);
                }
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m9916constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    public void mo11524invokeOnClose(Function1<? super Throwable, Unit> function1) {
        Symbol symbol;
        Symbol symbol2;
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> channelSegment) {
        ...
        Object m11503constructorimpl$default = InlineList.m11503constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core == symbol) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol2 || state$kotlinx_coroutines_core == null) {
                            ...
                            if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                m11503constructorimpl$default = InlineList.m11508plusFjFbRPM(m11503constructorimpl$default, waiter);
                                channelSegment.cleanElement$kotlinx_coroutines_core(i);
                                channelSegment.onSlotCleaned();
                            }
                        }
        ...
        if (m11503constructorimpl$default != null) {
            if (!(m11503constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) m11503constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(m11503constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) m11503constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> channelSegment, long j) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core != null) {
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m11503constructorimpl$default = InlineList.m11508plusFjFbRPM(m11503constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                    channelSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            } else if (!(state$kotlinx_coroutines_core instanceof Waiter)) {
                                ...
                                m11503constructorimpl$default = InlineList.m11508plusFjFbRPM(m11503constructorimpl$default, state$kotlinx_coroutines_core);
                                channelSegment.onCancelledRequest(i, true);
                                break;
                            }
                        }
        ...
        if (m11503constructorimpl$default != null) {
            if (!(m11503constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m11503constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m11503constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) m11503constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            Result.Companion companion = Result.Companion;
            ((SendBroadcast) waiter).getCont().resumeWith(Result.m9916constructorimpl(false));
        } else if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
        } else if (waiter instanceof ReceiveCatching) {
            Result.Companion companion3 = Result.Companion;
            ((ReceiveCatching) waiter).cont.resumeWith(Result.m9916constructorimpl(ChannelResult.m11464boximpl(ChannelResult.Companion.m11477closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long j, ChannelSegment<E> channelSegment) {
        ...
        loop0: while (true) {
            findSegmentInternal = ConcurrentLinkedListKt.findSegmentInternal(channelSegment2, j, function2);
            if (!SegmentOrClosed.m11520isClosedimpl(findSegmentInternal)) {
                Segment m11518getSegmentimpl = SegmentOrClosed.m11518getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m11518getSegmentimpl.id) {
                        break loop0;
                    } else if (!m11518getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m11518getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m11518getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m11518getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment3 = (ChannelSegment) SegmentOrClosed.m11518getSegmentimpl(findSegmentInternal);
        if (channelSegment3.id > j) {
            updateSendersCounterIfLower(channelSegment3.id * BufferedChannelKt.SEGMENT_SIZE);
            if (channelSegment3.id * BufferedChannelKt.SEGMENT_SIZE < getReceiversCounter$kotlinx_coroutines_core()) {
                channelSegment3.cleanPrev();
            }
            return null;
        } else if (!DebugKt.getASSERTIONS_ENABLED() || channelSegment3.id == j) {
    ...
    public final ChannelSegment<E> findSegmentReceive(long j, ChannelSegment<E> channelSegment) {
        ...
        if (!isRendezvousOrUnlimited() && j <= getBufferEndCounter() / BufferedChannelKt.SEGMENT_SIZE) {
            ...
            ChannelSegment<E> channelSegment4 = channelSegment3;
            while (true) {
                Segment segment2 = (Segment) atomicReferenceFieldUpdater2.get(this);
                if (segment2.id >= channelSegment4.id || !channelSegment4.tryIncPointers$kotlinx_coroutines_core()) {
                    break;
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, segment2, channelSegment4)) {
        ...
        if (channelSegment3.id > j) {
            updateReceiversCounterIfLower(channelSegment3.id * BufferedChannelKt.SEGMENT_SIZE);
    ...
    private final ChannelSegment<E> findSegmentBufferEnd(long j, ChannelSegment<E> channelSegment, long j2) {
        ...
        ChannelSegment<E> channelSegment3 = (ChannelSegment) SegmentOrClosed.m11518getSegmentimpl(findSegmentInternal);
        if (channelSegment3.id > j) {
            if (bufferEnd$volatile$FU.compareAndSet(this, j2 + 1, BufferedChannelKt.SEGMENT_SIZE * channelSegment3.id)) {
                incCompletedExpandBufferAttempts((channelSegment3.id * BufferedChannelKt.SEGMENT_SIZE) - j2);
            } else {
                incCompletedExpandBufferAttempts$default(this, 0L, 1, null);
            }
            return null;
    ...
    */
    ...
    private final void updateSendersCounterIfLower(long j) {
        ...
        while (true) {
            ...
            BufferedChannel<E> bufferedChannel = this;
            if (sendersAndCloseStatus$volatile$FU.compareAndSet(bufferedChannel, j2, constructSendersAndCloseStatus)) {
                return;
            }
            this = bufferedChannel;
        }
    ...
    private final void updateReceiversCounterIfLower(long j) {
        ...
        while (true) {
            ...
            BufferedChannel<E> bufferedChannel = this;
            long j3 = j;
            if (receivers$volatile$FU.compareAndSet(bufferedChannel, j2, j3)) {
                return;
            }
            this = bufferedChannel;
            j = j3;
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:108:0x01e5 A[EDGE_INSN: B:108:0x01e5->B:90:0x01e5 ?: BREAK  , SYNTHETIC] */
            ...
            loop2: while (true) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core instanceof CancellableContinuation) {
                        if (sendersCounter$kotlinx_coroutines_core <= j && j < receiversCounter$kotlinx_coroutines_core) {
                            str = "receive";
                        } else if (receiversCounter$kotlinx_coroutines_core <= j && i5 < 0) {
                            str = "send";
                        } else {
                            str = "cont";
                        }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:30:0x00d1 A[LOOP:2: B:30:0x00d1->B:81:0x01da, LOOP_START, PHI: r1 
      PHI: (r1v16 kotlinx.coroutines.channels.ChannelSegment) = (r1v14 kotlinx.coroutines.channels.ChannelSegment), (r1v18 kotlinx.coroutines.channels.ChannelSegment) binds: [B:29:0x00cf, B:81:0x01da] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final void m11454onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object m11469getOrNullimpl = ChannelResult.m11469getOrNullimpl(obj);
        Intrinsics.checkNotNull(m11469getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, m11469getOrNullimpl, coroutineContext);
    }
    ...
    public final Function3<Throwable, Object, CoroutineContext, Unit> bindCancellationFun(final Function1<? super E, Unit> function1, final E e) {
        return new Function3() { // from class: kotlinx.coroutines.channels.BufferedChannel$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function3
            public final Object invoke(Object obj, Object obj2, Object obj3) {
                return BufferedChannel.bindCancellationFun$lambda$0(Function1.this, e, (Throwable) obj, obj2, (CoroutineContext) obj3);
            }
        };
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m9916constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            int updateCellSend = updateCellSend(channelSegment, i, e, j, cancellableContinuationImpl2, false);
            if (updateCellSend == 0) {
                channelSegment.cleanPrev();
                ...
                if (updateCellSend != 2) {
                    if (updateCellSend != 4) {
                        ...
                        while (true) {
                            ...
                            int updateCellSend2 = updateCellSend(channelSegment2, i2, e, j2, cancellableContinuationImpl2, isClosedForSend0);
                            if (updateCellSend2 == 0) {
                                channelSegment2.cleanPrev();
                                cancellableContinuationImpl = orCreateCancellableContinuation;
                                Result.Companion companion2 = Result.Companion;
                                ...
                                if (!(cancellableContinuationImpl2 instanceof Waiter)) {
                    ...
                    prepareSenderForSuspension(cancellableContinuationImpl2, channelSegment, i);
                }
            ...
            cancellableContinuationImpl.resumeWith(Result.m9916constructorimpl(unit));
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            }
            if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m9916constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        cancellableContinuationImpl2.resumeWith(Result.m9916constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
    ...
    public final Object receiveOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super E> continuation) {
        ...
        try {
            ...
            Object updateCellReceive = updateCellReceive(channelSegment, i, j, cancellableContinuationImpl);
            symbol = BufferedChannelKt.SUSPEND;
            if (updateCellReceive != symbol) {
                symbol2 = BufferedChannelKt.FAILED;
                KFunction kFunction = null;
                if (updateCellReceive == symbol2) {
                    ...
                    while (true) {
                        ...
                        updateCellReceive = updateCellReceive(channelSegment2, i2, andIncrement, cancellableContinuationImpl);
                        ChannelSegment channelSegment4 = channelSegment2;
                        symbol3 = BufferedChannelKt.SUSPEND;
                        if (updateCellReceive != symbol3) {
                            symbol4 = BufferedChannelKt.FAILED;
                            ...
                            if (cancellableContinuationImpl != null) {
                                prepareReceiverForSuspension(cancellableContinuationImpl, channelSegment4, i2);
                            }
                        }
                    }
                } else {
                ...
                prepareReceiverForSuspension(cancellableContinuationImpl, channelSegment, i);
            }
            Object result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    this.onClosedSelectOnSend(obj, selectInstance);
                    return;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            Object obj2 = obj;
            int updateCellSend = bufferedChannel.updateCellSend(channelSegment, i, obj2, j, selectInstance2, isClosedForSend0);
            channelSegment2 = channelSegment;
            if (updateCellSend == 0) {
                channelSegment2.cleanPrev();
                ...
                if (isClosedForSend0) {
                    channelSegment2.onSlotCleaned();
                    bufferedChannel.onClosedSelectOnSend(obj2, selectInstance2);
                    return;
                }
                Waiter waiter = selectInstance2 instanceof Waiter ? (Waiter) selectInstance2 : null;
                if (waiter != null) {
                    bufferedChannel.prepareSenderForSuspension(waiter, channelSegment2, i);
                    return;
                }
                return;
            } else if (updateCellSend == 3) {
                ...
                this = (BufferedChannel<E>) bufferedChannel;
                obj = obj2;
    ...
    public final void registerSelectForReceive(SelectInstance<?> selectInstance, Object obj) {
        ...
        this.onClosedSelectOnReceive(selectInstance);
    }
}
