...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo11439receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m11437receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E e, CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        cancellableContinuation2.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(sendException)));
    }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegment != null) {
                    ...
                    return ChannelResult.Companion.m11459closedJP2dKIU(this.getSendException());
                }
            } else {
            ...
            if (updateCellSend == 0) {
                ...
                if (updateCellSend == 2) {
                    if (isClosedForSend0) {
                        ...
                        return ChannelResult.Companion.m11459closedJP2dKIU(bufferedChannel2.getSendException());
                    }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m11446boximpl = ChannelResult.m11446boximpl(ChannelResult.Companion.m11461successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m11446boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
            return tryResume02;
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    public static /* synthetic */ <E> Object m11437receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((bufferedChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i == 0) {
                    if (i == 1) {
                        ...
                        return ((ChannelResult) obj).m11458unboximpl();
                    }
                    ...
                    if (updateCellReceive != symbol) {
                        ...
                        if (updateCellReceive != symbol2) {
                            ...
                            if (updateCellReceive == symbol3) {
                                ...
                                Object m11438receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m11438receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment3, i6, andIncrement, bufferedChannel$receiveCatching$12);
                                return m11438receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : m11438receiveCatchingOnNoWaiterSuspendGKJJFZk;
                            }
                            channelSegment3.cleanPrev();
                            return ChannelResult.Companion.m11461successJP2dKIU(updateCellReceive);
                ...
                return ChannelResult.Companion.m11459closedJP2dKIU(bufferedChannel.getCloseCause());
            }
        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object m11438receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        int i2;
        Symbol symbol;
        Symbol symbol2;
        ChannelResult m11446boximpl;
        ChannelSegment channelSegment2;
        Symbol symbol3;
        Symbol symbol4;
        Symbol symbol5;
                    ...
                    try {
                        ...
                        if (updateCellReceive != symbol) {
                            ...
                            if (updateCellReceive == symbol2) {
                                ...
                                while (true) {
                                    ...
                                    if (updateCellReceive2 != symbol3) {
                                        ...
                                        if (updateCellReceive2 != symbol4) {
                                            ...
                                            m11446boximpl = ChannelResult.m11446boximpl(ChannelResult.Companion.m11461successJP2dKIU(updateCellReceive2));
                                            Function1<E, Unit> function1 = this.onUndeliveredElement;
                                            if (function1 != null) {
                                ...
                                channelSegment.cleanPrev();
                                m11446boximpl = ChannelResult.m11446boximpl(ChannelResult.Companion.m11461successJP2dKIU(updateCellReceive));
                                Function1<E, Unit> function12 = this.onUndeliveredElement;
                                if (function12 != null) {
                                    kFunction = bindCancellationFunResult(function12);
                                }
                            }
                            orCreateCancellableContinuation.resume((CancellableContinuationImpl) m11446boximpl, (Function3<? super Throwable, ? super CancellableContinuationImpl, ? super CoroutineContext, Unit>) kFunction);
                        } else {
        ...
        return ((ChannelResult) obj2).m11458unboximpl();
    }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m9898constructorimpl(ChannelResult.m11446boximpl(ChannelResult.Companion.m11459closedJP2dKIU(getCloseCause()))));
    }
    ...
    public Object mo11440tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.Companion.m11459closedJP2dKIU(getCloseCause());
        }
        if (j < (j2 & 1152921504606846975L)) {
            ...
            return ChannelResult.Companion.m11459closedJP2dKIU(this.getCloseCause());
        }
        return ChannelResult.Companion.m11460failurePtdJZtk();
    }
    ...
    public final Object processResultSelectReceiveCatching(Object obj, Object obj2) {
        return ChannelResult.m11446boximpl(obj2 == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.Companion.m11459closedJP2dKIU(getCloseCause()) : ChannelResult.Companion.m11461successJP2dKIU(obj2));
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        */
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m9898constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    */
    private final void removeUnprocessedElements(ChannelSegment<E> channelSegment) {
        ...
        Object m11485constructorimpl$default = InlineList.m11485constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core == symbol) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol2 || state$kotlinx_coroutines_core == null) {
                            ...
                            if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                m11485constructorimpl$default = InlineList.m11490plusFjFbRPM(m11485constructorimpl$default, waiter);
                                channelSegment.cleanElement$kotlinx_coroutines_core(i);
                                channelSegment.onSlotCleaned();
                            }
                        }
        ...
        if (m11485constructorimpl$default != null) {
            if (!(m11485constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) m11485constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(m11485constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
                ArrayList arrayList = (ArrayList) m11485constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> channelSegment, long j) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core != null) {
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (channelSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m11485constructorimpl$default = InlineList.m11490plusFjFbRPM(m11485constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                    channelSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            } else if (!(state$kotlinx_coroutines_core instanceof Waiter)) {
                                ...
                                m11485constructorimpl$default = InlineList.m11490plusFjFbRPM(m11485constructorimpl$default, state$kotlinx_coroutines_core);
                                channelSegment.onCancelledRequest(i, true);
                                break;
                            }
                        }
        ...
        if (m11485constructorimpl$default != null) {
            if (!(m11485constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m11485constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m11485constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>");
            ArrayList arrayList = (ArrayList) m11485constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            Result.Companion companion = Result.Companion;
            ((SendBroadcast) waiter).getCont().resumeWith(Result.m9898constructorimpl(false));
        } else if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
        } else if (waiter instanceof ReceiveCatching) {
            Result.Companion companion3 = Result.Companion;
            ((ReceiveCatching) waiter).cont.resumeWith(Result.m9898constructorimpl(ChannelResult.m11446boximpl(ChannelResult.Companion.m11459closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long j, ChannelSegment<E> channelSegment) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m11502isClosedimpl(findSegmentInternal)) {
                Segment m11500getSegmentimpl = SegmentOrClosed.m11500getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m11500getSegmentimpl.id) {
                        break loop0;
                    } else if (!m11500getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m11500getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m11500getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m11500getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment3 = (ChannelSegment) SegmentOrClosed.m11500getSegmentimpl(findSegmentInternal);
    ...
    */
    ...
    public final void m11436onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        Intrinsics.checkNotNull(function1);
        Object m11451getOrNullimpl = ChannelResult.m11451getOrNullimpl(obj);
        Intrinsics.checkNotNull(m11451getOrNullimpl);
        OnUndeliveredElementKt.callUndeliveredElement(function1, m11451getOrNullimpl, coroutineContext);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m9898constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            cancellableContinuationImpl.resumeWith(Result.m9898constructorimpl(unit));
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            }
            if (result != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m9898constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(BufferedChannel<E> bufferedChannel, E e, Continuation<? super Boolean> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        cancellableContinuationImpl2.resumeWith(Result.m9898constructorimpl(Boxing.boxBoolean(false)));
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
