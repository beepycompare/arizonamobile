...
public interface SendChannel<E> {
    ...
    void mo11443invokeOnClose(Function1<? super Throwable, Unit> function1);
    ...
    Object mo8867trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo8867trySendJP2dKIU = sendChannel.mo8867trySendJP2dKIU(e);
            if (ChannelResult.m11384isSuccessimpl(mo8867trySendJP2dKIU)) {
                return true;
            }
            Throwable m11378exceptionOrNullimpl = ChannelResult.m11378exceptionOrNullimpl(mo8867trySendJP2dKIU);
