...
public interface SendChannel<E> {
    ...
    void mo11529invokeOnClose(Function1<? super Throwable, Unit> function1);
    ...
    default boolean offer(E e) {
        ...
        if (ChannelResult.m11479isSuccessimpl(mo9057trySendJP2dKIU)) {
            return true;
        }
        Throwable m11473exceptionOrNullimpl = ChannelResult.m11473exceptionOrNullimpl(mo9057trySendJP2dKIU);
