...
public interface SendChannel<E> {
    ...
    void mo10096invokeOnClose(Function1<? super Throwable, Unit> function1);
    ...
    Object mo7559trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m10037isSuccessimpl(mo7559trySendJP2dKIU)) {
                return true;
            }
            Throwable m10031exceptionOrNullimpl = ChannelResult.m10031exceptionOrNullimpl(mo7559trySendJP2dKIU);
