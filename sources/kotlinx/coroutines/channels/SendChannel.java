...
public interface SendChannel<E> {
    ...
    void mo11447invokeOnClose(Function1<? super Throwable, Unit> function1);
    ...
    Object mo8871trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo8871trySendJP2dKIU = sendChannel.mo8871trySendJP2dKIU(e);
            if (ChannelResult.m11388isSuccessimpl(mo8871trySendJP2dKIU)) {
                return true;
            }
            Throwable m11382exceptionOrNullimpl = ChannelResult.m11382exceptionOrNullimpl(mo8871trySendJP2dKIU);
