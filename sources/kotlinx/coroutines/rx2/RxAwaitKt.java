    ...
    */
    ...
    public static final Object await(CompletableSource completableSource, Continuation<? super Unit> continuation) {
        ...
        completableSource.subscribe(new CompletableObserver() { // from class: kotlinx.coroutines.rx2.RxAwaitKt$await$2$1
            ...
            public void onError(Throwable th) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(ResultKt.createFailure(th)));
            }
        });
    ...
    public static final <T> Object awaitSingleOrNull(MaybeSource<T> maybeSource, Continuation<? super T> continuation) {
        ...
        maybeSource.subscribe((MaybeObserver) ((MaybeObserver<T>) new MaybeObserver<T>() { // from class: kotlinx.coroutines.rx2.RxAwaitKt$awaitSingleOrNull$2$1
            ...
            public void onComplete() {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(null));
            }

            @Override // io.reactivex.MaybeObserver
            public void onSuccess(T t) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(t));
            }
        ...
        observableSource.subscribe((Observer) ((Observer<T>) new Observer<T>() { // from class: kotlinx.coroutines.rx2.RxAwaitKt$awaitOne$2$1
            ...
            public void onNext(T t2) {
                ...
                if (i == 1 || i == 2) {
                    ...
                    this.seenValue = true;
                    Result.Companion companion = Result.Companion;
                    cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(t2));
                    ...
                    if (mode == Mode.SINGLE && this.seenValue) {
                        if (cancellableContinuationImpl2.isActive()) {
                            ...
                            cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(ResultKt.createFailure(new IllegalArgumentException("More than one onNext value for " + mode))));
                        }
            ...
            public void onComplete() {
                if (this.seenValue) {
                    if (cancellableContinuationImpl2.isActive()) {
                        Result.Companion companion = Result.Companion;
                        cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(this.value));
                    }
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m9901constructorimpl(ResultKt.createFailure(new NoSuchElementException("No value received via onNext for " + mode))));
                }
            }
