...
public final class ReactiveSubscriber<T> implements Subscriber<T> {
    ...
    */
    public final Object takeNextOrNull(Continuation<? super T> continuation) {
        ...
        int i;
        Object obj;
        Throwable m11734exceptionOrNullimpl;
        if (continuation instanceof ReactiveSubscriber$takeNextOrNull$1) {
            ...
            if ((reactiveSubscriber$takeNextOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    obj = channel.mo11722receiveCatchingJP2dKIU(reactiveSubscriber$takeNextOrNull$1);
                    ...
                    ResultKt.throwOnFailure(obj2);
                    obj = ((ChannelResult) obj2).m11742unboximpl();
                }
                m11734exceptionOrNullimpl = ChannelResult.m11734exceptionOrNullimpl(obj);
                if (m11734exceptionOrNullimpl == null) {
                    throw m11734exceptionOrNullimpl;
                }
                if (obj instanceof ChannelResult.Failed) {
                    ChannelResult.m11734exceptionOrNullimpl(obj);
                    return null;
                }
                return obj;
            }
    ...
    public void onNext(T t) {
        if (!ChannelResult.m11740isSuccessimpl(this.channel.mo9143trySendJP2dKIU(t))) {
