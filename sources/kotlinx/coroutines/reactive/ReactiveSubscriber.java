...
public final class ReactiveSubscriber<T> implements Subscriber<T> {
    ...
    */
    public final Object takeNextOrNull(Continuation<? super T> continuation) {
        ...
        int i;
        Object obj;
        Throwable m11378exceptionOrNullimpl;
        if (continuation instanceof ReactiveSubscriber$takeNextOrNull$1) {
            ...
            if ((reactiveSubscriber$takeNextOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    obj = channel.mo11366receiveCatchingJP2dKIU(reactiveSubscriber$takeNextOrNull$1);
                    ...
                    ResultKt.throwOnFailure(obj2);
                    obj = ((ChannelResult) obj2).m11386unboximpl();
                }
                m11378exceptionOrNullimpl = ChannelResult.m11378exceptionOrNullimpl(obj);
                if (m11378exceptionOrNullimpl == null) {
                    throw m11378exceptionOrNullimpl;
                }
                if (obj instanceof ChannelResult.Failed) {
                    ChannelResult.m11378exceptionOrNullimpl(obj);
                    return null;
                }
                return obj;
            }
    ...
    public void onNext(T t) {
        if (!ChannelResult.m11384isSuccessimpl(this.channel.mo8867trySendJP2dKIU(t))) {
