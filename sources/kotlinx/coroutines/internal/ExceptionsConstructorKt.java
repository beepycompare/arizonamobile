...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m9896constructorimpl = Result.m9896constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        try {
            final Method method = cls.getMethod("copyForStackTraceRecovery", new Class[0]);
            return new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
                    return ExceptionsConstructorKt.createConstructor$lambda$0(method, (Throwable) obj2);
                }
            };
            ...
            while (true) {
                ...
                if (length2 == 0) {
                    pair = TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda5
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj2) {
                            Throwable createConstructor$lambda$1$3;
                            createConstructor$lambda$1$3 = ExceptionsConstructorKt.createConstructor$lambda$1$3(constructor, (Throwable) obj2);
                            return createConstructor$lambda$1$3;
                        }
                    }), 0);
                } else if (length2 == 1) {
                    ...
                    if (Intrinsics.areEqual(cls2, String.class)) {
                        pair = TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda3
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj2) {
                                Throwable createConstructor$lambda$1$1;
                                createConstructor$lambda$1$1 = ExceptionsConstructorKt.createConstructor$lambda$1$1(constructor, (Throwable) obj2);
                                return createConstructor$lambda$1$1;
                            }
                        }), 2);
                        ...
                        pair = TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda4
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj2) {
                                Throwable createConstructor$lambda$1$2;
                                createConstructor$lambda$1$2 = ExceptionsConstructorKt.createConstructor$lambda$1$2(constructor, (Throwable) obj2);
                                return createConstructor$lambda$1$2;
                            }
                        }), 1);
                    } else {
                    ...
                    if (Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                        pair = TuplesKt.to(safeCtor(new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda2
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj2) {
                                Throwable createConstructor$lambda$1$0;
                                createConstructor$lambda$1$0 = ExceptionsConstructorKt.createConstructor$lambda$1$0(constructor, (Throwable) obj2);
                                return createConstructor$lambda$1$0;
                            }
                        }), 3);
                    } else {
                        pair = TuplesKt.to(null, -1);
    ...
    public static final Throwable createConstructor$lambda$0(Method method, Throwable th) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            m9896constructorimpl = Result.m9896constructorimpl((Throwable) method.invoke(th, new Object[0]));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.Companion;
            m9896constructorimpl = Result.m9896constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m9902isFailureimpl(m9896constructorimpl)) {
            m9896constructorimpl = null;
        }
        return (Throwable) m9896constructorimpl;
    }
    ...
    public static final Throwable createConstructor$lambda$1$1(Constructor constructor, Throwable th) {
    ...
    public static final Throwable createConstructor$lambda$1$2(Constructor constructor, Throwable th) {
        Object newInstance = constructor.newInstance(th);
        Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type kotlin.Throwable");
        return (Throwable) newInstance;
    }

    public static final Throwable createConstructor$lambda$1$3(Constructor constructor, Throwable th) {
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ExceptionsConstructorKt.safeCtor$lambda$0(Function1.this, (Throwable) obj);
            }
        };
    }
    ...
    public static final Throwable safeCtor$lambda$0(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m9896constructorimpl = Result.m9896constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.Companion;
            m9896constructorimpl = Result.m9896constructorimpl(ResultKt.createFailure(th3));
        }
        return Result.m9902isFailureimpl(m9896constructorimpl) ? null : m9896constructorimpl;
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m9896constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m9896constructorimpl = Result.m9896constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9896constructorimpl = Result.m9896constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m9902isFailureimpl(m9896constructorimpl)) {
            m9896constructorimpl = valueOf;
        }
        return ((Number) m9896constructorimpl).intValue();
    }
