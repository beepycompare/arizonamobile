...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m9898constructorimpl = Result.m9898constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable createConstructor$lambda$0(Method method, Throwable th) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            m9898constructorimpl = Result.m9898constructorimpl((Throwable) method.invoke(th, new Object[0]));
        } catch (Throwable th2) {
            Result.Companion companion2 = Result.Companion;
            m9898constructorimpl = Result.m9898constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m9904isFailureimpl(m9898constructorimpl)) {
            m9898constructorimpl = null;
        }
        return (Throwable) m9898constructorimpl;
    }
    ...
    public static final Throwable safeCtor$lambda$0(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m9898constructorimpl = Result.m9898constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.Companion;
            m9898constructorimpl = Result.m9898constructorimpl(ResultKt.createFailure(th3));
        }
        return Result.m9904isFailureimpl(m9898constructorimpl) ? null : m9898constructorimpl;
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m9898constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m9898constructorimpl = Result.m9898constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9898constructorimpl = Result.m9898constructorimpl(ResultKt.createFailure(th));
        }
