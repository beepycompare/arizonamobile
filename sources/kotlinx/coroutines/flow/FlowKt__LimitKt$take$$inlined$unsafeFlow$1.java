...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", f = "Limit.kt", i = {0, 0, 0, 0, 0, 0}, l = {115}, m = "collect", n = {"collector", "$completion", "$this$take_u24lambda_u241", "ownershipMarker", "consumed", "$i$a$-unsafeFlow-FlowKt__LimitKt$take$2"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "I$0"}, v = 1)
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        anonymousClass1.L$4 = SpillingKt.nullOutSpilledVariable(intRef);
