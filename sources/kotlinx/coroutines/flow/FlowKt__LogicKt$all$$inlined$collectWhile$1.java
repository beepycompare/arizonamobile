...
public final class FlowKt__LogicKt$all$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LogicKt$all$$inlined$collectWhile$1", f = "Logic.kt", i = {0, 0, 0, 0}, l = {142}, m = "emit", n = {"value", "$completion", "it", "$i$a$-collectWhile-FlowKt__LogicKt$all$2"}, s = {"L$0", "L$1", "L$2", "I$0"}, v = 1)
