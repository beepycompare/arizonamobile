...
public final class FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", f = "Limit.kt", i = {0, 0, 0, 0}, l = {142}, m = "emit", n = {"value", "$completion", "value", "$i$a$-collectWhile-FlowKt__LimitKt$transformWhile$1$1"}, s = {"L$0", "L$1", "L$2", "I$0"}, v = 1)
