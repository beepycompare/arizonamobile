...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$6", f = "Builders.kt", i = {0, 0, 0, 0, 0, 0, 0, 0, 0}, l = {114}, m = "collect", n = {"collector", "$completion", "$this$asFlow_u24lambda_u245", "$this$forEach$iv", "element$iv", "value", "$i$a$-unsafeFlow-FlowKt__BuildersKt$asFlow$6", "$i$f$forEach", "$i$a$-forEach-FlowKt__BuildersKt$asFlow$6$1"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "I$0", "I$1", "I$4"}, v = 1)
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:17:0x0099 -> B:19:0x009c). Please submit an issue!!! */
        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    objArr = (Object[]) anonymousClass1.L$3;
                    i3 = i7;
                    i2 = i6;
                    anonymousClass12 = anonymousClass1;
                    ...
                    if (i4 < length) {
                        ...
                        anonymousClass12.L$3 = objArr;
                        anonymousClass12.L$4 = SpillingKt.nullOutSpilledVariable(obj5);
                        anonymousClass12.L$5 = SpillingKt.nullOutSpilledVariable(obj5);
