...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", i = {0}, l = {273}, m = "invokeSuspend", n = {"$this$produce"}, s = {"L$0"}, v = 1)
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof FlowKt__DelayKt$sample$2$values$1$1$emit$1) {
                ...
                if ((flowKt__DelayKt$sample$2$values$1$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        flowKt__DelayKt$sample$2$values$1$1$emit$1.L$0 = SpillingKt.nullOutSpilledVariable(t);
                        flowKt__DelayKt$sample$2$values$1$1$emit$1.label = 1;
                        if (producerScope.send(obj2, flowKt__DelayKt$sample$2$values$1$1$emit$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else if (i != 1) {
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    } else {
                        Object obj3 = flowKt__DelayKt$sample$2$values$1$1$emit$1.L$0;
                        ResultKt.throwOnFailure(obj);
                    }
            ...
            Object obj4 = flowKt__DelayKt$sample$2$values$1$1$emit$1.result;
