...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CollectionKt", f = "Collection.kt", i = {0, 0}, l = {21}, m = "toCollection", n = {"$this$toCollection", FirebaseAnalytics.Param.DESTINATION}, s = {"L$0", "L$1"}, v = 1)
