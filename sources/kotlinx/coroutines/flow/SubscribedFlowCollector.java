...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0073, code lost:
        if (((kotlinx.coroutines.flow.SubscribedFlowCollector) r6).onSubscription(r0) == r1) goto L23;
     */
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [kotlinx.coroutines.flow.internal.SafeCollector, java.lang.Object] */
            ...
            if (continuation instanceof SubscribedFlowCollector$onSubscription$1) {
                ...
                if ((subscribedFlowCollector$onSubscription$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (r2 != 0) {
                        ...
                        SafeCollector safeCollector = new SafeCollector(this.collector, subscribedFlowCollector$onSubscription$1.getContext());
                        subscribedFlowCollector$onSubscription$1.L$0 = safeCollector;
                        subscribedFlowCollector$onSubscription$1.label = 1;
                        Object invoke = this.action.invoke(safeCollector, subscribedFlowCollector$onSubscription$1);
                        r2 = safeCollector;
                    } else if (r2 != 1) {
                        if (r2 == 2) {
                            SafeCollector safeCollector2 = (SafeCollector) subscribedFlowCollector$onSubscription$1.L$0;
                            ResultKt.throwOnFailure(obj);
                            return Unit.INSTANCE;
                        }
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    } else {
                        SafeCollector safeCollector3 = (SafeCollector) subscribedFlowCollector$onSubscription$1.L$0;
                        ResultKt.throwOnFailure(obj);
                        r2 = safeCollector3;
                    }
                    ...
                    subscribedFlowCollector$onSubscription$1.L$0 = SpillingKt.nullOutSpilledVariable(r2);
