    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
                ...
                if (flow.collect(new FlowCollector() { // from class: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1.1
                    ...
                    public final Object emit(T t, Continuation<? super Unit> continuation) {
                        ...
                        if (mutableStateFlow != null) {
                            ...
                            completableDeferred2.complete(Result.m10243boximpl(Result.m10244constructorimpl(new ReadonlyStateFlow((StateFlow) t2, JobKt.getJob(coroutineScope2.getCoroutineContext())))));
            ...
            if (objectRef.element == 0) {
                ...
                Result.Companion companion = Result.Companion;
                completableDeferred2.complete(Result.m10243boximpl(Result.m10244constructorimpl(ResultKt.createFailure(new NoSuchElementException("Flow is empty")))));
            }
            return Unit.INSTANCE;
        } catch (Throwable th) {
