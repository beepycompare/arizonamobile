...
public final class FlowKt__LogicKt$any$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LogicKt$any$$inlined$collectWhile$1", f = "Logic.kt", i = {0, 0, 0, 0}, l = {142}, m = "emit", n = {"value", "$completion", "it", "$i$a$-collectWhile-FlowKt__LogicKt$any$2"}, s = {"L$0", "L$1", "L$2", "I$0"}, v = 1)
