...
public final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    */
        ...
        if (continuation instanceof FlowKt__ErrorsKt$catchImpl$1) {
            ...
            if ((flowKt__ErrorsKt$catchImpl$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        flowKt__ErrorsKt$catchImpl$1.L$0 = SpillingKt.nullOutSpilledVariable(flow);
                        flowKt__ErrorsKt$catchImpl$1.L$1 = SpillingKt.nullOutSpilledVariable(flowCollector);
                    ...
                    Flow flow2 = (Flow) flowKt__ErrorsKt$catchImpl$1.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                        return null;
                    } catch (Throwable th3) {
    ...
    /* renamed from: catch */
    public static final <T> Flow<T> m11499catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
