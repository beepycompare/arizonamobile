...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$3", f = "Zip.kt", i = {0}, l = {269}, m = "invokeSuspend", n = {"$this$safeFlow"}, s = {"L$0"}, v = 1)
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$3<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$3$1", f = "Zip.kt", i = {0, 0, 0, 0, 0, 0}, l = {SubsamplingScaleImageView.ORIENTATION_270}, m = "invokeSuspend", n = {"$this$combineInternal", "it", "$completion", "args", "$this$combineTransform_u24lambda_u242", "$i$a$-combineTransformUnsafe-FlowKt__ZipKt$combineTransform$3"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "I$0"}, v = 1)
