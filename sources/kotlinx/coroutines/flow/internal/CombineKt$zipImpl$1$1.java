...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            ((SendChannel) produce$default).mo11429invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.1
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo11362receiveCatchingJP2dKIU = this.$second.mo11362receiveCatchingJP2dKIU(this);
                    } else if (i == 1) {
                        ResultKt.throwOnFailure(obj);
                    ...
                    if (mo11362receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m11373exceptionOrNullimpl = ChannelResult.m11373exceptionOrNullimpl(mo11362receiveCatchingJP2dKIU);
                    ...
                    T1 t1 = this.$value;
                    Object obj3 = mo11362receiveCatchingJP2dKIU == NullSurrogateKt.NULL ? null : mo11362receiveCatchingJP2dKIU;
                    this.L$0 = SpillingKt.nullOutSpilledVariable(mo11362receiveCatchingJP2dKIU);
                    this.L$1 = flowCollector2;
                    this.label = 2;
                    Object invoke = function3.invoke(t1, obj3, this);
                    if (invoke != coroutine_suspended) {
                        obj2 = mo11362receiveCatchingJP2dKIU;
                        obj = invoke;
