...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ((SendChannel) produce$default).mo10691invokeOnClose(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1.1
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        public static final class AnonymousClass1<T> implements FlowCollector {
            ...
            public static final class C00911 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00911(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, CompletableJob completableJob, Continuation<? super C00911> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00911(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, this.$collectJob, continuation);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    Object mo10614receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo10614receiveCatchingJP2dKIU = this.$second.mo10614receiveCatchingJP2dKIU(this);
                    } else if (i == 1) {
                        ResultKt.throwOnFailure(obj);
                        mo10614receiveCatchingJP2dKIU = ((ChannelResult) obj).m10634unboximpl();
                    } else if (i != 2) {
                        if (i == 3) {
                            ResultKt.throwOnFailure(obj);
                            return Unit.INSTANCE;
                    ...
                    if (mo10614receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m10626exceptionOrNullimpl = ChannelResult.m10626exceptionOrNullimpl(mo10614receiveCatchingJP2dKIU);
                        if (m10626exceptionOrNullimpl == null) {
                            throw new AbortFlowException(completableJob);
                        }
                        throw m10626exceptionOrNullimpl;
                    }
                    FlowCollector flowCollector2 = this.$this_unsafeFlow;
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (mo10614receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo10614receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector2;
                    this.label = 2;
                    obj = function3.invoke(t1, mo10614receiveCatchingJP2dKIU, this);
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            if (ChannelFlowKt.withContextUndispatched(this.$scopeContext, Unit.INSTANCE, this.$cnt, new C00911(this.$second, this.$this_unsafeFlow, this.$transform, t1, this.$collectJob, null), combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else if (i != 1) {
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
