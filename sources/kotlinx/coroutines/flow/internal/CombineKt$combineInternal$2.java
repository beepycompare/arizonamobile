    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            this.I$1 = b;
            this.label = 1;
            obj2 = channel.mo11739receiveCatchingJP2dKIU(this);
            ...
            if (i4 == 2 || i4 == 3) {
                ...
                if (obj2 != coroutine_suspended) {
                    ...
                    objArr2 = objArr;
                    bArr2 = bArr3;
                    indexedValue = (IndexedValue) ChannelResult.m11752getOrNullimpl(obj2);
                    if (indexedValue == null) {
                        do {
                            ...
                            bArr2[index] = (byte) i3;
                            indexedValue = (IndexedValue) ChannelResult.m11752getOrNullimpl(channel.mo11740tryReceivePtdJZtk());
            ...
            objArr2 = (Object[]) this.L$0;
            ResultKt.throwOnFailure(obj);
            obj2 = ((ChannelResult) obj).m11759unboximpl();
            indexedValue = (IndexedValue) ChannelResult.m11752getOrNullimpl(obj2);
            if (indexedValue == null) {
            }
        }
