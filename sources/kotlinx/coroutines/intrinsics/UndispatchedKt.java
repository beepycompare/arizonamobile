    ...
    public static final <R, T> void startCoroutineUndispatched(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation) {
        ...
        try {
            ...
            if (wrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                probeCoroutineCreated.resumeWith(Result.m9091constructorimpl(wrapWithContinuationImpl));
            }
        } catch (Throwable th) {
            th = th;
            ...
            probeCoroutineCreated.resumeWith(Result.m9091constructorimpl(ResultKt.createFailure(th)));
        }
    }
}
