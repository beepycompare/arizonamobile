...
public final class UndispatchedKt {
    ...
    private static final <T, R> Object startUndispatched(ScopeCoroutine<? super T> scopeCoroutine, boolean z, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
    ...
    public static final <R, T> void startCoroutineUndispatched(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation) {
        ...
        try {
            ...
            if (wrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                probeCoroutineCreated.resumeWith(Result.m9915constructorimpl(wrapWithContinuationImpl));
            }
        } catch (Throwable th) {
            th = th;
            ...
            probeCoroutineCreated.resumeWith(Result.m9915constructorimpl(ResultKt.createFailure(th)));
        }
    }
}
