...
public final class TimeoutCoroutine<U, T extends U> extends ScopeCoroutine<T> implements Runnable {
    ...
    public void run() {
        Delay delay = DelayKt.getDelay(getContext());
        CoroutineName coroutineName = (CoroutineName) getContext().get(CoroutineName.Key);
        cancelCoroutine(TimeoutKt.TimeoutCancellationException(this.time, delay, this, coroutineName != null ? coroutineName.getName() : null));
    }
