...
public final class WorkQueue {
    ...
    private final Task stealWithExclusiveMode(boolean z) {
    ...
    private final Task tryExtractFromTheMiddle(int i, boolean z) {
        ...
        if (task != null && task.taskContext == z && zzah$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i2, task, null)) {
            if (z) {
