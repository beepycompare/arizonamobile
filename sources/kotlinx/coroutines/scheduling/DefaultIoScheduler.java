...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f86default;
    ...
    static {
        ...
        f86default = CoroutineDispatcher.limitedParallelism$default(UnlimitedIoScheduler.INSTANCE, systemProp$default, null, 2, null);
    }
    ...
    public void execute(Runnable runnable) {
        mo10644dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo10644dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f86default.mo10644dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f86default.dispatchYield(coroutineContext, runnable);
    }
