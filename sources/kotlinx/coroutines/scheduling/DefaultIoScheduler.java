...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    static {
        ...
        f78default = CoroutineDispatcher.limitedParallelism$default(UnlimitedIoScheduler.INSTANCE, systemProp$default, null, 2, null);
    }
    ...
    public void execute(Runnable runnable) {
        mo11417dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo11417dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f78default.mo11417dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f78default.dispatchYield(coroutineContext, runnable);
    }
