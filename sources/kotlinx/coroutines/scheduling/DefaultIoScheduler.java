...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f74default;
    ...
    static {
        ...
        f74default = CoroutineDispatcher.limitedParallelism$default(UnlimitedIoScheduler.INSTANCE, systemProp$default, null, 2, null);
    }
    ...
    public void execute(Runnable runnable) {
        mo11427dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo11427dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f74default.mo11427dispatch(coroutineContext, runnable);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        f74default.dispatchYield(coroutineContext, runnable);
    }
