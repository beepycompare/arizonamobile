...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo11518scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m11445delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m11446toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m11446toDelayMillisLRDsOJo(long j) {
        boolean m11325isPositiveimpl = Duration.m11325isPositiveimpl(j);
        if (m11325isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m11309getInWholeMillisecondsimpl(Duration.m11327plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m11325isPositiveimpl) {
