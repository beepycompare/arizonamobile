...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo10081scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m10000delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m10001toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m10001toDelayMillisLRDsOJo(long j) {
        boolean m9880isPositiveimpl = Duration.m9880isPositiveimpl(j);
        if (m9880isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m9864getInWholeMillisecondsimpl(Duration.m9882plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m9880isPositiveimpl) {
