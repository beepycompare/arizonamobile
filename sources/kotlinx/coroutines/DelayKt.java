...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo10760scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m10685delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m10686toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m10686toDelayMillisLRDsOJo(long j) {
        boolean m10566isPositiveimpl = Duration.m10566isPositiveimpl(j);
        if (m10566isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m10550getInWholeMillisecondsimpl(Duration.m10568plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m10566isPositiveimpl) {
