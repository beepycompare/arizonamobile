...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo10058scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m9977delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9978toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9978toDelayMillisLRDsOJo(long j) {
        boolean m9857isPositiveimpl = Duration.m9857isPositiveimpl(j);
        if (m9857isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m9841getInWholeMillisecondsimpl(Duration.m9859plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m9857isPositiveimpl) {
