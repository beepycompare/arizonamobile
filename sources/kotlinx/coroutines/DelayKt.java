...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo10645scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m10564delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m10565toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m10565toDelayMillisLRDsOJo(long j) {
        boolean m10444isPositiveimpl = Duration.m10444isPositiveimpl(j);
        if (m10444isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m10428getInWholeMillisecondsimpl(Duration.m10446plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m10444isPositiveimpl) {
