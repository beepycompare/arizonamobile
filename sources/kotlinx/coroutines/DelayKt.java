...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo10054scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m9973delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9974toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9974toDelayMillisLRDsOJo(long j) {
        boolean m9853isPositiveimpl = Duration.m9853isPositiveimpl(j);
        if (m9853isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m9837getInWholeMillisecondsimpl(Duration.m9855plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m9853isPositiveimpl) {
