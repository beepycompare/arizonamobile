...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo11839scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m11758delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m11759toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m11759toDelayMillisLRDsOJo(long j) {
        boolean m11633isPositiveimpl = Duration.m11633isPositiveimpl(j);
        if (m11633isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m11617getInWholeMillisecondsimpl(Duration.m11635plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m11633isPositiveimpl) {
