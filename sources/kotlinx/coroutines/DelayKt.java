...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo11428scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m11347delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m11348toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m11348toDelayMillisLRDsOJo(long j) {
        boolean m11227isPositiveimpl = Duration.m11227isPositiveimpl(j);
        if (m11227isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m11211getInWholeMillisecondsimpl(Duration.m11229plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m11227isPositiveimpl) {
