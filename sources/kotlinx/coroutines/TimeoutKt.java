...
public final class TimeoutKt {
    ...
    public static final <T> Object m11431withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m11423toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m11432withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m11423toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job, String str) {
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            str2 = delayWithTimeoutDiagnostics.m11424timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
        }
        str2 = "Timed out waiting for " + j + " ms";
        if (str != null) {
            StringBuilder append = new StringBuilder("Coroutine \"").append(str).append("\" ");
            if (str2.length() > 0) {
        ...
        return new TimeoutCancellationException(str2, job);
    }
}
