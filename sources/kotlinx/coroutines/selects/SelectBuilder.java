...
public interface SelectBuilder<R> {
    ...
    public static final class DefaultImpls {
        ...
        public static <R, P, Q> void invoke(SelectBuilder<? super R> selectBuilder, SelectClause2<? super P, ? extends Q> selectClause2, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
            SelectBuilder.super.invoke((SelectClause2) selectClause2, (Function2<? super Q, ? super Continuation<? super Object>, ? extends Object>) function2);
        }
        ...
        public static <R> void onTimeout(SelectBuilder<? super R> selectBuilder, long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
            SelectBuilder.super.onTimeout(j, function1);
        }
    }

    default <P, Q> void invoke(SelectClause2<? super P, ? extends Q> selectClause2, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        invoke(selectClause2, null, function2);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "Replaced with the same extension function", replaceWith = @ReplaceWith(expression = "onTimeout(timeMillis, block)", imports = {"kotlinx.coroutines.selects.onTimeout"}))
    default void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        OnTimeoutKt.onTimeout(this, j, function1);
    }
}
