...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    public /* bridge */ <P, Q> void invoke(SelectClause2<? super P, ? extends Q> selectClause2, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        super.invoke(selectClause2, function2);
    }

    @Override // kotlinx.coroutines.selects.SelectBuilder
    @Deprecated(level = DeprecationLevel.ERROR, message = "Replaced with the same extension function", replaceWith = @ReplaceWith(expression = "onTimeout(timeMillis, block)", imports = {"kotlinx.coroutines.selects.onTimeout"}))
    public /* bridge */ void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        super.onTimeout(j, function1);
    }
        ...
        try {
            if (continuation instanceof SelectImplementation$processResultAndInvokeBlockRecoveringException$1) {
                ...
                if ((selectImplementation$processResultAndInvokeBlockRecoveringException$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i == 0) {
                        if (i == 1) {
                            Object obj3 = selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$2;
                            Object obj4 = selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$1;
                            ClauseData clauseData2 = (ClauseData) selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$0;
                    ...
                    selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$0 = SpillingKt.nullOutSpilledVariable(clauseData);
                    selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$1 = SpillingKt.nullOutSpilledVariable(obj);
                    selectImplementation$processResultAndInvokeBlockRecoveringException$1.L$2 = SpillingKt.nullOutSpilledVariable(processResult);
