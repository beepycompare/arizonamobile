...
public final class a implements Converter {
    ...
    public final byte[] a(FeatureConfig featureConfig) {
        return MessageNano.toByteArray(this.f1424a.fromModel(featureConfig));
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    public final Object fromModel(Object obj) {
        return MessageNano.toByteArray(this.f1424a.fromModel((FeatureConfig) obj));
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final FeatureConfig toModel(byte[] bArr) {
        return this.f1424a.toModel((e) MessageNano.mergeFrom(new e(), bArr));
    }
}
