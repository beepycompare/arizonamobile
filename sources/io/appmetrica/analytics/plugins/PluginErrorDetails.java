...
public class PluginErrorDetails {
    ...
    public static class Builder {
        ...
        public PluginErrorDetails build() {
            return new PluginErrorDetails(this.f1312a, this.b, (List) WrapUtils.getOrDefault(this.c, new ArrayList()), this.d, this.e, (Map) WrapUtils.getOrDefault(this.f, new HashMap()), 0);
        }
