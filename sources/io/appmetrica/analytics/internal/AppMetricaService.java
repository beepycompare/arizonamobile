...
public class AppMetricaService extends Service {
    ...
    private final C0672w1 f1193a = new C0672w1(this);
    ...
    public IBinder onBind(Intent intent) {
        ...
        K1 k1 = c;
        k1.f525a.execute(new E1(k1, intent));
        return iBinder;
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        K1 k1 = c;
        k1.f525a.execute(new A1(k1, configuration));
    }
    ...
    public void onCreate() {
        ...
        if (k1 == null) {
            ...
            L1 l1 = new L1(applicationContext, this.f1193a, new B5(applicationContext));
            C0666vk c0666vk = Na.F.v;
            O1 o1 = new O1(l1);
            LinkedHashMap linkedHashMap = c0666vk.f1125a;
    ...
    public void onRebind(Intent intent) {
        ...
        K1 k1 = c;
        k1.f525a.execute(new F1(k1, intent));
    }

    @Override // android.app.Service
    public void onStart(Intent intent, int i) {
        K1 k1 = c;
        k1.f525a.execute(new C1(k1, intent, i));
    }

    @Override // android.app.Service
    public int onStartCommand(Intent intent, int i, int i2) {
        K1 k1 = c;
        k1.f525a.execute(new D1(k1, intent, i, i2));
        return 2;
    }
    ...
    public boolean onUnbind(Intent intent) {
        K1 k1 = c;
        k1.f525a.execute(new G1(k1, intent));
        String action = intent.getAction();
