...
public final class r extends u implements LocationReceiver {
    ...
    public final void startLocationUpdates() {
        if (this.b.hasNecessaryPermissions(this.f1196a)) {
            SystemServiceUtils.accessSystemServiceByNameSafely(this.f1196a, FirebaseAnalytics.Param.LOCATION, "request location updates for " + this.d + " provider", "location manager", new FunctionWithThrowable() { // from class: io.appmetrica.analytics.location.impl.r$$ExternalSyntheticLambda1
    ...
    public final void stopLocationUpdates() {
        SystemServiceUtils.accessSystemServiceByNameSafely(this.f1196a, FirebaseAnalytics.Param.LOCATION, "stop location updates for passive provider", "location manager", new FunctionWithThrowable() { // from class: io.appmetrica.analytics.location.impl.r$$ExternalSyntheticLambda0
            @Override // io.appmetrica.analytics.coreapi.internal.backport.FunctionWithThrowable
            public final Object apply(Object obj) {
