...
public final class i {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(i.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                i iVar = (i) obj;
                return Intrinsics.areEqual(this.f1199a, iVar.f1199a) && Intrinsics.areEqual(this.b, iVar.b);
            }
    ...
    public final String toString() {
        return "LocationConfig(locationFilter=" + this.f1199a + ", cacheArguments=" + this.b + ')';
    }
