...
public final class i {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(i.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                i iVar = (i) obj;
                return Intrinsics.areEqual(this.f1349a, iVar.f1349a) && Intrinsics.areEqual(this.b, iVar.b);
            }
    ...
    public final String toString() {
        return "LocationConfig(locationFilter=" + this.f1349a + ", cacheArguments=" + this.b + ')';
    }
