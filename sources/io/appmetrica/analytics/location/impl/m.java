    ...
    */
    ...
    public final boolean shouldUpdate(Location location) {
        if (f.contains(location.getProvider())) {
            return this.mCachedData.isEmpty() || this.mCachedData.shouldUpdateData() || a(location, (Location) this.mCachedData.getData(), this.f1208a.f1207a, 200L);
        }
        return false;
    }
