...
public class Request {
    ...
    public static class Builder {
        ...
        public Request build() {
            return new Request(this.f1384a, this.b, this.c, this.d, 0);
        }
    ...
    public String toString() {
        return "Request{url=" + this.f1383a + ", method='" + this.b + "', bodyLength=" + this.c.length + ", headers=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }
