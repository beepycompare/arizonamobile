...
public class NetworkClient {
    ...
    public static class Builder {
        ...
        public NetworkClient build() {
            return new NetworkClient(this.f1285a, this.b, this.c, this.d, this.e, this.f, 0);
        }

        public Builder withConnectTimeout(int i) {
            this.f1285a = Integer.valueOf(i);
            return this;
        }
    ...
    public String toString() {
        return "NetworkClient{connectTimeout=" + this.f1284a + ", readTimeout=" + this.b + ", sslSocketFactory=" + this.c + ", useCaches=" + this.d + ", instanceFollowRedirects=" + this.e + ", maxResponseSize=" + this.f + AbstractJsonLexerKt.END_OBJ;
    }
