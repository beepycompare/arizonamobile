...
public class Response {
    ...
    public String toString() {
        return "Response{completed=" + this.f1386a + ", code=" + this.b + ", responseDataLength=" + this.c.length + ", errorDataLength=" + this.d.length + ", headers=" + this.e + ", exception=" + this.f + ", url=" + this.g + AbstractJsonLexerKt.END_OBJ;
    }
