...
public final class c implements Call {
    ...
    public final void a(HttpsURLConnection httpsURLConnection) {
        ...
        Integer readTimeout = this.f1233a.getReadTimeout();
        if (readTimeout != null) {
            httpsURLConnection.setReadTimeout(readTimeout.intValue());
        }
        Integer connectTimeout = this.f1233a.getConnectTimeout();
        if (connectTimeout != null) {
            httpsURLConnection.setConnectTimeout(connectTimeout.intValue());
        }
        Boolean useCaches = this.f1233a.getUseCaches();
        if (useCaches != null) {
            httpsURLConnection.setUseCaches(useCaches.booleanValue());
        }
        Boolean instanceFollowRedirects = this.f1233a.getInstanceFollowRedirects();
        ...
        SSLSocketFactory sslSocketFactory = this.f1233a.getSslSocketFactory();
    ...
    */
    public final Response execute() {
        ...
        try {
            ...
            try {
                bArr = e.a(this.f1233a.getMaxResponseSize(), new a(httpsURLConnection));
                bArr2 = e.a(this.f1233a.getMaxResponseSize(), new b(httpsURLConnection));
                z = true;
                map2 = headerFields;
            } catch (Throwable th4) {
                th = th4;
