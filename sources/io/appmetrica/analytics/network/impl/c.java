...
public final class c implements Call {
    ...
    public final void a(HttpsURLConnection httpsURLConnection) {
        ...
        Integer readTimeout = this.f1284a.getReadTimeout();
        if (readTimeout != null) {
            httpsURLConnection.setReadTimeout(readTimeout.intValue());
        }
        Integer connectTimeout = this.f1284a.getConnectTimeout();
        if (connectTimeout != null) {
            httpsURLConnection.setConnectTimeout(connectTimeout.intValue());
        }
        Boolean useCaches = this.f1284a.getUseCaches();
        if (useCaches != null) {
            httpsURLConnection.setUseCaches(useCaches.booleanValue());
        }
        Boolean instanceFollowRedirects = this.f1284a.getInstanceFollowRedirects();
        ...
        SSLSocketFactory sslSocketFactory = this.f1284a.getSslSocketFactory();
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        bArr = e.a(this.f1284a.getMaxResponseSize(), new a(httpsURLConnection));
                        bArr2 = e.a(this.f1284a.getMaxResponseSize(), new b(httpsURLConnection));
