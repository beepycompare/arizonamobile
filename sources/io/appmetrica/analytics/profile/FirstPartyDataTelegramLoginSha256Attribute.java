...
public class FirstPartyDataTelegramLoginSha256Attribute {
    ...
    private final L6 f1416a = new L6("appmetrica_1pd_telegram_sha256", new C0604t8(), new C0324ic(new D4(100)));
    private final Dl b;
    ...
    public UserProfileUpdate<? extends Ho> withTelegramLoginValues(Iterable<String> iterable) {
        ...
        C0775zn c0775zn = new C0775zn(200, "First party data telegram logins attribute", PublicLogger.getAnonymousInstance());
        L6 l6 = this.f1416a;
