...
public class BooleanAttribute {
    ...
    private final L6 f1410a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public BooleanAttribute(String str, Vo vo, InterfaceC0678w2 interfaceC0678w2) {
        this.f1410a = new L6(str, vo, interfaceC0678w2);
    }

    public UserProfileUpdate<? extends Ho> withValue(boolean z) {
        L6 l6 = this.f1410a;
        return new UserProfileUpdate<>(new C0368k3(l6.c, z, l6.f642a, new J4(l6.b)));
    }

    public UserProfileUpdate<? extends Ho> withValueIfUndefined(boolean z) {
        L6 l6 = this.f1410a;
        return new UserProfileUpdate<>(new C0368k3(l6.c, z, l6.f642a, new Cl(l6.b)));
    }

    public UserProfileUpdate<? extends Ho> withValueReset() {
        L6 l6 = this.f1410a;
        return new UserProfileUpdate<>(new Vi(3, l6.c, l6.f642a, l6.b));
    }
}
