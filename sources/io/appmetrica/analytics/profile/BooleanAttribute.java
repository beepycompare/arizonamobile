...
import io.appmetrica.analytics.impl.C0366k3;
import io.appmetrica.analytics.impl.Cl;
import io.appmetrica.analytics.impl.Ho;
import io.appmetrica.analytics.impl.InterfaceC0676w2;
...
public class BooleanAttribute {
    ...
    public BooleanAttribute(String str, Vo vo, InterfaceC0676w2 interfaceC0676w2) {
        this.f1412a = new L6(str, vo, interfaceC0676w2);
    }

    public UserProfileUpdate<? extends Ho> withValue(boolean z) {
        L6 l6 = this.f1412a;
        return new UserProfileUpdate<>(new C0366k3(l6.c, z, l6.f644a, new J4(l6.b)));
    }

    public UserProfileUpdate<? extends Ho> withValueIfUndefined(boolean z) {
        L6 l6 = this.f1412a;
        return new UserProfileUpdate<>(new C0366k3(l6.c, z, l6.f644a, new Cl(l6.b)));
    }
