...
import io.appmetrica.analytics.impl.C0589se;
...
public final class NumberAttribute {
    ...
    private final L6 f1256a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public NumberAttribute(String str, Jb jb, Zb zb) {
        this.f1256a = new L6(str, jb, zb);
    }

    public UserProfileUpdate<? extends Yn> withValue(double d) {
        return new UserProfileUpdate<>(new C0589se(this.f1256a.c, d, new Jb(), new N4(new Zb(new H4(100)))));
    }

    public UserProfileUpdate<? extends Yn> withValueIfUndefined(double d) {
        return new UserProfileUpdate<>(new C0589se(this.f1256a.c, d, new Jb(), new Vk(new Zb(new H4(100)))));
    }

    public UserProfileUpdate<? extends Yn> withValueReset() {
        return new UserProfileUpdate<>(new Li(1, this.f1256a.c, new Jb(), new Zb(new H4(100))));
    }
}
