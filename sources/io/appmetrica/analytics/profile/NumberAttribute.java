...
public final class NumberAttribute {
    ...
    public NumberAttribute(String str, Qb qb, C0276gc c0276gc) {
        this.f1280a = new S6(str, qb, c0276gc);
    }

    public UserProfileUpdate<? extends InterfaceC0391ko> withValue(double d) {
        return new UserProfileUpdate<>(new Ae(this.f1280a.c, d, new Qb(), new Q4(new C0276gc(new K4(100)))));
    }

    public UserProfileUpdate<? extends InterfaceC0391ko> withValueIfUndefined(double d) {
        return new UserProfileUpdate<>(new Ae(this.f1280a.c, d, new Qb(), new C0311hl(new C0276gc(new K4(100)))));
    }

    public UserProfileUpdate<? extends InterfaceC0391ko> withValueReset() {
        return new UserProfileUpdate<>(new Xi(1, this.f1280a.c, new Qb(), new C0276gc(new K4(100))));
    }
}
