...
public class StringAttribute {
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withValue(String str) {
        S6 s6 = this.b;
        return new UserProfileUpdate<>(new C0287gn(s6.c, str, this.f1276a, s6.f662a, new Q4(s6.b)));
    }

    public UserProfileUpdate<? extends InterfaceC0391ko> withValueIfUndefined(String str) {
        S6 s6 = this.b;
        return new UserProfileUpdate<>(new C0287gn(s6.c, str, this.f1276a, s6.f662a, new C0311hl(s6.b)));
    }
