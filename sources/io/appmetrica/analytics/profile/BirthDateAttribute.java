...
public class BirthDateAttribute {
    ...
    private final O6 f1255a = new O6("appmetrica_birth_date", new C0627u8(), new C0740yl());

    final UserProfileUpdate a(Calendar calendar, String str, W2 w2) {
        return new UserProfileUpdate(new Xm(this.f1255a.c, new SimpleDateFormat(str).format(calendar.getTime()), new C0602t8(), new C0627u8(), w2));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0166bo> withValueReset() {
        return new UserProfileUpdate<>(new Oi(0, this.f1255a.c, new C0627u8(), new C0740yl()));
    }
