...
public class BirthDateAttribute {
    ...
    private final C0615u6 f1413a = new C0615u6("appmetrica_birth_date", new C0135b8(), new C0755zl());

    final UserProfileUpdate a(Calendar calendar, String str, K2 k2) {
        return new UserProfileUpdate(new Zm(this.f1413a.c, new SimpleDateFormat(str).format(calendar.getTime()), new C0109a8(), new C0135b8(), k2));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withAge(int i) {
        ...
        return a(gregorianCalendar, "yyyy", new C0588t4(this.f1413a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withBirthDate(int i, int i2) {
        ...
        return a(gregorianCalendar, "yyyy-MM", new C0588t4(this.f1413a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withBirthDateIfUndefined(int i, int i2) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, 1);
        return a(gregorianCalendar, "yyyy-MM", new Yk(this.f1413a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withBirthDate(int i, int i2, int i3) {
        ...
        return a(gregorianCalendar, "yyyy-MM-dd", new C0588t4(this.f1413a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withBirthDateIfUndefined(int i, int i2, int i3) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, i3);
        return a(gregorianCalendar, "yyyy-MM-dd", new Yk(this.f1413a.b));
    }
}
