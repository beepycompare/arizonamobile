...
public class BirthDateAttribute {
    ...
    private final L6 f1251a = new L6("appmetrica_birth_date", new C0558r8(), new C0671vl());

    final UserProfileUpdate a(Calendar calendar, String str, W2 w2) {
        return new UserProfileUpdate(new Um(this.f1251a.c, new SimpleDateFormat(str).format(calendar.getTime()), new C0534q8(), new C0558r8(), w2));
    }
    ...
    public UserProfileUpdate<? extends Yn> withAge(int i) {
        ...
        return a(gregorianCalendar, "yyyy", new N4(this.f1251a.b));
    }
    ...
    public UserProfileUpdate<? extends Yn> withAgeIfUndefined(int i) {
        ...
        GregorianCalendar gregorianCalendar = new GregorianCalendar();
        gregorianCalendar.set(1, i2);
        return a(gregorianCalendar, "yyyy", new Vk(this.f1251a.b));
    }

    public UserProfileUpdate<? extends Yn> withBirthDate(Calendar calendar) {
        return a(calendar, "yyyy-MM-dd", new N4(this.f1251a.b));
    }

    public UserProfileUpdate<? extends Yn> withBirthDateIfUndefined(Calendar calendar) {
        return a(calendar, "yyyy-MM-dd", new Vk(this.f1251a.b));
    }

    public UserProfileUpdate<? extends Yn> withValueReset() {
        return new UserProfileUpdate<>(new Li(0, this.f1251a.c, new C0558r8(), new C0671vl()));
    }
    ...
    public UserProfileUpdate<? extends Yn> withBirthDate(int i, int i2) {
        ...
        return a(gregorianCalendar, "yyyy-MM", new N4(this.f1251a.b));
    }
    ...
    public UserProfileUpdate<? extends Yn> withBirthDateIfUndefined(int i, int i2) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, 1);
        return a(gregorianCalendar, "yyyy-MM", new Vk(this.f1251a.b));
    }
    ...
    public UserProfileUpdate<? extends Yn> withBirthDate(int i, int i2, int i3) {
        ...
        return a(gregorianCalendar, "yyyy-MM-dd", new N4(this.f1251a.b));
    }
    ...
    public UserProfileUpdate<? extends Yn> withBirthDateIfUndefined(int i, int i2, int i3) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, i3);
        return a(gregorianCalendar, "yyyy-MM-dd", new Vk(this.f1251a.b));
    }
}
