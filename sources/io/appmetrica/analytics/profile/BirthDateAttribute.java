...
import io.appmetrica.analytics.impl.C0127am;
import io.appmetrica.analytics.impl.C0578s8;
...
public class BirthDateAttribute {
    ...
    private final L6 f1411a = new L6("appmetrica_birth_date", new C0604t8(), new C0127am());

    final UserProfileUpdate a(Calendar calendar, String str, W2 w2) {
        return new UserProfileUpdate(new An(this.f1411a.c, new SimpleDateFormat(str).format(calendar.getTime()), new C0578s8(), new C0604t8(), w2));
    }
    ...
    public UserProfileUpdate<? extends Ho> withValueReset() {
        return new UserProfileUpdate<>(new Vi(0, this.f1411a.c, new C0604t8(), new C0127am()));
    }
