...
public class BirthDateAttribute {
    ...
    private final C0594t6 f1421a = new C0594t6("appmetrica_birth_date", new C0114a8(), new C0734yl());

    final UserProfileUpdate a(Calendar calendar, String str, J2 j2) {
        return new UserProfileUpdate(new Ym(this.f1421a.c, new SimpleDateFormat(str).format(calendar.getTime()), new Z7(), new C0114a8(), j2));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0233eo> withAge(int i) {
        ...
        return a(gregorianCalendar, "yyyy", new C0567s4(this.f1421a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0233eo> withBirthDate(Calendar calendar) {
        return a(calendar, "yyyy-MM-dd", new C0567s4(this.f1421a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0233eo> withValueReset() {
        return new UserProfileUpdate<>(new Bi(0, this.f1421a.c, new C0114a8(), new C0734yl()));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0233eo> withBirthDate(int i, int i2) {
        ...
        return a(gregorianCalendar, "yyyy-MM", new C0567s4(this.f1421a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0233eo> withBirthDate(int i, int i2, int i3) {
        ...
        return a(gregorianCalendar, "yyyy-MM-dd", new C0567s4(this.f1421a.b));
    }
