...
public class BirthDateAttribute {
    ...
    private final S6 f1270a = new S6("appmetrica_birth_date", new C0754z8(), new Hl());

    final UserProfileUpdate a(Calendar calendar, String str, Z2 z2) {
        return new UserProfileUpdate(new C0287gn(this.f1270a.c, new SimpleDateFormat(str).format(calendar.getTime()), new C0729y8(), new C0754z8(), z2));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withAge(int i) {
        ...
        return a(gregorianCalendar, "yyyy", new Q4(this.f1270a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withBirthDate(int i, int i2) {
        ...
        return a(gregorianCalendar, "yyyy-MM", new Q4(this.f1270a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withBirthDateIfUndefined(int i, int i2) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, 1);
        return a(gregorianCalendar, "yyyy-MM", new C0311hl(this.f1270a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withBirthDate(int i, int i2, int i3) {
        ...
        return a(gregorianCalendar, "yyyy-MM-dd", new Q4(this.f1270a.b));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0391ko> withBirthDateIfUndefined(int i, int i2, int i3) {
        ...
        gregorianCalendar.set(2, i2 - 1);
        gregorianCalendar.set(5, i3);
        return a(gregorianCalendar, "yyyy-MM-dd", new C0311hl(this.f1270a.b));
    }
}
