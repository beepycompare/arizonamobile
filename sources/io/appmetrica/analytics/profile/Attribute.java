...
public final class Attribute {
    ...
    public static BooleanAttribute customBoolean(String str) {
        return new BooleanAttribute(str, new Qb(), new C0277gc(new K4(100)));
    }

    public static CounterAttribute customCounter(String str) {
        return new CounterAttribute(str, new Qb(), new C0277gc(new K4(100)));
    }

    public static NumberAttribute customNumber(String str) {
        return new NumberAttribute(str, new Qb(), new C0277gc(new K4(100)));
    }

    public static StringAttribute customString(String str) {
        return new StringAttribute(str, new C0262fn(200, "String attribute \"" + str + "\"", PublicLogger.getAnonymousInstance()), new Qb(), new C0277gc(new K4(100)));
    }
