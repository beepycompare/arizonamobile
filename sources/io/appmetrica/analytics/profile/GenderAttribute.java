...
public class GenderAttribute {
    ...
    private final C0615u6 f1418a = new C0615u6("appmetrica_gender", new C0135b8(), new C0755zl());
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withValue(Gender gender) {
        String str = this.f1418a.c;
        String stringValue = gender.getStringValue();
        C0109a8 c0109a8 = new C0109a8();
        C0615u6 c0615u6 = this.f1418a;
        return new UserProfileUpdate<>(new Zm(str, stringValue, c0109a8, c0615u6.f1241a, new C0588t4(c0615u6.b)));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0254fo> withValueIfUndefined(Gender gender) {
        ...
        C0109a8 c0109a8 = new C0109a8();
        C0615u6 c0615u6 = this.f1418a;
        return new UserProfileUpdate<>(new Zm(str, stringValue, c0109a8, c0615u6.f1241a, new Yk(c0615u6.b)));
    }
