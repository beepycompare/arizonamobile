...
public class GenderAttribute {
    ...
    private final O6 f1259a = new O6("appmetrica_gender", new C0627u8(), new C0740yl());
    ...
    public UserProfileUpdate<? extends InterfaceC0166bo> withValue(Gender gender) {
        String str = this.f1259a.c;
        String stringValue = gender.getStringValue();
        C0602t8 c0602t8 = new C0602t8();
        O6 o6 = this.f1259a;
        return new UserProfileUpdate<>(new Xm(str, stringValue, c0602t8, o6.f574a, new N4(o6.b)));
    }
    ...
    public UserProfileUpdate<? extends InterfaceC0166bo> withValueIfUndefined(Gender gender) {
        ...
        C0602t8 c0602t8 = new C0602t8();
        O6 o6 = this.f1259a;
        return new UserProfileUpdate<>(new Xm(str, stringValue, c0602t8, o6.f574a, new Yk(o6.b)));
    }
