    ...
    public synchronized void onBillingConfigChanged(BillingConfig billingConfig) {
        ...
        if (!Intrinsics.areEqual(this.g, billingConfig)) {
            ...
            if (billingConfig != null && !this.h) {
                this.h = true;
                BillingClient build = BillingClient.newBuilder(this.f368a).setListener(new l()).enablePendingPurchases(PendingPurchasesParams.newBuilder().enableOneTimeProducts().build()).build();
