...
public final class BillingLibraryMonitor implements BillingMonitor, n {
    ...
    public synchronized void onBillingConfigChanged(BillingConfig billingConfig) {
        ...
        if (billingConfig != null && !this.h) {
            this.h = true;
            BillingClient build = BillingClient.newBuilder(this.f250a).setListener(new l()).enablePendingPurchases(PendingPurchasesParams.newBuilder().enableOneTimeProducts().build()).build();
            try {
