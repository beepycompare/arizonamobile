...
public final class InternalModuleEvent {
    ...
    public static final class Category {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final /* synthetic */ Category[] f1359a;
    ...
    public String toString() {
        return "ModuleEvent{type=" + this.f1357a + ", name='" + this.b + "', value='" + this.c + "', serviceDataReporterType=" + this.d + ", category=" + this.e + ", environment=" + this.f + ", extras=" + this.g + ", attributes=" + this.h + AbstractJsonLexerKt.END_OBJ;
    }

    private InternalModuleEvent(Builder builder) {
        this.f1357a = builder.getType$modules_api_release();
