...
public final class InternalModuleEvent {
    ...
    public String toString() {
        return "ModuleEvent{type=" + this.f1378a + ", name='" + this.b + "', value='" + this.c + "', serviceDataReporterType=" + this.d + ", category=" + this.e + ", environment=" + this.f + ", extras=" + this.g + ", attributes=" + this.h + AbstractJsonLexerKt.END_OBJ;
    }

    private InternalModuleEvent(Builder builder) {
        this.f1378a = builder.getType$modules_api_release();
