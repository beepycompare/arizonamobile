...
public final class AppMetrica {
    public static void activate(Context context, AppMetricaConfig appMetricaConfig) {
        AbstractC0614u1.f1245a.a(context, appMetricaConfig);
    }

    public static void activateReporter(Context context, ReporterConfig reporterConfig) {
        AbstractC0614u1.f1245a.a(context, reporterConfig);
    }

    public static void clearAppEnvironment() {
        AbstractC0614u1.f1245a.a();
    }

    public static void enableActivityAutoTracking(Application application) {
        AbstractC0614u1.f1245a.a(application);
    }

    public static String getDeviceId(Context context) {
        return AbstractC0614u1.f1245a.b();
    }
    ...
    public static void resumeSession(Activity activity) {
        AbstractC0614u1.f1245a.c(activity);
    }

    public static void sendEventsBuffer() {
        AbstractC0614u1.f1245a.f();
    }

    public static void setAdvIdentifiersTracking(boolean z) {
        AbstractC0614u1.f1245a.a(z);
    }

    public static void setDataSendingEnabled(boolean z) {
        AbstractC0614u1.f1245a.b(z);
    }

    public static void setLocation(Location location) {
        AbstractC0614u1.f1245a.a(location);
    }

    public static void setLocationTracking(boolean z) {
        AbstractC0614u1.f1245a.c(z);
    }

    public static void setUserProfileID(String str) {
        AbstractC0614u1.f1245a.d(str);
    }

    public static void reportAppOpen(Intent intent) {
        AbstractC0614u1.f1245a.a(intent);
    }

    public static void reportError(String str, String str2, Throwable th) {
        AbstractC0614u1.f1245a.a(str, str2, th);
    }

    public static void reportEvent(String str, String str2) {
        AbstractC0614u1.f1245a.c(str, str2);
    }

    public static void reportAppOpen(String str) {
        AbstractC0614u1.f1245a.a(str);
    }

    public static void reportError(String str, Throwable th) {
        AbstractC0614u1.f1245a.a(str, th);
    }

    public static void reportEvent(String str, Map<String, Object> map) {
        AbstractC0614u1.f1245a.a(str, map);
    }
}
