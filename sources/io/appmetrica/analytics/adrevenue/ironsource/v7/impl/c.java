...
public final class c implements ImpressionDataListener {
    ...
    public final ClientContext f209a;
    public final b b = new b();

    public c(ClientContext clientContext) {
        this.f209a = clientContext;
    }

    public final void onImpressionSuccess(ImpressionData impressionData) {
        ModuleAdType moduleAdType;
        if (impressionData != null) {
            InternalClientModuleFacade internalClientModuleFacade = this.f209a.getInternalClientModuleFacade();
            this.b.getClass();
