...
public class IronSourceClientModuleEntryPoint extends ModuleClientEntryPoint<Object> {
    ...
    private ClientContext f230a = null;
    ...
    public void initClientSide(ClientContext clientContext) {
        this.f230a = clientContext;
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.client.ModuleClientEntryPoint
    public void onActivated() {
        ClientContext clientContext;
        if (!ReflectionUtils.detectClassExists("com.ironsource.mediationsdk.IronSource") || (clientContext = this.f230a) == null) {
            return;
        }
