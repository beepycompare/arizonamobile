...
public final class d implements BundleToServiceConfigConverter {
    ...
    public final ClientSideAdRevenueOtherConfigWrapper fromBundle(Bundle bundle) {
        boolean z = f.f238a;
        return ClientSideAdRevenueOtherConfigWrapper.Companion.toWrapper$ad_revenue_other_release(new e(bundle.getBoolean("enabled", f.f238a), bundle.getBoolean("include_source", f.b)));
    }
}
