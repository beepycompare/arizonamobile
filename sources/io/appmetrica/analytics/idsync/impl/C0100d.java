...
public final class C0100d implements Converter {
    ...
    public final byte[] a(IdSyncConfig idSyncConfig) {
        return MessageNano.toByteArray(this.f470a.fromModel(idSyncConfig));
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    public final Object fromModel(Object obj) {
        return MessageNano.toByteArray(this.f470a.fromModel((IdSyncConfig) obj));
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final IdSyncConfig toModel(byte[] bArr) {
        return this.f470a.toModel((m) MessageNano.mergeFrom(new m(), bArr));
    }
}
