...
public final class C0099c implements JsonParser {

    /* renamed from: a  reason: collision with root package name */
    public final C0101e f469a;
    ...
    public final IdSyncConfig parse(JSONObject jSONObject) {
        ...
        m mVar = new m();
        mVar.f479a = RemoteConfigJsonUtils.extractFeature(jSONObject, this.b, mVar.f479a);
        l lVar = new l();
        lVar.f478a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject, this.d, lVar.f478a);
        ...
        if (optJSONArray == null) {
            ...
            while (i3 < length) {
                ...
                if (optJSONObject2 == null) {
                    ...
                    kVar.f477a = optString.getBytes(charset);
                    ...
                    if (optJSONObject4 == null) {
                        ...
                        while (keys.hasNext()) {
                            ...
                            i iVar = new i();
                            iVar.f475a = next.getBytes(Charsets.UTF_8);
        ...
        lVar.b = kVarArr;
        mVar.b = lVar;
        return this.f469a.toModel(mVar);
    }
