...
public final class r implements s {
    ...
    public final void a(final String str, SdkIdentifiers sdkIdentifiers) {
        PlatformIdentifiers platformIdentifiers = this.f480a.getPlatformIdentifiers();
        AdvertisingIdsHolder identifiers = platformIdentifiers.getAdvIdentifiersProvider().getIdentifiers(this.f480a.getContext());
        ...
        final IHandlerExecutor supportIOExecutor = this.f480a.getExecutorProvider().getSupportIOExecutor();
