...
public final class F implements Converter {
    ...
    public final String f419a = "request_state";
        ...
        if (list != null) {
            ...
            for (E e : list) {
                try {
                    ...
                    jSONObject.put(this.b, e.f418a);
                    jSONObject.put(this.c, e.b);
                    jSONObject.put(this.d, e.c.f415a);
    ...
    public final List<E> toModel(String str) {
        ...
        try {
            ...
            if (str != null && (optJSONArray = new JSONObject(str).optJSONArray(this.f419a)) != null) {
    ...
    public final E a(JSONObject jSONObject) {
        ...
        try {
            ...
            while (true) {
                ...
                a2 = values[i];
                if (Intrinsics.areEqual(a2.f415a, string2)) {
                    break;
                }
                i++;
            }
