...
public final class i extends MessageNano {
    ...
    public final i a() {
        this.f425a = WireFormatNano.EMPTY_BYTES;
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f425a, WireFormatNano.EMPTY_BYTES)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f425a);
        }
        byte[][] bArr = this.b;
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f425a, WireFormatNano.EMPTY_BYTES)) {
            codedOutputByteBufferNano.writeBytes(1, this.f425a);
        }
        byte[][] bArr = this.b;
        if (bArr != null && bArr.length > 0) {
            int i = 0;
    ...
    public final i mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f425a = codedInputByteBufferNano.readBytes();
            } else if (readTag != 18) {
