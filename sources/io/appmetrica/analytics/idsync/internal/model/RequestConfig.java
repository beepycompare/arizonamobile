...
public final class RequestConfig {
    ...
    public int hashCode() {
        ...
        int hashCode2 = this.f490a.hashCode();
    ...
    public String toString() {
        return "RequestConfig(type='" + this.f490a + "', url='" + this.b + "', preconditions=" + this.c + ", headers=" + this.d + ", resendIntervalForValidResponse=" + this.e + ", resendIntervalForInvalidResponse=" + this.f + ", validResponseCodes=" + this.g + ", reportEventEnabled=" + this.h + ", reportUrl=" + this.i + ')';
    }
}
