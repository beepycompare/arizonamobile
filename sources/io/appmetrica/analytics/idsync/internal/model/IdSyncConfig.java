...
public final class IdSyncConfig {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(IdSyncConfig.class, obj != null ? obj.getClass() : null)) {
            ...
            return this.f441a == idSyncConfig.f441a && this.b == idSyncConfig.b && Intrinsics.areEqual(this.c, idSyncConfig.c);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return this.c.hashCode() + ((hashCode + (Boolean.hashCode(this.f441a) * 31)) * 31);
    }

    public String toString() {
        return "IdSyncConfig(enabled=" + this.f441a + ", launchDelay=" + this.b + ", requests=" + this.c + ')';
    }
}
