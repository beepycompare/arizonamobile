...
public final class IdSyncConfig {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(IdSyncConfig.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f486a == idSyncConfig.f486a && this.b == idSyncConfig.b && Intrinsics.areEqual(this.c, idSyncConfig.c);
            }
    ...
    public int hashCode() {
        ...
        return this.c.hashCode() + ((hashCode + (Boolean.hashCode(this.f486a) * 31)) * 31);
    }

    public String toString() {
        return "IdSyncConfig(enabled=" + this.f486a + ", launchDelay=" + this.b + ", requests=" + this.c + ')';
    }
}
