...
public class AdvIdentifiersProvider {
    ...
    public static Bundle requestIdentifiers(Context context, Bundle bundle) {
        c a2;
        b bVar = (b) retriever.f446a.get(bundle.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
        ...
        if (aVar != null) {
            ...
            bundle3.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", aVar.f444a);
        ...
        bundle2.putString("io.appmetrica.analytics.identifiers.extra.STATUS", a2.f445a.getValue());
