...
public final class LocationFilter {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(LocationFilter.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1264a == locationFilter.f1264a && this.b == locationFilter.b;
            }
    ...
    public int hashCode() {
        return Float.hashCode(this.b) + (Long.hashCode(this.f1264a) * 31);
    }

    public String toString() {
        return "LocationFilter(updateTimeInterval=" + this.f1264a + ", updateDistanceInterval=" + this.b + ')';
    }
