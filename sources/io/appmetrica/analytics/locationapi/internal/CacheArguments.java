...
public final class CacheArguments {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(CacheArguments.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1345a == cacheArguments.f1345a && this.b == cacheArguments.b;
            }
    ...
    public int hashCode() {
        return Long.hashCode(this.b) + (Long.hashCode(this.f1345a) * 31);
    }

    public String toString() {
        return "CacheArguments(refreshPeriod=" + this.f1345a + ", outdatedTimeInterval=" + this.b + ')';
    }
