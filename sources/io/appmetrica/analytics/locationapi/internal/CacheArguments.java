...
public final class CacheArguments {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(CacheArguments.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1263a == cacheArguments.f1263a && this.b == cacheArguments.b;
            }
    ...
    public int hashCode() {
        return Long.hashCode(this.b) + (Long.hashCode(this.f1263a) * 31);
    }

    public String toString() {
        return "CacheArguments(refreshPeriod=" + this.f1263a + ", outdatedTimeInterval=" + this.b + ')';
    }
