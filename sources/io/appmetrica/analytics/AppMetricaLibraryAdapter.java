...
import io.appmetrica.analytics.impl.C0699x4;
...
public class AppMetricaLibraryAdapter {
    ...
    public static void activate(Context context) {
        ...
        if (a0.f328a.f700a.a(context).f975a) {
            ...
            xb.getClass();
            C0699x4.l().g.a(applicationContext);
            C0699x4.l().b().a(applicationContext, AppMetricaLibraryAdapterConfig.newConfigBuilder().build());
            return;
        }
    ...
    public static void activate(Context context, AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        ...
        if (wb.f700a.a(context).f975a && wb.b.a(appMetricaLibraryAdapterConfig).f975a) {
            ...
            xb.getClass();
            C0699x4.l().g.a(applicationContext);
            C0699x4.l().b().a(applicationContext, appMetricaLibraryAdapterConfig);
            return;
        }
