...
public final class C0777l {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0777l.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return Intrinsics.areEqual(this.f1318a, c0777l.f1318a) && Intrinsics.areEqual(this.b, c0777l.b) && Intrinsics.areEqual(this.c, c0777l.c);
            }
    ...
    public final String toString() {
        return "ClientSideScreenshotConfig(apiCaptorConfig=" + this.f1318a + ", serviceCaptorConfig=" + this.b + ", contentObserverCaptorConfig=" + this.c + ')';
    }
