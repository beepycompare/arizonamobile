...
public final class C0761d implements T {
    ...
    public final void a(C0770m c0770m) {
        this.c = c0770m != null ? c0770m.f1470a : null;
    }
    ...
    public final void a() {
        if (AndroidUtils.isApiAchieved(34)) {
            this.f1456a.getActivityLifecycleRegistry().registerListener(new C0760c(this), ActivityEvent.STARTED, ActivityEvent.STOPPED);
        }
    }
}
