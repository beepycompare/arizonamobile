...
public final class G extends ContentObserver {
    ...
    public final ClientContext f1436a;
    ...
    public final void onChange(boolean z, Uri uri) {
        ...
        try {
            ...
            Cursor query = this.f1436a.getContext().getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, strArr, "date_added >= ?", new String[]{String.valueOf(new SystemTimeProvider().currentTimeSeconds() - c0788j.c)}, "date_added DESC");
