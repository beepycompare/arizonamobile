...
public final class C0762d implements T {
    ...
    public final void a(C0771m c0771m) {
        this.c = c0771m != null ? c0771m.f1373a : null;
    }
    ...
    public final void a() {
        if (AndroidUtils.isApiAchieved(34)) {
            this.f1359a.getActivityLifecycleRegistry().registerListener(new C0761c(this), ActivityEvent.STARTED, ActivityEvent.STOPPED);
        }
    }
}
