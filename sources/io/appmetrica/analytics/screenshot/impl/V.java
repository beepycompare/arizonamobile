...
public final class V implements Converter {
    ...
    public final N fromModel(T t) {
        N n = new N();
        C0770e c0770e = t.f1296a;
        n.f1293a = c0770e != null ? this.f1298a.fromModel(c0770e) : null;
        X x = t.b;
    ...
    public final T toModel(N n) {
        ...
        K k = n.f1293a;
        if (k != null) {
            this.f1298a.getClass();
            c0770e = new C0770e(k.f1290a);
        } else {
            c0770e = null;
        }
        M m = n.b;
