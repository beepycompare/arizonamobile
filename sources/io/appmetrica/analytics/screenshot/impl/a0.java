...
public final class a0 implements Runnable {
    ...
    public static final Boolean a(d0 d0Var, a0 a0Var, C0781m c0781m, ActivityManager activityManager) {
        Object obj;
        ...
        if (((ActivityManager.RunningServiceInfo) obj) != null) {
            ((C0789v) d0Var.b).a("ServiceScreenshotCaptor");
        }
        return Boolean.valueOf(d0Var.c.postDelayed(a0Var, TimeUnit.SECONDS.toMillis(c0781m.b)));
    }

    @Override // java.lang.Runnable
    public final void run() {
        final C0781m c0781m = this.f1292a.e;
        if (this.f1292a.d || c0781m == null || !c0781m.f1309a) {
            return;
        }
        ...
        SystemServiceUtils.accessSystemServiceByNameSafely(context, "activity", "running service screenshot captor", "ActivityManager", new FunctionWithThrowable() { // from class: io.appmetrica.analytics.screenshot.impl.a0$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return a0.a(d0.this, this, c0781m, (ActivityManager) obj);
            }
        });
    }
}
