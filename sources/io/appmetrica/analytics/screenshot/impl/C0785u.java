...
public final class C0785u implements P {
    ...
    @Override // io.appmetrica.analytics.screenshot.impl.P
    public final void a() {
        this.f1325a.getActivityLifecycleRegistry().registerListener(new C0784t(this), ActivityEvent.RESUMED, ActivityEvent.PAUSED);
    }
}
