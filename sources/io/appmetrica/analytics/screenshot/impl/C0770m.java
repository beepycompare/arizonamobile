...
public final class C0770m {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0770m.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return Intrinsics.areEqual(this.f1471a, c0770m.f1471a) && Intrinsics.areEqual(this.b, c0770m.b) && Intrinsics.areEqual(this.c, c0770m.c);
            }
    ...
    public final String toString() {
        return "ClientSideScreenshotConfig(apiCaptorConfig=" + this.f1471a + ", serviceCaptorConfig=" + this.b + ", contentObserverCaptorConfig=" + this.c + ')';
    }
