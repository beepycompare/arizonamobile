...
public final class C0772l {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0772l.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1482a == c0772l.f1482a && Intrinsics.areEqual(this.b, c0772l.b);
            }
    ...
    public final int hashCode() {
        int hashCode = Boolean.hashCode(this.f1482a) * 31;
        C0773m c0773m = this.b;
        return hashCode + (c0773m != null ? c0773m.hashCode() : 0);
    }

    public final String toString() {
        return "ClientSideRemoteScreenshotConfig(enabled=" + this.f1482a + ", config=" + this.b + ')';
    }
}
