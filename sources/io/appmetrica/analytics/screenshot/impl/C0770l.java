...
public final class C0770l {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0770l.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1371a == c0770l.f1371a && Intrinsics.areEqual(this.b, c0770l.b);
            }
    ...
    public final int hashCode() {
        int hashCode = Boolean.hashCode(this.f1371a) * 31;
        C0771m c0771m = this.b;
        return hashCode + (c0771m != null ? c0771m.hashCode() : 0);
    }

    public final String toString() {
        return "ClientSideRemoteScreenshotConfig(enabled=" + this.f1371a + ", config=" + this.b + ')';
    }
}
