...
public final class C0771n {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0771n.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1457a == c0771n.f1457a && this.b == c0771n.b;
            }
    ...
    public final int hashCode() {
        return Long.hashCode(this.b) + (Boolean.hashCode(this.f1457a) * 31);
    }

    public final String toString() {
        return "ClientSideServiceCaptorConfig(enabled=" + this.f1457a + ", delaySeconds=" + this.b + ')';
    }
