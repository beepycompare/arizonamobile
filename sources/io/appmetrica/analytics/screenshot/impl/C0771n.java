...
public final class C0771n {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0771n.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1472a == c0771n.f1472a && this.b == c0771n.b;
            }
    ...
    public final int hashCode() {
        return Long.hashCode(this.b) + (Boolean.hashCode(this.f1472a) * 31);
    }

    public final String toString() {
        return "ClientSideServiceCaptorConfig(enabled=" + this.f1472a + ", delaySeconds=" + this.b + ')';
    }
