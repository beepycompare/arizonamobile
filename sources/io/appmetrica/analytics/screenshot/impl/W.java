...
public final class W extends ContentObserver {
    ...
    public final ClientContext f1299a;
    ...
    public final void onChange(boolean z, Uri uri) {
        ...
        try {
            ...
            Cursor query = this.f1299a.getContext().getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, strArr, "date_added >= ?", new String[]{String.valueOf(new SystemTimeProvider().currentTimeSeconds() - c0775j.c)}, "date_added DESC");
