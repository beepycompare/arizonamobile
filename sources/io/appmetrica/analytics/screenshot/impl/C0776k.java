...
public final class C0776k {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0776k.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1317a == c0776k.f1317a && Intrinsics.areEqual(this.b, c0776k.b);
            }
    ...
    public final int hashCode() {
        int hashCode = Boolean.hashCode(this.f1317a) * 31;
        C0777l c0777l = this.b;
        return hashCode + (c0777l != null ? c0777l.hashCode() : 0);
    }

    public final String toString() {
        return "ClientSideRemoteScreenshotConfig(enabled=" + this.f1317a + ", config=" + this.b + ')';
    }
}
