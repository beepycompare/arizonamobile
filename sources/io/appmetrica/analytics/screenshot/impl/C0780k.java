...
public final class C0780k {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0780k.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1322a == c0780k.f1322a && Intrinsics.areEqual(this.b, c0780k.b);
            }
    ...
    public final int hashCode() {
        int hashCode = Boolean.hashCode(this.f1322a) * 31;
        C0781l c0781l = this.b;
        return hashCode + (c0781l != null ? c0781l.hashCode() : 0);
    }

    public final String toString() {
        return "ClientSideRemoteScreenshotConfig(enabled=" + this.f1322a + ", config=" + this.b + ')';
    }
}
