...
public final class C0769l {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0769l.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return this.f1469a == c0769l.f1469a && Intrinsics.areEqual(this.b, c0769l.b);
            }
    ...
    public final int hashCode() {
        int hashCode = Boolean.hashCode(this.f1469a) * 31;
        C0770m c0770m = this.b;
        return hashCode + (c0770m != null ? c0770m.hashCode() : 0);
    }

    public final String toString() {
        return "ClientSideRemoteScreenshotConfig(enabled=" + this.f1469a + ", config=" + this.b + ')';
    }
}
