...
public final class L implements JsonParser {
    ...
    public final J parse(JSONObject jSONObject) {
        ...
        P p;
        Q q;
        boolean z = AbstractC0775o.f1486a;
        boolean extractFeature = RemoteConfigJsonUtils.extractFeature(jSONObject, "screenshot", AbstractC0775o.f1486a);
        Y y = this.f1454a;
        X x = this.b;
        x.getClass();
        ...
        if (optJSONObject == null) {
            ...
            if (optJSONObject2 == null) {
                ...
                if (optBooleanOrNull != null) {
                    n.f1456a = optBooleanOrNull.booleanValue();
                }
            }
            if (n != null) {
                q2.f1459a = n;
            ...
            if (optJSONObject3 == null) {
                ...
                if (optBooleanOrNull2 != null) {
                    p.f1458a = optBooleanOrNull2.booleanValue();
                }
            ...
            if (optJSONObject4 != null) {
                ...
                if (optBooleanOrNull3 != null) {
                    o2.f1457a = optBooleanOrNull3.booleanValue();
                }
