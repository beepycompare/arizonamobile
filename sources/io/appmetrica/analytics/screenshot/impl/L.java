...
public final class L implements JsonParser {
    ...
    public final J parse(JSONObject jSONObject) {
        ...
        P p;
        Q q;
        boolean z = AbstractC0772o.f1473a;
        boolean extractFeature = RemoteConfigJsonUtils.extractFeature(jSONObject, "screenshot", AbstractC0772o.f1473a);
        Y y = this.f1441a;
        X x = this.b;
        x.getClass();
        ...
        if (optJSONObject == null) {
            ...
            if (optJSONObject2 == null) {
                ...
                if (optBooleanOrNull != null) {
                    n.f1443a = optBooleanOrNull.booleanValue();
                }
            }
            if (n != null) {
                q2.f1446a = n;
            ...
            if (optJSONObject3 == null) {
                ...
                if (optBooleanOrNull2 != null) {
                    p.f1445a = optBooleanOrNull2.booleanValue();
                }
            ...
            if (optJSONObject4 != null) {
                ...
                if (optBooleanOrNull3 != null) {
                    o2.f1444a = optBooleanOrNull3.booleanValue();
                }
