...
public final class C0778v implements T {
    ...
    @Override // io.appmetrica.analytics.screenshot.impl.T
    public final void a() {
        this.f1463a.getActivityLifecycleRegistry().registerListener(new C0777u(this), ActivityEvent.RESUMED, ActivityEvent.PAUSED);
    }
}
