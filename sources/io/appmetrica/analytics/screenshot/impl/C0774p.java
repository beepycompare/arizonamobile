...
public final class C0774p {
    ...
    public final String toString() {
        return "ContentObserverCaptorConfig(enabled=" + this.f1376a + ", mediaStoreColumnNames='" + this.b + "', detectWindowSeconds=" + this.c + ')';
    }

    public C0774p() {
        this(new O().f1346a, ArraysKt.toList(new O().c), new O().b);
    }
}
