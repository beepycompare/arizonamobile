...
public final class C0781l {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(C0781l.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                ...
                return Intrinsics.areEqual(this.f1327a, c0781l.f1327a) && Intrinsics.areEqual(this.b, c0781l.b) && Intrinsics.areEqual(this.c, c0781l.c);
            }
    ...
    public final String toString() {
        return "ClientSideScreenshotConfig(apiCaptorConfig=" + this.f1327a + ", serviceCaptorConfig=" + this.b + ", contentObserverCaptorConfig=" + this.c + ')';
    }
