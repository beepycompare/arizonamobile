...
public final class I implements JsonParser {
    ...
    public final G parse(JSONObject jSONObject) {
        ...
        M m;
        N n;
        boolean z = AbstractC0783n.f1325a;
        boolean extractFeature = RemoteConfigJsonUtils.extractFeature(jSONObject, "screenshot", AbstractC0783n.f1325a);
        V v = this.f1293a;
        U u = this.b;
        u.getClass();
        ...
        if (optJSONObject == null) {
            ...
            if (optJSONObject2 == null) {
                ...
                if (optBooleanOrNull != null) {
                    k.f1295a = optBooleanOrNull.booleanValue();
                }
            }
            if (k != null) {
                n2.f1298a = k;
            ...
            if (optJSONObject3 == null) {
                ...
                if (optBooleanOrNull2 != null) {
                    m.f1297a = optBooleanOrNull2.booleanValue();
                }
            ...
            if (optJSONObject4 != null) {
                ...
                if (optBooleanOrNull3 != null) {
                    l2.f1296a = optBooleanOrNull3.booleanValue();
                }
