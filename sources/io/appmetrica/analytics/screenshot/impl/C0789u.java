...
public final class C0789u implements P {
    ...
    @Override // io.appmetrica.analytics.screenshot.impl.P
    public final void a() {
        this.f1330a.getActivityLifecycleRegistry().registerListener(new C0788t(this), ActivityEvent.RESUMED, ActivityEvent.PAUSED);
    }
}
