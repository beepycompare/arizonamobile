...
public class ECommerceCartItem {
    ...
    private final ECommerceProduct f388a;
    ...
    public String toString() {
        return "ECommerceCartItem{product=" + this.f388a + ", quantity=" + this.b + ", revenue=" + this.c + ", referrer=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }
