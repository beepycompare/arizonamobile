...
public class ECommerceCartItem {
    ...
    private final ECommerceProduct f387a;
    ...
    public String toString() {
        return "ECommerceCartItem{product=" + this.f387a + ", quantity=" + this.b + ", revenue=" + this.c + ", referrer=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }
