...
public class NetworkCore extends InterruptionSafeThread {
    ...
    private final LinkedBlockingQueue f1398a;
    ...
    public void run() {
        ...
        while (isRunning()) {
            try {
                ...
                this.d = (d) this.f1398a.take();
                networkTask = this.d.f1387a;
    ...
    public void startTask(NetworkTask networkTask) {
        if (this.f.canBeExecuted()) {
            synchronized (this.b) {
                ...
                if (isRunning() && !this.f1398a.contains(dVar) && !dVar.equals(this.d) && networkTask.onTaskAdded()) {
                    this.f1398a.offer(dVar);
                }
            }
        }
    }
    ...
    public void stopTasks() {
        synchronized (this.c) {
            ArrayList arrayList = new ArrayList(this.f1398a.size());
            this.f1398a.drainTo(arrayList);
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                ((d) it.next()).f1387a.onTaskRemoved();
            }
        }
    }
