...
public final class SdkInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SdkInfo) {
            ...
            return Intrinsics.areEqual(this.f331a, sdkInfo.f331a) && Intrinsics.areEqual(this.b, sdkInfo.b) && Intrinsics.areEqual(this.c, sdkInfo.c);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return this.c.hashCode() + ((hashCode + (this.f331a.hashCode() * 31)) * 31);
    }

    public String toString() {
        return "SdkInfo(sdkVersionName=" + this.f331a + ", sdkBuildNumber=" + this.b + ", sdkBuildType=" + this.c + ')';
    }
}
