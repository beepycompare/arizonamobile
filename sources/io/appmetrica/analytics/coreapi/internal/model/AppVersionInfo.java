...
public final class AppVersionInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AppVersionInfo) {
            ...
            return Intrinsics.areEqual(this.f261a, appVersionInfo.f261a) && Intrinsics.areEqual(this.b, appVersionInfo.b);
        }
        return false;
    }
    ...
    public String toString() {
        return "AppVersionInfo(appVersionName=" + this.f261a + ", appBuildNumber=" + this.b + ')';
    }
}
