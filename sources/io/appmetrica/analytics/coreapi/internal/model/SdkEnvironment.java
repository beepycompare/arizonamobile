...
public final class SdkEnvironment {
    ...
    private final AppVersionInfo f258a;
    ...
    public static /* synthetic */ SdkEnvironment copy$default(SdkEnvironment sdkEnvironment, AppVersionInfo appVersionInfo, String str, ScreenInfo screenInfo, SdkInfo sdkInfo, String str2, List list, int i, Object obj) {
        if ((i & 1) != 0) {
            appVersionInfo = sdkEnvironment.f258a;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SdkEnvironment) {
            ...
            return Intrinsics.areEqual(this.f258a, sdkEnvironment.f258a) && Intrinsics.areEqual(this.b, sdkEnvironment.b) && Intrinsics.areEqual(this.c, sdkEnvironment.c) && Intrinsics.areEqual(this.d, sdkEnvironment.d) && Intrinsics.areEqual(this.e, sdkEnvironment.e) && Intrinsics.areEqual(this.f, sdkEnvironment.f);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return this.f.hashCode() + ((hashCode4 + ((hashCode3 + ((hashCode2 + ((hashCode + (this.f258a.hashCode() * 31)) * 31)) * 31)) * 31)) * 31);
    }

    public String toString() {
        return "SdkEnvironment(appVersionInfo=" + this.f258a + ", appFramework=" + this.b + ", screenInfo=" + this.c + ", sdkInfo=" + this.d + ", deviceType=" + this.e + ", locales=" + this.f + ')';
    }
}
