...
public final class ScreenInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScreenInfo) {
            ...
            return this.f249a == screenInfo.f249a && this.b == screenInfo.b && this.c == screenInfo.c && Intrinsics.areEqual((Object) Float.valueOf(this.d), (Object) Float.valueOf(screenInfo.d));
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return Float.hashCode(this.d) + ((hashCode2 + ((hashCode + (Integer.hashCode(this.f249a) * 31)) * 31)) * 31);
    }

    public String toString() {
        return "ScreenInfo(width=" + this.f249a + ", height=" + this.b + ", dpi=" + this.c + ", scaleFactor=" + this.d + ')';
    }
}
