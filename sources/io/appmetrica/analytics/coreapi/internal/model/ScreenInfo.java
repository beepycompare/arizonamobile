...
public final class ScreenInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScreenInfo) {
            ...
            return this.f256a == screenInfo.f256a && this.b == screenInfo.b && this.c == screenInfo.c && Intrinsics.areEqual((Object) Float.valueOf(this.d), (Object) Float.valueOf(screenInfo.d));
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return Float.hashCode(this.d) + ((hashCode2 + ((hashCode + (Integer.hashCode(this.f256a) * 31)) * 31)) * 31);
    }

    public String toString() {
        return "ScreenInfo(width=" + this.f256a + ", height=" + this.b + ", dpi=" + this.c + ", scaleFactor=" + this.d + ')';
    }
}
