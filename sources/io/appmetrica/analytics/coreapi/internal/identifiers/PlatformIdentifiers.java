...
public final class PlatformIdentifiers {
    ...
    private final SimpleAdvertisingIdGetter f376a;
    ...
    public PlatformIdentifiers(SimpleAdvertisingIdGetter simpleAdvertisingIdGetter, AppSetIdProvider appSetIdProvider) {
        this.f376a = simpleAdvertisingIdGetter;
    ...
    public static /* synthetic */ PlatformIdentifiers copy$default(PlatformIdentifiers platformIdentifiers, SimpleAdvertisingIdGetter simpleAdvertisingIdGetter, AppSetIdProvider appSetIdProvider, int i, Object obj) {
        if ((i & 1) != 0) {
            simpleAdvertisingIdGetter = platformIdentifiers.f376a;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PlatformIdentifiers) {
            ...
            return Intrinsics.areEqual(this.f376a, platformIdentifiers.f376a) && Intrinsics.areEqual(this.b, platformIdentifiers.b);
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.b.hashCode() + (this.f376a.hashCode() * 31);
    }

    public String toString() {
        return "PlatformIdentifiers(advIdentifiersProvider=" + this.f376a + ", appSetIdProvider=" + this.b + ')';
    }
}
