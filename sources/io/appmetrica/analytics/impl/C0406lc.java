...
public final class C0406lc implements InterfaceC0380kc, InterfaceC0619tm, LocationProvider {

    /* renamed from: a  reason: collision with root package name */
    public final Context f970a;
    public final InterfaceC0510pc b;
    ...
    public C0406lc(Context context, InterfaceC0510pc interfaceC0510pc, LocationClient locationClient) {
        this.f970a = context;
        this.b = interfaceC0510pc;
        this.c = locationClient;
        C0634uc c0634uc = new C0634uc();
        this.d = new Cl(new H5(c0634uc, Na.j().o().getAskForPermissionStrategy()));
        this.e = Na.j().o();
        ((C0584sc) interfaceC0510pc).a(c0634uc, true);
        ((C0584sc) interfaceC0510pc).a(locationClient, true);
    ...
    @Override // io.appmetrica.analytics.impl.InterfaceC0380kc, io.appmetrica.analytics.impl.InterfaceC0458nc
    public final void init() {
        this.c.init(this.f970a, this.d, Na.F.d.c(), this.e.e());
        ...
        ((C0584sc) this.b).a(this.e.g());
        Na.F.u.a(this);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.service.LocationServiceApi
    public final void registerControllerObserver(LocationControllerObserver locationControllerObserver) {
        ((C0584sc) this.b).a(locationControllerObserver, true);
    }
