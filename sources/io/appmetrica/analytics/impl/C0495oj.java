...
public final class C0495oj implements SdkEnvironmentProvider {

    /* renamed from: a  reason: collision with root package name */
    public final Context f976a;
    public final C0162bc b = new C0162bc();
    public final CopyOnWriteArrayList c = new CopyOnWriteArrayList();
    public SdkEnvironment d;
    public String e;

    public C0495oj(Context context) {
        this.f976a = context;
        this.d = new SdkEnvironment(new AppVersionInfo(PackageManagerUtils.getAppVersionName(context), PackageManagerUtils.getAppVersionCodeString(context)), FrameworkDetector.framework(), new ScreenInfo(0, 0, 0, 0.0f), new SdkInfo("7.9.0", "50132373", AbstractC0520pj.a()), "phone", C0162bc.a(context.getResources().getConfiguration()));
    }
            ...
            if (!Intrinsics.areEqual(screenInfo, getSdkEnvironment().getScreenInfo())) {
                ...
                if (str == null) {
                    ...
                    if (f == 0.0f) {
                        ...
                        if (sqrt >= 15.0d && !Se.f625a.hasSystemFeature(context, "android.hardware.touchscreen")) {
                            str = "tv";
                        } else {
                ...
                while (it.hasNext()) {
                    ((H5) ((InterfaceC0470nj) it.next())).d();
                }
            }
        }
    }

    public final void b(InterfaceC0470nj interfaceC0470nj) {
        this.c.remove(interfaceC0470nj);
    }
    ...
    public final synchronized void a(Configuration configuration) {
        this.b.getClass();
        List a2 = C0162bc.a(configuration);
    ...
    public final void a(InterfaceC0470nj interfaceC0470nj) {
        this.c.add(interfaceC0470nj);
    }
}
