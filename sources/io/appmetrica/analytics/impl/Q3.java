...
public final class Q3 {
    ...
    public static Q3 a(I3 i3) {
        return new Q3(i3.b.getApiKey(), i3.f615a.f529a.getAsString("PROCESS_CFG_PACKAGE_NAME"), i3.f615a.f529a.getAsInteger("PROCESS_CFG_PROCESS_ID"), i3.f615a.f529a.getAsString("PROCESS_CFG_PROCESS_SESSION_ID"), i3.b.getReporterType());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && Q3.class == obj.getClass()) {
            ...
            if (str == null ? q3.f744a != null : !str.equals(q3.f744a)) {
                return false;
            }
    ...
    public final String toString() {
        return "ClientDescription{mApiKey='" + this.f744a + "', mPackageName='" + this.b + "', mProcessID=" + this.c + ", mProcessSessionID='" + this.d + "', mReporterType=" + this.e + AbstractJsonLexerKt.END_OBJ;
    }
}
