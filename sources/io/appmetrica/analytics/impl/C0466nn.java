...
public final class C0466nn extends AbstractC0621tn {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0459ng("preload_info_data", iBinaryDataHelper, new T8(r1, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new Ff());
    }
}
