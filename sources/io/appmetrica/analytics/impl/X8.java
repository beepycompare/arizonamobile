...
public final class X8 extends Ff {
    ...
    public final HashMap a() {
        ...
        hashMap.put(EnumC0142bb.EVENT_TYPE_ACTIVATION, new C0285h(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_START, new El(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_REGULAR, new Gg(this.f855a));
        C0323ib c0323ib = new C0323ib(this.f855a);
        ...
        C0555ri c0555ri = this.f855a;
        hashMap.put(enumC0142bb, new C0758zl(c0555ri, c0555ri.t));
        hashMap.put(EnumC0142bb.EVENT_TYPE_APP_OPEN, new Ng(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_PURGE_BUFFER, new Rf(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new C0568s6(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new C0652vf(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new Vn(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new C0677wf(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new Un(this.f855a));
        hashMap.put(EnumC0142bb.EVENT_TYPE_ANR, c0323ib);
        EnumC0142bb enumC0142bb2 = EnumC0142bb.EVENT_TYPE_APP_ENVIRONMENT_UPDATED;
        C0555ri c0555ri2 = this.f855a;
        ...
        hashMap.put(EnumC0142bb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new E9(this.f855a));
        return hashMap;
    }
