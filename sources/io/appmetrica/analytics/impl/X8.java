...
public final class X8 extends Ff {
    ...
    public final HashMap a() {
        ...
        hashMap.put(EnumC0143bb.EVENT_TYPE_ACTIVATION, new C0286h(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_START, new El(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_REGULAR, new Gg(this.f850a));
        C0324ib c0324ib = new C0324ib(this.f850a);
        ...
        C0556ri c0556ri = this.f850a;
        hashMap.put(enumC0143bb, new C0759zl(c0556ri, c0556ri.t));
        hashMap.put(EnumC0143bb.EVENT_TYPE_APP_OPEN, new Ng(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_PURGE_BUFFER, new Rf(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new C0569s6(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new C0653vf(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new Vn(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new C0678wf(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new Un(this.f850a));
        hashMap.put(EnumC0143bb.EVENT_TYPE_ANR, c0324ib);
        EnumC0143bb enumC0143bb2 = EnumC0143bb.EVENT_TYPE_APP_ENVIRONMENT_UPDATED;
        C0556ri c0556ri2 = this.f850a;
        ...
        hashMap.put(EnumC0143bb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new E9(this.f850a));
        return hashMap;
    }
