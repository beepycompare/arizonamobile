...
public final class C0203d9 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f815a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f815a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f815a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f815a);
        }
    ...
    public final C0203d9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f815a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
