...
public final class C0239f9 extends MessageNano {
    ...
    public static volatile C0239f9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f971a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0110a9 c0110a9 = this.f;
        if (c0110a9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0110a9);
        }
        C0213e9 c0213e9 = this.g;
        if (c0213e9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0213e9);
        }
        if (!this.h.equals("")) {
        ...
        C0188d9[] c0188d9Arr = this.s;
        if (c0188d9Arr != null && c0188d9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0188d9[] c0188d9Arr2 = this.s;
                if (i6 >= c0188d9Arr2.length) {
                    break;
                }
                C0188d9 c0188d9 = c0188d9Arr2[i6];
                if (c0188d9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0188d9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f971a);
        ...
        C0110a9 c0110a9 = this.f;
        if (c0110a9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0110a9);
        }
        C0213e9 c0213e9 = this.g;
        if (c0213e9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0213e9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0188d9Arr != null && c0188d9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0188d9 c0188d9 = c0188d9Arr2[i6];
                if (c0188d9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0188d9);
                }
                i6++;
            }
        }
    ...
    public static C0239f9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0239f9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0239f9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f971a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0188d9[] c0188d9Arr = this.s;
                    int length = c0188d9Arr == null ? 0 : c0188d9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0188d9[] c0188d9Arr2 = new C0188d9[i];
                    if (length != 0) {
                        System.arraycopy(c0188d9Arr, 0, c0188d9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0188d9 c0188d9 = new C0188d9();
                        c0188d9Arr2[length] = c0188d9;
                        codedInputByteBufferNano.readMessage(c0188d9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0188d9 c0188d92 = new C0188d9();
                    c0188d9Arr2[length] = c0188d92;
                    codedInputByteBufferNano.readMessage(c0188d92);
                    this.s = c0188d9Arr2;
                    break;
                default:
    ...
    public static C0239f9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0239f9) MessageNano.mergeFrom(new C0239f9(), bArr);
    }
}
