...
public final class Ql {
    ...
    public final Km a(Context context, C0476o5 c0476o5, C0337im c0337im) {
        Km km = (Km) this.b.get(c0476o5.f1017a);
        boolean z = true;
        if (km == null) {
            synchronized (this.b) {
                km = (Km) this.b.get(c0476o5.f1017a);
                if (km == null) {
                    km = new Km(new Lm(context, c0476o5.f1017a, c0337im, this.d));
                    km.f();
                    this.b.put(c0476o5.f1017a, km);
                    z = false;
                }
            }
        }
    ...
    public final void a(C0476o5 c0476o5, Zl zl) {
        synchronized (this.b) {
            this.f645a.a(c0476o5.f1017a, zl);
