...
public final class ro {
    ...
    public final so f1033a;

    public ro(Cif cif, vo voVar, String str) {
        this.f1033a = new so(cif, voVar, new to() { // from class: io.appmetrica.analytics.impl.ro$$ExternalSyntheticLambda0
    ...
    public static final JSONObject a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        jSONObject3.put("report_request_id", AbstractC0761zb.a(jSONObject2, "report_request_id", AbstractC0761zb.a(jSONObject, "report_request_id", -1)));
        ...
        jSONObject3.put("open_id", AbstractC0761zb.a(jSONObject2, "open_id", AbstractC0761zb.a(jSONObject, "open_id", 1)));
        jSONObject3.put("attribution_id", AbstractC0761zb.a(jSONObject2, "attribution_id", AbstractC0761zb.a(jSONObject, "attribution_id", 1)));
        jSONObject3.put("last_migration_api_level", AbstractC0761zb.a(jSONObject2, "last_migration_api_level", AbstractC0761zb.a(jSONObject, "last_migration_api_level", 0)));
    ...
    public final synchronized void b(long j) {
        so soVar = this.f1033a;
        soVar.a(soVar.a().put("global_number", j));
    }

    public final synchronized boolean c() {
        return this.f1033a.a().optBoolean("first_event_done", false);
    }

    public final synchronized boolean d() {
        return this.f1033a.a().optBoolean("init_event_done", false);
    }

    public final synchronized int b() {
        return this.f1033a.a().optInt("open_id", 1);
    }
    ...
    public final synchronized int a() {
        return this.f1033a.a().optInt("attribution_id", 1);
    }
