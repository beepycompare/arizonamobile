...
public final class C0664vh implements IParamsAppender {

    /* renamed from: a  reason: collision with root package name */
    public final AdvIdWithLimitedAppender f1128a;
    public final NetworkTaskForSendingDataParamsAppender b;
    public L7 c;
    public final C0303hc d;
    public long e;

    public C0664vh(RequestBodyEncrypter requestBodyEncrypter) {
        this(new AdvIdWithLimitedAppender(), new NetworkTaskForSendingDataParamsAppender(requestBodyEncrypter), new C0303hc());
    }
    ...
    public C0664vh(AdvIdWithLimitedAppender advIdWithLimitedAppender, NetworkTaskForSendingDataParamsAppender networkTaskForSendingDataParamsAppender, C0303hc c0303hc) {
