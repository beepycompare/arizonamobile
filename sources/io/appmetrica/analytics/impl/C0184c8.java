...
public final class C0184c8 {
    ...
    public final void a(int i) {
        ...
        C0132a8 c0132a8 = this.d;
        String str = c0132a8 == null ? null : c0132a8.c;
    ...
    public final void a() {
        ...
        if (c0132a8 != null) {
            ...
            if (str != null) {
                ...
                if (!fo.a(this.d.f751a)) {
                    Map<String, String> map = this.d.f751a;
                    DeferredDeeplinkParametersListener deferredDeeplinkParametersListener = this.c;
                    if (deferredDeeplinkParametersListener != null) {
