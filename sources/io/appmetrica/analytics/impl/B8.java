...
public final class B8 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        C0709x8 c0709x8 = this.b;
        return c0709x8 != null ? CodedOutputByteBufferNano.computeMessageSize(2, c0709x8) + computeSerializedSize : computeSerializedSize;
    }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0709x8 c0709x8 = this.b;
        if (c0709x8 != null) {
            codedOutputByteBufferNano.writeMessage(2, c0709x8);
        }
    ...
    public final B8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f473a = codedInputByteBufferNano.readUInt32();
            } else if (readTag != 18) {
