...
public final class B8 extends MessageNano {
    ...
    public final B8 a() {
        this.f366a = WireFormatNano.EMPTY_BYTES;
        this.b = null;
        this.cachedSize = -1;
        return this;
    }
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f366a, WireFormatNano.EMPTY_BYTES)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f366a);
        }
        F8 f8 = this.b;
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f366a, WireFormatNano.EMPTY_BYTES)) {
            codedOutputByteBufferNano.writeBytes(1, this.f366a);
        }
        F8 f8 = this.b;
        if (f8 != null) {
    ...
    public final B8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f366a = codedInputByteBufferNano.readBytes();
            } else if (readTag != 18) {
