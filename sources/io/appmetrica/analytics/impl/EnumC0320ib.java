...
public enum EnumC0320ib {
    ...
    static {
        EnumC0320ib[] values;
        for (EnumC0320ib enumC0320ib : values()) {
            K.put(Integer.valueOf(enumC0320ib.f931a), enumC0320ib);
        }
    }

    EnumC0320ib(int i, String str) {
        this.f931a = i;
        this.b = str;
    }
    ...
    public static EnumC0320ib a(int i) {
        EnumC0320ib enumC0320ib = (EnumC0320ib) K.get(Integer.valueOf(i));
        return enumC0320ib == null ? EVENT_TYPE_UNDEFINED : enumC0320ib;
    }
}
