...
public final class C0395l9 extends MessageNano {
    ...
    public static volatile C0395l9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f988a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0266g9 c0266g9 = this.f;
        if (c0266g9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0266g9);
        }
        C0369k9 c0369k9 = this.g;
        if (c0369k9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0369k9);
        }
        if (!this.h.equals("")) {
        ...
        C0343j9[] c0343j9Arr = this.s;
        if (c0343j9Arr != null && c0343j9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0343j9[] c0343j9Arr2 = this.s;
                if (i6 >= c0343j9Arr2.length) {
                    break;
                }
                C0343j9 c0343j9 = c0343j9Arr2[i6];
                if (c0343j9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0343j9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f988a);
        ...
        C0266g9 c0266g9 = this.f;
        if (c0266g9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0266g9);
        }
        C0369k9 c0369k9 = this.g;
        if (c0369k9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0369k9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0343j9Arr != null && c0343j9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0343j9 c0343j9 = c0343j9Arr2[i6];
                if (c0343j9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0343j9);
                }
                i6++;
            }
        }
    ...
    public static C0395l9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0395l9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0395l9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f988a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0343j9[] c0343j9Arr = this.s;
                    int length = c0343j9Arr == null ? 0 : c0343j9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0343j9[] c0343j9Arr2 = new C0343j9[i];
                    if (length != 0) {
                        System.arraycopy(c0343j9Arr, 0, c0343j9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0343j9 c0343j9 = new C0343j9();
                        c0343j9Arr2[length] = c0343j9;
                        codedInputByteBufferNano.readMessage(c0343j9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0343j9 c0343j92 = new C0343j9();
                    c0343j9Arr2[length] = c0343j92;
                    codedInputByteBufferNano.readMessage(c0343j92);
                    this.s = c0343j9Arr2;
                    break;
                default:
    ...
    public static C0395l9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0395l9) MessageNano.mergeFrom(new C0395l9(), bArr);
    }
}
