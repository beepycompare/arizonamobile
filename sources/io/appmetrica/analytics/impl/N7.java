...
public final class N7 implements ProtobufConverter {
    public final BigDecimal a(C0760z8 c0760z8) {
        throw new UnsupportedOperationException();
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    public final Object toModel(Object obj) {
        C0760z8 c0760z8 = (C0760z8) obj;
        throw new UnsupportedOperationException();
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final C0760z8 fromModel(BigDecimal bigDecimal) {
        ...
        while (true) {
            if (unscaledValue.compareTo(P7.f716a) <= 0 && unscaledValue.compareTo(P7.b) >= 0) {
                ...
                C0760z8 c0760z8 = new C0760z8();
                c0760z8.f1312a = o7.f699a;
                c0760z8.b = o7.b;
                return c0760z8;
            }
