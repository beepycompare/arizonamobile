...
public final class Sl implements Sn {
    ...
    public final Nl b() {
        return new Nl((Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f765a, "phone", "getting SimMcc", "TelephonyManager", new Ol()), (Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f765a, "phone", "getting SimMnc", "TelephonyManager", new Pl()), ((Boolean) SystemServiceUtils.accessSystemServiceByNameSafelyOrDefault(this.f765a, "phone", "getting NetworkRoaming", "TelephonyManager", Boolean.FALSE, new Rl(this))).booleanValue(), (String) SystemServiceUtils.accessSystemServiceByNameSafely(this.f765a, "phone", "getting SimOperatorName", "TelephonyManager", new Ql()));
    }
    ...
    public final synchronized List<Nl> a() {
        ...
        if (Na.I.u.a().n.d) {
            if (AndroidUtils.isApiAchieved(23)) {
                if (this.b.hasPermission(this.f765a, "android.permission.READ_PHONE_STATE")) {
                    arrayList2.addAll(Tl.a(this.f765a));
                }
