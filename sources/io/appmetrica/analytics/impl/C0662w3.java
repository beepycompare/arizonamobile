...
public final class C0662w3 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1277a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1277a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1277a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1277a);
        }
        if (!this.b.equals("")) {
    ...
    public final C0662w3 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1277a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
