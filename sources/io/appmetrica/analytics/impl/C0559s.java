...
public final class C0559s extends MessageNano {
    ...
    public static volatile C0559s[] t;
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f1102a, u)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f1102a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f1102a, u)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1102a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public static C0559s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0559s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0559s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1102a = codedInputByteBufferNano.readBytes();
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new r();
    ...
    public static C0559s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0559s) MessageNano.mergeFrom(new C0559s(), bArr);
    }
}
