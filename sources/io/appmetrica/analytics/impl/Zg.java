...
public final class Zg implements IParamsAppender {
    ...
    public final AdvIdWithLimitedAppender f893a;
    ...
    public Zg(AdvIdWithLimitedAppender advIdWithLimitedAppender, NetworkTaskForSendingDataParamsAppender networkTaskForSendingDataParamsAppender, Hb hb) {
        this.f893a = advIdWithLimitedAppender;
    ...
    public final void appendParams(Uri.Builder builder, C0380kh c0380kh) {
        ...
        if (c0395l7 != null) {
            builder.appendQueryParameter(CommonUrlParts.DEVICE_ID, StringUtils.ifIsEmptyToDef(c0395l7.f1098a, c0380kh.getDeviceId()));
        ...
        AdvIdWithLimitedAppender advIdWithLimitedAppender = this.f893a;
        this.d.getClass();
