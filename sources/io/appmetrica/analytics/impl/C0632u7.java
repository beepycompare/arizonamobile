...
public final class C0632u7 implements ProtobufConverter {

    /* renamed from: a  reason: collision with root package name */
    public final C0739ye f1069a;
    public final C7 b;
    ...
    /* renamed from: a */
    public final F7 fromModel(C0682w7 c0682w7) {
        F7 f7 = new F7();
        Integer num = c0682w7.f1100a;
        if (num != null) {
            f7.f425a = num.intValue();
        }
        String str = c0682w7.b;
        if (str != null) {
            f7.b = StringUtils.correctIllFormedString(str);
        }
        String str2 = c0682w7.c;
        if (str2 != null) {
        ...
        String str3 = c0682w7.f;
        if (str3 != null) {
            f7.f = str3;
        }
        String str4 = c0682w7.g;
        if (str4 != null) {
            f7.g = str4;
        }
        Long l2 = c0682w7.h;
        ...
        Integer num2 = c0682w7.i;
        if (num2 != null) {
            f7.i = num2.intValue();
        }
        Integer num3 = c0682w7.j;
        if (num3 != null) {
            f7.j = num3.intValue();
        }
        String str5 = c0682w7.k;
        if (str5 != null) {
            f7.k = str5;
        }
        Y8 y8 = c0682w7.l;
        ...
        String str6 = c0682w7.m;
        if (str6 != null) {
            f7.m = str6;
        }
        EnumC0685wa enumC0685wa = c0682w7.n;
        if (enumC0685wa != null) {
            f7.n = enumC0685wa.f1103a;
        }
        E9 e9 = c0682w7.o;
        if (e9 != null) {
            f7.o = e9.f405a;
        }
        Boolean bool = c0682w7.p;
        if (bool != null) {
            f7.p = this.f1069a.fromModel(Boolean.valueOf(bool.booleanValue())).intValue();
        }
        Integer num4 = c0682w7.q;
        if (num4 != null) {
            f7.q = num4.intValue();
        }
        byte[] bArr = c0682w7.r;
    ...
    public C0632u7(C0739ye c0739ye, C7 c7) {
        this.f1069a = c0739ye;
        this.b = c7;
    }

    public /* synthetic */ C0632u7(C0739ye c0739ye, C7 c7, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new C0739ye() : c0739ye, (i & 2) != 0 ? new C7(null, 1, null) : c7);
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final C0682w7 toModel(F7 f7) {
        Long l;
        E9 e9;
        F7 f72 = new F7();
        Integer valueOf = Integer.valueOf(f7.f425a);
        Integer num = valueOf.intValue() != f72.f425a ? valueOf : null;
        String str = f7.b;
        ...
        EnumC0685wa a3 = valueOf7 != null ? EnumC0685wa.a(Integer.valueOf(valueOf7.intValue())) : null;
        ...
        Boolean a4 = this.f1069a.a(f7.p);
        Integer valueOf9 = Integer.valueOf(f7.q);
        Integer num4 = valueOf9.intValue() != f72.q ? valueOf9 : null;
        byte[] bArr = f7.r;
        return new C0682w7(num, str2, str4, l2, model, str6, str8, l, num2, num3, str10, a2, str12, a3, e9, a4, num4, !Arrays.equals(bArr, f72.r) ? bArr : null);
    }
}
