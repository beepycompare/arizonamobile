...
public final class C0577s6 extends C0252fh {
    ...
    public /* synthetic */ C0577s6(Context context, C0545r0 c0545r0, El el, Ph ph, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, c0545r0, el, ph, (i & 16) != 0 ? false : z);
    }
    ...
    public C0577s6(Context context, C0545r0 c0545r0, El el, Ph ph, boolean z) {
        super(c0545r0, el, ph);
        this.f = context;
        this.g = ph;
        this.h = z;
