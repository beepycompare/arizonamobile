...
public final class C0110a9 extends MessageNano {
    ...
    public final C0110a9 a() {
        this.f877a = FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
    ...
    public final int computeSerializedSize() {
        int computeDoubleSize = CodedOutputByteBufferNano.computeDoubleSize(2, this.b) + CodedOutputByteBufferNano.computeDoubleSize(1, this.f877a) + super.computeSerializedSize();
        long j2 = this.c;
        if (j2 != 0) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeDouble(1, this.f877a);
    ...
    public static C0110a9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0110a9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0110a9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            int readTag = codedInputByteBufferNano.readTag();
            if (readTag == 0) {
                break;
            } else if (readTag == 9) {
                this.f877a = codedInputByteBufferNano.readDouble();
            } else if (readTag == 17) {
    ...
    public static C0110a9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0110a9) MessageNano.mergeFrom(new C0110a9(), bArr);
    }
}
