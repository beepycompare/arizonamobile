...
public final class C0640uk extends AbstractC0233ed {
    ...
    public final SparseArray<InterfaceC0208dd> c() {
        SparseArray<InterfaceC0208dd> sparseArray = new SparseArray<>(1);
        sparseArray.put(112, new C0665vk(this.f1088a));
        sparseArray.put(BuildConfig.API_LEVEL, new C0690wk());
        return sparseArray;
    }

    public C0640uk(to toVar) {
        this.f1088a = toVar;
    }
}
