...
public final class C0458nc implements InterfaceC0383kc, ToggleObserver {
    ...
    public final void a(final LocationControllerObserver locationControllerObserver, final boolean z) {
        this.b.execute(new Runnable() { // from class: io.appmetrica.analytics.impl.nc$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                C0458nc.a(C0458nc.this, locationControllerObserver, z);
            }
        });
    }

    public static final void a(C0458nc c0458nc, LocationControllerObserver locationControllerObserver, boolean z) {
        c0458nc.f967a.add(locationControllerObserver);
        if (z) {
            if (c0458nc.d) {
    ...
    public static final void a(C0458nc c0458nc, boolean z) {
        if (c0458nc.d != z) {
            c0458nc.d = z;
            Function1 function1 = z ? C0408lc.f937a : C0433mc.f952a;
            for (LocationControllerObserver locationControllerObserver : c0458nc.f967a) {
