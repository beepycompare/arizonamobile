...
public final class C0633uc implements PermissionStrategy, LocationControllerObserver {
    public static final C0608tc b = new C0608tc();
    ...
    public volatile boolean f1104a;
    ...
    public final String toString() {
        return "LocationFlagStrategy(enabled=" + this.f1104a + ", locationPermissions=" + c + ')';
    }
}
