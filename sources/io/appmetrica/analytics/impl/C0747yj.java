        ...
        for (Map.Entry entry : c0242f6.p.entrySet()) {
            ...
            if (bArr != null) {
                ...
                if (bArr.length != 0) {
                    ...
                    C0542ql c0542ql = c0438ml.f1099a;
                    c0542ql.d.insert(c0542ql.f1168a, c0542ql.c.toByteArray((C0516pl) c0542ql.b.fromModel(c0438ml.b)));
                }
            }
            remove = c0438ml.b.remove(str);
            byte[] bArr22 = (byte[]) remove;
            C0542ql c0542ql2 = c0438ml.f1099a;
            c0542ql2.d.insert(c0542ql2.f1168a, c0542ql2.c.toByteArray((C0516pl) c0542ql2.b.fromModel(c0438ml.b)));
        }
        return true;
    }
}
