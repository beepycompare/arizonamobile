...
public final class C0643v8 extends MessageNano {
    public static volatile C0643v8[] d;
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(bArr, bArr2)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f1165a);
        }
        if (!Arrays.equals(this.b, bArr2)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(2, this.b);
        }
        C0668w8 c0668w8 = this.c;
        return c0668w8 != null ? CodedOutputByteBufferNano.computeMessageSize(3, c0668w8) + computeSerializedSize : computeSerializedSize;
    }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        byte[] bArr2 = WireFormatNano.EMPTY_BYTES;
        if (!Arrays.equals(bArr, bArr2)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1165a);
        }
        if (!Arrays.equals(this.b, bArr2)) {
        ...
        C0668w8 c0668w8 = this.c;
        if (c0668w8 != null) {
            codedOutputByteBufferNano.writeMessage(3, c0668w8);
        }
    ...
    public final C0643v8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1165a = codedInputByteBufferNano.readBytes();
            } else if (readTag == 18) {
