...
public final class C0490on extends AbstractC0619tn {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0457ng("clids_info", iBinaryDataHelper, new T8(p3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new K3());
    }
}
