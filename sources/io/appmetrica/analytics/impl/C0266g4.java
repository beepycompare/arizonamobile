...
public final class C0266g4 {
    ...
    public static C0266g4 a(Y3 y3) {
        return new C0266g4(y3.b.getApiKey(), y3.f849a.f927a.getAsString("PROCESS_CFG_PACKAGE_NAME"), y3.f849a.f927a.getAsInteger("PROCESS_CFG_PROCESS_ID"), y3.f849a.f927a.getAsString("PROCESS_CFG_PROCESS_SESSION_ID"), y3.b.getReporterType());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && C0266g4.class == obj.getClass()) {
            ...
            if (str == null ? c0266g4.f991a != null : !str.equals(c0266g4.f991a)) {
                return false;
            }
    ...
    public final String toString() {
        return "ClientDescription{mApiKey='" + this.f991a + "', mPackageName='" + this.b + "', mProcessID=" + this.c + ", mProcessSessionID='" + this.d + "', mReporterType=" + this.e + AbstractJsonLexerKt.END_OBJ;
    }
}
