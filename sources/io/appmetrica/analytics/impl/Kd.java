...
public final class Kd implements NativeCrashHandler {
    ...
    public final void newCrash(final NativeCrash nativeCrash) {
        ...
        if (g0 != null) {
            LoggerStorage.getOrCreatePublicLogger(g0.f.f597a).info("Detected native crash with uuid = " + g0.c, new Object[0]);
            ...
            nd.getClass();
            Gd gd = new Gd(new Id(g0.f585a, g0.b), nd.f);
            Dd dd = new Dd(nd.b, g0.f, new Md(g0, nd.d));
            C0137ba c0137ba = nd.e;
            String str = g0.d;
            c0137ba.getClass();
            File file = new File(str);
            Context context = nd.f703a;
            if (C0111aa.c == null) {
        ...
        this.f651a.invoke(nativeCrash.getUuid());
    }
}
