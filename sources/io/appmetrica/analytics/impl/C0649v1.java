...
public final class C0649v1 {
    ...
    public C0649v1(B0 b0, N2 n2, Ml ml, lp lpVar, Hn hn, Ii ii, V7 v7, Bl bl) {
        this.f1243a = b0;
        this.b = lpVar;
        this.c = ii;
        this.d = v7;
    ...
    public final void a(final Context context, final AppMetricaConfig appMetricaConfig) {
        ...
        ((U9) b).b.post(new Runnable() { // from class: io.appmetrica.analytics.impl.v1$$ExternalSyntheticLambda2
            ...
            public final void run() {
                C0649v1.this.b(context, appMetricaConfig);
            }
        });
    ...
    public final void b(Context context, AppMetricaConfig appMetricaConfig) {
        ...
        ((U9) C0574s4.l().c.a()).execute(new RunnableC0727y1(context2));
    }
    ...
    public final void c(Activity activity) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0338j1(this, activity));
    }

    public C0649v1() {
        this(C0574s4.l().d(), new lp());
    }
    ...
    public final void d(String str, String str2) {
        ...
        if (n2.n.a(str).f784a) {
            this.g.getClass();
            IHandlerExecutor b = b();
            ((U9) b).b.post(new RunnableC0235f1(this, str, str2));
        }
    }

    public C0649v1(B0 b0, lp lpVar) {
        this(b0, new N2(b0), new Ml(b0), lpVar, new Hn(b0, lpVar), Ii.a(), C0574s4.l().j(), C0574s4.l().o());
    }
    ...
    public final void c(String str, String str2) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0520q1(this, str, str2));
    }
    ...
    public final void b(String str) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0494p1(this, str));
    }
    ...
    public final void c(String str) {
        if (this.e.a((Void) null).f784a && this.f.m.a(str).f784a) {
            this.g.getClass();
            IHandlerExecutor b = b();
            ((U9) b).b.post(new RunnableC0261g1(this, str));
        }
    }
    ...
    public final void a(Activity activity) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0468o1(this, activity));
    }
    ...
    public final void b(String str, String str2) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0184d1(this, str, str2));
    }
    ...
    public final IdentifiersResult b(Context context) {
        ...
        return C0574s4.l().a(context.getApplicationContext()).a();
    }
    ...
    public final void a(String str, Map<String, Object> map) {
        ...
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0545r1(this, str, listFromMap));
    }
    ...
    public final void a(String str, Throwable th) {
        ...
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0571s1(this, str, th));
    }
    ...
    public final void a(String str, String str2, Throwable th) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0597t1(this, str, str2, th));
    }
    ...
    public final void a(Throwable th) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0623u1(this, th));
    }
    ...
    public final void a(ECommerceEvent eCommerceEvent) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0106a1(this, eCommerceEvent));
    }
    ...
    public final void a(DeferredDeeplinkParametersListener deferredDeeplinkParametersListener) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0132b1(this, deferredDeeplinkParametersListener));
    }
    ...
    public final void a(DeferredDeeplinkListener deferredDeeplinkListener) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0158c1(this, deferredDeeplinkListener));
    }

    public final InterfaceC0504pb a(Context context, String str) {
        N2 n2 = this.f;
        n2.f.a(context);
        n2.j.a(str);
        Hn hn = this.g;
    ...
    public final void a(WebView webView) {
        ...
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0209e1(this));
    }
    ...
    public final String a(Context context) {
        ...
        Hn hn = this.g;
        hn.e.a(context.getApplicationContext());
        IdentifiersResult identifiersResult = (IdentifiersResult) C0574s4.l().d(context.getApplicationContext()).b.get(StartupParamsCallback.APPMETRICA_DEVICE_ID);
    ...
    public final void a(String str, String str2) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0287h1(this, str, str2));
    }
    ...
    public final void a() {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0313i1(this));
    }
    ...
    public final void a(Context context, StartupParamsCallback startupParamsCallback, List<String> list) {
        ...
        hn.e.a(context.getApplicationContext());
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0364k1(this, context, startupParamsCallback, list));
    }
    ...
    public final void a(AnrListener anrListener) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0390l1(this, anrListener));
    }
    ...
    public final void a(ExternalAttribution externalAttribution) {
        ...
        this.g.getClass();
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0416m1(this, externalAttribution));
    }

    public static /* synthetic */ void a(Object[] objArr) {
        ModuleAdRevenueProcessor b = C0574s4.l().m().b();
        if (b != null) {
            b.process(objArr);
        }
    }
    ...
    public final void a(Map<Thread, StackTraceElement[]> map) {
        ...
        List listFromMap = CollectionUtils.getListFromMap(map);
        IHandlerExecutor b = b();
        ((U9) b).b.post(new RunnableC0442n1(this, listFromMap));
    }

    public static InterfaceC0374kb a(C0649v1 c0649v1) {
        return c0649v1.c().f647a;
    }
}
