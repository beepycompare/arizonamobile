...
public final class C0522qb {
    ...
    public C0522qb(String str) throws JSONException {
        ...
        if (optString != null) {
            try {
                HashMap c = AbstractC0447nb.c(optString);
                if (c != null) {
                    for (Map.Entry entry : c.entrySet()) {
                        this.d.put(T3.valueOf((String) entry.getKey()), Integer.valueOf(Integer.parseInt((String) entry.getValue())));
                    }
                }
    ...
    public C0522qb(W5 w5, P3 p3, HashMap<T3, Integer> hashMap) {
        this.f1071a = w5.getValueBytes();
        this.b = w5.getName();
        this.c = w5.getBytesTruncated();
        if (hashMap != null) {
            this.d = hashMap;
        } else {
            this.d = new HashMap();
