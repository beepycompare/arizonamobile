...
public final class A0 implements InterfaceC0557rb {
        ...
        if (a02 == null) {
            synchronized (A0.class) {
                ...
                if (a0 == null) {
                    a0 = new A0(context);
                    a0.j();
                    C0576s4.l().c.a().execute(new RunnableC0754z0(a0));
                    e = a0;
                }
            }
            return a0;
    ...
    public final void d(AppMetricaConfig appMetricaConfig) {
        ...
        C0576s4.l().c.a().execute(new RunnableC0729y1(this.f446a));
    }
    ...
    public final InterfaceC0221eb f() {
        try {
            return (InterfaceC0221eb) this.c.get();
        } catch (Exception e2) {
    ...
    public final void j() {
        ...
        c0318i4.f1027a.getClass();
        new InterruptionSafeThread(runnable, "IAA-INIT_CORE-" + Zd.f870a.incrementAndGet()).start();
    }

    public final void o() {
        C0576s4.l().s.a(this.f446a);
        C0576s4.l().a(this.f446a).a();
        this.c.run();
    }
    ...
    public final InterfaceC0221eb p() {
        ...
        synchronized (c0598t0) {
            if (c0598t0.d == null) {
                if (c0598t0.a(context)) {
                    c0598t0.d = new G0();
                } else {
                    c0598t0.d = new E0(context, interfaceC0196db);
                }
            }
            interfaceC0221eb = c0598t0.d;
        }
        return interfaceC0221eb;
    }
    ...
    public static InterfaceC0327id c() {
        if (m()) {
            return e.f();
        }
        return C0576s4.l().b;
