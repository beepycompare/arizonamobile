...
public final class C0530qg implements InterfaceC0380kg {
    ...
    public final synchronized void a(C0455ng c0455ng) {
        if (c0455ng != null) {
            LoggerStorage.getMainPublicOrAnonymousLogger().info("Received referrer from source %s: %s", c0455ng.d.f1118a, c0455ng.f1137a);
        }
        this.c = c0455ng;
        this.b = true;
    ...
    public final synchronized void a(InterfaceC0251fg interfaceC0251fg) {
        this.f1190a.add(interfaceC0251fg);
        if (this.b) {
            interfaceC0251fg.a(this.c);
            this.f1190a.remove(interfaceC0251fg);
        }
    }
}
