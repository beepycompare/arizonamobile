...
public enum EnumC0164cb {
    ...
    static {
        EnumC0164cb[] values;
        for (EnumC0164cb enumC0164cb : values()) {
            K.put(Integer.valueOf(enumC0164cb.f927a), enumC0164cb);
        }
    }

    EnumC0164cb(int i, String str) {
        this.f927a = i;
        this.b = str;
    }
    ...
    public static EnumC0164cb a(int i) {
        EnumC0164cb enumC0164cb = (EnumC0164cb) K.get(Integer.valueOf(i));
        return enumC0164cb == null ? EVENT_TYPE_UNDEFINED : enumC0164cb;
    }
}
