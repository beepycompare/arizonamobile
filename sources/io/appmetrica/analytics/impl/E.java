...
public final class E {
    ...
    public final Pair a() {
        ...
        int i = 0;
        for (Pair pair : CollectionsKt.listOf((Object[]) new Pair[]{TuplesKt.to(this.f563a.adNetwork, new C0686x(c0561s)), TuplesKt.to(this.f563a.adPlacementId, new C0711y(c0561s)), TuplesKt.to(this.f563a.adPlacementName, new C0736z(c0561s)), TuplesKt.to(this.f563a.adUnitId, new A(c0561s)), TuplesKt.to(this.f563a.adUnitName, new B(c0561s)), TuplesKt.to(this.f563a.precision, new C(c0561s)), TuplesKt.to(this.f563a.currency.getCurrencyCode(), new D(c0561s))})) {
        ...
        Integer num = (Integer) F.f579a.get(this.f563a.adType);
        c0561s.d = num != null ? num.intValue() : 0;
        r rVar = new r();
        BigDecimal bigDecimal = this.f563a.adRevenue;
        ...
        rVar.f1200a = longValue;
        rVar.b = intValue;
        c0561s.b = rVar;
        Map<String, String> map = this.f563a.payload;
        ...
        if (this.b) {
            c0561s.f1218a = "autocollected".getBytes(Charsets.UTF_8);
        }
