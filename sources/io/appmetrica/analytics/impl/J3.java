...
public final class J3 implements InterfaceC0322i8 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof J3) {
            J3 j3 = (J3) obj;
            return Intrinsics.areEqual(this.f605a, j3.f605a) && Intrinsics.areEqual(this.b, j3.b);
        }
        return false;
    }

    public final int hashCode() {
        return this.b.hashCode() + (this.f605a.hashCode() * 31);
    }

    public final String toString() {
        return "ClidsInfo(chosen=" + this.f605a + ", candidates=" + this.b + ')';
    }
