...
public final class C0601t7 extends SQLiteOpenHelper implements Closeable {
    ...
    public final SQLiteDatabase getReadableDatabase() {
        try {
            ...
            this.b.error(th, "Could not get readable database %s due to an exception. AppMetrica SDK may behave unexpectedly.", this.f1062a);
    ...
    public final SQLiteDatabase getWritableDatabase() {
        try {
            ...
            this.b.error(th, "Could not get writable database %s due to an exception. AppMetrica SDK may behave unexpectedly.", this.f1062a);
            C0188ck c0188ck = Bj.f362a;
            c0188ck.getClass();
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            this.c.f892a.runScript(sQLiteDatabase);
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i > i2) {
            ...
            try {
                c0319hn.f892a.runScript(sQLiteDatabase);
                return;
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i2 > i) {
            for (int i3 = i + 1; i3 <= i2; i3++) {
                try {
                    Collection<DatabaseScript> collection = (Collection) c0319hn.c.f520a.get(Integer.valueOf(i3));
                    if (collection != null) {
