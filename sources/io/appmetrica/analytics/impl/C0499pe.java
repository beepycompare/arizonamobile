...
public final class C0499pe implements InterfaceC0161c8 {
    ...
    public final List<Ei> fromModel(C0474oe c0474oe) {
        ...
        c0642v8.f1263a = c0474oe.f1146a;
        c0642v8.f = new C0367k8();
        C0524qe c0524qe = c0474oe.b;
        C0316i8 c0316i8 = new C0316i8();
        c0316i8.f1035a = StringUtils.getUTF8Bytes(c0524qe.f1186a);
        Nn a2 = this.c.a(c0524qe.b);
        c0316i8.b = StringUtils.getUTF8Bytes((String) a2.f709a);
        c0316i8.e = c0524qe.c.size();
        Map<String, String> map = c0524qe.d;
        if (map != null) {
            ei = this.f1165a.fromModel(map);
            c0316i8.c = (C0418m8) ei.f561a;
        } else {
            ei = null;
        }
        c0642v8.f.f1070a = c0316i8;
        int i = 0;
        char c = 1;
        ...
        this.d.getClass();
        int computeInt32Size = c0642v8.f1263a != new C0642v8().f1263a ? CodedOutputByteBufferNano.computeInt32Size(1, c0642v8.f1263a) : 0;
        ...
        c0642v82.f1263a = c0642v8.f1263a;
        C0367k8 c0367k82 = new C0367k8();
        c0642v82.f = c0367k82;
        c0367k82.f1070a = new C0316i8();
        C0316i8 c0316i82 = c0642v82.f.f1070a;
        C0316i8 c0316i83 = c0642v8.f.f1070a;
        c0316i82.b = c0316i83.b;
        c0316i82.f1035a = c0316i83.f1035a;
        ...
        while (i3 < list.size()) {
            ...
            c0341j8.b = (C0238f8) fromModel.f561a;
            ...
            int computeMessageSizeNoTag = CodedOutputByteBufferNano.computeMessageSizeNoTag((C0341j8) ei2.f561a);
            ...
            if (arrayList2.size() != 0 && i4 + computeRawVarint32Size > 204800) {
                c0642v82.f.f1070a.d = (C0341j8[]) arrayList2.toArray(new C0341j8[arrayList2.size()]);
                ArrayList arrayList3 = new ArrayList();
                arrayList.add(new Ei(c0642v82, c0130b32));
                C0642v8 c0642v83 = new C0642v8();
                c0642v83.f1263a = c0642v8.f1263a;
                C0367k8 c0367k83 = new C0367k8();
                c0642v83.f = c0367k83;
                c0367k83.f1070a = new C0316i8();
                C0316i8 c0316i84 = c0642v83.f.f1070a;
                C0316i8 c0316i85 = c0642v8.f.f1070a;
                c0316i84.b = c0316i85.b;
                c0316i84.f1035a = c0316i85.f1035a;
            ...
            arrayList2.add((C0341j8) ei2.f561a);
