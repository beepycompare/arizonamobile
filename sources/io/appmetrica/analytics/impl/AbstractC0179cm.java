...
public abstract class AbstractC0179cm {

    /* renamed from: a  reason: collision with root package name */
    public static final Set f949a = SetsKt.setOf((Object[]) new String[]{"appmetrica_clids", StartupParamsCallback.APPMETRICA_DEVICE_ID_HASH, StartupParamsCallback.APPMETRICA_DEVICE_ID, "appmetrica_get_ad_url", "appmetrica_report_ad_url", StartupParamsCallback.APPMETRICA_UUID});
    ...
    */
    public static final boolean a(C0256fm c0256fm, Collection collection, Map map, Function0 function0) {
        boolean a2;
                ...
                switch (str.hashCode()) {
                    case -1367801046:
                        if (!str.equals(StartupParamsCallback.APPMETRICA_UUID)) {
                            ...
                            if (b.currentTimeSeconds() > c0256fm.o + c0256fm.z.f544a) {
                                return false;
                            }
                        } else {
                            a2 = a(c0256fm.d);
                    ...
                    case 530949152:
                        if (str.equals("appmetrica_clids")) {
                            c.getClass();
                            a2 = C3.a(map, c0256fm, (C0740z3) function0.invoke());
                            if (a2) {
                            }
                        } else if (c0256fm.w) {
                        }
