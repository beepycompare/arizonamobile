...
public class C0184d5 {
    ...
    public C0184d5(Context context, R4 r4, C0489p4 c0489p4, W4 w4, C0278gm c0278gm, InterfaceC0324ih interfaceC0324ih, ICommonExecutor iCommonExecutor, int i, Gb gb, InterfaceC0593t9 interfaceC0593t9) {
        this(context, r4, c0489p4, w4, c0278gm, interfaceC0324ih, iCommonExecutor, new I8(), i, new C0132b5(c0489p4.f1142a), new C0158c5(context, r4), gb, interfaceC0593t9);
    }
    ...
    public final yo f() {
        ...
        synchronized (D) {
            ...
            if (obj == null) {
                Xe xe = new Xe(C0470oa.I.B().b(D.f499a, r4));
                if (r4.d()) {
                    String str = "appmetrica_vital_" + r4.b + ".dat";
                    c0163ca = new C0287h5(CollectionsKt.listOf((Object[]) new Pair[]{TuplesKt.to(str, new C0163ca(D.f499a, str)), TuplesKt.to("appmetrica_vital_main.dat", new C0163ca(D.f499a, "appmetrica_vital_main.dat"))}));
                } else {
                    c0163ca = new C0163ca(D.f499a, "appmetrica_vital_" + r4.b + ".dat");
                }
