...
public final class C0551r4 {
    ...
    public final void b(Bundle bundle) {
        ...
        C0657va c0657va = this.n;
        Bundle bundle13 = new Bundle();
        bundle13.putParcelable("value", c0657va);
    ...
    public static C0657va a(Bundle bundle) {
        Parcelable parcelable;
        Bundle bundle2 = bundle.getBundle("features");
        ClassLoader classLoader = C0657va.class.getClassLoader();
        if (bundle2 == null) {
            parcelable = null;
        } else {
            bundle2.setClassLoader(classLoader);
        ...
        C0657va c0657va = (C0657va) parcelable;
        return c0657va == null ? new C0657va(null, IdentifierStatus.UNKNOWN, "bundle serialization error") : c0657va;
    }
    ...
    public static C0657va a(Boolean bool) {
        boolean z = bool != null;
        return new C0657va(bool, z ? IdentifierStatus.OK : IdentifierStatus.UNKNOWN, z ? null : "no identifier in startup state");
    }
}
