...
public final class C0497p0 implements InterfaceC0146bb {
    ...
    public final C0111a2 e = new C0111a2();
    public final Kb f = new Kb();

    public C0497p0(Context context, C0526q4 c0526q4) {
        this.f1024a = context;
        this.b = c0526q4.a();
        BaseReleaseLogger.init(context);
        f().execute(new Runnable() { // from class: io.appmetrica.analytics.impl.p0$$ExternalSyntheticLambda0
        ...
        a().a();
        AbstractC0216e4.a().onCreate();
    }

    public static final void e() {
        ImportantLogger.INSTANCE.info("AppMetrica", "Initializing of AppMetrica, " + StringUtils.capitalize("release") + " type, Version 7.12.0, API Level " + AppMetrica.getLibraryApiLevel() + ", Dated 04.09.2025.", new Object[0]);
    }
    ...
    */
    public final synchronized void a(AppMetricaConfig appMetricaConfig, InterfaceC0607tb interfaceC0607tb) {
        if (!C0646v0.g) {
            ...
            this.f.b();
            if (appMetricaConfig != null) {
                this.f.a(this.f1024a, appMetricaConfig, interfaceC0607tb);
            }
            if (appMetricaConfig != null) {
            }
            this.e.b();
