...
public final class C0706x9 extends Zf {

    /* renamed from: a  reason: collision with root package name */
    public final Ni f1153a;
    public final HashMap b;
    public final O4 c;

    public C0706x9(C0652v5 c0652v5) {
        Ni ni = new Ni(c0652v5);
        this.f1153a = ni;
        this.c = new O4(ni);
        this.b = a();
    }
    ...
    public final HashMap a() {
        ...
        hashMap.put(Bb.EVENT_TYPE_ACTIVATION, new C0290h(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_START, new Nl(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_REGULAR, new C0179ch(this.f1153a));
        Ib ib = new Ib(this.f1153a);
        ...
        hashMap.put(Bb.EVENT_TYPE_APP_OPEN, new C0359jh(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_PURGE_BUFFER, new C0462ng(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new R6(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new Pf(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new C0160bo(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new Qf(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new C0134ao(this.f1153a));
        ...
        hashMap.put(Bb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new C0223ea(this.f1153a));
        return hashMap;
    }
