...
public final class C0642uj implements InterfaceC0668vj {
    ...
    public C0642uj(Context context) {
        this.f1237a = context;
    }
    ...
    public final I3 invoke() {
        Throwable th;
        Cursor cursor;
        if (!PackageManagerUtils.hasContentProvider(this.f1237a, "com.yandex.preinstallsatellite.appmetrica.provider")) {
            Gj.a("Satellite content provider with clids was not found.", new Object[0]);
            return null;
        }
        try {
            cursor = this.f1237a.getContentResolver().query(Uri.parse(this.b), null, null, null, null);
            try {
            } catch (Throwable th2) {
                th = th2;
                try {
        ...
        if (cursor != null) {
            ...
            return new I3(linkedHashMap, EnumC0398l8.e);
        }
