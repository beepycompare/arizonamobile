...
public final class C0548r6 extends MessageNano {
    public static final int k = 0;
    public static final int l = 1;
    public static volatile C0548r6[] m;
    public static byte[] n;
    public static volatile boolean o;

    /* renamed from: a  reason: collision with root package name */
    public C0698x6 f1040a;
    public C0449n6 b;
    public String c;
    public int d;
    public C0648v6[] e;
    ...
    public final int computeSerializedSize() {
        ...
        C0524q6 c0524q6 = this.g;
        if (c0524q6 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(7, c0524q6);
        }
        ...
        C0499p6[] c0499p6Arr = this.j;
        if (c0499p6Arr != null && c0499p6Arr.length > 0) {
            while (true) {
                C0499p6[] c0499p6Arr2 = this.j;
                if (i2 >= c0499p6Arr2.length) {
                    break;
                }
                C0499p6 c0499p6 = c0499p6Arr2[i2];
                if (c0499p6 != null) {
                    computeSerializedSize = CodedOutputByteBufferNano.computeMessageSize(10, c0499p6) + computeSerializedSize;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0524q6 c0524q6 = this.g;
        if (c0524q6 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0524q6);
        }
        if (!Arrays.equals(this.h, n)) {
        ...
        if (c0499p6Arr != null && c0499p6Arr.length > 0) {
            while (true) {
                ...
                C0499p6 c0499p6 = c0499p6Arr2[i2];
                if (c0499p6 != null) {
                    codedOutputByteBufferNano.writeMessage(10, c0499p6);
                }
                i2++;
            }
        }
    ...
    public static C0548r6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0548r6().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0548r6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 10:
                    if (this.f1040a == null) {
                        this.f1040a = new C0698x6();
                    }
                    codedInputByteBufferNano.readMessage(this.f1040a);
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new C0449n6();
    ...
    public static C0548r6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0548r6) MessageNano.mergeFrom(new C0548r6(), bArr);
    }
}
