...
public final class Oc implements Y8 {
    ...
    public final void a(String str) {
        try {
            ...
            String jSONObject = put2.put("activation_offset", TimeUnit.SECONDS.convert(c0614tk.f1070a.currentTimeMillis() - c0614tk.b, TimeUnit.MILLISECONDS)).toString();
            c0188ck.getClass();
    ...
    public final boolean b() {
        String str;
        if (!this.d.get() && (str = ((C0711xh) this.f578a.a()).m) != null && !Intrinsics.areEqual(str, "629a824d-c717-4ba5-bc0f-3f3968554d01") && this.d.compareAndSet(false, true)) {
            this.b.b(true);
            a("activation");
        }
        return this.d.get();
