...
public final class Ug implements ProtobufConverter {
    ...
    public final C0449n6 fromModel(Tg tg) {
        ...
        c0449n6.f = StringUtils.correctIllFormedString((String) WrapUtils.getOrDefault(tg.f780a, c0449n6.f));
        C0622to c0622to = tg.b;
        if (c0622to != null) {
            C0363jo c0363jo = c0622to.f1223a;
            if (c0363jo != null) {
                c0449n6.f1112a = this.f796a.fromModel(c0363jo);
            }
            X x = c0622to.b;
            if (x != null) {
