...
public final class C0146bf {
    ...
    public C0146bf(Context context) {
    ...
    public final String a(String str) {
        try {
            ...
            if (fileFromSdkStorage != null && str != null) {
                AbstractC0400lb.a(str, new FileOutputStream(fileFromSdkStorage));
            }
            return str;
    ...
    public C0146bf(Context context, Ro ro, So so) {
        this.f910a = context;
        this.b = ro;
        this.c = so;
    }
