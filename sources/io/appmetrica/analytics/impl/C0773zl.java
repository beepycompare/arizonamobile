...
public final class C0773zl {
    ...
    protected final C0689wf b;
    public Hb c;

    public C0773zl(C0689wf c0689wf, String str) {
        this.b = c0689wf;
        this.f1323a = str;
        Hb hb = new Hb();
        try {
            String h2 = c0689wf.h(str);
    ...
    public final C0773zl a(long j2) {
        a(i, Long.valueOf(j2));
        return this;
    }

    public final C0773zl b(long j2) {
        a(h, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0773zl e(long j2) {
        a(f, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0773zl a(boolean z) {
        a(j, Boolean.valueOf(z));
        return this;
    }

    public final C0773zl b(boolean z) {
        a(k, Boolean.valueOf(z));
        return this;
    }

    public final C0773zl c(long j2) {
        a(e, Long.valueOf(j2));
        return this;
    }

    public final C0773zl d(long j2) {
        a(g, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0773zl f(long j2) {
        a(d, Long.valueOf(j2));
        return this;
    }
