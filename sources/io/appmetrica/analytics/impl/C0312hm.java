...
public final class C0312hm {
    ...
    public final void a(C0441mm c0441mm, Fb fb) {
        ...
        if (optJSONObject9 != null) {
            fm.f446a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject9, "disabled_reporting_interval_seconds", fm.f446a);
        }
        this.e.getClass();
        c0441mm.p = new Qm(fm.f446a);
        this.b.getClass();
        Bm bm = new Bm();
        try {
            ...
            if (optJSONObject10 != null) {
                H4 h4 = new H4();
                h4.f467a = C0681wa.a(optJSONObject10, "permissions_collecting", bm.f371a);
        ...
        try {
            ...
            if (optJSONObject11 != null) {
                ...
                while (keys2.hasNext()) {
                    ...
                    if (!Xa.f736a.contains(next2) && (a2 = Xa.a(optJSONObject11, next2)) != null) {
        ...
        if (c0441mm.b.f505a) {
            ...
            if (optJSONObject13 != null) {
                j = optJSONObject13.optLong("check_interval_seconds", dm.f411a);
        ...
        C0698x2 c0698x2 = this.f.f1159a;
        C0718xm c0718xm = new C0718xm();
        JSONObject optJSONObject14 = fb.optJSONObject("auto_inapp_collecting");
        if (optJSONObject14 != null) {
            c0718xm.f1156a = optJSONObject14.optInt("send_frequency_seconds", c0718xm.f1156a);
            c0718xm.b = optJSONObject14.optInt("first_collecting_inapp_max_age_seconds", c0718xm.b);
        }
        c0698x2.getClass();
        c0441mm.r = new BillingConfig(c0718xm.f1156a, c0718xm.b);
        F3 f3 = this.g;
        f3.getClass();
        C0743ym c0743ym = new C0743ym();
        JSONObject optJSONObject15 = fb.optJSONObject("cache_control");
        if (optJSONObject15 != null) {
            c0743ym.f1172a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject15, "last_known_location_ttl", c0743ym.f1172a);
        }
        f3.f432a.getClass();
        c0441mm.s = new C3(c0743ym.f1172a);
        this.h.getClass();
        ...
        if (a6 != null) {
            em.f427a = a6.intValue();
        }
        om.f610a.getClass();
        c0441mm.u = new Mm(em.f427a);
        Map<String, C0734yd> c = this.k.f590a.c();
        Md md = new Md(fb);
        ...
        C0171ca c0171ca = this.l.f836a;
        Am am = new Am();
        JSONObject optJSONObject17 = fb.optJSONObject("external_attribution");
        if (optJSONObject17 != null) {
            am.f351a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject17, "collecting_interval_seconds", am.f351a);
        }
        c0171ca.getClass();
        c0441mm.w = new C0145ba(am.f351a);
    }
