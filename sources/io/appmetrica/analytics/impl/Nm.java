...
public final class Nm extends Sm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Nf("clids_info", iBinaryDataHelper, new B8(c0738z3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0613u3());
    }
}
