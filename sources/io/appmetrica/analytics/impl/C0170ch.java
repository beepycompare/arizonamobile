...
public final class C0170ch extends Sg {
    ...
    public final boolean a(Q5 q5) {
        ...
        if (y4.t.c() && y4.x()) {
            ...
            c0736z2.getClass();
            U1 u12 = null;
            C0711y2 a2 = AndroidUtils.isApiAchieved(28) ? C0636v2.a(c0736z2.f1325a, c0736z2.b) : null;
            List list2 = u1.c;
            List list3 = (List) SystemServiceUtils.accessSystemServiceSafelyOrDefault(this.f.f1207a, "getting available providers", "location manager", Collections.emptyList(), new C0536r2());
            C0698xe c0698xe = this.b;
            Context context = this.f776a.f857a;
            c0698xe.getClass();
            ...
            c0394l92.f1088a.a(currentTimeSeconds2).b();
            this.c.save(u12);
            return false;
        }
        return false;
