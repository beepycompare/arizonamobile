...
public abstract class AbstractC0179cb {
        ...
        if (file != null && file.exists()) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            zj.getClass();
                            zj.a(new C0761zj("error_during_file_reading", th));
                            bArr = null;
                            if (bArr == null) {
                            }
                        } finally {
            ...
            if (bArr == null) {
                try {
                    ...
                    Zj zj2 = AbstractC0736yj.f1149a;
                    zj2.getClass();
                    zj2.a(new C0761zj("read_share_file_with_unsupported_encoding", e));
                    return str;
                }
            }
            return null;
