...
public final class C0170cc extends MessageNano {
    public static volatile C0170cc[] f;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f926a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f926a);
        }
        if (!this.b.equals("")) {
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0170cc mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0170cc b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0170cc().mergeFrom(codedInputByteBufferNano);
    }

    public static C0170cc a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0170cc) MessageNano.mergeFrom(new C0170cc(), bArr);
    }
}
