...
public final class C0276gg implements Converter {
    ...
    public final Di fromModel(C0703xg c0703xg) {
        ...
        Mn a2 = this.b.a(c0703xg.f1307a);
        c0496p8.f1171a = StringUtils.getUTF8Bytes((String) a2.f699a);
        Mn a3 = this.c.a(c0703xg.b);
        c0496p8.b = StringUtils.getUTF8Bytes((String) a3.f699a);
        C0176cj c0176cj = c0703xg.c;
        if (c0176cj != null) {
            di = this.f1013a.fromModel(c0176cj);
            c0496p8.c = (C0521q8) di.f552a;
        } else {
            di = null;
        }
