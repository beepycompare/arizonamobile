...
public final class B7 implements ProtobufConverter {
    ...
    public final M7 fromModel(D7 d7) {
        M7 m7 = new M7();
        Integer num = d7.f400a;
        if (num != null) {
            m7.f569a = num.intValue();
        }
        String str = d7.b;
        if (str != null) {
        ...
        Boolean bool = d7.p;
        if (bool != null) {
            m7.p = this.f360a.fromModel(Boolean.valueOf(bool.booleanValue())).intValue();
        }
        Integer num4 = d7.q;
        if (num4 != null) {
            m7.q = num4.intValue();
    ...
    public final D7 toModel(M7 m7) {
        ...
        M9 m9;
        M7 m72 = new M7();
        Integer valueOf = Integer.valueOf(m7.f569a);
        Integer num = valueOf.intValue() != m72.f569a ? valueOf : null;
        String str = m7.b;
