...
public final class C0140b9 extends MessageNano {
    public static volatile C0140b9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f915a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f915a);
        }
        if (!this.b.equals("")) {
        ...
        C0114a9[] c0114a9Arr = this.l;
        if (c0114a9Arr != null && c0114a9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0114a9[] c0114a9Arr2 = this.l;
                if (i4 >= c0114a9Arr2.length) {
                    break;
                }
                C0114a9 c0114a9 = c0114a9Arr2[i4];
                if (c0114a9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0114a9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f915a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f915a);
        }
        if (!this.b.equals("")) {
        ...
        if (c0114a9Arr != null && c0114a9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0114a9 c0114a9 = c0114a9Arr2[i4];
                if (c0114a9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0114a9);
                }
                i4++;
            }
        }
    ...
    public static C0140b9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0140b9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0140b9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f915a = codedInputByteBufferNano.readString();
                    break;
                case 18:
                ...
                case 186:
                    ...
                    C0114a9[] c0114a9Arr = this.l;
                    int length = c0114a9Arr == null ? 0 : c0114a9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0114a9[] c0114a9Arr2 = new C0114a9[i];
                    if (length != 0) {
                        System.arraycopy(c0114a9Arr, 0, c0114a9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0114a9 c0114a9 = new C0114a9();
                        c0114a9Arr2[length] = c0114a9;
                        codedInputByteBufferNano.readMessage(c0114a9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0114a9 c0114a92 = new C0114a9();
                    c0114a9Arr2[length] = c0114a92;
                    codedInputByteBufferNano.readMessage(c0114a92);
                    this.l = c0114a9Arr2;
                    break;
    ...
    public static C0140b9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0140b9) MessageNano.mergeFrom(new C0140b9(), bArr);
    }
}
