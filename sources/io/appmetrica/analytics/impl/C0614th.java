...
public final class C0614th implements IParamsAppender {

    /* renamed from: a  reason: collision with root package name */
    public final AdvIdWithLimitedAppender f1219a;
    public final NetworkTaskForSendingDataParamsAppender b;
    public C7 c;
    public final C0350jc d;
    public long e;

    public C0614th(RequestBodyEncrypter requestBodyEncrypter) {
        this(new AdvIdWithLimitedAppender(), new NetworkTaskForSendingDataParamsAppender(requestBodyEncrypter), new C0350jc());
    }
    ...
    public C0614th(AdvIdWithLimitedAppender advIdWithLimitedAppender, NetworkTaskForSendingDataParamsAppender networkTaskForSendingDataParamsAppender, C0350jc c0350jc) {
        this.f1219a = advIdWithLimitedAppender;
    ...
    public final void appendParams(Uri.Builder builder, Eh eh) {
        ...
        C7 c7 = this.c;
        if (c7 != null) {
            builder.appendQueryParameter(CommonUrlParts.DEVICE_ID, StringUtils.ifIsEmptyToDef(c7.f492a, eh.getDeviceId()));
        ...
        AdvIdWithLimitedAppender advIdWithLimitedAppender = this.f1219a;
        this.d.getClass();
