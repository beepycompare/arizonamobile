...
public final class C0462o2 implements ProtobufConverter {
    ...
    public final C0482om fromModel(C0437n2 c0437n2) {
        ...
        c0482om.f1153a = new C0457nm[c0437n2.f1118a.size()];
        for (int i = 0; i < c0437n2.f1118a.size(); i++) {
            C0457nm c0457nm = new C0457nm();
            Pair pair = (Pair) c0437n2.f1118a.get(i);
            c0457nm.f1134a = (String) pair.first;
            if (pair.second != null) {
                ...
                if (c0412m2 == null) {
                    ...
                    c0432mm2.f1113a = c0412m2.f1099a;
                    c0432mm = c0432mm2;
                }
                c0457nm.b = c0432mm;
            }
            c0482om.f1153a[i] = c0457nm;
        }
        return c0482om;
    }
    ...
    public final C0437n2 toModel(C0482om c0482om) {
        ...
        for (C0457nm c0457nm : c0482om.f1153a) {
            String str = c0457nm.f1134a;
            C0432mm c0432mm = c0457nm.b;
            arrayList.add(new Pair(str, c0432mm == null ? null : new C0412m2(c0432mm.f1113a)));
        }
