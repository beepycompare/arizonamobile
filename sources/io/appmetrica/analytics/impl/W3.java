...
public final class W3 extends AbstractC0378k8 {
    ...
    public final boolean a(N3 n3, N3 n32) {
        ...
        if (enumC0403l8 == EnumC0403l8.c) {
            if (((Number) this.f923a.a(enumC0403l8)).intValue() >= ((Number) this.f923a.a(n32.b)).intValue()) {
                return true;
            }
        } else if (((Number) this.f923a.a(enumC0403l8)).intValue() > ((Number) this.f923a.a(n32.b)).intValue()) {
            return true;
        }
        return false;
    }
