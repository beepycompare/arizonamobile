...
public final class C0445n extends V7 implements ActivityLifecycleRegistry {

    /* renamed from: a  reason: collision with root package name */
    public Application f960a;
    public volatile EnumC0420m b = EnumC0420m.d;
    public final Ka c = new Ka(true);

    public final synchronized void a(Context context) {
        if (this.f960a == null) {
            try {
                this.f960a = (Application) context.getApplicationContext();
    ...
    public final synchronized void b() {
        EnumC0420m enumC0420m = this.b;
        EnumC0420m enumC0420m2 = EnumC0420m.b;
        if (enumC0420m != enumC0420m2 && !this.c.f519a.isEmpty()) {
            if (this.f960a == null) {
                this.b = EnumC0420m.c;
                return;
            }
            this.b = enumC0420m2;
            this.f960a.registerActivityLifecycleCallbacks(this);
        }
    }

    public final synchronized void c() {
        if (this.b == EnumC0420m.b && this.c.f519a.isEmpty()) {
            this.b = EnumC0420m.d;
            Application application = this.f960a;
            if (application != null) {
    ...
    */
    public final synchronized void unregisterListener(ActivityLifecycleListener activityLifecycleListener, ActivityEvent... activityEventArr) {
        ...
        for (ActivityEvent activityEvent : activityEventArr) {
            Ka ka = this.c;
            Collection collection = (Collection) ka.f519a.get(activityEvent);
            if (collection != null && collection.remove(activityLifecycleListener)) {
                if (collection.isEmpty() && ka.b) {
                    ka.f519a.remove(activityEvent);
                }
    ...
    public final void a(Activity activity, ActivityEvent activityEvent) {
        ...
        synchronized (this) {
            collection = (Collection) this.c.f519a.get(activityEvent);
        }
        if (collection != null) {
