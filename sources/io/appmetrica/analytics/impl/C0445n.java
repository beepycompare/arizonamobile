...
public final class C0445n extends Z7 implements ActivityLifecycleRegistry {

    /* renamed from: a  reason: collision with root package name */
    public Application f999a;
    ...
    public final synchronized void a(Context context) {
        if (this.f999a == null) {
            try {
                this.f999a = (Application) context.getApplicationContext();
    ...
    public final synchronized void b() {
        ...
        if (enumC0419m != enumC0419m2 && !this.c.f624a.isEmpty()) {
            if (this.f999a == null) {
                this.b = EnumC0419m.c;
                return;
            }
            this.b = enumC0419m2;
            this.f999a.registerActivityLifecycleCallbacks(this);
        }
    }

    public final synchronized void c() {
        if (this.b == EnumC0419m.b && this.c.f624a.isEmpty()) {
            this.b = EnumC0419m.d;
            Application application = this.f999a;
            if (application != null) {
    ...
    */
    public final synchronized void unregisterListener(ActivityLifecycleListener activityLifecycleListener, ActivityEvent... activityEventArr) {
        ...
        for (ActivityEvent activityEvent : activityEventArr) {
            Pa pa = this.c;
            Collection collection = (Collection) pa.f624a.get(activityEvent);
            if (collection != null && collection.remove(activityLifecycleListener)) {
                if (collection.isEmpty() && pa.b) {
                    pa.f624a.remove(activityEvent);
                }
    ...
    public final void a(Activity activity, ActivityEvent activityEvent) {
        ...
        synchronized (this) {
            collection = (Collection) this.c.f624a.get(activityEvent);
        }
        if (collection != null) {
