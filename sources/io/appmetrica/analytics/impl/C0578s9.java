...
public final class C0578s9 extends Qf {
    ...
    public final HashMap a() {
        ...
        hashMap.put(EnumC0680wb.EVENT_TYPE_ACTIVATION, new C0295h(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_START, new El(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_REGULAR, new Tg(this.f1051a));
        Db db = new Db(this.f1051a);
        ...
        hashMap.put(EnumC0680wb.EVENT_TYPE_APP_OPEN, new C0133ah(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_PURGE_BUFFER, new C0235eg(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new N6(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new Jf(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new Sn(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new Kf(this.f1051a));
        hashMap.put(EnumC0680wb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new Rn(this.f1051a));
        ...
        hashMap.put(EnumC0680wb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new Z9(this.f1051a));
        return hashMap;
    }
