...
public abstract class AbstractC0191cm {
    ...
    */
    public static final boolean a(C0268fm c0268fm, Collection collection, Map map, Function0 function0) {
        boolean a2;
                ...
                switch (str.hashCode()) {
                    case -1367801046:
                        if (!str.equals(StartupParamsCallback.APPMETRICA_UUID)) {
                            ...
                            if (b.currentTimeSeconds() > c0268fm.o + c0268fm.A.f402a) {
                                return false;
                            }
                        } else {
                            a2 = a(c0268fm.d);
                    ...
                    case 530949152:
                        if (str.equals("appmetrica_clids")) {
                            c.getClass();
                            a2 = Y3.a(map, c0268fm, (V3) function0.invoke());
                            if (a2) {
                            }
                        } else if (c0268fm.w) {
                        }
