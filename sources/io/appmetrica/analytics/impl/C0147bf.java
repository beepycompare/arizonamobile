...
public final class C0147bf {
    ...
    public C0147bf(Context context) {
    ...
    public final String a(String str) {
        try {
            ...
            if (fileFromSdkStorage != null && str != null) {
                AbstractC0401lb.a(str, new FileOutputStream(fileFromSdkStorage));
            }
            return str;
    ...
    public C0147bf(Context context, Ro ro, So so) {
        this.f910a = context;
        this.b = ro;
        this.c = so;
    }
