...
public abstract class AbstractC0353jb {
    ...
    */
        ...
        if (file != null && file.exists()) {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        a(fileLock);
                        ro.a((Closeable) randomAccessFile);
                        bArr = array;
                        ...
                        try {
                            ...
                            c0414lk.getClass();
                            c0414lk.a(new Lj("error_during_file_reading", th));
                            bArr = null;
                            if (bArr == null) {
                            }
                        } finally {
            ...
            if (bArr == null) {
                try {
                    ...
                    C0414lk c0414lk2 = Kj.f543a;
                    c0414lk2.getClass();
                    c0414lk2.a(new Lj("read_share_file_with_unsupported_encoding", e));
                    return str;
                }
            }
            return null;
    ...
    public static void a(String str, FileOutputStream fileOutputStream) {
        ...
        try {
            ...
            a(fileLock);
            ro.a((Closeable) fileOutputStream);
        }
    }
}
