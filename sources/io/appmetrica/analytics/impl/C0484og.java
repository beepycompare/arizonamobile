...
public final class C0484og implements Wo {
    ...
    */
    public final byte[] a(C0296h9 c0296h9, Eh eh) {
        ...
        if (!StringUtils.isNullOrEmpty(c0296h9.b)) {
            try {
                byte[] decode = Base64.decode(c0296h9.b, 0);
                if (decode != null && decode.length != 0) {
                    bg = new Bg(decode);
                    C0691wg c0691wg = new C0691wg();
                    str = bg.f480a;
                    if (str != null) {
                        bytes = new byte[0];
                    } else {
                    ...
                    c0691wg.f1269a = bytes;
                    c0691wg.c = bg.b;
                    c0691wg.b = bg.c;
                    a2 = AbstractC0166c8.a(bg.d);
                    int i = 1;
                    if (a2 != 1) {
                        i = 2;
                        if (a2 != 2) {
                    ...
                    c0691wg.d = i;
                    return MessageNano.toByteArray(c0691wg);
                }
                bg = null;
                C0691wg c0691wg2 = new C0691wg();
                str = bg.f480a;
                if (str != null) {
                }
                c0691wg2.f1269a = bytes;
                c0691wg2.c = bg.b;
                c0691wg2.b = bg.c;
                a2 = AbstractC0166c8.a(bg.d);
                int i2 = 1;
                ...
                c0691wg2.d = i2;
                return MessageNano.toByteArray(c0691wg2);
