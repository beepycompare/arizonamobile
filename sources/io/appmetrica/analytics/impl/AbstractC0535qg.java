...
public abstract class AbstractC0535qg {
    ...
    static {
        ...
        P8 p8 = new P8();
        V8 v8 = new V8(new C0140b9());
        Q8 q8 = new Q8();
        C0573s3 c0573s3 = new C0573s3(new C0140b9());
        C0594so c0594so = new C0594so(new C0140b9());
        C0431mg c0431mg = new C0431mg();
        C0450n9 a2 = C0476o9.a();
        a2.b = c0431mg;
        a2.c = c0431mg;
        C0476o9 c0476o9 = new C0476o9(a2);
        C0450n9 a3 = C0476o9.a();
        a3.b = v8;
        C0476o9 c0476o92 = new C0476o9(a3);
        C0450n9 a4 = C0476o9.a();
        a4.b = c0573s3;
        C0476o9 c0476o93 = new C0476o9(a4);
        C0450n9 a5 = C0476o9.a();
        a5.b = c0594so;
        C0476o9 c0476o94 = new C0476o9(a5);
        C0450n9 a6 = C0476o9.a();
        a6.f1114a = p8;
        C0476o9 c0476o95 = new C0476o9(a6);
        C0450n9 a7 = C0476o9.a();
        a7.b = new Xo(new V8());
        C0476o9 c0476o96 = new C0476o9(a7);
        hashMap3.put(db2, c0476o92);
        C0450n9 a8 = C0476o9.a();
        a8.b = new C0483og();
        hashMap3.put(db3, new C0476o9(a8));
        C0450n9 a9 = C0476o9.a();
        a9.f1114a = p8;
        a9.b = q8;
        a9.e = new C0501p8();
        a9.f = new C0527q8();
        hashMap3.put(db4, new C0476o9(a9));
        hashMap3.put(db9, c0476o9);
        hashMap3.put(db10, c0476o9);
        hashMap3.put(db11, c0476o93);
        hashMap3.put(db12, c0476o93);
        hashMap3.put(db5, c0476o93);
        hashMap3.put(db6, c0476o93);
        hashMap3.put(db7, c0476o93);
        hashMap3.put(db8, c0476o93);
        C0450n9 a10 = C0476o9.a();
        a10.f1114a = new P8();
        a10.b = c0573s3;
        hashMap3.put(db14, new C0476o9(a10));
        Db db25 = Db.EVENT_TYPE_CUSTOM_EVENT;
        C0450n9 a11 = C0476o9.a();
        a11.d = new C0509pg();
        hashMap3.put(db25, new C0476o9(a11));
        hashMap3.put(db15, c0476o92);
        hashMap3.put(db17, c0476o95);
        hashMap3.put(db18, c0476o95);
        hashMap3.put(db19, c0476o93);
        hashMap3.put(db20, c0476o93);
        hashMap3.put(db21, c0476o93);
        hashMap3.put(db22, c0476o94);
        hashMap3.put(db, c0476o96);
        hashMap3.put(db16, c0476o96);
        hashMap3.put(db13, c0476o92);
        hashMap3.put(db23, c0476o92);
        hashMap3.put(db24, c0476o93);
