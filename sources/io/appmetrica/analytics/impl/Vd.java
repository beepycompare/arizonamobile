...
public abstract class Vd implements InterfaceC0391ko, InterfaceC0524q2 {
    ...
    public final C0417lo a() {
        ...
        c0417lo.b = this.b;
        c0417lo.f980a = this.f711a.getBytes();
    ...
    public final boolean f() {
        wo a2 = this.c.a(this.f711a);
        if (a2.f1145a) {
            return true;
        }
        this.e.warning("Attribute " + this.f711a + " of type " + ((String) Un.f704a.get(this.b)) + " is skipped because " + a2.b, new Object[0]);
        return false;
    }
