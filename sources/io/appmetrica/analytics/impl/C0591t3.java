...
public final class C0591t3 implements ProtobufConverter {
    ...
    public final C0691x3 fromModel(C0566s3 c0566s3) {
        ...
        c0691x3.f1298a = a(c0566s3.f1217a);
    ...
    public final C0566s3 toModel(C0691x3 c0691x3) {
        C0616u3 c0616u3 = c0691x3.f1298a;
        if (c0616u3 == null) {
            c0616u3 = new C0616u3();
        }
    ...
    public static C0616u3 a(C0541r3 c0541r3) {
        ...
        if (map != null) {
            ...
            c0666w3.f1281a = c0641v3Arr;
            int i3 = 0;
            for (Map.Entry entry : map.entrySet()) {
                C0641v3 c0641v3 = c0666w3.f1281a[i3];
                c0641v3.f1268a = (String) entry.getKey();
    ...
    public static C0541r3 a(C0616u3 c0616u3) {
        ...
        S7 s7;
        C0666w3 c0666w3 = c0616u3.f1248a;
        if (c0666w3 != null) {
            C0641v3[] c0641v3Arr = c0666w3.f1281a;
            ...
            for (C0641v3 c0641v3 : c0641v3Arr) {
                Pair pair = TuplesKt.to(c0641v3.f1268a, c0641v3.b);
