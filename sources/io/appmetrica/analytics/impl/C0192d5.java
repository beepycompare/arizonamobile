...
public final class C0192d5 extends DatabaseScript {

    /* renamed from: a  reason: collision with root package name */
    public final int f824a = 2000;
    ...
    public final C7 x = new C7(null, 1, null);

    public static boolean a(B7 b7) {
        Long l;
        EnumC0728yb enumC0728yb;
        Long l2;
        Long l3;
        Long l4 = b7.f358a;
        if (l4 == null || l4.longValue() < RealConnection.IDLE_CONNECTION_HEALTHY_NS || b7.b == null || (l = b7.c) == null || l.longValue() < 0 || (enumC0728yb = b7.d) == null || enumC0728yb == EnumC0728yb.EVENT_TYPE_UNDEFINED || (l2 = b7.e) == null || l2.longValue() < 0 || (l3 = b7.f) == null || l3.longValue() < 0) {
            return false;
        }
        Long l5 = b7.g.d;
    ...
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            ...
            try {
                cursor = sQLiteDatabase2.query(this.w, null, null, null, null, null, null, String.valueOf(this.f824a));
    ...
    */
    public final B7 a(Cursor cursor) {
        EnumC0156bl enumC0156bl;
        Integer valueOf;
        EnumC0196d9 enumC0196d9;
        EnumC0196d9 enumC0196d92;
        Integer valueOf2;
        Integer valueOf3;
        J9 j9;
        J9 j92;
        ...
        try {
            ...
            EnumC0156bl enumC0156bl2 = EnumC0156bl.FOREGROUND;
            boolean z = true;
            if (valueOf5 != null) {
            }
            enumC0156bl2 = EnumC0156bl.BACKGROUND;
            try {
                if (valueOf5 != null && valueOf5.intValue() == 1) {
                    enumC0156bl = enumC0156bl2;
                    Long valueOf6 = Long.valueOf(cursor.getLong(cursor.getColumnIndexOrThrow(this.b)));
                    EnumC0728yb a2 = EnumC0728yb.a(cursor.getInt(cursor.getColumnIndexOrThrow(this.g)));
                    ...
                    enumC0196d9 = EnumC0196d9.NONE;
                    if (valueOf != null) {
                    }
                    enumC0196d9 = EnumC0196d9.AES_VALUE_ENCRYPTION;
                    if (valueOf != null && valueOf.intValue() == 2) {
                        enumC0196d92 = enumC0196d9;
                    ...
                    enumC0196d9 = EnumC0196d9.EXTERNALLY_ENCRYPTED_EVENT_CRYPTER;
                    if (valueOf != null && valueOf.intValue() == 1) {
                        enumC0196d92 = enumC0196d9;
                        String string52 = cursor.getString(cursor.getColumnIndexOrThrow(this.q));
                        valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                        Aa aa3 = Aa.FIRST_OCCURRENCE;
                        if (valueOf2 != null) {
                            Aa aa2222 = aa3;
                            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                            j9 = J9.NATIVE;
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    Aa aa32 = Aa.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    aa32 = Aa.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    aa32 = Aa.UNKNOWN;
                    Aa aa2222222 = aa32;
                ...
                if (valueOf != null) {
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    Aa aa322 = Aa.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    aa322 = Aa.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    aa322 = Aa.UNKNOWN;
                    Aa aa22222222 = aa322;
                ...
                if (valueOf != null) {
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    Aa aa3222 = Aa.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    aa3222 = Aa.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    aa3222 = Aa.UNKNOWN;
                    Aa aa222222222 = aa3222;
                    valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                    j9 = J9.NATIVE;
                    if (valueOf3 != null) {
                    }
            ...
            EnumC0728yb a22 = EnumC0728yb.a(cursor.getInt(cursor.getColumnIndexOrThrow(this.g)));
            ...
            valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
            Aa aa32222 = Aa.FIRST_OCCURRENCE;
            if (valueOf2 != null) {
            }
            aa32222 = Aa.NON_FIRST_OCCURENCE;
            if (valueOf2 != null) {
            }
            aa32222 = Aa.UNKNOWN;
            Aa aa2222222222 = aa32222;
            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
            j9 = J9.NATIVE;
            if (valueOf3 != null) {
            }
            ...
            return new B7(valueOf4, enumC0156bl, valueOf62, a22, valueOf72, valueOf82, new A7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, enumC0196d92, string522222, aa2222222222, j92, valueOf13, valueOf14, columnIndex >= 0 ? null : cursor.getBlob(columnIndex)));
            Integer valueOf142 = Integer.valueOf(i);
            int columnIndex2 = cursor.getColumnIndex(this.v);
            return new B7(valueOf4, enumC0156bl, valueOf62, a22, valueOf72, valueOf82, new A7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, enumC0196d92, string522222, aa2222222222, j92, valueOf13, valueOf142, columnIndex2 >= 0 ? null : cursor.getBlob(columnIndex2)));
        } catch (Throwable unused3) {
            return null;
        }
    }
