...
public final class C0574sf implements ProtobufConverter {
    ...
    public final C0525qf f1217a = new C0525qf();

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final C0425mf fromModel(C0549rf c0549rf) {
        C0425mf c0425mf = new C0425mf();
        if (!TextUtils.isEmpty(c0549rf.f1200a)) {
            c0425mf.f1109a = c0549rf.f1200a;
        }
        c0425mf.b = c0549rf.b.toString();
        c0425mf.c = c0549rf.c;
        c0425mf.d = c0549rf.d;
        c0425mf.e = this.f1217a.fromModel(c0549rf.e).intValue();
        return c0425mf;
    }
    ...
    public final C0549rf toModel(C0425mf c0425mf) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            return new C0549rf(str, jSONObject, c0425mf.c, c0425mf.d, this.f1217a.toModel(Integer.valueOf(c0425mf.e)));
        }
