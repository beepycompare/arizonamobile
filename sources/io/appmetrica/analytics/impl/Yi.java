...
public final class Yi implements Converter {
    ...
    public final Di fromModel(C0176cj c0176cj) {
        ...
        Mn a2 = this.c.a(c0176cj.f946a);
        c0521q8.f1191a = StringUtils.getUTF8Bytes((String) a2.f704a);
        List<String> list = c0176cj.b;
        Di di2 = null;
        if (list != null) {
            di = this.b.fromModel(list);
            c0521q8.b = (C0242f8) di.f557a;
        } else {
            di = null;
        }
        Mn a3 = this.d.a(c0176cj.c);
        c0521q8.c = StringUtils.getUTF8Bytes((String) a3.f704a);
        Map<String, String> map = c0176cj.d;
        if (map != null) {
            di2 = this.f875a.fromModel(map);
            c0521q8.d = (C0396l8) di2.f557a;
        }
