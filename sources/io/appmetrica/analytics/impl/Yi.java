...
public final class Yi implements Converter {
    ...
    public final Di fromModel(C0177cj c0177cj) {
        ...
        Mn a2 = this.c.a(c0177cj.f942a);
        c0522q8.f1187a = StringUtils.getUTF8Bytes((String) a2.f700a);
        List<String> list = c0177cj.b;
        Di di2 = null;
        if (list != null) {
            di = this.b.fromModel(list);
            c0522q8.b = (C0243f8) di.f553a;
        } else {
            di = null;
        }
        Mn a3 = this.d.a(c0177cj.c);
        c0522q8.c = StringUtils.getUTF8Bytes((String) a3.f700a);
        Map<String, String> map = c0177cj.d;
        if (map != null) {
            di2 = this.f871a.fromModel(map);
            c0522q8.d = (C0397l8) di2.f553a;
        }
