...
public final class C0545r0 {
    ...
    public final S1 g;
    public final T1 h;
    public final RunnableC0494p0 i;
    public final ServiceConnectionC0520q0 j;

    public C0545r0(Context context, ICommonExecutor iCommonExecutor) {
        this(context, iCommonExecutor, C0575s4.l().e(), new T1());
    }
    ...
    public C0545r0(Context context, ICommonExecutor iCommonExecutor, S1 s1, T1 t1) {
        this.d = null;
        this.f = new Object();
        this.i = new RunnableC0494p0(this);
        this.j = new ServiceConnectionC0520q0(this);
