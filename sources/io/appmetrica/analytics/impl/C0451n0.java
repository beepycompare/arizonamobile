...
public final class C0451n0 implements Ua {
    ...
    */
    public final synchronized void a(AppMetricaConfig appMetricaConfig, InterfaceC0437mb interfaceC0437mb) {
        if (!C0600t0.g) {
            ...
            this.f.b();
            if (appMetricaConfig != null) {
                this.f.a(this.f948a, appMetricaConfig, interfaceC0437mb);
            }
            if (appMetricaConfig != null) {
            }
            this.e.b();
