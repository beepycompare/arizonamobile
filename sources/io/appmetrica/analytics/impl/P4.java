...
public final class P4 extends DatabaseScript {
    ...
    public final C0443n7 x = new C0443n7(null, 1, null);

    public static boolean a(C0418m7 c0418m7) {
        Long l;
        EnumC0320ib enumC0320ib;
        Long l2;
        Long l3;
        Long l4 = c0418m7.f1004a;
        if (l4 == null || l4.longValue() < RealConnection.IDLE_CONNECTION_HEALTHY_NS || c0418m7.b == null || (l = c0418m7.c) == null || l.longValue() < 0 || (enumC0320ib = c0418m7.d) == null || enumC0320ib == EnumC0320ib.EVENT_TYPE_UNDEFINED || (l2 = c0418m7.e) == null || l2.longValue() < 0 || (l3 = c0418m7.f) == null || l3.longValue() < 0) {
            return false;
        }
        Long l5 = c0418m7.g.d;
        if (l5 == null || l5.longValue() >= 0) {
            Integer num = c0418m7.g.i;
    ...
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            ...
            try {
                cursor = sQLiteDatabase2.query(this.w, null, null, null, null, null, null, String.valueOf(this.f630a));
    ...
    */
    public final C0418m7 a(Cursor cursor) {
        ...
        try {
            ...
            EnumC0123al enumC0123al2 = EnumC0123al.FOREGROUND;
            boolean z = true;
            if (valueOf5 != null) {
            }
            enumC0123al2 = EnumC0123al.BACKGROUND;
            try {
                if (valueOf5 != null && valueOf5.intValue() == 1) {
                    enumC0123al = enumC0123al2;
                    Long valueOf6 = Long.valueOf(cursor.getLong(cursor.getColumnIndexOrThrow(this.b)));
                    EnumC0320ib a2 = EnumC0320ib.a(cursor.getInt(cursor.getColumnIndexOrThrow(this.g)));
                    ...
                    if (valueOf != null && valueOf.intValue() == 2) {
                        ...
                        EnumC0370ka enumC0370ka = EnumC0370ka.FIRST_OCCURRENCE;
                        if (valueOf2 != null && valueOf2.intValue() == 1) {
                            EnumC0370ka enumC0370ka2 = enumC0370ka;
                            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                            enumC0594t9 = EnumC0594t9.NATIVE;
                            if (valueOf3 != null && valueOf3.intValue() == 0) {
                                enumC0594t92 = enumC0594t9;
                            }
                            enumC0594t9 = EnumC0594t9.JS;
                            if (valueOf3 != null) {
                            }
                            enumC0594t92 = null;
                        }
                        enumC0370ka = EnumC0370ka.NON_FIRST_OCCURENCE;
                        if (valueOf2 != null && valueOf2.intValue() == 2) {
                            EnumC0370ka enumC0370ka22 = enumC0370ka;
                            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                            enumC0594t9 = EnumC0594t9.NATIVE;
                            if (valueOf3 != null) {
                                enumC0594t92 = enumC0594t9;
                        ...
                        EnumC0370ka enumC0370ka222 = enumC0370ka;
                        valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                        enumC0594t9 = EnumC0594t9.NATIVE;
                        if (valueOf3 != null) {
                        }
                    ...
                    n8 = N8.EXTERNALLY_ENCRYPTED_EVENT_CRYPTER;
                    if (valueOf != null && valueOf.intValue() == 1) {
                        n82 = n8;
                        String string52 = cursor.getString(cursor.getColumnIndexOrThrow(this.q));
                        valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                        EnumC0370ka enumC0370ka3 = EnumC0370ka.FIRST_OCCURRENCE;
                        if (valueOf2 != null) {
                            EnumC0370ka enumC0370ka2222 = enumC0370ka3;
                            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                            enumC0594t9 = EnumC0594t9.NATIVE;
                            if (valueOf3 != null) {
                            }
                        ...
                        enumC0370ka3 = EnumC0370ka.NON_FIRST_OCCURENCE;
                        if (valueOf2 != null) {
                            EnumC0370ka enumC0370ka22222 = enumC0370ka3;
                            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                            enumC0594t9 = EnumC0594t9.NATIVE;
                            if (valueOf3 != null) {
                            }
                        ...
                        enumC0370ka3 = EnumC0370ka.UNKNOWN;
                        EnumC0370ka enumC0370ka222222 = enumC0370ka3;
                        valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                        enumC0594t9 = EnumC0594t9.NATIVE;
                        if (valueOf3 != null) {
                        }
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    EnumC0370ka enumC0370ka32 = EnumC0370ka.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka32 = EnumC0370ka.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka32 = EnumC0370ka.UNKNOWN;
                    EnumC0370ka enumC0370ka2222222 = enumC0370ka32;
                    valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                    enumC0594t9 = EnumC0594t9.NATIVE;
                    if (valueOf3 != null) {
                    }
                ...
                if (valueOf != null) {
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    EnumC0370ka enumC0370ka322 = EnumC0370ka.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka322 = EnumC0370ka.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka322 = EnumC0370ka.UNKNOWN;
                    EnumC0370ka enumC0370ka22222222 = enumC0370ka322;
                    valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                    enumC0594t9 = EnumC0594t9.NATIVE;
                    if (valueOf3 != null) {
                    }
                ...
                if (valueOf != null) {
                    ...
                    valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
                    EnumC0370ka enumC0370ka3222 = EnumC0370ka.FIRST_OCCURRENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka3222 = EnumC0370ka.NON_FIRST_OCCURENCE;
                    if (valueOf2 != null) {
                    }
                    enumC0370ka3222 = EnumC0370ka.UNKNOWN;
                    EnumC0370ka enumC0370ka222222222 = enumC0370ka3222;
                    valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
                    enumC0594t9 = EnumC0594t9.NATIVE;
                    if (valueOf3 != null) {
                    }
            ...
            EnumC0320ib a22 = EnumC0320ib.a(cursor.getInt(cursor.getColumnIndexOrThrow(this.g)));
            ...
            valueOf2 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.r)));
            EnumC0370ka enumC0370ka32222 = EnumC0370ka.FIRST_OCCURRENCE;
            if (valueOf2 != null) {
            }
            enumC0370ka32222 = EnumC0370ka.NON_FIRST_OCCURENCE;
            if (valueOf2 != null) {
            }
            enumC0370ka32222 = EnumC0370ka.UNKNOWN;
            EnumC0370ka enumC0370ka2222222222 = enumC0370ka32222;
            valueOf3 = Integer.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(this.s)));
            enumC0594t9 = EnumC0594t9.NATIVE;
            if (valueOf3 != null) {
            }
            ...
            return new C0418m7(valueOf4, enumC0123al, valueOf62, a22, valueOf72, valueOf82, new C0393l7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, n82, string522222, enumC0370ka2222222222, enumC0594t92, valueOf13, valueOf14, columnIndex >= 0 ? null : cursor.getBlob(columnIndex)));
            Integer valueOf142 = Integer.valueOf(i);
            int columnIndex2 = cursor.getColumnIndex(this.v);
            return new C0418m7(valueOf4, enumC0123al, valueOf62, a22, valueOf72, valueOf82, new C0393l7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, n82, string522222, enumC0370ka2222222222, enumC0594t92, valueOf13, valueOf142, columnIndex2 >= 0 ? null : cursor.getBlob(columnIndex2)));
        } catch (Throwable unused3) {
            return null;
        }
    }
