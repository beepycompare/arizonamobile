...
public abstract class AbstractC0410lf {
    ...
    public final C0435mf c(String str) {
        return new C0435mf(str, this.b);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0410lf> T a(String str, String[] strArr) {
        String str2;
        try {
    ...
    public final <T extends AbstractC0410lf> T a(String str, List<String> list) {
