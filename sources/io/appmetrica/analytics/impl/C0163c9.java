...
public final class C0163c9 extends MessageNano {
    public static volatile C0163c9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        C0137b9[] c0137b9Arr = this.l;
        if (c0137b9Arr != null && c0137b9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0137b9[] c0137b9Arr2 = this.l;
                if (i4 >= c0137b9Arr2.length) {
                    break;
                }
                C0137b9 c0137b9 = c0137b9Arr2[i4];
                if (c0137b9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0137b9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0137b9Arr != null && c0137b9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0137b9 c0137b9 = c0137b9Arr2[i4];
                if (c0137b9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0137b9);
                }
                i4++;
            }
        }
    ...
    public static C0163c9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0163c9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0163c9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 186:
                    ...
                    C0137b9[] c0137b9Arr = this.l;
                    int length = c0137b9Arr == null ? 0 : c0137b9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0137b9[] c0137b9Arr2 = new C0137b9[i];
                    if (length != 0) {
                        System.arraycopy(c0137b9Arr, 0, c0137b9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0137b9 c0137b9 = new C0137b9();
                        c0137b9Arr2[length] = c0137b9;
                        codedInputByteBufferNano.readMessage(c0137b9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0137b9 c0137b92 = new C0137b9();
                    c0137b9Arr2[length] = c0137b92;
                    codedInputByteBufferNano.readMessage(c0137b92);
                    this.l = c0137b9Arr2;
                    break;
    ...
    public static C0163c9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0163c9) MessageNano.mergeFrom(new C0163c9(), bArr);
    }
}
