...
public final class Eh extends C0189d6 {
    public boolean d;
    public boolean e;
    public int f;
    public int g;
    ...
    @Override // io.appmetrica.analytics.impl.C0189d6, io.appmetrica.analytics.networktasks.internal.BaseRequestConfig
    ...
    public final boolean v() {
        return isIdentifiersValid() && !Oo.a((Collection) this.q) && this.u;
    }

    public final boolean w() {
        return ((C0446n5) this.l).B();
    }
    ...
    public final void a(Boolean bool, Bh bh) {
        this.j = bool;
        this.k = bh;
    }
