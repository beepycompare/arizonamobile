...
public final class C0692wl implements InterfaceC0719xn {
    ...
    public final C0567rl b() {
        return new C0567rl((Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f1144a, "phone", "getting SimMcc", "TelephonyManager", new C0592sl()), (Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f1144a, "phone", "getting SimMnc", "TelephonyManager", new C0617tl()), ((Boolean) SystemServiceUtils.accessSystemServiceByNameSafelyOrDefault(this.f1144a, "phone", "getting NetworkRoaming", "TelephonyManager", Boolean.FALSE, new C0667vl(this))).booleanValue(), (String) SystemServiceUtils.accessSystemServiceByNameSafely(this.f1144a, "phone", "getting SimOperatorName", "TelephonyManager", new C0642ul()));
    }

    /* JADX WARN: Code restructure failed: missing block: B:8:0x0017, code lost:
        if (r4.c.shouldUpdateData() != false) goto L12;
     */
    @Override // io.appmetrica.analytics.impl.InterfaceC0719xn
    /* renamed from: c */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final synchronized List<C0567rl> a() {
        ArrayList arrayList;
        ...
        if (Na.F.u.b().n.d) {
            if (AndroidUtils.isApiAchieved(23)) {
                if (this.b.hasPermission(this.f1144a, "android.permission.READ_PHONE_STATE")) {
                    arrayList2.addAll(C0717xl.a(this.f1144a));
                }
