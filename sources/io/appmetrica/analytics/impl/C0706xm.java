...
public final class C0706xm extends MessageNano {
    public static final int D = -1;
    public static final int E = 0;
    public static final int F = 1;
    public static volatile C0706xm[] G;
    public C0656vm A;
    public C0606tm[] B;
    public C0556rm C;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1287a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1287a);
        }
        ...
        C0532qm[] c0532qmArr = this.h;
        if (c0532qmArr != null && c0532qmArr.length > 0) {
            int i11 = 0;
            while (true) {
                C0532qm[] c0532qmArr2 = this.h;
                if (i11 >= c0532qmArr2.length) {
                    break;
                }
                C0532qm c0532qm = c0532qmArr2[i11];
                if (c0532qm != null) {
                    computeInt64Size += CodedOutputByteBufferNano.computeMessageSize(8, c0532qm);
                }
                i11++;
            }
        }
        C0581sm c0581sm = this.i;
        if (c0581sm != null) {
            computeInt64Size += CodedOutputByteBufferNano.computeMessageSize(9, c0581sm);
        }
        if (!this.j.equals("")) {
        ...
        C0681wm c0681wm = this.p;
        if (c0681wm != null) {
            computeBoolSize += CodedOutputByteBufferNano.computeMessageSize(16, c0681wm);
        }
        boolean z = this.q;
        if (z) {
        ...
        C0631um c0631um = this.v;
        if (c0631um != null) {
            computeInt64Size2 += CodedOutputByteBufferNano.computeMessageSize(24, c0631um);
        }
        ...
        C0507pm c0507pm = this.y;
        if (c0507pm != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(27, c0507pm);
        }
        C0482om c0482om = this.z;
        if (c0482om != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(29, c0482om);
        }
        C0656vm c0656vm = this.A;
        if (c0656vm != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(30, c0656vm);
        }
        C0606tm[] c0606tmArr = this.B;
        if (c0606tmArr != null && c0606tmArr.length > 0) {
            while (true) {
                C0606tm[] c0606tmArr2 = this.B;
                if (i >= c0606tmArr2.length) {
                    break;
                }
                C0606tm c0606tm = c0606tmArr2[i];
                if (c0606tm != null) {
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(31, c0606tm);
                }
                i++;
            }
        }
        C0556rm c0556rm = this.C;
        return c0556rm != null ? CodedOutputByteBufferNano.computeMessageSize(32, c0556rm) + computeInt32Size : computeInt32Size;
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1287a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1287a);
        }
        ...
        if (c0532qmArr != null && c0532qmArr.length > 0) {
            ...
            while (true) {
                C0532qm[] c0532qmArr2 = this.h;
                if (i5 >= c0532qmArr2.length) {
                    break;
                }
                C0532qm c0532qm = c0532qmArr2[i5];
                if (c0532qm != null) {
                    codedOutputByteBufferNano.writeMessage(8, c0532qm);
                }
                i5++;
            }
        }
        C0581sm c0581sm = this.i;
        if (c0581sm != null) {
            codedOutputByteBufferNano.writeMessage(9, c0581sm);
        }
        if (!this.j.equals("")) {
        ...
        C0681wm c0681wm = this.p;
        if (c0681wm != null) {
            codedOutputByteBufferNano.writeMessage(16, c0681wm);
        }
        boolean z = this.q;
        if (z) {
        ...
        C0631um c0631um = this.v;
        if (c0631um != null) {
            codedOutputByteBufferNano.writeMessage(24, c0631um);
        }
        codedOutputByteBufferNano.writeInt32(25, this.w);
        codedOutputByteBufferNano.writeInt32(26, this.x);
        C0507pm c0507pm = this.y;
        if (c0507pm != null) {
            codedOutputByteBufferNano.writeMessage(27, c0507pm);
        }
        C0482om c0482om = this.z;
        if (c0482om != null) {
            codedOutputByteBufferNano.writeMessage(29, c0482om);
        }
        C0656vm c0656vm = this.A;
        if (c0656vm != null) {
            codedOutputByteBufferNano.writeMessage(30, c0656vm);
        }
        C0606tm[] c0606tmArr = this.B;
        if (c0606tmArr != null && c0606tmArr.length > 0) {
            while (true) {
                ...
                C0606tm c0606tm = c0606tmArr2[i];
                if (c0606tm != null) {
                    codedOutputByteBufferNano.writeMessage(31, c0606tm);
                }
                i++;
            }
        }
        C0556rm c0556rm = this.C;
        if (c0556rm != null) {
            codedOutputByteBufferNano.writeMessage(32, c0556rm);
        }
        super.writeTo(codedOutputByteBufferNano);
    }

    public static C0706xm b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0706xm().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0706xm mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1287a = codedInputByteBufferNano.readString();
                    break;
                case 16:
                ...
                case ConstraintLayout.LayoutParams.Table.LAYOUT_WRAP_BEHAVIOR_IN_PARENT /* 66 */:
                    ...
                    C0532qm[] c0532qmArr = this.h;
                    int length4 = c0532qmArr == null ? 0 : c0532qmArr.length;
                    int i4 = repeatedFieldArrayLength4 + length4;
                    C0532qm[] c0532qmArr2 = new C0532qm[i4];
                    if (length4 != 0) {
                        System.arraycopy(c0532qmArr, 0, c0532qmArr2, 0, length4);
                    }
                    while (length4 < i4 - 1) {
                        C0532qm c0532qm = new C0532qm();
                        c0532qmArr2[length4] = c0532qm;
                        codedInputByteBufferNano.readMessage(c0532qm);
                        codedInputByteBufferNano.readTag();
                        length4++;
                    }
                    C0532qm c0532qm2 = new C0532qm();
                    c0532qmArr2[length4] = c0532qm2;
                    codedInputByteBufferNano.readMessage(c0532qm2);
                    this.h = c0532qmArr2;
                    break;
                case 74:
                    if (this.i == null) {
                ...
                case 250:
                    ...
                    C0606tm[] c0606tmArr = this.B;
                    int length6 = c0606tmArr == null ? 0 : c0606tmArr.length;
                    int i6 = repeatedFieldArrayLength6 + length6;
                    C0606tm[] c0606tmArr2 = new C0606tm[i6];
                    if (length6 != 0) {
                        System.arraycopy(c0606tmArr, 0, c0606tmArr2, 0, length6);
                    }
                    while (length6 < i6 - 1) {
                        C0606tm c0606tm = new C0606tm();
                        c0606tmArr2[length6] = c0606tm;
                        codedInputByteBufferNano.readMessage(c0606tm);
                        codedInputByteBufferNano.readTag();
                        length6++;
                    }
                    C0606tm c0606tm2 = new C0606tm();
                    c0606tmArr2[length6] = c0606tm2;
                    codedInputByteBufferNano.readMessage(c0606tm2);
                    this.B = c0606tmArr2;
                    break;
                case 258:
                    if (this.C == null) {
    ...
    public static C0706xm a(byte[] bArr) throws InvalidProtocolBufferNanoException {
