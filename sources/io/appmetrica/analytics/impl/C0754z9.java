...
public final class C0754z9 extends MessageNano {
    ...
    public static volatile C0754z9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f1167a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0629u9 c0629u9 = this.f;
        if (c0629u9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0629u9);
        }
        C0729y9 c0729y9 = this.g;
        if (c0729y9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0729y9);
        }
        if (!this.h.equals("")) {
        ...
        C0704x9[] c0704x9Arr = this.s;
        if (c0704x9Arr != null && c0704x9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0704x9[] c0704x9Arr2 = this.s;
                if (i6 >= c0704x9Arr2.length) {
                    break;
                }
                C0704x9 c0704x9 = c0704x9Arr2[i6];
                if (c0704x9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0704x9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f1167a);
        ...
        C0629u9 c0629u9 = this.f;
        if (c0629u9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0629u9);
        }
        C0729y9 c0729y9 = this.g;
        if (c0729y9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0729y9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0704x9Arr != null && c0704x9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0704x9 c0704x9 = c0704x9Arr2[i6];
                if (c0704x9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0704x9);
                }
                i6++;
            }
        }
    ...
    public static C0754z9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0754z9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0754z9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f1167a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0704x9[] c0704x9Arr = this.s;
                    int length = c0704x9Arr == null ? 0 : c0704x9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0704x9[] c0704x9Arr2 = new C0704x9[i];
                    if (length != 0) {
                        System.arraycopy(c0704x9Arr, 0, c0704x9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0704x9 c0704x9 = new C0704x9();
                        c0704x9Arr2[length] = c0704x9;
                        codedInputByteBufferNano.readMessage(c0704x9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0704x9 c0704x92 = new C0704x9();
                    c0704x9Arr2[length] = c0704x92;
                    codedInputByteBufferNano.readMessage(c0704x92);
                    this.s = c0704x9Arr2;
                    break;
                default:
    ...
    public static C0754z9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0754z9) MessageNano.mergeFrom(new C0754z9(), bArr);
    }
}
