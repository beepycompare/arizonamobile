...
public final class B2 {
    public static void a(Fm fm, JSONObject jSONObject) {
            ...
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    if (!TextUtils.isEmpty(optString)) {
                        ...
                        arrayList.add(new Pair(optString, optString2 != null ? new C0728y2(optString2) : null));
                    }
                }
            }
            fm.s = new C0754z2(arrayList);
        }
    }
}
