...
public final class C0601t6 extends MessageNano {
    public static final int l = 0;
    public static final int m = 1;
    public static volatile C0601t6[] n;
    public static byte[] o;
    public static volatile boolean p;

    /* renamed from: a  reason: collision with root package name */
    public C0701x6 f1060a;
    public C0452n6 b;
    public String c;
    public int d;
    public C0651v6[] e;
    ...
    public final int computeSerializedSize() {
        ...
        C0576s6 c0576s6 = this.h;
        if (c0576s6 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(8, c0576s6);
        }
        ...
        C0502p6[] c0502p6Arr = this.k;
        if (c0502p6Arr != null && c0502p6Arr.length > 0) {
            while (true) {
                C0502p6[] c0502p6Arr2 = this.k;
                if (i2 >= c0502p6Arr2.length) {
                    break;
                }
                C0502p6 c0502p6 = c0502p6Arr2[i2];
                if (c0502p6 != null) {
                    computeSerializedSize = CodedOutputByteBufferNano.computeMessageSize(11, c0502p6) + computeSerializedSize;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0576s6 c0576s6 = this.h;
        if (c0576s6 != null) {
            codedOutputByteBufferNano.writeMessage(8, c0576s6);
        }
        if (!Arrays.equals(this.i, o)) {
        ...
        if (c0502p6Arr != null && c0502p6Arr.length > 0) {
            while (true) {
                ...
                C0502p6 c0502p6 = c0502p6Arr2[i2];
                if (c0502p6 != null) {
                    codedOutputByteBufferNano.writeMessage(11, c0502p6);
                }
                i2++;
            }
        }
    ...
    public static C0601t6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0601t6().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0601t6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 10:
                    if (this.f1060a == null) {
                        this.f1060a = new C0701x6();
                    }
                    codedInputByteBufferNano.readMessage(this.f1060a);
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new C0452n6();
    ...
    public static C0601t6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0601t6) MessageNano.mergeFrom(new C0601t6(), bArr);
    }
}
