...
public final class Xa implements Parcelable {
    ...
    public final ResultReceiver f852a;
    public final List b;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        bundle.putParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver", this.f852a);
        if (this.b != null) {
    ...
    public Xa(Parcel parcel) {
        ...
        if (readBundle != null) {
            this.f852a = (ResultReceiver) readBundle.getParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver");
