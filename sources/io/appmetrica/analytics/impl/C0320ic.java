...
public final class C0320ic extends J2 implements Ja {
    ...
    public final void a(AppMetricaConfig appMetricaConfig, C0385l0 c0385l0) {
        ...
        List<String> list = c0385l0.f1081a;
        ...
        if (booleanValue) {
            ...
            cd.d = new H0(this.b.b.getApiKey(), cd.f528a.f530a.getAsString("PROCESS_CFG_PACKAGE_NAME"), CounterConfigurationReporterType.MAIN, cd.f528a.f530a.getAsInteger("PROCESS_CFG_PROCESS_ID").intValue(), cd.f528a.f530a.getAsString("PROCESS_CFG_PROCESS_SESSION_ID"), this.b.d());
        ...
        synchronized (c0345jc) {
            ...
            c0345jc.f1053a = num != null ? num.intValue() : 5;
            Boolean bool = appMetricaConfig.anrMonitoring;
            if (bool == null) {
                bool = Boolean.FALSE;
            }
            if (bool.booleanValue()) {
                c0345jc.b.a(c0345jc.f1053a);
            } else {
                c0345jc.b.b();
            }
        }
    ...
    public final void b(Activity activity) {
        if (this.q.i.a(activity, EnumC0484p.PAUSED)) {
            ...
            synchronized (c0232f2) {
                c0232f2.getClass();
                for (C0206e2 c0206e2 : c0232f2.f979a) {
                    if (!c0206e2.d) {
                        c0206e2.d = true;
    ...
    public final void a(EnumC0434n enumC0434n) {
        if (enumC0434n == EnumC0434n.b) {
            ...
            this.c.warning("Could not enable activity auto tracking. " + enumC0434n.f1115a, new Object[0]);
        }
    }
    ...
    public final void a(Io io2) {
        ...
        Iterator it = io2.f628a.iterator();
        while (it.hasNext()) {
    ...
    public final void a(String str, String str2) {
        ...
        H0 h0 = cd.d;
        if (h0 != null) {
            H0 h02 = new H0(h0.f597a, h0.b, h0.c, h0.d, h0.e, d);
            cd.d = h02;
            NativeCrashClientModule nativeCrashClientModule = cd.b;
            cd.c.getClass();
