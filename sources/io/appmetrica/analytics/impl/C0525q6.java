...
public final class C0525q6 extends MessageNano {
    public static volatile C0525q6[] g;
    ...
    public final int computeSerializedSize() {
        ...
        C0499p6[] c0499p6Arr = this.f;
        if (c0499p6Arr != null && c0499p6Arr.length > 0) {
            int i2 = 0;
            while (true) {
                C0499p6[] c0499p6Arr2 = this.f;
                if (i2 >= c0499p6Arr2.length) {
                    break;
                }
                C0499p6 c0499p6 = c0499p6Arr2[i2];
                if (c0499p6 != null) {
                    computeSInt64Size = CodedOutputByteBufferNano.computeMessageSize(6, c0499p6) + computeSInt64Size;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0499p6Arr != null && c0499p6Arr.length > 0) {
            ...
            while (true) {
                ...
                C0499p6 c0499p6 = c0499p6Arr2[i2];
                if (c0499p6 != null) {
                    codedOutputByteBufferNano.writeMessage(6, c0499p6);
                }
                i2++;
            }
        }
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0525q6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0525q6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0525q6().mergeFrom(codedInputByteBufferNano);
    }

    public static C0525q6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0525q6) MessageNano.mergeFrom(new C0525q6(), bArr);
    }
}
