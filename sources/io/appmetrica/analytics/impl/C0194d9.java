...
public final class C0194d9 implements Converter {
    ...
    public final byte[] fromModel(Map<String, byte[]> map) {
        ...
        for (Object obj : map.entrySet()) {
            ...
            c0219e9.f959a = (String) entry.getKey();
            c0219e9.b = (byte[]) entry.getValue();
            c0219e9Arr[i] = c0219e9;
            i = i2;
        }
        c0245f9.f976a = c0219e9Arr;
    ...
    public final Map<String, byte[]> toModel(byte[] bArr) {
        C0219e9[] c0219e9Arr = ((C0245f9) MessageNano.mergeFrom(new C0245f9(), bArr)).f976a;
        ...
        for (C0219e9 c0219e9 : c0219e9Arr) {
            Pair pair = TuplesKt.to(c0219e9.f959a, c0219e9.b);
