...
public final class P3 implements ProtobufConverter {
    ...
    public static N3 a(Q3 q3) {
        ...
        if (s3 != null) {
            ...
            for (R3 r3 : r3Arr) {
                Pair pair = TuplesKt.to(r3.f618a, r3.b);
        ...
        if (i == 0) {
            ...
            enumC0403l8 = EnumC0403l8.c;
        } else if (i == 2) {
            enumC0403l8 = EnumC0403l8.d;
        } else if (i != 3) {
            enumC0403l8 = EnumC0403l8.b;
        } else {
            enumC0403l8 = EnumC0403l8.e;
        }
        return new N3(linkedHashMap, enumC0403l8);
    }
}
