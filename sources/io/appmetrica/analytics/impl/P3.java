...
public final class P3 implements ProtobufConverter {
    ...
    public static N3 a(Q3 q3) {
        ...
        if (s3 != null) {
            ...
            for (R3 r3 : r3Arr) {
                Pair pair = TuplesKt.to(r3.f627a, r3.b);
        ...
        if (i == 0) {
            ...
            enumC0451n8 = EnumC0451n8.c;
        } else if (i == 2) {
            enumC0451n8 = EnumC0451n8.d;
        } else if (i != 3) {
            enumC0451n8 = EnumC0451n8.b;
        } else {
            enumC0451n8 = EnumC0451n8.e;
        }
        return new N3(linkedHashMap, enumC0451n8);
    }
}
