...
public final class Ab extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f502a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f502a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f502a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f502a);
        }
        if (!this.b.equals("")) {
    ...
    public final Ab mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f502a = codedInputByteBufferNano.readString();
            } else if (readTag == 154) {
