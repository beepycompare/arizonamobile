...
public final class Ab implements InternalClientModuleFacade {
    ...
    public final C0485od f349a = new C0485od();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : AbstractC0459nd.f1004a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = AbstractC0758zb.f1189a[category2.ordinal()];
            if (i != 1) {
