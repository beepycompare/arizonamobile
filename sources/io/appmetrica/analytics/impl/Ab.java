...
public final class Ab implements InternalClientModuleFacade {
    ...
    public final C0484od f344a = new C0484od();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : AbstractC0458nd.f999a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = AbstractC0757zb.f1184a[category2.ordinal()];
            if (i != 1) {
