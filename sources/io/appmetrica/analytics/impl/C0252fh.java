...
public final class C0252fh extends BaseRequestConfig.BaseRequestArguments {
    ...
    public static C0252fh a() {
        return new C0252fh(null, null, null, null, null, null, null, null, null, null);
    }
    ...
    @Override // io.appmetrica.analytics.networktasks.internal.ArgumentsMerger
    /* renamed from: a */
    public final boolean compareWithOtherArguments(C0468o4 c0468o4) {
        Map<String, String> map;
        String str;
        Boolean bool = c0468o4.b;
        if (bool == null || this.b == bool.booleanValue()) {
            Boolean bool2 = c0468o4.d;
            if (bool2 == null || this.c == bool2.booleanValue()) {
                Integer num = c0468o4.e;
                if (num == null || this.d == num.intValue()) {
                    Integer num2 = c0468o4.f;
                    if (num2 == null || this.e == num2.intValue()) {
                        Integer num3 = c0468o4.g;
                        if (num3 == null || this.f == num3.intValue()) {
                            Boolean bool3 = c0468o4.h;
