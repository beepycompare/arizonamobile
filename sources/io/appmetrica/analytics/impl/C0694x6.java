...
public final class C0694x6 {

    /* renamed from: a  reason: collision with root package name */
    public final Tl f1301a = new Tl();
    ...
    */
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = AbstractC0272gb.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        if (hashMap != null) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                emptyMap.put(key, new IdentifiersResult(String.valueOf(lo.a((Collection) list2) ? null : new JSONArray((Collection) list2)), identifiersResult.status, identifiersResult.errorExplanation));
            }
        } else {
        ...
        for (Map.Entry entry2 : emptyMap.entrySet()) {
            ...
            if (str4 != null) {
                try {
                    list = AbstractC0272gb.a(new JSONArray(str4));
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        Tl tl = this.f1301a;
        String a2 = AbstractC0272gb.a((Map) linkedHashMap);
