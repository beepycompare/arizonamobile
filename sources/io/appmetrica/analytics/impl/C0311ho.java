...
public final class C0311ho extends MessageNano {
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0311ho mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0311ho b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0311ho().mergeFrom(codedInputByteBufferNano);
    }

    public static C0311ho a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0311ho) MessageNano.mergeFrom(new C0311ho(), bArr);
    }
}
