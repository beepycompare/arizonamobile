...
public abstract class AbstractC0536qg {

    /* renamed from: a  reason: collision with root package name */
    public static final Map f1166a;
    ...
    static {
        ...
        P8 p8 = new P8();
        V8 v8 = new V8(new C0141b9());
        Q8 q8 = new Q8();
        C0574s3 c0574s3 = new C0574s3(new C0141b9());
        C0595so c0595so = new C0595so(new C0141b9());
        C0432mg c0432mg = new C0432mg();
        C0451n9 a2 = C0477o9.a();
        a2.b = c0432mg;
        a2.c = c0432mg;
        C0477o9 c0477o9 = new C0477o9(a2);
        C0451n9 a3 = C0477o9.a();
        a3.b = v8;
        C0477o9 c0477o92 = new C0477o9(a3);
        C0451n9 a4 = C0477o9.a();
        a4.b = c0574s3;
        C0477o9 c0477o93 = new C0477o9(a4);
        C0451n9 a5 = C0477o9.a();
        a5.b = c0595so;
        C0477o9 c0477o94 = new C0477o9(a5);
        C0451n9 a6 = C0477o9.a();
        a6.f1114a = p8;
        C0477o9 c0477o95 = new C0477o9(a6);
        C0451n9 a7 = C0477o9.a();
        a7.b = new Xo(new V8());
        C0477o9 c0477o96 = new C0477o9(a7);
        hashMap3.put(db2, c0477o92);
        C0451n9 a8 = C0477o9.a();
        a8.b = new C0484og();
        hashMap3.put(db3, new C0477o9(a8));
        C0451n9 a9 = C0477o9.a();
        a9.f1114a = p8;
        a9.b = q8;
        a9.e = new C0502p8();
        a9.f = new C0528q8();
        hashMap3.put(db4, new C0477o9(a9));
        hashMap3.put(db9, c0477o9);
        hashMap3.put(db10, c0477o9);
        hashMap3.put(db11, c0477o93);
        hashMap3.put(db12, c0477o93);
        hashMap3.put(db5, c0477o93);
        hashMap3.put(db6, c0477o93);
        hashMap3.put(db7, c0477o93);
        hashMap3.put(db8, c0477o93);
        C0451n9 a10 = C0477o9.a();
        a10.f1114a = new P8();
        a10.b = c0574s3;
        hashMap3.put(db14, new C0477o9(a10));
        Db db25 = Db.EVENT_TYPE_CUSTOM_EVENT;
        C0451n9 a11 = C0477o9.a();
        a11.d = new C0510pg();
        hashMap3.put(db25, new C0477o9(a11));
        hashMap3.put(db15, c0477o92);
        hashMap3.put(db17, c0477o95);
        hashMap3.put(db18, c0477o95);
        hashMap3.put(db19, c0477o93);
        hashMap3.put(db20, c0477o93);
        hashMap3.put(db21, c0477o93);
        hashMap3.put(db22, c0477o94);
        hashMap3.put(db, c0477o96);
        hashMap3.put(db16, c0477o96);
        hashMap3.put(db13, c0477o92);
        hashMap3.put(db23, c0477o92);
        hashMap3.put(db24, c0477o93);
