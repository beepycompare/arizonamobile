...
public enum EnumC0165cb {
    ...
    static {
        EnumC0165cb[] values;
        for (EnumC0165cb enumC0165cb : values()) {
            K.put(Integer.valueOf(enumC0165cb.f829a), enumC0165cb);
        }
    }

    EnumC0165cb(int i, String str) {
        this.f829a = i;
        this.b = str;
    }
    ...
    public static EnumC0165cb a(int i) {
        EnumC0165cb enumC0165cb = (EnumC0165cb) K.get(Integer.valueOf(i));
        return enumC0165cb == null ? EVENT_TYPE_UNDEFINED : enumC0165cb;
    }
}
