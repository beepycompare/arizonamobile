...
public final class Vg implements J {
    ...
    public final AdTrackingInfoResult b(Context context) {
        ...
        bundle.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", this.f714a);
        Ug ug = this.b;
        ...
        if (bundle2 != null) {
            ...
            if (bundle3 != null) {
                Object obj = U5.f695a.get(bundle3.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
                if (obj != null) {
