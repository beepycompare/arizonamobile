...
public final class Nb implements InterfaceC0180cb, Closeable {
    ...
    */
    public static void a(Nb nb) {
        ...
        Cursor cursor = null;
        try {
            sQLiteDatabase = nb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(nb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(nb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(nb.c, null, contentValues2, 5);
                        }
                    }
    ...
    @Override // io.appmetrica.analytics.impl.InterfaceC0180cb
    public final synchronized InterfaceC0180cb a(String str, String str2) {
        a(str, (Object) str2);
        return this;
    }
    ...
    @Override // io.appmetrica.analytics.impl.InterfaceC0180cb
    public final synchronized InterfaceC0180cb a(int i, String str) {
