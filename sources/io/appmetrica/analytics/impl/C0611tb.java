...
public final class C0611tb implements InternalClientModuleFacade {

    /* renamed from: a  reason: collision with root package name */
    public final C0315hd f1057a = new C0315hd();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : AbstractC0290gd.f852a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = AbstractC0586sb.f1042a[category2.ordinal()];
            if (i != 1) {
