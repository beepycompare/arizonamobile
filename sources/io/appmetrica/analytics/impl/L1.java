...
public final class L1 implements InterfaceC0747z1, InterfaceC0546r0 {
    ...
    public final void onCreate() {
        if (!this.f550a) {
            ...
            AbstractC0572s1.f1075a.b(context2);
            ...
            if (absolutePath != null) {
                ...
                q.f940a.setDefaultCrashHandler(q.b.a(context3, c0488oh));
            }
    ...
    public final void reportData(int i, Bundle bundle) {
        this.j.getClass();
        List<InterfaceC0641uk> list = (List) Na.F.v.f1130a.get(Integer.valueOf(i));
        if (list == null) {
    ...
    public final void a(Intent intent, int i) {
        ((C0672w1) this.c).f1134a.stopSelfResult(i);
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0747z1
    public final void a(Intent intent, int i, int i2) {
        ((C0672w1) this.c).f1134a.stopSelfResult(i2);
    }
}
