...
public final class C0192co extends MessageNano {
    ...
    public static volatile C0192co[] i;
    ...
    public final C0192co a() {
        this.f806a = WireFormatNano.EMPTY_BYTES;
        this.b = 0;
        this.c = null;
        this.d = null;
        this.cachedSize = -1;
    ...
    public final int computeSerializedSize() {
        int computeInt32Size = CodedOutputByteBufferNano.computeInt32Size(2, this.b) + CodedOutputByteBufferNano.computeBytesSize(1, this.f806a) + super.computeSerializedSize();
        Cdo cdo = this.c;
        if (cdo != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(3, cdo);
        }
        C0243eo c0243eo = this.d;
        return c0243eo != null ? CodedOutputByteBufferNano.computeMessageSize(4, c0243eo) + computeInt32Size : computeInt32Size;
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeBytes(1, this.f806a);
        ...
        C0243eo c0243eo = this.d;
        if (c0243eo != null) {
            codedOutputByteBufferNano.writeMessage(4, c0243eo);
        }
    ...
    public final C0192co mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f806a = codedInputByteBufferNano.readBytes();
            } else if (readTag == 16) {
