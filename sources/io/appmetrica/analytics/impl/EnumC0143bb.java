...
public enum EnumC0143bb {
    ...
    static {
        EnumC0143bb[] values;
        for (EnumC0143bb enumC0143bb : values()) {
            K.put(Integer.valueOf(enumC0143bb.f917a), enumC0143bb);
        }
    }

    EnumC0143bb(int i, String str) {
        this.f917a = i;
        this.b = str;
    }
    ...
    public static EnumC0143bb a(int i) {
        EnumC0143bb enumC0143bb = (EnumC0143bb) K.get(Integer.valueOf(i));
        return enumC0143bb == null ? EVENT_TYPE_UNDEFINED : enumC0143bb;
    }
}
