...
public final class Bl implements SimpleNetworkApi {
    ...
    public final CacheControlHttpsConnectionPerformer f370a = new CacheControlHttpsConnectionPerformer(((Jl) Na.j().y()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f370a.performConnection(str, new D3(networkClientWithCacheControl));
    }
}
