...
public final class C0461nj {

    /* renamed from: a  reason: collision with root package name */
    public final Context f1120a;

    public C0461nj(Context context) {
        this.f1120a = context;
    }

    public static final void a(C0461nj c0461nj, ServiceConnection serviceConnection) {
        c0461nj.getClass();
        try {
            c0461nj.f1120a.unbindService(serviceConnection);
    ...
    */
    public final void a(Dg dg) {
        ...
        if (queryIntentServices.isEmpty()) {
            ...
            try {
                if (this.f1120a.bindService(intent2, new ServiceConnectionC0435mj(this, dg), 1)) {
                    return;
                }
