...
public final class RunnableC0597t1 implements Runnable {
    ...
    public final /* synthetic */ C0649v1 d;

    public RunnableC0597t1(C0649v1 c0649v1, String str, String str2, Throwable th) {
        this.d = c0649v1;
        this.f1208a = str;
        this.b = str2;
        this.c = th;
    ...
    public final void run() {
        C0649v1.a(this.d).reportError(this.f1208a, this.b, this.c);
    }
}
