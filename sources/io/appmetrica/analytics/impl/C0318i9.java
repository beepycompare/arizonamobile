...
public final class C0318i9 extends MessageNano {
    public static volatile C0318i9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f929a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f929a);
        }
        if (!this.b.equals("")) {
        ...
        C0292h9[] c0292h9Arr = this.l;
        if (c0292h9Arr != null && c0292h9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0292h9[] c0292h9Arr2 = this.l;
                if (i4 >= c0292h9Arr2.length) {
                    break;
                }
                C0292h9 c0292h9 = c0292h9Arr2[i4];
                if (c0292h9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0292h9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f929a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f929a);
        }
        if (!this.b.equals("")) {
        ...
        if (c0292h9Arr != null && c0292h9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0292h9 c0292h9 = c0292h9Arr2[i4];
                if (c0292h9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0292h9);
                }
                i4++;
            }
        }
    ...
    public static C0318i9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0318i9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0318i9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f929a = codedInputByteBufferNano.readString();
                    break;
                case 18:
                ...
                case 186:
                    ...
                    C0292h9[] c0292h9Arr2 = new C0292h9[i];
                    if (length != 0) {
    ...
    public static C0318i9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0318i9) MessageNano.mergeFrom(new C0318i9(), bArr);
    }
}
