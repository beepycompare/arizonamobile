...
public final class Tm extends Wm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0228eg("clids_info", iBinaryDataHelper, new V8(u3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new P3());
    }
