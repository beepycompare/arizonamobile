...
public final class Tm extends AbstractC0132an {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0331ig("startup_state", iBinaryDataHelper, new Y8(hm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0519pm());
    }
