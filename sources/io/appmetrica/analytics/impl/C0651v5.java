...
public class C0651v5 implements InterfaceC0508pb, InterfaceC0223eb, Fh {
    ...
    public final void w() {
        ...
        Do r1 = this.t;
        synchronized (r1) {
            optInt = r1.f413a.a().optInt("last_migration_api_level", 0);
        }
    ...
    public final void b(C0477o6 c0477o6) {
        ...
        synchronized (c0341j0) {
            if (a2.b > c0537qf.d().b) {
                c0537qf.a(a2).b();
                this.m.info("Save new app environment for %s. Value: %s", this.b, a2.f898a);
            }
        }
    }
    ...
    public C0651v5(Context context, C0476o5 c0476o5, C0341j0 c0341j0, TimePassedChecker timePassedChecker, A5 a5, M4 m4) {
        ...
        this.j = a7;
        a4.info("Read app environment for component %s. Value: %s", c0476o5.toString(), a6.a().f898a);
        Tk c = a5.c();
        this.u = c;
