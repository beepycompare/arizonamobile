...
public final class C0766zm implements UnderlyingNetworkTask {
    ...
    public C0766zm(Bm bm, FullUrlFormer<C0164bm> fullUrlFormer, RequestDataHolder requestDataHolder, ResponseDataHolder responseDataHolder, ConfigProvider<C0164bm> configProvider) {
    ...
    public final RetryPolicyConfig getRetryPolicyConfig() {
        return ((C0164bm) this.e.getConfig()).getRetryPolicyConfig();
    }
    ...
    public final boolean onRequestComplete() {
        C0216dm handle = this.h.handle(this.f);
        this.b = handle;
        return handle != null;
    }
    ...
    public C0766zm(Bm bm, Rl rl, FullUrlFormer fullUrlFormer, RequestDataHolder requestDataHolder, ResponseDataHolder responseDataHolder, ConfigProvider configProvider) {
        ...
        fullUrlFormer.setHosts(((C0164bm) configProvider.getConfig()).k());
    }
}
