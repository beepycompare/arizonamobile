...
public final class Cm extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f396a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f396a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f396a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f396a);
        }
    ...
    public final Cm mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f396a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
