...
public final class C0311he implements ServiceNetworkContext {

    /* renamed from: a  reason: collision with root package name */
    public final A5 f884a;
    public final String b = new Zn().a();
    public final C0591sl c = new C0591sl();

    public C0311he(Context context) {
        this.f884a = new A5(new K5(context), new Ci(Ia.j().g()));
    }
