...
public final class C0129a5 extends Qh {
    public C0129a5(Nf nf) {
        super(nf, new CounterConfiguration(), new T8(new C0497ol(LoggerStorage.getMainPublicOrAnonymousLogger(), "Crash Environment")));
