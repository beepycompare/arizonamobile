...
public final class C0189d4 extends C0242f6 {
    ...
    public static C0189d4 a(PublicLogger publicLogger, C0358jj c0358jj) {
        ...
        c0307hj.b = c0358jj.f1054a.currency.getCurrencyCode().getBytes();
        c0307hj.f = c0358jj.f1054a.priceMicros;
        c0307hj.c = StringUtils.stringToBytesForProtobuf(new C0777zn(200, "revenue productID", c0358jj.e).a(c0358jj.f1054a.productID));
        c0307hj.f1021a = ((Integer) WrapUtils.getOrDefault(c0358jj.f1054a.quantity, 1)).intValue();
        C0699wn c0699wn = c0358jj.b;
        String str = c0358jj.f1054a.payload;
        c0699wn.getClass();
        c0307hj.d = StringUtils.stringToBytesForProtobuf(c0699wn.a(str));
        if (Oo.a(c0358jj.f1054a.receipt)) {
            C0178cj c0178cj = new C0178cj();
            String str2 = (String) c0358jj.c.a(c0358jj.f1054a.receipt.data);
            i = !StringUtils.equalsNullSafety(c0358jj.f1054a.receipt.data, str2) ? c0358jj.f1054a.receipt.data.length() : 0;
            c0178cj.f932a = StringUtils.stringToBytesForProtobuf(str2);
            c0178cj.b = StringUtils.stringToBytesForProtobuf((String) c0358jj.d.a(c0358jj.f1054a.receipt.signature));
            c0307hj.e = c0178cj;
        } else {
            i = 0;
        }
