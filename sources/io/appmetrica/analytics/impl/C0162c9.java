...
public final class C0162c9 extends MessageNano {
    public static volatile C0162c9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f925a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f925a);
        }
        if (!this.b.equals("")) {
        ...
        C0136b9[] c0136b9Arr = this.l;
        if (c0136b9Arr != null && c0136b9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0136b9[] c0136b9Arr2 = this.l;
                if (i4 >= c0136b9Arr2.length) {
                    break;
                }
                C0136b9 c0136b9 = c0136b9Arr2[i4];
                if (c0136b9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0136b9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f925a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f925a);
        }
        if (!this.b.equals("")) {
        ...
        if (c0136b9Arr != null && c0136b9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0136b9 c0136b9 = c0136b9Arr2[i4];
                if (c0136b9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0136b9);
                }
                i4++;
            }
        }
    ...
    public static C0162c9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0162c9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0162c9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f925a = codedInputByteBufferNano.readString();
                    break;
                case 18:
                ...
                case 186:
                    ...
                    C0136b9[] c0136b9Arr = this.l;
                    int length = c0136b9Arr == null ? 0 : c0136b9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0136b9[] c0136b9Arr2 = new C0136b9[i];
                    if (length != 0) {
                        System.arraycopy(c0136b9Arr, 0, c0136b9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0136b9 c0136b9 = new C0136b9();
                        c0136b9Arr2[length] = c0136b9;
                        codedInputByteBufferNano.readMessage(c0136b9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0136b9 c0136b92 = new C0136b9();
                    c0136b9Arr2[length] = c0136b92;
                    codedInputByteBufferNano.readMessage(c0136b92);
                    this.l = c0136b9Arr2;
                    break;
    ...
    public static C0162c9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0162c9) MessageNano.mergeFrom(new C0162c9(), bArr);
    }
}
