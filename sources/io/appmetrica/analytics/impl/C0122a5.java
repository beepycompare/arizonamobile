...
public final class C0122a5 extends Sh {
    public C0122a5(Pf pf) {
        super(pf, new CounterConfiguration(), new W8(new C0566rl(LoggerStorage.getMainPublicOrAnonymousLogger(), "Crash Environment")));
