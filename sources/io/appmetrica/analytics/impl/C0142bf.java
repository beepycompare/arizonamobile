...
public final class C0142bf implements ProtobufConverter {
    ...
    public final C0450nf fromModel(C0194df c0194df) {
        ...
        if (!TextUtils.isEmpty(c0194df.f949a)) {
            c0450nf.f1128a = c0194df.f949a;
        }
        c0450nf.b = c0194df.b.toString();
        c0450nf.c = this.f915a.fromModel(c0194df.c).intValue();
        return c0450nf;
    }
    ...
    public final C0194df toModel(C0450nf c0450nf) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            return new C0194df(str, jSONObject, this.f915a.toModel(Integer.valueOf(c0450nf.c)));
        }
