...
public final class Pb implements InterfaceC0223eb, Closeable {
    ...
    public Pb(U6 u6) {
        this.f = u6;
        Ob ob = new Ob(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(Qd.a())));
        this.d = ob;
        ob.start();
    }
    ...
    */
    public static void a(Pb pb) {
        ...
        Cursor cursor = null;
        try {
            sQLiteDatabase = pb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(pb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final InterfaceC0223eb remove(String str) {
        synchronized (this.f603a) {
            c();
            this.f603a.remove(str);
        }
        synchronized (this.d) {
            this.b.put(str, this);
            this.d.notifyAll();
    ...
    public final Object b(String str) {
        ...
        synchronized (this.f603a) {
            c();
            obj = this.f603a.get(str);
        }
        return obj;
    }

    public static void a(Pb pb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        pb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(pb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(pb.c, null, contentValues2, 5);
                        }
                    }
    ...
    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final synchronized InterfaceC0223eb a(String str, String str2) {
        a(str, (Object) str2);
        return this;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final InterfaceC0223eb a(String str, long j) {
        a(str, Long.valueOf(j));
        return this;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final synchronized InterfaceC0223eb a(int i, String str) {
        a(str, Integer.valueOf(i));
        return this;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final InterfaceC0223eb a(String str, boolean z) {
        a(str, Boolean.valueOf(z));
        return this;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0223eb
    public final InterfaceC0223eb a(String str, float f) {
    ...
    public final boolean a(String str) {
        ...
        synchronized (this.f603a) {
            c();
            containsKey = this.f603a.containsKey(str);
        }
        return containsKey;
    }
    ...
    public final Set a() {
        HashSet hashSet;
        synchronized (this.f603a) {
            hashSet = new HashSet(this.f603a.keySet());
        }
        return hashSet;
    }
