...
public final class C0654vk implements ModuleRemoteConfig {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0654vk) {
            ...
            return Intrinsics.areEqual(this.f1271a, c0654vk.f1271a) && Intrinsics.areEqual(this.b, c0654vk.b) && Intrinsics.areEqual(this.c, c0654vk.c);
        }
        return false;
    }
    ...
    public final int hashCode() {
        int hashCode = (this.b.hashCode() + (this.f1271a.hashCode() * 31)) * 31;
        Object obj = this.c;
        return hashCode + (obj == null ? 0 : obj.hashCode());
    }

    public final String toString() {
        return "ServiceModuleRemoteConfigModel(identifiers=" + this.f1271a + ", remoteConfigMetaInfo=" + this.b + ", featuresConfig=" + this.c + ')';
    }
