...
public final class Be {
    ...
    public final String a(String str) {
        try {
            ...
            File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f411a, "uuid.dat");
    ...
    public final void a() {
        ...
        File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f411a, "uuid.dat");
        if (fileFromSdkStorage == null || fileFromSdkStorage.exists() || (fileFromAppStorage = FileUtils.getFileFromAppStorage(this.f411a, "uuid.dat")) == null || !fileFromAppStorage.exists()) {
            return;
        }
