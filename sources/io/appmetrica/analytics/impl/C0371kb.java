...
public final class C0371kb {
    ...
    public C0371kb(String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        JSONObject jSONObject2 = jSONObject.getJSONObject(NotificationCompat.CATEGORY_EVENT);
        this.f974a = Base64.decode(jSONObject2.getString("jvm_crash"), 0);
        ...
        if (optString != null) {
            try {
                HashMap c = AbstractC0294hb.c(optString);
                if (c != null) {
    ...
    public final String k() throws JSONException {
        ...
        return new JSONObject().put("process_configuration", new JSONObject().put("pid", this.f).put("psid", this.g).put("package_name", this.e)).put("reporter_configuration", new JSONObject().put("api_key", this.h).put("reporter_type", this.i.getStringValue())).put(NotificationCompat.CATEGORY_EVENT, new JSONObject().put("jvm_crash", Base64.encodeToString(this.f974a, 0)).put("name", this.b).put("bytes_truncated", this.c).put("trimmed_fields", AbstractC0294hb.b(hashMap)).putOpt("environment", this.j)).toString();
    }
    ...
    public C0371kb(Q5 q5, I3 i3, HashMap<M3, Integer> hashMap) {
        this.f974a = q5.getValueBytes();
        this.b = q5.getName();
