...
public final class C0280gj extends MessageNano {
    public static final int f = 0;
    public static final int g = 1;
    public static final int h = 2;
    public static volatile C0280gj[] i;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0280gj mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0280gj b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0280gj().mergeFrom(codedInputByteBufferNano);
    }

    public static C0280gj a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0280gj) MessageNano.mergeFrom(new C0280gj(), bArr);
    }
}
