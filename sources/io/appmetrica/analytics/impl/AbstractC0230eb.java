...
public abstract class AbstractC0230eb {
        ...
        if (file != null && file.exists()) {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        a(fileLock);
                        io.a((Closeable) randomAccessFile);
                        bArr = array;
                        ...
                        try {
                            ...
                            c0188ck.getClass();
                            c0188ck.a(new Cj("error_during_file_reading", th));
                            bArr = null;
                            if (bArr == null) {
                            }
                        } finally {
            ...
            if (bArr == null) {
                try {
                    ...
                    C0188ck c0188ck2 = Bj.f361a;
                    c0188ck2.getClass();
                    c0188ck2.a(new Cj("read_share_file_with_unsupported_encoding", e));
                    return str;
                }
            }
            return null;
