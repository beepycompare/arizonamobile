...
public final class Bg extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f360a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f360a);
        }
        long j = this.b;
        if (j != 0) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f360a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f360a);
        }
        long j = this.b;
        if (j != 0) {
    ...
    public final Bg mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f360a = codedInputByteBufferNano.readString();
            } else if (readTag == 16) {
