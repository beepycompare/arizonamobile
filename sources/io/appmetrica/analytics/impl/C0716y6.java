...
public final class C0716y6 {

    /* renamed from: a  reason: collision with root package name */
    public final Ul f1213a = new Ul();
    ...
    */
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = AbstractC0294hb.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        for (Map.Entry entry2 : emptyMap.entrySet()) {
            ...
            if (str4 != null) {
                try {
                    list = AbstractC0294hb.a(new JSONArray(str4));
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        Ul ul = this.f1213a;
        String a2 = AbstractC0294hb.a((Map) linkedHashMap);
