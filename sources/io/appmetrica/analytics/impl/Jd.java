...
public final class Jd implements NativeCrashHandler {
    ...
    public static final void a(Jd jd, NativeCrash nativeCrash, File file) {
        jd.f647a.invoke(nativeCrash.getUuid());
    }
    ...
    public final void newCrash(final NativeCrash nativeCrash) {
        ...
        if (g0 != null) {
            LoggerStorage.getOrCreatePublicLogger(g0.f.f610a).info("Detected native crash with uuid = " + g0.c, new Object[0]);
            ...
            md.getClass();
            Fd fd = new Fd(new Hd(g0.f593a, g0.b), md.f);
            Cd cd = new Cd(md.b, g0.f, new Ld(g0, md.d));
            C0115aa c0115aa = md.e;
            String str = g0.d;
            c0115aa.getClass();
            File file = new File(str);
            Context context = md.f698a;
            if (Z9.c == null) {
        ...
        this.f647a.invoke(nativeCrash.getUuid());
    }
}
