...
public final class C0470oa {
    ...
    public final C0508pn C() {
        ...
        if (c0508pn2 == null) {
            synchronized (this) {
                c0508pn = this.x;
                if (c0508pn == null) {
                    c0508pn = new C0508pn(this.f1144a);
                    this.x = c0508pn;
                }
            }
            return c0508pn;
        ...
        if (this.j == null) {
            synchronized (this) {
                if (this.j == null) {
                    ...
                    this.j = new C0624uf(this.f1144a, a3, new C0400lf(), new C0168cf(c0219ef), new C0599tf(), new C0374kf(this.f1144a), new C0500pf(k().y()), new C0245ff(), c0219ef, "[PreloadInfoStorage]");
                }
            }
        }
    }
    ...
    public final U c() {
        ...
        if (u2 == null) {
            synchronized (this) {
                u = this.g;
                if (u == null) {
                    u = new U(this.f1144a, this.d.a(), this.u.b());
                    this.u.a(u);
                    this.g = u;
                }
            }
    ...
    public final C0129b2 d() {
        ...
        if (c0129b22 == null) {
            synchronized (this) {
                c0129b2 = this.h;
                if (c0129b2 == null) {
                    c0129b2 = new C0129b2(this.f1144a, AbstractC0155c2.a());
                    this.h = c0129b2;
                }
            }
            return c0129b2;
        ...
        if (this.k == null) {
            synchronized (this) {
                if (this.k == null) {
                    ...
                    Sm sm = (Sm) a2;
                    ProtobufStateStorage<Object> a3 = sm.a(context, sm.a(context));
                    this.k = new A3(this.f1144a, a3, new B3(), new C0463o3(), new E3(), new Ui(this.f1144a), new C3(y()), new C0488p3(), (C0587t3) a3.read(), "[ClidsInfoStorage]");
                }
            }
        }
        return this.k;
    ...
    public final Gb l() {
        ...
        if (gb2 == null) {
            synchronized (this) {
                gb = this.o;
                if (gb == null) {
                    gb = new Gb(new P2(this.f1144a, this.d.a()), new C0284h2());
                    this.o = gb;
                }
            }
            return gb;
    ...
    public final C0672wd q() {
        ...
        if (c0672wd2 == null) {
            synchronized (this) {
                c0672wd = this.z;
                if (c0672wd == null) {
                    c0672wd = new C0672wd(this.f1144a, new oo());
                    this.z = c0672wd;
                }
            }
            return c0672wd;
    ...
    public final C0426mg u() {
        if (this.b == null) {
            synchronized (this) {
                if (this.b == null) {
                    this.b = new C0426mg(this.f1144a, I.D().c);
                }
            }
        }
        return this.b;
    ...
    public final C0249fj v() {
        ...
        if (c0249fj2 == null) {
            synchronized (this) {
                c0249fj = this.n;
                if (c0249fj == null) {
                    c0249fj = new C0249fj(this.f1144a);
                    this.n = c0249fj;
                }
            }
            return c0249fj;
    ...
    public final C0116af y() {
        if (this.l == null) {
            synchronized (this) {
                if (this.l == null) {
                    this.l = new C0116af(B().d(this.f1144a));
                }
            }
        }
        return this.l;
