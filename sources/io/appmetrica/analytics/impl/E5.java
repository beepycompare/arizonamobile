...
public abstract class E5 implements Ej {
    ...
    public E5(BaseRequestConfig.RequestConfigLoader<Object, C0137b6> requestConfigLoader, Hm hm, ArgumentsMerger<Object, Object> argumentsMerger) {
        this.b = requestConfigLoader;
        Na.k().v().a(this);
        a(new C0137b6(hm, Na.k().v(), Na.k().s(), argumentsMerger));
    }

    public final synchronized void a(C0137b6 c0137b6) {
        this.c = c0137b6;
    }
    ...
    public synchronized void a(Object obj) {
        if (!((ArgumentsMerger) this.c.componentArguments).compareWithOtherArguments(obj)) {
            a(new C0137b6(c(), Na.I.v(), Na.I.s(), (ArgumentsMerger) ((ArgumentsMerger) this.c.componentArguments).mergeFrom(obj)));
            e();
        }
    }

    public final synchronized void a(Hm hm) {
        a(new C0137b6(hm, Na.I.v(), Na.I.s(), b()));
        e();
    }
