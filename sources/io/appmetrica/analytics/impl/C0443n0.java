...
public final class C0443n0 implements Ya {
    ...
    public C0443n0(Context context, C0447n4 c0447n4) {
        ...
        a().a();
        AbstractC0139b4.a().onCreate();
    }

    public static final void e() {
        ImportantLogger.INSTANCE.info("AppMetrica", "Initializing of AppMetrica, " + StringUtils.capitalize("release") + " type, Version 7.11.0, API Level " + AppMetrica.getLibraryApiLevel() + ", Dated 21.08.2025.", new Object[0]);
    }
    ...
    */
    public final synchronized void a(AppMetricaConfig appMetricaConfig, InterfaceC0529qb interfaceC0529qb) {
        if (!C0592t0.g) {
            ...
            this.f.b();
            if (appMetricaConfig != null) {
                this.f.a(this.f976a, appMetricaConfig, interfaceC0529qb);
            }
            if (appMetricaConfig != null) {
            }
            this.e.b();
