...
public final class C0598t6 extends MessageNano {
    public static volatile C0598t6[] g;
    ...
    public final int computeSerializedSize() {
        int computeSInt64Size = CodedOutputByteBufferNano.computeSInt64Size(3, this.c) + CodedOutputByteBufferNano.computeSInt32Size(2, this.b) + CodedOutputByteBufferNano.computeStringSize(1, this.f1054a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0573s6[] c0573s6Arr = this.f;
        if (c0573s6Arr != null && c0573s6Arr.length > 0) {
            int i2 = 0;
            while (true) {
                C0573s6[] c0573s6Arr2 = this.f;
                if (i2 >= c0573s6Arr2.length) {
                    break;
                }
                C0573s6 c0573s6 = c0573s6Arr2[i2];
                if (c0573s6 != null) {
                    computeSInt64Size = CodedOutputByteBufferNano.computeMessageSize(6, c0573s6) + computeSInt64Size;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeString(1, this.f1054a);
        ...
        if (c0573s6Arr != null && c0573s6Arr.length > 0) {
            ...
            while (true) {
                ...
                C0573s6 c0573s6 = c0573s6Arr2[i2];
                if (c0573s6 != null) {
                    codedOutputByteBufferNano.writeMessage(6, c0573s6);
                }
                i2++;
            }
        }
    ...
    public final C0598t6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1054a = codedInputByteBufferNano.readString();
            } else if (readTag == 16) {
