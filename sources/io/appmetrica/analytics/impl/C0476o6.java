...
public final class C0476o6 extends MessageNano {
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0476o6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0476o6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0476o6().mergeFrom(codedInputByteBufferNano);
    }

    public static C0476o6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0476o6) MessageNano.mergeFrom(new C0476o6(), bArr);
    }
}
