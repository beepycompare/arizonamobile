...
public final class C0396lb {
    ...
    public final C0258g2 f1090a = new C0258g2();
    ...
    public final synchronized void a(Context context, AppMetricaConfig appMetricaConfig, Ua ua) {
        ...
        CollectionsKt.addAll(this.b.f1086a, new Ga[]{this.f1090a.a(context, appMetricaConfig, ua)});
        this.e = true;
    }
    ...
    public final synchronized void b() {
        ...
        ArrayList arrayList = C0157c4.l().i.f1135a;
        ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(arrayList, 10));
        Iterator it = arrayList.iterator();
        if (!it.hasNext()) {
            c0391l6.f1086a.addAll(arrayList2);
            this.d = true;
            return;
        }
        it.next().getClass();
    ...
    public final synchronized void c() {
        ...
        c0757zn.f1335a.add(p1);
        Thread.UncaughtExceptionHandler defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler != null) {
            c0757zn.f1335a.add(defaultUncaughtExceptionHandler);
        }
