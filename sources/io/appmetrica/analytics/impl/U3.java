...
public final class U3 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f688a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f688a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f688a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f688a);
        }
        if (!this.b.equals("")) {
    ...
    public final U3 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f688a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
