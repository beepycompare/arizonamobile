...
public final class C0537qb implements Parcelable {
    public static final Parcelable.Creator<C0537qb> CREATOR = new C0512pb();

    /* renamed from: a  reason: collision with root package name */
    public final ResultReceiver f1004a;
    public final List b;
    public final HashMap c;

    public C0537qb(T6 t6, List list, Map map) {
        HashMap hashMap;
        this.b = list;
        this.f1004a = t6;
        if (map == null) {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        bundle.putParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver", this.f1004a);
        if (this.b != null) {
    ...
    public C0537qb(Parcel parcel) {
        Bundle readBundle = parcel.readBundle(T6.class.getClassLoader());
        if (readBundle != null) {
            this.f1004a = (ResultReceiver) readBundle.getParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver");
