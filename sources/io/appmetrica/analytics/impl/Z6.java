...
public final class Z6 extends SQLiteOpenHelper implements Closeable {
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            this.c.f1060a.runScript(sQLiteDatabase);
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i > i2) {
            ...
            try {
                c0356jn.f1060a.runScript(sQLiteDatabase);
                return;
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i2 > i) {
            for (int i3 = i + 1; i3 <= i2; i3++) {
                try {
                    Collection<DatabaseScript> collection = (Collection) c0356jn.c.f1183a.get(Integer.valueOf(i3));
                    if (collection != null) {
