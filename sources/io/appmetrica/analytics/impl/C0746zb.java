...
public final class C0746zb implements Oa, Closeable {

    /* renamed from: a  reason: collision with root package name */
    public final HashMap f1228a = new HashMap();
    public final HashMap b = new HashMap();
    public final String c = "preferences";
    public final C0721yb d;
    public volatile boolean e;
    public final F6 f;

    public C0746zb(F6 f6) {
        this.f = f6;
        C0721yb c0721yb = new C0721yb(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(Gd.a())));
        this.d = c0721yb;
        c0721yb.start();
    }
    ...
    */
    public static void a(C0746zb c0746zb) {
        SQLiteDatabase sQLiteDatabase;
        String str;
        c0746zb.getClass();
        Cursor cursor = null;
        try {
            sQLiteDatabase = c0746zb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(c0746zb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    public final Object b(String str) {
        ...
        synchronized (this.f1228a) {
            c();
            obj = this.f1228a.get(str);
        }
        return obj;
    }

    public static void a(C0746zb c0746zb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        c0746zb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(c0746zb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(c0746zb.c, null, contentValues2, 5);
                        }
                    }
    ...
    public final boolean a(String str) {
        ...
        synchronized (this.f1228a) {
            c();
            containsKey = this.f1228a.containsKey(str);
        }
        return containsKey;
    }
    ...
    public final Set a() {
        HashSet hashSet;
        synchronized (this.f1228a) {
            hashSet = new HashSet(this.f1228a.keySet());
        }
        return hashSet;
    }
