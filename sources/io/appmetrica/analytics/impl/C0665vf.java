...
public final class C0665vf extends Yd {
    ...
    public final boolean a(boolean z) {
        return this.f1278a.getBoolean(t.b, z);
    }

    public final long b(long j2) {
        return this.f1278a.getLong(j.f1295a, j2);
    }
    ...
    public final List<String> g() {
        String string = this.f1278a.getString(i.b, null);
    ...
    public final C0531qa k() {
        String string = this.f1278a.getString(w.b, null);
        try {
            if (!TextUtils.isEmpty(string)) {
    ...
    public final long n() {
        return this.f1278a.getLong(p.b, 0L);
    }
    ...
    public final ScreenInfo p() {
        return Ib.e(this.f1278a.getString(u.b, null));
    }
    ...
    public final boolean t() {
        return this.f1278a.getBoolean(v.b, false);
    }
    ...
    public final long a(long j2) {
        return this.f1278a.getLong(o.b, j2);
    }
    ...
    public final AppMetricaConfig.Builder f() {
        String string = this.f1278a.getString(x.b, null);
        if (string == null) {
            return null;
        }
    ...
    */
    public final IdentifiersResult h(String str) {
        ...
        String string;
        try {
            string = this.f1278a.getString(str, null);
        } catch (Throwable unused) {
        }
        if (string != null) {
            JSONObject jSONObject = new JSONObject(string);
    ...
    public final String i(String str) {
        return this.f1278a.getString(m.b, str);
    }
    ...
    public final C0665vf a(C0531qa c0531qa) {
        ...
        try {
            jSONObject.putOpt("libSslEnabled", c0531qa.f1162a).put(DownloadsDB.DownloadColumns.STATUS, c0531qa.b.getValue()).putOpt("ERROR_EXPLANATION", c0531qa.c);
        } catch (Throwable unused) {
        }
