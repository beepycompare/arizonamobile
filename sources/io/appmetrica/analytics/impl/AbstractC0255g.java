...
public abstract class AbstractC0255g {
    ...
    public final Ek b() {
        if (this.c.h()) {
            return new Ek(this.f996a, this.c, a(), this.f);
        }
        return null;
    }
    ...
    public final Ek a(Fk fk) {
        ...
        vk2.a(Vk.d, Long.valueOf(fk.f580a));
        vk2.a(Vk.h, Long.valueOf(fk.f580a));
        vk2.a(Vk.g, 0L);
        vk2.a(Vk.i, Boolean.TRUE);
        vk2.b();
        this.f996a.e.a(a2, this.d.f752a, TimeUnit.MILLISECONDS.toSeconds(fk.b));
