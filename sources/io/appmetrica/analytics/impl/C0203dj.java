...
public final class C0203dj extends MessageNano {
    public static volatile C0203dj[] e;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0203dj mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            int readTag = codedInputByteBufferNano.readTag();
            if (readTag == 0) {
                break;
            } else if (readTag == 8) {
                this.f948a = codedInputByteBufferNano.readInt64();
            } else if (readTag == 18) {
                if (this.b == null) {
                    this.b = new C0228ej();
                }
    ...
    public static C0203dj b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0203dj().mergeFrom(codedInputByteBufferNano);
    }

    public static C0203dj a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0203dj) MessageNano.mergeFrom(new C0203dj(), bArr);
    }
}
