...
public final class C0180cn {

    /* renamed from: a  reason: collision with root package name */
    public final C0206dn f935a;
    public final Object b = new Object();
    public volatile NetworkTask c;

    public C0180cn(C0206dn c0206dn) {
        this.f935a = c0206dn;
    }
    ...
    public final Hm e() {
        Hm hm;
        C0385km c0385km = this.f935a.l;
        synchronized (c0385km) {
            hm = c0385km.c.f904a;
        }
        return hm;
    }
    ...
    */
    ...
    public final boolean a(List<String> list, Map<String, String> map) {
        return !Em.a(e(), list, map, new C0154bn(this));
    }
    ...
    */
    public final Hm a(Fm fm, Dm dm, long j) {
        String str;
        boolean equals;
        String a2 = AbstractC0309hn.a(dm.h);
        Map map = dm.i.f589a;
        String str2 = fm.j;
        String str3 = e().k;
        if (!AbstractC0309hn.a(AbstractC0309hn.a(str2))) {
            str2 = AbstractC0309hn.a(AbstractC0309hn.a(str3)) ? str3 : null;
        }
        String str4 = e().f584a;
        if (str4 != null) {
        ...
        HashMap a3 = AbstractC0309hn.a(str2);
        if (Oo.a(map)) {
            equals = Oo.a((Map) a3);
        } else {
    ...
    public final void a(Hm hm) {
        ArrayList arrayList;
        C0206dn c0206dn = this.f935a;
        C0308hm c0308hm = c0206dn.d;
        String str = c0206dn.b;
        synchronized (c0308hm.f1024a.b) {
            C0359jm c0359jm = c0308hm.f1024a;
            c0359jm.c = hm;
            Collection collection = (Collection) c0359jm.f1057a.f765a.get(str);
            if (collection == null) {
        ...
        while (it.hasNext()) {
            ((InterfaceC0592sm) it.next()).a(hm);
        }
    }

    public final void a(EnumC0411lm enumC0411lm) {
        ArrayList arrayList;
        this.c = null;
        C0206dn c0206dn = this.f935a;
        C0308hm c0308hm = c0206dn.d;
        String str = c0206dn.f.f995a;
        Hm e = e();
        synchronized (c0308hm.f1024a.b) {
            Collection collection = (Collection) c0308hm.f1024a.f1057a.f765a.get(str);
            if (collection == null) {
                arrayList = new ArrayList();
            } else {
                arrayList = new ArrayList(collection);
        ...
        Iterator it = arrayList.iterator();
        while (it.hasNext()) {
            ((InterfaceC0592sm) it.next()).a(enumC0411lm, e);
        }
    }
    ...
    public final void a(Fm fm, Dm dm, Map<String, ? extends List<String>> map) {
        ...
        if (!Oo.a((Map) map)) {
            ...
            if (!Oo.a((Collection) list)) {
                ...
                AbstractC0746yk.f1301a.a(longValue, fm.l);
