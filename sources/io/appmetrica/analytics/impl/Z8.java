...
public class Z8 implements StateSerializer {
    ...
    public final Object toState(byte[] bArr) throws IOException {
        try {
            return this.f771a.toState(this.b.decrypt(bArr));
        } catch (Throwable th) {
