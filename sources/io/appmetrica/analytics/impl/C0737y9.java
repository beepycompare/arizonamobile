...
public final class C0737y9 extends MessageNano {
    ...
    public static volatile C0737y9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f1291a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0607t9 c0607t9 = this.f;
        if (c0607t9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0607t9);
        }
        C0711x9 c0711x9 = this.g;
        if (c0711x9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0711x9);
        }
        if (!this.h.equals("")) {
        ...
        C0685w9[] c0685w9Arr = this.s;
        if (c0685w9Arr != null && c0685w9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0685w9[] c0685w9Arr2 = this.s;
                if (i6 >= c0685w9Arr2.length) {
                    break;
                }
                C0685w9 c0685w9 = c0685w9Arr2[i6];
                if (c0685w9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0685w9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f1291a);
        ...
        C0607t9 c0607t9 = this.f;
        if (c0607t9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0607t9);
        }
        C0711x9 c0711x9 = this.g;
        if (c0711x9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0711x9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0685w9Arr != null && c0685w9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0685w9 c0685w9 = c0685w9Arr2[i6];
                if (c0685w9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0685w9);
                }
                i6++;
            }
        }
    ...
    public static C0737y9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0737y9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0737y9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f1291a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0685w9[] c0685w9Arr = this.s;
                    int length = c0685w9Arr == null ? 0 : c0685w9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0685w9[] c0685w9Arr2 = new C0685w9[i];
                    if (length != 0) {
                        System.arraycopy(c0685w9Arr, 0, c0685w9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0685w9 c0685w9 = new C0685w9();
                        c0685w9Arr2[length] = c0685w9;
                        codedInputByteBufferNano.readMessage(c0685w9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0685w9 c0685w92 = new C0685w9();
                    c0685w9Arr2[length] = c0685w92;
                    codedInputByteBufferNano.readMessage(c0685w92);
                    this.s = c0685w9Arr2;
                    break;
                default:
    ...
    public static C0737y9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0737y9) MessageNano.mergeFrom(new C0737y9(), bArr);
    }
}
