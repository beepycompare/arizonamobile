...
public final class C0121ac extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f787a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f787a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f787a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f787a);
        }
        if (!this.b.equals("")) {
    ...
    public final C0121ac mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f787a = codedInputByteBufferNano.readString();
            } else if (readTag == 154) {
