...
public final class C0445mj {
    ...
    public C0445mj(ECommerceScreen eCommerceScreen) {
    ...
    public final String toString() {
        return "ScreenWrapper{name='" + this.f942a + "', categoriesPath=" + this.b + ", searchQuery='" + this.c + "', payload=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }

    public C0445mj(String str, String str2, List list, Map map) {
        this.f942a = str;
        this.b = list;
        this.c = str2;
        this.d = map;
