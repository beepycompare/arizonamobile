...
public final class Xl implements SimpleNetworkApi {
    ...
    public final CacheControlHttpsConnectionPerformer f844a = new CacheControlHttpsConnectionPerformer(((C0179cm) Na.k().z()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f844a.performConnection(str, new C0625u3(networkClientWithCacheControl));
    }
}
