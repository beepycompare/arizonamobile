...
public final class Xl implements IParamsAppender {
    ...
    public final void appendParams(Uri.Builder builder, C0153bm c0153bm) {
        ...
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.DEVICE_ID), c0153bm.getDeviceId());
        a(builder, C0448na.I.h(), this.c);
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.APP_SET_ID), c0153bm.getAppSetId());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.APP_SET_ID_SCOPE), c0153bm.getAppSetIdScope());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.APP_PLATFORM), c0153bm.getAppPlatform());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.PROTOCOL_VERSION), c0153bm.getProtocolVersion());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.ANALYTICS_SDK_VERSION_NAME), c0153bm.getAnalyticsSdkVersionName());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.MODEL), c0153bm.getModel());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.MANUFACTURER), c0153bm.getManufacturer());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.OS_VERSION), c0153bm.getOsVersion());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.SCREEN_WIDTH), String.valueOf(c0153bm.getScreenWidth()));
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.SCREEN_HEIGHT), String.valueOf(c0153bm.getScreenHeight()));
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.SCREEN_DPI), String.valueOf(c0153bm.getScreenDpi()));
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.SCALE_FACTOR), String.valueOf(c0153bm.getScaleFactor()));
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.LOCALE), c0153bm.getLocale());
        builder.appendQueryParameter(this.f857a.a(CommonUrlParts.DEVICE_TYPE), c0153bm.getDeviceType());
        ...
        builder.appendQueryParameter(this.f857a.a("app_id"), c0153bm.getPackageName());
        builder.appendQueryParameter(this.f857a.a("app_debuggable"), ((N5) c0153bm).f705a);
        if (c0153bm.l) {
        ...
        if (!lo.a(c0540r3.f1199a)) {
            ...
            builder.appendQueryParameter(this.f857a.a("clids_set"), Fm.a(c0540r3.f1199a));
        ...
        builder.appendQueryParameter(this.f857a.a("app_system_flag"), ((N5) c0153bm).b);
