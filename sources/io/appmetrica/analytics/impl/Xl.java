...
public final class Xl implements IParamsAppender {
    ...
    public final C0659ve f723a;
    public final Ed b;
    public final C0181cc c = new C0181cc();

    public Xl(C0659ve c0659ve, Ed ed) {
        this.f723a = c0659ve;
        this.b = ed;
    }
    ...
    /* renamed from: a */
    public final void appendParams(Uri.Builder builder, C0165bm c0165bm) {
        String str;
        Ag ag;
        builder.path("analytics/startup");
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.DEVICE_ID), c0165bm.getDeviceId());
        a(builder, Ia.F.g(), this.c);
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.APP_SET_ID), c0165bm.getAppSetId());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.APP_SET_ID_SCOPE), c0165bm.getAppSetIdScope());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.APP_PLATFORM), c0165bm.getAppPlatform());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.PROTOCOL_VERSION), c0165bm.getProtocolVersion());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.ANALYTICS_SDK_VERSION_NAME), c0165bm.getAnalyticsSdkVersionName());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.MODEL), c0165bm.getModel());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.MANUFACTURER), c0165bm.getManufacturer());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.OS_VERSION), c0165bm.getOsVersion());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.SCREEN_WIDTH), String.valueOf(c0165bm.getScreenWidth()));
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.SCREEN_HEIGHT), String.valueOf(c0165bm.getScreenHeight()));
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.SCREEN_DPI), String.valueOf(c0165bm.getScreenDpi()));
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.SCALE_FACTOR), String.valueOf(c0165bm.getScaleFactor()));
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.LOCALE), c0165bm.getLocale());
        builder.appendQueryParameter(this.f723a.a(CommonUrlParts.DEVICE_TYPE), c0165bm.getDeviceType());
        ...
        List<String> h = ((C0740yk) this.b).h();
        ...
        builder.appendQueryParameter(this.f723a.a("app_id"), c0165bm.getPackageName());
        builder.appendQueryParameter(this.f723a.a("app_debuggable"), ((C0352j6) c0165bm).f914a);
        if (c0165bm.l) {
            String str2 = c0165bm.m;
        ...
        if (!io.a(n3.f558a)) {
            ...
            String str3 = c0165bm.f;
            String str4 = c0165bm.g;
            if (TextUtils.isEmpty(str3) && (ag = c0165bm.o.b) != null) {
                str3 = ag.f339a;
                str4 = ag.d.f1172a;
            }
        ...
        builder.appendQueryParameter(this.f723a.a("app_system_flag"), ((C0352j6) c0165bm).b);
        ...
        Map<String, Integer> d = ((C0740yk) this.b).d();
        for (String str5 : d.keySet()) {
            builder.appendQueryParameter(str5, String.valueOf(d.get(str5)));
        }
    }

    public final void a(Uri.Builder builder, DataSendingRestrictionController dataSendingRestrictionController, C0181cc c0181cc) {
        c0181cc.getClass();
