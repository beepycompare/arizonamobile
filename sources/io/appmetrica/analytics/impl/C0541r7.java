...
public final class C0541r7 implements Converter {
    ...
    public final byte[] a(C0566s7 c0566s7) {
        return MessageNano.toByteArray(this.f1196a.fromModel(c0566s7));
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    public final Object fromModel(Object obj) {
        return MessageNano.toByteArray(this.f1196a.fromModel((C0566s7) obj));
    }
    ...
    */
    public final C0566s7 toModel(byte[] bArr) {
        ...
        c0492p7 = new C0492p7();
        return this.f1196a.toModel(c0492p7);
    }
