...
public abstract class AbstractC0210dg {
    public static final String a(C0753z9 c0753z9) {
        String str;
        StringBuilder sb = new StringBuilder("Event sent: ");
        int i = c0753z9.c;
        String str2 = c0753z9.d;
        byte[] bArr = c0753z9.e;
        if (i == 1) {
            str = "Attribution";
        } else if (i == 2) {
    ...
    public static final String a(String str, EnumC0680wb enumC0680wb, String str2, String str3) {
        if (R9.d.contains(EnumC0680wb.a(enumC0680wb.f1119a))) {
            ...
            sb.append(str);
            sb.append(": ");
            sb.append(enumC0680wb.name());
            if (R9.f.contains(enumC0680wb) && !TextUtils.isEmpty(str2)) {
                sb.append(" with name ");
                sb.append(str2);
            }
            if (R9.e.contains(enumC0680wb) && !TextUtils.isEmpty(str3)) {
