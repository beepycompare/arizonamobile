...
public final class C0573sb implements Ha, Closeable {
    ...
    public final InterfaceC0718y6 f;

    public C0573sb(InterfaceC0718y6 interfaceC0718y6) {
        this.f = interfaceC0718y6;
        C0548rb c0548rb = new C0548rb(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(ThreadFactoryC0750zd.a())));
        this.d = c0548rb;
        c0548rb.start();
    }
    ...
    */
    public static void a(C0573sb c0573sb) {
        SQLiteDatabase sQLiteDatabase;
        String str;
        c0573sb.getClass();
        Cursor cursor = null;
        try {
            sQLiteDatabase = c0573sb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(c0573sb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    public static void a(C0573sb c0573sb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        c0573sb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(c0573sb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(c0573sb.c, null, contentValues2, 5);
                        }
                    }
