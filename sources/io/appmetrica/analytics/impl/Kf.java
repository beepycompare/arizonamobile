...
public final class Kf implements InterfaceC0554r8 {
    ...
    public final JSONObject b() {
        if (this.c) {
            ...
            try {
                jSONObject.put("trackingId", this.f540a);
                if (this.b.length() > 0) {
    ...
    public final JSONObject c() {
        ...
        try {
            ...
            jSONObject.put("source", this.e.f1048a);
        } catch (Throwable unused) {
        }
        return jSONObject;
    }
    ...
    public final String toString() {
        return "PreloadInfoState{trackingId='" + this.f540a + "', additionalParameters=" + this.b + ", wasSet=" + this.c + ", autoTrackingEnabled=" + this.d + ", source=" + this.e + AbstractJsonLexerKt.END_OBJ;
    }
