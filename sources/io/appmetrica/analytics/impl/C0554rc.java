...
public final class C0554rc implements PermissionStrategy, LocationControllerObserver {
    public static final C0530qc b = new C0530qc();
    ...
    public volatile boolean f1042a;
    ...
    public final String toString() {
        return "LocationFlagStrategy(enabled=" + this.f1042a + ", locationPermissions=" + c + ')';
    }
}
