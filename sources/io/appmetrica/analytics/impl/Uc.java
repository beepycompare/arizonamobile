...
public final class Uc implements Z8 {
    ...
    public final void a(String str) {
        try {
            ...
            Ok ok = Na.I.D;
            String jSONObject = put2.put("activation_offset", TimeUnit.SECONDS.convert(ok.f707a.currentTimeMillis() - ok.b, TimeUnit.MILLISECONDS)).toString();
            c0541qk.getClass();
    ...
    public final boolean b() {
        String str;
        if (!this.d.get() && (str = ((Eh) this.f790a.a()).m) != null && !Intrinsics.areEqual(str, "629a824d-c717-4ba5-bc0f-3f3968554d01") && this.d.compareAndSet(false, true)) {
            this.b.b(true);
            a("activation");
        }
        return this.d.get();
