...
public final class C0414ll implements A8 {
    ...
    public final List<Zi> fromModel(C0388kl c0388kl) {
        ...
        t8.f678a = 2;
        t8.c = new Q8();
        Zi fromModel = this.f973a.fromModel(c0388kl.b);
        t8.c.b = (P8) fromModel.f772a;
        Zi fromModel2 = this.b.fromModel(c0388kl.f954a);
        t8.c.f634a = (M8) fromModel2.f772a;
