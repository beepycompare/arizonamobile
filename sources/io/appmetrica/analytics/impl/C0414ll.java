...
public final class C0414ll {

    /* renamed from: a  reason: collision with root package name */
    public static final C0414ll f927a = new C0414ll();

    private C0414ll() {
    }

    @JvmStatic
    public static final List<C0265fl> a(Context context) {
        Integer valueOf;
        Integer valueOf2;
        List<SubscriptionInfo> list = (List) SystemServiceUtils.accessSystemServiceByNameSafely(context, "telephony_subscription_service", "getting active subcription info list", "SubscriptionManager", new FunctionWithThrowable() { // from class: io.appmetrica.analytics.impl.ll$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                List a2;
                a2 = C0414ll.a((SubscriptionManager) obj);
                return a2;
            }
        });
        if (list != null) {
            ...
            for (SubscriptionInfo subscriptionInfo : list) {
                if (AndroidUtils.isApiAchieved(29)) {
                    valueOf = C0439ml.a(subscriptionInfo);
                } else {
                    valueOf = Integer.valueOf(subscriptionInfo.getMcc());
                }
                if (AndroidUtils.isApiAchieved(29)) {
                    valueOf2 = C0439ml.b(subscriptionInfo);
                } else {
                    valueOf2 = Integer.valueOf(subscriptionInfo.getMnc());
                }
                boolean z = subscriptionInfo.getDataRoaming() == 1;
                CharSequence carrierName = subscriptionInfo.getCarrierName();
                arrayList.add(new C0265fl(valueOf, valueOf2, z, carrierName != null ? carrierName.toString() : null));
            }
            return arrayList;
        }
