...
public final class C0203dk implements InterfaceC0478ob {
    ...
    public C0203dk(String str, String str2, PluginErrorDetails pluginErrorDetails) {
        this.f949a = str;
        this.b = str2;
    ...
    public final void a(InterfaceC0504pb interfaceC0504pb) {
        interfaceC0504pb.getPluginExtension().reportError(this.f949a, this.b, this.c);
    }
}
