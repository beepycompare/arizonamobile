...
public final class Zi implements Converter {
    ...
    public final Ei fromModel(C0198dj c0198dj) {
        ...
        Nn a2 = this.c.a(c0198dj.f952a);
        c0542r8.f1197a = StringUtils.getUTF8Bytes((String) a2.f709a);
        List<String> list = c0198dj.b;
        Ei ei2 = null;
        if (list != null) {
            ei = this.b.fromModel(list);
            c0542r8.b = (C0264g8) ei.f561a;
        } else {
            ei = null;
        }
        Nn a3 = this.d.a(c0198dj.c);
        c0542r8.c = StringUtils.getUTF8Bytes((String) a3.f709a);
        Map<String, String> map = c0198dj.d;
        if (map != null) {
            ei2 = this.f880a.fromModel(map);
            c0542r8.d = (C0418m8) ei2.f561a;
        }
