...
public final class On implements ProtobufConverter {
    ...
    /* renamed from: a */
    public final C0551r6 fromModel(Nn nn) {
        C0551r6 c0551r6 = new C0551r6();
        Dn dn = nn.f568a;
        if (dn != null) {
            c0551r6.f1032a = this.f584a.fromModel(dn);
        }
        U u = nn.b;
        if (u != null) {
            c0551r6.b = this.b.fromModel(u);
        }
        List<Dl> list = nn.c;
        if (list != null) {
            c0551r6.e = this.d.fromModel(list);
        }
        String str = nn.g;
        if (str != null) {
            c0551r6.c = str;
        }
        c0551r6.d = this.c.a(nn.h);
        if (!TextUtils.isEmpty(nn.d)) {
            c0551r6.h = this.e.fromModel(nn.d);
        }
        if (!TextUtils.isEmpty(nn.e)) {
            c0551r6.i = nn.e.getBytes();
        }
        if (!io.a(nn.f)) {
            c0551r6.j = this.f.fromModel(nn.f);
        }
        return c0551r6;
    }
    ...
    public final Nn a(C0551r6 c0551r6) {
        throw new UnsupportedOperationException();
    }
}
