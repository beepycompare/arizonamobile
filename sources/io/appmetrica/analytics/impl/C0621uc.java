...
public final class C0621uc implements G8 {
    ...
    public final void a(String str) {
        try {
            ...
            String jSONObject = put2.put("activation_offset", TimeUnit.SECONDS.convert(c0455nk.f1132a.currentTimeMillis() - c0455nk.b, TimeUnit.MILLISECONDS)).toString();
            rj.getClass();
    ...
    public final boolean b() {
        String str;
        if (!this.d.get() && (str = ((C0402lh) this.f1246a.a()).m) != null && !Intrinsics.areEqual(str, "629a824d-c717-4ba5-bc0f-3f3968554d01") && this.d.compareAndSet(false, true)) {
            this.b.b(true);
            a("activation");
        }
        return this.d.get();
