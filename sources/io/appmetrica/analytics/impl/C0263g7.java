...
public final class C0263g7 implements Converter {
    ...
    public final ContentValues fromModel(C0237f7 c0237f7) {
        ...
        Long l = c0237f7.f984a;
        if (l != null) {
            contentValues.put("session_id", Long.valueOf(l.longValue()));
        }
        Wk wk = c0237f7.b;
        if (wk != null) {
            contentValues.put("session_type", Integer.valueOf(wk.f840a));
        }
        Long l2 = c0237f7.c;
        if (l2 != null) {
        ...
        if (enumC0164cb != null) {
            contentValues.put("type", Integer.valueOf(enumC0164cb.f927a));
        }
        Long l3 = c0237f7.e;
        if (l3 != null) {
        ...
        C0186d7 c0186d7 = this.f999a;
        contentValues.put("event_description", MessageNano.toByteArray(c0186d7.f942a.fromModel(c0237f7.g)));
    ...
    public final C0237f7 toModel(ContentValues contentValues) {
        ...
        return new C0237f7(asLong, wk, asLong2, asInteger2 != null ? EnumC0164cb.a(asInteger2.intValue()) : null, contentValues.getAsLong("global_number"), contentValues.getAsLong("time"), this.f999a.toModel(contentValues.getAsByteArray("event_description")));
    }
}
