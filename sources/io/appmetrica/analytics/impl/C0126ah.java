...
public final class C0126ah implements ProtobufConverter {
    ...
    public final C0677w6 fromModel(Zg zg) {
        ...
        c0677w6.f = StringUtils.correctIllFormedString((String) WrapUtils.getOrDefault(zg.f771a, c0677w6.f));
        Wn wn = zg.b;
        if (wn != null) {
            Mn mn = wn.f727a;
            if (mn != null) {
                c0677w6.f1131a = this.f791a.fromModel(mn);
            }
            U u = wn.b;
            if (u != null) {
