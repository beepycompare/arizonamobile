...
public final class C0160c7 implements ProtobufConverter {
    ...
    public final C0442n7 fromModel(C0211e7 c0211e7) {
        ...
        Integer num = c0211e7.f949a;
        if (num != null) {
            c0442n7.f1108a = num.intValue();
        }
        ...
        if (enumC0214ea != null) {
            c0442n7.n = enumC0214ea.f952a;
        }
        EnumC0444n9 enumC0444n9 = c0211e7.o;
        if (enumC0444n9 != null) {
            c0442n7.o = enumC0444n9.f1110a;
        }
        Boolean bool = c0211e7.p;
        if (bool != null) {
            c0442n7.p = this.f909a.fromModel(Boolean.valueOf(bool.booleanValue())).intValue();
        }
    ...
    public final C0211e7 toModel(C0442n7 c0442n7) {
        ...
        Integer valueOf = Integer.valueOf(c0442n7.f1108a);
        Integer num = valueOf.intValue() != c0442n72.f1108a ? valueOf : null;
        ...
        if (valueOf8 != null) {
            ...
            while (true) {
                if (i < length) {
                    ...
                    l = valueOf3;
                    if (enumC0444n9.f1110a == intValue) {
                        break;
                    }
                    i++;
                    valueOf3 = l;
        ...
        Boolean a4 = this.f909a.a(c0442n7.p);
