...
public final class C0218e9 extends MessageNano {
    ...
    public static volatile C0218e9[] T = null;
    ...
    public final int computeSerializedSize() {
        ...
        C0193d9 c0193d9 = this.g;
        if (c0193d9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0193d9);
        }
        if (!this.h.equals("")) {
        ...
        C0167c9[] c0167c9Arr = this.s;
        if (c0167c9Arr != null && c0167c9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0167c9[] c0167c9Arr2 = this.s;
                if (i6 >= c0167c9Arr2.length) {
                    break;
                }
                C0167c9 c0167c9 = c0167c9Arr2[i6];
                if (c0167c9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0167c9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0193d9 c0193d9 = this.g;
        if (c0193d9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0193d9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0167c9Arr != null && c0167c9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0167c9 c0167c9 = c0167c9Arr2[i6];
                if (c0167c9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0167c9);
                }
                i6++;
            }
        }
        ...
        while (true) {
            ...
            switch (readTag) {
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0167c9[] c0167c9Arr = this.s;
                    int length = c0167c9Arr == null ? 0 : c0167c9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0167c9[] c0167c9Arr2 = new C0167c9[i];
                    if (length != 0) {
                        System.arraycopy(c0167c9Arr, 0, c0167c9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0167c9 c0167c9 = new C0167c9();
                        c0167c9Arr2[length] = c0167c9;
                        codedInputByteBufferNano.readMessage(c0167c9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0167c9 c0167c92 = new C0167c9();
                    c0167c9Arr2[length] = c0167c92;
                    codedInputByteBufferNano.readMessage(c0167c92);
                    this.s = c0167c9Arr2;
                    break;
                default:
