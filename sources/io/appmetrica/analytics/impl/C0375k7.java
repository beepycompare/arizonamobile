...
public final class C0375k7 {
    ...
    public C0375k7(C0652v5 c0652v5, C0704x7 c0704x7, C0272g7 c0272g7, F7 f7) {
        ...
        this.c = c0704x7;
        this.g = c0652v5.getContext();
        this.h = c0652v5;
        this.k = c0272g7;
        this.l = f7;
        atomicLong.set(c());
        C0349j7 c0349j7 = new C0349j7(this, c0652v5);
        this.d = c0349j7;
        c0349j7.setName(a(c0652v5));
    }
    ...
    public final void a(InterfaceC0532q9 interfaceC0532q9) {
        this.j.add(interfaceC0532q9);
    }

    public static String a(InterfaceC0224eb interfaceC0224eb) {
        return "DatabaseWorker [" + interfaceC0224eb.b().e() + "]";
    }

    public final void a(long j, EnumC0260fl enumC0260fl, long j2) {
    ...
    public final int a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            c0414lk.getClass();
            c0414lk.a(new Lj("deleteExcessiveReports exception", th));
            return 0;
        }
    }
    ...
    public final void a(long j, int i, int i2, boolean z) {
        ...
        try {
            ...
            SQLiteDatabase writableDatabase = this.c.getWritableDatabase();
            if (writableDatabase != null) {
                C0220e7 a2 = this.k.a(writableDatabase, format, 1, this.h.b.b, z);
                if (a2.f857a != null) {
                    ...
                    Iterator it = this.j.iterator();
                    while (it.hasNext()) {
                        ((InterfaceC0532q9) it.next()).b(arrayList);
                    }
                }
                List list = a2.f857a;
                if (list != null) {
    ...
    public final ContentValues a(long j, EnumC0260fl enumC0260fl) {
        ...
        try {
            SQLiteDatabase readableDatabase = this.c.getReadableDatabase();
            if (readableDatabase != null) {
                cursor = readableDatabase.rawQuery(String.format(Locale.US, "SELECT report_request_parameters FROM sessions WHERE id = %s AND type = %s ORDER BY id DESC LIMIT 1", Long.valueOf(j), Integer.valueOf(enumC0260fl.f884a)), null);
    ...
    public final void a(ContentValues contentValues, String str) {
        ...
        if (W9.d.contains(Bb.a(asInteger != null ? asInteger.intValue() : -1))) {
            ...
            Bb bb = model.d;
            D7 d7 = model.g;
            publicLogger.info(AbstractC0436mg.a(str, bb, d7.b, d7.c), new Object[0]);
        }
    }

    public static boolean a(C0375k7 c0375k7) {
        boolean isEmpty;
        synchronized (c0375k7.e) {
            isEmpty = c0375k7.f.isEmpty();
        }
        return isEmpty;
    }
}
