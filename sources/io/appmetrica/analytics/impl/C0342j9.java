...
public final class C0342j9 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        int computeSInt32Size = CodedOutputByteBufferNano.computeSInt32Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f1051a) + super.computeSerializedSize();
        long j = this.c;
        if (j != 0) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f1051a);
    ...
    public final C0342j9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1051a = codedInputByteBufferNano.readUInt64();
            } else if (readTag == 16) {
