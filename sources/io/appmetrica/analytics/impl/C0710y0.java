...
public final class C0710y0 implements Ua {
    public static volatile C0710y0 e = null;
    ...
    public C0710y0(Context context) {
        this.f1208a = context;
        C0535r0 c = C0158c4.l().c();
        this.b = c;
        this.d = c.a(context, C0158c4.l().g());
        this.c = new FutureTask(new Callable() { // from class: io.appmetrica.analytics.impl.y0$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return C0710y0.this.p();
            }
        });
    }

    public static C0710y0 a(Context context) {
        C0710y0 c0710y0;
        C0710y0 c0710y02 = e;
        if (c0710y02 == null) {
            synchronized (C0710y0.class) {
                c0710y0 = e;
                if (c0710y0 == null) {
                    c0710y0 = new C0710y0(context);
                    c0710y0.j();
                    C0158c4.l().c.a().execute(new RunnableC0685x0(c0710y0));
                    e = c0710y0;
                }
            }
            return c0710y0;
    ...
    public static synchronized boolean m() {
        ...
        synchronized (C0710y0.class) {
            C0710y0 c0710y0 = e;
            if (c0710y0 != null && c0710y0.c.isDone()) {
                z = c0710y0.f().i() != null;
            }
        }
        return z;
    ...
    public final void d(AppMetricaConfig appMetricaConfig) {
        ...
        C0158c4.l().c.a().execute(new RunnableC0686x1(this.f1208a));
    }
    ...
    public final void j() {
        ...
        s3.f671a.getClass();
        new InterruptionSafeThread(runnable, "IAA-INIT_CORE-" + Ad.f395a.incrementAndGet()).start();
    }

    public final void o() {
        C0158c4.l().r.a(this.f1208a);
        new W3(this.f1208a).a(this.f1208a);
        C0158c4.l().a(this.f1208a).a();
        this.c.run();
    }
    ...
    public static synchronized void a(C0710y0 c0710y0) {
        synchronized (C0710y0.class) {
            e = c0710y0;
        }
    }
