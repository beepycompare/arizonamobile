...
public final class C0514pj {
    ...
    public C0514pj(ECommerceScreen eCommerceScreen) {
    ...
    public final String toString() {
        return "ScreenWrapper{name='" + this.f1005a + "', categoriesPath=" + this.b + ", searchQuery='" + this.c + "', payload=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }

    public C0514pj(String str, String str2, List list, Map map) {
        this.f1005a = str;
        this.b = list;
        this.c = str2;
        this.d = map;
