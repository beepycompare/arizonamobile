...
public final class Ia {
    ...
    public final C0418ln A() {
        ...
        if (c0418ln2 == null) {
            synchronized (this) {
                c0418ln = this.x;
                if (c0418ln == null) {
                    c0418ln = new C0418ln(this.f490a);
                    this.x = c0418ln;
                }
            }
            return c0418ln;
        ...
        if (this.j == null) {
            synchronized (this) {
                if (this.j == null) {
                    ...
                    this.j = new Hf(this.f490a, a3, new C0734yf(), new C0510pf(c0559rf), new Gf(), new C0709xf(this.f490a), new Cf(j().x()), new C0584sf(), c0559rf, "[PreloadInfoStorage]");
                }
            }
        }
    }
    ...
    public final T b() {
        ...
        if (t2 == null) {
            synchronized (this) {
                t = this.g;
                if (t == null) {
                    t = new T(this.f490a, this.d.a(), this.u.b());
                    this.u.a(t);
                    this.g = t;
                }
            }
    ...
    public final C0273g2 c() {
        ...
        if (c0273g22 == null) {
            synchronized (this) {
                c0273g2 = this.h;
                if (c0273g2 == null) {
                    c0273g2 = new C0273g2(this.f490a, AbstractC0298h2.a());
                    this.h = c0273g2;
                }
            }
            return c0273g2;
        ...
        if (this.k == null) {
            synchronized (this) {
                if (this.k == null) {
                    ...
                    Context context = this.f490a;
                    ProtobufStateStorage<Object> a3 = a2.a(context, a2.c(context));
                    this.k = new V3(this.f490a, a3, new W3(), new J3(), new Z3(), new C0290gj(this.f490a), new X3(x()), new K3(), (O3) a3.read(), "[ClidsInfoStorage]");
                }
            }
        }
        return this.k;
    ...
    public final C0306ha h() {
        ...
        if (c0306ha2 == null) {
            synchronized (this) {
                c0306ha = this.C;
                if (c0306ha == null) {
                    c0306ha = new C0306ha(this.f490a);
                    this.C = c0306ha;
                }
            }
            return c0306ha;
    ...
    public final C0128ac k() {
        ...
        if (c0128ac2 == null) {
            synchronized (this) {
                c0128ac = this.o;
                if (c0128ac == null) {
                    c0128ac = new C0128ac(new C0145b3(this.f490a, this.d.a()), new C0422m2());
                    this.o = c0128ac;
                }
            }
            return c0128ac;
    ...
    public final C0735yg t() {
        if (this.b == null) {
            synchronized (this) {
                if (this.b == null) {
                    this.b = new C0735yg(this.f490a, F.B().c);
                }
            }
        }
        return this.b;
    ...
    public final C0563rj u() {
        ...
        if (c0563rj2 == null) {
            synchronized (this) {
                c0563rj = this.n;
                if (c0563rj == null) {
                    c0563rj = new C0563rj(this.f490a);
                    this.n = c0563rj;
                }
            }
            return c0563rj;
    ...
    public final C0460nf x() {
        if (this.l == null) {
            synchronized (this) {
                if (this.l == null) {
                    this.l = new C0460nf(C0626u7.a(this.f490a).c());
                }
            }
        }
        return this.l;
