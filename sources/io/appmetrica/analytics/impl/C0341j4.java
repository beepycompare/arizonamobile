...
public final class C0341j4 {
    ...
    public final void b(Bundle bundle) {
        ...
        C0529qa c0529qa = this.n;
        Bundle bundle13 = new Bundle();
        bundle13.putParcelable("value", c0529qa);
    ...
    public static C0529qa a(Bundle bundle) {
        Parcelable parcelable;
        Bundle bundle2 = bundle.getBundle("features");
        ClassLoader classLoader = C0529qa.class.getClassLoader();
        if (bundle2 == null) {
            parcelable = null;
        } else {
            bundle2.setClassLoader(classLoader);
        ...
        C0529qa c0529qa = (C0529qa) parcelable;
        return c0529qa == null ? new C0529qa(null, IdentifierStatus.UNKNOWN, "bundle serialization error") : c0529qa;
    }
    ...
    public static C0529qa a(Boolean bool) {
        boolean z = bool != null;
        return new C0529qa(bool, z ? IdentifierStatus.OK : IdentifierStatus.UNKNOWN, z ? null : "no identifier in startup state");
    }
}
