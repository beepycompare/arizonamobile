...
public final class C0141b9 extends MessageNano {
    public static volatile C0141b9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        C0115a9[] c0115a9Arr = this.l;
        if (c0115a9Arr != null && c0115a9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0115a9[] c0115a9Arr2 = this.l;
                if (i4 >= c0115a9Arr2.length) {
                    break;
                }
                C0115a9 c0115a9 = c0115a9Arr2[i4];
                if (c0115a9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0115a9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0115a9Arr != null && c0115a9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0115a9 c0115a9 = c0115a9Arr2[i4];
                if (c0115a9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0115a9);
                }
                i4++;
            }
        }
    ...
    public static C0141b9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0141b9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0141b9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 186:
                    ...
                    C0115a9[] c0115a9Arr = this.l;
                    int length = c0115a9Arr == null ? 0 : c0115a9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0115a9[] c0115a9Arr2 = new C0115a9[i];
                    if (length != 0) {
                        System.arraycopy(c0115a9Arr, 0, c0115a9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0115a9 c0115a9 = new C0115a9();
                        c0115a9Arr2[length] = c0115a9;
                        codedInputByteBufferNano.readMessage(c0115a9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0115a9 c0115a92 = new C0115a9();
                    c0115a9Arr2[length] = c0115a92;
                    codedInputByteBufferNano.readMessage(c0115a92);
                    this.l = c0115a9Arr2;
                    break;
    ...
    public static C0141b9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0141b9) MessageNano.mergeFrom(new C0141b9(), bArr);
    }
}
