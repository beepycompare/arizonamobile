...
public final class C0640v3 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1272a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1272a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1272a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1272a);
        }
        if (!this.b.equals("")) {
    ...
    public final C0640v3 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1272a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
