...
public final class C0505pk implements Jc {
    ...
    public static void a(xo xoVar, C0355jm c0355jm, Bb bb) {
        ...
        synchronized (xoVar) {
            optStringOrNull = JsonUtils.optStringOrNull(xoVar.f1289a.a(), "device_id");
        }
        if (TextUtils.isEmpty(optStringOrNull)) {
            ...
            if (TextUtils.isEmpty(bb.f492a)) {
                return;
            }
            c0355jm.f1044a = bb.f492a;
        }
    }
