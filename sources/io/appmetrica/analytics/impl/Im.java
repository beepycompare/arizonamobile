...
public final class Im extends Om {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Xf("app_permissions_state", iBinaryDataHelper, new Q8(c0229e2, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0126a2(new H2()));
    }
