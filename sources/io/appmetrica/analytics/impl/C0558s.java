...
public final class C0558s extends MessageNano {
    ...
    public static volatile C0558s[] t;
    ...
    public final C0558s a() {
        this.f1206a = (byte[]) u.clone();
        this.b = null;
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f1206a, u)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f1206a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f1206a, u)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1206a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public static C0558s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0558s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0558s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1206a = codedInputByteBufferNano.readBytes();
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new r();
    ...
    public static C0558s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0558s) MessageNano.mergeFrom(new C0558s(), bArr);
    }
}
