...
public final class Yl {
    ...
    public final void a(C0216dm c0216dm, Ab ab) {
        ...
        if (optJSONObject9 != null) {
            c0691wm.f1125a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject9, "disabled_reporting_interval_seconds", c0691wm.f1125a);
        }
        this.e.getClass();
        c0216dm.p = new Hm(c0691wm.f1125a);
        this.b.getClass();
        ...
        try {
            ...
            if (optJSONObject10 != null) {
                E4 e4 = new E4();
                e4.f410a = C0554ra.a(optJSONObject10, "permissions_collecting", c0591sm.f1056a);
        ...
        if (c0216dm.b.f446a) {
            ...
            if (optJSONObject13 != null) {
                j = optJSONObject13.optLong("check_interval_seconds", c0641um.f1089a);
        ...
        C0621u2 c0621u2 = this.f.f1093a;
        C0492om c0492om = new C0492om();
        JSONObject optJSONObject14 = ab.optJSONObject("auto_inapp_collecting");
        if (optJSONObject14 != null) {
            c0492om.f992a = optJSONObject14.optInt("send_frequency_seconds", c0492om.f992a);
            c0492om.b = optJSONObject14.optInt("first_collecting_inapp_max_age_seconds", c0492om.b);
        }
        c0621u2.getClass();
        c0216dm.r = new BillingConfig(c0492om.f992a, c0492om.b);
        C3 c3 = this.g;
        c3.getClass();
        C0517pm c0517pm = new C0517pm();
        JSONObject optJSONObject15 = ab.optJSONObject("cache_control");
        if (optJSONObject15 != null) {
            c0517pm.f1007a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject15, "last_known_location_ttl", c0517pm.f1007a);
        }
        c3.f369a.getClass();
        c0216dm.s = new C0747z3(c0517pm.f1007a);
        this.h.getClass();
        ...
        if (a6 != null) {
            c0666vm.f1105a = a6.intValue();
        }
        fm.f441a.getClass();
        c0216dm.u = new Dm(c0666vm.f1105a);
        Map<String, C0607td> c = this.k.f470a.c();
        Gd gd = new Gd(ab);
        ...
        if (optJSONObject17 != null) {
            c0566rm.f1042a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject17, "collecting_interval_seconds", c0566rm.f1042a);
        }
        x9.getClass();
        c0216dm.w = new W9(c0566rm.f1042a);
    }
