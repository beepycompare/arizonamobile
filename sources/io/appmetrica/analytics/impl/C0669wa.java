    ...
    public final Nn a(Map<String, String> map) {
        ...
        if (map != null) {
            ...
            while (i2 < length) {
                ...
                int utf8BytesLength2 = StringUtils.getUtf8BytesLength((String) a3.f709a) + StringUtils.getUtf8BytesLength((String) a2.f709a);
                if (z || utf8BytesLength2 + i4 > this.f537a) {
                    i3++;
                    i += utf8BytesLength;
                    z = true;
                } else {
                    i = a3.b.getBytesTruncated() + a2.b.getBytesTruncated() + i;
                    int utf8BytesLength3 = StringUtils.getUtf8BytesLength((String) a3.f709a) + StringUtils.getUtf8BytesLength((String) a2.f709a) + i4;
                    hashMap.put((String) a2.f709a, (String) a3.f709a);
                    i4 = utf8BytesLength3;
                }
                i2++;
            }
