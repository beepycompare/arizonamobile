...
public final class C0583sl implements SimpleNetworkApi {
    ...
    public final CacheControlHttpsConnectionPerformer f1224a = new CacheControlHttpsConnectionPerformer(((Al) C0448na.k().z()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f1224a.performConnection(str, new C0211e3(networkClientWithCacheControl));
    }
}
