...
public final class C0152bl implements ServiceStorageProvider {
    ...
    public C0152bl(Context context, Zl zl, SQLiteOpenHelper sQLiteOpenHelper) {
        this.f913a = context;
        this.b = zl;
    ...
    public final <T, P extends MessageNano> ProtobufBinaryStateStorageFactory<T> createBinaryStateStorageFactory(String str, ProtobufStateSerializer<P> protobufStateSerializer, ProtobufConverter<T, P> protobufConverter) {
        AbstractC0542qn.f1173a.getClass();
        return new C0516pn(str, protobufStateSerializer, protobufConverter);
    }
    ...
    public final TempCacheStorage getTempCacheStorage() {
        ...
        synchronized (B) {
            vn = B.h;
            if (vn == null) {
                EnumC0645un enumC0645un = EnumC0645un.SERVICE;
                Un un = B.g;
                if (un == null) {
                    un = new Un(new Vl(B.f(context)), "temp_cache");
                    B.g = un;
                }
                vn = new Vn(context, enumC0645un, un);
                B.h = vn;
            }
        }
        return vn;
    ...
    public final ModulePreferences legacyModulePreferences() {
        return new C0143bc(this.b);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.service.ServiceStorageProvider
    public final ModulePreferences modulePreferences(String str) {
        return new C0713xd(str, this.b);
    }
}
