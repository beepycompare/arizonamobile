...
public final class C0263g2 implements InterfaceC0409lk, ApplicationStateProvider {

    /* renamed from: a  reason: collision with root package name */
    public final HashSet f1005a = new HashSet();
    public final HashSet b = new HashSet();
    public volatile ApplicationState c = ApplicationState.UNKNOWN;
    public final CopyOnWriteArraySet d = new CopyOnWriteArraySet();

    public final void a(int i) {
        this.f1005a.remove(Integer.valueOf(i));
        a();
    }
    ...
    public final void c(int i) {
        this.f1005a.add(Integer.valueOf(i));
