...
public final class C0177c9 implements Converter {
    ...
    public final byte[] fromModel(Map<String, byte[]> map) {
        ...
        for (Object obj : map.entrySet()) {
            ...
            c0203d9.f815a = (String) entry.getKey();
            c0203d9.b = (byte[]) entry.getValue();
            c0203d9Arr[i] = c0203d9;
            i = i2;
        }
        c0228e9.f829a = c0203d9Arr;
    ...
    public final Map<String, byte[]> toModel(byte[] bArr) {
        C0203d9[] c0203d9Arr = ((C0228e9) MessageNano.mergeFrom(new C0228e9(), bArr)).f829a;
        ...
        for (C0203d9 c0203d9 : c0203d9Arr) {
            Pair pair = TuplesKt.to(c0203d9.f815a, c0203d9.b);
