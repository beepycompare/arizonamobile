...
public final class C0542qm implements InterfaceC0567rm {
    public static final Map k = Collections.unmodifiableMap(new C0464nm());
    public final Qi b;
    public final C0749ym c;
    ...
    public final C0490om f = new C0490om(this);

    public C0542qm(Qi qi, C0749ym c0749ym, Handler handler) {
        this.b = qi;
        this.c = c0749ym;
        this.d = handler;
    }
    ...
    public final void a(StartupParamsCallback startupParamsCallback, List<String> list, Map<String, String> map) {
        synchronized (this.g) {
            C0749ym c0749ym = this.c;
            c0749ym.getClass();
            if (!Oo.a((Map) map) && !Oo.a(map, c0749ym.e)) {
                c0749ym.e = new HashMap(map);
                c0749ym.g = true;
                c0749ym.c();
            }
            a(startupParamsCallback, list);
            if (this.c.a((List) list)) {
                a(list, new C0516pm(this, startupParamsCallback), map, true);
            } else {
    ...
    */
    public final void b(Bundle bundle) {
        HashMap hashMap;
        boolean equals;
        IdentifiersResult a2 = C0342j4.a(bundle, "Uuid");
        IdentifiersResult a3 = C0342j4.a(bundle, "DeviceId");
        IdentifiersResult a4 = C0342j4.a(bundle, "DeviceIdHash");
        IdentifiersResult a5 = C0342j4.a(bundle, "AdUrlReport");
        IdentifiersResult a6 = C0342j4.a(bundle, "AdUrlGet");
        IdentifiersResult a7 = C0342j4.a(bundle, "Clids");
        IdentifiersResult a8 = C0342j4.a(bundle, "RequestClids");
        IdentifiersResult a9 = C0342j4.a(bundle, "GAID");
        IdentifiersResult a10 = C0342j4.a(bundle, "HOAID");
        IdentifiersResult a11 = C0342j4.a(bundle, "YANDEX_ADV_ID");
        IdentifiersResult a12 = C0342j4.a(bundle, "CUSTOM_SDK_HOSTS");
        long j = bundle.getLong("ServerTimeOffset");
        long j2 = bundle.getLong("NextStartupTime");
        C0530qa a13 = C0342j4.a(bundle);
        Bundle bundle2 = bundle.getBundle("module_configs");
        C0749ym c0749ym = this.c;
        synchronized (c0749ym) {
            IdentifiersResult identifiersResult = (IdentifiersResult) c0749ym.b.get(StartupParamsCallback.APPMETRICA_UUID);
            if (identifiersResult != null) {
                So so = c0749ym.o;
                String str = identifiersResult.id;
                so.getClass();
                if (So.a(str)) {
                    c0749ym.a(StartupParamsCallback.APPMETRICA_DEVICE_ID, a3);
                    c0749ym.a(StartupParamsCallback.APPMETRICA_DEVICE_ID_HASH, a4);
                    c0749ym.b.put("appmetrica_google_adv_id", a9);
                    c0749ym.b.put("appmetrica_huawei_oaid", a10);
                    c0749ym.b.put("appmetrica_yandex_adv_id", a11);
                    c0749ym.l.a(a12);
                    c0749ym.m.a(a13);
                    if (!C0749ym.a(a6)) {
                        c0749ym.b.put("appmetrica_get_ad_url", a6);
                    }
                    if (!C0749ym.a(a5)) {
                        c0749ym.b.put("appmetrica_report_ad_url", a5);
                    }
                    c0749ym.f = j;
                    T3 t3 = c0749ym.k;
                    hashMap = c0749ym.e;
                    ...
                    if (equals) {
                        c0749ym.b.put("appmetrica_clids", a7);
                        c0749ym.g = false;
                    }
                    c0749ym.h = j2;
                    c0749ym.c();
            ...
            so2.getClass();
            if (So.a(str2)) {
                c0749ym.b.put(StartupParamsCallback.APPMETRICA_UUID, a2);
            }
            c0749ym.a(StartupParamsCallback.APPMETRICA_DEVICE_ID, a3);
            c0749ym.a(StartupParamsCallback.APPMETRICA_DEVICE_ID_HASH, a4);
            c0749ym.b.put("appmetrica_google_adv_id", a9);
        ...
        C0575s4.l().m().a(bundle2, new SdkIdentifiers(a2.id, a3.id, a4.id));
        h();
    }
    ...
    public final C0581sa e() {
        C0530qa c0530qa;
        C0749ym c0749ym = this.c;
        C0452na c0452na = c0749ym.n;
        C0478oa c0478oa = c0749ym.m;
        synchronized (c0478oa) {
            c0530qa = c0478oa.b;
        }
        c0452na.getClass();
        Boolean bool = c0530qa.f1165a;
        return new C0581sa();
    }
    ...
    public final void a(List list, S6 s6, Map map, boolean z) {
        ...
        bundle.putParcelable("io.appmetrica.analytics.impl.IdentifiersData", new C0686wb(t6, list, map, z));
        Db db = Db.EVENT_TYPE_UNDEFINED;
        PublicLogger anonymousInstance = PublicLogger.getAnonymousInstance();
        Set set = Q9.f730a;
        C0188d4 c0188d4 = new C0188d4("", "", 1536, 0, anonymousInstance);
        c0188d4.m = bundle;
        V4 v4 = qi.f736a;
        qi.a(Qi.a(c0188d4, v4), v4, 1, (Map) null);
    }
    ...
    public final void a(Map<String, String> map) {
        ...
        synchronized (this.g) {
            HashMap b = AbstractC0310hn.b(map);
            this.i = b;
            this.b.a(b);
            C0749ym c0749ym = this.c;
            c0749ym.getClass();
            if (!Oo.a((Map) b) && !Oo.a(b, c0749ym.e)) {
                c0749ym.e = new HashMap(b);
                c0749ym.g = true;
                c0749ym.c();
            }
        }
        ...
        synchronized (this.g) {
            ...
            if (Oo.a((Collection) list)) {
                if (!Oo.a((Collection) list2)) {
                    C0749ym c0749ym = this.c;
                    c0749ym.d = null;
                    c0749ym.i.a((List<String>) null);
                    this.b.a((List) null);
                }
            } else if (!Oo.a(list, list2)) {
                C0749ym c0749ym2 = this.c;
                c0749ym2.d = list;
                c0749ym2.i.a(list);
                this.b.a(list);
            } else {
        ...
        if (this.h.containsKey(startupParamsCallback)) {
            ...
            if (this.c.a((Collection) list)) {
                ...
                if (bundle.containsKey("startup_error_key_code")) {
                    ...
                    enumC0412lm = EnumC0412lm.UNKNOWN;
                    if (i == 1) {
                        enumC0412lm = EnumC0412lm.NETWORK;
                    } else if (i == 2) {
                        enumC0412lm = EnumC0412lm.PARSE;
                    }
                } else {
                    enumC0412lm = null;
                }
                ...
                if (reason == null) {
                    reason = (StartupParamsCallback.Reason) CollectionUtils.getOrDefault(k, enumC0412lm, StartupParamsCallback.Reason.UNKNOWN);
                }
                startupParamsCallback.onRequestError(reason, a(list));
            }
            this.h.remove(startupParamsCallback);
            if (this.h.isEmpty()) {
                C0545r0 c0545r0 = this.b.d;
                synchronized (c0545r0.f) {
                    c0545r0.c = false;
                    c0545r0.c();
                }
            }
    ...
    public final StartupParamsCallback.Result a(List list) {
        ...
        synchronized (c0749ym) {
            ...
            while (it.hasNext()) {
                ...
                IdentifiersResult identifiersResult = (IdentifiersResult) c0749ym.b.get(str);
                if (identifiersResult != null) {
                    hashMap.put(str, c0749ym.c.a(identifiersResult));
                }
            }
            c0749ym.l.a(list, hashMap);
            c0749ym.m.a(list, hashMap);
        }
    ...
    public final AdvIdentifiersResult a() {
        C0749ym c0749ym = this.c;
        c0749ym.j.getClass();
        return new AdvIdentifiersResult(Q.a((IdentifiersResult) c0749ym.b.get("appmetrica_google_adv_id")), Q.a((IdentifiersResult) c0749ym.b.get("appmetrica_huawei_oaid")), Q.a((IdentifiersResult) c0749ym.b.get("appmetrica_yandex_adv_id")));
    }
}
