...
public final class Eg implements InterfaceC0482ob {
    ...
    public final void a(final Og og, final Throwable th) {
        this.f424a.execute(new Runnable() { // from class: io.appmetrica.analytics.impl.Eg$$ExternalSyntheticLambda0
