...
public final class Eg implements K {
    ...
    public final AdTrackingInfoResult b(Context context) {
        ...
        bundle.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", this.f460a);
        Dg dg = this.b;
        ...
        if (bundle2 != null) {
            ...
            if (bundle3 != null) {
                Object obj = C5.f421a.get(bundle3.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
                if (obj != null) {
        ...
        if (ReflectionUtils.detectClassExists("io.appmetrica.analytics.identifiers.internal.AdvIdentifiersProvider")) {
            ...
            while (ln.b()) {
                try {
                    ...
                    adTrackingInfoResult2 = new AdTrackingInfoResult(null, IdentifierStatus.UNKNOWN, "exception while fetching " + this.f460a + " adv_id: " + (e.getTargetException() != null ? e.getTargetException().getMessage() : null));
                    adTrackingInfoResult = adTrackingInfoResult2;
                    try {
                        Thread.sleep(((Ln) li).b);
                    } catch (InterruptedException unused) {
                    }
                } catch (Throwable th) {
                    adTrackingInfoResult2 = new AdTrackingInfoResult(null, IdentifierStatus.UNKNOWN, "exception while fetching " + this.f460a + " adv_id: " + th.getMessage());
                    adTrackingInfoResult = adTrackingInfoResult2;
                    Thread.sleep(((Ln) li).b);
                }
            }
