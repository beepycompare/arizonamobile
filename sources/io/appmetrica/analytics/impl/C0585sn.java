...
public final class C0585sn implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final InterfaceC0718y6 f1226a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0585sn(InterfaceC0718y6 interfaceC0718y6, String str) {
        this.f1226a = interfaceC0718y6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0635un = new C0635un(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0635un = null;
                            }
                            if (c0635un != null) {
                                arrayList.add(c0635un);
                            }
