...
public final class C0634uc implements PermissionStrategy, LocationControllerObserver {
    public static final C0609tc b = new C0609tc();
    ...
    public final String toString() {
        return "LocationFlagStrategy(enabled=" + this.f1109a + ", locationPermissions=" + c + ')';
    }
}
