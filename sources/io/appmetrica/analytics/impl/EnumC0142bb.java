...
public enum EnumC0142bb {
    ...
    static {
        EnumC0142bb[] values;
        for (EnumC0142bb enumC0142bb : values()) {
            K.put(Integer.valueOf(enumC0142bb.f922a), enumC0142bb);
        }
    }

    EnumC0142bb(int i, String str) {
        this.f922a = i;
        this.b = str;
    }
    ...
    public static EnumC0142bb a(int i) {
        EnumC0142bb enumC0142bb = (EnumC0142bb) K.get(Integer.valueOf(i));
        return enumC0142bb == null ? EVENT_TYPE_UNDEFINED : enumC0142bb;
    }
}
