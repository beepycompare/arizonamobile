...
public final class C0354jg implements Converter {

    /* renamed from: a  reason: collision with root package name */
    public final Ua f1052a;
    ...
    public final Xi fromModel(List<String> list) {
        C0518po a2 = this.f1052a.a((List<Object>) list);
        List list2 = (List) a2.f1155a;
        H8[] h8Arr = new H8[0];
        if (list2 != null) {
            ...
            for (int i = 0; i < list2.size(); i++) {
                H8 h8 = new H8();
                h8Arr[i] = h8;
                h8.f577a = StringUtils.getUTF8Bytes((String) list2.get(i));
            }
        }
