...
public final class C0445n0 implements Wa {
    ...
    */
    public final synchronized void a(AppMetricaConfig appMetricaConfig, InterfaceC0481ob interfaceC0481ob) {
        if (!C0594t0.g) {
            ...
            this.f.b();
            if (appMetricaConfig != null) {
                this.f.a(this.f962a, appMetricaConfig, interfaceC0481ob);
            }
            if (appMetricaConfig != null) {
            }
            this.e.b();
