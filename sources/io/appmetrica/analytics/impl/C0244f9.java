...
public final class C0244f9 extends MessageNano {
    public static volatile C0244f9[] b;

    /* renamed from: a  reason: collision with root package name */
    public C0218e9[] f979a;
    ...
    public final int computeSerializedSize() {
        ...
        C0218e9[] c0218e9Arr = this.f979a;
        if (c0218e9Arr != null && c0218e9Arr.length > 0) {
            int i = 0;
            while (true) {
                C0218e9[] c0218e9Arr2 = this.f979a;
                if (i >= c0218e9Arr2.length) {
                    break;
                }
                C0218e9 c0218e9 = c0218e9Arr2[i];
                if (c0218e9 != null) {
                    computeSerializedSize = CodedOutputByteBufferNano.computeMessageSize(1, c0218e9) + computeSerializedSize;
                }
                i++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0218e9Arr != null && c0218e9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0218e9 c0218e9 = c0218e9Arr2[i];
                if (c0218e9 != null) {
                    codedOutputByteBufferNano.writeMessage(1, c0218e9);
                }
                i++;
            }
        }
    ...
    public final C0244f9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                C0218e9[] c0218e9Arr2 = new C0218e9[i];
                if (length != 0) {
