...
public abstract class AbstractCallableC0726yh implements Callable {
    ...
    public boolean c() {
        C0485p0 c0485p0 = this.f1319a;
        synchronized (c0485p0) {
            if (c0485p0.d == null) {
                c0485p0.e = new CountDownLatch(1);
                Intent a2 = c0485p0.h.a(c0485p0.f1155a);
                try {
                    c0485p0.g.b(c0485p0.f1155a);
                    c0485p0.f1155a.bindService(a2, c0485p0.j, 1);
