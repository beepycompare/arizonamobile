...
public final class C0173ce implements Consumer {
    ...
    public final void consume(String str) {
        C0330ih c0330ih = this.f926a;
        J0 j0 = this.b;
        String str2 = j0.f602a;
        String str3 = j0.b;
        ...
        Db db = c0405le.b;
        I0 i0 = c0405le.f1079a;
        String str4 = i0.c;
        PublicLogger orCreatePublicLogger = LoggerStorage.getOrCreatePublicLogger(i0.f.f602a);
        long a2 = ((G6) c0405le.c).a(c0405le.f1079a);
        Set set = Q9.f728a;
        Bundle bundle = new Bundle();
        bundle.putString("payload_crash_id", str4);
        C0189d4 c0189d4 = new C0189d4("", "", db.f511a, orCreatePublicLogger);
        c0189d4.b(a2);
        if (str != null) {
            c0189d4.f(str);
        }
        c0189d4.m = bundle;
        c0189d4.c = c0405le.f1079a.f.f;
