...
public final class T6 {
    ...
    */
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = Db.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        Yl yl = this.f657a;
        String a2 = Db.a((Map) linkedHashMap);
        ...
        hashMap.put("appmetrica_custom_sdk_hosts", yl.a(new IdentifiersResult(a2, identifierStatus, identifiersResult != null ? identifiersResult.errorExplanation : null)));
    }
}
