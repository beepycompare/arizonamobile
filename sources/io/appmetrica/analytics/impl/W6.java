...
public final class W6 {
    ...
    public final C0183cm f723a = new C0183cm();
    ...
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = Gb.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        if (hashMap != null) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                emptyMap.put(key, new IdentifiersResult(String.valueOf(ro.a((Collection) list2) ? null : new JSONArray((Collection) list2)), identifiersResult.status, identifiersResult.errorExplanation));
            }
        } else {
