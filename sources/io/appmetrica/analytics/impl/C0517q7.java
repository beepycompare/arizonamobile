...
public final class C0517q7 implements ProtobufConverter {
    ...
    public final C0492p7 fromModel(C0566s7 c0566s7) {
        ...
        Long l = c0566s7.f1213a;
        if (l != null) {
            c0492p7.f1159a = l.longValue();
        }
        Long l2 = c0566s7.b;
        if (l2 != null) {
        ...
        if (bool != null) {
            c0492p7.c = this.f1181a.fromModel(Boolean.valueOf(bool.booleanValue())).intValue();
        }
        return c0492p7;
    }
    ...
    public final C0566s7 toModel(C0492p7 c0492p7) {
        ...
        Long valueOf = Long.valueOf(c0492p7.f1159a);
        if (valueOf.longValue() == c0492p72.f1159a) {
            valueOf = null;
        }
        Long valueOf2 = Long.valueOf(c0492p7.b);
        return new C0566s7(valueOf, valueOf2.longValue() != c0492p72.b ? valueOf2 : null, this.f1181a.a(c0492p7.c));
    }
}
