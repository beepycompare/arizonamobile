...
public final class C0747z9 implements IHandlerExecutor {
    ...
    public static HandlerThreadC0169cb a(String str) {
        HandlerThreadC0169cb handlerThreadC0169cb = new HandlerThreadC0169cb(str + Constants.FILENAME_SEQUENCE_SEPARATOR + ThreadFactoryC0751zd.f1333a.incrementAndGet());
    ...
    public final void stopRunning() {
        HandlerThreadC0169cb handlerThreadC0169cb = this.c;
        synchronized (handlerThreadC0169cb) {
            handlerThreadC0169cb.f936a = false;
