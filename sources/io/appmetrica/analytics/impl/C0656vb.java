...
public final class C0656vb implements InternalClientModuleFacade {

    /* renamed from: a  reason: collision with root package name */
    public final C0359jd f1099a = new C0359jd();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : AbstractC0335id.f898a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = AbstractC0631ub.f1082a[category2.ordinal()];
            if (i != 1) {
