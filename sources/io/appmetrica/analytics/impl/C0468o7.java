...
public final class C0468o7 extends MessageNano {
    public static volatile C0468o7[] k;
    ...
    public static C0468o7 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0468o7().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0468o7 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0468o7 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0468o7) MessageNano.mergeFrom(new C0468o7(), bArr);
    }
}
