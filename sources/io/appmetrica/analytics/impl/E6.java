...
public final class E6 {
    ...
    */
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = AbstractC0447nb.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        if (hashMap != null) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                emptyMap.put(key, new IdentifiersResult(String.valueOf(no.a((Collection) list2) ? null : new JSONArray((Collection) list2)), identifiersResult.status, identifiersResult.errorExplanation));
            }
        } else {
        ...
        for (Map.Entry entry2 : emptyMap.entrySet()) {
            ...
            if (str4 != null) {
                try {
                    list = AbstractC0447nb.a(new JSONArray(str4));
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        Xl xl = this.f453a;
        String a2 = AbstractC0447nb.a((Map) linkedHashMap);
        ...
        hashMap.put("appmetrica_custom_sdk_hosts", xl.a(new IdentifiersResult(a2, identifierStatus, identifiersResult != null ? identifiersResult.errorExplanation : null)));
    }
}
