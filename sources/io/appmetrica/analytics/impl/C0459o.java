...
public final class C0459o extends A7 implements ActivityLifecycleRegistry {

    /* renamed from: a  reason: collision with root package name */
    public Application f1121a;
    public volatile EnumC0434n b = EnumC0434n.d;
    public final C0520qa c = new C0520qa(true);

    public final synchronized void a(Context context) {
        if (this.f1121a == null) {
            try {
                this.f1121a = (Application) context.getApplicationContext();
    ...
    public final synchronized void b() {
        EnumC0434n enumC0434n = this.b;
        EnumC0434n enumC0434n2 = EnumC0434n.b;
        if (enumC0434n != enumC0434n2 && !this.c.f1168a.isEmpty()) {
            if (this.f1121a == null) {
                this.b = EnumC0434n.c;
                return;
            }
            this.b = enumC0434n2;
            this.f1121a.registerActivityLifecycleCallbacks(this);
        }
    }

    public final synchronized void c() {
        if (this.b == EnumC0434n.b && this.c.f1168a.isEmpty()) {
            this.b = EnumC0434n.d;
            Application application = this.f1121a;
            if (application != null) {
    ...
    */
    public final synchronized void unregisterListener(ActivityLifecycleListener activityLifecycleListener, ActivityEvent... activityEventArr) {
        ...
        activityEventArr = ActivityEvent.values();
        for (ActivityEvent activityEvent : activityEventArr) {
            C0520qa c0520qa = this.c;
            Collection collection = (Collection) c0520qa.f1168a.get(activityEvent);
            if (collection != null && collection.remove(activityLifecycleListener)) {
                if (collection.isEmpty() && c0520qa.b) {
                    c0520qa.f1168a.remove(activityEvent);
                }
    ...
    public final void a(Activity activity, ActivityEvent activityEvent) {
        ...
        synchronized (this) {
            collection = (Collection) this.c.f1168a.get(activityEvent);
        }
        if (collection != null) {
