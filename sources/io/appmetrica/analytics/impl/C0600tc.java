...
public final class C0600tc implements F8 {
    ...
    public final void a(String str) {
        try {
            ...
            M9 i = C0449na.I.i();
            Bundle applicationMetaData = i.d.getApplicationMetaData(i.f691a);
            ...
            String jSONObject = put2.put("activation_offset", TimeUnit.SECONDS.convert(c0434mk.f1122a.currentTimeMillis() - c0434mk.b, TimeUnit.MILLISECONDS)).toString();
            qj.getClass();
    ...
    public final boolean b() {
        String str;
        if (!this.d.get() && (str = ((C0381kh) this.f1236a.a()).m) != null && !Intrinsics.areEqual(str, "629a824d-c717-4ba5-bc0f-3f3968554d01") && this.d.compareAndSet(false, true)) {
            this.b.b(true);
            a("activation");
        }
        return this.d.get();
