...
public final class C0446n7 extends MessageNano {
    public static volatile C0446n7[] k;
    ...
    public static C0446n7 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0446n7().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0446n7 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0446n7 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0446n7) MessageNano.mergeFrom(new C0446n7(), bArr);
    }
}
