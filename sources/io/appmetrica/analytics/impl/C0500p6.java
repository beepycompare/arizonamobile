...
public final class C0500p6 extends MessageNano {
    public static volatile C0500p6[] g;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0500p6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0500p6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0500p6().mergeFrom(codedInputByteBufferNano);
    }

    public static C0500p6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0500p6) MessageNano.mergeFrom(new C0500p6(), bArr);
    }
}
