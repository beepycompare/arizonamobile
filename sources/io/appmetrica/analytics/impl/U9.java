...
public final class U9 implements IHandlerExecutor {
    ...
    public static Eb a(String str) {
        Eb eb = new Eb(str + Constants.FILENAME_SEQUENCE_SEPARATOR + Zd.f870a.incrementAndGet());
        eb.start();
        return eb;
    }
    ...
    public U9(Eb eb) {
        this(eb, eb.getLooper(), new Handler(eb.getLooper()));
    }

    public U9(Eb eb, Looper looper, Handler handler) {
        this.c = eb;
        this.f787a = looper;
        this.b = handler;
    }
