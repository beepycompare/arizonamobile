...
public final class C0747z0 implements InterfaceC0173cb {

    /* renamed from: a  reason: collision with root package name */
    public final Context f1180a;
    public final InterfaceC0147bb b;
    ...
    public final Fi g;
    public final Si h;
    public final C0196d8 i;
    public final C0286gl j;
    public volatile Jc k;
    public final C0394l0 l;
    public boolean m;

    public C0747z0(Context context, InterfaceC0147bb interfaceC0147bb) {
        this.f1180a = context;
        this.b = interfaceC0147bb;
        C0513pf b = A4.l().b(context);
        this.c = b;
        Od.a();
        A4 l = A4.l();
        l.m().a(new C0346j4(context));
        Vf a2 = A0.a(context, A0.a(interfaceC0147bb.b(), this));
        this.f = a2;
        C0196d8 j = l.j();
        this.i = j;
        Si a3 = A0.a(a2, context, interfaceC0147bb.getDefaultExecutor());
        this.h = a3;
        j.a(a3);
        Xl a4 = A0.a(context, a3, b, interfaceC0147bb.b());
        this.d = a4;
        a3.a(a4);
        this.e = A0.a(a3, b, interfaceC0147bb.b());
        this.g = A0.a(context, a2, a3, interfaceC0147bb.b(), a4);
        this.j = l.o();
        this.l = new C0394l0(b);
    }
    ...
    public final InterfaceC0328ib j() {
        Jc jc = this.k;
    ...
    public final void a(AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        C0394l0 c0394l0 = this.l;
        AppMetricaConfig f = c0394l0.f961a.f();
        if (f == null) {
            C0597t0 c0597t0 = c0394l0.b;
            c0597t0.getClass();
            AppMetricaConfig.Builder newConfigBuilder = AppMetricaConfig.newConfigBuilder("629a824d-c717-4ba5-bc0f-3f3968554d01");
            if (c0597t0.f1088a.b() && Intrinsics.areEqual(c0597t0.b.f388a, Boolean.TRUE)) {
        ...
        if (a(mainPublicOrAnonymousLogger, f, new C0722y0(this, f, mainPublicOrAnonymousLogger))) {
    ...
    public final void b(AppMetricaConfig appMetricaConfig) {
        ...
        boolean a2 = a(orCreateMainPublicLogger, appMetricaConfig, new C0697x0(this, appMetricaConfig, orCreateMainPublicLogger));
        if (a2 || this.m) {
            z = false;
        } else {
    ...
    public final void a(StartupParamsCallback startupParamsCallback, List<String> list) {
        this.d.a(startupParamsCallback, list, Gb.c(this.f.f713a.getAsString("PROCESS_CFG_CLIDS")));
    }
    ...
    public final boolean a(PublicLogger publicLogger, AppMetricaConfig appMetricaConfig, Wc wc) {
        if (this.k == null) {
            ...
            synchronized (k5) {
                ...
                while (it.hasNext()) {
                    ((InterfaceC0661ve) it.next()).consume(a2);
                }
                k5.b.clear();
            }
            return true;
    ...
    public final void a(AppMetricaConfig appMetricaConfig, PublicLogger publicLogger) {
        ...
        if (((Boolean) WrapUtils.getOrDefault(appMetricaConfig.crashReporting, bool2)).booleanValue()) {
            this.b.d().a(this.f1180a, appMetricaConfig, this);
            this.b.d().b();
        ...
        if (((Boolean) WrapUtils.getOrDefault(appMetricaConfig.sessionsAutoTrackingEnabled, bool2)).booleanValue()) {
            ...
            C0286gl c0286gl = this.j;
            synchronized (c0286gl) {
                if (c0286gl.g) {
                    c0286gl.f901a.unregisterListener(c0286gl.c, ActivityEvent.RESUMED);
                    c0286gl.f901a.unregisterListener(c0286gl.d, ActivityEvent.PAUSED);
                    c0286gl.g = false;
                }
            }
        }
