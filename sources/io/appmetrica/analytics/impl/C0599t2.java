...
public final class C0599t2 implements Nk, ApplicationStateProvider {

    /* renamed from: a  reason: collision with root package name */
    public final HashSet f1209a = new HashSet();
    public final HashSet b = new HashSet();
    public volatile ApplicationState c = ApplicationState.UNKNOWN;
    public final CopyOnWriteArraySet d = new CopyOnWriteArraySet();

    public final void a(int i) {
        this.f1209a.remove(Integer.valueOf(i));
        a();
    }
    ...
    public final void c(int i) {
        this.f1209a.add(Integer.valueOf(i));
