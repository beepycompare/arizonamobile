...
public final class O3 {
    ...
    public volatile K7 f615a = new K7();
    ...
    public static PreloadInfo c(String str) {
        ...
        HashMap c = AbstractC0447nb.c(jSONObject.optString("params"));
        if (c != null && c.size() > 0) {
    ...
    public final AppMetricaConfig.Builder a(String str) {
        ...
        try {
            ...
            if (jSONObject.has("error_environment") && (c2 = AbstractC0447nb.c(jSONObject.optString("error_environment"))) != null) {
            ...
            if (jSONObject.has("app_environment") && (c = AbstractC0447nb.c(jSONObject.optString("app_environment"))) != null) {
            ...
            if (jSONObject.has("customHosts")) {
                newConfigBuilder.withCustomHosts(AbstractC0447nb.a(jSONObject.optJSONArray("customHosts")));
            }
