...
public final class C0517pj implements InterfaceC0542qj {
    ...
    public C0517pj(Context context) {
        this.f1037a = context;
    }
    ...
    public final Q3 invoke() {
        Cursor cursor;
        if (!PackageManagerUtils.hasContentProvider(this.f1037a, "com.yandex.preinstallsatellite.appmetrica.provider")) {
            Bj.a("Satellite content provider with clids was not found.", new Object[0]);
            return null;
        }
        try {
            cursor = this.f1037a.getContentResolver().query(Uri.parse(this.b), null, null, null, null);
            try {
            } catch (Throwable th) {
                th = th;
                try {
            ...
            while (cursor.moveToNext()) {
                try {
                    ...
                    if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                        ...
                        Bj.a("Invalid clid {%s : %s}", string, string2);
                    }
                } catch (Throwable unused) {
                }
            }
            Bj.a("Clids from satellite: %s", linkedHashMap);
            return new Q3(linkedHashMap, EnumC0531q8.d);
        }
