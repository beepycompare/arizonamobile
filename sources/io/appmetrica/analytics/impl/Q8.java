...
public final class Q8 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        P8 p8 = this.b;
        return p8 != null ? CodedOutputByteBufferNano.computeMessageSize(2, p8) + computeSerializedSize : computeSerializedSize;
    }
    ...
    public final Q8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                codedInputByteBufferNano.readMessage(this.f634a);
            } else if (readTag != 18) {
