...
public abstract class AbstractC0165c6 extends BaseRequestConfig.ComponentLoader {
    ...
    public final SafePackageManager f920a;
    ...
    public C0191d6 load(C0139b6 c0139b6) {
        ...
        ApplicationInfo applicationInfo = this.f920a.getApplicationInfo(getContext(), getPackageName(), 0);
        if (applicationInfo != null) {
            int i = applicationInfo.flags;
            c0191d6.f938a = (i & 2) != 0 ? "1" : "0";
            c0191d6.b = (i & 1) == 0 ? "0" : "1";
        } else if (TextUtils.equals(packageName, getPackageName())) {
            c0191d6.f938a = (getContext().getApplicationInfo().flags & 2) != 0 ? "1" : "0";
