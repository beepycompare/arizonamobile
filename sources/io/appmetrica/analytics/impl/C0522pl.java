...
public final class C0522pl implements SimpleNetworkApi {

    /* renamed from: a  reason: collision with root package name */
    public final CacheControlHttpsConnectionPerformer f993a = new CacheControlHttpsConnectionPerformer(((C0721xl) Ga.j().y()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f993a.performConnection(str, new A3(networkClientWithCacheControl));
    }
}
