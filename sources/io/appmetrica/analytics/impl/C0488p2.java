...
public final class C0488p2 {
    public static void a(C0227em c0227em, JSONObject jSONObject) {
            ...
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    if (!TextUtils.isEmpty(optString)) {
                        ...
                        arrayList.add(new Pair(optString, optString2 != null ? new C0413m2(optString2) : null));
                    }
                }
            }
            c0227em.s = new C0438n2(arrayList);
        }
    }
}
