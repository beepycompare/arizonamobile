...
public final class RunnableC0253ff implements Runnable {
    ...
    public final /* synthetic */ PluginErrorDetails f875a;
    public final /* synthetic */ Cif b;

    public RunnableC0253ff(Cif cif, PluginErrorDetails pluginErrorDetails) {
        this.b = cif;
        this.f875a = pluginErrorDetails;
    }

    @Override // java.lang.Runnable
    public final void run() {
        ((InterfaceC0557rb) this.b.d.get()).getPluginExtension().reportUnhandledException(this.f875a);
    }
}
