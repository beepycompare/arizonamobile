                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        if (string2 != null && string2.length() != 0) {
                            ...
                            if (!TextUtils.isEmpty(string) && ParseUtils.parseLong(string) == null) {
                                AbstractC0253fj.a("Tracking id from Satellite is not a number.", new Object[0]);
                            }
                            AbstractC0253fj.a("Preload info from Satellite: {tracking id = %s, additional parameters = %s}", string, jSONObject2);
                            C0528qf c0528qf = new C0528qf(string, jSONObject2, !TextUtils.isEmpty(string), false, S7.d);
                            lo.a(cursor);
                            return c0528qf;
                        }
                        ...
                        AbstractC0253fj.a("Preload info from Satellite: {tracking id = %s, additional parameters = %s}", string, jSONObject22);
                        C0528qf c0528qf2 = new C0528qf(string, jSONObject22, !TextUtils.isEmpty(string), false, S7.d);
                        lo.a(cursor);
                        return c0528qf2;
                    }
                    AbstractC0253fj.a("No Preload Info data in Satellite content provider", new Object[0]);
                } else {
