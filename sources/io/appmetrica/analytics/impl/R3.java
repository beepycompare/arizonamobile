...
public final class R3 implements InterfaceC0479o8 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof R3) {
            R3 r3 = (R3) obj;
            return Intrinsics.areEqual(this.f649a, r3.f649a) && Intrinsics.areEqual(this.b, r3.b);
        }
        return false;
    }

    public final int hashCode() {
        return this.b.hashCode() + (this.f649a.hashCode() * 31);
    }

    public final String toString() {
        return "ClidsInfo(chosen=" + this.f649a + ", candidates=" + this.b + ')';
    }
