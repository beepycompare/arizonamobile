...
public final class Z5 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f879a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f879a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f879a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f879a);
        }
        if (!this.b.equals("")) {
    ...
    public final Z5 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f879a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
