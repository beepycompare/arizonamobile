...
public abstract class AbstractC0399l6 extends BaseRequestConfig.ComponentLoader {
    ...
    public final SafePackageManager f961a;
    ...
    public C0425m6 load(C0373k6 c0373k6) {
        ...
        ApplicationInfo applicationInfo = this.f961a.getApplicationInfo(getContext(), getPackageName(), 0);
        if (applicationInfo != null) {
            int i = applicationInfo.flags;
            c0425m6.f984a = (i & 2) != 0 ? "1" : "0";
            c0425m6.b = (i & 1) == 0 ? "0" : "1";
        } else if (TextUtils.equals(packageName, getPackageName())) {
            c0425m6.f984a = (getContext().getApplicationInfo().flags & 2) != 0 ? "1" : "0";
