...
public final class C0676w9 extends MessageNano {
    ...
    public static volatile C0676w9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f1103a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0551r9 c0551r9 = this.f;
        if (c0551r9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0551r9);
        }
        C0651v9 c0651v9 = this.g;
        if (c0651v9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0651v9);
        }
        if (!this.h.equals("")) {
        ...
        C0626u9[] c0626u9Arr = this.s;
        if (c0626u9Arr != null && c0626u9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0626u9[] c0626u9Arr2 = this.s;
                if (i6 >= c0626u9Arr2.length) {
                    break;
                }
                C0626u9 c0626u9 = c0626u9Arr2[i6];
                if (c0626u9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0626u9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f1103a);
        ...
        C0551r9 c0551r9 = this.f;
        if (c0551r9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0551r9);
        }
        C0651v9 c0651v9 = this.g;
        if (c0651v9 != null) {
        ...
        if (c0626u9Arr != null && c0626u9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0626u9 c0626u9 = c0626u9Arr2[i6];
                if (c0626u9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0626u9);
                }
                i6++;
            }
        }
    ...
    public static C0676w9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0676w9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0676w9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f1103a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0626u9[] c0626u9Arr = this.s;
                    int length = c0626u9Arr == null ? 0 : c0626u9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0626u9[] c0626u9Arr2 = new C0626u9[i];
                    if (length != 0) {
                        System.arraycopy(c0626u9Arr, 0, c0626u9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0626u9 c0626u9 = new C0626u9();
                        c0626u9Arr2[length] = c0626u9;
                        codedInputByteBufferNano.readMessage(c0626u9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0626u9 c0626u92 = new C0626u9();
                    c0626u9Arr2[length] = c0626u92;
                    codedInputByteBufferNano.readMessage(c0626u92);
                    this.s = c0626u9Arr2;
                    break;
                default:
    ...
    public static C0676w9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0676w9) MessageNano.mergeFrom(new C0676w9(), bArr);
    }
}
