...
public final class C0204dg {
    ...
    public C0204dg(ECommerceProduct eCommerceProduct) {
    ...
    public final String toString() {
        return "ProductWrapper{sku='" + this.f846a + "', name='" + this.b + "', categoriesPath=" + this.c + ", payload=" + this.d + ", actualPrice=" + this.e + ", originalPrice=" + this.f + ", promocodes=" + this.g + AbstractJsonLexerKt.END_OBJ;
    }

    public C0204dg(String str, String str2, List list, Map map, Tf tf, Tf tf2, List list2) {
        this.f846a = str;
        this.b = str2;
        this.c = list;
        this.d = map;
