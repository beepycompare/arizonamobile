...
public abstract class AbstractC0716xf implements Zl {
    public static final String c = "xf";

    /* renamed from: a  reason: collision with root package name */
    public final InterfaceC0349jb f1281a;
    public final String b;

    public AbstractC0716xf(InterfaceC0349jb interfaceC0349jb) {
    ...
    public final <T extends AbstractC0716xf> T a(String str, float f) {
        synchronized (this) {
            this.f1281a.a(str, f);
        }
        return this;
    ...
    public final C0742yf d(String str) {
        return new C0742yf(str, this.b);
    }

    public abstract /* synthetic */ Zl e(String str);

    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T f(String str) {
        synchronized (this) {
    ...
    public AbstractC0716xf(InterfaceC0349jb interfaceC0349jb, String str) {
        this.f1281a = interfaceC0349jb;
        this.b = str;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T d(String str, String str2) {
        synchronized (this) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T a(String str, String[] strArr) {
        String str2;
        try {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T d(String str, long j) {
        synchronized (this) {
            this.f1281a.a(str, j);
        }
        return this;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T d(String str, int i) {
        synchronized (this) {
            this.f1281a.a(str, i);
        }
        return this;
    ...
    public final <T extends AbstractC0716xf> T a(String str, List<String> list) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends AbstractC0716xf> T d(String str, boolean z) {
        synchronized (this) {
            this.f1281a.a(str, z);
        }
        return this;
