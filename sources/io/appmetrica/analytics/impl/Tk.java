...
public final class Tk {
    ...
    public Tk(JSONObject jSONObject) {
        this.f795a = jSONObject.optString("analyticsSdkVersionName", "");
    ...
    public final String toString() {
        return "SessionRequestParams(kitVersionName='" + this.f795a + "', kitBuildNumber='" + this.b + "', appVersion='" + this.c + "', appBuild='" + this.d + "', osVersion='" + this.e + "', apiLevel=" + this.f + ", attributionId=" + this.g + ')';
    }
}
