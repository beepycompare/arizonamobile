...
public final class C0736y9 extends MessageNano {
    ...
    public static volatile C0736y9[] T = null;
    ...
    public final int computeSerializedSize() {
        ...
        C0606t9 c0606t9 = this.f;
        if (c0606t9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0606t9);
        }
        C0710x9 c0710x9 = this.g;
        if (c0710x9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0710x9);
        }
        if (!this.h.equals("")) {
        ...
        C0684w9[] c0684w9Arr = this.s;
        if (c0684w9Arr != null && c0684w9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0684w9[] c0684w9Arr2 = this.s;
                if (i6 >= c0684w9Arr2.length) {
                    break;
                }
                C0684w9 c0684w9 = c0684w9Arr2[i6];
                if (c0684w9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0684w9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0606t9 c0606t9 = this.f;
        if (c0606t9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0606t9);
        }
        C0710x9 c0710x9 = this.g;
        if (c0710x9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0710x9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0684w9Arr != null && c0684w9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0684w9 c0684w9 = c0684w9Arr2[i6];
                if (c0684w9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0684w9);
                }
                i6++;
            }
        }
    ...
    public static C0736y9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0736y9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0736y9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0684w9[] c0684w9Arr = this.s;
                    int length = c0684w9Arr == null ? 0 : c0684w9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0684w9[] c0684w9Arr2 = new C0684w9[i];
                    if (length != 0) {
                        System.arraycopy(c0684w9Arr, 0, c0684w9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0684w9 c0684w9 = new C0684w9();
                        c0684w9Arr2[length] = c0684w9;
                        codedInputByteBufferNano.readMessage(c0684w9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0684w9 c0684w92 = new C0684w9();
                    c0684w9Arr2[length] = c0684w92;
                    codedInputByteBufferNano.readMessage(c0684w92);
                    this.s = c0684w9Arr2;
                    break;
                default:
    ...
    public static C0736y9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0736y9) MessageNano.mergeFrom(new C0736y9(), bArr);
    }
}
