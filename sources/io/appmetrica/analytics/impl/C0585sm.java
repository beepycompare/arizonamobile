...
public final class C0585sm extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1226a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1226a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1226a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1226a);
        }
    ...
    public final C0585sm mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1226a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
