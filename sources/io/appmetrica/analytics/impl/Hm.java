...
public final class Hm extends Om {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Xf("startup_state", iBinaryDataHelper, new Q8(c0672vm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0224dm());
    }
