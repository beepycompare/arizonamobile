...
public final class C0462nj {
    ...
    public static final void a(C0462nj c0462nj, ServiceConnection serviceConnection) {
        c0462nj.getClass();
        try {
            c0462nj.f1117a.unbindService(serviceConnection);
    ...
    */
    public final void a(Dg dg) {
        ...
        try {
            ...
            queryIntentServices = this.f1117a.getPackageManager().queryIntentServices(intent, 0);
        } catch (Throwable unused) {
        }
        if (queryIntentServices.isEmpty()) {
            ...
            try {
                if (this.f1117a.bindService(intent2, new ServiceConnectionC0436mj(this, dg), 1)) {
                    return;
                }
