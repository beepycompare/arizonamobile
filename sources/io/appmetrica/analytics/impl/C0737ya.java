...
public final class C0737ya implements ep {
    public static final C0711xa h = new C0711xa();
    ...
    public C0737ya(Context context, String str, IHandlerExecutor iHandlerExecutor, long j) {
        this.f1294a = context;
        this.b = str;
    ...
    public final BufferedFileWriter c() {
        ...
        synchronized (this.e) {
            ...
            File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f1294a, this.b);
    ...
    public final void d() {
        ...
        synchronized (this.e) {
            ...
            try {
                File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f1294a, this.b);
                if (fileFromSdkStorage != null && !fileFromSdkStorage.exists() && (fileFromAppStorage = FileUtils.getFileFromAppStorage(this.f1294a, this.b)) != null) {
    ...
    public /* synthetic */ C0737ya(Context context, String str, IHandlerExecutor iHandlerExecutor, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
