...
public final class C0703x7 extends SQLiteOpenHelper implements Closeable {
    ...
    public final SQLiteDatabase getReadableDatabase() {
        try {
            ...
            this.b.error(th, "Could not get readable database %s due to an exception. AppMetrica SDK may behave unexpectedly.", this.f1147a);
    ...
    public final SQLiteDatabase getWritableDatabase() {
        try {
            ...
            this.b.error(th, "Could not get writable database %s due to an exception. AppMetrica SDK may behave unexpectedly.", this.f1147a);
            C0413lk c0413lk = Kj.f538a;
            c0413lk.getClass();
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            this.c.f1052a.runScript(sQLiteDatabase);
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i > i2) {
            ...
            try {
                c0545qn.f1052a.runScript(sQLiteDatabase);
                return;
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        if (i2 > i) {
            for (int i3 = i + 1; i3 <= i2; i3++) {
                try {
                    Collection<DatabaseScript> collection = (Collection) c0545qn.c.f619a.get(Integer.valueOf(i3));
                    if (collection != null) {
