...
public final class C0596tb implements Ia, Closeable {

    /* renamed from: a  reason: collision with root package name */
    public final HashMap f1132a = new HashMap();
    public final HashMap b = new HashMap();
    public final String c = "preferences";
    public final C0571sb d;
    public volatile boolean e;
    public final InterfaceC0741z6 f;

    public C0596tb(InterfaceC0741z6 interfaceC0741z6) {
        this.f = interfaceC0741z6;
        C0571sb c0571sb = new C0571sb(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(Ad.a())));
        this.d = c0571sb;
        c0571sb.start();
    }
    ...
    */
    public static void a(C0596tb c0596tb) {
        SQLiteDatabase sQLiteDatabase;
        String str;
        c0596tb.getClass();
        Cursor cursor = null;
        try {
            sQLiteDatabase = c0596tb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(c0596tb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    public final Object b(String str) {
        ...
        synchronized (this.f1132a) {
            c();
            obj = this.f1132a.get(str);
        }
        return obj;
    }

    public static void a(C0596tb c0596tb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        c0596tb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(c0596tb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(c0596tb.c, null, contentValues2, 5);
                        }
                    }
    ...
    public final boolean a(String str) {
        ...
        synchronized (this.f1132a) {
            c();
            containsKey = this.f1132a.containsKey(str);
        }
        return containsKey;
    }
    ...
    public final Set a() {
        HashSet hashSet;
        synchronized (this.f1132a) {
            hashSet = new HashSet(this.f1132a.keySet());
        }
        return hashSet;
    }
