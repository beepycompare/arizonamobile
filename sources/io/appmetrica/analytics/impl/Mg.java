...
public final class Mg implements J {
    ...
    public final AdTrackingInfoResult b(Context context) {
        ...
        bundle.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", this.f549a);
        Lg lg = this.b;
        ...
        if (bundle2 != null) {
            ...
            if (bundle3 != null) {
                Object obj = R5.f620a.get(bundle3.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
                if (obj != null) {
        ...
        if (ReflectionUtils.detectClassExists("io.appmetrica.analytics.identifiers.internal.AdvIdentifiersProvider")) {
            ...
            while (gn.b()) {
                try {
                    ...
                    adTrackingInfoResult2 = new AdTrackingInfoResult(null, IdentifierStatus.UNKNOWN, "exception while fetching " + this.f549a + " adv_id: " + (e.getTargetException() != null ? e.getTargetException().getMessage() : null));
                    adTrackingInfoResult = adTrackingInfoResult2;
                    try {
                    ...
                    adTrackingInfoResult2 = new AdTrackingInfoResult(null, IdentifierStatus.UNKNOWN, "exception while fetching " + this.f549a + " adv_id: " + th.getMessage());
                    adTrackingInfoResult = adTrackingInfoResult2;
                    Thread.sleep(((Gn) ti).b);
                }
            }
