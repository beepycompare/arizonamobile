...
public final class Af extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f339a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f339a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f339a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f339a);
        }
        if (!this.b.equals("")) {
    ...
    public final Af mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f339a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
