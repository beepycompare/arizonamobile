...
public final class C0474o4 {
    ...
    public final void b(Bundle bundle) {
        ...
        C0530qa c0530qa = this.n;
        Bundle bundle13 = new Bundle();
        bundle13.putParcelable("value", c0530qa);
    ...
    public static C0530qa a(Bundle bundle) {
        Parcelable parcelable;
        Bundle bundle2 = bundle.getBundle("features");
        ClassLoader classLoader = C0530qa.class.getClassLoader();
        if (bundle2 == null) {
            parcelable = null;
        } else {
            bundle2.setClassLoader(classLoader);
        ...
        C0530qa c0530qa = (C0530qa) parcelable;
        return c0530qa == null ? new C0530qa(null, IdentifierStatus.UNKNOWN, "bundle serialization error") : c0530qa;
    }
    ...
    public static C0530qa a(Boolean bool) {
        boolean z = bool != null;
        return new C0530qa(bool, z ? IdentifierStatus.OK : IdentifierStatus.UNKNOWN, z ? null : "no identifier in startup state");
    }
}
