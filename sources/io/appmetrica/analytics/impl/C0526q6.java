...
public final class C0526q6 extends MessageNano {
    public static volatile C0526q6[] g;
    ...
    public final int computeSerializedSize() {
        ...
        C0500p6[] c0500p6Arr = this.f;
        if (c0500p6Arr != null && c0500p6Arr.length > 0) {
            int i2 = 0;
            while (true) {
                C0500p6[] c0500p6Arr2 = this.f;
                if (i2 >= c0500p6Arr2.length) {
                    break;
                }
                C0500p6 c0500p6 = c0500p6Arr2[i2];
                if (c0500p6 != null) {
                    computeSInt64Size = CodedOutputByteBufferNano.computeMessageSize(6, c0500p6) + computeSInt64Size;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0500p6Arr != null && c0500p6Arr.length > 0) {
            ...
            while (true) {
                ...
                C0500p6 c0500p6 = c0500p6Arr2[i2];
                if (c0500p6 != null) {
                    codedOutputByteBufferNano.writeMessage(6, c0500p6);
                }
                i2++;
            }
        }
