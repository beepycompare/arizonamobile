...
public final class C0526q6 extends MessageNano {
    ...
    public final C0526q6 a() {
        this.f1015a = WireFormatNano.EMPTY_BYTES;
        this.b = null;
        this.cachedSize = -1;
        return this;
    }
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f1015a, WireFormatNano.EMPTY_BYTES)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f1015a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f1015a, WireFormatNano.EMPTY_BYTES)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1015a);
        }
        C0625u6 c0625u6 = this.b;
        if (c0625u6 != null) {
    ...
    public final C0526q6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1015a = codedInputByteBufferNano.readBytes();
            } else if (readTag != 18) {
