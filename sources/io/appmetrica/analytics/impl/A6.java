...
public final class A6 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        int computeStringSize = CodedOutputByteBufferNano.computeStringSize(1, this.f341a) + super.computeSerializedSize();
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeString(1, this.f341a);
        if (!this.b.equals("")) {
    ...
    public final A6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f341a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
