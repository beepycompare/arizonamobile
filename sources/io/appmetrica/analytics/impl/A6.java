...
public final class A6 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        int computeStringSize = CodedOutputByteBufferNano.computeStringSize(1, this.f346a) + super.computeSerializedSize();
        if (!this.b.equals("")) {
            computeStringSize += CodedOutputByteBufferNano.computeStringSize(2, this.b);
        }
        C0728y6[] c0728y6Arr = this.c;
        int i = 0;
        if (c0728y6Arr != null && c0728y6Arr.length > 0) {
            int i2 = 0;
            while (true) {
                C0728y6[] c0728y6Arr2 = this.c;
                if (i2 >= c0728y6Arr2.length) {
                    break;
                }
                C0728y6 c0728y6 = c0728y6Arr2[i2];
                if (c0728y6 != null) {
                    computeStringSize += CodedOutputByteBufferNano.computeMessageSize(3, c0728y6);
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeString(1, this.f346a);
        if (!this.b.equals("")) {
        ...
        if (c0728y6Arr != null && c0728y6Arr.length > 0) {
            ...
            while (true) {
                ...
                C0728y6 c0728y6 = c0728y6Arr2[i2];
                if (c0728y6 != null) {
                    codedOutputByteBufferNano.writeMessage(3, c0728y6);
                }
                i2++;
            }
        }
    ...
    public final A6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f346a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
