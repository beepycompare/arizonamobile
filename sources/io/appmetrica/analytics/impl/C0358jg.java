...
public final class C0358jg implements zo {
    ...
    */
    public final byte[] a(C0403l9 c0403l9, Gh gh) {
        ...
        if (!TextUtils.isEmpty(c0403l9.b)) {
            try {
                byte[] decode = Base64.decode(c0403l9.b, 0);
                if (decode != null && decode.length != 0) {
                    jg = new Jg(decode);
                    C0563rg c0563rg = new C0563rg();
                    str = jg.f520a;
                    if (str != null) {
                        bytes = new byte[0];
                    } else {
                    ...
                    c0563rg.d = i;
                    return MessageNano.toByteArray(c0563rg);
                }
                jg = null;
                C0563rg c0563rg2 = new C0563rg();
                str = jg.f520a;
                if (str != null) {
                }
                c0563rg2.f1068a = bytes;
                c0563rg2.c = jg.b;
                c0563rg2.b = jg.c;
                ordinal = jg.d.ordinal();
                int i2 = 1;
                ...
                c0563rg2.d = i2;
                return MessageNano.toByteArray(c0563rg2);
