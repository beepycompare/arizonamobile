...
public final class C0169cc extends MessageNano {
    public static volatile C0169cc[] f;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0169cc mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0169cc b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0169cc().mergeFrom(codedInputByteBufferNano);
    }

    public static C0169cc a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0169cc) MessageNano.mergeFrom(new C0169cc(), bArr);
    }
}
