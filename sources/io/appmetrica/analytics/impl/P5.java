...
public final class P5 implements Parcelable.Creator {
    ...
    public final Object createFromParcel(Parcel parcel) {
        ...
        if (readBundle.containsKey("CounterReport.Source")) {
            ...
            while (true) {
                if (i2 < length) {
                    enumC0444n9 = values[i2];
                    if (enumC0444n9.f1110a == i) {
                        break;
                    }
                    i2++;
                } else {
        ...
        q5.f731a = readBundle.getString("CounterReport.Event");
        ...
        q5.k = EnumC0214ea.a(Integer.valueOf(readBundle.getInt("CounterReport.UniquenessStatus")));
        q5.l = enumC0444n9;
