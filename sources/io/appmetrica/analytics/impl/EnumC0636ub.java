...
public enum EnumC0636ub {
    ...
    static {
        EnumC0636ub[] values;
        for (EnumC0636ub enumC0636ub : values()) {
            K.put(Integer.valueOf(enumC0636ub.f1073a), enumC0636ub);
        }
    }

    EnumC0636ub(int i, String str) {
        this.f1073a = i;
        this.b = str;
    }
    ...
    public static EnumC0636ub a(int i) {
        EnumC0636ub enumC0636ub = (EnumC0636ub) K.get(Integer.valueOf(i));
        return enumC0636ub == null ? EVENT_TYPE_UNDEFINED : enumC0636ub;
    }
}
