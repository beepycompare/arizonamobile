...
public class C0401l5 {

    /* renamed from: a  reason: collision with root package name */
    public final String f934a;
    public final String b;

    public C0401l5(String str, String str2) {
        this.f934a = str;
        this.b = str2;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            C0401l5 c0401l5 = (C0401l5) obj;
            String str = this.f934a;
            if (str == null ? c0401l5.f934a != null : !str.equals(c0401l5.f934a)) {
                return false;
            }
            String str2 = this.b;
            String str3 = c0401l5.b;
            if (str2 != null) {
