...
public final class C0133ag implements qo {
    ...
    */
    public final byte[] a(C0281g9 c0281g9, C0712xh c0712xh) {
        ...
        if (!TextUtils.isEmpty(c0281g9.b)) {
            try {
                byte[] decode = Base64.decode(c0281g9.b, 0);
                if (decode != null && decode.length != 0) {
                    ag = new Ag(decode);
                    C0337ig c0337ig = new C0337ig();
                    str = ag.f339a;
                    if (str != null) {
                        bytes = new byte[0];
                    } else {
                    ...
                    c0337ig.d = i;
                    return MessageNano.toByteArray(c0337ig);
                }
                ag = null;
                C0337ig c0337ig2 = new C0337ig();
                str = ag.f339a;
                if (str != null) {
                }
                c0337ig2.f901a = bytes;
                c0337ig2.c = ag.b;
                c0337ig2.b = ag.c;
                ordinal = ag.d.ordinal();
                int i2 = 1;
                ...
                c0337ig2.d = i2;
                return MessageNano.toByteArray(c0337ig2);
