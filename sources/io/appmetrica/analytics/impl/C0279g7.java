...
public final class C0279g7 {

    /* renamed from: a  reason: collision with root package name */
    public final ReentrantReadWriteLock.ReadLock f861a;
    public final ReentrantReadWriteLock.WriteLock b;
    public final C0602t7 c;
    public final C0253f7 d;
    public final Object e;
    public final ArrayList f;
    public final Context g;
    public final C0575s5 h;
    public final AtomicLong i;
    public final ArrayList j;
    public final C0176c7 k;
    public final B7 l;
    ...
    public C0279g7(C0575s5 c0575s5, C0602t7 c0602t7, C0176c7 c0176c7, B7 b7) {
        ReentrantReadWriteLock reentrantReadWriteLock = new ReentrantReadWriteLock();
        this.f861a = reentrantReadWriteLock.readLock();
        ...
        this.c = c0602t7;
        this.g = c0575s5.getContext();
        this.h = c0575s5;
        this.k = c0176c7;
        this.l = b7;
        atomicLong.set(c());
        C0253f7 c0253f7 = new C0253f7(this, c0575s5);
        this.d = c0253f7;
        c0253f7.setName(a(c0575s5));
    }
    ...
    public final void a(InterfaceC0405l9 interfaceC0405l9) {
        this.j.add(interfaceC0405l9);
    }
    ...
    public final void a(long j, Wk wk, long j2) {
        ...
        C0712xh c0712xh = (C0712xh) this.h.k.a();
        Long valueOf = Long.valueOf(j);
        Long valueOf2 = Long.valueOf(j2);
        try {
            jSONObject = new JSONObject().put("dId", c0712xh.getDeviceId()).put("uId", c0712xh.getUuid()).put("appVer", c0712xh.getAppVersion()).put(RemoteConfigConstants.RequestFieldKey.APP_BUILD, c0712xh.getAppBuildNumber()).put("kitBuildType", c0712xh.getAnalyticsSdkBuildType()).put("osVer", c0712xh.getOsVersion()).put("osApiLev", c0712xh.getOsApiLevel()).put("lang", c0712xh.getLocale()).put("root", c0712xh.getDeviceRootStatus()).put("app_debuggable", ((C0352j6) c0712xh).f914a).put(CommonUrlParts.APP_FRAMEWORK, c0712xh.getAppFramework()).put("attribution_id", c0712xh.r).put("analyticsSdkVersionName", c0712xh.getAnalyticsSdkVersionName()).put("kitBuildNumber", c0712xh.getAnalyticsSdkBuildNumber());
        } catch (Throwable unused) {
            jSONObject = new JSONObject();
        }
        String jSONObject2 = jSONObject.toString();
        Long valueOf3 = Long.valueOf(Fn.a());
        C0317hk c0317hk = AbstractC0292gk.f869a;
        synchronized (c0317hk) {
            b = c0317hk.b.b(true);
        }
    ...
    public final void a() {
        ...
        try {
            this.b.lock();
            if (this.i.get() > ((C0712xh) this.h.k.a()).v && (writableDatabase = this.c.getWritableDatabase()) != null) {
                int a2 = a(writableDatabase);
                this.i.addAndGet(-a2);
                if (a2 != 0) {
                    Iterator it = this.j.iterator();
                    while (it.hasNext()) {
                        ((InterfaceC0405l9) it.next()).a();
                    }
                }
            }
        } catch (Throwable unused) {
    ...
    public final int a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            c0189ck.getClass();
            c0189ck.a(new Cj("deleteExcessiveReports exception", th));
            return 0;
        }
    }
    ...
    public final void a(long j, int i, int i2, boolean z) {
        ...
        try {
            ...
            SQLiteDatabase writableDatabase = this.c.getWritableDatabase();
            if (writableDatabase != null) {
                C0124a7 a2 = this.k.a(writableDatabase, format, 1, this.h.b.b, z);
                if (a2.f763a != null) {
                    ArrayList arrayList = new ArrayList();
                    for (ContentValues contentValues : a2.f763a) {
                        arrayList.add(Integer.valueOf(contentValues.getAsInteger("type").intValue()));
                    }
                    Iterator it = this.j.iterator();
                    while (it.hasNext()) {
                        ((InterfaceC0405l9) it.next()).b(arrayList);
                    }
                }
                List list = a2.f763a;
                if (list != null) {
    ...
    public final ContentValues a(long j, Wk wk) {
        ...
        try {
            SQLiteDatabase readableDatabase = this.c.getReadableDatabase();
            if (readableDatabase != null) {
                cursor = readableDatabase.rawQuery(String.format(Locale.US, "SELECT report_request_parameters FROM sessions WHERE id = %s AND type = %s ORDER BY id DESC LIMIT 1", Long.valueOf(j), Integer.valueOf(wk.f706a)), null);
    ...
    public final void a(ContentValues contentValues, String str) {
        ...
        if (R9.d.contains(EnumC0681wb.a(asInteger != null ? asInteger.intValue() : -1))) {
            A7 model = new B7(null, 1, null).toModel(contentValues);
            PublicLogger publicLogger = this.h.m;
            EnumC0681wb enumC0681wb = model.d;
            C0752z7 c0752z7 = model.g;
            publicLogger.info(AbstractC0211dg.a(str, enumC0681wb, c0752z7.b, c0752z7.c), new Object[0]);
        }
    }

    public static boolean a(C0279g7 c0279g7) {
        boolean isEmpty;
        synchronized (c0279g7.e) {
            isEmpty = c0279g7.f.isEmpty();
        }
        return isEmpty;
    }
}
