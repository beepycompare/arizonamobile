...
public final class C0611te implements ServiceNetworkContext {

    /* renamed from: a  reason: collision with root package name */
    public final C0654v5 f1218a;
    public final String b = new Fo().a();
    public final Xl c = new Xl();

    public C0611te(Context context) {
        this.f1218a = new C0654v5(new F5(context), new Ji(Na.k().h()));
    }
