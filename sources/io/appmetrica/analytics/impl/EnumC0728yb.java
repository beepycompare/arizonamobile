...
public enum EnumC0728yb {
    ...
    static {
        EnumC0728yb[] values;
        for (EnumC0728yb enumC0728yb : values()) {
            K.put(Integer.valueOf(enumC0728yb.f1157a), enumC0728yb);
        }
    }

    EnumC0728yb(int i, String str) {
        this.f1157a = i;
        this.b = str;
    }
    ...
    public static EnumC0728yb a(int i) {
        EnumC0728yb enumC0728yb = (EnumC0728yb) K.get(Integer.valueOf(i));
        return enumC0728yb == null ? EVENT_TYPE_UNDEFINED : enumC0728yb;
    }
}
