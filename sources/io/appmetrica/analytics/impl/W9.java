...
public final class W9 implements Parcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof W9) {
            W9 w9 = (W9) obj;
            return Intrinsics.areEqual(this.f820a, w9.f820a) && this.b == w9.b && Intrinsics.areEqual(this.c, w9.c);
        }
        return false;
    }

    public final int hashCode() {
        Boolean bool = this.f820a;
    ...
    public final String toString() {
        return "FeaturesInternal(sslPinning=" + this.f820a + ", status=" + this.b + ", errorExplanation=" + this.c + ')';
    }
