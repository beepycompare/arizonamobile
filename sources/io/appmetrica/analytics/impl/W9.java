...
public final class W9 implements Parcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof W9) {
            W9 w9 = (W9) obj;
            return Intrinsics.areEqual(this.f835a, w9.f835a) && this.b == w9.b && Intrinsics.areEqual(this.c, w9.c);
        }
        return false;
    }

    public final int hashCode() {
        Boolean bool = this.f835a;
    ...
    public final String toString() {
        return "FeaturesInternal(sslPinning=" + this.f835a + ", status=" + this.b + ", errorExplanation=" + this.c + ')';
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeValue(this.f835a);
