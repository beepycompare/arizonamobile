...
public final class C0623u2 implements ProtobufConverter {
    ...
    public final C0693wm fromModel(C0598t2 c0598t2) {
        ...
        c0693wm.f1145a = new C0668vm[c0598t2.f1090a.size()];
        for (int i = 0; i < c0598t2.f1090a.size(); i++) {
            C0668vm c0668vm = new C0668vm();
            Pair pair = (Pair) c0598t2.f1090a.get(i);
            c0668vm.f1132a = (String) pair.first;
            if (pair.second != null) {
                ...
                if (c0573s2 == null) {
                    ...
                    c0643um2.f1116a = c0573s2.f1076a;
                    c0643um = c0643um2;
                }
                c0668vm.b = c0643um;
            }
            c0693wm.f1145a[i] = c0668vm;
        }
        return c0693wm;
    }
    ...
    public final C0598t2 toModel(C0693wm c0693wm) {
        ...
        for (C0668vm c0668vm : c0693wm.f1145a) {
            String str = c0668vm.f1132a;
            C0643um c0643um = c0668vm.b;
            arrayList.add(new Pair(str, c0643um == null ? null : new C0573s2(c0643um.f1116a)));
        }
