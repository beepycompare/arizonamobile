...
public final class C0469o9 extends MessageNano {
    ...
    public final C0469o9 a() {
        this.f1143a = WireFormatNano.EMPTY_BYTES;
        this.cachedSize = -1;
        return this;
    }
    ...
    public final int computeSerializedSize() {
        ...
        return !Arrays.equals(this.f1143a, WireFormatNano.EMPTY_BYTES) ? CodedOutputByteBufferNano.computeBytesSize(1, this.f1143a) + computeSerializedSize : computeSerializedSize;
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f1143a, WireFormatNano.EMPTY_BYTES)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1143a);
        }
    ...
    public final C0469o9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1143a = codedInputByteBufferNano.readBytes();
            }
        }
        return this;
    }
