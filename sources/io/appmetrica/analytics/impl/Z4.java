...
public final class Z4 extends DatabaseScript {
    ...
    public final String f866a = "sessions";
    ...
    public final K7 i = new K7(null, 1, null);
    ...
    public final J7 a(Cursor cursor) {
        try {
            ...
            return new J7(valueOf, al, string, new I7(valueOf2, valueOf3, Boolean.valueOf(z)));
    ...
    */
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            cursor = sQLiteDatabase2.query(this.f866a, null, null, null, null, null, null, String.valueOf(this.b));
            while (cursor.moveToNext()) {
                try {
                    J7 a2 = a(cursor);
                    if (a2 != null && (l = a2.f608a) != null && l.longValue() >= 0 && a2.b != null && (str = a2.c) != null && str.length() != 0 && (l2 = a2.d.f590a) != null && l2.longValue() > 0) {
        ...
        cursor.close();
        sQLiteDatabase2.execSQL("DROP TABLE IF EXISTS " + this.f866a);
