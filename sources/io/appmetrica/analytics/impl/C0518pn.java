...
public final class C0518pn implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final T6 f1009a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0518pn(T6 t6, String str) {
        this.f1009a = t6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0567rn = new C0567rn(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0567rn = null;
                            }
                            if (c0567rn != null) {
                                arrayList.add(c0567rn);
                            }
