...
public final class C0164c7 {

    /* renamed from: a  reason: collision with root package name */
    public final ReentrantReadWriteLock.ReadLock f924a;
    public final ReentrantReadWriteLock.WriteLock b;
    public final C0500p7 c;
    public final Context d;
    public final C0446n5 e;
    public final AtomicLong f;
    public final ArrayList g;
    public final Z6 h;
    public final C0681w7 i;
    public final C0418m3 j;

    public C0164c7(C0446n5 c0446n5, C0500p7 c0500p7, Z6 z6, C0681w7 c0681w7) {
        ...
        this.g = arrayList;
        this.c = c0500p7;
        this.d = c0446n5.getContext();
        this.e = c0446n5;
        this.h = z6;
        this.i = c0681w7;
        atomicLong.set(b());
        this.j = new C0418m3(new X8(c0500p7, c0446n5, atomicLong, arrayList, z6, reentrantReadWriteLock), Na.k().w().e());
    }
    ...
    public final void a(InterfaceC0424m9 interfaceC0424m9) {
        this.g.add(interfaceC0424m9);
    }
    ...
    public final X6 a(SQLiteDatabase sQLiteDatabase, String str, C0384kl c0384kl) {
        return this.h.a(sQLiteDatabase, str, new String[]{Long.toString(c0384kl.f1072a), Integer.toString(c0384kl.b), Long.toString(c0384kl.c)}, 1, this.e.b.b, c0384kl.d);
    }
    ...
    */
    public final C0695wl a(long j, Al al) {
        Cursor cursor;
        String asString;
        SQLiteDatabase readableDatabase;
        ...
        if (readableDatabase != null) {
            ...
            if (!StringUtils.isNullOrEmpty(asString)) {
                return new C0695wl(new JSONObject(asString));
            }
            return null;
        }
        cursor = null;
