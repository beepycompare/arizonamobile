...
public final class P6 {
    ...
    public final C0672vm f712a = new C0672vm();
    ...
    */
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = Ib.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        if (hashMap != null) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                emptyMap.put(key, new IdentifiersResult(String.valueOf(Oo.a((Collection) list2) ? null : new JSONArray((Collection) list2)), identifiersResult.status, identifiersResult.errorExplanation));
            }
        } else {
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        C0672vm c0672vm = this.f712a;
        String a2 = Ib.a((Map) linkedHashMap);
        ...
        hashMap.put("appmetrica_custom_sdk_hosts", c0672vm.a(new IdentifiersResult(a2, identifierStatus, identifiersResult != null ? identifiersResult.errorExplanation : null)));
    }
}
