...
public final class Bm {
    ...
    public final void f() {
        ...
        String str = c0278gm.f1009a;
        String str2 = c0278gm.b;
        qo qoVar = this.f513a.n;
        String str3 = c0278gm.d;
        qoVar.getClass();
        if (!qo.a(str3)) {
            a2.f1059a = this.f513a.m.a().id;
        }
        String str4 = c0278gm.f1009a;
        if (str4 == null || str4.length() == 0) {
            str = this.f513a.h.a();
            str2 = "";
        }
        List<String> list = this.f513a.c.e;
    ...
    */
    public final synchronized boolean g() {
        ...
        C0278gm e = e();
        Set set = AbstractC0201dm.f955a;
        boolean z3 = true;
        if (!e.w) {
            if (AbstractC0201dm.b.currentTimeSeconds() <= e.o + e.z.f548a) {
                z = false;
                if (!z) {
                    if (AbstractC0201dm.a(e.d) && AbstractC0201dm.a(e.f1009a) && AbstractC0201dm.a(e.b)) {
                        z2 = true;
                    }
                    z = !z2;
                    D3 d3 = this.f513a.k;
    ...
    public final synchronized void b(C0278gm c0278gm) {
        this.f513a.l.a(c0278gm);
        C0252fm c0252fm = this.f513a.g;
        c0252fm.b.a(c0278gm.f1009a);
        c0252fm.b.b(c0278gm.b);
        c0252fm.f994a.save(c0278gm.c);
        this.f513a.e.a(c0278gm);
    }
    ...
    */
    public final C0278gm a(C0226em c0226em, C0175cm c0175cm, long j) {
        ...
        c0355jm.o = this.f513a.i.currentTimeSeconds();
        c0355jm.f1059a = e().d;
        c0355jm.c = c0226em.d;
        c0355jm.f = c0226em.c;
        c0355jm.g = c0175cm.e;
    ...
    */
        ...
        synchronized (this) {
            if (!mo.a((Map) map)) {
                ...
                if (!mo.a((Collection) list)) {
                    ...
                    Xj.f850a.a(longValue, c0226em.l);
    ...
    public final void a(C0278gm c0278gm) {
        ...
        Gl gl = cm.d;
        String str = cm.b;
        synchronized (gl.f594a.b) {
            Il il = gl.f594a;
            il.c = c0278gm;
            Collection collection = (Collection) il.f627a.f1183a.get(str);
            if (collection == null) {
