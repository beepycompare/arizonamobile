...
public final class C0586sn implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final InterfaceC0719y6 f1226a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0586sn(InterfaceC0719y6 interfaceC0719y6, String str) {
        this.f1226a = interfaceC0719y6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0636un = new C0636un(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0636un = null;
                            }
                            if (c0636un != null) {
                                arrayList.add(c0636un);
                            }
