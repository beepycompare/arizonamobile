...
public final class C0500p7 extends SQLiteOpenHelper implements Closeable {
    ...
    public C0500p7(Context context, String str, Jn jn, PublicLogger publicLogger) {
    ...
    public final SQLiteDatabase getReadableDatabase() {
        try {
            ...
            c0539qk.getClass();
            c0539qk.a(new Pj("db_read_error", th));
            return null;
        }
    }
    ...
    public final SQLiteDatabase getWritableDatabase() {
        try {
            ...
            C0539qk c0539qk = Oj.f708a;
            c0539qk.getClass();
            c0539qk.a(new Pj("db_write_error", th));
            return null;
        }
    }
