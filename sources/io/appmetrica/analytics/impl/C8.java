...
public class C8 implements StateSerializer {
    ...
    public final Object toState(byte[] bArr) throws IOException {
        try {
            return this.f523a.toState(this.b.decrypt(bArr));
        } catch (Throwable th) {
