...
public final class Ig {
    ...
    public final SafePackageManager f595a;

    public Ig(SafePackageManager safePackageManager) {
        this.f595a = safePackageManager;
    }
    ...
    public final T9 a(Context context) {
        ...
        Zo zo = na.D().c;
        String installerPackageName = this.f595a.getInstallerPackageName(context, context.getPackageName());
