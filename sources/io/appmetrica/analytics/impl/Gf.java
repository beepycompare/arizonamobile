...
public final class Gf extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f461a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f461a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f461a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f461a);
        }
        if (!this.b.equals("")) {
    ...
    public final Gf mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f461a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
