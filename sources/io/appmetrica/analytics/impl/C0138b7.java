...
public final class C0138b7 implements InterfaceC0112a7 {

    /* renamed from: a  reason: collision with root package name */
    private final Zg f905a;

    public C0138b7(Zg zg) {
        this.f905a = zg;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0112a7
    public File a(Context context, String str) {
        return new File(context.getNoBackupFilesDir(), this.f905a.a(str));
    }
}
