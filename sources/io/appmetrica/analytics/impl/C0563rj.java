...
public final class C0563rj implements SdkEnvironmentProvider {
    ...
    public final synchronized void a(ScreenInfo screenInfo) {
        ...
        if (screenInfo != null) {
            if (!Intrinsics.areEqual(screenInfo, getSdkEnvironment().getScreenInfo())) {
                ...
                while (it.hasNext()) {
                    ((J5) ((InterfaceC0539qj) it.next())).d();
                }
            }
        }
    }

    public final void b(InterfaceC0539qj interfaceC0539qj) {
        this.c.remove(interfaceC0539qj);
    }
    ...
    public final synchronized void a(Configuration configuration) {
        this.b.getClass();
        List a2 = C0206dc.a(configuration);
    ...
    public final void a(InterfaceC0539qj interfaceC0539qj) {
        this.c.add(interfaceC0539qj);
    }
}
