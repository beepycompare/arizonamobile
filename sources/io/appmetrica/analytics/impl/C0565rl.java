...
public final class C0565rl {
    ...
    public final synchronized boolean a(C0129ad c0129ad, String str, String str2) {
        ...
        int i = this.f1042a.c.f465a;
        if (size >= i && (i != c0129ad.size() || !c0129ad.containsKey(str))) {
            Xc xc = this.f1042a;
            xc.d.warning("The %s has reached the limit of %d items. Item with key %s will be ignored", xc.e, Integer.valueOf(xc.c.f465a), str);
            return false;
        }
        this.b.getClass();
        int i2 = c0129ad.f768a;
        if (str2 != null) {
            i2 += str2.length();
        }
        ...
        if (i2 > 4500) {
            Wc wc = this.b;
            wc.b.warning("The %s has reached the total size limit that equals %d symbols. Item with key %s will be ignored", wc.f702a, 4500, str);
            return false;
        }
    ...
    public final boolean b(C0129ad c0129ad, String str, String str2) {
        if (c0129ad != null) {
            String a2 = this.f1042a.f717a.a(str);
            String a3 = this.f1042a.b.a(str2);
