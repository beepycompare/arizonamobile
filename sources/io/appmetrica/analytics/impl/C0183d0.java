...
public final class C0183d0 {
    ...
    public C0183d0(B0 b0, Bl bl, C0316i4 c0316i4) {
        this.f937a = b0;
        this.b = bl;
        this.c = c0316i4;
    }
    ...
    public final synchronized void a(final Context context, final AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        ...
        ((U9) a3).b.post(new Runnable() { // from class: io.appmetrica.analytics.impl.d0$$ExternalSyntheticLambda0
            ...
            public final void run() {
                C0183d0.a(C0183d0.this, context, appMetricaLibraryAdapterConfig);
            }
        });
        this.f937a.getClass();
        B0.b();
    ...
    public static final void a(C0183d0 c0183d0, Context context, AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        c0183d0.f937a.getClass();
        A0 a2 = A0.a(context);
        a2.f().a(appMetricaLibraryAdapterConfig);
        C0574s4.l().c.a().execute(new RunnableC0727y1(a2.f449a));
    }
}
