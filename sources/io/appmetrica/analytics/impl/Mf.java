...
public final class Mf extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f664a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f664a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f664a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f664a);
        }
        if (!this.b.equals("")) {
    ...
    public final Mf mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f664a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
