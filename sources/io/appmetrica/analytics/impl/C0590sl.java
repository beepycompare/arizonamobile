...
public final class C0590sl implements SimpleNetworkApi {
    ...
    public final CacheControlHttpsConnectionPerformer f1056a = new CacheControlHttpsConnectionPerformer(((Al) Ia.j().y()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f1056a.performConnection(str, new A3(networkClientWithCacheControl));
    }
}
