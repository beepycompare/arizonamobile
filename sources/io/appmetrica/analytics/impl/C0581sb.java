...
public final class C0581sb implements Parcelable {
    public static final Parcelable.Creator<C0581sb> CREATOR = new C0556rb();
    ...
    public C0581sb(W6 w6, List list, Map map, boolean z) {
        HashMap hashMap;
        this.b = list;
        this.f1051a = w6;
        if (map == null) {
