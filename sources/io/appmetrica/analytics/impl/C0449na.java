...
public final class C0449na {
    ...
    public final C0487on C() {
        ...
        if (c0487on2 == null) {
            synchronized (this) {
                c0487on = this.x;
                if (c0487on == null) {
                    c0487on = new C0487on(this.f1133a);
                    this.x = c0487on;
                }
            }
            return c0487on;
        ...
        if (this.j == null) {
            synchronized (this) {
                if (this.j == null) {
                    ...
                    this.j = new C0603tf(this.f1133a, a3, new C0379kf(), new C0147bf(c0199df), new C0578sf(), new C0353jf(this.f1133a), new C0479of(k().y()), new C0224ef(), c0199df, "[PreloadInfoStorage]");
                }
            }
        }
    }
    ...
    public final C0108a2 d() {
        ...
        if (c0108a22 == null) {
            synchronized (this) {
                c0108a2 = this.h;
                if (c0108a2 == null) {
                    c0108a2 = new C0108a2(this.f1133a, AbstractC0134b2.a());
                    this.h = c0108a2;
                }
            }
            return c0108a2;
        ...
        if (this.k == null) {
            synchronized (this) {
                if (this.k == null) {
                    ...
                    Rm rm = (Rm) a2;
                    ProtobufStateStorage<Object> a3 = rm.a(context, rm.a(context));
                    this.k = new C0741z3(this.f1133a, a3, new A3(), new C0442n3(), new D3(), new Ti(this.f1133a), new B3(y()), new C0467o3(), (C0566s3) a3.read(), "[ClidsInfoStorage]");
                }
            }
        }
        return this.k;
    ...
    public final Fb l() {
        ...
        if (fb2 == null) {
            synchronized (this) {
                fb = this.o;
                if (fb == null) {
                    fb = new Fb(new O2(this.f1133a, this.d.a()), new C0263g2());
                    this.o = fb;
                }
            }
            return fb;
    ...
    public final C0651vd q() {
        ...
        if (c0651vd2 == null) {
            synchronized (this) {
                c0651vd = this.z;
                if (c0651vd == null) {
                    c0651vd = new C0651vd(this.f1133a, new no());
                    this.z = c0651vd;
                }
            }
            return c0651vd;
    ...
    public final C0405lg u() {
        if (this.b == null) {
            synchronized (this) {
                if (this.b == null) {
                    this.b = new C0405lg(this.f1133a, I.D().c);
                }
            }
        }
        return this.b;
    ...
    public final C0228ej v() {
        ...
        if (c0228ej2 == null) {
            synchronized (this) {
                c0228ej = this.n;
                if (c0228ej == null) {
                    c0228ej = new C0228ej(this.f1133a);
                    this.n = c0228ej;
                }
            }
            return c0228ej;
