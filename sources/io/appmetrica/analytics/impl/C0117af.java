...
public final class C0117af extends AbstractC0748zd implements Co {
    ...
    public C0117af(Ia ia) {
        super(ia);
    }

    public final long a(int i2) {
        return this.f765a.getLong(e.b, i2);
    }

    public final boolean b(boolean z) {
        return this.f765a.getBoolean(f.b, z);
    }

    public final C0117af c(boolean z) {
        return (C0117af) b(g.b, z);
    }

    public final C0117af d(long j2) {
        return (C0117af) b(e.b, j2);
    }

    public final boolean e() {
        return this.f765a.getBoolean(d.b, false);
    }
    ...
    public final C0117af g() {
        return (C0117af) b(p.b, true);
    }

    public final C0117af h() {
        return (C0117af) b(o.b, true);
    }

    public final boolean i() {
        return this.f765a.getBoolean(o.b, false);
    }

    public final boolean j() {
        return this.f765a.getBoolean(p.b, false);
    }

    public final long a(long j2) {
        return this.f765a.getLong(h.b, j2);
    }

    public final C0117af b(long j2) {
        return (C0117af) b(h.b, j2);
    }

    public final C0117af c(long j2) {
        return (C0117af) b(r.b, j2);
    }

    public final C0117af d(boolean z) {
        return (C0117af) b(f.b, z);
    }
    ...
    public final long f() {
        return this.f765a.getLong(r.b, 0L);
    }

    @Override // io.appmetrica.analytics.impl.Co
    public final String a() {
        return this.f765a.getString(q.b, null);
    }

    public final C0117af b(Ud ud, int i2) {
        Ze ze;
        ...
        return ze != null ? (C0117af) b(ze.b, i2) : this;
    }
    ...
    public final Boolean d() {
        Ze ze = g;
        if (this.f765a.a(ze.b)) {
            return Boolean.valueOf(this.f765a.getBoolean(ze.b, true));
        }
        return null;
    }
    ...
    public final int a(Ud ud, int i2) {
        ...
        return this.f765a.getInt(ze.b, i2);
    }

    public final C0117af b(Ud ud, long j2) {
        Ze ze;
        int ordinal = ud.ordinal();
        if (ordinal == 0) {
            ze = l;
        ...
        return ze != null ? (C0117af) b(ze.b, j2) : this;
    }
    ...
    public final long a(Ud ud, long j2) {
        ...
        return this.f765a.getLong(ze.b, j2);
    }
}
