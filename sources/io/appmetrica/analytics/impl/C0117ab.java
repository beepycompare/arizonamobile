...
public final class C0117ab implements InternalClientModuleFacade {

    /* renamed from: a  reason: collision with root package name */
    public final Oc f902a = new Oc();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : Nc.f708a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = Za.f883a[category2.ordinal()];
            if (i != 1) {
