...
public final class yo {
    ...
    public final zo f1308a;

    public yo(Xe xe, Co co, String str) {
        this.f1308a = new zo(xe, co, new Ao() { // from class: io.appmetrica.analytics.impl.yo$$ExternalSyntheticLambda0
    ...
    public final synchronized void b(long j) {
        zo zoVar = this.f1308a;
        zoVar.a(zoVar.a().put("session_id", j));
    }

    public final synchronized boolean c() {
        return this.f1308a.a().optBoolean("first_event_done", false);
    }

    public final synchronized boolean d() {
        return this.f1308a.a().optBoolean("init_event_done", false);
    }

    public final synchronized int b() {
        return this.f1308a.a().optInt("open_id", 1);
    }
    ...
    public final synchronized int a() {
        return this.f1308a.a().optInt("attribution_id", 1);
    }
