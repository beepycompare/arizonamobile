...
public final class yo {
    ...
    public final zo f1322a;

    public yo(Xe xe, Co co, String str) {
        this.f1322a = new zo(xe, co, new Ao() { // from class: io.appmetrica.analytics.impl.yo$$ExternalSyntheticLambda0
    ...
    public static final JSONObject a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        jSONObject3.put("report_request_id", AbstractC0293hb.a(jSONObject2, "report_request_id", AbstractC0293hb.a(jSONObject, "report_request_id", -1)));
        ...
        jSONObject3.put("open_id", AbstractC0293hb.a(jSONObject2, "open_id", AbstractC0293hb.a(jSONObject, "open_id", 1)));
        jSONObject3.put("attribution_id", AbstractC0293hb.a(jSONObject2, "attribution_id", AbstractC0293hb.a(jSONObject, "attribution_id", 1)));
        jSONObject3.put("last_migration_api_level", AbstractC0293hb.a(jSONObject2, "last_migration_api_level", AbstractC0293hb.a(jSONObject, "last_migration_api_level", 0)));
    ...
    public final synchronized void b(long j) {
        zo zoVar = this.f1322a;
        zoVar.a(zoVar.a().put("session_id", j));
    }

    public final synchronized boolean c() {
        return this.f1322a.a().optBoolean("first_event_done", false);
    }

    public final synchronized boolean d() {
        return this.f1322a.a().optBoolean("init_event_done", false);
    }

    public final synchronized int b() {
        return this.f1322a.a().optInt("open_id", 1);
    }
    ...
    public final synchronized int a() {
        return this.f1322a.a().optInt("attribution_id", 1);
    }
