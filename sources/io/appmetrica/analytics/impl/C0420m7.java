...
public final class C0420m7 extends MessageNano {
    public static volatile C0420m7[] s;
    ...
    public final int computeSerializedSize() {
        ...
        C0445n7 c0445n7 = this.e;
        if (c0445n7 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(5, c0445n7);
        }
        if (!this.f.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0445n7 c0445n7 = this.e;
        if (c0445n7 != null) {
            codedOutputByteBufferNano.writeMessage(5, c0445n7);
        }
        if (!this.f.equals("")) {
    ...
    public static C0420m7 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0420m7().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0420m7 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0420m7 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0420m7) MessageNano.mergeFrom(new C0420m7(), bArr);
    }
}
