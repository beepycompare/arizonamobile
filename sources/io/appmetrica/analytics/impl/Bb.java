...
public final class Bb extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f506a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f506a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f506a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f506a);
        }
        if (!this.b.equals("")) {
    ...
    public final Bb mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f506a = codedInputByteBufferNano.readString();
            } else if (readTag == 154) {
