...
public final class Wl {
    ...
    public final synchronized boolean a(C0275gd c0275gd, String str, String str2) {
        ...
        int i = this.f829a.c.f505a;
        if (size >= i && (i != c0275gd.size() || !c0275gd.containsKey(str))) {
            C0198dd c0198dd = this.f829a;
            c0198dd.d.warning("The %s has reached the limit of %d items. Item with key %s will be ignored", c0198dd.e, Integer.valueOf(c0198dd.c.f505a), str);
            return false;
        }
        this.b.getClass();
        int i2 = c0275gd.f995a;
        if (str2 != null) {
            i2 += str2.length();
        }
        ...
        if (i2 > 4500) {
            ...
            c0172cd.b.warning("The %s has reached the total size limit that equals %d symbols. Item with key %s will be ignored", c0172cd.f924a, 4500, str);
            return false;
        }
    ...
    public final boolean b(C0275gd c0275gd, String str, String str2) {
        if (c0275gd != null) {
            String a2 = this.f829a.f943a.a(str);
            String a3 = this.f829a.b.a(str2);
