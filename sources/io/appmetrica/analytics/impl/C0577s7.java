...
public final class C0577s7 implements ProtobufConverter {
    ...
    /* renamed from: a */
    public final D7 fromModel(C0629u7 c0629u7) {
        D7 d7 = new D7();
        Integer num = c0629u7.f1229a;
        if (num != null) {
            d7.f510a = num.intValue();
        }
        String str = c0629u7.b;
        if (str != null) {
            d7.b = StringUtils.correctIllFormedString(str);
        }
        String str2 = c0629u7.c;
        if (str2 != null) {
        ...
        C0759z7 c0759z7 = c0629u7.e;
        if (c0759z7 != null) {
            d7.e = this.b.fromModel(c0759z7);
        }
        String str3 = c0629u7.f;
        if (str3 != null) {
            d7.f = str3;
        }
        String str4 = c0629u7.g;
        if (str4 != null) {
            d7.g = str4;
        }
        Long l2 = c0629u7.h;
        ...
        Integer num2 = c0629u7.i;
        if (num2 != null) {
            d7.i = num2.intValue();
        }
        Integer num3 = c0629u7.j;
        if (num3 != null) {
            d7.j = num3.intValue();
        }
        String str5 = c0629u7.k;
        if (str5 != null) {
            d7.k = str5;
        }
        EnumC0166c9 enumC0166c9 = c0629u7.l;
        if (enumC0166c9 != null) {
            d7.l = enumC0166c9.f925a;
        }
        String str6 = c0629u7.m;
        if (str6 != null) {
            d7.m = str6;
        }
        Aa aa = c0629u7.n;
    ...
    public C0577s7(Me me2, A7 a7) {
        this.f1196a = me2;
        this.b = a7;
    }

    public /* synthetic */ C0577s7(Me me2, A7 a7, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new Me() : me2, (i & 2) != 0 ? new A7(null, 1, null) : a7);
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.Converter
    /* renamed from: a */
    public final C0629u7 toModel(D7 d7) {
        Long l;
        G9 g9;
        D7 d72 = new D7();
        ...
        C0759z7 model = this.b.toModel(d7.e);
        String str5 = d7.f;
        ...
        EnumC0166c9 a2 = valueOf6 != null ? EnumC0166c9.a(Integer.valueOf(valueOf6.intValue())) : null;
        String str11 = d7.m;
        ...
        byte[] bArr = d7.r;
        return new C0629u7(num, str2, str4, l2, model, str6, str8, l, num2, num3, str10, a2, str12, a3, g9, a4, num4, !Arrays.equals(bArr, d72.r) ? bArr : null);
    }
}
