...
public class C0448n5 implements InterfaceC0454nb, InterfaceC0273gb, Dh {
    ...
    public final void b(C0242f6 c0242f6) {
        ...
        synchronized (c0417m0) {
            if (a2.b > c0691wf.d().b) {
                c0691wf.a(a2);
                this.m.info("Save new app environment for %s. Value: %s", this.b, a2.f1058a);
            }
        }
    }
    ...
    public final void w() {
        ...
        ap apVar = this.t;
        synchronized (apVar) {
            optInt = apVar.f893a.a().optInt("last_migration_api_level", 0);
        }
    ...
    public C0448n5(Context context, C0267g5 c0267g5, C0417m0 c0417m0, TimePassedChecker timePassedChecker, C0577s5 c0577s5, F4 f4) {
        ...
        this.j = a6;
        a4.info("Read app environment for component %s. Value: %s", c0267g5.toString(), a5.a().f1058a);
        C0438ml c = c0577s5.c();
        this.u = c;
    ...
    public final void a(String str) {
        this.c.j(str).f1278a.flushAsync();
    }
}
