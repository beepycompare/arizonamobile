...
public final class C0458ng implements ProtobufStateStorage {
    ...
    public C0458ng(String str, IBinaryDataHelper iBinaryDataHelper, ProtobufStateSerializer<MessageNano> protobufStateSerializer, ProtobufConverter<Object, MessageNano> protobufConverter) {
        this.f1118a = str;
    ...
    public final void delete() {
        this.b.remove(this.f1118a);
    }

    @Override // io.appmetrica.analytics.coreapi.internal.data.ProtobufStateStorage
    public final Object read() {
        try {
            byte[] bArr = this.b.get(this.f1118a);
    ...
    public final void save(Object obj) {
        this.b.insert(this.f1118a, this.c.toByteArray((MessageNano) this.d.fromModel(obj)));
    }
}
