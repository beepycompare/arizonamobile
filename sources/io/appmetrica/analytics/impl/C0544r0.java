...
public final class C0544r0 {
    ...
    public final S1 g;
    public final T1 h;
    public final RunnableC0493p0 i;
    public final ServiceConnectionC0519q0 j;

    public C0544r0(Context context, ICommonExecutor iCommonExecutor) {
        this(context, iCommonExecutor, C0574s4.l().e(), new T1());
    }
    ...
    public C0544r0(Context context, ICommonExecutor iCommonExecutor, S1 s1, T1 t1) {
        this.d = null;
        this.f = new Object();
        this.i = new RunnableC0493p0(this);
        this.j = new ServiceConnectionC0519q0(this);
