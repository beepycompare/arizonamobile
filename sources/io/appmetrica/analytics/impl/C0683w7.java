...
public final class C0683w7 implements Converter {
    ...
    public final ContentValues fromModel(C0657v7 c0657v7) {
        ...
        Long l = c0657v7.f1243a;
        if (l != null) {
            contentValues.put("session_id", Long.valueOf(l.longValue()));
        }
        Al al = c0657v7.b;
        if (al != null) {
            contentValues.put("session_type", Integer.valueOf(al.f462a));
        }
        Long l2 = c0657v7.c;
        if (l2 != null) {
        ...
        Db db = c0657v7.d;
        if (db != null) {
            contentValues.put("type", Integer.valueOf(db.f510a));
        }
        Long l3 = c0657v7.e;
        if (l3 != null) {
        ...
        C0605t7 c0605t7 = this.f1259a;
        contentValues.put("event_description", MessageNano.toByteArray(c0605t7.f1210a.fromModel(c0657v7.g)));
    ...
    public final C0657v7 toModel(ContentValues contentValues) {
        ...
        return new C0657v7(asLong, al, asLong2, asInteger2 != null ? Db.a(asInteger2.intValue()) : null, contentValues.getAsLong("global_number"), contentValues.getAsLong("time"), this.f1259a.toModel(contentValues.getAsByteArray("event_description")));
    }
}
