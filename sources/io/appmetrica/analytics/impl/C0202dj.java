...
public final class C0202dj extends MessageNano {
    public static volatile C0202dj[] e;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0202dj mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0202dj b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0202dj().mergeFrom(codedInputByteBufferNano);
    }

    public static C0202dj a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0202dj) MessageNano.mergeFrom(new C0202dj(), bArr);
    }
}
