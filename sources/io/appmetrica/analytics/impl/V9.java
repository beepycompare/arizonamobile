...
public final class V9 implements Parcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof V9) {
            V9 v9 = (V9) obj;
            return Intrinsics.areEqual(this.f826a, v9.f826a) && this.b == v9.b && Intrinsics.areEqual(this.c, v9.c);
        }
        return false;
    }

    public final int hashCode() {
        Boolean bool = this.f826a;
    ...
    public final String toString() {
        return "FeaturesInternal(sslPinning=" + this.f826a + ", status=" + this.b + ", errorExplanation=" + this.c + ')';
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeValue(this.f826a);
