...
public final class C0537qf extends Td implements Ho {
    ...
    public final C0290h0 d() {
        C0290h0 c0290h0;
        synchronized (this) {
            c0290h0 = new C0290h0(this.f1062a.getString(j.b, "{}"), this.f1062a.getLong(k.b, 0L));
        }
        return c0290h0;
    }

    public final String e() {
        return this.f1062a.getString(m.b, "");
    }

    public final Map<String, Long> f() {
        HashMap hashMap = new HashMap();
        try {
            String string = this.f1062a.getString(q.b, null);
    ...
    public final List<String> g() {
        ...
        String string = this.f1062a.getString(str, null);
        if (!TextUtils.isEmpty(string)) {
            try {
    ...
    public final int h() {
        return this.f1062a.getInt(l.b, -1);
    }

    public final long i() {
        return this.f1062a.getLong(h.b, 0L);
    }

    public final String j() {
        return this.f1062a.getString(i.b, null);
    }

    public final Map<Integer, String> k() {
        HashMap hashMap = new HashMap();
        try {
            String string = this.f1062a.getString(p.b, null);
            if (string != null) {
                JSONObject jSONObject = new JSONObject(string);
                Iterator<String> keys = jSONObject.keys();
                while (keys.hasNext()) {
    ...
    public final String h(String str) {
        return this.f1062a.getString(new C0586sf(r, str).b, "");
    }
    ...
    public final String a() {
        return this.f1062a.getString(o.b, null);
    }
