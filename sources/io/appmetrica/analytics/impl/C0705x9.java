...
public final class C0705x9 extends Zf {
    ...
    public final HashMap a() {
        ...
        hashMap.put(Bb.EVENT_TYPE_ACTIVATION, new C0289h(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_START, new Nl(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_REGULAR, new C0178ch(this.f1153a));
        ...
        hashMap.put(Bb.EVENT_TYPE_APP_OPEN, new C0358jh(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_PURGE_BUFFER, new C0461ng(this.f1153a));
        ...
        hashMap.put(Bb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new C0159bo(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new Qf(this.f1153a));
        hashMap.put(Bb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new C0133ao(this.f1153a));
        ...
        hashMap.put(Bb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new C0222ea(this.f1153a));
        return hashMap;
    }
