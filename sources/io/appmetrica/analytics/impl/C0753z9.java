...
public final class C0753z9 extends MessageNano {
    ...
    public static volatile C0753z9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f1168a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0628u9 c0628u9 = this.f;
        if (c0628u9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(6, c0628u9);
        }
        C0728y9 c0728y9 = this.g;
        if (c0728y9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0728y9);
        }
        if (!this.h.equals("")) {
        ...
        C0703x9[] c0703x9Arr = this.s;
        if (c0703x9Arr != null && c0703x9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0703x9[] c0703x9Arr2 = this.s;
                if (i6 >= c0703x9Arr2.length) {
                    break;
                }
                C0703x9 c0703x9 = c0703x9Arr2[i6];
                if (c0703x9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0703x9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f1168a);
        ...
        C0628u9 c0628u9 = this.f;
        if (c0628u9 != null) {
            codedOutputByteBufferNano.writeMessage(6, c0628u9);
        }
        C0728y9 c0728y9 = this.g;
        if (c0728y9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0728y9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0703x9Arr != null && c0703x9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0703x9 c0703x9 = c0703x9Arr2[i6];
                if (c0703x9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0703x9);
                }
                i6++;
            }
        }
    ...
    public static C0753z9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0753z9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0753z9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f1168a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0703x9[] c0703x9Arr = this.s;
                    int length = c0703x9Arr == null ? 0 : c0703x9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0703x9[] c0703x9Arr2 = new C0703x9[i];
                    if (length != 0) {
                        System.arraycopy(c0703x9Arr, 0, c0703x9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0703x9 c0703x9 = new C0703x9();
                        c0703x9Arr2[length] = c0703x9;
                        codedInputByteBufferNano.readMessage(c0703x9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0703x9 c0703x92 = new C0703x9();
                    c0703x9Arr2[length] = c0703x92;
                    codedInputByteBufferNano.readMessage(c0703x92);
                    this.s = c0703x9Arr2;
                    break;
                default:
    ...
    public static C0753z9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0753z9) MessageNano.mergeFrom(new C0753z9(), bArr);
    }
}
