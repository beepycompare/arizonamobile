...
public final class C0392l implements ActivityLifecycleListener {
    ...
    public final synchronized void a(InterfaceC0366k interfaceC0366k) {
        this.f945a.add(interfaceC0366k);
    }

    @Override // io.appmetrica.analytics.coreapi.internal.lifecycle.ActivityLifecycleListener
    public final void onEvent(Activity activity, ActivityEvent activityEvent) {
        C0696x4.l().c.a().execute(new RunnableC0340j(this, activity));
    }

    public final void a(Activity activity) {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f945a);
        }
        Iterator it = hashSet.iterator();
        while (it.hasNext()) {
            ((C0611tj) ((InterfaceC0366k) it.next())).a(activity);
        }
    }
}
