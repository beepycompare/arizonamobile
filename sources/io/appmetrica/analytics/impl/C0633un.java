            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0683wn = new C0683wn(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0683wn = null;
                            }
                            if (c0683wn != null) {
                                arrayList.add(c0683wn);
                            }
