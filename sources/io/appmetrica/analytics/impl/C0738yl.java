...
public final class C0738yl implements PermissionExtractor {
    public static final String b = "[SimplePermissionExtractor]";

    /* renamed from: a  reason: collision with root package name */
    public final PermissionStrategy f1164a;

    public C0738yl(PermissionStrategy permissionStrategy) {
        this.f1164a = permissionStrategy;
    }
    ...
    public final boolean hasPermission(Context context, String str) {
        if (this.f1164a.forbidUsePermission(str)) {
            return false;
        }
