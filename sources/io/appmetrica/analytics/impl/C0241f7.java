...
public final class C0241f7 implements Converter {
    ...
    public final ContentValues fromModel(C0215e7 c0215e7) {
        ...
        if (enumC0142bb != null) {
            contentValues.put("type", Integer.valueOf(enumC0142bb.f917a));
        }
        Long l3 = c0215e7.e;
        if (l3 != null) {
        ...
        C0164c7 c0164c7 = this.f989a;
        contentValues.put("event_description", MessageNano.toByteArray(c0164c7.f931a.fromModel(c0215e7.g)));
    ...
    public final C0215e7 toModel(ContentValues contentValues) {
        ...
        return new C0215e7(asLong, vk, asLong2, asInteger2 != null ? EnumC0142bb.a(asInteger2.intValue()) : null, contentValues.getAsLong("global_number"), contentValues.getAsLong("time"), this.f989a.toModel(contentValues.getAsByteArray("event_description")));
    }
}
