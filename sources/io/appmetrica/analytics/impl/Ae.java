...
public final class Ae {
    ...
    public final String a(String str) {
        try {
            ...
            File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f500a, "uuid.dat");
    ...
    public final void a() {
        ...
        File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f500a, "uuid.dat");
        if (fileFromSdkStorage == null || fileFromSdkStorage.exists() || (fileFromAppStorage = FileUtils.getFileFromAppStorage(this.f500a, "uuid.dat")) == null || !fileFromAppStorage.exists()) {
            return;
        }
