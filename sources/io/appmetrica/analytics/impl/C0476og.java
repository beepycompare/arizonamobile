...
public final class C0476og {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && C0476og.class == obj.getClass()) {
            ...
            if (this.b == c0476og.b && this.c == c0476og.c && this.f1148a.equals(c0476og.f1148a) && this.d == c0476og.d) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        long j = this.b;
        long j2 = this.c;
        return this.d.hashCode() + (((((this.f1148a.hashCode() * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31);
    }

    public final String toString() {
        return "ReferrerInfo{installReferrer='" + this.f1148a + "', referrerClickTimestampSeconds=" + this.b + ", installBeginTimestampSeconds=" + this.c + ", source=" + this.d + AbstractJsonLexerKt.END_OBJ;
    }
