...
public final class C0593sm {
    ...
    public C0593sm(C0568rm c0568rm) {
        ...
        if (mm != null) {
            ...
            mm2 = new Mm(AbstractC0272g8.b.f427a);
        }
        this.A = mm2;
        map = c0568rm.B;
        if (map != null) {
