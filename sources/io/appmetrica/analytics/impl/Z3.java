...
public final class Z3 extends AbstractC0505p8 {
    ...
    public final boolean a(Q3 q3, Q3 q32) {
        ...
        if (enumC0530q8 == EnumC0530q8.c) {
            if (((Number) this.f1028a.a(enumC0530q8)).intValue() >= ((Number) this.f1028a.a(q32.b)).intValue()) {
                return true;
            }
        } else if (((Number) this.f1028a.a(enumC0530q8)).intValue() > ((Number) this.f1028a.a(q32.b)).intValue()) {
            return true;
        }
        return false;
    }
