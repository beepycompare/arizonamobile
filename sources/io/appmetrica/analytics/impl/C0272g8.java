...
public final class C0272g8 {
    ...
    public final void a(int i) {
        ...
        C0220e8 c0220e8 = this.d;
        String str = c0220e8 == null ? null : c0220e8.c;
    ...
    public final void a() {
        ...
        if (c0220e8 != null) {
            ...
            if (str != null) {
                ...
                if (!no.a(this.d.f840a)) {
                    Map<String, String> map = this.d.f840a;
                    DeferredDeeplinkParametersListener deferredDeeplinkParametersListener = this.c;
                    if (deferredDeeplinkParametersListener != null) {
