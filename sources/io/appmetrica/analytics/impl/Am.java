...
public final class Am {
    ...
    public final void f() {
        ...
        String str = c0257fm.f1000a;
        String str2 = c0257fm.b;
        po poVar = this.f504a.n;
        String str3 = c0257fm.d;
        poVar.getClass();
        if (!po.a(str3)) {
            a2.f1050a = this.f504a.m.a().id;
        }
        String str4 = c0257fm.f1000a;
        if (str4 == null || str4.length() == 0) {
            str = this.f504a.h.a();
            str2 = "";
        }
        List<String> list = this.f504a.c.e;
    ...
    */
    public final synchronized boolean g() {
        ...
        C0257fm e = e();
        Set set = AbstractC0180cm.f945a;
        boolean z3 = true;
        if (!e.w) {
            if (AbstractC0180cm.b.currentTimeSeconds() <= e.o + e.z.f540a) {
                z = false;
                if (!z) {
                    if (AbstractC0180cm.a(e.d) && AbstractC0180cm.a(e.f1000a) && AbstractC0180cm.a(e.b)) {
                        z2 = true;
                    }
                    z = !z2;
                    C3 c3 = this.f504a.k;
                    Map map = d().h;
                    C0741z3 c0741z3 = this.f504a.j;
                    c3.getClass();
    ...
    public final synchronized void b(C0257fm c0257fm) {
        this.f504a.l.a(c0257fm);
        C0231em c0231em = this.f504a.g;
        c0231em.b.a(c0257fm.f1000a);
        c0231em.b.b(c0257fm.b);
        c0231em.f984a.save(c0257fm.c);
        this.f504a.e.a(c0257fm);
    }
    ...
    */
    public final C0257fm a(C0206dm c0206dm, C0154bm c0154bm, long j) {
        ...
        c0334im.o = this.f504a.i.currentTimeSeconds();
        c0334im.f1050a = e().d;
        c0334im.c = c0206dm.d;
        c0334im.f = c0206dm.c;
        c0334im.g = c0154bm.e;
    ...
    */
        ...
        synchronized (this) {
            if (!lo.a((Map) map)) {
                ...
                if (!lo.a((Collection) list)) {
                    ...
                    Wj.f842a.a(longValue, c0206dm.l);
    ...
    public final void a(C0257fm c0257fm) {
        ...
        Fl fl = bm.d;
        String str = bm.b;
        synchronized (fl.f585a.b) {
            Hl hl = fl.f585a;
            hl.c = c0257fm;
            Collection collection = (Collection) hl.f619a.f1173a.get(str);
            if (collection == null) {
