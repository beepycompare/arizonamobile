...
public final class C0695x0 implements Xa {
    ...
    public final Ol d;
    public final C0686wg e;
    public final Pf f;
    public final C0688wi g;
    public final Ji h;
    public final Z7 i;
    public final Xk j;
    public volatile Ec k;
    public final C0346j0 l;
    public boolean m;

    public C0695x0(Context context, Wa wa) {
        this.f1127a = context;
        this.b = wa;
        C0361jf b = C0699x4.l().b(context);
        this.c = b;
        Id.a();
        C0699x4 l = C0699x4.l();
        l.m().a(new C0276g4(context));
        Pf a2 = AbstractC0720y0.a(context, AbstractC0720y0.a(wa.b(), this));
        this.f = a2;
        Z7 j = l.j();
        this.i = j;
        Ji a3 = AbstractC0720y0.a(a2, context, wa.getDefaultExecutor());
        this.h = a3;
        j.a(a3);
        Ol a4 = AbstractC0720y0.a(context, a3, b, wa.b());
        this.d = a4;
        a3.a(a4);
        this.e = AbstractC0720y0.a(a3, b, wa.b());
        this.g = AbstractC0720y0.a(context, a2, a3, wa.b(), a4);
        this.j = l.o();
        this.l = new C0346j0(b);
    }

    @Override // io.appmetrica.analytics.impl.Xa
    public final InterfaceC0432mb c(ReporterConfig reporterConfig) {
        return this.g.b(reporterConfig);
    }

    @Override // io.appmetrica.analytics.impl.Xa, io.appmetrica.analytics.impl.InterfaceC0182cd
    ...
    public final InterfaceC0206db j() {
        Ec ec = this.k;
        Intrinsics.checkNotNull(ec);
        return ec.f416a;
    }

    public final C0688wi k() {
        return this.g;
    }
    ...
    public final void a(AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        C0346j0 c0346j0 = this.l;
        AppMetricaConfig f = c0346j0.f908a.f();
        if (f == null) {
            C0545r0 c0545r0 = c0346j0.b;
            c0545r0.getClass();
            AppMetricaConfig.Builder newConfigBuilder = AppMetricaConfig.newConfigBuilder("629a824d-c717-4ba5-bc0f-3f3968554d01");
            if (c0545r0.f1026a.c() && Intrinsics.areEqual(c0545r0.b.f1135a, Boolean.TRUE)) {
        ...
        if (a(mainPublicOrAnonymousLogger, f, new C0670w0(this, f, mainPublicOrAnonymousLogger))) {
    ...
    public final void b(AppMetricaConfig appMetricaConfig) {
        ...
        boolean a2 = a(orCreateMainPublicLogger, appMetricaConfig, new C0645v0(this, appMetricaConfig, orCreateMainPublicLogger));
        if (a2 || this.m) {
            z = false;
        } else {
    ...
    public final boolean a(PublicLogger publicLogger, AppMetricaConfig appMetricaConfig, Rc rc) {
        if (this.k == null) {
            ...
            synchronized (h5) {
                ...
                while (it.hasNext()) {
                    ((InterfaceC0510pe) it.next()).consume(a2);
                }
                h5.b.clear();
            }
            return true;
    ...
    @Override // io.appmetrica.analytics.impl.Xa, io.appmetrica.analytics.impl.InterfaceC0482ob
