...
public abstract class Em {
    ...
    public static final Set f531a = SetsKt.setOf((Object[]) new String[]{"appmetrica_clids", StartupParamsCallback.APPMETRICA_DEVICE_ID_HASH, StartupParamsCallback.APPMETRICA_DEVICE_ID, "appmetrica_get_ad_url", "appmetrica_report_ad_url", StartupParamsCallback.APPMETRICA_UUID});
    ...
    */
    public static final boolean a(Hm hm, Collection collection, Map map, Function0 function0) {
        boolean a2;
                ...
                switch (str.hashCode()) {
                    case -1367801046:
                        if (!str.equals(StartupParamsCallback.APPMETRICA_UUID)) {
                            ...
                            if (b.currentTimeSeconds() > hm.o + hm.z.f968a) {
                                return false;
                            }
                        } else {
                            a2 = a(hm.d);
                    ...
                    case 530949152:
                        if (str.equals("appmetrica_clids")) {
                            c.getClass();
                            a2 = T3.a(map, hm, (Q3) function0.invoke());
                            if (a2) {
                            }
                        } else if (hm.w) {
                        }
