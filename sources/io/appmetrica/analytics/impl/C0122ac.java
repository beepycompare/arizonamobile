...
public final class C0122ac extends MessageNano {
    public static volatile C0122ac[] f;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0122ac mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0122ac b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0122ac().mergeFrom(codedInputByteBufferNano);
    }

    public static C0122ac a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0122ac) MessageNano.mergeFrom(new C0122ac(), bArr);
    }
}
