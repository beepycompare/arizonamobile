...
public final class Pe implements InterfaceC0630u8 {

    /* renamed from: a  reason: collision with root package name */
    public final Te f719a;
    public final A3 b;
    public final Va c;
    public final C0379kg d;

    public Pe() {
        this(new Te(), new A3(), new Va(100), new C0379kg());
    }
    ...
    public final List<Xi> fromModel(Oe oe) {
        ...
        int i = 0;
        char c = 1;
        C0522q3 c0522q3 = new C0522q3(C0522q3.b(a2, xi));
        List list = qe.c;
        ...
        C0682w8 c0682w8 = n8.e;
        if (c0682w8 != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(5, c0682w8);
        }
        C8 c8 = n8.f;
        if (c8 != null) {
        ...
        while (i3 < list.size()) {
            ...
            if (arrayList2.size() != 0 && i4 + computeRawVarint32Size > 204800) {
                ...
                arrayList.add(new Xi(n82, c0522q32));
                N8 n83 = new N8();
                n83.f682a = n8.f682a;
                C8 c83 = new C8();
                n83.f = c83;
            ...
            InterfaceC0547r3[] interfaceC0547r3Arr = new InterfaceC0547r3[2];
            interfaceC0547r3Arr[i5] = c0522q32;
            interfaceC0547r3Arr[c2] = xi2.b;
            c0522q32 = new C0522q3(C0522q3.b(interfaceC0547r3Arr));
    ...
    public Pe(Te te, A3 a3, Va va, C0379kg c0379kg) {
        this.f719a = te;
        this.b = a3;
        this.c = va;
        this.d = c0379kg;
