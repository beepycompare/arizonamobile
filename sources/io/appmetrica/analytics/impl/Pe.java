...
public final class Pe implements InterfaceC0632u8 {
    ...
    public final List<Xi> fromModel(Oe oe) {
        ...
        Qe qe = oe.b;
        A8 a8 = new A8();
        a8.f453a = StringUtils.getUTF8Bytes(qe.f731a);
        C0519po a2 = this.c.a(qe.b);
        a8.b = StringUtils.getUTF8Bytes((String) a2.f1152a);
        a8.e = qe.c.size();
        Map<String, String> map = qe.d;
        if (map != null) {
            xi = this.f716a.fromModel(map);
            a8.c = (E8) xi.f838a;
        } else {
            xi = null;
        }
        ...
        this.d.getClass();
        int computeInt32Size = n8.f679a != new N8().f679a ? CodedOutputByteBufferNano.computeInt32Size(1, n8.f679a) : 0;
        M8 m8 = n8.b;
        if (m8 != null) {
        ...
        while (i3 < list.size()) {
            ...
            b8.b = (C0710x8) fromModel.f838a;
            fromModel.b.getBytesTruncated();
            Xi xi2 = new Xi(b8, fromModel);
            this.d.getClass();
            int computeTagSize = CodedOutputByteBufferNano.computeTagSize(i2);
            int computeMessageSizeNoTag = CodedOutputByteBufferNano.computeMessageSizeNoTag((B8) xi2.f838a);
            ...
            if (arrayList2.size() != 0 && i4 + computeRawVarint32Size > 204800) {
                n82.f.f490a.d = (B8[]) arrayList2.toArray(new B8[arrayList2.size()]);
