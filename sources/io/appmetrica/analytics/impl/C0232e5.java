...
public final class C0232e5 extends DatabaseScript {

    /* renamed from: a  reason: collision with root package name */
    public final String f815a = "sessions";
    ...
    */
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            cursor = sQLiteDatabase2.query(this.f815a, null, null, null, null, null, null, String.valueOf(this.b));
            while (cursor.moveToNext()) {
                try {
                    L7 a2 = a(cursor);
                    if (a2 != null && (l = a2.f514a) != null && l.longValue() >= 0 && a2.b != null && (str = a2.c) != null && str.length() != 0 && (l2 = a2.d.f502a) != null && l2.longValue() > 0) {
        ...
        cursor.close();
        sQLiteDatabase2.execSQL("DROP TABLE IF EXISTS " + this.f815a);
