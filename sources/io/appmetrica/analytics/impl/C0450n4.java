...
public final class C0450n4 {

    /* renamed from: a  reason: collision with root package name */
    public final C0425m4 f964a;
    ...
    public final IHandlerExecutor a() {
        if (this.b == null) {
            synchronized (this) {
                if (this.b == null) {
                    this.f964a.getClass();
                    HandlerThreadC0706xb a2 = U9.a("IAA-CDE");
    ...
    public final ICommonExecutor b() {
        if (this.c == null) {
            synchronized (this) {
                if (this.c == null) {
                    this.f964a.getClass();
                    HandlerThreadC0706xb a2 = U9.a("IAA-CRS");
    ...
    public C0450n4(C0425m4 c0425m4) {
        this.f964a = c0425m4;
    }
}
