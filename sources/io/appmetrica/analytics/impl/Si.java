...
public final class Si {
    ...
    public final void b(String str) {
        Vf vf = this.f668a.f884a;
        synchronized (vf) {
            vf.f708a.put("PROCESS_CFG_INSTALL_REFERRER_SOURCE", str);
        }
    }
    ...
    public final void a(Xl xl) {
        this.e = xl;
        this.f668a.b.setUuid(xl.g());
    }

    public final void a(Boolean bool, Boolean bool2, Boolean bool3) {
        if (ro.a(bool)) {
            this.f668a.b.setLocationTracking(bool.booleanValue());
        }
        if (ro.a(bool2)) {
            this.f668a.b.setDataSendingEnabled(bool2.booleanValue());
        }
        if (ro.a(bool3)) {
            this.f668a.b.setAdvIdentifiersTracking(bool3.booleanValue());
        }
        C0477o6 a2 = C0477o6.a();
        C0192d5 c0192d5 = this.f668a;
    ...
    public static C0477o6 a(C0477o6 c0477o6, C0153bi c0153bi) {
        if (W9.f721a.contains(Integer.valueOf(c0477o6.d))) {
            c0477o6.c = c0153bi.d();
        }
        return c0477o6;
    }
    ...
    public final void a(List list) {
        Vf vf = this.f668a.f884a;
        synchronized (vf) {
            vf.f708a.put("PROCESS_CFG_CUSTOM_HOSTS", ro.a((Collection) list) ? null : new JSONArray((Collection) list).toString());
        }
    }
    ...
    public final void a(HashMap hashMap) {
        Vf vf = this.f668a.f884a;
        synchronized (vf) {
            vf.f708a.put("PROCESS_CFG_CLIDS", Gb.b(hashMap));
        }
    }
    ...
    public final void a(String str) {
        Vf vf = this.f668a.f884a;
        synchronized (vf) {
            vf.f708a.put("PROCESS_CFG_DISTRIBUTION_REFERRER", str);
        }
    }
    ...
    public final Rh a(Wn wn, C0153bi c0153bi) {
        ...
        if (mn == null) {
            ...
            str = (String) WrapUtils.getOrDefault(mn.f579a, "");
        }
        byte[] fromModel = yn.f759a.fromModel(wn);
