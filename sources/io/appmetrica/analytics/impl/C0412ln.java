...
public final class C0412ln extends AbstractC0619tn {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0457ng("startup_state", iBinaryDataHelper, new T8(zm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new Im());
    }
