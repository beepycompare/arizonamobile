...
public final class C0595tb implements Ia, Closeable {
    ...
    public final InterfaceC0740z6 f;

    public C0595tb(InterfaceC0740z6 interfaceC0740z6) {
        this.f = interfaceC0740z6;
        C0570sb c0570sb = new C0570sb(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(Ad.a())));
        this.d = c0570sb;
        c0570sb.start();
    }
    ...
    */
    public static void a(C0595tb c0595tb) {
        SQLiteDatabase sQLiteDatabase;
        String str;
        c0595tb.getClass();
        Cursor cursor = null;
        try {
            sQLiteDatabase = c0595tb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(c0595tb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    public final Object b(String str) {
        ...
        synchronized (this.f1230a) {
            c();
            obj = this.f1230a.get(str);
        }
        return obj;
    }

    public static void a(C0595tb c0595tb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        c0595tb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(c0595tb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(c0595tb.c, null, contentValues2, 5);
                        }
                    }
    ...
    public final boolean a(String str) {
        ...
        synchronized (this.f1230a) {
            c();
            containsKey = this.f1230a.containsKey(str);
        }
        return containsKey;
    }
    ...
    public final Set a() {
        HashSet hashSet;
        synchronized (this.f1230a) {
            hashSet = new HashSet(this.f1230a.keySet());
        }
        return hashSet;
    }
