...
public abstract class AbstractC0275gb {
        ...
        if (file != null && file.exists()) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            c0310hk.getClass();
                            c0310hk.a(new Hj("error_during_file_reading", th));
                            bArr = null;
                            if (bArr == null) {
                            }
                        } finally {
            ...
            if (bArr == null) {
                try {
                    ...
                    C0310hk c0310hk2 = Gj.f460a;
                    c0310hk2.getClass();
                    c0310hk2.a(new Hj("read_share_file_with_unsupported_encoding", e));
                    return str;
                }
            }
            return null;
