...
public final class C0728y6 extends MessageNano {
    public static volatile C0728y6[] g;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0728y6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0728y6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0728y6().mergeFrom(codedInputByteBufferNano);
    }

    public static C0728y6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0728y6) MessageNano.mergeFrom(new C0728y6(), bArr);
    }
}
