...
public final class C0125ag implements Converter {
    ...
    public final Zi fromModel(C0203dg c0203dg) {
        ...
        Zi zi4;
        M8 m8 = new M8();
        Sn a2 = this.e.a(c0203dg.f845a);
        m8.f574a = StringUtils.getUTF8Bytes((String) a2.f675a);
        Sn a3 = this.f.a(c0203dg.b);
        m8.b = StringUtils.getUTF8Bytes((String) a3.f675a);
