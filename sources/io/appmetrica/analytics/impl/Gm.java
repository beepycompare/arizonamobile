...
public final class Gm extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f464a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f464a);
        }
        ...
        if (cmArr != null && cmArr.length > 0) {
            while (true) {
                ...
                Cm cm = cmArr2[i];
                if (cm != null) {
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(31, cm);
                }
                i++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f464a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f464a);
        }
        ...
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f464a = codedInputByteBufferNano.readString();
                    break;
                case 16:
