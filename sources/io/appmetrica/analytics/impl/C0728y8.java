...
public final class C0728y8 extends MessageNano {
    public static volatile C0728y8[] e;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0728y8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                codedInputByteBufferNano.readMessage(this.f1150a);
            } else if (readTag == 18) {
                if (this.b == null) {
                    this.b = new J8();
                }
    ...
    public static C0728y8 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0728y8().mergeFrom(codedInputByteBufferNano);
    }

    public static C0728y8 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0728y8) MessageNano.mergeFrom(new C0728y8(), bArr);
    }
}
