...
public final class Tc implements InterfaceC0196d9 {
    ...
    public final void a(String str) {
        try {
            ...
            Ck ck = Na.F.D;
            String jSONObject = put2.put("activation_offset", TimeUnit.SECONDS.convert(ck.f389a.currentTimeMillis() - ck.b, TimeUnit.MILLISECONDS)).toString();
            c0413lk.getClass();
    ...
    public final boolean b() {
        String str;
        if (!this.d.get() && (str = ((Gh) this.f680a.a()).m) != null && !Intrinsics.areEqual(str, "629a824d-c717-4ba5-bc0f-3f3968554d01") && this.d.compareAndSet(false, true)) {
            this.b.b(true);
            a("activation");
        }
        return this.d.get();
