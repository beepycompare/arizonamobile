...
public final class Zl {
    ...
    public final void a(C0226em c0226em, C0267gb c0267gb) {
        ...
        if (optJSONObject9 != null) {
            c0681wm.f1285a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject9, "disabled_reporting_interval_seconds", c0681wm.f1285a);
        }
        this.e.getClass();
        c0226em.p = new Hm(c0681wm.f1285a);
        this.b.getClass();
        ...
        try {
            ...
            if (optJSONObject10 != null) {
                ...
                c0363k4.f1066a = X9.a(optJSONObject10, "permissions_collecting", c0581sm.f1222a);
        ...
        try {
            ...
            if (optJSONObject11 != null) {
                ...
                while (keys2.hasNext()) {
                    ...
                    if (!C0719ya.f1314a.contains(next2) && (a2 = C0719ya.a(optJSONObject11, next2)) != null) {
        ...
        if (c0226em.b.f1101a) {
            ...
            if (optJSONObject13 != null) {
                j = optJSONObject13.optLong("check_interval_seconds", c0631um.f1252a);
        ...
        if (optJSONObject14 != null) {
            c0507pm.f1172a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject14, "last_known_location_ttl", c0507pm.f1172a);
        }
        c0285h3.f1014a.getClass();
        c0226em.r = new C0207e3(c0507pm.f1172a);
        this.g.getClass();
        ...
        if (a6 != null) {
            c0656vm.f1272a = a6.intValue();
        }
        fm.f581a.getClass();
        c0226em.t = new Dm(c0656vm.f1272a);
        Map<String, Zc> c = this.j.f1216a.c();
        ...
        if (optJSONObject16 != null) {
            c0556rm.f1204a = RemoteConfigJsonUtils.extractMillisFromSecondsOrDefault(optJSONObject16, "collecting_interval_seconds", c0556rm.f1204a);
        }
        d9.getClass();
        c0226em.v = new C9(c0556rm.f1204a);
    }
