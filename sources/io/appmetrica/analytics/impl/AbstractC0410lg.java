...
public abstract class AbstractC0410lg {
    ...
    static {
        ...
        EnumC0260fl enumC0260fl = EnumC0260fl.FOREGROUND;
        hashMap.put(enumC0260fl, 0);
        EnumC0260fl enumC0260fl2 = EnumC0260fl.BACKGROUND;
        hashMap.put(enumC0260fl2, 1);
        f974a = Collections.unmodifiableMap(hashMap);
        SparseArray sparseArray = new SparseArray();
        sparseArray.put(0, enumC0260fl);
        sparseArray.put(1, enumC0260fl2);
        b = sparseArray;
        ...
        U8 u8 = new U8();
        C0119a9 c0119a9 = new C0119a9(new C0248f9());
        V8 v8 = new V8();
        B3 b3 = new B3(new C0248f9());
        Vn vn = new Vn(new C0248f9());
        C0307hg c0307hg = new C0307hg();
        C0606t9 a2 = C0631u9.a();
        a2.b = c0307hg;
        a2.c = c0307hg;
        C0631u9 c0631u9 = new C0631u9(a2);
        C0606t9 a3 = C0631u9.a();
        a3.b = c0119a9;
        C0631u9 c0631u92 = new C0631u9(a3);
        C0606t9 a4 = C0631u9.a();
        a4.b = b3;
        C0631u9 c0631u93 = new C0631u9(a4);
        C0606t9 a5 = C0631u9.a();
        a5.b = vn;
        C0631u9 c0631u94 = new C0631u9(a5);
        C0606t9 a6 = C0631u9.a();
        a6.f1093a = u8;
        C0631u9 c0631u95 = new C0631u9(a6);
        C0606t9 a7 = C0631u9.a();
        a7.b = new Ao(new C0119a9());
        C0631u9 c0631u96 = new C0631u9(a7);
        hashMap3.put(bb2, c0631u92);
        C0606t9 a8 = C0631u9.a();
        a8.b = new C0358jg();
        hashMap3.put(bb3, new C0631u9(a8));
        C0606t9 a9 = C0631u9.a();
        a9.f1093a = u8;
        a9.b = v8;
        a9.e = new C0655v8();
        a9.f = new C0680w8();
        hashMap3.put(bb4, new C0631u9(a9));
        hashMap3.put(bb9, c0631u9);
        hashMap3.put(bb10, c0631u9);
        hashMap3.put(bb11, c0631u93);
        hashMap3.put(bb12, c0631u93);
        hashMap3.put(bb5, c0631u93);
        hashMap3.put(bb6, c0631u93);
        hashMap3.put(bb7, c0631u93);
        hashMap3.put(bb8, c0631u93);
        C0606t9 a10 = C0631u9.a();
        a10.f1093a = new U8();
        a10.b = b3;
        hashMap3.put(bb14, new C0631u9(a10));
        Bb bb25 = Bb.EVENT_TYPE_CUSTOM_EVENT;
        C0606t9 a11 = C0631u9.a();
        a11.d = new C0384kg();
        hashMap3.put(bb25, new C0631u9(a11));
        hashMap3.put(bb15, c0631u92);
        hashMap3.put(bb17, c0631u95);
        hashMap3.put(bb18, c0631u95);
        hashMap3.put(bb19, c0631u93);
        hashMap3.put(bb20, c0631u93);
        hashMap3.put(bb21, c0631u93);
        hashMap3.put(bb22, c0631u94);
        hashMap3.put(bb, c0631u96);
        hashMap3.put(bb16, c0631u96);
        hashMap3.put(bb13, c0631u92);
        hashMap3.put(bb23, c0631u92);
        hashMap3.put(bb24, c0631u93);
