...
public class U8 implements StateSerializer {
    ...
    public final Object toState(byte[] bArr) throws IOException {
        try {
            return this.f787a.toState(this.b.decrypt(bArr));
        } catch (Throwable th) {
