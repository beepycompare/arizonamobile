...
public final class Yf implements Wf {
    ...
    public final /* synthetic */ C0225eg f869a;
    ...
    public final void a() {
        C0225eg c0225eg = this.f869a;
        C0748za c0748za = c0225eg.b;
        Xf xf = new Xf(c0225eg);
        c0748za.getClass();
        try {
            FutureTask futureTask = new FutureTask(new CallableC0723ya(c0748za));
            C0449na.I.d.f1085a.getClass();
            new InterruptionSafeThread(futureTask, "IAA-SHMSR-" + ThreadFactoryC0751zd.f1333a.incrementAndGet()).start();
