...
public final class C0677wi extends C0433mn {
    ...
    public final void f() {
        this.b.a();
        C0402lh c0402lh = (C0402lh) ((Y4) this.f1099a).k.a();
    ...
    public final void h() {
        ...
        this.e.remove(this.d);
        if (((C0402lh) ((Y4) this.f1099a).k.a()).g > 0) {
            this.e.executeDelayed(this.d, TimeUnit.SECONDS.toMillis(((C0402lh) ((Y4) this.f1099a).k.a()).g));
        }
    }
}
