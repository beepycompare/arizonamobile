...
public abstract class AbstractC0263g {
    ...
    public final Nk b() {
        if (this.c.h()) {
            return new Nk(this.f885a, this.c, a(), this.f);
        }
        return null;
    }
    ...
    public final Nk a(Ok ok) {
        ...
        C0651v5 c0651v5 = this.f885a;
        C0233el c0233el = this.c;
        long a2 = this.b.a();
        C0233el c0233el2 = this.c;
        c0233el2.a(C0233el.f, Long.valueOf(a2));
        c0233el2.a(C0233el.d, Long.valueOf(ok.f612a));
        c0233el2.a(C0233el.h, Long.valueOf(ok.f612a));
        c0233el2.a(C0233el.g, 0L);
        c0233el2.a(C0233el.i, Boolean.TRUE);
        c0233el2.b();
        this.f885a.e.a(a2, this.d.f778a, TimeUnit.MILLISECONDS.toSeconds(ok.b));
