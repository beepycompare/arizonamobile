    ...
    */
    public final C0454ng a(List list) {
        ...
        while (it3.hasNext()) {
            ...
            arrayList.add(new JSONObject().put(Constants.REFERRER, c0454ng6.f1142a).put("install_timestamp_seconds", c0454ng6.c).put("click_timestamp_seconds", c0454ng6.b).put("source", c0454ng6.d.f1123a));
        }
        ra.reportEvent("several_filled_referrers", jSONObject.put("candidates", lo.a((Collection) arrayList) ? null : new JSONArray((Collection) arrayList)).put("chosen", new JSONObject().put(Constants.REFERRER, c0454ng.f1142a).put("install_timestamp_seconds", c0454ng.c).put("click_timestamp_seconds", c0454ng.b).put("source", c0454ng.d.f1123a)).putOpt("install_time", packageInfo != null ? Long.valueOf(packageInfo.firstInstallTime) : null).toString());
        return c0454ng;
    }
