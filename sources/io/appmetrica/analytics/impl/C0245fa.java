...
public final class C0245fa implements ProtobufConverter {
    ...
    public final AbstractC0428me f993a;
    ...
    public final C0560rm fromModel(C0393l4 c0393l4) {
        ...
        c0560rm.b = c0393l4.b;
        c0560rm.f1213a = c0393l4.f1091a;
        c0560rm.c = c0393l4.c;
        c0560rm.d = c0393l4.d;
        c0560rm.e = c0393l4.e;
        c0560rm.f = this.f993a.a(c0393l4.f);
        return c0560rm;
    }
    ...
    public final C0393l4 toModel(C0560rm c0560rm) {
        ...
        c0342j4.c = c0560rm.c;
        c0342j4.b = c0560rm.b;
        c0342j4.f1056a = c0560rm.f1213a;
        c0342j4.e = c0560rm.e;
        c0342j4.f = this.f993a.a(c0560rm.f);
