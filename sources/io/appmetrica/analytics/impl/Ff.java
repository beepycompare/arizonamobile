...
public final class Ff extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f447a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f447a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f447a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f447a);
        }
        if (!this.b.equals("")) {
    ...
    public final Ff mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f447a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
