...
public final class C0466nl implements InterfaceC0493on {
    ...
    public final C0341il b() {
        return new C0341il((Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f974a, "phone", "getting SimMcc", "TelephonyManager", new C0366jl()), (Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f974a, "phone", "getting SimMnc", "TelephonyManager", new C0391kl()), ((Boolean) SystemServiceUtils.accessSystemServiceByNameSafelyOrDefault(this.f974a, "phone", "getting NetworkRoaming", "TelephonyManager", Boolean.FALSE, new C0441ml(this))).booleanValue(), (String) SystemServiceUtils.accessSystemServiceByNameSafely(this.f974a, "phone", "getting SimOperatorName", "TelephonyManager", new C0416ll()));
    }
    ...
    public final synchronized List<C0341il> a() {
        ...
        if (Ia.F.u.b().n.d) {
            if (AndroidUtils.isApiAchieved(23)) {
                if (this.b.hasPermission(this.f974a, "android.permission.READ_PHONE_STATE")) {
                    arrayList2.addAll(C0491ol.a(this.f974a));
                }
