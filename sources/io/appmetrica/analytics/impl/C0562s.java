...
public final class C0562s extends MessageNano {
    ...
    public static volatile C0562s[] t;
    ...
    public static C0562s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0562s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0562s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0562s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0562s) MessageNano.mergeFrom(new C0562s(), bArr);
    }
}
