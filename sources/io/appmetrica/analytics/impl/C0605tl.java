...
public final class C0605tl implements SimpleNetworkApi {
    ...
    public final CacheControlHttpsConnectionPerformer f1219a = new CacheControlHttpsConnectionPerformer(((Bl) C0470oa.k().z()).getSslSocketFactory());
    ...
    public final void performRequestWithCacheControl(String str, NetworkClientWithCacheControl networkClientWithCacheControl) {
        this.f1219a.performConnection(str, new C0233f3(networkClientWithCacheControl));
    }
}
