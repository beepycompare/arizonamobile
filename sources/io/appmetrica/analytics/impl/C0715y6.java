...
public final class C0715y6 {

    /* renamed from: a  reason: collision with root package name */
    public final Ul f1296a = new Ul();
    ...
    */
    public final synchronized void a(IdentifiersResult identifiersResult) {
        ...
        if (str3 == null) {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    try {
                        ArrayList a2 = AbstractC0293hb.a(new JSONArray(jSONObject.optString(next)));
                        if (a2 != null) {
                            hashMap.put(next, a2);
                        }
        ...
        if (hashMap != null) {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                emptyMap.put(key, new IdentifiersResult(String.valueOf(mo.a((Collection) list2) ? null : new JSONArray((Collection) list2)), identifiersResult.status, identifiersResult.errorExplanation));
            }
        } else {
        ...
        for (Map.Entry entry2 : emptyMap.entrySet()) {
            ...
            if (str4 != null) {
                try {
                    list = AbstractC0293hb.a(new JSONArray(str4));
    ...
    public final synchronized void a(List list, HashMap hashMap) {
        ...
        Ul ul = this.f1296a;
        String a2 = AbstractC0293hb.a((Map) linkedHashMap);
