...
public final class C0608tn implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final InterfaceC0741z6 f1138a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0608tn(InterfaceC0741z6 interfaceC0741z6, String str) {
        this.f1138a = interfaceC0741z6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0658vn = new C0658vn(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0658vn = null;
                            }
                            if (c0658vn != null) {
                                arrayList.add(c0658vn);
                            }
