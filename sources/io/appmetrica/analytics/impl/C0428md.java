...
public final class C0428md implements Sn {
    ...
    public C0428md(Context context) {
    ...
    /* renamed from: b */
    public final synchronized C0402ld a() {
        C0402ld c0402ld;
        String str;
        c0402ld = (C0402ld) this.d.getData();
        if (c0402ld == null || this.d.shouldUpdateData()) {
            if (this.b.hasNecessaryPermissions(this.f1097a)) {
                str = this.c.getNetworkType();
            } else {
                str = "unknown";
            }
            c0402ld = new C0402ld(str);
            this.d.setData(c0402ld);
        }
        return c0402ld;
    }
}
