...
public final class C0217e5 extends DatabaseScript {

    /* renamed from: a  reason: collision with root package name */
    public final String f838a = "sessions";
    ...
    public final Q7 i = new Q7(null, 1, null);

    public final P7 a(Cursor cursor) {
        try {
            ...
            return new P7(valueOf, enumC0156bl, string, new O7(valueOf2, valueOf3, Boolean.valueOf(z)));
    ...
    */
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            cursor = sQLiteDatabase2.query(this.f838a, null, null, null, null, null, null, String.valueOf(this.b));
            while (cursor.moveToNext()) {
                try {
                    P7 a2 = a(cursor);
                    if (a2 != null && (l = a2.f601a) != null && l.longValue() >= 0 && a2.b != null && (str = a2.c) != null && str.length() != 0 && (l2 = a2.d.f587a) != null && l2.longValue() > 0) {
        ...
        cursor.close();
        sQLiteDatabase2.execSQL("DROP TABLE IF EXISTS " + this.f838a);
