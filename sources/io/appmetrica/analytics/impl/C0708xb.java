...
public final class C0708xb implements Parcelable {
    public static final Parcelable.Creator<C0708xb> CREATOR = new C0683wb();

    /* renamed from: a  reason: collision with root package name */
    public final ResultReceiver f1154a;
    public final List b;
    public final HashMap c;
    public final boolean d;

    public C0708xb(ResultReceiverC0117a7 resultReceiverC0117a7, List list, Map map, boolean z) {
        HashMap hashMap;
        this.b = list;
        this.f1154a = resultReceiverC0117a7;
        if (map == null) {
            hashMap = new HashMap();
        } else {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        bundle.putParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver", this.f1154a);
        if (this.b != null) {
    ...
    public C0708xb(Parcel parcel) {
        Bundle readBundle = parcel.readBundle(ResultReceiverC0117a7.class.getClassLoader());
        if (readBundle != null) {
            this.f1154a = (ResultReceiver) readBundle.getParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver");
