...
public final class C0304hg implements Converter {
    ...
    public final Xi fromModel(C0329ig c0329ig) {
        ...
        Xi xi4;
        G8 g8 = new G8();
        C0519po a2 = this.e.a(c0329ig.f1033a);
        g8.f561a = StringUtils.getUTF8Bytes((String) a2.f1153a);
        C0519po a3 = this.f.a(c0329ig.b);
        g8.b = StringUtils.getUTF8Bytes((String) a3.f1153a);
        List<String> list = c0329ig.c;
        Xi xi5 = null;
        if (list != null) {
            xi = this.c.fromModel(list);
            g8.c = (C0736y8) xi.f839a;
        } else {
            xi = null;
        }
        Map<String, String> map = c0329ig.d;
        if (map != null) {
            xi2 = this.f1016a.fromModel(map);
            g8.d = (E8) xi2.f839a;
        } else {
            xi2 = null;
        }
