...
public final class C0729y3 extends ECommerceEvent {
    ...
    public C0729y3(int i, ECommerceCartItem eCommerceCartItem) {
        this(i, new B3(eCommerceCartItem), new C0755z3());
    }
    ...
    public C0729y3(int i, B3 b3, InterfaceC0630u8 interfaceC0630u8) {
        this.f1288a = i;
        this.b = b3;
