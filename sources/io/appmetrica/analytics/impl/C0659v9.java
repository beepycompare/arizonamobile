...
public final class C0659v9 extends MessageNano {
    public static volatile C0659v9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1248a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1248a);
        }
        if (!this.b.equals("")) {
        ...
        C0633u9[] c0633u9Arr = this.l;
        if (c0633u9Arr != null && c0633u9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0633u9[] c0633u9Arr2 = this.l;
                if (i4 >= c0633u9Arr2.length) {
                    break;
                }
                C0633u9 c0633u9 = c0633u9Arr2[i4];
                if (c0633u9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0633u9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1248a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1248a);
        }
        if (!this.b.equals("")) {
        ...
        if (c0633u9Arr != null && c0633u9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0633u9 c0633u9 = c0633u9Arr2[i4];
                if (c0633u9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0633u9);
                }
                i4++;
            }
        }
    ...
    public static C0659v9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0659v9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0659v9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1248a = codedInputByteBufferNano.readString();
                    break;
                case 18:
                ...
                case 186:
                    ...
                    C0633u9[] c0633u9Arr = this.l;
                    int length = c0633u9Arr == null ? 0 : c0633u9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0633u9[] c0633u9Arr2 = new C0633u9[i];
                    if (length != 0) {
                        System.arraycopy(c0633u9Arr, 0, c0633u9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0633u9 c0633u9 = new C0633u9();
                        c0633u9Arr2[length] = c0633u9;
                        codedInputByteBufferNano.readMessage(c0633u9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0633u9 c0633u92 = new C0633u9();
                    c0633u9Arr2[length] = c0633u92;
                    codedInputByteBufferNano.readMessage(c0633u92);
                    this.l = c0633u9Arr2;
                    break;
    ...
    public static C0659v9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0659v9) MessageNano.mergeFrom(new C0659v9(), bArr);
    }
}
