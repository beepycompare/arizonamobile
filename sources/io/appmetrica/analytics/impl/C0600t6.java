...
public final class C0600t6 extends MessageNano {
    public static final int l = 0;
    public static final int m = 1;
    public static volatile C0600t6[] n;
    public static byte[] o;
    public static volatile boolean p;

    /* renamed from: a  reason: collision with root package name */
    public C0700x6 f1061a;
    public C0451n6 b;
    public String c;
    public int d;
    public C0650v6[] e;
    ...
    public final int computeSerializedSize() {
        ...
        C0575s6 c0575s6 = this.h;
        if (c0575s6 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(8, c0575s6);
        }
        ...
        C0501p6[] c0501p6Arr = this.k;
        if (c0501p6Arr != null && c0501p6Arr.length > 0) {
            while (true) {
                C0501p6[] c0501p6Arr2 = this.k;
                if (i2 >= c0501p6Arr2.length) {
                    break;
                }
                C0501p6 c0501p6 = c0501p6Arr2[i2];
                if (c0501p6 != null) {
                    computeSerializedSize = CodedOutputByteBufferNano.computeMessageSize(11, c0501p6) + computeSerializedSize;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0575s6 c0575s6 = this.h;
        if (c0575s6 != null) {
            codedOutputByteBufferNano.writeMessage(8, c0575s6);
        }
        if (!Arrays.equals(this.i, o)) {
        ...
        if (c0501p6Arr != null && c0501p6Arr.length > 0) {
            while (true) {
                ...
                C0501p6 c0501p6 = c0501p6Arr2[i2];
                if (c0501p6 != null) {
                    codedOutputByteBufferNano.writeMessage(11, c0501p6);
                }
                i2++;
            }
        }
    ...
    public static C0600t6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0600t6().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0600t6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 10:
                    if (this.f1061a == null) {
                        this.f1061a = new C0700x6();
                    }
                    codedInputByteBufferNano.readMessage(this.f1061a);
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new C0451n6();
    ...
    public static C0600t6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0600t6) MessageNano.mergeFrom(new C0600t6(), bArr);
    }
}
