...
public final class C0336j2 implements AppSetIdProvider {
    ...
    public final long e;
    public final C0311i2 f;

    public C0336j2(Context context, IAppSetIdRetriever iAppSetIdRetriever) {
        this.f944a = context;
        this.b = iAppSetIdRetriever;
        this.d = new CountDownLatch(1);
        this.e = 20L;
        this.f = new C0311i2(this);
    }
    ...
    public final synchronized AppSetId getAppSetId() {
        ...
        if (this.c == null) {
            try {
                this.d = new CountDownLatch(1);
                this.b.retrieveAppSetId(this.f944a, this.f);
    ...
    public C0336j2(Context context) {
        this(context, AbstractC0362k2.a());
    }
}
