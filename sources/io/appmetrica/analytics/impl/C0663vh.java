...
public final class C0663vh implements IParamsAppender {
    ...
    public final AdvIdWithLimitedAppender f1123a;
    ...
    public C0663vh(AdvIdWithLimitedAppender advIdWithLimitedAppender, NetworkTaskForSendingDataParamsAppender networkTaskForSendingDataParamsAppender, C0302hc c0302hc) {
        this.f1123a = advIdWithLimitedAppender;
    ...
    public final void appendParams(Uri.Builder builder, Gh gh) {
        ...
        L7 l7 = this.c;
        if (l7 != null) {
            builder.appendQueryParameter(CommonUrlParts.DEVICE_ID, StringUtils.ifIsEmptyToDef(l7.f550a, gh.getDeviceId()));
        ...
        AdvIdWithLimitedAppender advIdWithLimitedAppender = this.f1123a;
        this.d.getClass();
