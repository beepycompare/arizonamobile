...
public final class C0687wc implements PermissionStrategy, LocationControllerObserver {
    public static final C0661vc b = new C0661vc();
    ...
    public final String toString() {
        return "LocationFlagStrategy(enabled=" + this.f1266a + ", locationPermissions=" + c + ')';
    }
}
