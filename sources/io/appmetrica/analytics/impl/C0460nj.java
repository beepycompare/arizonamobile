...
public final class C0460nj {

    /* renamed from: a  reason: collision with root package name */
    public final Context f1120a;

    public C0460nj(Context context) {
        this.f1120a = context;
    }

    public static final void a(C0460nj c0460nj, ServiceConnection serviceConnection) {
        c0460nj.getClass();
        try {
            c0460nj.f1120a.unbindService(serviceConnection);
    ...
    */
    public final void a(Dg dg) {
        ...
        if (queryIntentServices.isEmpty()) {
            ...
            try {
                if (this.f1120a.bindService(intent2, new ServiceConnectionC0434mj(this, dg), 1)) {
                    return;
                }
