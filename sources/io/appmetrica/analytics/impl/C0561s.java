...
public final class C0561s extends MessageNano {
    ...
    public static volatile C0561s[] t;
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f1218a, u)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f1218a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f1218a, u)) {
            codedOutputByteBufferNano.writeBytes(1, this.f1218a);
        }
        r rVar = this.b;
        if (rVar != null) {
    ...
    public static C0561s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0561s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0561s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1218a = codedInputByteBufferNano.readBytes();
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new r();
    ...
    public static C0561s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0561s) MessageNano.mergeFrom(new C0561s(), bArr);
    }
}
