...
public final class C0200dk implements ServiceContext {

    /* renamed from: a  reason: collision with root package name */
    public final ModuleServiceLifecycleController f855a;
    public final Td b = new Td(getContext());
    public final C0115ad c = new C0115ad();
    public final Dk d = new Dk(getContext(), new Ck(new N1()));
    public final Ak e = new Ak(getContext(), C0471oa.k().y(), C0471oa.k().B().f(getContext()));
    public final C0744z9 f = new C0744z9();
    public final C0517q6 g = new C0517q6();

    public C0200dk(ModuleServiceLifecycleController moduleServiceLifecycleController) {
        this.f855a = moduleServiceLifecycleController;
    }
    ...
    public final ActivationBarrier getActivationBarrier() {
        return C0471oa.I.B.getActivationBarrier();
    }
    ...
    public final ChargeTypeProvider getChargeTypeProvider() {
        ...
        if (s22 == null) {
            synchronized (c0471oa) {
                s2 = c0471oa.e;
                if (s2 == null) {
                    s2 = new S2(c0471oa.d.a(), c0471oa.l().f491a);
                    c0471oa.e = s2;
                }
            }
            return s2;
    ...
    public final FirstExecutionConditionService getFirstExecutionConditionService() {
        return C0471oa.I.B.getFirstExecutionService();
    }
