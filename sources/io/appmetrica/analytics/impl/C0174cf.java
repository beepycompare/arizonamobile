...
public final class C0174cf implements InterfaceC0704x2 {

    /* renamed from: a  reason: collision with root package name */
    public final int f926a = 10;
    ...
    public final String a(String str) {
        ...
        if (length2 < this.f926a || length2 > this.b || ((firstOrNull2 != null && firstOrNull2.charValue() == '0') || !this.c.matches(str))) {
            return null;
        }
