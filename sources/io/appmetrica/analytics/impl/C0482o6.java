...
public final class C0482o6 extends MessageNano {
    public static final int k = 0;
    public static final int l = 1;
    public static volatile C0482o6[] m;
    public static byte[] n;
    public static volatile boolean o;

    /* renamed from: a  reason: collision with root package name */
    public C0631u6 f968a;
    public C0382k6 b;
    public String c;
    public int d;
    public C0581s6[] e;
    ...
    public final int computeSerializedSize() {
        ...
        C0457n6 c0457n6 = this.g;
        if (c0457n6 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(7, c0457n6);
        }
        ...
        C0432m6[] c0432m6Arr = this.j;
        if (c0432m6Arr != null && c0432m6Arr.length > 0) {
            while (true) {
                C0432m6[] c0432m6Arr2 = this.j;
                if (i2 >= c0432m6Arr2.length) {
                    break;
                }
                C0432m6 c0432m6 = c0432m6Arr2[i2];
                if (c0432m6 != null) {
                    computeSerializedSize = CodedOutputByteBufferNano.computeMessageSize(10, c0432m6) + computeSerializedSize;
                }
                i2++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        C0457n6 c0457n6 = this.g;
        if (c0457n6 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0457n6);
        }
        if (!Arrays.equals(this.h, n)) {
        ...
        if (c0432m6Arr != null && c0432m6Arr.length > 0) {
            while (true) {
                ...
                C0432m6 c0432m6 = c0432m6Arr2[i2];
                if (c0432m6 != null) {
                    codedOutputByteBufferNano.writeMessage(10, c0432m6);
                }
                i2++;
            }
        }
    ...
    public static C0482o6 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0482o6().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0482o6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 10:
                    if (this.f968a == null) {
                        this.f968a = new C0631u6();
                    }
                    codedInputByteBufferNano.readMessage(this.f968a);
                    break;
                case 18:
                    if (this.b == null) {
                        this.b = new C0382k6();
    ...
    public static C0482o6 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0482o6) MessageNano.mergeFrom(new C0482o6(), bArr);
    }
}
