...
public final class C0570s extends MessageNano {
    ...
    public static volatile C0570s[] t;
    ...
    public static C0570s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0570s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0570s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0570s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0570s) MessageNano.mergeFrom(new C0570s(), bArr);
    }
}
