...
public final class C0692x0 implements Va {
    ...
    public final Ll d;
    public final C0633ug e;
    public final Nf f;
    public final C0635ui g;
    public final Gi h;
    public final W7 i;
    public final Uk j;
    public volatile Cc k;
    public final C0343j0 l;
    public boolean m;

    public C0692x0(Context context, Ua ua) {
        this.f1115a = context;
        this.b = ua;
        C0309hf b = C0696x4.l().b(context);
        this.c = b;
        Gd.a();
        C0696x4 l = C0696x4.l();
        l.m().a(new C0273g4(context));
        Nf a2 = AbstractC0717y0.a(context, AbstractC0717y0.a(ua.b(), this));
        this.f = a2;
        W7 j = l.j();
        this.i = j;
        Gi a3 = AbstractC0717y0.a(a2, context, ua.getDefaultExecutor());
        this.h = a3;
        j.a(a3);
        Ll a4 = AbstractC0717y0.a(context, a3, b, ua.b());
        this.d = a4;
        a3.a(a4);
        this.e = AbstractC0717y0.a(a3, b, ua.b());
        this.g = AbstractC0717y0.a(context, a2, a3, ua.b(), a4);
        this.j = l.o();
        this.l = new C0343j0(b);
    }
    ...
    public final InterfaceC0153bb j() {
        Cc cc = this.k;
        Intrinsics.checkNotNull(cc);
        return cc.f373a;
    }

    public final C0635ui k() {
        return this.g;
    }
    ...
    public final void a(AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        C0343j0 c0343j0 = this.l;
        AppMetricaConfig f = c0343j0.f884a.f();
        if (f == null) {
            C0542r0 c0542r0 = c0343j0.b;
            c0542r0.getClass();
            AppMetricaConfig.Builder newConfigBuilder = AppMetricaConfig.newConfigBuilder("629a824d-c717-4ba5-bc0f-3f3968554d01");
            if (c0542r0.f1015a.c() && Intrinsics.areEqual(c0542r0.b.f1090a, Boolean.TRUE)) {
    ...
    public final void a(StartupParamsCallback startupParamsCallback, List<String> list) {
        this.d.a(startupParamsCallback, list, AbstractC0753zb.c(this.f.f554a.getAsString("PROCESS_CFG_CLIDS")));
    }
    ...
    public final boolean a(PublicLogger publicLogger, AppMetricaConfig appMetricaConfig, Pc pc) {
        if (this.k == null) {
            ...
            synchronized (f5) {
                ...
                while (it.hasNext()) {
                    ((InterfaceC0457ne) it.next()).consume(a2);
                }
                f5.b.clear();
            }
            return true;
    ...
    public final void a(AppMetricaConfig appMetricaConfig, PublicLogger publicLogger) {
        ...
        if (((Boolean) WrapUtils.getOrDefault(appMetricaConfig.crashReporting, bool2)).booleanValue()) {
            this.b.d().a(this.f1115a, appMetricaConfig, this);
            this.b.d().b();
        ...
        if (((Boolean) WrapUtils.getOrDefault(appMetricaConfig.sessionsAutoTrackingEnabled, bool2)).booleanValue()) {
            ...
            synchronized (uk) {
                if (uk.g) {
                    uk.f663a.unregisterListener(uk.c, ActivityEvent.RESUMED);
                    uk.f663a.unregisterListener(uk.d, ActivityEvent.PAUSED);
                    uk.g = false;
                }
            }
        }
