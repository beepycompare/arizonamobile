...
public final class C0217e9 extends MessageNano {
    ...
    public static volatile C0217e9[] T = null;
    ...
    public final int computeSerializedSize() {
        int computeUInt32Size = CodedOutputByteBufferNano.computeUInt32Size(3, this.c) + CodedOutputByteBufferNano.computeUInt64Size(2, this.b) + CodedOutputByteBufferNano.computeUInt64Size(1, this.f980a) + super.computeSerializedSize();
        if (!this.d.equals("")) {
        ...
        C0192d9 c0192d9 = this.g;
        if (c0192d9 != null) {
            computeUInt32Size += CodedOutputByteBufferNano.computeMessageSize(7, c0192d9);
        }
        if (!this.h.equals("")) {
        ...
        C0166c9[] c0166c9Arr = this.s;
        if (c0166c9Arr != null && c0166c9Arr.length > 0) {
            int i6 = 0;
            while (true) {
                C0166c9[] c0166c9Arr2 = this.s;
                if (i6 >= c0166c9Arr2.length) {
                    break;
                }
                C0166c9 c0166c9 = c0166c9Arr2[i6];
                if (c0166c9 != null) {
                    computeUInt32Size = CodedOutputByteBufferNano.computeMessageSize(25, c0166c9) + computeUInt32Size;
                }
                i6++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeUInt64(1, this.f980a);
        ...
        C0192d9 c0192d9 = this.g;
        if (c0192d9 != null) {
            codedOutputByteBufferNano.writeMessage(7, c0192d9);
        }
        if (!this.h.equals("")) {
        ...
        if (c0166c9Arr != null && c0166c9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0166c9 c0166c9 = c0166c9Arr2[i6];
                if (c0166c9 != null) {
                    codedOutputByteBufferNano.writeMessage(25, c0166c9);
                }
                i6++;
            }
        }
    ...
    public static C0217e9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0217e9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0217e9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 8:
                    this.f980a = codedInputByteBufferNano.readUInt64();
                    break;
                case 16:
                ...
                case ComposerKt.compositionLocalMapKey /* 202 */:
                    ...
                    C0166c9[] c0166c9Arr = this.s;
                    int length = c0166c9Arr == null ? 0 : c0166c9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0166c9[] c0166c9Arr2 = new C0166c9[i];
                    if (length != 0) {
                        System.arraycopy(c0166c9Arr, 0, c0166c9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0166c9 c0166c9 = new C0166c9();
                        c0166c9Arr2[length] = c0166c9;
                        codedInputByteBufferNano.readMessage(c0166c9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0166c9 c0166c92 = new C0166c9();
                    c0166c9Arr2[length] = c0166c92;
                    codedInputByteBufferNano.readMessage(c0166c92);
                    this.s = c0166c9Arr2;
                    break;
                default:
    ...
    public static C0217e9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0217e9) MessageNano.mergeFrom(new C0217e9(), bArr);
    }
}
