...
public abstract class AbstractC0279gm {
    ...
    public static final Set f901a = SetsKt.setOf((Object[]) new String[]{"appmetrica_clids", StartupParamsCallback.APPMETRICA_DEVICE_ID_HASH, StartupParamsCallback.APPMETRICA_DEVICE_ID, "appmetrica_get_ad_url", "appmetrica_report_ad_url", StartupParamsCallback.APPMETRICA_UUID});
    ...
    */
    public static final boolean a(C0356jm c0356jm, Collection collection, Map map, Function0 function0) {
        boolean a2;
                ...
                switch (str.hashCode()) {
                    case -1367801046:
                        if (!str.equals(StartupParamsCallback.APPMETRICA_UUID)) {
                            ...
                            if (b.currentTimeSeconds() > c0356jm.o + c0356jm.z.f496a) {
                                return false;
                            }
                        } else {
                            a2 = a(c0356jm.d);
                    ...
                    case 530949152:
                        if (str.equals("appmetrica_clids")) {
                            c.getClass();
                            a2 = K3.a(map, c0356jm, (H3) function0.invoke());
                            if (a2) {
                            }
                        } else if (c0356jm.w) {
                        }
