...
public final class Xd implements Consumer {
    ...
    public final void consume(String str) {
        C0488oh c0488oh = this.f738a;
        E0 e0 = this.b;
        String str2 = e0.f415a;
        String str3 = e0.b;
        ...
        D0 d0 = c0278ge.f891a;
        String str4 = d0.c;
        PublicLogger orCreatePublicLogger = LoggerStorage.getOrCreatePublicLogger(d0.f.f415a);
        Set set = W9.f721a;
        Bundle bundle = new Bundle();
        bundle.putString("payload_crash_id", str4);
        C0397l4 c0397l4 = new C0397l4("", "", bb.f364a, orCreatePublicLogger);
        if (str != null) {
            c0397l4.f(str);
        }
        c0397l4.m = bundle;
        c0397l4.c = c0278ge.f891a.f.f;
