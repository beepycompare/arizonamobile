...
public final class C0746z0 implements InterfaceC0172cb {
    ...
    public final void a(AppMetricaLibraryAdapterConfig appMetricaLibraryAdapterConfig) {
        ...
        AppMetricaConfig f = c0393l0.f961a.f();
        if (f == null) {
            C0596t0 c0596t0 = c0393l0.b;
            c0596t0.getClass();
            AppMetricaConfig.Builder newConfigBuilder = AppMetricaConfig.newConfigBuilder("629a824d-c717-4ba5-bc0f-3f3968554d01");
            if (c0596t0.f1088a.b() && Intrinsics.areEqual(c0596t0.b.f388a, Boolean.TRUE)) {
    ...
    public final void a(AppMetricaConfig appMetricaConfig, PublicLogger publicLogger) {
        ...
        if (((Boolean) WrapUtils.getOrDefault(appMetricaConfig.sessionsAutoTrackingEnabled, bool2)).booleanValue()) {
            ...
            synchronized (c0285gl) {
                if (c0285gl.g) {
                    c0285gl.f901a.unregisterListener(c0285gl.c, ActivityEvent.RESUMED);
                    c0285gl.f901a.unregisterListener(c0285gl.d, ActivityEvent.PAUSED);
                    c0285gl.g = false;
                }
            }
        }
