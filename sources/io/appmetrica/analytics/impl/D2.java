...
public abstract class D2 implements ModulePreferences {
    ...
    public final InterfaceC0633ul f541a;

    public D2(InterfaceC0633ul interfaceC0633ul) {
        this.f541a = interfaceC0633ul;
    }
    ...
    public final boolean getBoolean(String str, boolean z) {
        return ((AbstractC0725yd) this.f541a).c(str, z);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final int getInt(String str, int i) {
        return ((AbstractC0725yd) this.f541a).c(str, i);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final long getLong(String str, long j) {
        return ((AbstractC0725yd) this.f541a).c(a(str), j);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final String getString(String str, String str2) {
        return ((AbstractC0725yd) this.f541a).c(a(str), str2);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final void putBoolean(String str, boolean z) {
        AbstractC0725yd abstractC0725yd = (AbstractC0725yd) this.f541a;
