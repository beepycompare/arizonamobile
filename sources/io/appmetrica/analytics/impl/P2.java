...
public abstract class P2 implements ModulePreferences {
    ...
    public final InterfaceC0640ul f588a;

    public P2(InterfaceC0640ul interfaceC0640ul) {
        this.f588a = interfaceC0640ul;
    }
    ...
    public final boolean getBoolean(String str, boolean z) {
        return ((Nd) this.f588a).c(str, z);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final int getInt(String str, int i) {
        return ((Nd) this.f588a).c(str, i);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final long getLong(String str, long j) {
        return ((Nd) this.f588a).c(a(str), j);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final String getString(String str, String str2) {
        return ((Nd) this.f588a).c(a(str), str2);
    }
