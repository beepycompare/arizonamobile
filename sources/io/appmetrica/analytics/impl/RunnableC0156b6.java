...
public final class RunnableC0156b6 implements Runnable {

    /* renamed from: a  reason: collision with root package name */
    public final List f765a;
    public final IHandlerExecutor b = Ga.j().w().a();
    public final WaitForActivationDelayBarrier c = Ga.j().a();

    public RunnableC0156b6(List list) {
        this.f765a = list;
    }

    public static final void a(RunnableC0156b6 runnableC0156b6) {
        for (Runnable runnable : runnableC0156b6.f765a) {
            runnable.run();
        }
    }
    ...
    public final void run() {
        this.c.subscribe(TimeUnit.SECONDS.toMillis(10L), this.b, new ActivationBarrierCallback() { // from class: io.appmetrica.analytics.impl.b6$$ExternalSyntheticLambda0
            ...
            public final void onWaitFinished() {
                RunnableC0156b6.a(RunnableC0156b6.this);
            }
        });
    }
}
