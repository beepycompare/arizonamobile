...
public final class Km extends Rm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Zf("startup_state", iBinaryDataHelper, new T8(c0741ym, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0293gm());
    }
