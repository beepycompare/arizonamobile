...
public final class Km extends Sm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Nf("startup_state", iBinaryDataHelper, new B8(c0731ym, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0304hm());
    }
