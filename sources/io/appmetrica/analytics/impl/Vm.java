...
public final class Vm extends AbstractC0133an {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0332ig("preload_info_data", iBinaryDataHelper, new Y8(cf, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0762zf());
    }
