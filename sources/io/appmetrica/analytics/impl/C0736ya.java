...
public final class C0736ya implements ep {
    public static final C0710xa h = new C0710xa();
    ...
    public C0736ya(Context context, String str, IHandlerExecutor iHandlerExecutor, long j) {
        this.f1294a = context;
        this.b = str;
    ...
    public /* synthetic */ C0736ya(Context context, String str, IHandlerExecutor iHandlerExecutor, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
