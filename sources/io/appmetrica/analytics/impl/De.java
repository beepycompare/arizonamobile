...
public final class De implements InterfaceC0652v8 {

    /* renamed from: a  reason: collision with root package name */
    public final Ge f398a;
    public final F3 b;
    public final Na c;
    public final Wf d;
    ...
    public final List<Qi> fromModel(Ce ce) {
        ...
        Ee ee = ce.b;
        B8 b8 = new B8();
        b8.f354a = StringUtils.getUTF8Bytes(ee.f418a);
        Jn a2 = this.c.a(ee.b);
        b8.b = StringUtils.getUTF8Bytes((String) a2.f512a);
        b8.e = ee.c.size();
        Map<String, String> map = ee.d;
        if (map != null) {
            qi = this.f398a.fromModel(map);
            b8.c = (F8) qi.f613a;
        } else {
            qi = null;
        }
        ...
        int i = 0;
        char c = 1;
        C0672w3 c0672w3 = new C0672w3(C0672w3.b(a2, qi));
        List list = ee.c;
        ArrayList arrayList = new ArrayList();
        this.d.getClass();
        int computeInt32Size = o8.f576a != new O8().f576a ? CodedOutputByteBufferNano.computeInt32Size(1, o8.f576a) : 0;
        N8 n8 = o8.b;
        if (n8 != null) {
        ...
        C0702x8 c0702x8 = o8.e;
        if (c0702x8 != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(5, c0702x8);
        }
        D8 d8 = o8.f;
        if (d8 != null) {
        ...
        while (i3 < list.size()) {
            ...
            c8.b = (C0727y8) fromModel.f613a;
            fromModel.b.getBytesTruncated();
            Qi qi2 = new Qi(c8, fromModel);
            this.d.getClass();
            int computeTagSize = CodedOutputByteBufferNano.computeTagSize(i2);
            int computeMessageSizeNoTag = CodedOutputByteBufferNano.computeMessageSizeNoTag((C8) qi2.f613a);
            ...
            if (arrayList2.size() != 0 && i4 + computeRawVarint32Size > 204800) {
                o82.f.f393a.d = (C8[]) arrayList2.toArray(new C8[arrayList2.size()]);
                ArrayList arrayList3 = new ArrayList();
                arrayList.add(new Qi(o82, c0672w32));
                O8 o83 = new O8();
                o83.f576a = o8.f576a;
                D8 d83 = new D8();
                o83.f = d83;
            ...
            arrayList2.add((C8) qi2.f613a);
            InterfaceC0697x3[] interfaceC0697x3Arr = new InterfaceC0697x3[2];
            interfaceC0697x3Arr[i5] = c0672w32;
            interfaceC0697x3Arr[c2] = qi2.b;
            c0672w32 = new C0672w3(C0672w3.b(interfaceC0697x3Arr));
