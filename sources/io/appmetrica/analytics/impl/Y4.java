...
public final class Y4 extends DatabaseScript {
    ...
    public final C0681w7 x = new C0681w7(null, 1, null);

    public static boolean a(C0655v7 c0655v7) {
        Long l;
        Db db;
        Long l2;
        Long l3;
        Long l4 = c0655v7.f1246a;
        if (l4 == null || l4.longValue() < RealConnection.IDLE_CONNECTION_HEALTHY_NS || c0655v7.b == null || (l = c0655v7.c) == null || l.longValue() < 0 || (db = c0655v7.d) == null || db == Db.EVENT_TYPE_UNDEFINED || (l2 = c0655v7.e) == null || l2.longValue() < 0 || (l3 = c0655v7.f) == null || l3.longValue() < 0) {
            return false;
        }
        Long l5 = c0655v7.g.d;
        if (l5 == null || l5.longValue() >= 0) {
            Integer num = c0655v7.g.i;
    ...
    */
    public final C0655v7 a(Cursor cursor) {
        Al al;
        Integer valueOf;
        EnumC0166c9 enumC0166c9;
        EnumC0166c9 enumC0166c92;
        Integer valueOf2;
        Integer valueOf3;
        G9 g9;
        G9 g92;
        ...
        try {
            ...
            try {
                if (valueOf5 != null && valueOf5.intValue() == 1) {
                    ...
                    enumC0166c9 = EnumC0166c9.NONE;
                    if (valueOf != null) {
                    }
                    enumC0166c9 = EnumC0166c9.AES_VALUE_ENCRYPTION;
                    if (valueOf != null && valueOf.intValue() == 2) {
                        enumC0166c92 = enumC0166c9;
                    ...
                    enumC0166c9 = EnumC0166c9.EXTERNALLY_ENCRYPTED_EVENT_CRYPTER;
            ...
            return new C0655v7(valueOf4, al, valueOf62, a22, valueOf72, valueOf82, new C0629u7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, enumC0166c92, string522222, aa2222222222, g92, valueOf13, valueOf14, columnIndex >= 0 ? null : cursor.getBlob(columnIndex)));
            Integer valueOf142 = Integer.valueOf(i);
            int columnIndex2 = cursor.getColumnIndex(this.v);
            return new C0655v7(valueOf4, al, valueOf62, a22, valueOf72, valueOf82, new C0629u7(valueOf92, string6, string22, valueOf102, null, string32, string42, valueOf112, valueOf122, null, null, enumC0166c92, string522222, aa2222222222, g92, valueOf13, valueOf142, columnIndex2 >= 0 ? null : cursor.getBlob(columnIndex2)));
        } catch (Throwable unused3) {
            return null;
        }
    }
