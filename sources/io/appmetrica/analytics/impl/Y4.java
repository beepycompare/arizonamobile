...
public class Y4 implements Qa, Fa, InterfaceC0376kh {
    ...
    public final void w() {
        ...
        yo yoVar = this.t;
        synchronized (yoVar) {
            optInt = yoVar.f1323a.a().optInt("last_migration_api_level", 0);
        }
    ...
    public final void b(Q5 q5) {
        ...
        synchronized (c0359k0) {
            if (a2.b > xe.d().b) {
                xe.a(a2).b();
                this.m.info("Save new app environment for %s. Value: %s", this.b, a2.f1029a);
            }
        }
    }
    ...
    public Y4(Context context, R4 r4, C0359k0 c0359k0, TimePassedChecker timePassedChecker, C0184d5 c0184d5, C0489p4 c0489p4) {
        ...
        this.j = a6;
        a4.info("Read app environment for component %s. Value: %s", r4.toString(), a5.a().f1029a);
        Kk c = c0184d5.c();
        this.u = c;
