...
public final class C0442n extends W7 implements ActivityLifecycleRegistry {

    /* renamed from: a  reason: collision with root package name */
    public Application f975a;
    public volatile EnumC0417m b = EnumC0417m.d;
    public final Ma c = new Ma(true);

    public final synchronized void a(Context context) {
        if (this.f975a == null) {
            try {
                this.f975a = (Application) context.getApplicationContext();
    ...
    public final synchronized void b() {
        ...
        if (enumC0417m != enumC0417m2 && !this.c.f558a.isEmpty()) {
            if (this.f975a == null) {
                this.b = EnumC0417m.c;
                return;
            }
            this.b = enumC0417m2;
            this.f975a.registerActivityLifecycleCallbacks(this);
        }
    }

    public final synchronized void c() {
        if (this.b == EnumC0417m.b && this.c.f558a.isEmpty()) {
            this.b = EnumC0417m.d;
            Application application = this.f975a;
            if (application != null) {
    ...
    */
    public final synchronized void unregisterListener(ActivityLifecycleListener activityLifecycleListener, ActivityEvent... activityEventArr) {
        ...
        for (ActivityEvent activityEvent : activityEventArr) {
            Ma ma = this.c;
            Collection collection = (Collection) ma.f558a.get(activityEvent);
            if (collection != null && collection.remove(activityLifecycleListener)) {
                if (collection.isEmpty() && ma.b) {
                    ma.f558a.remove(activityEvent);
                }
    ...
    public final void a(Activity activity, ActivityEvent activityEvent) {
        ...
        synchronized (this) {
            collection = (Collection) this.c.f558a.get(activityEvent);
        }
        if (collection != null) {
