...
public final class C0323ig implements InstallReferrerStateListener {
    ...
    public final /* synthetic */ C0349jg f1038a;
    ...
    public final void onInstallReferrerSetupFinished(int i) {
        if (i == 0) {
            final C0349jg c0349jg = this.f1038a;
            ICommonExecutor iCommonExecutor = c0349jg.f1055a;
        ...
        this.f1038a.a(this.b, new IllegalStateException("Referrer check failed with error " + i));
    }
}
