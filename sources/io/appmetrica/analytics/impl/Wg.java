                ...
                if (!TextUtils.isEmpty(e)) {
                    ...
                    if (!CollectionUtils.areCollectionsEqual(hashSet, b)) {
                        ...
                        while (it.hasNext()) {
                            S9 s9 = (S9) it.next();
                            s9.getClass();
                            JSONObject put = new JSONObject().put("name", s9.f773a).put("required", s9.c);
                            int i3 = s9.b;
                            if (i3 != -1) {
