...
public final class Pf implements Converter {
    ...
    public final Ni fromModel(Sf sf) {
        ...
        Ni ni4;
        E8 e8 = new E8();
        Gn a2 = this.e.a(sf.f626a);
        e8.f404a = StringUtils.getUTF8Bytes((String) a2.f449a);
        Gn a3 = this.f.a(sf.b);
        e8.b = StringUtils.getUTF8Bytes((String) a3.f449a);
        List<String> list = sf.c;
        Ni ni5 = null;
        if (list != null) {
            ni = this.c.fromModel(list);
            e8.c = (C0683w8) ni.f556a;
        } else {
            ni = null;
        }
        Map<String, String> map = sf.d;
        if (map != null) {
            ni2 = this.f581a.fromModel(map);
            e8.d = (C8) ni2.f556a;
        } else {
            ni2 = null;
        }
        ...
        return new Ni(e8, new C0678w3(C0678w3.b(a2, a3, ni, ni2, ni3, ni4, ni5)));
    }
