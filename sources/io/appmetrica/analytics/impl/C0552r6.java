...
public final class C0552r6 extends MessageNano {
    public static volatile C0552r6[] d;

    /* renamed from: a  reason: collision with root package name */
    public C0528q6 f1058a;
    public String b;
    public int c;
    ...
    public final int computeSerializedSize() {
        ...
        C0528q6 c0528q6 = this.f1058a;
        if (c0528q6 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(1, c0528q6);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        C0528q6 c0528q6 = this.f1058a;
        if (c0528q6 != null) {
            codedOutputByteBufferNano.writeMessage(1, c0528q6);
        }
        if (!this.b.equals("")) {
    ...
    public final C0552r6 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                if (this.f1058a == null) {
                    this.f1058a = new C0528q6();
                }
                codedInputByteBufferNano.readMessage(this.f1058a);
            } else if (readTag == 18) {
