...
public final class E9 {
    ...
    public final void a(C0242f6 c0242f6, C0749yl c0749yl) {
        ...
        Long valueOf = Long.valueOf(c0749yl.f1299a);
        Al al = c0749yl.d;
        ...
        if (!Q9.g.contains(Db.a(i))) {
            synchronized (apVar) {
                JSONObject a6 = apVar.f893a.a();
                optLong = a6.optLong("global_number", 0L);
                apVar.f893a.a(a6.put("global_number", optLong + 1));
            }
            j = optLong;
        }
        ...
        c0166c7.j.b.submit(fromModel, Eo.f533a.contains(Integer.valueOf(fromModel.getAsInteger("type").intValue())));
        this.h.f1141a.h();
    }
}
