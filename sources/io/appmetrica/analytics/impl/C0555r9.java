...
public final class C0555r9 extends AbstractC0278gg {
    ...
    public final HashMap a(C0448n5 c0448n5) {
        ...
        hashMap.put(Db.EVENT_TYPE_ACTIVATION, new C0287h(this.f1180a, c0448n5.b));
        hashMap.put(Db.EVENT_TYPE_START, new C0284gm(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_REGULAR, new Wg(this.f1180a));
        Kb kb = new Kb(this.f1180a);
        ...
        hashMap.put(Db.EVENT_TYPE_APP_OPEN, new C0202dh(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_PURGE_BUFFER, new C0588sg(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new K6(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new Wf(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new C0752yo(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new Xf(this.f1180a));
        hashMap.put(Db.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new C0726xo(this.f1180a));
        ...
        hashMap.put(Db.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new Z9(this.f1180a));
        return hashMap;
    }
