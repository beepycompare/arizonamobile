...
public final class C0774zl {
    ...
    protected final C0690wf b;
    public Hb c;

    public C0774zl(C0690wf c0690wf, String str) {
        this.b = c0690wf;
        this.f1323a = str;
        Hb hb = new Hb();
        try {
            String h2 = c0690wf.h(str);
    ...
    public final C0774zl a(long j2) {
        a(i, Long.valueOf(j2));
        return this;
    }

    public final C0774zl b(long j2) {
        a(h, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0774zl e(long j2) {
        a(f, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0774zl a(boolean z) {
        a(j, Boolean.valueOf(z));
        return this;
    }

    public final C0774zl b(boolean z) {
        a(k, Boolean.valueOf(z));
        return this;
    }

    public final C0774zl c(long j2) {
        a(e, Long.valueOf(j2));
        return this;
    }

    public final C0774zl d(long j2) {
        a(g, Long.valueOf(j2));
        return this;
    }
    ...
    public final C0774zl f(long j2) {
        a(d, Long.valueOf(j2));
        return this;
    }
