...
public final class C0433mh extends AbstractC0304hh {
    public final SafePackageManager b;

    public C0433mh(C0447n5 c0447n5) {
        this(c0447n5, new SafePackageManager());
    }
    ...
    */
    public final boolean a(C0241f6 c0241f6) {
        ...
        if (c0447n5.t.c() && c0447n5.y()) {
            C0690wf c0690wf = c0447n5.c;
                ...
                if (!TextUtils.isEmpty(e)) {
                    try {
                        ...
                        for (int i = 0; i < jSONArray.length(); i++) {
                            hashSet.add(new C0426ma(jSONArray.getJSONObject(i)));
                        }
                    ...
                    if (!CollectionUtils.areCollectionsEqual(hashSet, b)) {
                        ...
                        while (it.hasNext()) {
                            C0426ma c0426ma = (C0426ma) it.next();
                            c0426ma.getClass();
                            JSONObject put = new JSONObject().put("name", c0426ma.f1096a).put("required", c0426ma.c);
                            int i2 = c0426ma.b;
                            if (i2 != -1) {
                        ...
                        C0241f6 a2 = C0241f6.a(c0241f6, new JSONObject().put("features", jSONArray2).toString());
                        E9 e9 = c0447n5.n;
                        e9.a(a2, C0670vl.a(e9.c.b(a2), a2.i));
                        int i3 = e9.j;
                        e9.l = i3;
                        e9.f527a.a(i3);
                        c0690wf.i(jSONArray2.toString());
                    }
                }
                b = b();
                if (!CollectionUtils.areCollectionsEqual(hashSet, b)) {
    ...
    public final ArrayList b() {
        AbstractC0400la c0374ka;
        FeatureInfo[] featureInfoArr;
        try {
            C0447n5 c0447n5 = this.f1019a;
            SafePackageManager safePackageManager = this.b;
            Context context = c0447n5.f1111a;
            ...
            if (packageInfo != null && (featureInfoArr = packageInfo.reqFeatures) != null) {
                for (FeatureInfo featureInfo : featureInfoArr) {
                    arrayList.add(c0374ka.a(featureInfo));
                }
            }
            return arrayList;
        } catch (Throwable unused) {
    ...
    public C0433mh(C0447n5 c0447n5, SafePackageManager safePackageManager) {
        super(c0447n5);
