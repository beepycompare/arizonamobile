...
public final class C0598te implements Converter {
    ...
    public final Ei fromModel(Map<String, String> map) {
        Nn a2 = this.f1217a.a(map);
        C0418m8 c0418m8 = new C0418m8();
        c0418m8.b = ((C0464o4) a2.b).b;
        Map map2 = (Map) a2.f694a;
        if (map2 != null) {
            c0418m8.f1090a = new C0393l8[map2.size()];
            int i = 0;
            for (Map.Entry entry : map2.entrySet()) {
                c0418m8.f1090a[i] = new C0393l8();
                c0418m8.f1090a[i].f1073a = StringUtils.getUTF8Bytes((String) entry.getKey());
                c0418m8.f1090a[i].b = StringUtils.getUTF8Bytes((String) entry.getValue());
                i++;
            }
        }
        InterfaceC0156c3 interfaceC0156c3 = a2.b;
        int i2 = ((C0464o4) interfaceC0156c3).f892a;
