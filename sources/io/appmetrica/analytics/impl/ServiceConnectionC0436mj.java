...
public final class ServiceConnectionC0436mj implements ServiceConnection {
    ...
    public final void onBindingDied(ComponentName componentName) {
        ...
        this.f1099a.a(new Jg("RuStore service binding died", null, 2, null));
    }

    @Override // android.content.ServiceConnection
    public final void onNullBinding(ComponentName componentName) {
        C0462nj.a(this.c, this);
        this.f1099a.a(new Jg("RuStore service returned null binding", null, 2, null));
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        try {
            ...
            if (a2 == null) {
                C0462nj.a(this.c, this);
                this.f1099a.a(new Jg("RuStore service binder is null", null, 2, null));
                return;
            }
            String packageName = this.c.f1118a.getPackageName();
            ...
            c0739yb.f1293a.transact(1, obtain, obtain2, 0);
            obtain2.readException();
            obtain2.recycle();
            obtain.recycle();
        } catch (Throwable th) {
            C0462nj.a(this.c, this);
            this.f1099a.a(new Jg("Failed to referrer from RuStore service", th));
        }
    }
