...
public final class C0428mf extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1122a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1122a);
        }
        if (!this.b.equals("")) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1122a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1122a);
        }
        if (!this.b.equals("")) {
    ...
    public final C0428mf mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1122a = codedInputByteBufferNano.readString();
            } else if (readTag == 18) {
