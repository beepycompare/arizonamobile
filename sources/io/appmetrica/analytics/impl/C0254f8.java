...
public final class C0254f8 {
    ...
    public final void a(int i) {
        ...
        C0203d8 c0203d8 = this.d;
        String str = c0203d8 == null ? null : c0203d8.c;
    ...
    public final void a() {
        ...
        if (c0203d8 != null) {
            ...
            if (str != null) {
                ...
                if (!io.a(this.d.f813a)) {
                    Map<String, String> map = this.d.f813a;
                    DeferredDeeplinkParametersListener deferredDeeplinkParametersListener = this.c;
                    if (deferredDeeplinkParametersListener != null) {
