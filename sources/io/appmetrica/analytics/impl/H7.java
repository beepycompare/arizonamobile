...
public final class H7 {
    ...
    public final int b;
    public final C0556r9 c;
    public final X8 d;
    public final C0291h0 e;
    public final C0300h9 f;
    public final K7 g;
    public final C0478o6 h;

    public H7(Context context, C0209dl c0209dl, int i, C0556r9 c0556r9, X8 x8, C0291h0 c0291h0, C0300h9 c0300h9, K7 k7) {
        this.f474a = context;
        this.b = i;
        this.c = c0556r9;
        this.d = x8;
    ...
    public final D7 a() {
        ...
        C0556r9 c0556r9 = this.c;
        int i = this.b;
        Do r7 = c0556r9.f1064a.f1080a;
        synchronized (r7) {
        ...
        String str = this.h.c;
        C0291h0 c0291h0 = this.e;
        String str2 = c0291h0.f903a;
        Long valueOf9 = Long.valueOf(c0291h0.b);
        Integer valueOf10 = Integer.valueOf(this.h.g);
        Context context = this.f474a;
        Ve ve = AbstractC0125af.f794a;
        Integer valueOf11 = Integer.valueOf(((Integer) AbstractC0125af.c.a((Ze) SystemServiceUtils.accessSystemServiceSafelyOrDefault((ConnectivityManager) context.getSystemService("connectivity"), "getting connection type", "ConnectivityManager", Ze.UNDEFINED, new Ye()))).intValue());
        String b = b();
        EnumC0274g9 enumC0274g9 = this.d.b;
        C0478o6 c0478o6 = this.h;
        return new D7(valueOf, name, value, valueOf2, i7, str, str2, valueOf9, valueOf10, valueOf11, b, enumC0274g9, c0478o6.h, c0478o6.k, c0478o6.l, c0478o6.n, c0478o6.o, this.f.fromModel(c0478o6.p));
    }

    public /* synthetic */ H7(Context context, C0209dl c0209dl, int i, C0556r9 c0556r9, X8 x8, Gh gh, C0291h0 c0291h0) {
        this(context, c0209dl, i, c0556r9, x8, c0291h0, new C0300h9(), new K7(gh));
    }
}
