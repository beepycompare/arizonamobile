...
public final class H7 {
    ...
    public final D7 a() {
        ...
        int i = this.b;
        Do r7 = c0555r9.f1059a.f1075a;
        synchronized (r7) {
            optJSONObject = r7.f413a.a().optJSONObject("numbers_of_type");
        }
        long optLong = optJSONObject != null ? optJSONObject.optLong(String.valueOf(i)) : 0L;
        c0555r9.f1059a.a(i, 1 + optLong);
        ...
        I7 i7 = new I7(Boolean.valueOf(z), valueOf4, valueOf3, no != null ? Integer.valueOf((int) no.getAltitude()) : null, valueOf7, valueOf6, valueOf8, valueOf5, no != null ? no.getProvider() : null, no != null ? no.f596a : null);
        String str = this.h.c;
        C0290h0 c0290h0 = this.e;
        String str2 = c0290h0.f898a;
