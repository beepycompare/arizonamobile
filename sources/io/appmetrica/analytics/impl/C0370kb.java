...
public final class C0370kb {
    ...
    public C0370kb(String str) throws JSONException {
        ...
        this.f1057a = Base64.decode(jSONObject2.getString("jvm_crash"), 0);
