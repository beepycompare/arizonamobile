...
public final class C0707xm extends MessageNano {
    ...
    public static volatile C0707xm[] G;
    public C0657vm A;
    public C0607tm[] B;
    public C0557rm C;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1204a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1204a);
        }
        ...
        C0533qm[] c0533qmArr = this.h;
        if (c0533qmArr != null && c0533qmArr.length > 0) {
            int i11 = 0;
            while (true) {
                C0533qm[] c0533qmArr2 = this.h;
                if (i11 >= c0533qmArr2.length) {
                    break;
                }
                C0533qm c0533qm = c0533qmArr2[i11];
                if (c0533qm != null) {
                    computeInt64Size += CodedOutputByteBufferNano.computeMessageSize(8, c0533qm);
                }
                i11++;
            }
        }
        C0582sm c0582sm = this.i;
        if (c0582sm != null) {
            computeInt64Size += CodedOutputByteBufferNano.computeMessageSize(9, c0582sm);
        }
        if (!this.j.equals("")) {
        ...
        C0682wm c0682wm = this.p;
        if (c0682wm != null) {
            computeBoolSize += CodedOutputByteBufferNano.computeMessageSize(16, c0682wm);
        }
        boolean z = this.q;
        if (z) {
        ...
        C0632um c0632um = this.v;
        if (c0632um != null) {
            computeInt64Size2 += CodedOutputByteBufferNano.computeMessageSize(24, c0632um);
        }
        ...
        C0508pm c0508pm = this.y;
        if (c0508pm != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(27, c0508pm);
        }
        C0483om c0483om = this.z;
        if (c0483om != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(29, c0483om);
        }
        C0657vm c0657vm = this.A;
        if (c0657vm != null) {
            computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(30, c0657vm);
        }
        C0607tm[] c0607tmArr = this.B;
        if (c0607tmArr != null && c0607tmArr.length > 0) {
            while (true) {
                C0607tm[] c0607tmArr2 = this.B;
                if (i >= c0607tmArr2.length) {
                    break;
                }
                C0607tm c0607tm = c0607tmArr2[i];
                if (c0607tm != null) {
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(31, c0607tm);
                }
                i++;
            }
        }
        C0557rm c0557rm = this.C;
        return c0557rm != null ? CodedOutputByteBufferNano.computeMessageSize(32, c0557rm) + computeInt32Size : computeInt32Size;
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1204a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1204a);
        }
        ...
        if (c0533qmArr != null && c0533qmArr.length > 0) {
            ...
            while (true) {
                C0533qm[] c0533qmArr2 = this.h;
                if (i5 >= c0533qmArr2.length) {
                    break;
                }
                C0533qm c0533qm = c0533qmArr2[i5];
                if (c0533qm != null) {
                    codedOutputByteBufferNano.writeMessage(8, c0533qm);
                }
                i5++;
            }
        }
        C0582sm c0582sm = this.i;
        if (c0582sm != null) {
            codedOutputByteBufferNano.writeMessage(9, c0582sm);
        }
        if (!this.j.equals("")) {
        ...
        C0682wm c0682wm = this.p;
        if (c0682wm != null) {
            codedOutputByteBufferNano.writeMessage(16, c0682wm);
        }
        boolean z = this.q;
        if (z) {
        ...
        C0632um c0632um = this.v;
        if (c0632um != null) {
            codedOutputByteBufferNano.writeMessage(24, c0632um);
        }
        codedOutputByteBufferNano.writeInt32(25, this.w);
        codedOutputByteBufferNano.writeInt32(26, this.x);
        C0508pm c0508pm = this.y;
        if (c0508pm != null) {
            codedOutputByteBufferNano.writeMessage(27, c0508pm);
        }
        C0483om c0483om = this.z;
        if (c0483om != null) {
            codedOutputByteBufferNano.writeMessage(29, c0483om);
        }
        C0657vm c0657vm = this.A;
        if (c0657vm != null) {
            codedOutputByteBufferNano.writeMessage(30, c0657vm);
        }
        C0607tm[] c0607tmArr = this.B;
        if (c0607tmArr != null && c0607tmArr.length > 0) {
            while (true) {
                ...
                C0607tm c0607tm = c0607tmArr2[i];
                if (c0607tm != null) {
                    codedOutputByteBufferNano.writeMessage(31, c0607tm);
                }
                i++;
            }
        }
        C0557rm c0557rm = this.C;
        if (c0557rm != null) {
            codedOutputByteBufferNano.writeMessage(32, c0557rm);
        }
        ...
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1204a = codedInputByteBufferNano.readString();
                    break;
                case 16:
                ...
                case ConstraintLayout.LayoutParams.Table.LAYOUT_WRAP_BEHAVIOR_IN_PARENT /* 66 */:
                    ...
                    C0533qm[] c0533qmArr = this.h;
                    int length4 = c0533qmArr == null ? 0 : c0533qmArr.length;
                    int i4 = repeatedFieldArrayLength4 + length4;
                    C0533qm[] c0533qmArr2 = new C0533qm[i4];
                    if (length4 != 0) {
                        System.arraycopy(c0533qmArr, 0, c0533qmArr2, 0, length4);
                    }
                    while (length4 < i4 - 1) {
                        C0533qm c0533qm = new C0533qm();
                        c0533qmArr2[length4] = c0533qm;
                        codedInputByteBufferNano.readMessage(c0533qm);
                        codedInputByteBufferNano.readTag();
                        length4++;
                    }
                    C0533qm c0533qm2 = new C0533qm();
                    c0533qmArr2[length4] = c0533qm2;
                ...
                case 250:
                    ...
                    C0607tm[] c0607tmArr = this.B;
                    int length6 = c0607tmArr == null ? 0 : c0607tmArr.length;
                    int i6 = repeatedFieldArrayLength6 + length6;
                    C0607tm[] c0607tmArr2 = new C0607tm[i6];
                    if (length6 != 0) {
                        System.arraycopy(c0607tmArr, 0, c0607tmArr2, 0, length6);
                    }
                    while (length6 < i6 - 1) {
                        C0607tm c0607tm = new C0607tm();
                        c0607tmArr2[length6] = c0607tm;
                        codedInputByteBufferNano.readMessage(c0607tm);
                        codedInputByteBufferNano.readTag();
                        length6++;
                    }
                    C0607tm c0607tm2 = new C0607tm();
                    c0607tmArr2[length6] = c0607tm2;
