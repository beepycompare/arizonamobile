...
public final class C0148bf {
    ...
    public final String a(String str) {
        try {
            ...
            File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f907a, "uuid.dat");
    ...
    public final void a() {
        ...
        File fileFromSdkStorage = FileUtils.getFileFromSdkStorage(this.f907a, "uuid.dat");
        if (fileFromSdkStorage == null || fileFromSdkStorage.exists() || (fileFromAppStorage = FileUtils.getFileFromAppStorage(this.f907a, "uuid.dat")) == null || !fileFromAppStorage.exists()) {
            return;
        }
