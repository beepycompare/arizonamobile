...
public final class C0450n extends S7 implements ActivityLifecycleRegistry {

    /* renamed from: a  reason: collision with root package name */
    public Application f947a;
    public volatile EnumC0425m b = EnumC0425m.d;
    public final Ia c = new Ia(true);

    public final synchronized void a(Context context) {
        if (this.f947a == null) {
            try {
                this.f947a = (Application) context.getApplicationContext();
    ...
    public final synchronized void b() {
        EnumC0425m enumC0425m = this.b;
        EnumC0425m enumC0425m2 = EnumC0425m.b;
        if (enumC0425m != enumC0425m2 && !this.c.f473a.isEmpty()) {
            if (this.f947a == null) {
                this.b = EnumC0425m.c;
                return;
            }
            this.b = enumC0425m2;
            this.f947a.registerActivityLifecycleCallbacks(this);
        }
    }

    public final synchronized void c() {
        if (this.b == EnumC0425m.b && this.c.f473a.isEmpty()) {
            this.b = EnumC0425m.d;
            Application application = this.f947a;
            if (application != null) {
    ...
    */
    public final synchronized void unregisterListener(ActivityLifecycleListener activityLifecycleListener, ActivityEvent... activityEventArr) {
        ...
        for (ActivityEvent activityEvent : activityEventArr) {
            Ia ia = this.c;
            Collection collection = (Collection) ia.f473a.get(activityEvent);
            if (collection != null && collection.remove(activityLifecycleListener)) {
                if (collection.isEmpty() && ia.b) {
                    ia.f473a.remove(activityEvent);
                }
    ...
    public final void a(Activity activity, ActivityEvent activityEvent) {
        ...
        synchronized (this) {
            collection = (Collection) this.c.f473a.get(activityEvent);
        }
        if (collection != null) {
