...
public final class C0496p7 implements ProtobufConverter {
    ...
    public final C0471o7 fromModel(C0545r7 c0545r7) {
        ...
        Long l = c0545r7.f1204a;
        if (l != null) {
            c0471o7.f1149a = l.longValue();
        }
        Long l2 = c0545r7.b;
        if (l2 != null) {
        ...
        if (bool != null) {
            c0471o7.c = this.f1171a.fromModel(Boolean.valueOf(bool.booleanValue())).intValue();
        }
        return c0471o7;
    }
    ...
    public final C0545r7 toModel(C0471o7 c0471o7) {
        ...
        Long valueOf = Long.valueOf(c0471o7.f1149a);
        if (valueOf.longValue() == c0471o72.f1149a) {
            valueOf = null;
        }
        Long valueOf2 = Long.valueOf(c0471o7.b);
        return new C0545r7(valueOf, valueOf2.longValue() != c0471o72.b ? valueOf2 : null, this.f1171a.a(c0471o7.c));
    }
}
