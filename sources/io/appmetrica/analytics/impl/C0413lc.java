...
public final class C0413lc implements InterfaceC0339ic, ToggleObserver {
    ...
    public final void a(final LocationControllerObserver locationControllerObserver, final boolean z) {
        this.b.execute(new Runnable() { // from class: io.appmetrica.analytics.impl.lc$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                C0413lc.a(C0413lc.this, locationControllerObserver, z);
            }
        });
    }

    public static final void a(C0413lc c0413lc, LocationControllerObserver locationControllerObserver, boolean z) {
        c0413lc.f920a.add(locationControllerObserver);
        if (z) {
            if (c0413lc.d) {
    ...
    public static final void a(C0413lc c0413lc, boolean z) {
        if (c0413lc.d != z) {
            c0413lc.d = z;
            Function1 function1 = z ? C0363jc.f890a : C0388kc.f904a;
            for (LocationControllerObserver locationControllerObserver : c0413lc.f920a) {
