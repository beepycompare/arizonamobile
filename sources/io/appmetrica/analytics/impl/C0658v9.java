...
public final class C0658v9 extends MessageNano {
    public static volatile C0658v9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        C0632u9[] c0632u9Arr = this.l;
        if (c0632u9Arr != null && c0632u9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0632u9[] c0632u9Arr2 = this.l;
                if (i4 >= c0632u9Arr2.length) {
                    break;
                }
                C0632u9 c0632u9 = c0632u9Arr2[i4];
                if (c0632u9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0632u9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0632u9Arr != null && c0632u9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0632u9 c0632u9 = c0632u9Arr2[i4];
                if (c0632u9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0632u9);
                }
                i4++;
            }
        }
    ...
    public static C0658v9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0658v9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0658v9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 186:
                    ...
                    C0632u9[] c0632u9Arr = this.l;
                    int length = c0632u9Arr == null ? 0 : c0632u9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0632u9[] c0632u9Arr2 = new C0632u9[i];
                    if (length != 0) {
                        System.arraycopy(c0632u9Arr, 0, c0632u9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0632u9 c0632u9 = new C0632u9();
                        c0632u9Arr2[length] = c0632u9;
                        codedInputByteBufferNano.readMessage(c0632u9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0632u9 c0632u92 = new C0632u9();
                    c0632u9Arr2[length] = c0632u92;
                    codedInputByteBufferNano.readMessage(c0632u92);
                    this.l = c0632u9Arr2;
                    break;
    ...
    public static C0658v9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0658v9) MessageNano.mergeFrom(new C0658v9(), bArr);
    }
}
