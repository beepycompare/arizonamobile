...
public final class C0279gj extends MessageNano {
    public static final int f = 0;
    public static final int g = 1;
    public static final int h = 2;
    public static volatile C0279gj[] i;
    ...
    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0279gj mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0279gj b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0279gj().mergeFrom(codedInputByteBufferNano);
    }

    public static C0279gj a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0279gj) MessageNano.mergeFrom(new C0279gj(), bArr);
    }
}
