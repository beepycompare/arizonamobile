...
public final class C0336j implements ActiveNetworkTypeProvider {
    ...
    public final NetworkType getNetworkType(Context context) {
        ...
        return (NetworkType) SystemServiceUtils.accessSystemServiceSafelyOrDefault((ConnectivityManager) context.getSystemService("connectivity"), "getting connection type", "ConnectivityManager", NetworkType.UNDEFINED, new C0275gf());
    }
}
