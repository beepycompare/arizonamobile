...
public abstract class AbstractC0261g implements InterfaceC0583sb {
    ...
    public final C0257fl a() {
        if (this.c.i()) {
            return new C0257fl(this.f987a, this.c, b(), this.f);
        }
        return null;
    }
