...
public enum EnumC0681wb {
    ...
    static {
        EnumC0681wb[] values;
        for (EnumC0681wb enumC0681wb : values()) {
            K.put(Integer.valueOf(enumC0681wb.f1119a), enumC0681wb);
        }
    }

    EnumC0681wb(int i, String str) {
        this.f1119a = i;
        this.b = str;
    }
    ...
    public static EnumC0681wb a(int i) {
        EnumC0681wb enumC0681wb = (EnumC0681wb) K.get(Integer.valueOf(i));
        return enumC0681wb == null ? EVENT_TYPE_UNDEFINED : enumC0681wb;
    }
}
