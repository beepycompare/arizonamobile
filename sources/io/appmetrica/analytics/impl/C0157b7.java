...
public final class C0157b7 implements InterfaceC0131a7 {

    /* renamed from: a  reason: collision with root package name */
    private final Ug f766a;

    public C0157b7(Ug ug) {
        this.f766a = ug;
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0131a7
    public File a(Context context, String str) {
        return new File(context.getNoBackupFilesDir(), this.f766a.a(str));
    }
}
