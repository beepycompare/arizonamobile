...
public final class C0501p7 extends SQLiteOpenHelper implements Closeable {
    ...
    public C0501p7(Context context, String str, Jn jn, PublicLogger publicLogger) {
    ...
    public final SQLiteDatabase getReadableDatabase() {
        try {
            ...
            c0540qk.getClass();
            c0540qk.a(new Pj("db_read_error", th));
            return null;
        }
    }
    ...
    public final SQLiteDatabase getWritableDatabase() {
        try {
            ...
            C0540qk c0540qk = Oj.f708a;
            c0540qk.getClass();
            c0540qk.a(new Pj("db_write_error", th));
            return null;
        }
    }
