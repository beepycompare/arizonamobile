...
public final class Mm extends Rm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Mf("clids_info", iBinaryDataHelper, new A8(c0715y3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new C0590t3());
    }
}
