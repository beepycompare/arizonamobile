...
public final class C0457nm extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1119a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1119a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1119a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1119a);
        }
        C0432mm c0432mm = this.b;
        if (c0432mm != null) {
    ...
    public final C0457nm mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f1119a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
