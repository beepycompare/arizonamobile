...
public final class C0295h5 extends DatabaseScript {
    ...
    public final String f902a = "sessions";
    ...
    public final S7 a(Cursor cursor) {
        try {
            ...
            return new S7(valueOf, enumC0259fl, string, new R7(valueOf2, valueOf3, Boolean.valueOf(z)));
    ...
    */
    public final void runScript(SQLiteDatabase sQLiteDatabase) {
        ...
        try {
            cursor = sQLiteDatabase2.query(this.f902a, null, null, null, null, null, null, String.valueOf(this.b));
            while (cursor.moveToNext()) {
                try {
                    S7 a2 = a(cursor);
                    if (a2 != null && (l = a2.f663a) != null && l.longValue() >= 0 && a2.b != null && (str = a2.c) != null && str.length() != 0 && (l2 = a2.d.f647a) != null && l2.longValue() > 0) {
        ...
        cursor.close();
        sQLiteDatabase2.execSQL("DROP TABLE IF EXISTS " + this.f902a);
