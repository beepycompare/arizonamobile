...
public final class C0448n3 implements InterfaceC0392km {
    ...
    public final C0398l3 i;

    public C0448n3(Context context, Executor executor, Executor executor2, BillingType billingType, BillingInfoStorage billingInfoStorage, BillingInfoSender billingInfoSender) {
        this(context, executor, executor2, billingType, billingInfoStorage, billingInfoSender, Ia.j().d(), new C0398l3());
    }

    public final void a(C0267fm c0267fm, Boolean bool) {
        BillingMonitor c0478o8;
        if (((Boolean) WrapUtils.getOrDefault(bool, Boolean.TRUE)).booleanValue()) {
            synchronized (this) {
                C0398l3 c0398l3 = this.i;
    ...
    public C0448n3(Context context, Executor executor, Executor executor2, BillingType billingType, BillingInfoStorage billingInfoStorage, BillingInfoSender billingInfoSender, ApplicationStateProvider applicationStateProvider, C0398l3 c0398l3) {
        this.b = context;
        this.c = executor;
        this.d = executor2;
        this.e = billingType;
