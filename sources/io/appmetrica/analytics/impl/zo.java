...
public final class zo {
    ...
    public final Ao f1187a;

    public zo(C0433mf c0433mf, Do r3, String str) {
        this.f1187a = new Ao(c0433mf, r3, new Bo() { // from class: io.appmetrica.analytics.impl.zo$$ExternalSyntheticLambda0
    ...
    public static final JSONObject a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        jSONObject3.put("report_request_id", Db.a(jSONObject2, "report_request_id", Db.a(jSONObject, "report_request_id", -1)));
        ...
        jSONObject3.put("open_id", Db.a(jSONObject2, "open_id", Db.a(jSONObject, "open_id", 1)));
        jSONObject3.put("attribution_id", Db.a(jSONObject2, "attribution_id", Db.a(jSONObject, "attribution_id", 1)));
        jSONObject3.put("last_migration_api_level", Db.a(jSONObject2, "last_migration_api_level", Db.a(jSONObject, "last_migration_api_level", 0)));
    ...
    public final synchronized boolean c() {
        return this.f1187a.a().optBoolean("first_event_done", false);
    }

    public final synchronized boolean d() {
        return this.f1187a.a().optBoolean("init_event_done", false);
    }

    public final synchronized int b() {
        return this.f1187a.a().optInt("open_id", 1);
    }
    ...
    public final synchronized int a() {
        return this.f1187a.a().optInt("attribution_id", 1);
    }
