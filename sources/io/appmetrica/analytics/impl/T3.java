...
public final class T3 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        V3 v3 = this.f674a;
        if (v3 != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(1, v3);
        }
        int i = this.b;
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        V3 v3 = this.f674a;
        if (v3 != null) {
            codedOutputByteBufferNano.writeMessage(1, v3);
        }
        int i = this.b;
        if (i != 0) {
    ...
    public final T3 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                codedInputByteBufferNano.readMessage(this.f674a);
            } else if (readTag != 16) {
