...
public abstract class E2 implements ModulePreferences {
    ...
    public final InterfaceC0655vl f550a;

    public E2(InterfaceC0655vl interfaceC0655vl) {
        this.f550a = interfaceC0655vl;
    }
    ...
    public final boolean getBoolean(String str, boolean z) {
        return ((AbstractC0747zd) this.f550a).c(str, z);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final int getInt(String str, int i) {
        return ((AbstractC0747zd) this.f550a).c(str, i);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final long getLong(String str, long j) {
        return ((AbstractC0747zd) this.f550a).c(a(str), j);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final String getString(String str, String str2) {
        return ((AbstractC0747zd) this.f550a).c(a(str), str2);
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.common.ModulePreferences
    public final void putBoolean(String str, boolean z) {
        AbstractC0747zd abstractC0747zd = (AbstractC0747zd) this.f550a;
