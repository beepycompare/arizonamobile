...
public final class C0609t9 extends MessageNano {
    public static volatile C0609t9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f1056a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f1056a);
        }
        if (!this.b.equals("")) {
        ...
        C0584s9[] c0584s9Arr = this.l;
        if (c0584s9Arr != null && c0584s9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0584s9[] c0584s9Arr2 = this.l;
                if (i4 >= c0584s9Arr2.length) {
                    break;
                }
                C0584s9 c0584s9 = c0584s9Arr2[i4];
                if (c0584s9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0584s9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f1056a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f1056a);
        }
        if (!this.b.equals("")) {
        ...
        if (c0584s9Arr != null && c0584s9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0584s9 c0584s9 = c0584s9Arr2[i4];
                if (c0584s9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0584s9);
                }
                i4++;
            }
        }
    ...
    public static C0609t9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0609t9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0609t9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    break;
                case 10:
                    this.f1056a = codedInputByteBufferNano.readString();
                    break;
                case 18:
                ...
                case 186:
                    ...
                    C0584s9[] c0584s9Arr = this.l;
                    int length = c0584s9Arr == null ? 0 : c0584s9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0584s9[] c0584s9Arr2 = new C0584s9[i];
                    if (length != 0) {
                        System.arraycopy(c0584s9Arr, 0, c0584s9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0584s9 c0584s9 = new C0584s9();
                        c0584s9Arr2[length] = c0584s9;
                        codedInputByteBufferNano.readMessage(c0584s9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0584s9 c0584s92 = new C0584s9();
                    c0584s9Arr2[length] = c0584s92;
                    codedInputByteBufferNano.readMessage(c0584s92);
                    this.l = c0584s9Arr2;
                    break;
    ...
    public static C0609t9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0609t9) MessageNano.mergeFrom(new C0609t9(), bArr);
    }
}
