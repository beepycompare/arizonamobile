...
public final class F {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(F.class, obj != null ? obj.getClass() : null)) {
            if (obj != null) {
                F f = (F) obj;
                return this.f435a == f.f435a && this.b == f.b && this.c == f.c;
            }
    ...
    public final String toString() {
        return "CanTrackIdentifiers(canTrackGaid=" + G.a(this.f435a) + ", canTrackHoaid=" + G.a(this.b) + ", canTrackYandexAdvId=" + G.a(this.c) + ')';
    }
}
