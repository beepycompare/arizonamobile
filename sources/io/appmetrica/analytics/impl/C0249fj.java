...
public final class C0249fj implements SdkEnvironmentProvider {
        ...
        if (screenInfo != null) {
            if (!Intrinsics.areEqual(screenInfo, getSdkEnvironment().getScreenInfo())) {
                ...
                if (str == null) {
                    ...
                    SafePackageManager safePackageManager = O7.f716a;
                    try {
                ...
                while (it.hasNext()) {
                    ((AbstractC0490p5) ((InterfaceC0223ej) it.next())).d();
                }
            }
        }
    }

    public final void b(InterfaceC0223ej interfaceC0223ej) {
        this.c.remove(interfaceC0223ej);
    }
    ...
    public final void a(InterfaceC0223ej interfaceC0223ej) {
        this.c.add(interfaceC0223ej);
    }
}
