...
public final class Ri extends C0594sn {
    ...
    public final void f() {
        this.b.a();
        Gh gh = (Gh) ((C0651v5) this.f1086a).k.a();
        if (gh.k.a(gh.j)) {
            String str = gh.m;
            ...
            try {
                a(C0536qe.a((C0651v5) this.f1086a));
    ...
    public final void h() {
        ...
        this.e.remove(this.d);
        if (((Gh) ((C0651v5) this.f1086a).k.a()).g > 0) {
            this.e.executeDelayed(this.d, TimeUnit.SECONDS.toMillis(((Gh) ((C0651v5) this.f1086a).k.a()).g));
        }
    }
}
