...
public final class C0123am extends BaseRequestConfig.BaseRequestArguments {
    ...
    public final C0123am mergeFrom(C0123am c0123am) {
        return new C0123am((String) WrapUtils.getOrDefaultNullable(this.f902a, c0123am.f902a), (String) WrapUtils.getOrDefaultNullable(this.b, c0123am.b), (Map) WrapUtils.getOrDefaultNullable(this.c, c0123am.c), this.d || c0123am.d, c0123am.d ? c0123am.e : this.e);
    }
    ...
    public final String toString() {
        return "Arguments{distributionReferrer='" + this.f902a + "', installReferrerSource='" + this.b + "', clientClids=" + this.c + ", hasNewCustomHosts=" + this.d + ", newCustomHosts=" + this.e + AbstractJsonLexerKt.END_OBJ;
    }
