...
public final class Y8 extends Gf {
    ...
    public final HashMap a() {
        ...
        hashMap.put(EnumC0164cb.EVENT_TYPE_ACTIVATION, new C0281h(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_START, new Fl(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_REGULAR, new Hg(this.f845a));
        C0344jb c0344jb = new C0344jb(this.f845a);
        ...
        C0577si c0577si = this.f845a;
        hashMap.put(enumC0164cb, new Al(c0577si, c0577si.t));
        hashMap.put(EnumC0164cb.EVENT_TYPE_APP_OPEN, new Og(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_PURGE_BUFFER, new Sf(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_CURRENT_SESSION_NATIVE_CRASH_PROTOBUF, new C0590t6(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_PREV_SESSION_NATIVE_CRASH_PROTOBUF, new C0674wf(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_EXCEPTION_UNHANDLED_FROM_FILE, new Wn(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_PREV_SESSION_EXCEPTION_UNHANDLED_FROM_FILE, new C0699xf(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_EXCEPTION_UNHANDLED_PROTOBUF, new Vn(this.f845a));
        hashMap.put(EnumC0164cb.EVENT_TYPE_ANR, c0344jb);
        EnumC0164cb enumC0164cb2 = EnumC0164cb.EVENT_TYPE_APP_ENVIRONMENT_UPDATED;
        C0577si c0577si2 = this.f845a;
        ...
        hashMap.put(EnumC0164cb.EVENT_CLIENT_EXTERNAL_ATTRIBUTION, new F9(this.f845a));
        return hashMap;
    }
