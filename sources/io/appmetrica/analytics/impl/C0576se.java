...
public final class C0576se implements Converter {
    ...
    public final Di fromModel(Map<String, String> map) {
        Mn a2 = this.f1227a.a(map);
        C0396l8 c0396l8 = new C0396l8();
        c0396l8.b = ((C0442n4) a2.b).b;
        Map map2 = (Map) a2.f704a;
        if (map2 != null) {
            c0396l8.f1099a = new C0371k8[map2.size()];
            int i = 0;
            for (Map.Entry entry : map2.entrySet()) {
                c0396l8.f1099a[i] = new C0371k8();
                c0396l8.f1099a[i].f1083a = StringUtils.getUTF8Bytes((String) entry.getKey());
                c0396l8.f1099a[i].b = StringUtils.getUTF8Bytes((String) entry.getValue());
                i++;
            }
        }
        InterfaceC0134b3 interfaceC0134b3 = a2.b;
        int i2 = ((C0442n4) interfaceC0134b3).f901a;
