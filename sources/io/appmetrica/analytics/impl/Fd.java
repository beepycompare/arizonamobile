...
public final class Fd implements Converter {
    ...
    public final Map<String, Object> toModel(C0616tm[] c0616tmArr) {
        ...
        for (C0616tm c0616tm : c0616tmArr) {
            C0607td c0607td = c.get(c0616tm.f1071a);
            Pair pair = c0607td != null ? TuplesKt.to(c0616tm.f1071a, c0607td.c.toModel(c0616tm.b)) : null;
            if (pair != null) {
                arrayList.add(pair);
            }
        }
