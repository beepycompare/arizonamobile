...
public final class C0576s6 extends C0251fh {
    ...
    public /* synthetic */ C0576s6(Context context, C0544r0 c0544r0, El el, Ph ph, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, c0544r0, el, ph, (i & 16) != 0 ? false : z);
    }
    ...
    public C0576s6(Context context, C0544r0 c0544r0, El el, Ph ph, boolean z) {
        super(c0544r0, el, ph);
        this.f = context;
        this.g = ph;
        this.h = z;
