...
public final class C0656va implements Parcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0656va) {
            ...
            return Intrinsics.areEqual(this.f1119a, c0656va.f1119a) && this.b == c0656va.b && Intrinsics.areEqual(this.c, c0656va.c);
        }
        return false;
    }

    public final int hashCode() {
        Boolean bool = this.f1119a;
    ...
    public final String toString() {
        return "FeaturesInternal(sslPinning=" + this.f1119a + ", status=" + this.b + ", errorExplanation=" + this.c + ')';
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeValue(this.f1119a);
