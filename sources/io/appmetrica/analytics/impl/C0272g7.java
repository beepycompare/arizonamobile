...
public final class C0272g7 {

    /* renamed from: a  reason: collision with root package name */
    public final CounterConfigurationReporterType f891a;
    public final Ij b;

    public C0272g7(CounterConfigurationReporterType counterConfigurationReporterType) {
    ...
    */
    public final C0220e7 a(SQLiteDatabase sQLiteDatabase, String str, int i, String str2, boolean z) {
        Cursor cursor;
        ...
        if (cursor != null) {
            try {
                ...
                try {
                    ...
                    c0414lk.getClass();
                    c0414lk.a(new Lj("select_rows_to_delete_exception", th));
                    ro.a(cursor);
                    arrayList = null;
                    int i2 = sQLiteDatabase.delete("events", str, null);
                    if (arrayList != null) {
                    }
                    return new C0220e7(arrayList, i2);
                } finally {
                    ro.a(cursor);
                }
            }
                        ...
                        for (ContentValues contentValues2 : arrayList) {
                            ...
                            if (asInteger != null && asInteger2 != null) {
                                ...
                                if (a2 == null) {
                                    ...
                                    num = (Integer) AbstractC0410lg.c.get(a2);
                                }
                                jSONArray2.put(num);
                            }
                        }
                        jSONObject.put("global_number", jSONArray).put("event_type", jSONArray2);
                        JSONObject put = new JSONObject().put("details", new JSONObject().put("reason", AbstractC0246f7.a(i)).put("cleared", jSONObject).put("actual_deleted_number", i22));
                        PublicLogger orCreatePublicLogger = LoggerStorage.getOrCreatePublicLogger(str2);
                        String jSONObject2 = put.toString();
                        Set set = W9.f726a;
                        Bb bb = Bb.EVENT_TYPE_UNDEFINED;
                        c0398l4 = new C0398l4(jSONObject2, "", 12290, 0, orCreatePublicLogger);
                    } catch (Throwable unused) {
                        c0398l4 = null;
                    }
                    if (c0398l4 != null && gj.c != null) {
                        try {
                            CounterConfiguration counterConfiguration = new CounterConfiguration(gj.f463a);
                            counterConfiguration.setReporterType(gj.c);
                            gj.d.f522a.reportData(1, c0398l4.d(new C0154bi(new Vf(gj.b, (ResultReceiver) null), counterConfiguration, new C0145b9(new Al(LoggerStorage.getOrCreatePublicLogger(gj.f463a), "Crash Environment")), null).c()));
                        } catch (Throwable unused2) {
                        }
                    }
                }
                return new C0220e7(arrayList, i22);
            }
        }
        arrayList = null;
        ...
        return new C0220e7(arrayList, i222);
    }

    public C0272g7(CounterConfigurationReporterType counterConfigurationReporterType, Ij ij) {
