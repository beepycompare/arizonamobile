...
public final class C0769zf extends Yd implements ep {
    ...
    public final Boolean d() {
        C0743yf c0743yf = g;
        if (this.f1281a.a(c0743yf.b)) {
            return Boolean.valueOf(this.f1281a.getBoolean(c0743yf.b, true));
        }
        return null;
    }
    ...
    public final int a(EnumC0638ue enumC0638ue, int i2) {
        ...
        return this.f1281a.getInt(c0743yf.b, i2);
    }
    ...
    public final long a(EnumC0638ue enumC0638ue, long j2) {
        ...
        return this.f1281a.getLong(c0743yf.b, j2);
    }
}
