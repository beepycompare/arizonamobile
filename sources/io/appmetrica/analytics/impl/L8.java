...
public final class L8 extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f650a.equals("")) {
            computeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f650a);
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f650a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f650a);
        }
    ...
    public final L8 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f650a = codedInputByteBufferNano.readString();
            } else if (readTag != 18) {
