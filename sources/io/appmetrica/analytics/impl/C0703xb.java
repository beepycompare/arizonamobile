...
public final class C0703xb implements InternalClientModuleFacade {

    /* renamed from: a  reason: collision with root package name */
    public final C0406ld f1139a = new C0406ld();
    ...
    public final void reportAdRevenue(ModuleAdRevenue moduleAdRevenue) {
        ...
        ModuleAdType.values();
        switch (adType2 == null ? -1 : AbstractC0380kd.f936a[adType2.ordinal()]) {
            case -1:
                adType = null;
                break;
            case 0:
    ...
    public final void reportEvent(InternalModuleEvent internalModuleEvent) {
        ...
        if (category2 != null) {
            int i = AbstractC0678wb.f1120a[category2.ordinal()];
            if (i != 1) {
