...
public final class Sk {
    ...
    public Sk(JSONObject jSONObject) {
        this.f786a = jSONObject.optString("analyticsSdkVersionName", "");
    ...
    public final String toString() {
        return "SessionRequestParams(kitVersionName='" + this.f786a + "', kitBuildNumber='" + this.b + "', appVersion='" + this.c + "', appBuild='" + this.d + "', osVersion='" + this.e + "', apiLevel=" + this.f + ", attributionId=" + this.g + ')';
    }
}
