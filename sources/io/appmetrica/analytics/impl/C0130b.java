...
public final class C0130b implements InterfaceC0114a9 {

    /* renamed from: a  reason: collision with root package name */
    public final AESEncrypter f897a;

    public C0130b() {
        this(new C0104a(Na.k().g()));
    }
    ...
    public final S8 a(C0240f6 c0240f6) {
        ...
        if (!TextUtils.isEmpty(value)) {
            ...
            if (encrypt != null) {
                ...
                c0240f6.setValue(encodeToString);
                return new S8(c0240f6, EnumC0166c9.AES_VALUE_ENCRYPTION);
            }
        }
        encodeToString = null;
        c0240f6.setValue(encodeToString);
    ...
    public final EnumC0166c9 a() {
        return EnumC0166c9.AES_VALUE_ENCRYPTION;
    }
}
