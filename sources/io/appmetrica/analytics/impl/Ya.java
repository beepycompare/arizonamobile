...
public final class Ya implements Parcelable {
    ...
    public final ResultReceiver f763a;
    public final List b;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        bundle.putParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver", this.f763a);
        if (this.b != null) {
    ...
    public Ya(Parcel parcel) {
        ...
        if (readBundle != null) {
            this.f763a = (ResultReceiver) readBundle.getParcelable("io.appmetrica.analytics.internal.CounterConfiguration.receiver");
