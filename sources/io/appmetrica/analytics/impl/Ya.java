...
public final class Ya extends P2 {
    ...
    public final C0517po a(Map<String, String> map) {
        HashMap hashMap;
        int i;
        int i2 = 0;
        if (map != null) {
            ...
            while (i2 < length) {
                ...
                C0517po a2 = this.b.a((String) entry.getKey());
                C0517po a3 = this.c.a((String) entry.getValue());
        ...
        return new C0517po(hashMap, new E4(i2, i));
    }
}
