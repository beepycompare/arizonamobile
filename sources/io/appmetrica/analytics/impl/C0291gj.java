...
public final class C0291gj implements InterfaceC0316hj {
    ...
    public C0291gj(Context context) {
        this.f868a = context;
    }
    ...
    public final N3 invoke() {
        ...
        if (!PackageManagerUtils.hasContentProvider(this.f868a, "com.yandex.preinstallsatellite.appmetrica.provider")) {
            AbstractC0589sj.a("Satellite content provider with clids was not found.", new Object[0]);
            return null;
        }
        try {
            ...
            while (cursor.moveToNext()) {
                try {
                    ...
                    if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                        ...
                        AbstractC0589sj.a("Invalid clid {%s : %s}", string, string2);
                    }
                } catch (Throwable unused) {
                }
            }
            AbstractC0589sj.a("Clids from satellite: %s", linkedHashMap);
            return new N3(linkedHashMap, EnumC0404l8.d);
        }
