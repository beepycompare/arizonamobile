...
public final class C0519pn implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final T6 f1008a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0519pn(T6 t6, String str) {
        this.f1008a = t6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0568rn = new C0568rn(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0568rn = null;
                            }
                            if (c0568rn != null) {
                                arrayList.add(c0568rn);
                            }
