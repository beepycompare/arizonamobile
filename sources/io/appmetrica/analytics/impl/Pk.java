...
public final class Pk extends AbstractC0378kd {
    ...
    public final void a(int i) {
        ...
        synchronized (zo) {
            ...
            if (a2.optInt("last_migration_api_level", -1) != i) {
                zo.f875a.a(a2.put("last_migration_api_level", i));
            }
            bp bpVar = zo.f875a;
            bp.a(bpVar.f913a);
            bp.a(bpVar.b);
    ...
    public final int b() {
        ...
        Zo zo = this.f719a;
        synchronized (zo) {
            optInt = zo.f875a.a().optInt("last_migration_api_level", -1);
        }
        return optInt;
    }
    ...
    public final SparseArray<InterfaceC0352jd> c() {
        ...
        sparseArray.put(112, new Qk(this.f719a));
