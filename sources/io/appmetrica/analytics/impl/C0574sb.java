...
public final class C0574sb implements Ha, Closeable {

    /* renamed from: a  reason: collision with root package name */
    public final HashMap f1221a = new HashMap();
    public final HashMap b = new HashMap();
    public final String c = "preferences";
    public final C0549rb d;
    public volatile boolean e;
    public final InterfaceC0719y6 f;

    public C0574sb(InterfaceC0719y6 interfaceC0719y6) {
        this.f = interfaceC0719y6;
        C0549rb c0549rb = new C0549rb(this, String.format(Locale.US, "IAA-DW-%s", Integer.valueOf(ThreadFactoryC0751zd.a())));
        this.d = c0549rb;
        c0549rb.start();
    }
    ...
    */
    public static void a(C0574sb c0574sb) {
        SQLiteDatabase sQLiteDatabase;
        String str;
        c0574sb.getClass();
        Cursor cursor = null;
        try {
            sQLiteDatabase = c0574sb.f.a();
            if (sQLiteDatabase != null) {
                try {
                    Cursor query = sQLiteDatabase.query(c0574sb.c, new String[]{"key", "value", "type"}, null, null, null, null, null);
    ...
    public final Object b(String str) {
        ...
        synchronized (this.f1221a) {
            c();
            obj = this.f1221a.get(str);
        }
        return obj;
    }

    public static void a(C0574sb c0574sb, HashMap hashMap) {
        SQLiteDatabase sQLiteDatabase;
        c0574sb.getClass();
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabase.delete(c0574sb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabase.insertWithOnConflict(c0574sb.c, null, contentValues2, 5);
                        }
                    }
    ...
    @Override // io.appmetrica.analytics.impl.Ha
    public final synchronized Ha a(int i, String str) {
    ...
    public final boolean a(String str) {
        ...
        synchronized (this.f1221a) {
            c();
            containsKey = this.f1221a.containsKey(str);
        }
        return containsKey;
    }
    ...
    public final Set a() {
        HashSet hashSet;
        synchronized (this.f1221a) {
            hashSet = new HashSet(this.f1221a.keySet());
        }
        return hashSet;
    }
