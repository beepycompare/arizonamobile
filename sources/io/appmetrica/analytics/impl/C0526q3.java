...
public final class C0526q3 implements InterfaceC0619tm {
    ...
    public final C0475o3 i;

    public C0526q3(Context context, Executor executor, Executor executor2, BillingType billingType, BillingInfoStorage billingInfoStorage, BillingInfoSender billingInfoSender) {
        this(context, executor, executor2, billingType, billingInfoStorage, billingInfoSender, Na.j().d(), new C0475o3());
    }

    public final void a(C0494om c0494om, Boolean bool) {
        BillingMonitor billingLibraryMonitor;
        BillingMonitor billingMonitor;
        if (((Boolean) WrapUtils.getOrDefault(bool, Boolean.TRUE)).booleanValue()) {
            synchronized (this) {
                C0475o3 c0475o3 = this.i;
                ...
                c0475o3.getClass();
                int i = AbstractC0449n3.f1002a[billingType.ordinal()];
                if (i == 1) {
            ...
            billingMonitor.onBillingConfigChanged(c0494om.x);
            if (this.h.registerStickyObserver(new C0501p3(this)) == ApplicationState.VISIBLE) {
                try {
    ...
    public C0526q3(Context context, Executor executor, Executor executor2, BillingType billingType, BillingInfoStorage billingInfoStorage, BillingInfoSender billingInfoSender, ApplicationStateProvider applicationStateProvider, C0475o3 c0475o3) {
        this.b = context;
        this.c = executor;
        this.d = executor2;
        this.e = billingType;
