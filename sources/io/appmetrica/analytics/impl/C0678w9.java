...
public final class C0678w9 extends MessageNano {
    public static volatile C0678w9[] n;
    ...
    public final int computeSerializedSize() {
        ...
        C0653v9[] c0653v9Arr = this.l;
        if (c0653v9Arr != null && c0653v9Arr.length > 0) {
            int i4 = 0;
            while (true) {
                C0653v9[] c0653v9Arr2 = this.l;
                if (i4 >= c0653v9Arr2.length) {
                    break;
                }
                C0653v9 c0653v9 = c0653v9Arr2[i4];
                if (c0653v9 != null) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(23, c0653v9);
                }
                i4++;
            }
        }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (c0653v9Arr != null && c0653v9Arr.length > 0) {
            ...
            while (true) {
                ...
                C0653v9 c0653v9 = c0653v9Arr2[i4];
                if (c0653v9 != null) {
                    codedOutputByteBufferNano.writeMessage(23, c0653v9);
                }
                i4++;
            }
        }
    ...
    public static C0678w9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0678w9().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0678w9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            switch (readTag) {
                ...
                case 186:
                    ...
                    C0653v9[] c0653v9Arr = this.l;
                    int length = c0653v9Arr == null ? 0 : c0653v9Arr.length;
                    int i = repeatedFieldArrayLength + length;
                    C0653v9[] c0653v9Arr2 = new C0653v9[i];
                    if (length != 0) {
                        System.arraycopy(c0653v9Arr, 0, c0653v9Arr2, 0, length);
                    }
                    while (length < i - 1) {
                        C0653v9 c0653v9 = new C0653v9();
                        c0653v9Arr2[length] = c0653v9;
                        codedInputByteBufferNano.readMessage(c0653v9);
                        codedInputByteBufferNano.readTag();
                        length++;
                    }
                    C0653v9 c0653v92 = new C0653v9();
                    c0653v9Arr2[length] = c0653v92;
                    codedInputByteBufferNano.readMessage(c0653v92);
                    this.l = c0653v9Arr2;
                    break;
    ...
    public static C0678w9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0678w9) MessageNano.mergeFrom(new C0678w9(), bArr);
    }
}
