...
public final class Df implements InterfaceC0542qj {
    ...
    public final Kf invoke() {
        ...
        if (!PackageManagerUtils.hasContentProvider(this.f411a, "com.yandex.preinstallsatellite.appmetrica.provider")) {
            Bj.a("Satellite content provider with preload info was not found.", new Object[0]);
            return null;
        }
        try {
            cursor = this.f411a.getContentResolver().query(Uri.parse(this.b), null, null, null, null);
            try {
                if (cursor != null) {
                    if (cursor.moveToFirst()) {
                        ...
                        if (string2 != null && string2.length() != 0) {
                            ...
                            Kf kf = new Kf(string, jSONObject2, !TextUtils.isEmpty(string), false, EnumC0531q8.d);
                            ro.a(cursor);
                            return kf;
                        }
                        ...
                        Kf kf2 = new Kf(string, jSONObject22, !TextUtils.isEmpty(string), false, EnumC0531q8.d);
                        ro.a(cursor);
                        return kf2;
                    }
