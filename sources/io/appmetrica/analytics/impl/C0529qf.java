...
public final class C0529qf implements T7 {
    ...
    public final JSONObject b() {
        if (this.c) {
            ...
            try {
                jSONObject.put("trackingId", this.f1190a);
                if (this.b.length() > 0) {
    ...
    public final JSONObject c() {
        ...
        try {
            ...
            jSONObject.put("source", this.e.f779a);
        } catch (Throwable unused) {
        }
        return jSONObject;
    }
    ...
    public final String toString() {
        return "PreloadInfoState{trackingId='" + this.f1190a + "', additionalParameters=" + this.b + ", wasSet=" + this.c + ", autoTrackingEnabled=" + this.d + ", source=" + this.e + AbstractJsonLexerKt.END_OBJ;
    }
    ...
    public static C0529qf a(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            s7 = values[i];
            if (Intrinsics.areEqual(s7.f779a, optStringOrNull2)) {
                break;
            }
            i++;
        }
