...
public final class C0569s extends MessageNano {
    ...
    public static volatile C0569s[] t;
    ...
    public static C0569s b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0569s().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0569s mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0569s a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0569s) MessageNano.mergeFrom(new C0569s(), bArr);
    }
}
