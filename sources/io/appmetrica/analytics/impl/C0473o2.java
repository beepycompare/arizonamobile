...
public final class C0473o2 implements Bk, ApplicationStateProvider {

    /* renamed from: a  reason: collision with root package name */
    public final HashSet f1015a = new HashSet();
    public final HashSet b = new HashSet();
    public volatile ApplicationState c = ApplicationState.UNKNOWN;
    public final CopyOnWriteArraySet d = new CopyOnWriteArraySet();

    public final void a(int i) {
        this.f1015a.remove(Integer.valueOf(i));
        a();
    }
    ...
    public final void c(int i) {
        this.f1015a.add(Integer.valueOf(i));
