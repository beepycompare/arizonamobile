...
public final class C0414ln extends AbstractC0621tn {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C0459ng("startup_state", iBinaryDataHelper, new T8(zm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArr, bArr2)), new Im());
    }
