...
public final class Wf extends MessageNano {
    ...
    public final Wf a() {
        this.f838a = WireFormatNano.EMPTY_BYTES;
        this.b = 0L;
        this.c = 0L;
        this.d = 0;
        this.cachedSize = -1;
    ...
    public final int computeSerializedSize() {
        int computeBytesSize = CodedOutputByteBufferNano.computeBytesSize(1, this.f838a) + super.computeSerializedSize();
        long j = this.b;
        if (j != 0) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        codedOutputByteBufferNano.writeBytes(1, this.f838a);
        long j = this.b;
        if (j != 0) {
    ...
    public final Wf mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f838a = codedInputByteBufferNano.readBytes();
            } else if (readTag == 16) {
