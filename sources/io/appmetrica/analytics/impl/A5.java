...
public class A5 {
    ...
    public A5(Context context, C0476o5 c0476o5, M4 m4, AbstractC0601t5 abstractC0601t5, C0493om c0493om, Dh dh, ICommonExecutor iCommonExecutor, int i, C0250fc c0250fc, S9 s9) {
        this(context, c0476o5, m4, abstractC0601t5, c0493om, dh, iCommonExecutor, new C0247f9(), i, new C0726y5(m4.f571a), new C0751z5(context, c0476o5), c0250fc, s9);
    }
    ...
    public final Do f() {
        ...
        synchronized (B) {
            ...
            if (obj == null) {
                C0537qf c0537qf = new C0537qf(C0728y7.a(B.f466a).b(c0476o5));
                if (c0476o5.d()) {
                    ...
                    ba = new Ba(B.f466a, "appmetrica_vital_" + c0476o5.b + ".dat");
                }
