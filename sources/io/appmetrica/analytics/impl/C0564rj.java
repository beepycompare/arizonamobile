...
public final class C0564rj implements SdkEnvironmentProvider {

    /* renamed from: a  reason: collision with root package name */
    public final Context f1039a;
    public final C0207dc b = new C0207dc();
    public final CopyOnWriteArrayList c = new CopyOnWriteArrayList();
    public SdkEnvironment d;
    public String e;

    public C0564rj(Context context) {
        this.f1039a = context;
        this.d = new SdkEnvironment(new AppVersionInfo(PackageManagerUtils.getAppVersionName(context), PackageManagerUtils.getAppVersionCodeString(context)), FrameworkDetector.framework(), new ScreenInfo(0, 0, 0, 0.0f), new SdkInfo("7.10.0", "50135769", AbstractC0589sj.a()), "phone", C0207dc.a(context.getResources().getConfiguration()));
    }
    ...
    public final synchronized void a(ScreenInfo screenInfo) {
        ...
        if (screenInfo != null) {
            if (!Intrinsics.areEqual(screenInfo, getSdkEnvironment().getScreenInfo())) {
                ...
                while (it.hasNext()) {
                    ((J5) ((InterfaceC0540qj) it.next())).d();
                }
            }
        }
    }

    public final void b(InterfaceC0540qj interfaceC0540qj) {
        this.c.remove(interfaceC0540qj);
    }
    ...
    public final synchronized void a(Configuration configuration) {
        this.b.getClass();
        List a2 = C0207dc.a(configuration);
    ...
    public final void a(InterfaceC0540qj interfaceC0540qj) {
        this.c.add(interfaceC0540qj);
    }
}
