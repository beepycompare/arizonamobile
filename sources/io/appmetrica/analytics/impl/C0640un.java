...
public final class C0640un implements TempCacheStorage {

    /* renamed from: a  reason: collision with root package name */
    public final U6 f1094a;
    public final String b;
    public final SystemTimeProvider c = new SystemTimeProvider();

    public C0640un(U6 u6, String str) {
        this.f1094a = u6;
        this.b = str;
    }
            ...
            try {
                ...
                if (cursor != null) {
                    while (cursor.moveToNext()) {
                        try {
                            try {
                                c0690wn = new C0690wn(cursor.getLong(cursor.getColumnIndexOrThrow("id")), cursor.getString(cursor.getColumnIndexOrThrow("scope")), cursor.getLong(cursor.getColumnIndexOrThrow("timestamp")), cursor.getBlob(cursor.getColumnIndexOrThrow("data")));
                            } catch (Throwable unused2) {
                                c0690wn = null;
                            }
                            if (c0690wn != null) {
                                arrayList.add(c0690wn);
                            }
