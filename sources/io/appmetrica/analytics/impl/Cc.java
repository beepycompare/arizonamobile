...
public final class Cc extends V2 implements InterfaceC0205db {
    ...
    public Cc(Nc nc) {
        ...
        this.p = new Bn(new C0484oe("Referral url"));
        this.q = nc;
        this.r = new Dc(this);
        l();
    }
    ...
    public final void a(String str, boolean z) {
        ...
        C0325i4 c0325i4 = new C0325i4(b, "", 8208, 0, publicLogger);
        Sh sh = this.b;
        ji.getClass();
    ...
    public final void l() {
        Ji ji = this.h;
        ji.c.a(this.b.f812a);
        C0372k2 c0372k2 = this.q.g;
        Bc bc = new Bc(this);
        long longValue = s.longValue();
        synchronized (c0372k2) {
            c0372k2.a(bc, longValue);
        }
    }
    ...
    public final void a(EnumC0419m enumC0419m) {
        if (enumC0419m == EnumC0419m.b) {
            ...
            this.c.warning("Could not enable activity auto tracking. " + enumC0419m.f945a, new Object[0]);
        }
    }

    @Override // io.appmetrica.analytics.impl.InterfaceC0205db
    public final void b(Activity activity) {
        if (this.q.i.a(activity, EnumC0469o.PAUSED)) {
            this.c.info("Pause session", new Object[0]);
            c(activity != null ? activity.getClass().getSimpleName() : null);
            C0372k2 c0372k2 = this.q.g;
            synchronized (c0372k2) {
                c0372k2.getClass();
                for (C0347j2 c0347j2 : c0372k2.f922a) {
                    if (!c0347j2.d) {
                        c0347j2.d = true;
                        c0347j2.b.executeDelayed(c0347j2.e, c0347j2.c);
                    }
                }
            }
        }
    ...
    public final void a(Activity activity) {
        if (this.q.i.a(activity, EnumC0469o.RESUMED)) {
            ...
            synchronized (c0372k2) {
                ...
                for (C0347j2 c0347j2 : c0372k2.f922a) {
                    if (c0347j2.d) {
                        c0347j2.d = false;
                        c0347j2.b.remove(c0347j2.e);
                        Cc cc = c0347j2.f911a.f356a;
                        cc.h.c.b(cc.b.f812a);
                    }
                }
            }
    ...
    public final void a(AppMetricaConfig appMetricaConfig, boolean z) {
        ...
        if (booleanValue) {
            ...
            qd.d = new C0(this.b.b.getApiKey(), qd.f611a.f596a.getAsString("PROCESS_CFG_PACKAGE_NAME"), CounterConfigurationReporterType.MAIN, qd.f611a.f596a.getAsInteger("PROCESS_CFG_PROCESS_ID").intValue(), qd.f611a.f596a.getAsString("PROCESS_CFG_PROCESS_SESSION_ID"), this.b.d());
        ...
        synchronized (dc) {
            ...
            dc.f396a = num != null ? num.intValue() : 5;
    ...
    public final void a(ExternalAttribution externalAttribution) {
        ...
        Set set = R9.f621a;
        EnumC0680wb enumC0680wb = EnumC0680wb.EVENT_TYPE_UNDEFINED;
        C0325i4 c0325i4 = new C0325i4(bytes, "", 42, publicLogger);
        Sh sh = this.b;
        ji.getClass();
        ji.a(Ji.a(c0325i4, sh), sh, 1, null);
    }

    @Override // io.appmetrica.analytics.impl.V2, io.appmetrica.analytics.impl.InterfaceC0205db, io.appmetrica.analytics.impl.InterfaceC0181cd
    public final void a(String str, String str2) {
        ...
        C0 c0 = qd.d;
        if (c0 != null) {
            C0 c02 = new C0(c0.f368a, c0.b, c0.c, c0.d, c0.e, d);
            qd.d = c02;
            NativeCrashClientModule nativeCrashClientModule = qd.b;
            qd.c.getClass();
