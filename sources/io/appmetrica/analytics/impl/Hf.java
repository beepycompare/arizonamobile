...
public final class Hf implements Converter {
    ...
    public final Ei fromModel(If r10) {
        ...
        Nn a2 = this.e.a(r10.f621a);
        c0468o8.f1141a = StringUtils.getUTF8Bytes((String) a2.f708a);
        Nn a3 = this.f.a(r10.b);
        c0468o8.b = StringUtils.getUTF8Bytes((String) a3.f708a);
        List<String> list = r10.c;
        Ei ei5 = null;
        if (list != null) {
            ei = this.c.fromModel(list);
            c0468o8.c = (C0264g8) ei.f560a;
        } else {
            ei = null;
        }
        Map<String, String> map = r10.d;
        if (map != null) {
            ei2 = this.f605a.fromModel(map);
            c0468o8.d = (C0418m8) ei2.f560a;
        } else {
            ei2 = null;
        }
        Af af = r10.e;
