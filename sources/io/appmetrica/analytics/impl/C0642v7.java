...
public final class C0642v7 extends MessageNano {
    public static volatile C0642v7[] k;
    ...
    public static C0642v7 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C0642v7().mergeFrom(codedInputByteBufferNano);
    }

    @Override // io.appmetrica.analytics.protobuf.nano.MessageNano
    /* renamed from: a */
    public final C0642v7 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C0642v7 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (C0642v7) MessageNano.mergeFrom(new C0642v7(), bArr);
    }
}
