...
public final class ModulesFacade {
    ...
    private static C0451nd f288a = new C0451nd();

    public static IModuleReporter getModuleReporter(Context context, String str) {
        C0451nd c0451nd = f288a;
        C0247fd c0247fd = c0451nd.b;
        c0247fd.b.a(context);
        c0247fd.d.a(str);
        c0451nd.c.f1260a.a(context.getApplicationContext().getApplicationContext());
        return AbstractC0456ni.f1143a.a(context.getApplicationContext(), str);
    }
    ...
    public static void subscribeForAutoCollectedData(Context context, String str) {
        ...
        c0247fd.b.a(context);
        c0247fd.d.a(str);
        c0451nd.c.f1260a.a(context.getApplicationContext());
