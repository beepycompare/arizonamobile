...
public final class Response {
    ...
    private final NetworkCallMetrics g;
    ...
    public String toString() {
        return "Response(isCompleted=" + this.f1375a + ", code=" + this.b + ", responseDataLength=" + this.c.length + ", headers=" + this.d + ", exception=" + this.e + ", url=" + this.f + ", metrics=" + this.g + ')';
    }
    ...
    public static final class Builder {
        ...
        public final Response build() {
            return new Response(this.f1376a, this.b, this.c, this.e, this.d, this.f, this.g, null);
        }
        ...
        public final Builder withMetrics(NetworkCallMetrics networkCallMetrics) {
            this.g = networkCallMetrics;
            return this;
        }
