...
public final class Response {
    ...
    public String toString() {
        return "Response(isCompleted=" + this.f1390a + ", code=" + this.b + ", responseDataLength=" + this.c.length + ", headers=" + this.d + ", exception=" + this.e + ", url=" + this.f + ')';
    }
    ...
    public static final class Builder {
        ...
        public final Response build() {
            return new Response(this.f1391a, this.b, this.c, this.e, this.d, this.f, null);
        }
