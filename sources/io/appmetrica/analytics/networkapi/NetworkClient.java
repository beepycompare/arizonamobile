...
public abstract class NetworkClient {
    ...
    private final NetworkClientSettings f1383a;
    ...
    public static abstract class Builder {
        ...
        /* renamed from: a  reason: collision with root package name */
        private NetworkClientSettings f1384a = new NetworkClientSettings.Builder().build();
        ...
        public final Builder withSettings(NetworkClientSettings networkClientSettings) {
            this.f1384a = networkClientSettings;
            return this;
        }
    }

    public NetworkClient(NetworkClientSettings networkClientSettings) {
        this.f1383a = networkClientSettings;
    }
