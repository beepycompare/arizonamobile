...
public abstract class NetworkClient {
    ...
    private final NetworkClientSettings f1387a;
    ...
    public static abstract class Builder {
        ...
        /* renamed from: a  reason: collision with root package name */
        private NetworkClientSettings f1388a = new NetworkClientSettings.Builder().build();
        ...
        public final Builder withSettings(NetworkClientSettings networkClientSettings) {
            this.f1388a = networkClientSettings;
            return this;
        }
    }

    public NetworkClient(NetworkClientSettings networkClientSettings) {
        this.f1387a = networkClientSettings;
    }
