...
public abstract class NetworkClient {
    ...
    private final NetworkClientSettings f1382a;
    ...
    public static abstract class Builder {
        ...
        /* renamed from: a  reason: collision with root package name */
        private NetworkClientSettings f1383a = new NetworkClientSettings.Builder().build();
    ...
    public NetworkClient(NetworkClientSettings networkClientSettings) {
        this.f1382a = networkClientSettings;
    }
