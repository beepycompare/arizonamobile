...
public final class Request {
    ...
    public static final class Builder {
        ...
        public final Request build() {
            return new Request(this.f1373a, this.b, this.c, MapsKt.toMap(this.d), null);
        }
    ...
    public String toString() {
        return "Request(url='" + this.f1372a + "', method='" + this.b + "', bodyLength=" + this.c.length + ", headers=" + this.d + ')';
    }
