...
public final class NetworkClientSettings {
    ...
    public static final class Builder {
        ...
        public final NetworkClientSettings build() {
            return new NetworkClientSettings(this.f1386a, this.b, this.c, this.d, this.e, this.f, null);
        }

        public final Builder withConnectTimeout(int i) {
            this.f1386a = Integer.valueOf(i);
            return this;
        }
    ...
    public String toString() {
        return "NetworkClientSettings(connectTimeout=" + this.f1385a + ", readTimeout=" + this.b + ", sslSocketFactory=" + this.c + ", useCaches=" + this.d + ", instanceFollowRedirects=" + this.e + ", maxResponseSize=" + this.f + ')';
    }
