...
public final class UtilityServiceConfiguration {
    ...
    public static /* synthetic */ UtilityServiceConfiguration copy$default(UtilityServiceConfiguration utilityServiceConfiguration, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = utilityServiceConfiguration.f285a;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UtilityServiceConfiguration) {
            ...
            return this.f285a == utilityServiceConfiguration.f285a && this.b == utilityServiceConfiguration.b;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Long.hashCode(this.b) + (Long.hashCode(this.f285a) * 31);
    }

    public String toString() {
        return "UtilityServiceConfiguration(initialConfigTime=" + this.f285a + ", lastUpdateConfigTime=" + this.b + ')';
    }
