...
public final class UtilityServiceConfiguration {
    ...
    public static /* synthetic */ UtilityServiceConfiguration copy$default(UtilityServiceConfiguration utilityServiceConfiguration, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = utilityServiceConfiguration.f400a;
        }
        if ((i & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UtilityServiceConfiguration) {
            ...
            return this.f400a == utilityServiceConfiguration.f400a && this.b == utilityServiceConfiguration.b;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Long.hashCode(this.b) + (Long.hashCode(this.f400a) * 31);
    }

    public String toString() {
        return "UtilityServiceConfiguration(initialConfigTime=" + this.f400a + ", lastUpdateConfigTime=" + this.b + ')';
    }
