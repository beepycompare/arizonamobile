...
public final class CellularNetworkTypeExtractor {
    ...
    public final String getNetworkType() {
        return CellularNetworkTypeConverter.convert((Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.f382a, "phone", "Extracting cellular networkType", "TelephonyManager", this.b));
    }
}
