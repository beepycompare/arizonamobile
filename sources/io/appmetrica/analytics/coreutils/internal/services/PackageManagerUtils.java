...
public final class PackageManagerUtils {
    ...
    private static final SafePackageManager f295a = new SafePackageManager();
    ...
    public static final PackageInfo getPackageInfo(Context context) {
        return f295a.getPackageInfo(context, context.getPackageName());
    }

    @JvmStatic
    public static final ServiceInfo getServiceInfo(Context context, Class<?> cls) {
        return f295a.getServiceInfo(context, new ComponentName(context, cls), 4);
    }
    ...
    public static final ProviderInfo resolveContentProvider(Context context, String str) {
        return f295a.resolveContentProvider(context, str);
    }
}
