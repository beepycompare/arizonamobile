...
public final class DeferredBatchExecutor<T> {
    ...
    private final IHandlerExecutor f352a;
    ...
    private final void b() {
        ...
        this.e = runnable;
        this.f352a.executeDelayed(runnable, this.d);
    }
    ...
    public final void flushAsync() {
        this.f352a.execute(new Runnable() { // from class: io.appmetrica.analytics.coreutils.internal.buffering.DeferredBatchExecutor$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
