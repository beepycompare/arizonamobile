...
public abstract class LoggerStorage {
    ...
    private static HashMap f406a = new HashMap();
    ...
    public static PublicLogger getOrCreatePublicLogger(String str) {
        ...
        PublicLogger publicLogger2 = (PublicLogger) f406a.get(str);
        if (publicLogger2 == null) {
            synchronized (b) {
                publicLogger = (PublicLogger) f406a.get(str);
                if (publicLogger == null) {
                    publicLogger = new PublicLogger(ApiKeyUtils.createPartialApiKey(str));
                    f406a.put(str, publicLogger);
                }
            }
            return publicLogger;
        }
