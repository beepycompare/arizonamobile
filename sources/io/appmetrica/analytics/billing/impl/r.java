...
public final class r implements Converter {
    ...
    public final t fromModel(RemoteBillingConfig remoteBillingConfig) {
        t tVar = new t();
        tVar.f322a = remoteBillingConfig.getEnabled();
        BillingConfig config = remoteBillingConfig.getConfig();
        tVar.b = config != null ? this.f320a.fromModel(config) : null;
        return tVar;
    }
    ...
    public final RemoteBillingConfig toModel(t tVar) {
        boolean z = tVar.f322a;
        g gVar = this.f320a;
        s sVar = tVar.b;
        gVar.getClass();
        return new RemoteBillingConfig(z, new BillingConfig(sVar.f321a, sVar.b));
    }
}
