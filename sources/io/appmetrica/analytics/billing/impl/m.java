...
public final class m implements ServiceModuleReporterComponentLifecycleListener {
    ...
    public final void a(B b) {
        ...
        if (billingMonitor != null) {
            if (b != null) {
                A a2 = b.b;
                billingConfig = new BillingConfig(a2.f291a, a2.b);
            } else {
                billingConfig = null;
            }
    ...
    */
    public final void onMainReporterCreated(ServiceModuleReporterComponentContext serviceModuleReporterComponentContext) {
        ...
        IHandlerExecutor defaultExecutor = this.f301a.getExecutorProvider().getDefaultExecutor();
        Executor uiExecutor = this.f301a.getExecutorProvider().getUiExecutor();
        try {
        ...
        k kVar = new k(this.f301a.getServiceStorageProvider().createBinaryStateStorageFactory("auto_inapp_collecting_info_data", new e(), new C0097b(null, 1, null)).create(this.f301a.getContext()));
        j jVar = new j(serviceModuleReporterComponentContext.getReporter(), this.f301a.getExecutorProvider().getReportRunnableExecutor(), null, 4, null);
        int i = l.f300a[billingType.ordinal()];
        if (i == 1) {
            ...
            a(this.b);
            if (this.f301a.getApplicationStateProvider().registerStickyObserver(new ApplicationStateObserver() { // from class: io.appmetrica.analytics.billing.impl.m$$ExternalSyntheticLambda0
