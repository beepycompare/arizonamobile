...
public final class m implements ServiceModuleReporterComponentLifecycleListener {
    ...
    public final void a(B b) {
        ...
        if (billingMonitor != null) {
            if (b != null) {
                A a2 = b.b;
                billingConfig = new BillingConfig(a2.f306a, a2.b);
            } else {
                billingConfig = null;
            }
    ...
    */
    public final void onMainReporterCreated(ServiceModuleReporterComponentContext serviceModuleReporterComponentContext) {
        ...
        IHandlerExecutor defaultExecutor = this.f316a.getExecutorProvider().getDefaultExecutor();
        Executor uiExecutor = this.f316a.getExecutorProvider().getUiExecutor();
        try {
        ...
        k kVar = new k(this.f316a.getServiceStorageProvider().createBinaryStateStorageFactory("auto_inapp_collecting_info_data", new e(), new C0097b(null, 1, null)).create(this.f316a.getContext()));
        j jVar = new j(serviceModuleReporterComponentContext.getReporter(), this.f316a.getExecutorProvider().getReportRunnableExecutor(), null, 4, null);
        int i = l.f315a[billingType.ordinal()];
        if (i == 1) {
            ...
            a(this.b);
            if (this.f316a.getApplicationStateProvider().registerStickyObserver(new ApplicationStateObserver() { // from class: io.appmetrica.analytics.billing.impl.m$$ExternalSyntheticLambda0
