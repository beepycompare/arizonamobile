...
public final class o {
    public static byte[] a(ProductInfo productInfo) {
        String str;
        z zVar = new z();
        zVar.f227a = productInfo.quantity;
        ...
        u uVar = new u();
        uVar.f222a = productInfo.purchaseOriginalJson.getBytes(charset);
        uVar.b = productInfo.signature.getBytes(charset);
        zVar.e = uVar;
        zVar.g = true;
        zVar.h = 1;
        int i = n.f216a[productInfo.type.ordinal()];
        zVar.i = (i == 1 || i != 2) ? 1 : 2;
        y yVar = new y();
        yVar.f226a = productInfo.purchaseToken.getBytes(charset);
        yVar.b = TimeUnit.MILLISECONDS.toSeconds(productInfo.purchaseTime);
        zVar.j = yVar;
        if (productInfo.type == ProductType.SUBS) {
            x xVar = new x();
            xVar.f225a = productInfo.autoRenewing;
            Period period = productInfo.subscriptionPeriod;
            if (period != null) {
                w wVar = new w();
                wVar.f224a = period.number;
                int i2 = n.b[period.timeUnit.ordinal()];
                wVar.b = i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? 0 : 4 : 3 : 2 : 1;
                xVar.b = wVar;
            }
            v vVar = new v();
            vVar.f223a = productInfo.introductoryPriceMicros;
            Period period2 = productInfo.introductoryPricePeriod;
            if (period2 != null) {
                w wVar2 = new w();
                wVar2.f224a = period2.number;
