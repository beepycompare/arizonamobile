...
public final class C0098b implements ProtobufConverter {
    ...
    public final d fromModel(C0097a c0097a) {
        d dVar = new d();
        List<BillingInfo> list = c0097a.f258a;
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list, 10));
        for (BillingInfo billingInfo : list) {
            arrayList.add(this.f259a.fromModel(billingInfo));
        }
        dVar.f261a = (c[]) arrayList.toArray(new c[0]);
        dVar.b = c0097a.b;
        return dVar;
    }
    ...
    public final C0097a toModel(d dVar) {
        c[] cVarArr = dVar.f261a;
        ArrayList arrayList = new ArrayList(cVarArr.length);
        for (c cVar : cVarArr) {
            arrayList.add(this.f259a.toModel(cVar));
        }
