...
public final class y extends MessageNano {
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(bArr, bArr2)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f277a);
        }
        long j = this.b;
        if (j != 0) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        byte[] bArr2 = WireFormatNano.EMPTY_BYTES;
        if (!Arrays.equals(bArr, bArr2)) {
            codedOutputByteBufferNano.writeBytes(1, this.f277a);
        }
        long j = this.b;
        if (j != 0) {
    ...
    public final y mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 0) {
                ...
                this.f277a = codedInputByteBufferNano.readBytes();
            } else if (readTag == 16) {
