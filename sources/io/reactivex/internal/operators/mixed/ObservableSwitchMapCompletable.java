    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, switchMapInnerObserver2));
        ...
        void innerError(SwitchMapInnerObserver switchMapInnerObserver, Throwable th) {
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.inner, switchMapInnerObserver, null) && this.errors.addThrowable(th)) {
                if (this.delayErrors) {
                    if (this.done) {
