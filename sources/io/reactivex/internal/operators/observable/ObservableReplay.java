...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    public void resetIf(Disposable disposable) {
        MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.current, (ReplayObserver) disposable, null);
    }
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.current, replayObserver, replayObserver2)) {
    ...
    public static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            while (true) {
                ...
                ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.curr, null, replayObserver2)) {
                    replayObserver = replayObserver2;
                    break;
                }
            }
