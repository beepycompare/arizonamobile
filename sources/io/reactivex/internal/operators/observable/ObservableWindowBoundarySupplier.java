...
public final class ObservableWindowBoundarySupplier<T, B> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowBoundaryMainObserver<T, B> extends AtomicInteger implements Observer<T>, Disposable, Runnable {
        ...
        void innerNext(WindowBoundaryInnerObserver<T, B> windowBoundaryInnerObserver) {
            MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.boundaryObserver, windowBoundaryInnerObserver, null);
            this.queue.offer(NEXT_WINDOW);
            drain();
        }
                    ...
                    if (poll != NEXT_WINDOW) {
                        ...
                        if (!this.stopWindows.get()) {
                            ...
                            try {
                                ...
                                if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.boundaryObserver, null, windowBoundaryInnerObserver)) {
