        ...
        SlotPair<T> addValue(T t) {
            ...
            while (true) {
                ...
                if (slotPair == null) {
                    ...
                    if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.current, null, slotPair)) {
                        continue;
                    }
                }
                ...
                MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(this.current, slotPair, null);
            }
            if (tryAcquireSlot == 0) {
                slotPair.first = t;
            } else {
