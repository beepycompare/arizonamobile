...
public final class EmploymentScreen extends SAMPUIElement implements InterfaceController {
    ...
    public EmploymentScreen(Activity targetActivity, int i) {
        ...
        this.jobsAdapter = new JobsAdapter(new Function1() { // from class: ru.mrlargha.employment.center.EmploymentScreen$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                Unit jobsAdapter$lambda$0;
                jobsAdapter$lambda$0 = EmploymentScreen.jobsAdapter$lambda$0(EmploymentScreen.this, (Job) obj);
                return jobsAdapter$lambda$0;
            }
        });
        this.bonusesAdapter = new BonusesAdapter(new Function1() { // from class: ru.mrlargha.employment.center.EmploymentScreen$$ExternalSyntheticLambda11
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit bonusesAdapter$lambda$0;
                bonusesAdapter$lambda$0 = EmploymentScreen.bonusesAdapter$lambda$0(EmploymentScreen.this, (BonusItem) obj);
                return bonusesAdapter$lambda$0;
            }
        });
    ...
    private final void selectJob(SelectJob selectJob) {
        this.jobsAdapter.select(selectJob.getId(), new Function1() { // from class: ru.mrlargha.employment.center.EmploymentScreen$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit selectJob$lambda$0;
                selectJob$lambda$0 = EmploymentScreen.selectJob$lambda$0(EmploymentScreen.this, ((Integer) obj).intValue());
                return selectJob$lambda$0;
            }
        });
    }
    ...
    private final void onClickBonus(BonusItem bonusItem) {
        if (bonusItem.getDesc().length() > 0) {
            ...
            this.binding.bonusDesc.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.employment.center.EmploymentScreen$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    EmploymentScreen.onClickBonus$lambda$0(EmploymentScreen.this, view);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onClickBonus$lambda$0(EmploymentScreen employmentScreen, View view) {
        employmentScreen.binding.bonusDesc.getRoot().setVisibility(8);
    }
    ...
    /* compiled from: EmploymentScreen.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\b¨\u0006\t"}, d2 = {"Lru/mrlargha/employment/center/EmploymentScreen$EasterBites;", "", "value", "", "<init>", "(Ljava/lang/String;II)V", "getValue", "()I", "Main", "employment-center_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    /* JADX WARN: Unknown enum class pattern. Please report as an issue! */
    /* compiled from: EmploymentScreen.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Lru/mrlargha/employment/center/EmploymentScreen$Navigation;", "", "<init>", "(Ljava/lang/String;I)V", "Main", "employment-center_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes6.dex */
