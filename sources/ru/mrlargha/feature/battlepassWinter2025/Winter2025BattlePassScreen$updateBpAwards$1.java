...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$updateBpAwards$1", f = "Winter2025BattlePass.kt", i = {0, 1, 2}, l = {311, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 329}, m = "invokeSuspend", n = {"url", "url", "pairList"}, nl = {310, TypedValues.AttributesType.TYPE_EASING, 332}, s = {"L$0", "L$0", "L$0"}, v = 2)
...
public final class Winter2025BattlePassScreen$updateBpAwards$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x0133, code lost:
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$updateBpAwards$1.AnonymousClass2(r11.this$0, r12, null), r11) == r0) goto L38;
     */
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (list.isEmpty()) {
                String str = UtilsKt.isArizonaType() ? "battlepass_awards_default" : "battlepass_level_default";
                winterBattlePassApi = this.this$0.api;
                this.L$0 = SpillingKt.nullOutSpilledVariable(str);
                this.label = 1;
                obj = winterBattlePassApi.getDefaultBP(str, this);
            }
            list2 = this.this$0._bpPremData;
            if (list2.isEmpty()) {
                String str2 = UtilsKt.isArizonaType() ? "battlepass_awards_gold" : "battlepass_level_premium";
                winterBattlePassApi2 = this.this$0.api;
                this.L$0 = SpillingKt.nullOutSpilledVariable(str2);
                this.label = 2;
                obj = winterBattlePassApi2.getGoldBP(str2, this);
            }
    ...
    /* compiled from: Winter2025BattlePass.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 3, 0}, xi = 48)
    @DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$updateBpAwards$1$2", f = "Winter2025BattlePass.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, nl = {}, s = {}, v = 2)
    /* renamed from: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$updateBpAwards$1$2  reason: invalid class name */
    /* loaded from: classes6.dex */
