...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$setWelcomeScreen$1$4", f = "Winter2025BattlePass.kt", i = {1, 2, 2}, l = {1370, 1377, 1384}, m = "invokeSuspend", n = {"bitmap1", "bitmap1", "bitmap2"}, s = {"L$0", "L$0", "L$1"}, v = 1)
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new Winter2025BattlePassScreen$setWelcomeScreen$1$4$bitmap1$1(null), this);
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
        } else if (i != 2) {
            if (i == 3) {
            ...
            this.label = 3;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new Winter2025BattlePassScreen$setWelcomeScreen$1$4$bitmap3$1(null), this);
        }
        bitmap = (Bitmap) obj;
        if (bitmap != null) {
        ...
        this.L$0 = SpillingKt.nullOutSpilledVariable(bitmap);
        this.label = 2;
        obj = BuildersKt.withContext(Dispatchers.getIO(), new Winter2025BattlePassScreen$setWelcomeScreen$1$4$bitmap2$1(null), this);
    }
}
