...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$setupBuyPremiumPage$1$3", f = "Winter2025BattlePass.kt", i = {1, 2, 2}, l = {410, 417, TypedValues.CycleType.TYPE_WAVE_OFFSET}, m = "invokeSuspend", n = {"bitmap1", "bitmap1", "bitmap2"}, nl = {413, TypedValues.CycleType.TYPE_EASING, 427}, s = {"L$0", "L$0", "L$1"}, v = 2)
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new Winter2025BattlePassScreen$setupBuyPremiumPage$1$3$bitmap1$1(null), this);
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
        } else if (i != 2) {
            if (i == 3) {
        ...
        this.L$0 = SpillingKt.nullOutSpilledVariable(bitmap);
        this.label = 2;
        obj = BuildersKt.withContext(Dispatchers.getIO(), new Winter2025BattlePassScreen$setupBuyPremiumPage$1$3$bitmap2$1(null), this);
    }
}
