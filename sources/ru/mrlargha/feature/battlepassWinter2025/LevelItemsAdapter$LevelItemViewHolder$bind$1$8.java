...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.LevelItemsAdapter$LevelItemViewHolder$bind$1$8", f = "LevelItemsAdapter.kt", i = {0}, l = {ComposerKt.compositionLocalMapKey}, m = "invokeSuspend", n = {"$this$launch"}, nl = {209}, s = {"L$0"}, v = 2)
/* loaded from: classes6.dex */
public final class LevelItemsAdapter$LevelItemViewHolder$bind$1$8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LevelItemsAdapter$LevelItemViewHolder$bind$1$8(WinterBattlepassLevelItemBinding winterBattlepassLevelItemBinding, LevelItemsAdapter levelItemsAdapter, AwardItemData awardItemData, LevelItemsAdapter.LevelItemViewHolder levelItemViewHolder, Continuation<? super LevelItemsAdapter$LevelItemViewHolder$bind$1$8> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        LevelItemsAdapter$LevelItemViewHolder$bind$1$8 levelItemsAdapter$LevelItemViewHolder$bind$1$8 = new LevelItemsAdapter$LevelItemViewHolder$bind$1$8(this.$this_apply, this.this$0, this.$itemUsual, this.this$1, continuation);
        levelItemsAdapter$LevelItemViewHolder$bind$1$8.L$0 = obj;
        return levelItemsAdapter$LevelItemViewHolder$bind$1$8;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LevelItemsAdapter$LevelItemViewHolder$bind$1$8) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new LevelItemsAdapter$LevelItemViewHolder$bind$1$8$bitmap$1(this.this$0, this.$itemUsual, null), this);
