...
public final class Winter2025BattlePassScreen extends SAMPUIElement {
    ...
    private Pair<? extends View, String> pendingPremiumRewardDescription;
    ...
    public static final /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[BattlePassModelType.ModalWindow.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                iArr[BattlePassModelType.BlockTimer.ordinal()] = 15;
    ...
    public Winter2025BattlePassScreen(Activity targetActivity, int i) {
        ...
        this.supportsBattlePassCurrency = isArizonaType;
        ...
        this.taskProgressTextColor$delegate = LazyKt.lazy(new Function0() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda42
        ...
        this.commonTasksAdapter = new CommonTasksAdapter(UtilsKt.isArizonaType(), resolveBattlePassColor, create.getItemLayouts().getCommonTaskItem(), new Function2() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda1
        ...
        this.rewardsTasksAdapter = new RewardsTasksAdapter(create.getItemLayouts().getTaskRewardItem());
        this.levelItemsAdapter = new LevelItemsAdapter(create.getItemLayouts().getLevelItem(), new Function0() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Winter2025BattlePassScreen.levelItemsAdapter$lambda$0(Winter2025BattlePassScreen.this);
            }
        }, new Function0() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Winter2025BattlePassScreen.levelItemsAdapter$lambda$1(Winter2025BattlePassScreen.this);
            }
        }, new Function2() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
        ...
        }, new Winter2025BattlePassScreen$levelItemsAdapter$4(this), new Function0() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.rouletteController = new BattlePassRouletteController(binding, UtilsKt.isArizonaType(), resolveBattlePassColor2, color, new Function2() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
        ...
        }, new Function1() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda7
        ...
        BattlePassPurchaseController battlePassPurchaseController = new BattlePassPurchaseController(targetActivity, binding, create.getMainPage().getPremiumAction(), arizonaRetrofit.getScope(), UtilsKt.isArizonaType(), string, string2, new Function2() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda8
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return Winter2025BattlePassScreen.purchaseController$lambda$0(Winter2025BattlePassScreen.this, ((Integer) obj).intValue(), ((Integer) obj2).intValue());
            }
        });
        ...
        create.prepare();
        binding.battlepass2023Container.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda9
        ...
        buttonBuyBattlePoints.setVisibility(isArizonaType ? 0 : 8);
        if (UtilsKt.isArizonaType()) {
    ...
    /* compiled from: Winter2025BattlePass.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Lru/mrlargha/feature/battlepassWinter2025/Winter2025BattlePassScreen$Companion;", "", "<init>", "()V", "ARIZONA_WELCOME_CTA_SUB_ID", "", "ARIZONA_REFRESH_TASKS_SUB_ID", "battle-pass"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static final Unit purchaseController$lambda$0(Winter2025BattlePassScreen winter2025BattlePassScreen, int i, int i2) {
        SAMPUIElement.notifyClick$default(winter2025BattlePassScreen, i, i2, null, 4, null);
        return Unit.INSTANCE;
    }
    ...
    private final void setupConvertBattleCoinsPage() {
        ...
        winterBattlepassConvertBattlecoinsLayoutBinding.plusBattlepointsButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda37
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        winterBattlepassConvertBattlecoinsLayoutBinding.minusBattlepointsButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda38
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        winterBattlepassConvertBattlecoinsLayoutBinding.multiplierBattlepoints10Text.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda39
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupConvertBattleCoinsPage$lambda$0$3(Winter2025BattlePassScreen.this, view);
            }
        });
        winterBattlepassConvertBattlecoinsLayoutBinding.multiplierBattlepoints100Text.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda40
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupConvertBattleCoinsPage$lambda$0$4(Winter2025BattlePassScreen.this, view);
            }
        });
        winterBattlepassConvertBattlecoinsLayoutBinding.multiplierBattlepoints1000Text.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda41
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void setupNavigation() {
        ...
        navigation.getBackButton().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$0$0(Winter2025BattlePassScreen.this, view);
            }
        });
        navigation.getMain().getContainer().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda14
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$0$1(Winter2025BattlePassScreen.this, view);
            }
        });
        navigation.getTasks().getContainer().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda15
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$0$2(Winter2025BattlePassScreen.this, view);
            }
        });
        navigation.getCases().getContainer().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda16
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$0$3(Winter2025BattlePassScreen.this, view);
            }
        });
        navigation.getCurrencyContainer().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda17
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (currencyAddButton != null) {
            currencyAddButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda18
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        mainPage.getBuyLevelsButton().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda19
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$1$0(Winter2025BattlePassScreen.this, view);
            }
        });
        mainPage.getPremiumAction().getContainer().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda20
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        winterBattlepassLayoutBinding.rouletteNavMenuButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda21
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupNavigation$lambda$2$0(Winter2025BattlePassScreen.this, view);
            }
        });
        winterBattlepassLayoutBinding.donateNavMenuButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda23
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (this.supportsBattlePassCurrency) {
            winterBattlepassLayoutBinding.buttonBuyBattlePoints.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda12
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private final void showTasksPage() {
        ...
        WinterBattlepassLayoutBinding winterBattlepassLayoutBinding = this.battlePassBinding;
        selectTaskCategory(CategoryType.DAILY);
    ...
    private final void showLevelSetsPage() {
        ...
        if ((mainBattlePassInfo != null ? mainBattlePassInfo.getLevel() : 0) >= 100) {
            ...
            winterBattlepassLayoutBinding.battlepassLevelSetsPageMaximum.buttonReturn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda30
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private final void setupCommonTasksInfo() {
        ...
        if (battlePassTaskCategoryViews != null && (container3 = battlePassTaskCategoryViews.getContainer()) != null) {
            container3.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda25
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (!UtilsKt.isArizonaType()) {
            ...
            if (battlePassTaskCategoryViews2 != null && (container2 = battlePassTaskCategoryViews2.getContainer()) != null) {
                container2.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda26
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
            ...
            if (battlePassTaskCategoryViews3 != null && (container = battlePassTaskCategoryViews3.getContainer()) != null) {
                container.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda27
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        tasksPage.getBuyLevelsButton().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda28
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupCommonTasksInfo$lambda$0$3(Winter2025BattlePassScreen.this, view);
            }
        });
        tasksPage.getBuyPremiumButton().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda29
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public static final void setupCommonTasksInfo$lambda$0$0(Winter2025BattlePassScreen winter2025BattlePassScreen, View view) {
        winter2025BattlePassScreen.selectTaskCategory(CategoryType.DAILY);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setupCommonTasksInfo$lambda$0$1(Winter2025BattlePassScreen winter2025BattlePassScreen, View view) {
        winter2025BattlePassScreen.selectTaskCategory(CategoryType.PREMIUM);
    }
    ...
    private final void selectTaskCategory(CategoryType categoryType) {
        updateTaskCategoryTheme(categoryType);
        filterListForSelectedTask(categoryType);
        CommonTaskInfo commonTaskInfo = (CommonTaskInfo) CollectionsKt.firstOrNull((List<? extends Object>) this.commonTasksAdapter.getCurrentTasksList());
        if (commonTaskInfo != null) {
            showSelectedTask(commonTaskInfo, categoryType);
        }
    }
    ...
    private final void updateMainPageInfo(MainBattlePassInfo mainBattlePassInfo) {
        ...
        BattlePassTasksPageViews tasksPage = this.battlePassUi.getTasksPage();
        tasksPage.getResetTimeText().setText(TimeConverterKt.taskPageTimeConvert(mainBattlePassInfo.getTimestampMissionTime()));
    ...
    private final void showSelectedTask(final CommonTaskInfo commonTaskInfo, final CategoryType categoryType) {
        ...
        tasksPage.getClaimButton().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda24
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.showSelectedTask$lambda$0$0(Winter2025BattlePassScreen.this, categoryType, commonTaskInfo, view);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showSelectedTask$lambda$0$0(Winter2025BattlePassScreen winter2025BattlePassScreen, CategoryType categoryType, CommonTaskInfo commonTaskInfo, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void requestPremiumRewardDescription(View view, String str) {
        if (this.pendingPremiumRewardDescription != null) {
            return;
        }
        ...
        this.pendingPremiumRewardDescription = TuplesKt.to(view, str);
        notifyClick(0, 26, str);
    }

    private final void showPremiumRewardDescription(String str) {
        Pair<? extends View, String> pair = this.pendingPremiumRewardDescription;
        if (pair == null) {
            return;
        }
        ...
        String str2 = str;
        if (!StringsKt.isBlank(str2) && component1.isAttachedToWindow() && Intrinsics.areEqual(component1.getTag(), component2)) {
            ...
            popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda35
            ...
            root.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda36
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    popupWindow.dismiss();
                }
    ...
    private final void setWelcomeScreen() {
        ...
        winterBattlepassWelcomeLayoutBinding.btnGetInfoWinterWelcome.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda22
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setWelcomeScreen$lambda$0$2(WinterBattlepassWelcomeLayoutBinding.this, this, view);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setWelcomeScreen$lambda$0$2(WinterBattlepassWelcomeLayoutBinding winterBattlepassWelcomeLayoutBinding, Winter2025BattlePassScreen winter2025BattlePassScreen, View view) {
        winterBattlepassWelcomeLayoutBinding.getRoot().setVisibility(8);
    ...
    private final void setupListeners() {
        WinterBattlepassLayoutBinding winterBattlepassLayoutBinding = this.battlePassBinding;
        winterBattlepassLayoutBinding.seasonEnded.btnAccept.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda31
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupListeners$lambda$0$0(Winter2025BattlePassScreen.this, view);
            }
        });
        winterBattlepassLayoutBinding.seasonEnded.btnClose.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda32
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Winter2025BattlePassScreen.setupListeners$lambda$0$1(Winter2025BattlePassScreen.this, view);
            }
        });
        winterBattlepassLayoutBinding.seasonEnded.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.battlepassWinter2025.Winter2025BattlePassScreen$$ExternalSyntheticLambda34
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
