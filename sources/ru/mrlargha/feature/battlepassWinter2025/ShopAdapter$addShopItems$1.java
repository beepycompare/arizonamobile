...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.ShopAdapter$addShopItems$1", f = "ShopAdapter.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {82}, m = "invokeSuspend", n = {"$this$map$iv", "$this$mapTo$iv$iv", "destination$iv$iv", "item$iv$iv", "it", "$i$f$map", "$i$f$mapTo", "$i$a$-map-ShopAdapter$addShopItems$1$resultList$1"}, s = {"L$0", "L$1", "L$2", "L$4", "L$5", "I$0", "I$1", "I$2"}, v = 1)
