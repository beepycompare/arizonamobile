...
@DebugMetadata(c = "ru.mrlargha.feature.battlepassWinter2025.RodinaBattlePassTaskRewardItemViewHolder$bind$1$1", f = "RewardsTasksAdapter.kt", i = {}, l = {61}, m = "invokeSuspend", n = {}, nl = {64}, s = {}, v = 2)
/* loaded from: classes6.dex */
final class RodinaBattlePassTaskRewardItemViewHolder$bind$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public RodinaBattlePassTaskRewardItemViewHolder$bind$1$1(WinterBattlepassTaskRewardItemBinding winterBattlepassTaskRewardItemBinding, CommonTaskReward commonTaskReward, Continuation<? super RodinaBattlePassTaskRewardItemViewHolder$bind$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RodinaBattlePassTaskRewardItemViewHolder$bind$1$1(this.$this_apply, this.$reward, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((RodinaBattlePassTaskRewardItemViewHolder$bind$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new RodinaBattlePassTaskRewardItemViewHolder$bind$1$1$bitmap$1(this.$reward, null), this);
