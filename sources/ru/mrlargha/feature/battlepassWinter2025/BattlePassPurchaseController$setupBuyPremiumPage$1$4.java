...
public final class BattlePassPurchaseController$setupBuyPremiumPage$1$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BattlePassPurchaseController$setupBuyPremiumPage$1$4(WinterBattlepassBuyPremiumLayoutBinding winterBattlepassBuyPremiumLayoutBinding, BattlePassPurchaseController battlePassPurchaseController, Continuation<? super BattlePassPurchaseController$setupBuyPremiumPage$1$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BattlePassPurchaseController$setupBuyPremiumPage$1$4(this.$this_apply, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BattlePassPurchaseController$setupBuyPremiumPage$1$4) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new BattlePassPurchaseController$setupBuyPremiumPage$1$4$bitmap1$1(null), this);
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
        } else if (i != 2) {
            if (i == 3) {
            ...
            this.label = 3;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new BattlePassPurchaseController$setupBuyPremiumPage$1$4$bitmap3$1(null), this);
        }
        bitmap = (Bitmap) obj;
        ...
        this.L$0 = SpillingKt.nullOutSpilledVariable(bitmap);
        this.label = 2;
        obj = BuildersKt.withContext(Dispatchers.getIO(), new BattlePassPurchaseController$setupBuyPremiumPage$1$4$bitmap2$1(null), this);
    }
}
