...
import ru.mrlargha.feature.mobile.databinding.MessengerInputFieldLayoutBinding;
import ru.mrlargha.feature.mobile.databinding.MobilePhoneBinding;
import ru.mrlargha.feature.mobile.databinding.MobilePhoneMessengerChatPageBinding;
import ru.mrlargha.feature.mobile.domain.enums.MobilePhonePage;
import ru.mrlargha.feature.mobile.domain.obj.ContactInfo;
import ru.mrlargha.feature.mobile.domain.obj.EmojiItem;
import ru.mrlargha.feature.mobile.domain.obj.MessageInfo;
import ru.mrlargha.feature.mobile.domain.obj.MobilePhoneObjectKt;
...
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneMessengerChatAdapter;
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneMessengerChatMenuAdapter;
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneMessengerEmojiAdapter;
...
public final class MessengerChat implements MobileController {
    ...
    /* compiled from: MessengerChat.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/messenger/MessengerChat$Companion;", "", "<init>", "()V", "TAG", "", "mobile"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    private final MenuChatItem getBlockMenuItem() {
        ...
        int i = R.drawable.ic_block_messenger;
    ...
    private final MenuChatItem getContactMenuItem() {
        ...
        if (Intrinsics.areEqual((Object) this.contactInfo.isContact(), (Object) true)) {
            i = R.drawable.ic_remove_user_messenger;
        } else {
            i = R.drawable.ic_add_user_messenger;
        }
        if (Intrinsics.areEqual((Object) this.contactInfo.isContact(), (Object) true)) {
    ...
    private final void prepareInput() {
        if (this.contactInfo.m11931isBlocked()) {
            showBlockContact();
        }
        final MessengerInputFieldLayoutBinding messengerInputFieldLayoutBinding = this.pageBinding.inputFieldChatLayout;
        messengerInputFieldLayoutBinding.messageEditText.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MessengerChat.prepareInput$lambda$0$0(MessengerChat.this, messengerInputFieldLayoutBinding, view);
            }
        });
        messengerInputFieldLayoutBinding.sendBtn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MessengerChat.prepareInput$lambda$0$1(MessengerInputFieldLayoutBinding.this, this, view);
            }
        });
        messengerInputFieldLayoutBinding.emojiBtn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void prepareHeader() {
        MobilePhoneMessengerChatPageBinding mobilePhoneMessengerChatPageBinding = this.pageBinding;
        mobilePhoneMessengerChatPageBinding.headerBack.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        mobilePhoneMessengerChatPageBinding.headerSettingsBtn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void preparePage() {
        ...
        recyclerView.addOnScrollListener(new PaginationScrollListener(layoutManager) { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.MessengerChat$preparePage$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
