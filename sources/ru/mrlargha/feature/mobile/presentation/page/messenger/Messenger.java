...
import ru.mrlargha.feature.mobile.databinding.MessengerMessagesLayoutBinding;
import ru.mrlargha.feature.mobile.databinding.MessengerNewCorrespondenceLayoutBinding;
import ru.mrlargha.feature.mobile.databinding.MessengerProfileLayoutBinding;
import ru.mrlargha.feature.mobile.databinding.MobilePhoneBinding;
import ru.mrlargha.feature.mobile.databinding.MobilePhoneMessengerPageBinding;
import ru.mrlargha.feature.mobile.domain.enums.MobilePhonePage;
import ru.mrlargha.feature.mobile.domain.obj.AvatarBackground;
import ru.mrlargha.feature.mobile.domain.obj.ContactInfo;
import ru.mrlargha.feature.mobile.domain.obj.SettingsInfo;
...
import ru.mrlargha.feature.mobile.presentation.adapter.ColorItem;
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneMessengerColorsAdapter;
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneMessengerContactsAdapter;
import ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger;
import ru.mrlargha.feature.mobile.presentation.page.messenger.api.MessagesApi;
...
public final class Messenger implements MobileController, CompoundButton.OnCheckedChangeListener {
    ...
    /* compiled from: Messenger.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\bX\u0086T¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/messenger/Messenger$Companion;", "", "<init>", "()V", "MESSENGER_PREFS", "", "TOKEN_PREFS", "MIN_SYMBOLS_SEARCH", "", "TAG", "JWT_EXPIRED", "mobile"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    public final void loadNextPage() {
        ...
        MessagesApi.findContact$default(api, this.token, this.searchNickname, 0, this.paginationPage, 4, null).enqueue(new Callback<List<? extends ContactApiResponse>>() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$loadNextPage$1
    ...
    public final void requestContacts(String str) {
        ...
        MessagesApi api = this.api;
        Intrinsics.checkNotNullExpressionValue(api, "api");
        MessagesApi.findContact$default(api, this.token, str, 0, this.paginationPage, 4, null).enqueue(new Callback<List<? extends ContactApiResponse>>() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$requestContacts$2
            @Override // retrofit2.Callback
            public void onResponse(Call<List<? extends ContactApiResponse>> call, Response<List<? extends ContactApiResponse>> response) {
                MobilePhoneMessengerContactsAdapter mobilePhoneMessengerContactsAdapter;
                Intrinsics.checkNotNullParameter(call, "call");
    ...
    private final void loadChats(String str, final Integer num) {
        MessagesApi api = this.api;
        Intrinsics.checkNotNullExpressionValue(api, "api");
        MessagesApi.getMessages$default(api, str, 0, 0, null, 14, null).enqueue(new Callback<List<? extends ContactApiResponse>>() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$loadChats$1
            @Override // retrofit2.Callback
            public void onResponse(Call<List<? extends ContactApiResponse>> call, Response<List<? extends ContactApiResponse>> response) {
                MobilePhoneMessengerContactsAdapter mobilePhoneMessengerContactsAdapter;
    ...
    public final void loadSettings() {
        this.api.getSettings(this.token).enqueue(new Callback<SettingsApiResponse>() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$loadSettings$1
            @Override // retrofit2.Callback
    ...
    private final void setupEmptyPages() {
        this.pageBinding.emptyMessagesLayout.buttonNewChat.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Messenger.setupEmptyPages$lambda$0$0(Messenger.this, view);
            }
        });
        this.pageBinding.emptyContactsLayout.buttonNewChat.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void setupNewCorrespondencePage() {
        ...
        messengerNewCorrespondenceLayoutBinding.addFromContactsContainer.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Messenger.setupNewCorrespondencePage$lambda$0$0(Messenger.this, view);
            }
        });
        messengerNewCorrespondenceLayoutBinding.findByNumberContainer.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void setupMessagesPage() {
        ...
        recyclerView.addOnScrollListener(new PaginationScrollListener(layoutManager) { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$setupMessagesPage$1$1
            /* JADX INFO: Access modifiers changed from: package-private */
        ...
        messengerMessagesLayoutBinding.searchEditText.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void prepareHeader() {
        ...
        mobilePhoneMessengerPageBinding.headerBack.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Messenger.prepareHeader$lambda$0$0(Messenger.this, view);
            }
        });
        mobilePhoneMessengerPageBinding.headerSettingsBtn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Messenger.this.loadSettings();
            }
        });
        mobilePhoneMessengerPageBinding.headerAddBtn.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.messenger.Messenger$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
