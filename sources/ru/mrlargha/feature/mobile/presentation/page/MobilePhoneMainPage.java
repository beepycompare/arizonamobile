...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0006\u0010\u001b\u001a\u00020\u001cJ\b\u0010\u001d\u001a\u00020\u001cH\u0016J\b\u0010\u001e\u001a\u00020\u001cH\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00120\u0011X\u0082\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0013\u001a\u00020\u0014¢\u0006\b\n\u0000\u001a\u0004\b\u0015\u0010\u0016R\u000e\u0010\u0017\u001a\u00020\u0018X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0019\u001a\u00020\u001aX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001f"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/MobilePhoneMainPage;", "Lru/mrlargha/feature/mobile/presentation/MobileController;", "<init>", "()V", "mobilePhone", "Lru/mrlargha/arizonaui/mobile/presentation/MobilePhone;", "context", "Landroid/app/Activity;", "phoneBinding", "Lru/mrlargha/feature/mobile/databinding/MobilePhoneBinding;", "sendFrontedMessage", "Lru/mrlargha/commonui/core/IBackendNotifier;", "timer", "Landroid/os/CountDownTimer;", "sharedPreferences", "Landroid/content/SharedPreferences;", "menus", "", "Lru/mrlargha/feature/mobile/domain/obj/MobilePhoneCarousel;", "mpMain", "Landroidx/constraintlayout/widget/ConstraintLayout;", "getMpMain", "()Landroidx/constraintlayout/widget/ConstraintLayout;", "mpMainBinding", "Lru/mrlargha/feature/mobile/databinding/MobilePhoneMainPageBinding;", "viewPagerAdapter", "Lru/mrlargha/feature/mobile/presentation/adapter/ViewPageAdapter;", "onApplicationOpened", "", "renderPage", "removePage", "mobile"}, k = 1, mv = {2, 3, 0}, xi = 48)
...
public final class MobilePhoneMainPage implements MobileController {
    ...
    public MobilePhoneMainPage() {
        ...
        MobilePhoneMenu[] mobilePhoneMenuArr = {new MobilePhoneMenu("Меню", R.drawable.mp_main_menu_ic, 1, 0, 8, null), new MobilePhoneMenu("Мой промокод", R.drawable.mp_promocode, 2, 0, 8, null), new MobilePhoneMenu("Квесты", R.drawable.mp_quest_ic, 3, 0, 8, null), new MobilePhoneMenu("Реклама в СМИ", R.drawable.mp_media_ic, 15, 0, 8, null), new MobilePhoneMenu("Spotify", R.drawable.mp_music_ic, 5, 0, 8, null), new MobilePhoneMenu("Driver", R.drawable.mp_driver_ic, 6, 0, 8, null), new MobilePhoneMenu("Uber", R.drawable.mp_taxi_ic, 7, 0, 8, null), new MobilePhoneMenu("Навигатор", R.drawable.mp_navigator_ic, 8, 0, 8, null), new MobilePhoneMenu("Настройки", R.drawable.mp_settings_ic, 9, 0, 8, null), new MobilePhoneMenu("Звонки", R.drawable.mp_call_ic, 10, 0, 8, null), new MobilePhoneMenu("СМС", R.drawable.mp_sms_ic, 11, sharedPreferences.getInt("UNREAD_MESSAGE", 0)), new MobilePhoneMenu("Контакты", R.drawable.mp_contact_ic, 12, 0, 8, null)};
        String string = context.getString(R.string.arizona_rent);
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        MobilePhoneMenu[] mobilePhoneMenuArr2 = {new MobilePhoneMenu("Достижения", R.drawable.mp_achievements_ic, 13, 0, 8, null), new MobilePhoneMenu(string, R.drawable.mp_arizona_rent, 40, 0, 8, null), new MobilePhoneMenu("Item Market", R.drawable.mp_ic_rent_accessory, 44, sharedPreferences.getInt("WAREHOUSE_COUNT", 0)), new MobilePhoneMenu("Магазин", R.drawable.mp_shop_ic, 14, 0, 8, null), new MobilePhoneMenu("Документы", R.drawable.mp_passport_ic, 17, 0, 8, null), new MobilePhoneMenu("Анимации", R.drawable.mp_anims_ic, 18, 0, 8, null), new MobilePhoneMenu("Моя семья", R.drawable.mp_family_ic, 19, 0, 8, null), new MobilePhoneMenu("YouTube", R.drawable.mp_youtube_ic, 20, 0, 8, null), new MobilePhoneMenu("Бизнесы", R.drawable.mp_business_ic, 21, 0, 8, null), new MobilePhoneMenu("Авто", R.drawable.mp_auto, 22, 0, 8, null), new MobilePhoneMenu("Дома", R.drawable.mp_home_ic, 23, 0, 8, null), new MobilePhoneMenu("Банковское меню", R.drawable.mp_exchange_ic, 24, 0, 8, null)};
        MobilePhoneMenu[] mobilePhoneMenuArr3 = {new MobilePhoneMenu("Аренда билборда", R.drawable.mp_bilboard_ic, 25, 0, 8, null), new MobilePhoneMenu("Галерея", R.drawable.mp_camera_ic, 26, 0, 8, null), new MobilePhoneMenu("Звуки", R.drawable.mp_sound_settings_ic, 27, 0, 8, null), new MobilePhoneMenu("Режим погони", R.drawable.mp_copchase_ic, 28, 0, 8, null), new MobilePhoneMenu("Трезвый водитель", R.drawable.mp_soberdriver_ic, 29, 0, 8, null), new MobilePhoneMenu("Ловля", R.drawable.mp_catch_ic, 30, 0, 8, null), new MobilePhoneMenu("Селфи", R.drawable.mp_selfie_camera, 31, 0, 8, null), new MobilePhoneMenu("Телефонный справочник", R.drawable.mp_phone_number, 32, 0, 8, null), new MobilePhoneMenu("История ник-неймов,", R.drawable.mp_phone_nickname, 33, 0, 8, null), new MobilePhoneMenu("Календарь", R.drawable.mp_calendar_welcom, 34, 0, 8, null), new MobilePhoneMenu("Лог продаж", R.drawable.ic_marketplace_phone, 35, 0, 8, null), new MobilePhoneMenu("Хранилище", R.drawable.ic_storage_phone, 36, 0, 8, null)};
        String string2 = context.getString(R.string.rating_bp);
        Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
        List<MobilePhoneCarousel> listOf = CollectionsKt.listOf((Object[]) new MobilePhoneCarousel[]{new MobilePhoneCarousel(0, CollectionsKt.listOf((Object[]) mobilePhoneMenuArr)), new MobilePhoneCarousel(1, CollectionsKt.listOf((Object[]) mobilePhoneMenuArr2)), new MobilePhoneCarousel(2, CollectionsKt.listOf((Object[]) mobilePhoneMenuArr3)), new MobilePhoneCarousel(3, CollectionsKt.listOf((Object[]) new MobilePhoneMenu[]{new MobilePhoneMenu("Гонка вооружений", R.drawable.mobile_catch_app_ic, 37, 0, 8, null), new MobilePhoneMenu("Режим в полете", R.drawable.mp_avia, 38, 0, 8, null), new MobilePhoneMenu("Рейтинг аксессуаров", R.drawable.mp_accs_rating_ic, 41, 0, 8, null), new MobilePhoneMenu("Рейтинг транспорта", R.drawable.mp_cars_rating_ic, 42, 0, 8, null), new MobilePhoneMenu("Криптовалюта", R.drawable.mp_bitcoin_ic, 39, 0, 8, null), new MobilePhoneMenu(string2, R.drawable.mp_rating_bp, 43, 0, 8, null)}))});
        this.menus = listOf;
