...
@DebugMetadata(c = "ru.mrlargha.feature.mobile.presentation.page.rent.ArizonaRentAddPage$setupListeners$1$7$1", f = "ArizonaRentAddPage.kt", i = {}, l = {234}, m = "invokeSuspend", n = {}, nl = {237}, s = {}, v = 2)
...
public final class ArizonaRentAddPage$setupListeners$1$7$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ArizonaRentAddPage$setupListeners$1$7$1(ArizonaRentAddPage arizonaRentAddPage, Editable editable, Continuation<? super ArizonaRentAddPage$setupListeners$1$7$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ArizonaRentAddPage$setupListeners$1$7$1(this.this$0, this.$it, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ArizonaRentAddPage$setupListeners$1$7$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: ArizonaRentAddPage.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 4, 0}, xi = 48)
    @DebugMetadata(c = "ru.mrlargha.feature.mobile.presentation.page.rent.ArizonaRentAddPage$setupListeners$1$7$1$1", f = "ArizonaRentAddPage.kt", i = {}, l = {235}, m = "invokeSuspend", n = {}, nl = {236}, s = {}, v = 2)
