...
@DebugMetadata(c = "ru.mrlargha.feature.mobile.presentation.page.rent.ArizonaRentAddPage$setupListeners$1$8$onItemSelected$1", f = "ArizonaRentAddPage.kt", i = {0, 1}, l = {LauncherApkNetworkPolicy.IPV6_UNIQUE_LOCAL_PREFIX, 269}, m = "invokeSuspend", n = {"item", "item"}, nl = {257, 271}, s = {"L$0", "L$0"}, v = 2)
