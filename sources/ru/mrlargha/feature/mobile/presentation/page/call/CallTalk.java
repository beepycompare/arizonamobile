...
public final class CallTalk implements MobileController {
    ...
    public CallTalk() {
        ...
        countDown();
        bind.mpReceiveCallActionDecline.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.call.CallTalk$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallTalk.this.sendFrontedMessage.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), -1, 3);
            }
        });
    }

    private final void countDown() {
        CountDownTimer countDownTimer = new CountDownTimer(86400000L, this) { // from class: ru.mrlargha.feature.mobile.presentation.page.call.CallTalk$countDown$1
