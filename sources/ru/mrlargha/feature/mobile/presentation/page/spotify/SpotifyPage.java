...
import ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyGenreAdapter;
import ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage;
import ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyTrackListAdapter;
...
public final class SpotifyPage implements MobileController {
    ...
    public SpotifyPage() {
        ...
        bind.mpSpotifyBackArrow.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage$$ExternalSyntheticLambda0
        ...
        bind.mpSpotifyLogoBackArrow.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SpotifyPage.lambda$0$1(SpotifyPage.this, view);
            }
        });
        bind.mpSpotifyPlay.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        bind.mpSpotifySeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage$1$5
        ...
        spotifyGenreAdapter.setOnGenreClickListener(new SpotifyGenreAdapter.OnGenreClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage.2
            @Override // ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyGenreAdapter.OnGenreClickListener
        ...
        spotifyTrackListAdapter.setOnPlayTrackClickListener(new SpotifyTrackListAdapter.OnPlayTrackClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage.3
            @Override // ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyTrackListAdapter.OnPlayTrackClickListener
            public void callback(int i, boolean z) {
    ...
    public static final boolean spotifyState$lambda$1$2(final SpotifyPage spotifyPage, final MobilePhoneSpotifyPageBinding mobilePhoneSpotifyPageBinding, TextView textView, int i, KeyEvent keyEvent) {
        if (i == 5 || i == 6) {
            spotifyPage.api.searchTrackListByParam(textView.getText().toString()).enqueue((Callback) new Callback<List<? extends ArizonaSpotifyTrackResponse>>() { // from class: ru.mrlargha.feature.mobile.presentation.page.spotify.SpotifyPage$spotifyState$2$3$1
                @Override // retrofit2.Callback
                public void onResponse(Call<List<? extends ArizonaSpotifyTrackResponse>> call, Response<List<? extends ArizonaSpotifyTrackResponse>> response) {
                    Intrinsics.checkNotNullParameter(call, "call");
                    Intrinsics.checkNotNullParameter(response, "response");
    ...
    /* compiled from: SpotifyPage.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0011\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000b¨\u0006\f"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/spotify/SpotifyPage$SpotifyState;", "", "stateId", "", "<init>", "(Ljava/lang/String;II)V", "getStateId", "()I", "INIT", "SEARCH", "TRACK_LIST", "CATEGORY_TRACK_LIST", "mobile"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    /* compiled from: SpotifyPage.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0006\u0010\u0004\u001a\u00020\u0005R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u000e¢\u0006\u0002\n\u0000R\u001d\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\b0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u001d\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\f0\u0007¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\n¨\u0006\u000e"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/spotify/SpotifyPage$Companion;", "", "<init>", "()V", "isTrackPlaying", "", "mapGenre", "", "", "getMapGenre", "()Ljava/util/Map;", "mapImage", "", "getMapImage", "mobile"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
