package ru.mrlargha.feature.mobile.presentation.page.uber;
...
import ru.mrlargha.feature.mobile.databinding.MobilePhoneUberChoseTaxiPageBinding;
...
import ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneUberAdapter;
/* compiled from: UberChoseTaxi.kt */
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\b\u0010\u0016\u001a\u00020\u0015H\u0016R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0011X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0013X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/page/uber/UberChoseTaxi;", "Lru/mrlargha/feature/mobile/presentation/MobileController;", "<init>", "()V", "mobilePhone", "Lru/mrlargha/arizonaui/mobile/presentation/MobilePhone;", "context", "Landroid/app/Activity;", "phoneBinding", "Lru/mrlargha/feature/mobile/databinding/MobilePhoneBinding;", "sendFrontedMessage", "Lru/mrlargha/commonui/core/IBackendNotifier;", "priority", "", "uberChoseTaxi", "Landroidx/constraintlayout/widget/ConstraintLayout;", "uberChoseTaxiBinding", "Lru/mrlargha/feature/mobile/databinding/MobilePhoneUberChoseTaxiPageBinding;", "uberAdapter", "Lru/mrlargha/feature/mobile/presentation/adapter/MobilePhoneUberAdapter;", "renderPage", "", "removePage", "mobile"}, k = 1, mv = {2, 3, 0}, xi = 48)
...
public final class UberChoseTaxi implements MobileController {
    ...
    public UberChoseTaxi() {
        ...
        ((GradientDrawable) mutate2).setColor(-16777216);
        ...
        ((GradientDrawable) mutate3).setColor(-16777216);
        ...
        mobilePhoneUberAdapter.setOnChoseCarClickListener(new MobilePhoneUberAdapter.OnChosePriorityClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.uber.UberChoseTaxi.1
            @Override // ru.mrlargha.feature.mobile.presentation.adapter.MobilePhoneUberAdapter.OnChosePriorityClickListener
            public void callback(int i) {
                UberChoseTaxi.this.priority = i;
            }
        });
        bind.mpUberFinalLocationContainer.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.uber.UberChoseTaxi$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UberChoseTaxi.this.sendFrontedMessage.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), -1, 9);
            }
        });
        bind.mpUberActionButton.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.uber.UberChoseTaxi$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UberChoseTaxi._init_$lambda$1(UberChoseTaxi.this, view);
            }
        });
        bind.mpUberHeaderBack.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.mobile.presentation.page.uber.UberChoseTaxi$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
