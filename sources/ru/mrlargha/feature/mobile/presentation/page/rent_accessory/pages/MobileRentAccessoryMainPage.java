...
public final class MobileRentAccessoryMainPage {
    ...
    public MobileRentAccessoryMainPage(RentAccessoryPage parentContainer) {
        ...
        this.retrofitClient = new MobileRetrofitClient(parentContainer.getTargetActivity(), UIElementID.ARIZONA_MOBILE_PHONE.getId());
    ...
    private final void getAds() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(Dispatchers.getIO()), null, null, new MobileRentAccessoryMainPage$getAds$1(this, null), 3, null);
        updateWareHouse();
    }
