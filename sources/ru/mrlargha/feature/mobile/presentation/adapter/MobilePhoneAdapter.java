...
public final class MobilePhoneAdapter extends RecyclerView.Adapter<MobilePhoneHolder> {
    ...
    /* compiled from: MobilePhoneAdapter.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\bÀ\u0006\u0003"}, d2 = {"Lru/mrlargha/feature/mobile/presentation/adapter/MobilePhoneAdapter$OnApplicationClickListener;", "", "callback", "", "applicationName", "", "position", "", "mobile"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    public void onBindViewHolder(final MobilePhoneHolder holder, final int i) {
        ...
        MobilePhoneMenu mobilePhoneMenu = this.mobileMenu.get(i);
        Intrinsics.checkNotNullExpressionValue(mobilePhoneMenu, "get(...)");
        MobilePhoneMenu mobilePhoneMenu2 = mobilePhoneMenu;
        if (mobilePhoneMenu2.getNotification() > 0) {
            ...
            holder.getPhoneApplicationBinding().tvMessageCount.setText(String.valueOf(mobilePhoneMenu2.getNotification()));
            return;
        }
