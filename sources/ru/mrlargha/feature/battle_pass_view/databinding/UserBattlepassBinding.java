...
public final class UserBattlepassBinding implements ViewBinding {
    ...
    private UserBattlepassBinding(FrameLayout frameLayout, CustomCardView customCardView, AppCompatImageView appCompatImageView, LinearLayout linearLayout, FrameLayout frameLayout2, RecyclerView recyclerView, RecyclerView recyclerView2, AppCompatTextView appCompatTextView) {
                    ...
                    if (recyclerView != null) {
                        ...
                        if (recyclerView2 != null) {
                            ...
                            if (appCompatTextView != null) {
                                return new UserBattlepassBinding(frameLayout, customCardView, appCompatImageView, linearLayout, frameLayout, recyclerView, recyclerView2, appCompatTextView);
                            }
                        }
                    }
                }
