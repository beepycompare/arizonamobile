...
public final class ArizonaCasesMainPageBinding implements ViewBinding {
    ...
    public final ArizonaCasesPrizesPageBinding prizePage;
    ...
    private ArizonaCasesMainPageBinding(FrameLayout frameLayout, FrameLayout frameLayout2, LinearLayout linearLayout, LinearLayout linearLayout2, CardView cardView, View view, ImageView imageView, ImageView imageView2, ImageView imageView3, LinearLayout linearLayout3, ArizonaCasesPrizesPageBinding arizonaCasesPrizesPageBinding, RecyclerView recyclerView, RecyclerView recyclerView2, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6) {
        this.rootView = frameLayout;
        this.animateContainer = frameLayout2;
        ...
        this.prizePage = arizonaCasesPrizesPageBinding;
    ...
    public static ArizonaCasesMainPageBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ArizonaCasesMainPageBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.arizona_cases_main_page, viewGroup, false);
        if (z) {
    ...
    public static ArizonaCasesMainPageBinding bind(View view) {
        View findChildViewById;
        View findChildViewById2;
        int i = R.id.animate_container;
        FrameLayout frameLayout = (FrameLayout) ViewBindings.findChildViewById(view, i);
        if (frameLayout != null) {
            i = R.id.available_until_conateiner;
                            ...
                            if (imageView2 != null) {
                                ...
                                if (imageView3 != null) {
                                    ...
                                    if (linearLayout3 != null && (findChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.prize_page))) != null) {
                                        ArizonaCasesPrizesPageBinding bind = ArizonaCasesPrizesPageBinding.bind(findChildViewById2);
                                                        ...
                                                        if (textView3 != null) {
                                                            ...
                                                            if (textView4 != null) {
                                                                ...
                                                                if (textView5 != null) {
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        return new ArizonaCasesMainPageBinding((FrameLayout) view, frameLayout, linearLayout, linearLayout2, cardView, findChildViewById, imageView, imageView2, imageView3, linearLayout3, bind, recyclerView, recyclerView2, textView, textView2, textView3, textView4, textView5, textView6);
                                                                    }
                                                                }
                                                            }
                                                        }
