...
public final class CasesInfoModel {
    ...
    public final String m11153getCost() {
        int intValue;
        if (this.countLeft > 0) {
            return "Открыть";
        }
    ...
    public final String m11154getCountLeft() {
    ...
    public final CasesCurrencyType m11155getCurrency() {
        Object obj;
