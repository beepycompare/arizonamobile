...
public final class CasesInfoModel {
    ...
    public final String m11888getCost() {
        if (this.countLeft > 0) {
    ...
    public final String m11889getCountLeft() {
    ...
    public final CasesCurrencyType m11890getCurrency() {
        Object obj;
