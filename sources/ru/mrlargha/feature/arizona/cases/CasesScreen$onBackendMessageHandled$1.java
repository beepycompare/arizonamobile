...
final class CasesScreen$onBackendMessageHandled$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CasesScreen$onBackendMessageHandled$1(String str, CasesScreen casesScreen, Continuation<? super CasesScreen$onBackendMessageHandled$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CasesScreen$onBackendMessageHandled$1(this.$data, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CasesScreen$onBackendMessageHandled$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
