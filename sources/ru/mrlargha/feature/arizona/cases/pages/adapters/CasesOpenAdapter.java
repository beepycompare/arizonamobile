...
import ru.mrlargha.feature.arizona.cases.databinding.CasesOpenItemBinding;
...
public final class CasesOpenAdapter extends ListAdapter<CasesGuaranteedPrizeModel, OpenViewHolder> {
    ...
    /* compiled from: CasesOpenAdapter.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0016\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rJ\u0018\u0010\u000e\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0002J \u0010\u000f\u001a\u00020\t2\u0006\u0010\u0010\u001a\u00020\r2\u0006\u0010\u0011\u001a\u00020\r2\u0006\u0010\u0012\u001a\u00020\u0013H\u0002R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, d2 = {"Lru/mrlargha/feature/arizona/cases/pages/adapters/CasesOpenAdapter$OpenViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "binding", "Lru/mrlargha/feature/arizona/cases/databinding/CasesOpenItemBinding;", "<init>", "(Lru/mrlargha/feature/arizona/cases/pages/adapters/CasesOpenAdapter;Lru/mrlargha/feature/arizona/cases/databinding/CasesOpenItemBinding;)V", "getBinding", "()Lru/mrlargha/feature/arizona/cases/databinding/CasesOpenItemBinding;", "onBind", "", CommonUrlParts.MODEL, "Lru/mrlargha/feature/arizona/cases/CasesGuaranteedPrizeModel;", "position", "", "initialize", "setupListeners", "id", "cost", "isHave", "", "cases_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes6.dex */
    public final class OpenViewHolder extends RecyclerView.ViewHolder {
        private final CasesOpenItemBinding binding;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public OpenViewHolder(CasesOpenAdapter casesOpenAdapter, CasesOpenItemBinding binding) {
        ...
        public final CasesOpenItemBinding getBinding() {
            return this.binding;
        }
        ...
        private final void initialize(CasesGuaranteedPrizeModel casesGuaranteedPrizeModel, int i) {
            ...
            casesOpenItemBinding.bg.setBackgroundResource(casesGuaranteedPrizeModel.getBgType().getResId());
            ...
            if (itemsInfo != null) {
                ImageView ivPrize = casesOpenItemBinding.ivPrize;
                Intrinsics.checkNotNullExpressionValue(ivPrize, "ivPrize");
                CasesResponseKt.getCaseImageUrl(ivPrize, itemsInfo.getIcon());
                casesOpenItemBinding.tvTitle.setText(itemsInfo.getName() + "\n" + casesGuaranteedPrizeModel.m11346getCount());
            }
            casesOpenItemBinding.tvCost.setText("+" + casesGuaranteedPrizeModel.getShards());
            TextView tvClose = casesOpenItemBinding.tvClose;
            Intrinsics.checkNotNullExpressionValue(tvClose, "tvClose");
            tvClose.setVisibility(casesOpenAdapter.isOpen() ? 4 : 0);
            FrameLayout openContainer = casesOpenItemBinding.openContainer;
            ...
            LinearLayout costContainer = casesOpenItemBinding.costContainer;
            ...
            casesOpenItemBinding.ivCheck.setAlpha(casesOpenAdapter.getSelectList().contains(Integer.valueOf(i)) ? 1.0f : 0.36f);
            ...
            if (!casesOpenAdapter.isOpen()) {
                if (casesOpenAdapter.getOpenList().contains(Integer.valueOf(i))) {
                    casesOpenItemBinding.bg.setAlpha(1.0f);
                    TextView tvClose2 = casesOpenItemBinding.tvClose;
                    Intrinsics.checkNotNullExpressionValue(tvClose2, "tvClose");
                    tvClose2.setVisibility(4);
                    FrameLayout openContainer2 = casesOpenItemBinding.openContainer;
                    Intrinsics.checkNotNullExpressionValue(openContainer2, "openContainer");
                    openContainer2.setVisibility(0);
                    LinearLayout costContainer2 = casesOpenItemBinding.costContainer;
                    Intrinsics.checkNotNullExpressionValue(costContainer2, "costContainer");
                    costContainer2.setVisibility(0);
                    casesOpenItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesOpenAdapter$OpenViewHolder$$ExternalSyntheticLambda0
            ...
            if (!(list2 instanceof Collection) || !list2.isEmpty()) {
                for (CasesUsedModel casesUsedModel2 : list2) {
                    if (casesUsedModel2.getItemId() == i) {
                        casesOpenItemBinding.ivCheck.setAlpha(1.0f);
                        casesOpenItemBinding.ivCheck.setColorFilter(Color.parseColor("#7FDD2D"));
                        LinearLayout costContainer4 = casesOpenItemBinding.costContainer;
                        Intrinsics.checkNotNullExpressionValue(costContainer4, "costContainer");
                        costContainer4.setVisibility(4);
                        List<CasesUsedModel> list3 = casesOpenAdapter.usedPrize;
                        if ((list3 instanceof Collection) && list3.isEmpty()) {
                            return;
                        }
                        for (CasesUsedModel casesUsedModel3 : list3) {
                            if (casesUsedModel3.getItemId() == i) {
                                Iterator it2 = casesOpenAdapter.usedPrize.iterator();
                                while (true) {
                                    if (!it2.hasNext()) {
                                        obj2 = null;
                                        break;
                                ...
                                CasesUsedModel casesUsedModel4 = (CasesUsedModel) obj2;
                                if (casesUsedModel4 != null) {
                                    int i2 = WhenMappings.$EnumSwitchMapping$0[casesUsedModel4.getUsedType().ordinal()];
                                    if (i2 == 1) {
                                        TextView tvGotIt2 = casesOpenItemBinding.tvGotIt;
                                        Intrinsics.checkNotNullExpressionValue(tvGotIt2, "tvGotIt");
                                        tvGotIt2.setVisibility(0);
                                        TextView tvSchism2 = casesOpenItemBinding.tvSchism;
                                        ...
                                        TextView tvGotIt3 = casesOpenItemBinding.tvGotIt;
                                        Intrinsics.checkNotNullExpressionValue(tvGotIt3, "tvGotIt");
                                        tvGotIt3.setVisibility(8);
                                        TextView tvSchism3 = casesOpenItemBinding.tvSchism;
            ...
            LinearLayout costContainer5 = casesOpenItemBinding.costContainer;
        ...
        private final void setupListeners(final int i, final int i2, boolean z) {
            ...
            if (casesOpenAdapter.isOpen()) {
                if (!z && casesOpenAdapter.getCurrentList().size() > 1) {
                    casesOpenItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesOpenAdapter$OpenViewHolder$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                    ...
                    casesOpenItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesOpenAdapter$OpenViewHolder$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
            ...
            casesOpenItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesOpenAdapter$OpenViewHolder$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public OpenViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        CasesOpenItemBinding inflate = CasesOpenItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
