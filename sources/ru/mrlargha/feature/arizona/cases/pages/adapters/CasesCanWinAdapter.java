...
public final class CasesCanWinAdapter extends ListAdapter<CasesGuaranteedPrizeModel, CanWinViewHolder> {
    ...
    /* compiled from: CasesCanWinAdapter.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u000e\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bJ\u0010\u0010\f\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0002R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\r"}, d2 = {"Lru/mrlargha/feature/arizona/cases/pages/adapters/CasesCanWinAdapter$CanWinViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "binding", "Lru/mrlargha/feature/arizona/cases/databinding/ArizonaCasesCanWinItemBinding;", "<init>", "(Lru/mrlargha/feature/arizona/cases/pages/adapters/CasesCanWinAdapter;Lru/mrlargha/feature/arizona/cases/databinding/ArizonaCasesCanWinItemBinding;)V", "getBinding", "()Lru/mrlargha/feature/arizona/cases/databinding/ArizonaCasesCanWinItemBinding;", "onBind", "", CommonUrlParts.MODEL, "Lru/mrlargha/feature/arizona/cases/CasesGuaranteedPrizeModel;", "initialize", "cases"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    public final class CanWinViewHolder extends RecyclerView.ViewHolder {
        private final ArizonaCasesCanWinItemBinding binding;
        final /* synthetic */ CasesCanWinAdapter this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public CanWinViewHolder(CasesCanWinAdapter casesCanWinAdapter, ArizonaCasesCanWinItemBinding binding) {
        ...
        public final ArizonaCasesCanWinItemBinding getBinding() {
            return this.binding;
        }
        ...
        private final void initialize(final CasesGuaranteedPrizeModel casesGuaranteedPrizeModel) {
            Object obj;
            ArizonaCasesCanWinItemBinding arizonaCasesCanWinItemBinding = this.binding;
            final CasesCanWinAdapter casesCanWinAdapter = this.this$0;
            arizonaCasesCanWinItemBinding.getRoot().setBackgroundResource(casesGuaranteedPrizeModel.getBgType().getResId());
            ...
            if (itemsInfo != null) {
                ...
                textView.setText(name + "\n" + casesGuaranteedPrizeModel.m11892getCount());
                if (casesGuaranteedPrizeModel.getCustom_image() != null) {
                    ...
                    ImageView ivPrize2 = arizonaCasesCanWinItemBinding.ivPrize;
            ...
            if (isVehicle != null && isVehicle.intValue() == 1) {
                arizonaCasesCanWinItemBinding.qualityButton1.setVisibility(0);
                arizonaCasesCanWinItemBinding.qualityButton1.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesCanWinAdapter$CanWinViewHolder$$ExternalSyntheticLambda0
                ...
                arizonaCasesCanWinItemBinding.qualityButton1.setVisibility(8);
            }
            arizonaCasesCanWinItemBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.arizona.cases.pages.adapters.CasesCanWinAdapter$CanWinViewHolder$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public CanWinViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        ArizonaCasesCanWinItemBinding inflate = ArizonaCasesCanWinItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    /* compiled from: CasesCanWinAdapter.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0018\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0002H\u0016J\u0018\u0010\t\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0002H\u0016¨\u0006\n"}, d2 = {"Lru/mrlargha/feature/arizona/cases/pages/adapters/CasesCanWinAdapter$DiffUtilCallback;", "Landroidx/recyclerview/widget/DiffUtil$ItemCallback;", "Lru/mrlargha/feature/arizona/cases/CasesGuaranteedPrizeModel;", "<init>", "()V", "areItemsTheSame", "", "oldItem", "newItem", "areContentsTheSame", "cases"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
