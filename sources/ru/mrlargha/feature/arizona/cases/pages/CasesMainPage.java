...
public final class CasesMainPage implements CasesBasePage {
    ...
    private final Job initialize(CasesInfoModel casesInfoModel) {
        ...
        arizonaCasesMainPageBinding.tvCountLeft.setText(casesInfoModel.m12424getCountLeft());
        setSelectXType(true);
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[casesInfoModel.m12425getCurrency().ordinal()];
        if (i == 1) {
