...
public final class CasesMainPage implements CasesBasePage {
    ...
    private final Job initialize(CasesInfoModel casesInfoModel) {
        ...
        arizonaCasesMainPageBinding.tvCountLeft.setText(casesInfoModel.m11895getCountLeft());
        setSelectXType(true);
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[casesInfoModel.m11896getCurrency().ordinal()];
        if (i == 1) {
