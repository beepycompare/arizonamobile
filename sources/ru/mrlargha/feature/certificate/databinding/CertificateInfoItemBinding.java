...
public final class CertificateInfoItemBinding implements ViewBinding {
    ...
    private CertificateInfoItemBinding(ConstraintLayout constraintLayout, ImageView imageView, ConstraintLayout constraintLayout2, TextView textView, TextView textView2, TextView textView3) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        return new CertificateInfoItemBinding(constraintLayout, imageView, constraintLayout, textView, textView2, textView3);
                    }
                }
            }
        }
