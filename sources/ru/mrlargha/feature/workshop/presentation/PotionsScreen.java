    ...
    public final void addLockedItems() {
        ...
        if (list != null) {
            ...
            for (InventoryItem inventoryItem2 : list2) {
                arrayList.add(InventoryItem.copy$default(inventoryItem2, 0, null, 0, null, null, null, null, null, null, null, null, Integer.valueOf(!CollectionsKt.contains(this.availableList, inventoryItem2.getItem()) ? 1 : 0), null, null, null, null, 0, null, null, false, false, null, null, 8386559, null));
            }
        ...
        if (i == 1) {
            ...
            if (i == UIElementID.INVENTORY.getId()) {
                ...
                for (InventoryItem inventoryItem3 : items) {
                    ...
                    arrayList.add(InventoryItem.copy$default(inventoryItem3, 0, null, 0, null, valueOf, null, null, null, null, null, null, null, null, null, null, null, type2, itemsInfo2 != null ? Integer.valueOf(itemsInfo2.getAcs_slot()) : null, null, false, false, null, null, 8191983, null));
                }
