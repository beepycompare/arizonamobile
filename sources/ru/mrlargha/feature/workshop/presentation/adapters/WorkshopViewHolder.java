...
public final class WorkshopViewHolder extends RecyclerView.ViewHolder {
    ...
    public final void bind(final InventoryItem itemVal) {
        ...
        itemInventoryBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.workshop.presentation.adapters.WorkshopViewHolder$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
