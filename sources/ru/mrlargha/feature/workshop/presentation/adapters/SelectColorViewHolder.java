...
public final class SelectColorViewHolder extends RecyclerView.ViewHolder {
    ...
    public final void bind(final ItemColor item, int i, int i2) {
        ...
        itemWorkbenchColorBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.feature.workshop.presentation.adapters.SelectColorViewHolder$$ExternalSyntheticLambda0
