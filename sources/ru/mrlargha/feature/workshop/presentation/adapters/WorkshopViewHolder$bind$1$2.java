...
@DebugMetadata(c = "ru.mrlargha.feature.workshop.presentation.adapters.WorkshopViewHolder$bind$1$2", f = "WorkshopViewHolder.kt", i = {}, l = {68}, m = "invokeSuspend", n = {}, nl = {TsExtractor.TS_SYNC_BYTE}, s = {}, v = 2)
/* loaded from: classes6.dex */
public final class WorkshopViewHolder$bind$1$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WorkshopViewHolder$bind$1$2(ItemInventoryBinding itemInventoryBinding, WorkshopViewHolder workshopViewHolder, InventoryItem inventoryItem, Continuation<? super WorkshopViewHolder$bind$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WorkshopViewHolder$bind$1$2(this.$this_with, this.this$0, this.$itemVal, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WorkshopViewHolder$bind$1$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new WorkshopViewHolder$bind$1$2$bitmap$1(this.$itemVal, null), this);
