    ...
    public final void onApplicationOpened() {
        this.viewPagerAdapter.setOnApplicationClickListener(new ViewPageAdapter.OnApplicationClickListener() { // from class: ru.mrlargha.arizonaui.mobile.presentation.page.MobilePhoneMainPage$onApplicationOpened$1
            ...
            public void callback(String applicationName, int i) {
                ...
                IBackendNotifier iBackendNotifier35;
                IBackendNotifier iBackendNotifier36;
                ...
                switch (applicationName.hashCode()) {
                    ...
                    case 859900293:
                        ...
                        return;
                    case 871287981:
                        if (applicationName.equals("Лог продаж")) {
                            iBackendNotifier19 = MobilePhoneMainPage.this.sendFrontedMessage;
                            iBackendNotifier19.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), i + 24, 0);
                            return;
                        }
                        return;
                    case 935241912:
                    ...
                    case 979596910:
                        if (applicationName.equals("Навигатор")) {
                            ...
                            iBackendNotifier21.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), i, 0);
                            return;
                        }
                        return;
                    case 1000005094:
                    ...
                    case 1009322299:
                        if (applicationName.equals("Селфи")) {
                            ...
                            iBackendNotifier24.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), i + 24, 0);
                            return;
                        }
                        return;
                    case 1020865357:
                    ...
                    case 1195705782:
                        if (applicationName.equals("Репорт")) {
                            ...
                            iBackendNotifier27.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), i, 0);
                            return;
                        }
                        return;
                    case 1204476576:
                    ...
                    case 2038453418:
                        if (applicationName.equals("Банковское меню")) {
                            iBackendNotifier35 = MobilePhoneMainPage.this.sendFrontedMessage;
                            iBackendNotifier35.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), 23, 0);
                            return;
                        }
                        return;
                    case 2055308360:
                        if (applicationName.equals("Driver")) {
                            ...
                            iBackendNotifier36 = MobilePhoneMainPage.this.sendFrontedMessage;
                            iBackendNotifier36.clickedWrapper(UIElementID.ARIZONA_MOBILE_PHONE.getId(), i, 0);
                            return;
                        }
                        return;
                    default:
