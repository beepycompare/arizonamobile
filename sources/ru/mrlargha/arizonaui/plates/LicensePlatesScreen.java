    ...
    */
    private final Companion.GeneratedPlateResponse parseGeneratedPlate(String str) {
        ...
        if (MapperKt.isJsonValid(str) && !Intrinsics.areEqual(str, AbstractJsonLexerKt.NULL) && !Intrinsics.areEqual(str, "{}") && str.length() != 0) {
            ...
            m9916constructorimpl = Result.m9916constructorimpl((Companion.GeneratedPlateResponse) obj);
            if (Result.m9922isFailureimpl(m9916constructorimpl)) {
                m9916constructorimpl = null;
            }
            Companion.GeneratedPlateResponse generatedPlateResponse = (Companion.GeneratedPlateResponse) m9916constructorimpl;
        ...
        Companion.GeneratedPlateResponse generatedPlateResponse2 = (Companion.GeneratedPlateResponse) m9916constructorimpl;
