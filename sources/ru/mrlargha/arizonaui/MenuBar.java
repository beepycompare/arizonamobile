...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001:\u0001\nB\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Lru/mrlargha/arizonaui/MenuBar;", "Lru/mrlargha/commonui/core/SAMPUIElement;", "activity", "Landroid/app/Activity;", "backendID", "", "<init>", "(Landroid/app/Activity;I)V", "menuLayout", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Spawner", "ArizonaUI"}, k = 1, mv = {2, 3, 0}, xi = 48)
...
public final class MenuBar extends SAMPUIElement {
    ...
    public MenuBar(Activity activity, final int i) {
        ...
        ((MaterialButton) constraintLayout.findViewById(R.id.escape)).setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.arizonaui.MenuBar$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MenuBar.this.getNotifier().clickedWrapper(i, 1, -1);
            }
        });
        setVisibility(false);
    }
