...
public final class CarsSecondScreenCarParamItemBinding implements ViewBinding {
    ...
    private CarsSecondScreenCarParamItemBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ImageView imageView, TextView textView) {
    ...
    public static CarsSecondScreenCarParamItemBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                return new CarsSecondScreenCarParamItemBinding(constraintLayout, constraintLayout, imageView, textView);
            }
        }
