...
public final class GhettoScreen$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ int $backendID$inlined;
    final /* synthetic */ Activity $targetActivity$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GhettoScreen$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Key key, Activity activity, int i) {
        super(key);
