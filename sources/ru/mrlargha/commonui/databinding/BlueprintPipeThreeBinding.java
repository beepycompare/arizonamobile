...
public final class BlueprintPipeThreeBinding implements ViewBinding {
    ...
    public static BlueprintPipeThreeBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static BlueprintPipeThreeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.blueprint_pipe_three, parent, false);
        if (attachToParent) {
    ...
    public static BlueprintPipeThreeBinding bind(View rootView) {
