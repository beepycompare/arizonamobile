...
public final class HudRodinaTrainJobBinding implements ViewBinding {
    ...
    public final HudRodinaTrainInstructionBinding trainInstruction;
    ...
    public final HudRodinaTrainSpeedIndicatorBinding trainSpeedIndicator;
    public final HudTrainStopPanelBinding trainStopPanel;
    public final TextView warningsCount;

    private HudRodinaTrainJobBinding(FrameLayout rootView, FrameLayout hudTrainJob, TextView income, LinearLayout legacyTrainData, TextView speedLimit, CustomCardView speedLimitCard, TextView speedLimitDistance, CustomCardView speedLimitDistanceCard, FrameLayout trainBottomIndicators, HudTrainCallPanelBinding trainCallPanel, TextView trainCurrentTime, HudTrainDispatcherPanelBinding trainDispatcherPanel, CustomCardView trainDoorCloseAction, ImageView trainDoorLockedIcon, CustomCardView trainDoorOpenAction, ImageView trainDoorUnlockedIcon, FrameLayout trainDriverContainer, HudTrainFullControlPanelBinding trainFullControlPanel, HudRodinaTrainInstructionBinding trainInstruction, TextView trainMaxTime, TextView trainPassengerCount, LinearLayout trainPassengers, HudTrainRouteBinding trainRoute, FrameLayout trainSettings, HudRodinaTrainSpeedIndicatorBinding trainSpeedIndicator, HudTrainStopPanelBinding trainStopPanel, TextView warningsCount) {
    ...
    public static HudRodinaTrainJobBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static HudRodinaTrainJobBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.hud_rodina_train_job, parent, false);
        if (attachToParent) {
    ...
    public static HudRodinaTrainJobBinding bind(View rootView) {
                                                    ...
                                                    if (imageView2 != null) {
                                                        ...
                                                        if (frameLayout3 != null && (findChildViewById3 = ViewBindings.findChildViewById(rootView, (i = R.id.train_full_control_panel))) != null) {
                                                            ...
                                                            if (findChildViewById6 != null) {
                                                                HudRodinaTrainInstructionBinding bind4 = HudRodinaTrainInstructionBinding.bind(findChildViewById6);
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        ...
                                                                        if (linearLayout2 != null && (findChildViewById4 = ViewBindings.findChildViewById(rootView, (i = R.id.train_route))) != null) {
                                                                            ...
                                                                            if (frameLayout4 != null && (findChildViewById5 = ViewBindings.findChildViewById(rootView, (i = R.id.train_speed_indicator))) != null) {
                                                                                HudRodinaTrainSpeedIndicatorBinding bind6 = HudRodinaTrainSpeedIndicatorBinding.bind(findChildViewById5);
                                                                                ...
                                                                                if (findChildViewById7 != null) {
                                                                                    ...
                                                                                    if (textView7 != null) {
                                                                                        return new HudRodinaTrainJobBinding(frameLayout, frameLayout, textView, linearLayout, textView2, customCardView, textView3, customCardView2, frameLayout2, bind, textView4, bind2, customCardView3, imageView, customCardView4, imageView2, frameLayout3, bind3, bind4, textView5, textView6, linearLayout2, bind5, frameLayout4, bind6, bind7, textView7);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
