...
public final class WorkshopScreenBinding implements ViewBinding {
    ...
    public static WorkshopScreenBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static WorkshopScreenBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.workshop_screen, parent, false);
        if (attachToParent) {
    ...
    public static WorkshopScreenBinding bind(View rootView) {
                                                                ...
                                                                if (progressBar != null && (findChildViewById3 = ViewBindings.findChildViewById(rootView, (i = R.id.rightItemField))) != null) {
                                                                    ...
                                                                    if (recyclerView != null) {
                                                                        ...
                                                                        if (recyclerView2 != null) {
                                                                            ...
                                                                            if (recyclerView3 != null && (findChildViewById4 = ViewBindings.findChildViewById(rootView, (i = R.id.successChanceField))) != null) {
                                                                                                    ...
                                                                                                    if (textView6 != null) {
                                                                                                        ...
                                                                                                        if (textView7 != null) {
                                                                                                            ...
                                                                                                            if (textView8 != null) {
                                                                                                                ...
                                                                                                                if (imageView2 != null) {
                                                                                                                    return new WorkshopScreenBinding(constraintLayout, appCompatImageView, button, button2, bind, bind2, group, guideline, guideline2, guideline3, guideline4, guideline5, guideline6, imageView, linearLayout, bind3, bind4, constraintLayout, progressBar, bind5, recyclerView, recyclerView2, recyclerView3, bind6, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, imageView2);
                                                                                                                }
                                                                                                            }
                                                                                                        }
                                                                                                    }
