...
public final class TradeScreenBinding implements ViewBinding {
    ...
    private TradeScreenBinding(ConstraintLayout rootView, Button btnAccept, AppCompatImageView btnBack, Button btnCancel, CustomCardView btnReceiveItem, CustomCardView btnSendItem, EditText etReceiveItems, EditText etSendItems, Group groupProgressBar, Guideline guidelineHor1, Guideline guidelineHor2, Guideline guidelineVer1, Guideline guidelineVer2, Guideline guidelineVer3, Guideline guidelineVer4, ImageView ivReceiveStatus, ImageView ivSendStatus, LinearLayout layoutButtons, ConstraintLayout parentLayout, ProgressBar progressBar, LinearLayout receiveItemsContainer, RecyclerView rvInventory, RecyclerView rvReceiveItems, RecyclerView rvSendItems, LinearLayout sendItemContainer, TextView tvLoadingTitle, TextView tvReceiveItems, TextView tvSendItems, TextView tvTitle, ImageView viewLine) {
                                                                                                        ...
                                                                                                        if (textView2 != null) {
                                                                                                            ...
                                                                                                            if (textView3 != null) {
                                                                                                                ...
                                                                                                                if (textView4 != null) {
                                                                                                                    ...
                                                                                                                    if (imageView3 != null) {
                                                                                                                        return new TradeScreenBinding(constraintLayout, button, appCompatImageView, button2, customCardView, customCardView2, editText, editText2, group, guideline, guideline2, guideline3, guideline4, guideline5, guideline6, imageView, imageView2, linearLayout, constraintLayout, progressBar, linearLayout2, recyclerView, recyclerView2, recyclerView3, linearLayout3, textView, textView2, textView3, textView4, imageView3);
                                                                                                                    }
                                                                                                                }
                                                                                                            }
                                                                                                        }
