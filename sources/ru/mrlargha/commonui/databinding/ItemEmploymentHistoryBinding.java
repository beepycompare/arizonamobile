...
public final class ItemEmploymentHistoryBinding implements ViewBinding {
    ...
    public static ItemEmploymentHistoryBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemEmploymentHistoryBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_employment_history, parent, false);
        if (attachToParent) {
    ...
    public static ItemEmploymentHistoryBinding bind(View rootView) {
                                            ...
                                            if (materialTextView4 != null) {
                                                ...
                                                if (materialTextView5 != null) {
                                                    ...
                                                    if (materialTextView6 != null) {
                                                        return new ItemEmploymentHistoryBinding((ConstraintLayout) rootView, guideline, guideline2, guideline3, guideline4, guideline5, constraintLayout, materialTextView, materialTextView2, materialTextView3, materialTextView4, materialTextView5, materialTextView6);
                                                    }
                                                }
                                            }
                                        }
