...
public final class PromoElementBinding implements ViewBinding {
    ...
    public static PromoElementBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static PromoElementBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.promo_element, parent, false);
        if (attachToParent) {
    ...
    public static PromoElementBinding bind(View rootView) {
        int i = R.id.card;
