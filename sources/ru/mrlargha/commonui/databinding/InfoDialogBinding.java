...
public final class InfoDialogBinding implements ViewBinding {
    ...
    public final LinearLayout infoDialogAnimatedBar;
    public final TextView infoDialogAnimatedBarLabel;
    public final CustomCardView infoDialogAnimatedBarProgress;
    ...
    private InfoDialogBinding(FrameLayout rootView, ImageView btnCancel, DialogButtonsBinding buttons, TextView caption, LinearLayout infoDialogAnimatedBar, TextView infoDialogAnimatedBarLabel, CustomCardView infoDialogAnimatedBarProgress, FrameLayout infoDialogLayout, CustomCardView infoDialogListItemTabPrimary, TextView infoDialogListItemTabPrimaryText, CustomCardView infoDialogListItemTabSecondary, TextView infoDialogListItemTabSecondaryText, CustomCardView infoDialogListItemTabs, TextView infoText) {
        this.rootView = rootView;
        this.btnCancel = btnCancel;
        this.buttons = buttons;
        this.caption = caption;
        this.infoDialogAnimatedBar = infoDialogAnimatedBar;
        this.infoDialogAnimatedBarLabel = infoDialogAnimatedBarLabel;
        this.infoDialogAnimatedBarProgress = infoDialogAnimatedBarProgress;
    ...
    public static InfoDialogBinding bind(View rootView) {
        ...
        if (imageView != null && (findChildViewById = ViewBindings.findChildViewById(rootView, (i = R.id.buttons))) != null) {
            ...
            if (textView != null) {
                i = R.id.info_dialog_animated_bar;
                LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
                if (linearLayout != null) {
                    i = R.id.info_dialog_animated_bar_label;
                    TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, i);
                    if (textView2 != null) {
                        i = R.id.info_dialog_animated_bar_progress;
                                    ...
                                    if (customCardView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (customCardView4 != null) {
                                                ...
                                                if (textView5 != null) {
                                                    return new InfoDialogBinding(frameLayout, imageView, bind, textView, linearLayout, textView2, customCardView, frameLayout, customCardView2, textView3, customCardView3, textView4, customCardView4, textView5);
                                                }
                                            }
                                        }
                                    }
