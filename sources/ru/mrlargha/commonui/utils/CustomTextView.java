...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u0000 #2\u00020\u0001:\u0001#B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\u0018\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\rH\u0002J\u0010\u0010\u001b\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\rH\u0002J$\u0010\u001c\u001a\u00020\t2\u0006\u0010\u001d\u001a\u00020\t2\u0012\u0010\u001e\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\u00190\u001fH\u0002J\"\u0010 \u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010!\u001a\u00020\u000b2\u0006\u0010\"\u001a\u00020\u0014H\u0002R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u0004¢\u0006\u0002\n\u0000R\u0017\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012R!\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00140\u000f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0016\u0010\u0017\u001a\u0004\b\u0015\u0010\u0012Ê\u0001\u0010\b%\u0012\f\b&\u0012\b\b\fJ\u0004\b\b('¨\u0006$"}, d2 = {"Lru/mrlargha/commonui/utils/CustomTextView;", "Landroidx/appcompat/widget/AppCompatTextView;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "builder", "Landroid/text/SpannableStringBuilder;", "typeArray", "Landroid/content/res/TypedArray;", "colorListString", "", "fonts", "", "Landroid/graphics/Typeface;", "getFonts", "()Ljava/util/List;", "colors", "", "getColors", "colors$delegate", "Lkotlin/Lazy;", "applyColoredTags", "", "raw", "applyColorWithFontTags", "addSpansOverExistingText", TtmlNode.RUBY_BASE, "apply", "Lkotlin/Function1;", "getTypefaceFromAttr", "ta", "attrId", "Companion", "CommonUI", "Landroid/annotation/SuppressLint;", "value", "NewApi"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class CustomTextView extends AppCompatTextView {
    ...
    public CustomTextView(Context context, AttributeSet attrs) {
        ...
        this.colors$delegate = LazyKt.lazy(new Function0() { // from class: ru.mrlargha.commonui.utils.CustomTextView$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return CustomTextView.colors_delegate$lambda$0(CustomTextView.this);
            }
        });
        post(new Runnable() { // from class: ru.mrlargha.commonui.utils.CustomTextView$$ExternalSyntheticLambda1
    ...
    private final void applyColorWithFontTags(String str) {
        ...
        for (MatchResult matchResult : Regex.findAll$default(new Regex("<cf(\\d+)>(.*?)</cf\\d+>"), str, 0, 2, null)) {
            ...
            if (str3.length() > 0) {
                int length = this.builder.length();
                this.builder.append((CharSequence) str3);
                this.builder.setSpan(new FontColorSpan(((Number) CollectionsKt.first((List<? extends Object>) getColors())).intValue(), (Typeface) CollectionsKt.first((List<? extends Object>) this.fonts)), length, this.builder.length(), 33);
            }
            int length2 = this.builder.length();
            this.builder.append((CharSequence) str2);
            int length3 = this.builder.length();
            ...
            Typeface typeface = (Typeface) CollectionsKt.getOrNull(this.fonts, intValue % getColors().size());
            if (typeface == null) {
        ...
        if (i < str.length()) {
            ...
            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
            spannableStringBuilder.append((CharSequence) substring2);
            this.builder.setSpan(new FontColorSpan(((Number) CollectionsKt.first((List<? extends Object>) getColors())).intValue(), (Typeface) CollectionsKt.first((List<? extends Object>) this.fonts)), length4, this.builder.length(), 33);
        }
    }
