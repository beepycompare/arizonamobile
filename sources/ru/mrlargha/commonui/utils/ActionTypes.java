...
public final class ActionTypes {
    ...
    public static final ActionTypes INVENT_BUTTON_TYPE_EMPTY = new ActionTypes("INVENT_BUTTON_TYPE_EMPTY", 20, 1048576);
    public static final ActionTypes INVENT_BUTTON_TYPE_CANCEL_RENT = new ActionTypes("INVENT_BUTTON_TYPE_CANCEL_RENT", 21, 2097152);
    public static final ActionTypes INVENT_BUTTON_TYPE_RATING = new ActionTypes("INVENT_BUTTON_TYPE_RATING", 22, 4194304);
    public static final ActionTypes INVENT_BUTTON_TYPE_ACTIVE = new ActionTypes("INVENT_BUTTON_TYPE_ACTIVE", 23, 8388608);
    public static final ActionTypes INVENT_BUTTON_TYPE_DEACTIVE = new ActionTypes("INVENT_BUTTON_TYPE_DEACTIVE", 24, 16777216);
