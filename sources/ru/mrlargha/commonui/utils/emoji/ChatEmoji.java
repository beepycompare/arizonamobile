...
public final class ChatEmoji {
    ...
    */
    ...
    public final SpannableString toSpannable(CharSequence charSequence, float f) {
        ...
        return applyIconFont(tagsColor(tagsHtml(parseEmojiInText(charSequence))), f);
    }
