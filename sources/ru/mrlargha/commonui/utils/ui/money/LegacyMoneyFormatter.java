...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J,\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\b\u001a\u00020\t2\b\b\u0002\u0010\n\u001a\u00020\u00052\b\b\u0002\u0010\u000b\u001a\u00020\u0005J\u0018\u0010\f\u001a\u00020\u00052\u0006\u0010\r\u001a\u00020\u00072\b\b\u0002\u0010\n\u001a\u00020\u0005J\u000e\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0006\u001a\u00020\u0007J\u0018\u0010\u0010\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00112\b\b\u0002\u0010\u0012\u001a\u00020\t¨\u0006\u0013"}, d2 = {"Lru/mrlargha/commonui/utils/ui/money/LegacyMoneyFormatter;", "", "<init>", "()V", "format", "", "value", "", "isInvert", "", "prefix", "postfix", "formatMoneyShort", "rawValue", "splitValue", "Lru/mrlargha/commonui/utils/ui/money/MoneyParts;", "formatK", "", "dropFractionForWholeValues", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class LegacyMoneyFormatter {
    ...
    public final String format(long j, boolean z, String prefix, String postfix) {
        ...
        if (UtilsKt.isArizonaType()) {
            ...
            if (z) {
                ...
                sb.append(formatK$default(INSTANCE, splitValue.getK(), false, 2, null));
                sb.append(":k:");
            } else {
                if (splitValue.getM() > 0) {
                    sb.append(":m:");
    ...
    public static /* synthetic */ String formatK$default(LegacyMoneyFormatter legacyMoneyFormatter, int i, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = false;
        }
        return legacyMoneyFormatter.formatK(i, z);
    }

    public final String formatK(int i, boolean z) {
        int coerceIn = RangesKt.coerceIn(i, 0, 999999);
        int i2 = coerceIn / 1000;
        int i3 = coerceIn % 1000;
        if (z && i3 == 0) {
            return String.valueOf(i2);
        }
        return i2 + "." + StringsKt.padStart(String.valueOf(i3), 3, '0');
    }
}
