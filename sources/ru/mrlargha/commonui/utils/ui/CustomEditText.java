...
public final class CustomEditText extends AppCompatEditText {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setAlpha(RodinaTrainSpeedGaugeView.MAX_SPEED_KMH);
