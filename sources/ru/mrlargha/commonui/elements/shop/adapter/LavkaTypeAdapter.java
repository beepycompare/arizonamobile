...
public final class LavkaTypeAdapter extends ListAdapter<InventoryItem, LavkaTypeViewHolder> {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onViewRecycled(LavkaTypeViewHolder holder) {
        Intrinsics.checkNotNullParameter(holder, "holder");
        holder.recycle();
        super.onViewRecycled((LavkaTypeAdapter) holder);
    }

    /* compiled from: LavkaTypeAdapter.kt */
    @Metadata(d1 = {"\u0000\u0013\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\b\u0003*\u0001\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0010\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0006¨\u0006\u0007"}, d2 = {"Lru/mrlargha/commonui/elements/shop/adapter/LavkaTypeAdapter$Companion;", "", "<init>", "()V", "COMPARATOR", "ru/mrlargha/commonui/elements/shop/adapter/LavkaTypeAdapter$Companion$COMPARATOR$1", "Lru/mrlargha/commonui/elements/shop/adapter/LavkaTypeAdapter$Companion$COMPARATOR$1;", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
