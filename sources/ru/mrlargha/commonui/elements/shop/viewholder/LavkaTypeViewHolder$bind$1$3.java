...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.shop.viewholder.LavkaTypeViewHolder$bind$1$3", f = "LavkaTypeViewHolder.kt", i = {}, l = {49}, m = "invokeSuspend", n = {}, nl = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_BASELINE_TO_TOP_OF}, s = {}, v = 2)
/* loaded from: classes6.dex */
public final class LavkaTypeViewHolder$bind$1$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LavkaTypeViewHolder$bind$1$3(ItemInventoryBinding itemInventoryBinding, LavkaTypeViewHolder lavkaTypeViewHolder, InventoryItem inventoryItem, Continuation<? super LavkaTypeViewHolder$bind$1$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LavkaTypeViewHolder$bind$1$3(this.$this_with, this.this$0, this.$itemVal, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LavkaTypeViewHolder$bind$1$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new LavkaTypeViewHolder$bind$1$3$bitmap$1(this.$itemVal, null), this);
