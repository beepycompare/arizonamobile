...
public final class RewardsScreen extends SAMPUIElement {
    ...
    public RewardsScreen(Activity targetActivity, final int i) {
        ...
        this.binding = bind;
        this.path = "systems/reward_banner/";
    ...
    private final void setRewardScreenInfo(Companion.RewardScreenInfo rewardScreenInfo) {
        ...
        int i = 0;
        PicassoLoadSafeKt.loadSafe(picasso, FirebaseConfigHelper.INSTANCE.getProjectResourceUrl(false) + this.path + "background/" + rewardScreenInfo.getBackground()).into(rewardsLayoutBinding.layoutBg);
        ...
        for (Object obj : rewardScreenInfo.getRewards()) {
            ...
            if (i == 0) {
                RewardsLayoutItemBinding firstItem = rewardsLayoutBinding.firstItem;
                Intrinsics.checkNotNullExpressionValue(firstItem, "firstItem");
                setItemReward(firstItem, rewardItem, rewardScreenInfo);
            } else if (i == 1) {
                RewardsLayoutItemBinding firstLongItem = rewardsLayoutBinding.firstLongItem;
                Intrinsics.checkNotNullExpressionValue(firstLongItem, "firstLongItem");
                setItemReward(firstLongItem, rewardItem, rewardScreenInfo);
            } else if (i == 2) {
                RewardsLayoutItemBinding secondItem = rewardsLayoutBinding.secondItem;
                Intrinsics.checkNotNullExpressionValue(secondItem, "secondItem");
                setItemReward(secondItem, rewardItem, rewardScreenInfo);
            } else if (i == 3) {
                RewardsLayoutItemBinding secondLongItem = rewardsLayoutBinding.secondLongItem;
                Intrinsics.checkNotNullExpressionValue(secondLongItem, "secondLongItem");
                setItemReward(secondLongItem, rewardItem, rewardScreenInfo);
            }
            i = i2;
        }
    }
    ...
    private final void setItemReward(RewardsLayoutItemBinding rewardsLayoutItemBinding, Companion.RewardItem rewardItem, Companion.RewardScreenInfo rewardScreenInfo) {
        ...
        PicassoLoadSafeKt.loadSafe(picasso, projectResourceUrl$default + str + "items/" + rewardItem.getImage()).into(rewardsLayoutItemBinding.shortPrizeIc);
        ...
        if (rewardItem.getBadge().length() > 0) {
            rewardsLayoutItemBinding.shortPrizeTimeContainer.setVisibility(0);
            rewardsLayoutItemBinding.shortPrizeTimeContainer.setBackgroundTintList(ColorStateList.valueOf(parseColor));
            rewardsLayoutItemBinding.shortPrizeTimeDescription.setText(rewardItem.getBadge());
        } else {
            rewardsLayoutItemBinding.shortPrizeTimeContainer.setVisibility(8);
        }
        rewardsLayoutItemBinding.shortPrizeIcContainer.setBackground(parseColor);
        rewardsLayoutItemBinding.shortPrize.setBorder(parseColor);
    }
    ...
    /* compiled from: RewardsScreen.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0002\u0004\u0005B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0006"}, d2 = {"Lru/mrlargha/commonui/elements/rewards_screen/RewardsScreen$Companion;", "", "<init>", "()V", "RewardScreenInfo", "RewardItem", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
