...
public final class DialogBuyCryptoModel {
    ...
    @SerializedName(alternate = {"currency_rate", "rate", UpdateServiceContract.BundleKey.CURRENT, FirebaseAnalytics.Param.PRICE, "cost", "course"}, value = "currencyRate")
