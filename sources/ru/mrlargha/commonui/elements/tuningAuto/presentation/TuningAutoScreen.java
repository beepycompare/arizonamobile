    ...
    private final void initSubMenuCategories(List<CategoryInfo> list) {
        ...
        try {
            ...
            for (Object obj : this.categoryComponentsList) {
                ...
                int intValue = (categoryInfo3 == null || (id2 = categoryInfo3.getId()) == null) ? 0 : id2.intValue();
