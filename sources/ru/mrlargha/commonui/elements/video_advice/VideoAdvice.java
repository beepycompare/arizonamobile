...
public final class VideoAdvice extends SAMPUIElement {
    ...
    private final void setupListeners() {
        this.videoBackgroundBinding.btnSkip.setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.commonui.elements.video_advice.VideoAdvice$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                SAMPUIElement.notifyClick$default(VideoAdvice.this, 0, VideoAdviceIds.SKIP_QUEST.getSubId(), null, 4, null);
            }
        });
    }
            ...
            if (file.exists()) {
                ...
                build.addListener(new Player.Listener() { // from class: ru.mrlargha.commonui.elements.video_advice.VideoAdvice$playVideo$1$1
                    ...
                    public void onPlaybackStateChanged(int i) {
                        if (i == 4) {
                            VideoAdvice.this.releasePlayer();
    ...
    public final void releasePlayer() {
        ...
        this.videoBackgroundBinding.videoAdviceBg.setPlayer(null);
        if (exoPlayer != null) {
            try {
                exoPlayer.stop();
            } finally {
    ...
    /* compiled from: VideoAdvice.kt */
    @Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0018\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0016R\u001a\u0010\n\u001a\b\u0012\u0004\u0012\u00020\f0\u000bX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Lru/mrlargha/commonui/elements/video_advice/VideoAdvice$Spawner;", "Lru/mrlargha/commonui/core/UIElementAbstractSpawner;", "<init>", "()V", "create", "Lru/mrlargha/commonui/core/SAMPUIElement;", "targetActivity", "Landroid/app/Activity;", "backendID", "", "correctIds", "", "Lru/mrlargha/commonui/core/UIElementID;", "getCorrectIds", "()Ljava/util/Set;", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    public static final class Spawner extends UIElementAbstractSpawner {
        private final Set<UIElementID> correctIds = SetsKt.setOf(UIElementID.VIDEO_ADVICE);
