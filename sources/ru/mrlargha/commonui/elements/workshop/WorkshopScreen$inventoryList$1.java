...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.workshop.WorkshopScreen$inventoryList$1", f = "WorkshopScreen.kt", i = {}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_WRAP_BEHAVIOR_IN_PARENT}, m = "invokeSuspend", n = {}, s = {})
...
public final class WorkshopScreen$inventoryList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<InventoryItem>>, Object> {
    int label;
    final /* synthetic */ WorkshopScreen this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WorkshopScreen$inventoryList$1(WorkshopScreen workshopScreen, Continuation<? super WorkshopScreen$inventoryList$1> continuation) {
        super(2, continuation);
        this.this$0 = workshopScreen;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WorkshopScreen$inventoryList$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super List<InventoryItem>> continuation) {
        return ((WorkshopScreen$inventoryList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
