...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.battlepassWinter2025.LevelItemsAdapter$LevelItemViewHolder$bind$1$8", f = "LevelItemsAdapter.kt", i = {}, l = {187}, m = "invokeSuspend", n = {}, s = {}, v = 1)
...
public final class LevelItemsAdapter$LevelItemViewHolder$bind$1$8 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LevelItemsAdapter$LevelItemViewHolder$bind$1$8(WinterBattlepassLevelItemBinding winterBattlepassLevelItemBinding, LevelItemsAdapter.LevelItemViewHolder levelItemViewHolder, AwardItemData awardItemData, Continuation<? super LevelItemsAdapter$LevelItemViewHolder$bind$1$8> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LevelItemsAdapter$LevelItemViewHolder$bind$1$8(this.$this_apply, this.this$0, this.$itemUsual, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new LevelItemsAdapter$LevelItemViewHolder$bind$1$8$bitmap$1(this.$itemUsual, null), this);
