...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.battlepassWinter2025.LevelItemViewHolder$bind$1$1", f = "LevelItemsAdapter.kt", i = {}, l = {112}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes5.dex */
public final class LevelItemViewHolder$bind$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public LevelItemViewHolder$bind$1$1(WinterBattlepassLevelItemBinding winterBattlepassLevelItemBinding, LevelItemViewHolder levelItemViewHolder, AwardItemData awardItemData, Continuation<? super LevelItemViewHolder$bind$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LevelItemViewHolder$bind$1$1(this.$this_apply, this.this$0, this.$itemPremium, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LevelItemViewHolder$bind$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new LevelItemViewHolder$bind$1$1$bitmap$1(this.$itemPremium, null), this);
