...
public final class AnimationMenu extends SAMPUIElement {
    ...
    private final AnimationApi api;
    private final ArizonaRetrofit client;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AnimationMenu(final Activity targetActivity, int i) {
        ...
        AnimationCategoryAdapter animationCategoryAdapter = new AnimationCategoryAdapter(targetActivity);
        ...
        this.api = (AnimationApi) ArizonaRetrofit.create$default(arizonaRetrofit, AnimationApi.class, false, null, null, 14, null);
        ...
        animationCategoryAdapter.setOnCategoryClickListener(new AnimationCategoryAdapter.OnCategoryClickListener() { // from class: ru.mrlargha.commonui.elements.animation.presentation.AnimationMenu.2
            ...
            public void callback(int i2) {
                ...
                boolean areEqual = Intrinsics.areEqual(animationCategoryList.get(i2).getName(), targetActivity.getString(R.string.animation_favorites));
                AnimationMenu animationMenu2 = AnimationMenu.this;
                if (areEqual) {
                    ArrayList arrayList = new ArrayList();
                    for (Object obj : animationMenu2.animationList) {
                ...
                for (Object obj2 : animationMenu2.animationList) {
                    int categoryId = ((Animation) obj2).getCategoryId();
    ...
    private final void addAnimations(String str) {
        Log.d(TAG, "addAnimations: " + str);
        this.animationList.addAll(MapperKt.toListModel(str, Animation.class));
        Log.d(TAG, "addAnimations list: " + this.animationList);
        if (UtilsKt.isArizonaType()) {
    ...
    public final void mergeAnimations() {
        ...
        if (list != null) {
            ...
            for (Object obj2 : this.animationList) {
                ...
                if (animation2 != null) {
                    this.animationList.set(i, Animation.copy$default(animation, 0, null, animation2.getAddition(), animation2.getCategoryId(), animation2.getName(), animation2.getImage(), animation2.getImageHover(), 0, false, false, 899, null));
                }
                i = i2;
            }
            this.animationAdapter.addAnimations(this.animationList);
    ...
    private final void initRetrofit() {
        BuildersKt__Builders_commonKt.launch$default(this.client.getScope(), Dispatchers.getIO(), null, new AnimationMenu$initRetrofit$1(this, null), 2, null);
    }
    ...
    /* compiled from: AnimationMenu.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lru/mrlargha/commonui/elements/animation/presentation/AnimationMenu$Companion;", "", "<init>", "()V", "TAG", "", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
