...
import ru.mrlargha.commonui.databinding.CaseRouletteItemBinding;
import ru.mrlargha.commonui.utils.PicassoLoadSafeKt;
import ru.mrlargha.commonui.utils.UtilsKt;
/* compiled from: RouletteAwardsAdapter.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0015B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0018\u0010\t\u001a\u00020\u00022\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\rH\u0016J\u0018\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00020\rH\u0016J\u0006\u0010\u0012\u001a\u00020\u000fJ\u001e\u0010\u0013\u001a\u00020\u000f2\u0016\u0010\u0005\u001a\u0012\u0012\u0004\u0012\u00020\u00070\u0006j\b\u0012\u0004\u0012\u00020\u0007`\bJ\b\u0010\u0014\u001a\u00020\rH\u0016R\u001e\u0010\u0005\u001a\u0012\u0012\u0004\u0012\u00020\u00070\u0006j\b\u0012\u0004\u0012\u00020\u0007`\bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Lru/mrlargha/commonui/elements/roulette/RouletteAwardsAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lru/mrlargha/commonui/elements/roulette/RouletteAwardsAdapter$RouletteAwardsViewHolder;", "<init>", "()V", "caseAwards", "Ljava/util/ArrayList;", "Lru/mrlargha/commonui/elements/roulette/CaseAward;", "Lkotlin/collections/ArrayList;", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "", "onBindViewHolder", "", "holder", "position", "clearAwards", "addAwards", "getItemCount", "RouletteAwardsViewHolder", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
/* loaded from: classes6.dex */
public final class RouletteAwardsAdapter extends RecyclerView.Adapter<RouletteAwardsViewHolder> {
    private final ArrayList<CaseAward> caseAwards = new ArrayList<>();

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public RouletteAwardsViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.case_roulette_item, parent, false);
        Intrinsics.checkNotNullExpressionValue(inflate, "inflate(...)");
        return new RouletteAwardsViewHolder(inflate);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(RouletteAwardsViewHolder holder, int i) {
        ...
        CaseRouletteItemBinding binding = holder.getBinding();
        ...
        if (UtilsKt.isArizonaType()) {
            ...
            PicassoLoadSafeKt.loadSafe(picasso, projectResourceUrl$default + "assets/images/donate/" + caseAward2.getUrl()).into(binding.itemIc);
        } else {
            ...
            PicassoLoadSafeKt.loadSafe(picasso2, projectResourceUrl$default2 + "systems/battlepass/items/" + caseAward2.getUrl()).into(binding.itemIc);
        }
    ...
    /* compiled from: RouletteAwardsAdapter.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\n"}, d2 = {"Lru/mrlargha/commonui/elements/roulette/RouletteAwardsAdapter$RouletteAwardsViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "view", "Landroid/view/View;", "<init>", "(Landroid/view/View;)V", "binding", "Lru/mrlargha/commonui/databinding/CaseRouletteItemBinding;", "getBinding", "()Lru/mrlargha/commonui/databinding/CaseRouletteItemBinding;", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    public static final class RouletteAwardsViewHolder extends RecyclerView.ViewHolder {
        private final CaseRouletteItemBinding binding;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public RouletteAwardsViewHolder(View view) {
            super(view);
            Intrinsics.checkNotNullParameter(view, "view");
            CaseRouletteItemBinding bind = CaseRouletteItemBinding.bind(view);
            Intrinsics.checkNotNullExpressionValue(bind, "bind(...)");
            this.binding = bind;
        }

        public final CaseRouletteItemBinding getBinding() {
            return this.binding;
        }
    }
}
