            ...
            for (InventoryItem inventoryItem : items) {
                ...
                if (i >= 0) {
                    ...
                    if (inventoryItem.getItem() != null) {
                        List<InventoryItem> subAccessoriesList = this.inventory.getSubAccessoriesList();
                        ...
                        this.inventory.getSubAccessoriesList().set(i, inventoryItem);
                    }
                }
            }
        }
