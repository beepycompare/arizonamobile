...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.inventory.presentation.InventoryScreen$updateInfoToDatabase$1", f = "InventoryScreen.kt", i = {0, 0}, l = {1924}, m = "invokeSuspend", n = {"it", "$i$a$-let-InventoryScreen$updateInfoToDatabase$1$1"}, nl = {1925}, s = {"L$0", "I$0"}, v = 2)
