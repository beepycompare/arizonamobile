...
public final class UpgradesInventoryAdapter extends ListAdapter<InventoryItem, UpgradesInventoryViewHolder> {
    ...
    public UpgradesInventoryAdapter(Function1<? super DraggedItem, Unit> onItemDropped, Context context, Function1<? super InventoryItem, Unit> onLongClicked, Function1<? super InventoryItem, Unit> onItemClicked) {
        super(COMPARATOR);
    ...
    public UpgradesInventoryViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        return new UpgradesInventoryViewHolder(inflate, this.onItemDropped, this.onLongClicked, this.onItemClicked);
    }
