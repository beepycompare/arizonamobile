        ...
        if (itemVal.getTime() != null && itemVal.getTime().longValue() > 0) {
            ...
            ?? r0 = new CountDownTimer(longValue) { // from class: ru.mrlargha.commonui.elements.inventory.presentation.viewHolder.MainInventoryViewHolder$bind$1$5
                ...
                public void onTick(long j) {
                    ...
                    if (i > 24) {
                        itemInventoryBinding2.tvTitleText.setText(ChatEmoji.toSpannable$default(ChatEmoji.INSTANCE, inventoryItem.getText(), 0.0f, null, 3, null));
            ...
            inventoryItem = itemVal;
            itemInventoryBinding.tvTitleText.setText(ChatEmoji.toSpannable$default(ChatEmoji.INSTANCE, UtilKt.inventoryItemDisplayText(inventoryItem.getText(), inventoryItem.getItem_type(), inventoryItem.getEnchant()), 0.0f, null, 3, null));
