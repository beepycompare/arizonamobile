...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.inventory.presentation.viewHolder.MainInventoryViewHolder$bind$1$4", f = "MainInventoryViewHolder.kt", i = {}, l = {TsExtractor.TS_STREAM_TYPE_AC3}, m = "invokeSuspend", n = {}, s = {}, v = 1)
...
public final class MainInventoryViewHolder$bind$1$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MainInventoryViewHolder$bind$1$4(ItemInventoryBinding itemInventoryBinding, MainInventoryViewHolder mainInventoryViewHolder, InventoryItem inventoryItem, Continuation<? super MainInventoryViewHolder$bind$1$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MainInventoryViewHolder$bind$1$4(this.$this_with, this.this$0, this.$itemVal, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new MainInventoryViewHolder$bind$1$4$bitmap$1(this.$itemVal, null), this);
