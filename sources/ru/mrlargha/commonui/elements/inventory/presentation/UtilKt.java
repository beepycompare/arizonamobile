...
public final class UtilKt {
    ...
    public static final void loadEffectModel(ImageView imageView, Object obj) {
        ...
        try {
            ...
            m9915constructorimpl = Result.m9915constructorimpl(Glide.with(imageView).asDrawable().load(obj).override(192, 192).disallowHardwareConfig().skipMemoryCache(true).diskCacheStrategy(DiskCacheStrategy.DATA).into(imageView));
        } catch (Throwable th) {
