...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.inventory.presentation.InventoryScreen$addInfoToDatabase$1", f = "InventoryScreen.kt", i = {0, 0, 0, 0, 0}, l = {1895}, m = "invokeSuspend", n = {"$this$forEach$iv", "element$iv", "it", "$i$f$forEach", "$i$a$-forEach-InventoryScreen$addInfoToDatabase$1$1"}, nl = {1896}, s = {"L$0", "L$3", "L$4", "I$0", "I$1"}, v = 2)
