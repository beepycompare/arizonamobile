...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.inventory.presentation.InventoryScreen$addInfoToDatabase$1", f = "InventoryScreen.kt", i = {0, 0, 0}, l = {2419}, m = "invokeSuspend", n = {"$this$forEach$iv", "element$iv", "it"}, nl = {2420}, s = {"L$0", "L$3", "L$4"}, v = 2)
