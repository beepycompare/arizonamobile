...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.donate.presentation.DonateStates$setCategories$1", f = "DonateStates.kt", i = {1, 2, 2}, l = {91, 93, 101}, m = "invokeSuspend", n = {RemoteConfigConstants.ResponseFieldKey.STATE, RemoteConfigConstants.ResponseFieldKey.STATE, "categories"}, nl = {92, 96, 91}, s = {"L$0", "L$0", "L$1"}, v = 2)
