...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.donate.presentation.DonateStates$setCategories$1", f = "DonateStates.kt", i = {1, 2}, l = {MdtaMetadataEntry.TYPE_INDICATOR_UNSIGNED_INT64, 80, 84}, m = "invokeSuspend", n = {RemoteConfigConstants.ResponseFieldKey.STATE, RemoteConfigConstants.ResponseFieldKey.STATE}, nl = {79, 83, MdtaMetadataEntry.TYPE_INDICATOR_UNSIGNED_INT64}, s = {"L$0", "L$0"}, v = 2)
