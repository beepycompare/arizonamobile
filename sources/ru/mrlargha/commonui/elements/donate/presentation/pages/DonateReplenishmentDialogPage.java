...
public final class DonateReplenishmentDialogPage extends DonatePage {
    ...
    private final Unit dialogInit(DonateBoostModelUi donateBoostModelUi) {
        ...
        donateReplenishmentDialogBinding.tvAzCoins.setText(MoneyElementKt.toMoneyFormattedSpannable$default(donateBoostModelUi.getRate().getTo(), false, null, null, 7, null));
