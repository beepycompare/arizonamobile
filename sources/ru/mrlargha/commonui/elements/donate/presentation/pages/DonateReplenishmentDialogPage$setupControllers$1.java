...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.donate.presentation.pages.DonateReplenishmentDialogPage$setupControllers$1", f = "DonateReplenishmentDialogPage.kt", i = {}, l = {330}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
        ...
        if (i == 0) {
            ...
            if (mutableStateFlow.collect(new FlowCollector() { // from class: ru.mrlargha.commonui.elements.donate.presentation.pages.DonateReplenishmentDialogPage$setupControllers$1.1
                ...
                public static final class C00841 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public static final /* synthetic */ class WhenMappings {
                        ...
                        static {
                            ...
                            try {
                                iArr[DonateRateType.EXCHANGER_GREEN_RUB.ordinal()] = 2;
                            } catch (NoSuchFieldError unused2) {
                            }
                            try {
                                iArr[DonateRateType.EXCHANGER_RUB.ordinal()] = 3;
                            } catch (NoSuchFieldError unused3) {
                            }
                            try {
                                iArr[DonateRateType.EXCHANGER_EXP.ordinal()] = 4;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00841(Pair<Long, Integer> pair, DonateBoostModelUi donateBoostModelUi, DonateReplenishmentDialogPage donateReplenishmentDialogPage, Continuation<? super C00841> continuation) {
                        super(2, continuation);
                        this.$it = pair;
                        this.$model = donateBoostModelUi;
                        this.this$0 = donateReplenishmentDialogPage;
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C00841(this.$it, this.$model, this.this$0, continuation);
                    }
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 1 || i == 2) {
                            ...
                            this.this$0.getBinding().tvReceive.setText(String.valueOf(longValue));
                ...
                public final Object emit(Pair<Long, Integer> pair, Continuation<? super Unit> continuation) {
                    Object withContext = BuildersKt.withContext(Dispatchers.getMain(), new C00841(pair, DonateBoostModelUi.this, donateReplenishmentDialogPage, null), continuation);
