...
public final class DonateBadgesAdapter extends ListAdapter<DonateBadgesModelUi, RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int i) {
        Object obj;
        Iterator<E> it = BadgesType.getEntries().iterator();
        while (true) {
            if (!it.hasNext()) {
                obj = null;
                break;
            ...
            obj = it.next();
            if (Intrinsics.areEqual(((BadgesType) obj).name(), getCurrentList().get(i).getIcon())) {
                break;
            }
        }
        BadgesType badgesType = (BadgesType) obj;
        if (badgesType == null) {
            badgesType = BadgesType.DEFAULT;
        }
