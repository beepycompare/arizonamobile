...
public final class DonateStates {
    ...
    public DonateStates(Activity targetActivity, int i) {
        ...
        DonateRetrofitClient donateRetrofitClient = new DonateRetrofitClient(targetActivity, i);
        this.retrofitClient = donateRetrofitClient;
        DonateRepositoryImpl donateRepositoryImpl = new DonateRepositoryImpl(donateRetrofitClient);
