...
public final class DonateItemModel {
    ...
    public final DonateItemModel copy(int i, int i2, String name, String description, int i3, int i4, int i5, int i6, int i7, int i8, List<String> colorListButton, String titleButton, int i9, String imageEffect, int i10, int i11, int i12, List<DonateBadgesModel> list, int i13, String blockedReason, int i14, int i15, int i16, List<String> textGradientColor, long j, int i17, int i18) {
        ...
        return new DonateItemModel(i, i2, name, description, i3, i4, i5, i6, i7, i8, colorListButton, titleButton, i9, imageEffect, i10, i11, i12, list, i13, blockedReason, i14, i15, i16, textGradientColor, j, i17, i18);
    }
