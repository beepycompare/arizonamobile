...
public interface DonateRepository {
    ...
    Object getPayPassLevels(Continuation<? super ResultState<? extends List<DonatePayPassLevelModel>>> continuation);
}
