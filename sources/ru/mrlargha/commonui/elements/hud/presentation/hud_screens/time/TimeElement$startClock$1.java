...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.hud.presentation.hud_screens.time.TimeElement$startClock$1", f = "TimeElement.kt", i = {0, 1, 1}, l = {117, 120}, m = "invokeSuspend", n = {"$this$launch", "$this$launch", "e"}, nl = {118, 123}, s = {"L$0", "L$0", "L$1"}, v = 2)
