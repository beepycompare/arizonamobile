...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.hud.presentation.hud_screens.time.TimeElement$startClock$1", f = "TimeElement.kt", i = {0, 1, 1}, l = {119, 122}, m = "invokeSuspend", n = {"$this$launch", "$this$launch", "e"}, nl = {120, GapComposerKt.nodeKey}, s = {"L$0", "L$0", "L$1"}, v = 2)
