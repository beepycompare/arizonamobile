...
@Metadata(d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0004\b\u0005\u0010\u0006J\u0018\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00192\b\b\u0002\u0010\u001a\u001a\u00020\u001bJ\u0006\u0010\u001c\u001a\u00020\fJ\u0006\u0010\r\u001a\u00020\fJ)\u0010\u001d\u001a\u00020\u00172!\u0010\u001e\u001a\u001d\u0012\u0013\u0012\u00110\f¢\u0006\f\b \u0012\b\b!\u0012\u0004\b\b(\"\u0012\u0004\u0012\u00020\u00170\u001fJ \u0010#\u001a\u00020\u00172\u0006\u0010$\u001a\u00020\f2\u0006\u0010%\u001a\u00020\f2\u0006\u0010&\u001a\u00020\u001bH\u0002J\u0010\u0010'\u001a\u00020\f2\u0006\u0010(\u001a\u00020\fH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u001a\u0010\r\u001a\u00020\fX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\u0010\u0010\u0012\u001a\u0004\u0018\u00010\u0013X\u0082\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0014\u001a\u0004\u0018\u00010\fX\u0082\u000e¢\u0006\u0004\n\u0002\u0010\u0015¨\u0006)"}, d2 = {"Lru/mrlargha/commonui/elements/hud/presentation/hud_screens/chicken_charge/PercentMover;", "", "track", "Landroid/view/View;", "marker", "<init>", "(Landroid/view/View;Landroid/view/View;)V", "handler", "Landroid/os/Handler;", "running", "", "maxX", "", "currentPercent", "getCurrentPercent", "()F", "setCurrentPercent", "(F)V", "tickAnimator", "Landroid/animation/ValueAnimator;", "lastTouchX", "Ljava/lang/Float;", TtmlNode.START, "", "speed", "", "tickMs", "", "stop", "attachStopOnClick", "onStop", "Lkotlin/Function1;", "Lkotlin/ParameterName;", "name", "percent", "animateBetweenPercents", "fromPercent", "toPercent", "durationMs", "computePercentFromTouch", "touchX", "CommonUI_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
        ...
        percentMover.handler.post(new Runnable() { // from class: ru.mrlargha.commonui.elements.hud.presentation.hud_screens.chicken_charge.PercentMover$start$1$r$1
            ...
            public void run() {
                ...
                if (z) {
                    ...
                    if (coerceIn < 100.0f) {
                        handler = PercentMover.this.handler;
                        handler.postDelayed(this, j);
                        return;
                    }
                    PercentMover.this.stop();
                }
            }
        });
    }
    ...
    public final void attachStopOnClick(final Function1<? super Float, Unit> onStop) {
        ...
        this.track.setOnTouchListener(new View.OnTouchListener() { // from class: ru.mrlargha.commonui.elements.hud.presentation.hud_screens.chicken_charge.PercentMover$$ExternalSyntheticLambda1
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                boolean attachStopOnClick$lambda$0;
                attachStopOnClick$lambda$0 = PercentMover.attachStopOnClick$lambda$0(PercentMover.this, onStop, view, motionEvent);
                return attachStopOnClick$lambda$0;
            }
        });
