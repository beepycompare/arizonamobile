    ...
    public final void setToolsInfo(HudChickenGameModel gameModel) {
        ...
        for (Object obj : gameModel.getTools()) {
            ...
            if (hudChickenGameToolsItemBinding2 != null) {
                ...
                PicassoLoadSafeKt.loadSafe(picasso, FirebaseConfigHelper.INSTANCE.getProjectResourceUrl(false) + "systems/pirate-event/chickengrad/bonuses/" + hudChickenGameToolsModel.getImage()).into(hudChickenGameToolsItemBinding2.ivItem);
