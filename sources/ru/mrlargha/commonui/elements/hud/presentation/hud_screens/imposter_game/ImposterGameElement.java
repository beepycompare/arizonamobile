    ...
    private final void setItems(List<ImposterGameToolItem> list) {
        ...
        if (imposterGameToolItem != null) {
            if (imposterGameToolItem.getId() != -1) {
                ...
                String str = this.url;
                PicassoLoadSafeKt.loadSafe(picasso, projectResourceUrl$default + str + imposterGameToolItem.getImage()).into(this.binding.hudImposterGameItem1Image);
            }
        ...
        if (imposterGameToolItem2 != null) {
            if (imposterGameToolItem2.getId() != -1) {
                ...
                PicassoLoadSafeKt.loadSafe(picasso2, projectResourceUrl$default2 + str2 + imposterGameToolItem2.getImage()).into(this.binding.hudImposterGameItem2Image);
            }
