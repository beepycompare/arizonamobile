...
public final class CaseTimerElement {
    ...
    public CaseTimerElement(HudElementCasesTimerBinding binding, SAMPUIElement notifier) {
        ...
        CustomCardView main = binding.main;
        Intrinsics.checkNotNullExpressionValue(main, "main");
        CustomCardView.setBackground$default(main, Color.parseColor("#B3040610"), Color.parseColor("#FF77CC"), null, null, 12, null);
    }
