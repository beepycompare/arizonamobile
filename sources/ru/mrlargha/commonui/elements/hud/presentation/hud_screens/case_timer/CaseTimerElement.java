...
public final class CaseTimerElement {
    ...
    public final void showButton() {
        ...
        this.binding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: ru.mrlargha.commonui.elements.hud.presentation.hud_screens.case_timer.CaseTimerElement$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CaseTimerElement.showButton$lambda$0(CaseTimerElement.this, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void showButton$lambda$0(CaseTimerElement caseTimerElement, View view) {
        SAMPUIElement.notifyClick$default(caseTimerElement.notifier, 72, 72, null, 4, null);
    }
