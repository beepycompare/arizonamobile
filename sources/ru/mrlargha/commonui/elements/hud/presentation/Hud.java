...
public final class Hud extends SAMPUIElement {
    ...
    public Hud(final Activity targetActivity, final int i) {
        ...
        PromoElementBinding promo = bind.promo;
    ...
    static /* synthetic */ void setTaximeterLayoutType$default(Hud hud, int i, int i2, Integer num, String str, String str2, String str3, boolean z, int i3, int i4, Object obj) {
        if ((i4 & 4) != 0) {
            num = null;
        }
        hud.setTaximeterLayoutType(i, i2, num, str, (i4 & 16) != 0 ? "Сумма" : str2, (i4 & 32) != 0 ? "#FFFFFF" : str3, (i4 & 64) != 0 ? true : z, (i4 & 128) != 0 ? R.font.harreegh_popped_cyrillic : i3);
    }
    ...
    private final void setTaximeterLayoutType(int i, int i2, Integer num, String str, String str2, String str3, boolean z, int i3) {
        ...
        Typeface font = ResourcesCompat.getFont(getTargetActivity(), i3);
