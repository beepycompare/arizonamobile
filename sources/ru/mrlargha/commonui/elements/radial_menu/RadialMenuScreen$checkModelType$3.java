...
@DebugMetadata(c = "ru.mrlargha.commonui.elements.radial_menu.RadialMenuScreen$checkModelType$3", f = "RadialMenuScreen.kt", i = {}, l = {114}, m = "invokeSuspend", n = {}, s = {}, v = 1)
        ...
        if (i == 0) {
            ...
            if (mutableStateFlow.collect(new FlowCollector() { // from class: ru.mrlargha.commonui.elements.radial_menu.RadialMenuScreen$checkModelType$3.1
                ...
                public static final class C00981 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00981(RadialMenuScreen radialMenuScreen, int i, Continuation<? super C00981> continuation) {
                        super(2, continuation);
                        this.this$0 = radialMenuScreen;
                        this.$listSize = i;
                    }
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C00981(this.this$0, this.$listSize, continuation);
                    }
                ...
                public final Object emit(int i2, Continuation<? super Unit> continuation) {
                    Object withContext = BuildersKt.withContext(Dispatchers.getMain(), new C00981(RadialMenuScreen.this, i2, null), continuation);
