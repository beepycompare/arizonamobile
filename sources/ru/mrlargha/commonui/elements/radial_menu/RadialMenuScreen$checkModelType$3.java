        ...
        if (i == 0) {
            ...
            if (mutableStateFlow.collect(new FlowCollector() { // from class: ru.mrlargha.commonui.elements.radial_menu.RadialMenuScreen$checkModelType$3.1
                ...
                public static final class C01061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C01061(RadialMenuScreen radialMenuScreen, int i, Continuation<? super C01061> continuation) {
                        super(2, continuation);
                        this.this$0 = radialMenuScreen;
                        this.$listSize = i;
                    }
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new C01061(this.this$0, this.$listSize, continuation);
                    }
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        Function0 function0 = new Function0() { // from class: ru.mrlargha.commonui.elements.radial_menu.RadialMenuScreen$checkModelType$3$1$1$$ExternalSyntheticLambda0
                            ...
                            public final Object invoke() {
                                ...
                                invokeSuspend$lambda$1 = RadialMenuScreen$checkModelType$3.AnonymousClass1.C01061.invokeSuspend$lambda$1(RadialMenuScreen.this);
                        ...
                        radialMenuScreen.setOnBottomBtnListener(i, function0, new Function0() { // from class: ru.mrlargha.commonui.elements.radial_menu.RadialMenuScreen$checkModelType$3$1$1$$ExternalSyntheticLambda1
                            ...
                            public final Object invoke() {
                                ...
                                invokeSuspend$lambda$3 = RadialMenuScreen$checkModelType$3.AnonymousClass1.C01061.invokeSuspend$lambda$3(RadialMenuScreen.this);
                ...
                public final Object emit(int i2, Continuation<? super Unit> continuation) {
                    Object withContext = BuildersKt.withContext(Dispatchers.getMain(), new C01061(RadialMenuScreen.this, i2, null), continuation);
