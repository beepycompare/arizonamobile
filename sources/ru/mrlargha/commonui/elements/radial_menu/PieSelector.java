...
public final class PieSelector extends View {
    ...
    /* compiled from: PieSelector.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J\b\u0010\u0006\u001a\u00020\u0003H&J\b\u0010\u0007\u001a\u00020\u0003H&¨\u0006\bÀ\u0006\u0003"}, d2 = {"Lru/mrlargha/commonui/elements/radial_menu/PieSelector$SectorSelectedLister;", "", "onSectorSelected", "", "data", "Lru/mrlargha/commonui/elements/radial_menu/SectorData;", "onCanceled", "onCenterClicked", "CommonUI"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    ...
    public final class Sector {
        ...
        public final void draw(Canvas canvas) {
            ...
            Path path = this.sectorPath;
            boolean z = this.isCancelSector;
            PieSelector pieSelector = this.this$0;
            canvas.drawPath(path, z ? pieSelector.cancelSectorBackgroundPaint : pieSelector.sectorBackgroundPaint);
            Path path2 = this.sectorPath;
            boolean z2 = this.isCancelSector;
            PieSelector pieSelector2 = this.this$0;
            canvas.drawPath(path2, z2 ? pieSelector2.cancelSectorPaint : pieSelector2.sectorPaint);
            ...
            if (bitmap != null) {
                PieSelector pieSelector3 = this.this$0;
                canvas.drawBitmap(bitmap, this.bitmapPoint.x - (pieSelector3.sectorBitmapSize / 2), this.bitmapPoint.y - (pieSelector3.sectorBitmapSize / 2), new Paint());
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.isCenterSelected) {
                ...
                for (Sector sector : this.sectors) {
                    if (sector.getSelected()) {
                        boolean isCancelSector = sector.isCancelSector();
                        SectorSelectedLister sectorSelectedLister2 = this.listener;
                        if (isCancelSector) {
                            if (sectorSelectedLister2 != null) {
                                sectorSelectedLister2.onCanceled();
                            }
                        } else if (sectorSelectedLister2 != null) {
                            sectorSelectedLister2.onSectorSelected(sector.getSectorData());
                        }
                    }
                }
            }
