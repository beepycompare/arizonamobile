...
public final class TaskRewardViewHolder extends RecyclerView.ViewHolder {
    ...
    public final void bind(RewardType item) {
        ...
        if (item.getItem() != null) {
            ...
            ItemsInfo itemsInfo = (ItemsInfo) CollectionsKt.getOrNull(UtilsKt.getItemsName(), item.getItem().intValue());
            materialTextView.setText((itemsInfo == null || (r3 = itemsInfo.getName()) == null) ? "" : "");
