...
public final class Authorization implements InterfaceController {
    ...
    private final void installServerLogotype(int i, String str) {
        ...
        PicassoLoadSafeKt.loadSafe(picasso, str + i + ".webp").placeholder(R.drawable.logo_phoenix).into(this.authorizationBinding.authServerLogotype);
    }
