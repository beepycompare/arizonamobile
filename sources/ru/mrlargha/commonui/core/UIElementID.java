...
public final class UIElementID {
    ...
    public static final UIElementID RODINA_PROMO = new UIElementID("RODINA_PROMO", 112, MenuKt.InTransitionDuration, ProjectType.RODINA);
    ...
    public static final UIElementID SPAWN_SELECTION = new UIElementID("SPAWN_SELECTION", BuildConfig.API_LEVEL, 123, ProjectType.RODINA);
    public static final UIElementID TRANSPORT_SHOP = new UIElementID("TRANSPORT_SHOP", AppInfoTableDecoder.APPLICATION_INFORMATION_TABLE_ID, 124, ProjectType.RODINA);
    public static final UIElementID RATING = new UIElementID("RATING", 117, 125, ProjectType.COMMON);
