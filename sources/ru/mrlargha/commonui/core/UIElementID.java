...
public final class UIElementID {
    ...
    public static final UIElementID RATING = new UIElementID("RATING", 117, 125, ProjectType.RODINA);
    ...
    public static final UIElementID FISHING_BACKEND = new UIElementID("FISHING_BACKEND", 125, TsExtractor.TS_STREAM_TYPE_E_AC3, ProjectType.COMMON);
