...
public final class UIElementID {
    ...
    public static final UIElementID CARS = new UIElementID("CARS", 88, 91, ProjectType.COMMON);
    ...
    public static final UIElementID RODINA_EVENT = new UIElementID("RODINA_EVENT", 102, 110, ProjectType.COMMON);
    ...
    public static final UIElementID FAMILY_ARIZONA = new UIElementID("FAMILY_ARIZONA", 107, 115, ProjectType.ARIZONA);
    public static final UIElementID STARTER_PACK_RODINA = new UIElementID("STARTER_PACK_RODINA", 108, 116, ProjectType.COMMON);
    public static final UIElementID TEST = new UIElementID("TEST", 109, 117, ProjectType.COMMON);
    public static final UIElementID ARIZONA_GHETTO = new UIElementID("ARIZONA_GHETTO", 110, 118, ProjectType.ARIZONA);
    public static final UIElementID KILLER = new UIElementID("KILLER", 111, 119, ProjectType.RODINA);
    public static final UIElementID RODINA_PROMO = new UIElementID("RODINA_PROMO", 112, 120, ProjectType.COMMON);
    public static final UIElementID RODINA_QUESTS = new UIElementID("RODINA_QUESTS", 113, 121, ProjectType.RODINA);
    public static final UIElementID ARIZONA_EVENT = new UIElementID("ARIZONA_EVENT", 114, 122, ProjectType.COMMON);
    public static final UIElementID SPAWN_SELECTION = new UIElementID("SPAWN_SELECTION", 115, 123, ProjectType.RODINA);
    public static final UIElementID TRANSPORT_SHOP = new UIElementID("TRANSPORT_SHOP", 116, 124, ProjectType.RODINA);
    public static final UIElementID RATING = new UIElementID("RATING", 117, ComposerImplKt.nodeKey, ProjectType.RODINA);
    public static final UIElementID CERTIFICATE = new UIElementID("CERTIFICATE", 118, WebSocketProtocol.PAYLOAD_SHORT, ProjectType.COMMON);
    public static final UIElementID AZ_ROULETTE = new UIElementID("AZ_ROULETTE", 119, TsExtractor.TS_STREAM_TYPE_AC3, ProjectType.RODINA);
    public static final UIElementID SELECTOR = new UIElementID("SELECTOR", 120, 127, ProjectType.ARIZONA);
    public static final UIElementID EMPLOYMENT_CENTER = new UIElementID("EMPLOYMENT_CENTER", 121, 131, ProjectType.ARIZONA);
    public static final UIElementID ARIZONA_RATING = new UIElementID("ARIZONA_RATING", 122, 132, ProjectType.COMMON);
    public static final UIElementID RODINA_ACCS_CERTIFICATE = new UIElementID("RODINA_ACCS_CERTIFICATE", 123, 133, ProjectType.RODINA);
    public static final UIElementID ARIZONA_PROMO = new UIElementID("ARIZONA_PROMO", 124, TsExtractor.TS_STREAM_TYPE_SPLICE_INFO, ProjectType.COMMON);
    public static final UIElementID FISHING_BACKEND = new UIElementID("FISHING_BACKEND", ComposerImplKt.nodeKey, TsExtractor.TS_STREAM_TYPE_E_AC3, ProjectType.COMMON);
    public static final UIElementID PHONE_NUMBER = new UIElementID("PHONE_NUMBER", WebSocketProtocol.PAYLOAD_SHORT, TsExtractor.TS_STREAM_TYPE_DTS_HD, ProjectType.RODINA);
    public static final UIElementID ATM_MINIGAME = new UIElementID("ATM_MINIGAME", 127, 137, ProjectType.COMMON);

    private static final /* synthetic */ UIElementID[] $values() {
        return new UIElementID[]{COMMAND_BINDER, VOICE_SETTINGS, VOICE_PLAYERS_SETTINGS, DIALOG, RADIAL_MENU, SNACKBAR, ANIMATION_MENU, HUD, AUTHORIZATION, RODINA_SELECT_CHARACTER, RODINA_PARK_MENU, RODINA_VEHICLE_DOCUMENT, RODINA_REGISTRATION_REFERRAL, RODINA_REFERRAL, QUEST_DIALOG, RODINA_CAPTURE, PERSONAL_PROPERTY, RODINA_EMPLOYMENT_CENTER, RODINA_SHOP_SCREEN, RODINA_VEHICLE_LIST, RODINA_METAL_DETECTOR, RODINA_JOB_MAIN_SCREEN, RODINA_JOB_RATING_SCREEN, RODINA_JOB_CONTRACTS_SCREEN, UNIVERSAL_ACTION, RODINA_CONTAINER_SCREEN, RODINA_LATCHKEY_SCREEN, RODINA_EXCAVATION_SCREEN, QUESTS_SCREEN, RODINA_LICENSE_PLATES_SCREEN, RODINA_SERVICE_STATION, RODINA_MOBILE_PHONE, DICE_SCREEN, RODINA_UNIVERSAL_MENU, RODINA_DRIFT_SCORE_SCREEN, RODINA_CAPTCHA_SCREEN, ARIZONA_PASS_PROMO, USER_BATTLE_PASS, MAIN_BATTLE_PASS, NEWBIE_BATTLE_PASS, ARIZONA_DONATE_SHOP, ARIZONA_CONTAINER, ARIZONA_CURRENT_CONTAINER, ARIZONA_CONTAINER_REWARDS, ARIZONA_ACTION, ARIZONA_MOBILE_PHONE, ARIZONA_GAS_STATION, CINEMA_EFFECT, RODINA_NEW_QUEST, ARIZONA_VEHICLE_PLATE, INVENTORY, INTERACTION_BUTTON, MAIN_MENU, ARIZONA_STREET_FOOD, PLAYER_LIST, TRADE, CRAFT, WORKSHOP, ARIZONA_GLOVO, ARIZONA_LAVKA, INPUT_LAYOUT, STREAM_VIDEO, INVENTORY_SECURITY_SCREEN, INVENTORY_WAREHOUSE, INVENTORY_VEHICLE_SCREEN, INVENTORY_WALLET_SCREEN, PRODUCTS_SCREEN, RODINA_CHOOSE_INTERIOR, RODINA_UPGRADE_HOME, PREVIEW_USER_INVENTORY, VIDEO_ADVICE, TUNING_SCREEN, EMPLOYMENT_TASK, CASE_ROULETTE, FLASH_GRENADE, SHOOTING_GALLERY, FRACTION_STAT, ARIZONA_SITUATION, ARIZONA_FISHING, ARIZONA_NEW_CONTAINER, ARIZONA_BANNERS, ARIZONA_BUSINESS, TRAIN_JOB, COLLECTOR_JOB, HINTS, DAILY_REWARD, LINKING, SKILLS, CARS, HOUSES, POTIONS, CASINO, REWARDS_SCREEN, BLUEPRINT, BATTLE_PASS, CATALOG, NEIGHBOR_GAME_TASK, NEIGHBOR_GAME, ARIZONA_DOCUMENTS, GROOMING, AGREEMENT_SCREEN, FAMILY_RODINA, RODINA_EVENT, BP_EVENT_CHOICE, CONVEYOR_GAME, IMPROVEMENT_PREMIUM_VIP, CASES, FAMILY_ARIZONA, STARTER_PACK_RODINA, TEST, ARIZONA_GHETTO, KILLER, RODINA_PROMO, RODINA_QUESTS, ARIZONA_EVENT, SPAWN_SELECTION, TRANSPORT_SHOP, RATING, CERTIFICATE, AZ_ROULETTE, SELECTOR, EMPLOYMENT_CENTER, ARIZONA_RATING, RODINA_ACCS_CERTIFICATE, ARIZONA_PROMO, FISHING_BACKEND, PHONE_NUMBER, ATM_MINIGAME};
    }
