...
public final class InventoryItemEntity {
    ...
    public static /* synthetic */ InventoryItemEntity copy$default(InventoryItemEntity inventoryItemEntity, int i, Integer num, int i2, String str, Integer num2, Long l, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, Integer num9, Integer num10, Integer num11, Long l2, Integer num12, int i3, boolean z, boolean z2, String str2, Integer num13, Integer num14, String str3, int i4, Object obj) {
        ...
        Integer num18 = (i4 & 64) != 0 ? inventoryItemEntity.background : num3;
        Integer num19 = (i4 & 128) != 0 ? inventoryItemEntity.color : num4;
        Integer num20 = (i4 & 256) != 0 ? inventoryItemEntity.bits : num5;
        Integer num21 = (i4 & 512) != 0 ? inventoryItemEntity.available : num6;
        Integer num22 = (i4 & 1024) != 0 ? inventoryItemEntity.enchant : num7;
        Integer num23 = (i4 & 2048) != 0 ? inventoryItemEntity.breaks : num8;
        Integer num24 = (i4 & 4096) != 0 ? inventoryItemEntity.isActive : num9;
        Integer num25 = (i4 & 8192) != 0 ? inventoryItemEntity.itemStrength : num10;
        int i7 = i5;
        Integer num26 = (i4 & 16384) != 0 ? inventoryItemEntity.blackout : num11;
        Long l4 = (i4 & 32768) != 0 ? inventoryItemEntity.time : l2;
        Integer num27 = (i4 & 65536) != 0 ? inventoryItemEntity.acsSlot : num12;
        ...
        Integer num28 = (i4 & 2097152) != 0 ? inventoryItemEntity.effectType : num13;
        Integer num29 = (i4 & 4194304) != 0 ? inventoryItemEntity.quality : num14;
        if ((i4 & 8388608) != 0) {
            num15 = num29;
            str4 = inventoryItemEntity.custom_icon;
        } else {
            str4 = str3;
            num15 = num29;
        }
        return inventoryItemEntity.copy(i7, num16, i6, str5, num17, l3, num18, num19, num20, num21, num22, num23, num24, num25, num26, l4, num27, i8, z3, z4, str6, num28, num15, str4);
    }
    ...
    public final InventoryItemEntity copy(int i, Integer num, int i2, String str, Integer num2, Long l, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, Integer num9, Integer num10, Integer num11, Long l2, Integer num12, int i3, boolean z, boolean z2, String str2, Integer num13, Integer num14, String str3) {
        return new InventoryItemEntity(i, num, i2, str, num2, l, num3, num4, num5, num6, num7, num8, num9, num10, num11, l2, num12, i3, z, z2, str2, num13, num14, str3);
    }
    ...
    public /* synthetic */ InventoryItemEntity(int i, Integer num, int i2, String str, Integer num2, Long l, Integer num3, Integer num4, Integer num5, Integer num6, Integer num7, Integer num8, Integer num9, Integer num10, Integer num11, Long l2, Integer num12, int i3, boolean z, boolean z2, String str2, Integer num13, Integer num14, String str3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, num, i2, str, num2, l, num3, num4, num5, num6, num7, num8, num9, num10, num11, l2, num12, i3, z, z2, str2, num13, (i4 & 4194304) != 0 ? null : num14, (i4 & 8388608) != 0 ? "" : str3);
    }
