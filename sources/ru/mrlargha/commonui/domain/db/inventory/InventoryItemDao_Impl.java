...
public final class InventoryItemDao_Impl implements InventoryItemDao {
    ...
    public InventoryItemDao_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfInventoryItemEntity = new EntityInsertAdapter<InventoryItemEntity>() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, InventoryItemEntity entity) {
                ...
                statement.mo9068bindLong(1, entity.getSlot());
                Integer item = entity.getItem();
                if (item == null) {
                    statement.mo9069bindNull(2);
                } else {
                    statement.mo9068bindLong(2, item.intValue());
                }
                statement.mo9068bindLong(3, entity.getId());
                String text = entity.getText();
                if (text == null) {
                    statement.mo9069bindNull(4);
                } else {
                    statement.mo9070bindText(4, text);
                }
                Integer item_type = entity.getItem_type();
                if (item_type == null) {
                    statement.mo9069bindNull(5);
                } else {
                    statement.mo9068bindLong(5, item_type.intValue());
                }
                Long amount = entity.getAmount();
                if (amount == null) {
                    statement.mo9069bindNull(6);
                } else {
                    statement.mo9068bindLong(6, amount.longValue());
                }
                Integer background = entity.getBackground();
                if (background == null) {
                    statement.mo9069bindNull(7);
                } else {
                    statement.mo9068bindLong(7, background.intValue());
                }
                Integer color = entity.getColor();
                if (color == null) {
                    statement.mo9069bindNull(8);
                } else {
                    statement.mo9068bindLong(8, color.intValue());
                }
                Integer bits = entity.getBits();
                if (bits == null) {
                    statement.mo9069bindNull(9);
                } else {
                    statement.mo9068bindLong(9, bits.intValue());
                }
                Integer available = entity.getAvailable();
                if (available == null) {
                    statement.mo9069bindNull(10);
                } else {
                    statement.mo9068bindLong(10, available.intValue());
                }
                Integer enchant = entity.getEnchant();
                if (enchant == null) {
                    statement.mo9069bindNull(11);
                } else {
                    statement.mo9068bindLong(11, enchant.intValue());
                }
                Integer breaks = entity.getBreaks();
                if (breaks == null) {
                    statement.mo9069bindNull(12);
                } else {
                    statement.mo9068bindLong(12, breaks.intValue());
                }
                Integer isActive = entity.isActive();
                if (isActive == null) {
                    statement.mo9069bindNull(13);
                } else {
                    statement.mo9068bindLong(13, isActive.intValue());
                }
                Integer itemStrength = entity.getItemStrength();
                if (itemStrength == null) {
                    statement.mo9069bindNull(14);
                } else {
                    statement.mo9068bindLong(14, itemStrength.intValue());
                }
                Integer blackout = entity.getBlackout();
                if (blackout == null) {
                    statement.mo9069bindNull(15);
                } else {
                    statement.mo9068bindLong(15, blackout.intValue());
                }
                Long time = entity.getTime();
                if (time == null) {
                    statement.mo9069bindNull(16);
                } else {
                    statement.mo9068bindLong(16, time.longValue());
                }
                Integer acsSlot = entity.getAcsSlot();
                if (acsSlot == null) {
                    statement.mo9069bindNull(17);
                } else {
                    statement.mo9068bindLong(17, acsSlot.intValue());
                }
                statement.mo9068bindLong(18, entity.getInventoryType());
                statement.mo9068bindLong(19, entity.isColored() ? 1L : 0L);
                statement.mo9068bindLong(20, entity.isLocked() ? 1L : 0L);
                String effect = entity.getEffect();
                if (effect == null) {
                    statement.mo9069bindNull(21);
                } else {
                    statement.mo9070bindText(21, effect);
                }
                Integer effectType = entity.getEffectType();
                if (effectType == null) {
                    statement.mo9069bindNull(22);
                } else {
                    statement.mo9068bindLong(22, effectType.intValue());
                }
                Integer quality = entity.getQuality();
                if (quality == null) {
                    statement.mo9069bindNull(23);
                } else {
                    statement.mo9068bindLong(23, quality.intValue());
                }
                String custom_icon = entity.getCustom_icon();
                if (custom_icon == null) {
                    statement.mo9069bindNull(24);
                } else {
    ...
    public Object insertAll(final InventoryItemEntity inventoryItemEntity, Continuation<? super Unit> continuation) {
        Object performSuspending = DBUtil.performSuspending(this.__db, false, true, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.insertAll$lambda$0(InventoryItemDao_Impl.this, inventoryItemEntity, (SQLiteConnection) obj);
            }
        }, continuation);
    ...
    public Object updateInfo(final InventoryItemEntity inventoryItemEntity, Continuation<? super Unit> continuation) {
        Object performSuspending = DBUtil.performSuspending(this.__db, false, true, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.updateInfo$lambda$0(InventoryItemDao_Impl.this, inventoryItemEntity, (SQLiteConnection) obj);
            }
        }, continuation);
        return performSuspending == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? performSuspending : Unit.INSTANCE;
    }
    ...
    public Flow<List<InventoryItemEntity>> getCollectInventoryList() {
        return FlowUtil.createFlow(this.__db, false, new String[]{"inventoryitementity"}, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.getCollectInventoryList$lambda$0(r1, (SQLiteConnection) obj);
            }
        });
    }
    ...
    public Object getAll(Continuation<? super List<InventoryItemEntity>> continuation) {
        return DBUtil.performSuspending(this.__db, true, false, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.getAll$lambda$0(r1, (SQLiteConnection) obj);
            }
        }, continuation);
    }
    ...
    public Object findByItem(final int i, Continuation<? super InventoryItemEntity> continuation) {
        return DBUtil.performSuspending(this.__db, true, false, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.findByItem$lambda$0(r1, i, (SQLiteConnection) obj);
            }
        }, continuation);
    }
    ...
    public void deleteByItem(final int i) {
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.deleteByItem$lambda$0(r1, i, (SQLiteConnection) obj);
            }
        });
    }
    ...
    public void deleteAllItems() {
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: ru.mrlargha.commonui.domain.db.inventory.InventoryItemDao_Impl$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return InventoryItemDao_Impl.deleteAllItems$lambda$0(r1, (SQLiteConnection) obj);
            }
        });
    }
