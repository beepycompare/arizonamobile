...
import ru.mrlargha.feature.event.databinding.EventRatingItemBinding;
/* compiled from: RatingAdapter.kt */
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0010 \n\u0002\b\u0003\u0018\u00002\f\u0012\b\u0012\u00060\u0002R\u00020\u00000\u0001:\u0001\u0016B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u001c\u0010\b\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u001c\u0010\r\u001a\u00020\u000e2\n\u0010\u000f\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0010\u001a\u00020\fH\u0016J\b\u0010\u0011\u001a\u00020\fH\u0016J\u0014\u0010\u0012\u001a\u00020\u000e2\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00070\u0014J\u0006\u0010\u0015\u001a\u00020\u000eR\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lru/mrlargha/event/adapters/RatingAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lru/mrlargha/event/adapters/RatingAdapter$PiratesRatingViewHolder;", "<init>", "()V", "itemsList", "", "Lru/mrlargha/event/data/RatingData;", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "", "onBindViewHolder", "", "holder", "position", "getItemCount", "addAllItems", "items", "", "clearList", "PiratesRatingViewHolder", "event"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class RatingAdapter extends RecyclerView.Adapter<PiratesRatingViewHolder> {
    ...
    public PiratesRatingViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_rating_item, parent, false);
    ...
    public void onBindViewHolder(PiratesRatingViewHolder holder, int i) {
        ...
        EventRatingItemBinding binding = holder.getBinding();
    ...
    /* compiled from: RatingAdapter.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\n"}, d2 = {"Lru/mrlargha/event/adapters/RatingAdapter$PiratesRatingViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "view", "Landroid/view/View;", "<init>", "(Lru/mrlargha/event/adapters/RatingAdapter;Landroid/view/View;)V", "binding", "Lru/mrlargha/feature/event/databinding/EventRatingItemBinding;", "getBinding", "()Lru/mrlargha/feature/event/databinding/EventRatingItemBinding;", "event"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes6.dex */
    public final class PiratesRatingViewHolder extends RecyclerView.ViewHolder {
        private final EventRatingItemBinding binding;
        ...
        public PiratesRatingViewHolder(RatingAdapter ratingAdapter, View view) {
            ...
            EventRatingItemBinding bind = EventRatingItemBinding.bind(view);
            Intrinsics.checkNotNullExpressionValue(bind, "bind(...)");
            this.binding = bind;
        }

        public final EventRatingItemBinding getBinding() {
            return this.binding;
        }
    }
}
