...
public final class ItemRatingScreen$search$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ItemRatingScreen$search$2(ItemRatingScreen itemRatingScreen, int i, String str, Continuation<? super ItemRatingScreen$search$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ItemRatingScreen$search$2(this.this$0, this.$quality, this.$text, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ItemRatingScreen$search$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0066, code lost:
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain(), new ru.mrlargha.arizona.rating.ItemRatingScreen$search$2.AnonymousClass1(r12.this$0, null), r12) == r0) goto L14;
     */
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = RatingApi.getAccsList$default(ratingApi, 0, z, this.$quality, this.$text, this, 1, null);
        } else if (i != 1) {
            if (i == 2) {
                ResultKt.throwOnFailure(obj);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                if (!isEmpty) {
                    ...
                    textView.setText(targetActivity.getString(R.string.rating_not_found_accessory));
                }
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
