...
public final class CarInfoListAdapter extends ListAdapter<CarInfoListItem, ViewHolder> {
    ...
    private static final CarInfoListAdapter$Companion$COMPARATOR$1 COMPARATOR = new DiffUtil.ItemCallback<CarInfoListItem>() { // from class: ru.mrlargha.cars.CarInfoListAdapter$Companion$COMPARATOR$1
        @Override // androidx.recyclerview.widget.DiffUtil.ItemCallback
        public boolean areItemsTheSame(CarInfoListItem oldItem, CarInfoListItem newItem) {
        ...
        @Override // androidx.recyclerview.widget.DiffUtil.ItemCallback
        public boolean areContentsTheSame(CarInfoListItem oldItem, CarInfoListItem newItem) {
            Intrinsics.checkNotNullParameter(oldItem, "oldItem");
            Intrinsics.checkNotNullParameter(newItem, "newItem");
    ...
    /* compiled from: CarInfoListAdapter.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006À\u0006\u0003"}, d2 = {"Lru/mrlargha/cars/CarInfoListAdapter$OnCarInfoClickListener;", "", "onCarInfoClickListener", "", "id", "", "cars_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes5.dex */
    ...
    /* compiled from: CarInfoListAdapter.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006À\u0006\u0003"}, d2 = {"Lru/mrlargha/cars/CarInfoListAdapter$OnSpawnClickListener;", "", "onSpawnClickListener", "", "id", "", "cars_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes5.dex */
    ...
    public void onBindViewHolder(ViewHolder holder, int i) {
        ...
        Picasso.get().load(FirebaseConfigHelper.INSTANCE.getResourceUrl() + str2 + item.getSysName()).into(binding.carIc);
        ...
        binding.mainPageCarParamsRc.addOnItemTouchListener(new RecyclerView.SimpleOnItemTouchListener() { // from class: ru.mrlargha.cars.CarInfoListAdapter$onBindViewHolder$1$1
        ...
        EasyAnimation.animateClick$default(easyAnimation, spawnButton, 0L, null, new Function0() { // from class: ru.mrlargha.cars.CarInfoListAdapter$$ExternalSyntheticLambda0
        ...
        EasyAnimation.animateClick$default(easyAnimation2, carInfoContainer, 0L, null, new Function0() { // from class: ru.mrlargha.cars.CarInfoListAdapter$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (rarity != null) {
            ...
            binding.rarityCard.setBackground(Color.parseColor(str3));
            if (intValue == 0) {
                str = "случайное";
            } else if (intValue == 1) {
                str = "хлам";
            ...
            if (intValue == 0) {
                ...
                binding.qualityText.setText(String.valueOf(str));
                return;
            }
            binding.qualityText.setText(str + " (" + item.getRarityLevel() + ")");
            binding.itemIc.setVisibility(8);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onBindViewHolder$lambda$0$0(CarInfoListAdapter carInfoListAdapter, CarInfoListItem carInfoListItem) {
    ...
    /* compiled from: CarInfoListAdapter.kt */
    @Metadata(d1 = {"\u0000\u0013\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\b\u0003*\u0001\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0010\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0006¨\u0006\u0007"}, d2 = {"Lru/mrlargha/cars/CarInfoListAdapter$Companion;", "", "<init>", "()V", "COMPARATOR", "ru/mrlargha/cars/CarInfoListAdapter$Companion$COMPARATOR$1", "Lru/mrlargha/cars/CarInfoListAdapter$Companion$COMPARATOR$1;", "cars_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* loaded from: classes5.dex */
