            ...
            public Disposable executeDelayed(long j, TimeUnit timeUnit, final Function0<Unit> block) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0016: INVOKE  
                      (wrap: android.os.Handler : 0x000f: IGET  (r4v1 android.os.Handler A[REMOVE]) = (r1v0 'this' ru.rustore.sdk.reactive.core.Dispatchers$mainDispatcher$2$1 A[IMMUTABLE_TYPE, THIS]) ru.rustore.sdk.reactive.core.Dispatchers$mainDispatcher$2.1.$handler android.os.Handler)
                      (wrap: java.lang.Runnable : 0x0013: CONSTRUCTOR  (r0v2 java.lang.Runnable A[REMOVE]) = (r5v0 'block' kotlin.jvm.functions.Function0<kotlin.Unit> A[DONT_INLINE]) call: ru.rustore.sdk.reactive.core.Dispatchers$mainDispatcher$2$1$$ExternalSyntheticLambda1.<init>(kotlin.jvm.functions.Function0):void type: CONSTRUCTOR)
                      (wrap: long : 0x000b: INVOKE  (r2v1 long A[REMOVE]) = (r4v0 'timeUnit' java.util.concurrent.TimeUnit), (r2v0 'j' long) type: VIRTUAL call: java.util.concurrent.TimeUnit.toMillis(long):long)
                     type: VIRTUAL call: android.os.Handler.postDelayed(java.lang.Runnable, long):boolean in method: ru.rustore.sdk.reactive.core.Dispatchers$mainDispatcher$2.1.executeDelayed(long, java.util.concurrent.TimeUnit, kotlin.jvm.functions.Function0<kotlin.Unit>):ru.rustore.sdk.reactive.core.Disposable, file: classes5.dex
            ...
            public void execute(final Function0<Unit> block) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000c: INVOKE  
                     ...
                     type: VIRTUAL call: android.os.Handler.post(java.lang.Runnable):boolean in method: ru.rustore.sdk.reactive.core.Dispatchers$mainDispatcher$2.1.execute(kotlin.jvm.functions.Function0<kotlin.Unit>):void, file: classes5.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:309)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:272)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:91)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
            ...
            public static final void executeDelayed$lambda$1(final Function0 block) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0010: INVOKE  
                     ...
                     type: VIRTUAL call: java.util.concurrent.ThreadPoolExecutor.execute(java.lang.Runnable):void in method: ru.rustore.sdk.reactive.core.Dispatchers$ioDispatcher$2.1.executeDelayed$lambda$1(kotlin.jvm.functions.Function0):void, file: classes5.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:309)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:272)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:91)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
            ...
            public void execute(final Function0<Unit> block) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0010: INVOKE  
                     ...
                     type: VIRTUAL call: java.util.concurrent.ThreadPoolExecutor.execute(java.lang.Runnable):void in method: ru.rustore.sdk.reactive.core.Dispatchers$ioDispatcher$2.1.execute(kotlin.jvm.functions.Function0<kotlin.Unit>):void, file: classes5.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:309)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:272)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:91)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
