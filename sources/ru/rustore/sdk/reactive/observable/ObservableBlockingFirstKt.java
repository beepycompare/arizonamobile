...
public final class ObservableBlockingFirstKt {
    public static final <T> Object blockingFirst(Observable<T> observable) {
        ...
        Disposable subscribe = ObservableSubscribeKt.subscribe(observable, new Function1<Throwable, Unit>() { // from class: ru.rustore.sdk.reactive.observable.ObservableBlockingFirstKt$blockingFirst$disposable$1
            ...
            public final void invoke2(Throwable error) {
                ...
                if (atomicBoolean.compareAndSet(false, true)) {
                    ...
                    objectRef2.element = Result.m9919boximpl(Result.m9920constructorimpl(ResultKt.createFailure(error)));
            ...
            public final void invoke2() {
                if (atomicBoolean.compareAndSet(false, true)) {
                    Ref.ObjectRef<Result<T>> objectRef2 = objectRef;
                    Result.Companion companion = Result.Companion;
                    objectRef2.element = Result.m9919boximpl(Result.m9920constructorimpl(ResultKt.createFailure(new IllegalStateException("onComplete() called before value was received in blockingFirst()"))));
                    countDownLatch.countDown();
                }
            }
            ...
            public final void invoke2(T t) {
                if (atomicBoolean.compareAndSet(false, true)) {
                    Ref.ObjectRef<Result<T>> objectRef2 = objectRef;
                    Result.Companion companion = Result.Companion;
                    objectRef2.element = (T) Result.m9919boximpl(Result.m9920constructorimpl(t));
                    countDownLatch.countDown();
                }
            }
        });
        try {
            ...
            if (t != null) {
                return ((Result) t).m9929unboximpl();
            }
