...
public final class ObservableFilter$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            m8500constructorimpl = Result.m8500constructorimpl(Boolean.valueOf(((Boolean) function1.invoke(t)).booleanValue()));
        } catch (Throwable th) {
        ...
        if (Result.m8507isSuccessimpl(m8500constructorimpl)) {
            boolean booleanValue = ((Boolean) m8500constructorimpl).booleanValue();
