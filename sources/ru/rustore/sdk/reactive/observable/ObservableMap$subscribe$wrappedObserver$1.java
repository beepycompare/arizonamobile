...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            m8500constructorimpl = Result.m8500constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
        ...
        if (Result.m8507isSuccessimpl(m8500constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m8500constructorimpl);
        }
        ...
        if (m8503exceptionOrNullimpl == null || !this.disposed.compareAndSet(false, true)) {
            return;
        }
        ...
        observableObserver2.onError(m8503exceptionOrNullimpl);
    }
