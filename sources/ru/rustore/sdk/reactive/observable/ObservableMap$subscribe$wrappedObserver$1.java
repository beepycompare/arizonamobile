...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            m9902constructorimpl = Result.m9902constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
        ...
        if (Result.m9909isSuccessimpl(m9902constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m9902constructorimpl);
        }
