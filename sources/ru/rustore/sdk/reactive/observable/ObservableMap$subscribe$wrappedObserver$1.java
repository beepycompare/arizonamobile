...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        if (Result.m10222isSuccessimpl(m10215constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m10215constructorimpl);
        }
        ...
        if (m10218exceptionOrNullimpl == null || !this.disposed.compareAndSet(false, true)) {
            return;
        }
        ...
        observableObserver2.onError(m10218exceptionOrNullimpl);
    }
