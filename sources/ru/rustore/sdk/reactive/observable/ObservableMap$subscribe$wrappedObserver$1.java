...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            ObservableMap$subscribe$wrappedObserver$1<T> observableMap$subscribe$wrappedObserver$1 = this;
            function1 = ((ObservableMap) observableMap).block;
            m10199constructorimpl = Result.m10199constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
        ...
        if (Result.m10206isSuccessimpl(m10199constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m10199constructorimpl);
        }
        ...
        if (m10202exceptionOrNullimpl == null || !this.disposed.compareAndSet(false, true)) {
            return;
        }
        ...
        observableObserver2.onError(m10202exceptionOrNullimpl);
    }
