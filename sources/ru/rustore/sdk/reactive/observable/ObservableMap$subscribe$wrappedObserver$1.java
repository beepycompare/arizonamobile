...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            m9904constructorimpl = Result.m9904constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
        ...
        if (Result.m9911isSuccessimpl(m9904constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m9904constructorimpl);
        }
