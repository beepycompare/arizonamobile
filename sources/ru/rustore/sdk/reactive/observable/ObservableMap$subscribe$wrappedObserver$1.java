...
public final class ObservableMap$subscribe$wrappedObserver$1<T> implements ObservableObserver<T>, Disposable {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            m9896constructorimpl = Result.m9896constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
        ...
        if (Result.m9903isSuccessimpl(m9896constructorimpl) && !isDisposed()) {
            observableObserver.onNext(m9896constructorimpl);
        }
        ...
        if (m9899exceptionOrNullimpl == null || !this.disposed.compareAndSet(false, true)) {
            return;
        }
        ...
        observableObserver2.onError(m9899exceptionOrNullimpl);
    }
