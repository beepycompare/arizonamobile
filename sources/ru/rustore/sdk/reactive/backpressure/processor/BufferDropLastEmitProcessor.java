...
public final class BufferDropLastEmitProcessor<T> extends BufferEmitProcessor<T> {
    ...
    public BufferDropLastEmitProcessor(ObservableObserver<T> downStream, int i, Dispatcher dispatcher) {
