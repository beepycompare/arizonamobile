...
import ru.rustore.sdk.metrics.internal.C0816m;
import ru.rustore.sdk.metrics.internal.C0817n;
...
public final class MetricsClient {
    ...
    private final C0817n metricsClientController;
    ...
    public MetricsClient(C0817n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0817n c0817n = this.metricsClientController;
        c0817n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0816m(c0817n, metricsEvent)), c0817n.d);
    }
}
