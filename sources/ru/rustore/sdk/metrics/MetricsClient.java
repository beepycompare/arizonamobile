...
import ru.rustore.sdk.metrics.internal.C0822m;
import ru.rustore.sdk.metrics.internal.C0823n;
...
public final class MetricsClient {
    ...
    private final C0823n metricsClientController;
    ...
    public MetricsClient(C0823n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0823n c0823n = this.metricsClientController;
        c0823n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0822m(c0823n, metricsEvent)), c0823n.d);
    }
}
