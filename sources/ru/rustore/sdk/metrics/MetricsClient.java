...
import ru.rustore.sdk.metrics.internal.C0833m;
import ru.rustore.sdk.metrics.internal.C0834n;
...
public final class MetricsClient {
    ...
    private final C0834n metricsClientController;
    ...
    public MetricsClient(C0834n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0834n c0834n = this.metricsClientController;
        c0834n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0833m(c0834n, metricsEvent)), c0834n.d);
    }
}
