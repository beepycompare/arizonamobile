...
import ru.rustore.sdk.metrics.internal.C0834m;
import ru.rustore.sdk.metrics.internal.C0835n;
...
public final class MetricsClient {
    ...
    private final C0835n metricsClientController;
    ...
    public MetricsClient(C0835n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0835n c0835n = this.metricsClientController;
        c0835n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0834m(c0835n, metricsEvent)), c0835n.d);
    }
}
