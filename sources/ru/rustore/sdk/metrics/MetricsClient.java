...
import ru.rustore.sdk.metrics.internal.C0817m;
import ru.rustore.sdk.metrics.internal.C0818n;
...
public final class MetricsClient {
    ...
    private final C0818n metricsClientController;
    ...
    public MetricsClient(C0818n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0818n c0818n = this.metricsClientController;
        c0818n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0817m(c0818n, metricsEvent)), c0818n.d);
    }
}
