...
import ru.rustore.sdk.metrics.internal.C0838m;
import ru.rustore.sdk.metrics.internal.C0839n;
...
public final class MetricsClient {
    ...
    private final C0839n metricsClientController;
    ...
    public MetricsClient(C0839n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0839n c0839n = this.metricsClientController;
        c0839n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0838m(c0839n, metricsEvent)), c0839n.d);
    }
}
