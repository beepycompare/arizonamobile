...
import ru.rustore.sdk.metrics.internal.C0818m;
import ru.rustore.sdk.metrics.internal.C0819n;
...
public final class MetricsClient {
    ...
    private final C0819n metricsClientController;
    ...
    public MetricsClient(C0819n metricsClientController) {
    ...
    public final Single<Unit> send(MetricsEvent metricsEvent) {
        ...
        C0819n c0819n = this.metricsClientController;
        c0819n.getClass();
        Intrinsics.checkNotNullParameter(metricsEvent, "metricsEvent");
        return SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0818m(c0819n, metricsEvent)), c0819n.d);
    }
}
