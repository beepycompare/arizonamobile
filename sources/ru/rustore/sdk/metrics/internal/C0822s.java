...
public final class C0822s {
    ...
    public final C0806b f1560a;
    public final Q b;
    public final InterfaceC0811g c;
    public final Lazy d;

    public C0822s(C0806b endpointProvider, Q remoteMetricsEventDtoSerializer, X.b logger) {
        ...
        this.c = logger;
        this.d = LazyKt.lazy(new C0820p(this));
    }
    ...
    public final void b(ArrayList values) {
        ...
        try {
            this.c.a(new C0821q(a3.getURL(), a3.getResponseCode(), a2));
            a3.disconnect();
        } catch (Throwable th2) {
            th = th2;
            httpsURLConnection = a3;
    ...
    public static HostnameVerifier a(final URL url) {
        return new HostnameVerifier() { // from class: ru.rustore.sdk.metrics.internal.s$$ExternalSyntheticLambda0
            ...
            public final boolean verify(String str, SSLSession sSLSession) {
                return C0822s.a(url, str, sSLSession);
            }
        };
    }
