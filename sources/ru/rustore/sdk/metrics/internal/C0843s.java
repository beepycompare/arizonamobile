...
public final class C0843s {
    ...
    public final C0827b f1602a;
    public final Q b;
    public final InterfaceC0832g c;
    public final Lazy d;

    public C0843s(C0827b endpointProvider, Q remoteMetricsEventDtoSerializer, X.b logger) {
    ...
    public final void b(ArrayList values) {
        ...
        try {
            this.c.a(new C0842q(a3.getURL(), a3.getResponseCode(), a2));
            a3.disconnect();
        } catch (Throwable th2) {
            th = th2;
            httpsURLConnection = a3;
    ...
    public static HostnameVerifier a(final URL url) {
        return new HostnameVerifier() { // from class: ru.rustore.sdk.metrics.internal.s$$ExternalSyntheticLambda0
            ...
            public final boolean verify(String str, SSLSession sSLSession) {
                return C0843s.a(url, str, sSLSession);
            }
        };
    }
