...
public final class C0821s {
    ...
    public final C0805b f1560a;
    public final Q b;
    public final InterfaceC0810g c;
    public final Lazy d;

    public C0821s(C0805b endpointProvider, Q remoteMetricsEventDtoSerializer, X.b logger) {
        ...
        this.c = logger;
        this.d = LazyKt.lazy(new C0819p(this));
    }
    ...
    public final void b(ArrayList values) {
        ...
        try {
            this.c.a(new C0820q(a3.getURL(), a3.getResponseCode(), a2));
            a3.disconnect();
        } catch (Throwable th2) {
            th = th2;
            httpsURLConnection = a3;
    ...
    public static HostnameVerifier a(final URL url) {
        return new HostnameVerifier() { // from class: ru.rustore.sdk.metrics.internal.s$$ExternalSyntheticLambda0
            ...
            public final boolean verify(String str, SSLSession sSLSession) {
                return C0821s.a(url, str, sSLSession);
            }
        };
    }
