...
public final class T {
    ...
    public T(N persistentMetricsEventRepository, S remoteMetricsEventRepository) {
        ...
        this.f1583a = persistentMetricsEventRepository;
    ...
    public final W a() {
        ...
        try {
            ...
            for (J dto : list) {
                ...
                String str2 = dto.f1575a;
                C0828t c0828t = l.f1577a;
            ...
            String value2 = s.b.f1566a.getPackageName();
            Intrinsics.checkNotNullExpressionValue(value2, "context.packageName");
            Intrinsics.checkNotNullParameter(value2, "value");
            b0 b0Var = s.f1582a;
            SharedPreferences sharedPreferences = b0Var.f1593a.f1589a;
            ...
            if (value3 == null) {
                synchronized (b0.c) {
                    SharedPreferences sharedPreferences2 = b0Var.f1593a.f1589a;
            ...
            String str3 = d0Var != null ? d0Var.f1596a : null;
            ArrayList values2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(values, 10));
            Iterator it = values.iterator();
            while (it.hasNext()) {
                D d = (D) it.next();
                values2.add(new P(value2, d.f1567a, str, str3, d.b));
            }
            O o = s.c;
            o.getClass();
