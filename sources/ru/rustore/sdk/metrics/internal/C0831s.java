...
public final class C0831s {
    ...
    public final C0815b f1625a;
    public final Q b;
    public final InterfaceC0820g c;
    public final Lazy d;

    public C0831s(C0815b endpointProvider, Q remoteMetricsEventDtoSerializer, X.b logger) {
        ...
        this.c = logger;
        this.d = LazyKt.lazy(new C0829p(this));
    }
    ...
    public final void b(ArrayList values) {
        ...
        try {
            this.c.a(new C0830q(a3.getURL(), a3.getResponseCode(), a2));
            a3.disconnect();
        } catch (Throwable th2) {
            th = th2;
            httpsURLConnection = a3;
    ...
    public static HostnameVerifier a(final URL url) {
        return new HostnameVerifier() { // from class: ru.rustore.sdk.metrics.internal.s$$ExternalSyntheticLambda0
            ...
            public final boolean verify(String str, SSLSession sSLSession) {
                return C0831s.a(url, str, sSLSession);
            }
        };
    }
