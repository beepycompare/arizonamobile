...
public final class C0839s {
    ...
    public final C0823b f1473a;
    public final Q b;
    public final InterfaceC0828g c;
    public final Lazy d;

    public C0839s(C0823b endpointProvider, Q remoteMetricsEventDtoSerializer, X.b logger) {
        Intrinsics.checkNotNullParameter(endpointProvider, "endpointProvider");
        Intrinsics.checkNotNullParameter(remoteMetricsEventDtoSerializer, "remoteMetricsEventDtoSerializer");
        Intrinsics.checkNotNullParameter(logger, "logger");
        this.f1473a = endpointProvider;
        this.b = remoteMetricsEventDtoSerializer;
        this.c = logger;
        this.d = LazyKt.lazy(new C0837p(this));
    }
    ...
    public final String a(ArrayList arrayList) {
        ...
        while (it.hasNext()) {
            ...
            jSONObject3.put("package_name", remoteMetricsEventDto.f1437a);
    ...
    public final void b(ArrayList values) {
        ...
        try {
            this.c.a(new C0838q(a3.getURL(), a3.getResponseCode(), a2));
            a3.disconnect();
        } catch (Throwable th2) {
            th = th2;
            httpsURLConnection = a3;
    ...
    public static HostnameVerifier a(final URL url) {
        return new HostnameVerifier() { // from class: ru.rustore.sdk.metrics.internal.s$$ExternalSyntheticLambda0
            ...
            public final boolean verify(String str, SSLSession sSLSession) {
                return C0839s.a(url, str, sSLSession);
            }
        };
    }
