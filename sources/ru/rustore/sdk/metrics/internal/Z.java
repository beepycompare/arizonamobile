...
public final class Z implements Dispatcher {
    ...
    public final ScheduledThreadPoolExecutor f1437a = new ScheduledThreadPoolExecutor(1);

    /* loaded from: classes6.dex */
    public static final class a implements Disposable {

        /* renamed from: a  reason: collision with root package name */
        public final AtomicBoolean f1438a = new AtomicBoolean();
    ...
    public final void execute(final Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        this.f1437a.submit(new Runnable() { // from class: ru.rustore.sdk.metrics.internal.Z$$ExternalSyntheticLambda0
    ...
    public final Disposable executeDelayed(long j, TimeUnit timeUnit, final Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        return new a(this.f1437a.schedule(new Runnable() { // from class: ru.rustore.sdk.metrics.internal.Z$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                Z.b(Function0.this);
            }
