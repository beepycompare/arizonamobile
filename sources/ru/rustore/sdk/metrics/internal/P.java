...
public final class P {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(P.class, obj != null ? obj.getClass() : null)) {
            ...
            P p = (P) obj;
            if (Intrinsics.areEqual(this.f1437a, p.f1437a) && Intrinsics.areEqual(this.b, p.b) && Intrinsics.areEqual(this.c, p.c)) {
                String str = this.d;
                String str2 = p.d;
                if (str == null) {
                    if (str2 == null) {
    ...
    public final int hashCode() {
        int hashCode = (this.c.hashCode() + ((this.b.hashCode() + (this.f1437a.hashCode() * 31)) * 31)) * 31;
        String str = this.d;
        d0 d0Var = str != null ? new d0(str) : null;
        return this.e.hashCode() + ((hashCode + (d0Var != null ? d0Var.f1452a.hashCode() : 0)) * 31);
    }
}
