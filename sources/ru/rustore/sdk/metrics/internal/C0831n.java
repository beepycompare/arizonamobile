...
public final class C0831n {
    ...
    public final InterfaceC0824g e;
    public boolean f;

    public C0831n(U sendMetricsEventInteractor, C0820c enqueueMetricsEventUseCase, V sendMetricsEventJobScheduler, Z singleThreadDispatcher, X.b logger) {
        ...
        this.f1453a = sendMetricsEventInteractor;
