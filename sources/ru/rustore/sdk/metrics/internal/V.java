...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1598a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1598a, SendMetricsEventJobService.class));
        this.b.f1608a.f1612a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m10569getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
