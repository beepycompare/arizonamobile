...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1570a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1570a, SendMetricsEventJobService.class));
        this.b.f1580a.f1584a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m11567getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
