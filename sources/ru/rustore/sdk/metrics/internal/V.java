...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1441a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1441a, SendMetricsEventJobService.class));
        this.b.f1451a.f1455a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m10459getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
