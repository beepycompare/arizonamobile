...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1584a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1584a, SendMetricsEventJobService.class));
        this.b.f1594a.f1598a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m11584getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
