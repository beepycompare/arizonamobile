...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1437a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1437a, SendMetricsEventJobService.class));
        this.b.f1447a.f1451a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m10447getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
