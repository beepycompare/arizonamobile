...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1571a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1571a, SendMetricsEventJobService.class));
        this.b.f1581a.f1585a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m11210getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
