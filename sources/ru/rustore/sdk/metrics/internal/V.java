...
public final class V {
    ...
    public final void a() {
        Object systemService = this.f1487a.getSystemService(JobScheduler.class);
        ...
        JobInfo.Builder builder = new JobInfo.Builder(88123556, new ComponentName(this.f1487a, SendMetricsEventJobService.class));
        this.b.f1497a.f1501a.getClass();
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m11270getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
