...
public final class V {
    ...
    public final void a() {
        ...
        jobScheduler.schedule(builder.setPeriodic(Duration.m11284getInWholeMillisecondsimpl(DurationKt.toDuration(JOB_REPEAT_INTERVAL_MINUTES.intValue(), DurationUnit.MINUTES))).setPersisted(true).build());
    }
}
