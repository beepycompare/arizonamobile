...
public final class B {
    ...
    public final C0842w f1401a;
    public final C0843x b;
    public final C0845z c;
    public final A d;
    ...
    public B(C0842w migrationDtoVer1Factory, C0843x migrationDtoVer1Serializer, C0845z migrationDtoVer2Mapper, A migrationDtoVer2Serializer) {
        ...
        this.f1401a = migrationDtoVer1Factory;
    ...
    public final void a(SQLiteDatabase db) {
        ...
        try {
            ...
            while (rawQuery.moveToNext()) {
                ...
                c0842w.getClass();
                arrayList.add(C0842w.a(value, decodeToString));
            }
            ...
            while (it.hasNext()) {
                C0841v dto = (C0841v) it.next();
                C0845z c0845z = b.c;
                c0845z.getClass();
                Intrinsics.checkNotNullParameter(dto, "dto");
                String str = dto.f1456a;
                String str2 = dto.b;
                Map<String, String> map = dto.c;
                c0845z.f1458a.getClass();
                C0844y dto2 = new C0844y(str, str2, map, System.currentTimeMillis());
                b.b.getClass();
                Intrinsics.checkNotNullParameter(dto, "dto");
                ...
                String joinToString$default = ArraysKt.joinToString$default(bytes, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0821a.f1429a, 30, (Object) null);
                b.d.getClass();
                ...
                arrayList2.add(dto.f1456a);
                sb.append("\n                WHEN metrics_event = x'" + joinToString$default + "' THEN x'" + ArraysKt.joinToString$default(bytes2, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0821a.f1429a, 30, (Object) null) + "'\n            ");
                i = 0;
                b = this;
            }
            sb.append("\n                END\n                WHERE uuid IN (" + CollectionsKt.joinToString$default(arrayList2, null, null, null, 0, null, a.f1402a, 31, null) + ")\n            ");
