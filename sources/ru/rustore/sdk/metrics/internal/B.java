...
public final class B {
    ...
    public B(C0847w migrationDtoVer1Factory, C0848x migrationDtoVer1Serializer, C0850z migrationDtoVer2Mapper, A migrationDtoVer2Serializer) {
        ...
        this.f1550a = migrationDtoVer1Factory;
    ...
    public final void a(SQLiteDatabase db) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                String str = dto.f1605a;
                String str2 = dto.b;
                Map<String, String> map = dto.c;
                c0850z.f1607a.getClass();
                ...
                String joinToString$default = ArraysKt.joinToString$default(bytes, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0826a.f1578a, 30, (Object) null);
                b.d.getClass();
                ...
                arrayList2.add(dto.f1605a);
                sb.append("\n                WHEN metrics_event = x'" + joinToString$default + "' THEN x'" + ArraysKt.joinToString$default(bytes2, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0826a.f1578a, 30, (Object) null) + "'\n            ");
                i = 0;
                b = this;
            }
            sb.append("\n                END\n                WHERE uuid IN (" + CollectionsKt.joinToString$default(arrayList2, null, null, null, 0, null, a.f1551a, 31, null) + ")\n            ");
