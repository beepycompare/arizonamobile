...
public final class B {
    ...
    public final C0839w f1411a;
    public final C0840x b;
    public final C0842z c;
    public final A d;
    ...
    public B(C0839w migrationDtoVer1Factory, C0840x migrationDtoVer1Serializer, C0842z migrationDtoVer2Mapper, A migrationDtoVer2Serializer) {
        ...
        this.f1411a = migrationDtoVer1Factory;
    ...
    public final void a(SQLiteDatabase db) {
        ...
        try {
            ...
            while (rawQuery.moveToNext()) {
                ...
                c0839w.getClass();
                arrayList.add(C0839w.a(value, decodeToString));
            }
            ...
            while (it.hasNext()) {
                C0838v dto = (C0838v) it.next();
                C0842z c0842z = b.c;
                c0842z.getClass();
                Intrinsics.checkNotNullParameter(dto, "dto");
                String str = dto.f1466a;
                String str2 = dto.b;
                Map<String, String> map = dto.c;
                c0842z.f1468a.getClass();
                C0841y dto2 = new C0841y(str, str2, map, System.currentTimeMillis());
                b.b.getClass();
                Intrinsics.checkNotNullParameter(dto, "dto");
                ...
                String joinToString$default = ArraysKt.joinToString$default(bytes, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0818a.f1439a, 30, (Object) null);
                b.d.getClass();
                ...
                arrayList2.add(dto.f1466a);
                sb.append("\n                WHEN metrics_event = x'" + joinToString$default + "' THEN x'" + ArraysKt.joinToString$default(bytes2, (CharSequence) "", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) C0818a.f1439a, 30, (Object) null) + "'\n            ");
                i = 0;
                b = this;
            }
            sb.append("\n                END\n                WHERE uuid IN (" + CollectionsKt.joinToString$default(arrayList2, null, null, null, 0, null, a.f1412a, 31, null) + ")\n            ");
