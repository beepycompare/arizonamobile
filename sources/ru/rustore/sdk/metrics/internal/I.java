...
public final class I {
    ...
    public final C0820o f1515a;
    public final InterfaceC0812g b;
    public final Lazy c;
    ...
    public static final class b extends Lambda implements Function0<String> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ J f1517a;
        ...
        @Override // kotlin.jvm.functions.Function0
        public final String invoke() {
            return "Create row in storage " + ((Object) ("MetricsEventUuid(value=" + this.f1517a.f1518a + ')'));
        }
    }

    public I(C0820o metricsEventDataBaseHelper, X.b logger) {
        Intrinsics.checkNotNullParameter(metricsEventDataBaseHelper, "metricsEventDataBaseHelper");
        Intrinsics.checkNotNullParameter(logger, "logger");
        this.f1515a = metricsEventDataBaseHelper;
        this.b = logger;
    ...
    public final void a(ArrayList persistentMetricsEventsDto) {
        ...
        String joinToString$default = CollectionsKt.joinToString$default(persistentMetricsEventsDto, null, null, null, 0, null, G.f1513a, 31, null);
    ...
    public final void a(J persistentMetricsEventDto) {
        ...
        contentValues.put(CommonUrlParts.UUID, persistentMetricsEventDto.f1518a);
        ...
        try {
            ...
            String str = "Saving error " + ((Object) ("MetricsEventUuid(value=" + persistentMetricsEventDto.f1518a + ')'));
            this.b.a(new a(str));
