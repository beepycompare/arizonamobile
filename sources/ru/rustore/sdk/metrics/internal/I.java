...
public final class I {
    ...
    public final C0840o f1560a;
    public final InterfaceC0832g b;
    public final Lazy c;
    ...
    public static final class b extends Lambda implements Function0<String> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final /* synthetic */ J f1562a;
        ...
        @Override // kotlin.jvm.functions.Function0
        public final String invoke() {
            return "Create row in storage " + ((Object) ("MetricsEventUuid(value=" + this.f1562a.f1563a + ')'));
        }
    }

    public I(C0840o metricsEventDataBaseHelper, X.b logger) {
        Intrinsics.checkNotNullParameter(metricsEventDataBaseHelper, "metricsEventDataBaseHelper");
        Intrinsics.checkNotNullParameter(logger, "logger");
        this.f1560a = metricsEventDataBaseHelper;
        this.b = logger;
    ...
    public final void a(ArrayList persistentMetricsEventsDto) {
        ...
        String joinToString$default = CollectionsKt.joinToString$default(persistentMetricsEventsDto, null, null, null, 0, null, G.f1558a, 31, null);
    ...
    public final void a(J persistentMetricsEventDto) {
        ...
        contentValues.put(CommonUrlParts.UUID, persistentMetricsEventDto.f1563a);
        ...
        try {
            ...
            String str = "Saving error " + ((Object) ("MetricsEventUuid(value=" + persistentMetricsEventDto.f1563a + ')'));
            this.b.a(new a(str));
