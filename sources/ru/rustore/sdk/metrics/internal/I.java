...
public final class I {
    ...
    public static final class b extends Lambda implements Function0<String> {
        ...
        @Override // kotlin.jvm.functions.Function0
        public final String invoke() {
            return "Create row in storage " + ((Object) ("MetricsEventUuid(value=" + this.f1560a.f1561a + ')'));
        }
    }
    ...
    public I(C0840o metricsEventDataBaseHelper, X.b logger) {
        ...
        this.f1558a = metricsEventDataBaseHelper;
        this.b = logger;
    ...
    public final void a(ArrayList persistentMetricsEventsDto) {
        ...
        String joinToString$default = CollectionsKt.joinToString$default(persistentMetricsEventsDto, null, null, null, 0, null, G.f1556a, 31, null);
    ...
    public final void a(J persistentMetricsEventDto) {
        ...
        contentValues.put(CommonUrlParts.UUID, persistentMetricsEventDto.f1561a);
        ...
        try {
            ...
            String str = "Saving error " + ((Object) ("MetricsEventUuid(value=" + persistentMetricsEventDto.f1561a + ')'));
            this.b.a(new a(str));
