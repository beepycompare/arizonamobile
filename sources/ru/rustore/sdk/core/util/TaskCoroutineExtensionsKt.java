                ...
                if (i != 0) {
                    ...
                    task.addOnCompleteListener(new OnCompleteListener<T>() { // from class: ru.rustore.sdk.core.util.TaskCoroutineExtensionsKt$toSuspendResult$2$1
                        ...
                        public void onSuccess(T t) {
                            ...
                            CancellableContinuationExtKt.resumeIfActive(cancellableContinuation, Result.m8473boximpl(Result.m8474constructorimpl(t)));
                        }
                        ...
                        public void onFailure(Throwable throwable) {
                            ...
                            CancellableContinuation<Result<? extends T>> cancellableContinuation = cancellableContinuationImpl2;
                            Result.Companion companion = Result.Companion;
                            CancellableContinuationExtKt.resumeIfActive(cancellableContinuation, Result.m8473boximpl(Result.m8474constructorimpl(ResultKt.createFailure(throwable))));
                        }
                    });
