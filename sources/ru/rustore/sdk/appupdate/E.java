...
public final class E extends Lambda implements Function1<SingleEmitter<Integer>, Unit> {
    ...
    public final void a(final SingleEmitter<Integer> emitter) {
        ...
        try {
            ...
            ContextExtensionKt.openActivityForResult(c0817r.f1538a, new Intent("ru.vk.store.AnyAppForceUpdateActivity"), new OnReceiveResultCallback() { // from class: ru.rustore.sdk.appupdate.E$$ExternalSyntheticLambda0
        ...
        if (m9845exceptionOrNullimpl != null) {
            emitter.error(m9845exceptionOrNullimpl);
        }
    }
