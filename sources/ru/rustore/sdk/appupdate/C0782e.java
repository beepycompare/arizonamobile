...
public final class C0782e {
    ...
    public C0782e(C0791n analyticsRepository, a0 sdkInfoRepository, L appVersionNameRepository, AnalyticsEventProvider analyticsEventProvider, Context context) {
    ...
    public final void a(int i, String errorCode) {
        ...
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(new C0786i("updateStart.error", linkedHashMap))), Dispatchers.INSTANCE.getIo()), null, b.f1469a, 1, null);
    }
}
