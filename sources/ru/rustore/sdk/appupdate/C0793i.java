...
public final class C0793i extends AnalyticsEvent {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0793i) {
            ...
            return Intrinsics.areEqual(this.f1444a, c0793i.f1444a) && Intrinsics.areEqual(this.b, c0793i.b);
        }
        return false;
    }
    ...
    public final int hashCode() {
        return this.b.hashCode() + (this.f1444a.hashCode() * 31);
    }

    public final String toString() {
        return "AppUpdateAnalyticsEvent(eventName=" + this.f1444a + ", eventData=" + this.b + ')';
    }
}
