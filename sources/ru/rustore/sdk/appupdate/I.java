...
public final class I extends Lambda implements Function1<Unit, Single<Integer>> {
    ...
    public final /* synthetic */ C0812r f1338a;
    public final /* synthetic */ AppUpdateInfo b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public I(C0812r c0812r, AppUpdateInfo appUpdateInfo) {
        super(1);
        this.f1338a = c0812r;
    ...
    public final Single<Integer> invoke(Unit unit) {
        ...
        C0812r c0812r = this.f1338a;
        AppUpdateInfo appUpdateInfo = this.b;
        c0812r.getClass();
        return Single.Companion.create(new C(c0812r, appUpdateInfo));
    }
}
