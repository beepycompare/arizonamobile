...
public final class C0786i extends AnalyticsEvent {

    /* renamed from: a  reason: collision with root package name */
    public final String f1485a;
    public final Map<String, String> b;

    public C0786i(String eventName, Map<String, String> eventData) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0786i) {
            ...
            return Intrinsics.areEqual(this.f1485a, c0786i.f1485a) && Intrinsics.areEqual(this.b, c0786i.b);
        }
        return false;
    }
