...
public final class C0795i extends AnalyticsEvent {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0795i) {
            ...
            return Intrinsics.areEqual(this.f1555a, c0795i.f1555a) && Intrinsics.areEqual(this.b, c0795i.b);
        }
        return false;
    }
    ...
    public final String toString() {
        return "AppUpdateAnalyticsEvent(eventName=" + this.f1555a + ", eventData=" + this.b + ')';
    }
}
