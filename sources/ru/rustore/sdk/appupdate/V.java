    ...
    public final Unit invoke(InstallState installState) {
        ...
        if (appUpdateOptions != null) {
            ...
            if (installStatus == 1) {
                C0788e c0788e = z.c;
                c0788e.getClass();
                SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0786c(c0788e, new C0792i("updateStart.downloaded", c0788e.a(appUpdateType)))), Dispatchers.INSTANCE.getIo()), null, C0787d.f1522a, 1, null);
        ...
        for (InstallStateUpdateListener installStateUpdateListener : this.f1514a.b) {
