...
public final class V extends Lambda implements Function1<InstallState, Unit> {
    ...
    public final /* synthetic */ Z f1524a;
    ...
    public final Unit invoke(InstallState installState) {
        ...
        if (appUpdateOptions != null) {
            ...
            if (installStatus == 1) {
                C0792e c0792e = z.c;
                c0792e.getClass();
                SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0790c(c0792e, new C0796i("updateStart.downloaded", c0792e.a(appUpdateType)))), Dispatchers.INSTANCE.getIo()), null, C0791d.f1532a, 1, null);
        ...
        for (InstallStateUpdateListener installStateUpdateListener : this.f1524a.b) {
