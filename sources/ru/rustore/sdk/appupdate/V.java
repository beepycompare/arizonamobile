...
public final class V extends Lambda implements Function1<InstallState, Unit> {
    ...
    public final /* synthetic */ Z f1515a;
    ...
    public final Unit invoke(InstallState installState) {
        ...
        if (appUpdateOptions != null) {
            ...
            if (installStatus == 1) {
                C0788e c0788e = z.c;
                c0788e.getClass();
                SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0786c(c0788e, new C0792i("updateStart.downloaded", c0788e.a(appUpdateType)))), Dispatchers.INSTANCE.getIo()), null, C0787d.f1523a, 1, null);
        ...
        for (InstallStateUpdateListener installStateUpdateListener : this.f1515a.b) {
