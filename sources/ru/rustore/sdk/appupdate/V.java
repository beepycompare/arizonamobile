    ...
    public final Unit invoke(InstallState installState) {
        ...
        if (appUpdateOptions != null) {
            ...
            if (installStatus == 1) {
                C0799e c0799e = z.c;
                c0799e.getClass();
                SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new C0797c(c0799e, new C0803i("updateStart.downloaded", c0799e.a(appUpdateType)))), Dispatchers.INSTANCE.getIo()), null, C0798d.f1360a, 1, null);
        ...
        for (InstallStateUpdateListener installStateUpdateListener : this.f1352a.b) {
