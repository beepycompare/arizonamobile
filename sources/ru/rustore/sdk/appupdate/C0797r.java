...
public final class C0797r {
    ...
    public static final class a<T> extends Lambda implements Function1<SingleEmitter<T>, Unit> {
        ...
        public final Unit invoke(Object obj) {
            ...
            C0797r c0797r = C0797r.this;
            Function1<SingleEmitter<T>, ServiceConnection> function1 = this.b;
            try {
                Result.Companion companion = Result.Companion;
                ServiceConnection invoke = function1.invoke(emitter);
                emitter.onFinish(new C0795p(c0797r, invoke));
                C0797r.a(c0797r, c0797r.f1496a, new C0796q(emitter), invoke);
    ...
    public C0797r(Context context, C0794o appUpdateInfoMapper) {
    ...
    public static final void a(C0797r c0797r, Context context, C0796q c0796q, ServiceConnection serviceConnection) {
        List<ResolveInfo> queryIntentServices;
        String str;
        if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(context)) {
            c0796q.invoke(new RuStoreNotInstalledException());
            return;
        }
        ...
        if (findRuStoreServiceComponentName == null) {
            c0796q.invoke(new RuStoreOutdatedException());
            return;
        }
    ...
    public static final AppUpdateParams a(C0797r c0797r, Context context) {
        c0797r.getClass();
