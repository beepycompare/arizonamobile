...
public final class o implements OnReceiveResultCallback {
    ...
    public final /* synthetic */ CancellableContinuation<Unit> f1359a;
    ...
    public final void onReceiveResult(int i, Bundle bundle) {
        if (i == -1 || i == 0) {
            CancellableContinuationExtKt.resumeIfActive(this.f1359a, Unit.INSTANCE);
        } else if (i == 2) {
            CancellableContinuationExtKt.resumeWithExceptionIfActive(this.f1359a, new RuStoreOutdatedException());
