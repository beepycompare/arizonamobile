...
public final class C0813r {
    ...
    public static final void a(C0813r c0813r, Context context, C0812q c0812q, ServiceConnection serviceConnection) {
        List<ResolveInfo> queryIntentServices;
        String str;
        if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(context)) {
            c0812q.invoke(new RuStoreNotInstalledException());
            return;
        }
        ...
        if (findRuStoreServiceComponentName == null) {
            c0812q.invoke(new RuStoreOutdatedException());
            return;
        }
    ...
    public static final AppUpdateParams a(C0813r c0813r, Context context) {
        c0813r.getClass();
