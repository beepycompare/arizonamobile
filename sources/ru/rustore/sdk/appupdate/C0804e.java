...
public final class C0804e {
    ...
    public static final class c extends Lambda implements Function0<Map<String, ? extends String>> {
        ...
        public final Map<String, ? extends String> invoke() {
            a0 a0Var = C0804e.this.b;
            a0Var.f1507a.getClass();
            c0 c0Var = a0Var.b;
            c0Var.getClass();
            String type = RuStoreInternalConfig.Companion.create(c0Var.f1510a).getSdkType().getValue();
            a0Var.c.getClass();
    ...
    public C0804e(C0813n analyticsRepository, a0 sdkInfoRepository, L appVersionNameRepository, AnalyticsEventProvider analyticsEventProvider, Context context) {
        ...
        this.f1512a = analyticsRepository;
    ...
    public final LinkedHashMap a(int i) {
        ...
        String value = (String) this.c.f1493a.b.getValue();
        if (value != null) {
    ...
    public final void a(int i, String errorCode) {
        ...
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(new C0808i("updateStart.error", linkedHashMap))), Dispatchers.INSTANCE.getIo()), null, b.f1514a, 1, null);
    }
}
