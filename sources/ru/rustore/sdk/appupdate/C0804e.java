...
public final class C0804e {
    ...
    public final void a(int i, String errorCode) {
        ...
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(new C0808i("updateStart.error", linkedHashMap))), Dispatchers.INSTANCE.getIo()), null, b.f1511a, 1, null);
    }
}
