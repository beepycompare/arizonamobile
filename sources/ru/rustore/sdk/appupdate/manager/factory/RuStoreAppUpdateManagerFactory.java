...
public final class RuStoreAppUpdateManagerFactory {
    ...
    public final RuStoreAppUpdateManager create(Context context, Map<String, ? extends Object> map) {
        Intrinsics.checkNotNullParameter(context, "context");
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(context, map)), Dispatchers.INSTANCE.getIo()), null, b.f1547a, 1, null);
