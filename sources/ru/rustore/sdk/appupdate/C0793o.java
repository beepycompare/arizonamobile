...
public final class C0793o {
    ...
    public final AppUpdateInfo.Factory f1493a;
    public final i0 b;

    public C0793o(AppUpdateInfo.Factory appUpdateInfoFactory, i0 timeProvider) {
        Intrinsics.checkNotNullParameter(appUpdateInfoFactory, "appUpdateInfoFactory");
        Intrinsics.checkNotNullParameter(timeProvider, "timeProvider");
        this.f1493a = appUpdateInfoFactory;
        this.b = timeProvider;
    }
    ...
    public final AppUpdateInfo a(Bundle bundle) {
        ...
        AppUpdateInfo.Factory factory = this.f1493a;
        ...
        Date time = this.b.f1486a.getTime();
