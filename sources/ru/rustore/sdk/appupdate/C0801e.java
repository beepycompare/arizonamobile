...
public final class C0801e {
    ...
    public C0801e(C0810n analyticsRepository, a0 sdkInfoRepository, L appVersionNameRepository, AnalyticsEventProvider analyticsEventProvider, Context context) {
    ...
    public final void a(int i, String errorCode) {
        ...
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(new C0805i("updateStart.error", linkedHashMap))), Dispatchers.INSTANCE.getIo()), null, b.f1383a, 1, null);
    }
}
