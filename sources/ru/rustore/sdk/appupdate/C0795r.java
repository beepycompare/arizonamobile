...
public final class C0795r {
    ...
    public static final class a<T> extends Lambda implements Function1<SingleEmitter<T>, Unit> {
        ...
        public final Unit invoke(Object obj) {
            ...
            C0795r c0795r = C0795r.this;
            Function1<SingleEmitter<T>, ServiceConnection> function1 = this.b;
            try {
                Result.Companion companion = Result.Companion;
                ServiceConnection invoke = function1.invoke(emitter);
                emitter.onFinish(new C0793p(c0795r, invoke));
                C0795r.a(c0795r, c0795r.f1496a, new C0794q(emitter), invoke);
            ...
            if (m9924exceptionOrNullimpl != null) {
                emitter.error(m9924exceptionOrNullimpl);
            }
    ...
    public C0795r(Context context, C0792o appUpdateInfoMapper) {
    ...
    public static final void a(C0795r c0795r, Context context, C0794q c0794q, ServiceConnection serviceConnection) {
        List<ResolveInfo> queryIntentServices;
        String str;
        if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(context)) {
            c0794q.invoke(new RuStoreNotInstalledException());
            return;
        }
        ...
        if (findRuStoreServiceComponentName == null) {
            c0794q.invoke(new RuStoreOutdatedException());
            return;
        }
    ...
    public static final AppUpdateParams a(C0795r c0795r, Context context) {
        c0795r.getClass();
