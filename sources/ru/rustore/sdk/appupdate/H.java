...
public final class H extends Lambda implements Function1<SingleEmitter<Unit>, ServiceConnection> {
    ...
    public final /* synthetic */ AppUpdateInfo f1337a;
    public final /* synthetic */ C0812r b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public H(C0812r c0812r, AppUpdateInfo appUpdateInfo) {
        super(1);
        this.f1337a = appUpdateInfo;
        this.b = c0812r;
    }
    ...
    public final ServiceConnection invoke(SingleEmitter<Unit> singleEmitter) {
        ...
        this.f1337a.markIsUsed$sdk_public_appupdate_release();
        Context context = this.b.f1390a;
