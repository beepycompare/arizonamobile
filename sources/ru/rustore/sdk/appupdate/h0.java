...
public final class h0 implements ServiceConnection {
    ...
    public h0(Context context, String applicationId, C0808v onSuccess, C0809w onError) {
    ...
    public final void onServiceConnected(ComponentName name, IBinder service) {
        ...
        try {
            ...
            ContextExtKt.unbindServiceSafely(this.f1553a, this);
        }
    }
    ...
    public static final class a extends g0.a {
        ...
        public final void a(int i, String errorMessage) {
            ...
            ContextExtKt.unbindServiceSafely(h0.this.f1553a, this.b);
        }
