...
public final class C0806o {
    ...
    public final AppUpdateInfo.Factory f1397a;
    public final i0 b;

    public C0806o(AppUpdateInfo.Factory appUpdateInfoFactory, i0 timeProvider) {
        Intrinsics.checkNotNullParameter(appUpdateInfoFactory, "appUpdateInfoFactory");
        Intrinsics.checkNotNullParameter(timeProvider, "timeProvider");
        this.f1397a = appUpdateInfoFactory;
        this.b = timeProvider;
    }
    ...
    public final AppUpdateInfo a(Bundle bundle) {
        ...
        AppUpdateInfo.Factory factory = this.f1397a;
        ...
        Date time = this.b.f1390a.getTime();
