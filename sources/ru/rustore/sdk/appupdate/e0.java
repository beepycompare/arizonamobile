...
public final class e0 {
    ...
    public final Lazy f = LazyKt.lazy(b.f1515a);
    ...
    /* loaded from: classes6.dex */
    public static final class b extends Lambda implements Function0<C0809j> {
        ...
        public final C0809j invoke() {
            return new C0809j();
        }
    }

    /* loaded from: classes6.dex */
    public static final class c extends Lambda implements Function0<C0813n> {
        public c() {
            super(0);
        }

        @Override // kotlin.jvm.functions.Function0
        public final C0813n invoke() {
            return new C0813n((C0809j) e0.this.f.getValue(), (MetricsClient) e0.this.g.getValue());
        }
    }

    /* loaded from: classes6.dex */
    public static final class d extends Lambda implements Function0<C0804e> {
        public d() {
            super(0);
        }

        @Override // kotlin.jvm.functions.Function0
        public final C0804e invoke() {
            return new C0804e((C0813n) e0.this.d.getValue(), (a0) e0.this.h.getValue(), (L) e0.this.e.getValue(), AnalyticsEventProvider.INSTANCE, e0.this.f1514a);
        }
    }
    ...
    public static final class e extends Lambda implements Function0<L> {
        ...
        public final L invoke() {
            return new L(new K(e0.this.f1514a));
        }
    }
    ...
    public static final class f extends Lambda implements Function0<MetricsClient> {
        ...
        public final MetricsClient invoke() {
            return MetricsClient.Companion.getInstance(e0.this.f1514a);
        }
    }
