...
public final class C0783e {
    ...
    public C0783e(C0792n analyticsRepository, a0 sdkInfoRepository, L appVersionNameRepository, AnalyticsEventProvider analyticsEventProvider, Context context) {
    ...
    public final void a(int i, String errorCode) {
        ...
        SingleSubscribeKt.subscribe$default(SingleSubscribeOnKt.subscribeOn(Single.Companion.from(new a(new C0787i("updateStart.error", linkedHashMap))), Dispatchers.INSTANCE.getIo()), null, b.f1469a, 1, null);
    }
}
