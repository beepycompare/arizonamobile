...
public final class D extends Lambda implements Function1<SingleEmitter<Unit>, Unit> {
    ...
    public final /* synthetic */ C0795r f1439a;
    public final /* synthetic */ int b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public D(C0795r c0795r, int i) {
        super(1);
        this.f1439a = c0795r;
        this.b = i;
    }
    ...
    public final void a(final SingleEmitter<Unit> emitter) {
        ...
        C0795r c0795r = this.f1439a;
        int i = this.b;
        try {
            Result.Companion companion = Result.Companion;
            if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(c0795r.f1496a)) {
                emitter.error(new RuStoreNotInstalledException());
            }
            Context context = c0795r.f1496a;
            Intent intent = new Intent("ru.vk.store.FlexibleAppUpdate");
            intent.putExtra("RUN_INSTALL", true);
            intent.putExtra("PACKAGE_NAME", c0795r.f1496a.getPackageName());
