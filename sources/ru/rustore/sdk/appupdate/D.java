...
public final class D extends Lambda implements Function1<SingleEmitter<Unit>, Unit> {
    ...
    public final /* synthetic */ C0805r f1504a;
    ...
    public final void a(final SingleEmitter<Unit> emitter) {
        ...
        C0805r c0805r = this.f1504a;
        int i = this.b;
        try {
            Result.Companion companion = Result.Companion;
            if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(c0805r.f1561a)) {
            ...
            intent.putExtra("PACKAGE_NAME", c0805r.f1561a.getPackageName());
