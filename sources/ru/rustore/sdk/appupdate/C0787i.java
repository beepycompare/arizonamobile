...
public final class C0787i extends AnalyticsEvent {

    /* renamed from: a  reason: collision with root package name */
    public final String f1485a;
    public final Map<String, String> b;

    public C0787i(String eventName, Map<String, String> eventData) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C0787i) {
            ...
            return Intrinsics.areEqual(this.f1485a, c0787i.f1485a) && Intrinsics.areEqual(this.b, c0787i.b);
        }
        return false;
    }
