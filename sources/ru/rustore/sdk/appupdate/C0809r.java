...
public final class C0809r {
    ...
    public static final class a<T> extends Lambda implements Function1<SingleEmitter<T>, Unit> {
        ...
        public final Unit invoke(Object obj) {
            ...
            C0809r c0809r = C0809r.this;
            Function1<SingleEmitter<T>, ServiceConnection> function1 = this.b;
            try {
                Result.Companion companion = Result.Companion;
                ServiceConnection invoke = function1.invoke(emitter);
                emitter.onFinish(new C0807p(c0809r, invoke));
                C0809r.a(c0809r, c0809r.f1400a, new C0808q(emitter), invoke);
            ...
            if (m9068exceptionOrNullimpl != null) {
                emitter.error(m9068exceptionOrNullimpl);
            }
    ...
    public C0809r(Context context, C0806o appUpdateInfoMapper) {
    ...
    public static final void a(C0809r c0809r, Context context, C0808q c0808q, ServiceConnection serviceConnection) {
        List<ResolveInfo> queryIntentServices;
        String str;
        if (!RuStoreUtils.INSTANCE.isRuStoreInstalled(context)) {
            c0808q.invoke(new RuStoreNotInstalledException());
            return;
        }
        ...
        if (findRuStoreServiceComponentName == null) {
            c0808q.invoke(new RuStoreOutdatedException());
            return;
        }
    ...
    public static final AppUpdateParams a(C0809r c0809r, Context context) {
        c0809r.getClass();
    ...
    public final <T> Single<T> a(Function1<? super SingleEmitter<T>, ? extends ServiceConnection> function1) {
        return SingleMapErrorKt.mapError(SingleTimeoutKt.timeout$default(Single.Companion.create(new a(function1)), 20000L, TimeUnit.MILLISECONDS, null, 4, null), b.f1402a);
    }
}
