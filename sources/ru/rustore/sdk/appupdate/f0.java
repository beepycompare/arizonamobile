...
public final class f0 implements ServiceConnection {
    ...
    public f0(Context context, String applicationId, F onSuccess, G onError) {
    ...
    public final void onServiceConnected(ComponentName name, IBinder service) {
        ...
        try {
            ...
            ContextExtKt.unbindServiceSafely(this.f1524a, this);
        }
    }
    ...
    public static final class a extends g0.a {
        ...
        public final void a(int i, String errorMessage) {
            ...
            ContextExtKt.unbindServiceSafely(f0.this.f1524a, this.b);
        }
