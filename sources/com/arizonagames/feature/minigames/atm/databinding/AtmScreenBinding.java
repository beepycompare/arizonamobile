...
public final class AtmScreenBinding implements ViewBinding {
    ...
    private AtmScreenBinding(FrameLayout frameLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, View view, ImageView imageView4, FrameLayout frameLayout2, LinearLayout linearLayout, View view2, LinearLayout linearLayout2, FrameLayout frameLayout3, CustomCardView customCardView, ImageView imageView5, TextView textView, LinearLayout linearLayout3, FrameLayout frameLayout4, ImageView imageView6, TextView textView2, TextView textView3, LinearLayout linearLayout4, FrameLayout frameLayout5, FrameLayout frameLayout6, FrameLayout frameLayout7, FrameLayout frameLayout8, FrameLayout frameLayout9, LinearLayout linearLayout5, CustomCardView customCardView2, TextView textView4, TextView textView5, LinearLayout linearLayout6) {
    ...
    public static AtmScreenBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AtmScreenBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.atm_screen, viewGroup, false);
        if (z) {
    ...
    public static AtmScreenBinding bind(View view) {
                                                                                                    ...
                                                                                                    if (textView4 != null) {
                                                                                                        ...
                                                                                                        if (textView5 != null) {
                                                                                                            ...
                                                                                                            if (linearLayout6 != null) {
                                                                                                                return new AtmScreenBinding(frameLayout4, imageView, imageView2, imageView3, findChildViewById, imageView4, frameLayout, linearLayout, findChildViewById2, linearLayout2, frameLayout2, customCardView, imageView5, textView, linearLayout3, frameLayout3, imageView6, textView2, textView3, linearLayout4, frameLayout4, frameLayout5, frameLayout6, frameLayout7, frameLayout8, linearLayout5, customCardView2, textView4, textView5, linearLayout6);
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
