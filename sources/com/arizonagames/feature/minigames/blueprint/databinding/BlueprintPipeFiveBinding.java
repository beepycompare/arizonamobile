...
public final class BlueprintPipeFiveBinding implements ViewBinding {
    ...
    private BlueprintPipeFiveBinding(ConstraintLayout constraintLayout, ImageView imageView, Guideline guideline, Guideline guideline2, Guideline guideline3, Guideline guideline4, Guideline guideline5, Guideline guideline6, Guideline guideline7, Guideline guideline8, Guideline guideline9, Guideline guideline10, Guideline guideline11, Guideline guideline12, Guideline guideline13, FrameLayout frameLayout, FrameLayout frameLayout2, FrameLayout frameLayout3, FrameLayout frameLayout4, FrameLayout frameLayout5) {
        this.rootView = constraintLayout;
        this.ivDrawing = imageView;
        this.stageFiveStart = guideline;
        this.stageFiveTop = guideline2;
        this.stageFourEnd = guideline3;
        this.stageFourStart = guideline4;
        this.stageOneBottom = guideline5;
        this.stageOneEnd = guideline6;
        this.stageOneStart = guideline7;
        this.stageOneTop = guideline8;
        this.stageThreeBottom = guideline9;
        this.stageThreeStart = guideline10;
        this.stageTwoBottom = guideline11;
        this.stageTwoEnd = guideline12;
        this.stageTwoStart = guideline13;
    ...
    public static BlueprintPipeFiveBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static BlueprintPipeFiveBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.blueprint_pipe_five, viewGroup, false);
        if (z) {
    ...
    public static BlueprintPipeFiveBinding bind(View view) {
                                                                        ...
                                                                        if (frameLayout3 != null) {
                                                                            ...
                                                                            if (frameLayout4 != null) {
                                                                                ...
                                                                                if (frameLayout5 != null) {
                                                                                    return new BlueprintPipeFiveBinding((ConstraintLayout) view, imageView, guideline, guideline2, guideline3, guideline4, guideline5, guideline6, guideline7, guideline8, guideline9, guideline10, guideline11, guideline12, guideline13, frameLayout, frameLayout2, frameLayout3, frameLayout4, frameLayout5);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
