...
public final class BlueprintPipeThreeBinding implements ViewBinding {
    ...
    public static BlueprintPipeThreeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static BlueprintPipeThreeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.blueprint_pipe_three, viewGroup, false);
        if (z) {
    ...
    public static BlueprintPipeThreeBinding bind(View view) {
                                                                                        ...
                                                                                        if (frameLayout3 != null) {
                                                                                            ...
                                                                                            if (frameLayout4 != null) {
                                                                                                ...
                                                                                                if (frameLayout5 != null) {
                                                                                                    return new BlueprintPipeThreeBinding((ConstraintLayout) view, imageView, guideline, guideline2, guideline3, guideline4, guideline5, guideline6, guideline7, guideline8, guideline9, guideline10, guideline11, guideline12, guideline13, guideline14, guideline15, guideline16, guideline17, frameLayout, frameLayout2, frameLayout3, frameLayout4, frameLayout5);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
