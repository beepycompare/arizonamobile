...
public final class ConveyorGameItemAdapter extends ListAdapter<ConveyorGameItemModel, ConveyorGameViewHolder> {
    ...
    public final class ConveyorGameViewHolder extends RecyclerView.ViewHolder {
        ...
        private final void initItem(ConveyorGameItemModel conveyorGameItemModel, int i) {
            ...
            if (i != this.this$0.selectItemId) {
                boolean z = this.this$0.isStartAnimation;
                ConveyorGameItemBinding conveyorGameItemBinding = this.binding;
                if (z) {
                    conveyorGameItemBinding.getRoot().setScaleX(1.0f);
                    this.binding.getRoot().setScaleY(1.0f);
                } else {
                    FrameLayout root2 = conveyorGameItemBinding.getRoot();
        ...
        private final void setupListeners(final ConveyorGameItemModel conveyorGameItemModel, final int i) {
            ...
            root.setOnClickListener(new View.OnClickListener() { // from class: com.arizonagames.feature.minigames.conveyor.ConveyorGameItemAdapter$ConveyorGameViewHolder$$ExternalSyntheticLambda0
    ...
    /* compiled from: ConveyorGameItemAdapter.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u0018\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0002H\u0016J\u0018\u0010\t\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\b\u001a\u00020\u0002H\u0016¨\u0006\n"}, d2 = {"Lcom/arizonagames/feature/minigames/conveyor/ConveyorGameItemAdapter$DiffUtilCallback;", "Landroidx/recyclerview/widget/DiffUtil$ItemCallback;", "Lcom/arizonagames/feature/minigames/conveyor/ConveyorGameItemModel;", "<init>", "()V", "areItemsTheSame", "", "oldItem", "newItem", "areContentsTheSame", "conveyor"}, k = 1, mv = {2, 3, 0}, xi = 48)
    /* loaded from: classes3.dex */
