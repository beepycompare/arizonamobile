...
public final class CertificateInfoItemLeftBinding implements ViewBinding {
    ...
    private CertificateInfoItemLeftBinding(ConstraintLayout constraintLayout, ImageView imageView, ConstraintLayout constraintLayout2, TextView textView, TextView textView2) {
    ...
    public static CertificateInfoItemLeftBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    return new CertificateInfoItemLeftBinding(constraintLayout, imageView, constraintLayout, textView, textView2);
                }
            }
        }
