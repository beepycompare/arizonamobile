...
@Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001*\u00020\u0003H\n"}, d2 = {"<anonymous>", "", "Lcom/arizonagames/feature/arizona/family/data/MemberItem;", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 3, 0}, xi = 48)
@DebugMetadata(c = "com.arizonagames.feature.arizona.family.FamilyScreen$requestMembersName$1$1$list$1", f = "FamilyScreen.kt", i = {}, l = {453}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
...
final class FamilyScreen$requestMembersName$1$1$list$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends MemberItem>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object membersName = familyApi.getMembersName(this.$it.getId(), 1, this.$name, this);
        return membersName == coroutine_suspended ? coroutine_suspended : membersName;
    }
}
