...
@DebugMetadata(c = "com.arizonagames.feature.arizona.family.FamilyScreen$requestCharterMembers$1$1$list$1", f = "FamilyScreen.kt", i = {}, l = {468}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
...
final class FamilyScreen$requestCharterMembers$1$1$list$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends CharterItem>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object charter = familyApi.getCharter(this.$it.getId(), this.$page, this);
        return charter == coroutine_suspended ? coroutine_suspended : charter;
    }
}
