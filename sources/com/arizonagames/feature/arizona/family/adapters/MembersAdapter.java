...
public final class MembersAdapter extends RecyclerView.Adapter<MembersViewHolder> {
    ...
    public final void sort1(boolean z) {
        ...
        if (z) {
            ...
            CollectionsKt.sortWith(list, new Comparator() { // from class: com.arizonagames.feature.arizona.family.adapters.MembersAdapter$sort1$$inlined$sortBy$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
    ...
    public final void sort2(boolean z) {
        ...
        if (z) {
            ...
            CollectionsKt.sortWith(list, new Comparator() { // from class: com.arizonagames.feature.arizona.family.adapters.MembersAdapter$sort2$$inlined$sortBy$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
