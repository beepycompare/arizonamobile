...
import com.arizonagames.feature.arizona.family.databinding.FamilyTerritoriesItemBinding;
...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010!\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\r\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B/\u0012\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004\u0012\u0012\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00060\u0004¢\u0006\u0004\b\t\u0010\nJ\u0018\u0010\u0014\u001a\u00020\u00022\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u0018H\u0016J\u0018\u0010\u0019\u001a\u00020\u00062\u0006\u0010\u001a\u001a\u00020\u00022\u0006\u0010\u001b\u001a\u00020\u0018H\u0016J\b\u0010\u001c\u001a\u00020\u0018H\u0016J\u0014\u0010\u001d\u001a\u00020\u00062\f\u0010\u001e\u001a\b\u0012\u0004\u0012\u00020\u00130\u0012J\u0014\u0010\u001f\u001a\u00020\u00062\f\u0010 \u001a\b\u0012\u0004\u0012\u00020\b0\u0012J\u0006\u0010!\u001a\u00020\u0006J\u0006\u0010\"\u001a\u00020\u0006J\u0006\u0010#\u001a\u00020\u0006J\u0006\u0010$\u001a\u00020\u0006R\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\u00060\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0017\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\b0\f¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u000e\u0010\u000f\u001a\u00020\u0010X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00130\u0012X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006%"}, d2 = {"Lcom/arizonagames/feature/arizona/family/adapters/TerritoryAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lcom/arizonagames/feature/arizona/family/adapters/TerritoriesItemViewHolder;", "onClick", "Lkotlin/Function1;", "Lcom/arizonagames/feature/arizona/family/data/FrameMapData;", "", "onGPS", "Lcom/arizonagames/feature/arizona/family/data/GangZoneItem;", "<init>", "(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V", "itemsList", "", "getItemsList", "()Ljava/util/List;", "isRequestSend", "", "uniqData", "", "Lcom/arizonagames/feature/arizona/family/data/UniqCellItem;", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "", "onBindViewHolder", "holder", "position", "getItemCount", "addUniq", "data", "addAllItems", "items", "sort1", "sort2", "sort3", "clearList", "family"}, k = 1, mv = {2, 3, 0}, xi = 48)
...
public final class TerritoryAdapter extends RecyclerView.Adapter<TerritoriesItemViewHolder> {
    ...
    public void onBindViewHolder(TerritoriesItemViewHolder holder, int i) {
        ...
        binding.infoBtn.setOnClickListener(new View.OnClickListener() { // from class: com.arizonagames.feature.arizona.family.adapters.TerritoryAdapter$$ExternalSyntheticLambda0
        ...
        if (uniqCellItem != null) {
            ...
            binding.infoBtn.setOnClickListener(new View.OnClickListener() { // from class: com.arizonagames.feature.arizona.family.adapters.TerritoryAdapter$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public final void sort1() {
        ...
        if (list.size() > 1) {
            CollectionsKt.sortWith(list, new Comparator() { // from class: com.arizonagames.feature.arizona.family.adapters.TerritoryAdapter$sort1$$inlined$sortBy$1
    ...
    public final void sort2() {
        List<GangZoneItem> list = this.itemsList;
        if (list.size() > 1) {
            CollectionsKt.sortWith(list, new Comparator() { // from class: com.arizonagames.feature.arizona.family.adapters.TerritoryAdapter$sort2$$inlined$sortByDescending$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
    ...
    public final void sort3() {
        List<GangZoneItem> list = this.itemsList;
        if (list.size() > 1) {
            CollectionsKt.sortWith(list, new Comparator() { // from class: com.arizonagames.feature.arizona.family.adapters.TerritoryAdapter$sort3$$inlined$sortByDescending$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
                    return ComparisonsKt.compareValues(Long.valueOf(((GangZoneItem) t2).getFamily_money()), Long.valueOf(((GangZoneItem) t).getFamily_money()));
                }
            });
        }
        notifyDataSetChanged();
