    ...
    public static final class ImagePageViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(final String imageUrl) {
            ...
            if (StringsKt.isBlank(imageUrl)) {
                finishLoading(imageUrl, false);
                return;
            }
            Picasso picasso = Picasso.get();
            Intrinsics.checkNotNullExpressionValue(picasso, "get(...)");
            PicassoLoadSafeKt.loadSafe(picasso, imageUrl).fit().noFade().into(this.binding.image, new Callback() { // from class: com.arizonagames.feature.arizona.imageviewer.ImageViewerPagerAdapter$ImagePageViewHolder$bind$1
