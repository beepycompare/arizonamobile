...
public final class VehicleItem {
    ...
    public final VehicleItem copy(String title, int i, int i2, int i3, List<Bonus> list) {
        Intrinsics.checkNotNullParameter(title, "title");
        return new VehicleItem(title, i, i2, i3, list);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((this.title.hashCode() * 31) + Integer.hashCode(this.rarity)) * 31) + Integer.hashCode(this.rarityLevel)) * 31) + Integer.hashCode(this.ratingPosition)) * 31;
    ...
    public VehicleItem(String title, int i, int i2, int i3, List<Bonus> list) {
        Intrinsics.checkNotNullParameter(title, "title");
        this.title = title;
        this.rarity = i;
        this.rarityLevel = i2;
