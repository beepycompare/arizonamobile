...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.of("t", CmcdData.STREAMING_FORMAT_SS, "e", "o", CmcdData.OBJECT_TYPE_INIT_SEGMENT, CmcdData.STREAMING_FORMAT_HLS, TypedValues.TransitionType.S_TO, "ti");
    ...
    private static <T> Keyframe<T> parseMultiDimensionalKeyframe(LottieComposition lottieComposition, JsonReader jsonReader, float f, ValueParser<T> valueParser) throws IOException {
        ...
        if (z4) {
            ...
            } else if (pointF6 != null && pointF7 != null && pointF14 != null && pointF9 != null) {
