...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of(CmcdData.OBJECT_TYPE_AUDIO_ONLY, TtmlNode.TAG_P, CmcdData.STREAMING_FORMAT_SS, "rz", "r", "o", "so", "eo", "sk", "sa", "rx", "ry");
