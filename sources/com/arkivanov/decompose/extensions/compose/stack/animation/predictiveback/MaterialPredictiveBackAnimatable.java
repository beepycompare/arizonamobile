...
public final class MaterialPredictiveBackAnimatable implements PredictiveBackAnimatable {
    ...
    public static final Unit _get_enterModifier_$lambda$2(MaterialPredictiveBackAnimatable materialPredictiveBackAnimatable, ContentDrawScope drawWithContent) {
        ...
        DrawScope.m5852drawRectnJ9OG0$default(drawWithContent, Color.m5278copywmQWz5c$default(Color.Companion.m5305getBlack0d7_KjU(), materialPredictiveBackAnimatable.getFinishProgress() * 0.25f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
    ...
    public static final Unit exitModifier$lambda$7$lambda$6(MutableState mutableState, LayoutCoordinates it) {
        ...
        exitModifier$lambda$5(mutableState, IntSizeKt.m8178toSizeozmzZPI(it.mo6705getSizeYbymL2g()));
        return Unit.INSTANCE;
    }
    ...
    private final float exitOffsetX(Density density, float f, float f2) {
        ...
        if (i != 1) {
            ...
            return ((f3 - f) / 2.0f) + (density.mo429toPx0680j_4(Dp.m7995constructorimpl(8)) * getProgress());
        }
        return ((f - f3) / 2.0f) - (density.mo429toPx0680j_4(Dp.m7995constructorimpl(8)) * getProgress());
    }
    ...
    private final float exitOffsetY(Density density, float f) {
        ...
        return ((f / 20.0f) - density.mo429toPx0680j_4(Dp.m7995constructorimpl(8))) * ((getTouchY() - this.initialEvent.getTouchY()) / f) * RangesKt.coerceAtMost(getProgress() * 3.0f, 1.0f);
    }
}
