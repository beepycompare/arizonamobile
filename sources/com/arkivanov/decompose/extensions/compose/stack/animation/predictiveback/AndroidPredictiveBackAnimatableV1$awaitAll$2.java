...
final class AndroidPredictiveBackAnimatableV1$awaitAll$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AndroidPredictiveBackAnimatableV1$awaitAll$2(Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>[] function2Arr, Continuation<? super AndroidPredictiveBackAnimatableV1$awaitAll$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AndroidPredictiveBackAnimatableV1$awaitAll$2 androidPredictiveBackAnimatableV1$awaitAll$2 = new AndroidPredictiveBackAnimatableV1$awaitAll$2(this.$actions, continuation);
        androidPredictiveBackAnimatableV1$awaitAll$2.L$0 = obj;
        return androidPredictiveBackAnimatableV1$awaitAll$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AndroidPredictiveBackAnimatableV1$awaitAll$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
