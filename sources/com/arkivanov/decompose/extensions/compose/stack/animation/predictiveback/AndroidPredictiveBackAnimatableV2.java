...
public final class AndroidPredictiveBackAnimatableV2 implements PredictiveBackAnimatable {
    ...
    public static final Unit _get_enterModifier_$lambda$2(AndroidPredictiveBackAnimatableV2 androidPredictiveBackAnimatableV2, ContentDrawScope drawWithContent) {
        ...
        DrawScope.m5852drawRectnJ9OG0$default(drawWithContent, Color.m5278copywmQWz5c$default(Color.Companion.m5305getBlack0d7_KjU(), (1.0f - androidPredictiveBackAnimatableV2.getFinishProgress()) * 0.25f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
    ...
    public final Modifier enterModifier(Modifier modifier, Shape shape, Composer composer, int i) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5092boximpl(Size.Companion.m5113getZeroNHjbRc()), null, 2, null);
    ...
    public static final Unit exitModifier$lambda$12$lambda$11(MutableState mutableState, LayoutCoordinates it) {
        Intrinsics.checkNotNullParameter(it, "it");
        exitModifier$lambda$10(mutableState, IntSizeKt.m8178toSizeozmzZPI(it.mo6705getSizeYbymL2g()));
        return Unit.INSTANCE;
    }
    ...
    private final float exitOffsetX(Density density, float f) {
        ...
        if (i == 1) {
            f2 = ((f - (initialScaleFactor() * f)) / 2.0f) - (density.mo429toPx0680j_4(Dp.m7995constructorimpl(8)) * getProgress());
        } else if (i != 2 && i != 3) {
    ...
    private final float exitOffsetY(Density density, float f) {
        ...
        return MathHelpersKt.lerp(((f / 20.0f) - density.mo429toPx0680j_4(Dp.m7995constructorimpl(8))) * ((getTouchY() - this.initialEvent.getTouchY()) / f) * RangesKt.coerceAtMost(getProgress() * 3.0f, 1.0f), 0.0f, getFinishProgress());
    }
}
