...
public final class LayoutCorner {
    ...
    public static /* synthetic */ LayoutCorner m8604copyD5KLDUw$default(LayoutCorner layoutCorner, float f, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return layoutCorner.m8606copyD5KLDUw(f, z);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m8605component1D9Ej5fM() {
        return this.radius;
    }
    ...
    public final LayoutCorner m8606copyD5KLDUw(float f, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LayoutCorner) {
            ...
            return Dp.m7269equalsimpl0(this.radius, layoutCorner.radius) && this.isFixed == layoutCorner.isFixed;
        }
        return false;
    }

    public int hashCode() {
        return (Dp.m7270hashCodeimpl(this.radius) * 31) + Boolean.hashCode(this.isFixed);
    }

    public String toString() {
        return "LayoutCorner(radius=" + ((Object) Dp.m7275toStringimpl(this.radius)) + ", isFixed=" + this.isFixed + ')';
    }
    ...
    public final float m8607getRadiusD9Ej5fM() {
        return this.radius;
    }
    ...
    public /* synthetic */ LayoutCorner(float f, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7264constructorimpl(16) : f, (i & 2) != 0 ? false : z, null);
    }
}
