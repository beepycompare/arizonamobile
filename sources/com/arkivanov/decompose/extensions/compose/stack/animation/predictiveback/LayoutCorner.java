...
public final class LayoutCorner {
    ...
    public static /* synthetic */ LayoutCorner m8583copyD5KLDUw$default(LayoutCorner layoutCorner, float f, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return layoutCorner.m8585copyD5KLDUw(f, z);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m8584component1D9Ej5fM() {
        return this.radius;
    }
    ...
    public final LayoutCorner m8585copyD5KLDUw(float f, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LayoutCorner) {
            ...
            return Dp.m7256equalsimpl0(this.radius, layoutCorner.radius) && this.isFixed == layoutCorner.isFixed;
        }
        return false;
    }

    public int hashCode() {
        return (Dp.m7257hashCodeimpl(this.radius) * 31) + Boolean.hashCode(this.isFixed);
    }

    public String toString() {
        return "LayoutCorner(radius=" + ((Object) Dp.m7262toStringimpl(this.radius)) + ", isFixed=" + this.isFixed + ')';
    }
    ...
    public final float m8586getRadiusD9Ej5fM() {
        return this.radius;
    }
    ...
    public /* synthetic */ LayoutCorner(float f, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7251constructorimpl(16) : f, (i & 2) != 0 ? false : z, null);
    }
}
