...
final class AndroidPredictiveBackAnimatableV2$finish$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AndroidPredictiveBackAnimatableV2$finish$2(AndroidPredictiveBackAnimatableV2 androidPredictiveBackAnimatableV2, float f, float f2, Continuation<? super AndroidPredictiveBackAnimatableV2$finish$2> continuation) {
        super(2, continuation);
        this.this$0 = androidPredictiveBackAnimatableV2;
        this.$progress = f;
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AndroidPredictiveBackAnimatableV2$finish$2 androidPredictiveBackAnimatableV2$finish$2 = new AndroidPredictiveBackAnimatableV2$finish$2(this.this$0, this.$progress, this.$velocityFactor, continuation);
        androidPredictiveBackAnimatableV2$finish$2.L$0 = obj;
        return androidPredictiveBackAnimatableV2$finish$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AndroidPredictiveBackAnimatableV2$finish$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(AndroidPredictiveBackAnimatableV2 androidPredictiveBackAnimatableV2, float f, float f2, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = androidPredictiveBackAnimatableV2;
            this.$progress = f;
            this.$velocityFactor = f2;
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(AndroidPredictiveBackAnimatableV2 androidPredictiveBackAnimatableV2, Continuation<? super AnonymousClass2> continuation) {
            super(2, continuation);
            this.this$0 = androidPredictiveBackAnimatableV2;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (Animatable.animateTo$default(animatable, Boxing.boxFloat(1.0f), null, null, null, this, 14, null) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
