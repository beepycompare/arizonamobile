...
public final class ChildPagesFactoryKt {
    ...
    public static final <Ctx extends GenericComponentContext<? extends Ctx>, C, T> Value<ChildPages<C, T>> childPages(Ctx ctx, NavigationSource<PagesNavigation.Event<C>> source, final Function0<? extends Pages<? extends C>> initialPages, final Function1<? super Pages<? extends C>, SerializableContainer> savePages, final Function1<? super SerializableContainer, ? extends Pages<? extends C>> restorePages, String key, final Function2<? super Integer, ? super Pages<? extends C>, ? extends ChildNavState.Status> pageStatus, final boolean z, Function2<? super C, ? super Ctx, ? extends T> childFactory) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0066: INVOKE  (r0v2 'children' com.arkivanov.decompose.value.Value<com.arkivanov.decompose.router.pages.ChildPages<C, T>>) = 
              ...
              (wrap: kotlin.jvm.functions.Function0 : 0x003c: CONSTRUCTOR  (r8v1 kotlin.jvm.functions.Function0 A[REMOVE]) = 
             ...
             call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda0.<init>(kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2):void type: CONSTRUCTOR)
              (wrap: kotlin.jvm.functions.Function1 : 0x0041: CONSTRUCTOR  (r9v0 kotlin.jvm.functions.Function1 A[REMOVE]) = 
             ...
             call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda2.<init>(kotlin.jvm.functions.Function1):void type: CONSTRUCTOR)
              (wrap: kotlin.jvm.functions.Function1 : 0x0046: CONSTRUCTOR  (r10v0 kotlin.jvm.functions.Function1 A[REMOVE]) = 
             ...
             call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda3.<init>(kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2):void type: CONSTRUCTOR)
              (wrap: kotlin.jvm.functions.Function2 : 0x004b: CONSTRUCTOR  (r11v0 kotlin.jvm.functions.Function2 A[REMOVE]) = 
              (r25v0 'pageStatus' kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super com.arkivanov.decompose.router.pages.Pages<? extends C>, ? extends com.arkivanov.decompose.router.children.ChildNavState$Status> A[DONT_INLINE])
             call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda4.<init>(kotlin.jvm.functions.Function2):void type: CONSTRUCTOR)
              (wrap: kotlin.jvm.functions.Function2 : 0x0050: CONSTRUCTOR  (r12v0 kotlin.jvm.functions.Function2 A[REMOVE]) =  call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda5.<init>():void type: CONSTRUCTOR)
              ...
              (wrap: kotlin.jvm.functions.Function3 : ?: TERNARYnull = ((wrap: int : 0x000f: ARITH  (r1v1 int A[REMOVE]) = (r26v0 int) & (256 int)) != (0 int)) ? (wrap: kotlin.jvm.functions.Function3 : 0x0018: CONSTRUCTOR   call: com.arkivanov.decompose.router.children.ChildrenFactoryKt$$ExternalSyntheticLambda9.<init>():void type: CONSTRUCTOR) : (wrap: kotlin.jvm.functions.Function3 : 0x0055: CONSTRUCTOR  (r14v0 kotlin.jvm.functions.Function3 A[REMOVE]) =  call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda6.<init>():void type: CONSTRUCTOR))
              (wrap: kotlin.jvm.functions.Function1 : ?: TERNARYnull = ((wrap: int : 0x001c: ARITH  (r0v1 int A[REMOVE]) = (r26v0 int) & (512 int)) != (0 int)) ? (wrap: com.arkivanov.decompose.router.children.ChildrenFactoryKt$children$8 : 0x0024: SGET   com.arkivanov.decompose.router.children.ChildrenFactoryKt$children$8.INSTANCE com.arkivanov.decompose.router.children.ChildrenFactoryKt$children$8) : (wrap: kotlin.jvm.functions.Function1 : 0x005c: CONSTRUCTOR  (r15v0 kotlin.jvm.functions.Function1 A[REMOVE]) = (r26v0 'z' boolean A[DONT_INLINE]) call: com.arkivanov.decompose.router.pages.ChildPagesFactoryKt$$ExternalSyntheticLambda7.<init>(boolean):void type: CONSTRUCTOR))
