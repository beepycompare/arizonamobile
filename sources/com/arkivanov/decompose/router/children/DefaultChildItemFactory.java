...
public final class DefaultChildItemFactory<Ctx, C, T> implements ChildItemFactory<C, T> {
    ...
    public ChildItem.Created<C, T> invoke(C configuration, String key, SerializableContainer serializableContainer, InstanceKeeperDispatcher instanceKeeperDispatcher) {
        ...
        return new ChildItem.Created<>(configuration, key, this.childFactory.invoke(configuration, this.contextFactory.invoke(mergedLifecycle, StateKeeperDispatcher, instanceKeeperDispatcher2, childBackHandler$default)), LifecycleRegistry, StateKeeperDispatcher, instanceKeeperDispatcher2, childBackHandler$default);
    }
}
