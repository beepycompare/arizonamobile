...
public final class StackNavigatorExtKt$popTo$4<C> implements Function2<List<? extends C>, List<? extends C>, Unit> {
    final /* synthetic */ Function1<Boolean, Unit> $onComplete;

    /* JADX WARN: Multi-variable type inference failed */
    public StackNavigatorExtKt$popTo$4(Function1<? super Boolean, Unit> function1) {
