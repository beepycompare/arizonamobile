...
public class NormedXYSeries implements XYSeries {
    ...
    public static class Norm {
        ...
        public Norm(Region region) {
            this(region, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, false);
        }
    ...
    public NormedXYSeries(XYSeries xYSeries) {
        this(xYSeries, null, new Norm(null, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, false));
    }
    ...
    protected Region calculateTransform(Norm norm) {
        if (norm.useOffsetCompression) {
            return new Region(Double.valueOf(norm.offset > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? norm.offset : 0.0d), Double.valueOf(norm.offset < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? 1.0d + norm.offset : 1.0d));
        }
        return new Region(Double.valueOf(norm.offset + FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE), Double.valueOf(norm.offset + 1.0d));
    }
