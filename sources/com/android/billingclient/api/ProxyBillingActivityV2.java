...
public class ProxyBillingActivityV2 extends ComponentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            if (getIntent().hasExtra("ALTERNATIVE_BILLING_ONLY_DIALOG_INTENT")) {
                ...
                this.zzd.launch(new IntentSenderRequest.Builder((PendingIntent) getIntent().getParcelableExtra("launch_external_link_flow_pending_intent")).build());
                return;
            } else {
                return;
            }
    ...
    public final void zza(ActivityResult activityResult) {
        ...
        if (activityResult.getResultCode() != -1 || responseCode != 0) {
            ...
            com.google.android.gms.internal.play_billing.zzc.zzo("ProxyBillingActivityV2", "Alternative billing only dialog finished with resultCode " + resultCode + " and billing's responseCode: " + responseCode);
        }
        finish();
    }
