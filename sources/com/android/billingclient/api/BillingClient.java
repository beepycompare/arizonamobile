            ...
            if (context != null) {
                if (this.zzf == null) {
                    if (this.zzj == null) {
                        ...
                        if (zza()) {
                            return new zzcw(null, context, null, null, this);
                        }
                    ...
                    if (this.zzf == null) {
                        ...
                        if (zza()) {
                            return new zzcw(null, pendingPurchasesParams, context, null, null, null, this);
                        }
                        return new BillingClientImpl(null, pendingPurchasesParams, context, null, null, null, this);
                        ...
                        if (zza()) {
                            return new zzcw(null, pendingPurchasesParams2, context, purchasesUpdatedListener, null, null, null, this);
                        }
                        return new BillingClientImpl(null, pendingPurchasesParams2, context, purchasesUpdatedListener, null, null, null, this);
                    } else {
                        ...
                        if (zza()) {
                            return new zzcw(null, pendingPurchasesParams3, context, purchasesUpdatedListener2, userChoiceBillingListener, developerProvidedBillingListener, null, null, this);
                        }
                        return new BillingClientImpl(null, pendingPurchasesParams3, context, purchasesUpdatedListener2, userChoiceBillingListener, developerProvidedBillingListener, null, null, this);
                    }
                }
            }
