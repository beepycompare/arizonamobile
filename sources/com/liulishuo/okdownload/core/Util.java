...
public class Util {
    ...
    public static String humanReadableBytes(long j, boolean z) {
        ...
        double d = j;
        double d2 = i;
        return String.format(Locale.ENGLISH, "%.1f %sB", Double.valueOf(d / Math.pow(d2, (int) (Math.log(d) / Math.log(d2)))), (z ? "kMGTPE" : "KMGTPE").charAt(log - 1) + (z ? "" : CmcdData.OBJECT_TYPE_INIT_SEGMENT));
    }
