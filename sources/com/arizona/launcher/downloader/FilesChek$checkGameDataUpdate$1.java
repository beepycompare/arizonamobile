...
@DebugMetadata(c = "com.arizona.launcher.downloader.FilesChek", f = "FilesChek.kt", i = {0, 0}, l = {TsExtractor.TS_STREAM_TYPE_AC3}, m = "checkGameDataUpdate", n = {"dataInfo", "useManifest"}, s = {"L$0", "Z$0"}, v = 1)
