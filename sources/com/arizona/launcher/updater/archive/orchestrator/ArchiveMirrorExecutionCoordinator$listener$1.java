...
public final class ArchiveMirrorExecutionCoordinator$listener$1 implements ArchiveUpdaterListener {
    ...
    public ArchiveMirrorExecutionCoordinator$listener$1(ArchiveMirrorExecutionCoordinator archiveMirrorExecutionCoordinator) {
    ...
    public void onDownloadProgress(final long j, final long j2) {
        ...
        function1 = this.this$0.postToMain;
        final ArchiveMirrorExecutionCoordinator archiveMirrorExecutionCoordinator = this.this$0;
        function1.invoke(new Function0() { // from class: com.arizona.launcher.updater.archive.orchestrator.ArchiveMirrorExecutionCoordinator$listener$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return ArchiveMirrorExecutionCoordinator$listener$1.onDownloadProgress$lambda$1(ArchiveMirrorExecutionCoordinator.this, j, j2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static final Unit onDownloadProgress$lambda$1(ArchiveMirrorExecutionCoordinator archiveMirrorExecutionCoordinator, long j, long j2) {
        Function0 function0;
        ArchiveMirrorExecutionCallbacks archiveMirrorExecutionCallbacks;
        function0 = archiveMirrorExecutionCoordinator.isCurrentOperation;
        if (((Boolean) function0.invoke()).booleanValue()) {
            archiveMirrorExecutionCallbacks = archiveMirrorExecutionCoordinator.callbacks;
            archiveMirrorExecutionCallbacks.onDownloadProgress(j, j2);
        }
        return Unit.INSTANCE;
    }
