...
public final class ArchiveStorageEstimator {
    ...
    public static /* synthetic */ long downloadBytes$default(ArchiveStorageEstimator archiveStorageEstimator, ArchiveUpdatePlan archiveUpdatePlan, ArchiveUpdaterState archiveUpdaterState, Map map, int i, Object obj) {
        if ((i & 2) != 0) {
        ...
        return archiveStorageEstimator.downloadBytes(archiveUpdatePlan, archiveUpdaterState, map);
    }
    ...
    private final long overlayPlannedNetworkBytes(ArchivePackage archivePackage, ArchivePackageJournalEntry archivePackageJournalEntry, long j, Map<String, Long> map) {
        Long l;
