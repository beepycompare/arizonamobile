...
public final class ArchivePackageUpdater {
    ...
    */
    ...
    public static /* synthetic */ Object execute$default(ArchivePackageUpdater archivePackageUpdater, ArchiveUpdatePlan archiveUpdatePlan, String str, ArchiveUpdaterListener archiveUpdaterListener, Continuation continuation, int i, Object obj) {
        ...
        return archivePackageUpdater.execute(archiveUpdatePlan, str, archiveUpdaterListener, continuation);
    }

    public final Object execute(ArchiveUpdatePlan archiveUpdatePlan, String str, ArchiveUpdaterListener archiveUpdaterListener, Continuation<? super ArchiveUpdaterResult> continuation) {
        return SupervisorKt.supervisorScope(new ArchivePackageUpdater$execute$2(this, archiveUpdatePlan, str, archiveUpdaterListener, null), continuation);
    }
