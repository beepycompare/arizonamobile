    ...
    public ServersDAO_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfServerEntity = new EntityInsertAdapter<ServerEntity>() { // from class: com.arizona.launcher.data.database.ServersDAO_Impl.1
            ...
            public void bind(SQLiteStatement statement, ServerEntity entity) {
                ...
                statement.mo9199bindText(2, entity.getAddress());
                statement.mo9197bindLong(3, entity.getPort());
                statement.mo9197bindLong(4, entity.getHasPassword() ? 1L : 0L);
                statement.mo9197bindLong(5, entity.getCurrentPlayerCount());
                statement.mo9197bindLong(6, entity.getMaxPlayerCount());
                statement.mo9199bindText(7, entity.getServerName());
                statement.mo9199bindText(8, entity.getTg());
                statement.mo9199bindText(9, entity.getVk());
                statement.mo9199bindText(10, entity.getInst());
                statement.mo9197bindLong(11, entity.getFavorite() ? 1L : 0L);
                statement.mo9199bindText(12, ServersDAO_Impl.this.__ServerType_enumToString(entity.getServerType()));
                statement.mo9197bindLong(13, entity.getPing());
                statement.mo9199bindText(14, entity.getPlotPoints());
                statement.mo9199bindText(15, entity.getServerIcon());
            }
        };
    }
