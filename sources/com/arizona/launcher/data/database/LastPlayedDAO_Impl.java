...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u0000 \u00132\u00020\u0001:\u0001\u0013B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\bH\u0016J\u0014\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u00100\u000fH\u0016J\b\u0010\u0011\u001a\u00020\u0012H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000Ê\u0001\f\b\u0015\u0012\b\b\u0016\u0012\u0004\b\u0003\u0010\u0000¨\u0006\u0014"}, d2 = {"Lcom/arizona/launcher/data/database/LastPlayedDAO_Impl;", "Lcom/arizona/launcher/data/database/LastPlayedDAO;", "__db", "Landroidx/room/RoomDatabase;", "<init>", "(Landroidx/room/RoomDatabase;)V", "__insertAdapterOfLastPlayedServer", "Landroidx/room/EntityInsertAdapter;", "Lcom/arizona/launcher/model/servers/LastPlayedServer;", "__dateConverter", "Lru/mrlargha/commonui/utils/DateConverter;", "addLastPlayed", "Lio/reactivex/Completable;", "server", "getLastPlayedServers", "Lio/reactivex/Observable;", "", "dropTable", "", "Companion", "app", "Landroidx/compose/runtime/internal/StabilityInferred;", "parameters"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class LastPlayedDAO_Impl implements LastPlayedDAO {
    ...
    public LastPlayedDAO_Impl(RoomDatabase __db) {
        ...
        this.__insertAdapterOfLastPlayedServer = new EntityInsertAdapter<LastPlayedServer>() { // from class: com.arizona.launcher.data.database.LastPlayedDAO_Impl.1
            ...
            public void bind(SQLiteStatement statement, LastPlayedServer entity) {
                ...
                statement.mo9068bindLong(1, entity.getServerId());
                statement.mo9070bindText(2, entity.getServerType());
                ...
                if (dateToTimestamp == null) {
                    ...
                    statement.mo9068bindLong(3, dateToTimestamp.longValue());
                }
            }
        };
    }
    ...
    public Completable addLastPlayed(final LastPlayedServer server) {
        ...
        return RxRoom.Companion.createCompletable(this.__db, false, true, new Function1() { // from class: com.arizona.launcher.data.database.LastPlayedDAO_Impl$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return LastPlayedDAO_Impl.addLastPlayed$lambda$0(LastPlayedDAO_Impl.this, server, (SQLiteConnection) obj);
            }
        });
    }
    ...
    public Observable<List<LastPlayedServer>> getLastPlayedServers() {
        return RxRoom.Companion.createObservable(this.__db, false, new String[]{"lastplayed"}, new Function1() { // from class: com.arizona.launcher.data.database.LastPlayedDAO_Impl$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return LastPlayedDAO_Impl.getLastPlayedServers$lambda$0(r1, this, (SQLiteConnection) obj);
            }
        });
    }
    ...
    public void dropTable() {
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: com.arizona.launcher.data.database.LastPlayedDAO_Impl$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return LastPlayedDAO_Impl.dropTable$lambda$0(r1, (SQLiteConnection) obj);
            }
        });
    }
    ...
    /* compiled from: LastPlayedDAO_Impl.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/arizona/launcher/data/database/LastPlayedDAO_Impl$Companion;", "", "<init>", "()V", "getRequiredConverters", "", "Lkotlin/reflect/KClass;", "app"}, k = 1, mv = {2, 4, 0}, xi = 48)
    /* loaded from: classes3.dex */
