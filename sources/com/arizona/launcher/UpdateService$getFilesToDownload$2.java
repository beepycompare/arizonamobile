...
@DebugMetadata(c = "com.arizona.launcher.UpdateService$getFilesToDownload$2", f = "UpdateService.kt", i = {0, 0, 0, 0}, l = {827}, m = "invokeSuspend", n = {"jsonObject", "jsonArray", "jsonDir", CmcdData.OBJECT_TYPE_INIT_SEGMENT}, s = {"L$0", "L$1", "L$2", "I$0"})
        ...
        if (i2 == 0) {
            ...
            if (i >= length) {
                ...
                if (Intrinsics.areEqual(jSONObject2.getString("type"), "dir")) {
                    ...
                    this.I$1 = length;
                    this.label = 1;
                    obj = updateService.getFilesToDownload(jSONArray2, str2 + "/" + string, this.$destDir, this);
                    ...
                    if (Intrinsics.areEqual(jSONObject2.getString("type"), "file")) {
                        ...
                        File file = new File((this.this$0.getExternalFilesDir(null) != null ? externalFilesDir2.getPath() : null) + this.$destDir + this.$dir + "/" + string2);
                        ...
                        if (!new File((this.this$0.getExternalFilesDir(null) != null ? externalFilesDir.getPath() : null) + this.$destDir + this.$dir + "/" + string3).exists()) {
