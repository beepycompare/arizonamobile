...
@Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J(\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016¨\u0006\f"}, d2 = {"com/arizona/launcher/UpdateService$prepareGameUpdateCheck$decision$1$rangeRetryListener$1", "Lcom/arizona/launcher/updater/archive/orchestrator/ArchiveRangeRetryListener;", "onRetry", "", "packageId", "", "retryAttempt", "", "delayMs", "", "failure", "Lcom/arizona/launcher/DownloadFailureDetails;", "app"}, k = 1, mv = {2, 4, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UpdateService$prepareGameUpdateCheck$decision$1$rangeRetryListener$1 implements ArchiveRangeRetryListener {
    ...
    public UpdateService$prepareGameUpdateCheck$decision$1$rangeRetryListener$1(UpdateService updateService, UpdateOperationKind updateOperationKind, long j, String str) {
    ...
    public void onRetry(final String packageId, final int i, final long j, final DownloadFailureDetails failure) {
        ...
        handler.post(new Runnable() { // from class: com.arizona.launcher.UpdateService$prepareGameUpdateCheck$decision$1$rangeRetryListener$1$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                UpdateService$prepareGameUpdateCheck$decision$1$rangeRetryListener$1.onRetry$lambda$0(UpdateService.this, updateOperationKind, j2, packageId, i, j, failure, str);
            }
        });
    }
