...
public interface ArchiveUpdateServiceHost {
    ...
    ArchiveStorageSpaceCheckResult checkArchiveStorageSpace(ArchiveStorageRequirementsSnapshot archiveStorageRequirementsSnapshot);
