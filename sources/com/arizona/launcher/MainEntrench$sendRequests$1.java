...
@DebugMetadata(c = "com.arizona.launcher.MainEntrench$sendRequests$1", f = "MainEntrench.kt", i = {0, 0, 0}, l = {1125}, m = "invokeSuspend", n = {"request", "it", "$i$a$-repeat-MainEntrench$sendRequests$1$1"}, s = {"L$2", "I$2", "I$3"}, v = 1)
