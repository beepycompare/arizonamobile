...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\t\b\u0080\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\t¨\u0006\n"}, d2 = {"Lcom/arizona/launcher/ArchiveServiceFailureKind;", "", "<init>", "(Ljava/lang/String;I)V", "CONNECTION", "CORRUPTED", "INSUFFICIENT_STORAGE", "STORAGE_UNAVAILABLE", "FOREGROUND_UNAVAILABLE", "RECOVERY_BLOCKED", "app"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class ArchiveServiceFailureKind {
    ...
    public static final ArchiveServiceFailureKind STORAGE_UNAVAILABLE = new ArchiveServiceFailureKind("STORAGE_UNAVAILABLE", 3);
    public static final ArchiveServiceFailureKind FOREGROUND_UNAVAILABLE = new ArchiveServiceFailureKind("FOREGROUND_UNAVAILABLE", 4);
    public static final ArchiveServiceFailureKind RECOVERY_BLOCKED = new ArchiveServiceFailureKind("RECOVERY_BLOCKED", 5);

    private static final /* synthetic */ ArchiveServiceFailureKind[] $values() {
        return new ArchiveServiceFailureKind[]{CONNECTION, CORRUPTED, INSUFFICIENT_STORAGE, STORAGE_UNAVAILABLE, FOREGROUND_UNAVAILABLE, RECOVERY_BLOCKED};
    }
