...
public final class IFramePlayerOptions {
    ...
    private static final IFramePlayerOptions f87default = new Builder().controls(1).build();
    ...
    public static final class Companion {
        ...
        public final IFramePlayerOptions getDefault() {
            return IFramePlayerOptions.f87default;
        }
    }
