...
public final class TopBarBtnShape implements Shape {
    ...
    public Outline mo365createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Matrix.m5686scaleimpl$default(m5670constructorimpl$default, Float.intBitsToFloat((int) (j >> 32)) / ((float) ServiceStarter.ERROR_UNKNOWN), Float.intBitsToFloat((int) (j & 4294967295L)) / 96, 0.0f, 4, null);
