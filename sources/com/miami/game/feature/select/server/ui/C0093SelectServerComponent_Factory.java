...
public final class C0093SelectServerComponent_Factory {
    ...
    private C0093SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0093SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0093SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
