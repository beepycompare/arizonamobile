...
public final class C0114SelectServerComponent_Factory {
    ...
    private C0114SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0114SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0114SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
