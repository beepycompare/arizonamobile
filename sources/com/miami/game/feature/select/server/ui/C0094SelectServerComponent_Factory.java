...
public final class C0094SelectServerComponent_Factory {
    ...
    private C0094SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0094SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0094SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
