...
public final class C0121SelectServerComponent_Factory {
    ...
    public C0121SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0121SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0121SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
