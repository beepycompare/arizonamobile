...
public final class ServerPromotionLabelKt {
    ...
    */
    public static final void ServerPromotion(final Integer num, final Integer num2, final Boolean bool, final Boolean bool2, final boolean z, final boolean z2, final Modifier modifier, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((599187 & i2) != 599186, i2 & 1)) {
            ...
            if (num == null || ((num.intValue() <= 3 && z2) || (num.intValue() <= 2 && !z2))) {
                ...
                if (bool2 == null && bool == null) {
                    ...
                    if (bool == null) {
                        ...
                        Modifier m8435promo4WTKRHQ = m8435promo4WTKRHQ(modifier, ColorKt.Color(4294927670L));
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                        MeasurePolicy maybeCachedBoxMeasurePolicy2 = BoxKt.maybeCachedBoxMeasurePolicy(center2, false);
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
                        int currentCompositeKeyHash3 = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
                        CompositionLocalMap currentCompositionLocalMap3 = startRestartGroup.getCurrentCompositionLocalMap();
                        Modifier materializeModifier3 = ComposedModifierKt.materializeModifier(startRestartGroup, m8435promo4WTKRHQ);
                    ...
                    if (bool2 != null) {
                        ...
                        Modifier m8435promo4WTKRHQ2 = m8435promo4WTKRHQ(modifier, ColorKt.Color(4294945024L));
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                        ...
                        Modifier materializeModifier5 = ComposedModifierKt.materializeModifier(startRestartGroup, m8435promo4WTKRHQ2);
            ...
            if (num2 == null || num2.intValue() <= 1) {
                ...
                Modifier m8435promo4WTKRHQ3 = m8435promo4WTKRHQ(modifier, ColorKt.Color(4289456127L));
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                ...
                Modifier materializeModifier8 = ComposedModifierKt.materializeModifier(startRestartGroup, m8435promo4WTKRHQ3);
            ...
            if (num == null || ((num.intValue() <= 3 || !z2) && (num.intValue() <= i5 || z2))) {
                ...
                Modifier m8435promo4WTKRHQ4 = m8435promo4WTKRHQ(modifier, MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m1714getPrimary0d7_KjU());
                ...
                Modifier materializeModifier9 = ComposedModifierKt.materializeModifier(startRestartGroup, m8435promo4WTKRHQ4);
    ...
    private static final Modifier m8435promo4WTKRHQ(Modifier modifier, long j) {
