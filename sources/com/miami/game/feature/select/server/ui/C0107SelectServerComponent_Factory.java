...
public final class C0107SelectServerComponent_Factory {
    ...
    private C0107SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0107SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0107SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
