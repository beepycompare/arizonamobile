...
public final class C0095SelectServerComponent_Factory {
    ...
    private C0095SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0095SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0095SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
