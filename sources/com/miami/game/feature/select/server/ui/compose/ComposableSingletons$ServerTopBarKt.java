...
public final class ComposableSingletons$ServerTopBarKt {
    ...
    private static Function3<BoxScope, Composer, Integer, Unit> f63lambda$1484463318 = ComposableLambdaKt.composableLambdaInstance(-1484463318, false, new Function3() { // from class: com.miami.game.feature.select.server.ui.compose.ComposableSingletons$ServerTopBarKt$$ExternalSyntheticLambda0
    ...
    public final Function3<BoxScope, Composer, Integer, Unit> m9767getLambda$1484463318$select_server_release() {
        return f63lambda$1484463318;
    }
    ...
    public static final Unit lambda__1484463318$lambda$0(BoxScope ScalingButton, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.btn_back_launcher, composer, 0), (String) null, SizeKt.m880height3ABfNKs(Modifier.Companion, Dp.m7995constructorimpl(72)), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, composer, 25008, 104);
            if (ComposerKt.isTraceInProgress()) {
