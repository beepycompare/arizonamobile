...
public final class C0106SelectServerComponent_Factory {
    ...
    private C0106SelectServerComponent_Factory(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
    ...
    public static C0106SelectServerComponent_Factory create(Provider<ServersInteractor> serversInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider) {
        return new C0106SelectServerComponent_Factory(serversInteractorProvider, buildConfigProvider);
    }
