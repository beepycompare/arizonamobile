...
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a5\u0010\u0000\u001a\u00020\u00012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0007b\u0002\b\u0007b\f\b\b\u0012\b\b\t\u0012\u0004\b\b(\n¢\u0006\u0002\u0010\u0006\u001a\u0095\u0001\u0010\u000b\u001a\u00020\u00012\u0006\u0010\f\u001a\u00020\r2\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00010\u00032\u0012\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\u0010\u0012\u0004\u0012\u00020\u00010\u000f2\u0012\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u00020\u0010\u0012\u0004\u0012\u00020\u00010\u000f2\f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00010\u00032\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00010\u00032\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00010\u0003H\u0001b\f\b\u0016\u0012\b\b\u0017\u0012\u0004\b\u0003\u0010\u0004b\u0002\b\u0007b\f\b\b\u0012\b\b\t\u0012\u0004\b\b(\n¢\u0006\u0002\u0010\u0015¨\u0006\u0018²\u0006\n\u0010\f\u001a\u00020\rX\u008a\u0084\u0002"}, d2 = {"SelectServerRoute", "", "navigateHome", "Lkotlin/Function0;", "component", "Lcom/miami/game/feature/select/server/ui/SelectServerComponent;", "(Lkotlin/jvm/functions/Function0;Lcom/miami/game/feature/select/server/ui/SelectServerComponent;Landroidx/compose/runtime/Composer;I)V", "Landroidx/compose/runtime/Composable;", "Landroidx/compose/runtime/ComposableTarget;", "applier", "androidx.compose.ui.UiComposable", "SelectServerScreen", "uiState", "Lcom/miami/game/feature/select/server/ui/model/SelectServerUiState;", "onSelect", "Lkotlin/Function1;", "Lcom/miami/game/core/server/model/ServerModel;", "onFavorite", "onFavoriteList", "onMobileList", "onDesktopList", "(Lcom/miami/game/feature/select/server/ui/model/SelectServerUiState;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;I)V", "Landroidx/annotation/VisibleForTesting;", "otherwise", "select-server"}, k = 2, mv = {2, 4, 0}, xi = 48)
...
public final class SelectServerScreenKt {
    ...
    public static final void SelectServerRoute(final Function0<Unit> navigateHome, final SelectServerComponent component, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(SelectServerRoute)N(navigateHome,component)47@2197L34,48@2269L29,49@2359L115,49@2322L152,57@2582L19,58@2624L21,59@2670L23,60@2720L25,61@2771L24,54@2479L322:SelectServerScreen.kt#2ojkxh");
        if ((i & 6) == 0) {
        ...
        if (startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-387912032, i3, -1, "com.miami.game.feature.select.server.ui.compose.SelectServerRoute (SelectServerScreen.kt:46)");
            }
            int i4 = (i3 << 3) & 112;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.SelectServerScreenKt$$ExternalSyntheticLambda4
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return SelectServerScreenKt.SelectServerRoute$lambda$7(Function0.this, component, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final void SelectServerScreen(final SelectServerUiState uiState, final Function0<Unit> navigateHome, Function1<? super ServerModel, Unit> onSelect, final Function1<? super ServerModel, Unit> onFavorite, final Function0<Unit> onFavoriteList, final Function0<Unit> onMobileList, final Function0<Unit> onDesktopList, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(SelectServerScreen)N(uiState,navigateHome,onSelect,onFavorite,onFavoriteList,onMobileList,onDesktopList)79@3199L60,80@3276L24,82@3324L23,84@3353L95,85@3453L2822:SelectServerScreen.kt#2ojkxh");
        if ((i & 6) == 0) {
        ...
        if (!startRestartGroup.shouldExecute((599187 & i2) != 599186, i2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1256713563, i2, -1, "com.miami.game.feature.select.server.ui.compose.SelectServerScreen (SelectServerScreen.kt:78)");
            }
            ...
            Main_backgroundKt.BackgroundImage(uiState.getBackGroundId(), true, uiState.getImageBitmap(), uiState.getFile(), uiState.getVersion(), startRestartGroup, 48);
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 153058280, "C91@3607L2134,143@5787L157,142@5750L519:SelectServerScreen.kt#2ojkxh");
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1498398803, "C97@3853L132,92@3628L358:SelectServerScreen.kt#2ojkxh");
            ...
            if (uiState.getSelectedCategory() != ServerStateCategory.Favorite || !uiState.getServersList().isEmpty()) {
                ...
                ComposerKt.sourceInformation(startRestartGroup, "117@4673L1044");
                ...
                Modifier m1104heightInVpY3zN4 = SizeKt.m1104heightInVpY3zN4(Modifier.Companion, Dp.m8160constructorimpl(125.0f), Dp.m8160constructorimpl(300.0f));
                GridCells.FixedSize fixedSize = new GridCells.FixedSize(Dp.m8160constructorimpl(125.0f), null);
                Arrangement.HorizontalOrVertical spaceEvenly = Arrangement.INSTANCE.getSpaceEvenly();
                PaddingValues m1047PaddingValuesa9UjIt4$default = PaddingKt.m1047PaddingValuesa9UjIt4$default(Dp.m8160constructorimpl(40.0f), 0.0f, Dp.m8160constructorimpl(140.0f), 0.0f, 10, null);
                ...
                if (z3 || rememberedValue4 == Composer.Companion.getEmpty()) {
                    ...
                    rememberedValue4 = new Function1() { // from class: com.miami.game.feature.select.server.ui.compose.SelectServerScreenKt$$ExternalSyntheticLambda1
                        ...
                        public final Object invoke(Object obj) {
                            ...
                            SelectServerScreen$lambda$1$0$2$0$0 = SelectServerScreenKt.SelectServerScreen$lambda$1$0$2$0$0(SelectServerUiState.this, onFavorite, mutableState, (LazyGridScope) obj);
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                LazyGridDslKt.LazyHorizontalGrid(fixedSize2, m1104heightInVpY3zN4, rememberLazyGridState, m1047PaddingValuesa9UjIt4$default, false, null, horizontalOrVertical, null, false, null, rememberedValue4, startRestartGroup, 1575984, 0, 944);
                startRestartGroup = startRestartGroup;
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ...
                ComposerKt.sourceInformation(startRestartGroup, "103@4112L523");
                ...
                long m9864dpToSp8Feqmps = TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(32.0f), startRestartGroup, 6);
                long m9864dpToSp8Feqmps2 = TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(32.0f), startRestartGroup, 6);
                long m9864dpToSp8Feqmps3 = TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(1.0f), startRestartGroup, 6);
                TextUnitKt.m8367checkArithmeticR2X_6o(m9864dpToSp8Feqmps3);
                long pack = TextUnitKt.pack(TextUnit.m8352getRawTypeimpl(m9864dpToSp8Feqmps3), -TextUnit.m8354getValueimpl(m9864dpToSp8Feqmps3));
                z2 = false;
                z = true;
                str = "CC(remember):SelectServerScreen.kt#9igjgp";
                boxScopeInstance = boxScopeInstance2;
                TextKt.m3157TextNvy7gAk("НЕТ ИЗБРАННЫХ", null, m5347copywmQWz5c$default, null, m9864dpToSp8Feqmps, null, null, null, pack, null, null, m9864dpToSp8Feqmps2, 0, false, 0, 0, null, bodyMedium, startRestartGroup, 390, 0, 128746);
                startRestartGroup = startRestartGroup;
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
            ...
            if (z5 || rememberedValue5 == Composer.Companion.getEmpty()) {
                ...
                rememberedValue5 = new Function0() { // from class: com.miami.game.feature.select.server.ui.compose.SelectServerScreenKt$$ExternalSyntheticLambda2
                    ...
                    public final Object invoke() {
                        ...
                        SelectServerScreen$lambda$1$1$0 = SelectServerScreenKt.SelectServerScreen$lambda$1$1$0(SelectServerUiState.this, mutableState, function1);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ScalingButtonKt.ScalingButton((Function0) rememberedValue5, boxScopeInstance.align(Modifier.Companion, Alignment.Companion.getBottomEnd()), ComposableSingletons$SelectServerScreenKt.INSTANCE.getLambda$22973248$select_server(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 0);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.SelectServerScreenKt$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return SelectServerScreenKt.SelectServerScreen$lambda$2(SelectServerUiState.this, navigateHome, function12, onFavorite, onFavoriteList, onMobileList, onDesktopList, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    public static final Unit SelectServerScreen$lambda$1$0$2$0$0(SelectServerUiState selectServerUiState, final Function1 function1, final MutableState mutableState, LazyGridScope LazyHorizontalGrid) {
        ...
        LazyHorizontalGrid.items(serversList.size(), null, null, new Function1<Integer, Object>() { // from class: com.miami.game.feature.select.server.ui.compose.SelectServerScreenKt$SelectServerScreen$lambda$1$0$2$0$0$$inlined$items$default$4
            ...
            public final void invoke(LazyGridItemScope lazyGridItemScope, int i, Composer composer, int i2) {
                ...
                ComposerKt.sourceInformation(composer, "CN(it)*131@5389L109,129@5284L367:SelectServerScreen.kt#2ojkxh");
