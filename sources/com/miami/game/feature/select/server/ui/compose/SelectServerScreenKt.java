    ...
    public static final void SelectServerScreen(final SelectServerUiState uiState, final Function0<Unit> navigateHome, Function1<? super ServerModel, Unit> onSelect, final Function1<? super ServerModel, Unit> onFavorite, final Function0<Unit> onFavoriteList, final Function0<Unit> onMobileList, final Function0<Unit> onDesktopList, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((599187 & i2) != 599186, i2 & 1)) {
            ...
            if (uiState.getSelectedCategory() != ServerStateCategory.Favorite || !uiState.getServersList().isEmpty()) {
                ...
                long m9865dpToSp8Feqmps = TypeKt.m9865dpToSp8Feqmps(Dp.m8160constructorimpl(32.0f), startRestartGroup, 6);
                long m9865dpToSp8Feqmps2 = TypeKt.m9865dpToSp8Feqmps(Dp.m8160constructorimpl(32.0f), startRestartGroup, 6);
                long m9865dpToSp8Feqmps3 = TypeKt.m9865dpToSp8Feqmps(Dp.m8160constructorimpl(1.0f), startRestartGroup, 6);
                TextUnitKt.m8367checkArithmeticR2X_6o(m9865dpToSp8Feqmps3);
                long pack = TextUnitKt.pack(TextUnit.m8352getRawTypeimpl(m9865dpToSp8Feqmps3), -TextUnit.m8354getValueimpl(m9865dpToSp8Feqmps3));
                z2 = false;
                z = true;
                str = "CC(remember):SelectServerScreen.kt#9igjgp";
                boxScopeInstance = boxScopeInstance2;
                TextKt.m3157TextNvy7gAk("НЕТ ИЗБРАННЫХ", null, m5347copywmQWz5c$default, null, m9865dpToSp8Feqmps, null, null, null, pack, null, null, m9865dpToSp8Feqmps2, 0, false, 0, 0, null, bodyMedium, startRestartGroup, 390, 0, 128746);
                startRestartGroup = startRestartGroup;
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
