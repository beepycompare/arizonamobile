...
public final class ServerItemKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ServerName$lambda$4(String str, String str2, Modifier modifier, int i, Composer composer, int i2) {
        ServerName(str, str2, modifier, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ServerOnline$lambda$6(int i, int i2, Modifier modifier, int i3, Composer composer, int i4) {
    ...
    public static final void ServerItem(final ServerModel serverModel, final Function1<? super ServerModel, Unit> onSelect, final Function1<? super ServerModel, Unit> onFavorite, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceGroup(-1228239050);
            ComposerKt.sourceInformation(startRestartGroup, "39@1690L11");
            long m1714getPrimary0d7_KjU = z ? MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m1714getPrimary0d7_KjU() : Color.Companion.m4113getTransparent0d7_KjU();
            startRestartGroup.endReplaceGroup();
            long m4077copywmQWz5c$default = Color.m4077copywmQWz5c$default(Color.Companion.m4104getBlack0d7_KjU(), z ? 0.58f : 0.41f, 0.0f, 0.0f, 0.0f, 14, null);
            startRestartGroup.startReplaceGroup(-1633490746);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):ServerItem.kt#9igjgp");
            boolean changedInstance = ((i2 & 112) == 32) | startRestartGroup.changedInstance(serverModel);
            ...
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableLambdaKt.rememberComposableLambda(1759199162, true, new ServerItemKt$ServerItem$2(m4077copywmQWz5c$default, m1714getPrimary0d7_KjU, serverModel, onFavorite), startRestartGroup, 54), composer2, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerItemKt$$ExternalSyntheticLambda3
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void ServerName(String str, final String str2, final Modifier modifier, Composer composer, final int i) {
        int i2;
        int i3;
        int i4;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerItemKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit ServerName$lambda$4;
                    ServerName$lambda$4 = ServerItemKt.ServerName$lambda$4(str3, str2, modifier, i, (Composer) obj, ((Integer) obj2).intValue());
                    return ServerName$lambda$4;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void ServerOnline(final int i, final int i2, final Modifier modifier, Composer composer, final int i3) {
        int i4;
        Composer composer2;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerItemKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit ServerOnline$lambda$6;
                    ServerOnline$lambda$6 = ServerItemKt.ServerOnline$lambda$6(i, i2, modifier, i3, (Composer) obj, ((Integer) obj2).intValue());
                    return ServerOnline$lambda$6;
                }
            });
        }
    }
