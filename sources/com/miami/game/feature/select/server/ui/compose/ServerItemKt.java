...
public final class ServerItemKt {
    ...
    private static final void ServerName(String str, final String str2, final Modifier modifier, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 147) != 146, i2 & 1)) {
            ...
            if (str2 != null) {
                ...
                i3 = i2;
                i4 = 6;
                SingletonAsyncImageKt.m9379AsyncImage10Xjiaw(str2, null, SizeKt.m976size3ABfNKs(Modifier.Companion, Dp.m8258constructorimpl(24)), null, null, null, ContentScale.Companion.getCrop(), 0.0f, null, 0, false, startRestartGroup, ((i2 >> 3) & 14) | 1573296, 0, 1976);
                startRestartGroup.endReplaceGroup();
            } else {
                i3 = i2;
                i4 = 6;
            ...
            str3 = str;
            TextKt.m3255TextNvy7gAk(str3, null, m5461getWhite0d7_KjU, null, TypeKt.m10152dpToSp8Feqmps(Dp.m8258constructorimpl(21), startRestartGroup, i4), null, null, null, TextUnitKt.pack(TextUnit.m8450getRawTypeimpl(sp), -TextUnit.m8452getValueimpl(sp)), null, null, TypeKt.m10152dpToSp8Feqmps(Dp.m8258constructorimpl(22), startRestartGroup, i4), 0, false, 0, 0, null, labelMedium, startRestartGroup, (i3 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 0, 128746);
    ...
    private static final void ServerOnline(final int i, final int i2, final Modifier modifier, Composer composer, final int i3) {
        ...
        if (!startRestartGroup.shouldExecute((i4 & 147) != 146, i4 & 1)) {
            ...
            float f = 21;
            composer2 = startRestartGroup;
            TextKt.m3255TextNvy7gAk(String.valueOf(i), null, Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10152dpToSp8Feqmps(Dp.m8258constructorimpl(f), startRestartGroup, 6), null, null, null, 0L, null, null, TypeKt.m10152dpToSp8Feqmps(Dp.m8258constructorimpl(f), startRestartGroup, 6), 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodySmall(), composer2, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 129002);
            TextKt.m3255TextNvy7gAk(" / " + i2, OffsetKt.m885offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8258constructorimpl(-Dp.m8258constructorimpl(1)), 1, null), Color.m5423copywmQWz5c$default(Color.Companion.m5461getWhite0d7_KjU(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null), null, TypeKt.m10152dpToSp8Feqmps(Dp.m8258constructorimpl(15), composer2, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer2, MaterialTheme.$stable).getBodySmall(), composer2, 432, 0, 131048);
