...
public final class ServerTopBarKt {
    ...
    public static final void ServerTopBar(final SelectServerUiState uiState, final Function0<Unit> onBack, final Function0<Unit> onFavorite, final Function0<Unit> onMobile, final Function0<Unit> onDesktop, Composer composer, final int i) {
        ...
        if ((i3 & 9363) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):ServerTopBar.kt#9igjgp");
            boolean z = (i3 & 112) == 32;
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (z || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new Function0() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda3
            ...
            Arrangement.HorizontalOrVertical m619spacedBy0680j_4 = Arrangement.INSTANCE.m619spacedBy0680j_4(Dp.m6684constructorimpl(-Dp.m6684constructorimpl(f2)));
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 693286680, "CC(Row)P(2,1,3)99@5124L58,100@5187L130:Row.kt#2w3rfo");
            MeasurePolicy rowMeasurePolicy3 = RowKt.rowMeasurePolicy(m619spacedBy0680j_4, centerVertically3, startRestartGroup, 54);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
    ...
    public static final void FavoriteButtonTopBar(Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceGroup(-772243687);
            ComposerKt.sourceInformation(startRestartGroup, "93@3549L11");
            final long m1714getPrimary0d7_KjU = z ? MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m1714getPrimary0d7_KjU() : Color.Companion.m4113getTransparent0d7_KjU();
            startRestartGroup.endReplaceGroup();
            function0 = onClick;
            ScalingButtonKt.ScalingButton(function0, null, ComposableLambdaKt.rememberComposableLambda(434062301, true, new Function3<BoxScope, Composer, Integer, Unit>() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$FavoriteButtonTopBar$1
                ...
                public final void invoke(BoxScope ScalingButton, Composer composer2, int i3) {
                    ...
                    ComposerKt.sourceInformation(composer2, "C95@3655L47,95@3639L248:ServerTopBar.kt#2ojkxh");
                    if ((i3 & 17) != 16 || !composer2.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(434062301, i3, -1, "com.miami.game.feature.select.server.ui.compose.FavoriteButtonTopBar.<anonymous> (ServerTopBar.kt:95)");
                        }
                        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.btn_favorite_server, composer2, 0), (String) null, BorderKt.m258borderxT4_qwU(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), Dp.m6684constructorimpl(3), m1714getPrimary0d7_KjU, new TopBarBtnShape()), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, composer2, 24624, 104);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda5
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit FavoriteButtonTopBar$lambda$7;
                    FavoriteButtonTopBar$lambda$7 = ServerTopBarKt.FavoriteButtonTopBar$lambda$7(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
    ...
    public static final void MobileButtonTopBar(final Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 19) == 18 && startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceGroup(236646111);
            ...
            if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new Function0() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit MobileButtonTopBar$lambda$9$lambda$8;
                        MobileButtonTopBar$lambda$9$lambda$8 = ServerTopBarKt.MobileButtonTopBar$lambda$9$lambda$8(Function0.this);
                        return MobileButtonTopBar$lambda$9$lambda$8;
                    }
                };
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            startRestartGroup.endReplaceGroup();
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableLambdaKt.rememberComposableLambda(596446243, true, new Function3<BoxScope, Composer, Integer, Unit>() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$MobileButtonTopBar$2
                @Override // kotlin.jvm.functions.Function3
                public /* bridge */ /* synthetic */ Unit invoke(BoxScope boxScope, Composer composer2, Integer num) {
                    invoke(boxScope, composer2, num.intValue());
                    return Unit.INSTANCE;
                ...
                public final void invoke(BoxScope ScalingButton, Composer composer2, int i3) {
                    Intrinsics.checkNotNullParameter(ScalingButton, "$this$ScalingButton");
                    ComposerKt.sourceInformation(composer2, "C111@4202L22,110@4173L231:ServerTopBar.kt#2ojkxh");
                    if ((i3 & 17) != 16 || !composer2.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(596446243, i3, -1, "com.miami.game.feature.select.server.ui.compose.MobileButtonTopBar.<anonymous> (ServerTopBar.kt:109)");
                        }
                        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.btn_mobile_server, composer2, 0), (String) null, BorderKt.m258borderxT4_qwU(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), Dp.m6684constructorimpl(3), m1714getPrimary0d7_KjU, new TopBarBtnShape()), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, composer2, 24624, 104);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit MobileButtonTopBar$lambda$10;
                    MobileButtonTopBar$lambda$10 = ServerTopBarKt.MobileButtonTopBar$lambda$10(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
                    return MobileButtonTopBar$lambda$10;
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit MobileButtonTopBar$lambda$9$lambda$8(Function0 function0) {
        function0.invoke();
        return Unit.INSTANCE;
    }
    ...
    public static final void DesktopButtonTopBar(Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.startReplaceGroup(650827613);
            ComposerKt.sourceInformation(startRestartGroup, "122@4536L11");
            final long m1714getPrimary0d7_KjU = z ? MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m1714getPrimary0d7_KjU() : Color.Companion.m4113getTransparent0d7_KjU();
            startRestartGroup.endReplaceGroup();
            function0 = onClick;
            ScalingButtonKt.ScalingButton(function0, null, ComposableLambdaKt.rememberComposableLambda(-1186374773, true, new Function3<BoxScope, Composer, Integer, Unit>() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$DesktopButtonTopBar$1
                @Override // kotlin.jvm.functions.Function3
                public /* bridge */ /* synthetic */ Unit invoke(BoxScope boxScope, Composer composer2, Integer num) {
                    invoke(boxScope, composer2, num.intValue());
                    return Unit.INSTANCE;
                ...
                public final void invoke(BoxScope ScalingButton, Composer composer2, int i3) {
                    Intrinsics.checkNotNullParameter(ScalingButton, "$this$ScalingButton");
                    ComposerKt.sourceInformation(composer2, "C125@4655L46,124@4626L262:ServerTopBar.kt#2ojkxh");
                    if ((i3 & 17) != 16 || !composer2.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1186374773, i3, -1, "com.miami.game.feature.select.server.ui.compose.DesktopButtonTopBar.<anonymous> (ServerTopBar.kt:124)");
                        }
                        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.btn_desktop_server, composer2, 0), (String) null, BorderKt.m258borderxT4_qwU(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), Dp.m6684constructorimpl(3), m1714getPrimary0d7_KjU, new TopBarDesktopBtnShape()), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, composer2, 24624, 104);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit DesktopButtonTopBar$lambda$11;
                    DesktopButtonTopBar$lambda$11 = ServerTopBarKt.DesktopButtonTopBar$lambda$11(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
                    return DesktopButtonTopBar$lambda$11;
                }
            });
        }
    }
