...
public final class ServerTopBarKt {
    ...
    public static final void ServerTopBar(final SelectServerUiState uiState, final Function0<Unit> onBack, final Function0<Unit> onFavorite, final Function0<Unit> onMobile, final Function0<Unit> onDesktop, final Function0<Unit> onLogo, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((74899 & i2) != 74898, i2 & 1)) {
            ...
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableSingletons$ServerTopBarKt.INSTANCE.m9031getLambda$1484463318$select_server_release(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            Painter painterResource = PainterResources_androidKt.painterResource(R.drawable.select_server_label, startRestartGroup, 0);
            float f = 30;
            float f2 = 12;
            Modifier m797offsetVpY3zN4$default = OffsetKt.m797offsetVpY3zN4$default(SizeKt.m880height3ABfNKs(Modifier.Companion, Dp.m7264constructorimpl(f)), Dp.m7264constructorimpl(-Dp.m7264constructorimpl(f2)), 0.0f, 2, null);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ImageKt.Image(painterResource, (String) null, ClickableKt.m308clickableoSLSa3U$default(m797offsetVpY3zN4$default, false, null, null, null, (Function0) rememberedValue2, 15, null), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, startRestartGroup, 24624, 104);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier m846paddingqDBjuR0$default = PaddingKt.m846paddingqDBjuR0$default(SizeKt.m880height3ABfNKs(Modifier.Companion, Dp.m7264constructorimpl(f)), 0.0f, 0.0f, Dp.m7264constructorimpl(f2), 0.0f, 11, null);
            Alignment.Vertical centerVertically3 = Alignment.Companion.getCenterVertically();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 844473419, "CC(Row)N(modifier,horizontalArrangement,verticalAlignment,content)99@5125L58,100@5188L131:Row.kt#2w3rfo");
            MeasurePolicy rowMeasurePolicy3 = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m701spacedBy0680j_4(Dp.m7264constructorimpl(-Dp.m7264constructorimpl(f2))), centerVertically3, startRestartGroup, 54);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1159599143, "CC(Layout)P(!1,2)80@3267L27,83@3433L360:Layout.kt#80mrfh");
            ...
            Updater.m3874setimpl(m3867constructorimpl4, rowMeasurePolicy3, ComposeUiNode.Companion.getSetMeasurePolicy());
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            CustomDividerKt.CustomDivider(OffsetKt.m797offsetVpY3zN4$default(boxScopeInstance.align(Modifier.Companion, Alignment.Companion.getBottomCenter()), 0.0f, Dp.m7264constructorimpl(-Dp.m7264constructorimpl(0)), 1, null), startRestartGroup, 0, 0);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda7
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    ServerTopBar$lambda$1 = ServerTopBarKt.ServerTopBar$lambda$1(SelectServerUiState.this, onBack, onFavorite, onMobile, onDesktop, onLogo, i, (Composer) obj, ((Integer) obj2).intValue());
    ...
    public static final void FavoriteButtonTopBar(Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        final long m4584getTransparent0d7_KjU;
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            if (z) {
                ...
                m4584getTransparent0d7_KjU = MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m2031getPrimary0d7_KjU();
            ...
            ScalingButtonKt.ScalingButton(function0, null, ComposableLambdaKt.rememberComposableLambda(434062301, true, new Function3() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda8
                ...
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    Unit FavoriteButtonTopBar$lambda$0;
                    FavoriteButtonTopBar$lambda$0 = ServerTopBarKt.FavoriteButtonTopBar$lambda$0(m4584getTransparent0d7_KjU, (BoxScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
                    return FavoriteButtonTopBar$lambda$0;
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda9
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit FavoriteButtonTopBar$lambda$1;
                    FavoriteButtonTopBar$lambda$1 = ServerTopBarKt.FavoriteButtonTopBar$lambda$1(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
                    return FavoriteButtonTopBar$lambda$1;
                }
            });
        }
    }
    ...
    public static final Unit FavoriteButtonTopBar$lambda$0(long j, BoxScope ScalingButton, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.btn_favorite_server, composer, 0), (String) null, BorderKt.m279borderxT4_qwU(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), Dp.m7264constructorimpl(3), j, new TopBarBtnShape()), (Alignment) null, ContentScale.Companion.getFillHeight(), 0.0f, (ColorFilter) null, composer, 24624, 104);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void MobileButtonTopBar(final Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        if (startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableLambdaKt.rememberComposableLambda(596446243, true, new Function3() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    Unit MobileButtonTopBar$lambda$1;
                    MobileButtonTopBar$lambda$1 = ServerTopBarKt.MobileButtonTopBar$lambda$1(m4584getTransparent0d7_KjU, (BoxScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
                    return MobileButtonTopBar$lambda$1;
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit MobileButtonTopBar$lambda$2;
                    MobileButtonTopBar$lambda$2 = ServerTopBarKt.MobileButtonTopBar$lambda$2(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
                    return MobileButtonTopBar$lambda$2;
                }
            });
        }
    }
    ...
    public static final void DesktopButtonTopBar(Function0<Unit> onClick, final boolean z, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            ScalingButtonKt.ScalingButton(function0, null, ComposableLambdaKt.rememberComposableLambda(-1186374773, true, new Function3() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda3
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    Unit DesktopButtonTopBar$lambda$0;
                    DesktopButtonTopBar$lambda$0 = ServerTopBarKt.DesktopButtonTopBar$lambda$0(m4584getTransparent0d7_KjU, (BoxScope) obj, (Composer) obj2, ((Integer) obj3).intValue());
                    return DesktopButtonTopBar$lambda$0;
                }
            }, startRestartGroup, 54), startRestartGroup, (i2 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.select.server.ui.compose.ServerTopBarKt$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit DesktopButtonTopBar$lambda$1;
                    DesktopButtonTopBar$lambda$1 = ServerTopBarKt.DesktopButtonTopBar$lambda$1(Function0.this, z, i, (Composer) obj, ((Integer) obj2).intValue());
                    return DesktopButtonTopBar$lambda$1;
                }
            });
        }
    }
