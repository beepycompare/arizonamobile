...
public final class SelectServerComponent_Factory_Impl implements SelectServerComponent.Factory {
    private final C0106SelectServerComponent_Factory delegateFactory;

    SelectServerComponent_Factory_Impl(C0106SelectServerComponent_Factory delegateFactory) {
    ...
    public static Provider<SelectServerComponent.Factory> create(C0106SelectServerComponent_Factory delegateFactory) {
        return InstanceFactory.create(new SelectServerComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<SelectServerComponent.Factory> createFactoryProvider(C0106SelectServerComponent_Factory delegateFactory) {
        return InstanceFactory.create(new SelectServerComponent_Factory_Impl(delegateFactory));
    }
}
