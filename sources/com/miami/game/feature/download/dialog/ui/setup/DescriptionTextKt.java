...
public final class DescriptionTextKt {
    ...
    public static final void DescriptionText(final String updateSize, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            int pushStyle = builder.pushStyle(new SpanStyle(Color.m5347copywmQWz5c$default(Color.Companion.m5385getWhite0d7_KjU(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null), TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(16.0f), startRestartGroup, 6), MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall().getFontWeight(), (FontStyle) null, (FontSynthesis) null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall().getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65496, (DefaultConstructorMarker) null));
            try {
                builder.append("Вы собираетесь загрузить файлы игры размером ");
                Unit unit = Unit.INSTANCE;
                builder.pop(pushStyle);
                pushStyle = builder.pushStyle(new SpanStyle(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).m2322getPrimary0d7_KjU(), TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(18.0f), startRestartGroup, 6), MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall().getFontWeight(), (FontStyle) null, (FontSynthesis) null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall().getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65496, (DefaultConstructorMarker) null));
                try {
