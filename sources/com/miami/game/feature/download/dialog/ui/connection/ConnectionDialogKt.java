...
public final class ConnectionDialogKt {
    ...
    public static final Unit ConnectionDialog$lambda$0(ConnectionData connectionData, final Function0 function0, final Function1 function1, Composer composer, int i) {
        ...
        if (composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            InputFieldKt.m9802InputFieldrAjV9yQ(mutableState, Dp.m8160constructorimpl(140.0f), R.drawable.input, composer, 54);
            InputFieldKt.m9802InputFieldrAjV9yQ(mutableState2, Dp.m8160constructorimpl(50.0f), R.drawable.input_port, composer, 54);
            InputFieldKt.m9802InputFieldrAjV9yQ(mutableState3, Dp.m8160constructorimpl(120.0f), R.drawable.input_password, composer, 54);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            DialogButtonKt.DialogButtonNo((Function0) rememberedValue4, ComposableSingletons$ConnectionDialogKt.INSTANCE.m9800getLambda$751471044$dialogs(), composer, 48);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            DialogButtonKt.DialogButtonYes((Function0) rememberedValue5, false, ComposableSingletons$ConnectionDialogKt.INSTANCE.m9799getLambda$1711092251$dialogs(), composer, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
