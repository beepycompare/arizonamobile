...
public final class C0109CommonDialogComponent_Factory {
    ...
    private C0109CommonDialogComponent_Factory(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
    ...
    public static C0109CommonDialogComponent_Factory create(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
        return new C0109CommonDialogComponent_Factory(resourcesProvider, buildConfigProvider, privacyInteractorProvider);
    }
