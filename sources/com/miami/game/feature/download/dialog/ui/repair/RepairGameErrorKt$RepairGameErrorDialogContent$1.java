...
final class RepairGameErrorKt$RepairGameErrorDialogContent$1 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function0<Unit> $onDismiss;

    /* JADX INFO: Access modifiers changed from: package-private */
    public RepairGameErrorKt$RepairGameErrorDialogContent$1(Function0<Unit> function0) {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformation(composer, "CC(remember):RepairGameError.kt#9igjgp");
            boolean changed = composer.changed(function0);
            Object rememberedValue = composer.rememberedValue();
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new Function0() { // from class: com.miami.game.feature.download.dialog.ui.repair.RepairGameErrorKt$RepairGameErrorDialogContent$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit invoke$lambda$2$lambda$1$lambda$0;
                        invoke$lambda$2$lambda$1$lambda$0 = RepairGameErrorKt$RepairGameErrorDialogContent$1.invoke$lambda$2$lambda$1$lambda$0(Function0.this);
