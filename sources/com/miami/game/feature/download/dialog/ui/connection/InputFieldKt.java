...
public final class InputFieldKt {
    ...
    public static final Unit InputField_rAjV9yQ$lambda$1(MutableState mutableState, float f, int i, int i2, Composer composer, int i3) {
        m9761InputFieldrAjV9yQ(mutableState, f, i, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }

    /* renamed from: InputField-rAjV9yQ  reason: not valid java name */
    public static final void m9761InputFieldrAjV9yQ(final MutableState<String> state, final float f, final int i, Composer composer, final int i2) {
        int i3;
        ...
        if (!startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            Modifier m900width3ABfNKs = SizeKt.m900width3ABfNKs(Modifier.Companion, f);
            String value = state.getValue();
            float f2 = 24;
            TextStyle m7471copyp1EtxEg$default = TextStyle.m7471copyp1EtxEg$default(MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodySmall(), Color.m5279copywmQWz5c$default(Color.Companion.m5317getWhite0d7_KjU(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null), TypeKt.m9855dpToSp8Feqmps(Dp.m7996constructorimpl(f2), startRestartGroup, 6), null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, TypeKt.m9855dpToSp8Feqmps(Dp.m7996constructorimpl(f2), startRestartGroup, 6), null, null, null, 0, 0, null, 16646140, null);
            ...
            BasicTextFieldKt.BasicTextField(value, (Function1<? super String, Unit>) rememberedValue, m900width3ABfNKs, false, false, m7471copyp1EtxEg$default, (KeyboardOptions) null, (KeyboardActions) null, true, 0, 0, (VisualTransformation) null, (Function1<? super TextLayoutResult, Unit>) null, (MutableInteractionSource) null, (Brush) null, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableSingletons$InputFieldKt.INSTANCE.m9757getLambda$1682333503$dialogs_release(), startRestartGroup, 100663296, (int) ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 32472);
