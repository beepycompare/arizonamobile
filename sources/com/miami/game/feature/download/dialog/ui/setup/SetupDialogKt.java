...
public final class SetupDialogKt {
    ...
    public static final Unit SetupDialogContent$lambda$1(String str, final boolean z, Function0 function0, Function0 function02, final MutableState mutableState, final Function0 function03, final Function0 function04, final Function0 function05, Composer composer, int i) {
        ...
        if (composer2.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            if (z) {
                ...
                MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m742spacedBy0680j_4(Dp.m8160constructorimpl(-Dp.m8160constructorimpl(12.0f))), centerVertically, composer2, 54);
    ...
    public static final Unit SetupDialogContent$lambda$1$1$2(MutableState mutableState, boolean z, BoxScope DialogButtonYes, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            TextKt.m3157TextNvy7gAk("ЗАГРУЗИТЬ", null, (((Boolean) mutableState.getValue()).booleanValue() || z) ? Color.Companion.m5385getWhite0d7_KjU() : Color.m5347copywmQWz5c$default(Color.Companion.m5385getWhite0d7_KjU(), 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, 6).getBodySmall(), composer, 6, 0, 131066);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
