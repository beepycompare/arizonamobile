...
public final class ErrorDialogComponent_Factory_Impl implements ErrorDialogComponent.Factory {
    private final C0102ErrorDialogComponent_Factory delegateFactory;

    ErrorDialogComponent_Factory_Impl(C0102ErrorDialogComponent_Factory delegateFactory) {
    ...
    public static Provider<ErrorDialogComponent.Factory> create(C0102ErrorDialogComponent_Factory delegateFactory) {
        return InstanceFactory.create(new ErrorDialogComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<ErrorDialogComponent.Factory> createFactoryProvider(C0102ErrorDialogComponent_Factory delegateFactory) {
        return InstanceFactory.create(new ErrorDialogComponent_Factory_Impl(delegateFactory));
    }
}
