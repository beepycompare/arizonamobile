...
public final class C0088CommonDialogComponent_Factory {
    ...
    private C0088CommonDialogComponent_Factory(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
    ...
    public static C0088CommonDialogComponent_Factory create(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
        return new C0088CommonDialogComponent_Factory(resourcesProvider, buildConfigProvider, privacyInteractorProvider);
    }
