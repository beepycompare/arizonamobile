...
public final class ComposableSingletons$RepairGameErrorKt {
    ...
    public final Function3<BoxScope, Composer, Integer, Unit> getLambda$2144985598$dialogs_release() {
    ...
    public static final Unit lambda_2144985598$lambda$0(BoxScope DialogButtonNo, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            TextKt.m3169TextNvy7gAk("НАЗАД", null, 0L, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, MaterialTheme.$stable).getBodySmall(), composer, 6, 0, 131070);
            if (ComposerKt.isTraceInProgress()) {
