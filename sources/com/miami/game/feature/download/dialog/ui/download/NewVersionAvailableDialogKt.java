...
public final class NewVersionAvailableDialogKt {
    ...
    public static final Unit NewVersionAvailableDialogContent$lambda$11(final Function0 function0, final Function0 function02, Composer composer, int i) {
        ...
        if (composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            DialogButtonKt.DialogButtonNo((Function0) rememberedValue, ComposableSingletons$NewVersionAvailableDialogKt.INSTANCE.m8343getLambda$1405896063$dialogs_release_web(), composer, 48);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            DialogButtonKt.DialogButtonYes((Function0) rememberedValue2, false, ComposableSingletons$NewVersionAvailableDialogKt.INSTANCE.m8344getLambda$1889472662$dialogs_release_web(), composer, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
