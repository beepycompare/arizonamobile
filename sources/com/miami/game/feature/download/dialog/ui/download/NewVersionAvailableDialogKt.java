...
public final class NewVersionAvailableDialogKt {
    ...
    public static final Unit NewVersionAvailableDialogContent$lambda$6(Function0 function0, Function0 function02, int i, Composer composer, int i2) {
    ...
    public static final void NewVersionAvailableDialogRoute(final CommonDialogComponent component, final Function0<Unit> onBackClick, final Function0<Unit> navigateToDownloadScreen, Composer composer, final int i) {
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember):NewVersionAvailableDialog.kt#9igjgp");
    ...
    public static final void NewVersionAvailableDialogContent(final Function0<Unit> onConfirm, Function0<Unit> onDismiss, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            function0 = onDismiss;
            DialogFrameKt.DialogFrame(Integer.valueOf(R.drawable.dialog_frame_background_download_icon), function0, ComposableLambdaKt.rememberComposableLambda(1396301117, true, new NewVersionAvailableDialogKt$NewVersionAvailableDialogContent$1(onDismiss, onConfirm), startRestartGroup, 54), startRestartGroup, (i2 & 112) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.download.dialog.ui.download.NewVersionAvailableDialogKt$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    Unit NewVersionAvailableDialogContent$lambda$6;
                    NewVersionAvailableDialogContent$lambda$6 = NewVersionAvailableDialogKt.NewVersionAvailableDialogContent$lambda$6(Function0.this, function0, i, (Composer) obj, ((Integer) obj2).intValue());
                    return NewVersionAvailableDialogContent$lambda$6;
                }
            });
        }
    }
