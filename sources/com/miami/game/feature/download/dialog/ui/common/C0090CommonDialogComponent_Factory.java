...
public final class C0090CommonDialogComponent_Factory {
    ...
    private C0090CommonDialogComponent_Factory(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
    ...
    public static C0090CommonDialogComponent_Factory create(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
        return new C0090CommonDialogComponent_Factory(resourcesProvider, buildConfigProvider, privacyInteractorProvider);
    }
