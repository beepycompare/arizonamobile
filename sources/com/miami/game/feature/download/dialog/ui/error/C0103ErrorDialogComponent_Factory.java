...
public final class C0103ErrorDialogComponent_Factory {
    private final Provider<Resources> resourcesProvider;
    private final Provider<ErrorDialogUiAssembler> uiAssemblerProvider;

    private C0103ErrorDialogComponent_Factory(Provider<ErrorDialogUiAssembler> uiAssemblerProvider, Provider<Resources> resourcesProvider) {
    ...
    public static C0103ErrorDialogComponent_Factory create(Provider<ErrorDialogUiAssembler> uiAssemblerProvider, Provider<Resources> resourcesProvider) {
        return new C0103ErrorDialogComponent_Factory(uiAssemblerProvider, resourcesProvider);
    }
