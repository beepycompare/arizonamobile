...
public final class ComposableSingletons$RepairGameDialogKt {
    ...
    public final Function3<BoxScope, Composer, Integer, Unit> m9104getLambda$1796529959$dialogs() {
        return f138lambda$1796529959;
    }

    /* renamed from: getLambda$-277375600$dialogs  reason: not valid java name */
    public final Function3<BoxScope, Composer, Integer, Unit> m9105getLambda$277375600$dialogs() {
    ...
    public static final Unit lambda__1796529959$lambda$0(BoxScope DialogButtonNo, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            TextKt.m2712TextNvy7gAk("НЕТ", null, 0L, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, MaterialTheme.$stable).getBodySmall(), composer, 6, 0, 131070);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Unit lambda__277375600$lambda$0(BoxScope DialogButtonYes, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            TextKt.m2712TextNvy7gAk("ДА", null, 0L, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, MaterialTheme.$stable).getBodySmall(), composer, 6, 0, 131070);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
