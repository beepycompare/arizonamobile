...
public final class ComponentKt {
    ...
    public static final void AlertLabelDialog(Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute(i != 0, i & 1)) {
            ...
            composer2 = startRestartGroup;
            TextKt.m3157TextNvy7gAk("ПРЕДУПРЕЖДЕНИЕ", null, MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6).m2322getPrimary0d7_KjU(), null, TypeKt.m9869dpToSp8Feqmps(Dp.m8160constructorimpl(40.0f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodyMedium(), composer2, 6, 0, 131050);
            if (ComposerKt.isTraceInProgress()) {
