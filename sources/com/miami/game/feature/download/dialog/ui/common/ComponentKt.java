...
public final class ComponentKt {
    ...
    public static final void AlertLabelDialog(Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute(i != 0, i & 1)) {
            ...
            composer2 = startRestartGroup;
            TextKt.m2712TextNvy7gAk("ПРЕДУПРЕЖДЕНИЕ", null, MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m1877getPrimary0d7_KjU(), null, TypeKt.m9135dpToSp8Feqmps(Dp.m7555constructorimpl(40.0f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodyMedium(), composer2, 6, 0, 131050);
            if (ComposerKt.isTraceInProgress()) {
