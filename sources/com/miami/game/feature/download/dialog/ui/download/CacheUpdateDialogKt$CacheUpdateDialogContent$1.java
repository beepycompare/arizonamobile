...
final class CacheUpdateDialogKt$CacheUpdateDialogContent$1 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function0<Unit> $onConfirm;
    final /* synthetic */ Function0<Unit> $onDismiss;
    final /* synthetic */ String $updateSize;

    /* JADX INFO: Access modifiers changed from: package-private */
    public CacheUpdateDialogKt$CacheUpdateDialogContent$1(String str, Function0<Unit> function0, Function0<Unit> function02) {
        this.$updateSize = str;
    ...
    public final void invoke(Composer composer, int i) {
        ...
        DialogDescriptionTextKt.DialogDescriptionText("Данная версия устарела, необходимо загрузить версию 4.3.1az0 " + this.$updateSize, composer, 0);
        ...
        ComposerKt.sourceInformation(composer, "CC(remember):CacheUpdateDialog.kt#9igjgp");
        boolean changed = composer.changed(function0);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function0() { // from class: com.miami.game.feature.download.dialog.ui.download.CacheUpdateDialogKt$CacheUpdateDialogContent$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit invoke$lambda$4$lambda$1$lambda$0;
                    invoke$lambda$4$lambda$1$lambda$0 = CacheUpdateDialogKt$CacheUpdateDialogContent$1.invoke$lambda$4$lambda$1$lambda$0(Function0.this);
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new Function0() { // from class: com.miami.game.feature.download.dialog.ui.download.CacheUpdateDialogKt$CacheUpdateDialogContent$1$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit invoke$lambda$4$lambda$3$lambda$2;
                    invoke$lambda$4$lambda$3$lambda$2 = CacheUpdateDialogKt$CacheUpdateDialogContent$1.invoke$lambda$4$lambda$3$lambda$2(Function0.this);
        ...
        composer.endReplaceGroup();
        DialogButtonKt.DialogButtonYes(rememberedValue2, false, ComposableSingletons$CacheUpdateDialogKt.INSTANCE.getLambda$1292262873$dialogs_release_web(), composer, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
