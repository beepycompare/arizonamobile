...
public final class C0090ErrorDialogComponent_Factory {
    private final Provider<Resources> resourcesProvider;
    private final Provider<ErrorDialogUiAssembler> uiAssemblerProvider;

    private C0090ErrorDialogComponent_Factory(Provider<ErrorDialogUiAssembler> uiAssemblerProvider, Provider<Resources> resourcesProvider) {
    ...
    public static C0090ErrorDialogComponent_Factory create(Provider<ErrorDialogUiAssembler> uiAssemblerProvider, Provider<Resources> resourcesProvider) {
        return new C0090ErrorDialogComponent_Factory(uiAssemblerProvider, resourcesProvider);
    }
