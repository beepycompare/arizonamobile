...
public final class C0101CommonDialogComponent_Factory {
    ...
    private C0101CommonDialogComponent_Factory(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
    ...
    public static C0101CommonDialogComponent_Factory create(Provider<Resources> resourcesProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<privacyInteractor> privacyInteractorProvider) {
        return new C0101CommonDialogComponent_Factory(resourcesProvider, buildConfigProvider, privacyInteractorProvider);
    }
