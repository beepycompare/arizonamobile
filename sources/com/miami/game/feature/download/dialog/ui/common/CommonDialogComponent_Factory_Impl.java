...
public final class CommonDialogComponent_Factory_Impl implements CommonDialogComponent.Factory {
    private final C0109CommonDialogComponent_Factory delegateFactory;

    CommonDialogComponent_Factory_Impl(C0109CommonDialogComponent_Factory delegateFactory) {
    ...
    public static Provider<CommonDialogComponent.Factory> create(C0109CommonDialogComponent_Factory delegateFactory) {
        return InstanceFactory.create(new CommonDialogComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<CommonDialogComponent.Factory> createFactoryProvider(C0109CommonDialogComponent_Factory delegateFactory) {
        return InstanceFactory.create(new CommonDialogComponent_Factory_Impl(delegateFactory));
    }
}
