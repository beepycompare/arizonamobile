...
final class FailDownloadDialogKt$FailDownloadErrorDialogScreen$1 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Function0<Unit> $onConfirm;

    /* JADX INFO: Access modifiers changed from: package-private */
    public FailDownloadDialogKt$FailDownloadErrorDialogScreen$1(Function0<Unit> function0) {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "CC(remember):FailDownloadDialog.kt#9igjgp");
        boolean changed = composer.changed(function0);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function0() { // from class: com.miami.game.feature.download.dialog.ui.error.compose.FailDownloadDialogKt$FailDownloadErrorDialogScreen$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit invoke$lambda$4$lambda$1$lambda$0;
                    invoke$lambda$4$lambda$1$lambda$0 = FailDownloadDialogKt$FailDownloadErrorDialogScreen$1.invoke$lambda$4$lambda$1$lambda$0(Function0.this);
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new Function0() { // from class: com.miami.game.feature.download.dialog.ui.error.compose.FailDownloadDialogKt$FailDownloadErrorDialogScreen$1$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit invoke$lambda$4$lambda$3$lambda$2;
                    invoke$lambda$4$lambda$3$lambda$2 = FailDownloadDialogKt$FailDownloadErrorDialogScreen$1.invoke$lambda$4$lambda$3$lambda$2(Function0.this);
        ...
        composer.endReplaceGroup();
        DialogButtonKt.DialogButtonYes(rememberedValue2, false, ComposableSingletons$FailDownloadDialogKt.INSTANCE.m8340getLambda$1143154327$dialogs_release_web(), composer, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
