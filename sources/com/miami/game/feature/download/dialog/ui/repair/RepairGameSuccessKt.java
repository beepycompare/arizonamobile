...
public final class RepairGameSuccessKt {
    ...
    public static final Unit RepairGameSuccessDialogContent$lambda$0(final Function0 function0, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.check_files_success_icon, composer, 0), (String) null, SizeKt.m895size3ABfNKs(Modifier.Companion, Dp.m7996constructorimpl(100)), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer, 432, 120);
            TextKt.m3169TextNvy7gAk("ФАЙЛЫ ПРОВЕРЕНЫ", null, ColorKt.Color(4293066608L), null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, MaterialTheme.$stable).getBodyMedium(), composer, 390, 0, 131066);
