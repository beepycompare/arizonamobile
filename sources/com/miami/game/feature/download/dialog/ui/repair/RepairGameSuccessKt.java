...
public final class RepairGameSuccessKt {
    ...
    public static final Unit RepairGameSuccessDialogContent$lambda$0(final Function0 function0, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            TextKt.m3157TextNvy7gAk("ФАЙЛЫ ПРОВЕРЕНЫ", null, ColorKt.Color(4293066608L), null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, MaterialTheme.$stable).getBodyMedium(), composer, 390, 0, 131066);
