...
@DebugMetadata(c = "com.miami.game.feature.download.screen.ui.DownloadScreenComponent$initVmState$2$1", f = "DownloadScreenComponent.kt", i = {0, 0, 0}, l = {180}, m = "invokeSuspend", n = {"$this$getSuspend$iv", "key$iv", "$i$f$getSuspend"}, s = {"L$0", "L$1", "I$0"}, v = 1)
