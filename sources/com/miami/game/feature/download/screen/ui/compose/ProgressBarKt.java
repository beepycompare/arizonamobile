...
public final class ProgressBarKt {
    ...
    public static final void ProgressBar(final Modifier modifier, final double d, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            Modifier m881height3ABfNKs = SizeKt.m881height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), Dp.m7996constructorimpl(20));
            ...
            Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, m881height3ABfNKs);
            ...
            float f = 12;
            BoxKt.Box(BackgroundKt.m267backgroundbw27NRU(SizeKt.fillMaxWidth$default(SizeKt.m881height3ABfNKs(Modifier.Companion, Dp.m7996constructorimpl(f)), 0.0f, 1, null), Color.Companion.m5306getBlack0d7_KjU(), new ProgressBarShape()), startRestartGroup, 0);
            BoxKt.Box(BackgroundKt.m267backgroundbw27NRU(SizeKt.fillMaxWidth(SizeKt.m881height3ABfNKs(BoxScopeInstance.INSTANCE.align(Modifier.Companion, Alignment.Companion.getCenterStart()), Dp.m7996constructorimpl(f)), (float) d), MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m2103getPrimary0d7_KjU(), new ProgressBarShape()), startRestartGroup, 0);
    ...
    */
    public static final void CustomLinerProgressBar(final Function0<Float> progress, Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if (i4 != 0) {
            ...
            if (startRestartGroup.shouldExecute((i3 & 19) == 18, i3 & 1)) {
                ...
                final long m5279copywmQWz5c$default = Color.m5279copywmQWz5c$default(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, MaterialTheme.$stable).m2103getPrimary0d7_KjU(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null);
                Modifier m881height3ABfNKs = SizeKt.m881height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), Dp.m7996constructorimpl(10));
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1755266998, "CC(remember):ProgressBar.kt#9igjgp");
                boolean changed = startRestartGroup.changed(m5279copywmQWz5c$default) | ((i3 & 14) == 4);
                ...
                if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = new Function1() { // from class: com.miami.game.feature.download.screen.ui.compose.ProgressBarKt$$ExternalSyntheticLambda1
                        ...
                        public final Object invoke(Object obj2) {
                            ...
                            CustomLinerProgressBar$lambda$0$0 = ProgressBarKt.CustomLinerProgressBar$lambda$0$0(Function0.this, m5279copywmQWz5c$default, (DrawScope) obj2);
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                CanvasKt.Canvas(m881height3ABfNKs, (Function1) rememberedValue, startRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
    ...
    public static final Unit CustomLinerProgressBar$lambda$0$0(Function0 function0, long j, DrawScope Canvas) {
        ...
        drawCustomLine(Canvas, Brush.Companion.m5230linearGradientmHitzGk$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m5270boximpl(Color.m5279copywmQWz5c$default(Color.Companion.m5306getBlack0d7_KjU(), 0.65f, 0.0f, 0.0f, 0.0f, 14, null)), Color.m5270boximpl(Color.m5279copywmQWz5c$default(Color.Companion.m5306getBlack0d7_KjU(), 0.65f, 0.0f, 0.0f, 0.0f, 14, null))}), 0L, 0L, 0, 14, (Object) null), 1.0f);
        try {
            drawCustomLine(Canvas, Brush.Companion.m5230linearGradientmHitzGk$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m5270boximpl(ColorKt.getPink()), Color.m5270boximpl(Color.Companion.m5317getWhite0d7_KjU())}), Offset.m5028constructorimpl((Float.floatToRawIntBits((Float.intBitsToFloat((int) (Canvas.mo5859getSizeNHjbRc() >> 32)) * ((Number) function0.invoke()).floatValue()) / 1.5f) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L)), Offset.m5028constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (Canvas.mo5859getSizeNHjbRc() >> 32)) * ((Number) function0.invoke()).floatValue()) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L)), 0, 8, (Object) null), ((Number) function0.invoke()).floatValue(), new Border(20.0f, j, null));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return Unit.INSTANCE;
    ...
    public static final void drawCustomLine(DrawScope drawScope, Brush brush, float f) {
        ...
        float intBitsToFloat = Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() & 4294967295L)) / 2;
        float intBitsToFloat2 = Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() >> 32)) * f;
        Path Path = AndroidPath_androidKt.Path();
        Path.moveTo(intBitsToFloat, 0.0f);
        Path.lineTo(intBitsToFloat2, 0.0f);
        Path.lineTo(intBitsToFloat2 - intBitsToFloat, Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() & 4294967295L)));
        Path.lineTo(0.0f, Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() & 4294967295L)));
        Path.close();
        DrawScope.m5848drawPathGBMwjPU$default(drawScope, Path, brush, 0.0f, Fill.INSTANCE, null, 0, 52, null);
    }
    ...
    public static final void drawCustomLine(DrawScope drawScope, Brush brush, float f, Border border) {
        ...
        Path.lineTo(intBitsToFloat2, 0.0f);
        Path.lineTo(intBitsToFloat2 - intBitsToFloat, Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() & 4294967295L)));
        Path.lineTo(0.0f, Float.intBitsToFloat((int) (4294967295L & drawScope.mo5859getSizeNHjbRc())));
        Path.close();
        DrawScope.m5849drawPathLG529CI$default(drawScope, Path, border.m9797getColor0d7_KjU(), 0.0f, new Stroke(border.getWight(), 0.0f, 0, 0, null, 30, null), null, 0, 52, null);
        DrawScope.m5848drawPathGBMwjPU$default(drawScope, Path, brush, 0.0f, Fill.INSTANCE, null, 0, 52, null);
    }
