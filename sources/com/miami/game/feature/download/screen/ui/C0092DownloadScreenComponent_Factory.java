...
public final class C0092DownloadScreenComponent_Factory {
    ...
    private C0092DownloadScreenComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
    ...
    public static C0092DownloadScreenComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
        return new C0092DownloadScreenComponent_Factory(filesUpdaterInteractorProvider, buildConfigRepositoryProvider, localRepositoryProvider);
    }
