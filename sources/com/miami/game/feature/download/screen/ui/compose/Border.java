...
public final class Border {
    ...
    public static /* synthetic */ Border m9799copy4WTKRHQ$default(Border border, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            f = border.wight;
        }
        if ((i & 2) != 0) {
        ...
        return border.m9801copy4WTKRHQ(f, j);
    }
    ...
    public final long m9800component20d7_KjU() {
        return this.color;
    }

    /* renamed from: copy-4WTKRHQ  reason: not valid java name */
    public final Border m9801copy4WTKRHQ(float f, long j) {
    ...
    public final long m9802getColor0d7_KjU() {
        return this.color;
    }
}
