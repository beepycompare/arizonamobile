...
public final class Border {
    ...
    public static /* synthetic */ Border m8371copy4WTKRHQ$default(Border border, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            f = border.wight;
        }
        if ((i & 2) != 0) {
        ...
        return border.m8373copy4WTKRHQ(f, j);
    }
    ...
    public final long m8372component20d7_KjU() {
        return this.color;
    }

    /* renamed from: copy-4WTKRHQ  reason: not valid java name */
    public final Border m8373copy4WTKRHQ(float f, long j) {
    ...
    public final long m8374getColor0d7_KjU() {
        return this.color;
    }
}
