...
public final class Border {
    ...
    public static /* synthetic */ Border m10107copy4WTKRHQ$default(Border border, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            f = border.wight;
        }
        if ((i & 2) != 0) {
        ...
        return border.m10109copy4WTKRHQ(f, j);
    }
    ...
    public final long m10108component20d7_KjU() {
        return this.color;
    }

    /* renamed from: copy-4WTKRHQ  reason: not valid java name */
    public final Border m10109copy4WTKRHQ(float f, long j) {
    ...
    public final long m10110getColor0d7_KjU() {
        return this.color;
    }
}
