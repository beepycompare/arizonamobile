...
public final class Border {
    ...
    public static /* synthetic */ Border m10122copy4WTKRHQ$default(Border border, float f, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            f = border.wight;
        }
        if ((i & 2) != 0) {
        ...
        return border.m10124copy4WTKRHQ(f, j);
    }
    ...
    public final long m10123component20d7_KjU() {
        return this.color;
    }

    /* renamed from: copy-4WTKRHQ  reason: not valid java name */
    public final Border m10124copy4WTKRHQ(float f, long j) {
    ...
    public final long m10125getColor0d7_KjU() {
        return this.color;
    }
}
