...
public final class C0104DownloadScreenComponent_Factory {
    ...
    private C0104DownloadScreenComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
    ...
    public static C0104DownloadScreenComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
        return new C0104DownloadScreenComponent_Factory(filesUpdaterInteractorProvider, buildConfigRepositoryProvider, localRepositoryProvider);
    }
