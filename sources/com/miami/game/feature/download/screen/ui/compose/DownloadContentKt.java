...
public final class DownloadContentKt {
    ...
    public static final void DownloadContent(final DownloadScreenUiState uiState, final Function0<Unit> onSoundClick, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(DownloadContent)N(uiState,onSoundClick)45@1734L2000:DownloadContent.kt#k3v2wi");
        if ((i & 6) == 0) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 246919290, "C75@2776L952:DownloadContent.kt#k3v2wi");
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 2040836637, "C81@2995L10,80@2951L199,96@3664L40,93@3509L209:DownloadContent.kt#k3v2wi");
            int i6 = i5;
            ...
            if (!StringsKt.isBlank(uiState.getTimeRemainingString())) {
                startRestartGroup.startReplaceGroup(2041094556);
                ComposerKt.sourceInformation(startRestartGroup, "87@3275L10,86@3227L255");
                ...
                startRestartGroup.startReplaceGroup(2041353499);
                startRestartGroup.endReplaceGroup();
            }
            ...
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1873807121, "CC(remember):DownloadContent.kt#9igjgp");
