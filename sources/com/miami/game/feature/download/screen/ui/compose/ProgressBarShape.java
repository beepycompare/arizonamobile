...
public final class ProgressBarShape implements Shape {
    ...
    public Outline mo365createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Matrix.m5686scaleimpl$default(m5670constructorimpl$default, Float.intBitsToFloat((int) (j >> 32)) / 864.0f, Float.intBitsToFloat((int) (j & 4294967295L)) / 31.0f, 0.0f, 4, null);
