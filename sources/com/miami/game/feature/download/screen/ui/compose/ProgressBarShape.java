...
public final class ProgressBarShape implements Shape {
    ...
    public Outline mo344createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Matrix.m5608scaleimpl$default(m5592constructorimpl$default, Float.intBitsToFloat((int) (j >> 32)) / 864.0f, Float.intBitsToFloat((int) (j & 4294967295L)) / 31.0f, 0.0f, 4, null);
