...
public final class C0111DownloadScreenComponent_Factory {
    ...
    private C0111DownloadScreenComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
    ...
    public static C0111DownloadScreenComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
        return new C0111DownloadScreenComponent_Factory(filesUpdaterInteractorProvider, buildConfigRepositoryProvider, localRepositoryProvider);
    }
