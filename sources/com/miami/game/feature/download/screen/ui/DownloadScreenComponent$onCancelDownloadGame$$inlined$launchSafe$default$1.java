...
@DebugMetadata(c = "com.miami.game.feature.download.screen.ui.DownloadScreenComponent$onCancelDownloadGame$$inlined$launchSafe$default$1", f = "DownloadScreenComponent.kt", i = {0, 0, 0}, l = {27}, m = "invokeSuspend", n = {"$this$launch", "$completion", "$this$onCancelDownloadGame_u24lambda_u240"}, nl = {28}, s = {"L$0", "L$1", "L$2"}, v = 2)
