...
public final class C0103DownloadScreenComponent_Factory {
    ...
    private C0103DownloadScreenComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
    ...
    public static C0103DownloadScreenComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigRepositoryProvider, Provider<LocalRepository> localRepositoryProvider) {
        return new C0103DownloadScreenComponent_Factory(filesUpdaterInteractorProvider, buildConfigRepositoryProvider, localRepositoryProvider);
    }
