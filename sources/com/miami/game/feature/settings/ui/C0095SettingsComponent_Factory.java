...
public final class C0095SettingsComponent_Factory {
    ...
    private C0095SettingsComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
    ...
    public static C0095SettingsComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
        return new C0095SettingsComponent_Factory(filesUpdaterInteractorProvider, buildConfigProvider, settingsInteractorProvider);
    }
