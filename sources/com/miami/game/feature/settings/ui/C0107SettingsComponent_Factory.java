...
public final class C0107SettingsComponent_Factory {
    ...
    private C0107SettingsComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
    ...
    public static C0107SettingsComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
        return new C0107SettingsComponent_Factory(filesUpdaterInteractorProvider, buildConfigProvider, settingsInteractorProvider);
    }
