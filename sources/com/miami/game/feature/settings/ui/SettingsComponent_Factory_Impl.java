...
public final class SettingsComponent_Factory_Impl implements SettingsComponent.Factory {
    private final C0108SettingsComponent_Factory delegateFactory;

    SettingsComponent_Factory_Impl(C0108SettingsComponent_Factory delegateFactory) {
    ...
    public static Provider<SettingsComponent.Factory> create(C0108SettingsComponent_Factory delegateFactory) {
        return InstanceFactory.create(new SettingsComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<SettingsComponent.Factory> createFactoryProvider(C0108SettingsComponent_Factory delegateFactory) {
        return InstanceFactory.create(new SettingsComponent_Factory_Impl(delegateFactory));
    }
}
