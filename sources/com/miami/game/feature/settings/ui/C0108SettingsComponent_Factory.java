...
public final class C0108SettingsComponent_Factory {
    ...
    private C0108SettingsComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
    ...
    public static C0108SettingsComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
        return new C0108SettingsComponent_Factory(filesUpdaterInteractorProvider, buildConfigProvider, settingsInteractorProvider);
    }
