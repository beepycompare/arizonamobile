    ...
    */
    public static final void DebugGameTestScriptCard(final String activeScriptName, final boolean z, final List<GameTestSavedScript> importedScripts, final String str, final String screenshotPullPath, boolean z2, boolean z3, final String screenshotDeviceDir, final Function0<Unit> onImportGameTestScript, final Function0<Unit> onUseBundledGameTestScript, final Function1<? super String, Unit> onSelectImportedGameTestScript, final Function1<? super String, Unit> onUpdateScreenshotPullPath, Function0<Unit> function0, Function0<Unit> onToggleLogShareButton, final Function1<? super String, Unit> onUpdateScreenshotDeviceDir, Composer composer, final int i, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute(((i8 & 306783379) == 306783378 && (i9 & 9363) == 9362) ? false : true, i8 & 1)) {
            ...
            TextKt.m3157TextNvy7gAk("Source: ".concat(z ? "IMPORTED FILE" : "PROJECT SCRIPT"), null, Color.m5347copywmQWz5c$default(Color.Companion.m5385getWhite0d7_KjU(), 0.75f, 0.0f, 0.0f, 0.0f, 14, null), null, TypeKt.m9847dpToSp8Feqmps(Dp.m8160constructorimpl(14.0f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 131050);
            int i12 = i6;
            int i13 = i7;
            TextKt.m3157TextNvy7gAk(activeScriptName, null, Color.Companion.m5385getWhite0d7_KjU(), null, TypeKt.m9847dpToSp8Feqmps(Dp.m8160constructorimpl(16.0f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, TextOverflow.Companion.m8096getEllipsisgIe3tQ8(), false, 1, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall(), startRestartGroup, (i5 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 24960, 110570);
            str2 = screenshotPullPath;
            TextKt.m3157TextNvy7gAk("Screenshot pull dir: " + str2, null, Color.m5347copywmQWz5c$default(Color.Companion.m5385getWhite0d7_KjU(), 0.75f, 0.0f, 0.0f, 0.0f, 14, null), null, TypeKt.m9847dpToSp8Feqmps(Dp.m8160constructorimpl(14.0f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, TextOverflow.Companion.m8096getEllipsisgIe3tQ8(), false, 2, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getBodySmall(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 24960, 110570);
            str3 = screenshotDeviceDir;
            String str4 = str3;
            ...
            if (DebugGameTestScriptCard$lambda$4(mutableState11)) {
                ...
                }, startRestartGroup, 54), null, ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9820getLambda$1734159728$settings(), ComposableLambdaKt.rememberComposableLambda(1104394513, true, new Function2() { // from class: com.miami.game.feature.settings.ui.compose.DebugGameTestScriptCardKt$$ExternalSyntheticLambda25
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
            ...
            if (DebugGameTestScriptCard$lambda$7(mutableState)) {
                ...
                }, composer3, 54), null, ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9825getLambda$562951057$settings(), ComposableLambdaKt.rememberComposableLambda(-2019364112, true, new Function2() { // from class: com.miami.game.feature.settings.ui.compose.DebugGameTestScriptCardKt$$ExternalSyntheticLambda28
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
    ...
    public static final Unit DebugGameTestScriptCard$lambda$19(final MutableState mutableState, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            OutlinedTextFieldKt.OutlinedTextField(DebugGameTestScriptCard$lambda$10, (Function1<? super String, Unit>) rememberedValue, fillMaxWidth$default, false, false, (TextStyle) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9823getLambda$1963712254$settings(), (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, false, (VisualTransformation) null, (KeyboardOptions) null, (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, composer, 1573248, 12582912, 0, 8257464);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit DebugGameTestScriptCard$lambda$17(final Function1 function1, final MutableState mutableState, final MutableState mutableState2, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            ButtonKt.TextButton((Function0) rememberedValue, null, false, null, null, null, null, null, null, ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9821getLambda$1804383392$settings(), composer, 805306368, TypedValues.PositionType.TYPE_POSITION_TYPE);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit DebugGameTestScriptCard$lambda$23(final MutableState mutableState, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            OutlinedTextFieldKt.OutlinedTextField(DebugGameTestScriptCard$lambda$13, (Function1<? super String, Unit>) rememberedValue, fillMaxWidth$default, false, false, (TextStyle) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9824getLambda$335067231$settings(), (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, (Function2<? super Composer, ? super Integer, Unit>) null, false, (VisualTransformation) null, (KeyboardOptions) null, (KeyboardActions) null, true, 0, 0, (MutableInteractionSource) null, (Shape) null, (TextFieldColors) null, composer, 1573248, 12582912, 0, 8257464);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final Unit DebugGameTestScriptCard$lambda$22(final MutableState mutableState, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            ButtonKt.TextButton((Function0) rememberedValue, null, false, null, null, null, null, null, null, ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9822getLambda$1910135413$settings(), composer, 805306374, TypedValues.PositionType.TYPE_POSITION_TYPE);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit DebugGameTestScriptCard$lambda$26(final boolean z, final Function0 function0, final List list, final String str, final Function1 function1, MutableState mutableState, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            if (list.isEmpty()) {
                ...
                TextKt.m3157TextNvy7gAk("No saved imported scripts yet. Use IMPORT FILE first.", null, Color.m5347copywmQWz5c$default(Color.Companion.m5385getWhite0d7_KjU(), 0.75f, 0.0f, 0.0f, 0.0f, 14, null), null, TypeKt.m9847dpToSp8Feqmps(Dp.m8160constructorimpl(13.0f), composer, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer, 6).getBodySmall(), composer, 390, 0, 131050);
    ...
    public static final Unit DebugGameTestScriptCard$lambda$25(final MutableState mutableState, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 3) != 2, i & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            ButtonKt.TextButton((Function0) rememberedValue, null, false, null, null, null, null, null, null, ComposableSingletons$DebugGameTestScriptCardKt.INSTANCE.m9826getLambda$738926742$settings(), composer, 805306374, TypedValues.PositionType.TYPE_POSITION_TYPE);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
