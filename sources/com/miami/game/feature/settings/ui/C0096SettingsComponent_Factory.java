...
public final class C0096SettingsComponent_Factory {
    ...
    private C0096SettingsComponent_Factory(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
    ...
    public static C0096SettingsComponent_Factory create(Provider<FilesUpdaterInteractor> filesUpdaterInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<SettingsInteractor> settingsInteractorProvider) {
        return new C0096SettingsComponent_Factory(filesUpdaterInteractorProvider, buildConfigProvider, settingsInteractorProvider);
    }
