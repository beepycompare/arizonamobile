...
public final class C0093HomeComponent_Factory {
    ...
    public static C0093HomeComponent_Factory create(Provider<privacyInteractor> privacyInteractorProvider, Provider<NewsInteractor> newsInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<NetworkDataSource> apiProvider, Provider<PlayCountryResolver> playCountryResolverProvider, Provider<ServersInteractor> serversInteractorProvider, Provider<SettingsInteractor> settingsInteractorProvider, Provider<NotificationStateHolder> notificationStateHolderProvider) {
        return new C0093HomeComponent_Factory(privacyInteractorProvider, newsInteractorProvider, buildConfigProvider, apiProvider, playCountryResolverProvider, serversInteractorProvider, settingsInteractorProvider, notificationStateHolderProvider);
    }
