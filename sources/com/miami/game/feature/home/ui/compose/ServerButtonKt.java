    ...
    public static final Unit ServerButton$lambda$0(HomeUiState homeUiState, BoxScope ScalingButton, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            if (homeUiState.getCurrentServer() != null) {
                ...
                Modifier m869width3ABfNKs = SizeKt.m869width3ABfNKs(Modifier.Companion, Dp.m7555constructorimpl(70.0f));
                ...
                ComposerKt.sourceInformationMarkerEnd(composer);
                ComposerKt.sourceInformationMarkerEnd(composer);
                Modifier m778offsetVpY3zN4$default = OffsetKt.m778offsetVpY3zN4$default(SizeKt.fillMaxHeight$default(PaddingKt.m820paddingVpY3zN4$default(Modifier.Companion, Dp.m7555constructorimpl(8.0f), 0.0f, 2, null), 0.0f, 1, null), 0.0f, Dp.m7555constructorimpl(-Dp.m7555constructorimpl(1.0f)), 1, null);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.server_button_arrow, composer2, 0), (String) null, OffsetKt.m778offsetVpY3zN4$default(SizeKt.m864size3ABfNKs(Modifier.Companion, Dp.m7555constructorimpl(8.0f)), Dp.m7555constructorimpl(-Dp.m7555constructorimpl(10.0f)), 0.0f, 2, null), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, composer, Painter.$stable | 432, 120);
            ComposerKt.sourceInformationMarkerEnd(composer);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer);
