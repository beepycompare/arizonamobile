    ...
    public static final Unit ServerButton$lambda$0(HomeUiState homeUiState, BoxScope ScalingButton, Composer composer, int i) {
        ...
        if (!composer.shouldExecute((i & 17) != 16, i & 1)) {
            ...
            if (homeUiState.getCurrentServer() != null) {
                ...
                float f2 = 16;
                AnimatedLoadingKt.m10064AnimatedLoadinguFdPcIQ(true, Dp.m8258constructorimpl(f2), null, composer, 54, 4);
                SingletonAsyncImageKt.m9410AsyncImage10Xjiaw(homeUiState.getCurrentServer().getIcon(), null, SizeKt.m976size3ABfNKs(Modifier.Companion, Dp.m8258constructorimpl(f)), null, null, null, contentScale, 0.0f, null, 0, false, composer, 432, 0, 1976);
                ComposerKt.sourceInformationMarkerEnd(composer);
                ComposerKt.sourceInformationMarkerEnd(composer);
                composer.endNode();
                ComposerKt.sourceInformationMarkerEnd(composer);
