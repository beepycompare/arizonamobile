...
public final class MenuContentKt {
    ...
    public static final void MenuContent(final HomeUiState uiState, final State<Integer> notificationState, final Function0<Unit> onClickAccount, final Function0<Unit> onClickForum, final Function0<Unit> onClickSettings, final Function0<Unit> onClickNotificaions, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((74897 & i3) != 74896, i3 & 1)) {
            ...
            ScalingButtonKt.ScalingButton(onClickAccount, null, ComposableSingletons$MenuContentKt.INSTANCE.m8384getLambda$432014182$home_release_web(), startRestartGroup, ((i3 >> 6) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            ScalingButtonKt.ScalingButton(onClickForum, null, ComposableSingletons$MenuContentKt.INSTANCE.m8385getLambda$989998245$home_release_web(), startRestartGroup, ((i3 >> 9) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
