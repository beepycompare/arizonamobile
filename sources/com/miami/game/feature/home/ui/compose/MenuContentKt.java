...
public final class MenuContentKt {
    ...
    public static final void MenuContent(final HomeUiState uiState, final State<Integer> notificationState, final Function0<Unit> onClickAccount, final Function0<Unit> onClickForum, final Function0<Unit> onClickSettings, final Function0<Unit> onClickNotificaions, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(MenuContent)N(uiState,notificationState,onClickAccount,onClickForum,onClickSettings,onClickNotificaions)25@879L823:MenuContent.kt#dswm0d");
        if ((i & 48) == 0) {
        ...
        if (!startRestartGroup.shouldExecute((74897 & i3) != 74896, i3 & 1)) {
            ...
            Modifier m1054paddingqDBjuR0$default = PaddingKt.m1054paddingqDBjuR0$default(Modifier.Companion, 0.0f, 0.0f, Dp.m8160constructorimpl(24.0f), 0.0f, 11, null);
            ...
            Modifier m1052paddingVpY3zN4$default = PaddingKt.m1052paddingVpY3zN4$default(Modifier.Companion, 0.0f, 0.0f, 3, null);
            Alignment.Vertical centerVertically2 = Alignment.Companion.getCenterVertically();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 844473419, "CC(Row)N(modifier,horizontalArrangement,verticalAlignment,content)99@5125L58,100@5188L131:Row.kt#2w3rfo");
            MeasurePolicy rowMeasurePolicy2 = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m742spacedBy0680j_4(Dp.m8160constructorimpl(-Dp.m8160constructorimpl(24.0f))), centerVertically2, startRestartGroup, 54);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1159599143, "CC(Layout)N(content,modifier,measurePolicy)81@3355L27,84@3521L415:Layout.kt#80mrfh");
            ...
            ScalingButtonKt.ScalingButton(onClickAccount, null, ComposableSingletons$MenuContentKt.INSTANCE.m9805getLambda$432014182$home(), startRestartGroup, ((i3 >> 6) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            ScalingButtonKt.ScalingButton(onClickForum, null, ComposableSingletons$MenuContentKt.INSTANCE.m9806getLambda$989998245$home(), startRestartGroup, ((i3 >> 9) & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 2);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ScalingButtonKt.ScalingButton(onClickSettings, OffsetKt.m1010offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8160constructorimpl(-Dp.m8160constructorimpl(0.0f)), 1, null), ComposableSingletons$MenuContentKt.INSTANCE.getLambda$1483995263$home(), startRestartGroup, ((i3 >> 12) & 14) | 432, 0);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.feature.home.ui.compose.MenuContentKt$$ExternalSyntheticLambda1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return MenuContentKt.MenuContent$lambda$1(HomeUiState.this, notificationState, onClickAccount, onClickForum, onClickSettings, onClickNotificaions, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
