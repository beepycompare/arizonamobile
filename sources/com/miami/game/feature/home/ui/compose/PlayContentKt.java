...
public final class PlayContentKt {
    ...
    public static final void PlayContent(final HomeUiState uiState, final Function0<Unit> onClickGame, final Function0<Unit> onClickServer, final Function0<Unit> onLongClickGame, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 1171) != 1170, i2 & 1)) {
            ...
            AnimatedLoadingKt.m9790AnimatedLoadinguFdPcIQ(isCheckingFiles, 0.0f, null, startRestartGroup, 0, 6);
            ...
            if (isCheckingFiles) {
                ...
                TextKt.m3157TextNvy7gAk((String) mutableState.getValue(), SizeKt.m1103height3ABfNKs(OffsetKt.m1010offsetVpY3zN4$default(columnScopeInstance.align(Modifier.Companion, Alignment.Companion.getStart()), Dp.m8160constructorimpl(62.0f), 0.0f, 2, null), Dp.m8160constructorimpl(24.0f)), ColorKt.Color(4294046193L), null, TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(13.0f), startRestartGroup, 6), null, null, null, 0L, null, null, TypeKt.m9864dpToSp8Feqmps(Dp.m8160constructorimpl(13.0f), startRestartGroup, 6), 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getHeadlineSmall(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 129000);
