...
public final class PlayContentKt {
    ...
    public static final void PlayContent(final HomeUiState uiState, final Function0<Unit> onClickGame, final Function0<Unit> onClickServer, final Function0<Unit> onLongClickGame, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 1171) != 1170, i2 & 1)) {
            ...
            AnimatedLoadingKt.m9081AnimatedLoadinguFdPcIQ(isCheckingFiles, 0.0f, null, startRestartGroup, 0, 6);
            ...
            if (isCheckingFiles) {
                ...
                float f = 13;
                TextKt.m2712TextNvy7gAk((String) mutableState.getValue(), SizeKt.m850height3ABfNKs(OffsetKt.m778offsetVpY3zN4$default(columnScopeInstance.align(Modifier.Companion, Alignment.Companion.getStart()), Dp.m7555constructorimpl(62), 0.0f, 2, null), Dp.m7555constructorimpl(24)), ColorKt.Color(4294046193L), null, TypeKt.m9134dpToSp8Feqmps(Dp.m7555constructorimpl(f), startRestartGroup, 6), null, null, null, 0L, null, null, TypeKt.m9134dpToSp8Feqmps(Dp.m7555constructorimpl(f), startRestartGroup, 6), 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getHeadlineSmall(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 129000);
