...
public final class NewsItemKt {
    ...
    public static final void NewsItem(final NewsModel newsModel, final Function1<? super String, Unit> onClickNews, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            AnimatedLoadingKt.m10048AnimatedLoadinguFdPcIQ(true, Dp.m8258constructorimpl(30), null, startRestartGroup, 54, 4);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            SingletonAsyncImageKt.m9395AsyncImage10Xjiaw(newsModel.getImageUrl(), null, null, null, null, null, ContentScale.Companion.getCrop(), 0.0f, null, 0, false, startRestartGroup, 1572912, 0, 1980);
            ...
            float f2 = 16;
            float f3 = 2;
            TextKt.m3255TextNvy7gAk(String.valueOf(newsModel.getTitle()), OffsetKt.m885offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8258constructorimpl(-Dp.m8258constructorimpl(f3)), 1, null), Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10168dpToSp8Feqmps(Dp.m8258constructorimpl(f2), startRestartGroup, 6), null, FontWeight.Companion.getBold(), null, TextUnitKt.getSp(-0.0d), null, null, TypeKt.m10168dpToSp8Feqmps(Dp.m8258constructorimpl(f2), startRestartGroup, 6), 0, false, 1, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getDisplaySmall(), startRestartGroup, 1573296, 24576, 112296);
            float f4 = 12;
            TextKt.m3255TextNvy7gAk(String.valueOf(newsModel.getDate()), OffsetKt.m885offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8258constructorimpl(-Dp.m8258constructorimpl(f3)), 1, null), Color.Companion.m5454getGray0d7_KjU(), null, TypeKt.m10168dpToSp8Feqmps(Dp.m8258constructorimpl(f4), startRestartGroup, 6), null, null, null, 0L, null, null, TypeKt.m10168dpToSp8Feqmps(Dp.m8258constructorimpl(f4), startRestartGroup, 6), 0, false, 1, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getLabelSmall(), startRestartGroup, 432, 24576, 112616);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
