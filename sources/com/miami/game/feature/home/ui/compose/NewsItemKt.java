...
public final class NewsItemKt {
    ...
    public static final void NewsItem(final NewsModel newsModel, final Function1<? super String, Unit> onClickNews, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            TextKt.m3157TextNvy7gAk(String.valueOf(newsModel.getTitle()), OffsetKt.m1010offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8160constructorimpl(-Dp.m8160constructorimpl(2.0f)), 1, null), Color.Companion.m5385getWhite0d7_KjU(), null, TypeKt.m9868dpToSp8Feqmps(Dp.m8160constructorimpl(16.0f), startRestartGroup, 6), null, FontWeight.Companion.getBold(), null, TextUnitKt.getSp(-0.0d), null, null, TypeKt.m9868dpToSp8Feqmps(Dp.m8160constructorimpl(16.0f), startRestartGroup, 6), 0, false, 1, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getDisplaySmall(), startRestartGroup, 1573296, 24576, 112296);
            TextKt.m3157TextNvy7gAk(String.valueOf(newsModel.getDate()), OffsetKt.m1010offsetVpY3zN4$default(Modifier.Companion, 0.0f, Dp.m8160constructorimpl(-Dp.m8160constructorimpl(2.0f)), 1, null), Color.Companion.m5378getGray0d7_KjU(), null, TypeKt.m9868dpToSp8Feqmps(Dp.m8160constructorimpl(12.0f), startRestartGroup, 6), null, null, null, 0L, null, null, TypeKt.m9868dpToSp8Feqmps(Dp.m8160constructorimpl(12.0f), startRestartGroup, 6), 0, false, 1, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelSmall(), startRestartGroup, 432, 24576, 112616);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
