    ...
    public static final void OnlineContent(final HomeUiState uiState, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (uiState.getQueue() <= 0) {
                ...
                float f = 11;
                i3 = 0;
                TextKt.m3255TextNvy7gAk("Очередь", null, Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10184dpToSp8Feqmps(Dp.m8258constructorimpl(f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodySmall(), startRestartGroup, 390, 0, 131050);
                ...
                TextKt.m3255TextNvy7gAk(String.valueOf(uiState.getQueue()), null, Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10184dpToSp8Feqmps(Dp.m8258constructorimpl(f), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodySmall(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 131050);
                startRestartGroup = startRestartGroup;
            }
            startRestartGroup.endReplaceGroup();
            float f2 = 11;
            composer2 = startRestartGroup;
            TextKt.m3255TextNvy7gAk("Онлайн", null, Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10184dpToSp8Feqmps(Dp.m8258constructorimpl(f2), startRestartGroup, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(startRestartGroup, MaterialTheme.$stable).getBodySmall(), composer2, 390, 0, 131050);
            ...
            TextKt.m3255TextNvy7gAk(String.valueOf(uiState.getOnline()), null, Color.Companion.m5461getWhite0d7_KjU(), null, TypeKt.m10184dpToSp8Feqmps(Dp.m8258constructorimpl(f2), composer2, 6), null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, MaterialTheme.INSTANCE.getTypography(composer2, MaterialTheme.$stable).getBodySmall(), composer2, RendererCapabilities.DECODER_SUPPORT_MASK, 0, 131050);
