...
public final class C0091HomeComponent_Factory {
    ...
    public static C0091HomeComponent_Factory create(Provider<privacyInteractor> privacyInteractorProvider, Provider<NewsInteractor> newsInteractorProvider, Provider<BuildConfigRepository> buildConfigProvider, Provider<NetworkDataSource> apiProvider, Provider<ServersInteractor> serversInteractorProvider, Provider<SettingsInteractor> settingsInteractorProvider, Provider<NotificationStateHolder> notificationStateHolderProvider) {
        return new C0091HomeComponent_Factory(privacyInteractorProvider, newsInteractorProvider, buildConfigProvider, apiProvider, serversInteractorProvider, settingsInteractorProvider, notificationStateHolderProvider);
    }
