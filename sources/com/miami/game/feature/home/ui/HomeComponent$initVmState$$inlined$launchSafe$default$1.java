...
@DebugMetadata(c = "com.miami.game.feature.home.ui.HomeComponent$initVmState$$inlined$launchSafe$default$1", f = "HomeComponent.kt", i = {0, 0, 0, 0, 0, 0, 0, 0, 0}, l = {31}, m = "invokeSuspend", n = {"$this$launch", "$completion", "$this$initVmState_u24lambda_u240", "$this$update$iv", "prevValue$iv", "it", "$i$a$-launchSafe$default-HomeComponent$initVmState$2", "$i$f$update", "$i$a$-update-HomeComponent$initVmState$2$1"}, s = {"L$0", "L$1", "L$2", "L$3", "L$4", "L$5", "I$0", "I$1", "I$2"}, v = 1)
