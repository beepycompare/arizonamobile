...
@DebugMetadata(c = "com.miami.game.feature.home.ui.HomeComponent", f = "HomeComponent.kt", i = {0, 1, 1, 1}, l = {328, 334}, m = "isShopAllowedForDetectedRegion", n = {"context", "context", "playCountryCode", RemoteConfigConstants.RequestFieldKey.COUNTRY_CODE}, nl = {329, 336}, s = {"L$0", "L$0", "L$1", "L$2"}, v = 2)
