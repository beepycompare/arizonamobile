...
public final class HomeComponent_Factory_Impl implements HomeComponent.Factory {
    private final C0104HomeComponent_Factory delegateFactory;

    HomeComponent_Factory_Impl(C0104HomeComponent_Factory delegateFactory) {
    ...
    public static Provider<HomeComponent.Factory> create(C0104HomeComponent_Factory delegateFactory) {
        return InstanceFactory.create(new HomeComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<HomeComponent.Factory> createFactoryProvider(C0104HomeComponent_Factory delegateFactory) {
        return InstanceFactory.create(new HomeComponent_Factory_Impl(delegateFactory));
    }
}
