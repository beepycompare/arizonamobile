...
public final class DeviceCountryResolver {
    ...
    public final String detectCountryIso(Context context) {
        ...
        try {
            ...
            m9919constructorimpl = Result.m9919constructorimpl(telephonyManager != null ? telephonyManager.getNetworkCountryIso() : null);
        } catch (Throwable th) {
        ...
        try {
            ...
            m9919constructorimpl2 = Result.m9919constructorimpl(telephonyManager != null ? telephonyManager.getSimCountryIso() : null);
        } catch (Throwable th2) {
        ...
        if (Result.m9925isFailureimpl(m9919constructorimpl2)) {
            m9919constructorimpl2 = null;
        }
        String str2 = (String) m9919constructorimpl2;
