...
public final class NotificationsScreentKt$NotificationsScreent$lambda$1$0$2$0$$inlined$items$default$3 implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    public /* bridge */ /* synthetic */ GridItemSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return GridItemSpan.m1191boximpl(m9833invoke_orMbw(lazyGridItemSpanScope, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw  reason: not valid java name */
    public final long m9833invoke_orMbw(LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
