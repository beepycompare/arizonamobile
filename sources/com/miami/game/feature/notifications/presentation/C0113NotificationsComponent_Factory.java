...
public final class C0113NotificationsComponent_Factory {
    ...
    private C0113NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0113NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0113NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
