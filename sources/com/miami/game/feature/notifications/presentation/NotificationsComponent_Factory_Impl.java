...
public final class NotificationsComponent_Factory_Impl implements NotificationsComponent.Factory {
    private final C0113NotificationsComponent_Factory delegateFactory;

    NotificationsComponent_Factory_Impl(C0113NotificationsComponent_Factory delegateFactory) {
    ...
    public static Provider<NotificationsComponent.Factory> create(C0113NotificationsComponent_Factory delegateFactory) {
        return InstanceFactory.create(new NotificationsComponent_Factory_Impl(delegateFactory));
    }

    public static dagger.internal.Provider<NotificationsComponent.Factory> createFactoryProvider(C0113NotificationsComponent_Factory delegateFactory) {
        return InstanceFactory.create(new NotificationsComponent_Factory_Impl(delegateFactory));
    }
}
