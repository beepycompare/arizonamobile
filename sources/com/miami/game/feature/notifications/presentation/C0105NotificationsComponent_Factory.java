...
public final class C0105NotificationsComponent_Factory {
    ...
    private C0105NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0105NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0105NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
