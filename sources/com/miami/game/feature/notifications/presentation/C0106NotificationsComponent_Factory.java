...
public final class C0106NotificationsComponent_Factory {
    ...
    private C0106NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0106NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0106NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
