...
public final class C0093NotificationsComponent_Factory {
    ...
    private C0093NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0093NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0093NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
