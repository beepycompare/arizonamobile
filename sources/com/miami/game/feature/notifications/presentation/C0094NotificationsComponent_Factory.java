...
public final class C0094NotificationsComponent_Factory {
    ...
    private C0094NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0094NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0094NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
