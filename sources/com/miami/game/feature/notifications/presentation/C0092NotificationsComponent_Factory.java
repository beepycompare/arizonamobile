...
public final class C0092NotificationsComponent_Factory {
    ...
    private C0092NotificationsComponent_Factory(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
    ...
    public static C0092NotificationsComponent_Factory create(Provider<BuildConfigRepository> buildConfigProvider, Provider<NotificationStateHolder> holderProvider) {
        return new C0092NotificationsComponent_Factory(buildConfigProvider, holderProvider);
    }
