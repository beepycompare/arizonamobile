...
public final class NotificationsScreentKt {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            if (((List) observeAsState.getValue()).isEmpty()) {
                ...
                if (((Number) observeAsState2.getValue()).intValue() == 0) {
                    ...
                    TextKt.m3157TextNvy7gAk("НЕТ УВЕДОМЛЕНИЙ", null, m5347copywmQWz5c$default, null, m9864dpToSp8Feqmps, null, null, null, TextUnitKt.pack(TextUnit.m8352getRawTypeimpl(m9864dpToSp8Feqmps3), -TextUnit.m8354getValueimpl(m9864dpToSp8Feqmps3)), null, null, m9864dpToSp8Feqmps2, 0, false, 0, 0, null, bodyMedium, startRestartGroup, 390, 0, 128746);
                    ...
                    AnimatedLoadingKt.m9790AnimatedLoadinguFdPcIQ(true, 0.0f, null, startRestartGroup, 6, 6);
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    startRestartGroup.endNode();
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    public static final void ServerTopBar(final Function0<Unit> onBack, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableSingletons$NotificationsScreentKt.INSTANCE.m9830getLambda$556808038$notifications(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
