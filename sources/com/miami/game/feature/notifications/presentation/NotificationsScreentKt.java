...
public final class NotificationsScreentKt {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            if (((List) observeAsState.getValue()).isEmpty()) {
                ...
                if (((Number) observeAsState2.getValue()).intValue() == 0) {
                    ...
                    float f = 32;
                    long m10169dpToSp8Feqmps = TypeKt.m10169dpToSp8Feqmps(Dp.m8258constructorimpl(f), composer2, 6);
                    long m10169dpToSp8Feqmps2 = TypeKt.m10169dpToSp8Feqmps(Dp.m8258constructorimpl(f), composer2, 6);
                    long m10169dpToSp8Feqmps3 = TypeKt.m10169dpToSp8Feqmps(Dp.m8258constructorimpl(1), composer2, 6);
                    TextUnitKt.m8465checkArithmeticR2X_6o(m10169dpToSp8Feqmps3);
                    TextKt.m3255TextNvy7gAk("НЕТ УВЕДОМЛЕНИЙ", null, m5423copywmQWz5c$default, null, m10169dpToSp8Feqmps, null, null, null, TextUnitKt.pack(TextUnit.m8450getRawTypeimpl(m10169dpToSp8Feqmps3), -TextUnit.m8452getValueimpl(m10169dpToSp8Feqmps3)), null, null, m10169dpToSp8Feqmps2, 0, false, 0, 0, null, bodyMedium, composer2, 390, 0, 128746);
                    composer2 = composer2;
                    ...
                    AnimatedLoadingKt.m10049AnimatedLoadinguFdPcIQ(true, 0.0f, null, composer2, 6, 6);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    composer2.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final void ServerTopBar(final Function0<Unit> onBack, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ScalingButtonKt.ScalingButton((Function0) rememberedValue, null, ComposableSingletons$NotificationsScreentKt.INSTANCE.m10134getLambda$556808038$notifications_release(), startRestartGroup, RendererCapabilities.DECODER_SUPPORT_MASK, 2);
