...
public final class RoundedParallelogramLeftShape implements Shape {
    ...
    public Outline mo320createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        long m4519constructorimpl2 = Offset.m4519constructorimpl((Float.floatToRawIntBits(intBitsToFloat - f) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
        long m4519constructorimpl3 = Offset.m4519constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L));
        long m4519constructorimpl4 = Offset.m4519constructorimpl((Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    ...
    public /* synthetic */ RoundedParallelogramLeftShape(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7555constructorimpl(8) : f, (i & 2) != 0 ? 0.45f : f2, null);
    }
}
