...
public final class DialogButtonShape implements Shape {
    ...
    public Outline mo320createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Matrix.m5032scaleimpl$default(m5016constructorimpl$default, Float.intBitsToFloat((int) (j >> 32)) / 520.0f, Float.intBitsToFloat((int) (j & 4294967295L)) / 141.0f, 0.0f, 4, null);
