...
public final class DialogButtonShape implements Shape {
    ...
    public Outline mo331createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Matrix.m5537scaleimpl$default(m5521constructorimpl$default, Float.intBitsToFloat((int) (j >> 32)) / 520.0f, Float.intBitsToFloat((int) (j & 4294967295L)) / 141.0f, 0.0f, 4, null);
