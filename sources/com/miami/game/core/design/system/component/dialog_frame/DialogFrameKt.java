...
public final class DialogFrameKt {
    ...
    public static final void DialogFrame(Integer num, final Function0<Unit> onDismiss, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute((i6 & 131) != 130, i6 & 1)) {
            ...
            Modifier m268backgroundbw27NRU$default = BackgroundKt.m268backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.m5279copywmQWz5c$default(Color.Companion.m5306getBlack0d7_KjU(), 0.5f, 0.0f, 0.0f, 0.0f, 14, null), null, 2, null);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier m305clickableO2vRcR0$default = ClickableKt.m305clickableO2vRcR0$default(m268backgroundbw27NRU$default, mutableInteractionSource, null, false, null, null, (Function0) rememberedValue2, 28, null);
            ...
            Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, m305clickableO2vRcR0$default);
            ...
            Integer num4 = num3;
            Modifier clip = ClipKt.clip(BorderKt.m282borderziNgDLE(SizeKt.m900width3ABfNKs(SizeKt.m881height3ABfNKs(Modifier.Companion, Dp.m7996constructorimpl(300)), Dp.m7996constructorimpl(600)), Dp.m7996constructorimpl(2), Brush.Companion.m5236verticalGradient8A3gB4$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m5270boximpl(Color.m5279copywmQWz5c$default(Color.Companion.m5312getLightGray0d7_KjU(), 0.8f, 0.0f, 0.0f, 0.0f, 14, null)), Color.m5270boximpl(Color.Companion.m5315getTransparent0d7_KjU())}), 0.0f, 0.0f, 0, 14, (Object) null), new RoundedParallelogramShape(0.0f, 0.0f, 3, null)), new RoundedParallelogramShape(0.0f, 0.0f, 3, null));
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1042775818, "CC(Box)N(modifier,contentAlignment,propagateMinConstraints,content)71@3424L131:Box.kt#2w3rfo");
            ...
            if (num4 != null) {
                ...
                obj2 = null;
                IconKt.m2462Iconww6aTOc(PainterResources_androidKt.painterResource(num4.intValue(), startRestartGroup, i6 & 14), (String) null, boxScopeInstance2.align(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, null), Alignment.Companion.getCenterEnd()), Color.m5279copywmQWz5c$default(Color.Companion.m5317getWhite0d7_KjU(), 0.7f, 0.0f, 0.0f, 0.0f, 14, null), startRestartGroup, 3120, 0);
            } else {
                i4 = 1;
                str = "CC(ReusableComposeNode)N(factory,update,content)399@15590L9:Composables.kt#9igjgp";
                obj2 = null;
            ...
            colorArr[0] = Color.m5270boximpl(ColorKt.Color(4279508784L));
            colorArr[i4] = Color.m5270boximpl(ColorKt.Color(3489660928L));
            Modifier background$default = BackgroundKt.background$default(fillMaxSize$default, Brush.Companion.m5230linearGradientmHitzGk$default(companion, CollectionsKt.listOf((Object[]) colorArr), 0L, 0L, 0, 14, (Object) null), null, 0.0f, 6, null);
            ...
            float f2 = 10;
            Modifier verticalScroll$default = ScrollKt.verticalScroll$default(PaddingKt.m843padding3ABfNKs(Modifier.Companion, Dp.m7996constructorimpl(f2)), ScrollKt.rememberScrollState(0, startRestartGroup, 0, i4), false, null, false, 14, null);
            Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1341605231, "CC(Column)N(modifier,verticalArrangement,horizontalAlignment,content)87@4443L61,88@4509L134:Column.kt#2w3rfo");
            MeasurePolicy columnMeasurePolicy = ColumnKt.columnMeasurePolicy(Arrangement.INSTANCE.m702spacedBy0680j_4(Dp.m7996constructorimpl(f2)), centerHorizontally, startRestartGroup, 54);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1159599143, str4);
