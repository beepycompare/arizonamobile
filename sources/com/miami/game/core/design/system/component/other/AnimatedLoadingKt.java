...
import com.miami.game.core.design.system.R;
...
public final class AnimatedLoadingKt {
    ...
    public static final Unit AnimatedLoading_uFdPcIQ$lambda$1(boolean z, float f, Modifier modifier, int i, int i2, Composer composer, int i3) {
        m9773AnimatedLoadinguFdPcIQ(z, f, modifier, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    */
    public static final void m9773AnimatedLoadinguFdPcIQ(final boolean z, float f, Modifier modifier, Composer composer, final int i, final int i2) {
        int i3;
        float f2;
        int i4;
        Object obj;
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(AnimatedLoading)N(isChecking,width:c#ui.unit.Dp,modifier):AnimatedLoading.kt#8aq8qr");
        if ((i & 6) == 0) {
        ...
        if (i5 != 0) {
            ...
            if (i4 == 0) {
                ...
                if (!startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
                    ...
                    float m8160constructorimpl = i5 != 0 ? Dp.m8160constructorimpl(60.0f) : f2;
                    ...
                    if (z) {
                        ...
                        modifier3 = companion;
                        ImageKt.Image(PainterResources_androidKt.painterResource(R.drawable.loading_animated_icon, startRestartGroup, 0), (String) null, RotateKt.rotate(SizeKt.m1122width3ABfNKs(companion, m8160constructorimpl), AnimatedLoading_uFdPcIQ$lambda$0(InfiniteTransitionKt.animateFloat(InfiniteTransitionKt.rememberInfiniteTransition(null, startRestartGroup, 0, 1), 0.0f, 360.0f, AnimationSpecKt.m196infiniteRepeatable9IiC70o$default(AnimationSpecKt.tween$default(1000, 0, EasingKt.getLinearEasing(), 2, null), RepeatMode.Restart, 0L, 4, null), null, startRestartGroup, InfiniteTransition.$stable | 432 | (InfiniteRepeatableSpec.$stable << 9), 8))), (Alignment) null, (ContentScale) null, 0.0f, (ColorFilter) null, startRestartGroup, Painter.$stable | 48, 120);
                        ...
                        SpacerKt.Spacer(SizeKt.m1122width3ABfNKs(Modifier.Companion, Dp.m8160constructorimpl(60.0f)), startRestartGroup, 6);
                        startRestartGroup.endReplaceGroup();
                    }
                    if (ComposerKt.isTraceInProgress()) {
                ...
                if (endRestartGroup != null) {
                    endRestartGroup.updateScope(new Function2() { // from class: com.miami.game.core.design.system.component.other.AnimatedLoadingKt$$ExternalSyntheticLambda0
                        ...
                        public final Object invoke(Object obj2, Object obj3) {
                            return AnimatedLoadingKt.AnimatedLoading_uFdPcIQ$lambda$1(z, f3, modifier2, i, i2, (Composer) obj2, ((Integer) obj3).intValue());
                        }
                    });
                    return;
                }
