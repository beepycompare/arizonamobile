...
public final class ScalingButtonKt {
    ...
    */
    public static final void ScalingButton(final Function0<Unit> onClick, Modifier modifier, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        ScalingButtonKt$ScalingButton$1$1 rememberedValue2;
        boolean z;
        ...
        if (i4 != 0) {
            ...
            if ((i3 & 147) == 146 || !startRestartGroup.getSkipping()) {
                ...
                ComposerKt.sourceInformation(startRestartGroup, "CC(remember):ScalingButton.kt#9igjgp");
                ...
                Modifier scale = ScaleKt.scale(companion, ScalingButton$lambda$3(AnimateAsStateKt.animateFloatAsState(!ScalingButton$lambda$1(mutableState) ? 0.9f : 1.0f, null, 0.0f, "", null, startRestartGroup, 3072, 22)));
        ...
        startRestartGroup.endReplaceGroup();
        Modifier scale2 = ScaleKt.scale(companion, ScalingButton$lambda$3(AnimateAsStateKt.animateFloatAsState(!ScalingButton$lambda$1(mutableState2) ? 0.9f : 1.0f, null, 0.0f, "", null, startRestartGroup, 3072, 22)));
        ...
        startRestartGroup.endReplaceGroup();
        Modifier pointerInput2 = SuspendingPointerInputFilterKt.pointerInput(scale2, unit2, (PointerInputEventHandler) rememberedValue2);
        ...
        startRestartGroup.updateRememberedValue(rememberedValue3);
        startRestartGroup.endReplaceGroup();
        Modifier clickWithDelay$default2 = ComposeExtensionsKt.clickWithDelay$default(pointerInput2, false, 0L, clickIndicationType2, (Function0) rememberedValue3, 3, null);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
    ...
    */
    public static final void ScalingButtonLong(final Function0<Unit> onClick, final Function0<Unit> onLongClick, Modifier modifier, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        Object rememberedValue;
        boolean z;
        ScalingButtonKt$ScalingButtonLong$1$1 rememberedValue2;
        int currentCompositeKeyHash;
        Composer m3520constructorimpl;
        final Modifier modifier2;
        ScopeUpdateScope endRestartGroup;
        ...
        Modifier scale2 = ScaleKt.scale(modifier32, ScalingButtonLong$lambda$12(AnimateAsStateKt.animateFloatAsState(!ScalingButtonLong$lambda$10(mutableState2) ? 0.9f : 1.0f, null, 0.0f, "", null, startRestartGroup, 3072, 22)));
        Unit unit2 = Unit.INSTANCE;
        startRestartGroup.startReplaceGroup(-1746271574);
        ComposerKt.sourceInformation(startRestartGroup, "CC(remember):ScalingButton.kt#9igjgp");
        z = ((i3 & 112) != 32) | ((i3 & 14) == 4);
        ...
        rememberedValue2 = new ScalingButtonKt$ScalingButtonLong$1$1(onLongClick, mutableState2, onClick);
        startRestartGroup.updateRememberedValue(rememberedValue2);
        startRestartGroup.endReplaceGroup();
        Modifier pointerInput2 = SuspendingPointerInputFilterKt.pointerInput(scale2, unit2, (PointerInputEventHandler) rememberedValue2);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
