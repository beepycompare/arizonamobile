...
public final class ScrollBarKt {
    ...
    public static final Modifier m8909verticalColumnScrollbarosbwsH8(Modifier verticalColumnScrollbar, final ScrollState scrollState, float f, boolean z, float f2, float f3, Composer composer, int i, int i2) {
        ...
        final float m7251constructorimpl = (i2 & 2) != 0 ? Dp.m7251constructorimpl(4) : f;
        boolean z2 = true;
    ...
    public static final Unit verticalColumnScrollbar_osbwsH8$lambda$1$lambda$0(ScrollState scrollState, boolean z, float f, float f2, float f3, ContentDrawScope drawWithContent) {
        ...
        if (z) {
            c = 1;
            j = 4294967295L;
            DrawScope.m5111drawRoundRectZuiqVtQ$default(drawWithContent, Brush.Companion.m4487linearGradientmHitzGk$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m4527boximpl(ColorKt.Color(2570671230L)), Color.m4527boximpl(Color.Companion.m4572getTransparent0d7_KjU())}), 0L, 0L, 0, 14, (Object) null), Offset.m4285constructorimpl((Float.floatToRawIntBits(0.0f) & 4294967295L) | (Float.floatToRawIntBits(Float.intBitsToFloat((int) (drawWithContent.mo5116getSizeNHjbRc() >> 32)) - f2) << 32)), Size.m4353constructorimpl((Float.floatToRawIntBits(drawWithContent.mo419toPx0680j_4(f3)) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & 4294967295L)), CornerRadius.m4247constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)), 0.0f, null, null, 0, 240, null);
        } else {
            c = 1;
            j = 4294967295L;
        }
        long m4247constructorimpl = CornerRadius.m4247constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & j));
        Brush.Companion companion = Brush.Companion;
        Color[] colorArr = new Color[2];
        colorArr[0] = Color.m4527boximpl(ColorKt.Color(4293206357L));
        colorArr[c] = Color.m4527boximpl(ColorKt.Color(4294474909L));
        DrawScope.m5111drawRoundRectZuiqVtQ$default(drawWithContent, Brush.Companion.m4487linearGradientmHitzGk$default(companion, CollectionsKt.listOf((Object[]) colorArr), 0L, 0L, 0, 14, (Object) null), Offset.m4285constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (drawWithContent.mo5116getSizeNHjbRc() >> 32)) - f2) << 32) | (Float.floatToRawIntBits(value) & j)), Size.m4353constructorimpl((Float.floatToRawIntBits(drawWithContent.mo419toPx0680j_4(f3)) << 32) | (Float.floatToRawIntBits(f4) & j)), m4247constructorimpl, 0.0f, null, null, 0, 240, null);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit fadingTopBottomEdgesSimplified$lambda$2(ScrollState scrollState, float f, float f2, ContentDrawScope drawWithContent) {
        ...
        if (f > 0.0f) {
            DrawScope.m5109drawRectAsUm42w$default(drawWithContent, Brush.Companion.m4494verticalGradient8A3gB4$default(Brush.Companion, new Pair[]{TuplesKt.to(Float.valueOf(0.0f), Color.m4527boximpl(Color.Companion.m4572getTransparent0d7_KjU())), TuplesKt.to(Float.valueOf(f), Color.m4527boximpl(Color.Companion.m4563getBlack0d7_KjU()))}, 0.0f, 0.0f, 0, 14, (Object) null), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m4459getDstIn0nO6VwU(), 62, null);
        }
        if (f2 > 0.0f) {
            DrawScope.m5109drawRectAsUm42w$default(drawWithContent, Brush.Companion.m4494verticalGradient8A3gB4$default(Brush.Companion, new Pair[]{TuplesKt.to(Float.valueOf(1 - f2), Color.m4527boximpl(Color.Companion.m4563getBlack0d7_KjU())), TuplesKt.to(Float.valueOf(1.0f), Color.m4527boximpl(Color.Companion.m4572getTransparent0d7_KjU()))}, 0.0f, 0.0f, 0, 14, (Object) null), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m4459getDstIn0nO6VwU(), 62, null);
        }
        return Unit.INSTANCE;
    }
}
