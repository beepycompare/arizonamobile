    ...
    */
    ...
    private final String calculateFileHashOrEmpty(File file) {
        ...
        try {
            ...
            m9915constructorimpl = Result.m9915constructorimpl(calculateFileHash(file));
        } catch (Throwable th) {
        ...
        if (m9918exceptionOrNullimpl != null) {
            Log.e(TAG, "calculateFileHashOrEmpty: failed for " + file.getAbsolutePath(), m9918exceptionOrNullimpl);
        }
        if (Result.m9921isFailureimpl(m9915constructorimpl)) {
            m9915constructorimpl = "";
        }
