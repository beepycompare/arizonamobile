...
public final class GameTestScriptRunner$executeLoginAndSpawn$1 extends ContinuationImpl {
    ...
    public GameTestScriptRunner$executeLoginAndSpawn$1(GameTestScriptRunner gameTestScriptRunner, Continuation<? super GameTestScriptRunner$executeLoginAndSpawn$1> continuation) {
        super(continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        Object executeLoginAndSpawn;
        this.result = obj;
        this.label |= Integer.MIN_VALUE;
        executeLoginAndSpawn = this.this$0.executeLoginAndSpawn(null, this);
        return executeLoginAndSpawn;
    }
}
