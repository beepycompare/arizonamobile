    ...
    */
    ...
    private final int resolveSpawnSelectionId(String str, int i) {
        ...
        try {
            ...
            m9916constructorimpl = Result.m9916constructorimpl(Integer.valueOf(jSONObject != null ? jSONObject.optInt(TtmlNode.ATTR_ID) : 0));
        } catch (Throwable th) {
