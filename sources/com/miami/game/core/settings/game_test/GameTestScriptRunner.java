    ...
    */
    ...
    private final int resolveSpawnSelectionId(String str, int i) {
        ...
        try {
            ...
            m9919constructorimpl = Result.m9919constructorimpl(Integer.valueOf(jSONObject != null ? jSONObject.optInt(TtmlNode.ATTR_ID) : 0));
        } catch (Throwable th) {
