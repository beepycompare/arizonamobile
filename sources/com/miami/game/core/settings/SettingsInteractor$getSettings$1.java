...
@DebugMetadata(c = "com.miami.game.core.settings.SettingsInteractor$getSettings$1", f = "SettingsInteractor.kt", i = {0, 0, 0, 0}, l = {86}, m = "invokeSuspend", n = {"$this$getSuspend$iv", "key$iv", "notification", "$i$f$getSuspend"}, s = {"L$0", "L$1", "Z$0", "I$0"}, v = 1)
