...
@DebugMetadata(c = "com.miami.game.core.news.data.store.NewsPrefRepository", f = "NewsPrefRepository.kt", i = {0, 0, 0}, l = {43}, m = "getCache", n = {"$this$getSuspend$iv", "key$iv", "$i$f$getSuspend"}, s = {"L$0", "L$1", "I$0"}, v = 1)
