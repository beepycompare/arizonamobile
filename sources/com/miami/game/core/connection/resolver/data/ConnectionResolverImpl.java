...
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\b\n\u0002\b\b\n\u0002\u0010 \n\u0000\u0018\u00002\u00020\u0001B\u001d\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u001a\u0002\b\b¢\u0006\u0004\b\u0006\u0010\u0007J\"\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\u0006\u0010\r\u001a\u00020\fH\u0096@¢\u0006\u0002\u0010\u000eJ\"\u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\u0006\u0010\r\u001a\u00020\fH\u0096@¢\u0006\u0002\u0010\u000eJ\"\u0010\u0010\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\u0006\u0010\r\u001a\u00020\fH\u0096@¢\u0006\u0002\u0010\u000eJ\"\u0010\u0011\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\u0006\u0010\r\u001a\u00020\fH\u0096@¢\u0006\u0002\u0010\u000eJ\"\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\u0006\u0010\r\u001a\u00020\fH\u0096@¢\u0006\u0002\u0010\u000eJ\"\u0010\u0013\u001a\u000e\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020\f0\n2\f\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0015H\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Lcom/miami/game/core/connection/resolver/data/ConnectionResolverImpl;", "Lcom/miami/game/core/connection/resolver/api/ConnectionResolver;", "availabilityService", "Lcom/miami/game/core/connection/resolver/data/AvailabilityService;", "serversList", "Lcom/miami/game/core/connection/resolver/data/ServersList;", "<init>", "(Lcom/miami/game/core/connection/resolver/data/AvailabilityService;Lcom/miami/game/core/connection/resolver/data/ServersList;)V", "Ljavax/inject/Inject;", "getDownloadFilesChannel", "Lkotlin/Pair;", "", "", "channel", "(ILkotlin/coroutines/Continuation;)Ljava/lang/Object;", "getServerDesktopList", "getServerMobileList", "getServerVcList", "getNewsServer", "findAvailableServer", "servers", "", "connection-resolver"}, k = 1, mv = {2, 4, 0}, xi = 48)
...
public final class ConnectionResolverImpl implements ConnectionResolver {
    ...
    @Override // com.miami.game.core.connection.resolver.api.ConnectionResolver
    public Object getServerVcList(int i, Continuation<? super Pair<String, Integer>> continuation) {
        List<String> gameServersVc = this.serversList.gameServersVc();
        if (i == -1) {
            return findAvailableServer(gameServersVc);
        }
        return i >= gameServersVc.size() ? TuplesKt.to(CollectionsKt.first((List<? extends Object>) gameServersVc), Boxing.boxInt(0)) : TuplesKt.to(gameServersVc.get(i), Boxing.boxInt(i));
    }
