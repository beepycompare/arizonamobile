...
public final class ServersList {
    ...
    public final List<String> gameServersDesktop() {
        ...
        boolean isArizona = this.buildConfig.isArizona();
        BuildConfigRepository buildConfigRepository = this.buildConfig;
        if (isArizona) {
            if (buildConfigRepository.isDebug()) {
                return CollectionsKt.listOf((Object[]) new String[]{string + "/launcher/servers/arizona", string2 + "/launcher/servers/arizona"});
            }
            return CollectionsKt.listOf((Object[]) new String[]{string + "/launcher/servers/arizona", string2 + "/launcher/servers/arizona"});
        } else if (buildConfigRepository.isDebug()) {
    ...
    public final List<String> gameServersVc() {
        String string = this.remoteConfig.getString("main_api");
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        String string2 = this.remoteConfig.getString("reserve_api");
        Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
        if (this.buildConfig.isDebug()) {
            return CollectionsKt.listOf((Object[]) new String[]{string + "/launcher/servers/vc", string2 + "/launcher/servers/vc"});
        }
        return CollectionsKt.listOf((Object[]) new String[]{string + "/launcher/servers/vc", string2 + "/launcher/servers/vc"});
    }
