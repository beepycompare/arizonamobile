...
public final class ErrorHandlerApiCall<T> implements Call<T> {
    ...
    @Override // retrofit2.Call
    public Call<T> clone() {
        Call<T> mo10058clone = this.sourceCall.mo10058clone();
        Intrinsics.checkNotNullExpressionValue(mo10058clone, "clone(...)");
        return mo10058clone;
    }
