...
public final class ErrorHandlerApiCall<T> implements Call<T> {
    ...
    @Override // retrofit2.Call
    public Call<T> clone() {
        Call<T> mo9725clone = this.sourceCall.mo9725clone();
        Intrinsics.checkNotNullExpressionValue(mo9725clone, "clone(...)");
        return mo9725clone;
    }
