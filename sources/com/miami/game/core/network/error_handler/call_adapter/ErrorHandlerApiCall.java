...
public final class ErrorHandlerApiCall<T> implements Call<T> {
    ...
    @Override // retrofit2.Call
    public Call<T> clone() {
        Call<T> mo9776clone = this.sourceCall.mo9776clone();
        Intrinsics.checkNotNullExpressionValue(mo9776clone, "clone(...)");
        return mo9776clone;
    }
