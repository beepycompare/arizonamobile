...
public final class C0088MainComponent_Factory {
    ...
    public static C0088MainComponent_Factory create(Provider<HomeComponent.Factory> provider, Provider<SelectServerComponent.Factory> provider2, Provider<SettingsComponent.Factory> provider3, Provider<CommonDialogComponent.Factory> provider4, Provider<ErrorDialogComponent.Factory> provider5, Provider<DownloadScreenComponent.Factory> provider6, Provider<NotificationsComponent.Factory> provider7) {
        return new C0088MainComponent_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
