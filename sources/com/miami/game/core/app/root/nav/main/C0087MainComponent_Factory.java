...
public final class C0087MainComponent_Factory {
    ...
    private C0087MainComponent_Factory(Provider<HomeComponent.Factory> provider, Provider<SelectServerComponent.Factory> provider2, Provider<SettingsComponent.Factory> provider3, Provider<CommonDialogComponent.Factory> provider4, Provider<ErrorDialogComponent.Factory> provider5, Provider<DownloadScreenComponent.Factory> provider6, Provider<NotificationsComponent.Factory> provider7) {
    ...
    public static C0087MainComponent_Factory create(Provider<HomeComponent.Factory> provider, Provider<SelectServerComponent.Factory> provider2, Provider<SettingsComponent.Factory> provider3, Provider<CommonDialogComponent.Factory> provider4, Provider<ErrorDialogComponent.Factory> provider5, Provider<DownloadScreenComponent.Factory> provider6, Provider<NotificationsComponent.Factory> provider7) {
        return new C0087MainComponent_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
