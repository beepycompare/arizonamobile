...
public final class C0101MainComponent_Factory {
    ...
    private C0101MainComponent_Factory(Provider<HomeComponent.Factory> provider, Provider<SelectServerComponent.Factory> provider2, Provider<SettingsComponent.Factory> provider3, Provider<CommonDialogComponent.Factory> provider4, Provider<ErrorDialogComponent.Factory> provider5, Provider<DownloadScreenComponent.Factory> provider6, Provider<NotificationsComponent.Factory> provider7) {
    ...
    public static C0101MainComponent_Factory create(Provider<HomeComponent.Factory> provider, Provider<SelectServerComponent.Factory> provider2, Provider<SettingsComponent.Factory> provider3, Provider<CommonDialogComponent.Factory> provider4, Provider<ErrorDialogComponent.Factory> provider5, Provider<DownloadScreenComponent.Factory> provider6, Provider<NotificationsComponent.Factory> provider7) {
        return new C0101MainComponent_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
