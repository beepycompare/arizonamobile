        ...
        if (continuation instanceof ValueStateFlow$collect$1) {
            ...
            if ((valueStateFlow$collect$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Cancellation subscribe = this.store.subscribe(new Function1() { // from class: com.miami.game.core.decompose.utils.ValueStateFlow$$ExternalSyntheticLambda0
                    ...
                    try {
                        valueStateFlow$collect$1.L$0 = subscribe;
                    ...
                    cancellation = (Cancellation) valueStateFlow$collect$1.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                    } catch (Throwable th2) {
                        th = th2;
