...
public final class SharedEventFlow<T> implements FlowCollector<T>, Flow<T> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0058, code lost:
        if (kotlinx.coroutines.flow.FlowKt.first(r6.sharedFlow.getSubscriptionCount(), new com.miami.game.core.decompose.utils.SharedEventFlow$emit$2(null), r0) == r1) goto L18;
     */
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof SharedEventFlow$emit$1) {
            ...
            if ((sharedEventFlow$emit$1.label & Integer.MIN_VALUE) != 0) {
                ...
                Object emit = this.sharedFlow.emit(t, sharedEventFlow$emit$1);
                return emit != coroutine_suspended ? coroutine_suspended : emit;
            }
        }
        ...
        sharedEventFlow$emit$1.L$0 = SpillingKt.nullOutSpilledVariable(t);
        sharedEventFlow$emit$1.label = 2;
        Object emit2 = this.sharedFlow.emit(t, sharedEventFlow$emit$1);
