...
@DebugMetadata(c = "com.miami.game.core.decompose.utils.CoroutineFeatureExtensionsKt$launchSafe$1", f = "CoroutineFeatureExtensions.kt", i = {0, 1, 1}, l = {20, 22}, m = "invokeSuspend", n = {"$this$launch", "$this$launch", "exception"}, s = {"L$0", "L$0", "L$1"}, v = 1)
