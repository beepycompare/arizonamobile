...
@DebugMetadata(c = "com.miami.game.core.api.network.NetworkDataSourceImpl", f = "NetworkDataSourceImpl.kt", i = {1, 1, 2, 2, 2}, l = {82, 87, 90}, m = "getServersDesktop", n = {"url", "channel", "url", "e", "channel"}, s = {"L$0", "I$0", "L$0", "L$1", "I$0"}, v = 1)
