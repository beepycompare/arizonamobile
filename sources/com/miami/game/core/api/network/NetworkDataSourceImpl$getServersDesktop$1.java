...
@DebugMetadata(c = "com.miami.game.core.api.network.NetworkDataSourceImpl", f = "NetworkDataSourceImpl.kt", i = {1, 1, 2, 2, 2}, l = {83, 88, 93}, m = "getServersDesktop", n = {"url", "channel", "url", "e", "channel"}, nl = {85, TsExtractor.TS_STREAM_TYPE_DVBSUBS, 87}, s = {"L$0", "I$0", "L$0", "L$1", "I$0"}, v = 2)
