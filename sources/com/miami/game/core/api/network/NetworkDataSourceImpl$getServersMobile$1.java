...
@DebugMetadata(c = "com.miami.game.core.api.network.NetworkDataSourceImpl", f = "NetworkDataSourceImpl.kt", i = {1, 1, 2, 2, 2}, l = {69, 74, 77}, m = "getServersMobile", n = {"url", "channel", "url", "e", "channel"}, s = {"L$0", "I$0", "L$0", "L$1", "I$0"}, v = 1)
