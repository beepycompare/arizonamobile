...
public final class ServersInteractor$getCurrentServer$$inlined$getSuspend$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ServerModel>, Object> {
    ...
    public ServersInteractor$getCurrentServer$$inlined$getSuspend$1(IKeyValueRepository iKeyValueRepository, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ServersInteractor$getCurrentServer$$inlined$getSuspend$1(this.$this_getSuspend, this.$key, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ServerModel> continuation) {
        return ((ServersInteractor$getCurrentServer$$inlined$getSuspend$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Type type = new TypeToken<ServerModel>() { // from class: com.miami.game.core.server.ServersInteractor$getCurrentServer$$inlined$getSuspend$1.1
        }.getType();
