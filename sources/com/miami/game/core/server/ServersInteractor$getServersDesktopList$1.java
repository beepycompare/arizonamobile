...
@DebugMetadata(c = "com.miami.game.core.server.ServersInteractor", f = "ServersInteractor.kt", i = {0, 0, 0, 2, 2, 2}, l = {364, 340, 344, 354}, m = "getServersDesktopList", n = {"$this$getSuspend$iv", "key$iv", "$i$f$getSuspend", "serverList", "it", "$i$a$-let-ServersInteractor$getServersDesktopList$4"}, s = {"L$0", "L$1", "I$0", "L$0", "L$1", "I$0"}, v = 1)
