...
public final class ServersInteractor$getCurrentServerLocal$1$invokeSuspend$$inlined$getSuspend$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ServerModel>, Object> {
    final /* synthetic */ String $key;
    final /* synthetic */ IKeyValueRepository $this_getSuspend;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ServersInteractor$getCurrentServerLocal$1$invokeSuspend$$inlined$getSuspend$1(IKeyValueRepository iKeyValueRepository, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ServersInteractor$getCurrentServerLocal$1$invokeSuspend$$inlined$getSuspend$1(this.$this_getSuspend, this.$key, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ServerModel> continuation) {
        return ((ServersInteractor$getCurrentServerLocal$1$invokeSuspend$$inlined$getSuspend$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        String str = this.$key;
        Type type = new TypeToken<ServerModel>() { // from class: com.miami.game.core.server.ServersInteractor$getCurrentServerLocal$1$invokeSuspend$$inlined$getSuspend$1.1
        }.getType();
