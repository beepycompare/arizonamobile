...
@DebugMetadata(c = "com.miami.game.core.server.ServersInteractor$getCurrentServer$1", f = "ServersInteractor.kt", i = {0, 0, 0}, l = {364}, m = "invokeSuspend", n = {"$this$getSuspend$iv", "key$iv", "$i$f$getSuspend"}, s = {"L$0", "L$1", "I$0"})
...
public final class ServersInteractor$getCurrentServer$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.I$0 = 0;
            this.label = 1;
            obj = BuildersKt.withContext(Dispatchers.getIO(), new ServersInteractor$getCurrentServer$1$invokeSuspend$$inlined$getSuspend$1(localRepository2, ServersInteractor.CURRENT_SERVER_KEY, null), this);
