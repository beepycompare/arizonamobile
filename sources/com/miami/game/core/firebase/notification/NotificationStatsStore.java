...
public final class NotificationStatsStore {
    ...
    public final void append(NotificationInteractionEvent event) {
        ...
        synchronized (LOCK) {
            ...
            if (m9922exceptionOrNullimpl != null) {
                Timber.Forest.w(m9922exceptionOrNullimpl, "Failed to append pending notification stats", new Object[0]);
            }
        }
    }

    public final List<NotificationInteractionEvent> pendingEvents() {
        List m9919constructorimpl;
        ...
        try {
            ...
            m9919constructorimpl = Result.m9919constructorimpl(pendingEventsLocked);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m9919constructorimpl = Result.m9919constructorimpl(ResultKt.createFailure(th));
        }
        Throwable m9922exceptionOrNullimpl = Result.m9922exceptionOrNullimpl(m9919constructorimpl);
        if (m9922exceptionOrNullimpl != null) {
            Timber.Forest.w(m9922exceptionOrNullimpl, "Failed to read pending notification stats", new Object[0]);
        }
        List emptyList = CollectionsKt.emptyList();
        if (Result.m9925isFailureimpl(m9919constructorimpl)) {
            m9919constructorimpl = emptyList;
        }
        return (List) m9919constructorimpl;
    }
    ...
    public final void remove(Set<String> eventIds) {
        ...
        Throwable m9922exceptionOrNullimpl = Result.m9922exceptionOrNullimpl(m9919constructorimpl);
        if (m9922exceptionOrNullimpl != null) {
            Timber.Forest.w(m9922exceptionOrNullimpl, "Failed to remove sent notification stats", new Object[0]);
        }
    }
    ...
    private final List<NotificationInteractionEvent> pendingEventsLocked() {
        ...
        try {
            ...
            m9919constructorimpl = Result.m9919constructorimpl(CollectionsKt.build(createListBuilder));
        } catch (Throwable th) {
        ...
        Throwable m9922exceptionOrNullimpl = Result.m9922exceptionOrNullimpl(m9919constructorimpl);
        if (m9922exceptionOrNullimpl != null) {
            Timber.Forest.w(m9922exceptionOrNullimpl, "Failed to parse pending notification stats", new Object[0]);
