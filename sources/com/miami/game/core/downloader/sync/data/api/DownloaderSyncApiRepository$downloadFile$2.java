...
@DebugMetadata(c = "com.miami.game.core.downloader.sync.data.api.DownloaderSyncApiRepository$downloadFile$2", f = "DownloaderSyncApiRepository.kt", i = {1}, l = {73, 74}, m = "invokeSuspend", n = {"url"}, s = {"L$0"}, v = 1)
