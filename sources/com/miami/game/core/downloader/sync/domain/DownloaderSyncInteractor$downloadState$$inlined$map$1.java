...
public final class DownloaderSyncInteractor$downloadState$$inlined$map$1 implements Flow<BytesAndSpeedState> {
    final /* synthetic */ Flow $this_unsafeTransform$inlined;
    final /* synthetic */ DownloaderSyncInteractor this$0;

    @Metadata(k = 3, mv = {2, 4, 0}, xi = 48)
    @DebugMetadata(c = "com.miami.game.core.downloader.sync.domain.DownloaderSyncInteractor$downloadState$$inlined$map$1", f = "DownloaderSyncInteractor.kt", i = {0, 0, 0}, l = {112}, m = "collect", n = {"collector", "$completion", "$this$unsafeTransform_u24lambda_u240"}, nl = {115}, s = {"L$0", "L$1", "L$2"}, v = 2)
    /* renamed from: com.miami.game.core.downloader.sync.domain.DownloaderSyncInteractor$downloadState$$inlined$map$1$1  reason: invalid class name */
    /* loaded from: classes5.dex */
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return DownloaderSyncInteractor$downloadState$$inlined$map$1.this.collect(null, this);
        }
    }
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @Metadata(k = 3, mv = {2, 4, 0}, xi = 48)
        @DebugMetadata(c = "com.miami.game.core.downloader.sync.domain.DownloaderSyncInteractor$downloadState$$inlined$map$1$2", f = "DownloaderSyncInteractor.kt", i = {0, 0, 0, 0}, l = {217}, m = "emit", n = {"value", "$completion", "value", "$this$map_u24lambda_u240"}, nl = {47}, s = {"L$0", "L$1", "L$2", "L$3"}, v = 2)
    ...
    */
        ...
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    anonymousClass1.label = 1;
                    if (this.$this_unsafeTransform$inlined.collect(new AnonymousClass2(flowCollector, this.this$0), anonymousClass1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public DownloaderSyncInteractor$downloadState$$inlined$map$1(Flow flow, DownloaderSyncInteractor downloaderSyncInteractor) {
