...
@DebugMetadata(c = "com.miami.game.core.downloader.AndroidDownloader$downloadBytesFlow$1", f = "AndroidDownloader.kt", i = {0, 0, 1, 1}, l = {34, 35}, m = "invokeSuspend", n = {"$this$flow", "progress", "$this$flow", "progress"}, s = {"L$0", "J$0", "L$0", "J$0"}, v = 1)
