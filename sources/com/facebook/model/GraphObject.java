    ...
    public static final class Factory {
        ...
        public static final class GraphObjectListImpl<T> extends AbstractList<T> implements GraphObjectList<T> {
            ...
            public GraphObjectListImpl(JSONArray jSONArray, Class<?> cls) {
                Validate.notNull(jSONArray, RemoteConfigConstants.ResponseFieldKey.STATE);
        ...
        public static abstract class ProxyBase<STATE> implements InvocationHandler {
            ...
            protected final Object proxyObjectMethods(Object obj, Method method, Object[] objArr) throws Throwable {
                String name = method.getName();
        ...
        private static <T extends GraphObject> boolean hasClassBeenVerified(Class<T> cls) {
            boolean contains;
        ...
        private static <T extends GraphObject> void recordClassHasBeenVerified(Class<T> cls) {
            synchronized (Factory.class) {
                try {
