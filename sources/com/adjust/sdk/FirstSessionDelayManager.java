...
public class FirstSessionDelayManager {
    ...
    public final ActivityHandler f166a;
    public final ArrayList b = new ArrayList();
    public int c = 0;

    public FirstSessionDelayManager(ActivityHandler activityHandler) {
        this.f166a = activityHandler;
    }

    public final void a(Runnable runnable, String str) {
        if (this.c == 3) {
            this.f166a.getAdjustConfig().getLogger().debug("Enqueuing \"" + str + "\" action to be executed after first session delay ends", new Object[0]);
            this.b.add(runnable);
            return;
        }
        runnable.run();
    ...
    public final void a(String str, IRunActivityHandler iRunActivityHandler) {
        int i = this.c;
        ActivityHandler activityHandler = this.f166a;
        if (i == 3) {
            ...
            this.f166a.getAdjustConfig().preLaunchActions.preLaunchActionsArray.add(iRunActivityHandler);
            return;
        }
