...
public class GooglePlayServicesClient {
    ...
    public static final class GooglePlayServicesConnection implements ServiceConnection {
        ...
        public final IBinder a() {
            if (!this.b) {
                this.b = true;
                return (IBinder) this.c.poll(this.f165a, TimeUnit.MILLISECONDS);
            }
    ...
    public static final class GooglePlayServicesInterface implements IInterface {
        ...
        public final String a() {
            ...
            try {
                ...
                this.f166a.transact(1, obtain, obtain2, 0);
        ...
        public final Boolean b() {
            ...
            try {
                obtain.writeInterfaceToken("com.google.android.gms.ads.identifier.internal.IAdvertisingIdService");
                obtain.writeInt(1);
                this.f166a.transact(2, obtain, obtain2, 0);
                obtain2.readException();
