...
public final class BalloonIndicatorType extends IndicatorType {
    ...
    public /* synthetic */ BalloonIndicatorType(DotGraphic dotGraphic, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new DotGraphic(Dp.m7996constructorimpl(12), 0L, null, null, 0L, 30, null) : dotGraphic, (i & 2) != 0 ? 1.5f : f);
    }
    ...
    public void mo9881IndicatorTypeComposablejt2gSs(final Function0<Float> globalOffsetProvider, final Modifier modifier, final int i, final float f, final Function1<? super Integer, Unit> function1, Composer composer, final int i2) {
        ...
        if ((374491 & i3) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m881height3ABfNKs = SizeKt.m881height3ABfNKs(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, null), Dp.m7996constructorimpl(this.dotsGraphic.m9880getSizeD9Ej5fM() * this.balloonSizeFactor));
            ...
            LazyDslKt.LazyRow(m881height3ABfNKs, null, m840PaddingValuesa9UjIt4$default, false, m703spacedByD5KLDUw, centerVertically, null, false, (Function1) rememberedValue, composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, ComposerKt.compositionLocalMapKey);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.BalloonIndicatorType$IndicatorTypeComposable$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    BalloonIndicatorType.this.mo9881IndicatorTypeComposablejt2gSs(globalOffsetProvider, modifier, i, f, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public final float computeDotWidth(int i, float f) {
        return Dp.m7996constructorimpl(this.dotsGraphic.m9880getSizeD9Ej5fM() + Dp.m7996constructorimpl(Dp.m7996constructorimpl(RangesKt.coerceAtLeast(this.balloonSizeFactor - 1.0f, 0.0f) * this.dotsGraphic.m9880getSizeD9Ej5fM()) * (1.0f - RangesKt.coerceAtMost(Math.abs(i - f), 1.0f)))) / this.dotsGraphic.m9880getSizeD9Ej5fM();
    }
}
