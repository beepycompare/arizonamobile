...
public final class ShiftIndicatorType extends IndicatorType {
    ...
    public void mo9046IndicatorTypeComposablejt2gSs(final Function0<Float> globalOffsetProvider, final Modifier modifier, final int i, final float f, final Function1<? super Integer, Unit> function1, Composer composer, final int i2) {
        ...
        if ((374491 & i3) != 74898 || !startRestartGroup.getSkipping()) {
                            ...
                            public final void invoke(LazyItemScope items, final int i6, Composer composer3, int i7) {
                                ...
                                if ((i7 & 721) != 144 || !composer3.getSkipping()) {
                                    ...
                                    if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
                                        rememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Dp>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.ShiftIndicatorType$IndicatorTypeComposable$1$1$1$1$dotWidth$2$1
                                            ...
                                            public /* bridge */ /* synthetic */ Dp invoke() {
                                                return Dp.m7249boximpl(m9049invokeD9Ej5fM());
                                            }

                                            /* renamed from: invoke-D9Ej5fM  reason: not valid java name */
                                            public final float m9049invokeD9Ej5fM() {
                                                float m9048computeDotWidthchRvn1I;
                                                m9048computeDotWidthchRvn1I = ShiftIndicatorType.this.m9048computeDotWidthchRvn1I(i6, function02.invoke().floatValue());
                                                return m9048computeDotWidthchRvn1I;
                                            }
                                        });
                                    ...
                                    if (changed2 || rememberedValue3 == Composer.Companion.getEmpty()) {
                                        rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ClickableKt.m296clickableXHw0xAI$default(SizeKt.m889width3ABfNKs(Modifier.Companion, invoke$lambda$1(state)), false, null, null, new Function0<Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.ShiftIndicatorType$IndicatorTypeComposable$1$1$1$1$dotModifier$2$1
                                            /* JADX INFO: Access modifiers changed from: package-private */
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            /* JADX WARN: Multi-variable type inference failed */
                                            {
            ...
            LazyDslKt.LazyRow(fillMaxWidth$default, null, m829PaddingValuesa9UjIt4$default, false, m692spacedByD5KLDUw, null, null, false, (Function1) rememberedValue, composer2, 6, 234);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.ShiftIndicatorType$IndicatorTypeComposable$2
                ...
                public final void invoke(Composer composer3, int i5) {
                    ShiftIndicatorType.this.mo9046IndicatorTypeComposablejt2gSs(globalOffsetProvider, modifier, i, f, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public final float m9048computeDotWidthchRvn1I(int i, float f) {
        return Dp.m7251constructorimpl(this.dotsGraphic.m9045getSizeD9Ej5fM() + Dp.m7251constructorimpl(Dp.m7251constructorimpl(RangesKt.coerceAtLeast(this.shiftSizeFactor - 1.0f, 0.0f) * this.dotsGraphic.m9045getSizeD9Ej5fM()) * (1.0f - RangesKt.coerceAtMost(Math.abs(i - f), 1.0f))));
    }
}
