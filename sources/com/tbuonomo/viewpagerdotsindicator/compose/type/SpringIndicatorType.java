...
public final class SpringIndicatorType extends IndicatorType {
                ...
                if (rememberedValue4 == Composer.Companion.getEmpty()) {
                    rememberedValue4 = SnapshotStateKt.derivedStateOf(new Function0<Dp>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.SpringIndicatorType$IndicatorTypeComposable$1$centeredOffset$2$1
                        ...
                        public final float m9902invokeD9Ej5fM() {
                            ...
                            float m9895getSizeD9Ej5fM = dotGraphic3.m9895getSizeD9Ej5fM();
                            dotGraphic4 = SpringIndicatorType.this.selectorDotGraphic;
                            return Dp.m8160constructorimpl(Dp.m8160constructorimpl(m9895getSizeD9Ej5fM - dotGraphic4.m9895getSizeD9Ej5fM()) / 2.0f);
                        }
                    });
                ...
                if (z || rememberedValue5 == Composer.Companion.getEmpty()) {
                    ...
                    rememberedValue5 = SnapshotStateKt.derivedStateOf(new Function0<Dp>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.SpringIndicatorType$IndicatorTypeComposable$1$foregroundDotPositionDp$2$1
                        ...
                        public final float m9903invokeD9Ej5fM() {
                            ...
                            float m9901computeSelectorDotPositionDptILSbM;
                            ...
                            m9901computeSelectorDotPositionDptILSbM = springIndicatorType2.m9901computeSelectorDotPositionDptILSbM(IndicatorTypeComposable__jt2gSs$lambda$1, IndicatorTypeComposable__jt2gSs$lambda$4, i8, floatValue, f2, IndicatorTypeComposable__jt2gSs$lambda$11$lambda$8);
                            return m9901computeSelectorDotPositionDptILSbM;
                        }
                    });
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.tbuonomo.viewpagerdotsindicator.compose.type.SpringIndicatorType$IndicatorTypeComposable$2
                ...
                public final void invoke(Composer composer3, int i8) {
                    SpringIndicatorType.this.mo9896IndicatorTypeComposablejt2gSs(globalOffsetProvider, modifier, i, f, function1, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public final float m9901computeSelectorDotPositionDptILSbM(float f, float f2, int i, float f3, float f4, float f5) {
