...
final class CloudyBackgroundModifierElement extends ModifierNodeElement<CloudyBackgroundModifierNode> {
    ...
    public static /* synthetic */ CloudyBackgroundModifierElement m9846copyBx497Mc$default(CloudyBackgroundModifierElement cloudyBackgroundModifierElement, Sky sky, int i, CloudyProgressive cloudyProgressive, long j, boolean z, Function1 function1, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return cloudyBackgroundModifierElement.m9848copyBx497Mc(sky, i, cloudyProgressive2, j2, z, function12);
    }
    ...
    public final long m9847component40d7_KjU() {
        return this.tint;
    }
    ...
    public final CloudyBackgroundModifierElement m9848copyBx497Mc(Sky sky, int i, CloudyProgressive progressive, long j, boolean z, Function1<? super CloudyState, Unit> onStateChanged) {
    ...
    public final long m9849getTint0d7_KjU() {
        return this.tint;
    }
    ...
    public void update(CloudyBackgroundModifierNode node) {
        ...
        node.m9850updateBx497Mc(this.sky, this.radius, this.progressive, this.tint, this.cpuBlurEnabled, this.onStateChanged);
    }
}
