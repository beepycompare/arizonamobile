...
public final class SkySnapshot {
    ...
    public static /* synthetic */ SkySnapshot m9802copyfnh65Uc$default(SkySnapshot skySnapshot, int i, float f, float f2, float f3, float f4, ProgressiveDirection progressiveDirection, float f5, float f6, Easing easing, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        float f9 = f4;
        float f10 = f2;
        return skySnapshot.m9804copyfnh65Uc(i, f, f10, f3, f9, progressiveDirection2, f8, f7, easing2, j2);
    }
    ...
    public final long m9803component100d7_KjU() {
    ...
    public final SkySnapshot m9804copyfnh65Uc(int i, float f, float f2, float f3, float f4, ProgressiveDirection direction, float f5, float f6, Easing easing, long j) {
    ...
    public final long m9805getTintColor0d7_KjU() {
        return this.tintColor;
    }
    ...
    public static final class Companion {
        ...
        public final SkySnapshot m9806fromProgressivePE3pjmc(int i, float f, float f2, float f3, float f4, CloudyProgressive progressive, long j) {
