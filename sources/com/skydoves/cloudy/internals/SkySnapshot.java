...
public final class SkySnapshot {
    ...
    public static /* synthetic */ SkySnapshot m9873copyfnh65Uc$default(SkySnapshot skySnapshot, int i, float f, float f2, float f3, float f4, ProgressiveDirection progressiveDirection, float f5, float f6, Easing easing, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        float f9 = f4;
        float f10 = f2;
        return skySnapshot.m9875copyfnh65Uc(i, f, f10, f3, f9, progressiveDirection2, f8, f7, easing2, j2);
    }
    ...
    public final long m9874component100d7_KjU() {
    ...
    public final SkySnapshot m9875copyfnh65Uc(int i, float f, float f2, float f3, float f4, ProgressiveDirection direction, float f5, float f6, Easing easing, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SkySnapshot) {
            ...
            return this.radius == skySnapshot.radius && Float.compare(this.offsetX, skySnapshot.offsetX) == 0 && Float.compare(this.offsetY, skySnapshot.offsetY) == 0 && Float.compare(this.childWidth, skySnapshot.childWidth) == 0 && Float.compare(this.childHeight, skySnapshot.childHeight) == 0 && this.direction == skySnapshot.direction && Float.compare(this.fadeStart, skySnapshot.fadeStart) == 0 && Float.compare(this.fadeEnd, skySnapshot.fadeEnd) == 0 && Intrinsics.areEqual(this.easing, skySnapshot.easing) && Color.m5349equalsimpl0(this.tintColor, skySnapshot.tintColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((Integer.hashCode(this.radius) * 31) + Float.hashCode(this.offsetX)) * 31) + Float.hashCode(this.offsetY)) * 31) + Float.hashCode(this.childWidth)) * 31) + Float.hashCode(this.childHeight)) * 31) + this.direction.hashCode()) * 31) + Float.hashCode(this.fadeStart)) * 31) + Float.hashCode(this.fadeEnd)) * 31) + this.easing.hashCode()) * 31) + Color.m5355hashCodeimpl(this.tintColor);
    }

    public String toString() {
        return "SkySnapshot(radius=" + this.radius + ", offsetX=" + this.offsetX + ", offsetY=" + this.offsetY + ", childWidth=" + this.childWidth + ", childHeight=" + this.childHeight + ", direction=" + this.direction + ", fadeStart=" + this.fadeStart + ", fadeEnd=" + this.fadeEnd + ", easing=" + this.easing + ", tintColor=" + ((Object) Color.m5356toStringimpl(this.tintColor)) + ')';
    }
    ...
    public final long m9876getTintColor0d7_KjU() {
        return this.tintColor;
    }
    ...
    public static final class Companion {
        ...
        public final SkySnapshot m9877fromProgressivePE3pjmc(int i, float f, float f2, float f3, float f4, CloudyProgressive progressive, long j) {
