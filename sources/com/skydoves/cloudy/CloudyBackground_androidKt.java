...
public final class CloudyBackground_androidKt {
    ...
    public static final Modifier m9854cloudyNpZTi58(Modifier cloudy, Sky sky, int i, CloudyProgressive cloudyProgressive, long j, boolean z, boolean z2, Function1<? super CloudyState, Unit> function1, Composer composer, int i2, int i3) {
        ...
        long m5383getTransparent0d7_KjU = (i3 & 8) != 0 ? Color.Companion.m5383getTransparent0d7_KjU() : j;
        ...
        if (i4 >= 0) {
            ...
            Modifier then = cloudy.then(new CloudyBackgroundModifierElement(sky, i4, none, m5383getTransparent0d7_KjU, z4, function12, null));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
