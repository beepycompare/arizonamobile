...
public final class RemoteSettings implements SettingsProvider {
    ...
    public Duration mo9776getSessionRestartTimeoutFghU774() {
        Integer sessionRestartTimeout = this.settingsCache.sessionRestartTimeout();
        if (sessionRestartTimeout != null) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m11290boximpl(DurationKt.toDuration(sessionRestartTimeout.intValue(), DurationUnit.SECONDS));
        }
        return null;
    }
    ...
    */
    ...
    static {
        Duration.Companion companion = Duration.Companion;
        defaultCacheDuration = (int) Duration.m11306getInWholeSecondsimpl(DurationKt.toDuration(24, DurationUnit.HOURS));
