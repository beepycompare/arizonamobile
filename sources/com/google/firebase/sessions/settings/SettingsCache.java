...
public final class SettingsCache {
    ...
    @DebugMetadata(c = "com.google.firebase.sessions.settings.SettingsCache$1", f = "SettingsCache.kt", i = {}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_BASELINE_TO_TOP_OF}, m = "invokeSuspend", n = {}, s = {})
        ...
        if (continuation instanceof SettingsCache$removeConfigs$1) {
            ...
            if ((settingsCache$removeConfigs$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (PreferencesKt.edit(this.dataStore, new SettingsCache$removeConfigs$2(this, null), settingsCache$removeConfigs$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
