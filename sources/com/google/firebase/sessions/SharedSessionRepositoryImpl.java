    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Flow m10632catch = FlowKt.m10632catch(SharedSessionRepositoryImpl.this.sessionDataStore.getData(), new C00801(SharedSessionRepositoryImpl.this, null));
                final SharedSessionRepositoryImpl sharedSessionRepositoryImpl = SharedSessionRepositoryImpl.this;
                this.label = 1;
                if (m10632catch.collect(new FlowCollector() { // from class: com.google.firebase.sessions.SharedSessionRepositoryImpl.1.2
    ...
    */
    ...
    public final boolean isSessionExpired(SessionData sessionData) {
        ...
        if (backgroundTime != null) {
            boolean z = Duration.m10435compareToLRDsOJo(this.timeProvider.currentTime().m8899minus5sfh64U(backgroundTime), this.sessionsSettings.m8903getSessionRestartTimeoutUwyO8pc()) > 0;
            if (z) {
