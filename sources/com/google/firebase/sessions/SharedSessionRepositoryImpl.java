    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Flow m10049catch = FlowKt.m10049catch(SharedSessionRepositoryImpl.this.sessionDataStore.getData(), new C00881(SharedSessionRepositoryImpl.this, null));
                final SharedSessionRepositoryImpl sharedSessionRepositoryImpl = SharedSessionRepositoryImpl.this;
                this.label = 1;
                if (m10049catch.collect(new FlowCollector() { // from class: com.google.firebase.sessions.SharedSessionRepositoryImpl.1.2
        ...
        /* loaded from: classes4.dex */
        public static final class C00881 extends SuspendLambda implements Function3<FlowCollector<? super SessionData>, Throwable, Continuation<? super Unit>, Object> {
            ...
            C00881(SharedSessionRepositoryImpl sharedSessionRepositoryImpl, Continuation<? super C00881> continuation) {
    ...
    */
    ...
    public final boolean isSessionExpired(SessionData sessionData) {
        ...
        if (backgroundTime != null) {
            boolean z = Duration.m9852compareToLRDsOJo(this.timeProvider.currentTime().m8314minus5sfh64U(backgroundTime), this.sessionsSettings.m8318getSessionRestartTimeoutUwyO8pc()) > 0;
            if (z) {
