    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Flow m10749catch = FlowKt.m10749catch(SharedSessionRepositoryImpl.this.sessionDataStore.getData(), new C00671(SharedSessionRepositoryImpl.this, null));
                final SharedSessionRepositoryImpl sharedSessionRepositoryImpl = SharedSessionRepositoryImpl.this;
                this.label = 1;
                if (m10749catch.collect(new FlowCollector() { // from class: com.google.firebase.sessions.SharedSessionRepositoryImpl.1.2
    ...
    */
    ...
    public final boolean isSessionExpired(SessionData sessionData) {
        ...
        if (backgroundTime != null) {
            boolean z = Duration.m10557compareToLRDsOJo(this.timeProvider.currentTime().m9068minus5sfh64U(backgroundTime), this.sessionsSettings.m9072getSessionRestartTimeoutUwyO8pc()) > 0;
            if (z) {
