...
public final class SessionLifecycleService extends Service {
    ...
    public static final class MessageHandler extends Handler {
        private final ArrayList<android.os.Messenger> boundClients;
        ...
        private final void broadcastSession() {
            ...
            for (android.os.Messenger it : new ArrayList(this.boundClients)) {
                Intrinsics.checkNotNullExpressionValue(it, "it");
                maybeSendSessionToClient(it);
            }
        }

        private final void maybeSendSessionToClient(android.os.Messenger messenger) {
            try {
                if (this.hasForegrounded) {
        ...
        private final void sendSessionToClient(android.os.Messenger messenger, String str) {
            try {
        ...
        private final boolean isSessionRestart(long j) {
            return j - this.lastMsgTimeMs > Duration.m9801getInWholeMillisecondsimpl(SessionsSettings.Companion.getInstance().m8295getSessionRestartTimeoutUwyO8pc());
        }
    }
    ...
    private final android.os.Messenger getClientCallback(Intent intent) {
