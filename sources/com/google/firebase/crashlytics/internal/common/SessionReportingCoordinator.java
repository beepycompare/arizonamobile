...
public class SessionReportingCoordinator {
        ...
        if (!z) {
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SessionReportingCoordinator.this.m8847x631b9fbf(addMetaDataToEvent, eventMetadata, equals);
                }
            });
        } else {
    ...
    public /* synthetic */ void m8847x631b9fbf(CrashlyticsReport.Session.Event event, EventMetadata eventMetadata, boolean z) {
