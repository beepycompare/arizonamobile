...
public class FirebaseRemoteConfig {
    ...
    public Task<FirebaseRemoteConfigInfo> ensureInitialized() {
        ...
        return Tasks.whenAllComplete(task, task2, task3, call, this.firebaseInstallations.getId(), this.firebaseInstallations.getToken(false)).continueWith(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda9
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda10
            ...
            public final Task then(Object obj) {
                return FirebaseRemoteConfig.this.m10022xebd5994c((Void) obj);
            }
        });
    }
    ...
    public /* synthetic */ Task m10022xebd5994c(Void r1) throws Exception {
        return activate();
    }
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete(task, task2).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task3) {
                return FirebaseRemoteConfig.this.m10021x98ca96b0(task, task2, task3);
            }
        });
    }
    ...
    public /* synthetic */ Task m10021x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda7
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return FirebaseRemoteConfig.this.m10024xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }
    ...
    public /* synthetic */ Void m10024xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public Task<Void> reset() {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda6
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return FirebaseRemoteConfig.this.m10023xf98246b6();
            }
        });
    }
    ...
    public /* synthetic */ Void m10023xf98246b6() throws Exception {
    ...
    public Task<Void> setCustomSignals(final CustomSignals customSignals) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return FirebaseRemoteConfig.this.m10025x5520461b(customSignals);
            }
        });
    }
    ...
    public /* synthetic */ Void m10025x5520461b(CustomSignals customSignals) throws Exception {
