                ...
                if (this.zzi < i) {
                    ...
                    if (zzkhVar != null && zzkhVar.zzb() != null) {
                        ...
                        if (absent.isPresent()) {
                            ...
                            str = ((zzjt) absent.get()).zza(zzkgVar.zza, null, zzkgVar.zzc, this.zzb);
                            Preconditions.checkState(zzkhVar == null, "Must call PhenotypeFlagInitializer.maybeInit() first");
                            zzkg zzkgVar2 = this.zza;
                            uri = zzkgVar2.zza;
                            if (uri == null) {
                                zza = zzka.zza(zzkhVar.zza(), uri) ? zzjr.zza(zzkhVar.zza().getContentResolver(), uri, zzkj.zza) : null;
                            } else {
                                zza = zzko.zza(zzkhVar.zza(), (String) Preconditions.checkNotNull(null), zzki.zza);
                            }
