    ...
    public final void zza() {
        ...
        try {
            ...
            if (zzcvVar != null) {
                ...
                zzdh zzdhVar = new zzdh(119002L, Math.max(localVersion, remoteVersion), DynamiteModule.getRemoteVersion(context, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzig.zza(context));
