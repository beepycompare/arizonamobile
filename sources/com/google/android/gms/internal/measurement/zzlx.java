...
public abstract class zzlx {
    ...
    public static zzlp zzb(Class cls) {
        ...
        } else if (!cls.getPackage().equals(zzlx.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzlp) cls.cast(((zzlx) Class.forName(format, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
