...
final class zzwp {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x002b, code lost:
        if (r6.containsKey(r7) != false) goto L33;
     */
    ...
    */
            ...
            while (true) {
                ...
                while (true) {
                    if (zzwpVar.zzf > 0) {
                        ...
                        int i5 = ((zzwn) zzwnVar2.zzd.get(Integer.valueOf(iArr2[zzwpVar.zzd]))).zza;
                        int i6 = zzwpVar.zze;
                        if (iArr2[i5 + i6] != i3) {
                            zzwn zzwnVar3 = (zzwn) zzwpVar.zzc.zzd.get(Integer.valueOf(iArr2[zzwpVar.zzd]));
                            zzwn zzwnVar4 = new zzwn(zzwnVar3.zza, (zzwpVar.zze + i) - 1, null);
                            zzwpVar.zzc.zzd.put(Integer.valueOf(iArr2[zzwpVar.zzd]), zzwnVar4);
                            Map map = zzwnVar4.zzd;
                            int i7 = zzwnVar4.zzb + 1;
                            map.put(Integer.valueOf(iArr2[i7]), zzwnVar3);
                            zzwnVar3.zza = i7;
                            if (zzwnVar != null) {
                                zzwnVar.zzc = zzwnVar4;
                            }
                            map.put(Integer.valueOf(i3), new zzwn(i2, 1073741824, null));
                            zzwpVar.zzf--;
                            zzwpVar.zzc();
                            zzwnVar = zzwnVar4;
                        } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0058, code lost:
        if (zzf(r9, r10, r5, (r5 + r10) - r9) != false) goto L20;
     */
