...
public final class zznu {
    ...
    public static int zza(List list) {
        ...
        if (!(list instanceof zzme)) {
            int i2 = 0;
            while (i < size) {
                i2 += zzlk.zzA(((Integer) list.get(i)).intValue());
                i++;
            }
            return i2;
        }
    ...
    public static int zzg(List list) {
        ...
        if (!(list instanceof zzmw)) {
            int i2 = 0;
            while (i < size) {
                i2 += zzlk.zzA(((Long) list.get(i)).longValue());
                i++;
            }
            return i2;
        }
    ...
    public static int zzi(List list) {
        ...
        if (!(list instanceof zzme)) {
            ...
            while (i < size) {
                ...
                i2 += zzlk.zzz((intValue >> 31) ^ (intValue + intValue));
                i++;
            }
            return i2;
        }
    ...
    public static int zzj(List list) {
        ...
        if (!(list instanceof zzmw)) {
            ...
            while (i < size) {
                ...
                i2 += zzlk.zzA((longValue >> 63) ^ (longValue + longValue));
                i++;
            }
            return i2;
        }
    ...
    public static int zzk(List list) {
        ...
        if (!(list instanceof zzme)) {
            int i2 = 0;
            while (i < size) {
                i2 += zzlk.zzz(((Integer) list.get(i)).intValue());
                i++;
            }
            return i2;
        }
    ...
    */
    public static Object zzn(Object obj, int i, int i2, Object obj2, zzoe zzoeVar) {
        ...
        if (obj2 == null) {
            ...
            zzof zzofVar2 = zzmdVar.zzc;
            zzofVar = zzofVar2;
            if (zzofVar2 == zzof.zzc()) {
                zzof zzf = zzof.zzf();
                zzmdVar.zzc = zzf;
                zzofVar = zzf;
            }
        }
        ((zzof) zzofVar).zzj(i << 3, Long.valueOf(i2));
        return zzofVar;
    }
