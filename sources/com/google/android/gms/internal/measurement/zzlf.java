        ...
        if (optional2 == null) {
            synchronized (zzlf.class) {
                ...
                if (optional == null) {
                    ...
                    Context createDeviceProtectedStorageContext = (!zzky.zza() || context.isDeviceProtectedStorage()) ? context : context.createDeviceProtectedStorageContext();
