        ...
        if (bundle != null) {
            ...
            for (String str3 : new TreeSet(bundle.keySet())) {
                ...
                if (zzi != 0) {
                    ...
                    int zza2 = zza(str, str2, str3, bundle.get(str3), bundle2, list2, z, zzaC);
                    if (zza2 == 17) {
        ...
        for (String str5 : new TreeSet(bundle.keySet())) {
            ...
            if (zzi != 0) {
                ...
                if (zzal(bundle.get(str5))) {
                    ...
                    str4 = null;
                    zza2 = zza(str, str2, str5, bundle.get(str5), bundle, list2, z, false);
                }
                if (zza2 == 0 || "_ev".equals(str5)) {
                    if (zzaq(str5) && !zzaC(str5, zzjz.zzd)) {
                        i2++;
