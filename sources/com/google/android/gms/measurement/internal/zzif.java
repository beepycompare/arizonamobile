...
public final class zzif extends zzpg implements zzal {
    ...
    private final void zzH(String str, com.google.android.gms.internal.measurement.zzgn zzgnVar) {
        ...
        for (com.google.android.gms.internal.measurement.zzgk zzgkVar : zzgnVar.zzh()) {
            hashSet.add(zzgkVar.zzb());
        }
        ...
        if (zzgoVar.zza() != 0) {
            ...
            try {
                ...
                for (com.google.android.gms.internal.measurement.zzit zzitVar : zzivVar.zza().zzd()) {
                    zzioVar.zzaW().zzj().zzb("EES program activity", zzitVar.zzb());
                }
                return;
    ...
    public final SortedSet zzp(String str) {
        ...
        com.google.android.gms.internal.measurement.zzgi zzi = zzi(str);
        if (zzi != null) {
            for (com.google.android.gms.internal.measurement.zzgh zzghVar : zzi.zzc()) {
                treeSet.add(zzghVar.zzb());
            }
        }
        return treeSet;
    }
