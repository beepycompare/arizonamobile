...
public final class zzaw extends zzos {
    ...
    */
    private final zzbd zzaE(String str, String str2, String str3) {
        String str4;
        Cursor cursor;
        Cursor cursor2;
        Boolean bool;
        ...
        try {
            ...
            if (zzb2 != zzls.GOOGLE_SIGNAL && zzb2 != zzls.GOOGLE_SIGNAL_PENDING && i2 > 0) {
                ...
                for (com.google.android.gms.internal.measurement.zzid zzidVar : zzhzVar.zza()) {
                    com.google.android.gms.internal.measurement.zzic zzicVar = (com.google.android.gms.internal.measurement.zzic) zzidVar.zzco();
                    zzicVar.zzao(i2);
    ...
    */
    public final zzpj zzB(long j) {
        ...
        zzpj zzaH = zzaH((String) Preconditions.checkNotNull(cursor4.getString(1)), j, cursor4.getBlob(2), cursor4.getString(3), cursor4.getString(4), cursor4.getInt(5), cursor4.getInt(6), cursor4.getLong(7), cursor4.getLong(8), cursor4.getLong(9));
        if (cursor4 != null) {
            cursor4.close();
        }
        return zzaH;
        ...
        try {
            ...
            try {
                ...
                while (cursor3.moveToNext()) {
                    ...
                    List list2 = list;
                    try {
                        zzpj zzaH = zzaH(str2, j, blob, string, string2, i9, i10, j2, j3, cursor3.getLong(9));
                        if (zzaH != null) {
                            list2.add(zzaH);
                        }
                        list = list2;
    ...
    */
        ...
        if (zzai()) {
            ...
            if (abs > zzal.zzJ()) {
                ...
                if (zzai()) {
                    SQLiteDatabase zze2 = zze();
                    zzicVar.zzc();
                    int delete = zze2.delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(zzicVar.zzba().currentTimeMillis()), String.valueOf(zzal.zzI())});
                    if (delete > 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x00ae, code lost:
        r13.zzu.zzaW().zzb().zzd("Error inserting column. appId", com.google.android.gms.measurement.internal.zzgu.zzl(r14), "first_open_count", r15);
     */
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Bundle zzV(String str) {
        Cursor cursor;
        Cursor cursor2;
        zzg();
        zzay();
            ...
            try {
                ...
                try {
                    if (!cursor.moveToFirst()) {
                        ...
                        try {
                            com.google.android.gms.internal.measurement.zzhs zzhsVar = (com.google.android.gms.internal.measurement.zzhs) ((com.google.android.gms.internal.measurement.zzhr) zzpk.zzw(com.google.android.gms.internal.measurement.zzhs.zzp(), cursor.getBlob(0))).zzbd();
                            this.zzg.zzp();
                            Bundle zzH = zzpk.zzH(zzhsVar.zza());
                            if (cursor != null) {
                                cursor.close();
                            }
                            return zzH;
    ...
    /* JADX WARN: Removed duplicated region for block: B:95:0x02d9 A[Catch: SQLiteException -> 0x02ef, TRY_LEAVE, TryCatch #4 {SQLiteException -> 0x02ef, blocks: (B:93:0x02be, B:95:0x02d9), top: B:108:0x02be }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void zzX(String str, Long l, String str2, Bundle bundle) {
        ...
        zzg();
        zzay();
        zzau zzauVar = l != null ? new zzau(this, str4, l.longValue()) : new zzau(this, str4);
        List zza2 = zzauVar.zza();
        while (!zza2.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    ...
                    try {
                        try {
                            query = zze().query("raw_events_metadata", new String[]{TtmlNode.TAG_METADATA}, "app_id = ? and metadata_fingerprint = ?", new String[]{str4, Long.toString(zzatVar.zzb)}, null, null, "rowid", ExifInterface.GPS_MEASUREMENT_2D);
                        } catch (SQLiteException e) {
                            e = e;
                            zzidVar = null;
                        }
                    ...
                    try {
                        ...
                        if (query.moveToFirst()) {
                            try {
                                zzidVar = (com.google.android.gms.internal.measurement.zzid) ((com.google.android.gms.internal.measurement.zzic) zzpk.zzw(com.google.android.gms.internal.measurement.zzid.zzaE(), query.getBlob(0))).zzbd();
                            } catch (IOException e3) {
                                this.zzu.zzaW().zzb().zzc("Data loss. Failed to merge raw event metadata. appId", zzgu.zzl(str4), e3);
                            }
                            try {
                                if (query.moveToNext()) {
                                ...
                                zzgv zzgvVar = new zzgv(zzd2, string, bundle3, zzhsVar.zzf(), zzhsVar.zzo());
                                zzic zzicVar = this.zzu;
                                ...
                                zzk2.zzK(bundle4, bundle2);
                                zzau zzauVar2 = zzauVar;
                                Iterator it2 = it;
                                zzbc zzbcVar = new zzbc(this.zzu, zzgvVar.zzb, str4, zzhsVar.zzd(), zzhsVar.zzf(), zzhsVar.zzo(), zzhsVar.zzi(), bundle4);
                                long j = zzatVar.zza;
                                long j2 = zzatVar.zzb;
                                ...
                                String str5 = zzbcVar.zza;
                                Preconditions.checkNotEmpty(str5);
                                byte[] zzcd = zzpgVar2.zzp().zzh(zzbcVar).zzcd();
                                ContentValues contentValues = new ContentValues();
                ...
                com.google.android.gms.internal.measurement.zzhs zzhsVar2 = zzatVar.zzd;
                ...
                for (com.google.android.gms.internal.measurement.zzhw zzhwVar : zzhsVar2.zza()) {
                    if (zzhwVar.zzj()) {
                        ...
                        zzp2.zzu.zzaW().zzb().zzb("Unexpected parameter type for parameter", zzhwVar);
                    } else {
                ...
                zzgv zzgvVar2 = new zzgv(zzd22, string, bundle32, zzhsVar2.zzf(), zzhsVar2.zzo());
                zzic zzicVar2 = this.zzu;
                Bundle bundle42 = zzgvVar2.zze;
                str3 = zzgvVar2.zza;
                ...
                zzk22.zzK(bundle42, bundle2);
                zzau zzauVar22 = zzauVar;
                Iterator it22 = it;
                zzbc zzbcVar2 = new zzbc(this.zzu, zzgvVar2.zzb, str4, zzhsVar2.zzd(), zzhsVar2.zzf(), zzhsVar2.zzo(), zzhsVar2.zzi(), bundle42);
                long j3 = zzatVar.zza;
                ...
                String str52 = zzbcVar2.zza;
                Preconditions.checkNotEmpty(str52);
                byte[] zzcd2 = zzpgVar22.zzp().zzh(zzbcVar2).zzcd();
                ContentValues contentValues2 = new ContentValues();
                contentValues2.put("app_id", str52);
                contentValues2.put("name", zzbcVar2.zzb);
                ...
                try {
                    ...
                    if (update != 1) {
                        zzicVar2.zzaW().zzb().zzc("Failed to update raw event. appId, updatedRows", zzgu.zzl(str52), Long.valueOf(update));
                    }
                } catch (SQLiteException e5) {
                    this.zzu.zzaW().zzb().zzc("Error updating raw event. appId", zzgu.zzl(zzbcVar2.zza), e5);
                }
                str4 = str;
                zzauVar = zzauVar22;
                it = it22;
    ...
    */
    ...
    public final List zzac(String str) {
        ...
        try {
            ...
            try {
                try {
                    cursor = zze2.query("diagnostic_signals", new String[]{"signal_name", TtmlNode.TAG_METADATA, "count"}, "app_id=?", new String[]{str}, null, null, "rowid", null);
                    if (!cursor.moveToFirst()) {
                        zze2.setTransactionSuccessful();
                    } else {
    ...
    */
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (zzfcVar.zzd() != 0) {
                for (int i2 = 0; i2 < zzfcVar.zzd(); i2++) {
                    ...
                    com.google.android.gms.internal.measurement.zzfe zzfeVar2 = (com.google.android.gms.internal.measurement.zzfe) zzfeVar.zzaS();
                    ...
                    while (i3 < zzfeVar.zzc()) {
                        ...
                        String zzc2 = zzlt.zzc(zzd2.zzi(), zzjn.zza, zzjn.zzb);
                        if (zzc2 != null) {
                            com.google.android.gms.internal.measurement.zzfg zzfgVar = (com.google.android.gms.internal.measurement.zzfg) zzd2.zzco();
                            zzfgVar.zza(zzc2);
            ...
            if (zzfcVar.zza() != 0) {
                for (int i4 = 0; i4 < zzfcVar.zza(); i4++) {
                    ...
                    if (zzc3 != null) {
                        com.google.android.gms.internal.measurement.zzfm zzfmVar = (com.google.android.gms.internal.measurement.zzfm) zzb3.zzco();
                        zzfmVar.zza(zzc3);
                    ...
                    while (true) {
                        if (it2.hasNext()) {
                            if (!((com.google.android.gms.internal.measurement.zzff) it2.next()).zza()) {
                                this.zzu.zzaW().zze().zzc("Event filter with no ID. Audience definition ignored. appId, audienceId", zzgu.zzl(str), Integer.valueOf(zzb4));
                                break;
                            }
                        } else {
                            break;
    ...
    /* JADX WARN: Removed duplicated region for block: B:78:0x0242 A[DONT_GENERATE] */
        ...
        try {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                try {
                    ...
                    e = e2;
                    this.zzu.zzaW().zzb().zzc("Data loss. Error selecting raw event. appId", zzgu.zzl(str2), e);
                }
            } else {
            ...
            if (!cursor.moveToFirst()) {
                this.zzu.zzaW().zzb().zzb("Raw event metadata record is missing. appId", zzgu.zzl(str2));
            } else {
                try {
                    com.google.android.gms.internal.measurement.zzid zzidVar = (com.google.android.gms.internal.measurement.zzid) ((com.google.android.gms.internal.measurement.zzic) zzpk.zzw(com.google.android.gms.internal.measurement.zzid.zzaE(), cursor.getBlob(0))).zzbd();
                    if (cursor.moveToNext()) {
                        this.zzu.zzaW().zze().zzb("Get multiple raw event metadata records, expected one. appId", zzgu.zzl(str2));
                    }
                    cursor.close();
                    Preconditions.checkNotNull(zzidVar);
                    zzpcVar.zza = zzidVar;
                    long zzaB = zzaB("select (rowid - 1) as max_rowid from raw_events where app_id = ? and metadata_fingerprint != ? order by rowid limit 1;", new String[]{str2, string}, -1L);
                    if (j2 != -1) {
                        j3 = j2;
                    } else if (zzaB != -1) {
                        j3 = -1;
                        ...
                        cursor = zze2.query("raw_events", new String[]{"rowid", "name", "timestamp", "data", "elapsed_time"}, str4, strArr, null, null, "rowid", null);
                        if (cursor.moveToFirst()) {
                            this.zzu.zzaW().zze().zzb("Raw event data disappeared while in transaction. appId", zzgu.zzl(str2));
                        } else {
                            while (true) {
                                ...
                                try {
                                    ...
                                    i = i4;
                                    this.zzu.zzaW().zzb().zzc("Data loss. Failed to merge raw event. appId", zzgu.zzl(str2), e3);
                                }
                                if (!cursor.moveToNext()) {
                                    break;
                                }
                    ...
                    strArr = new String[]{str2, string, String.valueOf(zzaB)};
                    cursor = zze2.query("raw_events", new String[]{"rowid", "name", "timestamp", "data", "elapsed_time"}, str4, strArr, null, null, "rowid", null);
                    if (cursor.moveToFirst()) {
                    }
                } catch (IOException e4) {
                    this.zzu.zzaW().zzb().zzc("Data loss. Failed to merge raw event metadata. appId", zzgu.zzl(str2), e4);
                }
            }
        } finally {
            if (0 != 0) {
                        ...
                        if (cursor2.moveToFirst()) {
                            while (true) {
                                ...
                                if (zzL != null) {
                                    ...
                                    try {
                                        zzicVar.zzaW().zzb().zzd("(2)Read invalid user property value, ignoring it", zzgu.zzl(str6), string2, str3);
                                        str5 = string2;
                                    } catch (SQLiteException e3) {
                                        e = e3;
                                        str5 = string2;
    ...
    public final zzah zzq(String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                cursor5 = cursor2;
                zzic zzicVar = this.zzu;
                zzicVar.zzaW().zzb().zzd("Error querying conditional property", zzgu.zzl(str), zzicVar.zzl().zzc(str3), e);
                zzahVar = cursor2;
                if (cursor5 != null) {
                }
                return zzahVar;
        ...
        String str4 = string;
        try {
            zzah zzahVar2 = new zzah(str, str4, new zzpl(str3, cursor5.getLong(8), zzL, str4), cursor5.getLong(6), z, string2, (zzbh) zzpgVar.zzp().zzl(cursor5.getBlob(5), zzbh.CREATOR), j, (zzbh) zzpgVar.zzp().zzl(cursor5.getBlob(7), zzbh.CREATOR), cursor5.getLong(9), (zzbh) zzpgVar.zzp().zzl(cursor5.getBlob(10), zzbh.CREATOR));
            if (cursor5.moveToNext()) {
                zzic zzicVar2 = this.zzu;
                zzicVar2.zzaW().zzb().zzc("Got multiple records for conditional property, expected one", zzgu.zzl(str), zzicVar2.zzl().zzc(str3));
            }
            if (cursor5 != null) {
                cursor5.close();
            }
            ...
            zzicVar3.zzaW().zzb().zzd("Error querying conditional property", zzgu.zzl(str), zzicVar3.zzl().zzc(str3), e);
            zzahVar = cursor2;
            if (cursor5 != null) {
            }
            return zzahVar;
    ...
    */
            ...
            try {
                if (cursor2.moveToFirst()) {
                    while (true) {
                        ...
                        zzpg zzpgVar = this.zzg;
                        arrayList.add(new zzah(string, string2, new zzpl(string3, cursor2.getLong(10), zzL, string2), cursor2.getLong(8), z, string4, (zzbh) zzpgVar.zzp().zzl(cursor2.getBlob(7), zzbh.CREATOR), j, (zzbh) zzpgVar.zzp().zzl(cursor2.getBlob(9), zzbh.CREATOR), cursor2.getLong(11), (zzbh) zzpgVar.zzp().zzl(cursor2.getBlob(12), zzbh.CREATOR)));
                        if (!cursor2.moveToNext()) {
                            break;
                        }
                        i = 0;
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x020c A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x0255  */
    /* JADX WARN: Removed duplicated region for block: B:36:0x0258 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:39:0x0267 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x0283 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:45:0x0294 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:51:0x02d5 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x02ef A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:60:0x0303  */
    /* JADX WARN: Removed duplicated region for block: B:61:0x0306 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:67:0x032e  */
    /* JADX WARN: Removed duplicated region for block: B:68:0x0331 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:71:0x0346 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:74:0x0359 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:77:0x0375 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:80:0x0388 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    /* JADX WARN: Removed duplicated region for block: B:85:0x03a0 A[Catch: SQLiteException -> 0x03b7, all -> 0x03e1, TRY_LEAVE, TryCatch #0 {all -> 0x03e1, blocks: (B:6:0x013e, B:9:0x0146, B:11:0x015d, B:12:0x0164, B:14:0x0177, B:15:0x017e, B:17:0x01bd, B:22:0x01c7, B:26:0x0211, B:28:0x0240, B:33:0x024a, B:37:0x025c, B:39:0x0267, B:40:0x0279, B:42:0x0283, B:43:0x028c, B:45:0x0294, B:49:0x029d, B:51:0x02d5, B:52:0x02e7, B:54:0x02ef, B:58:0x02f8, B:65:0x0311, B:69:0x033b, B:71:0x0346, B:72:0x0351, B:74:0x0359, B:75:0x0364, B:77:0x0375, B:78:0x037c, B:80:0x0388, B:82:0x0390, B:83:0x0397, B:85:0x03a0, B:68:0x0331, B:61:0x0306, B:64:0x030d, B:36:0x0258, B:25:0x020c, B:101:0x03c8), top: B:110:0x000d }] */
    ...
    */
    public final zzh zzu(String str) {
        ...
        if (zzB.zzo(zzjkVar)) {
            zzhVar2.zze(cursor5.getString(0));
        }
        zzhVar2.zzg(cursor5.getString(1));
        if (zzpgVar.zzB(str).zzo(zzjk.AD_STORAGE)) {
            zzhVar2.zzk(cursor5.getString(2));
        }
        zzhVar2.zzF(cursor5.getLong(3));
        zzhVar2.zzo(cursor5.getLong(4));
        zzhVar2.zzq(cursor5.getLong(5));
        zzhVar2.zzs(cursor5.getString(6));
        zzhVar2.zzw(cursor5.getString(7));
        zzhVar2.zzy(cursor5.getLong(8));
        zzhVar2.zzA(cursor5.getLong(9));
        if (!cursor5.isNull(10) && cursor5.getInt(10) == 0) {
            z = false;
            zzhVar2.zzE(z);
            zzhVar2.zzO(cursor5.getLong(11));
            zzhVar2.zzQ(cursor5.getLong(12));
            zzhVar2.zzS(cursor5.getLong(13));
            zzhVar2.zzU(cursor5.getLong(14));
            zzhVar2.zzI(cursor5.getLong(15));
            zzhVar2.zzK(cursor5.getLong(16));
            zzhVar2.zzu(!cursor5.isNull(17) ? SieveCacheKt.NodeMetaAndPreviousMask : cursor5.getInt(17));
            zzhVar2.zzm(cursor5.getString(18));
            zzhVar2.zzY(cursor5.getLong(19));
            zzhVar2.zzW(cursor5.getLong(20));
            zzhVar2.zzab(cursor5.getString(21));
            if (!cursor5.isNull(23) && cursor5.getInt(23) == 0) {
                z2 = false;
                zzhVar2.zzad(z2);
                zzhVar2.zzC(!cursor5.isNull(25) ? 0L : cursor5.getLong(25));
                if (!cursor5.isNull(26)) {
                    zzhVar2.zzah(Arrays.asList(cursor5.getString(26).split(StringUtils.COMMA, -1)));
                }
                if (zzpgVar.zzB(str).zzo(zzjkVar)) {
                    zzhVar2.zzi(cursor5.getString(28));
                }
                zzhVar2.zzaj(cursor5.isNull(29) && cursor5.getInt(29) != 0);
                zzhVar2.zzaE(cursor5.getLong(39));
                zzhVar2.zzaz(cursor5.getString(36));
                zzhVar2.zzal(cursor5.getLong(30));
                zzhVar2.zzan(cursor5.getLong(31));
                zzaif.zza();
                zzicVar = this.zzu;
                if (zzicVar.zzc().zzp(str, zzfy.zzaO)) {
                    zzhVar2.zzap(cursor5.getInt(32));
                    zzhVar2.zzax(cursor5.getLong(35));
                }
                zzhVar2.zzar(cursor5.isNull(33) && cursor5.getInt(33) != 0);
                if (cursor5.isNull(34)) {
                    valueOf = Boolean.valueOf(cursor5.getInt(34) != 0);
                } else {
                    valueOf = null;
                }
                zzhVar2.zzaf(valueOf);
                zzhVar2.zzaB(cursor5.getInt(37));
                zzhVar2.zzaD(cursor5.getInt(38));
                zzhVar2.zzaG(!cursor5.isNull(40) ? "" : (String) Preconditions.checkNotNull(cursor5.getString(40)));
                if (!cursor5.isNull(41)) {
                    zzhVar2.zzat(Long.valueOf(cursor5.getLong(41)));
                }
                if (!cursor5.isNull(42)) {
                    zzhVar2.zzav(Long.valueOf(cursor5.getLong(42)));
                }
                zzhVar2.zzaI(cursor5.getBlob(43));
                if (!cursor5.isNull(44)) {
                    zzhVar2.zzaK(cursor5.getInt(44));
                }
                if (zzicVar.zzc().zzp(str, zzfy.zzbj) && !cursor5.isNull(45)) {
                    zzhVar2.zzaM(cursor5.getLong(45));
                }
                zzhVar2.zzb();
                if (cursor5.moveToNext()) {
            ...
            if (zzicVar.zzc().zzp(str, zzfy.zzbj)) {
                zzhVar2.zzaM(cursor5.getLong(45));
            }
            zzhVar2.zzb();
            if (cursor5.moveToNext()) {
    ...
    */
    public final boolean zzz(com.google.android.gms.internal.measurement.zzid zzidVar, boolean z) {
        ...
        zzicVar.zzaW().zze().zzd("Storing bundle outside of the max uploading time span. appId, now, timestamp", zzgu.zzl(zzidVar.zzA()), Long.valueOf(currentTimeMillis), Long.valueOf(zzidVar.zzo()));
        try {
            byte[] zzv = this.zzg.zzp().zzv(zzidVar.zzcd());
            zzic zzicVar2 = this.zzu;
            zzicVar2.zzaW().zzk().zzb("Saving bundle, size", Integer.valueOf(zzv.length));
            ContentValues contentValues = new ContentValues();
