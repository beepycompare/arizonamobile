...
public final class zabk implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zat {
    ...
    private final void zaN(ConnectionResult connectionResult) {
        ...
        for (zal zalVar : set) {
            zalVar.zac(this.zad, connectionResult, com.google.android.gms.common.internal.Objects.equal(connectionResult, ConnectionResult.RESULT_SUCCESS) ? this.zac.getEndpointPackageName() : null);
        }
        set.clear();
    }
    ...
    public final void zac(ConnectionResult connectionResult, Exception exc) {
        ...
        if (connectionResult.getErrorCode() == 4) {
            ...
            zav(status);
        } else if (connectionResult.getErrorCode() == 25) {
            ...
            if (queue.isEmpty()) {
                ...
                boolean zaG = googleApiManager.zaG();
                ApiKey apiKey = this.zad;
                if (zaG) {
