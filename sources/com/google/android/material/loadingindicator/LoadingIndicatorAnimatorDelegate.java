...
public class LoadingIndicatorAnimatorDelegate {
    ...
    private void updateIndicatorShapeAndColor() {
        ...
        int i = this.specs.indicatorColors[length];
        int i2 = this.specs.indicatorColors[length2];
        this.indicatorState.color = ArgbEvaluatorCompat.getInstance().evaluate(MathUtils.clamp(this.morphFactor - (this.morphFactorTarget - 1), 0.0f, 1.0f), Integer.valueOf(i), Integer.valueOf(i2)).intValue();
    }
