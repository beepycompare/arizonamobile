...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setAction(CharSequence charSequence, final View.OnClickListener onClickListener) {
        ...
        actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                Snackbar.this.m9573lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(onClickListener, view);
            }
        });
        return this;
    }
    ...
    public /* synthetic */ void m9573lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
