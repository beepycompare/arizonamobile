    ...
    private void maybeUpdateSegmentColors(int i) {
        ...
        while (true) {
            ...
            if (fractionInRange >= 0.0f && fractionInRange <= 1.0f) {
                ...
                this.activeIndicators.get(0).color = ArgbEvaluatorCompat.getInstance().evaluate(this.standardInterpolator.getInterpolation(fractionInRange), Integer.valueOf(this.baseSpec.indicatorColors[length]), Integer.valueOf(this.baseSpec.indicatorColors[length2])).intValue();
                return;
            }
            i2++;
        }
