...
final class LinearDrawingDelegate extends DrawingDelegate<LinearProgressIndicatorSpec> {
    ...
    private void drawLine(Canvas canvas, Paint paint, float f, float f2, int i, int i2, int i3, float f3, float f4, boolean z) {
        ...
        int clamp3 = (int) ((lerp * f7) + ((int) ((i2 * MathUtils.clamp(lerp, 0.0f, 0.01f)) / 0.01f)));
        int clamp4 = (int) ((lerp2 * f7) - ((int) ((i3 * (1.0f - MathUtils.clamp(lerp2, 0.99f, 1.0f))) / 0.01f)));
        ...
        if (f8 != f9) {
            ...
            float f11 = max / f10;
            float lerp3 = com.google.android.material.math.MathUtils.lerp(this.displayedCornerRadius, this.displayedInnerCornerRadius, MathUtils.clamp(clamp3 / f10, 0.0f, f11) / f11);
            float f12 = this.displayedCornerRadius;
            float f13 = this.displayedInnerCornerRadius;
            float f14 = this.trackLength;
            f6 = com.google.android.material.math.MathUtils.lerp(f12, f13, MathUtils.clamp((f14 - clamp4) / f14, 0.0f, f11) / f11);
            f5 = lerp3;
        } else {
            f5 = f8;
            f6 = f5;
