...
public final class DrawablePainter extends Painter implements RememberObserver {
    ...
    public DrawablePainter(Drawable drawable) {
        ...
        this.callback$delegate = LazyKt.lazy(new Function0() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return DrawablePainter.callback_delegate$lambda$0(DrawablePainter.this);
            }
        });
    ...
    private final long m9480getDrawableIntrinsicSizeNHjbRc() {
        return ((Size) this.drawableIntrinsicSize$delegate.getValue()).m5177unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setDrawableIntrinsicSize-uvyYCjk  reason: not valid java name */
    public final void m9481setDrawableIntrinsicSizeuvyYCjk(long j) {
    ...
    public static final DrawablePainter$callback$2$1 callback_delegate$lambda$0(final DrawablePainter drawablePainter) {
        return new Drawable.Callback() { // from class: com.google.accompanist.drawablepainter.DrawablePainter$callback$2$1
            ...
            public void invalidateDrawable(Drawable d) {
                ...
                drawablePainter2.m9481setDrawableIntrinsicSizeuvyYCjk(intrinsicSize);
            }
    ...
    public long mo6042getIntrinsicSizeNHjbRc() {
        return m9480getDrawableIntrinsicSizeNHjbRc();
    }
