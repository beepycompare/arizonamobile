...
public final class InetAddresses {
    ...
    */
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        return substring + hexString + StringUtils.PROCESS_POSTFIX_DELIMITER + Integer.toHexString((textToNumericFormatV4[3] & 255) | ((textToNumericFormatV4[2] & 255) << 8));
    }
    ...
    private static InetAddress forUriStringOrNull(String hostAddr, boolean parseScope) {
        ...
        byte[] ipStringToBytes = ipStringToBytes(hostAddr, scope);
