...
public final class GeneralRange<T> implements Serializable {
    ...
    public String toString() {
        return this.comparator + StringUtils.PROCESS_POSTFIX_DELIMITER + (this.lowerBoundType == BoundType.CLOSED ? AbstractJsonLexerKt.BEGIN_LIST : '(') + (this.hasLowerBound ? this.lowerEndpoint : "-∞") + AbstractJsonLexerKt.COMMA + (this.hasUpperBound ? this.upperEndpoint : "∞") + (this.upperBoundType == BoundType.CLOSED ? AbstractJsonLexerKt.END_LIST : ')');
    }
