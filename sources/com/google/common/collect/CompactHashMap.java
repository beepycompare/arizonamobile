    ...
    public V put(@ParametricNullness K key, @ParametricNullness V value) {
        ...
        if (tableGet != 0) {
            ...
            while (true) {
                ...
                if (CompactHashing.getHashPrefix(i6, hashTableMask) == hashPrefix && Objects.equal(key, requireKeys[i5])) {
                    V v = (V) requireValues[i5];
                    requireValues[i5] = value;
                    accessEntry(i5);
                    return v;
                }
        ...
        resizeMeMaybe(i2);
        insertEntry(i, key, value, smearedHash, hashTableMask);
        this.size = i2;
        incrementModCount();
        return null;
    }
