...
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
        ...
        do {
            ...
            if (atomicInteger != null || (atomicInteger = this.countMap.putIfAbsent(element, new AtomicInteger(occurrences))) != null) {
                while (true) {
                    ...
                    try {
                        if (atomicInteger.compareAndSet(i, IntMath.checkedAdd(i, occurrences))) {
                            return i;
                        }
    ...
    */
    public int setCount(E element, int count) {
        ...
        do {
            ...
            while (true) {
                ...
                if (i == 0) {
                    break;
                } else if (atomicInteger.compareAndSet(i, count)) {
                    if (count == 0) {
                        this.countMap.remove(element, atomicInteger);
                    }
                    return i;
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        FieldSettersHolder.COUNT_MAP_FIELD_SETTER.set((Serialization.FieldSetter<? super ConcurrentHashMultiset<?>>) this, (Object) ((ConcurrentMap) Objects.requireNonNull(stream.readObject())));
    }
}
