...
public final class TriggerBasedInvalidationTracker$syncTriggers$2$1$1 extends SuspendLambda implements Function2<Transactor, Continuation<? super Boolean>, Object> {
    ...
    public TriggerBasedInvalidationTracker$syncTriggers$2$1$1(ObservedTableStates.ObserveOp[] observeOpArr, TriggerBasedInvalidationTracker triggerBasedInvalidationTracker, Continuation<? super TriggerBasedInvalidationTracker$syncTriggers$2$1$1> continuation) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x005f, code lost:
        if (r1.withTransaction(androidx.room.Transactor.SQLiteTransactionType.IMMEDIATE, new androidx.room.TriggerBasedInvalidationTracker$syncTriggers$2$1$1.AnonymousClass1(r8.$tablesToSync, r8.this$0, r1, null), r8) == r0) goto L18;
     */
    ...
    */
    ...
    @DebugMetadata(c = "androidx.room.TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1", f = "InvalidationTracker.kt", i = {0, 0, 1, 1}, l = {TypedValues.AttributesType.TYPE_EASING, TypedValues.AttributesType.TYPE_PIVOT_TARGET}, m = "invokeSuspend", n = {"$this$forEachIndexed$iv", "index$iv", "$this$forEachIndexed$iv", "index$iv"}, s = {"L$0", "I$0", "L$0", "I$0"})
