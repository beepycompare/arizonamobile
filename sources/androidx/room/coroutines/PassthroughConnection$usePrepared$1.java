...
@DebugMetadata(c = "androidx.room.coroutines.PassthroughConnection", f = "PassthroughConnectionPool.kt", i = {0, 0}, l = {TsExtractor.TS_STREAM_TYPE_DVBSUBS, 91}, m = "usePrepared", n = {"sql", "block"}, s = {"L$0", "L$1"})
