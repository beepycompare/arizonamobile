            ...
            roomDatabase.getTransactionExecutor().execute(new Runnable() { // from class: androidx.room.RoomDatabaseKt__RoomDatabase_androidKt$startTransactionCoroutine$2$1
                ...
                static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        continuation.resumeWith(Result.m10243constructorimpl(obj));
                ...
                public final void run() {
                    try {
                        BuildersKt.runBlocking(cancellableContinuationImpl2.getContext().minusKey(ContinuationInterceptor.Key), new AnonymousClass1(roomDatabase, cancellableContinuationImpl2, function2, null));
                    } catch (Throwable th) {
