...
public final /* synthetic */ class DBUtil__DBUtil_androidKt {
            ...
            if ((dBUtil__DBUtil_androidKt$performSuspending$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (roomDatabase.inCompatibilityMode() && roomDatabase.isOpenInternal$room_runtime() && roomDatabase.inTransaction()) {
                        ...
                        Object useConnection = roomDatabase.useConnection(z, new DBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1(z2, z, roomDatabase, null, function1), dBUtil__DBUtil_androidKt$performSuspending$12);
    ...
    */
    public static final <R> Object performInTransactionSuspending(RoomDatabase roomDatabase, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
            ...
            if ((dBUtil__DBUtil_androidKt$performInTransactionSuspending$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (roomDatabase.inCompatibilityMode()) {
                        ...
                        Object withTransactionContext = RoomDatabaseKt.withTransactionContext(roomDatabase, new DBUtil__DBUtil_androidKt$performInTransactionSuspending$2(roomDatabase, function1, null), dBUtil__DBUtil_androidKt$performInTransactionSuspending$1);
                        ...
                        Object useConnection = roomDatabase.useConnection(false, new DBUtil__DBUtil_androidKt$performInTransactionSuspending$lambda$3$$inlined$internalPerform$1(true, false, roomDatabase, null, function1), dBUtil__DBUtil_androidKt$performInTransactionSuspending$1);
                        if (useConnection != coroutine_suspended) {
                            return useConnection;
                        }
                    } else {
                ...
                Object withContext = BuildersKt.withContext((CoroutineContext) obj, new DBUtil__DBUtil_androidKt$performInTransactionSuspending$$inlined$compatCoroutineExecute$DBUtil__DBUtil_androidKt$1(null, roomDatabase2, function12), dBUtil__DBUtil_androidKt$performInTransactionSuspending$1);
                return withContext != coroutine_suspended ? coroutine_suspended : withContext;
            }
        }
        ...
        dBUtil__DBUtil_androidKt$performInTransactionSuspending$1.L$1 = null;
        dBUtil__DBUtil_androidKt$performInTransactionSuspending$1.label = 4;
        Object withContext2 = BuildersKt.withContext((CoroutineContext) obj2, new DBUtil__DBUtil_androidKt$performInTransactionSuspending$$inlined$compatCoroutineExecute$DBUtil__DBUtil_androidKt$1(null, roomDatabase2, function12), dBUtil__DBUtil_androidKt$performInTransactionSuspending$1);
        if (withContext2 != coroutine_suspended2) {
        }
    }
    ...
    public static final Object getCoroutineContext(RoomDatabase roomDatabase, boolean z, Continuation<? super CoroutineContext> continuation) {
        ...
        if (!roomDatabase.inCompatibilityMode()) {
            return roomDatabase.getQueryContext().plus(transactionDispatcher$room_runtime != null ? transactionDispatcher$room_runtime : EmptyCoroutineContext.INSTANCE);
        } else if (transactionDispatcher$room_runtime != null) {
