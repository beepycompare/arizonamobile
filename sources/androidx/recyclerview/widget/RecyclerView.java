...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private int releaseHorizontalGlow(int i, float f) {
        ...
        if (edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            ...
            if (canScrollHorizontally) {
                ...
                float f3 = -EdgeEffectCompat.onPullDistance(edgeEffect2, -width, 1.0f - height);
            ...
            if (edgeEffect3 != null && EdgeEffectCompat.getDistance(edgeEffect3) != 0.0f) {
                ...
                if (canScrollHorizontally2) {
                    ...
                    float onPullDistance = EdgeEffectCompat.onPullDistance(edgeEffect4, width, height);
    ...
    private int releaseVerticalGlow(int i, float f) {
        ...
        if (edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            ...
            if (canScrollVertically) {
                ...
                float f3 = -EdgeEffectCompat.onPullDistance(edgeEffect2, -height, width);
            ...
            if (edgeEffect3 != null && EdgeEffectCompat.getDistance(edgeEffect3) != 0.0f) {
                ...
                if (canScrollVertically2) {
                    ...
                    float onPullDistance = EdgeEffectCompat.onPullDistance(edgeEffect4, height, 1.0f - width);
    ...
    */
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                if (focusFinder.findNextFocus(this, view, i == 2 ? TsExtractor.TS_STREAM_TYPE_HDMV_DTS : 33) == null) {
                    z = true;
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int i4 = RecyclerView.this.mReusableIntPair[0];
                    int i5 = RecyclerView.this.mReusableIntPair[1];
                    consumeFlingInHorizontalStretch -= i4;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i4, i5);
                        } else {
                            smoothScroller.onAnimation(i4, i5);
                        }
                    }
                ...
                int i6 = consumeFlingInHorizontalStretch;
                int i7 = consumeFlingInVerticalStretch;
                ...
                recyclerView3.dispatchNestedScroll(i, i2, i6, i7, null, 1, recyclerView3.mReusableIntPair);
                int i8 = i6 - RecyclerView.this.mReusableIntPair[0];
                int i9 = i7 - RecyclerView.this.mReusableIntPair[1];
                if (i != 0 || i2 != 0) {
