...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m10596getOrNullimpl = ChannelResult.m10596getOrNullimpl(((SimpleActor) this).messageQueue.mo10584tryReceivePtdJZtk());
                        if (m10596getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m10596getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                            continue;
                        } else {
                            unit = null;
    ...
    public final void offer(T t) {
        Object obj = this.messageQueue.mo8125trySendJP2dKIU(t);
        if (obj instanceof ChannelResult.Closed) {
            Throwable m10595exceptionOrNullimpl = ChannelResult.m10595exceptionOrNullimpl(obj);
            if (m10595exceptionOrNullimpl != null) {
                throw m10595exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        } else if (!ChannelResult.m10601isSuccessimpl(obj)) {
