...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        @Override // androidx.text.emoji.flatbuffer.FlexBuffers.Sized
        ...
        @Override // androidx.text.emoji.flatbuffer.FlexBuffers.Object
        public String toString() {
    ...
    public static class Map extends Vector {
        ...
        @Override // androidx.text.emoji.flatbuffer.FlexBuffers.Vector, androidx.text.emoji.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb) {
            sb.append("{ ");
            KeyVector keys = keys();
            int size = size();
    ...
    public static class TypedVector extends Vector {
        ...
        @Override // androidx.text.emoji.flatbuffer.FlexBuffers.Vector
        public Reference get(int i) {
            if (i >= size()) {
                return Reference.NULL_REFERENCE;
            }
