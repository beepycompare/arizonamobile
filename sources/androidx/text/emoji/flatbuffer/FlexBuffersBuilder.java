...
import androidx.text.emoji.flatbuffer.FlexBuffers;
...
public class FlexBuffersBuilder {
    ...
    public FlexBuffersBuilder(ReadWriteBuf readWriteBuf, int i) {
        ...
        this.finished = false;
        this.keyComparator = new Comparator<Value>() { // from class: androidx.text.emoji.flatbuffer.FlexBuffersBuilder.1
