...
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u00020\u0002B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\"\u0010\u000b\u001a\u00020\f2\u0012\u0010\r\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u000f0\u000eH\u0086@¢\u0006\u0002\u0010\u0010J \u0010\u0011\u001a\u0014\u0012\u0010\u0012\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u000f0\u000e0\u0012H\u0086@¢\u0006\u0002\u0010\u0013J\u000e\u0010\u0014\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u0015R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00028\u00000\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0016"}, d2 = {"Landroidx/paging/FlattenedPageController;", ExifInterface.GPS_DIRECTION_TRUE, "", "<init>", "()V", "list", "Landroidx/paging/FlattenedPageEventStorage;", "lock", "Lkotlinx/coroutines/sync/Mutex;", "maxEventIndex", "", "record", "", NotificationCompat.CATEGORY_EVENT, "Lkotlin/collections/IndexedValue;", "Landroidx/paging/PageEvent;", "(Lkotlin/collections/IndexedValue;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "getStateAsEvents", "", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "getCachedEvent", "Landroidx/paging/PageEvent$Insert;", "paging-common"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class FlattenedPageController<T> {
    ...
    */
            ...
            if (continuation instanceof FlattenedPageController$record$1) {
                ...
                if ((flattenedPageController$record$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        flattenedPageController$record$1.L$1 = mutex;
                        ...
                        ResultKt.throwOnFailure(obj);
                        mutex = (Mutex) flattenedPageController$record$1.L$1;
                        indexedValue = (IndexedValue) flattenedPageController$record$1.L$0;
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:21:0x0070 A[Catch: all -> 0x008e, TryCatch #0 {all -> 0x008e, blocks: (B:18:0x0048, B:19:0x006a, B:21:0x0070, B:23:0x0078, B:24:0x007b, B:25:0x0088), top: B:31:0x0048 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
            ...
            if (continuation instanceof FlattenedPageController$getStateAsEvents$1) {
                ...
                if ((flattenedPageController$getStateAsEvents$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        flattenedPageController$getStateAsEvents$1.L$0 = mutex2;
                        ...
                        mutex = (Mutex) flattenedPageController$getStateAsEvents$1.L$0;
                        ResultKt.throwOnFailure(obj);
                    }
