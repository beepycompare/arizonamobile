...
public abstract class PagingDataPresenter<T> {
    ...
    */
        ...
        if (continuation instanceof PagingDataPresenter$presentNewList$1) {
            ...
            if ((pagingDataPresenter$presentNewList$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (pageStore2.getSize() == 0 && (hintReceiver4 = this.hintReceiver) != null) {
                    hintReceiver4.accessHint(pageStore2.initializeHint());
                }
                return Unit.INSTANCE;
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: PagingDataPresenter.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\b\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\r\u001a\u00020\u000eH\u0016J\b\u0010\u000f\u001a\u00020\u000eH\u0016R\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\tR\u001a\u0010\n\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\u0007\"\u0004\b\f\u0010\t¨\u0006\u0010"}, d2 = {"Landroidx/paging/PagingDataPresenter$InitialUiReceiver;", "Landroidx/paging/UiReceiver;", "<init>", "()V", "shouldRetry", "", "getShouldRetry", "()Z", "setShouldRetry", "(Z)V", "shouldRefresh", "getShouldRefresh", "setShouldRefresh", "retry", "", "refresh", "paging-common"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: classes3.dex */
