...
public final class PagingDataTransforms__PagingDataTransformsKt$transform$$inlined$map$1<R> implements Flow<PageEvent<R>> {
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        @Metadata(k = 3, mv = {2, 0, 0}, xi = 176)
        @DebugMetadata(c = "androidx.paging.PagingDataTransforms__PagingDataTransformsKt$transform$$inlined$map$1$2", f = "PagingDataTransforms.kt", i = {}, l = {ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_TAG, 50}, m = "emit", n = {}, s = {}, v = 1)
