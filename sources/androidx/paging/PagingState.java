...
public final class PagingState<Key, Value> {
    ...
    public final PagingSource.LoadResult.Page<Key, Value> closestPageToPosition(int i) {
        ...
        while (it.hasNext()) {
            if (!((PagingSource.LoadResult.Page) it.next()).getData().isEmpty()) {
                ...
                if (i2 < 0) {
                    return (PagingSource.LoadResult.Page) CollectionsKt.first((List<? extends Object>) this.pages);
                }
    ...
    public final <T> T anchorPositionToPagedIndices$paging_common_release(int i, Function2<? super Integer, ? super Integer, ? extends T> block) {
