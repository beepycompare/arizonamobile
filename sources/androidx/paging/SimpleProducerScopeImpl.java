...
public final class SimpleProducerScopeImpl<T> implements SimpleProducerScope<T>, CoroutineScope, SendChannel<T> {
    ...
    public void mo11447invokeOnClose(Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        this.channel.mo11447invokeOnClose(handler);
    }
    ...
    public Object mo8871trySendJP2dKIU(T t) {
        return this.channel.mo8871trySendJP2dKIU(t);
    }
