...
public final class SimpleProducerScopeImpl<T> implements SimpleProducerScope<T>, CoroutineScope, SendChannel<T> {
    ...
    public void mo11853invokeOnClose(Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        this.channel.mo11853invokeOnClose(handler);
    }
    ...
    public Object mo9174trySendJP2dKIU(T t) {
        return this.channel.mo9174trySendJP2dKIU(t);
    }
