...
public final class SimpleProducerScopeImpl<T> implements SimpleProducerScope<T>, CoroutineScope, SendChannel<T> {
    ...
    public void mo10770invokeOnClose(Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        this.channel.mo10770invokeOnClose(handler);
    }
    ...
    public Object mo8396trySendJP2dKIU(T t) {
        return this.channel.mo8396trySendJP2dKIU(t);
    }
