...
public final class SimpleProducerScopeImpl<T> implements SimpleProducerScope<T>, CoroutineScope, SendChannel<T> {
    ...
    public void mo11429invokeOnClose(Function1<? super Throwable, Unit> handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        this.channel.mo11429invokeOnClose(handler);
    }
    ...
    public Object mo9005trySendJP2dKIU(T t) {
        return this.channel.mo9005trySendJP2dKIU(t);
    }
