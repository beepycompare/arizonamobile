...
public final class ShapesKt {
    ...
    private static final float[] pillStarVerticesFromNumVerts(int i, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        long m12constructorimpl2 = FloatFloatPair.m12constructorimpl(f11, f10);
        float f23 = -f11;
        long m12constructorimpl3 = FloatFloatPair.m12constructorimpl(f23, f10);
        float f24 = -f10;
        long m12constructorimpl4 = FloatFloatPair.m12constructorimpl(f23, f24);
        long m12constructorimpl5 = FloatFloatPair.m12constructorimpl(f11, f24);
        float f25 = f10;
        int i3 = 0;
        float f26 = 0.0f;
        boolean z = false;
                ...
                if (f27 >= f28) {
                    ...
                    switch (i4) {
                        case 0:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = FloatFloatPair.m12constructorimpl(f30, f29 * f9);
                            break;
                        case 1:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = PointKt.m8767plusybeJwSQ(Utils.m8798radialToCartesianL6JJ3z0$default(f30, (f29 * Utils.getFloatPi()) / 2.0f, 0L, 4, null), m12constructorimpl2);
                            break;
                        case 2:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = FloatFloatPair.m12constructorimpl(f11 - (f29 * coerceAtLeast2), f30);
                            break;
                        case 3:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = PointKt.m8767plusybeJwSQ(Utils.m8798radialToCartesianL6JJ3z0$default(f30, (Utils.getFloatPi() / 2.0f) + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m12constructorimpl3);
                            break;
                        case 4:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = FloatFloatPair.m12constructorimpl(-f30, f9 - (f29 * coerceAtLeast));
                            break;
                        case 5:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = PointKt.m8767plusybeJwSQ(Utils.m8798radialToCartesianL6JJ3z0$default(f30, Utils.getFloatPi() + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m12constructorimpl4);
                            break;
                        case 6:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = FloatFloatPair.m12constructorimpl(f8 + (f29 * coerceAtLeast2), -f30);
                            break;
                        case 7:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = PointKt.m8767plusybeJwSQ(Utils.m8798radialToCartesianL6JJ3z0$default(f30, (Utils.getFloatPi() * 1.5f) + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m12constructorimpl5);
                            break;
                        default:
                            f8 = f23;
                            f9 = f10;
                            m12constructorimpl = FloatFloatPair.m12constructorimpl(f30, f24 + (f29 * f9));
                            break;
                    }
                    int i7 = i5 + 1;
                    fArr2[i5] = PointKt.m8763getXDnnuFBc(m12constructorimpl) + f6;
                    i5 += 2;
                    fArr2[i7] = PointKt.m8764getYDnnuFBc(m12constructorimpl) + f7;
                    f22 += f21;
                    z = !z;
                    i3++;
                    f23 = f8;
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long m8798radialToCartesianL6JJ3z0$default = Utils.m8798radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2.0f * i3, 0L, 4, null);
            fArr[i2] = PointKt.m8763getXDnnuFBc(m8798radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m8764getYDnnuFBc(m8798radialToCartesianL6JJ3z0$default) + f4;
            long m8798radialToCartesianL6JJ3z0$default2 = Utils.m8798radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m8763getXDnnuFBc(m8798radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m8764getYDnnuFBc(m8798radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
