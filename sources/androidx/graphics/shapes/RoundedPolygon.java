...
public final class RoundedPolygon {
    ...
    public final long m8782getCenter1ufDz9w$graphics_shapes() {
        return this.center;
    }
    ...
    public final float getCenterX() {
        return PointKt.m8763getXDnnuFBc(this.center);
    }

    public final float getCenterY() {
        return PointKt.m8764getYDnnuFBc(this.center);
    }
    ...
    public final RoundedPolygon transformed(PointTransformer f) {
        ...
        long m8770transformedso9K2fw = PointKt.m8770transformedso9K2fw(this.center, f);
        List createListBuilder = CollectionsKt.createListBuilder();
        int size = this.features.size();
        for (int i = 0; i < size; i++) {
            createListBuilder.add(this.features.get(i).transformed(f));
        }
        return new RoundedPolygon(CollectionsKt.build(createListBuilder), m8770transformedso9K2fw, null);
    }
    ...
    public final RoundedPolygon normalized() {
        ...
        return transformed(new PointTransformer() { // from class: androidx.graphics.shapes.RoundedPolygon$normalized$1
            ...
            public final long mo8772transformXgqJiTY(float f5, float f6) {
                float f7 = f5 + f3;
                float f8 = max;
    ...
    public final float[] calculateMaxBounds(float[] bounds) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m8752pointOnCurveOOQOV4g$graphics_shapes = cubic.m8752pointOnCurveOOQOV4g$graphics_shapes(0.5f);
            f = Math.max(f, Math.max(distanceSquared, Utils.distanceSquared(PointKt.m8763getXDnnuFBc(m8752pointOnCurveOOQOV4g$graphics_shapes) - getCenterX(), PointKt.m8764getYDnnuFBc(m8752pointOnCurveOOQOV4g$graphics_shapes) - getCenterY())));
        }
