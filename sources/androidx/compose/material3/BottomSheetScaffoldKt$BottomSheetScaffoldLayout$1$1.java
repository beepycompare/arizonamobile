...
final class BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1 implements MultiContentMeasurePolicy {
    ...
    public final MeasureResult mo864measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(list4.get(i2).mo6875measureBRTryo0(m8201copyZbe2FdA$default));
        }
        final ArrayList arrayList2 = arrayList;
        ArrayList arrayList3 = new ArrayList(list2.size());
        int size2 = list2.size();
        for (int i3 = 0; i3 < size2; i3++) {
            arrayList3.add(list2.get(i3).mo6875measureBRTryo0(m8201copyZbe2FdA$default));
        }
        ...
        long m8201copyZbe2FdA$default2 = Constraints.m8201copyZbe2FdA$default(m8201copyZbe2FdA$default, 0, 0, 0, m8210getMaxHeightimpl - intValue, 7, null);
        ArrayList arrayList5 = new ArrayList(list3.size());
        int size3 = list3.size();
        for (int i4 = 0; i4 < size3; i4++) {
            arrayList5.add(list3.get(i4).mo6875measureBRTryo0(m8201copyZbe2FdA$default2));
        }
        final ArrayList arrayList6 = arrayList5;
        ArrayList arrayList7 = new ArrayList(list5.size());
        int size4 = list5.size();
        for (int i5 = 0; i5 < size4; i5++) {
            arrayList7.add(list5.get(i5).mo6875measureBRTryo0(m8201copyZbe2FdA$default));
        }
        final ArrayList arrayList8 = arrayList7;
        final SheetState sheetState = this.$sheetState;
        final Function0<Float> function0 = this.$sheetOffset;
        return MeasureScope.layout$default(measureScope, m8211getMaxWidthimpl, m8210getMaxHeightimpl, null, new Function1() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$12;
                measure_3p2s80s$lambda$12 = BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.measure_3p2s80s$lambda$12(arrayList2, m8211getMaxWidthimpl, arrayList8, sheetState, function0, m8210getMaxHeightimpl, arrayList6, arrayList4, intValue, (Placeable.PlacementScope) obj);
