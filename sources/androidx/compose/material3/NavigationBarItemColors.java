...
public final class NavigationBarItemColors {
    ...
    public final long m2710getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2712getSelectedTextColor0d7_KjU() {
    ...
    public final long m2713getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2714getUnselectedTextColor0d7_KjU() {
        return this.unselectedTextColor;
    }

    /* renamed from: getDisabledIconColor-0d7_KjU  reason: not valid java name */
    public final long m2707getDisabledIconColor0d7_KjU() {
        return this.disabledIconColor;
    }

    /* renamed from: getDisabledTextColor-0d7_KjU  reason: not valid java name */
    public final long m2708getDisabledTextColor0d7_KjU() {
        return this.disabledTextColor;
    }

    /* renamed from: copy-4JmcsL4  reason: not valid java name */
    public final NavigationBarItemColors m2706copy4JmcsL4(long j, long j2, long j3, long j4, long j5, long j6, long j7) {
    ...
    public final long m2715iconColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedIconColor;
            }
    ...
    public final long m2716textColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedTextColor;
            }
    ...
    public final long m2709getIndicatorColor0d7_KjU$material3() {
        return this.selectedIndicatorColor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5349equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m5349equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m5349equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m5349equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m5349equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor) && Color.m5349equalsimpl0(this.disabledIconColor, navigationBarItemColors.disabledIconColor) && Color.m5349equalsimpl0(this.disabledTextColor, navigationBarItemColors.disabledTextColor);
    }
