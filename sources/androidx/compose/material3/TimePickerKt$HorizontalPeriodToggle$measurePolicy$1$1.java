    ...
    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "Spacer")) {
                final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, measureScope.mo428roundToPx0680j_4(TimePickerTokens.INSTANCE.m4264getPeriodSelectorOutlineWidthD9Ej5fM()), 0, 0, 12, null));
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    arrayList3.add(((Measurable) arrayList2.get(i3)).mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, Constraints.m8113getMaxWidthimpl(j) / 2, 0, 0, 12, null)));
                }
                final ArrayList arrayList4 = arrayList3;
                return MeasureScope.layout$default(measureScope, Constraints.m8113getMaxWidthimpl(j), Constraints.m8112getMaxHeightimpl(j), null, new Function1() { // from class: androidx.compose.material3.TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1.measure_3p2s80s$lambda$3(arrayList4, mo6818measureBRTryo0, (Placeable.PlacementScope) obj);
                    }
                }, 4, null);
            }
        }
