...
public final class DatePickerKt$DisplayModeToggleButton$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (DisplayMode.m2476equalsimpl0(this.$displayMode, DisplayMode.Companion.m2481getPickerjFl4v0())) {
            ...
            String m3533getString2EP1pXo = Strings_androidKt.m3533getString2EP1pXo(Strings.m3454constructorimpl(R.string.m3c_date_picker_switch_to_input_mode), composer, 0);
            ...
            DatePickerKt.IconButtonWithTooltip((Function0) rememberedValue, edit$material3, m3533getString2EP1pXo, this.$modifier, false, composer, 0, 16);
            ...
            String m3533getString2EP1pXo2 = Strings_androidKt.m3533getString2EP1pXo(Strings.m3454constructorimpl(R.string.m3c_date_picker_switch_to_calendar_mode), composer, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            DatePickerKt.IconButtonWithTooltip((Function0) rememberedValue2, dateRange$material3, m3533getString2EP1pXo2, this.$modifier, false, composer, 0, 16);
            composer.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Unit invoke$lambda$1$lambda$0(Function1 function1) {
        function1.invoke(DisplayMode.m2473boximpl(DisplayMode.Companion.m2480getInputjFl4v0()));
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static final Unit invoke$lambda$3$lambda$2(Function1 function1) {
        function1.invoke(DisplayMode.m2473boximpl(DisplayMode.Companion.m2481getPickerjFl4v0()));
        return Unit.INSTANCE;
    }
}
