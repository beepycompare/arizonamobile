...
final class LabelKt$Label$wrappedContent$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.Companion, new Function1() { // from class: androidx.compose.material3.LabelKt$Label$wrappedContent$1$$ExternalSyntheticLambda0
