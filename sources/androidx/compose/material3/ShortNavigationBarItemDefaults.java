...
public final class ShortNavigationBarItemDefaults {
    ...
    public final NavigationItemColors m2896colors69fazGs(long j, long j2, long j3, long j4, long j5, long j6, long j7, Composer composer, int i, int i2) {
        ...
        NavigationItemColors m2640copy4JmcsL4 = getDefaultShortNavigationBarItemColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2640copy4JmcsL4(value, value2, value3, value4, value5, m5279copywmQWz5c$default, m5279copywmQWz5c$default2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
