...
public final class RadioButtonColors {
    ...
    public final long m2767getSelectedColor0d7_KjU() {
        return this.selectedColor;
    }

    /* renamed from: getUnselectedColor-0d7_KjU  reason: not valid java name */
    public final long m2768getUnselectedColor0d7_KjU() {
        return this.unselectedColor;
    }

    /* renamed from: getDisabledSelectedColor-0d7_KjU  reason: not valid java name */
    public final long m2765getDisabledSelectedColor0d7_KjU() {
        return this.disabledSelectedColor;
    }

    /* renamed from: getDisabledUnselectedColor-0d7_KjU  reason: not valid java name */
    public final long m2766getDisabledUnselectedColor0d7_KjU() {
        return this.disabledUnselectedColor;
    }

    /* renamed from: copy-jRlVdoo$default  reason: not valid java name */
    public static /* synthetic */ RadioButtonColors m2763copyjRlVdoo$default(RadioButtonColors radioButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return radioButtonColors.m2764copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? radioButtonColors.disabledUnselectedColor : j4);
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final RadioButtonColors m2764copyjRlVdoo(long j, long j2, long j3, long j4) {
    ...
    public final State<Color> radioColor$material3(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m131animateColorAsStateeuL9pac(j2, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5281equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m5281equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m5281equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m5281equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m5287hashCodeimpl(this.selectedColor) * 31) + Color.m5287hashCodeimpl(this.unselectedColor)) * 31) + Color.m5287hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m5287hashCodeimpl(this.disabledUnselectedColor);
    }
}
