...
public final class RadioButtonColors {
    ...
    public final long m2513getSelectedColor0d7_KjU() {
        return this.selectedColor;
    }

    /* renamed from: getUnselectedColor-0d7_KjU  reason: not valid java name */
    public final long m2514getUnselectedColor0d7_KjU() {
        return this.unselectedColor;
    }

    /* renamed from: getDisabledSelectedColor-0d7_KjU  reason: not valid java name */
    public final long m2511getDisabledSelectedColor0d7_KjU() {
        return this.disabledSelectedColor;
    }

    /* renamed from: getDisabledUnselectedColor-0d7_KjU  reason: not valid java name */
    public final long m2512getDisabledUnselectedColor0d7_KjU() {
        return this.disabledUnselectedColor;
    }

    /* renamed from: copy-jRlVdoo$default  reason: not valid java name */
    public static /* synthetic */ RadioButtonColors m2509copyjRlVdoo$default(RadioButtonColors radioButtonColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return radioButtonColors.m2510copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? radioButtonColors.disabledUnselectedColor : j4);
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final RadioButtonColors m2510copyjRlVdoo(long j, long j2, long j3, long j4) {
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer2, 48, 12);
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4550equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m4550equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m4550equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m4550equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return (((((Color.m4556hashCodeimpl(this.selectedColor) * 31) + Color.m4556hashCodeimpl(this.unselectedColor)) * 31) + Color.m4556hashCodeimpl(this.disabledSelectedColor)) * 31) + Color.m4556hashCodeimpl(this.disabledUnselectedColor);
    }
}
