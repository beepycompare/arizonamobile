...
public final class TimePickerKt$TimeSelector$3 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        final String m3229numberContentDescriptiondSwYdS4 = TimePickerKt.m3229numberContentDescriptiondSwYdS4(this.$selection, this.$state.is24hour(), this.$value, composer, 0);
        ...
        boolean changed = composer.changed(m3229numberContentDescriptiondSwYdS4);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function1() { // from class: androidx.compose.material3.TimePickerKt$TimeSelector$3$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    ...
                    invoke$lambda$2$lambda$1$lambda$0 = TimePickerKt$TimeSelector$3.invoke$lambda$2$lambda$1$lambda$0(m3229numberContentDescriptiondSwYdS4, (SemanticsPropertyReceiver) obj);
        ...
        TextKt.m3168TextNvy7gAk(CalendarLocale_jvmKt.toLocalString$default(i2, 2, 0, false, null, 14, null), SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue, 1, null), j, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, composer, 0, 0, 262136);
        ComposerKt.sourceInformationMarkerEnd(composer);
        ComposerKt.sourceInformationMarkerEnd(composer);
        composer.endNode();
        ComposerKt.sourceInformationMarkerEnd(composer);
