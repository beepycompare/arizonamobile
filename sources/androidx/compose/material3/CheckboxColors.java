...
public final class CheckboxColors {
    ...
    public final long m2098getDisabledIndeterminateBorderColor0d7_KjU() {
        return this.disabledIndeterminateBorderColor;
    }

    /* renamed from: copy-2qZNXz8$default  reason: not valid java name */
    public static /* synthetic */ CheckboxColors m2091copy2qZNXz8$default(CheckboxColors checkboxColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
        ...
        return checkboxColors.m2092copy2qZNXz8(j22, j16, j17, j18, j19, j20, j21, j23, j24, j25, j14, j13);
    }

    /* renamed from: copy-2qZNXz8  reason: not valid java name */
    public final CheckboxColors m2092copy2qZNXz8(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12) {
    ...
    public final State<Color> checkmarkColor$material3(ToggleableState toggleableState, Composer composer, int i) {
        ...
        State<Color> m147animateColorAsStateeuL9pac = SingleValueAnimationKt.m147animateColorAsStateeuL9pac(j, colorAnimationSpecForState(toggleableState, composer, i & WebSocketProtocol.PAYLOAD_SHORT), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> boxColor$material3(boolean z, ToggleableState toggleableState, Composer composer, int i) {
        ...
        if (z) {
            ...
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m147animateColorAsStateeuL9pac(j2, colorAnimationSpecForState(toggleableState, composer, (i >> 3) & WebSocketProtocol.PAYLOAD_SHORT), null, null, composer2, 0, 12);
            composer2.endReplaceGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceGroup(496141925);
            ComposerKt.sourceInformation(composer2, "646@29442L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m5414boximpl(j2), composer2, 0);
            composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5425equalsimpl0(this.checkedCheckmarkColor, checkboxColors.checkedCheckmarkColor) && Color.m5425equalsimpl0(this.uncheckedCheckmarkColor, checkboxColors.uncheckedCheckmarkColor) && Color.m5425equalsimpl0(this.checkedBoxColor, checkboxColors.checkedBoxColor) && Color.m5425equalsimpl0(this.uncheckedBoxColor, checkboxColors.uncheckedBoxColor) && Color.m5425equalsimpl0(this.disabledCheckedBoxColor, checkboxColors.disabledCheckedBoxColor) && Color.m5425equalsimpl0(this.disabledUncheckedBoxColor, checkboxColors.disabledUncheckedBoxColor) && Color.m5425equalsimpl0(this.disabledIndeterminateBoxColor, checkboxColors.disabledIndeterminateBoxColor) && Color.m5425equalsimpl0(this.checkedBorderColor, checkboxColors.checkedBorderColor) && Color.m5425equalsimpl0(this.uncheckedBorderColor, checkboxColors.uncheckedBorderColor) && Color.m5425equalsimpl0(this.disabledBorderColor, checkboxColors.disabledBorderColor) && Color.m5425equalsimpl0(this.disabledUncheckedBorderColor, checkboxColors.disabledUncheckedBorderColor) && Color.m5425equalsimpl0(this.disabledIndeterminateBorderColor, checkboxColors.disabledIndeterminateBorderColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m5431hashCodeimpl(this.checkedCheckmarkColor) * 31) + Color.m5431hashCodeimpl(this.uncheckedCheckmarkColor)) * 31) + Color.m5431hashCodeimpl(this.checkedBoxColor)) * 31) + Color.m5431hashCodeimpl(this.uncheckedBoxColor)) * 31) + Color.m5431hashCodeimpl(this.disabledCheckedBoxColor)) * 31) + Color.m5431hashCodeimpl(this.disabledUncheckedBoxColor)) * 31) + Color.m5431hashCodeimpl(this.disabledIndeterminateBoxColor)) * 31) + Color.m5431hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m5431hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m5431hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m5431hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m5431hashCodeimpl(this.disabledIndeterminateBorderColor);
    }
}
