...
public final class DisplayMode {
    ...
    private static final int Picker = m2388constructorimpl(0);
    private static final int Input = m2388constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ DisplayMode m2387boximpl(int i) {
        return new DisplayMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2388constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2389equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).m2393unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2390equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m2389equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2391hashCodeimpl(this.value);
    }
    ...
    public static String m2392toStringimpl(int i) {
        return m2390equalsimpl0(i, Picker) ? "Picker" : m2390equalsimpl0(i, Input) ? "Input" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
