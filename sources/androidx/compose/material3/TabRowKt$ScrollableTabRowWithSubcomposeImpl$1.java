...
final class TabRowKt$ScrollableTabRowWithSubcomposeImpl$1 implements Function2<Composer, Integer, Unit> {
        ...
        if (changed2 || rememberedValue3 == Composer.Companion.getEmpty()) {
            Function2 function23 = new Function2() { // from class: androidx.compose.material3.TabRowKt$ScrollableTabRowWithSubcomposeImpl$1$$ExternalSyntheticLambda1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    invoke$lambda$9$lambda$8 = TabRowKt$ScrollableTabRowWithSubcomposeImpl$1.invoke$lambda$9$lambda$8(f, function2, function22, scrollableTabData, i2, function3, (SubcomposeMeasureScope) obj, (Constraints) obj2);
    ...
    public static final MeasureResult invoke$lambda$9$lambda$8(float f, Function2 function2, final Function2 function22, final ScrollableTabData scrollableTabData, final int i, final Function3 function3, final SubcomposeMeasureScope subcomposeMeasureScope, final Constraints constraints) {
        int i2 = subcomposeMeasureScope.mo423roundToPx0680j_4(TabRowDefaults.INSTANCE.m3048getScrollableTabRowMinTabWidthD9Ej5fM());
        final int i3 = subcomposeMeasureScope.mo423roundToPx0680j_4(f);
        ...
        long m7938copyZbe2FdA$default = Constraints.m7938copyZbe2FdA$default(constraints.m7954unboximpl(), i2, 0, intValue, intValue, 2, null);
        ...
        for (int i6 = 0; i6 < size2; i6++) {
            ...
            float m7995constructorimpl = Dp.m7995constructorimpl(subcomposeMeasureScope.mo426toDpu2uoSUM(Math.min(measurable.maxIntrinsicWidth(mo6697measureBRTryo0.getHeight()), mo6697measureBRTryo0.getWidth())) - Dp.m7995constructorimpl(TabKt.getHorizontalTextPadding() * 2));
            arrayList.add(mo6697measureBRTryo0);
            arrayList2.add(Dp.m7993boximpl(m7995constructorimpl));
        }
    ...
    public static final Unit invoke$lambda$9$lambda$8$lambda$7(int i, List list, SubcomposeMeasureScope subcomposeMeasureScope, Function2 function2, ScrollableTabData scrollableTabData, int i2, List list2, Constraints constraints, int i3, int i4, final Function3 function3, Placeable.PlacementScope placementScope) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            ...
            arrayList.add(new TabPosition(subcomposeMeasureScope.mo426toDpu2uoSUM(i5), subcomposeMeasureScope.mo426toDpu2uoSUM(placeable.getWidth()), ((Dp) list2.get(i6)).m8009unboximpl(), null));
            i5 += placeable.getWidth();
        }
        List<Measurable> subcompose = subcomposeMeasureScope.subcompose(TabSlots.Divider, function2);
        int size2 = subcompose.size();
        for (int i7 = 0; i7 < size2; i7++) {
            Placeable mo6697measureBRTryo0 = subcompose.get(i7).mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(constraints.m7954unboximpl(), i3, i3, 0, 0, 8, null));
            Placeable.PlacementScope.placeRelative$default(placementScope, mo6697measureBRTryo0, 0, i4 - mo6697measureBRTryo0.getHeight(), 0.0f, 4, null);
        }
        ...
        for (int i8 = 0; i8 < size3; i8++) {
            Placeable.PlacementScope.placeRelative$default(placementScope, subcompose2.get(i8).mo6697measureBRTryo0(Constraints.Companion.m7958fixedJhjzzOo(i3, i4)), 0, 0, 0.0f, 4, null);
        }
