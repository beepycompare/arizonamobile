...
public final class DividerKt {
    ...
    public static final Unit Divider_9IZ8Weo$lambda$6(Modifier modifier, float f, long j, int i, int i2, Composer composer, int i3) {
        m2401Divider9IZ8Weo(modifier, f, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    public static final Unit HorizontalDivider_9IZ8Weo$lambda$2(Modifier modifier, float f, long j, int i, int i2, Composer composer, int i3) {
        m2402HorizontalDivider9IZ8Weo(modifier, f, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit VerticalDivider_9IZ8Weo$lambda$5(Modifier modifier, float f, long j, int i, int i2, Composer composer, int i3) {
        m2403VerticalDivider9IZ8Weo(modifier, f, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    */
    public static final void m2402HorizontalDivider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        float f2;
        final long j2;
        ...
        if (i5 != 0) {
            ...
            if (startRestartGroup.shouldExecute((i3 & 147) == 146, i3 & 1)) {
                ...
                if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                    ...
                    f3 = i5 != 0 ? DividerDefaults.INSTANCE.m2396getThicknessD9Ej5fM() : f2;
                    if ((i2 & 4) != 0) {
                        i3 &= -897;
                ...
                Modifier m962height3ABfNKs = SizeKt.m962height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), f3);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m2403VerticalDivider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        float f2;
        final long j2;
        ...
        if (i5 != 0) {
            ...
            if (startRestartGroup.shouldExecute((i3 & 147) == 146, i3 & 1)) {
                ...
                Modifier m981width3ABfNKs = SizeKt.m981width3ABfNKs(SizeKt.fillMaxHeight$default(companion, 0.0f, 1, null), f3);
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                CanvasKt.Canvas(m981width3ABfNKs, (Function1) rememberedValue, startRestartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            }
    ...
    public static final Unit VerticalDivider_9IZ8Weo$lambda$4$lambda$3(float f, long j, DrawScope drawScope) {
        float f2;
        float f3 = drawScope.mo464toPx0680j_4(f);
        long m5171constructorimpl = Offset.m5171constructorimpl((Float.floatToRawIntBits(drawScope.mo464toPx0680j_4(f) / f2) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
        float f4 = drawScope.mo464toPx0680j_4(f) / 2;
        float intBitsToFloat = Float.intBitsToFloat((int) (drawScope.mo6005getSizeNHjbRc() & 4294967295L));
        DrawScope.m5991drawLineNGM6Ib0$default(drawScope, j, m5171constructorimpl, Offset.m5171constructorimpl((Float.floatToRawIntBits(f4) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & 4294967295L)), f3, 0, null, 0.0f, null, 0, 496, null);
        return Unit.INSTANCE;
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m2401Divider9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        long j2;
        Modifier.Companion companion;
        float f2;
        ...
        if (startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                f2 = i6 != 0 ? DividerDefaults.INSTANCE.m2396getThicknessD9Ej5fM() : f;
                if ((i2 & 4) != 0) {
                    i3 &= -897;
                    ...
                    if (Dp.m8263equalsimpl0(f2, Dp.Companion.m8276getHairlineD9Ej5fM())) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        f3 = Dp.m8258constructorimpl(1.0f / ((Density) consume).getDensity());
                        startRestartGroup.endReplaceGroup();
                    }
                    BoxKt.Box(BackgroundKt.m299backgroundbw27NRU$default(SizeKt.m962height3ABfNKs(SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), f3), j3, null, 2, null), startRestartGroup, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                }
