...
public final class ClockDialNode$pointerInputDragNode$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        float f3;
        long m2152getCenternOccac;
        float f4;
        long m2152getCenternOccac2;
        float atan;
        ...
        if (i == 0) {
            ...
            clockDialNode.offsetX = f + Float.intBitsToFloat((int) (this.$dragAmount.m5189unboximpl() >> 32));
            ClockDialNode clockDialNode2 = this.this$0;
            f2 = clockDialNode2.offsetY;
            clockDialNode2.offsetY = f2 + Float.intBitsToFloat((int) (this.$dragAmount.m5189unboximpl() & 4294967295L));
            analogTimePickerState = this.this$0.state;
            f3 = this.this$0.offsetY;
            m2152getCenternOccac = this.this$0.m2152getCenternOccac();
            float m8387getYimpl = f3 - IntOffset.m8387getYimpl(m2152getCenternOccac);
            f4 = this.this$0.offsetX;
            m2152getCenternOccac2 = this.this$0.m2152getCenternOccac();
            atan = TimePickerKt.atan(m8387getYimpl, f4 - IntOffset.m8386getXimpl(m2152getCenternOccac2));
        ...
        m2152getCenternOccac3 = this.this$0.m2152getCenternOccac();
        TimePickerKt.m3315moveSelectord3b8Pxo(analogTimePickerState2, f5, f6, maxDist, m2152getCenternOccac3);
