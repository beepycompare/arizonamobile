...
public final class WideNavigationRailColors {
    ...
    public final long m3426getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m3427getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getModalContainerColor-0d7_KjU  reason: not valid java name */
    public final long m3428getModalContainerColor0d7_KjU() {
        return this.modalContainerColor;
    }

    /* renamed from: getModalScrimColor-0d7_KjU  reason: not valid java name */
    public final long m3430getModalScrimColor0d7_KjU() {
        return this.modalScrimColor;
    }

    /* renamed from: getModalContentColor-0d7_KjU  reason: not valid java name */
    public final long m3429getModalContentColor0d7_KjU() {
        return this.modalContentColor;
    }

    /* renamed from: copy-t635Npw$default  reason: not valid java name */
    public static /* synthetic */ WideNavigationRailColors m3424copyt635Npw$default(WideNavigationRailColors wideNavigationRailColors, long j, long j2, long j3, long j4, long j5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return wideNavigationRailColors.m3425copyt635Npw(j6, j2, (i & 4) != 0 ? wideNavigationRailColors.modalContainerColor : j3, (i & 8) != 0 ? wideNavigationRailColors.modalScrimColor : j4, (i & 16) != 0 ? wideNavigationRailColors.modalContentColor : j5);
    }

    /* renamed from: copy-t635Npw  reason: not valid java name */
    public final WideNavigationRailColors m3425copyt635Npw(long j, long j2, long j3, long j4, long j5) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5280equalsimpl0(this.containerColor, wideNavigationRailColors.containerColor) && Color.m5280equalsimpl0(this.contentColor, wideNavigationRailColors.contentColor) && Color.m5280equalsimpl0(this.modalContainerColor, wideNavigationRailColors.modalContainerColor) && Color.m5280equalsimpl0(this.modalScrimColor, wideNavigationRailColors.modalScrimColor);
    }

    public int hashCode() {
        return (((((((Color.m5286hashCodeimpl(this.containerColor) * 31) + Color.m5286hashCodeimpl(this.contentColor)) * 31) + Color.m5286hashCodeimpl(this.modalContainerColor)) * 31) + Color.m5286hashCodeimpl(this.modalScrimColor)) * 31) + Color.m5286hashCodeimpl(this.modalContentColor);
    }
}
