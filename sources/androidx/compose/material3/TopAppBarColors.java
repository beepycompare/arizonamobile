...
public final class TopAppBarColors {
    ...
    public final long m2973getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getScrolledContainerColor-0d7_KjU  reason: not valid java name */
    public final long m2975getScrolledContainerColor0d7_KjU() {
        return this.scrolledContainerColor;
    }

    /* renamed from: getNavigationIconContentColor-0d7_KjU  reason: not valid java name */
    public final long m2974getNavigationIconContentColor0d7_KjU() {
        return this.navigationIconContentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m2976getTitleContentColor0d7_KjU() {
        return this.titleContentColor;
    }

    /* renamed from: getActionIconContentColor-0d7_KjU  reason: not valid java name */
    public final long m2972getActionIconContentColor0d7_KjU() {
        return this.actionIconContentColor;
    }

    /* renamed from: copy-t635Npw$default  reason: not valid java name */
    public static /* synthetic */ TopAppBarColors m2969copyt635Npw$default(TopAppBarColors topAppBarColors, long j, long j2, long j3, long j4, long j5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return topAppBarColors.m2971copyt635Npw(j6, j2, (i & 4) != 0 ? topAppBarColors.navigationIconContentColor : j3, (i & 8) != 0 ? topAppBarColors.titleContentColor : j4, (i & 16) != 0 ? topAppBarColors.actionIconContentColor : j5);
    }

    /* renamed from: copy-t635Npw  reason: not valid java name */
    public final TopAppBarColors m2971copyt635Npw(long j, long j2, long j3, long j4, long j5) {
    ...
    public final long m2970containerColorvNxB06k$material3_release(float f) {
        return ColorKt.m4600lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4550equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m4550equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m4550equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m4550equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m4550equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m4556hashCodeimpl(this.containerColor) * 31) + Color.m4556hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m4556hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m4556hashCodeimpl(this.titleContentColor)) * 31) + Color.m4556hashCodeimpl(this.actionIconContentColor);
    }
}
