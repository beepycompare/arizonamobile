...
public final class TimePickerDisplayMode {
    ...
    private static final int Picker = m3201constructorimpl(0);
    private static final int Input = m3201constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerDisplayMode m3200boximpl(int i) {
    ...
    public static boolean m3202equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerDisplayMode) && i == ((TimePickerDisplayMode) obj).m3206unboximpl();
    }
    ...
    public static String m3205toStringimpl(int i) {
        return m3203equalsimpl0(i, Picker) ? "Picker" : m3203equalsimpl0(i, Input) ? "Input" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
