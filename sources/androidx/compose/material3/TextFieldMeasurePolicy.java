...
public final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo52measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        int i2 = measureScope.mo423roundToPx0680j_4(this.paddingValues.mo788calculateTopPaddingD9Ej5fM());
        int i3 = measureScope.mo423roundToPx0680j_4(this.paddingValues.mo785calculateBottomPaddingD9Ej5fM());
        ...
        int max = Math.max(0, LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo0));
        ...
        int max3 = Math.max(max2, LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo02));
        ...
        if (!z) {
            objectRef.element = measurable12 != null ? measurable12.mo6697measureBRTryo0(ConstraintsKt.m7967offsetNN6EwU(j3, -widthOrZero4, -i3)) : 0;
        ...
        long m7967offsetNN6EwU = ConstraintsKt.m7967offsetNN6EwU(Constraints.m7938copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null), -widthOrZero4, ((-heightOrZero) - i3) - minIntrinsicHeight2);
        ...
        while (i10 < size7) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable14), TextFieldImplKt.TextFieldId)) {
                final Placeable mo6697measureBRTryo03 = measurable14.mo6697measureBRTryo0(m7967offsetNN6EwU);
                long m7938copyZbe2FdA$default2 = Constraints.m7938copyZbe2FdA$default(m7967offsetNN6EwU, 0, 0, 0, 0, 14, null);
                ...
                Placeable mo6697measureBRTryo04 = measurable15 != null ? measurable15.mo6697measureBRTryo0(m7938copyZbe2FdA$default2) : null;
                int max5 = Math.max(max4, Math.max(LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo03), LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo04)) + i12 + i3);
                long j4 = j3;
                boolean z2 = z;
                final Placeable placeable4 = placeable2;
                Ref.ObjectRef objectRef2 = objectRef;
                final int m3160calculateWidthyeHjK3Y = m3160calculateWidthyeHjK3Y(LayoutUtilKt.getWidthOrZero(mo6697measureBRTryo0), LayoutUtilKt.getWidthOrZero(placeable), LayoutUtilKt.getWidthOrZero(mo6697measureBRTryo02), LayoutUtilKt.getWidthOrZero(placeable2), mo6697measureBRTryo03.getWidth(), LayoutUtilKt.getWidthOrZero((Placeable) objectRef.element), LayoutUtilKt.getWidthOrZero(mo6697measureBRTryo04), j);
                if (z2) {
                    objectRef2.element = measurable12 != null ? measurable12.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j4, 0, m3160calculateWidthyeHjK3Y, 0, minIntrinsicHeight, 5, null)) : 0;
                }
                long m7938copyZbe2FdA$default3 = Constraints.m7938copyZbe2FdA$default(ConstraintsKt.m7968offsetNN6EwU$default(j4, 0, -max5, 1, null), 0, m3160calculateWidthyeHjK3Y, 0, 0, 9, null);
                if (measurable13 != null) {
                    i = i2;
                    placeable3 = measurable13.mo6697measureBRTryo0(m7938copyZbe2FdA$default3);
                } else {
                    i = i2;
                    placeable3 = null;
                }
                ...
                boolean z3 = z2;
                int m3159calculateHeightmKXJcVc = m3159calculateHeightmKXJcVc(measureScope, mo6697measureBRTryo03.getHeight(), LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element), LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo0), LayoutUtilKt.getHeightOrZero(placeable), LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo02), LayoutUtilKt.getHeightOrZero(placeable4), LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo04), LayoutUtilKt.getHeightOrZero(placeable3), j, z3, invoke);
                final int heightOrZero3 = (m3159calculateHeightmKXJcVc - heightOrZero2) - (z3 ? LayoutUtilKt.getHeightOrZero((Placeable) objectRef2.element) : 0);
                ...
                while (i15 < size9) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable16), TextFieldImplKt.ContainerId)) {
                        final Placeable mo6697measureBRTryo05 = measurable16.mo6697measureBRTryo0(ConstraintsKt.Constraints(m3160calculateWidthyeHjK3Y != Integer.MAX_VALUE ? m3160calculateWidthyeHjK3Y : 0, m3160calculateWidthyeHjK3Y, heightOrZero3 != Integer.MAX_VALUE ? heightOrZero3 : 0, heightOrZero3));
                        final int i16 = m3159calculateHeightmKXJcVc;
                        final boolean z4 = z3;
                        final Ref.ObjectRef objectRef3 = objectRef2;
                        final int i17 = i;
                        final Placeable placeable5 = mo6697measureBRTryo0;
                        final Placeable placeable6 = placeable;
                        final Placeable placeable7 = mo6697measureBRTryo04;
                        final Placeable placeable8 = mo6697measureBRTryo02;
                        return MeasureScope.layout$default(measureScope, m3160calculateWidthyeHjK3Y, i16, null, new Function1() { // from class: androidx.compose.material3.TextFieldMeasurePolicy$$ExternalSyntheticLambda2
                            @Override // kotlin.jvm.functions.Function1
                            public final Object invoke(Object obj) {
                                Unit measure_3p2s80s$lambda$9;
                                measure_3p2s80s$lambda$9 = TextFieldMeasurePolicy.measure_3p2s80s$lambda$9(Ref.ObjectRef.this, z4, this, heightOrZero3, i17, measureScope, m3160calculateWidthyeHjK3Y, i16, mo6697measureBRTryo03, placeable7, placeable5, placeable6, placeable8, placeable4, mo6697measureBRTryo05, placeable3, invoke, (Placeable.PlacementScope) obj);
                                return measure_3p2s80s$lambda$9;
                            }
                        }, 4, null);
                    }
                    i15++;
                    m3159calculateHeightmKXJcVc = m3159calculateHeightmKXJcVc;
                    z3 = z3;
            ...
            z = z;
            objectRef = objectRef;
            m7967offsetNN6EwU = m7967offsetNN6EwU;
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
    }
        ...
        if (objectRef.element != 0) {
            if (z) {
                ...
                if (textFieldMeasurePolicy.singleLine) {
                    ...
                    measureScope2 = measureScope;
                    i5 = i2 + measureScope2.mo423roundToPx0680j_4(textFieldMeasurePolicy.minimizedLabelHalfHeight);
                }
                i6 = i5;
            }
    ...
    private final int m3160calculateWidthyeHjK3Y(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        int i8 = i3 + i4;
        return ConstraintsKt.m7965constrainWidthK40F9xA(j, i + Math.max(i5 + i8, Math.max(i7 + i8, i6)) + i2);
    }

    /* renamed from: calculateHeight-mKXJcVc  reason: not valid java name */
    private final int m3159calculateHeightmKXJcVc(Density density, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, boolean z, float f) {
        int mo423roundToPx0680j_4 = density.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.paddingValues.mo788calculateTopPaddingD9Ej5fM() + this.paddingValues.mo785calculateBottomPaddingD9Ej5fM())) + ((i2 <= 0 || z) ? 0 : Math.max(density.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.minimizedLabelHalfHeight * 2)), MathHelpersKt.lerp(0, i2, MotionTokens.INSTANCE.getEasingEmphasizedAccelerateCubicBezier().transform(f)))) + ComparisonsKt.maxOf(i, i7, i5, i6, z ? 0 : MathHelpersKt.lerp(i2, 0, f));
        if (!z) {
            i2 = 0;
        }
        return ConstraintsKt.m7964constrainHeightK40F9xA(j, i2 + Math.max(i3, Math.max(i4, mo423roundToPx0680j_4)) + i8);
    }
    ...
    private final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i, int i2, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, Placeable placeable8, float f) {
        Placeable.PlacementScope.m6762place70tqf50$default(placementScope, placeable7, IntOffset.Companion.m8134getZeronOccac(), 0.0f, 2, null);
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable7), TextFieldImplKt.TextFieldId)) {
                ...
                return m3160calculateWidthyeHjK3Y(intValue6, intValue3, intValue4, intValue5, intValue, intValue2, intrinsicMeasurable14 != null ? function2.invoke(intrinsicMeasurable14, Integer.valueOf(i)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
            }
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        while (i14 < size6) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable13), TextFieldImplKt.TextFieldId)) {
                ...
                return textFieldMeasurePolicy.m3159calculateHeightmKXJcVc(intrinsicMeasureScope, intValue3, intValue, i4, i5, i7, i8, intValue4, intrinsicMeasurable15 != null ? function2.invoke(intrinsicMeasurable15, Integer.valueOf(i2)).intValue() : 0, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), textFieldMeasurePolicy.labelPosition instanceof TextFieldLabelPosition.Above, textFieldMeasurePolicy.labelProgress.invoke());
            }
            i14++;
