...
public final class ListItemDefaults {
    ...
    private static final float Elevation = ListTokens.INSTANCE.m4121getListItemContainerElevationD9Ej5fM();
    ...
    public final ListItemColors m2602colorsJ08w3E(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, Composer composer, int i, int i2) {
        ...
        long m5460getUnspecified0d7_KjU9 = (i2 & 256) != 0 ? Color.Companion.m5460getUnspecified0d7_KjU() : j9;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-352515689, i, -1, "androidx.compose.material3.ListItemDefaults.colors (ListItem.kt:576)");
        }
        ListItemColors m2587copy5r9EGqc = getDefaultListItemColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2587copy5r9EGqc(m5460getUnspecified0d7_KjU, m5460getUnspecified0d7_KjU2, m5460getUnspecified0d7_KjU3, m5460getUnspecified0d7_KjU4, m5460getUnspecified0d7_KjU5, m5460getUnspecified0d7_KjU6, m5460getUnspecified0d7_KjU7, m5460getUnspecified0d7_KjU8, m5460getUnspecified0d7_KjU9);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2587copy5r9EGqc;
    }
