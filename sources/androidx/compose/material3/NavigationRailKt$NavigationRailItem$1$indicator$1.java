...
final class NavigationRailKt$NavigationRailItem$1$indicator$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        BoxKt.Box(BackgroundKt.m298backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue), this.$colors.m2768getIndicatorColor0d7_KjU$material3(), this.$indicatorShape), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
