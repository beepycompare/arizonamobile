...
public final class DatePickerKt$Day$2 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        Modifier m970requiredSizeVpY3zN4 = SizeKt.m970requiredSizeVpY3zN4(Modifier.Companion, DatePickerModalTokens.INSTANCE.m3932getDateContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3931getDateContainerHeightD9Ej5fM());
        ...
        Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer, m970requiredSizeVpY3zN4);
        ...
        TextKt.m3255TextNvy7gAk(str, SemanticsModifierKt.clearAndSetSemantics(companion, (Function1) rememberedValue), datePickerColors.dayContentColor$material3(z, z2, z3, z4, composer, 0).getValue().m5434unboximpl(), null, 0L, null, null, null, 0L, null, TextAlign.m8129boximpl(TextAlign.Companion.m8136getCentere0LSkKk()), 0L, 0, false, 0, 0, null, null, composer, 0, 0, 261112);
        ComposerKt.sourceInformationMarkerEnd(composer);
        ComposerKt.sourceInformationMarkerEnd(composer);
        composer.endNode();
        ComposerKt.sourceInformationMarkerEnd(composer);
