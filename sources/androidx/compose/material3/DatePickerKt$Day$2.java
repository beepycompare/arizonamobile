...
public final class DatePickerKt$Day$2 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        Modifier m1111requiredSizeVpY3zN4 = SizeKt.m1111requiredSizeVpY3zN4(Modifier.Companion, DatePickerModalTokens.INSTANCE.m3761getDateContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3760getDateContainerHeightD9Ej5fM());
        ...
        Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer, m1111requiredSizeVpY3zN4);
        ...
        TextKt.m3157TextNvy7gAk(str, SemanticsModifierKt.clearAndSetSemantics(companion, (Function1) rememberedValue), datePickerColors.dayContentColor$material3(z, z2, z3, z4, composer, 0).getValue().m5358unboximpl(), null, 0L, null, null, null, 0L, null, TextAlign.m8031boximpl(TextAlign.Companion.m8038getCentere0LSkKk()), 0L, 0, false, 0, 0, null, null, composer, 0, 0, 261112);
        ComposerKt.sourceInformationMarkerEnd(composer);
        ComposerKt.sourceInformationMarkerEnd(composer);
        composer.endNode();
        ComposerKt.sourceInformationMarkerEnd(composer);
