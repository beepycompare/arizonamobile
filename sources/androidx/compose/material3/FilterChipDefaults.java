...
public final class FilterChipDefaults {
    ...
    private static final float Height = FilterChipTokens.INSTANCE.m4070getContainerHeightD9Ej5fM();
    private static final float IconSize = FilterChipTokens.INSTANCE.m4086getIconSizeD9Ej5fM();

    private FilterChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM  reason: not valid java name */
    public final float m2476getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM  reason: not valid java name */
    public final float m2477getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final SelectableChipColors m2474filterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        long m5460getUnspecified0d7_KjU11 = (i3 & 1024) != 0 ? Color.Companion.m5460getUnspecified0d7_KjU() : j11;
        long m5460getUnspecified0d7_KjU12 = (i3 & 2048) != 0 ? Color.Companion.m5460getUnspecified0d7_KjU() : j12;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1831479801, i, i2, "androidx.compose.material3.FilterChipDefaults.filterChipColors (Chip.kt:1302)");
        }
        SelectableChipColors m2955copydaRQuJA = getDefaultFilterChipColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2955copydaRQuJA(m5460getUnspecified0d7_KjU, m5460getUnspecified0d7_KjU2, m5460getUnspecified0d7_KjU3, m5460getUnspecified0d7_KjU3, m5460getUnspecified0d7_KjU4, m5460getUnspecified0d7_KjU5, m5460getUnspecified0d7_KjU6, m5460getUnspecified0d7_KjU7, m5460getUnspecified0d7_KjU8, m5460getUnspecified0d7_KjU9, m5460getUnspecified0d7_KjU10, m5460getUnspecified0d7_KjU11, m5460getUnspecified0d7_KjU12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2955copydaRQuJA;
    }
    ...
    public final SelectableChipColors getDefaultFilterChipColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultFilterChipColorsCached$material3 == null) {
            SelectableChipColors selectableChipColors = new SelectableChipColors(Color.Companion.m5459getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getUnselectedLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getUnselectedLeadingIconColor()), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getUnselectedTrailingIconColor()), Color.Companion.m5459getTransparent0d7_KjU(), Color.m5423copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getDisabledLabelTextColor()), FilterChipTokens.INSTANCE.getDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5423copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getDisabledLeadingIconColor()), FilterChipTokens.INSTANCE.getDisabledLeadingIconOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5423copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getDisabledTrailingIconColor()), FilterChipTokens.INSTANCE.getDisabledTrailingIconOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getFlatSelectedContainerColor()), Color.m5423copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerColor()), FilterChipTokens.INSTANCE.getFlatDisabledSelectedContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getSelectedLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getSelectedLeadingIconColor()), ColorSchemeKt.fromToken(colorScheme, FilterChipTokens.INSTANCE.getSelectedTrailingIconColor()), null);
    ...
    public final SelectableChipElevation m2475filterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilterChipTokens.INSTANCE.m4077getFlatContainerElevationD9Ej5fM();
        }
        float f7 = f;
        if ((i2 & 2) != 0) {
            f2 = FilterChipTokens.INSTANCE.m4081getFlatSelectedPressedContainerElevationD9Ej5fM();
        }
        float f8 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilterChipTokens.INSTANCE.m4078getFlatSelectedFocusContainerElevationD9Ej5fM();
        }
        float f9 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilterChipTokens.INSTANCE.m4079getFlatSelectedHoverContainerElevationD9Ej5fM();
        }
        float f10 = f4;
        float m4071getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m4071getDraggedContainerElevationD9Ej5fM() : f5;
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(f7, f8, f9, f10, m4071getDraggedContainerElevationD9Ej5fM, f11, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final BorderStroke m2473filterChipBorder_7El2pE(boolean z, boolean z2, long j, long j2, long j3, long j4, float f, float f2, Composer composer, int i, int i2) {
        ...
        long m5459getTransparent0d7_KjU = (i2 & 8) != 0 ? Color.Companion.m5459getTransparent0d7_KjU() : j2;
        long m5423copywmQWz5c$default = (i2 & 16) != 0 ? Color.m5423copywmQWz5c$default(ColorSchemeKt.getValue(FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineColor(), composer, 6), FilterChipTokens.INSTANCE.getFlatDisabledUnselectedOutlineOpacity(), 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m5459getTransparent0d7_KjU2 = (i2 & 32) != 0 ? Color.Companion.m5459getTransparent0d7_KjU() : j4;
        float m4084getFlatUnselectedOutlineWidthD9Ej5fM = (i2 & 64) != 0 ? FilterChipTokens.INSTANCE.m4084getFlatUnselectedOutlineWidthD9Ej5fM() : f;
        float m4080getFlatSelectedOutlineWidthD9Ej5fM = (i2 & 128) != 0 ? FilterChipTokens.INSTANCE.m4080getFlatSelectedOutlineWidthD9Ej5fM() : f2;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1138342447, i, -1, "androidx.compose.material3.FilterChipDefaults.filterChipBorder (Chip.kt:1409)");
        }
        if (!z) {
            value = z2 ? m5459getTransparent0d7_KjU2 : m5423copywmQWz5c$default;
        } else if (z2) {
            value = m5459getTransparent0d7_KjU;
        }
        if (z2) {
            m4084getFlatUnselectedOutlineWidthD9Ej5fM = m4080getFlatSelectedOutlineWidthD9Ej5fM;
        }
        BorderStroke m332BorderStrokecXLIe8U = BorderStrokeKt.m332BorderStrokecXLIe8U(m4084getFlatUnselectedOutlineWidthD9Ej5fM, value);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final SelectableChipColors m2471elevatedFilterChipColorsXqyqHi0(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, Composer composer, int i, int i2, int i3) {
        ...
        SelectableChipColors m2955copydaRQuJA = getDefaultElevatedFilterChipColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2955copydaRQuJA(m5460getUnspecified0d7_KjU, m5460getUnspecified0d7_KjU2, m5460getUnspecified0d7_KjU3, m5460getUnspecified0d7_KjU3, m5460getUnspecified0d7_KjU4, m5460getUnspecified0d7_KjU5, m5460getUnspecified0d7_KjU6, m5460getUnspecified0d7_KjU7, m5460getUnspecified0d7_KjU8, m5460getUnspecified0d7_KjU9, m5460getUnspecified0d7_KjU10, m5460getUnspecified0d7_KjU11, m5460getUnspecified0d7_KjU12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final SelectableChipElevation m2472elevatedFilterChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilterChipTokens.INSTANCE.m4072getElevatedContainerElevationD9Ej5fM();
        }
        float f7 = f;
        if ((i2 & 2) != 0) {
            f2 = FilterChipTokens.INSTANCE.m4076getElevatedPressedContainerElevationD9Ej5fM();
        }
        float f8 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilterChipTokens.INSTANCE.m4074getElevatedFocusContainerElevationD9Ej5fM();
        }
        float f9 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilterChipTokens.INSTANCE.m4075getElevatedHoverContainerElevationD9Ej5fM();
        }
        float f10 = f4;
        float m4071getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? FilterChipTokens.INSTANCE.m4071getDraggedContainerElevationD9Ej5fM() : f5;
        float m4073getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? FilterChipTokens.INSTANCE.m4073getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        SelectableChipElevation selectableChipElevation = new SelectableChipElevation(f7, f8, f9, f10, m4071getDraggedContainerElevationD9Ej5fM, m4073getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
