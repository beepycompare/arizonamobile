...
final class TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1 implements MeasurePolicy {
    ...
    public static final Unit measure_3p2s80s$lambda$3(boolean z, int i, Placeable placeable, int i2, Placeable placeable2, int i3, int i4, int i5, MeasureScope measureScope, Placeable placeable3, int i6, int i7, int i8, int i9, Placeable.PlacementScope placementScope) {
        if (z) {
            ...
            int i10 = i4 >= i5 ? measureScope.mo423roundToPx0680j_4(Dp.m7995constructorimpl(16)) : 0;
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "timePickerContent")) {
                        ...
                        while (i4 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "actions")) {
                                float f = 24;
                                final int i5 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(f));
                                final int i6 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl((float) RendererCapabilities.DECODER_SUPPORT_MASK));
                                final int i7 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(f));
                                final int i8 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(16));
                                final int i9 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(4));
                                final int i10 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(8));
                                final int i11 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(f));
                                int i12 = measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(f));
                                final Placeable mo6697measureBRTryo0 = measurable2.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                if (mo6697measureBRTryo0.getWidth() <= mo6697measureBRTryo0.getHeight() || mo6697measureBRTryo0.getHeight() < MathKt.truncate(measureScope2.mo429toPx0680j_4(TimePickerKt.getClockDialMinContainerSize()))) {
                                    i = i12;
                                    z = false;
                                } else {
                                    i = i12;
                                ...
                                final boolean z2 = z;
                                final Placeable mo6697measureBRTryo02 = measurable3.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j, 0, mo6697measureBRTryo0.getWidth(), 0, 0, 8, null));
                                final Placeable mo6697measureBRTryo03 = measurable.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j, 0, mo6697measureBRTryo0.getWidth(), 0, 0, 8, null));
                                if (z2) {
                                    height = mo6697measureBRTryo0.getHeight() + mo6697measureBRTryo02.getHeight() + i10 + i8 + i9;
                                    if (Constraints.m7943getHasBoundedHeightimpl(j)) {
                                        height = Constraints.m7947getMaxHeightimpl(j);
                                    }
                                } else {
                                    height = mo6697measureBRTryo03.getHeight() + i11 + mo6697measureBRTryo0.getHeight() + mo6697measureBRTryo02.getHeight() + i;
                                }
                                ...
                                return MeasureScope.layout$default(measureScope, i13, i14, null, new Function1() { // from class: androidx.compose.material3.TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1$$ExternalSyntheticLambda0
                                    ...
                                    public final Object invoke(Object obj) {
                                        ...
                                        measure_3p2s80s$lambda$3 = TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1.measure_3p2s80s$lambda$3(z2, i8, mo6697measureBRTryo0, i9, mo6697measureBRTryo02, i10, i14, i6, measureScope, mo6697measureBRTryo03, i7, i5, i11, i13, (Placeable.PlacementScope) obj);
