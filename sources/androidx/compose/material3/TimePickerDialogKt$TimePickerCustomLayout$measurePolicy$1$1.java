...
final class TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1 implements MeasurePolicy {
    ...
    public static final Unit measure_3p2s80s$lambda$3(boolean z, int i, Placeable placeable, int i2, Placeable placeable2, int i3, int i4, int i5, MeasureScope measureScope, Placeable placeable3, int i6, int i7, int i8, int i9, Placeable.PlacementScope placementScope) {
        if (z) {
            ...
            int i10 = i4 >= i5 ? measureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(16.0f)) : 0;
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "timePickerContent")) {
                        ...
                        while (i4 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "actions")) {
                                final int i5 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(24.0f));
                                final int i6 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(384.0f));
                                final int i7 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(24.0f));
                                final int i8 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(16.0f));
                                final int i9 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(4.0f));
                                final int i10 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(8.0f));
                                final int i11 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(24.0f));
                                int i12 = measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(24.0f));
                                final Placeable mo6818measureBRTryo0 = measurable2.mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                if (mo6818measureBRTryo0.getWidth() <= mo6818measureBRTryo0.getHeight() || mo6818measureBRTryo0.getHeight() < MathKt.truncate(measureScope2.mo434toPx0680j_4(TimePickerKt.getClockDialMinContainerSize()))) {
                                    i = i12;
                                    z = false;
                                } else {
                                    i = i12;
                                ...
                                if (z) {
                                    width = mo6818measureBRTryo0.getWidth();
                                } else {
                                    width = mo6818measureBRTryo0.getWidth();
                                }
                                final int i13 = width + (i5 * 2);
                                final boolean z2 = z;
                                final Placeable mo6818measureBRTryo02 = measurable3.mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, mo6818measureBRTryo0.getWidth(), 0, 0, 8, null));
                                final Placeable mo6818measureBRTryo03 = measurable.mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, mo6818measureBRTryo0.getWidth(), 0, 0, 8, null));
                                if (z2) {
                                    height = mo6818measureBRTryo0.getHeight() + mo6818measureBRTryo02.getHeight() + i10 + i8 + i9;
                                    if (Constraints.m8108getHasBoundedHeightimpl(j)) {
                                        height = Constraints.m8112getMaxHeightimpl(j);
                                    }
                                } else {
                                    height = mo6818measureBRTryo03.getHeight() + i11 + mo6818measureBRTryo0.getHeight() + mo6818measureBRTryo02.getHeight() + i;
                                }
                                ...
                                return MeasureScope.layout$default(measureScope, i13, i14, null, new Function1() { // from class: androidx.compose.material3.TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1$$ExternalSyntheticLambda0
                                    ...
                                    public final Object invoke(Object obj) {
                                        return TimePickerDialogKt$TimePickerCustomLayout$measurePolicy$1$1.measure_3p2s80s$lambda$3(z2, i8, mo6818measureBRTryo0, i9, mo6818measureBRTryo02, i10, i14, i6, measureScope, mo6818measureBRTryo03, i7, i5, i11, i13, (Placeable.PlacementScope) obj);
                                    }
                                }, 4, null);
                            }
                            i4++;
