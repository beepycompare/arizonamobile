...
public final class DateInputValidator {
    ...
    */
    public final String m2114validateXivgLIo(CalendarDate calendarDate, int i, Locale locale) {
        if (calendarDate == null) {
            ...
            if (InputIdentifier.m2291equalsimpl0(i, InputIdentifier.Companion.m2297getStartDateInputJ2x2o4M())) {
                long utcTimeMillis = calendarDate.getUtcTimeMillis();
                Long l = this.currentEndDateMillis;
            }
            if (InputIdentifier.m2291equalsimpl0(i, InputIdentifier.Companion.m2295getEndDateInputJ2x2o4M())) {
