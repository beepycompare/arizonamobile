...
public final class DateInputValidator {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0088, code lost:
        if (r0 <= (r10 != null ? r10.longValue() : Long.MAX_VALUE)) goto L23;
     */
    /* renamed from: validate-XivgLIo  reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final String m1955validateXivgLIo(CalendarDate calendarDate, int i, Locale locale) {
        if (calendarDate == null) {
            ...
            if (InputIdentifier.m2186equalsimpl0(i, InputIdentifier.Companion.m2192getStartDateInputJ2x2o4M())) {
                long utcTimeMillis = calendarDate.getUtcTimeMillis();
                Long l = this.currentEndDateMillis;
            }
            if (InputIdentifier.m2186equalsimpl0(i, InputIdentifier.Companion.m2190getEndDateInputJ2x2o4M())) {
