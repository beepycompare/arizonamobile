...
public final class DateInputValidator {
    ...
    */
    public final String m2184validateXivgLIo(CalendarDate calendarDate, int i, Locale locale) {
        if (calendarDate == null) {
            ...
            if (InputIdentifier.m2489equalsimpl0(i, InputIdentifier.Companion.m2495getStartDateInputJ2x2o4M())) {
                long utcTimeMillis = calendarDate.getUtcTimeMillis();
                Long l = this.currentEndDateMillis;
            }
            if (InputIdentifier.m2489equalsimpl0(i, InputIdentifier.Companion.m2493getEndDateInputJ2x2o4M())) {
