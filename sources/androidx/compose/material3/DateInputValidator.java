...
public final class DateInputValidator {
    ...
    */
    public final String m2400validateXivgLIo(CalendarDate calendarDate, int i, Locale locale) {
        if (calendarDate == null) {
            ...
            if (InputIdentifier.m2631equalsimpl0(i, InputIdentifier.Companion.m2637getStartDateInputJ2x2o4M())) {
                long utcTimeMillis = calendarDate.getUtcTimeMillis();
                Long l = this.currentEndDateMillis;
            }
            if (InputIdentifier.m2631equalsimpl0(i, InputIdentifier.Companion.m2635getEndDateInputJ2x2o4M())) {
