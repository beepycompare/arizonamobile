...
public final class BadgeKt {
    private static final float BadgeWithContentHorizontalPadding = Dp.m7264constructorimpl(4);
    private static final float BadgeWithContentHorizontalOffset = Dp.m7264constructorimpl(12);
    private static final float BadgeWithContentVerticalOffset = Dp.m7264constructorimpl(14);
    private static final float BadgeOffset = Dp.m7264constructorimpl(6);
    ...
    */
    public static final void BadgedBox(final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function3, Modifier modifier, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function32, Composer composer, final int i, final int i2) {
                        ...
                        public final MeasureResult mo52measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
                            ...
                            for (int i5 = 0; i5 < size; i5++) {
                                ...
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "badge")) {
                                    final Placeable mo5967measureBRTryo0 = measurable.mo5967measureBRTryo0(Constraints.m7207copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                    int size2 = list.size();
                                    for (int i6 = 0; i6 < size2; i6++) {
                                        Measurable measurable2 = list.get(i6);
                                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "anchor")) {
                                            final Placeable mo5967measureBRTryo02 = measurable2.mo5967measureBRTryo0(j);
                                            int i7 = mo5967measureBRTryo02.get(AlignmentLineKt.getFirstBaseline());
                                            int i8 = mo5967measureBRTryo02.get(AlignmentLineKt.getLastBaseline());
                                            ...
                                            return measureScope.layout(width, height, mapOf, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BadgeKt$BadgedBox$3$1.1
                                                ...
                                                public final void invoke2(Placeable.PlacementScope placementScope) {
                                                    ...
                                                    boolean z = Placeable.this.getWidth() > measureScope.mo423roundToPx0680j_4(BadgeTokens.INSTANCE.m3136getSizeD9Ej5fM());
                                                    ...
                                                    Placeable.PlacementScope.placeRelative$default(placementScope, mo5967measureBRTryo02, 0, 0, 0.0f, 4, null);
                                                    int width2 = mo5967measureBRTryo02.getWidth() - measureScope.mo423roundToPx0680j_4(badgeWithContentHorizontalOffset);
                                                    int i9 = (-Placeable.this.getHeight()) + measureScope.mo423roundToPx0680j_4(badgeWithContentVerticalOffset);
        ...
        m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
        Updater.m3874setimpl(m3867constructorimpl, measurePolicy2, ComposeUiNode.Companion.getSetMeasurePolicy());
        ...
        m3867constructorimpl2 = Updater.m3867constructorimpl(startRestartGroup);
        Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy3, ComposeUiNode.Companion.getSetMeasurePolicy());
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m1909BadgeeopBjH0(Modifier modifier, long j, long j2, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        long j3;
        long j4;
        ...
        if (i5 != 0) {
            ...
            if ((i3 & 1171) == 1170 || !startRestartGroup.getSkipping()) {
                ...
                float m3135getLargeSizeD9Ej5fM = obj2 == null ? badgeTokens.m3135getLargeSizeD9Ej5fM() : badgeTokens.m3136getSizeD9Ej5fM();
                if (obj2 == null) {
                ...
                Modifier m266backgroundbw27NRU = BackgroundKt.m266backgroundbw27NRU(SizeKt.m878defaultMinSizeVpY3zN4(companion, m3135getLargeSizeD9Ej5fM, m3135getLargeSizeD9Ej5fM), j3, value);
                if (obj2 == null) {
                    companion2 = PaddingKt.m844paddingVpY3zN4$default(Modifier.Companion, BadgeWithContentHorizontalPadding, 0.0f, 2, null);
                } else {
                    companion2 = Modifier.Companion;
                }
                Modifier then = m266backgroundbw27NRU.then(companion2);
                ...
                if (obj2 == null) {
                    ProvideContentColorTextStyleKt.m3024ProvideContentColorTextStyle3JVO9M(j4, TypographyKt.getValue(BadgeTokens.INSTANCE.getLargeLabelTextFont(), startRestartGroup, 6), ComposableLambdaKt.rememberComposableLambda(719214594, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$1$1
                        /* JADX INFO: Access modifiers changed from: package-private */
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BadgeKt$Badge$2
                    ...
                    public final void invoke(Composer composer3, int i6) {
                        BadgeKt.m1909BadgeeopBjH0(Modifier.this, j5, j6, function32, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
                return;
            }
        ...
        Modifier m266backgroundbw27NRU2 = BackgroundKt.m266backgroundbw27NRU(SizeKt.m878defaultMinSizeVpY3zN4(companion, m3135getLargeSizeD9Ej5fM, m3135getLargeSizeD9Ej5fM), j3, value);
        if (obj2 == null) {
        }
        Modifier then2 = m266backgroundbw27NRU2.then(companion2);
