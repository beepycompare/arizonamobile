    ...
    public final MeasureResult mo54measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (i < size) {
            ...
            if (LayoutIdKt.getLayoutId(measurable) == RangeSliderComponents.STARTTHUMB) {
                final Placeable mo6875measureBRTryo0 = measurable.mo6875measureBRTryo0(j2);
                int size2 = list2.size();
                int i2 = 0;
                while (i2 < size2) {
                    Measurable measurable2 = list.get(i2);
                    if (LayoutIdKt.getLayoutId(measurable2) == RangeSliderComponents.ENDTHUMB) {
                        final Placeable mo6875measureBRTryo02 = measurable2.mo6875measureBRTryo0(j2);
                        int size3 = list2.size();
                        int i3 = 0;
                        while (i3 < size3) {
                            Measurable measurable3 = list.get(i3);
                            if (LayoutIdKt.getLayoutId(measurable3) == RangeSliderComponents.TRACK) {
                                final Placeable mo6875measureBRTryo03 = measurable3.mo6875measureBRTryo0(Constraints.m8201copyZbe2FdA$default(ConstraintsKt.m8231offsetNN6EwU$default(j2, (-(mo6875measureBRTryo0.getWidth() + mo6875measureBRTryo02.getWidth())) / 2, 0, 2, null), 0, 0, 0, 0, 11, null));
                                int width = mo6875measureBRTryo03.getWidth() + ((mo6875measureBRTryo0.getWidth() + mo6875measureBRTryo02.getWidth()) / 2);
                                int max = Math.max(mo6875measureBRTryo03.getHeight(), Math.max(mo6875measureBRTryo0.getHeight(), mo6875measureBRTryo02.getHeight()));
                                ...
                                final int width2 = mo6875measureBRTryo0.getWidth() / 2;
                                int i4 = mo6875measureBRTryo03.get(SliderKt.getCornerSizeAlignmentLine());
                                int i5 = i4 != Integer.MIN_VALUE ? i4 : 0;
                                if (this.$state.getSteps() > 0 && !z2) {
                                    roundToInt = MathKt.roundToInt((mo6875measureBRTryo03.getWidth() - (i5 * 2)) * coercedActiveRangeStartAsFraction$material3) + i5;
                                } else {
                                    roundToInt = MathKt.roundToInt(mo6875measureBRTryo03.getWidth() * coercedActiveRangeStartAsFraction$material3);
                                }
                                final int i6 = roundToInt;
                                int width3 = (mo6875measureBRTryo0.getWidth() - mo6875measureBRTryo02.getWidth()) / 2;
                                if (this.$state.getSteps() > 0 && !z) {
                                    roundToInt2 = MathKt.roundToInt(((mo6875measureBRTryo03.getWidth() - (i5 * 2)) * coercedActiveRangeEndAsFraction$material3) + width3) + i5;
                                } else {
                                    roundToInt2 = MathKt.roundToInt((mo6875measureBRTryo03.getWidth() * coercedActiveRangeEndAsFraction$material3) + width3);
                                }
                                final int i7 = roundToInt2;
                                final int height = (max - mo6875measureBRTryo03.getHeight()) / 2;
                                final int height2 = (max - mo6875measureBRTryo0.getHeight()) / 2;
                                final int height3 = (max - mo6875measureBRTryo02.getHeight()) / 2;
                                return MeasureScope.layout$default(measureScope, width, max, null, new Function1() { // from class: androidx.compose.material3.SliderKt$RangeSliderImpl$2$1$$ExternalSyntheticLambda0
                                    ...
                                    public final Object invoke(Object obj) {
                                        ...
                                        measure_3p2s80s$lambda$4 = SliderKt$RangeSliderImpl$2$1.measure_3p2s80s$lambda$4(Placeable.this, width2, height, mo6875measureBRTryo0, i6, height2, mo6875measureBRTryo02, i7, height3, (Placeable.PlacementScope) obj);
