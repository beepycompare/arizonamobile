...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m8158boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            Object animatable2 = new Animatable(Dp.m8158boximpl(f), VectorConvertersKt.getVectorConverter(Dp.Companion), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m8158boximpl, (Function2) rememberedValue4, composer, 0);
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m8165equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m8165equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m8165equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m8165equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m8165equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m8166hashCodeimpl(this.defaultElevation) * 31) + Dp.m8166hashCodeimpl(this.pressedElevation)) * 31) + Dp.m8166hashCodeimpl(this.focusedElevation)) * 31) + Dp.m8166hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m8166hashCodeimpl(this.disabledElevation);
    }
}
