...
public final class KeylinesKt {
    public static /* synthetic */ KeylineList multiBrowseKeylineList$default(Density density, float f, float f2, float f3, int i, float f4, float f5, int i2, Object obj) {
        if ((i2 & 32) != 0) {
            f4 = density.mo429toPx0680j_4(CarouselDefaults.INSTANCE.m3002getMinSmallItemSizeD9Ej5fM$material3_release());
        }
        float f6 = f4;
        if ((i2 & 64) != 0) {
            f5 = density.mo429toPx0680j_4(CarouselDefaults.INSTANCE.m3001getMaxSmallItemSizeD9Ej5fM$material3_release());
        }
    ...
    public static final KeylineList multiBrowseKeylineList(Density density, float f, float f2, float f3, int i, float f4, float f5) {
        ...
        float mo429toPx0680j_4 = density.mo429toPx0680j_4(CarouselDefaults.INSTANCE.m3000getAnchorSizeD9Ej5fM$material3_release());
    ...
    public static final KeylineList createLeftAlignedKeylineList(float f, float f2, final float f3, final float f4, final Arrangement arrangement) {
        return KeylineListKt.m3008keylineListOfWNYm7Xg(f, f2, CarouselAlignment.Companion.m2999getStartNUL3oTo(), new Function1<KeylineListScope, Unit>() { // from class: androidx.compose.material3.carousel.KeylinesKt$createLeftAlignedKeylineList$1
