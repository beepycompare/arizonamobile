...
public final class ChipColors {
    ...
    public final long m2120getDisabledTrailingIconContentColor0d7_KjU() {
        return this.disabledTrailingIconContentColor;
    }

    /* renamed from: copy-FD3wquc$default  reason: not valid java name */
    public static /* synthetic */ ChipColors m2113copyFD3wquc$default(ChipColors chipColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, int i, Object obj) {
        long j9;
        long j10;
        ...
        return chipColors.m2115copyFD3wquc(j10, j12, j13, j14, j15, j16, j17, j9);
    }

    /* renamed from: copy-FD3wquc  reason: not valid java name */
    public final ChipColors m2115copyFD3wquc(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8) {
    ...
    public final long m2114containerColorvNxB06k$material3(boolean z) {
    ...
    public final long m2124labelColorvNxB06k$material3(boolean z) {
    ...
    public final long m2125leadingIconContentColorvNxB06k$material3(boolean z) {
    ...
    public final long m2126trailingIconContentColorvNxB06k$material3(boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5425equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m5425equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m5425equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m5425equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m5425equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m5425equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m5425equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m5425equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m5431hashCodeimpl(this.containerColor) * 31) + Color.m5431hashCodeimpl(this.labelColor)) * 31) + Color.m5431hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m5431hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m5431hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m5431hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m5431hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m5431hashCodeimpl(this.disabledTrailingIconContentColor);
    }
}
