...
public final class DatePickerKt$DatePicker$5 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        DatePickerKt.m2436DisplayModeToggleButtoniUJLfQg(padding, mo2441getDisplayModejFl4v0, (Function1) rememberedValue, this.$colors, composer, 6);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Unit invoke$lambda$1$lambda$0(DatePickerState datePickerState, DisplayMode displayMode) {
        datePickerState.mo2442setDisplayModevCnGnXg(displayMode.m2479unboximpl());
        return Unit.INSTANCE;
    }
}
