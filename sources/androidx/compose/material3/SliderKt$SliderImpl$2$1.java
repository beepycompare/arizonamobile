    ...
    public final MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (LayoutIdKt.getLayoutId(measurable) == SliderComponents.THUMB) {
                long j2 = j;
                final Placeable mo6697measureBRTryo02 = measurable.mo6697measureBRTryo0(j2);
                ...
                while (i3 < size2) {
                    ...
                    if (LayoutIdKt.getLayoutId(measurable2) == SliderComponents.TRACK) {
                        if (this.$state.getOrientation$material3() == Orientation.Vertical) {
                            mo6697measureBRTryo0 = measurable2.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(ConstraintsKt.m7968offsetNN6EwU$default(j2, 0, -mo6697measureBRTryo02.getHeight(), 1, null), 0, 0, 0, 0, 14, null));
                        } else {
                            mo6697measureBRTryo0 = measurable2.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(ConstraintsKt.m7968offsetNN6EwU$default(j, -mo6697measureBRTryo02.getWidth(), 0, 2, null), 0, 0, 0, 0, 11, null));
                        }
                        ...
                        if (this.$state.getOrientation$material3() == Orientation.Vertical) {
                            width = Math.max(placeable.getWidth(), mo6697measureBRTryo02.getWidth());
                            max = mo6697measureBRTryo02.getHeight() + placeable.getHeight();
                            width2 = (width - placeable.getWidth()) / 2;
                            height = mo6697measureBRTryo02.getHeight() / 2;
                            i = (width - mo6697measureBRTryo02.getWidth()) / 2;
                            ...
                            width = mo6697measureBRTryo02.getWidth() + placeable.getWidth();
                            max = Math.max(placeable.getHeight(), mo6697measureBRTryo02.getHeight());
                            width2 = mo6697measureBRTryo02.getWidth() / 2;
                            ...
                            i = roundToInt;
                            intRef.element = (max - mo6697measureBRTryo02.getHeight()) / 2;
                        }
                        final int i6 = height;
                        final int i7 = i;
                        final int i8 = width2;
                        ...
                        return MeasureScope.layout$default(measureScope, width, max, null, new Function1() { // from class: androidx.compose.material3.SliderKt$SliderImpl$2$1$$ExternalSyntheticLambda0
                            ...
                            public final Object invoke(Object obj) {
                                ...
                                measure_3p2s80s$lambda$3 = SliderKt$SliderImpl$2$1.measure_3p2s80s$lambda$3(Placeable.this, i8, i6, mo6697measureBRTryo02, i7, intRef, (Placeable.PlacementScope) obj);
