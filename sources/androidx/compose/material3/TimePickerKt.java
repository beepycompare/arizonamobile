...
public final class TimePickerKt {
    ...
    private static final float OuterCircleToSizeRatio = Dp.m7995constructorimpl(101) / TimePickerTokens.INSTANCE.m4341getClockDialContainerSizeD9Ej5fM();
    private static final float InnerCircleToSizeRatio = Dp.m7995constructorimpl(69) / TimePickerTokens.INSTANCE.m4341getClockDialContainerSizeD9Ej5fM();
    private static final float ClockDisplayBottomMargin = Dp.m7995constructorimpl(36);
    private static final float SupportLabelTop = Dp.m7995constructorimpl(7);
    private static final float MaxDistance = Dp.m7995constructorimpl(74);
    private static final float MinimumInteractiveSize = Dp.m7995constructorimpl(48);
    ...
    public static final Unit TimePickerTextField_1vLObsk$lambda$94(Modifier modifier, TextFieldValue textFieldValue, Function1 function1, TimePickerState timePickerState, int i, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, TimePickerColors timePickerColors, int i2, int i3, Composer composer, int i4) {
        m3221TimePickerTextField1vLObsk(modifier, textFieldValue, function1, timePickerState, i, keyboardOptions, keyboardActions, timePickerColors, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit TimePicker_mT9BvqQ$lambda$4(TimePickerState timePickerState, Modifier modifier, TimePickerColors timePickerColors, int i, int i2, int i3, Composer composer, int i4) {
        m3220TimePickermT9BvqQ(timePickerState, modifier, timePickerColors, i, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit TimeSelector_SAnMeKU$lambda$59(Modifier modifier, int i, TimePickerState timePickerState, int i2, TimePickerColors timePickerColors, int i3, Composer composer, int i4) {
        m3222TimeSelectorSAnMeKU(modifier, i, timePickerState, i2, timePickerColors, composer, RecomposeScopeImplKt.updateChangedFlags(i3 | 1));
        return Unit.INSTANCE;
    }
    ...
    */
    public static final void m3220TimePickermT9BvqQ(final TimePickerState timePickerState, Modifier modifier, TimePickerColors timePickerColors, int i, Composer composer, final int i2, final int i3) {
        int i4;
        Object obj;
        Object obj2;
        int i5;
            ...
            if (!startRestartGroup.shouldExecute((i4 & 1171) == 1170, i4 & 1)) {
                ...
                if ((i2 & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i3 & 8) != 0) {
                        ...
                        m3193layoutTypesDNSZnc = TimePickerDefaults.INSTANCE.m3193layoutTypesDNSZnc(startRestartGroup, 6);
                        ...
                        if (!TimePickerLayoutType.m3242equalsimpl0(m3193layoutTypesDNSZnc, TimePickerLayoutType.Companion.m3247getVerticalQJTpgSE())) {
                        ...
                        i6 = m3193layoutTypesDNSZnc;
                    } else {
                        i7 = i4;
                        timePickerColors4 = timePickerColors3;
                    }
                }
                m3193layoutTypesDNSZnc = i5;
                startRestartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                }
    ...
    */
    ...
    public static final TimePickerState rememberTimePickerState(final int i, final int i2, final boolean z, Composer composer, int i3, int i4) {
        ...
        TimePickerStateImpl timePickerStateImpl = (TimePickerStateImpl) RememberSaveableKt.m4725rememberSaveable(objArr, Saver, (Function0<? extends Object>) rememberedValue, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final void m3228moveSelectord3b8Pxo(TimePickerState timePickerState, float f, float f2, float f3, long j) {
        if (TimePickerSelectionMode.m3251equalsimpl0(timePickerState.mo1882getSelectionyecRtBI(), TimePickerSelectionMode.Companion.m3255getHouryecRtBI()) && timePickerState.is24hour()) {
            float dist = dist(f, f2, IntOffset.m8123getXimpl(j), IntOffset.m8124getYimpl(j));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object m3230onTapuYHVD98(AnalogTimePickerState analogTimePickerState, float f, float f2, float f3, boolean z, long j, AnimationSpec<Float> animationSpec, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof TimePickerKt$onTap$1) {
            ...
            if ((timePickerKt$onTap$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    float atan = atan(f2 - IntOffset.m8124getYimpl(j), f - IntOffset.m8123getXimpl(j));
                    if (TimePickerSelectionMode.m3251equalsimpl0(analogTimePickerState.mo1882getSelectionyecRtBI(), TimePickerSelectionMode.Companion.m3256getMinuteyecRtBI())) {
                        f4 = RadiansPerMinute;
                    ...
                    m3228moveSelectord3b8Pxo(analogTimePickerState, f, f2, f3, j);
                    ...
                    if (i == 2) {
                        ...
                        if (z2) {
                            analogTimePickerState.mo1884setSelection6_8s6DQ(TimePickerSelectionMode.Companion.m3256getMinuteyecRtBI());
                        }
                        return Unit.INSTANCE;
                    }
                ...
                if (TimePickerSelectionMode.m3251equalsimpl0(analogTimePickerState.mo1882getSelectionyecRtBI(), TimePickerSelectionMode.Companion.m3255getHouryecRtBI()) && z2) {
                    timePickerKt$onTap$1.L$0 = analogTimePickerState;
                    timePickerKt$onTap$1.Z$0 = z2;
        ...
        if (TimePickerSelectionMode.m3251equalsimpl0(analogTimePickerState.mo1882getSelectionyecRtBI(), TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
            timePickerKt$onTap$1.L$0 = analogTimePickerState;
            timePickerKt$onTap$1.Z$0 = z2;
            timePickerKt$onTap$1.label = 2;
            if (DelayKt.delay(100L, timePickerKt$onTap$1) != coroutine_suspended) {
    ...
    public static final long getSelectorPos(AnalogTimePickerState analogTimePickerState) {
        ...
        float m7995constructorimpl2 = Dp.m7995constructorimpl(Dp.m7995constructorimpl(TimePickerTokens.INSTANCE.m4343getClockDialSelectorHandleContainerSizeD9Ej5fM() / 2.0f) * (analogTimePickerState.m1881getCurrentDiameterD9Ej5fM() / TimePickerTokens.INSTANCE.m4341getClockDialContainerSizeD9Ej5fM()));
        if (analogTimePickerState.is24hour() && isPm(analogTimePickerState) && TimePickerSelectionMode.m3251equalsimpl0(analogTimePickerState.mo1882getSelectionyecRtBI(), TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
            m7995constructorimpl = Dp.m7995constructorimpl(analogTimePickerState.m1881getCurrentDiameterD9Ej5fM() * InnerCircleToSizeRatio);
        } else {
            m7995constructorimpl = Dp.m7995constructorimpl(analogTimePickerState.m1881getCurrentDiameterD9Ej5fM() * OuterCircleToSizeRatio);
        }
        float m7995constructorimpl3 = Dp.m7995constructorimpl(((Dp) RangesKt.coerceAtLeast(Dp.m7993boximpl(Dp.m7995constructorimpl(m7995constructorimpl - m7995constructorimpl2)), Dp.m7993boximpl(Dp.m7995constructorimpl(0)))).m8009unboximpl() + m7995constructorimpl2);
        float f = 2;
        return DpOffset.m8051constructorimpl((Float.floatToRawIntBits(Dp.m7995constructorimpl(Dp.m7995constructorimpl(((float) Math.cos(analogTimePickerState.getCurrentAngle())) * m7995constructorimpl3) + Dp.m7995constructorimpl(analogTimePickerState.m1881getCurrentDiameterD9Ej5fM() / f))) << 32) | (Float.floatToRawIntBits(Dp.m7995constructorimpl(Dp.m7995constructorimpl(m7995constructorimpl3 * ((float) Math.sin(analogTimePickerState.getCurrentAngle()))) + Dp.m7995constructorimpl(analogTimePickerState.m1881getCurrentDiameterD9Ej5fM() / f))) & 4294967295L));
    }
        ...
        if (i6 != 0) {
            ...
            if ((i2 & 8) == 0) {
                ...
                if (startRestartGroup.shouldExecute((i3 & 1171) != 1170, i3 & 1)) {
                    ...
                    ClockFace(SizeKt.m894size3ABfNKs(Modifier.Companion, TimePickerTokens.INSTANCE.m4341getClockDialContainerSizeD9Ej5fM()), analogTimePickerState, timePickerColors3, z2, startRestartGroup, ((i4 << 3) & 112) | 6 | (i4 & 896) | (i4 & 7168));
    ...
    */
    ...
    private static final void TimeInputImpl(Modifier modifier, TimePickerColors timePickerColors, TimePickerState timePickerState, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{TextKt.getLocalTextStyle().provides(TextStyle.m7470copyp1EtxEg$default(TypographyKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldLabelTextFont(), startRestartGroup, 6), timePickerColors.m3191timeSelectorContentColorvNxB06k$material3(true), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.Companion.m7879getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744446, null)), CompositionLocalsKt.getLocalLayoutDirection().provides(LayoutDirection.Ltr)}, ComposableLambdaKt.rememberComposableLambda(1306700887, true, new TimePickerKt$TimeInputImpl$2$1(mutableState, timePickerState2, ref, timePickerColors2, mutableState2), startRestartGroup, 54), startRestartGroup, ProvidedValue.$stable | 48);
            if (!timePickerState2.is24hour()) {
                ...
                VerticalPeriodToggle(SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimeInputTokens.INSTANCE.m4336getPeriodSelectorContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m4335getPeriodSelectorContainerHeightD9Ej5fM()), timePickerState2, timePickerColors2, startRestartGroup, ((i3 >> 3) & 112) | 6 | ((i3 << 3) & 896));
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    private static final void HorizontalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            if (!timePickerState.is24hour()) {
                ...
                int i3 = i2 << 3;
                HorizontalPeriodToggle(SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimePickerTokens.INSTANCE.m4347getPeriodSelectorHorizontalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m4346getPeriodSelectorHorizontalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & 112) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    private static final void VerticalClockDisplay(final TimePickerState timePickerState, final TimePickerColors timePickerColors, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            if (!timePickerState.is24hour()) {
                ...
                int i3 = i2 << 3;
                VerticalPeriodToggle(SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimePickerTokens.INSTANCE.m4350getPeriodSelectorVerticalContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m4349getPeriodSelectorVerticalContainerHeightD9Ej5fM()), timePickerState, timePickerColors, startRestartGroup, (i3 & 896) | (i3 & 112) | 6);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                startRestartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{TextKt.getLocalTextStyle().provides(TypographyKt.getValue(TimePickerTokens.INSTANCE.getTimeSelectorLabelTextFont(), startRestartGroup, 6)), CompositionLocalsKt.getLocalLayoutDirection().provides(LayoutDirection.Ltr)}, ComposableLambdaKt.rememberComposableLambda(-477913269, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$ClockDisplayNumbers$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    TimePickerKt.m3222TimeSelectorSAnMeKU(SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimePickerTokens.INSTANCE.m4353getTimeSelectorContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m4352getTimeSelectorContainerHeightD9Ej5fM()), TimePickerKt.getHourForDisplay(timePickerState2), timePickerState2, TimePickerSelectionMode.Companion.m3255getHouryecRtBI(), timePickerColors2, composer2, 3078);
                    f = TimePickerKt.DisplaySeparatorWidth;
                    TimePickerKt.DisplaySeparator(SizeKt.m896sizeVpY3zN4(Modifier.Companion, f, TimePickerTokens.INSTANCE.m4349getPeriodSelectorVerticalContainerHeightD9Ej5fM()), composer2, 6);
                    TimePickerKt.m3222TimeSelectorSAnMeKU(SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimePickerTokens.INSTANCE.m4353getTimeSelectorContainerWidthD9Ej5fM(), TimePickerTokens.INSTANCE.m4352getTimeSelectorContainerHeightD9Ej5fM()), timePickerState2.getMinute(), timePickerState2, TimePickerSelectionMode.Companion.m3256getMinuteyecRtBI(), timePickerColors2, composer2, 3078);
    ...
    private static final void PeriodToggleImpl(final Modifier modifier, final TimePickerState timePickerState, final TimePickerColors timePickerColors, final MeasurePolicy measurePolicy, final Shape shape, final Shape shape2, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((74899 & i2) != 74898, i2 & 1)) {
            ...
            BorderStroke m297BorderStrokecXLIe8U = BorderStrokeKt.m297BorderStrokecXLIe8U(TimePickerTokens.INSTANCE.m4348getPeriodSelectorOutlineWidthD9Ej5fM(), timePickerColors.m3178getPeriodSelectorBorderColor0d7_KjU());
            Shape value = ShapesKt.getValue(TimePickerTokens.INSTANCE.getPeriodSelectorContainerShape(), startRestartGroup, 6);
            Intrinsics.checkNotNull(value, "null cannot be cast to non-null type androidx.compose.foundation.shape.CornerBasedShape");
            CornerBasedShape cornerBasedShape = (CornerBasedShape) value;
            Strings.Companion companion = Strings.Companion;
            final String m3610getString2EP1pXo = Strings_androidKt.m3610getString2EP1pXo(Strings.m3531constructorimpl(R.string.m3c_time_picker_period_toggle_description), startRestartGroup, 0);
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new Function1() { // from class: androidx.compose.material3.TimePickerKt$$ExternalSyntheticLambda20
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        PeriodToggleImpl$lambda$41$lambda$40 = TimePickerKt.PeriodToggleImpl$lambda$41$lambda$40(m3610getString2EP1pXo, (SemanticsPropertyReceiver) obj);
            ...
            SpacerKt.Spacer(BackgroundKt.m267backgroundbw27NRU$default(SizeKt.fillMaxSize$default(ZIndexModifierKt.zIndex(LayoutIdKt.layoutId(Modifier.Companion, "Spacer"), 2.0f), 0.0f, 1, null), timePickerColors.m3178getPeriodSelectorBorderColor0d7_KjU(), null, 2, null), startRestartGroup, 0);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ToggleItem(isPm, shape3, rememberedValue3, timePickerColors, ComposableSingletons$TimePickerKt.INSTANCE.m2179getLambda$1179219109$material3(), startRestartGroup, ((i2 >> 12) & 112) | 24576 | i4);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            startRestartGroup.endNode();
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
    ...
    private static final void ToggleItem(final boolean z, final Shape shape, final Function0<Unit> function0, final TimePickerColors timePickerColors, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 9363) != 9362, i2 & 1)) {
            ...
            long m3189periodSelectorContentColorvNxB06k$material3 = timePickerColors.m3189periodSelectorContentColorvNxB06k$material3(z);
            long m3188periodSelectorContainerColorvNxB06k$material3 = timePickerColors.m3188periodSelectorContainerColorvNxB06k$material3(z);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ButtonKt.TextButton(function0, SemanticsModifierKt.semantics$default(fillMaxSize$default, false, (Function1) rememberedValue, 1, null), false, shape, ButtonDefaults.INSTANCE.m1984textButtonColorsro_MJ88(m3188periodSelectorContainerColorvNxB06k$material3, m3189periodSelectorContentColorvNxB06k$material3, 0L, 0L, startRestartGroup, 24576, 12), null, null, PaddingKt.m835PaddingValues0680j_4(Dp.m7995constructorimpl(0)), null, function3, startRestartGroup, ((i2 >> 6) & 14) | 12582912 | ((i2 << 6) & 7168) | ((i2 << 15) & 1879048192), 356);
            composer2 = startRestartGroup;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
    ...
    public static final void DisplaySeparator(final Modifier modifier, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            TextStyle m7470copyp1EtxEg$default = TextStyle.m7470copyp1EtxEg$default((TextStyle) consume, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.Companion.m7879getCentere0LSkKk(), 0, 0L, null, null, new LineHeightStyle(LineHeightStyle.Alignment.Companion.m7847getCenterPIaL0Z0(), LineHeightStyle.Trim.Companion.m7868getBothEVpEnUU(), (DefaultConstructorMarker) null), 0, 0, null, 15695871, null);
            ...
            composer2 = startRestartGroup;
            TextKt.m3168TextNvy7gAk(StringUtils.PROCESS_POSTFIX_DELIMITER, null, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSeparatorColor(), startRestartGroup, 6), null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, m7470copyp1EtxEg$default, composer2, 6, 0, 131066);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final void m3222TimeSelectorSAnMeKU(final Modifier modifier, final int i, final TimePickerState timePickerState, final int i2, final TimePickerColors timePickerColors, Composer composer, final int i3) {
        int i4;
        Composer composer2;
        ...
        if (!startRestartGroup.shouldExecute((i4 & 9363) != 9362, i4 & 1)) {
            ...
            boolean m3251equalsimpl0 = TimePickerSelectionMode.m3251equalsimpl0(timePickerState.mo1882getSelectionyecRtBI(), i2);
            if (TimePickerSelectionMode.m3251equalsimpl0(i2, TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
                Strings.Companion companion = Strings.Companion;
                m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_hour_selection);
            } else {
                Strings.Companion companion2 = Strings.Companion;
                m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_minute_selection);
            }
            final String m3610getString2EP1pXo = Strings_androidKt.m3610getString2EP1pXo(m3531constructorimpl, startRestartGroup, 0);
            long m3190timeSelectorContainerColorvNxB06k$material3 = timePickerColors.m3190timeSelectorContainerColorvNxB06k$material3(m3251equalsimpl0);
            long m3191timeSelectorContentColorvNxB06k$material3 = timePickerColors.m3191timeSelectorContentColorvNxB06k$material3(m3251equalsimpl0);
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new Function1() { // from class: androidx.compose.material3.TimePickerKt$$ExternalSyntheticLambda37
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        TimeSelector_SAnMeKU$lambda$56$lambda$55 = TimePickerKt.TimeSelector_SAnMeKU$lambda$56$lambda$55(m3610getString2EP1pXo, (SemanticsPropertyReceiver) obj);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            composer2 = startRestartGroup;
            SurfaceKt.m2997Surfaced85dljk(m3251equalsimpl0, (Function0<Unit>) rememberedValue2, semantics, false, value, m3190timeSelectorContainerColorvNxB06k$material3, 0L, 0.0f, 0.0f, (BorderStroke) null, (MutableInteractionSource) null, (Function2<? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(-1477282471, true, new TimePickerKt$TimeSelector$3(i2, timePickerState, i, m3191timeSelectorContentColorvNxB06k$material3), startRestartGroup, 54), composer2, 0, 48, 1992);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final Unit TimeSelector_SAnMeKU$lambda$56$lambda$55(String str, SemanticsPropertyReceiver semanticsPropertyReceiver) {
        SemanticsPropertiesKt.m7223setRolekuIjeqM(semanticsPropertyReceiver, Role.Companion.m7209getRadioButtono7Vup1c());
        SemanticsPropertiesKt.setContentDescription(semanticsPropertyReceiver, str);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit TimeSelector_SAnMeKU$lambda$58$lambda$57(int i, TimePickerState timePickerState) {
        if (!TimePickerSelectionMode.m3251equalsimpl0(i, timePickerState.mo1882getSelectionyecRtBI())) {
            timePickerState.mo1884setSelection6_8s6DQ(i);
        }
        return Unit.INSTANCE;
    }
    ...
    public static final Unit drawSelector$lambda$61(AnalogTimePickerState analogTimePickerState, TimePickerColors timePickerColors, ContentDrawScope contentDrawScope) {
        float f = contentDrawScope.mo429toPx0680j_4(DpOffset.m8056getXD9Ej5fM(getSelectorPos(analogTimePickerState)));
        float f2 = contentDrawScope.mo429toPx0680j_4(DpOffset.m8058getYD9Ej5fM(getSelectorPos(analogTimePickerState)));
        long m5027constructorimpl = Offset.m5027constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
        float f3 = ((contentDrawScope.mo429toPx0680j_4(TimePickerTokens.INSTANCE.m4343getClockDialSelectorHandleContainerSizeD9Ej5fM()) / 2.0f) * contentDrawScope.mo423roundToPx0680j_4(analogTimePickerState.m1881getCurrentDiameterD9Ej5fM())) / contentDrawScope.mo423roundToPx0680j_4(TimePickerTokens.INSTANCE.m4341getClockDialContainerSizeD9Ej5fM());
        long m3183getSelectorColor0d7_KjU = timePickerColors.m3183getSelectorColor0d7_KjU();
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        DrawScope.m5839drawCircleVaOC9Bg$default(contentDrawScope2, Color.Companion.m5305getBlack0d7_KjU(), f3, m5027constructorimpl, 0.0f, null, null, BlendMode.Companion.m5193getClear0nO6VwU(), 56, null);
        contentDrawScope.drawContent();
        DrawScope.m5839drawCircleVaOC9Bg$default(contentDrawScope2, m3183getSelectorColor0d7_KjU, f3, m5027constructorimpl, 0.0f, null, null, BlendMode.Companion.m5221getXor0nO6VwU(), 56, null);
        DrawScope.m5844drawLineNGM6Ib0$default(contentDrawScope2, m3183getSelectorColor0d7_KjU, androidx.compose.ui.geometry.SizeKt.m5114getCenteruvyYCjk(contentDrawScope.mo5858getSizeNHjbRc()), Offset.m5039minusMKHz9U(m5027constructorimpl, Offset.m5027constructorimpl((Float.floatToRawIntBits(((float) Math.sin(analogTimePickerState.getCurrentAngle())) * f3) & 4294967295L) | (Float.floatToRawIntBits(((float) Math.cos(analogTimePickerState.getCurrentAngle())) * f3) << 32))), contentDrawScope.mo429toPx0680j_4(TimePickerTokens.INSTANCE.m4344getClockDialSelectorTrackContainerWidthD9Ej5fM()), 0, null, 0.0f, null, BlendMode.Companion.m5220getSrcOver0nO6VwU(), 240, null);
        DrawScope.m5839drawCircleVaOC9Bg$default(contentDrawScope2, m3183getSelectorColor0d7_KjU, contentDrawScope.mo429toPx0680j_4(TimePickerTokens.INSTANCE.m4342getClockDialSelectorCenterContainerSizeD9Ej5fM()) / 2, androidx.compose.ui.geometry.SizeKt.m5114getCenteruvyYCjk(contentDrawScope.mo5858getSizeNHjbRc()), 0.0f, null, null, 0, 120, null);
        DrawScope.m5839drawCircleVaOC9Bg$default(contentDrawScope2, timePickerColors.m3172clockDialContentColorvNxB06k$material3(true), f3, m5027constructorimpl, 0.0f, null, null, BlendMode.Companion.m5203getDstOver0nO6VwU(), 56, null);
        return Unit.INSTANCE;
    }
    ...
    public static final void ClockText(final Modifier modifier, final AnalogTimePickerState analogTimePickerState, final int i, final boolean z, Composer composer, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute((i4 & 1171) != 1170, i4 & 1)) {
            ...
            final float mo429toPx0680j_4 = density.mo429toPx0680j_4(MaxDistance);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1151501687, "CC(remember):TimePicker.kt#9igjgp");
            Object rememberedValue = startRestartGroup.rememberedValue();
            if (rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5024boximpl(Offset.Companion.m5051getZeroF1C5BW0()), null, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            ...
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m8114boximpl(IntOffset.Companion.m8134getZeronOccac()), null, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final String m3229numberContentDescriptiondSwYdS4 = m3229numberContentDescriptiondSwYdS4(analogTimePickerState.mo1882getSelectionyecRtBI(), analogTimePickerState.is24hour(), i, startRestartGroup, i4 & 896);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier focusable$default = FocusableKt.focusable$default(SizeKt.m894size3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(OnGloballyPositionedModifierKt.onGloballyPositioned(modifier, (Function1) rememberedValue6)), MinimumInteractiveSize), false, null, 3, null);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1151458555, "CC(remember):TimePicker.kt#9igjgp");
            boolean changedInstance = startRestartGroup.changedInstance(coroutineScope) | startRestartGroup.changedInstance(analogTimePickerState) | startRestartGroup.changed(mo429toPx0680j_4) | ((i4 & 7168) == 2048) | startRestartGroup.changed(state);
            ...
            if (changedInstance || rememberedValue7 == Composer.Companion.getEmpty()) {
                Function1 function1 = new Function1() { // from class: androidx.compose.material3.TimePickerKt$$ExternalSyntheticLambda5
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        ClockText$lambda$80$lambda$79 = TimePickerKt.ClockText$lambda$80$lambda$79(CoroutineScope.this, analogTimePickerState, mo429toPx0680j_4, z, mutableState, mutableState2, state, (SemanticsPropertyReceiver) obj);
            ...
            boolean changed2 = startRestartGroup.changed(m3229numberContentDescriptiondSwYdS4);
            ...
            if (changed2 || rememberedValue8 == Composer.Companion.getEmpty()) {
                rememberedValue8 = new Function1() { // from class: androidx.compose.material3.TimePickerKt$$ExternalSyntheticLambda6
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        ClockText$lambda$83$lambda$82$lambda$81 = TimePickerKt.ClockText$lambda$83$lambda$82$lambda$81(m3229numberContentDescriptiondSwYdS4, (SemanticsPropertyReceiver) obj);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            composer2 = startRestartGroup;
            TextKt.m3168TextNvy7gAk(localString$default, SemanticsModifierKt.clearAndSetSemantics(companion, (Function1) rememberedValue8), 0L, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, value, composer2, 0, 0, 131068);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            ComposerKt.sourceInformationMarkerEnd(composer2);
            composer2.endNode();
            ComposerKt.sourceInformationMarkerEnd(composer2);
    ...
    public static final boolean ClockText$lambda$74$lambda$73(AnalogTimePickerState analogTimePickerState, Density density, MutableState mutableState) {
        ...
        float mo429toPx0680j_4 = density.mo429toPx0680j_4(DpOffset.m8056getXD9Ej5fM(selectorPos));
        float mo429toPx0680j_42 = density.mo429toPx0680j_4(DpOffset.m8058getYD9Ej5fM(selectorPos));
        return ClockText$lambda$70(mutableState).m5061containsk4lQ0M(Offset.m5027constructorimpl((Float.floatToRawIntBits(mo429toPx0680j_42) & 4294967295L) | (Float.floatToRawIntBits(mo429toPx0680j_4) << 32)));
    }
    ...
    public static final Unit ClockText$lambda$77$lambda$76(MutableState mutableState, MutableState mutableState2, MutableState mutableState3, LayoutCoordinates layoutCoordinates) {
        ...
        ClockText$lambda$68(mutableState, parentCoordinates != null ? IntSizeKt.m8172getCenterozmzZPI(parentCoordinates.mo6705getSizeYbymL2g()) : IntOffset.Companion.m8134getZeronOccac());
        mutableState2.setValue(LayoutCoordinatesKt.boundsInParent(layoutCoordinates));
        ClockText$lambda$65(mutableState3, ClockText$lambda$70(mutableState2).m5065getCenterF1C5BW0());
        return Unit.INSTANCE;
    }
    ...
    public static final void m3231timeInputOnChange_K77t0(int i, TimePickerState timePickerState, TextFieldValue textFieldValue, TextFieldValue textFieldValue2, int i2, Ref<Boolean> ref, Function1<? super TextFieldValue, Unit> function1) {
        int parseInt;
        int i3 = 0;
        ref.setValue(false);
        ...
        if (textFieldValue.getText().length() == 0) {
            if (TimePickerSelectionMode.m3251equalsimpl0(i, TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
            ...
            function1.invoke(TextFieldValue.m7704copy3r_uNRQ$default(textFieldValue, "", 0L, (TextRange) null, 6, (Object) null));
            return;
        }
        try {
            if (textFieldValue.getText().length() == 3 && TextRange.m7457getStartimpl(textFieldValue.m7708getSelectiond9O1mEE()) == 1) {
            ...
            if (parseInt <= i2) {
                ...
                function1.invoke(textFieldValue.getText().length() <= 2 ? textFieldValue : TextFieldValue.m7704copy3r_uNRQ$default(textFieldValue, String.valueOf(textFieldValue.getText().charAt(0)), 0L, (TextRange) null, 6, (Object) null));
            }
    ...
    */
        ...
        if ((i3 & 4) != 0) {
            ...
            if (i5 == 0) {
                ...
                if (!startRestartGroup.shouldExecute((4793491 & i4) != 4793490, i4 & 1)) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    final TextFieldColors m2707colors0hiis_0 = OutlinedTextFieldDefaults.INSTANCE.m2707colors0hiis_0(timePickerColors.m3191timeSelectorContentColorvNxB06k$material3(true), 0L, 0L, 0L, timePickerColors.m3190timeSelectorContainerColorvNxB06k$material3(true), timePickerColors.m3190timeSelectorContainerColorvNxB06k$material3(true), 0L, 0L, 0L, 0L, null, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, startRestartGroup, 0, 0, 0, 0, 3072, 2147483598, 4095);
                    boolean m3251equalsimpl0 = TimePickerSelectionMode.m3251equalsimpl0(i, timePickerState2.mo1882getSelectionyecRtBI());
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)87@4442L61,88@4508L133:Column.kt#2w3rfo");
                    ...
                    if (!m3251equalsimpl0) {
                        ...
                        Modifier m896sizeVpY3zN4 = SizeKt.m896sizeVpY3zN4(Modifier.Companion, TimeInputTokens.INSTANCE.m4339getTimeFieldContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m4338getTimeFieldContainerHeightD9Ej5fM());
                        if (TimePickerSelectionMode.m3251equalsimpl0(i, TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
                        ...
                        m3222TimeSelectorSAnMeKU(m896sizeVpY3zN4, i12, timePickerState2, i, timePickerColors, composer2, i10);
                        i8 = i;
                        composer2.endReplaceGroup();
                    } else {
                        i7 = i4;
                    ...
                    if (TimePickerSelectionMode.m3251equalsimpl0(i8, TimePickerSelectionMode.Companion.m3256getMinuteyecRtBI())) {
                        Strings.Companion companion = Strings.Companion;
                        m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_minute_text_field);
                    } else {
                        Strings.Companion companion2 = Strings.Companion;
                        m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_hour_text_field);
                    }
                    final String m3610getString2EP1pXo = Strings_androidKt.m3610getString2EP1pXo(m3531constructorimpl, composer2, 0);
                    Modifier visible = visible(Modifier.Companion, m3251equalsimpl0);
                    ...
                    Modifier m896sizeVpY3zN42 = SizeKt.m896sizeVpY3zN4(FocusRequesterModifierKt.focusRequester(Modifier.Companion, focusRequester), TimeInputTokens.INSTANCE.m4339getTimeFieldContainerWidthD9Ej5fM(), TimeInputTokens.INSTANCE.m4338getTimeFieldContainerHeightD9Ej5fM());
                    ComposerKt.sourceInformationMarkerStart(composer2, 1443153546, "CC(remember):TimePicker.kt#9igjgp");
                    boolean changed = composer2.changed(m3610getString2EP1pXo);
                    ...
                    if (changed || rememberedValue4 == Composer.Companion.getEmpty()) {
                        rememberedValue4 = new Function1() { // from class: androidx.compose.material3.TimePickerKt$$ExternalSyntheticLambda33
                            ...
                            public final Object invoke(Object obj3) {
                                ...
                                TimePickerTextField_1vLObsk$lambda$92$lambda$89$lambda$88$lambda$87 = TimePickerKt.TimePickerTextField_1vLObsk$lambda$92$lambda$89$lambda$88$lambda$87(m3610getString2EP1pXo, (SemanticsPropertyReceiver) obj3);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer2);
                    Modifier semantics$default = SemanticsModifierKt.semantics$default(m896sizeVpY3zN42, false, (Function1) rememberedValue4, 1, null);
                    ...
                    BasicTextFieldKt.BasicTextField(textFieldValue, function1, semantics$default, true, false, (TextStyle) consume, keyboardOptions4, keyboardActions4, true, 0, 0, (VisualTransformation) null, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource, Brush.Companion.m5236verticalGradient8A3gB4$default(Brush.Companion, new Pair[]{TuplesKt.to(Float.valueOf(0.0f), Color.m5269boximpl(Color.Companion.m5314getTransparent0d7_KjU())), TuplesKt.to(Float.valueOf(0.1f), Color.m5269boximpl(Color.Companion.m5314getTransparent0d7_KjU())), TuplesKt.to(Float.valueOf(0.1f), Color.m5269boximpl(MaterialTheme.INSTANCE.getColorScheme(composer2, 6).m2102getPrimary0d7_KjU())), TuplesKt.to(Float.valueOf(0.9f), Color.m5269boximpl(MaterialTheme.INSTANCE.getColorScheme(composer2, 6).m2102getPrimary0d7_KjU())), TuplesKt.to(Float.valueOf(0.9f), Color.m5269boximpl(Color.Companion.m5314getTransparent0d7_KjU())), TuplesKt.to(Float.valueOf(1.0f), Color.m5269boximpl(Color.Companion.m5314getTransparent0d7_KjU()))}, 0.0f, 0.0f, 0, 14, (Object) null), (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(1007938103, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$1$2
                        ...
                        public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer4, int i16) {
                            ...
                            PaddingValues m835PaddingValues0680j_4 = PaddingKt.m835PaddingValues0680j_4(Dp.m7995constructorimpl(0));
                            TextFieldColors textFieldColors = m2707colors0hiis_0;
                            final MutableInteractionSource mutableInteractionSource3 = mutableInteractionSource;
                            final TextFieldColors textFieldColors2 = m2707colors0hiis_0;
                            outlinedTextFieldDefaults.DecorationBox(text, function2, true, true, none, mutableInteractionSource, false, null, null, null, null, null, null, null, textFieldColors, m835PaddingValues0680j_4, ComposableLambdaKt.rememberComposableLambda(769667466, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TimePickerKt$TimePickerTextField$1$1$2.1
                                @Override // kotlin.jvm.functions.Function2
                                ...
                                public final void invoke(Composer composer5, int i18) {
                                    ...
                                    OutlinedTextFieldDefaults.INSTANCE.m2705Container4EFweAY(true, false, MutableInteractionSource.this, null, textFieldColors2, ShapesKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldContainerShape(), composer5, 6), 0.0f, 0.0f, composer5, 100663734, 200);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                }
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    Modifier m797offsetVpY3zN4$default = OffsetKt.m797offsetVpY3zN4$default(Modifier.Companion, 0.0f, SupportLabelTop, 1, null);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    Modifier clearAndSetSemantics = SemanticsModifierKt.clearAndSetSemantics(m797offsetVpY3zN4$default, (Function1) rememberedValue5);
                    if (TimePickerSelectionMode.m3251equalsimpl0(i, TimePickerSelectionMode.Companion.m3255getHouryecRtBI())) {
                        Strings.Companion companion3 = Strings.Companion;
                        m3531constructorimpl2 = Strings.m3531constructorimpl(R.string.m3c_time_picker_hour);
                    } else {
                        Strings.Companion companion4 = Strings.Companion;
                        m3531constructorimpl2 = Strings.m3531constructorimpl(R.string.m3c_time_picker_minute);
                    }
                    TextKt.m3168TextNvy7gAk(Strings_androidKt.m3610getString2EP1pXo(m3531constructorimpl2, composer3, 0), clearAndSetSemantics, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextColor(), composer3, 6), null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, TypographyKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextFont(), composer3, 6), composer3, 0, 0, 131064);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    TimePickerSelectionMode m3248boximpl = TimePickerSelectionMode.m3248boximpl(timePickerState.mo1882getSelectionyecRtBI());
                    ...
                    if ((i15 & 7168) != 2048) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        EffectsKt.LaunchedEffect(m3248boximpl, (Function2) rememberedValue, startRestartGroup, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
    ...
    public static final String m3229numberContentDescriptiondSwYdS4(int i, boolean z, int i2, Composer composer, int i3) {
        int m3531constructorimpl;
        ...
        if (TimePickerSelectionMode.m3251equalsimpl0(i, TimePickerSelectionMode.Companion.m3256getMinuteyecRtBI())) {
            Strings.Companion companion = Strings.Companion;
            m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_minute_suffix);
        } else if (z) {
            Strings.Companion companion2 = Strings.Companion;
            m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_hour_24h_suffix);
        } else {
            Strings.Companion companion3 = Strings.Companion;
            m3531constructorimpl = Strings.m3531constructorimpl(R.string.m3c_time_picker_hour_suffix);
        }
        String m3611getStringqBjtwXw = Strings_androidKt.m3611getStringqBjtwXw(m3531constructorimpl, new Object[]{Integer.valueOf(i2)}, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m3611getStringqBjtwXw;
    }
    ...
    static {
        float f = 24;
        ClockFaceBottomMargin = Dp.m7995constructorimpl(f);
        DisplaySeparatorWidth = Dp.m7995constructorimpl(f);
        TimeInputBottomPadding = Dp.m7995constructorimpl(f);
        ...
        PeriodToggleMargin = Dp.m7995constructorimpl(12);
        TimePickerMaxHeight = Dp.m7995constructorimpl((float) RendererCapabilities.DECODER_SUPPORT_MASK);
        TimePickerMidHeight = Dp.m7995constructorimpl(330);
        ClockDialMidContainerSize = Dp.m7995constructorimpl(238);
        ClockDialMinContainerSize = Dp.m7995constructorimpl(200);
    }
}
