...
public final class DragHandleColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5281equalsimpl0(this.color, dragHandleColors.color) && Color.m5281equalsimpl0(this.pressedColor, dragHandleColors.pressedColor) && Color.m5281equalsimpl0(this.draggedColor, dragHandleColors.draggedColor);
    }

    public int hashCode() {
        return (((Color.m5287hashCodeimpl(this.color) * 31) + Color.m5287hashCodeimpl(this.pressedColor)) * 31) + Color.m5287hashCodeimpl(this.draggedColor);
    }
}
