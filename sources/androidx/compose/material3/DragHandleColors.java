...
public final class DragHandleColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5349equalsimpl0(this.color, dragHandleColors.color) && Color.m5349equalsimpl0(this.pressedColor, dragHandleColors.pressedColor) && Color.m5349equalsimpl0(this.draggedColor, dragHandleColors.draggedColor);
    }

    public int hashCode() {
        return (((Color.m5355hashCodeimpl(this.color) * 31) + Color.m5355hashCodeimpl(this.pressedColor)) * 31) + Color.m5355hashCodeimpl(this.draggedColor);
    }
}
