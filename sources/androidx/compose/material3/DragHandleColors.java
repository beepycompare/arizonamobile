...
public final class DragHandleColors {
    ...
    public final long m2318getDraggedColor0d7_KjU() {
        return this.draggedColor;
    }

    /* renamed from: getPressedColor-0d7_KjU  reason: not valid java name */
    public final long m2319getPressedColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5280equalsimpl0(this.color, dragHandleColors.color) && Color.m5280equalsimpl0(this.pressedColor, dragHandleColors.pressedColor) && Color.m5280equalsimpl0(this.draggedColor, dragHandleColors.draggedColor);
    }

    public int hashCode() {
        return (((Color.m5286hashCodeimpl(this.color) * 31) + Color.m5286hashCodeimpl(this.pressedColor)) * 31) + Color.m5286hashCodeimpl(this.draggedColor);
    }
}
