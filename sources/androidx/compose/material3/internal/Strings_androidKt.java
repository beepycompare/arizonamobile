...
public final class Strings_androidKt {
    ...
    public static final String m3697getString2EP1pXo(int i, Composer composer, int i2) {
    ...
    public static final String m3698getStringqBjtwXw(int i, Object[] objArr, Composer composer, int i2) {
        ...
        String m3697getString2EP1pXo = m3697getString2EP1pXo(i, composer, i2 & 14);
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        ...
        String format = String.format(locale, m3697getString2EP1pXo, Arrays.copyOf(copyOf, copyOf.length));
