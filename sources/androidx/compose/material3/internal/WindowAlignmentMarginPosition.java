...
public final class WindowAlignmentMarginPosition {
    ...
    public static final class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo3012position95KtPRI(IntRect intRect, long j, int i, LayoutDirection layoutDirection) {
            if (i >= IntSize.m7435getWidthimpl(j) - (this.margin * 2)) {
                return Alignment.Companion.getCenterHorizontally().align(i, IntSize.m7435getWidthimpl(j), layoutDirection);
            }
            return RangesKt.coerceIn(this.alignment.align(i, IntSize.m7435getWidthimpl(j), layoutDirection), this.margin, (IntSize.m7435getWidthimpl(j) - this.margin) - i);
        }
    }
    ...
    public static final class Vertical implements MenuPosition.Vertical {
        ...
        public int mo3013positionJVtK1S4(IntRect intRect, long j, int i) {
            if (i >= IntSize.m7434getHeightimpl(j) - (this.margin * 2)) {
                return Alignment.Companion.getCenterVertically().align(i, IntSize.m7434getHeightimpl(j));
            }
            return RangesKt.coerceIn(this.alignment.align(i, IntSize.m7434getHeightimpl(j)), this.margin, (IntSize.m7434getHeightimpl(j) - this.margin) - i);
        }
    }
}
