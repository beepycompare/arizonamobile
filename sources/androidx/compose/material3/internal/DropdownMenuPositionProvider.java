...
public final class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m3018copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m3020copyuVxBXkw(j2, density2, i3, function22);
    }

    /* renamed from: component1-RKDOV3M  reason: not valid java name */
    public final long m3019component1RKDOV3M() {
    ...
    public final DropdownMenuPositionProvider m3020copyuVxBXkw(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DropdownMenuPositionProvider) {
            ...
            return DpOffset.m7324equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
        }
        return false;
    }

    public int hashCode() {
        return (((((DpOffset.m7329hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m7332toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int mo423roundToPx0680j_4 = density.mo423roundToPx0680j_4(DpOffset.m7325getXD9Ej5fM(j));
        this.startToAnchorStart = MenuPosition.INSTANCE.startToAnchorStart(mo423roundToPx0680j_4);
        this.endToAnchorEnd = MenuPosition.INSTANCE.endToAnchorEnd(mo423roundToPx0680j_4);
        ...
        int mo423roundToPx0680j_42 = density.mo423roundToPx0680j_4(DpOffset.m7327getYD9Ej5fM(j));
        this.topToAnchorBottom = MenuPosition.INSTANCE.topToAnchorBottom(mo423roundToPx0680j_42);
        this.bottomToAnchorTop = MenuPosition.INSTANCE.bottomToAnchorTop(mo423roundToPx0680j_42);
        this.centerToAnchorTop = MenuPosition.INSTANCE.centerToAnchorTop(mo423roundToPx0680j_42);
    ...
    public final long m3021getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, AnonymousClass2 anonymousClass2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo423roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider.2
    ...
    public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        ...
        if (IntOffset.m7392getXimpl(intRect.m7416getCenternOccac()) < IntSize.m7435getWidthimpl(j) / 2) {
        ...
        while (true) {
            ...
            i = ((MenuPosition.Horizontal) listOf.get(i3)).mo3012position95KtPRI(intRect, j, IntSize.m7435getWidthimpl(j2), layoutDirection);
            if (i3 == CollectionsKt.getLastIndex(listOf) || (i >= 0 && IntSize.m7435getWidthimpl(j2) + i <= IntSize.m7435getWidthimpl(j))) {
                break;
            }
            i3++;
        }
        ...
        if (IntOffset.m7393getYimpl(intRect.m7416getCenternOccac()) < IntSize.m7434getHeightimpl(j) / 2) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            int mo3013positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i4)).mo3013positionJVtK1S4(intRect, j, IntSize.m7434getHeightimpl(j2));
            if (i4 == CollectionsKt.getLastIndex(listOf2) || (mo3013positionJVtK1S4 >= this.verticalMargin && IntSize.m7434getHeightimpl(j2) + mo3013positionJVtK1S4 <= IntSize.m7434getHeightimpl(j) - this.verticalMargin)) {
