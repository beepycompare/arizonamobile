...
public final class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public static /* synthetic */ DropdownMenuPositionProvider m3521copyuVxBXkw$default(DropdownMenuPositionProvider dropdownMenuPositionProvider, long j, Density density, int i, Function2 function2, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return dropdownMenuPositionProvider.m3523copyuVxBXkw(j2, density2, i3, function22);
    }

    /* renamed from: component1-RKDOV3M  reason: not valid java name */
    public final long m3522component1RKDOV3M() {
    ...
    public final DropdownMenuPositionProvider m3523copyuVxBXkw(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DropdownMenuPositionProvider) {
            ...
            return DpOffset.m8055equalsimpl0(this.contentOffset, dropdownMenuPositionProvider.contentOffset) && Intrinsics.areEqual(this.density, dropdownMenuPositionProvider.density) && this.verticalMargin == dropdownMenuPositionProvider.verticalMargin && Intrinsics.areEqual(this.onPositionCalculated, dropdownMenuPositionProvider.onPositionCalculated);
        }
        return false;
    }

    public int hashCode() {
        return (((((DpOffset.m8060hashCodeimpl(this.contentOffset) * 31) + this.density.hashCode()) * 31) + Integer.hashCode(this.verticalMargin)) * 31) + this.onPositionCalculated.hashCode();
    }

    public String toString() {
        return "DropdownMenuPositionProvider(contentOffset=" + ((Object) DpOffset.m8063toStringimpl(this.contentOffset)) + ", density=" + this.density + ", verticalMargin=" + this.verticalMargin + ", onPositionCalculated=" + this.onPositionCalculated + ')';
    }
    ...
    private DropdownMenuPositionProvider(long j, Density density, int i, Function2<? super IntRect, ? super IntRect, Unit> function2) {
        ...
        int mo423roundToPx0680j_4 = density.mo423roundToPx0680j_4(DpOffset.m8056getXD9Ej5fM(j));
        ...
        int mo423roundToPx0680j_42 = density.mo423roundToPx0680j_4(DpOffset.m8058getYD9Ej5fM(j));
    ...
    public final long m3524getContentOffsetRKDOV3M() {
        return this.contentOffset;
    }
    ...
    public /* synthetic */ DropdownMenuPositionProvider(long j, Density density, int i, Function2 function2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, density, (i2 & 4) != 0 ? density.mo423roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i, (i2 & 8) != 0 ? new Function2() { // from class: androidx.compose.material3.internal.DropdownMenuPositionProvider$$ExternalSyntheticLambda0
    ...
    public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        ...
        int i4 = (int) (j >> 32);
        if (IntOffset.m8123getXimpl(intRect.m8147getCenternOccac()) < i4 / 2) {
        ...
        while (true) {
            ...
            int i8 = i5;
            intRect2 = intRect;
            i = horizontal2.mo3490position95KtPRI(intRect2, j3, i6, layoutDirection);
        ...
        if (IntOffset.m8124getYimpl(intRect2.m8147getCenternOccac()) < i9 / 2) {
        ...
        while (true) {
            ...
            i2 = ((MenuPosition.Vertical) listOf2.get(i10)).mo3491positionJVtK1S4(intRect2, j3, i12);
