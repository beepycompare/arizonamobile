...
public final class DragGestureDetectorCopyKt {
    ...
    */
    public static final Object m3440awaitHorizontalPointerSlopOrCancellationgDDlDlE(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Continuation<? super PointerInputChange> continuation) {
        ...
        if (continuation instanceof DragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1) {
            ...
            if ((dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i2 != 0) {
                    ...
                    if (m3442isPointerUpDmW0f2w(awaitPointerEventScope.getCurrentEvent(), j)) {
                        return null;
                    }
                    float m3443pointerSlopE8SPZFQ = m3443pointerSlopE8SPZFQ(awaitPointerEventScope.getViewConfiguration(), i);
                    ...
                    if (i2 == 2) {
                        ...
                        if (awaitPointerEvent$default != coroutine_suspended) {
                            ...
                            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
                                ...
                                longRef2.element = pointerInputChange3.m6682getIdJ3iCeTQ();
                                f2 = f4;
                                f = f3;
                            } else {
                                f2 = f4 + (Float.intBitsToFloat((int) (pointerInputChange.m6685getPositionF1C5BW0() >> 32)) - Float.intBitsToFloat((int) (pointerInputChange.m6686getPreviousPositionF1C5BW0() >> 32)));
                                if (Math.abs(f2) < f3) {
    ...
    private static final Object m3441awaitPointerSlopOrCancellationpn7EDYM(AwaitPointerEventScope awaitPointerEventScope, long j, int i, Function2<? super PointerInputChange, ? super Float, Unit> function2, Function1<? super Offset, Float> function1, Continuation<? super PointerInputChange> continuation) {
        float f;
        PointerInputChange pointerInputChange;
        float f2;
        ...
        while (true) {
            ...
            if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
                ...
                float floatValue = f + (function1.invoke(Offset.m5092boximpl(pointerInputChange3.m6685getPositionF1C5BW0())).floatValue() - function1.invoke(Offset.m5092boximpl(pointerInputChange3.m6686getPreviousPositionF1C5BW0())).floatValue());
                if (Math.abs(floatValue) < m3443pointerSlopE8SPZFQ) {
                    ...
                    function2.invoke(pointerInputChange3, Float.valueOf(floatValue - (Math.signum(floatValue) * m3443pointerSlopE8SPZFQ)));
                    if (pointerInputChange3.isConsumed()) {
    ...
    private static final boolean m3442isPointerUpDmW0f2w(PointerEvent pointerEvent, long j) {
        PointerInputChange pointerInputChange;
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        boolean z = false;
    ...
    public static final float m3443pointerSlopE8SPZFQ(ViewConfiguration viewConfiguration, int i) {
