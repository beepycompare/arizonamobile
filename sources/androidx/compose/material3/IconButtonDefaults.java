...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors iconButtonColors(Composer composer, int i) {
        ...
        long m5358unboximpl = ((Color) consume).m5358unboximpl();
        IconButtonColors m2576defaultIconButtonColors4WTKRHQ$material3 = m2576defaultIconButtonColors4WTKRHQ$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m5358unboximpl);
        if (!Color.m5349equalsimpl0(m2576defaultIconButtonColors4WTKRHQ$material3.m2572getContentColor0d7_KjU(), m5358unboximpl)) {
            m2576defaultIconButtonColors4WTKRHQ$material3 = IconButtonColors.m2567copyjRlVdoo$default(m2576defaultIconButtonColors4WTKRHQ$material3, 0L, m5358unboximpl, 0L, Color.m5347copywmQWz5c$default(m5358unboximpl, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2576defaultIconButtonColors4WTKRHQ$material3;
    }

    /* renamed from: iconButtonColors-ro_MJ88  reason: not valid java name */
    public final IconButtonColors m2584iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        long j7;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(ContentColorKt.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd(composer);
            j5 = ((Color) consume).m5358unboximpl();
        } else {
            j5 = j2;
        }
        ...
        if ((i2 & 8) != 0) {
            long j8 = j5;
            j7 = Color.m5347copywmQWz5c$default(j8, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j6 = j8;
        } else {
            j6 = j5;
            j7 = j4;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m2570copyjRlVdoo = m2576defaultIconButtonColors4WTKRHQ$material3(colorScheme, ((Color) consume2).m5358unboximpl()).m2570copyjRlVdoo(m5384getUnspecified0d7_KjU, j6, m5384getUnspecified0d7_KjU2, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m2576defaultIconButtonColors4WTKRHQ$material3(ColorScheme colorScheme, long j) {
        ...
        if (defaultIconButtonColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), j, Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(j, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconButtonColors m2585iconButtonVibrantColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        ...
        if ((i2 & 8) != 0) {
            long j7 = m5384getUnspecified0d7_KjU2;
            j6 = Color.m5347copywmQWz5c$default(j7, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j5 = j7;
        } else {
            j5 = m5384getUnspecified0d7_KjU2;
            j6 = j4;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors m2570copyjRlVdoo = defaultIconButtonVibrantColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2570copyjRlVdoo(m5384getUnspecified0d7_KjU, j5, m5384getUnspecified0d7_KjU3, j6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors defaultIconButtonVibrantColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultIconButtonVibrantColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getColor()), Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getDisabledColor()), StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors iconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m5358unboximpl = ((Color) consume).m5358unboximpl();
        IconToggleButtonColors m2577defaultIconToggleButtonColors4WTKRHQ$material3 = m2577defaultIconToggleButtonColors4WTKRHQ$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m5358unboximpl);
        if (Color.m5349equalsimpl0(m2577defaultIconToggleButtonColors4WTKRHQ$material3.m2612getContentColor0d7_KjU(), m5358unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2577defaultIconToggleButtonColors4WTKRHQ$material3;
        }
        IconToggleButtonColors m2607copytNS2XkQ$default = IconToggleButtonColors.m2607copytNS2XkQ$default(m2577defaultIconToggleButtonColors4WTKRHQ$material3, 0L, m5358unboximpl, 0L, Color.m5347copywmQWz5c$default(m5358unboximpl, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m2607copytNS2XkQ$default;
    }

    /* renamed from: iconToggleButtonColors-5tl4gsc  reason: not valid java name */
    public final IconToggleButtonColors m2586iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        long j10;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(ContentColorKt.getLocalContentColor());
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m5358unboximpl();
        } else {
            j7 = j2;
        }
        long m5384getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j11 = j7;
            j9 = Color.m5347copywmQWz5c$default(j11, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j8 = j11;
        } else {
            j8 = j7;
            j9 = j4;
        }
        long m5384getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j5;
        long m5384getUnspecified0d7_KjU4 = (i2 & 32) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long j12 = j10;
        IconToggleButtonColors m2608copytNS2XkQ = m2577defaultIconToggleButtonColors4WTKRHQ$material3(colorScheme, ((Color) consume2).m5358unboximpl()).m2608copytNS2XkQ(j12, j8, m5384getUnspecified0d7_KjU2, j9, m5384getUnspecified0d7_KjU3, m5384getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2608copytNS2XkQ;
    }

    /* renamed from: defaultIconToggleButtonColors-4WTKRHQ$material3  reason: not valid java name */
    public final IconToggleButtonColors m2577defaultIconToggleButtonColors4WTKRHQ$material3(ColorScheme colorScheme, long j) {
        ...
        if (defaultIconToggleButtonColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), j, Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(j, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getSelectedColor()), null);
    ...
    public final IconToggleButtonColors m2587iconToggleButtonVibrantColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        ...
        long m5384getUnspecified0d7_KjU3 = (i2 & 4) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j10 = m5384getUnspecified0d7_KjU2;
            j8 = Color.m5347copywmQWz5c$default(j10, StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j7 = j10;
        } else {
            j7 = m5384getUnspecified0d7_KjU2;
            j8 = j4;
        }
        long m5384getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j5;
        long m5384getUnspecified0d7_KjU5 = (i2 & 32) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
            j9 = m5384getUnspecified0d7_KjU;
        ...
        IconToggleButtonColors m2608copytNS2XkQ = defaultIconToggleButtonVibrantColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2608copytNS2XkQ(j9, j7, m5384getUnspecified0d7_KjU3, j8, m5384getUnspecified0d7_KjU4, m5384getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors defaultIconToggleButtonVibrantColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultIconToggleButtonVibrantColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getUnselectedColor()), Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getDisabledColor()), StandardIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, StandardIconButtonTokens.INSTANCE.getSelectedColor()), null);
    ...
    public final IconButtonColors m2580filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long j5 = j;
        long m2347contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(j5, composer, i & 14) : j2;
        long m5384getUnspecified0d7_KjU = (i2 & 4) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j3;
        long m5384getUnspecified0d7_KjU2 = (i2 & 8) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors m2570copyjRlVdoo = getDefaultFilledIconButtonColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2570copyjRlVdoo(j5, m2347contentColorForek8zF_U, m5384getUnspecified0d7_KjU, m5384getUnspecified0d7_KjU2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledIconButtonColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultFilledIconButtonColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getColor()), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2581filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m2347contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m5384getUnspecified0d7_KjU5, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors m2608copytNS2XkQ = getDefaultFilledIconToggleButtonColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2608copytNS2XkQ(j7, m5384getUnspecified0d7_KjU2, m5384getUnspecified0d7_KjU3, m5384getUnspecified0d7_KjU4, m5384getUnspecified0d7_KjU5, m2347contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledIconToggleButtonColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultFilledIconToggleButtonColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getUnselectedColor()), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedColor()), null);
    ...
    public final IconButtonColors m2582filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        IconButtonColors m2570copyjRlVdoo = getDefaultFilledTonalIconButtonColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2570copyjRlVdoo(j5, m2347contentColorForek8zF_U, m5384getUnspecified0d7_KjU, m5384getUnspecified0d7_KjU2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledTonalIconButtonColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultFilledTonalIconButtonColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getColor()), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2583filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m5384getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j;
        long m2347contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m5384getUnspecified0d7_KjU, composer, i & 14) : j2;
        long m5384getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j3;
        long m5384getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j4;
        long m5384getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j5;
        long m2347contentColorForek8zF_U2 = (i2 & 32) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m5384getUnspecified0d7_KjU4, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
            j7 = m5384getUnspecified0d7_KjU;
        ...
        IconToggleButtonColors m2608copytNS2XkQ = getDefaultFilledTonalIconToggleButtonColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2608copytNS2XkQ(j7, m2347contentColorForek8zF_U, m5384getUnspecified0d7_KjU2, m5384getUnspecified0d7_KjU3, m5384getUnspecified0d7_KjU4, m2347contentColorForek8zF_U2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledTonalIconToggleButtonColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultFilledTonalIconToggleButtonColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedColor()), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getSelectedColor()), null);
    ...
    public final IconButtonColors outlinedIconButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m5358unboximpl = ((Color) consume).m5358unboximpl();
        IconButtonColors m2578defaultOutlinedIconButtonColors4WTKRHQ$material3 = m2578defaultOutlinedIconButtonColors4WTKRHQ$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m5358unboximpl);
        if (Color.m5349equalsimpl0(m2578defaultOutlinedIconButtonColors4WTKRHQ$material3.m2572getContentColor0d7_KjU(), m5358unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2578defaultOutlinedIconButtonColors4WTKRHQ$material3;
        }
        IconButtonColors m2567copyjRlVdoo$default = IconButtonColors.m2567copyjRlVdoo$default(m2578defaultOutlinedIconButtonColors4WTKRHQ$material3, 0L, m5358unboximpl, 0L, Color.m5347copywmQWz5c$default(m5358unboximpl, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m2567copyjRlVdoo$default;
    }

    /* renamed from: outlinedIconButtonColors-ro_MJ88  reason: not valid java name */
    public final IconButtonColors m2588outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        long j7;
        ...
        if ((i2 & 8) != 0) {
            long j8 = j5;
            j7 = Color.m5347copywmQWz5c$default(j8, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j6 = j8;
        } else {
            j6 = j5;
            j7 = j4;
        ...
        Object consume2 = composer.consume(ContentColorKt.getLocalContentColor());
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m2570copyjRlVdoo = m2578defaultOutlinedIconButtonColors4WTKRHQ$material3(colorScheme, ((Color) consume2).m5358unboximpl()).m2570copyjRlVdoo(m5384getUnspecified0d7_KjU, j6, m5384getUnspecified0d7_KjU2, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m2578defaultOutlinedIconButtonColors4WTKRHQ$material3(ColorScheme colorScheme, long j) {
        ...
        if (defaultOutlinedIconButtonColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), j, Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(j, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconButtonColors m2589outlinedIconButtonVibrantColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        ...
        if ((i2 & 8) != 0) {
            long j7 = m5384getUnspecified0d7_KjU2;
            j6 = Color.m5347copywmQWz5c$default(j7, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j5 = j7;
        } else {
            j5 = m5384getUnspecified0d7_KjU2;
            j6 = j4;
        ...
        IconButtonColors m2570copyjRlVdoo = defaultOutlinedIconButtonVibrantColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2570copyjRlVdoo(m5384getUnspecified0d7_KjU, j5, m5384getUnspecified0d7_KjU3, j6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors defaultOutlinedIconButtonVibrantColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultOutlinedIconButtonVibrantColorsCached$material3 == null) {
            IconButtonColors iconButtonColors = new IconButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getColor()), Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getDisabledColor()), OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors outlinedIconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m5358unboximpl = ((Color) consume).m5358unboximpl();
        IconToggleButtonColors m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3 = m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m5358unboximpl);
        if (Color.m5349equalsimpl0(m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3.m2612getContentColor0d7_KjU(), m5358unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3;
        }
        IconToggleButtonColors m2607copytNS2XkQ$default = IconToggleButtonColors.m2607copytNS2XkQ$default(m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3, 0L, m5358unboximpl, 0L, Color.m5347copywmQWz5c$default(m5358unboximpl, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconToggleButtonColors m2590outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        ...
        if ((i2 & 8) != 0) {
            long j10 = j7;
            j9 = Color.m5347copywmQWz5c$default(j10, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j8 = j10;
        } else {
            j8 = j7;
            j9 = j4;
        ...
        long m5384getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j5;
        long m2347contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m5384getUnspecified0d7_KjU3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object consume2 = composer.consume(ContentColorKt.getLocalContentColor());
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors m2608copytNS2XkQ = m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3(colorScheme, ((Color) consume2).m5358unboximpl()).m2608copytNS2XkQ(m5384getUnspecified0d7_KjU, j8, m5384getUnspecified0d7_KjU2, j9, m5384getUnspecified0d7_KjU3, m2347contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors m2579defaultOutlinedIconToggleButtonColors4WTKRHQ$material3(ColorScheme colorScheme, long j) {
        IconToggleButtonColors defaultIconToggleButtonColorsCached$material3 = colorScheme.getDefaultIconToggleButtonColorsCached$material3();
        if (defaultIconToggleButtonColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), j, Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(j, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m2346contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final IconToggleButtonColors m2591outlinedIconToggleButtonVibrantColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        ...
        if ((i2 & 8) != 0) {
            long j10 = m5384getUnspecified0d7_KjU2;
            j8 = Color.m5347copywmQWz5c$default(j10, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
            j7 = j10;
        } else {
            j7 = m5384getUnspecified0d7_KjU2;
            j8 = j4;
        ...
        long m5384getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.Companion.m5384getUnspecified0d7_KjU() : j5;
        long m2347contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m5384getUnspecified0d7_KjU4, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
            j9 = m5384getUnspecified0d7_KjU;
        ...
        IconToggleButtonColors m2608copytNS2XkQ = defaultOutlinedIconToggleButtonVibrantColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2608copytNS2XkQ(j9, j7, m5384getUnspecified0d7_KjU3, j8, m5384getUnspecified0d7_KjU4, m2347contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors defaultOutlinedIconToggleButtonVibrantColors$material3(ColorScheme colorScheme) {
        ...
        if (defaultOutlinedIconToggleButtonVibrantColorsCached$material3 == null) {
            IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.Companion.m5383getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getUnselectedColor()), Color.Companion.m5383getTransparent0d7_KjU(), Color.m5347copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getDisabledColor()), OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedColor()), null);
            colorScheme.setDefaultOutlinedIconToggleButtonColorsCached$material3(iconToggleButtonColors);
            return iconToggleButtonColors;
        }
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        long m5358unboximpl = ((Color) consume).m5358unboximpl();
        if (!z) {
            m5358unboximpl = Color.m5347copywmQWz5c$default(m5358unboximpl, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
        }
        ComposerKt.sourceInformationMarkerStart(composer, -1314785653, "CC(remember):IconButtonDefaults.kt#9igjgp");
        boolean changed = composer.changed(m5358unboximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BorderStrokeKt.m314BorderStrokecXLIe8U(SmallIconButtonTokens.INSTANCE.m4184getOutlinedOutlineWidthD9Ej5fM(), m5358unboximpl);
    ...
    public final BorderStroke outlinedIconButtonVibrantBorder(boolean z, Composer composer, int i) {
        ...
        if (!z) {
            value = Color.m5347copywmQWz5c$default(value, OutlinedIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null);
        }
        ...
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BorderStrokeKt.m314BorderStrokecXLIe8U(SmallIconButtonTokens.INSTANCE.m4184getOutlinedOutlineWidthD9Ej5fM(), value);
            composer.updateRememberedValue(rememberedValue);
        }
        BorderStroke borderStroke = (BorderStroke) rememberedValue;
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static /* synthetic */ long m2575smallContainerSizeNwlBFI$material3$default(IconButtonDefaults iconButtonDefaults, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = IconButtonWidthOption.Companion.m2601getUniformrc6NtMs();
        }
    ...
    public final long m2592smallContainerSizeNwlBFI$material3(int i) {
        float m8160constructorimpl;
        if (!IconButtonWidthOption.m2596equalsimpl0(i, IconButtonWidthOption.Companion.m2600getNarrowrc6NtMs())) {
            if (!IconButtonWidthOption.m2596equalsimpl0(i, IconButtonWidthOption.Companion.m2601getUniformrc6NtMs())) {
                if (IconButtonWidthOption.m2596equalsimpl0(i, IconButtonWidthOption.Companion.m2602getWiderc6NtMs())) {
                    m8160constructorimpl = Dp.m8160constructorimpl(SmallIconButtonTokens.INSTANCE.m4185getWideLeadingSpaceD9Ej5fM() + SmallIconButtonTokens.INSTANCE.m4186getWideTrailingSpaceD9Ej5fM());
                } else {
                    m8160constructorimpl = Dp.m8160constructorimpl(0.0f);
                }
            } else {
                m8160constructorimpl = Dp.m8160constructorimpl(SmallIconButtonTokens.INSTANCE.m4179getDefaultLeadingSpaceD9Ej5fM() + SmallIconButtonTokens.INSTANCE.m4179getDefaultLeadingSpaceD9Ej5fM());
            }
        } else {
            m8160constructorimpl = Dp.m8160constructorimpl(SmallIconButtonTokens.INSTANCE.m4182getNarrowLeadingSpaceD9Ej5fM() + SmallIconButtonTokens.INSTANCE.m4183getNarrowTrailingSpaceD9Ej5fM());
        }
        return DpKt.m8182DpSizeYgX7TsA(Dp.m8160constructorimpl(SmallIconButtonTokens.INSTANCE.m4181getIconSizeD9Ej5fM() + m8160constructorimpl), SmallIconButtonTokens.INSTANCE.m4178getContainerHeightD9Ej5fM());
    }
    ...
    public static final class IconButtonWidthOption {
        ...
        public static boolean m2595equalsimpl(int i, Object obj) {
            return (obj instanceof IconButtonWidthOption) && i == ((IconButtonWidthOption) obj).m2599unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m2595equalsimpl(this.value, obj);
        }
        ...
        public static String m2598toStringimpl(int i) {
            return m2596equalsimpl0(i, Narrow) ? "Narrow" : m2596equalsimpl0(i, Uniform) ? "Uniform" : m2596equalsimpl0(i, Wide) ? "Wide" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
        }
    }
}
