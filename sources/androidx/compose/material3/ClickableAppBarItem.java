        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            TooltipKt.TooltipBox(TooltipDefaults.INSTANCE.m3366rememberTooltipPositionProviderHu5FAss(TooltipAnchorPosition.Companion.m3353getAbovelOKsHw4(), 0.0f, startRestartGroup, 390, 2), ComposableLambdaKt.rememberComposableLambda(-816691117, true, new Function3<TooltipScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ClickableAppBarItem$AppbarContent$1
                ...
                public final void invoke(TooltipScope tooltipScope, Composer composer2, int i3) {
                    ...
                    TooltipKt.m3374PlainTooltipgv3ox5I(tooltipScope, null, null, 0.0f, null, 0L, 0L, 0.0f, 0.0f, ComposableLambdaKt.rememberComposableLambda(837175745, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ClickableAppBarItem$AppbarContent$1.1
