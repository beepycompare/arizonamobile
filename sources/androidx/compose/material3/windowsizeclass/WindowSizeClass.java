...
public final class WindowSizeClass {
    ...
    public final int m4570getWidthSizeClassY0FxcvE() {
        return this.widthSizeClass;
    }

    /* renamed from: getHeightSizeClass-Pt018CI  reason: not valid java name */
    public final int m4569getHeightSizeClassPt018CI() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ WindowSizeClass m4571calculateFromSizeqzXmJYc$default(Companion companion, long j, Set set, Set set2, int i, Object obj) {
            ...
            return companion.m4572calculateFromSizeqzXmJYc(j, set3, set4);
        }

        /* renamed from: calculateFromSize-qzXmJYc  reason: not valid java name */
        public final WindowSizeClass m4572calculateFromSizeqzXmJYc(long j, Set<WindowWidthSizeClass> set, Set<WindowHeightSizeClass> set2) {
            return new WindowSizeClass(WindowWidthSizeClass.Companion.m4584fromWidthLJjiCC4$material3_window_size_class(DpSize.m8356getWidthD9Ej5fM(j), set), WindowHeightSizeClass.Companion.m4565fromHeightBkRwncw$material3_window_size_class(DpSize.m8354getHeightD9Ej5fM(j), set2), null);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return WindowWidthSizeClass.m4577equalsimpl0(this.widthSizeClass, windowSizeClass.widthSizeClass) && WindowHeightSizeClass.m4558equalsimpl0(this.heightSizeClass, windowSizeClass.heightSizeClass);
    }

    public int hashCode() {
        return (WindowWidthSizeClass.m4578hashCodeimpl(this.widthSizeClass) * 31) + WindowHeightSizeClass.m4559hashCodeimpl(this.heightSizeClass);
    }

    public String toString() {
        return "WindowSizeClass(" + ((Object) WindowWidthSizeClass.m4579toStringimpl(this.widthSizeClass)) + ", " + ((Object) WindowHeightSizeClass.m4560toStringimpl(this.heightSizeClass)) + ')';
    }
}
