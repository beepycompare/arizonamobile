...
final class CenteredContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        int size = list.size();
        if (size < 1) {
            return MeasureScope.layout$default(measureScope, m8113getMaxWidthimpl, m8114getMinHeightimpl, null, new Function1() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$$ExternalSyntheticLambda0
        ...
        if (Constraints.m8109getHasBoundedWidthimpl(j)) {
            int i3 = m8113getMaxWidthimpl / size;
            calculateCenteredContentHorizontalPadding = ShortNavigationBarKt.calculateCenteredContentHorizontalPadding(size, m8113getMaxWidthimpl);
            intRef.element = calculateCenteredContentHorizontalPadding;
            int i4 = (m8113getMaxWidthimpl - (intRef.element * 2)) / size;
            List<? extends Measurable> list2 = list;
            int size2 = list2.size();
            for (int i5 = 0; i5 < size2; i5++) {
                int maxIntrinsicHeight = list.get(i5).maxIntrinsicHeight(i4);
                if (m8114getMinHeightimpl < maxIntrinsicHeight) {
                    m8114getMinHeightimpl = RangesKt.coerceAtMost(maxIntrinsicHeight, Constraints.m8112getMaxHeightimpl(j));
                }
            }
            ...
            while (i2 < size3) {
                ...
                int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m8114getMinHeightimpl(j));
                ...
                arrayList3.add(measurable.mo6818measureBRTryo0(ConstraintsKt.m8128constrainN9IONVI(j, Constraints.Companion.m8123fixedJhjzzOo(i, m8114getMinHeightimpl))));
                i2++;
            }
            ...
            int size4 = list.size();
            while (i2 < size4) {
                arrayList4.add(list.get(i2).mo6818measureBRTryo0(ConstraintsKt.m8128constrainN9IONVI(j, Constraints.Companion.m8124fixedHeightOenEA2s(m8114getMinHeightimpl))));
                i2++;
            }
            arrayList = arrayList4;
        }
        return MeasureScope.layout$default(measureScope, m8113getMaxWidthimpl, m8114getMinHeightimpl, null, new Function1() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
