...
public final class CenteredContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        int size = list.size();
        if (size < 1) {
            return MeasureScope.layout$default(measureScope, m7217getMaxWidthimpl, m7218getMinHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$measure$1
        ...
        if (Constraints.m7213getHasBoundedWidthimpl(j)) {
            int i3 = m7217getMaxWidthimpl / size;
            calculateCenteredContentHorizontalPadding = ExpressiveNavigationBarKt.calculateCenteredContentHorizontalPadding(size, m7217getMaxWidthimpl);
            intRef.element = calculateCenteredContentHorizontalPadding;
            int i4 = (m7217getMaxWidthimpl - (intRef.element * 2)) / size;
            int size2 = list.size();
            ...
            while (i2 < size3) {
                ...
                int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m7218getMinHeightimpl(j));
                ...
                arrayList3.add(measurable.mo5967measureBRTryo0(ConstraintsKt.m7232constrainN9IONVI(j, Constraints.Companion.m7227fixedJhjzzOo(i, m7218getMinHeightimpl))));
                i2++;
            }
            ...
            int size4 = list.size();
            while (i2 < size4) {
                arrayList4.add(list.get(i2).mo5967measureBRTryo0(ConstraintsKt.m7232constrainN9IONVI(j, Constraints.Companion.m7228fixedHeightOenEA2s(m7218getMinHeightimpl))));
                i2++;
            }
            arrayList = arrayList4;
        }
        return MeasureScope.layout$default(measureScope, m7217getMaxWidthimpl, m7218getMinHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.CenteredContentMeasurePolicy$measure$5
            /* JADX INFO: Access modifiers changed from: package-private */
