...
public final class NavigationItemIconPosition {
    ...
    private static final int Top = m2650constructorimpl(0);
    private static final int Start = m2650constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ NavigationItemIconPosition m2649boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2650constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2651equalsimpl(int i, Object obj) {
        return (obj instanceof NavigationItemIconPosition) && i == ((NavigationItemIconPosition) obj).m2655unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2652equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2653hashCodeimpl(int i) {
    ...
    public static String m2654toStringimpl(int i) {
        return m2652equalsimpl0(i, Top) ? "Top" : m2652equalsimpl0(i, Start) ? "Start" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
