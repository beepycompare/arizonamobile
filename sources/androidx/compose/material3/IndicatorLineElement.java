...
public final class IndicatorLineElement extends ModifierNodeElement<IndicatorLineNode> {
    ...
    public final float m2616component6D9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* renamed from: component7-D9Ej5fM  reason: not valid java name */
    public final float m2617component7D9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }

    /* renamed from: copy-gv0btCI  reason: not valid java name */
    public final IndicatorLineElement m2618copygv0btCI(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f, float f2) {
    ...
    public int hashCode() {
        ...
        return ((((hashCode2 + (shape != null ? shape.hashCode() : 0)) * 31) + Dp.m8166hashCodeimpl(this.focusedIndicatorLineThickness)) * 31) + Dp.m8166hashCodeimpl(this.unfocusedIndicatorLineThickness);
    }

    public String toString() {
        return "IndicatorLineElement(enabled=" + this.enabled + ", isError=" + this.isError + ", interactionSource=" + this.interactionSource + ", colors=" + this.colors + ", textFieldShape=" + this.textFieldShape + ", focusedIndicatorLineThickness=" + ((Object) Dp.m8171toStringimpl(this.focusedIndicatorLineThickness)) + ", unfocusedIndicatorLineThickness=" + ((Object) Dp.m8171toStringimpl(this.unfocusedIndicatorLineThickness)) + ')';
    }
    ...
    public void update(IndicatorLineNode indicatorLineNode) {
        indicatorLineNode.m2621updategv0btCI(this.enabled, this.isError, this.interactionSource, this.colors, this.textFieldShape, this.focusedIndicatorLineThickness, this.unfocusedIndicatorLineThickness);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", Dp.m8158boximpl(this.focusedIndicatorLineThickness));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", Dp.m8158boximpl(this.unfocusedIndicatorLineThickness));
    }
}
