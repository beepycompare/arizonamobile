...
public final class IndicatorLineElement extends ModifierNodeElement<IndicatorLineNode> {
    ...
    public static /* synthetic */ IndicatorLineElement m2559copygv0btCI$default(IndicatorLineElement indicatorLineElement, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return indicatorLineElement.m2562copygv0btCI(z, z2, interactionSource2, textFieldColors, shape2, f3, f4);
    }
    ...
    public final float m2560component6D9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* renamed from: component7-D9Ej5fM  reason: not valid java name */
    public final float m2561component7D9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }

    /* renamed from: copy-gv0btCI  reason: not valid java name */
    public final IndicatorLineElement m2562copygv0btCI(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f, float f2) {
    ...
    public int hashCode() {
        ...
        return ((((hashCode2 + (shape != null ? shape.hashCode() : 0)) * 31) + Dp.m8264hashCodeimpl(this.focusedIndicatorLineThickness)) * 31) + Dp.m8264hashCodeimpl(this.unfocusedIndicatorLineThickness);
    }

    public String toString() {
        return "IndicatorLineElement(enabled=" + this.enabled + ", isError=" + this.isError + ", interactionSource=" + this.interactionSource + ", colors=" + this.colors + ", textFieldShape=" + this.textFieldShape + ", focusedIndicatorLineThickness=" + ((Object) Dp.m8269toStringimpl(this.focusedIndicatorLineThickness)) + ", unfocusedIndicatorLineThickness=" + ((Object) Dp.m8269toStringimpl(this.unfocusedIndicatorLineThickness)) + ')';
    }
    ...
    public final float m2563getFocusedIndicatorLineThicknessD9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* renamed from: getUnfocusedIndicatorLineThickness-D9Ej5fM  reason: not valid java name */
    public final float m2564getUnfocusedIndicatorLineThicknessD9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }
    ...
    public void update(IndicatorLineNode indicatorLineNode) {
        indicatorLineNode.m2566updategv0btCI(this.enabled, this.isError, this.interactionSource, this.colors, this.textFieldShape, this.focusedIndicatorLineThickness, this.unfocusedIndicatorLineThickness);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", Dp.m8256boximpl(this.focusedIndicatorLineThickness));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", Dp.m8256boximpl(this.unfocusedIndicatorLineThickness));
    }
}
