...
public final class ExposedDropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public /* synthetic */ ExposedDropdownMenuPositionProvider(Density density, int i, State state, int i2, Function2 function2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(density, i, (i3 & 4) != 0 ? null : state, (i3 & 8) != 0 ? density.mo458roundToPx0680j_4(MenuKt.getMenuVerticalMargin()) : i2, (i3 & 16) != 0 ? new Function2() { // from class: androidx.compose.material3.ExposedDropdownMenuPositionProvider$$ExternalSyntheticLambda0
    ...
    public long mo428calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        ...
        char c2 = ' ';
        long j4 = 4294967295L;
        long m8424constructorimpl = IntSize.m8424constructorimpl(((((int) (j & 4294967295L)) + this.topWindowInsets) & 4294967295L) | (((int) (j >> 32)) << 32));
        MenuPosition.Horizontal[] horizontalArr = new MenuPosition.Horizontal[3];
        int i2 = 0;
        horizontalArr[0] = this.startToAnchorStart;
        horizontalArr[1] = this.endToAnchorEnd;
        int i3 = (int) (m8424constructorimpl >> 32);
        if (IntOffset.m8386getXimpl(intRect.m8410getCenternOccac()) < i3 / 2) {
        ...
        while (true) {
            ...
            intRect2 = intRect;
            List list = listOf;
            i = ((MenuPosition.Horizontal) listOf.get(i4)).mo3577position95KtPRI(intRect2, m8424constructorimpl, i5, layoutDirection);
        ...
        int i8 = (int) (m8424constructorimpl & j3);
        if (IntOffset.m8387getYimpl(intRect2.m8410getCenternOccac()) < i8 / 2) {
        ...
        for (int i9 = 0; i9 < size2; i9++) {
            int i10 = (int) (j2 & j3);
            int mo3578positionJVtK1S4 = ((MenuPosition.Vertical) listOf2.get(i9)).mo3578positionJVtK1S4(intRect2, m8424constructorimpl, i10);
            if (i9 == CollectionsKt.getLastIndex(listOf2) || (mo3578positionJVtK1S4 >= 0 && i10 + mo3578positionJVtK1S4 <= i8)) {
                i2 = mo3578positionJVtK1S4;
                break;
            }
        }
        long m8380constructorimpl = IntOffset.m8380constructorimpl((i << c) | (i2 & j3));
