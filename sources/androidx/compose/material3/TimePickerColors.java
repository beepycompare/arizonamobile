...
public final class TimePickerColors {
    ...
    public final long m3165getClockDialUnselectedContentColor0d7_KjU() {
    ...
    public final long m3168getPeriodSelectorSelectedContainerColor0d7_KjU() {
    ...
    public final long m3170getPeriodSelectorUnselectedContainerColor0d7_KjU() {
    ...
    public final long m3169getPeriodSelectorSelectedContentColor0d7_KjU() {
    ...
    public final long m3171getPeriodSelectorUnselectedContentColor0d7_KjU() {
    ...
    public final long m3173getTimeSelectorSelectedContainerColor0d7_KjU() {
    ...
    public final long m3175getTimeSelectorUnselectedContainerColor0d7_KjU() {
    ...
    public final long m3174getTimeSelectorSelectedContentColor0d7_KjU() {
    ...
    public final long m3176getTimeSelectorUnselectedContentColor0d7_KjU() {
    ...
    public static /* synthetic */ TimePickerColors m3160copydVHXu7A$default(TimePickerColors timePickerColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, int i, Object obj) {
        ...
        return timePickerColors.m3162copydVHXu7A(j24, j18, j19, j20, j21, j22, j23, j25, j26, j27, j28, j29, j16, j15);
    }

    /* renamed from: copy-dVHXu7A  reason: not valid java name */
    public final TimePickerColors m3162copydVHXu7A(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14) {
    ...
    public final long m3177periodSelectorContainerColorvNxB06k$material3(boolean z) {
        if (z) {
            return this.periodSelectorSelectedContainerColor;
        }
        return this.periodSelectorUnselectedContainerColor;
    ...
    public final long m3178periodSelectorContentColorvNxB06k$material3(boolean z) {
        if (z) {
            return this.periodSelectorSelectedContentColor;
        }
        return this.periodSelectorUnselectedContentColor;
    ...
    public final long m3179timeSelectorContainerColorvNxB06k$material3(boolean z) {
        if (z) {
            return this.timeSelectorSelectedContainerColor;
        }
        return this.timeSelectorUnselectedContainerColor;
    ...
    public final long m3180timeSelectorContentColorvNxB06k$material3(boolean z) {
        if (z) {
            return this.timeSelectorSelectedContentColor;
        }
        return this.timeSelectorUnselectedContentColor;
    ...
    public final long m3161clockDialContentColorvNxB06k$material3(boolean z) {
        if (z) {
            return this.clockDialSelectedContentColor;
        }
        return this.clockDialUnselectedContentColor;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return Color.m5349equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m5349equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m5349equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m5349equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m5349equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m5349equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m5349equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m5349equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m5349equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m5349equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m5349equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m5349equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m5355hashCodeimpl(this.clockDialColor) * 31) + Color.m5355hashCodeimpl(this.selectorColor)) * 31) + Color.m5355hashCodeimpl(this.containerColor)) * 31) + Color.m5355hashCodeimpl(this.periodSelectorBorderColor)) * 31) + Color.m5355hashCodeimpl(this.periodSelectorSelectedContainerColor)) * 31) + Color.m5355hashCodeimpl(this.periodSelectorUnselectedContainerColor)) * 31) + Color.m5355hashCodeimpl(this.periodSelectorSelectedContentColor)) * 31) + Color.m5355hashCodeimpl(this.periodSelectorUnselectedContentColor)) * 31) + Color.m5355hashCodeimpl(this.timeSelectorSelectedContainerColor)) * 31) + Color.m5355hashCodeimpl(this.timeSelectorUnselectedContainerColor)) * 31) + Color.m5355hashCodeimpl(this.timeSelectorSelectedContentColor)) * 31) + Color.m5355hashCodeimpl(this.timeSelectorUnselectedContentColor);
    }
}
