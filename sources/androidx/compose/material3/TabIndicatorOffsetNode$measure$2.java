...
final class TabIndicatorOffsetNode$measure$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Animatable.animateTo$default(this.$widthAnim, Dp.m6682boximpl(this.$currentTabWidth), TabRowKt.access$getTabRowIndicatorSpec$p(), null, null, this, 12, null) == coroutine_suspended) {
