...
public final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window) {
        ...
        this.window = window;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2168getLambda$91331245$material3(), null, 2, null);
