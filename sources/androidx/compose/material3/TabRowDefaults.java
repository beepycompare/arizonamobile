...
public final class TabRowDefaults {
    ...
    private static final float ScrollableTabRowEdgeStartPadding = Dp.m7264constructorimpl(52);
    ...
    public final float m2710getScrollableTabRowEdgeStartPaddingD9Ej5fM() {
    ...
    */
    public final void m2707Indicator9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        long j2;
        long fromToken;
        final long j3;
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if (i5 != 0) {
                    f = PrimaryNavigationTabTokens.INSTANCE.m3579getActiveIndicatorHeightD9Ej5fM();
                }
                if ((i2 & 4) != 0) {
                    i3 &= -897;
                    ...
                    BoxKt.Box(BackgroundKt.m267backgroundbw27NRU$default(SizeKt.m880height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f), fromToken, null, 2, null), startRestartGroup, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    j3 = fromToken;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$Indicator$1
                ...
                public final void invoke(Composer composer2, int i6) {
                    TabRowDefaults.this.m2707Indicator9IZ8Weo(modifier2, f2, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m2708PrimaryIndicator10LGxhE(Modifier modifier, float f, float f2, long j, Shape shape, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        float f3;
        int i4;
                ...
                if (i5 != 0) {
                    ...
                    if ((i3 & 9363) == 9362 || !startRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i8 != 0) {
                                f3 = Dp.m7264constructorimpl(24);
                            }
                            if (i4 != 0) {
                                f4 = PrimaryNavigationTabTokens.INSTANCE.m3579getActiveIndicatorHeightD9Ej5fM();
                            }
                            if ((i2 & 8) != 0) {
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$PrimaryIndicator$1
                            ...
                            public final void invoke(Composer composer2, int i9) {
                                TabRowDefaults.this.m2708PrimaryIndicator10LGxhE(companion, f5, f6, j3, shape2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                            }
                        });
                        return;
                    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m2709SecondaryIndicator9IZ8Weo(Modifier modifier, float f, long j, Composer composer, final int i, final int i2) {
        int i3;
        long j2;
        long value;
        final long j3;
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((i2 & 4) != 0) {
                    ...
                    BoxKt.Box(BackgroundKt.m267backgroundbw27NRU$default(SizeKt.m880height3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), f), value, null, 2, null), startRestartGroup, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    j3 = value;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabRowDefaults$SecondaryIndicator$1
                ...
                public final void invoke(Composer composer2, int i6) {
                    TabRowDefaults.this.m2709SecondaryIndicator9IZ8Weo(modifier2, f2, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }
