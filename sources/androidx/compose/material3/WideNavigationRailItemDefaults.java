...
public final class WideNavigationRailItemDefaults {
    ...
    public final int m3433iconPositionFors8pcRp0(boolean z) {
        return z ? NavigationItemIconPosition.Companion.m2656getStartxw1Ddg() : NavigationItemIconPosition.Companion.m2657getTopxw1Ddg();
    }
    ...
    public final NavigationItemColors m3432colors69fazGs(long j, long j2, long j3, long j4, long j5, long j6, long j7, Composer composer, int i, int i2) {
        ...
        NavigationItemColors m2639copy4JmcsL4 = getDefaultWideNavigationRailItemColors(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2639copy4JmcsL4(value, value2, value3, value4, value5, m5278copywmQWz5c$default, m5278copywmQWz5c$default2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2639copy4JmcsL4;
    }
