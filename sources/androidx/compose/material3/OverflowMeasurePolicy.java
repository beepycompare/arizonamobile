...
public final class OverflowMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo924measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        Integer valueOf6;
        Integer valueOf7;
        long m8103copyZbe2FdA$default;
        Integer valueOf8;
        int i2 = 0;
        long m8103copyZbe2FdA$default2 = Constraints.m8103copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
        ...
        if (this.isVertical) {
            if (list3.isEmpty()) {
                ...
                valueOf8 = Integer.valueOf(list3.get(0).maxIntrinsicHeight(Constraints.m8113getMaxWidthimpl(j)));
                int lastIndex = CollectionsKt.getLastIndex(list3);
                if (1 <= lastIndex) {
                    int i4 = 1;
                    while (true) {
                        Integer valueOf9 = Integer.valueOf(list3.get(i4).maxIntrinsicHeight(Constraints.m8113getMaxWidthimpl(j)));
            ...
            if (list3.isEmpty()) {
                ...
                valueOf = Integer.valueOf(list3.get(0).maxIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j)));
                int lastIndex2 = CollectionsKt.getLastIndex(list3);
                if (1 <= lastIndex2) {
                    int i5 = 1;
                    while (true) {
                        Integer valueOf10 = Integer.valueOf(list3.get(i5).maxIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j)));
        ...
        int subtractConstraintSafely = LayoutUtilKt.subtractConstraintSafely(this.isVertical ? Constraints.m8112getMaxHeightimpl(j) : Constraints.m8113getMaxWidthimpl(j), intValue);
        ...
        while (true) {
            ...
            Placeable mo6818measureBRTryo0 = list2.get(i6).mo6818measureBRTryo0(m8103copyZbe2FdA$default2);
            int i8 = i6 == CollectionsKt.getLastIndex(list2) ? i3 : 0;
            i = i3;
            if (i8 == 0 && i6 == this.maxItemCount - 1) {
                break;
            }
            int height = this.isVertical ? mo6818measureBRTryo0.getHeight() : mo6818measureBRTryo0.getWidth();
            if (height > subtractConstraintSafely && (i8 == 0 || height > subtractConstraintSafely + intValue)) {
                break;
            }
            arrayList3.add(mo6818measureBRTryo0);
            i7 += height;
        ...
        if (arrayList3.size() != list2.size()) {
            if (this.isVertical) {
                ...
                m8103copyZbe2FdA$default = Constraints.m8103copyZbe2FdA$default(m8103copyZbe2FdA$default2, 0, 0, 0, subtractConstraintSafely + intValue, 7, null);
            } else {
                arrayList = arrayList3;
                m8103copyZbe2FdA$default = Constraints.m8103copyZbe2FdA$default(m8103copyZbe2FdA$default2, 0, subtractConstraintSafely + intValue, 0, 0, 13, null);
            }
            ArrayList arrayList4 = new ArrayList(list3.size());
            int size2 = list3.size();
            for (int i9 = 0; i9 < size2; i9++) {
                arrayList4.add(list3.get(i9).mo6818measureBRTryo0(m8103copyZbe2FdA$default));
            }
        ...
        if (this.isVertical) {
            return MeasureScope.layout$default(measureScope, ConstraintsKt.m8130constrainWidthK40F9xA(j, max), ConstraintsKt.m8129constrainHeightK40F9xA(j, i12), null, new Function1() { // from class: androidx.compose.material3.OverflowMeasurePolicy$$ExternalSyntheticLambda0
        ...
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m8130constrainWidthK40F9xA(j, i12), ConstraintsKt.m8129constrainHeightK40F9xA(j, max), null, new Function1() { // from class: androidx.compose.material3.OverflowMeasurePolicy$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
