...
final class EqualWeightContentMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        int size = list.size();
        if (size < 1) {
            return MeasureScope.layout$default(measureScope, m8211getMaxWidthimpl, m8212getMinHeightimpl, null, new Function1() { // from class: androidx.compose.material3.EqualWeightContentMeasurePolicy$$ExternalSyntheticLambda0
        ...
        if (Constraints.m8207getHasBoundedWidthimpl(j)) {
            int i2 = m8211getMaxWidthimpl / size;
            ...
            while (i < size3) {
                arrayList2.add(list.get(i).mo6875measureBRTryo0(ConstraintsKt.m8226constrainN9IONVI(j, Constraints.Companion.m8221fixedJhjzzOo(i2, m8212getMinHeightimpl))));
                i++;
            }
            ...
            int size4 = list.size();
            while (i < size4) {
                arrayList3.add(list.get(i).mo6875measureBRTryo0(ConstraintsKt.m8226constrainN9IONVI(j, Constraints.Companion.m8222fixedHeightOenEA2s(m8212getMinHeightimpl))));
                i++;
            }
            arrayList = arrayList3;
        }
        return MeasureScope.layout$default(measureScope, m8211getMaxWidthimpl, m8212getMinHeightimpl, null, new Function1() { // from class: androidx.compose.material3.EqualWeightContentMeasurePolicy$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
