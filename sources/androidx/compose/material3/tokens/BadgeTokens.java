...
public final class BadgeTokens {
    ...
    private static final float LargeSize = Dp.m7264constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = Dp.m7264constructorimpl((float) 6.0d);
    ...
    public final float m3135getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3136getSizeD9Ej5fM() {
        return Size;
    }
}
