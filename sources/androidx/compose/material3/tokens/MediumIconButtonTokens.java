...
public final class MediumIconButtonTokens {
    ...
    public final float m4053getContainerHeightD9Ej5fM() {
    ...
    public final float m4060getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* renamed from: getWideTrailingSpace-D9Ej5fM  reason: not valid java name */
    public final float m4061getWideTrailingSpaceD9Ej5fM() {
    ...
    static {
        ...
        IconSize = Dp.m7996constructorimpl(f2);
        float f3 = (float) 12.0d;
        NarrowLeadingSpace = Dp.m7996constructorimpl(f3);
        NarrowTrailingSpace = Dp.m7996constructorimpl(f3);
        WideLeadingSpace = Dp.m7996constructorimpl(f2);
        WideTrailingSpace = Dp.m7996constructorimpl(f2);
    }
}
