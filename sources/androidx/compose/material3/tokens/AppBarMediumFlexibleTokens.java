...
public final class AppBarMediumFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m7995constructorimpl((float) 112.0d);
    ...
    private static final float LargeContainerHeight = Dp.m7995constructorimpl((float) 136.0d);

    private AppBarMediumFlexibleTokens() {
    }

    /* renamed from: getContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m3644getContainerHeightD9Ej5fM() {
    ...
    public final float m3645getLargeContainerHeightD9Ej5fM() {
