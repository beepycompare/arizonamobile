...
public final class AppBarMediumFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m7996constructorimpl((float) 112.0d);
    ...
    private static final float LargeContainerHeight = Dp.m7996constructorimpl((float) 136.0d);
