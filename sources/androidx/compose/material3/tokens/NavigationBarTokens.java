...
public final class NavigationBarTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3977getLevel2D9Ej5fM();
    ...
    private static final float ItemActiveIndicatorIconLabelSpace = Dp.m8258constructorimpl((float) 4.0d);
    ...
    private static final float ItemBetweenSpace = Dp.m8258constructorimpl((float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
    ...
    private static final float TallContainerHeight = Dp.m8258constructorimpl((float) 80.0d);
    ...
    public final float m4153getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m4154getContainerHeightD9Ej5fM() {
    ...
    public final float m4155getItemActiveIndicatorIconLabelSpaceD9Ej5fM() {
    ...
    public final float m4156getItemBetweenSpaceD9Ej5fM() {
    ...
    public final float m4157getTallContainerHeightD9Ej5fM() {
