...
public final class NavigationRailHorizontalItemTokens {
    ...
    public final float m4102getLeadingSpaceD9Ej5fM() {
        return LeadingSpace;
    }
    ...
    static {
        float f = (float) 16.0d;
        FullWidthLeadingSpace = Dp.m7995constructorimpl(f);
        FullWidthTrailingSpace = Dp.m7995constructorimpl(f);
