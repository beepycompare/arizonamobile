...
public final class SplitButtonXLargeTokens {
    ...
    private static final float BetweenSpace = Dp.m7995constructorimpl((float) 2.0d);
    private static final float ContainerHeight = Dp.m7995constructorimpl((float) 136.0d);
    ...
    private static final float TrailingIconSize = Dp.m7995constructorimpl((float) 50.0d);
    ...
    public final float m4296getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* renamed from: getContainerHeight-D9Ej5fM  reason: not valid java name */
    public final float m4297getContainerHeightD9Ej5fM() {
    ...
    public final float m4298getLeadingButtonLeadingSpaceD9Ej5fM() {
        return LeadingButtonLeadingSpace;
    }

    /* renamed from: getLeadingButtonTrailingSpace-D9Ej5fM  reason: not valid java name */
    public final float m4299getLeadingButtonTrailingSpaceD9Ej5fM() {
        return LeadingButtonTrailingSpace;
    }

    /* renamed from: getTrailingIconSize-D9Ej5fM  reason: not valid java name */
    public final float m4302getTrailingIconSizeD9Ej5fM() {
    ...
    public final float m4300getTrailingButtonLeadingSpaceD9Ej5fM() {
        return TrailingButtonLeadingSpace;
    }

    /* renamed from: getTrailingButtonTrailingSpace-D9Ej5fM  reason: not valid java name */
    public final float m4301getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    static {
        float f = (float) 64.0d;
        LeadingButtonLeadingSpace = Dp.m7995constructorimpl(f);
        LeadingButtonTrailingSpace = Dp.m7995constructorimpl(f);
        float f2 = (float) 43.0d;
        TrailingButtonLeadingSpace = Dp.m7995constructorimpl(f2);
        TrailingButtonTrailingSpace = Dp.m7995constructorimpl(f2);
    }
}
