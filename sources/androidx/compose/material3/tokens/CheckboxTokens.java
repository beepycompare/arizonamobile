...
public final class CheckboxTokens {
    ...
    static {
        ...
        float f2 = (float) 2.0d;
        ContainerShape = RoundedCornerShapeKt.m1126RoundedCornerShape0680j_4(Dp.m7555constructorimpl(f2));
        ...
        SelectedDisabledContainerOutlineWidth = Dp.m7555constructorimpl(f3);
