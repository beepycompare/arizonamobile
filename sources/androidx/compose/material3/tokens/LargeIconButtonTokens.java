...
public final class LargeIconButtonTokens {
    ...
    private static final float OutlinedOutlineWidth = Dp.m7995constructorimpl((float) 2.0d);
    ...
    static {
        ...
        UniformLeadingSpace = Dp.m7995constructorimpl(f);
        UniformTrailingSpace = Dp.m7995constructorimpl(f);
