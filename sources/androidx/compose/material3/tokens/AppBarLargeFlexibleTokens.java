...
public final class AppBarLargeFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m7995constructorimpl((float) 120.0d);
    ...
    private static final float LargeContainerHeight = Dp.m7995constructorimpl((float) 152.0d);
    ...
    public final float m3642getLargeContainerHeightD9Ej5fM() {
