...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m7555constructorimpl((float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
    ...
    private static final float UnselectedOutlineWidth = Dp.m7555constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m7555constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m7555constructorimpl(f);
        TrailingIconSize = Dp.m7555constructorimpl(f);
    }
