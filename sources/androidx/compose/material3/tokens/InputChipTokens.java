...
public final class InputChipTokens {
    ...
    private static final float SelectedOutlineWidth = Dp.m8258constructorimpl((float) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
    ...
    private static final float UnselectedOutlineWidth = Dp.m8258constructorimpl((float) 1.0d);
    ...
    private static final float AvatarSize = Dp.m8258constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m8258constructorimpl(f);
        TrailingIconSize = Dp.m8258constructorimpl(f);
    }
    ...
    public final float m4095getDraggedContainerElevationD9Ej5fM() {
    ...
    public final float m4097getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m4099getUnselectedOutlineWidthD9Ej5fM() {
    ...
    public final float m4092getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m4096getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m4098getTrailingIconSizeD9Ej5fM() {
