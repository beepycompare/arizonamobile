...
public interface AppBarScope {
    void clickableItem(Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, String str, boolean z);

    void customItem(Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super AppBarMenuState, ? super Composer, ? super Integer, Unit> function3);

    void toggleableItem(boolean z, Function1<? super Boolean, Unit> function1, Function2<? super Composer, ? super Integer, Unit> function2, String str, boolean z2);
