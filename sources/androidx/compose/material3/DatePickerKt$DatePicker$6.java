...
public final class DatePickerKt$DatePicker$6 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int mo2441getDisplayModejFl4v0 = this.$state.mo2441getDisplayModejFl4v0();
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        DatePickerKt.m2437SwitchableDateEntryContentKaiTk9E(selectedDateMillis, displayedMonthMillis, mo2441getDisplayModejFl4v0, function1, (Function1) rememberedValue2, this.$calendarModel, this.$state.getYearRange(), this.$dateFormatter, this.$state.getSelectableDates(), this.$colors, this.$focusRequester, composer, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
