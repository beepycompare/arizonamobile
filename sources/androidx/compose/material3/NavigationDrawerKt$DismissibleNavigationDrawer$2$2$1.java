...
public final class NavigationDrawerKt$DismissibleNavigationDrawer$2$2$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final Placeable mo6697measureBRTryo02 = list.get(1).mo6697measureBRTryo0(j);
        int width = mo6697measureBRTryo02.getWidth();
        int height = mo6697measureBRTryo02.getHeight();
        ...
        return MeasureScope.layout$default(measureScope, width, height, null, new Function1() { // from class: androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$2$1$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                ...
                measure_3p2s80s$lambda$1 = NavigationDrawerKt$DismissibleNavigationDrawer$2$2$1.measure_3p2s80s$lambda$1(DrawerState.this, mo6697measureBRTryo0, mo6697measureBRTryo02, mutableState, (Placeable.PlacementScope) obj);
