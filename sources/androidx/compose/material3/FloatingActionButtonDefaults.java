...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = Dp.m8258constructorimpl(36);

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: getLargeIconSize-D9Ej5fM  reason: not valid java name */
    public final float m2481getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m2480elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FabPrimaryContainerTokens.INSTANCE.m4027getContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = FabPrimaryContainerTokens.INSTANCE.m4030getPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = FabPrimaryContainerTokens.INSTANCE.m4028getFocusedContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = FabPrimaryContainerTokens.INSTANCE.m4029getHoveredContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m2482loweredElevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = ElevationTokens.INSTANCE.m3976getLevel1D9Ej5fM();
        }
        float f5 = f;
        if ((i2 & 2) != 0) {
            f2 = ElevationTokens.INSTANCE.m3976getLevel1D9Ej5fM();
        }
        float f6 = f2;
        if ((i2 & 4) != 0) {
            f3 = ElevationTokens.INSTANCE.m3976getLevel1D9Ej5fM();
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = ElevationTokens.INSTANCE.m3977getLevel2D9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final FloatingActionButtonElevation m2479bottomAppBarFabElevationa9UjIt4(float f, float f2, float f3, float f4) {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m2478bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m2479bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }
}
