...
public final class ModalWideNavigationRailDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public static final class Api34Impl {
        ...
        @JvmStatic
        public static final OnBackAnimationCallback createBackCallback(final Function0<Unit> function0, final Function1<? super Float, Unit> function1, final Function0<Unit> function02, final RailPredictiveBackState railPredictiveBackState, final LayoutDirection layoutDirection) {
            return new OnBackAnimationCallback() { // from class: androidx.compose.material3.ModalWideNavigationRailDialogLayout$Api34Impl$createBackCallback$1
                public void onBackStarted(BackEvent backEvent) {
                    ...
                    function1.invoke(Float.valueOf(PredictiveBack.INSTANCE.transform$material3(backEvent.getProgress())));
                }
