    ...
    */
    public static final void m1884DropdownMenuIlH_yew(final boolean z, final Function0<Unit> function0, Modifier modifier, long j, ScrollState scrollState, PopupProperties popupProperties, Shape shape, long j2, float f, float f2, BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2, final int i3) {
                ...
                if (i9 != 0) {
                    ...
                    if ((i4 & 306783379) == 306783378 || (i15 & 19) != 18 || !startRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i6 != 0) {
                                float f7 = 0;
                                j3 = DpKt.m7285DpOffsetYgX7TsA(Dp.m7264constructorimpl(f7), Dp.m7264constructorimpl(f7));
                            }
                            if ((i3 & 16) == 0) {
                            ...
                            float m2349getTonalElevationD9Ej5fM = i8 == 0 ? MenuDefaults.INSTANCE.m2349getTonalElevationD9Ej5fM() : f;
                            float m2348getShadowElevationD9Ej5fM = i10 == 0 ? MenuDefaults.INSTANCE.m2348getShadowElevationD9Ej5fM() : f2;
                            if (i12 == 0) {
                                modifier2 = companion;
                        ...
                        if (!((Boolean) mutableTransitionState.getCurrentState()).booleanValue() || ((Boolean) mutableTransitionState.getTargetState()).booleanValue()) {
                            ...
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                rememberedValue2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TransformOrigin.m4944boximpl(TransformOrigin.Companion.m4957getCenterSzJe1aQ()), null, 2, null);
                            ...
                            if (!changed || rememberedValue3 == Composer.Companion.getEmpty()) {
                                rememberedValue3 = new DropdownMenuPositionProvider(j3, density, 0, new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$popupPositionProvider$1$1
                                    ...
                                    public final void invoke2(IntRect intRect, IntRect intRect2) {
                                        mutableState.setValue(TransformOrigin.m4944boximpl(MenuKt.calculateTransformOrigin(intRect, intRect2)));
                                    }
                                }, 4, null);
                            ...
                            AndroidPopup_androidKt.Popup((DropdownMenuPositionProvider) rememberedValue3, obj, obj3, ComposableLambdaKt.rememberComposableLambda(2126968933, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$1
                                ...
                                public final void invoke(Composer composer3, int i16) {
                                    ...
                                    if ((i16 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        MenuKt.m2362DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState, scrollState3, shape4, j5, f3, f4, borderStroke2, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                                        if (ComposerKt.isTraceInProgress()) {
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$2
                            ...
                            public final void invoke(Composer composer3, int i16) {
                                AndroidMenu_androidKt.m1884DropdownMenuIlH_yew(z, function0, modifier3, j6, scrollState4, popupProperties2, shape5, j7, f5, f6, borderStroke3, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
                            }
                        });
                        return;
                    }
                ...
                AndroidPopup_androidKt.Popup((DropdownMenuPositionProvider) rememberedValue3, obj, obj3, ComposableLambdaKt.rememberComposableLambda(2126968933, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$1
                    ...
                    public final void invoke(Composer composer3, int i16) {
                        ...
                        if ((i16 & 3) != 2 || !composer3.getSkipping()) {
                            ...
                            MenuKt.m2362DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState2, scrollState3, shape4, j5, f3, f4, borderStroke2, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            AndroidPopup_androidKt.Popup((DropdownMenuPositionProvider) rememberedValue3, obj, obj3, ComposableLambdaKt.rememberComposableLambda(2126968933, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$1
                ...
                public final void invoke(Composer composer3, int i16) {
                    ...
                    if ((i16 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        MenuKt.m2362DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState22, scrollState3, shape4, j5, f3, f4, borderStroke2, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        rememberedValue3 = new DropdownMenuPositionProvider(j3, density222, 0, new Function2<IntRect, IntRect, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$popupPositionProvider$1$1
            ...
            /* renamed from: invoke  reason: avoid collision after fix types in other method */
            public final void invoke2(IntRect intRect, IntRect intRect2) {
                mutableState222.setValue(TransformOrigin.m4944boximpl(MenuKt.calculateTransformOrigin(intRect, intRect2)));
            }
        }, 4, null);
        startRestartGroup.updateRememberedValue(rememberedValue3);
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        AndroidPopup_androidKt.Popup((DropdownMenuPositionProvider) rememberedValue3, obj, obj3, ComposableLambdaKt.rememberComposableLambda(2126968933, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$1
            ...
            public final void invoke(Composer composer3, int i16) {
                ...
                if ((i16 & 3) != 2 || !composer3.getSkipping()) {
                    ...
                    MenuKt.m2362DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState222, scrollState3, shape4, j5, f3, f4, borderStroke2, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        return;
                    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final /* synthetic */ void m1882DropdownMenu4kj_NE(final boolean z, final Function0 function0, Modifier modifier, long j, ScrollState scrollState, PopupProperties popupProperties, final Function3 function3, Composer composer, final int i, final int i2) {
        boolean z2;
        int i3;
                    ...
                    if ((i2 & 64) == 0) {
                        ...
                        if ((599187 & i3) == 599186 || !startRestartGroup.getSkipping()) {
                            ...
                            if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                                ...
                                if (i4 != 0) {
                                    float f = 0;
                                    j2 = DpKt.m7285DpOffsetYgX7TsA(Dp.m7264constructorimpl(f), Dp.m7264constructorimpl(f));
                                }
                                if ((i2 & 16) != 0) {
                                    i3 &= -57345;
                                ...
                                if (i5 != 0) {
                                    ...
                                    composer2 = startRestartGroup;
                                    m1884DropdownMenuIlH_yew(z2, function02, obj4, j3, scrollState2, popupProperties2, MenuDefaults.INSTANCE.getShape(startRestartGroup, 6), MenuDefaults.INSTANCE.getContainerColor(startRestartGroup, 6), MenuDefaults.INSTANCE.m2349getTonalElevationD9Ej5fM(), MenuDefaults.INSTANCE.m2348getShadowElevationD9Ej5fM(), null, function3, composer2, (i3 & 14) | 905969664 | (i3 & 112) | (i3 & 896) | (i3 & 7168) | (57344 & i3) | (458752 & i3), ((i3 >> 15) & 112) | 6, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                    }
                                    modifier2 = obj4;
                        ...
                        if (endRestartGroup != null) {
                            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$3
                                ...
                                public final void invoke(Composer composer3, int i9) {
                                    AndroidMenu_androidKt.m1882DropdownMenu4kj_NE(z, function0, modifier2, j4, scrollState3, popupProperties3, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                }
                            });
                            return;
                        }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final /* synthetic */ void m1883DropdownMenuILWXrKs(final boolean z, final Function0 function0, Modifier modifier, long j, PopupProperties popupProperties, final Function3 function3, Composer composer, final int i, final int i2) {
        boolean z2;
        int i3;
        Function0 function02;
        Object obj;
        ...
        if (i6 != 0) {
            ...
            if (i4 == 0) {
                ...
                if (i5 != 0) {
                    ...
                    if ((i2 & 32) == 0) {
                        ...
                        if ((74899 & i3) == 74898 || !startRestartGroup.getSkipping()) {
                            ...
                            long j4 = j2;
                            m1884DropdownMenuIlH_yew(z2, function02, modifier3, j4, ScrollKt.rememberScrollState(0, startRestartGroup, 0, 1), popupProperties3, null, 0L, 0.0f, 0.0f, null, obj3, composer2, (i3 & 8190) | ((i3 << 3) & 458752), (i3 >> 12) & 112, 1984);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier2 = modifier3;
                        ...
                        if (endRestartGroup != null) {
                            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AndroidMenu_androidKt$DropdownMenu$4
                                ...
                                public final void invoke(Composer composer3, int i7) {
                                    AndroidMenu_androidKt.m1883DropdownMenuILWXrKs(z, function0, modifier2, j3, popupProperties2, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                                }
                            });
                            return;
                        }
                    ...
                    long j42 = j2;
                    m1884DropdownMenuIlH_yew(z2, function02, modifier32, j42, ScrollKt.rememberScrollState(0, startRestartGroup, 0, 1), popupProperties3, null, 0L, 0.0f, 0.0f, null, obj3, composer2, (i3 & 8190) | ((i3 << 3) & 458752), (i3 >> 12) & 112, 1984);
                    if (ComposerKt.isTraceInProgress()) {
                    }
                ...
                long j422 = j2;
                m1884DropdownMenuIlH_yew(z2, function02, modifier322, j422, ScrollKt.rememberScrollState(0, startRestartGroup, 0, 1), popupProperties3, null, 0L, 0.0f, 0.0f, null, obj3, composer2, (i3 & 8190) | ((i3 << 3) & 458752), (i3 >> 12) & 112, 1984);
                if (ComposerKt.isTraceInProgress()) {
                }
            ...
            long j4222 = j2;
            m1884DropdownMenuIlH_yew(z2, function02, modifier3222, j4222, ScrollKt.rememberScrollState(0, startRestartGroup, 0, 1), popupProperties3, null, 0L, 0.0f, 0.0f, null, obj3, composer2, (i3 & 8190) | ((i3 << 3) & 458752), (i3 >> 12) & 112, 1984);
            if (ComposerKt.isTraceInProgress()) {
            }
        ...
        long j42222 = j2;
        m1884DropdownMenuIlH_yew(z2, function02, modifier32222, j42222, ScrollKt.rememberScrollState(0, startRestartGroup, 0, 1), popupProperties3, null, 0L, 0.0f, 0.0f, null, obj3, composer2, (i3 & 8190) | ((i3 << 3) & 458752), (i3 >> 12) & 112, 1984);
        if (ComposerKt.isTraceInProgress()) {
        }
