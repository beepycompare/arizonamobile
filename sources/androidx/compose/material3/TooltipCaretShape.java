...
final class TooltipCaretShape implements Shape {
    ...
    public Outline mo331createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Outline mo331createOutlinePq9zytI = this.tooltipShape.mo331createOutlinePq9zytI(j, layoutDirection, density);
        Outline mo331createOutlinePq9zytI2 = this.caretShape.mo331createOutlinePq9zytI(j, layoutDirection, density);
        if (mo331createOutlinePq9zytI instanceof Outline.Generic) {
            Path.m5561addPathUv8p0NA$default(this.tooltipPath, ((Outline.Generic) mo331createOutlinePq9zytI).getPath(), 0L, 2, null);
        } else if (mo331createOutlinePq9zytI instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.tooltipPath, ((Outline.Rounded) mo331createOutlinePq9zytI).getRoundRect(), null, 2, null);
        } else if (!(mo331createOutlinePq9zytI instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.tooltipPath, ((Outline.Rectangle) mo331createOutlinePq9zytI).getRect(), null, 2, null);
        }
        if (mo331createOutlinePq9zytI2 instanceof Outline.Generic) {
            Path.m5561addPathUv8p0NA$default(this.caretPath, ((Outline.Generic) mo331createOutlinePq9zytI2).getPath(), 0L, 2, null);
        } else if (mo331createOutlinePq9zytI2 instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.caretPath, ((Outline.Rounded) mo331createOutlinePq9zytI2).getRoundRect(), null, 2, null);
        } else if (!(mo331createOutlinePq9zytI2 instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.caretPath, ((Outline.Rectangle) mo331createOutlinePq9zytI2).getRect(), null, 2, null);
        }
        this.caretPath.mo5171transform58bKbWc(this.transformationMatrix.getValue().m5544unboximpl());
        this.combinedPath.mo5169opN5in7k0(this.tooltipPath, this.caretPath, PathOperation.Companion.m5586getUnionb3I0S0c());
