...
final class TooltipCaretShape implements Shape {
    ...
    public Outline mo344createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Outline mo344createOutlinePq9zytI = this.tooltipShape.mo344createOutlinePq9zytI(j, layoutDirection, density);
        Outline mo344createOutlinePq9zytI2 = this.caretShape.mo344createOutlinePq9zytI(j, layoutDirection, density);
        if (mo344createOutlinePq9zytI instanceof Outline.Generic) {
            Path.m5632addPathUv8p0NA$default(this.tooltipPath, ((Outline.Generic) mo344createOutlinePq9zytI).getPath(), 0L, 2, null);
        } else if (mo344createOutlinePq9zytI instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.tooltipPath, ((Outline.Rounded) mo344createOutlinePq9zytI).getRoundRect(), null, 2, null);
        } else if (!(mo344createOutlinePq9zytI instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.tooltipPath, ((Outline.Rectangle) mo344createOutlinePq9zytI).getRect(), null, 2, null);
        }
        if (mo344createOutlinePq9zytI2 instanceof Outline.Generic) {
            Path.m5632addPathUv8p0NA$default(this.caretPath, ((Outline.Generic) mo344createOutlinePq9zytI2).getPath(), 0L, 2, null);
        } else if (mo344createOutlinePq9zytI2 instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.caretPath, ((Outline.Rounded) mo344createOutlinePq9zytI2).getRoundRect(), null, 2, null);
        } else if (!(mo344createOutlinePq9zytI2 instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.caretPath, ((Outline.Rectangle) mo344createOutlinePq9zytI2).getRect(), null, 2, null);
        }
        this.caretPath.mo5239transform58bKbWc(this.transformationMatrix.getValue().m5615unboximpl());
        this.combinedPath.mo5237opN5in7k0(this.tooltipPath, this.caretPath, PathOperation.Companion.m5657getUnionb3I0S0c());
