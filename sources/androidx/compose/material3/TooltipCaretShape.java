...
final class TooltipCaretShape implements Shape {
    ...
    public Outline mo332createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        Outline mo332createOutlinePq9zytI = this.tooltipShape.mo332createOutlinePq9zytI(j, layoutDirection, density);
        Outline mo332createOutlinePq9zytI2 = this.caretShape.mo332createOutlinePq9zytI(j, layoutDirection, density);
        if (mo332createOutlinePq9zytI instanceof Outline.Generic) {
            Path.m5562addPathUv8p0NA$default(this.tooltipPath, ((Outline.Generic) mo332createOutlinePq9zytI).getPath(), 0L, 2, null);
        } else if (mo332createOutlinePq9zytI instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.tooltipPath, ((Outline.Rounded) mo332createOutlinePq9zytI).getRoundRect(), null, 2, null);
        } else if (!(mo332createOutlinePq9zytI instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.tooltipPath, ((Outline.Rectangle) mo332createOutlinePq9zytI).getRect(), null, 2, null);
        }
        if (mo332createOutlinePq9zytI2 instanceof Outline.Generic) {
            Path.m5562addPathUv8p0NA$default(this.caretPath, ((Outline.Generic) mo332createOutlinePq9zytI2).getPath(), 0L, 2, null);
        } else if (mo332createOutlinePq9zytI2 instanceof Outline.Rounded) {
            Path.addRoundRect$default(this.caretPath, ((Outline.Rounded) mo332createOutlinePq9zytI2).getRoundRect(), null, 2, null);
        } else if (!(mo332createOutlinePq9zytI2 instanceof Outline.Rectangle)) {
            throw new NoWhenBranchMatchedException();
        } else {
            Path.addRect$default(this.caretPath, ((Outline.Rectangle) mo332createOutlinePq9zytI2).getRect(), null, 2, null);
        }
        this.caretPath.mo5172transform58bKbWc(this.transformationMatrix.getValue().m5545unboximpl());
        this.combinedPath.mo5170opN5in7k0(this.tooltipPath, this.caretPath, PathOperation.Companion.m5587getUnionb3I0S0c());
