...
public abstract class ExposedDropdownMenuBoxScope {
    ...
    public abstract String mo2439getAnchorTypeoYjWRB4$material3();
    ...
    */
                            ...
                            if ((i3 & 2048) == 0) {
                                ...
                                if (startRestartGroup.shouldExecute((i4 & 306783379) == 306783378 || (i13 & 19) != 18, i4 & 1)) {
                                    ...
                                    if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        float m2632getTonalElevationD9Ej5fM = i7 != 0 ? MenuDefaults.INSTANCE.m2632getTonalElevationD9Ej5fM() : f;
                                        float m2631getShadowElevationD9Ej5fM = i9 != 0 ? MenuDefaults.INSTANCE.m2631getShadowElevationD9Ej5fM() : f2;
                                        if (i11 != 0) {
                                            modifier3 = companion;
                                            ...
                                            if (!((Boolean) mutableTransitionState.getCurrentState()).booleanValue() || ((Boolean) mutableTransitionState.getTargetState()).booleanValue()) {
                                                ...
                                                if (rememberedValue3 == Composer.Companion.getEmpty()) {
                                                    rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TransformOrigin.m5826boximpl(TransformOrigin.Companion.m5839getCenterSzJe1aQ()), null, 2, null);
                                                ...
                                                AndroidPopup_androidKt.Popup((ExposedDropdownMenuPositionProvider) rememberedValue4, obj, ExposedDropdownMenu_androidKt.m2459popupPropertiesForAnchorTypeBTG8q0(mo2439getAnchorTypeoYjWRB4$material3(), getAlwaysFocusable$material3(), startRestartGroup, 0), ComposableLambdaKt.rememberComposableLambda(2063119149, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuBoxScope$ExposedDropdownMenu$2
                                                    ...
                                                    public final void invoke(Composer composer3, int i15) {
                                                        ...
                                                        MenuKt.m2646DropdownMenuContentQj0Zi0g(ExposedDropdownMenuBoxScope.this.exposedDropdownSize(modifier3, z5), mutableTransitionState, mutableState2, scrollState5, shape4, j3, f5, f6, borderStroke3, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                                                        if (ComposerKt.isTraceInProgress()) {
                                    ...
                                    AndroidPopup_androidKt.Popup((ExposedDropdownMenuPositionProvider) rememberedValue4, obj, ExposedDropdownMenu_androidKt.m2459popupPropertiesForAnchorTypeBTG8q0(mo2439getAnchorTypeoYjWRB4$material3(), getAlwaysFocusable$material3(), startRestartGroup, 0), ComposableLambdaKt.rememberComposableLambda(2063119149, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ExposedDropdownMenuBoxScope$ExposedDropdownMenu$2
                                        ...
                                        public final void invoke(Composer composer3, int i15) {
                                            ...
                                            MenuKt.m2646DropdownMenuContentQj0Zi0g(ExposedDropdownMenuBoxScope.this.exposedDropdownSize(modifier3, z5), mutableTransitionState, mutableState22, scrollState5, shape4, j3, f5, f6, borderStroke3, function3, composer3, (MutableTransitionState.$stable << 3) | RendererCapabilities.DECODER_SUPPORT_MASK);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
    ...
    public final Modifier menuAnchor(Modifier modifier) {
        return m2436menuAnchor2Hz36ac$default(this, modifier, ExposedDropdownMenuAnchorType.Companion.m2432getPrimaryNotEditableoYjWRB4(), false, 2, null);
    }
                ...
                if (i8 != 0) {
                    ...
                    if ((i3 & 4096) == 0) {
                        ...
                        if (startRestartGroup.shouldExecute((i4 & 306775187) == 306775186 || (i13 & 147) != 146, i4 & 1)) {
                            ...
                            int i15 = i4 >> 3;
                            composer2 = startRestartGroup;
                            m2438ExposedDropdownMenuvNxi1II(z, obj, modifier3, scrollState4, z8, shape4, j4, f5, f6, borderStroke3, function3, composer2, (i4 & 8190) | (57344 & i15) | (458752 & i15) | (3670016 & i15) | (29360128 & i15) | (i15 & 234881024) | ((i13 << 27) & 1879048192), (i13 >> 3) & WebSocketProtocol.PAYLOAD_SHORT, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            z6 = z7;
                    ...
                    if (!startRestartGroup.shouldExecute((74899 & i3) == 74898, i3 & 1)) {
                        ...
                        if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i2 & 8) != 0) {
                                ...
                                int i6 = i3 >> 9;
                                composer2 = startRestartGroup;
                                exposedDropdownMenuBoxScope.m2437ExposedDropdownMenukbRbctU(z2, function02, modifier2, rememberScrollState, false, true, MenuDefaults.INSTANCE.getShape(startRestartGroup, 6), MenuDefaults.INSTANCE.getContainerColor(startRestartGroup, 6), MenuDefaults.INSTANCE.m2632getTonalElevationD9Ej5fM(), MenuDefaults.INSTANCE.m2631getShadowElevationD9Ej5fM(), null, obj2, composer2, (i3 & 14) | 906166272 | (i3 & 112) | (i3 & 896) | (i3 & 7168), (i6 & 112) | 6 | (i6 & 896), 16);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                                obj = modifier2;
