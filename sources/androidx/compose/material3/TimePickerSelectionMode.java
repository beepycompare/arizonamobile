...
public final class TimePickerSelectionMode {
    ...
    private static final int Hour = m3336constructorimpl(0);
    private static final int Minute = m3336constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerSelectionMode m3335boximpl(int i) {
        return new TimePickerSelectionMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m3336constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3337equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m3341unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3338equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m3339hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m3337equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m3339hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m3340toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3340toStringimpl(int i) {
        return m3338equalsimpl0(i, Hour) ? "Hour" : m3338equalsimpl0(i, Minute) ? "Minute" : "";
    }
}
