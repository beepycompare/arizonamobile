...
public final class TimePicker_androidKt {
    public static final int defaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m3247getVerticalQJTpgSE = TimePickerLayoutType.Companion.m3246getHorizontalQJTpgSE();
        } else {
            m3247getVerticalQJTpgSE = TimePickerLayoutType.Companion.m3247getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m3247getVerticalQJTpgSE;
    }
}
