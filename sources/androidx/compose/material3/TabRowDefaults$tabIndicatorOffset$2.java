...
final class TabRowDefaults$tabIndicatorOffset$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        State<Dp> m151animateDpAsStateAjpBEmI = AnimateAsStateKt.m151animateDpAsStateAjpBEmI(this.$currentTabPosition.m3043getWidthD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
        final State<Dp> m151animateDpAsStateAjpBEmI2 = AnimateAsStateKt.m151animateDpAsStateAjpBEmI(this.$currentTabPosition.m3041getLeftD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
        ...
        boolean changed = composer.changed(m151animateDpAsStateAjpBEmI2);
        ...
        Modifier m900width3ABfNKs = SizeKt.m900width3ABfNKs(OffsetKt.offset(wrapContentSize$default, (Function1) rememberedValue), invoke$lambda$0(m151animateDpAsStateAjpBEmI));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m900width3ABfNKs;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final IntOffset invoke$lambda$3$lambda$2(State state, Density density) {
        return IntOffset.m8115boximpl(IntOffset.m8118constructorimpl((density.mo424roundToPx0680j_4(invoke$lambda$1(state)) << 32) | (0 & 4294967295L)));
    }
