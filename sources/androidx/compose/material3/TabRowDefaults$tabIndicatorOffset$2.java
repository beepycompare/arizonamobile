...
final class TabRowDefaults$tabIndicatorOffset$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        State<Dp> m185animateDpAsStateAjpBEmI = AnimateAsStateKt.m185animateDpAsStateAjpBEmI(this.$currentTabPosition.m3053getWidthD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
        final State<Dp> m185animateDpAsStateAjpBEmI2 = AnimateAsStateKt.m185animateDpAsStateAjpBEmI(this.$currentTabPosition.m3051getLeftD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
        ...
        boolean changed = composer.changed(m185animateDpAsStateAjpBEmI2);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function1() { // from class: androidx.compose.material3.TabRowDefaults$tabIndicatorOffset$2$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    ...
                    m8279boximpl = IntOffset.m8279boximpl(IntOffset.m8282constructorimpl(density.mo428roundToPx0680j_4(TabRowDefaults$tabIndicatorOffset$2.invoke$lambda$1(state)) << 32));
                    return m8279boximpl;
                }
            };
        ...
        Modifier m1122width3ABfNKs = SizeKt.m1122width3ABfNKs(OffsetKt.offset(wrapContentSize$default, (Function1) rememberedValue), invoke$lambda$0(m185animateDpAsStateAjpBEmI));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1122width3ABfNKs;
    }
