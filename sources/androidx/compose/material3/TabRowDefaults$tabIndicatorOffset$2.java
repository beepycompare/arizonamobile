...
final class TabRowDefaults$tabIndicatorOffset$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        State<Dp> m150animateDpAsStateAjpBEmI = AnimateAsStateKt.m150animateDpAsStateAjpBEmI(this.$currentTabPosition.m3042getWidthD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
        final State<Dp> m150animateDpAsStateAjpBEmI2 = AnimateAsStateKt.m150animateDpAsStateAjpBEmI(this.$currentTabPosition.m3040getLeftD9Ej5fM(), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultSpatial, composer, 6), null, null, composer, 0, 12);
    ...
    public static final IntOffset invoke$lambda$3$lambda$2(State state, Density density) {
        return IntOffset.m8114boximpl(IntOffset.m8117constructorimpl((density.mo423roundToPx0680j_4(invoke$lambda$1(state)) << 32) | (0 & 4294967295L)));
    }
