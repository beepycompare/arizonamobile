...
public final class DatePicker_jvmKt {
    ...
    public static final DatePickerState m2447rememberDatePickerStateEU0dCGE(LocalDate localDate, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        DatePickerState m2439rememberDatePickerStateEU0dCGE = DatePickerKt.m2439rememberDatePickerStateEU0dCGE(localDate != null ? getLocalDateMillisUtc(localDate) : null, yearMonth != null ? Long.valueOf(getYearMonthMillisUtc(yearMonth)) : null, intRange2, i4, selectableDates2, composer, i2 & 65408, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2439rememberDatePickerStateEU0dCGE;
    }

    /* renamed from: DatePickerState-sHin3Bw$default  reason: not valid java name */
    public static /* synthetic */ DatePickerState m2444DatePickerStatesHin3Bw$default(Locale locale, LocalDate localDate, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            yearMonth = localDate != null ? YearMonth.from(localDate) : null;
        }
        ...
        return m2443DatePickerStatesHin3Bw(locale, localDate, yearMonth2, intRange2, i3, selectableDates);
    }

    /* renamed from: DatePickerState-sHin3Bw  reason: not valid java name */
    public static final DatePickerState m2443DatePickerStatesHin3Bw(Locale locale, LocalDate localDate, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates) {
        return DatePickerKt.m2434DatePickerStatesHin3Bw(locale, getLocalDateMillisUtc(localDate), yearMonth != null ? Long.valueOf(getYearMonthMillisUtc(yearMonth)) : null, intRange, i, selectableDates);
    }

    /* renamed from: rememberDateRangePickerState-IlFM19s  reason: not valid java name */
    public static final DateRangePickerState m2448rememberDateRangePickerStateIlFM19s(LocalDate localDate, LocalDate localDate2, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        IntRange intRange2 = intRange;
        int m2481getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.Companion.m2481getPickerjFl4v0() : i;
        ...
        DateRangePickerState m2457rememberDateRangePickerStateIlFM19s = DateRangePickerKt.m2457rememberDateRangePickerStateIlFM19s(localDate != null ? getLocalDateMillisUtc(localDate) : null, localDate2 != null ? getLocalDateMillisUtc(localDate2) : null, yearMonth != null ? Long.valueOf(getYearMonthMillisUtc(yearMonth)) : null, intRange2, m2481getPickerjFl4v0, allDates, composer, i2 & 523264, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2457rememberDateRangePickerStateIlFM19s;
    }

    /* renamed from: DateRangePickerState-HVP43zI$default  reason: not valid java name */
    public static /* synthetic */ DateRangePickerState m2446DateRangePickerStateHVP43zI$default(Locale locale, LocalDate localDate, LocalDate localDate2, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            yearMonth = localDate != null ? YearMonth.from(localDate) : null;
        }
        YearMonth yearMonth2 = yearMonth;
        ...
        return m2445DateRangePickerStateHVP43zI(locale, localDate, localDate2, yearMonth2, intRange2, i3, selectableDates);
    }

    /* renamed from: DateRangePickerState-HVP43zI  reason: not valid java name */
    public static final DateRangePickerState m2445DateRangePickerStateHVP43zI(Locale locale, LocalDate localDate, LocalDate localDate2, YearMonth yearMonth, IntRange intRange, int i, SelectableDates selectableDates) {
        return DateRangePickerKt.m2452DateRangePickerStateHVP43zI(locale, getLocalDateMillisUtc(localDate), getLocalDateMillisUtc(localDate2), yearMonth != null ? Long.valueOf(getYearMonthMillisUtc(yearMonth)) : null, intRange, i, selectableDates);
    }
