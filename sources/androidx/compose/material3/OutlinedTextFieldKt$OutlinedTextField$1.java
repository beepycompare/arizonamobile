...
public final class OutlinedTextFieldKt$OutlinedTextField$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (this.$label != null && !(this.$labelPosition instanceof TextFieldLabelPosition.Above)) {
            ...
            companion = PaddingKt.m847paddingqDBjuR0$default(SemanticsModifierKt.semantics(companion2, true, (Function1) rememberedValue), 0.0f, TextFieldImplKt.minimizedLabelHalfHeight(composer, 0), 0.0f, 0.0f, 13, null);
        ...
        Modifier m879defaultMinSizeVpY3zN4 = SizeKt.m879defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(then, z, Strings_androidKt.m3611getString2EP1pXo(Strings.m3532constructorimpl(androidx.compose.ui.R.string.default_error_message), composer, 0)), OutlinedTextFieldDefaults.INSTANCE.m2712getMinWidthD9Ej5fM(), OutlinedTextFieldDefaults.INSTANCE.m2711getMinHeightD9Ej5fM());
        SolidColor solidColor = new SolidColor(this.$colors.m3075cursorColorvNxB06k$material3(this.$isError), null);
        ...
        BasicTextFieldKt.BasicTextField(this.$state, m879defaultMinSizeVpY3zN4, this.$enabled, this.$readOnly, this.$inputTransformation, this.$mergedTextStyle, this.$keyboardOptions, this.$onKeyboardAction, this.$lineLimits, this.$onTextLayout, this.$interactionSource, solidColor, this.$outputTransformation, outlinedTextFieldDefaults.decorator(textFieldState, z2, textFieldLineLimits, outputTransformation, mutableInteractionSource, textFieldLabelPosition, function3, function2, function22, function23, function24, function25, function26, z3, textFieldColors, paddingValues, ComposableLambdaKt.rememberComposableLambda(-98391231, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt$OutlinedTextField$1.2
            ...
            public final void invoke(Composer composer2, int i2) {
                ...
                OutlinedTextFieldDefaults.INSTANCE.m2706Container4EFweAY(z4, z5, mutableInteractionSource2, null, textFieldColors2, shape, 0.0f, 0.0f, composer2, 100663296, 200);
                if (ComposerKt.isTraceInProgress()) {
