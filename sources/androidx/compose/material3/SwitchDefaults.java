...
public final class SwitchDefaults {
    ...
    private static final float IconSize = Dp.m7264constructorimpl(16);
    ...
    public final SwitchColors m2696colorsV1nXRL4(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, Composer composer, int i, int i2, int i3) {
        long j17;
        long j18;
        long j19;
        int i4;
        ...
        long m4584getTransparent0d7_KjU = (i3 & 4) != 0 ? Color.Companion.m4584getTransparent0d7_KjU() : j3;
        ...
        long m4594compositeOverOWjLjI = (i3 & 256) != 0 ? ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledSelectedHandleColor(), composer, 6), SwitchTokens.INSTANCE.getDisabledSelectedHandleOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2036getSurface0d7_KjU()) : j9;
        if ((i3 & 512) != 0) {
            j17 = value;
            j18 = ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledSelectedTrackColor(), composer, 6), SwitchTokens.INSTANCE.getDisabledTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2036getSurface0d7_KjU());
        } else {
            j17 = value;
            j18 = j10;
        }
        long m4584getTransparent0d7_KjU2 = (i3 & 1024) != 0 ? Color.Companion.m4584getTransparent0d7_KjU() : j11;
        if ((i3 & 2048) != 0) {
            i4 = 6;
            j19 = m4594compositeOverOWjLjI;
            j20 = ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledSelectedIconColor(), composer, 6), SwitchTokens.INSTANCE.getDisabledSelectedIconOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2036getSurface0d7_KjU());
        } else {
            j19 = m4594compositeOverOWjLjI;
            i4 = 6;
            j20 = j12;
        }
        long m4594compositeOverOWjLjI2 = (i3 & 4096) != 0 ? ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledUnselectedHandleColor(), composer, i4), SwitchTokens.INSTANCE.getDisabledUnselectedHandleOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, i4).m2036getSurface0d7_KjU()) : j13;
        long m4594compositeOverOWjLjI3 = (i3 & 8192) != 0 ? ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledUnselectedTrackColor(), composer, i4), SwitchTokens.INSTANCE.getDisabledTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, i4).m2036getSurface0d7_KjU()) : j14;
        long m4594compositeOverOWjLjI4 = (i3 & 16384) != 0 ? ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledUnselectedTrackOutlineColor(), composer, i4), SwitchTokens.INSTANCE.getDisabledTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, i4).m2036getSurface0d7_KjU()) : j15;
        long m4594compositeOverOWjLjI5 = (i3 & 32768) != 0 ? ColorKt.m4594compositeOverOWjLjI(Color.m4548copywmQWz5c$default(ColorSchemeKt.getValue(SwitchTokens.INSTANCE.getDisabledUnselectedIconColor(), composer, i4), SwitchTokens.INSTANCE.getDisabledUnselectedIconOpacity(), 0.0f, 0.0f, 0.0f, 14, null), MaterialTheme.INSTANCE.getColorScheme(composer, i4).m2036getSurface0d7_KjU()) : j16;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1937926421, i, i2, "androidx.compose.material3.SwitchDefaults.colors (Switch.kt:362)");
        }
        SwitchColors switchColors = new SwitchColors(j17, value2, m4584getTransparent0d7_KjU, value3, value4, value5, value6, value7, j19, j18, m4584getTransparent0d7_KjU2, j20, m4594compositeOverOWjLjI2, m4594compositeOverOWjLjI3, m4594compositeOverOWjLjI4, m4594compositeOverOWjLjI5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final float m2697getIconSizeD9Ej5fM() {
        return IconSize;
    }
}
