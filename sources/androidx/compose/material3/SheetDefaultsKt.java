...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m7995constructorimpl(22);
        ...
        if (!startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            TooltipKt.TooltipBox(TooltipDefaults.INSTANCE.m3365rememberTooltipPositionProviderHu5FAss(TooltipAnchorPosition.Companion.m3352getAbovelOKsHw4(), 0.0f, startRestartGroup, 390, 2), ComposableLambdaKt.rememberComposableLambda(2059851063, true, new Function3<TooltipScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SheetDefaultsKt$DragHandleWithTooltip$1$1
                ...
                public final void invoke(TooltipScope tooltipScope, Composer composer2, int i4) {
                    ...
                    final String str = m3610getString2EP1pXo;
                    TooltipKt.m3373PlainTooltipgv3ox5I(tooltipScope, null, null, 0.0f, null, 0L, 0L, 0.0f, 0.0f, ComposableLambdaKt.rememberComposableLambda(-999924215, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SheetDefaultsKt$DragHandleWithTooltip$1$1.1
                        ...
                        public final void invoke(Composer composer3, int i6) {
                            ...
                            TextKt.m3168TextNvy7gAk(str, null, 0L, null, 0L, null, null, null, 0L, null, null, 0L, 0, false, 0, 0, null, null, composer3, 0, 0, 262142);
                            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> function1) {
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo928onPreScrollOzD1aCk(long j, int i) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m6450equalsimpl0(i, NestedScrollSource.Companion.m6462getUserInputWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m8233getXimpl(j) : Velocity.m8234getYimpl(j);
            }
    ...
    public static final SheetState m2880rememberSheetStateAGcomas(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, float f, float f2, Composer composer, int i, int i2) {
        ...
        final float m1954getPositionalThresholdD9Ej5fM$material3 = (i2 & 16) != 0 ? BottomSheetDefaults.INSTANCE.m1954getPositionalThresholdD9Ej5fM$material3() : f;
        final float m1957getVelocityThresholdD9Ej5fM$material3 = (i2 & 32) != 0 ? BottomSheetDefaults.INSTANCE.m1957getVelocityThresholdD9Ej5fM$material3() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        boolean z5 = true;
        boolean changed = composer.changed(density) | ((((57344 & i) ^ 24576) > 16384 && composer.changed(m1954getPositionalThresholdD9Ej5fM$material3)) || (i & 24576) == 16384);
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new Function0() { // from class: androidx.compose.material3.SheetDefaultsKt$$ExternalSyntheticLambda1
                ...
                public final Object invoke() {
                    ...
                    mo429toPx0680j_4 = Density.this.mo429toPx0680j_4(m1954getPositionalThresholdD9Ej5fM$material3);
                    return Float.valueOf(mo429toPx0680j_4);
                }
            };
        ...
        if (changed2 || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = new Function0() { // from class: androidx.compose.material3.SheetDefaultsKt$$ExternalSyntheticLambda2
                ...
                public final Object invoke() {
                    float mo429toPx0680j_4;
                    mo429toPx0680j_4 = Density.this.mo429toPx0680j_4(m1957getVelocityThresholdD9Ej5fM$material3);
                    return Float.valueOf(mo429toPx0680j_4);
                }
            };
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        SheetState sheetState = (SheetState) RememberSaveableKt.m4725rememberSaveable(objArr, Saver, (Function0<? extends Object>) rememberedValue4, (Composer) composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
