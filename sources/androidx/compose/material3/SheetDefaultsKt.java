...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m8160constructorimpl(22.0f);
        ...
        if (!startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            TooltipKt.TooltipBox(TooltipDefaults.INSTANCE.m3336rememberTooltipPositionProviderHu5FAss(TooltipAnchorPosition.Companion.m3323getAbovelOKsHw4(), 0.0f, startRestartGroup, 390, 2), ComposableLambdaKt.rememberComposableLambda(2059851063, true, new Function3<TooltipScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.SheetDefaultsKt$DragHandleWithTooltip$1$1
                ...
                public final void invoke(TooltipScope tooltipScope, Composer composer2, int i4) {
                    ...
                    final String str = m3533getString2EP1pXo;
                    TooltipKt.m3339PlainTooltipgv3ox5I(tooltipScope, null, null, 0.0f, null, 0L, 0L, 0.0f, 0.0f, ComposableLambdaKt.rememberComposableLambda(-999924215, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SheetDefaultsKt$DragHandleWithTooltip$1$1.1
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> function1) {
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo1150onPreScrollOzD1aCk(long j, int i) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m6542equalsimpl0(i, NestedScrollSource.Companion.m6554getUserInputWNlRxjI())) {
            ...
            public Object mo602onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
                ...
                return Velocity.m8389boximpl(j2);
            }
            ...
            private final long toOffset(float f) {
                ...
                return Offset.m5095constructorimpl((Float.floatToRawIntBits(f) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
            }

            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m8398getXimpl(j) : Velocity.m8399getYimpl(j);
            }
    ...
    public static final SheetState m2923rememberSheetStateAGcomas(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, float f, float f2, Composer composer, int i, int i2) {
        ...
        final float m2193getPositionalThresholdD9Ej5fM$material3 = (i2 & 16) != 0 ? BottomSheetDefaults.INSTANCE.m2193getPositionalThresholdD9Ej5fM$material3() : f;
        final float m2196getVelocityThresholdD9Ej5fM$material3 = (i2 & 32) != 0 ? BottomSheetDefaults.INSTANCE.m2196getVelocityThresholdD9Ej5fM$material3() : f2;
        if (ComposerKt.isTraceInProgress()) {
        ...
        boolean z5 = true;
        boolean changed = composer.changed(density) | ((((57344 & i) ^ 24576) > 16384 && composer.changed(m2193getPositionalThresholdD9Ej5fM$material3)) || (i & 24576) == 16384);
        ...
        if (changed || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new Function0() { // from class: androidx.compose.material3.SheetDefaultsKt$$ExternalSyntheticLambda1
                ...
                public final Object invoke() {
                    ...
                    mo434toPx0680j_4 = Density.this.mo434toPx0680j_4(m2193getPositionalThresholdD9Ej5fM$material3);
        ...
        if (changed2 || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = new Function0() { // from class: androidx.compose.material3.SheetDefaultsKt$$ExternalSyntheticLambda2
                ...
                public final Object invoke() {
                    float mo434toPx0680j_4;
                    mo434toPx0680j_4 = Density.this.mo434toPx0680j_4(m2196getVelocityThresholdD9Ej5fM$material3);
                    return Float.valueOf(mo434toPx0680j_4);
                }
            };
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        SheetState sheetState = (SheetState) RememberSaveableKt.m4739rememberSaveable(objArr, Saver, (Function0<? extends Object>) rememberedValue4, (Composer) composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
