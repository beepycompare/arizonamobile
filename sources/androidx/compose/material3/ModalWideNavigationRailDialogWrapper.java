...
public final class ModalWideNavigationRailDialogWrapper extends ComponentDialog implements ViewRootForInspector {
    ...
    public ModalWideNavigationRailDialogWrapper(Function0<Unit> function0, ModalWideNavigationRailProperties modalWideNavigationRailProperties, View view, LayoutDirection layoutDirection, Density density, UUID uuid, Function1<? super Float, Unit> function1, Function0<Unit> function02, RailPredictiveBackState railPredictiveBackState, boolean z) {
        ...
        modalWideNavigationRailDialogLayout.setElevation(density.mo434toPx0680j_4(m8160constructorimpl));
    ...
    public final void updateParameters(Function0<Unit> function0, ModalWideNavigationRailProperties modalWideNavigationRailProperties, LayoutDirection layoutDirection) {
        this.onDismissRequest = function0;
        this.properties = modalWideNavigationRailProperties;
        setSecurePolicy(modalWideNavigationRailProperties.getSecurePolicy());
