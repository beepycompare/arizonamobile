...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
        ...
        if (this.this$0.getCanScroll().invoke().booleanValue()) {
            ...
            if (Float.intBitsToFloat(i2) <= 0.0f) {
                ...
                if (heightOffset != this.this$0.getState().getHeightOffset()) {
                    return Offset.m5029copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
                }
    ...
    public long mo577onPostScrollDzOQY0M(long j, long j2, int i) {
        if (this.this$0.getCanScroll().invoke().booleanValue()) {
            ...
            if (Float.intBitsToFloat(i3) < 0.0f || Float.intBitsToFloat(i2) < 0.0f) {
                float heightOffset = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Float.intBitsToFloat(i2));
                return Offset.m5027constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(this.this$0.getState().getHeightOffset() - heightOffset) & 4294967295L));
                ...
                return Offset.m5027constructorimpl((Float.floatToRawIntBits(heightOffset3) & 4294967295L) | (Float.floatToRawIntBits(0.0f) << 32));
            } else {
                return Offset.Companion.m5051getZeroF1C5BW0();
            }
        }
    ...
    */
    public Object mo576onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1) {
            ...
            if ((exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (Velocity.m8234getYimpl(j2) > 0.0f) {
                    ...
                    if (i == 2) {
                        m8242unboximpl = exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12.J$0;
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m8224boximpl(Velocity.m8237plusAH228Gc(m8242unboximpl, ((Velocity) obj).m8242unboximpl()));
                    }
                ...
                float m8234getYimpl = Velocity.m8234getYimpl(j3);
                ...
                exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12.J$0 = m8242unboximpl;
                exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12.label = 2;
                obj = AppBarKt.settleAppBar(state, m8234getYimpl, flingAnimationSpec, snapAnimationSpec, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$12);
            }
        }
        ...
        float m8234getYimpl2 = Velocity.m8234getYimpl(j3);
        ...
        exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$122.J$0 = m8242unboximpl;
        exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$122.label = 2;
        obj2 = AppBarKt.settleAppBar(state2, m8234getYimpl2, flingAnimationSpec2, snapAnimationSpec2, exitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$122);
    }
}
