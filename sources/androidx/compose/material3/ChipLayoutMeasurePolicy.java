...
final class ChipLayoutMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        final Placeable mo6697measureBRTryo0 = measurable3 != null ? measurable3.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null)) : null;
        final int widthOrZero = LayoutUtilKt.getWidthOrZero(mo6697measureBRTryo0);
        final int heightOrZero = LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo0);
        ...
        Placeable mo6697measureBRTryo02 = measurable4 != null ? measurable4.mo6697measureBRTryo0(Constraints.m7938copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null)) : null;
        int widthOrZero2 = LayoutUtilKt.getWidthOrZero(mo6697measureBRTryo02);
        final int heightOrZero2 = LayoutUtilKt.getHeightOrZero(mo6697measureBRTryo02);
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), Constants.ScionAnalytics.PARAM_LABEL)) {
                final Placeable mo6697measureBRTryo03 = measurable5.mo6697measureBRTryo0(ConstraintsKt.m7968offsetNN6EwU$default(j, -(widthOrZero + widthOrZero2), 0, 2, null));
                final int max = Math.max(heightOrZero, Math.max(mo6697measureBRTryo03.getHeight(), heightOrZero2));
                final Placeable placeable = mo6697measureBRTryo02;
                return MeasureScope.layout$default(measureScope, mo6697measureBRTryo03.getWidth() + widthOrZero + widthOrZero2, max, null, new Function1() { // from class: androidx.compose.material3.ChipLayoutMeasurePolicy$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        Unit measure_3p2s80s$lambda$3;
                        measure_3p2s80s$lambda$3 = ChipLayoutMeasurePolicy.measure_3p2s80s$lambda$3(Placeable.this, heightOrZero, max, mo6697measureBRTryo03, widthOrZero, placeable, heightOrZero2, (Placeable.PlacementScope) obj);
