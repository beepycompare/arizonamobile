...
public final class AnimatedMeasurePolicy implements MeasurePolicy {
    ...
    public final int m1892getIconPositionxw1Ddg() {
    ...
    public final float m1897getTopIconIndicatorHorizontalPaddingD9Ej5fM() {
    ...
    public final float m1899getTopIconIndicatorVerticalPaddingD9Ej5fM() {
    ...
    public final float m1898getTopIconIndicatorToLabelVerticalPaddingD9Ej5fM() {
    ...
    public final float m1894getStartIconIndicatorHorizontalPaddingD9Ej5fM() {
    ...
    public final float m1895getStartIconIndicatorVerticalPaddingD9Ej5fM() {
    ...
    public final float m1896getStartIconToLabelHorizontalPaddingD9Ej5fM() {
        return this.startIconToLabelHorizontalPadding;
    }

    /* renamed from: getItemHorizontalPadding-D9Ej5fM  reason: not valid java name */
    public final float m1893getItemHorizontalPaddingD9Ej5fM() {
    ...
    public MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2673placeAnimatedLabelAndIcon2QYhCQ8;
        ...
        while (i < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                Placeable mo6697measureBRTryo0 = measurable.mo6697measureBRTryo0(m7938copyZbe2FdA$default);
                int size2 = list2.size();
                int i2 = 0;
                while (i2 < size2) {
                    Measurable measurable2 = list.get(i2);
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), Constants.ScionAnalytics.PARAM_LABEL)) {
                        Placeable mo6697measureBRTryo02 = measurable2.mo6697measureBRTryo0(m7938copyZbe2FdA$default);
                        float f = 2;
                        int width = mo6697measureBRTryo0.getWidth() + measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.topIconIndicatorHorizontalPadding * f));
                        int height = mo6697measureBRTryo0.getHeight() + measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.topIconIndicatorVerticalPadding * f));
                        int width2 = mo6697measureBRTryo0.getWidth() + mo6697measureBRTryo02.getWidth() + measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m7995constructorimpl(this.startIconIndicatorHorizontalPadding * f)));
                        int max = Math.max(mo6697measureBRTryo0.getHeight(), mo6697measureBRTryo02.getHeight()) + measureScope2.mo423roundToPx0680j_4(Dp.m7995constructorimpl(this.startIconIndicatorVerticalPadding * f));
                        ...
                        while (i3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                Placeable mo6697measureBRTryo03 = measurable3.mo6697measureBRTryo0(ConstraintsKt.m7963constrainN9IONVI(m7938copyZbe2FdA$default, Constraints.Companion.m7958fixedJhjzzOo(lerp, lerp2)));
                                int size4 = list2.size();
                                int i5 = 0;
                                while (i5 < size4) {
                                    Measurable measurable4 = list.get(i5);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "indicator")) {
                                        Placeable mo6697measureBRTryo04 = measurable4.mo6697measureBRTryo0(ConstraintsKt.m7963constrainN9IONVI(m7938copyZbe2FdA$default, Constraints.Companion.m7958fixedJhjzzOo(roundToInt, lerp2)));
                                        m2673placeAnimatedLabelAndIcon2QYhCQ8 = NavigationItemKt.m2673placeAnimatedLabelAndIcon2QYhCQ8(measureScope, this.iconPosition, this.iconPositionProgress, mo6697measureBRTryo02, mo6697measureBRTryo0, mo6697measureBRTryo03, mo6697measureBRTryo04, width, m7938copyZbe2FdA$default, this.topIconIndicatorToLabelVerticalPadding, this.topIconIndicatorVerticalPadding, this.topIconIndicatorHorizontalPadding, this.startIconIndicatorHorizontalPadding, this.startIconIndicatorVerticalPadding, this.startIconToLabelHorizontalPadding, this.itemHorizontalPadding);
                                        return m2673placeAnimatedLabelAndIcon2QYhCQ8;
                                    }
                                    i5++;
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable), "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable2), Constants.ScionAnalytics.PARAM_LABEL)) {
                        ...
                        if (NavigationItemIconPosition.m2652equalsimpl0(this.iconPosition, NavigationItemIconPosition.Companion.m2657getTopxw1Ddg())) {
                            float f = 2;
                            return Math.max(maxIntrinsicWidth2, maxIntrinsicWidth + intrinsicMeasureScope.mo423roundToPx0680j_4(Dp.m7995constructorimpl(Dp.m7995constructorimpl(this.topIconIndicatorHorizontalPadding * f) + Dp.m7995constructorimpl(this.itemHorizontalPadding * f))));
                        }
                        return maxIntrinsicWidth + maxIntrinsicWidth2 + intrinsicMeasureScope.mo423roundToPx0680j_4(Dp.m7995constructorimpl(Dp.m7995constructorimpl(Dp.m7995constructorimpl(this.startIconIndicatorHorizontalPadding * 2) + this.startIconToLabelHorizontalPadding) + this.itemHorizontalPadding));
                    }
                }
                ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
                throw new KotlinNothingValueException();
