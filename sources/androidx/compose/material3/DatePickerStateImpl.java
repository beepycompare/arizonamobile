...
public final class DatePickerStateImpl extends BaseDatePickerStateImpl implements DatePickerState {
    ...
    */
    private DatePickerStateImpl(Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m2473boximpl(i), null, 2, null);
    ...
    public void mo2442setDisplayModevCnGnXg(int i) {
    ...
    public static final class Companion {
        ...
        public final Saver<DatePickerStateImpl, Object> Saver(final SelectableDates selectableDates, final Locale locale) {
            return ListSaverKt.listSaver(new Function2() { // from class: androidx.compose.material3.DatePickerStateImpl$Companion$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    listOf = CollectionsKt.listOf(r2.getSelectedDateMillis(), Long.valueOf(r2.getDisplayedMonthMillis()), Integer.valueOf(r2.getYearRange().getFirst()), Integer.valueOf(r2.getYearRange().getLast()), Integer.valueOf(((DatePickerStateImpl) obj2).mo2441getDisplayModejFl4v0()));
                    return listOf;
                }
        ...
        public static final DatePickerStateImpl Saver$lambda$1(SelectableDates selectableDates, Locale locale, List list) {
            ...
            return new DatePickerStateImpl((Long) list.get(0), (Long) list.get(1), intRange, DisplayMode.m2474constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
        }
    }
}
