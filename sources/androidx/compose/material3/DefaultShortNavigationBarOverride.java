        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            SurfaceKt.m2996SurfaceT9BRK9s(shortNavigationBarOverrideScope.getModifier(), null, shortNavigationBarOverrideScope.m2900getContainerColor0d7_KjU(), shortNavigationBarOverrideScope.m2901getContentColor0d7_KjU(), 0.0f, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(236236519, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DefaultShortNavigationBarOverride$ShortNavigationBar$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m879defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(Modifier.Companion, ShortNavigationBarOverrideScope.this.getWindowInsets()), 0.0f, NavigationBarTokens.INSTANCE.m4067getContainerHeightD9Ej5fM(), 1, null));
                    Function2<Composer, Integer, Unit> content = ShortNavigationBarOverrideScope.this.getContent();
                    int m2899getArrangementLnnQw40 = ShortNavigationBarOverrideScope.this.m2899getArrangementLnnQw40();
                    if (ShortNavigationBarArrangement.m2888equalsimpl0(m2899getArrangementLnnQw40, ShortNavigationBarArrangement.Companion.m2893getEqualWeightLnnQw40())) {
                        centeredContentMeasurePolicy = new EqualWeightContentMeasurePolicy();
                    } else if (ShortNavigationBarArrangement.m2888equalsimpl0(m2899getArrangementLnnQw40, ShortNavigationBarArrangement.Companion.m2892getCenteredLnnQw40())) {
                    ...
                    Updater.m4604setimpl(m4597constructorimpl, centeredContentMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
