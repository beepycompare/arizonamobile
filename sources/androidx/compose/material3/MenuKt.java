...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m7995constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m7995constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m7995constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m7995constructorimpl((float) RouletteView.DEFAULT_ROULETTE_WIDTH);
    ...
    public static final Unit DropdownMenuContent_Qj0Zi0g$lambda$6(Modifier modifier, MutableTransitionState mutableTransitionState, MutableState mutableState, ScrollState scrollState, Shape shape, long j, float f, float f2, BorderStroke borderStroke, Function3 function3, int i, Composer composer, int i2) {
        m2559DropdownMenuContentQj0Zi0g(modifier, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1));
    ...
    public static final void m2559DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 306783379) != 306783378, i2 & 1)) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                function1 = new Function1() { // from class: androidx.compose.material3.MenuKt$$ExternalSyntheticLambda1
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        DropdownMenuContent_Qj0Zi0g$lambda$5$lambda$4 = MenuKt.DropdownMenuContent_Qj0Zi0g$lambda$5$lambda$4(booleanValue5, mutableTransitionState, mutableState, createTransitionAnimation, createTransitionAnimation2, (GraphicsLayerScope) obj);
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2996SurfaceT9BRK9s(GraphicsLayerModifierKt.graphicsLayer(companion, function1), shape, j, 0L, f, f2, borderStroke, ComposableLambdaKt.rememberComposableLambda(-1463404422, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                ...
                public final void invoke(Composer composer3, int i6) {
                    ...
                    Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m844paddingVpY3zN4$default(Modifier.this, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.MenuKt$$ExternalSyntheticLambda2
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    DropdownMenuContent_Qj0Zi0g$lambda$6 = MenuKt.DropdownMenuContent_Qj0Zi0g$lambda$6(Modifier.this, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, i, (Composer) obj, ((Integer) obj2).intValue());
    ...
    public static final Unit DropdownMenuContent_Qj0Zi0g$lambda$5$lambda$4(boolean z, MutableTransitionState mutableTransitionState, MutableState mutableState, State state, State state2, GraphicsLayerScope graphicsLayerScope) {
        ...
        graphicsLayerScope.mo5481setTransformOrigin__ExYCQ(((TransformOrigin) mutableState.getValue()).m5686unboximpl());
        return Unit.INSTANCE;
    }
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> function2, final Function0<Unit> function0, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final boolean z, final MenuItemColors menuItemColors, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((38347923 & i2) != 38347922, i2 & 1)) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m898sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m304clickableO2vRcR0$default(modifier, obj6, RippleKt.m2780rippleH2RKhps$default(true, 0.0f, 0L, 6, null), z, null, null, obj2, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuListItemContainerHeight, DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), paddingValues);
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(865999929, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if (function26 != null) {
                        ...
                        ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m5269boximpl(menuItemColors2.m2555leadingIconColorvNxB06k$material3(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.rememberComposableLambda(1241781204, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                Modifier m879defaultMinSizeVpY3zN4$default = SizeKt.m879defaultMinSizeVpY3zN4$default(Modifier.Companion, ListTokens.INSTANCE.m4038getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                ...
                                Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer3, m879defaultMinSizeVpY3zN4$default);
                    ...
                    ProvidedValue<Color> provides2 = ContentColorKt.getLocalContentColor().provides(Color.m5269boximpl(menuItemColors2.m2556textColorvNxB06k$material3(z)));
                    ...
                    CompositionLocalKt.CompositionLocalProvider(provides2, ComposableLambdaKt.rememberComposableLambda(-893579015, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                        ...
                        public final void invoke(Composer composer3, int i4) {
                            ...
                            if (function28 != null) {
                                m7995constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                            } else {
                                m7995constructorimpl = Dp.m7995constructorimpl(0);
                            }
                            float f = m7995constructorimpl;
                            if (function29 != null) {
                                m7995constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                            } else {
                                m7995constructorimpl2 = Dp.m7995constructorimpl(0);
                            }
                            Modifier m846paddingqDBjuR0$default = PaddingKt.m846paddingqDBjuR0$default(weight$default, f, 0.0f, m7995constructorimpl2, 0.0f, 10, null);
                    ...
                    if (function25 != null) {
                        ...
                        ProvidedValue<Color> provides3 = ContentColorKt.getLocalContentColor().provides(Color.m5269boximpl(menuItemColors2.m2557trailingIconColorvNxB06k$material3(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides3, ComposableLambdaKt.rememberComposableLambda(-782441013, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                Modifier m879defaultMinSizeVpY3zN4$default = SizeKt.m879defaultMinSizeVpY3zN4$default(Modifier.Companion, ListTokens.INSTANCE.m4046getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.MenuKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj7, Object obj8) {
                    ...
                    DropdownMenuItemContent$lambda$8 = MenuKt.DropdownMenuItemContent$lambda$8(Function2.this, function0, modifier, function22, function23, z, menuItemColors, paddingValues, mutableInteractionSource, i, (Composer) obj7, ((Integer) obj8).intValue());
    ...
    */
    ...
    static {
        float f = 48;
        MenuVerticalMargin = Dp.m7995constructorimpl(f);
        MenuListItemContainerHeight = Dp.m7995constructorimpl(f);
    }
}
