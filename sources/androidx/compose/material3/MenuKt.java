...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m7264constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m7264constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m7264constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m7264constructorimpl((float) RouletteView.DEFAULT_ROULETTE_WIDTH);
    ...
    public static final void m2362DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                ...
                function1 = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        ...
                        graphicsLayerScope.mo4751setTransformOrigin__ExYCQ(mutableState.getValue().m4956unboximpl());
                    }
                };
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2664SurfaceT9BRK9s(graphicsLayer, shape, j, 0L, f, f2, borderStroke, rememberComposableLambda, startRestartGroup, (i4 & 896) | (i4 & 112) | 12582912 | (57344 & i5) | (458752 & i5) | (i5 & 3670016), 8);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    MenuKt.m2362DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(1065051884, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(menuItemColors.m2359leadingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.rememberComposableLambda(2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m879defaultMinSizeVpY3zN4$default = SizeKt.m879defaultMinSizeVpY3zN4$default(Modifier.Companion, ListTokens.INSTANCE.m3427getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                        ...
                        ProvidedValue<Color> provides2 = ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(menuItemColors.m2360textColorvNxB06k$material3_release(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides2, ComposableLambdaKt.rememberComposableLambda(-1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (function25 != null) {
                                        m7264constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m7264constructorimpl = Dp.m7264constructorimpl(0);
                                    }
                                    float f = m7264constructorimpl;
                                    if (function26 != null) {
                                        m7264constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m7264constructorimpl2 = Dp.m7264constructorimpl(0);
                                    }
                                    Modifier m846paddingqDBjuR0$default = PaddingKt.m846paddingqDBjuR0$default(weight$default, f, 0.0f, m7264constructorimpl2, 0.0f, 10, null);
                        ...
                        if (function23 != null) {
                            ProvidedValue<Color> provides3 = ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(menuItemColors.m2361trailingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides3, ComposableLambdaKt.rememberComposableLambda(580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m879defaultMinSizeVpY3zN4$default = SizeKt.m879defaultMinSizeVpY3zN4$default(Modifier.Companion, ListTokens.INSTANCE.m3435getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
    ...
    */
    ...
    static {
        float f = 48;
        MenuVerticalMargin = Dp.m7264constructorimpl(f);
        MenuListItemContainerHeight = Dp.m7264constructorimpl(f);
    }
}
