...
public final class SliderColors {
    ...
    public static /* synthetic */ SliderColors m2593copyK518z4$default(SliderColors sliderColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, int i, Object obj) {
        ...
        return sliderColors.m2594copyK518z4(j20, j14, j15, j16, j17, j18, j19, j21, j12, j11);
    }

    /* renamed from: copy--K518z4  reason: not valid java name */
    public final SliderColors m2594copyK518z4(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10) {
    ...
    public final long m2605thumbColorvNxB06k$material3_release(boolean z) {
        return z ? this.thumbColor : this.disabledThumbColor;
    }

    /* renamed from: trackColor-WaAFU9c$material3_release  reason: not valid java name */
    public final long m2607trackColorWaAFU9c$material3_release(boolean z, boolean z2) {
    ...
    public final long m2606tickColorWaAFU9c$material3_release(boolean z, boolean z2) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4550equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m4550equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m4550equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m4550equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m4550equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m4550equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m4550equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m4550equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m4550equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m4550equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m4556hashCodeimpl(this.thumbColor) * 31) + Color.m4556hashCodeimpl(this.activeTrackColor)) * 31) + Color.m4556hashCodeimpl(this.activeTickColor)) * 31) + Color.m4556hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m4556hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m4556hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m4556hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m4556hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m4556hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m4556hashCodeimpl(this.disabledInactiveTickColor);
    }
}
