...
public final class SliderColors {
    ...
    public static /* synthetic */ SliderColors m2904copyK518z4$default(SliderColors sliderColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, int i, Object obj) {
        ...
        return sliderColors.m2905copyK518z4(j20, j14, j15, j16, j17, j18, j19, j21, j12, j11);
    }

    /* renamed from: copy--K518z4  reason: not valid java name */
    public final SliderColors m2905copyK518z4(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10) {
    ...
    public final long m2916thumbColorvNxB06k$material3(boolean z) {
        return z ? this.thumbColor : this.disabledThumbColor;
    }

    /* renamed from: trackColor-WaAFU9c$material3  reason: not valid java name */
    public final long m2918trackColorWaAFU9c$material3(boolean z, boolean z2) {
    ...
    public final long m2917tickColorWaAFU9c$material3(boolean z, boolean z2) {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5281equalsimpl0(this.thumbColor, sliderColors.thumbColor) && Color.m5281equalsimpl0(this.activeTrackColor, sliderColors.activeTrackColor) && Color.m5281equalsimpl0(this.activeTickColor, sliderColors.activeTickColor) && Color.m5281equalsimpl0(this.inactiveTrackColor, sliderColors.inactiveTrackColor) && Color.m5281equalsimpl0(this.inactiveTickColor, sliderColors.inactiveTickColor) && Color.m5281equalsimpl0(this.disabledThumbColor, sliderColors.disabledThumbColor) && Color.m5281equalsimpl0(this.disabledActiveTrackColor, sliderColors.disabledActiveTrackColor) && Color.m5281equalsimpl0(this.disabledActiveTickColor, sliderColors.disabledActiveTickColor) && Color.m5281equalsimpl0(this.disabledInactiveTrackColor, sliderColors.disabledInactiveTrackColor) && Color.m5281equalsimpl0(this.disabledInactiveTickColor, sliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m5287hashCodeimpl(this.thumbColor) * 31) + Color.m5287hashCodeimpl(this.activeTrackColor)) * 31) + Color.m5287hashCodeimpl(this.activeTickColor)) * 31) + Color.m5287hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m5287hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m5287hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m5287hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m5287hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m5287hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m5287hashCodeimpl(this.disabledInactiveTickColor);
    }
}
