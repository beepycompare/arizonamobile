...
final class FloatingActionButtonKt$ExtendedFloatingActionButton$5 implements Function2<Composer, Integer, Unit> {
    ...
    public static final MeasureResult invoke$lambda$4$lambda$3(float f, State state, MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        int lerp = MathHelpersKt.lerp(measureScope.mo428roundToPx0680j_4(f), measurable.maxIntrinsicWidth(Constraints.m8112getMaxHeightimpl(constraints.m8119unboximpl())), ((Number) state.getValue()).floatValue());
        final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(constraints.m8119unboximpl());
        return MeasureScope.layout$default(measureScope, lerp, mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.FloatingActionButtonKt$ExtendedFloatingActionButton$5$$ExternalSyntheticLambda4
    ...
    public final void invoke(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        Modifier m1054paddingqDBjuR0$default = PaddingKt.m1054paddingqDBjuR0$default(SizeKt.m1121sizeInqDBjuR0$default(LayoutModifierKt.layout(companion, (Function3) rememberedValue), this.$minWidth, this.$minHeight, 0.0f, 0.0f, 12, null), this.$startPadding, 0.0f, this.$endPadding, 0.0f, 10, null);
        ...
        Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer, m1054paddingqDBjuR0$default);
        ...
        if (!((Boolean) ((State) rememberedValue2).getValue()).booleanValue()) {
            ...
            SpacerKt.Spacer(SizeKt.m1122width3ABfNKs(Modifier.Companion, f2), composer, 0);
