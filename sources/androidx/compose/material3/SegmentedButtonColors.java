...
public final class SegmentedButtonColors {
    ...
    public final long m2937getDisabledInactiveContentColor0d7_KjU() {
        return this.disabledInactiveContentColor;
    }

    /* renamed from: getDisabledInactiveBorderColor-0d7_KjU  reason: not valid java name */
    public final long m2935getDisabledInactiveBorderColor0d7_KjU() {
        return this.disabledInactiveBorderColor;
    }

    /* renamed from: copy-2qZNXz8$default  reason: not valid java name */
    public static /* synthetic */ SegmentedButtonColors m2924copy2qZNXz8$default(SegmentedButtonColors segmentedButtonColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
        ...
        return segmentedButtonColors.m2928copy2qZNXz8(j22, j16, j17, j18, j19, j20, j21, j23, j24, j25, j14, j13);
    }

    /* renamed from: copy-2qZNXz8  reason: not valid java name */
    public final SegmentedButtonColors m2928copy2qZNXz8(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12) {
    ...
    public final long m2925borderColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z && z2) {
            return this.activeBorderColor;
        }
        if (!z || z2) {
    ...
    public final long m2927contentColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z && z2) {
            return this.activeContentColor;
        }
        if (!z || z2) {
    ...
    public final long m2926containerColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z && z2) {
            return this.activeContainerColor;
        }
        if (!z || z2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return Color.m5425equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m5425equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m5425equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m5425equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m5425equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m5425equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m5425equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m5425equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m5425equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m5425equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m5425equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m5425equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m5431hashCodeimpl(this.activeBorderColor) * 31) + Color.m5431hashCodeimpl(this.activeContentColor)) * 31) + Color.m5431hashCodeimpl(this.activeContainerColor)) * 31) + Color.m5431hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m5431hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m5431hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m5431hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m5431hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m5431hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m5431hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m5431hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m5431hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
