...
public final class DateRangePickerStateImpl extends BaseDatePickerStateImpl implements DateRangePickerState {
    ...
    private DateRangePickerStateImpl(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Locale locale) {
        ...
        setSelection(l, l2);
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DisplayMode.m2300boximpl(i), null, 2, null);
    ...
    public int mo2272getDisplayModejFl4v0() {
        return this._displayMode.getValue().m2306unboximpl();
    }

    @Override // androidx.compose.material3.DateRangePickerState
    /* renamed from: setDisplayMode-vCnGnXg */
    public void mo2273setDisplayModevCnGnXg(int i) {
        ...
        this._displayMode.setValue(DisplayMode.m2300boximpl(i));
    }
    ...
    public static final class Companion {
        ...
        public static final List Saver$lambda$0(SaverScope saverScope, DateRangePickerStateImpl dateRangePickerStateImpl) {
            return CollectionsKt.listOf(dateRangePickerStateImpl.getSelectedStartDateMillis(), dateRangePickerStateImpl.getSelectedEndDateMillis(), Long.valueOf(dateRangePickerStateImpl.getDisplayedMonthMillis()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getFirst()), Integer.valueOf(dateRangePickerStateImpl.getYearRange().getLast()), Integer.valueOf(dateRangePickerStateImpl.mo2272getDisplayModejFl4v0()));
        }
        ...
        public static final DateRangePickerStateImpl Saver$lambda$1(SelectableDates selectableDates, Locale locale, List list) {
            ...
            return new DateRangePickerStateImpl((Long) list.get(0), (Long) list.get(1), (Long) list.get(2), intRange, DisplayMode.m2301constructorimpl(((Integer) obj3).intValue()), selectableDates, locale, null);
        }
    }
}
