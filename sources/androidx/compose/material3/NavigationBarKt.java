...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m3442getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m7264constructorimpl(8);
    private static final float NavigationBarIndicatorToLabelPadding = Dp.m7264constructorimpl(4);
    private static final float IndicatorVerticalOffset = Dp.m7264constructorimpl(12);
    ...
    */
    public static final void m2394NavigationBarHsRjFd4(Modifier modifier, long j, long j2, float f, WindowInsets windowInsets, final Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        long j3;
        long j4;
        ...
        if (i7 != 0) {
            ...
            if ((74899 & i3) == 74898 || !startRestartGroup.getSkipping()) {
                ...
                if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i2 & 4) != 0) {
                        j4 = ColorSchemeKt.m2049contentColorFor4WTKRHQ(MaterialTheme.INSTANCE.getColorScheme(startRestartGroup, 6), j3);
                        i3 &= -897;
                    }
                    if (i7 != 0) {
                        f2 = NavigationBarDefaults.INSTANCE.m2379getElevationD9Ej5fM();
                    }
                    if ((i2 & 16) == 0) {
                ...
                SurfaceKt.m2664SurfaceT9BRK9s(modifier2, null, j8, j5, f3, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(105663120, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$1
                    ...
                    public final void invoke(Composer composer3, int i9) {
                        ...
                        if ((i9 & 3) != 2 || !composer3.getSkipping()) {
                            ...
                            Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m879defaultMinSizeVpY3zN4$default(windowInsetsPadding, 0.0f, f5, 1, null));
                            Alignment.Vertical centerVertically = Alignment.Companion.getCenterVertically();
                            Function3<RowScope, Composer, Integer, Unit> function32 = function3;
                            ComposerKt.sourceInformationMarkerStart(composer3, 693286680, "CC(Row)P(2,1,3)98@4939L58,99@5002L130:Row.kt#2w3rfo");
                            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m701spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding()), centerVertically, composer3, 54);
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$2
                    ...
                    public final void invoke(Composer composer3, int i9) {
                        NavigationBarKt.m2394NavigationBarHsRjFd4(Modifier.this, j6, j7, f4, windowInsets3, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                    }
                });
                return;
            }
        ...
        int i82 = i3 << 3;
        composer2 = startRestartGroup;
        SurfaceKt.m2664SurfaceT9BRK9s(modifier2, null, j82, j5, f3, 0.0f, null, ComposableLambdaKt.rememberComposableLambda(105663120, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBar$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
    ...
    */
    public static final void NavigationBarItem(final RowScope rowScope, final boolean z, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean z2, Function2<? super Composer, ? super Integer, Unit> function22, boolean z3, NavigationBarItemColors navigationBarItemColors, MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        ...
        if ((i2 & 2) != 0) {
            ...
            if ((i2 & 4) == 0) {
                ...
                if (i4 != 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        if (i6 != 0) {
                                ...
                                if ((i3 & 306783379) == 306783378 || !startRestartGroup.getSkipping()) {
                                    ...
                                    if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        if (i9 != 0) {
                                            ...
                                            ComposableLambda rememberComposableLambda2 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z9), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                                        ...
                                                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function25, composer3, ProvidedValue.$stable);
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                        composer3.endNode();
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                ...
                                                rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1644987592, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledLabel$1$1
                                                    ...
                                                    public final void invoke(Composer composer3, int i13) {
                                                        ...
                                                        if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                            ...
                                                            ProvideContentColorTextStyleKt.m3024ProvideContentColorTextStyle3JVO9M(invoke$lambda$0(SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2391textColorWaAFU9c$material3_release(z, z4), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12)), TypographyKt.getValue(NavigationBarTokens.INSTANCE.getLabelTextFont(), composer3, 6), obj2, composer3, 0);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
                                            ...
                                            Modifier weight$default = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier3, z, mutableInteractionSource5, null, z10, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                                            ...
                                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                                rememberedValue2 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$1$1
                                                    ...
                                                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                                        m2399invokeozmzZPI(intSize.m7439unboximpl());
                                                        return Unit.INSTANCE;
                                                    }

                                                    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                                                    public final void m2399invokeozmzZPI(long j) {
                                                        MutableIntState.this.setIntValue(IntSize.m7435getWidthimpl(j));
                                                    }
                                                };
                                            ...
                                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                            long Offset = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume).mo429toPx0680j_4(IndicatorVerticalOffset));
                                            ...
                                            ComposableLambda rememberComposableLambda4 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                        BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors4.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                                        if (ComposerKt.isTraceInProgress()) {
                                                            ComposerKt.traceEventEnd();
                                                            return;
                                                        }
                                        ...
                                        ComposableLambda rememberComposableLambda22 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                                            ...
                                            public final void invoke(Composer composer3, int i13) {
                                                ...
                                                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                    ...
                                                    State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z92), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                        ...
                                        Modifier weight$default2 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier32, z, mutableInteractionSource52, null, z102, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                                        rememberedValue2 = startRestartGroup.rememberedValue();
                                        if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                        }
                                        ...
                                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                        long Offset2 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState2) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume2).mo429toPx0680j_4(IndicatorVerticalOffset));
                                        ...
                                        ComposableLambda rememberComposableLambda42 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                                            ...
                                            public final void invoke(Composer composer3, int i13) {
                                                ...
                                                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                    ...
                                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                                                    BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors42.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                                    if (ComposerKt.isTraceInProgress()) {
                                                        ComposerKt.traceEventEnd();
                                                        return;
                                                    }
                                        ...
                                        if ((i2 & 128) != 0) {
                                            ...
                                            ComposableLambda rememberComposableLambda222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z922), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                            ...
                                            Modifier weight$default22 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier322, z, mutableInteractionSource522, null, z1022, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                                            rememberedValue2 = startRestartGroup.rememberedValue();
                                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                            }
                                            ...
                                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                            long Offset22 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState22) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume22).mo429toPx0680j_4(IndicatorVerticalOffset));
                                            ...
                                            ComposableLambda rememberComposableLambda422 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                        BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors422.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                                        if (ComposerKt.isTraceInProgress()) {
                                                            ComposerKt.traceEventEnd();
                                                            return;
                                                        }
                                            ...
                                            ComposableLambda rememberComposableLambda2222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z9222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                            ...
                                            Modifier weight$default222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier3222, z, mutableInteractionSource5222, null, z10222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                                            rememberedValue2 = startRestartGroup.rememberedValue();
                                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                            }
                                            ...
                                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                            long Offset222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume222).mo429toPx0680j_4(IndicatorVerticalOffset));
                                            ...
                                            ComposableLambda rememberComposableLambda4222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                                                ...
                                                public final void invoke(Composer composer3, int i13) {
                                                    ...
                                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                                        ...
                                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                                        BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors4222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                                        if (ComposerKt.isTraceInProgress()) {
                                                            ComposerKt.traceEventEnd();
                                                            return;
                                                        }
                            ...
                            ComposableLambda rememberComposableLambda22222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                                ...
                                public final void invoke(Composer composer3, int i13) {
                                    ...
                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z92222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                        ...
                                        Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                                        Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy2222, ComposeUiNode.Companion.getSetMeasurePolicy());
                                        ...
                                        ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function252, composer3, ProvidedValue.$stable);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        composer3.endNode();
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                            ...
                            Modifier weight$default2222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier32222, z, mutableInteractionSource52222, null, z102222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                            rememberedValue2 = startRestartGroup.rememberedValue();
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                            }
                            ...
                            m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
                            Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy2222, ComposeUiNode.Companion.getSetMeasurePolicy());
                            Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap2222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                            if (!m3867constructorimpl.getInserting()) {
                            }
                            m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                            m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash2222);
                            Updater.m3874setimpl(m3867constructorimpl, materializeModifier2222, ComposeUiNode.Companion.getSetModifier());
                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                            BoxScopeInstance boxScopeInstance2222 = BoxScopeInstance.INSTANCE;
                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
                            boolean z112222 = z5;
                            ...
                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                            long Offset2222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState2222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume2222).mo429toPx0680j_4(IndicatorVerticalOffset));
                            ...
                            ComposableLambda rememberComposableLambda42222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                                ...
                                public final void invoke(Composer composer3, int i13) {
                                    ...
                                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors42222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                        if (ComposerKt.isTraceInProgress()) {
                                            ComposerKt.traceEventEnd();
                                            return;
                                        }
                        ...
                        ComposableLambda rememberComposableLambda222222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                            ...
                            public final void invoke(Composer composer3, int i13) {
                                ...
                                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z922222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                    ...
                                    Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                                    Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy22222, ComposeUiNode.Companion.getSetMeasurePolicy());
                                    Updater.m3874setimpl(m3867constructorimpl2, currentCompositionLocalMap22222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                                    Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash22222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                                    if (m3867constructorimpl2.getInserting() || !Intrinsics.areEqual(m3867constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                        m3867constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                                        m3867constructorimpl2.apply(Integer.valueOf(currentCompositeKeyHash2), setCompositeKeyHash22222);
                                    }
                                    Updater.m3874setimpl(m3867constructorimpl2, materializeModifier22222, ComposeUiNode.Companion.getSetModifier());
                                    ComposerKt.sourceInformationMarkerStart(composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                                    BoxScopeInstance boxScopeInstance22222 = BoxScopeInstance.INSTANCE;
                                    ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                                    CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function2522, composer3, ProvidedValue.$stable);
                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                                    composer3.endNode();
                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                        ...
                        Modifier weight$default22222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier322222, z, mutableInteractionSource522222, null, z1022222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                        rememberedValue2 = startRestartGroup.rememberedValue();
                        if (rememberedValue2 == Composer.Companion.getEmpty()) {
                        }
                        ...
                        m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
                        Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy22222, ComposeUiNode.Companion.getSetMeasurePolicy());
                        Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap22222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash22222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                        if (!m3867constructorimpl.getInserting()) {
                        }
                        m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                        m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash22222);
                        Updater.m3874setimpl(m3867constructorimpl, materializeModifier22222, ComposeUiNode.Companion.getSetModifier());
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                        BoxScopeInstance boxScopeInstance22222 = BoxScopeInstance.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
                        boolean z1122222 = z5;
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        long Offset22222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState22222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume22222).mo429toPx0680j_4(IndicatorVerticalOffset));
                        ...
                        ComposableLambda rememberComposableLambda422222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                            ...
                            public final void invoke(Composer composer3, int i13) {
                                ...
                                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                                    BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors422222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                    ...
                    ComposableLambda rememberComposableLambda2222222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                        ...
                        public final void invoke(Composer composer3, int i13) {
                            ...
                            if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                ...
                                State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z9222222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                                ...
                                Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                                Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                                Updater.m3874setimpl(m3867constructorimpl2, currentCompositionLocalMap222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                                if (m3867constructorimpl2.getInserting() || !Intrinsics.areEqual(m3867constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                    m3867constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                                    m3867constructorimpl2.apply(Integer.valueOf(currentCompositeKeyHash2), setCompositeKeyHash222222);
                                }
                                Updater.m3874setimpl(m3867constructorimpl2, materializeModifier222222, ComposeUiNode.Companion.getSetModifier());
                                ComposerKt.sourceInformationMarkerStart(composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                                BoxScopeInstance boxScopeInstance222222 = BoxScopeInstance.INSTANCE;
                                ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function25222, composer3, ProvidedValue.$stable);
                                ComposerKt.sourceInformationMarkerEnd(composer3);
                                ComposerKt.sourceInformationMarkerEnd(composer3);
                                composer3.endNode();
                                ComposerKt.sourceInformationMarkerEnd(composer3);
                    ...
                    Modifier weight$default222222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier3222222, z, mutableInteractionSource5222222, null, z10222222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                    rememberedValue2 = startRestartGroup.rememberedValue();
                    if (rememberedValue2 == Composer.Companion.getEmpty()) {
                    }
                    ...
                    m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
                    Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                    Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                    Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                    if (!m3867constructorimpl.getInserting()) {
                    }
                    m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                    m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash222222);
                    Updater.m3874setimpl(m3867constructorimpl, materializeModifier222222, ComposeUiNode.Companion.getSetModifier());
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                    BoxScopeInstance boxScopeInstance222222 = BoxScopeInstance.INSTANCE;
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
                    ...
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    long Offset222222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState222222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume222222).mo429toPx0680j_4(IndicatorVerticalOffset));
                    ...
                    ComposableLambda rememberComposableLambda4222222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                        ...
                        public final void invoke(Composer composer3, int i13) {
                            ...
                            if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                                ...
                                ComposerKt.sourceInformationMarkerEnd(composer3);
                                BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors4222222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                    return;
                                }
                ...
                ComposableLambda rememberComposableLambda22222222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                    ...
                    public final void invoke(Composer composer3, int i13) {
                        ...
                        if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                            ...
                            State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z92222222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                            ...
                            Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                            Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy2222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                            Updater.m3874setimpl(m3867constructorimpl2, currentCompositionLocalMap2222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                            if (m3867constructorimpl2.getInserting() || !Intrinsics.areEqual(m3867constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                                m3867constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                                m3867constructorimpl2.apply(Integer.valueOf(currentCompositeKeyHash2), setCompositeKeyHash2222222);
                            }
                            Updater.m3874setimpl(m3867constructorimpl2, materializeModifier2222222, ComposeUiNode.Companion.getSetModifier());
                            ComposerKt.sourceInformationMarkerStart(composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                            BoxScopeInstance boxScopeInstance2222222 = BoxScopeInstance.INSTANCE;
                            ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function252222, composer3, ProvidedValue.$stable);
                            ComposerKt.sourceInformationMarkerEnd(composer3);
                            ComposerKt.sourceInformationMarkerEnd(composer3);
                            composer3.endNode();
                            ComposerKt.sourceInformationMarkerEnd(composer3);
                ...
                Modifier weight$default2222222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier32222222, z, mutableInteractionSource52222222, null, z102222222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
                rememberedValue2 = startRestartGroup.rememberedValue();
                if (rememberedValue2 == Composer.Companion.getEmpty()) {
                }
                ...
                m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
                Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy2222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap2222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                if (!m3867constructorimpl.getInserting()) {
                }
                m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash2222222);
                Updater.m3874setimpl(m3867constructorimpl, materializeModifier2222222, ComposeUiNode.Companion.getSetModifier());
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                BoxScopeInstance boxScopeInstance2222222 = BoxScopeInstance.INSTANCE;
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                long Offset2222222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState2222222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume2222222).mo429toPx0680j_4(IndicatorVerticalOffset));
                ...
                ComposableLambda rememberComposableLambda42222222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                    ...
                    public final void invoke(Composer composer3, int i13) {
                        ...
                        if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composer3);
                            BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors42222222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                                return;
                            }
            ...
            ComposableLambda rememberComposableLambda222222222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
                ...
                public final void invoke(Composer composer3, int i13) {
                    ...
                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z922222222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                        ...
                        Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                        Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy22222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                        Updater.m3874setimpl(m3867constructorimpl2, currentCompositionLocalMap22222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash22222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                        if (m3867constructorimpl2.getInserting() || !Intrinsics.areEqual(m3867constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                            m3867constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                            m3867constructorimpl2.apply(Integer.valueOf(currentCompositeKeyHash2), setCompositeKeyHash22222222);
                        }
                        Updater.m3874setimpl(m3867constructorimpl2, materializeModifier22222222, ComposeUiNode.Companion.getSetModifier());
                        ComposerKt.sourceInformationMarkerStart(composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                        BoxScopeInstance boxScopeInstance22222222 = BoxScopeInstance.INSTANCE;
                        ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                        CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function2522222, composer3, ProvidedValue.$stable);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        composer3.endNode();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
            ...
            Modifier weight$default22222222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier322222222, z, mutableInteractionSource522222222, null, z1022222222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
            rememberedValue2 = startRestartGroup.rememberedValue();
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
            }
            ...
            m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
            Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy22222222, ComposeUiNode.Companion.getSetMeasurePolicy());
            Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap22222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
            Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash22222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
            if (!m3867constructorimpl.getInserting()) {
            }
            m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash22222222);
            Updater.m3874setimpl(m3867constructorimpl, materializeModifier22222222, ComposeUiNode.Companion.getSetModifier());
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
            BoxScopeInstance boxScopeInstance22222222 = BoxScopeInstance.INSTANCE;
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            long Offset22222222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState22222222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume22222222).mo429toPx0680j_4(IndicatorVerticalOffset));
            ...
            ComposableLambda rememberComposableLambda422222222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
                ...
                public final void invoke(Composer composer3, int i13) {
                    ...
                    if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors422222222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        ComposableLambda rememberComposableLambda2222222222 = ComposableLambdaKt.rememberComposableLambda(-1419576100, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1
            ...
            public final void invoke(Composer composer3, int i13) {
                ...
                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                    ...
                    State<Color> m130animateColorAsStateeuL9pac = SingleValueAnimationKt.m130animateColorAsStateeuL9pac(NavigationBarItemColors.this.m2390iconColorWaAFU9c$material3_release(z, z9222222222), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer3, 48, 12);
                    ...
                    Composer m3867constructorimpl2 = Updater.m3867constructorimpl(composer3);
                    Updater.m3874setimpl(m3867constructorimpl2, maybeCachedBoxMeasurePolicy222222222, ComposeUiNode.Companion.getSetMeasurePolicy());
                    Updater.m3874setimpl(m3867constructorimpl2, currentCompositionLocalMap222222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                    Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash222222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                    if (m3867constructorimpl2.getInserting() || !Intrinsics.areEqual(m3867constructorimpl2.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                        m3867constructorimpl2.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                        m3867constructorimpl2.apply(Integer.valueOf(currentCompositeKeyHash2), setCompositeKeyHash222222222);
                    }
                    Updater.m3874setimpl(m3867constructorimpl2, materializeModifier222222222, ComposeUiNode.Companion.getSetModifier());
                    ComposerKt.sourceInformationMarkerStart(composer3, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                    BoxScopeInstance boxScopeInstance222222222 = BoxScopeInstance.INSTANCE;
                    ComposerKt.sourceInformationMarkerStart(composer3, -1543730008, "C193@9057L78:NavigationBar.kt#uh7d8r");
                    CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4539boximpl(invoke$lambda$0(m130animateColorAsStateeuL9pac))), function25222222, composer3, ProvidedValue.$stable);
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    composer3.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer3);
        ...
        Modifier weight$default222222222 = RowScope.weight$default(rowScope, SizeKt.m879defaultMinSizeVpY3zN4$default(SelectableKt.m1169selectableO2vRcR0(modifier3222222222, z, mutableInteractionSource5222222222, null, z10222222222, Role.m6467boximpl(Role.Companion.m6481getTabo7Vup1c()), function0), 0.0f, NavigationBarHeight, 1, null), 1.0f, false, 2, null);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -103177977, "CC(remember):NavigationBar.kt#9igjgp");
        rememberedValue2 = startRestartGroup.rememberedValue();
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
        }
        ...
        m3867constructorimpl = Updater.m3867constructorimpl(startRestartGroup);
        Updater.m3874setimpl(m3867constructorimpl, maybeCachedBoxMeasurePolicy222222222, ComposeUiNode.Companion.getSetMeasurePolicy());
        Updater.m3874setimpl(m3867constructorimpl, currentCompositionLocalMap222222222, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash222222222 = ComposeUiNode.Companion.getSetCompositeKeyHash();
        if (!m3867constructorimpl.getInserting()) {
        }
        m3867constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
        m3867constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash222222222);
        Updater.m3874setimpl(m3867constructorimpl, materializeModifier222222222, ComposeUiNode.Companion.getSetModifier());
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
        BoxScopeInstance boxScopeInstance222222222 = BoxScopeInstance.INSTANCE;
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1652172306, "C233@10442L157,*242@10883L7,248@11165L128,255@11508L293,263@11850L395,280@12505L27,274@12255L288:NavigationBar.kt#uh7d8r");
        ...
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        long Offset222222222 = OffsetKt.Offset((NavigationBarItem$lambda$3(mutableIntState222222222) - density.mo423roundToPx0680j_4(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM())) / 2, ((Density) consume222222222).mo429toPx0680j_4(IndicatorVerticalOffset));
        ...
        ComposableLambda rememberComposableLambda4222222222 = ComposableLambdaKt.rememberComposableLambda(-474426875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$2$indicator$1
            ...
            public final void invoke(Composer composer3, int i13) {
                ...
                if ((i13 & 3) != 2 || !composer3.getSkipping()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    BoxKt.Box(BackgroundKt.m266backgroundbw27NRU(GraphicsLayerModifierKt.graphicsLayer(layoutId, (Function1) rememberedValue6), navigationBarItemColors4222222222.m2384getIndicatorColor0d7_KjU$material3_release(), ShapesKt.getValue(NavigationBarTokens.INSTANCE.getActiveIndicatorShape(), composer3, 6)), composer3, 0);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                        return;
                    }
            ...
            if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemLayout$2$1
                    ...
                    public final MeasureResult mo52measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        Placeable placeable;
                        MeasureResult m2398placeLabelAndIconzUg2_y0;
                        MeasureResult m2397placeIconX9ElhV4;
                        ...
                        while (i5 < size) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                Placeable mo5967measureBRTryo0 = measurable2.mo5967measureBRTryo0(m7207copyZbe2FdA$default);
                                int width = mo5967measureBRTryo0.getWidth();
                                f = NavigationBarKt.IndicatorHorizontalPadding;
                                float f2 = 2;
                                int i6 = width + measureScope2.mo423roundToPx0680j_4(Dp.m7264constructorimpl(f * f2));
                                int roundToInt = MathKt.roundToInt(i6 * floatValue);
                                int height = mo5967measureBRTryo0.getHeight() + measureScope2.mo423roundToPx0680j_4(Dp.m7264constructorimpl(NavigationBarKt.getIndicatorVerticalPadding() * f2));
                                int size2 = list.size();
                                int i7 = 0;
                                while (i7 < size2) {
                                    Measurable measurable3 = list.get(i7);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                        Placeable mo5967measureBRTryo02 = measurable3.mo5967measureBRTryo0(Constraints.Companion.m7227fixedJhjzzOo(i6, height));
                                        int size3 = list.size();
                                        int i8 = 0;
                                        while (true) {
                                            if (i8 >= size3) {
                                        ...
                                        Placeable mo5967measureBRTryo03 = measurable4 != null ? measurable4.mo5967measureBRTryo0(Constraints.Companion.m7227fixedJhjzzOo(roundToInt, height)) : null;
                                        if (function25 != null) {
                                            int size4 = list.size();
                                            for (int i9 = 0; i9 < size4; i9++) {
                                                ...
                                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), Constants.ScionAnalytics.PARAM_LABEL)) {
                                                    placeable = measurable5.mo5967measureBRTryo0(m7207copyZbe2FdA$default);
                                                }
                                            }
                                        ...
                                        placeable = null;
                                        if (function25 == null) {
                                            m2397placeIconX9ElhV4 = NavigationBarKt.m2397placeIconX9ElhV4(measureScope2, mo5967measureBRTryo0, mo5967measureBRTryo02, mo5967measureBRTryo03, j);
                                            return m2397placeIconX9ElhV4;
                                        }
                                        Intrinsics.checkNotNull(placeable);
                                        m2398placeLabelAndIconzUg2_y0 = NavigationBarKt.m2398placeLabelAndIconzUg2_y0(measureScope, placeable, mo5967measureBRTryo0, mo5967measureBRTryo02, mo5967measureBRTryo03, j, z, floatValue);
                                        return m2398placeLabelAndIconzUg2_y0;
                                    }
                                    i7++;
    ...
    public static final MeasureResult m2397placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m7217getMaxWidthimpl = Constraints.m7217getMaxWidthimpl(j);
        final int m7233constrainHeightK40F9xA = ConstraintsKt.m7233constrainHeightK40F9xA(j, measureScope.mo423roundToPx0680j_4(NavigationBarHeight));
        final int width = (m7217getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (m7233constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (m7217getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (m7233constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m7217getMaxWidthimpl, m7233constrainHeightK40F9xA, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable4, (m7217getMaxWidthimpl - placeable4.getWidth()) / 2, (m7233constrainHeightK40F9xA - placeable4.getHeight()) / 2, 0.0f, 4, null);
    ...
    public static final MeasureResult m2398placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        float f2 = IndicatorVerticalPadding;
        float height = placeable2.getHeight() + measureScope.mo429toPx0680j_4(f2);
        float f3 = NavigationBarIndicatorToLabelPadding;
        float f4 = height + measureScope.mo429toPx0680j_4(f3) + placeable.getHeight();
        float f5 = 2;
        final float coerceAtLeast = RangesKt.coerceAtLeast((Constraints.m7218getMinHeightimpl(j) - f4) / f5, measureScope.mo429toPx0680j_4(f2));
        float f6 = f4 + (coerceAtLeast * f5);
        final float height2 = ((z ? coerceAtLeast : (f6 - placeable2.getHeight()) / f5) - coerceAtLeast) * (1 - f);
        final float height3 = placeable2.getHeight() + coerceAtLeast + measureScope.mo429toPx0680j_4(f2) + measureScope.mo429toPx0680j_4(f3);
        final int m7217getMaxWidthimpl = Constraints.m7217getMaxWidthimpl(j);
        final int width = (m7217getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (m7217getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (m7217getMaxWidthimpl - placeable3.getWidth()) / 2;
        final float f7 = coerceAtLeast - measureScope.mo429toPx0680j_4(f2);
        return MeasureScope.layout$default(measureScope, m7217getMaxWidthimpl, MathKt.roundToInt(f6), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (placeable5 != null) {
                    int i = m7217getMaxWidthimpl;
                    float f8 = coerceAtLeast;
                    MeasureScope measureScope2 = measureScope;
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable5, (i - placeable5.getWidth()) / 2, MathKt.roundToInt((f8 - measureScope2.mo423roundToPx0680j_4(NavigationBarKt.getIndicatorVerticalPadding())) + height2), 0.0f, 4, null);
                    placementScope2 = placementScope;
                } else {
                    placementScope2 = placementScope;
                }
    ...
    static {
        float f = 2;
        IndicatorHorizontalPadding = Dp.m7264constructorimpl(Dp.m7264constructorimpl(NavigationBarTokens.INSTANCE.m3440getActiveIndicatorWidthD9Ej5fM() - NavigationBarTokens.INSTANCE.m3443getIconSizeD9Ej5fM()) / f);
        IndicatorVerticalPadding = Dp.m7264constructorimpl(Dp.m7264constructorimpl(NavigationBarTokens.INSTANCE.m3439getActiveIndicatorHeightD9Ej5fM() - NavigationBarTokens.INSTANCE.m3443getIconSizeD9Ej5fM()) / f);
    }
