...
public final class SnackbarHostKt {
    ...
    public static final void SnackbarHost(final SnackbarHostState snackbarHostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            if (i5 != 0) {
                function3 = ComposableSingletons$SnackbarHostKt.INSTANCE.m2173getLambda$1548712596$material3();
            }
    ...
    private static final void FadeInFadeOutWithScale(final SnackbarData snackbarData, Modifier modifier, final Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if (i4 != 0) {
            ...
            if (startRestartGroup.shouldExecute((i3 & 147) == 146, i3 & 1)) {
                ...
                String m3611getString2EP1pXo = Strings_androidKt.m3611getString2EP1pXo(Strings.m3532constructorimpl(R.string.m3c_snackbar_pane_title), startRestartGroup, 0);
                ...
                if (!Intrinsics.areEqual(snackbarData, fadeInFadeOutState.getCurrent())) {
                    ...
                    while (i6 < size2) {
                        ...
                        items2.add(new FadeInFadeOutAnimationItem(snackbarData2, ComposableLambdaKt.rememberComposableLambda(-1952400805, true, new SnackbarHostKt$FadeInFadeOutWithScale$1$1(snackbarData2, snackbarData, fadeInFadeOutState, m3611getString2EP1pXo), startRestartGroup, 54)));
                        i6++;
                        m3611getString2EP1pXo = m3611getString2EP1pXo;
                    }
