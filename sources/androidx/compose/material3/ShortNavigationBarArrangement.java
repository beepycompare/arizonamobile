...
public final class ShortNavigationBarArrangement {
    ...
    private static final int EqualWeight = m2886constructorimpl(0);
    private static final int Centered = m2886constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ShortNavigationBarArrangement m2885boximpl(int i) {
        return new ShortNavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2886constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2887equalsimpl(int i, Object obj) {
        return (obj instanceof ShortNavigationBarArrangement) && i == ((ShortNavigationBarArrangement) obj).m2891unboximpl();
    }
    ...
    public static String m2890toStringimpl(int i) {
        return m2888equalsimpl0(i, EqualWeight) ? "EqualWeight" : m2888equalsimpl0(i, Centered) ? "Centered" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
