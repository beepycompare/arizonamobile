...
public final class ShortNavigationBarArrangement {
    ...
    private static final int EqualWeight = m2973constructorimpl(0);
    private static final int Centered = m2973constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ShortNavigationBarArrangement m2972boximpl(int i) {
        return new ShortNavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2973constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2974equalsimpl(int i, Object obj) {
        return (obj instanceof ShortNavigationBarArrangement) && i == ((ShortNavigationBarArrangement) obj).m2978unboximpl();
    }
    ...
    public static String m2977toStringimpl(int i) {
        return m2975equalsimpl0(i, EqualWeight) ? "EqualWeight" : m2975equalsimpl0(i, Centered) ? "Centered" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
