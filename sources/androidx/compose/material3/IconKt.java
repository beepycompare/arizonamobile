...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m894size3ABfNKs(Modifier.Companion, SmallIconButtonTokens.INSTANCE.m4265getIconSizeD9Ej5fM());
    ...
    public static final Unit Icon_ww6aTOc$lambda$0(ImageVector imageVector, String str, Modifier modifier, long j, int i, int i2, Composer composer, int i3) {
        m2462Iconww6aTOc(imageVector, str, modifier, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit Icon_ww6aTOc$lambda$2(ImageBitmap imageBitmap, String str, Modifier modifier, long j, int i, int i2, Composer composer, int i3) {
        m2460Iconww6aTOc(imageBitmap, str, modifier, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit Icon_ww6aTOc$lambda$6(Painter painter, String str, Modifier modifier, long j, int i, int i2, Composer composer, int i3) {
        m2461Iconww6aTOc(painter, str, modifier, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    */
    public static final void m2462Iconww6aTOc(final ImageVector imageVector, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        int i3;
        String str2;
        final Object obj;
        final long j2;
            ...
            if (!startRestartGroup.shouldExecute((i3 & 1171) == 1170, i3 & 1)) {
                ...
                if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i2 & 8) != 0) {
                        ...
                        i3 &= -7169;
                        modifier2 = companion;
                        m5289unboximpl = ((Color) consume).m5289unboximpl();
                        startRestartGroup.endDefaults();
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-126890956, i3, -1, "androidx.compose.material3.Icon (Icon.kt:69)");
                        }
                        m2461Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, startRestartGroup, i3 & 14), str2, modifier2, m5289unboximpl, startRestartGroup, VectorPainter.$stable | (i3 & 112) | (i3 & 896) | (i3 & 7168), 0);
                        if (ComposerKt.isTraceInProgress()) {
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj2, Object obj3) {
                        ...
                        Icon_ww6aTOc$lambda$0 = IconKt.Icon_ww6aTOc$lambda$0(ImageVector.this, str, obj, j2, i, i2, (Composer) obj2, ((Integer) obj3).intValue());
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m2460Iconww6aTOc(final ImageBitmap imageBitmap, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        int i3;
        String str2;
        Object obj;
        long j2;
            ...
            if (!startRestartGroup.shouldExecute((i3 & 1171) == 1170, i3 & 1)) {
                ...
                if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i2 & 8) != 0) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        m2461Iconww6aTOc((BitmapPainter) rememberedValue, str2, modifier3, m5289unboximpl, startRestartGroup, i4 & 8176, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                        modifier2 = modifier3;
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda3
                    ...
                    public final Object invoke(Object obj2, Object obj3) {
                        ...
                        Icon_ww6aTOc$lambda$2 = IconKt.Icon_ww6aTOc$lambda$2(ImageBitmap.this, str, modifier2, j3, i, i2, (Composer) obj2, ((Integer) obj3).intValue());
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m2461Iconww6aTOc(final Painter painter, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        int i3;
        Object obj;
        long j2;
        final Modifier modifier2;
        ...
        Modifier modifier3;
        long j5;
        ColorFilter m5320tintxETnrds$default;
            ...
            if (!startRestartGroup.shouldExecute((i3 & 1171) == 1170, i3 & 1)) {
                ...
                if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                    ...
                    if ((i2 & 8) != 0) {
                        ...
                        Object consume = startRestartGroup.consume(ContentColorKt.getLocalContentColor());
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        j4 = ((Color) consume).m5289unboximpl();
                        i3 &= -7169;
                    } else {
                        j4 = j2;
                    }
                ...
                if (z || rememberedValue == Composer.Companion.getEmpty()) {
                    if (Color.m5280equalsimpl0(j4, Color.Companion.m5315getUnspecified0d7_KjU())) {
                        j5 = j4;
                        m5320tintxETnrds$default = null;
                    } else {
                        j5 = j4;
                        m5320tintxETnrds$default = ColorFilter.Companion.m5320tintxETnrds$default(ColorFilter.Companion, j5, 0, 2, null);
                    }
                    startRestartGroup.updateRememberedValue(m5320tintxETnrds$default);
                } else {
                    j5 = j4;
                    m5320tintxETnrds$default = rememberedValue;
                }
                ColorFilter colorFilter = m5320tintxETnrds$default;
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                if (str != null) {
                    ...
                    if (z2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                        rememberedValue2 = new Function1() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda6
                            ...
                            public final Object invoke(Object obj2) {
                                ...
                                Icon_ww6aTOc$lambda$5$lambda$4 = IconKt.Icon_ww6aTOc$lambda$5$lambda$4(str, (SemanticsPropertyReceiver) obj2);
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda7
                    ...
                    public final Object invoke(Object obj2, Object obj3) {
                        ...
                        Icon_ww6aTOc$lambda$6 = IconKt.Icon_ww6aTOc$lambda$6(Painter.this, str, modifier2, j3, i, i2, (Composer) obj2, ((Integer) obj3).intValue());
    ...
    */
    public static final void Icon(final Painter painter, final ColorProducer colorProducer, final String str, Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if (i4 != 0) {
            ...
            if (startRestartGroup.shouldExecute((i3 & 1171) == 1170, i3 & 1)) {
                ...
                long m5315getUnspecified0d7_KjU = Color.Companion.m5315getUnspecified0d7_KjU();
                ...
                if (changedInstance || rememberedValue == Composer.Companion.getEmpty()) {
                    rememberedValue = new Function1() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda1
                        ...
                        public final Object invoke(Object obj3) {
                            ...
                            Icon$lambda$12$lambda$11 = IconKt.Icon$lambda$12$lambda$11(ColorProducer.this, (CacheDrawScope) obj3);
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                m2461Iconww6aTOc(painter, obj, DrawModifierKt.drawWithCache(companion, (Function1) rememberedValue), m5315getUnspecified0d7_KjU, startRestartGroup, (i3 & 14) | 3072 | ((i3 >> 3) & 112), 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj2 = companion;
            ...
            if (endRestartGroup == null) {
                endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda2
                    ...
                    public final Object invoke(Object obj3, Object obj4) {
                        Unit Icon$lambda$13;
                        Icon$lambda$13 = IconKt.Icon$lambda$13(Painter.this, colorProducer, str, obj2, i, i2, (Composer) obj3, ((Integer) obj4).intValue());
    ...
    public static final DrawResult Icon$lambda$12$lambda$11(ColorProducer colorProducer, CacheDrawScope cacheDrawScope) {
        ...
        CacheDrawScope.m4818recordTdoYBX4$default(cacheDrawScope, obtainGraphicsLayer, null, null, 0L, new Function1() { // from class: androidx.compose.material3.IconKt$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function1
        ...
        if (colorProducer != null) {
            obtainGraphicsLayer.setColorFilter(ColorFilter.Companion.m5320tintxETnrds$default(ColorFilter.Companion, colorProducer.mo2299invoke0d7_KjU(), 0, 2, null));
        }
    ...
    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        Modifier.Companion companion;
        if (Size.m5100equalsimpl0(painter.mo5978getIntrinsicSizeNHjbRc(), Size.Companion.m5112getUnspecifiedNHjbRc()) || m2463isInfiniteuvyYCjk(painter.mo5978getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m2463isInfiniteuvyYCjk(long j) {
