...
public final class DatePickerColors {
    ...
    public final long m2419getSelectedYearContainerColor0d7_KjU() {
    ...
    public final long m2407getDayInSelectionRangeContentColor0d7_KjU() {
        return this.dayInSelectionRangeContentColor;
    }

    /* renamed from: getDividerColor-0d7_KjU  reason: not valid java name */
    public final long m2414getDividerColor0d7_KjU() {
    ...
    public final DatePickerColors m2402copytNwlRmA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, TextFieldColors textFieldColors) {
    ...
    public final State<Color> dayContentColor$material3(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        ...
        if (z3) {
            ...
            m158animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m5338boximpl(j2), composer, 0);
            ...
            composer2 = composer;
            m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j2, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
    ...
    public final State<Color> dayContainerColor$material3(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        if (z) {
            m5383getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m5383getTransparent0d7_KjU = Color.Companion.m5383getTransparent0d7_KjU();
        }
        long j = m5383getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceGroup(-1319856736);
            ComposerKt.sourceInformation(composer, "987@47597L7,984@47415L204");
            composer2 = composer;
            rememberUpdatedState = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer2, 0, 12);
            composer2.endReplaceGroup();
        } else {
            composer2 = composer;
            composer2.startReplaceGroup(-1319630064);
            ComposerKt.sourceInformation(composer2, "990@47649L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m5338boximpl(j), composer2, 0);
            composer2.endReplaceGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        ...
        State<Color> m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(j, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final State<Color> yearContainerColor$material3(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            m5383getTransparent0d7_KjU = z2 ? this.selectedYearContainerColor : this.disabledSelectedYearContainerColor;
        } else {
            m5383getTransparent0d7_KjU = Color.Companion.m5383getTransparent0d7_KjU();
        }
        State<Color> m158animateColorAsStateeuL9pac = SingleValueAnimationKt.m158animateColorAsStateeuL9pac(m5383getTransparent0d7_KjU, MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, composer, 6), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DatePickerColors) {
            ...
            return Color.m5349equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m5349equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m5349equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m5349equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m5349equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m5349equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m5349equalsimpl0(this.disabledYearContentColor, datePickerColors.disabledYearContentColor) && Color.m5349equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m5349equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m5349equalsimpl0(this.disabledSelectedYearContentColor, datePickerColors.disabledSelectedYearContentColor) && Color.m5349equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m5349equalsimpl0(this.disabledSelectedYearContainerColor, datePickerColors.disabledSelectedYearContainerColor) && Color.m5349equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m5349equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m5349equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m5349equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m5349equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m5349equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m5349equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m5349equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m5349equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m5349equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m5355hashCodeimpl(this.containerColor) * 31) + Color.m5355hashCodeimpl(this.titleContentColor)) * 31) + Color.m5355hashCodeimpl(this.headlineContentColor)) * 31) + Color.m5355hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m5355hashCodeimpl(this.subheadContentColor)) * 31) + Color.m5355hashCodeimpl(this.yearContentColor)) * 31) + Color.m5355hashCodeimpl(this.disabledYearContentColor)) * 31) + Color.m5355hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m5355hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m5355hashCodeimpl(this.disabledSelectedYearContentColor)) * 31) + Color.m5355hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m5355hashCodeimpl(this.disabledSelectedYearContainerColor)) * 31) + Color.m5355hashCodeimpl(this.dayContentColor)) * 31) + Color.m5355hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m5355hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m5355hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m5355hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m5355hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m5355hashCodeimpl(this.todayContentColor)) * 31) + Color.m5355hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m5355hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m5355hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
