...
public final class ListItemMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo924measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        float m2665verticalPaddingyh95HIg;
        long j2;
        Placeable placeable;
        ...
        float m2665verticalPaddingyh95HIg2;
        int m2664calculateWidthyeHjK3Y;
        int m2663calculateHeightN4Jib3Y;
        MeasureResult place;
        ...
        int i = measureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(listItemStartPadding + listItemEndPadding));
        Measurable measurable = (Measurable) CollectionsKt.firstOrNull((List<? extends Object>) list6);
        int minIntrinsicWidth = measurable != null ? measurable.minIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j)) : 0;
        Measurable measurable2 = (Measurable) CollectionsKt.firstOrNull((List<? extends Object>) list7);
        int subtractConstraintSafely = LayoutUtilKt.subtractConstraintSafely(Constraints.m8113getMaxWidthimpl(m8103copyZbe2FdA$default), minIntrinsicWidth + (measurable2 != null ? measurable2.minIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j)) : 0) + i);
        ...
        m2665verticalPaddingyh95HIg = ListItemKt.m2665verticalPaddingyh95HIg(ListItemType.Companion.m2678invokeZLSjz4$material3(CollectionsKt.firstOrNull((List<? extends Object>) list4) != null, CollectionsKt.firstOrNull((List<? extends Object>) list5) != null, isSupportingMultilineHeuristic));
        long m8132offsetNN6EwU = ConstraintsKt.m8132offsetNN6EwU(m8103copyZbe2FdA$default, -i, -measureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(m2665verticalPaddingyh95HIg * 2.0f)));
        Measurable measurable4 = (Measurable) CollectionsKt.firstOrNull((List<? extends Object>) list6);
        Placeable mo6818measureBRTryo0 = measurable4 != null ? measurable4.mo6818measureBRTryo0(m8132offsetNN6EwU) : null;
        ...
        if (measurable5 != null) {
            j2 = m8132offsetNN6EwU;
            placeable = measurable5.mo6818measureBRTryo0(ConstraintsKt.m8133offsetNN6EwU$default(j2, -widthOrZero, 0, 2, null));
        } else {
            j2 = m8132offsetNN6EwU;
            placeable = null;
        }
        ...
        if (measurable6 != null) {
            list2 = list4;
            j3 = j2;
            placeable2 = measurable6.mo6818measureBRTryo0(ConstraintsKt.m8133offsetNN6EwU$default(j2, -widthOrZero2, 0, 2, null));
        } else {
            list2 = list4;
            j3 = j2;
            placeable2 = null;
        ...
        if (measurable7 != null) {
            ...
            placeable3 = measurable7.mo6818measureBRTryo0(ConstraintsKt.m8132offsetNN6EwU(j3, -widthOrZero2, -heightOrZero));
        } else {
            f = listItemStartPadding;
            placeable3 = null;
        }
        ...
        Placeable mo6818measureBRTryo02 = measurable8 != null ? measurable8.mo6818measureBRTryo0(ConstraintsKt.m8132offsetNN6EwU(j3, -widthOrZero2, -heightOrZero2)) : null;
        int m2678invokeZLSjz4$material3 = ListItemType.Companion.m2678invokeZLSjz4$material3(mo6818measureBRTryo02 != null, placeable3 != null, z);
        m2665verticalPaddingyh95HIg2 = ListItemKt.m2665verticalPaddingyh95HIg(m2678invokeZLSjz4$material3);
        float m8160constructorimpl = Dp.m8160constructorimpl(2.0f * m2665verticalPaddingyh95HIg2);
        MeasureScope measureScope2 = measureScope;
        m2664calculateWidthyeHjK3Y = ListItemKt.m2664calculateWidthyeHjK3Y(measureScope2, LayoutUtilKt.getWidthOrZero(mo6818measureBRTryo0), LayoutUtilKt.getWidthOrZero(placeable), LayoutUtilKt.getWidthOrZero(placeable2), LayoutUtilKt.getWidthOrZero(mo6818measureBRTryo02), LayoutUtilKt.getWidthOrZero(placeable3), i, j);
        m2663calculateHeightN4Jib3Y = ListItemKt.m2663calculateHeightN4Jib3Y(measureScope2, LayoutUtilKt.getHeightOrZero(mo6818measureBRTryo0), LayoutUtilKt.getHeightOrZero(placeable), LayoutUtilKt.getHeightOrZero(placeable2), LayoutUtilKt.getHeightOrZero(mo6818measureBRTryo02), LayoutUtilKt.getHeightOrZero(placeable3), m2678invokeZLSjz4$material3, measureScope.mo428roundToPx0680j_4(m8160constructorimpl), j);
        Placeable placeable4 = placeable2;
        place = ListItemKt.place(measureScope, m2664calculateWidthyeHjK3Y, m2663calculateHeightN4Jib3Y, mo6818measureBRTryo0, placeable, placeable4, mo6818measureBRTryo02, placeable3, ListItemType.m2670equalsimpl0(m2678invokeZLSjz4$material3, ListItemType.Companion.m2676getThreeLineAlXitO8()), measureScope.mo428roundToPx0680j_4(f), measureScope.mo428roundToPx0680j_4(listItemEndPadding), measureScope.mo428roundToPx0680j_4(m2665verticalPaddingyh95HIg2));
        return place;
    }
    ...
    private final int calculateIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        m2664calculateWidthyeHjK3Y = ListItemKt.m2664calculateWidthyeHjK3Y(intrinsicMeasureScope, intValue, intValue2, intValue3, intValue4, intrinsicMeasurable5 != null ? function2.invoke(intrinsicMeasurable5, Integer.valueOf(i)).intValue() : 0, intrinsicMeasureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(ListItemKt.getListItemStartPadding() + ListItemKt.getListItemEndPadding())), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
        return m2664calculateWidthyeHjK3Y;
    }
    ...
    private final int calculateIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        List<? extends IntrinsicMeasurable> list4 = list.get(2);
        List<? extends IntrinsicMeasurable> list5 = list.get(4);
        int subtractConstraintSafely = LayoutUtilKt.subtractConstraintSafely(i, intrinsicMeasureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(ListItemKt.getListItemStartPadding() + ListItemKt.getListItemEndPadding())));
        IntrinsicMeasurable intrinsicMeasurable = (IntrinsicMeasurable) CollectionsKt.firstOrNull((List<? extends Object>) list.get(3));
        ...
        int m2678invokeZLSjz4$material3 = ListItemType.Companion.m2678invokeZLSjz4$material3(intValue > 0, intValue3 > 0, isSupportingMultilineHeuristic);
        m2665verticalPaddingyh95HIg = ListItemKt.m2665verticalPaddingyh95HIg(m2678invokeZLSjz4$material3);
        int i4 = intValue2;
        int i5 = intValue;
        m2663calculateHeightN4Jib3Y = ListItemKt.m2663calculateHeightN4Jib3Y(intrinsicMeasureScope, i2, i3, i4, i5, intValue3, m2678invokeZLSjz4$material3, intrinsicMeasureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(m2665verticalPaddingyh95HIg * 2.0f)), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
        return m2663calculateHeightN4Jib3Y;
    }
}
