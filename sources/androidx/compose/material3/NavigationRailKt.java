...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailVerticalPadding = Dp.m8160constructorimpl(4.0f);
    private static final float NavigationRailHeaderPadding = Dp.m8160constructorimpl(8.0f);
    ...
    private static final float NavigationRailItemVerticalPadding = Dp.m8160constructorimpl(4.0f);
    private static final float IndicatorHorizontalPadding = Dp.m8160constructorimpl(Dp.m8160constructorimpl(NavigationRailVerticalItemTokens.INSTANCE.m4020getActiveIndicatorWidthD9Ej5fM() - NavigationRailBaselineItemTokens.INSTANCE.m4003getIconSizeD9Ej5fM()) / 2.0f);
    private static final float IndicatorVerticalPaddingWithLabel = Dp.m8160constructorimpl(Dp.m8160constructorimpl(NavigationRailVerticalItemTokens.INSTANCE.m4019getActiveIndicatorHeightD9Ej5fM() - NavigationRailBaselineItemTokens.INSTANCE.m4003getIconSizeD9Ej5fM()) / 2.0f);
    private static final float IndicatorVerticalPaddingNoLabel = Dp.m8160constructorimpl(Dp.m8160constructorimpl(NavigationRailVerticalItemTokens.INSTANCE.m4020getActiveIndicatorWidthD9Ej5fM() - NavigationRailBaselineItemTokens.INSTANCE.m4003getIconSizeD9Ej5fM()) / 2.0f);
    ...
    */
                                ...
                                if (!startRestartGroup.shouldExecute((i3 & 38347923) == 38347922, i3 & 1)) {
                                    ...
                                    if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                                        ...
                                        if (i8 != 0) {
                                            ...
                                            if (function26 != null) {
                                                ...
                                                rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(-2056532825, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItem$styledLabel$1$1
                                                    ...
                                                    public final void invoke(Composer composer3, int i12) {
                                                        ...
                                                        ProvideContentColorTextStyleKt.m3452ProvideContentColorTextStyle3JVO9M(invoke$lambda$0(SingleValueAnimationKt.m158animateColorAsStateeuL9pac(NavigationRailItemColors.this.m2780textColorWaAFU9c$material3(z, z11), value2, null, null, composer3, 0, 12)), TypographyKt.getValue(NavigationRailVerticalItemTokens.INSTANCE.getLabelTextFont(), composer3, 6), function28, composer3, 0);
                                                        if (ComposerKt.isTraceInProgress()) {
                                                            ComposerKt.traceEventEnd();
                                                        }
                                                    }
                                            ...
                                            Modifier m1102defaultMinSizeVpY3zN4$default = SizeKt.m1102defaultMinSizeVpY3zN4$default(SelectableKt.m1342selectableO2vRcR0(modifier2, z, mutableInteractionSource5, null, z12, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), obj), 0.0f, NavigationRailItemHeight, r7, null);
                                            float f = NavigationRailItemWidth;
                                            Modifier m1124widthInVpY3zN4$default = SizeKt.m1124widthInVpY3zN4$default(m1102defaultMinSizeVpY3zN4$default, f, 0.0f, 2, null);
                                            ...
                                            Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, m1124widthInVpY3zN4$default);
                                            ...
                                            long m5095constructorimpl = Offset.m5095constructorimpl((Float.floatToRawIntBits((density.mo428roundToPx0680j_4(f) - density.mo428roundToPx0680j_4(NavigationRailVerticalItemTokens.INSTANCE.m4020getActiveIndicatorWidthD9Ej5fM())) / 2.0f) << c) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
                                            Unit unit = Unit.INSTANCE;
                                            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -474539147, "CC(remember):NavigationRail.kt#9igjgp");
                                            changed = startRestartGroup.changed(mutableInteractionSource5) | startRestartGroup.changed(m5095constructorimpl);
                                            rememberedValue = startRestartGroup.rememberedValue();
                                            if (!changed || rememberedValue == Composer.Companion.getEmpty()) {
                                                rememberedValue = new MappedInteractionSource(mutableInteractionSource5, m5095constructorimpl, null);
                                            ...
                                            ComposableLambda rememberComposableLambda3 = ComposableLambdaKt.rememberComposableLambda(455696046, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItem$1$indicatorRipple$1
                                                ...
                                                public final void invoke(Composer composer3, int i12) {
                                                    ...
                                                    BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.Companion, "indicatorRipple"), Shape.this), mappedInteractionSource, RippleKt.m2847rippleH2RKhps$default(false, 0.0f, 0L, 7, null)), composer3, 0);
                                                    if (ComposerKt.isTraceInProgress()) {
                                                        ComposerKt.traceEventEnd();
                                                    }
                                                }
                                    ...
                                    Modifier m1102defaultMinSizeVpY3zN4$default2 = SizeKt.m1102defaultMinSizeVpY3zN4$default(SelectableKt.m1342selectableO2vRcR0(modifier22, z, mutableInteractionSource52, null, z122, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), obj), 0.0f, NavigationRailItemHeight, r7, null);
                                    float f2 = NavigationRailItemWidth;
                                    Modifier m1124widthInVpY3zN4$default2 = SizeKt.m1124widthInVpY3zN4$default(m1102defaultMinSizeVpY3zN4$default2, f2, 0.0f, 2, null);
                                    ...
                                    Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(startRestartGroup, m1124widthInVpY3zN4$default2);
                                    ...
                                    m4467constructorimpl = Updater.m4467constructorimpl(startRestartGroup);
                                    Updater.m4475setimpl(m4467constructorimpl, maybeCachedBoxMeasurePolicy2, ComposeUiNode.Companion.getSetMeasurePolicy());
                                    Updater.m4475setimpl(m4467constructorimpl, currentCompositionLocalMap2, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                                    Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash2 = ComposeUiNode.Companion.getSetCompositeKeyHash();
                                    if (!m4467constructorimpl.getInserting()) {
                                    }
                                    m4467constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                                    m4467constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash2);
                                    Updater.m4475setimpl(m4467constructorimpl, materializeModifier2, ComposeUiNode.Companion.getSetModifier());
                                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -2146730711, "C72@3468L9:Box.kt#2w3rfo");
                                    ...
                                    long m5095constructorimpl2 = Offset.m5095constructorimpl((Float.floatToRawIntBits((density2.mo428roundToPx0680j_4(f2) - density2.mo428roundToPx0680j_4(NavigationRailVerticalItemTokens.INSTANCE.m4020getActiveIndicatorWidthD9Ej5fM())) / 2.0f) << c) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
                                    Unit unit2 = Unit.INSTANCE;
                                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -474539147, "CC(remember):NavigationRail.kt#9igjgp");
                                    changed = startRestartGroup.changed(mutableInteractionSource52) | startRestartGroup.changed(m5095constructorimpl2);
                                    rememberedValue = startRestartGroup.rememberedValue();
                                    if (!changed) {
                                    }
                                    rememberedValue = new MappedInteractionSource(mutableInteractionSource52, m5095constructorimpl2, null);
                                    startRestartGroup.updateRememberedValue(rememberedValue);
                                    ...
                                    ComposableLambda rememberComposableLambda32 = ComposableLambdaKt.rememberComposableLambda(455696046, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItem$1$indicatorRipple$1
                                        ...
                                        public final void invoke(Composer composer3, int i12) {
                                            ...
                                            BoxKt.Box(IndicationKt.indication(ClipKt.clip(LayoutIdKt.layoutId(Modifier.Companion, "indicatorRipple"), Shape.this), mappedInteractionSource2, RippleKt.m2847rippleH2RKhps$default(false, 0.0f, 0L, 7, null)), composer3, 0);
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
            ...
            if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemLayout$1$1
                    ...
                    public final MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        Placeable placeable;
                        MeasureResult m2787placeLabelAndIconzUg2_y0;
                        MeasureResult m2786placeIconX9ElhV4;
                        ...
                        while (i4 < size) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "icon")) {
                                Placeable mo6818measureBRTryo0 = measurable2.mo6818measureBRTryo0(m8103copyZbe2FdA$default);
                                int width = mo6818measureBRTryo0.getWidth();
                                f = NavigationRailKt.IndicatorHorizontalPadding;
                                int i5 = width + measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl(f * 2.0f));
                                int roundToInt = MathKt.roundToInt(i5 * coerceAtLeast);
                                int height = mo6818measureBRTryo0.getHeight() + measureScope2.mo428roundToPx0680j_4(Dp.m8160constructorimpl((function24 == null ? NavigationRailKt.IndicatorVerticalPaddingNoLabel : NavigationRailKt.IndicatorVerticalPaddingWithLabel) * 2.0f));
                                int size2 = list2.size();
                                for (int i6 = 0; i6 < size2; i6++) {
                                    Measurable measurable3 = list.get(i6);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicatorRipple")) {
                                        Placeable mo6818measureBRTryo02 = measurable3.mo6818measureBRTryo0(Constraints.Companion.m8123fixedJhjzzOo(i5, height));
                                        ...
                                        Placeable mo6818measureBRTryo03 = measurable4 != null ? measurable4.mo6818measureBRTryo0(Constraints.Companion.m8123fixedJhjzzOo(roundToInt, height)) : null;
                                        if (function24 != null) {
                                            ...
                                            for (int i8 = 0; i8 < size4; i8++) {
                                                ...
                                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), Constants.ScionAnalytics.PARAM_LABEL)) {
                                                    placeable = measurable5.mo6818measureBRTryo0(m8103copyZbe2FdA$default);
                                                }
                                            }
                                        ...
                                        placeable = null;
                                        if (function24 == null) {
                                            m2786placeIconX9ElhV4 = NavigationRailKt.m2786placeIconX9ElhV4(measureScope, mo6818measureBRTryo0, mo6818measureBRTryo02, mo6818measureBRTryo03, j);
                                            return m2786placeIconX9ElhV4;
                                        }
                                        Intrinsics.checkNotNull(placeable);
                                        m2787placeLabelAndIconzUg2_y0 = NavigationRailKt.m2787placeLabelAndIconzUg2_y0(measureScope, placeable, mo6818measureBRTryo0, mo6818measureBRTryo02, mo6818measureBRTryo03, j, z, coerceAtLeast);
                                        return m2787placeLabelAndIconzUg2_y0;
                                    }
                                }
                                ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
                                throw new KotlinNothingValueException();
    ...
    public static final MeasureResult m2786placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m8130constrainWidthK40F9xA = ConstraintsKt.m8130constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), Math.max(placeable2.getWidth(), placeable3 != null ? placeable3.getWidth() : 0)));
        final int m8129constrainHeightK40F9xA = ConstraintsKt.m8129constrainHeightK40F9xA(j, measureScope.mo428roundToPx0680j_4(NavigationRailItemHeight));
        final int width = (m8130constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = (m8129constrainHeightK40F9xA - placeable.getHeight()) / 2;
        final int width2 = (m8130constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height2 = (m8129constrainHeightK40F9xA - placeable2.getHeight()) / 2;
        return MeasureScope.layout$default(measureScope, m8130constrainWidthK40F9xA, m8129constrainHeightK40F9xA, null, new Function1() { // from class: androidx.compose.material3.NavigationRailKt$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return NavigationRailKt.placeIcon_X9ElhV4$lambda$20(Placeable.this, placeable, width, height, placeable2, width2, height2, m8130constrainWidthK40F9xA, m8129constrainHeightK40F9xA, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final MeasureResult m2787placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        float f2 = IndicatorVerticalPaddingWithLabel;
        float height = placeable2.getHeight() + measureScope.mo434toPx0680j_4(f2);
        float f3 = NavigationRailItemVerticalPadding;
        float f4 = height + measureScope.mo434toPx0680j_4(f3) + placeable.getHeight();
        final float coerceAtLeast = RangesKt.coerceAtLeast((Constraints.m8114getMinHeightimpl(j) - f4) / 2.0f, measureScope.mo434toPx0680j_4(f2));
        float f5 = f4 + (coerceAtLeast * 2.0f);
        final float height2 = ((z ? coerceAtLeast : (f5 - placeable2.getHeight()) / 2.0f) - coerceAtLeast) * (1.0f - f);
        final float height3 = placeable2.getHeight() + coerceAtLeast + measureScope.mo434toPx0680j_4(f2) + measureScope.mo434toPx0680j_4(f3);
        final int m8130constrainWidthK40F9xA = ConstraintsKt.m8130constrainWidthK40F9xA(j, Math.max(placeable2.getWidth(), Math.max(placeable.getWidth(), placeable4 != null ? placeable4.getWidth() : 0)));
        final int width = (m8130constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int width2 = (m8130constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width3 = (m8130constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final float f6 = coerceAtLeast - measureScope.mo434toPx0680j_4(f2);
        return MeasureScope.layout$default(measureScope, m8130constrainWidthK40F9xA, MathKt.roundToInt(f5), null, new Function1() { // from class: androidx.compose.material3.NavigationRailKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return NavigationRailKt.placeLabelAndIcon_zUg2_y0$lambda$22(Placeable.this, z, f, placeable, width, height3, height2, placeable2, width2, coerceAtLeast, placeable3, width3, f6, m8130constrainWidthK40F9xA, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit placeLabelAndIcon_zUg2_y0$lambda$22(Placeable placeable, boolean z, float f, Placeable placeable2, int i, float f2, float f3, Placeable placeable3, int i2, float f4, Placeable placeable4, int i3, float f5, int i4, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        if (placeable != null) {
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable, (i4 - placeable.getWidth()) / 2, MathKt.roundToInt((f4 - measureScope.mo434toPx0680j_4(IndicatorVerticalPaddingWithLabel)) + f3), 0.0f, 4, null);
        }
        if (z || f != 0.0f) {
