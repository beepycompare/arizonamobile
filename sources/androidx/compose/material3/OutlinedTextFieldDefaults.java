...
public final class OutlinedTextFieldDefaults {
    ...
    private static final float MinHeight = Dp.m7555constructorimpl(56);
    private static final float MinWidth = Dp.m7555constructorimpl((float) RouletteView.DEFAULT_ROULETTE_WIDTH);
    private static final float UnfocusedBorderThickness = Dp.m7555constructorimpl(1);
    private static final float FocusedBorderThickness = Dp.m7555constructorimpl(2);
