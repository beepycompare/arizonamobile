...
final class TabIndicatorOffsetNode$measure$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Animatable.animateTo$default(this.$offsetAnim, Dp.m8256boximpl(this.$indicatorOffset), this.this$0.getAnimationSpec(), null, null, this, 12, null) == coroutine_suspended) {
