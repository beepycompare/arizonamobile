...
public final class PullToRefreshModifierNode extends DelegatingNode implements NestedScrollConnection {
    ...
    public final float m3639getThresholdD9Ej5fM() {
        return this.threshold;
    }

    /* renamed from: setThreshold-0680j_4  reason: not valid java name */
    public final void m3640setThreshold0680j_4(float f) {
        this.threshold = f;
    }
    ...
    public final int getThresholdPx() {
        return DelegatableNodeKt.requireDensity(this).mo423roundToPx0680j_4(this.threshold);
    }
    ...
    public long mo928onPreScrollOzD1aCk(long j, int i) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m6450equalsimpl0(i, NestedScrollSource.Companion.m6462getUserInputWNlRxjI()) && Float.intBitsToFloat((int) (4294967295L & j)) < 0.0f) {
                return m3638consumeAvailableOffsetMKHz9U(j);
            }
    ...
    public long mo577onPostScrollDzOQY0M(long j, long j2, int i) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m6450equalsimpl0(i, NestedScrollSource.Companion.m6462getUserInputWNlRxjI())) {
                long m3638consumeAvailableOffsetMKHz9U = m3638consumeAvailableOffsetMKHz9U(j2);
                ...
                return m3638consumeAvailableOffsetMKHz9U;
            }
            return Offset.Companion.m5051getZeroF1C5BW0();
        }
        return Offset.Companion.m5051getZeroF1C5BW0();
    ...
    */
    public Object mo927onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        if (continuation instanceof PullToRefreshModifierNode$onPreFling$1) {
            ...
            if ((pullToRefreshModifierNode$onPreFling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    float m8234getYimpl = Velocity.m8234getYimpl(j);
                    pullToRefreshModifierNode$onPreFling$1.F$0 = 0.0f;
                    pullToRefreshModifierNode$onPreFling$1.label = 1;
                    obj = onRelease(m8234getYimpl, pullToRefreshModifierNode$onPreFling$1);
                ...
                return Velocity.m8224boximpl(VelocityKt.Velocity(f, ((Number) obj).floatValue()));
            }
        }
        ...
        return Velocity.m8224boximpl(VelocityKt.Velocity(f, ((Number) obj2).floatValue()));
    }
    ...
    private final long m3638consumeAvailableOffsetMKHz9U(long j) {
        ...
        return Offset.m5027constructorimpl((Float.floatToRawIntBits(distancePulled) & 4294967295L) | (Float.floatToRawIntBits(0.0f) << 32));
    }
