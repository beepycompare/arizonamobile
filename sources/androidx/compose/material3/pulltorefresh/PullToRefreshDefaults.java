...
public final class PullToRefreshDefaults {
    ...
    private static final float PositionalThreshold = Dp.m7264constructorimpl(80);
    private static final float Elevation = ElevationTokens.INSTANCE.m3296getLevel2D9Ej5fM();
    ...
    public final long getContainerColor(Composer composer, int i) {
        ...
        long m2039getSurfaceContainerHigh0d7_KjU = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2039getSurfaceContainerHigh0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2039getSurfaceContainerHigh0d7_KjU;
    }
    ...
    public final long getIndicatorColor(Composer composer, int i) {
        ...
        long m2026getOnSurfaceVariant0d7_KjU = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2026getOnSurfaceVariant0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2026getOnSurfaceVariant0d7_KjU;
    }

    /* renamed from: getPositionalThreshold-D9Ej5fM  reason: not valid java name */
    public final float m3107getPositionalThresholdD9Ej5fM() {
        return PositionalThreshold;
    }

    /* renamed from: getElevation-D9Ej5fM  reason: not valid java name */
    public final float m3106getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    */
    public final void m3105Indicator2poqoh4(final PullToRefreshState pullToRefreshState, final boolean z, Modifier modifier, long j, long j2, float f, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        Object obj;
        long j3;
        ...
        if ((i2 & 2) != 0) {
            ...
            if (i4 == 0) {
                    ...
                    if ((599187 & i3) == 599186 || !startRestartGroup.getSkipping()) {
                        ...
                        if ((i & 1) != 0 || startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i2 & 32) != 0) {
                                ...
                                int i9 = i5;
                                Modifier m3121pullToRefreshIndicatorwUdLESc$default = PullToRefreshKt.m3121pullToRefreshIndicatorwUdLESc$default(modifier3, pullToRefreshState, z, f3, null, j5, 0.0f, 40, null);
                                float f5 = f3;
                                long j10 = j5;
                                ...
                                Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, m3121pullToRefreshIndicatorwUdLESc$default);
                                    ...
                                    public final void invoke(boolean z2, Composer composer3, int i10) {
                                        ...
                                        if ((i10 & 19) != 18 || !composer3.getSkipping()) {
                                            ...
                                            if (z2) {
                                                ...
                                                ProgressIndicatorKt.m2488CircularProgressIndicatorLxG7B9w(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), j9, f6, 0L, 0, composer3, 390, 24);
                                                ...
                                                PullToRefreshKt.m3112CircularArrowProgressIndicatorRPmYEkk((Function0) rememberedValue, j9, composer3, 0);
                                                composer3.endReplaceGroup();
                                            }
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                        ...
                        int i92 = i5;
                        Modifier m3121pullToRefreshIndicatorwUdLESc$default2 = PullToRefreshKt.m3121pullToRefreshIndicatorwUdLESc$default(modifier32, pullToRefreshState, z, f3, null, j5, 0.0f, 40, null);
                        float f52 = f3;
                        long j102 = j5;
                        ...
                        Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(startRestartGroup, m3121pullToRefreshIndicatorwUdLESc$default2);
                            ...
                            public final void invoke(boolean z2, Composer composer3, int i10) {
                                ...
                                if ((i10 & 19) != 18 || !composer3.getSkipping()) {
                                    ...
                                    if (z2) {
                                        ...
                                        ComposerKt.sourceInformation(composer3, "456@17267L201");
                                        f6 = PullToRefreshKt.StrokeWidth;
                                        ProgressIndicatorKt.m2488CircularProgressIndicatorLxG7B9w(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), j92, f6, 0L, 0, composer3, 390, 24);
                                        composer3.endReplaceGroup();
                                    } else {
                                        composer3.startReplaceGroup(577079337);
                                        ComposerKt.sourceInformation(composer3, "463@17581L26,462@17514L155");
                                        ...
                                        ComposerKt.sourceInformationMarkerEnd(composer3);
                                        PullToRefreshKt.m3112CircularArrowProgressIndicatorRPmYEkk((Function0) rememberedValue, j92, composer3, 0);
                                        composer3.endReplaceGroup();
                                    }
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshDefaults$Indicator$2
                            ...
                            public final void invoke(Composer composer3, int i10) {
                                PullToRefreshDefaults.this.m3105Indicator2poqoh4(pullToRefreshState, z, modifier2, j8, j7, f4, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
                            }
                        });
                        return;
                    }
                ...
                int i922 = i5;
                Modifier m3121pullToRefreshIndicatorwUdLESc$default22 = PullToRefreshKt.m3121pullToRefreshIndicatorwUdLESc$default(modifier322, pullToRefreshState, z, f3, null, j5, 0.0f, 40, null);
                float f522 = f3;
                long j1022 = j5;
                ...
                Modifier materializeModifier22 = ComposedModifierKt.materializeModifier(startRestartGroup, m3121pullToRefreshIndicatorwUdLESc$default22);
                    ...
                    public final void invoke(boolean z2, Composer composer3, int i10) {
                        ...
                        if ((i10 & 19) != 18 || !composer3.getSkipping()) {
                            ...
                            if (z2) {
                                ...
                                ComposerKt.sourceInformation(composer3, "456@17267L201");
                                f6 = PullToRefreshKt.StrokeWidth;
                                ProgressIndicatorKt.m2488CircularProgressIndicatorLxG7B9w(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), j922, f6, 0L, 0, composer3, 390, 24);
                                composer3.endReplaceGroup();
                            } else {
                                composer3.startReplaceGroup(577079337);
                                ComposerKt.sourceInformation(composer3, "463@17581L26,462@17514L155");
                                ...
                                ComposerKt.sourceInformationMarkerEnd(composer3);
                                PullToRefreshKt.m3112CircularArrowProgressIndicatorRPmYEkk((Function0) rememberedValue, j922, composer3, 0);
                                composer3.endReplaceGroup();
                            }
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
            ...
            int i9222 = i5;
            Modifier m3121pullToRefreshIndicatorwUdLESc$default222 = PullToRefreshKt.m3121pullToRefreshIndicatorwUdLESc$default(modifier3222, pullToRefreshState, z, f3, null, j5, 0.0f, 40, null);
            float f5222 = f3;
            long j10222 = j5;
            ...
            Modifier materializeModifier222 = ComposedModifierKt.materializeModifier(startRestartGroup, m3121pullToRefreshIndicatorwUdLESc$default222);
                ...
                public final void invoke(boolean z2, Composer composer3, int i10) {
                    ...
                    if ((i10 & 19) != 18 || !composer3.getSkipping()) {
                        ...
                        if (z2) {
                            ...
                            ComposerKt.sourceInformation(composer3, "456@17267L201");
                            f6 = PullToRefreshKt.StrokeWidth;
                            ProgressIndicatorKt.m2488CircularProgressIndicatorLxG7B9w(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), j9222, f6, 0L, 0, composer3, 390, 24);
                            composer3.endReplaceGroup();
                        } else {
                            composer3.startReplaceGroup(577079337);
                            ComposerKt.sourceInformation(composer3, "463@17581L26,462@17514L155");
                            ...
                            ComposerKt.sourceInformationMarkerEnd(composer3);
                            PullToRefreshKt.m3112CircularArrowProgressIndicatorRPmYEkk((Function0) rememberedValue, j9222, composer3, 0);
                            composer3.endReplaceGroup();
                        }
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
        ...
        int i92222 = i5;
        Modifier m3121pullToRefreshIndicatorwUdLESc$default2222 = PullToRefreshKt.m3121pullToRefreshIndicatorwUdLESc$default(modifier32222, pullToRefreshState, z, f3, null, j5, 0.0f, 40, null);
        float f52222 = f3;
        long j102222 = j5;
        ...
        Modifier materializeModifier2222 = ComposedModifierKt.materializeModifier(startRestartGroup, m3121pullToRefreshIndicatorwUdLESc$default2222);
            ...
            public final void invoke(boolean z2, Composer composer3, int i10) {
                ...
                if ((i10 & 19) != 18 || !composer3.getSkipping()) {
                    ...
                    if (z2) {
                        ...
                        ComposerKt.sourceInformation(composer3, "456@17267L201");
                        f6 = PullToRefreshKt.StrokeWidth;
                        ProgressIndicatorKt.m2488CircularProgressIndicatorLxG7B9w(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), j92222, f6, 0L, 0, composer3, 390, 24);
                        composer3.endReplaceGroup();
                    } else {
                        composer3.startReplaceGroup(577079337);
                        ComposerKt.sourceInformation(composer3, "463@17581L26,462@17514L155");
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        PullToRefreshKt.m3112CircularArrowProgressIndicatorRPmYEkk((Function0) rememberedValue, j92222, composer3, 0);
                        composer3.endReplaceGroup();
                    }
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
