...
public final class PullToRefreshDefaults {
    ...
    public static final Unit IndicatorBox_1CPYgEU$lambda$7(PullToRefreshDefaults pullToRefreshDefaults, PullToRefreshState pullToRefreshState, boolean z, Modifier modifier, float f, Shape shape2, long j, float f2, Function3 function3, int i, int i2, Composer composer, int i3) {
        pullToRefreshDefaults.m3624IndicatorBox1CPYgEU(pullToRefreshState, z, modifier, f, shape2, j, f2, function3, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    public static final Unit Indicator_2poqoh4$lambda$8(PullToRefreshDefaults pullToRefreshDefaults, PullToRefreshState pullToRefreshState, boolean z, Modifier modifier, long j, long j2, float f, int i, int i2, Composer composer, int i3) {
        pullToRefreshDefaults.m3623Indicator2poqoh4(pullToRefreshState, z, modifier, j, j2, f, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
        return Unit.INSTANCE;
    }
    ...
    static {
        float m7995constructorimpl = Dp.m7995constructorimpl(80);
        PositionalThreshold = m7995constructorimpl;
        IndicatorMaxDistance = m7995constructorimpl;
        Elevation = ElevationTokens.INSTANCE.m3890getLevel2D9Ej5fM();
        LoadingIndicatorElevation = ElevationTokens.INSTANCE.m3888getLevel0D9Ej5fM();
    }
    ...
    public final long getContainerColor(Composer composer, int i) {
        ...
        long m2114getSurfaceContainerHigh0d7_KjU = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2114getSurfaceContainerHigh0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2114getSurfaceContainerHigh0d7_KjU;
    }
    ...
    public final long getIndicatorColor(Composer composer, int i) {
        ...
        long m2095getOnSurfaceVariant0d7_KjU = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2095getOnSurfaceVariant0d7_KjU();
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2095getOnSurfaceVariant0d7_KjU;
    }

    /* renamed from: getPositionalThreshold-D9Ej5fM  reason: not valid java name */
    public final float m3628getPositionalThresholdD9Ej5fM() {
        return PositionalThreshold;
    }

    /* renamed from: getIndicatorMaxDistance-D9Ej5fM  reason: not valid java name */
    public final float m3626getIndicatorMaxDistanceD9Ej5fM() {
    ...
    public final float m3627getLoadingIndicatorElevationD9Ej5fM() {
    ...
    */
    public final void m3624IndicatorBox1CPYgEU(final PullToRefreshState pullToRefreshState, final boolean z, Modifier modifier, float f, Shape shape2, long j, float f2, final Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        int i3;
        boolean z2;
        int i4;
                ...
                if ((i2 & 256) != 0) {
                    ...
                    if (!startRestartGroup.shouldExecute((i3 & 38347923) == 38347922, i3 & 1)) {
                        ...
                        if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i5 != 0) {
                                j2 = Color.Companion.m5315getUnspecified0d7_KjU();
                            }
                            if ((i2 & 64) != 0) {
                                i3 &= -3670017;
                                f4 = Elevation;
                        ...
                        Modifier m894size3ABfNKs = SizeKt.m894size3ABfNKs(companion, PullToRefreshKt.getSpinnerContainerSize());
                        ...
                        Modifier drawWithContent = DrawModifierKt.drawWithContent(m894size3ABfNKs, (Function1) rememberedValue);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        Modifier m266backgroundbw27NRU = BackgroundKt.m266backgroundbw27NRU(LayoutModifierKt.layout(drawWithContent, (Function3) rememberedValue2), j2, shape4);
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshDefaults$$ExternalSyntheticLambda4
                            ...
                            public final Object invoke(Object obj, Object obj2) {
                                ...
                                IndicatorBox_1CPYgEU$lambda$7 = PullToRefreshDefaults.IndicatorBox_1CPYgEU$lambda$7(PullToRefreshDefaults.this, pullToRefreshState, z, modifier2, f7, shape3, j3, f8, function3, i, i2, (Composer) obj, ((Integer) obj2).intValue());
    ...
    public static final Unit IndicatorBox_1CPYgEU$lambda$2$lambda$1(ContentDrawScope contentDrawScope) {
        ...
        try {
            drawContext.getTransform().mo5782clipRectN_I0leg(-3.4028235E38f, 0.0f, Float.MAX_VALUE, Float.MAX_VALUE, m5268getIntersectrtfAjoo);
    ...
    public static final MeasureResult IndicatorBox_1CPYgEU$lambda$6$lambda$5(final PullToRefreshState pullToRefreshState, final boolean z, final float f, final float f2, final Shape shape2, MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        ...
        return MeasureScope.layout$default(measureScope, mo6697measureBRTryo0.getWidth(), mo6697measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshDefaults$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit IndicatorBox_1CPYgEU$lambda$6$lambda$5$lambda$4$lambda$3(PullToRefreshState pullToRefreshState, boolean z, float f, float f2, Shape shape2, GraphicsLayerScope graphicsLayerScope) {
        ...
        graphicsLayerScope.setTranslationY((pullToRefreshState.getDistanceFraction() * graphicsLayerScope.mo423roundToPx0680j_4(f)) - Float.intBitsToFloat((int) (graphicsLayerScope.mo5474getSizeNHjbRc() & 4294967295L)));
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void m3623Indicator2poqoh4(final PullToRefreshState pullToRefreshState, final boolean z, Modifier modifier, long j, long j2, float f, Composer composer, final int i, final int i2) {
        int i3;
        Object obj;
        long j3;
        long j4;
        ...
        if (i7 != 0) {
            ...
            if (!startRestartGroup.shouldExecute((599187 & i3) == 599186, i3 & 1)) {
                ...
                m3624IndicatorBox1CPYgEU(pullToRefreshState, z, modifier3, f3, null, j7, 0.0f, ComposableLambdaKt.rememberComposableLambda(298232649, true, new Function3<BoxScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshDefaults$Indicator$1
                    @Override // kotlin.jvm.functions.Function3
                    ...
                    public static final class AnonymousClass1 implements Function3<Boolean, Composer, Integer, Unit> {
                        ...
                        public final void invoke(boolean z, Composer composer, int i) {
                            ...
                            if (z) {
                                ...
                                ProgressIndicatorKt.m2743CircularProgressIndicator4lLiAd8(SizeKt.m894size3ABfNKs(Modifier.Companion, PullToRefreshKt.getSpinnerSize()), this.$color, f, 0L, 0, 0.0f, composer, 390, 56);
                                ...
                                if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                                    ...
                                    L34:
                                        ...
                                        androidx.compose.ui.Modifier r0 = androidx.compose.foundation.layout.SizeKt.m894size3ABfNKs(r12, r14)
                                        long r1 = r11.$color
                                        ...
                                        r7 = 0
                                        r8 = r13
                                        androidx.compose.material3.ProgressIndicatorKt.m2743CircularProgressIndicator4lLiAd8(r0, r1, r3, r4, r6, r7, r8, r9, r10)
                                        r8.endReplaceGroup()
                                        goto La2
                                    L63:
                                        r8 = r13
                                    ...
                                    L95:
                                        ...
                                        long r12 = r11.$color
                                        androidx.compose.material3.pulltorefresh.PullToRefreshKt.m3633access$CircularArrowProgressIndicatorRPmYEkk(r14, r12, r8, r2)
                                        r8.endReplaceGroup()
                                    La2:
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.pulltorefresh.PullToRefreshDefaults$$ExternalSyntheticLambda0
                            ...
                            public final Object invoke(Object obj2, Object obj3) {
                                ...
                                Indicator_2poqoh4$lambda$8 = PullToRefreshDefaults.Indicator_2poqoh4$lambda$8(PullToRefreshDefaults.this, pullToRefreshState, z, modifier2, j5, j6, f2, i, i2, (Composer) obj2, ((Integer) obj3).intValue());
