...
public final class PullToRefreshElement extends ModifierNodeElement<PullToRefreshModifierNode> {
    ...
    public final float m3547getThresholdD9Ej5fM() {
    ...
    public void update(PullToRefreshModifierNode pullToRefreshModifierNode) {
        ...
        pullToRefreshModifierNode.m3556setThreshold0680j_4(this.threshold);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("threshold", Dp.m8158boximpl(this.threshold));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PullToRefreshElement) {
            ...
            return this.isRefreshing == pullToRefreshElement.isRefreshing && this.enabled == pullToRefreshElement.enabled && this.onRefresh == pullToRefreshElement.onRefresh && Intrinsics.areEqual(this.state, pullToRefreshElement.state) && Dp.m8165equalsimpl0(this.threshold, pullToRefreshElement.threshold);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Boolean.hashCode(this.isRefreshing) * 31) + Boolean.hashCode(this.enabled)) * 31) + this.onRefresh.hashCode()) * 31) + this.state.hashCode()) * 31) + Dp.m8166hashCodeimpl(this.threshold);
    }
}
