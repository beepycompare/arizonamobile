...
public final class PullToRefreshElement extends ModifierNodeElement<PullToRefreshModifierNode> {
    ...
    public final float m3629getThresholdD9Ej5fM() {
    ...
    public void update(PullToRefreshModifierNode pullToRefreshModifierNode) {
        ...
        pullToRefreshModifierNode.m3640setThreshold0680j_4(this.threshold);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("threshold", Dp.m7993boximpl(this.threshold));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PullToRefreshElement) {
            ...
            return this.isRefreshing == pullToRefreshElement.isRefreshing && this.enabled == pullToRefreshElement.enabled && this.onRefresh == pullToRefreshElement.onRefresh && Intrinsics.areEqual(this.state, pullToRefreshElement.state) && Dp.m8000equalsimpl0(this.threshold, pullToRefreshElement.threshold);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Boolean.hashCode(this.isRefreshing) * 31) + Boolean.hashCode(this.enabled)) * 31) + this.onRefresh.hashCode()) * 31) + this.state.hashCode()) * 31) + Dp.m8001hashCodeimpl(this.threshold);
    }
}
