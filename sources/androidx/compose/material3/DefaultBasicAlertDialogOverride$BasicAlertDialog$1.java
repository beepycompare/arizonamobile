...
public final class DefaultBasicAlertDialogOverride$BasicAlertDialog$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        final String m3610getString2EP1pXo = Strings_androidKt.m3610getString2EP1pXo(Strings.m3531constructorimpl(R.string.m3c_dialog), composer, 0);
        Modifier m898sizeInqDBjuR0$default = SizeKt.m898sizeInqDBjuR0$default(this.$this_BasicAlertDialog.getModifier(), AlertDialogKt.getDialogMinWidth(), 0.0f, AlertDialogKt.getDialogMaxWidth(), 0.0f, 10, null);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new Function1() { // from class: androidx.compose.material3.DefaultBasicAlertDialogOverride$BasicAlertDialog$1$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    ...
                    invoke$lambda$1$lambda$0 = DefaultBasicAlertDialogOverride$BasicAlertDialog$1.invoke$lambda$1$lambda$0(m3610getString2EP1pXo, (SemanticsPropertyReceiver) obj);
        ...
        Modifier then = m898sizeInqDBjuR0$default.then(SemanticsModifierKt.semantics$default(companion2, false, (Function1) rememberedValue, 1, null));
