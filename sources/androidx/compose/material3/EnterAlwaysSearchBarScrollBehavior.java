...
public final class EnterAlwaysSearchBarScrollBehavior implements SearchBarScrollBehavior {
    ...
    private final NestedScrollConnection nestedScrollConnection = new NestedScrollConnection() { // from class: androidx.compose.material3.EnterAlwaysSearchBarScrollBehavior$nestedScrollConnection$1
            ...
            if (EnterAlwaysSearchBarScrollBehavior.this.getCanScroll().invoke().booleanValue()) {
                if (EnterAlwaysSearchBarScrollBehavior.this.getReverseLayout()) {
                    ...
                    if (Float.intBitsToFloat(i2) > 0.0f) {
                        ...
                        return Offset.m5029copydBAh8RU$default(j2, 0.0f, 0.0f, 2, null);
                    }
                }
                if (!EnterAlwaysSearchBarScrollBehavior.this.getReverseLayout()) {
        ...
        public Object mo576onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
            Object m2335settleSearchBarOhffZ5M;
            if (EnterAlwaysSearchBarScrollBehavior.this.getCanScroll().invoke().booleanValue()) {
                m2335settleSearchBarOhffZ5M = EnterAlwaysSearchBarScrollBehavior.this.m2335settleSearchBarOhffZ5M(Velocity.m8234getYimpl(j2), continuation);
                return m2335settleSearchBarOhffZ5M;
            }
    ...
    public static final MeasureResult searchBarScrollBehavior$lambda$2(EnterAlwaysSearchBarScrollBehavior enterAlwaysSearchBarScrollBehavior, MeasureScope measureScope, Measurable measurable, Constraints constraints) {
        ...
        return MeasureScope.layout$default(measureScope, mo6697measureBRTryo0.getWidth(), RangesKt.coerceAtLeast(mo6697measureBRTryo0.getHeight() + roundToInt, 0), null, new Function1() { // from class: androidx.compose.material3.EnterAlwaysSearchBarScrollBehavior$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit searchBarScrollBehavior$lambda$3(EnterAlwaysSearchBarScrollBehavior enterAlwaysSearchBarScrollBehavior, IntSize intSize) {
        enterAlwaysSearchBarScrollBehavior.setScrollOffsetLimit(-((int) (intSize.m8170unboximpl() & 4294967295L)));
        return Unit.INSTANCE;
    }
    ...
    */
    public final Object m2335settleSearchBarOhffZ5M(float f, Continuation<? super Velocity> continuation) {
