...
public final class DefaultSingleRowTopAppBarOverride implements SingleRowTopAppBarOverride {
    ...
    public void SingleRowTopAppBar(final SingleRowTopAppBarOverrideScope singleRowTopAppBarOverrideScope, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (Float.isNaN(singleRowTopAppBarOverrideScope.m2989getExpandedHeightD9Ej5fM()) || (Float.floatToRawIntBits(singleRowTopAppBarOverrideScope.m2989getExpandedHeightD9Ej5fM()) & Integer.MAX_VALUE) >= 2139095040) {
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = SnapshotStateKt.derivedStateOf(new Function0<Color>() { // from class: androidx.compose.material3.DefaultSingleRowTopAppBarOverride$SingleRowTopAppBar$targetColor$2$1
                    ...
                    public /* bridge */ /* synthetic */ Color invoke() {
                        return Color.m5414boximpl(m2377invoke0d7_KjU());
                    }

                    /* renamed from: invoke-0d7_KjU  reason: not valid java name */
                    public final long m2377invoke0d7_KjU() {
                        TopAppBarState state;
                        TopAppBarScrollBehavior scrollBehavior2 = SingleRowTopAppBarOverrideScope.this.getScrollBehavior();
                        return SingleRowTopAppBarOverrideScope.this.getColors().m3473containerColorvNxB06k$material3(((scrollBehavior2 == null || (state = scrollBehavior2.getState()) == null) ? 0.0f : state.getOverlappedFraction()) > 0.01f ? 1.0f : 0.0f);
                    }
                });
                startRestartGroup.updateRememberedValue(rememberedValue);
            }
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final State<Color> m147animateColorAsStateeuL9pac = SingleValueAnimationKt.m147animateColorAsStateeuL9pac(SingleRowTopAppBar$lambda$2((State) rememberedValue), MotionSchemeKt.value(MotionSchemeKeyTokens.DefaultEffects, startRestartGroup, 6), null, null, startRestartGroup, 0, 12);
            ...
            boolean changed2 = startRestartGroup.changed(m147animateColorAsStateeuL9pac);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            long m3477getNavigationIconContentColor0d7_KjU = singleRowTopAppBarOverrideScope.getColors().m3477getNavigationIconContentColor0d7_KjU();
            long m3480getTitleContentColor0d7_KjU = singleRowTopAppBarOverrideScope.getColors().m3480getTitleContentColor0d7_KjU();
            long m3475getActionIconContentColor0d7_KjU = singleRowTopAppBarOverrideScope.getColors().m3475getActionIconContentColor0d7_KjU();
            long m3479getSubtitleContentColor0d7_KjU = singleRowTopAppBarOverrideScope.getColors().m3479getSubtitleContentColor0d7_KjU();
            ...
            float m2989getExpandedHeightD9Ej5fM = singleRowTopAppBarOverrideScope.m2989getExpandedHeightD9Ej5fM();
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            AppBarKt.m2019TopAppBarLayoutlyUyIHI(adjustHeightOffsetLimit, floatProducer, m3477getNavigationIconContentColor0d7_KjU, m3480getTitleContentColor0d7_KjU, m3479getSubtitleContentColor0d7_KjU, m3475getActionIconContentColor0d7_KjU, title, titleTextStyle, subtitle, subtitleTextStyle, (Function0) rememberedValue8, center, titleHorizontalAlignment, 0, false, navigationIcon, rememberComposableLambda, m2989getExpandedHeightD9Ej5fM, startRestartGroup, 0, 1600566);
    ...
    public static final Unit SingleRowTopAppBar$lambda$7$lambda$6(State state, DrawScope drawScope) {
        long m5434unboximpl = ((Color) state.getValue()).m5434unboximpl();
        if (!Color.m5425equalsimpl0(m5434unboximpl, Color.Companion.m5460getUnspecified0d7_KjU())) {
            DrawScope.m5999drawRectnJ9OG0$default(drawScope, m5434unboximpl, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        return Unit.INSTANCE;
    }
