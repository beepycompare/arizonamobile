...
public final class RichTooltipColors {
    ...
    public final long m2520getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m2521getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m2522getTitleContentColor0d7_KjU() {
        return this.titleContentColor;
    }

    /* renamed from: getActionContentColor-0d7_KjU  reason: not valid java name */
    public final long m2519getActionContentColor0d7_KjU() {
        return this.actionContentColor;
    }

    /* renamed from: copy-jRlVdoo$default  reason: not valid java name */
    public static /* synthetic */ RichTooltipColors m2517copyjRlVdoo$default(RichTooltipColors richTooltipColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return richTooltipColors.m2518copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? richTooltipColors.actionContentColor : j4);
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final RichTooltipColors m2518copyjRlVdoo(long j, long j2, long j3, long j4) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RichTooltipColors) {
            ...
            return Color.m4550equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m4550equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m4550equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m4550equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((Color.m4556hashCodeimpl(this.containerColor) * 31) + Color.m4556hashCodeimpl(this.contentColor)) * 31) + Color.m4556hashCodeimpl(this.titleContentColor)) * 31) + Color.m4556hashCodeimpl(this.actionContentColor);
    }
}
