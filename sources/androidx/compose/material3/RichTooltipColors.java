...
public final class RichTooltipColors {
    ...
    public final long m2862getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getTitleContentColor-0d7_KjU  reason: not valid java name */
    public final long m2863getTitleContentColor0d7_KjU() {
        return this.titleContentColor;
    }

    /* renamed from: getActionContentColor-0d7_KjU  reason: not valid java name */
    public final long m2860getActionContentColor0d7_KjU() {
        return this.actionContentColor;
    }

    /* renamed from: copy-jRlVdoo$default  reason: not valid java name */
    public static /* synthetic */ RichTooltipColors m2858copyjRlVdoo$default(RichTooltipColors richTooltipColors, long j, long j2, long j3, long j4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return richTooltipColors.m2859copyjRlVdoo(j5, j6, j3, (i & 8) != 0 ? richTooltipColors.actionContentColor : j4);
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final RichTooltipColors m2859copyjRlVdoo(long j, long j2, long j3, long j4) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RichTooltipColors) {
            ...
            return Color.m5425equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m5425equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m5425equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m5425equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
        }
        return false;
    }

    public int hashCode() {
        return (((((Color.m5431hashCodeimpl(this.containerColor) * 31) + Color.m5431hashCodeimpl(this.contentColor)) * 31) + Color.m5431hashCodeimpl(this.titleContentColor)) * 31) + Color.m5431hashCodeimpl(this.actionContentColor);
    }
}
