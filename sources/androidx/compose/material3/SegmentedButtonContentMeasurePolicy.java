...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo762measure3p2s80s(final MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        Object obj;
        Object obj2;
        Object obj3;
        float f;
        ...
        for (int i3 = 0; i3 < size; i3++) {
            arrayList.add(list2.get(i3).mo6216measureBRTryo0(j));
        }
        ...
        for (int i5 = 0; i5 < size2; i5++) {
            arrayList3.add(list3.get(i5).mo6216measureBRTryo0(j));
        }
        ...
        int max = Math.max(measureScope.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2461getIconSizeD9Ej5fM()), width3);
        f = SegmentedButtonKt.IconSpacing;
        int i7 = max + measureScope.mo399roundToPx0680j_4(f) + (valueOf != null ? valueOf.intValue() : 0);
        if (width3 == 0) {
            int i8 = measureScope.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2461getIconSizeD9Ej5fM());
            f2 = SegmentedButtonKt.IconSpacing;
            i = (-(i8 + measureScope.mo399roundToPx0680j_4(f2))) / 2;
        }
    ...
    public static final Unit measure_3p2s80s$lambda$8(List list, MeasureScope measureScope, SegmentedButtonContentMeasurePolicy segmentedButtonContentMeasurePolicy, int i, List list2, int i2, Placeable.PlacementScope placementScope) {
        ...
        int i4 = measureScope.mo399roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m2461getIconSizeD9Ej5fM());
        f = SegmentedButtonKt.IconSpacing;
        int i5 = i4 + measureScope.mo399roundToPx0680j_4(f);
