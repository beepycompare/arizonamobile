...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m7555constructorimpl(48);
    private static final float MonthYearHeight = Dp.m7555constructorimpl(56);
    ...
    */
    ...
    public static final void m1992SwitchableDateEntryContentKaiTk9E(final Long l, final long j, final int i, final Function1<? super Long, Unit> function1, final Function1<? super Long, Unit> function12, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, final FocusRequester focusRequester, Composer composer, final int i2, final int i3) {
        ...
        if (!startRestartGroup.shouldExecute(((i4 & 306783379) == 306783378 && (i5 & 3) == 2) ? false : true, i4 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final int i6 = -((Density) consume).mo399roundToPx0680j_4(Dp.m7555constructorimpl(48));
    ...
    public static final void Month(final CalendarMonth calendarMonth, final Function1<? super Long, Unit> function1, final long j, final Long l, final Long l2, final SelectedRangeInfo selectedRangeInfo, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, final Locale locale, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((306783379 & i9) != 306783378, i9 & 1)) {
            ...
            Modifier then = SizeKt.m853requiredHeight3ABfNKs(Modifier.Companion, Dp.m7555constructorimpl(6 * RecommendedSizeForAccessibility)).then(companion);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)87@4442L61,88@4508L133:Column.kt#2w3rfo");
    ...
    */
    ...
    static {
        float f = 12;
        DatePickerHorizontalPadding = Dp.m7555constructorimpl(f);
        DatePickerModeTogglePadding = PaddingKt.m815PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m7555constructorimpl(f), Dp.m7555constructorimpl(f), 3, null);
        float f2 = 24;
        float f3 = 16;
        DatePickerTitlePadding = PaddingKt.m815PaddingValuesa9UjIt4$default(Dp.m7555constructorimpl(f2), Dp.m7555constructorimpl(f3), Dp.m7555constructorimpl(f), 0.0f, 8, null);
        DatePickerHeadlinePadding = PaddingKt.m815PaddingValuesa9UjIt4$default(Dp.m7555constructorimpl(f2), 0.0f, Dp.m7555constructorimpl(f), Dp.m7555constructorimpl(f), 2, null);
        YearsVerticalPadding = Dp.m7555constructorimpl(f3);
    }
}
