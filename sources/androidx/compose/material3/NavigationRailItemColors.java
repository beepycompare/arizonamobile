...
public final class NavigationRailItemColors {
    ...
    public final long m2447getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2449getSelectedTextColor0d7_KjU() {
        return this.selectedTextColor;
    }

    /* renamed from: getSelectedIndicatorColor-0d7_KjU  reason: not valid java name */
    public final long m2448getSelectedIndicatorColor0d7_KjU() {
        return this.selectedIndicatorColor;
    }

    /* renamed from: getUnselectedIconColor-0d7_KjU  reason: not valid java name */
    public final long m2450getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2451getUnselectedTextColor0d7_KjU() {
        return this.unselectedTextColor;
    }

    /* renamed from: getDisabledIconColor-0d7_KjU  reason: not valid java name */
    public final long m2444getDisabledIconColor0d7_KjU() {
        return this.disabledIconColor;
    }

    /* renamed from: getDisabledTextColor-0d7_KjU  reason: not valid java name */
    public final long m2445getDisabledTextColor0d7_KjU() {
        return this.disabledTextColor;
    }

    /* renamed from: copy-4JmcsL4  reason: not valid java name */
    public final NavigationRailItemColors m2443copy4JmcsL4(long j, long j2, long j3, long j4, long j5, long j6, long j7) {
    ...
    public final long m2452iconColorWaAFU9c$material3_release(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedIconColor;
            }
    ...
    public final long m2453textColorWaAFU9c$material3_release(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedTextColor;
            }
    ...
    public final long m2446getIndicatorColor0d7_KjU$material3_release() {
        return this.selectedIndicatorColor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4550equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m4550equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m4550equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m4550equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m4550equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m4550equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m4550equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m4556hashCodeimpl(this.selectedIconColor) * 31) + Color.m4556hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m4556hashCodeimpl(this.selectedTextColor)) * 31) + Color.m4556hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m4556hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m4556hashCodeimpl(this.disabledIconColor)) * 31) + Color.m4556hashCodeimpl(this.disabledTextColor);
    }
}
