...
public final class NavigationRailItemColors {
    ...
    public final long m2774getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2776getSelectedTextColor0d7_KjU() {
    ...
    public final long m2777getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2778getUnselectedTextColor0d7_KjU() {
        return this.unselectedTextColor;
    }

    /* renamed from: getDisabledIconColor-0d7_KjU  reason: not valid java name */
    public final long m2771getDisabledIconColor0d7_KjU() {
        return this.disabledIconColor;
    }

    /* renamed from: getDisabledTextColor-0d7_KjU  reason: not valid java name */
    public final long m2772getDisabledTextColor0d7_KjU() {
        return this.disabledTextColor;
    }

    /* renamed from: copy-4JmcsL4  reason: not valid java name */
    public final NavigationRailItemColors m2770copy4JmcsL4(long j, long j2, long j3, long j4, long j5, long j6, long j7) {
    ...
    public final long m2779iconColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedIconColor;
            }
    ...
    public final long m2780textColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedTextColor;
            }
    ...
    public final long m2773getIndicatorColor0d7_KjU$material3() {
        return this.selectedIndicatorColor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5349equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m5349equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m5349equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m5349equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m5349equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m5349equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m5349equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m5355hashCodeimpl(this.selectedIconColor) * 31) + Color.m5355hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m5355hashCodeimpl(this.selectedTextColor)) * 31) + Color.m5355hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m5355hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m5355hashCodeimpl(this.disabledIconColor)) * 31) + Color.m5355hashCodeimpl(this.disabledTextColor);
    }
}
