...
public final class NavigationRailItemColors {
    ...
    public final long m2682getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2684getSelectedTextColor0d7_KjU() {
        return this.selectedTextColor;
    }

    /* renamed from: getSelectedIndicatorColor-0d7_KjU  reason: not valid java name */
    public final long m2683getSelectedIndicatorColor0d7_KjU() {
        return this.selectedIndicatorColor;
    }

    /* renamed from: getUnselectedIconColor-0d7_KjU  reason: not valid java name */
    public final long m2685getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2686getUnselectedTextColor0d7_KjU() {
        return this.unselectedTextColor;
    }

    /* renamed from: getDisabledIconColor-0d7_KjU  reason: not valid java name */
    public final long m2679getDisabledIconColor0d7_KjU() {
        return this.disabledIconColor;
    }

    /* renamed from: getDisabledTextColor-0d7_KjU  reason: not valid java name */
    public final long m2680getDisabledTextColor0d7_KjU() {
        return this.disabledTextColor;
    }

    /* renamed from: copy-4JmcsL4  reason: not valid java name */
    public final NavigationRailItemColors m2678copy4JmcsL4(long j, long j2, long j3, long j4, long j5, long j6, long j7) {
    ...
    public final long m2687iconColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedIconColor;
            }
    ...
    public final long m2688textColorWaAFU9c$material3(boolean z, boolean z2) {
        if (z2) {
            if (z) {
                return this.selectedTextColor;
            }
    ...
    public final long m2681getIndicatorColor0d7_KjU$material3() {
        return this.selectedIndicatorColor;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m5280equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m5280equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m5280equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m5280equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m5280equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m5280equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m5280equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m5286hashCodeimpl(this.selectedIconColor) * 31) + Color.m5286hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m5286hashCodeimpl(this.selectedTextColor)) * 31) + Color.m5286hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m5286hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m5286hashCodeimpl(this.disabledIconColor)) * 31) + Color.m5286hashCodeimpl(this.disabledTextColor);
    }
}
