...
public final class TooltipPositionProviderImpl implements PopupPositionProvider {
    ...
    public final int m3381getTypelOKsHw4() {
        return this.type;
    }
    ...
    public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        int i = this.type;
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3355getLeftlOKsHw4())) {
            return m3382leftPositioningoFUgxo0(intRect, j2);
        }
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3356getRightlOKsHw4())) {
            return m3383rightPositioninguHY26d4(intRect, j2, j);
        }
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3352getAbovelOKsHw4())) {
            return m3378abovePositioninguHY26d4(intRect, j2, j);
        }
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3353getBelowlOKsHw4())) {
            return m3379belowPositioninguHY26d4(intRect, j2, j);
        }
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3357getStartlOKsHw4())) {
            return m3384startPositioning_JLpSYE(layoutDirection, intRect, j2, j);
        }
        if (TooltipAnchorPosition.m3348equalsimpl0(i, TooltipAnchorPosition.Companion.m3354getEndlOKsHw4())) {
            return m3380endPositioning_JLpSYE(layoutDirection, intRect, j2, j);
        }
        return m3378abovePositioninguHY26d4(intRect, j2, j);
    }

    /* renamed from: leftPositioning-oFUgxo0  reason: not valid java name */
    public final long m3382leftPositioningoFUgxo0(IntRect intRect, long j) {
        int left = intRect.getLeft() - (((int) (j >> 32)) + this.tooltipAnchorSpacing);
        if (left < 0) {
            left = intRect.getRight() + this.tooltipAnchorSpacing;
        }
        return IntOffset.m8117constructorimpl((left << 32) | ((((intRect.getTop() + intRect.getBottom()) - ((int) (j & 4294967295L))) / 2) & 4294967295L));
    }

    /* renamed from: rightPositioning-uHY26d4  reason: not valid java name */
    public final long m3383rightPositioninguHY26d4(IntRect intRect, long j, long j2) {
        ...
        return IntOffset.m8117constructorimpl((right << 32) | ((((intRect.getTop() + intRect.getBottom()) - ((int) (j & 4294967295L))) / 2) & 4294967295L));
    }

    /* renamed from: abovePositioning-uHY26d4  reason: not valid java name */
    public final long m3378abovePositioninguHY26d4(IntRect intRect, long j, long j2) {
        int i = (int) (j >> 32);
    ...
    public final long m3379belowPositioninguHY26d4(IntRect intRect, long j, long j2) {
        int i = (int) (j >> 32);
        int left = intRect.getLeft() + ((intRect.getWidth() - i) / 2);
        if (left < 0) {
            left = intRect.getLeft();
        ...
        return IntOffset.m8117constructorimpl((left << 32) | (bottom & 4294967295L));
    }

    /* renamed from: startPositioning-_JLpSYE  reason: not valid java name */
    public final long m3384startPositioning_JLpSYE(LayoutDirection layoutDirection, IntRect intRect, long j, long j2) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return m3382leftPositioningoFUgxo0(intRect, j);
        }
        return m3383rightPositioninguHY26d4(intRect, j, j2);
    }

    /* renamed from: endPositioning-_JLpSYE  reason: not valid java name */
    public final long m3380endPositioning_JLpSYE(LayoutDirection layoutDirection, IntRect intRect, long j, long j2) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return m3383rightPositioninguHY26d4(intRect, j, j2);
        }
        return m3382leftPositioningoFUgxo0(intRect, j);
