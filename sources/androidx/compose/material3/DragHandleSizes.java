...
public final class DragHandleSizes {
    ...
    public final long m2323getDraggedSizeMYxV2XQ() {
        return this.draggedSize;
    }

    /* renamed from: getPressedSize-MYxV2XQ  reason: not valid java name */
    public final long m2324getPressedSizeMYxV2XQ() {
        return this.pressedSize;
    }

    /* renamed from: getSize-MYxV2XQ  reason: not valid java name */
    public final long m2325getSizeMYxV2XQ() {
        return this.size;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DpSize.m8090equalsimpl0(this.size, dragHandleSizes.size) && DpSize.m8090equalsimpl0(this.pressedSize, dragHandleSizes.pressedSize) && DpSize.m8090equalsimpl0(this.draggedSize, dragHandleSizes.draggedSize);
    }

    public int hashCode() {
        return (((DpSize.m8095hashCodeimpl(this.size) * 31) + DpSize.m8095hashCodeimpl(this.pressedSize)) * 31) + DpSize.m8095hashCodeimpl(this.draggedSize);
    }
}
