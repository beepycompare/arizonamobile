...
public final class TabKt {
    ...
    private static final float LargeTabHeight = Dp.m8160constructorimpl(72.0f);
    private static final float HorizontalTextPadding = Dp.m8160constructorimpl(16.0f);
    private static final float SingleLineTextBaselineWithIcon = Dp.m8160constructorimpl(14.0f);
    private static final float DoubleLineTextBaselineWithIcon = Dp.m8160constructorimpl(6.0f);
    private static final long IconDistanceFromBaseline = TextUnitKt.getSp(20);
    private static final float TextDistanceFromLeadingIcon = Dp.m8160constructorimpl(8.0f);
    ...
    */
                    ...
                    if (i6 == 0) {
                        ...
                        if (i9 != 0) {
                            ...
                            if (!startRestartGroup.shouldExecute((i7 & 38347923) == 38347922, i7 & 1)) {
                                ...
                                if (obj == null) {
                                    ...
                                    composableLambda = ComposableLambdaKt.rememberComposableLambda(-1745256900, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$styledText$1$1
                                        ...
                                        public final void invoke(Composer composer3, int i15) {
                                            ...
                                            TextKt.ProvideTextStyle(TextStyle.m7621copyp1EtxEg$default(TypographyKt.getValue(PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont(), composer3, 6), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.Companion.m8038getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744447, null), obj, composer3, 0);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                m3047TabbogVsAg(z3, function02, BadgeKt.badgeBounds(companion), z6, j7, j8, mutableInteractionSource3, ComposableLambdaKt.rememberComposableLambda(-906085472, true, new Function3<ColumnScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$1
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m3046LeadingIconTabwqdebIU(final boolean z, final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Modifier modifier, boolean z2, long j, long j2, MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        final boolean z3;
        int i3;
                ...
                if (i4 != 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        if (i7 != 0) {
                            ...
                            i8 = i7;
                            i6 |= startRestartGroup.changed(mutableInteractionSource) ? 67108864 : GroupFlagsKt.HasAuxSlotFlag;
                            if (!startRestartGroup.shouldExecute((i6 & 38347923) == 38347922, i6 & 1)) {
                                ...
                                if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                                    ...
                                    if ((i2 & 64) != 0) {
                                        ...
                                        Object consume = startRestartGroup.consume(ContentColorKt.getLocalContentColor());
                                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                        j3 = ((Color) consume).m5358unboximpl();
                                        i6 &= -3670017;
                                    }
                                    if ((i2 & 128) != 0) {
                                        i6 &= -29360129;
                                    ...
                                    if (i8 != 0) {
                                        ...
                                        final IndicationNodeFactory m2847rippleH2RKhps$default = RippleKt.m2847rippleH2RKhps$default(true, 0.0f, j3, 2, null);
                                        final Modifier modifier3 = companion;
                                        final Function2<? super Composer, ? super Integer, Unit> function23 = obj;
                                        int i10 = i9 >> 18;
                                        m3049TabTransitionKlgxPg(j3, j5, z, ComposableLambdaKt.rememberComposableLambda(1831009258, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$1
                                            @Override // kotlin.jvm.functions.Function2
                                            public /* bridge */ /* synthetic */ Unit invoke(Composer composer3, Integer num) {
                                                invoke(composer3, num.intValue());
                                                return Unit.INSTANCE;
                                            ...
                                            public final void invoke(Composer composer3, int i11) {
                                                ...
                                                Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(PaddingKt.m1052paddingVpY3zN4$default(SelectableKt.m1342selectableO2vRcR0(SizeKt.m1103height3ABfNKs(modifier4, f), z3, mutableInteractionSource3, m2847rippleH2RKhps$default, z6, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), function02), TabKt.getHorizontalTextPadding(), 0.0f, 2, null), 0.0f, 1, null);
                                                ...
                                                SpacerKt.Spacer(SizeKt.m1114requiredWidth3ABfNKs(Modifier.Companion, f2), composer3, 6);
                                                TextKt.ProvideTextStyle(TextStyle.m7621copyp1EtxEg$default(TypographyKt.getValue(PrimaryNavigationTabTokens.INSTANCE.getLabelTextFont(), composer3, 6), 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, TextAlign.Companion.m8038getCentere0LSkKk(), 0, 0L, null, null, null, 0, 0, null, 16744447, null), function25, composer3, 0);
                                ...
                                final IndicationNodeFactory m2847rippleH2RKhps$default2 = RippleKt.m2847rippleH2RKhps$default(true, 0.0f, j3, 2, null);
                                ...
                                m3049TabTransitionKlgxPg(j3, j5, z, ComposableLambdaKt.rememberComposableLambda(1831009258, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$LeadingIconTab$1
                                    ...
                                    public final void invoke(Composer composer3, int i11) {
                                        ...
                                        Modifier modifier4 = Modifier.this;
                                        f = TabKt.SmallTabHeight;
                                        Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(PaddingKt.m1052paddingVpY3zN4$default(SelectableKt.m1342selectableO2vRcR0(SizeKt.m1103height3ABfNKs(modifier4, f), z3, mutableInteractionSource3, m2847rippleH2RKhps$default2, z62, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), function02), TabKt.getHorizontalTextPadding(), 0.0f, 2, null), 0.0f, 1, null);
                                        Alignment.Vertical centerVertically = Alignment.Companion.getCenterVertically();
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m3047TabbogVsAg(final boolean z, final Function0<Unit> function0, Modifier modifier, boolean z2, long j, long j2, MutableInteractionSource mutableInteractionSource, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        boolean z3;
        int i3;
        int i4;
        Modifier.Companion companion;
                        ...
                        if (startRestartGroup.shouldExecute((i3 & 4793491) != 4793490, i7 & 1)) {
                            ...
                            if ((i & 1) == 0 || startRestartGroup.getDefaultsInvalid()) {
                                ...
                                if (i6 != 0) {
                                    ...
                                    final boolean z7 = z3;
                                    int i11 = i8 >> 12;
                                    m3049TabTransitionKlgxPg(j3, j7, z, ComposableLambdaKt.rememberComposableLambda(1128552423, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
                                        @Override // kotlin.jvm.functions.Function2
                                        public /* bridge */ /* synthetic */ Unit invoke(Composer composer3, Integer num) {
                                            invoke(composer3, num.intValue());
                                            return Unit.INSTANCE;
                                        ...
                                        public final void invoke(Composer composer3, int i12) {
                                            ...
                                            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m1342selectableO2vRcR0(Modifier.this, z7, mutableInteractionSource3, m2847rippleH2RKhps$default, z6, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), function0), 0.0f, 1, null);
                            ...
                            m3049TabTransitionKlgxPg(j3, j7, z, ComposableLambdaKt.rememberComposableLambda(1128552423, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.TabKt$Tab$3
                                ...
                                public final void invoke(Composer composer3, int i12) {
                                    ...
                                    Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SelectableKt.m1342selectableO2vRcR0(Modifier.this, z72, mutableInteractionSource3, m2847rippleH2RKhps$default2, z62, Role.m7371boximpl(Role.Companion.m7385getTabo7Vup1c()), function0), 0.0f, 1, null);
                                    Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
                                    Arrangement.HorizontalOrVertical center = Arrangement.INSTANCE.getCenter();
                                    Function3<ColumnScope, Composer, Integer, Unit> function32 = function3;
                                    ComposerKt.sourceInformationMarkerStart(composer3, -483455358, "CC(Column)P(2,3,1)87@4442L61,88@4508L133:Column.kt#2w3rfo");
    ...
    private static final void m3049TabTransitionKlgxPg(final long j, final long j2, boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        final boolean z2;
        ...
        if (!startRestartGroup.shouldExecute((i2 & 1171) != 1170, i2 & 1)) {
            ...
            boolean changed = startRestartGroup.changed(m5352getColorSpaceimpl);
            ...
            startRestartGroup.endReplaceGroup();
            State createTransitionAnimation = TransitionKt.createTransitionAnimation(updateTransition, m5338boximpl, Color.m5338boximpl(j5), tabKt$TabTransition$color$2.invoke((TabKt$TabTransition$color$2) updateTransition.getSegment(), (Transition.Segment) startRestartGroup, (Composer) 0), twoWayConverter, "ColorAnimation", startRestartGroup, 0);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m5338boximpl(TabTransition_Klgx_Pg$lambda$5(createTransitionAnimation))), function2, startRestartGroup, ProvidedValue.$stable | (i3 & 112));
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    public static final void TabBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            if (function2 != null) {
                ...
                Modifier m1052paddingVpY3zN4$default = PaddingKt.m1052paddingVpY3zN4$default(LayoutIdKt.layoutId(Modifier.Companion, "text"), HorizontalTextPadding, 0.0f, 2, null);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.Companion.getTopStart(), false);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
                int currentCompositeKeyHash2 = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
                CompositionLocalMap currentCompositionLocalMap2 = startRestartGroup.getCurrentCompositionLocalMap();
                Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(startRestartGroup, m1052paddingVpY3zN4$default);
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i, int i2, int i3, int i4) {
        ...
        int mo428roundToPx0680j_4 = density.mo428roundToPx0680j_4(f) + density.mo428roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m4140getActiveIndicatorHeightD9Ej5fM());
        int i5 = (i2 - i4) - mo428roundToPx0680j_4;
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable, (i - placeable.getWidth()) / 2, i5, 0.0f, 4, null);
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, (i - placeable2.getWidth()) / 2, i5 - ((placeable2.getHeight() + density.mo427roundToPxR2X_6o(IconDistanceFromBaseline)) - i3), 0.0f, 4, null);
    }
