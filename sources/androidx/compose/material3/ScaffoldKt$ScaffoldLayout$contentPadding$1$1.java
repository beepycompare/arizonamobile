...
public final class ScaffoldKt$ScaffoldLayout$contentPadding$1$1 implements PaddingValues {
    ...
    public ScaffoldKt$ScaffoldLayout$contentPadding$1$1() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PaddingKt.m1043PaddingValues0680j_4(Dp.m8160constructorimpl(0.0f)), null, 2, null);
    ...
    public float mo1000calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        return getPaddingHolder().mo1000calculateLeftPaddingu2uoSUM(layoutDirection);
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateTopPadding-D9Ej5fM */
    public float mo1002calculateTopPaddingD9Ej5fM() {
        return getPaddingHolder().mo1002calculateTopPaddingD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateRightPadding-u2uoSUM */
    public float mo1001calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        return getPaddingHolder().mo1001calculateRightPaddingu2uoSUM(layoutDirection);
    }

    @Override // androidx.compose.foundation.layout.PaddingValues
    /* renamed from: calculateBottomPadding-D9Ej5fM */
    public float mo999calculateBottomPaddingD9Ej5fM() {
        return getPaddingHolder().mo999calculateBottomPaddingD9Ej5fM();
    }
}
