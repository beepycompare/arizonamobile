...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7286DpSizeYgX7TsA(Dp.m7264constructorimpl(16), Dp.m7264constructorimpl(8));
    ...
    public final long m2961getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m2964richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2518copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2518copyjRlVdoo(m4585getUnspecified0d7_KjU, m4585getUnspecified0d7_KjU2, m4585getUnspecified0d7_KjU3, m4585getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2518copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2962rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
                    int left = intRect.getLeft() + ((intRect.getWidth() - IntSize.m7435getWidthimpl(j2)) / 2);
                    int top = (intRect.getTop() - IntSize.m7434getHeightimpl(j2)) - mo423roundToPx0680j_4;
                    if (top < 0) {
    ...
    public final PopupPositionProvider m2963rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
                    ...
                    if (IntSize.m7435getWidthimpl(j2) + left > IntSize.m7435getWidthimpl(j) && (left = intRect.getRight() - IntSize.m7435getWidthimpl(j2)) < 0) {
                        left = intRect.getLeft() + ((intRect.getWidth() - IntSize.m7435getWidthimpl(j2)) / 2);
                    }
                    int top = (intRect.getTop() - IntSize.m7434getHeightimpl(j2)) - mo423roundToPx0680j_4;
                    if (top < 0) {
                        top = mo423roundToPx0680j_4 + intRect.getBottom();
