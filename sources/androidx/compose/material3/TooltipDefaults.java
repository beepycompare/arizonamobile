...
public final class TooltipDefaults {
    ...
    public static /* synthetic */ Shape m3358caretShapeEaSLcWc$default(TooltipDefaults tooltipDefaults, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = caretSize;
        }
        return tooltipDefaults.m3359caretShapeEaSLcWc(j);
    }

    /* renamed from: caretShape-EaSLcWc  reason: not valid java name */
    public final Shape m3359caretShapeEaSLcWc(long j) {
    ...
    public final RichTooltipColors m3367richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2772copyjRlVdoo = getDefaultRichTooltipColors$material3(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2772copyjRlVdoo(m5315getUnspecified0d7_KjU, m5315getUnspecified0d7_KjU2, m5315getUnspecified0d7_KjU3, m5315getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2772copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m3363rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        final int mo423roundToPx0680j_4 = ((Density) consume).mo423roundToPx0680j_4(f);
        ComposerKt.sourceInformationMarkerStart(composer, 1977770815, "CC(remember):Tooltip.kt#9igjgp");
        boolean changed = composer.changed(mo423roundToPx0680j_4);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
                    ...
                    int top = (intRect.getTop() - ((int) (j2 & 4294967295L))) - mo423roundToPx0680j_4;
                    if (top < 0) {
                        top = mo423roundToPx0680j_4 + intRect.getBottom();
                    }
                    return IntOffset.m8117constructorimpl((left << 32) | (top & 4294967295L));
                }
            };
    ...
    public final PopupPositionProvider m3364rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo393calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
                    ...
                    return IntOffset.m8117constructorimpl((top & 4294967295L) | (left << 32));
                }
            };
            composer.updateRememberedValue(rememberedValue);
        }
    ...
    public final PopupPositionProvider m3366rememberTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
    ...
    public final PopupPositionProvider m3365rememberTooltipPositionProviderHu5FAss(int i, float f, Composer composer, int i2, int i3) {
        ...
        Object consume = composer.consume(CompositionLocalsKt.getLocalDensity());
        ComposerKt.sourceInformationMarkerEnd(composer);
        int mo423roundToPx0680j_4 = ((Density) consume).mo423roundToPx0680j_4(f);
        ComposerKt.sourceInformationMarkerStart(composer, -1669413528, "CC(remember):Tooltip.kt#9igjgp");
        boolean changed = ((((i2 & 14) ^ 6) > 4 && composer.changed(i)) || (i2 & 6) == 4) | composer.changed(mo423roundToPx0680j_4);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TooltipPositionProviderImpl(i, mo423roundToPx0680j_4, null);
            composer.updateRememberedValue(rememberedValue);
        }
    ...
    static {
        long m8017DpSizeYgX7TsA = DpKt.m8017DpSizeYgX7TsA(Dp.m7995constructorimpl(16), Dp.m7995constructorimpl(8));
        caretSize = m8017DpSizeYgX7TsA;
        plainTooltipMaxWidth = Dp.m7995constructorimpl(200);
        richTooltipMaxWidth = Dp.m7995constructorimpl(320);
        DefaultCaretShape = new DefaultTooltipCaretShape(m8017DpSizeYgX7TsA, null);
    }
}
