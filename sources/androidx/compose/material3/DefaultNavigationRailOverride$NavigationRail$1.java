...
final class DefaultNavigationRailOverride$NavigationRail$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        Arrangement.HorizontalOrVertical m742spacedBy0680j_4 = Arrangement.INSTANCE.m742spacedBy0680j_4(NavigationRailKt.getNavigationRailVerticalPadding());
        NavigationRailOverrideScope navigationRailOverrideScope = this.$this_NavigationRail;
        ComposerKt.sourceInformationMarkerStart(composer, -483455358, "CC(Column)P(2,3,1)87@4442L61,88@4508L133:Column.kt#2w3rfo");
        MeasurePolicy columnMeasurePolicy = ColumnKt.columnMeasurePolicy(m742spacedBy0680j_4, centerHorizontally, composer, 54);
        ...
        if (header != null) {
            ...
            SpacerKt.Spacer(SizeKt.m1103height3ABfNKs(Modifier.Companion, f), composer, 6);
