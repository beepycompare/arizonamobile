...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0() { // from class: androidx.compose.material3.SurfaceKt$$ExternalSyntheticLambda0
        ...
        public final Object invoke() {
            Dp m8158boximpl;
            m8158boximpl = Dp.m8158boximpl(Dp.m8160constructorimpl(0.0f));
            return m8158boximpl;
        }
    }, 1, null);

    /* renamed from: Surface-T9BRK9s  reason: not valid java name */
    public static final void m3014SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2) {
        ...
        if ((i2 & 4) != 0) {
            j = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2331getSurface0d7_KjU();
        }
        if ((i2 & 8) != 0) {
            j2 = ColorSchemeKt.m2347contentColorForek8zF_U(j, composer, (i >> 6) & 14);
        }
        if ((i2 & 16) != 0) {
        ...
        float m8160constructorimpl = Dp.m8160constructorimpl(((Dp) consume).m8174unboximpl() + f);
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m5338boximpl(j2)), providableCompositionLocal.provides(Dp.m8158boximpl(m8160constructorimpl))}, ComposableLambdaKt.rememberComposableLambda(421772006, true, new SurfaceKt$Surface$1(modifier, shape, j, m8160constructorimpl, borderStroke, f2, function2), composer, 54), composer, ProvidedValue.$stable | 48);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m3017Surfaceo_FOJdg(final Function0<Unit> function0, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ?? r18;
        ...
        final long m2331getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2331getSurface0d7_KjU() : j;
        long m2347contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m2331getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float m8160constructorimpl = (i3 & 64) != 0 ? Dp.m8160constructorimpl(0.0f) : f;
        final float m8160constructorimpl2 = (i3 & 128) != 0 ? Dp.m8160constructorimpl(0.0f) : f2;
        ...
        Object consume = composer.consume(providableCompositionLocal);
        ComposerKt.sourceInformationMarkerEnd(composer);
        final float m8160constructorimpl3 = Dp.m8160constructorimpl(((Dp) consume).m8174unboximpl() + m8160constructorimpl);
        ProvidedValue[] providedValueArr = new ProvidedValue[2];
        providedValueArr[0] = ContentColorKt.getLocalContentColor().provides(Color.m5338boximpl(m2347contentColorForek8zF_U));
        providedValueArr[r18] = providableCompositionLocal.provides(Dp.m8158boximpl(m8160constructorimpl3));
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.rememberComposableLambda(849208527, r18, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$2
            ...
            public final void invoke(Composer composer2, int i4) {
                long m3021surfaceColorAtElevationCLU3JFs;
                Modifier m3020surfaceXOJAsU;
                ...
                m3021surfaceColorAtElevationCLU3JFs = SurfaceKt.m3021surfaceColorAtElevationCLU3JFs(m2331getSurface0d7_KjU, m8160constructorimpl3, composer2, 0);
                ...
                m3020surfaceXOJAsU = SurfaceKt.m3020surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3021surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo434toPx0680j_4(m8160constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(ClickableKt.m319clickableO2vRcR0$default(m3020surfaceXOJAsU, mutableInteractionSource3, RippleKt.m2847rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z2, null, null, function0, 24, null), null, 1, null);
    ...
    public static final void m3015Surfaced85dljk(final boolean z, final Function0<Unit> function0, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ...
        final long m2331getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2331getSurface0d7_KjU() : j;
        long m2347contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m2347contentColorForek8zF_U(m2331getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float m8160constructorimpl = (i3 & 128) != 0 ? Dp.m8160constructorimpl(0.0f) : f;
        final float m8160constructorimpl2 = (i3 & 256) != 0 ? Dp.m8160constructorimpl(0.0f) : f2;
        ...
        final float m8160constructorimpl3 = Dp.m8160constructorimpl(((Dp) consume).m8174unboximpl() + m8160constructorimpl);
        final BorderStroke borderStroke3 = borderStroke2;
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m5338boximpl(m2347contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m8158boximpl(m8160constructorimpl3))}, ComposableLambdaKt.rememberComposableLambda(1508735219, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Unit invoke(Composer composer2, Integer num) {
                invoke(composer2, num.intValue());
                return Unit.INSTANCE;
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer2);
                m3020surfaceXOJAsU = SurfaceKt.m3020surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3021surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo434toPx0680j_4(m8160constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(SelectableKt.m1343selectableO2vRcR0$default(m3020surfaceXOJAsU, z, mutableInteractionSource2, RippleKt.m2847rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z3, null, function0, 16, null), null, 1, null);
                Function2<Composer, Integer, Unit> function22 = function2;
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.Companion.getTopStart(), true);
                ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
    ...
    /* renamed from: Surface-d85dljk  reason: not valid java name */
    public static final void m3016Surfaced85dljk(final boolean z, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ...
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m5338boximpl(m2347contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m8158boximpl(m8160constructorimpl3))}, ComposableLambdaKt.rememberComposableLambda(-1839065134, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$4
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer2);
                m3020surfaceXOJAsU = SurfaceKt.m3020surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3021surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo434toPx0680j_4(m8160constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(ToggleableKt.m1350toggleableO2vRcR0$default(m3020surfaceXOJAsU, z, mutableInteractionSource2, RippleKt.m2847rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z3, null, function1, 16, null), null, 1, null);
                Function2<Composer, Integer, Unit> function22 = function2;
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.Companion.getTopStart(), true);
                ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
    ...
    public static final Modifier m3020surfaceXOJAsU(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        Shape shape2;
        Modifier.Companion companion;
        if (f > 0.0f) {
            shape2 = shape;
            companion = GraphicsLayerModifierKt.m5510graphicsLayerAp8cVGQ(Modifier.Companion, (r41 & 1) != 0 ? 1.0f : 0.0f, (r41 & 2) != 0 ? 1.0f : 0.0f, (r41 & 4) == 0 ? 0.0f : 1.0f, (r41 & 8) != 0 ? 0.0f : 0.0f, (r41 & 16) != 0 ? 0.0f : 0.0f, (r41 & 32) != 0 ? 0.0f : f, (r41 & 64) != 0 ? 0.0f : 0.0f, (r41 & 128) != 0 ? 0.0f : 0.0f, (r41 & 256) == 0 ? 0.0f : 0.0f, (r41 & 512) != 0 ? 8.0f : 0.0f, (r41 & 1024) != 0 ? TransformOrigin.Companion.m5761getCenterSzJe1aQ() : 0L, (r41 & 2048) != 0 ? RectangleShapeKt.getRectangleShape() : shape2, (r41 & 4096) != 0 ? false : false, (r41 & 8192) != 0 ? null : null, (r41 & 16384) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (32768 & r41) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (r41 & 65536) != 0 ? CompositingStrategy.Companion.m5437getAutoNrFUSI() : 0);
        } else {
            shape2 = shape;
            companion = Modifier.Companion;
        }
        return ClipKt.clip(BackgroundKt.m287backgroundbw27NRU(modifier.then(companion).then(borderStroke != null ? BorderKt.border(Modifier.Companion, borderStroke, shape2) : Modifier.Companion), j, shape2), shape2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-CLU3JFs  reason: not valid java name */
    public static final long m3021surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        long m2345applyTonalElevationRFCenO8 = ColorSchemeKt.m2345applyTonalElevationRFCenO8(MaterialTheme.INSTANCE.getColorScheme(composer, 6), j, f, composer, (i << 3) & 1008);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2345applyTonalElevationRFCenO8;
    }
