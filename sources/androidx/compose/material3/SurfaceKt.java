...
public final class SurfaceKt {
    ...
    public static final void m2997SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2) {
        ...
        if ((i2 & 4) != 0) {
            j = MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2112getSurface0d7_KjU();
        }
        if ((i2 & 8) != 0) {
            j2 = ColorSchemeKt.m2130contentColorForek8zF_U(j, composer, (i >> 6) & 14);
        }
        if ((i2 & 16) != 0) {
        ...
        float m7996constructorimpl = Dp.m7996constructorimpl(((Dp) consume).m8010unboximpl() + f);
        CompositionLocalKt.CompositionLocalProvider(new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m5270boximpl(j2)), providableCompositionLocal.provides(Dp.m7994boximpl(m7996constructorimpl))}, ComposableLambdaKt.rememberComposableLambda(421772006, true, new SurfaceKt$Surface$1(modifier, shape, j, m7996constructorimpl, borderStroke, f2, function2), composer, 54), composer, ProvidedValue.$stable | 48);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m3000Surfaceo_FOJdg(final Function0<Unit> function0, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ?? r18;
        ...
        final long m2112getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2112getSurface0d7_KjU() : j;
        long m2130contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m2130contentColorForek8zF_U(m2112getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float m7996constructorimpl = (i3 & 64) != 0 ? Dp.m7996constructorimpl(0) : f;
        final float m7996constructorimpl2 = (i3 & 128) != 0 ? Dp.m7996constructorimpl(0) : f2;
        ...
        Object consume = composer.consume(providableCompositionLocal);
        ComposerKt.sourceInformationMarkerEnd(composer);
        final float m7996constructorimpl3 = Dp.m7996constructorimpl(((Dp) consume).m8010unboximpl() + m7996constructorimpl);
        ProvidedValue[] providedValueArr = new ProvidedValue[2];
        providedValueArr[0] = ContentColorKt.getLocalContentColor().provides(Color.m5270boximpl(m2130contentColorForek8zF_U));
        providedValueArr[r18] = providableCompositionLocal.provides(Dp.m7994boximpl(m7996constructorimpl3));
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.rememberComposableLambda(849208527, r18, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$2
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                m3004surfaceColorAtElevationCLU3JFs = SurfaceKt.m3004surfaceColorAtElevationCLU3JFs(m2112getSurface0d7_KjU, m7996constructorimpl3, composer2, 0);
                ...
                m3003surfaceXOJAsU = SurfaceKt.m3003surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3004surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo430toPx0680j_4(m7996constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(ClickableKt.m305clickableO2vRcR0$default(m3003surfaceXOJAsU, mutableInteractionSource3, RippleKt.m2781rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z2, null, null, function0, 24, null), null, 1, null);
    ...
    public static final void m2998Surfaced85dljk(final boolean z, final Function0<Unit> function0, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ?? r20;
        ...
        final long m2112getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m2112getSurface0d7_KjU() : j;
        long m2130contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m2130contentColorForek8zF_U(m2112getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float m7996constructorimpl = (i3 & 128) != 0 ? Dp.m7996constructorimpl(0) : f;
        final float m7996constructorimpl2 = (i3 & 256) != 0 ? Dp.m7996constructorimpl(0) : f2;
        ...
        ProvidedValue[] providedValueArr = new ProvidedValue[2];
        providedValueArr[0] = ContentColorKt.getLocalContentColor().provides(Color.m5270boximpl(m2130contentColorForek8zF_U));
        providedValueArr[r20] = providableCompositionLocal.provides(Dp.m7994boximpl(m7996constructorimpl3));
        final BorderStroke borderStroke3 = borderStroke2;
        final MutableInteractionSource mutableInteractionSource3 = mutableInteractionSource2;
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.rememberComposableLambda(1508735219, r20, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer2);
                m3003surfaceXOJAsU = SurfaceKt.m3003surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3004surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo430toPx0680j_4(m7996constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(SelectableKt.m1171selectableO2vRcR0$default(m3003surfaceXOJAsU, z, mutableInteractionSource3, RippleKt.m2781rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z3, null, function0, 16, null), null, 1, null);
                Function2<Composer, Integer, Unit> function22 = function2;
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.Companion.getTopStart(), true);
                ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
    ...
    /* JADX WARN: Type inference failed for: r20v3 */
    /* renamed from: Surface-d85dljk  reason: not valid java name */
    public static final void m2999Surfaced85dljk(final boolean z, final Function1<? super Boolean, Unit> function1, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i, int i2, int i3) {
        ?? r20;
        ...
        CompositionLocalKt.CompositionLocalProvider(providedValueArr, ComposableLambdaKt.rememberComposableLambda(-1839065134, r20, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$4
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer2);
                m3003surfaceXOJAsU = SurfaceKt.m3003surfaceXOJAsU(minimumInteractiveComponentSize, shape2, m3004surfaceColorAtElevationCLU3JFs, borderStroke4, ((Density) consume2).mo430toPx0680j_4(m7996constructorimpl2));
                Modifier childSemantics$default = ChildParentSemanticsKt.childSemantics$default(ToggleableKt.m1178toggleableO2vRcR0$default(m3003surfaceXOJAsU, z, mutableInteractionSource3, RippleKt.m2781rippleH2RKhps$default(false, 0.0f, 0L, 7, null), z3, null, function1, 16, null), null, 1, null);
                Function2<Composer, Integer, Unit> function22 = function2;
                ComposerKt.sourceInformationMarkerStart(composer2, 733328855, "CC(Box)P(2,1,3)71@3423L130:Box.kt#2w3rfo");
                MeasurePolicy maybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.Companion.getTopStart(), true);
                ComposerKt.sourceInformationMarkerStart(composer2, -1323940314, "CC(Layout)P(!1,2)79@3206L23,82@3357L359:Layout.kt#80mrfh");
    ...
    public static final Modifier m3003surfaceXOJAsU(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        Shape shape2;
        Modifier.Companion companion;
        if (f > 0.0f) {
            shape2 = shape;
            companion = GraphicsLayerModifierKt.m5443graphicsLayerAp8cVGQ(Modifier.Companion, (r41 & 1) != 0 ? 1.0f : 0.0f, (r41 & 2) != 0 ? 1.0f : 0.0f, (r41 & 4) == 0 ? 0.0f : 1.0f, (r41 & 8) != 0 ? 0.0f : 0.0f, (r41 & 16) != 0 ? 0.0f : 0.0f, (r41 & 32) != 0 ? 0.0f : f, (r41 & 64) != 0 ? 0.0f : 0.0f, (r41 & 128) != 0 ? 0.0f : 0.0f, (r41 & 256) == 0 ? 0.0f : 0.0f, (r41 & 512) != 0 ? 8.0f : 0.0f, (r41 & 1024) != 0 ? TransformOrigin.Companion.m5688getCenterSzJe1aQ() : 0L, (r41 & 2048) != 0 ? RectangleShapeKt.getRectangleShape() : shape2, (r41 & 4096) != 0 ? false : false, (r41 & 8192) != 0 ? null : null, (r41 & 16384) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (32768 & r41) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : 0L, (r41 & 65536) != 0 ? CompositingStrategy.Companion.m5370getAutoNrFUSI() : 0);
        } else {
            shape2 = shape;
            companion = Modifier.Companion;
        }
        return ClipKt.clip(BackgroundKt.m267backgroundbw27NRU(modifier.then(companion).then(borderStroke != null ? BorderKt.border(Modifier.Companion, borderStroke, shape2) : Modifier.Companion), j, shape2), shape2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-CLU3JFs  reason: not valid java name */
    public static final long m3004surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        long m2128applyTonalElevationRFCenO8 = ColorSchemeKt.m2128applyTonalElevationRFCenO8(MaterialTheme.INSTANCE.getColorScheme(composer, 6), j, f, composer, (i << 3) & 1008);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2128applyTonalElevationRFCenO8;
    }
    ...
    public static final Dp LocalAbsoluteTonalElevation$lambda$3() {
        return Dp.m7994boximpl(Dp.m7996constructorimpl(0));
    }
}
