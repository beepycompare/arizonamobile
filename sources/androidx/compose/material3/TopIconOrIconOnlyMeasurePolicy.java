    ...
    public MeasureResult mo54measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (i < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                float f = 2;
                Placeable mo6875measureBRTryo0 = measurable.mo6875measureBRTryo0(ConstraintsKt.m8230offsetNN6EwU(m8201copyZbe2FdA$default, -measureScope2.mo458roundToPx0680j_4(Dp.m8258constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope2.mo458roundToPx0680j_4(Dp.m8258constructorimpl(this.indicatorVerticalPadding * f))));
                int width = mo6875measureBRTryo0.getWidth() + measureScope2.mo458roundToPx0680j_4(Dp.m8258constructorimpl(this.indicatorHorizontalPadding * f));
                int height = mo6875measureBRTryo0.getHeight() + measureScope2.mo458roundToPx0680j_4(Dp.m8258constructorimpl(this.indicatorVerticalPadding * f));
                ...
                while (i2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        Placeable mo6875measureBRTryo02 = measurable2.mo6875measureBRTryo0(ConstraintsKt.m8226constrainN9IONVI(m8201copyZbe2FdA$default, Constraints.Companion.m8221fixedJhjzzOo(width, height)));
                        ...
                        while (i3 < size3) {
                            ...
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicator")) {
                                ...
                                if (!this.hasLabel) {
                                    return NavigationItemKt.m2757access$placeIconX9ElhV4(measureScope2, mo6875measureBRTryo0, mo6875measureBRTryo02, mo6875measureBRTryo03, j);
                                }
                                ...
                                while (i4 < size4) {
                                    ...
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), Constants.ScionAnalytics.PARAM_LABEL)) {
                                        return NavigationItemKt.m2759access$placeLabelAndTopIconqoqLrGI(measureScope2, measurable4.mo6875measureBRTryo0(ConstraintsKt.m8231offsetNN6EwU$default(m8201copyZbe2FdA$default, 0, -(mo6875measureBRTryo03.getHeight() + measureScope2.mo458roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null)), mo6875measureBRTryo0, mo6875measureBRTryo02, mo6875measureBRTryo03, j, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                    }
                                    i4++;
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(LayoutUtilKt.getLayoutId(intrinsicMeasurable2), "icon")) {
                ...
                float f = 2;
                return maxIntrinsicHeight + maxIntrinsicHeight2 + intrinsicMeasureScope.mo458roundToPx0680j_4(Dp.m8258constructorimpl(Dp.m8258constructorimpl(Dp.m8258constructorimpl(this.topIconItemVerticalPadding * f) + Dp.m8258constructorimpl(this.indicatorVerticalPadding * f)) + this.indicatorToLabelVerticalPadding));
            }
        }
        ListUtilsKt.throwNoSuchElementException("Collection contains no element matching the predicate.");
        throw new KotlinNothingValueException();
