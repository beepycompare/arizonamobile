...
public final class PersistentOrderedMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public PersistentMap<K, V> build() {
        ...
        if (build == this.map.getHashMap$runtime()) {
            CommonFunctionsKt.m3984assert(this.firstKey == this.map.getFirstKey$runtime());
            CommonFunctionsKt.m3984assert(this.lastKey == this.map.getLastKey$runtime());
    ...
    public V put(K k, V v) {
        ...
        if (linkedValue != null) {
            ...
            CommonFunctionsKt.m3984assert(!linkedValue3.getHasNext());
