...
public final class ExtensionsKt {
    ...
    public static final <E> PersistentSet<E> persistentSetOf(E... eArr) {
        return PersistentOrderedSet.Companion.emptyOf$runtime().addAll((Collection) ArraysKt.asList(eArr));
    }
    ...
    public static final <E> PersistentSet<E> persistentHashSetOf(E... eArr) {
        return PersistentHashSet.Companion.emptyOf$runtime().addAll((Collection) ArraysKt.asList(eArr));
    }
    ...
    public static final <T> PersistentSet<T> toPersistentHashSet(Iterable<? extends T> iterable) {
        ...
        return plus(PersistentHashSet.Companion.emptyOf$runtime(), (Iterable) iterable);
    }
    ...
    public static final <K, V> PersistentMap<K, V> toPersistentMap(Map<K, ? extends V> map) {
        ...
        return build == null ? PersistentOrderedMap.Companion.emptyOf$runtime().putAll((Map) map) : build;
    }
