...
public final class RememberSaveableKt {
    ...
    public static final <T> T m4724rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, String str, Function0<? extends T> function0, Composer composer, int i, int i2) {
        Object[] objArr2;
        final T t;
    ...
    public static final <T> T rememberSaveable(Object[] objArr, Function0<? extends T> function0, Composer composer, int i) {
        ...
        T t = (T) m4724rememberSaveable(Arrays.copyOf(objArr, objArr.length), SaverKt.autoSaver(), (String) null, function0, composer, ((i << 6) & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    /* renamed from: rememberSaveable  reason: collision with other method in class */
    public static final <T> T m4725rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, Function0<? extends T> function0, Composer composer, int i) {
        ...
        T t = (T) m4724rememberSaveable(Arrays.copyOf(objArr, objArr.length), saver, (String) null, function0, composer, (i & 112) | RendererCapabilities.DECODER_SUPPORT_MASK | ((i << 3) & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, Function0<? extends MutableState<T>> function0, Composer composer, int i) {
        ...
        MutableState<T> mutableState = (MutableState) m4724rememberSaveable(Arrays.copyOf(objArr, objArr.length), (Saver<Object, ? extends Object>) mutableStateSaver(saver), (String) null, (Function0<? extends Object>) function0, composer, ((i << 3) & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, String str, Function0<? extends MutableState<T>> function0, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) m4724rememberSaveable(Arrays.copyOf(objArr, objArr.length), (Saver<Object, ? extends Object>) mutableStateSaver(saver), str2, (Function0<? extends Object>) function0, composer, i & 8064, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
