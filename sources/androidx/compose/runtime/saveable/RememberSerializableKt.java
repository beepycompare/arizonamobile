...
public final class RememberSerializableKt {
    ...
    public static final /* synthetic */ <T> T m3984rememberSerializable(Object[] objArr, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) m3985rememberSerializable(copyOf, SerializersKt.serializer(serializersModule, (KType) null), savedStateConfiguration2, function0, composer, (i << 3) & 8064, 0);
        ComposerKt.sourceInformationMarkerEnd(composer);
        return t;
    }

    /* renamed from: rememberSerializable  reason: collision with other method in class */
    public static final <T> T m3985rememberSerializable(Object[] objArr, KSerializer<T> kSerializer, SavedStateConfiguration savedStateConfiguration, Function0<? extends T> function0, Composer composer, int i, int i2) {
        ...
        T t = (T) RememberSaveableKt.m3982rememberSaveable(Arrays.copyOf(objArr, objArr.length), SerializableSaverKt.serializableSaver(kSerializer, savedStateConfiguration), (String) null, function0, composer, (i & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final <T> MutableState<T> rememberSerializable(Object[] objArr, KSerializer<T> kSerializer, SavedStateConfiguration savedStateConfiguration, Function0<? extends MutableState<T>> function0, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) RememberSaveableKt.m3982rememberSaveable(Arrays.copyOf(objArr, objArr.length), (Saver<Object, ? extends Object>) RememberSaveableKt.mutableStateSaver(SerializableSaverKt.serializableSaver(kSerializer, savedStateConfiguration)), (String) null, (Function0<? extends Object>) function0, composer, (i & 7168) | RendererCapabilities.DECODER_SUPPORT_MASK, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
