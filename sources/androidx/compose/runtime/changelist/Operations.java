...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> function1) {
        pushOp(operation);
        function1.invoke(WriteScope.m3928boximpl(WriteScope.m3929constructorimpl(this)));
    ...
    private final String exceptionMessageForOperationPushWithScope(Operation operation) {
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) == 0) {
                ...
                sb3.append(operation.mo3879objectParamName31yXWZQ(Operation.ObjectParameter.m3905constructorimpl(i4)));
                i3++;
            }
        }
    ...
    private final int m3927topObjectIndexOf31yXWZQ(int i) {
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m3928boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static Operations m3929constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m3930equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).m3942unboximpl());
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m3931equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m3933hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m3941toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m3930equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m3933hashCodeimpl(this.stack);
        }

        public String toString() {
            return m3941toStringimpl(this.stack);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ Operations m3942unboximpl() {
            return this.stack;
        }
        ...
        public static final void m3934setIntimpl(Operations operations, int i, int i2) {
        ...
        public static final void m3935setIntsimpl(Operations operations, int i, int i2, int i3, int i4) {
        ...
        /* renamed from: setInts-impl  reason: not valid java name */
        public static final void m3936setIntsimpl(Operations operations, int i, int i2, int i3, int i4, int i5, int i6) {
            int ints = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] iArr = operations.intArgs;
            iArr[i + ints] = i2;
            iArr[i3 + ints] = i4;
        ...
        public static final <T> void m3937setObjectDKhxnng(Operations operations, int i, T t) {
        ...
        public static final <T, U> void m3938setObjects4uCC6AY(Operations operations, int i, T t, int i2, U u) {
        ...
        public static final <T, U, V> void m3940setObjectst7hvbck(Operations operations, int i, T t, int i2, U u, int i3, V v) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final <T, U, V, W> void m3939setObjectsOGa0p1M(Operations operations, int i, T t, int i2, U u, int i3, V v, int i4, W w) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final Operation m3932getOperationimpl(Operations operations) {
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public <T> T mo3926getObject31yXWZQ(int i) {
    ...
    public final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int m3905constructorimpl = Operation.ObjectParameter.m3905constructorimpl(i2);
            String mo3879objectParamName31yXWZQ = operation.mo3879objectParamName31yXWZQ(m3905constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append(...)");
            sb.append(indent);
            sb.append(mo3879objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo3926getObject31yXWZQ(m3905constructorimpl), indent));
        }
        Intrinsics.checkNotNullExpressionValue(sb.append('\n'), "append(...)");
        sb.append(str);
        sb.append(")");
