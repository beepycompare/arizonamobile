...
public final class Pending {
    ...
    public Pending(List<KeyInfo> list, int i) {
        ...
        this.keyMap$delegate = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m4675boximpl(m4547invokefVlnmYg());
            }

            /* renamed from: invoke-fVlnmYg  reason: not valid java name */
            public final MutableScatterMap<Object, Object> m4547invokefVlnmYg() {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    MultiValueMap.m4674addimpl(multiMap, joinedKey, keyInfo2);
                }
                return multiMap;
            }
        });
    ...
    public final MutableScatterMap<Object, Object> m4546getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap$delegate.getValue()).m4692unboximpl();
    }

    public final KeyInfo getNext(int i, Object obj) {
        return (KeyInfo) MultiValueMap.m4687removeFirstimpl(m4546getKeyMapfVlnmYg(), obj != null ? new JoinedKey(Integer.valueOf(i), obj) : Integer.valueOf(i));
    }
