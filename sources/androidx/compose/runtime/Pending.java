...
public final class Pending {
    ...
    public Pending(List<KeyInfo> list, int i) {
        ...
        this.keyMap$delegate = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m4674boximpl(m4546invokefVlnmYg());
            }

            /* renamed from: invoke-fVlnmYg  reason: not valid java name */
            public final MutableScatterMap<Object, Object> m4546invokefVlnmYg() {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    MultiValueMap.m4673addimpl(multiMap, joinedKey, keyInfo2);
                }
                return multiMap;
            }
        });
    ...
    public final MutableScatterMap<Object, Object> m4545getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap$delegate.getValue()).m4691unboximpl();
    }

    public final KeyInfo getNext(int i, Object obj) {
        return (KeyInfo) MultiValueMap.m4686removeFirstimpl(m4545getKeyMapfVlnmYg(), obj != null ? new JoinedKey(Integer.valueOf(i), obj) : Integer.valueOf(i));
    }
