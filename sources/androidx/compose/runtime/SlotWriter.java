...
public final class SlotWriter {
    ...
    public final boolean removeGroup() {
        ...
        if (mutableIntList != null) {
            while (PrioritySet.m4556isNotEmptyimpl(mutableIntList) && PrioritySet.m4557peekimpl(mutableIntList) >= i) {
                PrioritySet.m4558takeMaximpl(mutableIntList);
            }
        }
    ...
    public final boolean inGroup(Anchor anchor, Anchor anchor2) {
        ...
        return anchorIndex <= location$runtime && location$runtime < access$groupSize;
    }
    ...
    private final void recalculateMarks() {
        MutableIntList mutableIntList = this.pendingRecalculateMarks;
        if (mutableIntList != null) {
            while (PrioritySet.m4556isNotEmptyimpl(mutableIntList)) {
                m4576updateContainsMarkNowXpTMRCE(PrioritySet.m4558takeMaximpl(mutableIntList), mutableIntList);
            }
        }
    }
    ...
    public final void updateContainsMark(int i) {
        if (i >= 0) {
            MutableIntList mutableIntList = this.pendingRecalculateMarks;
            if (mutableIntList == null) {
                mutableIntList = PrioritySet.m4551constructorimpl$default(null, 1, null);
                this.pendingRecalculateMarks = mutableIntList;
            }
            PrioritySet.m4548addimpl(mutableIntList, i);
        }
    }

    /* renamed from: updateContainsMarkNow-XpTMRCE  reason: not valid java name */
    private final void m4576updateContainsMarkNowXpTMRCE(int i, MutableIntList mutableIntList) {
        int groupIndexToAddress = groupIndexToAddress(i);
        ...
        if (((iArr[(groupIndexToAddress * 5) + 1] & 67108864) != 0) != childContainsAnyMarks) {
            ...
            int parent = parent(i);
            if (parent >= 0) {
                PrioritySet.m4548addimpl(mutableIntList, parent);
            }
        }
    }
