...
public final class ManagedRetainedValuesStore implements RetainedValuesStore {
    ...
    private final MutableScatterMap<Object, Object> keptExitedValues = SafeMultiValueMap.m4720constructorimpl$default(null, 1, null);
    ...
    public void onContentExitComposition() {
        ...
        if (!SafeMultiValueMap.m4727isEmptyimpl(this.keptExitedValues)) {
    ...
    private final void purgeUnusedExitedValues() {
        ...
        SafeMultiValueMap.m4718clearimpl(this.keptExitedValues);
    }

    @Override // androidx.compose.runtime.retain.RetainedValuesStore
    public Object consumeExitedValueOrDefault(Object obj, Object obj2) {
        return SafeMultiValueMap.m4731removeLastimpl(this.keptExitedValues, obj, obj2);
    }

    @Override // androidx.compose.runtime.retain.RetainedValuesStore
    public void saveExitingValue(Object obj, Object obj2) {
        if (isRetainingExitedValues()) {
            SafeMultiValueMap.m4716addimpl(this.keptExitedValues, obj, obj2);
