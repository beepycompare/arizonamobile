...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m4014recordReadInh_f27i8$runtime(int i) {
        int m3996constructorimpl;
        do {
            m3996constructorimpl = ReaderKind.m3996constructorimpl(this.readerKind.get());
            if ((m3996constructorimpl & i) != 0) {
                return;
            }
        } while (!this.readerKind.compareAndSet(m3996constructorimpl, ReaderKind.m3996constructorimpl(m3996constructorimpl | i)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime  reason: not valid java name */
    public final boolean m4013isReadInh_f27i8$runtime(int i) {
        return (i & ReaderKind.m3996constructorimpl(this.readerKind.get())) != 0;
    }
}
