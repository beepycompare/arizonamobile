...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m4746boximpl(int i) {
        return new ReaderKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4747constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4749equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m4755unboximpl();
    }
    ...
    public static final boolean m4752isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m4749equalsimpl(this.mask, obj);
    }
    ...
    public String toString() {
        return m4753toStringimpl(this.mask);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m4755unboximpl() {
        return this.mask;
    }
    ...
    public static /* synthetic */ int m4748constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m4747constructorimpl(i);
    }
    ...
    public static final int m4754withReadIn3QSx2Dw(int i, int i2) {
        return m4747constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m4756getComposition6f8NoZ8() {
            return ReaderKind.m4747constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8  reason: not valid java name */
        public final int m4757getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m4747constructorimpl(2);
        }
    }
}
