...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m4220boximpl(int i) {
        return new ReaderKind(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4221constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4223equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m4229unboximpl();
    }
    ...
    public static final boolean m4226isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4227toStringimpl(int i) {
        return "ReaderKind(mask=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m4223equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m4225hashCodeimpl(this.mask);
    }

    public String toString() {
        return m4227toStringimpl(this.mask);
    }
    ...
    public static /* synthetic */ int m4222constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m4221constructorimpl(i);
    }
    ...
    public static final int m4228withReadIn3QSx2Dw(int i, int i2) {
        return m4221constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m4230getComposition6f8NoZ8() {
            return ReaderKind.m4221constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8  reason: not valid java name */
        public final int m4232getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m4221constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8  reason: not valid java name */
        public final int m4231getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m4221constructorimpl(4);
        }
    }
}
