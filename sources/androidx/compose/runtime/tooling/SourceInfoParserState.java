...
final class SourceInfoParserState {
    ...
    public final Void throwParseError(String str) {
        ...
        StringBuilder append = new StringBuilder("Error while parsing source information: ").append(str).append(" at ");
    ...
    public final void skipUntil(String str) {
        while (this.i < this.data.length() && !StringsKt.contains$default((CharSequence) str, this.data.charAt(this.i), false, 2, (Object) null)) {
            this.i++;
        }
    }
