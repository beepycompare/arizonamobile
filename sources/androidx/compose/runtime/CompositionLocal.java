...
public abstract class CompositionLocal<T> {
    ...
    public abstract ValueHolder<T> updatedStateOf$runtime(ProvidedValue<T> providedValue, ValueHolder<T> valueHolder);
