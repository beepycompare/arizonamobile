...
public final class AwaiterQueue<A extends Awaiter> {
    ...
    private final AtomicInt pendingAwaitersCountUnlocked = AtomicAwaitersCount.m4686constructorimpl();
    ...
    /* compiled from: AwaiterQueue.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\b'\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0004\u001a\u00020\u0005H&J\u0010\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\bH&¨\u0006\t"}, d2 = {"Landroidx/compose/runtime/internal/AwaiterQueue$Awaiter;", "", "<init>", "()V", FacebookDialog.COMPLETION_GESTURE_CANCEL, "", "resumeWithException", "exception", "", "runtime"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes.dex */
    ...
    public final CancellationHandle addAwaiter(final A a2, Function0<Unit> function0) {
        int i;
        int i2;
    ...
    public final void flushAndDispatchAwaiters(Function1<? super A, Unit> function1) {
        int i;
        int i2;
        synchronized (this.lock) {
            ...
            do {
                i = atomicInt.get();
            } while (!atomicInt.compareAndSet(i, AtomicAwaitersCount.m4697packimpl(atomicInt, ((i >>> 27) & 15) + 1, 0)));
    ...
    public final void fail(Throwable th) {
        ...
        synchronized (this.lock) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ((Awaiter) objArr[i3]).resumeWithException(th);
            }
            this.awaiters.clear();
            AtomicInt atomicInt = this.pendingAwaitersCountUnlocked;
            do {
