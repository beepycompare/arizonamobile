    ...
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long j) {
            ...
            try {
                ...
                m9901constructorimpl = Result.m9901constructorimpl(function1.invoke(Long.valueOf(j)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m9901constructorimpl = Result.m9901constructorimpl(ResultKt.createFailure(th));
            }
            cancellableContinuation.resumeWith(m9901constructorimpl);
        }
        ...
        public final void resumeWithException(Throwable th) {
            ...
            if (cancellableContinuation != null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m9901constructorimpl(ResultKt.createFailure(th)));
            }
        }
    }
