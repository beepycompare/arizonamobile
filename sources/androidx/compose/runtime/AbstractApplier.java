...
public abstract class AbstractApplier<T> implements Applier<T> {
    ...
    private final ArrayList<T> stack = Stack.m4581constructorimpl$default(null, 1, null);
    ...
    public void down(T t) {
        Stack.m4591pushimpl(this.stack, getCurrent());
        setCurrent(t);
    }
    ...
    @Override // androidx.compose.runtime.Applier
    public void up() {
        setCurrent(Stack.m4590popimpl(this.stack));
    }

    @Override // androidx.compose.runtime.Applier
    public final void clear() {
        Stack.m4579clearimpl(this.stack);
