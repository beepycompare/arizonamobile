...
public abstract class AbstractApplier<T> implements Applier<T> {
    ...
    private final ArrayList<T> stack = Stack.m4026constructorimpl$default(null, 1, null);
    ...
    public void down(T t) {
        Stack.m4036pushimpl(this.stack, getCurrent());
        setCurrent(t);
    }
    ...
    @Override // androidx.compose.runtime.Applier
    public void up() {
        setCurrent(Stack.m4035popimpl(this.stack));
    }

    @Override // androidx.compose.runtime.Applier
    public final void clear() {
        Stack.m4024clearimpl(this.stack);
