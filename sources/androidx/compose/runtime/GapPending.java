...
final class GapPending {
    ...
    public GapPending(List<KeyInfo> list, int i) {
        ...
        this.keyMap$delegate = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.GapPending$keyMap$2
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m4481boximpl(m4432invokefVlnmYg());
            }

            /* renamed from: invoke-fVlnmYg  reason: not valid java name */
            public final MutableScatterMap<Object, Object> m4432invokefVlnmYg() {
                ...
                for (int i4 = 0; i4 < size2; i4++) {
                    ...
                    MultiValueMap.m4480addimpl(multiMap, joinedKey, keyInfo2);
                }
                return multiMap;
            }
        });
    ...
    public final MutableScatterMap<Object, Object> m4431getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap$delegate.getValue()).m4499unboximpl();
    }

    public final KeyInfo getNext(int i, Object obj) {
        return (KeyInfo) MultiValueMap.m4494removeFirstimpl(m4431getKeyMapfVlnmYg(), obj != null ? new JoinedKey(Integer.valueOf(i), obj) : Integer.valueOf(i));
    }
