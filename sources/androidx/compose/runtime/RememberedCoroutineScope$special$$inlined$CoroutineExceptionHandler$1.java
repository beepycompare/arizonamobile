...
public final class RememberedCoroutineScope$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    ...
    public void handleException(CoroutineContext coroutineContext, Throwable th) {
        ...
        CoroutineExceptionHandler coroutineExceptionHandler = (CoroutineExceptionHandler) coroutineContext2.get(CoroutineExceptionHandler.Key);
        if (coroutineExceptionHandler != null) {
            coroutineExceptionHandler.handleException(coroutineContext, th);
            return;
        }
        coroutineContext3 = this.this$0.parentContext;
        CoroutineExceptionHandler coroutineExceptionHandler2 = (CoroutineExceptionHandler) coroutineContext3.get(CoroutineExceptionHandler.Key);
