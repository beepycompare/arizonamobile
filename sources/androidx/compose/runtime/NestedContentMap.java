...
public final class NestedContentMap {
    private final MutableScatterMap<Object, Object> contentMap = MultiValueMap.m4756constructorimpl$default(null, 1, null);
    private final MutableScatterMap<Object, Object> containerMap = MultiValueMap.m4756constructorimpl$default(null, 1, null);

    public final void add(MovableContent<Object> movableContent, NestedMovableContent nestedMovableContent) {
        MultiValueMap.m4752addimpl(this.contentMap, movableContent, nestedMovableContent);
        MultiValueMap.m4752addimpl(this.containerMap, nestedMovableContent.getContainer(), movableContent);
    }

    public final void clear() {
        MultiValueMap.m4754clearimpl(this.contentMap);
        MultiValueMap.m4754clearimpl(this.containerMap);
    }

    public final NestedMovableContent removeLast(MovableContent<Object> movableContent) {
        NestedMovableContent nestedMovableContent = (NestedMovableContent) MultiValueMap.m4767removeLastimpl(this.contentMap, movableContent);
        if (MultiValueMap.m4764isEmptyimpl(this.contentMap)) {
            MultiValueMap.m4754clearimpl(this.containerMap);
        }
    ...
    public final boolean contains(MovableContent<Object> movableContent) {
        return MultiValueMap.m4757containsimpl(this.contentMap, movableContent);
    }
        ...
        if (obj != null) {
            if (obj instanceof MutableObjectList) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    MultiValueMap.m4768removeValueIfimpl(this.contentMap, (MovableContent) obj2, new Function1() { // from class: androidx.compose.runtime.NestedContentMap$$ExternalSyntheticLambda0
            ...
            MultiValueMap.m4768removeValueIfimpl(this.contentMap, (MovableContent) obj, new Function1() { // from class: androidx.compose.runtime.NestedContentMap$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj3) {
                    boolean usedContainer$lambda$0$0;
                    usedContainer$lambda$0$0 = NestedContentMap.usedContainer$lambda$0$0(MovableContentStateReference.this, (NestedMovableContent) obj3);
