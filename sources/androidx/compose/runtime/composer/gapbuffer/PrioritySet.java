...
public final class PrioritySet {
    ...
    public static final /* synthetic */ PrioritySet m4540boximpl(MutableIntList mutableIntList) {
        return new PrioritySet(mutableIntList);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static MutableIntList m4541constructorimpl(MutableIntList mutableIntList) {
        return mutableIntList;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4543equalsimpl(MutableIntList mutableIntList, Object obj) {
        return (obj instanceof PrioritySet) && Intrinsics.areEqual(mutableIntList, ((PrioritySet) obj).m4552unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4544equalsimpl0(MutableIntList mutableIntList, MutableIntList mutableIntList2) {
        return Intrinsics.areEqual(mutableIntList, mutableIntList2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4545hashCodeimpl(MutableIntList mutableIntList) {
        return mutableIntList.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m4550toStringimpl(MutableIntList mutableIntList) {
        return "PrioritySet(list=" + mutableIntList + ')';
    }

    public boolean equals(Object obj) {
        return m4543equalsimpl(this.list, obj);
    }

    public int hashCode() {
        return m4545hashCodeimpl(this.list);
    }

    public String toString() {
        return m4550toStringimpl(this.list);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ MutableIntList m4552unboximpl() {
        return this.list;
    }
    ...
    public static final void m4539addimpl(MutableIntList mutableIntList, int i) {
    ...
    public static final boolean m4546isEmptyimpl(MutableIntList mutableIntList) {
        return mutableIntList._size == 0;
    }

    /* renamed from: isNotEmpty-impl  reason: not valid java name */
    public static final boolean m4547isNotEmptyimpl(MutableIntList mutableIntList) {
        return mutableIntList._size != 0;
    }

    /* renamed from: peek-impl  reason: not valid java name */
    public static final int m4548peekimpl(MutableIntList mutableIntList) {
        return mutableIntList.first();
    }

    /* renamed from: takeMax-impl  reason: not valid java name */
    public static final int m4549takeMaximpl(MutableIntList mutableIntList) {
        int i;
        MutableIntList mutableIntList2 = mutableIntList;
        int i2 = mutableIntList2._size;
    ...
    public static final void m4551validateHeapimpl(MutableIntList mutableIntList) {
    ...
    public static /* synthetic */ MutableIntList m4542constructorimpl$default(MutableIntList mutableIntList, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            mutableIntList = new MutableIntList(0, 1, null);
        }
        return m4541constructorimpl(mutableIntList);
    }
}
