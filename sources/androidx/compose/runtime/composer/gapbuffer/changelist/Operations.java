...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> function1) {
        pushOp(operation);
        function1.invoke(WriteScope.m4603boximpl(WriteScope.m4604constructorimpl(this)));
    ...
    private final String exceptionMessageForOperationPushWithScope(Operation operation) {
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) == 0) {
                ...
                sb3.append(operation.mo4555objectParamNamePtLUHM(Operation.ObjectParameter.m4581constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m4603boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static Operations m4604constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m4605equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && Intrinsics.areEqual(operations, ((WriteScope) obj).m4617unboximpl());
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m4606equalsimpl0(Operations operations, Operations operations2) {
            return Intrinsics.areEqual(operations, operations2);
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m4608hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m4616toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m4605equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m4608hashCodeimpl(this.stack);
        }

        public String toString() {
            return m4616toStringimpl(this.stack);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ Operations m4617unboximpl() {
            return this.stack;
        }
        ...
        public static final void m4609setIntimpl(Operations operations, int i, int i2) {
        ...
        public static final void m4610setIntsimpl(Operations operations, int i, int i2, int i3, int i4) {
        ...
        /* renamed from: setInts-impl  reason: not valid java name */
        public static final void m4611setIntsimpl(Operations operations, int i, int i2, int i3, int i4, int i5, int i6) {
            int ints = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] iArr = operations.intArgs;
            iArr[i + ints] = i2;
            iArr[i3 + ints] = i4;
        ...
        public static final <T> void m4612setObjectsGr0YRc(Operations operations, int i, T t) {
        ...
        public static final <T, U> void m4613setObjectsEsEZvaA(Operations operations, int i, T t, int i2, U u) {
        ...
        public static final <T, U, V> void m4614setObjectsJOGOPjs(Operations operations, int i, T t, int i2, U u, int i3, V v) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final <T, U, V, W> void m4615setObjectsfiWQlIY(Operations operations, int i, T t, int i2, U u, int i3, V v, int i4, W w) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final Operation m4607getOperationimpl(Operations operations) {
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public <T> T mo4601getObjectPtLUHM(int i) {
    ...
    public final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int m4581constructorimpl = Operation.ObjectParameter.m4581constructorimpl(i2);
            String mo4555objectParamNamePtLUHM = operation.mo4555objectParamNamePtLUHM(m4581constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            sb.append('\n');
            sb.append(indent);
            sb.append(mo4555objectParamNamePtLUHM);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo4601getObjectPtLUHM(m4581constructorimpl), indent));
        }
        sb.append('\n');
        sb.append(str);
        sb.append(")");
