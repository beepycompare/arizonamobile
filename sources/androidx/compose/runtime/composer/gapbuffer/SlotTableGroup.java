...
public final class SlotTableGroup implements CompositionGroup, Iterable<CompositionGroup>, KMappedMarker {
    ...
    public Object getKey() {
        ...
        if (i != 0) {
            ...
            Object obj = m4553getSlots[objectKeyIndex];
    ...
    public Object getNode() {
        if ((this.table.getGroups()[(this.group * 5) + 1] & 1073741824) != 0) {
            return this.table.m4553getSlots()[this.table.getGroups()[(this.group * 5) + 4]];
        }
        return null;
    }
    ...
    public CompositionGroup find(Object obj) {
        if (obj instanceof GapAnchor) {
            return find$findAnchoredGroup(this, (GapAnchor) obj);
        }
