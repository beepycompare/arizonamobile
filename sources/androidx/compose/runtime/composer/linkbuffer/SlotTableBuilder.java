...
public final class SlotTableBuilder {
    ...
    public final long getParentHandle() {
        return ((this.previousSiblingStack.tos == 0 ? -1 : this.previousSiblingStack.peek()) << 32) | (UInt.m10020constructorimpl(this.parent) & 4294967295L);
    }
    ...
    public final long lastRoot() {
        ...
        return (i << 32) | (UInt.m10020constructorimpl(root) & 4294967295L);
    }
