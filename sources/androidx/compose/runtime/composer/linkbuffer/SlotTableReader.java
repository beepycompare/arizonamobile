...
public final class SlotTableReader {
    ...
    public final long getParentHandle() {
        return UInt.m9943constructorimpl(this.parent) & 4294967295L;
    }
    ...
    public final long rootHandle() {
        return (UInt.m9943constructorimpl(this.table.getRoot()) & 4294967295L) | (-4294967296L);
    }
    ...
    public final List<KeyInfo> extractKeys() {
        ...
        if (!getInEmpty()) {
            ...
            while (i >= 0) {
                int i4 = iArr[i + 4];
                int i5 = i3 + 1;
                arrayList.add(new KeyInfo(iArr[i], (i4 & 16777216) == 16777216 ? objArr[(iArr[i + 5] >> 4) + Integer.bitCount(i4 & 8388608)] : null, (i2 << 32) | (UInt.m9943constructorimpl(i) & 4294967295L), (i4 & 8388608) == 8388608 ? 1 : 8388607 & i4, i3));
                int i6 = i;
                i = groups[i + 1];
                i2 = i6;
                i3 = i5;
    ...
    */
    ...
    public final void traverseChildrenByHandle(int i, Function1<? super Long, Unit> function1) {
        long m9943constructorimpl = UInt.m9943constructorimpl(firstChildOf(i)) & 4294967295L;
        long j = -4294967296L;
        while (true) {
            long j2 = m9943constructorimpl | j;
            if (GroupHandleKt.getGroup(j2) == -1) {
                return;
            }
            function1.invoke(Long.valueOf(j2));
            j = GroupHandleKt.getGroup(j2) << 32;
            m9943constructorimpl = UInt.m9943constructorimpl(nextSiblingOf(GroupHandleKt.getGroup(j2))) & 4294967295L;
        }
    }
    ...
    public final void reposition(int i) {
        reposition(UInt.m9943constructorimpl(i) & 4294967295L);
    }
}
