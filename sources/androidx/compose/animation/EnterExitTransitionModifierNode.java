...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m109setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m110sizeByStateUzc_VyU(EnterExitState enterExitState, long j) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m8323boximpl(j)).m8335unboximpl();
                }
            } else if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m8323boximpl(j)).m8335unboximpl();
                }
            }
        }
        return j;
    ...
    public final long m112targetOffsetByStateoFUgxo0(EnterExitState enterExitState, long j) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    if (changeSize != null) {
                        long m8335unboximpl = changeSize.getSize().invoke(IntSize.m8323boximpl(j)).m8335unboximpl();
                        Alignment alignment = getAlignment();
                        Intrinsics.checkNotNull(alignment);
                        long mo4771alignKFBX0sM = alignment.mo4771alignKFBX0sM(j, m8335unboximpl, LayoutDirection.Ltr);
                        Alignment alignment2 = this.currentAlignment;
                        Intrinsics.checkNotNull(alignment2);
                        return IntOffset.m8291minusqkQi6aY(mo4771alignKFBX0sM, alignment2.mo4771alignKFBX0sM(j, m8335unboximpl, LayoutDirection.Ltr));
                    }
                    return IntOffset.Companion.m8299getZeronOccac();
                }
                return IntOffset.Companion.m8299getZeronOccac();
            }
            return IntOffset.Companion.m8299getZeronOccac();
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long m8326constructorimpl = IntSize.m8326constructorimpl((mo6818measureBRTryo0.getWidth() << 32) | (mo6818measureBRTryo0.getHeight() & 4294967295L));
            this.lookaheadSize = m8326constructorimpl;
            m109setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, (int) (m8326constructorimpl >> 32), (int) (m8326constructorimpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
            ...
            final Placeable mo6818measureBRTryo02 = measurable.mo6818measureBRTryo0(j);
            long m8326constructorimpl2 = IntSize.m8326constructorimpl((mo6818measureBRTryo02.getWidth() << 32) | (mo6818measureBRTryo02.getHeight() & 4294967295L));
            final long j2 = AnimationModifierKt.m73isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : m8326constructorimpl2;
            ...
            State<IntSize> animate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m8323boximpl(m113invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw  reason: not valid java name */
                public final long m113invokeYEO4UFw(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m110sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (animate3 != null) {
                m8326constructorimpl2 = animate3.getValue().m8335unboximpl();
            }
            long m8127constrain4WqzIAM = ConstraintsKt.m8127constrain4WqzIAM(j, m8326constructorimpl2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            long m8299getZeronOccac = (deferredAnimation2 == null || (animate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    SpringSpec springSpec;
                    springSpec = EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m8279boximpl(m114invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4  reason: not valid java name */
                public final long m114invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m112targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.Companion.m8299getZeronOccac() : animate2.getValue().m8297unboximpl();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long m8299getZeronOccac2 = (deferredAnimation3 == null || (animate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m8279boximpl(m115invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4  reason: not valid java name */
                public final long m115invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m111slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.Companion.m8299getZeronOccac() : animate.getValue().m8297unboximpl();
            Alignment alignment2 = this.currentAlignment;
            final long m8292plusqkQi6aY = IntOffset.m8292plusqkQi6aY(alignment2 != null ? alignment2.mo4771alignKFBX0sM(j2, m8127constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.Companion.m8299getZeronOccac(), m8299getZeronOccac2);
            final long j3 = m8299getZeronOccac;
            return MeasureScope.layout$default(measureScope, (int) (m8127constrain4WqzIAM >> 32), (int) (m8127constrain4WqzIAM & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(Placeable.this, IntOffset.m8288getXimpl(j3) + IntOffset.m8288getXimpl(m8292plusqkQi6aY), IntOffset.m8289getYimpl(j3) + IntOffset.m8289getYimpl(m8292plusqkQi6aY), 0.0f, init);
                }
            }, 4, null);
        } else {
            final Placeable mo6818measureBRTryo03 = measurable.mo6818measureBRTryo0(j);
            return MeasureScope.layout$default(measureScope, mo6818measureBRTryo03.getWidth(), mo6818measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
    ...
    public final long m111slideTargetValueByStateoFUgxo0(EnterExitState enterExitState, long j) {
        ...
        long m8299getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.Companion.m8299getZeronOccac() : slideOffset2.invoke(IntSize.m8323boximpl(j)).m8297unboximpl();
        Slide slide2 = this.exit.getData$animation().getSlide();
        long m8299getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.Companion.m8299getZeronOccac() : slideOffset.invoke(IntSize.m8323boximpl(j)).m8297unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[enterExitState.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return m8299getZeronOccac2;
                }
                throw new NoWhenBranchMatchedException();
            }
