...
public final class ActiveMatchConfigured extends MatchIsOrHasBeenConfigured {
    ...
    public SharedTransitionStateMachine.State mo36configureActiveMatch38uP1EE(SharedElement sharedElement, BoundsProvider boundsProvider, long j, long j2, long j3) {
        SharedTransitionStateMachineKt.m154access$updateTargetDataBGTQxF0(getTargetData(), j, j2, j3, !Intrinsics.areEqual(getTargetBoundsProvider(), boundsProvider));
    ...
    public SharedTransitionStateMachine.State onVisibleContentRemovedDuringTransition() {
        Rect calculateAlternativeTargetBounds = getTargetBoundsProvider().calculateAlternativeTargetBounds(RectKt.m5143Recttz77jQw(Offset.m5108plusMKHz9U(getTargetData().m168getCurrentMfrOffsetF1C5BW0(), getTargetData().m171getTargetStructuralOffsetF1C5BW0()), getTargetData().m170getSizeNHjbRc()));
        if (calculateAlternativeTargetBounds == null) {
            return NoMatchFound.INSTANCE;
        }
        TargetData targetData = new TargetData(calculateAlternativeTargetBounds.m5136getSizeNHjbRc(), getTargetData().m169getInitialMfrOffsetF1C5BW0(), Offset.m5107minusMKHz9U(calculateAlternativeTargetBounds.m5138getTopLeftF1C5BW0(), getTargetData().m168getCurrentMfrOffsetF1C5BW0()), null);
        targetData.m172setCurrentMfrOffsetk4lQ0M(getTargetData().m168getCurrentMfrOffsetF1C5BW0());
