...
public final class SkipToLookaheadSizeNodeKt {
    ...
    public static final Modifier createContentScaleModifier(Modifier modifier, ScaleToBoundsImpl scaleToBoundsImpl, final Function0<Boolean> function0) {
        ...
        if (Intrinsics.areEqual(scaleToBoundsImpl.getContentScale(), ContentScale.Companion.getCrop())) {
            companion = GraphicsLayerModifierKt.graphicsLayer(Modifier.Companion, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadSizeNodeKt$createContentScaleModifier$1
