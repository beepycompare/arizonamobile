...
public final class SharedElement {
    ...
    public final void onLookaheadPlaced(Placeable.PlacementScope placementScope, SharedElementInternalState sharedElementInternalState) {
        ...
        if (getFoundMatch() && sharedElementInternalState.getBoundsAnimation().getTarget() && (coordinates = placementScope.getCoordinates()) != null) {
            long m7434toSizeozmzZPI = IntSizeKt.m7434toSizeozmzZPI(coordinates.mo5962getSizeYbymL2g());
            long m5983localLookaheadPositionOfauaQtc$default = LookaheadScope.m5983localLookaheadPositionOfauaQtc$default(sharedElementInternalState.getSharedElement().scope, sharedElementInternalState.getSharedElement().scope.getLookaheadRoot$animation(), coordinates, 0L, false, 6, null);
            SharedTransitionScopeImpl sharedTransitionScopeImpl = sharedElementInternalState.getSharedElement().scope;
            long m5961localPositionOfS_NoaFU$default = LayoutCoordinates.m5961localPositionOfS_NoaFU$default(sharedElementInternalState.getSharedElement().scope.getLookaheadRoot$animation(), coordinates, 0L, false, 2, null);
            TargetData targetData$animation = getTargetData$animation();
            if (targetData$animation == null) {
                j = m7434toSizeozmzZPI;
                j2 = m5961localPositionOfS_NoaFU$default;
                targetData$animation = new TargetData(j, Offset.m4297minusMKHz9U(m5983localLookaheadPositionOfauaQtc$default, m5961localPositionOfS_NoaFU$default), j2, null);
            } else {
                j = m7434toSizeozmzZPI;
                j2 = m5961localPositionOfS_NoaFU$default;
            }
            if (!Offset.m4290equalsimpl0(targetData$animation.m133getTargetStructuralOffsetF1C5BW0(), j2) || !Size.m4358equalsimpl0(targetData$animation.m132getSizeNHjbRc(), j) || this.targetBoundsProviderChanged) {
                targetData$animation.m136setSizeuvyYCjk(j);
                targetData$animation.m137setTargetStructuralOffsetk4lQ0M(j2);
                if (this.targetBoundsProviderChanged) {
                    targetData$animation.m135setInitialMfrOffsetk4lQ0M(Offset.m4297minusMKHz9U(Offset.m4297minusMKHz9U(m5983localLookaheadPositionOfauaQtc$default, j2), Offset.m4297minusMKHz9U(targetData$animation.m130getCurrentMfrOffsetF1C5BW0(), targetData$animation.m131getInitialMfrOffsetF1C5BW0())));
                }
                if (getCurrentBoundsWhenMatched() == null) {
                    Rect obtainBoundsFromLastTarget = obtainBoundsFromLastTarget();
                    if (obtainBoundsFromLastTarget == null) {
                        obtainBoundsFromLastTarget = RectKt.m4333Recttz77jQw(m5983localLookaheadPositionOfauaQtc$default, j);
                    }
                    setCurrentBoundsWhenMatched(obtainBoundsFromLastTarget);
                }
            }
            targetData$animation.m134setCurrentMfrOffsetk4lQ0M(Offset.m4297minusMKHz9U(m5983localLookaheadPositionOfauaQtc$default, j2));
