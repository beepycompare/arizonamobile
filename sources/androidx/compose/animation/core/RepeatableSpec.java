...
public final class RepeatableSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public final long m175getInitialStartOffsetRmkjzm4() {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RepeatableSpec) {
            ...
            if (repeatableSpec.iterations == this.iterations && Intrinsics.areEqual(repeatableSpec.animation, this.animation) && repeatableSpec.repeatMode == this.repeatMode && StartOffset.m182equalsimpl0(repeatableSpec.initialStartOffset, this.initialStartOffset)) {
                return true;
            }
        }
        return false;
