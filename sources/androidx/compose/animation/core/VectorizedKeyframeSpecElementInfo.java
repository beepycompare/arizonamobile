...
public final class VectorizedKeyframeSpecElementInfo<V extends AnimationVector> {
    ...
    public static /* synthetic */ VectorizedKeyframeSpecElementInfo m209copy2NF0KzA$default(VectorizedKeyframeSpecElementInfo vectorizedKeyframeSpecElementInfo, AnimationVector animationVector, Easing easing, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return vectorizedKeyframeSpecElementInfo.m211copy2NF0KzA(animationVector, easing, i);
    }
    ...
    public final int m210component39TMq4() {
        return this.arcMode;
    }

    /* renamed from: copy-2NF0KzA  reason: not valid java name */
    public final VectorizedKeyframeSpecElementInfo<V> m211copy2NF0KzA(V v, Easing easing, int i) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VectorizedKeyframeSpecElementInfo) {
            ...
            return Intrinsics.areEqual(this.vectorValue, vectorizedKeyframeSpecElementInfo.vectorValue) && Intrinsics.areEqual(this.easing, vectorizedKeyframeSpecElementInfo.easing) && ArcMode.m154equalsimpl0(this.arcMode, vectorizedKeyframeSpecElementInfo.arcMode);
        }
        return false;
    }

    public int hashCode() {
        return (((this.vectorValue.hashCode() * 31) + this.easing.hashCode()) * 31) + ArcMode.m155hashCodeimpl(this.arcMode);
    }

    public String toString() {
        return "VectorizedKeyframeSpecElementInfo(vectorValue=" + this.vectorValue + ", easing=" + this.easing + ", arcMode=" + ((Object) ArcMode.m156toStringimpl(this.arcMode)) + ')';
    }
    ...
    public final int m212getArcMode9TMq4() {
        return this.arcMode;
    }
}
