...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m213usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m212setArcModeRur9ykg$animation_core(i);
            return keyframeEntity;
        }
    }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> twoWayConverter) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            mutableIntObjectMap.set(i7, new VectorizedKeyframeSpecElementInfo(twoWayConverter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core()), keyframeEntity.getEasing$animation_core(), keyframeEntity.m211getArcMode9TMq4$animation_core(), null));
                        } else {
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            i = i3;
        ...
        mutableIntList.sort();
        return new VectorizedKeyframesSpec<>(mutableIntList, mutableIntObjectMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.Companion.m209getArcLinear9TMq4(), null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.Companion.m209getArcLinear9TMq4() : i, null);
        }

        /* renamed from: getArcMode--9T-Mq4$animation_core  reason: not valid java name */
        public final int m211getArcMode9TMq4$animation_core() {
            return this.arcMode;
        }

        /* renamed from: setArcMode-Rur9ykg$animation_core  reason: not valid java name */
        public final void m212setArcModeRur9ykg$animation_core(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof KeyframeEntity) {
                ...
                return Intrinsics.areEqual(keyframeEntity.getValue$animation_core(), getValue$animation_core()) && Intrinsics.areEqual(keyframeEntity.getEasing$animation_core(), getEasing$animation_core()) && ArcMode.m203equalsimpl0(keyframeEntity.arcMode, this.arcMode);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            return ((((value$animation_core != null ? value$animation_core.hashCode() : 0) * 31) + ArcMode.m204hashCodeimpl(this.arcMode)) * 31) + getEasing$animation_core().hashCode();
        }
    }
}
