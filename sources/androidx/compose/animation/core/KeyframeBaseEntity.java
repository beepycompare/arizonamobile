...
public abstract class KeyframeBaseEntity<T> {
    ...
    public final Easing getEasing$animation_core() {
        return this.easing;
    }
    ...
    public final <V extends AnimationVector> Pair<V, Easing> toPair$animation_core(Function1<? super T, ? extends V> function1) {
