...
public final class AnimationSpecKt {
    ...
    public static final <T> RepeatableSpec<T> m173repeatable91I0pcU(int i, DurationBasedAnimationSpec<T> durationBasedAnimationSpec, RepeatMode repeatMode, long j) {
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode) {
        return new RepeatableSpec(i, durationBasedAnimationSpec, repeatMode, StartOffset.m204constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode) {
        return new InfiniteRepeatableSpec(durationBasedAnimationSpec, repeatMode, StartOffset.m204constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
