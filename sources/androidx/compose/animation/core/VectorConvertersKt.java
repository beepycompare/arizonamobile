...
public final class VectorConvertersKt {
    ...
    private static final TwoWayConverter<Dp, AnimationVector1D> DpToVector = TwoWayConverter(new Function1() { // from class: androidx.compose.animation.core.VectorConvertersKt$$ExternalSyntheticLambda3
        ...
        public final Object invoke(Object obj) {
            Dp m8158boximpl;
            m8158boximpl = Dp.m8158boximpl(Dp.m8160constructorimpl(((AnimationVector1D) obj).getValue()));
            return m8158boximpl;
        }
    });
    private static final TwoWayConverter<DpOffset, AnimationVector2D> DpOffsetToVector = TwoWayConverter(new Function1() { // from class: androidx.compose.animation.core.VectorConvertersKt$$ExternalSyntheticLambda5
        ...
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            DpOffset m8215boximpl;
            AnimationVector2D animationVector2D = (AnimationVector2D) obj;
            m8215boximpl = DpOffset.m8215boximpl(DpOffset.m8216constructorimpl((Float.floatToRawIntBits(Dp.m8160constructorimpl(animationVector2D.getV1())) << 32) | (Float.floatToRawIntBits(Dp.m8160constructorimpl(animationVector2D.getV2())) & 4294967295L)));
            return m8215boximpl;
        }
    });
    private static final TwoWayConverter<Size, AnimationVector2D> SizeToVector = TwoWayConverter(new Function1() { // from class: androidx.compose.animation.core.VectorConvertersKt$$ExternalSyntheticLambda7
        ...
        public final Object invoke(Object obj) {
            Size m5160boximpl;
            AnimationVector2D animationVector2D = (AnimationVector2D) obj;
            m5160boximpl = Size.m5160boximpl(Size.m5163constructorimpl((Float.floatToRawIntBits(animationVector2D.getV1()) << 32) | (Float.floatToRawIntBits(animationVector2D.getV2()) & 4294967295L)));
            return m5160boximpl;
        }
    });
    ...
    private static final TwoWayConverter<IntOffset, AnimationVector2D> IntOffsetToVector = TwoWayConverter(new Function1() { // from class: androidx.compose.animation.core.VectorConvertersKt$$ExternalSyntheticLambda11
        ...
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            IntOffset m8279boximpl;
            AnimationVector2D animationVector2D = (AnimationVector2D) obj;
            m8279boximpl = IntOffset.m8279boximpl(IntOffset.m8282constructorimpl((Math.round(animationVector2D.getV1()) << 32) | (Math.round(animationVector2D.getV2()) & 4294967295L)));
            return m8279boximpl;
        }
    });
    ...
    public static final AnimationVector1D DpToVector$lambda$0(Dp dp) {
        return new AnimationVector1D(dp.m8174unboximpl());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static final AnimationVector2D DpOffsetToVector$lambda$0(DpOffset dpOffset) {
        return new AnimationVector2D(DpOffset.m8221getXD9Ej5fM(dpOffset.m8229unboximpl()), DpOffset.m8223getYD9Ej5fM(dpOffset.m8229unboximpl()));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static final AnimationVector2D SizeToVector$lambda$0(Size size) {
        return new AnimationVector2D(Float.intBitsToFloat((int) (size.m5177unboximpl() >> 32)), Float.intBitsToFloat((int) (size.m5177unboximpl() & 4294967295L)));
    }
    ...
    public static final AnimationVector2D IntOffsetToVector$lambda$0(IntOffset intOffset) {
        return new AnimationVector2D(IntOffset.m8288getXimpl(intOffset.m8297unboximpl()), IntOffset.m8289getYimpl(intOffset.m8297unboximpl()));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static final AnimationVector2D IntSizeToVector$lambda$0(IntSize intSize) {
        return new AnimationVector2D((int) (intSize.m8335unboximpl() >> 32), (int) (intSize.m8335unboximpl() & 4294967295L));
    }
    ...
    public static final IntSize IntSizeToVector$lambda$1(AnimationVector2D animationVector2D) {
        ...
        return IntSize.m8323boximpl(IntSize.m8326constructorimpl(((Math.round(animationVector2D.getV2()) >= 0 ? round : 0) & 4294967295L) | (round2 << 32)));
    }
