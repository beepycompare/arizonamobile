...
public final class VectorizedKeyframesSpec<V extends AnimationVector> implements VectorizedDurationBasedAnimationSpec<V> {
    ...
    */
    public VectorizedKeyframesSpec(Map<Integer, ? extends Pair<? extends V, ? extends Easing>> map, int i, int i2) {
        this(r4, r0, i, i2, EasingKt.getLinearEasing(), ArcMode.Companion.m209getArcLinear9TMq4(), null);
        ...
        for (Map.Entry<Integer, ? extends Pair<? extends V, ? extends Easing>> entry2 : map.entrySet()) {
            ...
            mutableIntObjectMap.set(intValue, new VectorizedKeyframeSpecElementInfo(value.getFirst(), value.getSecond(), ArcMode.Companion.m209getArcLinear9TMq4(), null));
        }
    }
    ...
    private final void init(V v, V v2, V v3) {
        ...
        if (this.valueVector == null) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                int m249getArcMode9TMq4 = vectorizedKeyframeSpecElementInfo != null ? vectorizedKeyframeSpecElementInfo.m249getArcMode9TMq4() : this.initialArcMode;
                if (!ArcMode.m203equalsimpl0(m249getArcMode9TMq4, ArcMode.Companion.m209getArcLinear9TMq4())) {
                    z = true;
                }
                iArr[i4] = m249getArcMode9TMq4;
            }
            this.modes = iArr;
        }
        if (z) {
