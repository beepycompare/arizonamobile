...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public final long m162getInitialStartOffsetRmkjzm4() {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof InfiniteRepeatableSpec) {
            ...
            if (Intrinsics.areEqual(infiniteRepeatableSpec.animation, this.animation) && infiniteRepeatableSpec.repeatMode == this.repeatMode && StartOffset.m182equalsimpl0(infiniteRepeatableSpec.initialStartOffset, this.initialStartOffset)) {
                return true;
            }
        }
        return false;
