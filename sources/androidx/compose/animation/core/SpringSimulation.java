...
public final class SpringSimulation {
    ...
    public final long m224updateValuesIJZedt4$animation_core(float f, float f2, long j) {
        double exp;
        double d;
        float f3 = f - this.finalPosition;
        double d2 = j / 1000.0d;
        ...
        return Motion.m215constructorimpl((Float.floatToRawIntBits((float) exp) & 4294967295L) | (Float.floatToRawIntBits((float) (d + this.finalPosition)) << 32));
    }
}
