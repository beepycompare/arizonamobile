...
public final class SkipToLookaheadSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        Placeable mo6818measureBRTryo0;
        if (measureScope.isLookingAhead()) {
            this.lookaheadConstraints = Constraints.m8100boximpl(j);
        }
        if (!isEnabled().invoke().booleanValue()) {
            final Placeable mo6818measureBRTryo02 = measurable.mo6818measureBRTryo0(j);
            return MeasureScope.layout$default(measureScope, mo6818measureBRTryo02.getWidth(), mo6818measureBRTryo02.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadSizeNode$measure$1$1
        ...
        if (measureScope.isLookingAhead()) {
            mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(j);
            this.lookaheadSize = IntSize.m8326constructorimpl((mo6818measureBRTryo0.getWidth() << 32) | (mo6818measureBRTryo0.getHeight() & 4294967295L));
        } else {
            Constraints constraints = this.lookaheadConstraints;
            Intrinsics.checkNotNull(constraints);
            mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(constraints.m8119unboximpl());
        }
        final long m8127constrain4WqzIAM = ConstraintsKt.m8127constrain4WqzIAM(j, this.lookaheadSize);
        final Placeable placeable = mo6818measureBRTryo0;
        return MeasureScope.layout$default(measureScope, (int) (m8127constrain4WqzIAM >> 32), (int) (4294967295L & m8127constrain4WqzIAM), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadSizeNode$measure$2
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                long j2;
                final long m6928constructorimpl;
                long j3;
                long j4;
                long j5;
                long j6;
                ...
                if (((int) (j2 >> 32)) != 0) {
                    ...
                    if (((int) (j5 & 4294967295L)) != 0) {
                        ...
                        m6928constructorimpl = contentScale.mo6811computeScaleFactorH7hwNQA(IntSizeKt.m8343toSizeozmzZPI(j6), IntSizeKt.m8343toSizeozmzZPI(m8127constrain4WqzIAM));
                        Alignment alignment = scaleToBounds.getAlignment();
                        j3 = SkipToLookaheadSizeNode.this.lookaheadSize;
                        int roundToInt = MathKt.roundToInt(((int) (j3 >> 32)) * Float.intBitsToFloat((int) (m6928constructorimpl >> 32)));
                        j4 = SkipToLookaheadSizeNode.this.lookaheadSize;
                        long mo4771alignKFBX0sM = alignment.mo4771alignKFBX0sM(IntSize.m8326constructorimpl((MathKt.roundToInt(((int) (j4 & 4294967295L)) * Float.intBitsToFloat((int) (m6928constructorimpl & 4294967295L))) & 4294967295L) | (roundToInt << 32)), m8127constrain4WqzIAM, measureScope.getLayoutDirection());
                        Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m8288getXimpl(mo4771alignKFBX0sM), IntOffset.m8289getYimpl(mo4771alignKFBX0sM), 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadSizeNode$measure$2.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                                graphicsLayerScope.setScaleX(Float.intBitsToFloat((int) (m6928constructorimpl >> 32)));
                                graphicsLayerScope.setScaleY(Float.intBitsToFloat((int) (m6928constructorimpl & 4294967295L)));
                                graphicsLayerScope.mo5549setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(0.0f, 0.0f));
                            }
                        }, 4, (Object) null);
                    }
                }
                m6928constructorimpl = ScaleFactor.m6928constructorimpl((Float.floatToRawIntBits(1.0f) << 32) | (Float.floatToRawIntBits(1.0f) & 4294967295L));
                Alignment alignment2 = scaleToBounds.getAlignment();
                j3 = SkipToLookaheadSizeNode.this.lookaheadSize;
                int roundToInt2 = MathKt.roundToInt(((int) (j3 >> 32)) * Float.intBitsToFloat((int) (m6928constructorimpl >> 32)));
                j4 = SkipToLookaheadSizeNode.this.lookaheadSize;
                long mo4771alignKFBX0sM2 = alignment2.mo4771alignKFBX0sM(IntSize.m8326constructorimpl((MathKt.roundToInt(((int) (j4 & 4294967295L)) * Float.intBitsToFloat((int) (m6928constructorimpl & 4294967295L))) & 4294967295L) | (roundToInt2 << 32)), m8127constrain4WqzIAM, measureScope.getLayoutDirection());
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m8288getXimpl(mo4771alignKFBX0sM2), IntOffset.m8289getYimpl(mo4771alignKFBX0sM2), 0.0f, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.animation.SkipToLookaheadSizeNode$measure$2.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
