...
public interface AnimatedContentTransitionScope<S> extends Transition.Segment<S> {
    ...
    EnterTransition mo57slideIntoContainermOhB8PU(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1);

    /* renamed from: slideOutOfContainer-mOhB8PU  reason: not valid java name */
    ExitTransition mo58slideOutOfContainermOhB8PU(int i, FiniteAnimationSpec<IntOffset> finiteAnimationSpec, Function1<? super Integer, Integer> function1);
    ...
    public static final class SlideDirection {
        ...
        public static final /* synthetic */ SlideDirection m59boximpl(int i) {
            return new SlideDirection(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static int m60constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m61equalsimpl(int i, Object obj) {
            return (obj instanceof SlideDirection) && i == ((SlideDirection) obj).m65unboximpl();
        }
        ...
        public static int m63hashCodeimpl(int i) {
        ...
        public static String m64toStringimpl(int i) {
            return m62equalsimpl0(i, Left) ? "Left" : m62equalsimpl0(i, Right) ? "Right" : m62equalsimpl0(i, Up) ? "Up" : m62equalsimpl0(i, Down) ? "Down" : m62equalsimpl0(i, Start) ? "Start" : m62equalsimpl0(i, End) ? "End" : "Invalid";
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: slideIntoContainer-mOhB8PU$default  reason: not valid java name */
    static /* synthetic */ EnterTransition m55slideIntoContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m8377boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
            }
            if ((i2 & 4) != 0) {
            ...
            return animatedContentTransitionScope.mo57slideIntoContainermOhB8PU(i, finiteAnimationSpec, function1);
        }
    ...
    static /* synthetic */ ExitTransition m56slideOutOfContainermOhB8PU$default(AnimatedContentTransitionScope animatedContentTransitionScope, int i, FiniteAnimationSpec finiteAnimationSpec, Function1 function1, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                finiteAnimationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m8377boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
            }
            ...
            return animatedContentTransitionScope.mo58slideOutOfContainermOhB8PU(i, finiteAnimationSpec, function1);
        }
