...
public final class SharedElementKt {
    private static final SpringSpec<Offset> DefaultMomentumSpring = AnimationSpecKt.spring$default(0.0f, 400.0f, Offset.m5168boximpl(Offset.m5171constructorimpl((Float.floatToRawIntBits(3.0f) << 32) | (Float.floatToRawIntBits(3.0f) & 4294967295L))), 1, null);
    ...
    public static final long m135toOffsetTH1AsA0(long j) {
        float m8496getXimpl = Velocity.m8496getXimpl(j);
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(Velocity.m8497getYimpl(j)) & 4294967295L) | (Float.floatToRawIntBits(m8496getXimpl) << 32));
    }
