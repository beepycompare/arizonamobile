...
public final class SharedElementKt {
    private static final SpringSpec<Offset> DefaultMomentumSpring = AnimationSpecKt.spring$default(0.0f, 400.0f, Offset.m5092boximpl(Offset.m5095constructorimpl((Float.floatToRawIntBits(3.0f) << 32) | (Float.floatToRawIntBits(3.0f) & 4294967295L))), 1, null);
    ...
    public static final long m146toOffsetTH1AsA0(long j) {
        float m8398getXimpl = Velocity.m8398getXimpl(j);
        return Offset.m5095constructorimpl((Float.floatToRawIntBits(Velocity.m8399getYimpl(j)) & 4294967295L) | (Float.floatToRawIntBits(m8398getXimpl) << 32));
    }
