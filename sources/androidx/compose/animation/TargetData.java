...
public final class TargetData {
    ...
    private TargetData(long j, long j2, long j3) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5160boximpl(j), null, 2, null);
        this.size$delegate = mutableStateOf$default;
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(j2), null, 2, null);
        this.initialMfrOffset$delegate = mutableStateOf$default2;
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(j3), null, 2, null);
        this.targetStructuralOffset$delegate = mutableStateOf$default3;
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(j2), null, 2, null);
        this.currentMfrOffset$delegate = mutableStateOf$default4;
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public final long m170getSizeNHjbRc() {
        return ((Size) this.size$delegate.getValue()).m5177unboximpl();
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m174setSizeuvyYCjk(long j) {
        this.size$delegate.setValue(Size.m5160boximpl(j));
    }

    /* renamed from: getInitialMfrOffset-F1C5BW0  reason: not valid java name */
    public final long m169getInitialMfrOffsetF1C5BW0() {
        return ((Offset) this.initialMfrOffset$delegate.getValue()).m5113unboximpl();
    }
    ...
    public final void m173setInitialMfrOffsetk4lQ0M(long j) {
        this.initialMfrOffset$delegate.setValue(Offset.m5092boximpl(j));
    }
    ...
    public final long m171getTargetStructuralOffsetF1C5BW0() {
        return ((Offset) this.targetStructuralOffset$delegate.getValue()).m5113unboximpl();
    }
    ...
    public final void m175setTargetStructuralOffsetk4lQ0M(long j) {
        this.targetStructuralOffset$delegate.setValue(Offset.m5092boximpl(j));
    }

    /* renamed from: getCurrentMfrOffset-F1C5BW0  reason: not valid java name */
    public final long m168getCurrentMfrOffsetF1C5BW0() {
        return ((Offset) this.currentMfrOffset$delegate.getValue()).m5113unboximpl();
    }
    ...
    public final void m172setCurrentMfrOffsetk4lQ0M(long j) {
        this.currentMfrOffset$delegate.setValue(Offset.m5092boximpl(j));
    }
}
