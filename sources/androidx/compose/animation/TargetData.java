...
public final class TargetData {
    ...
    private TargetData(long j, long j2, long j3) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5236boximpl(j), null, 2, null);
        this.size$delegate = mutableStateOf$default;
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5168boximpl(j2), null, 2, null);
        this.initialMfrOffset$delegate = mutableStateOf$default2;
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5168boximpl(j3), null, 2, null);
        this.targetStructuralOffset$delegate = mutableStateOf$default3;
        mutableStateOf$default4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5168boximpl(j2), null, 2, null);
        this.currentMfrOffset$delegate = mutableStateOf$default4;
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public final long m159getSizeNHjbRc() {
        return ((Size) this.size$delegate.getValue()).m5253unboximpl();
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m163setSizeuvyYCjk(long j) {
        this.size$delegate.setValue(Size.m5236boximpl(j));
    }

    /* renamed from: getInitialMfrOffset-F1C5BW0  reason: not valid java name */
    public final long m158getInitialMfrOffsetF1C5BW0() {
        return ((Offset) this.initialMfrOffset$delegate.getValue()).m5189unboximpl();
    }

    /* renamed from: setInitialMfrOffset-k-4lQ0M  reason: not valid java name */
    public final void m162setInitialMfrOffsetk4lQ0M(long j) {
        this.initialMfrOffset$delegate.setValue(Offset.m5168boximpl(j));
    }

    /* renamed from: getTargetStructuralOffset-F1C5BW0  reason: not valid java name */
    public final long m160getTargetStructuralOffsetF1C5BW0() {
        return ((Offset) this.targetStructuralOffset$delegate.getValue()).m5189unboximpl();
    }

    /* renamed from: setTargetStructuralOffset-k-4lQ0M  reason: not valid java name */
    public final void m164setTargetStructuralOffsetk4lQ0M(long j) {
        this.targetStructuralOffset$delegate.setValue(Offset.m5168boximpl(j));
    }

    /* renamed from: getCurrentMfrOffset-F1C5BW0  reason: not valid java name */
    public final long m157getCurrentMfrOffsetF1C5BW0() {
        return ((Offset) this.currentMfrOffset$delegate.getValue()).m5189unboximpl();
    }

    /* renamed from: setCurrentMfrOffset-k-4lQ0M  reason: not valid java name */
    public final void m161setCurrentMfrOffsetk4lQ0M(long j) {
        this.currentMfrOffset$delegate.setValue(Offset.m5168boximpl(j));
    }
}
