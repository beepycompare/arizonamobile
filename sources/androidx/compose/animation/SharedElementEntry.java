...
public final class SharedElementEntry implements LayerRenderer, RememberObserver {
    ...
    public final Rect calculateTargetBounds(Rect rect) {
        return getUserState().getConfig$animation().m148alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(getUserState(), rect, IntSizeKt.m8343toSizeozmzZPI(getSharedElement().getScope().getLookaheadRoot$animation().mo6826getSizeYbymL2g()));
    }
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        long m5138getTopLeftF1C5BW0 = currentBounds.m5138getTopLeftF1C5BW0();
        float intBitsToFloat = Float.intBitsToFloat((int) (m5138getTopLeftF1C5BW0 >> 32));
        float intBitsToFloat2 = Float.intBitsToFloat((int) (m5138getTopLeftF1C5BW0 & 4294967295L));
