        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m82invoke8_81llA(color.m4782unboximpl());
                }

                /* renamed from: invoke-8_81llA  reason: not valid java name */
                public final AnimationVector4D m82invoke8_81llA(long j) {
                    long m4769convertvNxB06k = Color.m4769convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m4774getAlphaimpl(m4769convertvNxB06k), Color.m4778getRedimpl(m4769convertvNxB06k), Color.m4777getGreenimpl(m4769convertvNxB06k), Color.m4775getBlueimpl(m4769convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m4762boximpl(m83invokevNxB06k(animationVector4D));
                }

                /* renamed from: invoke-vNxB06k  reason: not valid java name */
                public final long m83invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m4769convertvNxB06k(ColorKt.Color(v2, v3, f2, f3 <= 1.0f ? f3 : 1.0f, ColorSpaces.INSTANCE.getOklab()), ColorSpace.this);
                }
            });
        }
    };
