        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m84invoke8_81llA(color.m5358unboximpl());
                }

                /* renamed from: invoke-8_81llA  reason: not valid java name */
                public final AnimationVector4D m84invoke8_81llA(long j) {
                    long m5345convertvNxB06k = Color.m5345convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m5350getAlphaimpl(m5345convertvNxB06k), Color.m5354getRedimpl(m5345convertvNxB06k), Color.m5353getGreenimpl(m5345convertvNxB06k), Color.m5351getBlueimpl(m5345convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m5338boximpl(m85invokevNxB06k(animationVector4D));
                }
                ...
                public final long m85invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m5345convertvNxB06k(ColorKt.Color(v2, v3, f2, f3 <= 1.0f ? f3 : 1.0f, ColorSpaces.INSTANCE.getOklab()), ColorSpace.this);
                }
            });
        }
    };
