    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i2] = mo6818measureBRTryo0;
                m8336getZeroYbymL2g = m8326constructorimpl;
            }
            i2++;
        }
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            if (placeableArr[i3] == null) {
                placeableArr[i3] = measurable2.mo6818measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = (int) (m8336getZeroYbymL2g >> 32);
        } else {
            if (size == 0) {
                placeable2 = null;
            } else {
        ...
        if (measureScope.isLookingAhead()) {
            height = (int) (m8336getZeroYbymL2g & 4294967295L);
        } else {
            if (size != 0) {
        ...
        if (!measureScope.isLookingAhead()) {
            this.rootScope.m66setMeasuredSizeozmzZPI$animation(IntSize.m8326constructorimpl((width << 32) | (height & 4294967295L)));
        }
        return MeasureScope.layout$default(measureScope, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long mo4771alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo4771alignKFBX0sM(IntSize.m8326constructorimpl((placeable5.getWidth() << 32) | (placeable5.getHeight() & 4294967295L)), IntSize.m8326constructorimpl((i5 << 32) | (i6 & 4294967295L)), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m8288getXimpl(mo4771alignKFBX0sM), IntOffset.m8289getYimpl(mo4771alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
