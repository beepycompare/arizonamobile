...
public interface SharedTransitionScope extends LookaheadScope {
    ...
    public interface SharedContentConfig {
        ...
        default Rect m148alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(SharedContentState sharedContentState, Rect rect, long j) {
            return null;
        }
    ...
    public interface PlaceholderSize {
        ...
        long mo147calculateSizeJyjRU_E(long j, long j2);
        ...
        public static final class Companion {
            ...
            private static final PlaceholderSize AnimatedSize = new PlaceholderSize() { // from class: androidx.compose.animation.SharedTransitionScope$PlaceholderSize$Companion$AnimatedSize$1
                ...
                public final long mo147calculateSizeJyjRU_E(long j, long j2) {
                    return j2;
                }
            };
    ...
    default Modifier skipToLookaheadPosition(Modifier modifier, final Function0<Boolean> function0) {
        return LookaheadScopeKt.approachLayout(modifier, new Function1<IntSize, Boolean>() { // from class: androidx.compose.animation.SharedTransitionScope$skipToLookaheadPosition$2
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(IntSize intSize) {
                return m150invokeozmzZPI(intSize.m8335unboximpl());
            }

            /* renamed from: invoke-ozmzZPI  reason: not valid java name */
            public final Boolean m150invokeozmzZPI(long j) {
                return false;
            }
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(ApproachMeasureScope approachMeasureScope, Measurable measurable, Constraints constraints) {
                return m151invoke3p2s80s(approachMeasureScope, measurable, constraints.m8119unboximpl());
            }

            /* renamed from: invoke-3p2s80s  reason: not valid java name */
            public final MeasureResult m151invoke3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
                ...
                return MeasureScope.layout$default(approachMeasureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScope$skipToLookaheadPosition$4$1$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        if (function02.invoke().booleanValue()) {
                            ...
                            if (coordinates != null) {
                                ...
                                Placeable.PlacementScope.m6884place70tqf50$default(placementScope, mo6818measureBRTryo0, IntOffsetKt.m8305roundk4lQ0M(Offset.m5107minusMKHz9U(coordinates.mo6827localPositionOfR5De75A(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), Offset.m5107minusMKHz9U(LookaheadScope.m6848localLookaheadPositionOfauaQtc$default(sharedTransitionScope2, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null), LayoutCoordinates.m6825localPositionOfS_NoaFU$default(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null))), LayoutCoordinates.m6825localPositionOfS_NoaFU$default(coordinates, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), 0L, false, 6, null))), 0.0f, 2, null);
                                return;
                            }
    ...
    static /* synthetic */ Modifier sharedElement$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, BoundsTransform boundsTransform, PlaceholderSize placeholderSize, boolean z, float f, OverlayClip overlayClip, int i, Object obj) {
        if (obj == null) {
            ...
            return sharedTransitionScope.sharedElement(modifier, sharedContentState, animatedVisibilityScope, boundsTransform2, placeholderSize, (i & 16) != 0 ? true : z, (i & 32) != 0 ? 0.0f : f, (i & 64) != 0 ? SharedTransitionScopeKt.access$getParentClip$p() : overlayClip);
        }
    ...
    static /* synthetic */ Modifier sharedBounds$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, EnterTransition enterTransition, ExitTransition exitTransition, BoundsTransform boundsTransform, ResizeMode resizeMode, PlaceholderSize placeholderSize, boolean z, float f, OverlayClip overlayClip, int i, Object obj) {
        if (obj == null) {
            return sharedTransitionScope.sharedBounds(modifier, sharedContentState, animatedVisibilityScope, (i & 4) != 0 ? EnterExitTransitionKt.fadeIn$default(null, 0.0f, 3, null) : enterTransition, (i & 8) != 0 ? EnterExitTransitionKt.fadeOut$default(null, 0.0f, 3, null) : exitTransition, (i & 16) != 0 ? SharedTransitionDefaults.INSTANCE.getBoundsTransform() : boundsTransform, (i & 32) != 0 ? ResizeMode.Companion.scaleToBounds(ContentScale.Companion.getFillWidth(), Alignment.Companion.getCenter()) : resizeMode, (i & 64) != 0 ? PlaceholderSize.Companion.getContentSize() : placeholderSize, (i & 128) != 0 ? true : z, (i & 256) != 0 ? 0.0f : f, (i & 512) != 0 ? SharedTransitionScopeKt.access$getParentClip$p() : overlayClip);
        }
    ...
    static /* synthetic */ Modifier sharedElementWithCallerManagedVisibility$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, SharedContentState sharedContentState, boolean z, BoundsTransform boundsTransform, PlaceholderSize placeholderSize, boolean z2, float f, OverlayClip overlayClip, int i, Object obj) {
        if (obj == null) {
            ...
            return sharedTransitionScope.sharedElementWithCallerManagedVisibility(modifier, sharedContentState, z, boundsTransform2, placeholderSize, (i & 16) != 0 ? true : z2, (i & 32) != 0 ? 0.0f : f, (i & 64) != 0 ? SharedTransitionScopeKt.access$getParentClip$p() : overlayClip);
        }
    ...
    public static final class SharedContentState {
        ...
        public SharedContentState(Object obj, SharedContentConfig sharedContentConfig) {
            ...
            this.key = obj;
            mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(sharedContentConfig, null, 2, null);
            this.config$delegate = mutableStateOf$default;
            mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(null, null, 2, null);
            this.internalState$delegate = mutableStateOf$default2;
        }
        ...
        public final SharedContentConfig getConfig$animation() {
            return (SharedContentConfig) this.config$delegate.getValue();
        }

        public final void setConfig$animation(SharedContentConfig sharedContentConfig) {
            this.config$delegate.setValue(sharedContentConfig);
        }
        ...
        public final void m149prepareTransitionWithInitialVelocityTH1AsA0(long j) {
            SharedElementEntry nonNullInternalState = getNonNullInternalState();
            if (getConfig$animation().isEnabled(this)) {
                nonNullInternalState.getSharedElement().m144updateExitVelocityTH1AsA0$animation(j);
            }
        }
        ...
        public final SharedElementEntry getInternalState$animation() {
            return (SharedElementEntry) this.internalState$delegate.getValue();
        }

        public final void setInternalState$animation(SharedElementEntry sharedElementEntry) {
            this.internalState$delegate.setValue(sharedElementEntry);
        }
