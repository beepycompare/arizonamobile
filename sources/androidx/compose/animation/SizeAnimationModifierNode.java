...
public final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final long m160targetConstraintsZezNO4M(long j) {
    ...
    public static final class AnimData {
        ...
        public final long m163component2YbymL2g() {
            return this.startSize;
        }

        /* renamed from: copy-O0kMr_c  reason: not valid java name */
        public final AnimData m164copyO0kMr_c(Animatable<IntSize, AnimationVector2D> animatable, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof AnimData) {
                ...
                return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m8329equalsimpl0(this.startSize, animData.startSize);
            }
            return false;
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m8332hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m8334toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(m160targetConstraintsZezNO4M(j));
        }
        final Placeable placeable = mo6818measureBRTryo0;
        final long m8326constructorimpl = IntSize.m8326constructorimpl((placeable.getWidth() << 32) | (placeable.getHeight() & 4294967295L));
        if (measureScope.isLookingAhead()) {
            this.lookaheadSize = m8326constructorimpl;
            m8127constrain4WqzIAM = m8326constructorimpl;
        } else {
            m8127constrain4WqzIAM = ConstraintsKt.m8127constrain4WqzIAM(j, m161animateTomzRDjE0(AnimationModifierKt.m73isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : m8326constructorimpl));
        }
        final int i = (int) (m8127constrain4WqzIAM >> 32);
        final int i2 = (int) (m8127constrain4WqzIAM & 4294967295L);
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m6884place70tqf50$default(placementScope, placeable, SizeAnimationModifierNode.this.getAlignment().mo4771alignKFBX0sM(m8326constructorimpl, IntSize.m8326constructorimpl((i << 32) | (i2 & 4294967295L)), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0  reason: not valid java name */
    public final long m161animateTomzRDjE0(long j) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m8329equalsimpl0(j, animData.getAnim().getValue().m8335unboximpl()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m8329equalsimpl0(j, animData.getAnim().getTargetValue().m8335unboximpl()) || z) {
                animData.m166setStartSizeozmzZPI(animData.getAnim().getValue().m8335unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m8323boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m8323boximpl(IntSize.m8326constructorimpl(InlineClassHelperKt.Uint64Low32)), null, 8, null), j, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m8335unboximpl();
    }
}
