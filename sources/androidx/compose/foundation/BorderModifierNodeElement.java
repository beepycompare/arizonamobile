...
public final class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m267copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m269copy8Feqmps(f, brush, shape);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m268component1D9Ej5fM() {
        return this.width;
    }
    ...
    public final BorderModifierNodeElement m269copy8Feqmps(float f, Brush brush, Shape shape) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BorderModifierNodeElement) {
            ...
            return Dp.m6689equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m6690hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m6695toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public final float m270getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public void update(BorderModifierNode borderModifierNode) {
        borderModifierNode.m266setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m6682boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set("color", Color.m4068boximpl(((SolidColor) this.brush).m4414getValue0d7_KjU()));
            inspectorInfo.setValue(Color.m4068boximpl(((SolidColor) this.brush).m4414getValue0d7_KjU()));
        } else {
