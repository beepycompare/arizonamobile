...
final class DefaultPagerNestedScrollConnection implements NestedScrollConnection {
    ...
    public final long m1135consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return Velocity.m8230copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m8230copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPreScroll-OzD1aCk */
    public long mo929onPreScrollOzD1aCk(long j, int i) {
        if (NestedScrollSource.m6451equalsimpl0(i, NestedScrollSource.Companion.m6463getUserInputWNlRxjI()) && Math.abs(this.state.getCurrentPageOffsetFraction()) > 1.0E-6d) {
            ...
            return Offset.m5029copydBAh8RU(j, intBitsToFloat, f);
        }
    ...
    public long mo578onPostScrollDzOQY0M(long j, long j2, int i) {
        if (NestedScrollSource.m6451equalsimpl0(i, NestedScrollSource.Companion.m6462getSideEffectWNlRxjI()) && m1134mainAxisk4lQ0M(j2) != 0.0f) {
    ...
    public Object mo577onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m8225boximpl(m1135consumeOnOrientationQWom1Mo(j2, this.orientation));
    }

    /* renamed from: mainAxis-k-4lQ0M  reason: not valid java name */
    private final float m1134mainAxisk4lQ0M(long j) {
