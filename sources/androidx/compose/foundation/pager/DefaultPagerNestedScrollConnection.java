...
final class DefaultPagerNestedScrollConnection implements NestedScrollConnection {
    ...
    public final long m1319consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return Velocity.m8394copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m8394copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }
    ...
    public long mo1150onPreScrollOzD1aCk(long j, int i) {
        float f;
        if (NestedScrollSource.m6542equalsimpl0(i, NestedScrollSource.Companion.m6554getUserInputWNlRxjI()) && Math.abs(this.state.getCurrentPageOffsetFraction()) > 1.0E-6d && Math.abs(m1318toFloatk4lQ0M(j)) > 0.0f) {
            ...
            float coerceIn = RangesKt.coerceIn(m1318toFloatk4lQ0M(j), currentPageOffsetFraction, pageSize);
            ...
            return Offset.m5096copydBAh8RU(j, intBitsToFloat, f);
        }
        return Offset.Companion.m5119getZeroF1C5BW0();
    }

    /* renamed from: toFloat-k-4lQ0M  reason: not valid java name */
    private final float m1318toFloatk4lQ0M(long j) {
    ...
    public long mo603onPostScrollDzOQY0M(long j, long j2, int i) {
        if (NestedScrollSource.m6542equalsimpl0(i, NestedScrollSource.Companion.m6553getSideEffectWNlRxjI()) && m1317mainAxisk4lQ0M(j2) != 0.0f) {
    ...
    public Object mo602onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m8389boximpl(m1319consumeOnOrientationQWom1Mo(j2, this.orientation));
    }

    /* renamed from: mainAxis-k-4lQ0M  reason: not valid java name */
    private final float m1317mainAxisk4lQ0M(long j) {
        return Float.intBitsToFloat((int) (this.orientation == Orientation.Horizontal ? j >> 32 : j & 4294967295L));
    }
}
