...
public final class PagerCacheWindowScope implements CacheWindowScope {
    ...
    public List<LazyLayoutPrefetchState.PrefetchHandle> schedulePrefetch(int i, final Function2<? super Integer, ? super Integer, Unit> function2) {
        return CollectionsKt.listOf(getState().m1254schedulePrecompositionAndPremeasure_EkL_Y$foundation(i, getLayoutInfo().m1334getChildConstraintsmsEJaDk(), true, new Function1() { // from class: androidx.compose.foundation.pager.PagerCacheWindowScope$$ExternalSyntheticLambda0
