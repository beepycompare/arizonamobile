...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f, PrefetchScheduler prefetchScheduler) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(Offset.Companion.m5119getZeroF1C5BW0()), null, 2, null);
        ...
        this.placementScopeInvalidator = ObservableScopeInvalidator.m1261constructorimpl$default(null, 1, null);
        this.measurementScopeInvalidator = ObservableScopeInvalidator.m1261constructorimpl$default(null, 1, null);
    ...
    public final long m1338getUpDownDifferenceF1C5BW0$foundation() {
        return ((Offset) this.upDownDifference$delegate.getValue()).m5113unboximpl();
    }

    /* renamed from: setUpDownDifference-k-4lQ0M$foundation  reason: not valid java name */
    public final void m1340setUpDownDifferencek4lQ0M$foundation(long j) {
        this.upDownDifference$delegate.setValue(Offset.m5092boximpl(j));
    }
    ...
    public final float performScroll(float f) {
        ...
        if (copyWithScrollDeltaWithoutRemeasure != null) {
            ...
            ObservableScopeInvalidator.m1265invalidateScopeimpl(this.placementScopeInvalidator);
    ...
    public final float getPositionThresholdFraction$foundation() {
        return Math.min(this.density.mo434toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation() / 2.0f) / getPageSize$foundation();
    }
    ...
    public final long m1337getPremeasureConstraintsmsEJaDk$foundation() {
        return this.premeasureConstraints;
    }

    /* renamed from: setPremeasureConstraints-BRTryo0$foundation  reason: not valid java name */
    public final void m1339setPremeasureConstraintsBRTryo0$foundation(long j) {
    ...
    public final MutableState<Unit> m1336getPlacementScopeInvalidatorzYiylxw$foundation() {
    ...
    public final void snapToItem$foundation(int i, float f, boolean z) {
        ...
        ObservableScopeInvalidator.m1265invalidateScopeimpl(this.measurementScopeInvalidator);
    }

    /* renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation  reason: not valid java name */
    public final MutableState<Unit> m1335getMeasurementScopeInvalidatorzYiylxw$foundation() {
    ...
    */
    ...
    private final boolean isGestureActionMatchesScroll(float f) {
        if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
            if (Math.signum(f) == Math.signum(-Float.intBitsToFloat((int) (m1338getUpDownDifferenceF1C5BW0$foundation() & 4294967295L)))) {
                return true;
            }
        } else if (Math.signum(f) == Math.signum(-Float.intBitsToFloat((int) (m1338getUpDownDifferenceF1C5BW0$foundation() >> 32)))) {
            return true;
        }
    ...
    public final boolean isNotGestureAction$foundation() {
        return ((int) Float.intBitsToFloat((int) (m1338getUpDownDifferenceF1C5BW0$foundation() >> 32))) == 0 && ((int) Float.intBitsToFloat((int) (m1338getUpDownDifferenceF1C5BW0$foundation() & 4294967295L))) == 0;
    }
    ...
    private final void notifyPrefetch(float f, PagerLayoutInfo pagerLayoutInfo) {
        ...
        if (this.prefetchingEnabled && !pagerLayoutInfo.getVisiblePagesInfo().isEmpty()) {
            ...
            if (calculatePrefetchIndex != this.indexToPrefetch) {
                ...
                this.currentPrefetchHandle = LazyLayoutPrefetchState.m1251schedulePrecompositionAndPremeasureVKLhPVY$default(this.prefetchState, calculatePrefetchIndex, this.premeasureConstraints, null, 4, null);
            }
            if (z) {
