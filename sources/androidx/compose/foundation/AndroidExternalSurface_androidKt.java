...
public final class AndroidExternalSurface_androidKt {
    ...
    public static final Unit AndroidEmbeddedExternalSurface_sv6N_fY$lambda$18(Modifier modifier, boolean z, long j, float[] fArr, Function1 function1, int i, int i2, Composer composer, int i3) {
        m262AndroidEmbeddedExternalSurfacesv6N_fY(modifier, z, j, fArr, function1, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    public static final Unit AndroidExternalSurface_58FFMhA$lambda$8(Modifier modifier, boolean z, long j, int i, boolean z2, Function1 function1, int i2, int i3, Composer composer, int i4) {
        m263AndroidExternalSurface58FFMhA(modifier, z, j, i, z2, function1, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), i3);
        return Unit.INSTANCE;
    }
    ...
    */
    public static final void m263AndroidExternalSurface58FFMhA(Modifier modifier, boolean z, long j, int i, boolean z2, final Function1<? super AndroidExternalSurfaceScope, Unit> function1, Composer composer, final int i2, final int i3) {
        Object obj;
        int i4;
        boolean z3;
        long j2;
                ...
                if (i7 != 0) {
                    ...
                    if (!startRestartGroup.shouldExecute((i4 & 74899) == 74898, i4 & 1)) {
                        ...
                        if ((i2 & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if (i5 != 0) {
                                i6 = AndroidExternalSurfaceZOrder.Companion.m259getBehindB_4ceCc();
                            }
                            if (i7 != 0) {
                                z4 = false;
                            }
                        ...
                        if (changedInstance || rememberedValue == Composer.Companion.getEmpty()) {
                            rememberedValue = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda0
                                ...
                                public final Object invoke(Object obj3) {
                                    ...
                                    AndroidExternalSurface_58FFMhA$lambda$3$lambda$2 = AndroidExternalSurface_androidKt.AndroidExternalSurface_58FFMhA$lambda$3$lambda$2(Function1.this, rememberAndroidExternalSurfaceState, (Context) obj3);
                        ...
                        if (z8 || rememberedValue3 == Composer.Companion.getEmpty()) {
                            ...
                            rememberedValue3 = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda2
                                ...
                                public final Object invoke(Object obj3) {
                                    ...
                                    AndroidExternalSurface_58FFMhA$lambda$7$lambda$6 = AndroidExternalSurface_androidKt.AndroidExternalSurface_58FFMhA$lambda$7$lambda$6(j5, z9, i12, z10, (SurfaceView) obj3);
                    ...
                    if (endRestartGroup == null) {
                        endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda3
                            ...
                            public final Object invoke(Object obj3, Object obj4) {
                                ...
                                AndroidExternalSurface_58FFMhA$lambda$8 = AndroidExternalSurface_androidKt.AndroidExternalSurface_58FFMhA$lambda$8(Modifier.this, z5, j3, i8, z6, function1, i2, i3, (Composer) obj3, ((Integer) obj4).intValue());
    ...
    public static final Unit AndroidExternalSurface_58FFMhA$lambda$7$lambda$6(long j, boolean z, int i, boolean z2, SurfaceView surfaceView) {
        if (!IntSize.m8165equalsimpl0(j, IntSize.Companion.m8172getZeroYbymL2g())) {
            surfaceView.getHolder().setFixedSize((int) (j >> 32), (int) (j & 4294967295L));
        } else {
            surfaceView.getHolder().setSizeFromLayout();
        }
        surfaceView.getHolder().setFormat(z ? -1 : -3);
        if (AndroidExternalSurfaceZOrder.m255equalsimpl0(i, AndroidExternalSurfaceZOrder.Companion.m259getBehindB_4ceCc())) {
            surfaceView.setZOrderOnTop(false);
        } else if (AndroidExternalSurfaceZOrder.m255equalsimpl0(i, AndroidExternalSurfaceZOrder.Companion.m260getMediaOverlayB_4ceCc())) {
            surfaceView.setZOrderMediaOverlay(true);
        } else if (AndroidExternalSurfaceZOrder.m255equalsimpl0(i, AndroidExternalSurfaceZOrder.Companion.m261getOnTopB_4ceCc())) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void m262AndroidEmbeddedExternalSurfacesv6N_fY(Modifier modifier, boolean z, long j, float[] fArr, final Function1<? super AndroidExternalSurfaceScope, Unit> function1, Composer composer, final int i, final int i2) {
        Object obj;
        int i3;
        boolean z2;
        long j2;
        ...
        if (i6 != 0) {
            ...
            if (i4 == 0) {
                ...
                i3 |= startRestartGroup.changedInstance(fArr != null ? Matrix.m5520boximpl(fArr) : null) ? 2048 : 1024;
            }
            if ((i2 & 16) == 0) {
                i3 |= 24576;
            } else if ((i & 24576) == 0) {
                ...
                if (startRestartGroup.shouldExecute((i3 & 9363) != 9362, i3 & 1)) {
                    ...
                    if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                        ...
                        if (i4 != 0) {
                            ...
                            if (rememberedValue == Composer.Companion.getEmpty()) {
                                rememberedValue = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda4
                                    ...
                                    public final Object invoke(Object obj3) {
                                        ...
                                        AndroidEmbeddedExternalSurface_sv6N_fY$lambda$11$lambda$10 = AndroidExternalSurface_androidKt.AndroidEmbeddedExternalSurface_sv6N_fY$lambda$11$lambda$10((Context) obj3);
                            ...
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                rememberedValue2 = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda5
                                    ...
                                    public final Object invoke(Object obj3) {
                                        ...
                                        AndroidEmbeddedExternalSurface_sv6N_fY$lambda$13$lambda$12 = AndroidExternalSurface_androidKt.AndroidEmbeddedExternalSurface_sv6N_fY$lambda$13$lambda$12((TextureView) obj3);
                            ...
                            if (!changedInstance || rememberedValue3 == Composer.Companion.getEmpty()) {
                                ...
                                rememberedValue3 = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda6
                                    ...
                                    public final Object invoke(Object obj3) {
                                        ...
                                        AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16 = AndroidExternalSurface_androidKt.AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16(j4, rememberAndroidEmbeddedExternalSurfaceState, function14, z4, fArr3, (TextureView) obj3);
                            ...
                            AndroidView_androidKt.AndroidView(function12, modifier3, function13, null, (Function1) rememberedValue3, startRestartGroup, ((i3 << 3) & 112) | 390, 8);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                            modifier2 = modifier3;
                    ...
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    ComposerKt.sourceInformationMarkerStart(startRestartGroup, -1396180415, "CC(remember):AndroidExternalSurface.android.kt#9igjgp");
                    changedInstance = ((((i3 & 896) ^ RendererCapabilities.DECODER_SUPPORT_MASK) <= 256 && startRestartGroup.changed(j2)) || (i3 & RendererCapabilities.DECODER_SUPPORT_MASK) == 256) | startRestartGroup.changedInstance(rememberAndroidEmbeddedExternalSurfaceState2) | ((57344 & i3) != 16384) | ((i3 & 112) == 32) | startRestartGroup.changedInstance(fArr3 == null ? Matrix.m5520boximpl(fArr3) : null);
                    rememberedValue3 = startRestartGroup.rememberedValue();
                    if (changedInstance) {
                    }
                    j4 = j2;
                    final Function1 function142 = obj2;
                    rememberedValue3 = new Function1() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda6
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj3) {
                            Unit AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16;
                            AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16 = AndroidExternalSurface_androidKt.AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16(j4, rememberAndroidEmbeddedExternalSurfaceState2, function142, z4, fArr3, (TextureView) obj3);
                            return AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16;
                        }
                    };
                    startRestartGroup.updateRememberedValue(rememberedValue3);
                    ...
                    AndroidView_androidKt.AndroidView(function122, modifier32, function132, null, (Function1) rememberedValue3, startRestartGroup, ((i3 << 3) & 112) | 390, 8);
                    if (ComposerKt.isTraceInProgress()) {
                    }
                ...
                if (endRestartGroup != null) {
                    endRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.AndroidExternalSurface_androidKt$$ExternalSyntheticLambda7
                        ...
                        public final Object invoke(Object obj3, Object obj4) {
                            ...
                            AndroidEmbeddedExternalSurface_sv6N_fY$lambda$18 = AndroidExternalSurface_androidKt.AndroidEmbeddedExternalSurface_sv6N_fY$lambda$18(Modifier.this, z3, j3, fArr2, function1, i, i2, (Composer) obj3, ((Integer) obj4).intValue());
    ...
    public static final Unit AndroidEmbeddedExternalSurface_sv6N_fY$lambda$17$lambda$16(long j, AndroidEmbeddedExternalSurfaceState androidEmbeddedExternalSurfaceState, Function1 function1, boolean z, float[] fArr, TextureView textureView) {
        ...
        if (!IntSize.m8165equalsimpl0(j, IntSize.Companion.m8172getZeroYbymL2g()) && (surfaceTexture = textureView.getSurfaceTexture()) != null) {
            surfaceTexture.setDefaultBufferSize((int) (j >> 32), (int) (4294967295L & j));
        }
        androidEmbeddedExternalSurfaceState.m251setSurfaceSizeozmzZPI(j);
        ...
        if (fArr != null) {
            ...
            AndroidMatrixConversions_androidKt.m5148setFromEL8BTi8(matrix, fArr);
        } else {
            matrix = null;
        }
