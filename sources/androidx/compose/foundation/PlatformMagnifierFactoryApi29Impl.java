...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo372createnHHXs2Y(View view, boolean z, long j, float f, float f2, boolean z2, Density density, float f3) {
        ...
        long mo431toSizeXkaWNTQ = density.mo431toSizeXkaWNTQ(j);
        float mo430toPx0680j_4 = density.mo430toPx0680j_4(f);
        float mo430toPx0680j_42 = density.mo430toPx0680j_4(f2);
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo431toSizeXkaWNTQ != InlineClassHelperKt.UnspecifiedPackedFloats) {
            builder.setSize(MathKt.roundToInt(Float.intBitsToFloat((int) (mo431toSizeXkaWNTQ >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (mo431toSizeXkaWNTQ & 4294967295L))));
        }
        if (!Float.isNaN(mo430toPx0680j_4)) {
            builder.setCornerRadius(mo430toPx0680j_4);
        }
        if (!Float.isNaN(mo430toPx0680j_42)) {
            builder.setElevation(mo430toPx0680j_42);
        }
        if (!Float.isNaN(f3)) {
