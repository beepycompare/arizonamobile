...
public final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetPxNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OffsetPxNode.measure_3p2s80s$lambda$0(OffsetPxNode.this, mo6818measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetPxNode offsetPxNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        long m8297unboximpl = offsetPxNode.offset.invoke(placementScope).m8297unboximpl();
        if (offsetPxNode.rtlAware) {
            Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeable, IntOffset.m8288getXimpl(m8297unboximpl), IntOffset.m8289getYimpl(m8297unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        } else {
            Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m8288getXimpl(m8297unboximpl), IntOffset.m8289getYimpl(m8297unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        }
