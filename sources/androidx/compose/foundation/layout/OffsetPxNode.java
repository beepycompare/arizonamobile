...
public final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo80measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo5967measureBRTryo0.getWidth(), mo5967measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.OffsetPxNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = OffsetPxNode.measure_3p2s80s$lambda$0(OffsetPxNode.this, mo5967measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit measure_3p2s80s$lambda$0(OffsetPxNode offsetPxNode, Placeable placeable, Placeable.PlacementScope placementScope) {
        long m7401unboximpl = offsetPxNode.offset.invoke(placementScope).m7401unboximpl();
        if (offsetPxNode.rtlAware) {
            Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeable, IntOffset.m7392getXimpl(m7401unboximpl), IntOffset.m7393getYimpl(m7401unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        } else {
            Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m7392getXimpl(m7401unboximpl), IntOffset.m7393getYimpl(m7401unboximpl), 0.0f, (Function1) null, 12, (Object) null);
        }
