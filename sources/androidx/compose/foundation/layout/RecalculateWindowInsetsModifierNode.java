...
public final class RecalculateWindowInsetsModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, final Measurable measurable, long j) {
        if (!Constraints.m8111getHasFixedWidthimpl(j) || !Constraints.m8110getHasFixedHeightimpl(j)) {
            ...
            return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.RecalculateWindowInsetsModifierNode$$ExternalSyntheticLambda0
        ...
        final int m8113getMaxWidthimpl = Constraints.m8113getMaxWidthimpl(j);
        final int m8112getMaxHeightimpl = Constraints.m8112getMaxHeightimpl(j);
        return MeasureScope.layout$default(measureScope, m8113getMaxWidthimpl, m8112getMaxHeightimpl, null, new Function1() { // from class: androidx.compose.foundation.layout.RecalculateWindowInsetsModifierNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return RecalculateWindowInsetsModifierNode.measure_3p2s80s$lambda$1(RecalculateWindowInsetsModifierNode.this, measurable, m8113getMaxWidthimpl, m8112getMaxHeightimpl, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$1(RecalculateWindowInsetsModifierNode recalculateWindowInsetsModifierNode, Measurable measurable, int i, int i2, Placeable.PlacementScope placementScope) {
        ...
        if (coordinates != null) {
            ...
            long mo6826getSizeYbymL2g = coordinates.mo6826getSizeYbymL2g();
            long mo6829localToRootMKHz9U = coordinates.mo6829localToRootMKHz9U(Offset.m5095constructorimpl((Float.floatToRawIntBits((int) (mo6826getSizeYbymL2g & 4294967295L)) & 4294967295L) | (Float.floatToRawIntBits((int) (mo6826getSizeYbymL2g >> 32)) << 32)));
            long mo6826getSizeYbymL2g2 = LayoutCoordinatesKt.findRootCoordinates(coordinates).mo6826getSizeYbymL2g();
            ...
            int round3 = ((int) (mo6826getSizeYbymL2g2 >> 32)) - Math.round(Float.intBitsToFloat((int) (mo6829localToRootMKHz9U >> 32)));
            int round4 = ((int) (mo6826getSizeYbymL2g2 & 4294967295L)) - Math.round(Float.intBitsToFloat((int) (mo6829localToRootMKHz9U & 4294967295L)));
        ...
        Placeable.PlacementScope.place$default(placementScope, measurable.mo6818measureBRTryo0(Constraints.Companion.m8123fixedJhjzzOo(i, i2)), 0, 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
