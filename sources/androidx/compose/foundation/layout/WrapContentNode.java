...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo70measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        int m6639getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m6639getMinWidthimpl(j);
        int m6638getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m6638getMinHeightimpl(j) : 0;
        int i = Integer.MAX_VALUE;
        int m6637getMaxWidthimpl = (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6637getMaxWidthimpl(j) : Integer.MAX_VALUE;
        if (this.direction == Direction.Horizontal || !this.unbounded) {
            i = Constraints.m6636getMaxHeightimpl(j);
        }
        final Placeable mo5438measureBRTryo0 = measurable.mo5438measureBRTryo0(ConstraintsKt.Constraints(m6639getMinWidthimpl, m6637getMaxWidthimpl, m6638getMinHeightimpl, i));
        final int coerceIn = RangesKt.coerceIn(mo5438measureBRTryo0.getWidth(), Constraints.m6639getMinWidthimpl(j), Constraints.m6637getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo5438measureBRTryo0.getHeight(), Constraints.m6638getMinHeightimpl(j), Constraints.m6636getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                int width = coerceIn - mo5438measureBRTryo0.getWidth();
                Placeable.PlacementScope.m5502place70tqf50$default(placementScope, mo5438measureBRTryo0, alignmentCallback.invoke(IntSize.m6847boximpl(IntSize.m6850constructorimpl(((coerceIn2 - mo5438measureBRTryo0.getHeight()) & 4294967295L) | (width << 32))), measureScope.getLayoutDirection()).m6821unboximpl(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
