...
public final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        int m8115getMinWidthimpl = this.direction != Direction.Vertical ? 0 : Constraints.m8115getMinWidthimpl(j);
        int m8114getMinHeightimpl = this.direction == Direction.Horizontal ? Constraints.m8114getMinHeightimpl(j) : 0;
        int i = Integer.MAX_VALUE;
        int m8113getMaxWidthimpl = (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m8113getMaxWidthimpl(j) : Integer.MAX_VALUE;
        ...
        final int coerceIn = RangesKt.coerceIn(mo6818measureBRTryo0.getWidth(), Constraints.m8115getMinWidthimpl(j), Constraints.m8113getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo6818measureBRTryo0.getHeight(), Constraints.m8114getMinHeightimpl(j), Constraints.m8112getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, coerceIn, coerceIn2, null, new Function1() { // from class: androidx.compose.foundation.layout.WrapContentNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return WrapContentNode.measure_3p2s80s$lambda$0(WrapContentNode.this, coerceIn, mo6818measureBRTryo0, coerceIn2, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(WrapContentNode wrapContentNode, int i, Placeable placeable, int i2, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m6884place70tqf50$default(placementScope, placeable, wrapContentNode.alignmentCallback.invoke(IntSize.m8323boximpl(IntSize.m8326constructorimpl(((i - placeable.getWidth()) << 32) | ((i2 - placeable.getHeight()) & 4294967295L))), measureScope.getLayoutDirection()).m8297unboximpl(), 0.0f, 2, null);
