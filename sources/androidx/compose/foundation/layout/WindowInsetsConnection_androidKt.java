...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll$lambda$1(Modifier modifier, Composer composer, int i) {
        ...
        Modifier nestedScroll$default = NestedScrollModifierKt.nestedScroll$default(modifier, m1142rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.Companion.current(composer, 6).getIme(), WindowInsetsSides.Companion.m1165getBottomJoeWqyM(), composer, 48), null, 2, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m1142rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets androidWindowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator m1100chooseCalculatorni1skBw = SideCalculator.Companion.m1100chooseCalculatorni1skBw(i, (LayoutDirection) consume);
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        ...
        boolean changed = ((((i2 & 14) ^ 6) > 4 && composer.changed(androidWindowInsets)) || (i2 & 6) == 4) | composer.changed(view) | composer.changed(m1100chooseCalculatorni1skBw) | composer.changed(density);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new WindowInsetsNestedScrollConnection(androidWindowInsets, view, m1100chooseCalculatorni1skBw, density);
