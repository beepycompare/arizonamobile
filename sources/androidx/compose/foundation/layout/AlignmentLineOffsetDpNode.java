...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m723getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: setBefore-0680j_4  reason: not valid java name */
    public final void m725setBefore0680j_4(float f) {
        this.before = f;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m722getAfterD9Ej5fM() {
        return this.after;
    }

    /* renamed from: setAfter-0680j_4  reason: not valid java name */
    public final void m724setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        m711alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m711alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j);
