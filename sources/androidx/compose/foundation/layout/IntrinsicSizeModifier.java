...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo1003calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long mo1003calculateContentConstraintsl58MMJ0 = mo1003calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            mo1003calculateContentConstraintsl58MMJ0 = ConstraintsKt.m8128constrainN9IONVI(j, mo1003calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(mo1003calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$$ExternalSyntheticLambda0
    ...
    public static final Unit measure_3p2s80s$lambda$0(Placeable placeable, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m6885placeRelative70tqf50$default(placementScope, placeable, IntOffset.Companion.m8299getZeronOccac(), 0.0f, 2, null);
