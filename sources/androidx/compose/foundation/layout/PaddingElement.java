...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final float m1037getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: setStart-0680j_4  reason: not valid java name */
    public final void m1041setStart0680j_4(float f) {
        this.start = f;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m1038getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: setTop-0680j_4  reason: not valid java name */
    public final void m1042setTop0680j_4(float f) {
        this.top = f;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m1036getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: setEnd-0680j_4  reason: not valid java name */
    public final void m1040setEnd0680j_4(float f) {
        this.end = f;
    }

    /* renamed from: getBottom-D9Ej5fM  reason: not valid java name */
    public final float m1035getBottomD9Ej5fM() {
        return this.bottom;
    }

    /* renamed from: setBottom-0680j_4  reason: not valid java name */
    public final void m1039setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public void update(PaddingNode paddingNode) {
        paddingNode.m1061setStart0680j_4(this.start);
        paddingNode.m1062setTop0680j_4(this.top);
        paddingNode.m1060setEnd0680j_4(this.end);
        paddingNode.m1059setBottom0680j_4(this.bottom);
        paddingNode.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m8166hashCodeimpl(this.start) * 31) + Dp.m8166hashCodeimpl(this.top)) * 31) + Dp.m8166hashCodeimpl(this.end)) * 31) + Dp.m8166hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object obj) {
        PaddingElement paddingElement = obj instanceof PaddingElement ? (PaddingElement) obj : null;
        return paddingElement != null && Dp.m8165equalsimpl0(this.start, paddingElement.start) && Dp.m8165equalsimpl0(this.top, paddingElement.top) && Dp.m8165equalsimpl0(this.end, paddingElement.end) && Dp.m8165equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m8160constructorimpl(0.0f) : f, (i & 2) != 0 ? Dp.m8160constructorimpl(0.0f) : f2, (i & 4) != 0 ? Dp.m8160constructorimpl(0.0f) : f3, (i & 8) != 0 ? Dp.m8160constructorimpl(0.0f) : f4, z, function1, null);
    }
}
