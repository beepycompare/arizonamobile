...
public final class FlowLayoutOverflowState {
    ...
    public final IntIntPair m905ellipsisSizeF35zmw$foundation_layout(boolean z, int i, int i2) {
    ...
    public final void m907setOverflowMeasurableshBUhpc$foundation_layout(IntrinsicMeasurable intrinsicMeasurable, IntrinsicMeasurable intrinsicMeasurable2, boolean z, long j) {
        long m1019constructorimpl = OrientationIndependentConstraints.m1019constructorimpl(j, z ? LayoutOrientation.Horizontal : LayoutOrientation.Vertical);
        if (intrinsicMeasurable != null) {
            int mainAxisMin = FlowLayoutKt.mainAxisMin(intrinsicMeasurable, z, Constraints.m8112getMaxHeightimpl(m1019constructorimpl));
        ...
        if (intrinsicMeasurable2 != null) {
            int mainAxisMin2 = FlowLayoutKt.mainAxisMin(intrinsicMeasurable2, z, Constraints.m8112getMaxHeightimpl(m1019constructorimpl));
    ...
    /* renamed from: setOverflowMeasurables--hBUhpc$foundation_layout  reason: not valid java name */
    public final void m906setOverflowMeasurableshBUhpc$foundation_layout(final FlowLineMeasurePolicy flowLineMeasurePolicy, Measurable measurable, Measurable measurable2, long j) {
        ...
        long m1032toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m1032toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m1021copyyUG9Ft0$default(OrientationIndependentConstraints.m1019constructorimpl(j, layoutOrientation), 0, 0, 0, 0, 10, null), layoutOrientation);
        if (measurable != null) {
            FlowLayoutKt.m901measureAndCacherqJ1uqs(measurable, flowLineMeasurePolicy, m1032toBoxConstraintsOenEA2s, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda0
        ...
        if (measurable2 != null) {
            FlowLayoutKt.m901measureAndCacherqJ1uqs(measurable2, flowLineMeasurePolicy, m1032toBoxConstraintsOenEA2s, new Function1() { // from class: androidx.compose.foundation.layout.FlowLayoutOverflowState$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
    ...
    public final void m908setOverflowMeasurablesVKLhPVY$foundation_layout(FlowLineMeasurePolicy flowLineMeasurePolicy, long j, Function2<? super Boolean, ? super Integer, ? extends Measurable> function2) {
        this.itemShown = 0;
        this.getOverflowMeasurable = function2;
        m906setOverflowMeasurableshBUhpc$foundation_layout(flowLineMeasurePolicy, function2.invoke(true, 0), function2.invoke(false, 0), j);
    }
}
