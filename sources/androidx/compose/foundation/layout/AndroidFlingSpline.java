...
final class AndroidFlingSpline {
    ...
    public final long m688flingPositionLfoxSSI(float f) {
        float f2;
        float f3;
        float f4 = 100;
        int i = (int) (f4 * f);
        ...
        return FlingResult.m690constructorimpl((Float.floatToRawIntBits(f3) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m689boximpl(long j) {
        ...
        public static boolean m691equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m697unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m691equalsimpl(this.packedValue, obj);
        }
        ...
        public static final float m693getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m694getVelocityCoefficientimpl(long j) {
