...
final class AndroidFlingSpline {
    ...
    public final long m732flingPositionLfoxSSI(float f) {
        float f2;
        float f3;
        int i = (int) (100.0f * f);
        if (i < 100) {
        ...
        return FlingResult.m734constructorimpl((Float.floatToRawIntBits(f3) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m733boximpl(long j) {
            return new FlingResult(j);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static long m734constructorimpl(long j) {
            return j;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m735equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m741unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m736equalsimpl0(long j, long j2) {
            return j == j2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m739hashCodeimpl(long j) {
            return Long.hashCode(j);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m740toStringimpl(long j) {
            return "FlingResult(packedValue=" + j + ')';
        }

        public boolean equals(Object obj) {
            return m735equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m739hashCodeimpl(this.packedValue);
        }

        public String toString() {
            return m740toStringimpl(this.packedValue);
        }
        ...
        public static final float m737getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m738getVelocityCoefficientimpl(long j) {
