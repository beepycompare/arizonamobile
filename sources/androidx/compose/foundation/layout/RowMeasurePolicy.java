...
public final class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo42measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        measure = RowColumnMeasurePolicyKt.measure(this, Constraints.m6639getMinWidthimpl(j), Constraints.m6638getMinHeightimpl(j), Constraints.m6637getMaxWidthimpl(j), Constraints.m6636getMaxHeightimpl(j), measureScope.mo383roundToPx0680j_4(this.horizontalArrangement.mo625getSpacingD9Ej5fM()), measureScope, list, new Placeable[list.size()], 0, list.size(), (r28 & 1024) != 0 ? null : null, (r28 & 2048) != 0 ? 0 : 0);
        return measure;
    }
        ...
        return MeasureScope.layout$default(measureScope, i2, i3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RowMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i9 < length) {
                    ...
                    crossAxisPosition = rowMeasurePolicy.getCrossAxisPosition(placeable, RowColumnImplKt.getRowColumnParentData(placeable), i7, i8);
                    Placeable.PlacementScope.place$default(placementScope, placeable, iArr3[i10], crossAxisPosition, 0.0f, 4, null);
                    i9++;
                    i10++;
                }
            }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, i, intrinsicMeasureScope.mo383roundToPx0680j_4(this.horizontalArrangement.mo625getSpacingD9Ej5fM()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, i, intrinsicMeasureScope.mo383roundToPx0680j_4(this.horizontalArrangement.mo625getSpacingD9Ej5fM()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, i, intrinsicMeasureScope.mo383roundToPx0680j_4(this.horizontalArrangement.mo625getSpacingD9Ej5fM()));
    }

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, i, intrinsicMeasureScope.mo383roundToPx0680j_4(this.horizontalArrangement.mo625getSpacingD9Ej5fM()));
    }
}
