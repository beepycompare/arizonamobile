...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m8111getHasFixedWidthimpl(j) ? Constraints.m8113getMaxWidthimpl(j) : 0, Constraints.m8110getHasFixedHeightimpl(j) ? Constraints.m8112getMaxHeightimpl(j) : 0, null, new Function1() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$$ExternalSyntheticLambda0
