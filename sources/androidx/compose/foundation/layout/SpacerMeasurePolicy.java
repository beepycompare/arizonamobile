...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo42measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6635getHasFixedWidthimpl(j) ? Constraints.m6637getMaxWidthimpl(j) : 0, Constraints.m6634getHasFixedHeightimpl(j) ? Constraints.m6636getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
