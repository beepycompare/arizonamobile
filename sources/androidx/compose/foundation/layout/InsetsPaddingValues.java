...
public final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo1000calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo431toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo1002calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo431toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo1001calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density density = this.density;
        return density.mo431toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo999calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo431toDpu2uoSUM(this.insets.getBottom(density));
    }
