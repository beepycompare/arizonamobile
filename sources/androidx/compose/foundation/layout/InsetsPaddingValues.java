...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo688calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo386toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float mo690calculateTopPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo386toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo689calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Density density = this.density;
        return density.mo386toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float mo687calculateBottomPaddingD9Ej5fM() {
        Density density = this.density;
        return density.mo386toDpu2uoSUM(this.insets.getBottom(density));
    }
