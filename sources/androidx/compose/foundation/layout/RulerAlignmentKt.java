...
public final class RulerAlignmentKt {
    ...
    public static final MeasureResult fitInside$lambda$2(final RectRulers rectRulers, MeasureScope measureScope, final Measurable measurable, Constraints constraints) {
        if (Constraints.m7200getHasBoundedWidthimpl(constraints.m7210unboximpl()) && Constraints.m7199getHasBoundedHeightimpl(constraints.m7210unboximpl())) {
            final int m7204getMaxWidthimpl = Constraints.m7204getMaxWidthimpl(constraints.m7210unboximpl());
            final int m7203getMaxHeightimpl = Constraints.m7203getMaxHeightimpl(constraints.m7210unboximpl());
            return MeasureScope.layout$default(measureScope, m7204getMaxWidthimpl, m7203getMaxHeightimpl, null, new Function1() { // from class: androidx.compose.foundation.layout.RulerAlignmentKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit fitInside$lambda$2$lambda$0;
                    fitInside$lambda$2$lambda$0 = RulerAlignmentKt.fitInside$lambda$2$lambda$0(RectRulers.this, m7204getMaxWidthimpl, m7203getMaxHeightimpl, measurable, (Placeable.PlacementScope) obj);
                    return fitInside$lambda$2$lambda$0;
                }
            }, 4, null);
        }
        final Placeable mo5954measureBRTryo0 = measurable.mo5954measureBRTryo0(constraints.m7210unboximpl());
        final int width = mo5954measureBRTryo0.getWidth();
        final int height = mo5954measureBRTryo0.getHeight();
        return MeasureScope.layout$default(measureScope, width, height, null, new Function1() { // from class: androidx.compose.foundation.layout.RulerAlignmentKt$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                ...
                fitInside$lambda$2$lambda$1 = RulerAlignmentKt.fitInside$lambda$2$lambda$1(RectRulers.this, width, height, mo5954measureBRTryo0, (Placeable.PlacementScope) obj);
    ...
    public static final Unit fitInside$lambda$2$lambda$0(RectRulers rectRulers, int i, int i2, Measurable measurable, Placeable.PlacementScope placementScope) {
        ...
        Placeable.PlacementScope.place$default(placementScope, measurable.mo5954measureBRTryo0(Constraints.Companion.m7214fixedJhjzzOo(i - i3, i2 - i4)), i3, i4, 0.0f, 4, null);
    ...
    public static final MeasureResult fitOutside$lambda$5(final RectRulers rectRulers, MeasureScope measureScope, final Measurable measurable, Constraints constraints) {
        if (Constraints.m7200getHasBoundedWidthimpl(constraints.m7210unboximpl()) && Constraints.m7199getHasBoundedHeightimpl(constraints.m7210unboximpl())) {
            final int m7204getMaxWidthimpl = Constraints.m7204getMaxWidthimpl(constraints.m7210unboximpl());
            final int m7203getMaxHeightimpl = Constraints.m7203getMaxHeightimpl(constraints.m7210unboximpl());
            return MeasureScope.layout$default(measureScope, m7204getMaxWidthimpl, m7203getMaxHeightimpl, null, new Function1() { // from class: androidx.compose.foundation.layout.RulerAlignmentKt$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit fitOutside$lambda$5$lambda$3;
                    fitOutside$lambda$5$lambda$3 = RulerAlignmentKt.fitOutside$lambda$5$lambda$3(RectRulers.this, m7204getMaxWidthimpl, m7203getMaxHeightimpl, measurable, (Placeable.PlacementScope) obj);
    ...
    public static final Unit fitOutside$lambda$5$lambda$3(RectRulers rectRulers, int i, int i2, Measurable measurable, Placeable.PlacementScope placementScope) {
        ...
        if (roundToInt > 0) {
            ...
            Placeable.PlacementScope.place$default(placementScope, measurable.mo5954measureBRTryo0(Constraints.Companion.m7214fixedJhjzzOo(i, i2)), i3, i4, 0.0f, 4, null);
            return Unit.INSTANCE;
        } else {
            i2 = roundToInt2;
        }
    ...
    public static final Unit fitOutside$lambda$5$lambda$4(Measurable measurable, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.place$default(placementScope, measurable.mo5954measureBRTryo0(Constraints.Companion.m7214fixedJhjzzOo(0, 0)), 0, 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
}
