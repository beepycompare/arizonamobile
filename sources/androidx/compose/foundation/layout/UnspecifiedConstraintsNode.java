...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.Companion.m8180getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.Companion.m8180getUnspecifiedD9Ej5fM() : f2, null);
    }

    /* renamed from: getMinWidth-D9Ej5fM  reason: not valid java name */
    public final float m1138getMinWidthD9Ej5fM() {
    ...
    public final float m1137getMinHeightD9Ej5fM() {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!Float.isNaN(this.minWidth) && Constraints.m8115getMinWidthimpl(j) == 0) {
            int i = measureScope.mo428roundToPx0680j_4(this.minWidth);
            m8115getMinWidthimpl = Constraints.m8113getMaxWidthimpl(j);
            if (i < 0) {
                i = 0;
            }
            if (i <= m8115getMinWidthimpl) {
                m8115getMinWidthimpl = i;
            }
        } else {
            m8115getMinWidthimpl = Constraints.m8115getMinWidthimpl(j);
        }
        int m8113getMaxWidthimpl = Constraints.m8113getMaxWidthimpl(j);
        if (!Float.isNaN(this.minHeight) && Constraints.m8114getMinHeightimpl(j) == 0) {
            int i2 = measureScope.mo428roundToPx0680j_4(this.minHeight);
            m8114getMinHeightimpl = Constraints.m8112getMaxHeightimpl(j);
            int i3 = i2 >= 0 ? i2 : 0;
            if (i3 <= m8114getMinHeightimpl) {
                m8114getMinHeightimpl = i3;
            }
        } else {
            m8114getMinHeightimpl = Constraints.m8114getMinHeightimpl(j);
        }
        final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(ConstraintsKt.Constraints(m8115getMinWidthimpl, m8113getMaxWidthimpl, m8114getMinHeightimpl, Constraints.m8112getMaxHeightimpl(j)));
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$$ExternalSyntheticLambda0
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minWidth) ? intrinsicMeasureScope.mo428roundToPx0680j_4(this.minWidth) : 0;
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minHeight) ? intrinsicMeasureScope.mo428roundToPx0680j_4(this.minHeight) : 0;
