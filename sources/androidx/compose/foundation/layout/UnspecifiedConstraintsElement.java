...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public final float m1136getMinWidthD9Ej5fM() {
        return this.minWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public final float m1135getMinHeightD9Ej5fM() {
    ...
    public void update(UnspecifiedConstraintsNode unspecifiedConstraintsNode) {
        unspecifiedConstraintsNode.m1140setMinWidth0680j_4(this.minWidth);
        unspecifiedConstraintsNode.m1139setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m8158boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m8158boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UnspecifiedConstraintsElement) {
            ...
            return Dp.m8165equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m8165equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m8166hashCodeimpl(this.minWidth) * 31) + Dp.m8166hashCodeimpl(this.minHeight);
    }
}
