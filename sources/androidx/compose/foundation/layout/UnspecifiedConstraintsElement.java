...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public final float m883getMinWidthD9Ej5fM() {
        return this.minWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public final float m882getMinHeightD9Ej5fM() {
    ...
    public void update(UnspecifiedConstraintsNode unspecifiedConstraintsNode) {
        unspecifiedConstraintsNode.m887setMinWidth0680j_4(this.minWidth);
        unspecifiedConstraintsNode.m886setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m7553boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m7553boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UnspecifiedConstraintsElement) {
            ...
            return Dp.m7560equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m7560equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m7561hashCodeimpl(this.minWidth) * 31) + Dp.m7561hashCodeimpl(this.minHeight);
    }
}
