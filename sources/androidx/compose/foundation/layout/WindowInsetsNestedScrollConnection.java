...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public Object mo927onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m925flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7502getXimpl(j), Velocity.m7503getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo576onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m925flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7502getXimpl(j2), Velocity.m7503getYimpl(j2)), true, continuation);
    }
            ...
            if ((windowInsetsNestedScrollConnection$fling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i == 2) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m7493boximpl(this.sideCalculator.mo876consumedVelocityQWom1Mo(j3, floatRef.element));
                    } else if (i == 3) {
                        j4 = windowInsetsNestedScrollConnection$fling$12.J$0;
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m7493boximpl(this.sideCalculator.mo876consumedVelocityQWom1Mo(j4, 0.0f));
                    } else {
