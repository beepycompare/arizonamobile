...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo918onPreScrollOzD1aCk(long j, int i) {
        return m916scroll8S9VItk(j, this.sideCalculator.hideMotion(Float.intBitsToFloat((int) (j >> 32)), Float.intBitsToFloat((int) (4294967295L & j))));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo567onPostScrollDzOQY0M(long j, long j2, int i) {
        return m916scroll8S9VItk(j2, this.sideCalculator.showMotion(Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat((int) (4294967295L & j2))));
    }

    /* renamed from: scroll-8S9VItk  reason: not valid java name */
    private final long m916scroll8S9VItk(long j, float f) {
        ...
        if (f != 0.0f) {
            ...
            if (this.windowInsets.isVisible() != (i > 0) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo865consumedOffsetsMKHz9U(j);
                }
    ...
    public Object mo917onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m915flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7489getXimpl(j), Velocity.m7490getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo566onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m915flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7489getXimpl(j2), Velocity.m7490getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final Object m915flinghuYlsQE(long j, float f, boolean z, Continuation<? super Velocity> continuation) {
            ...
            if ((windowInsetsNestedScrollConnection$fling$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i == 2) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m7480boximpl(this.sideCalculator.mo866consumedVelocityQWom1Mo(j3, floatRef.element));
                    } else if (i == 3) {
                        j4 = windowInsetsNestedScrollConnection$fling$12.J$0;
                        ResultKt.throwOnFailure(obj);
                        return Velocity.m7480boximpl(this.sideCalculator.mo866consumedVelocityQWom1Mo(j4, 0.0f));
                    } else {
