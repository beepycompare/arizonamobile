...
public final class WindowInsetsSides {
    ...
    public static final /* synthetic */ WindowInsetsSides m1151boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1152constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1153equalsimpl(int i, Object obj) {
        return (obj instanceof WindowInsetsSides) && i == ((WindowInsetsSides) obj).m1160unboximpl();
    }
    ...
    public static final boolean m1155hasAnybkgdKaI$foundation_layout(int i, int i2) {
        return (i & i2) != 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1156hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m1153equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m1156hashCodeimpl(this.value);
    }
    ...
    public static final int m1157plusgK_yJZ4(int i, int i2) {
        return m1152constructorimpl(i | i2);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1158toStringimpl(int i) {
        return "WindowInsetsSides(" + m1159valueToStringimpl(i) + ')';
    }
    ...
    private static final String m1159valueToStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m1161getAllowLeftInLtrJoeWqyM$foundation_layout() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout  reason: not valid java name */
        public final int m1163getAllowRightInLtrJoeWqyM$foundation_layout() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout  reason: not valid java name */
        public final int m1162getAllowLeftInRtlJoeWqyM$foundation_layout() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout  reason: not valid java name */
        public final int m1164getAllowRightInRtlJoeWqyM$foundation_layout() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* renamed from: getStart-JoeWqyM  reason: not valid java name */
        public final int m1170getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* renamed from: getEnd-JoeWqyM  reason: not valid java name */
        public final int m1166getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* renamed from: getTop-JoeWqyM  reason: not valid java name */
        public final int m1171getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* renamed from: getBottom-JoeWqyM  reason: not valid java name */
        public final int m1165getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* renamed from: getLeft-JoeWqyM  reason: not valid java name */
        public final int m1168getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* renamed from: getRight-JoeWqyM  reason: not valid java name */
        public final int m1169getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* renamed from: getHorizontal-JoeWqyM  reason: not valid java name */
        public final int m1167getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* renamed from: getVertical-JoeWqyM  reason: not valid java name */
        public final int m1172getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int m1152constructorimpl = m1152constructorimpl(8);
        AllowLeftInLtr = m1152constructorimpl;
        int m1152constructorimpl2 = m1152constructorimpl(4);
        AllowRightInLtr = m1152constructorimpl2;
        int m1152constructorimpl3 = m1152constructorimpl(2);
        AllowLeftInRtl = m1152constructorimpl3;
        int m1152constructorimpl4 = m1152constructorimpl(1);
        AllowRightInRtl = m1152constructorimpl4;
        Start = m1157plusgK_yJZ4(m1152constructorimpl, m1152constructorimpl4);
        End = m1157plusgK_yJZ4(m1152constructorimpl2, m1152constructorimpl3);
        int m1152constructorimpl5 = m1152constructorimpl(16);
        Top = m1152constructorimpl5;
        int m1152constructorimpl6 = m1152constructorimpl(32);
        Bottom = m1152constructorimpl6;
        int m1157plusgK_yJZ4 = m1157plusgK_yJZ4(m1152constructorimpl, m1152constructorimpl3);
        Left = m1157plusgK_yJZ4;
        int m1157plusgK_yJZ42 = m1157plusgK_yJZ4(m1152constructorimpl2, m1152constructorimpl4);
        Right = m1157plusgK_yJZ42;
        Horizontal = m1157plusgK_yJZ4(m1157plusgK_yJZ4, m1157plusgK_yJZ42);
        Vertical = m1157plusgK_yJZ4(m1152constructorimpl5, m1152constructorimpl6);
    }
}
