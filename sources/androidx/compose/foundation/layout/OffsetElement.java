...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public final float m693getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m694getYD9Ej5fM() {
        return this.y;
    }
    ...
    public void update(OffsetNode offsetNode) {
        offsetNode.m703updateMdfbLM(this.x, this.y, this.rtlAware);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return offsetElement != null && Dp.m6689equalsimpl0(this.x, offsetElement.x) && Dp.m6689equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m6690hashCodeimpl(this.x) * 31) + Dp.m6690hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m6695toStringimpl(this.x)) + ", y=" + ((Object) Dp.m6695toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
