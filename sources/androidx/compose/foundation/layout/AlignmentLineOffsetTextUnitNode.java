...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m606getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m608setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m605getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m607setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m588alignmentLineOffsetMeasuretjqqzMA;
        m588alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m588alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m6876getRawTypeimpl(this.before) == 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : measureScope.mo384toDpGaN1DYA(this.before), TextUnit.m6876getRawTypeimpl(this.after) == 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : measureScope.mo384toDpGaN1DYA(this.after), measurable, j);
        return m588alignmentLineOffsetMeasuretjqqzMA;
    }
}
