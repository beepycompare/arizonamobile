...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m729getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m731setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m728getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m730setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m711alignmentLineOffsetMeasuretjqqzMA;
        m711alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m711alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m8352getRawTypeimpl(this.before) == 0 ? Dp.Companion.m8180getUnspecifiedD9Ej5fM() : measureScope.mo429toDpGaN1DYA(this.before), TextUnit.m8352getRawTypeimpl(this.after) == 0 ? Dp.Companion.m8180getUnspecifiedD9Ej5fM() : measureScope.mo429toDpGaN1DYA(this.after), measurable, j);
        return m711alignmentLineOffsetMeasuretjqqzMA;
    }
}
