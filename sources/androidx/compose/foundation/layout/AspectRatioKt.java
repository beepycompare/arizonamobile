...
public final class AspectRatioKt {
    ...
    public static final boolean m759isSatisfiedByNN6EwU(long j, int i, int i2) {
        int m8115getMinWidthimpl = Constraints.m8115getMinWidthimpl(j);
        if (i > Constraints.m8113getMaxWidthimpl(j) || m8115getMinWidthimpl > i) {
            return false;
        }
        return i2 <= Constraints.m8112getMaxHeightimpl(j) && Constraints.m8114getMinHeightimpl(j) <= i2;
    }
}
