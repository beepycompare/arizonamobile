...
public final class SizeElement extends ModifierNodeElement<SizeNode> {
    ...
    public /* synthetic */ SizeElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : f2, (i & 4) != 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : f3, (i & 8) != 0 ? Dp.Companion.m6704getUnspecifiedD9Ej5fM() : f4, z, function1, null);
    }
    ...
    public void update(SizeNode sizeNode) {
        sizeNode.m801setMinWidth0680j_4(this.minWidth);
        sizeNode.m800setMinHeight0680j_4(this.minHeight);
        sizeNode.m799setMaxWidth0680j_4(this.maxWidth);
        sizeNode.m798setMaxHeight0680j_4(this.maxHeight);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SizeElement) {
            ...
            return Dp.m6689equalsimpl0(this.minWidth, sizeElement.minWidth) && Dp.m6689equalsimpl0(this.minHeight, sizeElement.minHeight) && Dp.m6689equalsimpl0(this.maxWidth, sizeElement.maxWidth) && Dp.m6689equalsimpl0(this.maxHeight, sizeElement.maxHeight) && this.enforceIncoming == sizeElement.enforceIncoming;
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6690hashCodeimpl(this.minWidth) * 31) + Dp.m6690hashCodeimpl(this.minHeight)) * 31) + Dp.m6690hashCodeimpl(this.maxWidth)) * 31) + Dp.m6690hashCodeimpl(this.maxHeight)) * 31) + Boolean.hashCode(this.enforceIncoming);
    }
}
