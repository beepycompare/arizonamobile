...
public final class FlexWrap {
    ...
    public static final /* synthetic */ FlexWrap m883boximpl(int i) {
        return new FlexWrap(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m884constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m885equalsimpl(int i, Object obj) {
        return (obj instanceof FlexWrap) && i == ((FlexWrap) obj).m889unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m885equalsimpl(this.bits, obj);
    }

    public int hashCode() {
        return m887hashCodeimpl(this.bits);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m889unboximpl() {
        return this.bits;
    }
    ...
    public String toString() {
        return m888toStringimpl(this.bits);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m888toStringimpl(int i) {
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    return "WrapReverse";
    ...
    public static final class Companion {
        ...
        public final int m890getNoWrap7ziDAWk() {
            return FlexWrap.m884constructorimpl(0);
        }

        /* renamed from: getWrap-7ziDAWk  reason: not valid java name */
        public final int m891getWrap7ziDAWk() {
            return FlexWrap.m884constructorimpl(1);
        }

        /* renamed from: getWrapReverse-7ziDAWk  reason: not valid java name */
        public final int m892getWrapReverse7ziDAWk() {
            return FlexWrap.m884constructorimpl(2);
        }
    }
}
