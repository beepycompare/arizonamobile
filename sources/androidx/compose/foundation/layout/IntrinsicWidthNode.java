...
final class IntrinsicWidthNode extends IntrinsicSizeModifier {
    ...
    public long mo691calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.width == IntrinsicSize.Min) {
            maxIntrinsicWidth = measurable.minIntrinsicWidth(Constraints.m6636getMaxHeightimpl(j));
        } else {
            maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m6636getMaxHeightimpl(j));
        }
        if (maxIntrinsicWidth < 0) {
            maxIntrinsicWidth = 0;
        }
        return Constraints.Companion.m6649fixedWidthOenEA2s(maxIntrinsicWidth);
    }
