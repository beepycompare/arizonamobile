...
public final class ContextualFlowLayoutKt {
    ...
    */
    ...
    public static final Unit ContextualFlowRow$lambda$2(Function4 function4, int i, FlowLineInfo flowLineInfo, Composer composer, int i2) {
        ...
        function4.invoke(new ContextualFlowRowScopeImpl(flowLineInfo.getLineIndex$foundation_layout(), flowLineInfo.getPositionInLine$foundation_layout(), flowLineInfo.m910getMaxMainAxisSizeD9Ej5fM$foundation_layout(), flowLineInfo.m909getMaxCrossAxisSizeD9Ej5fM$foundation_layout(), null), Integer.valueOf(i), composer, Integer.valueOf((i2 << 3) & 112));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return Unit.INSTANCE;
    ...
    */
    ...
    public static final Unit ContextualFlowColumn$lambda$2(Function4 function4, int i, FlowLineInfo flowLineInfo, Composer composer, int i2) {
        ...
        function4.invoke(new ContextualFlowColumnScopeImpl(flowLineInfo.getLineIndex$foundation_layout(), flowLineInfo.getPositionInLine$foundation_layout(), flowLineInfo.m909getMaxCrossAxisSizeD9Ej5fM$foundation_layout(), flowLineInfo.m910getMaxMainAxisSizeD9Ej5fM$foundation_layout(), null), Integer.valueOf(i), composer, Integer.valueOf((i2 << 3) & 112));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return Unit.INSTANCE;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:68:0x00e7, code lost:
        r3 = new androidx.compose.foundation.layout.FlowMeasureLazyPolicy(true, r21, r22, r21.mo748getSpacingD9Ej5fM(), androidx.compose.foundation.layout.CrossAxisAlignment.Companion.vertical$foundation_layout(r23), r22.mo748getSpacingD9Ej5fM(), r27, r25, r4, r26, r28, r29, null).getMeasurePolicy();
    ...
    */
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:68:0x00e7, code lost:
        r3 = new androidx.compose.foundation.layout.FlowMeasureLazyPolicy(false, r22, r21, r21.mo748getSpacingD9Ej5fM(), androidx.compose.foundation.layout.CrossAxisAlignment.Companion.horizontal$foundation_layout(r23), r22.mo748getSpacingD9Ej5fM(), r27, r25, r4, r26, r28, r29, null).getMeasurePolicy();
        r30.updateRememberedValue(r3);
     */
    /* JADX WARN: Code restructure failed: missing block: B:69:0x010c, code lost:
        r3 = (kotlin.jvm.functions.Function2) r3;
