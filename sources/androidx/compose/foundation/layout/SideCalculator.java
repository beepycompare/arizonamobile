...
interface SideCalculator {
    ...
    long mo1098consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long mo1099consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo1099consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(Velocity.m8398getXimpl(j) - f, 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo1098consumedOffsetsMKHz9U(long j) {
                return Offset.m5095constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j >> 32))) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo1099consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(0.0f, Velocity.m8399getYimpl(j) - f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo1098consumedOffsetsMKHz9U(long j) {
                return Offset.m5095constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (4294967295L & Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L)))));
            }
        };
        ...
        public final SideCalculator m1100chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1168getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1171getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1169getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1165getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1170getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (WindowInsetsSides.m1154equalsimpl0(i, WindowInsetsSides.Companion.m1166getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
