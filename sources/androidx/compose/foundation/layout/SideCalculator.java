...
interface SideCalculator {
    ...
    long mo766consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long mo767consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo767consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(Velocity.m6922getXimpl(j) - f, 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo766consumedOffsetsMKHz9U(long j) {
                return Offset.m3829constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j >> 32))) << 32) | (Float.floatToRawIntBits(0.0f) & 4294967295L));
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* renamed from: consumedVelocity-QWom1Mo */
            public long mo767consumedVelocityQWom1Mo(long j, float f) {
                return VelocityKt.Velocity(0.0f, Velocity.m6923getYimpl(j) - f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* renamed from: consumedOffsets-MK-Hz9U */
            public long mo766consumedOffsetsMKHz9U(long j) {
                return Offset.m3829constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits(0.0f) << 32));
            }
        };
        ...
        public final SideCalculator m768chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m834getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m837getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m835getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m831getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m836getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (WindowInsetsSides.m820equalsimpl0(i, WindowInsetsSides.Companion.m832getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
