...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo266applyToScrollRhakbz0(long j, int i, Function1<? super Offset, Offset> function1) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo266applyToScrollRhakbz0(j, i, function1);
        }
    ...
    public Object mo265applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object mo265applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo265applyToFlingBMRW4eQ(j, function2, continuation);
            return mo265applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? mo265applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object invoke = function2.invoke(Velocity.m8389boximpl(j), continuation);
