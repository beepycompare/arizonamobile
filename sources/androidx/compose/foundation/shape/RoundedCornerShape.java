...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1363createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        if (f + f2 + f3 + f4 == 0.0f) {
            return new Outline.Rectangle(SizeKt.m5193toRectuvyYCjk(j));
        }
        Rect m5193toRectuvyYCjk = SizeKt.m5193toRectuvyYCjk(j);
        float f5 = layoutDirection == LayoutDirection.Ltr ? f : f2;
        long m5057constructorimpl = CornerRadius.m5057constructorimpl((Float.floatToRawIntBits(f5) << 32) | (Float.floatToRawIntBits(f5) & 4294967295L));
        float f6 = layoutDirection == LayoutDirection.Ltr ? f2 : f;
        long m5057constructorimpl2 = CornerRadius.m5057constructorimpl((Float.floatToRawIntBits(f6) & 4294967295L) | (Float.floatToRawIntBits(f6) << 32));
        float f7 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        long m5057constructorimpl3 = CornerRadius.m5057constructorimpl((Float.floatToRawIntBits(f7) << 32) | (Float.floatToRawIntBits(f7) & 4294967295L));
        float f8 = layoutDirection == LayoutDirection.Ltr ? f4 : f3;
        return new Outline.Rounded(RoundRectKt.m5155RoundRectZAM2FJo(m5193toRectuvyYCjk, m5057constructorimpl, m5057constructorimpl2, m5057constructorimpl3, CornerRadius.m5057constructorimpl((4294967295L & Float.floatToRawIntBits(f8)) | (Float.floatToRawIntBits(f8) << 32))));
    }
    ...
    public Object lerp(Object obj, float f) {
        if (Intrinsics.areEqual(obj, RectangleShapeKt.getRectangleShape()) || obj == null) {
            obj = RoundedCornerShapeKt.RoundedCornerShape(0.0f);
        }
        if (obj instanceof RoundedCornerShape) {
            return RoundedCornerShapeKt.lerp(this, (RoundedCornerShape) obj, f);
        }
        return null;
    }
}
