...
public final class RoundedCornerShapeKt {
    ...
    public static final CornerSize lerp(final CornerSize cornerSize, final CornerSize cornerSize2, final float f) {
        return new CornerSize() { // from class: androidx.compose.foundation.shape.RoundedCornerShapeKt$lerp$1
            ...
            public float mo1371toPxTmRCtEA(long j, Density density) {
                return MathHelpersKt.lerp(CornerSize.this.mo1371toPxTmRCtEA(j, density), cornerSize2.mo1371toPxTmRCtEA(j, density), f);
            }
        };
    }
    ...
    public static final RoundedCornerShape m1380RoundedCornerShape0680j_4(float f) {
        return RoundedCornerShape(CornerSizeKt.m1372CornerSize0680j_4(f));
    }
    ...
    public static final RoundedCornerShape m1381RoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new RoundedCornerShape(CornerSizeKt.m1372CornerSize0680j_4(f), CornerSizeKt.m1372CornerSize0680j_4(f2), CornerSizeKt.m1372CornerSize0680j_4(f3), CornerSizeKt.m1372CornerSize0680j_4(f4));
    }
    ...
    public static /* synthetic */ RoundedCornerShape m1382RoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1381RoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
}
