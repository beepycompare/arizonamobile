...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1015createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m3889RoundRectZAM2FJo(SizeKt.m3927toRectuvyYCjk(j), CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)), CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(f2) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L)), CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(f3) << 32) | (Float.floatToRawIntBits(f3) & 4294967295L)), CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(f4) & 4294967295L) | (Float.floatToRawIntBits(f4) << 32))));
    }
    ...
    private final long m1019toRadiusBz7bX_o(float f) {
        return CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
    }
}
