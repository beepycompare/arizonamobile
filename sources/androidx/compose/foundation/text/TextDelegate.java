...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.Companion.m8095getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }

    /* renamed from: getOverflow-gIe3tQ8  reason: not valid java name */
    public final int m1637getOverflowgIe3tQ8() {
    ...
    private final MultiParagraph m1636layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int m8115getMinWidthimpl = Constraints.m8115getMinWidthimpl(j);
        int m8113getMaxWidthimpl = ((this.softWrap || TextOverflow.m8086equalsimpl0(this.overflow, TextOverflow.Companion.m8096getEllipsisgIe3tQ8())) && Constraints.m8109getHasBoundedWidthimpl(j)) ? Constraints.m8113getMaxWidthimpl(j) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m8086equalsimpl0(this.overflow, TextOverflow.Companion.m8096getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (m8115getMinWidthimpl != m8113getMaxWidthimpl) {
            m8113getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), m8115getMinWidthimpl, m8113getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.Companion.m8122fitPrioritizingWidthZbe2FdA(0, m8113getMaxWidthimpl, 0, Constraints.m8112getMaxHeightimpl(j)), i, this.overflow, (DefaultConstructorMarker) null);
    }

    /* renamed from: layout-NN6Ew-U$default  reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1635layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1638layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U  reason: not valid java name */
    public final TextLayoutResult m1638layoutNN6EwU(long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
        if (textLayoutResult != null && TextLayoutHelperKt.m1675canReuse7_7YC6M(textLayoutResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j)) {
            TextLayoutInput textLayoutInput = new TextLayoutInput(textLayoutResult.getLayoutInput().getText(), this.style, textLayoutResult.getLayoutInput().getPlaceholders(), textLayoutResult.getLayoutInput().getMaxLines(), textLayoutResult.getLayoutInput().getSoftWrap(), textLayoutResult.getLayoutInput().m7575getOverflowgIe3tQ8(), textLayoutResult.getLayoutInput().getDensity(), textLayoutResult.getLayoutInput().getLayoutDirection(), textLayoutResult.getLayoutInput().getFontFamilyResolver(), j, (DefaultConstructorMarker) null);
            int ceilToIntPx = TextDelegateKt.ceilToIntPx(textLayoutResult.getMultiParagraph().getWidth());
            return textLayoutResult.m7577copyO0kMr_c(textLayoutInput, ConstraintsKt.m8127constrain4WqzIAM(j, IntSize.m8326constructorimpl((TextDelegateKt.ceilToIntPx(textLayoutResult.getMultiParagraph().getHeight()) & 4294967295L) | (ceilToIntPx << 32))));
        }
        MultiParagraph m1636layoutTextK40F9xA = m1636layoutTextK40F9xA(j, layoutDirection);
        int ceilToIntPx2 = TextDelegateKt.ceilToIntPx(m1636layoutTextK40F9xA.getWidth());
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j, (DefaultConstructorMarker) null), m1636layoutTextK40F9xA, ConstraintsKt.m8127constrain4WqzIAM(j, IntSize.m8326constructorimpl((TextDelegateKt.ceilToIntPx(m1636layoutTextK40F9xA.getHeight()) & 4294967295L) | (ceilToIntPx2 << 32))), null);
    }
