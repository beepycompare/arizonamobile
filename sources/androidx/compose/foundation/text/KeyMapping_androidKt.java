...
public final class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo1066mapZmokQxo(KeyEvent keyEvent) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m5175isShiftPressedZmokQxo(keyEvent) && KeyEvent_androidKt.m5172isAltPressedZmokQxo(keyEvent)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo1066mapZmokQxo(keyEvent) : keyCommand;
        }
    };
