...
final class TextFieldCursorKt$cursor$1 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        boolean z = ((brush instanceof SolidColor) && ((SolidColor) brush).m4889getValue0d7_KjU() == 16) ? false : true;
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        Object consume2 = composer.consume(CompositionLocalsKt.getLocalWindowInfo());
        ComposerKt.sourceInformationMarkerEnd(composer);
        if (((WindowInfo) consume2).isWindowFocused() && this.$state.getHasFocus() && TextRange.m6707getCollapsedimpl(this.$value.m6964getSelectiond9O1mEE()) && z) {
            ...
            TextRange m6701boximpl = TextRange.m6701boximpl(this.$value.m6964getSelectiond9O1mEE());
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            EffectsKt.LaunchedEffect(annotatedString, m6701boximpl, (Function2) rememberedValue2, composer, 0);
    ...
    public static final Unit invoke$lambda$4$lambda$3(CursorAnimationState cursorAnimationState, OffsetMapping offsetMapping, TextFieldValue textFieldValue, LegacyTextFieldState legacyTextFieldState, Brush brush, ContentDrawScope contentDrawScope) {
        ...
        if (cursorAlpha != 0.0f) {
            int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m6713getStartimpl(textFieldValue.m6964getSelectiond9O1mEE()));
            ...
            float coerceAtLeast = RangesKt.coerceAtLeast((float) Math.floor(contentDrawScope.mo419toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness())), 1.0f);
            float f = coerceAtLeast / 2;
            float coerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f, Float.intBitsToFloat((int) (contentDrawScope.mo5116getSizeNHjbRc() >> 32)) - f), f);
