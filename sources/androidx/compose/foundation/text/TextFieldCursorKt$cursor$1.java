...
final class TextFieldCursorKt$cursor$1 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        boolean z = ((brush instanceof SolidColor) && ((SolidColor) brush).m5632getValue0d7_KjU() == 16) ? false : true;
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
        Object consume2 = composer.consume(CompositionLocalsKt.getLocalWindowInfo());
        ComposerKt.sourceInformationMarkerEnd(composer);
        if (((WindowInfo) consume2).isWindowFocused() && this.$state.getHasFocus() && TextRange.m7452getCollapsedimpl(this.$value.m7709getSelectiond9O1mEE()) && z) {
            ...
            TextRange m7446boximpl = TextRange.m7446boximpl(this.$value.m7709getSelectiond9O1mEE());
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            EffectsKt.LaunchedEffect(annotatedString, m7446boximpl, (Function2) rememberedValue2, composer, 0);
    ...
    public static final Unit invoke$lambda$4$lambda$3(CursorAnimationState cursorAnimationState, OffsetMapping offsetMapping, TextFieldValue textFieldValue, LegacyTextFieldState legacyTextFieldState, Brush brush, ContentDrawScope contentDrawScope) {
        ...
        if (cursorAlpha != 0.0f) {
            int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(textFieldValue.m7709getSelectiond9O1mEE()));
            ...
            float coerceAtLeast = RangesKt.coerceAtLeast((float) Math.floor(contentDrawScope.mo430toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness())), 1.0f);
            float f = coerceAtLeast / 2;
            float coerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f, Float.intBitsToFloat((int) (contentDrawScope.mo5859getSizeNHjbRc() >> 32)) - f), f);
