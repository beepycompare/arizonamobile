...
public final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo749measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        if (measurable.maxIntrinsicWidth(Constraints.m7948getMaxHeightimpl(j)) < Constraints.m7949getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = j;
            j = Constraints.m7939copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable mo6698measureBRTryo0 = measurable.mo6698measureBRTryo0(j);
        final int min = Math.min(mo6698measureBRTryo0.getWidth(), Constraints.m7949getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, min, mo6698measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                Unit measure_3p2s80s$lambda$0;
                measure_3p2s80s$lambda$0 = HorizontalScrollLayoutModifier.measure_3p2s80s$lambda$0(HorizontalScrollLayoutModifier.this, measureScope, mo6698measureBRTryo0, min, (Placeable.PlacementScope) obj);
