...
public final class LegacyTextFieldState {
    ...
    public LegacyTextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope, SoftwareKeyboardController softwareKeyboardController) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m8158boximpl(Dp.m8160constructorimpl(0.0f)), null, 2, null);
        ...
        this.onImeActionPerformedWithResult = new Function1() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                boolean m1589runActionKlQnJC8;
                m1589runActionKlQnJC8 = LegacyTextFieldState.this.keyboardActionRunner.m1589runActionKlQnJC8(((ImeAction) obj).m7779unboximpl());
                return Boolean.valueOf(m1589runActionKlQnJC8);
            }
        };
        this.highlightPaint = AndroidPaint_androidKt.Paint();
        this.selectionBackgroundColor = Color.Companion.m5384getUnspecified0d7_KjU();
        mutableStateOf$default12 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m7596boximpl(TextRange.Companion.m7613getZerod9O1mEE()), null, 2, null);
        this.selectionPreviewHighlightRange$delegate = mutableStateOf$default12;
        mutableStateOf$default13 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m7596boximpl(TextRange.Companion.m7613getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1607getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m8174unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4  reason: not valid java name */
    public final void m1611setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField$delegate.setValue(Dp.m8158boximpl(f));
    }
    ...
    public static final Unit onValueChange$lambda$0(LegacyTextFieldState legacyTextFieldState, TextFieldValue textFieldValue) {
        ...
        legacyTextFieldState.m1613setSelectionPreviewHighlightRange5zctL8(TextRange.Companion.m7613getZerod9O1mEE());
    ...
    public static final Unit onImeActionPerformed$lambda$0(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        legacyTextFieldState.keyboardActionRunner.m1589runActionKlQnJC8(imeAction.m7779unboximpl());
        return Unit.INSTANCE;
    }
    ...
    public final long m1608getSelectionBackgroundColor0d7_KjU() {
        return this.selectionBackgroundColor;
    }

    /* renamed from: setSelectionBackgroundColor-8_81llA  reason: not valid java name */
    public final void m1612setSelectionBackgroundColor8_81llA(long j) {
        this.selectionBackgroundColor = j;
    }

    /* renamed from: getSelectionPreviewHighlightRange-d9O1mEE  reason: not valid java name */
    public final long m1609getSelectionPreviewHighlightRanged9O1mEE() {
        return ((TextRange) this.selectionPreviewHighlightRange$delegate.getValue()).m7612unboximpl();
    }

    /* renamed from: setSelectionPreviewHighlightRange-5zc-tL8  reason: not valid java name */
    public final void m1613setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange$delegate.setValue(TextRange.m7596boximpl(j));
    }

    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE  reason: not valid java name */
    public final long m1606getDeletionPreviewHighlightRanged9O1mEE() {
        return ((TextRange) this.deletionPreviewHighlightRange$delegate.getValue()).m7612unboximpl();
    }

    /* renamed from: setDeletionPreviewHighlightRange-5zc-tL8  reason: not valid java name */
    public final void m1610setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange$delegate.setValue(TextRange.m7596boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m7602getCollapsedimpl(m1609getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m7602getCollapsedimpl(m1606getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc  reason: not valid java name */
    public final void m1614updatefnh65Uc(AnnotatedString annotatedString, AnnotatedString annotatedString2, TextStyle textStyle, boolean z, Density density, FontFamily.Resolver resolver, Function1<? super TextFieldValue, Unit> function1, KeyboardActions keyboardActions, FocusManager focusManager, long j) {
        ...
        this.untransformedText = annotatedString;
        TextDelegate m1640updateTextDelegaterm0N8CA$default = TextDelegateKt.m1640updateTextDelegaterm0N8CA$default(this.textDelegate, annotatedString2, textStyle, density, resolver, z, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != m1640updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m1640updateTextDelegaterm0N8CA$default;
    }
}
