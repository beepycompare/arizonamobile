...
public final class MinLinesConstrainer {
    ...
    public final long m1983coerceMinLinesOh53vG4$foundation(long j, int i) {
        String str;
        Paragraph m7487ParagraphUl8oQg4;
        String str2;
        Paragraph m7487ParagraphUl8oQg42;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m7487ParagraphUl8oQg4 = ParagraphKt.m7487ParagraphUl8oQg4(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? TextOverflow.Companion.m8095getClipgIe3tQ8() : TextOverflow.Companion.m8095getClipgIe3tQ8());
            f = m7487ParagraphUl8oQg4.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m7487ParagraphUl8oQg42 = ParagraphKt.m7487ParagraphUl8oQg4(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? TextOverflow.Companion.m8095getClipgIe3tQ8() : TextOverflow.Companion.m8095getClipgIe3tQ8());
            f2 = m7487ParagraphUl8oQg42.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (i != 1) {
            m8114getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(f + (f2 * (i - 1))), 0), Constraints.m8112getMaxHeightimpl(j));
        } else {
            m8114getMinHeightimpl = Constraints.m8114getMinHeightimpl(j);
        }
        return ConstraintsKt.Constraints(Constraints.m8115getMinWidthimpl(j), Constraints.m8113getMaxWidthimpl(j), m8114getMinHeightimpl, Constraints.m8112getMaxHeightimpl(j));
    }
}
