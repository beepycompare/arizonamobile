...
public final class SelectableTextAnnotatedStringNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, GlobalPositionAwareModifierNode {
    ...
    public MeasureResult mo81measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return this.textAnnotatedStringNode.m1728measureNonExtension3p2s80s(measureScope, measurable, j);
    }
    ...
    public final void m1725update7NebLg4(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, int i2, boolean z, FontFamily.Resolver resolver, int i3, Function1<? super TextLayoutResult, Unit> function1, Function1<? super List<Rect>, Unit> function12, SelectionController selectionController, ColorProducer colorProducer, TextAutoSize textAutoSize) {
        TextAnnotatedStringNode textAnnotatedStringNode = this.textAnnotatedStringNode;
        textAnnotatedStringNode.doInvalidations(textAnnotatedStringNode.updateDraw(colorProducer, textStyle), this.textAnnotatedStringNode.updateText$foundation_release(annotatedString), this.textAnnotatedStringNode.m1729updateLayoutRelatedArgsy0kMQk(textStyle, list, i, i2, z, resolver, i3, textAutoSize), this.textAnnotatedStringNode.updateCallbacks(function1, function12, selectionController, this.onShowTranslation));
        this.selectionController = selectionController;
