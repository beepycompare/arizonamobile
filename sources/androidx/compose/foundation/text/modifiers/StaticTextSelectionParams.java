...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return (textLayoutResult == null || TextOverflow.m8086equalsimpl0(textLayoutResult.getLayoutInput().m7575getOverflowgIe3tQ8(), TextOverflow.Companion.m8099getVisiblegIe3tQ8()) || !textLayoutResult.getHasVisualOverflow()) ? false : true;
    }
