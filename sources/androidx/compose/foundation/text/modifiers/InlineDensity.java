...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1664constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1663boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static long m1665constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1667equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).m1673unboximpl();
    }
    ...
    public int hashCode() {
        return m1671hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1673unboximpl() {
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1666constructorimpl(Density density) {
        return m1664constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1672toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1672toStringimpl(long j) {
        return "InlineDensity(density=" + m1669getDensityimpl(j) + ", fontScale=" + m1670getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1674getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1664constructorimpl(float f, float f2) {
        return m1665constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl  reason: not valid java name */
    public static final float m1669getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl  reason: not valid java name */
    public static final float m1670getFontScaleimpl(long j) {
