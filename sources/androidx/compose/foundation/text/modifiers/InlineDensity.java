...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1957constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1956boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static long m1958constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1960equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).m1966unboximpl();
    }
    ...
    public int hashCode() {
        return m1964hashCodeimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1966unboximpl() {
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1959constructorimpl(Density density) {
        return m1957constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1965toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1965toStringimpl(long j) {
        return "InlineDensity(density=" + m1962getDensityimpl(j) + ", fontScale=" + m1963getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1967getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1957constructorimpl(float f, float f2) {
        return m1958constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl  reason: not valid java name */
    public static final float m1962getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl  reason: not valid java name */
    public static final float m1963getFontScaleimpl(long j) {
