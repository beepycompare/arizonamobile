...
public final class InlineDensity {
    ...
    private static final long Unspecified = m1404constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1403boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static long m1405constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1407equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).m1413unboximpl();
    }
    ...
    public int hashCode() {
        return m1411hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1406constructorimpl(Density density) {
        return m1404constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1412toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1412toStringimpl(long j) {
        return "InlineDensity(density=" + m1409getDensityimpl(j) + ", fontScale=" + m1410getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1414getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1404constructorimpl(float f, float f2) {
        return m1405constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* renamed from: getDensity-impl  reason: not valid java name */
    public static final float m1409getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl  reason: not valid java name */
    public static final float m1410getFontScaleimpl(long j) {
