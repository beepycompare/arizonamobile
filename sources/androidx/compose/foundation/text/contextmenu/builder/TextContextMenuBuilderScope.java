...
public final class TextContextMenuBuilderScope {
    ...
    public final void addFilter$foundation_release(Function1<? super TextContextMenuComponent, Boolean> function1) {
        this.filters.add(function1);
    }

    public final void addComponent$foundation_release(TextContextMenuComponent textContextMenuComponent) {
