...
public final class DefaultTextContextMenuDropdownProvider_androidKt {
    ...
    public static final Unit IconBox_RPmYEkk$lambda$13(int i, long j, int i2, Composer composer, int i3) {
        m1398IconBoxRPmYEkk(i, j, composer, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
        return Unit.INSTANCE;
    }
    ...
    public static final BasicTextContextMenuProvider defaultTextContextMenuDropdown(Composer composer, int i) {
        ...
        BasicTextContextMenuProvider basicTextContextMenuProvider = BasicTextContextMenuProviderKt.basicTextContextMenuProvider(ComposableSingletons$DefaultTextContextMenuDropdownProvider_androidKt.INSTANCE.m1394getLambda$1357803046$foundation_release(), composer, 6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public static final IntOffset OpenContextMenu$lambda$3$lambda$2(TextContextMenuDataProvider textContextMenuDataProvider, Function0 function0) {
        return IntOffset.m7370boximpl(IntOffsetKt.m7396roundk4lQ0M(textContextMenuDataProvider.mo1416positiontuRUvjQ((LayoutCoordinates) function0.invoke())));
    }
    ...
    public static final void DefaultTextContextMenuDropdown(final TextContextMenuSession textContextMenuSession, final TextContextMenuData textContextMenuData, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ContextMenuUi_androidKt.ContextMenuColumnBuilder(null, null, rememberedValue, startRestartGroup, 0, 3);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
            ...
            if (textContextMenuComponent instanceof TextContextMenuItem) {
                ...
                ContextMenuScope.item$default(contextMenuScope2, new Function2<Composer, Integer, String>() { // from class: androidx.compose.foundation.text.contextmenu.internal.DefaultTextContextMenuDropdownProvider_androidKt$DefaultTextContextMenuDropdown$1$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Color color, Composer composer, Integer num) {
                        m1400invokeek8zF_U(color.m4547unboximpl(), composer, num.intValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-ek8zF_U  reason: not valid java name */
                    public final void m1400invokeek8zF_U(long j, Composer composer, int i2) {
                        ...
                        DefaultTextContextMenuDropdownProvider_androidKt.m1398IconBoxRPmYEkk(((TextContextMenuItem) TextContextMenuComponent.this).getLeadingIcon(), j, composer, (i2 << 3) & 112);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
    ...
    public static final void m1398IconBoxRPmYEkk(final int i, final long j, Composer composer, final int i2) {
        int i3;
        ...
        if (!startRestartGroup.shouldExecute((i3 & 19) != 18, i3 & 1)) {
            ...
            Object rememberedValue2 = startRestartGroup.rememberedValue();
            if (z || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = j == 16 ? null : ColorFilter.Companion.m4578tintxETnrds$default(ColorFilter.Companion, j, 0, 2, null);
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            BoxKt.Box(PainterModifierKt.paint$default(SizeKt.m884size3ABfNKs(Modifier.Companion, ContextMenuSpec.INSTANCE.m391getIconSizeD9Ej5fM()), painterResource, false, null, ContentScale.Companion.getFit(), 0.0f, (ColorFilter) rememberedValue2, 22, null), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
