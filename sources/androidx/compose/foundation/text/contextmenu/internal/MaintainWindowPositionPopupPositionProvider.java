...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public final IntSize m1698getPreviousWindowSizebOM6tXw() {
        return this.previousWindowSize;
    }

    /* renamed from: setPreviousWindowSize-fhxjrPA  reason: not valid java name */
    public final void m1701setPreviousWindowSizefhxjrPA(IntSize intSize) {
    ...
    public long mo401calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        ...
        if (intOffset != null) {
            ...
            if ((intSize == null ? false : IntSize.m8329equalsimpl0(intSize.m8335unboximpl(), j)) && this.previousLayoutDirection == layoutDirection) {
                IntSize intSize2 = this.previousPopupContentSize;
                if (intSize2 != null ? IntSize.m8329equalsimpl0(intSize2.m8335unboximpl(), j2) : false) {
                    return intOffset.m8297unboximpl();
                }
            }
        }
        long mo401calculatePositionllwVHH4 = this.popupPositionProvider.mo401calculatePositionllwVHH4(intRect, j, layoutDirection, j2);
        this.previousWindowSize = IntSize.m8323boximpl(j);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.m8323boximpl(j2);
        this.previousPosition = IntOffset.m8279boximpl(mo401calculatePositionllwVHH4);
        return mo401calculatePositionllwVHH4;
    }
}
