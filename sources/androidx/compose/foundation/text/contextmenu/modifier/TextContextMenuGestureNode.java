...
public final class TextContextMenuGestureNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode {
        ...
        delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.text.contextmenu.modifier.TextContextMenuGestureNode.1
            ...
            /* synthetic */ class C00151 extends FunctionReferenceImpl implements Function1<Offset, Unit> {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m1415invokek4lQ0M(offset.m4303unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final void m1415invokek4lQ0M(long j) {
                    ((TextContextMenuGestureNode) this.receiver).m1414tryShowContextMenuk4lQ0M(j);
                }
            }
    ...
    public final void update(Function1<? super Continuation<? super Unit>, ? extends Object> function1) {
        this.onPreShowContextMenu = function1;
    }
    ...
    public final void m1414tryShowContextMenuk4lQ0M(long j) {
        ...
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new TextContextMenuGestureNode$tryShowContextMenu$1(this, textContextMenuProvider, new ClickTextContextMenuDataProvider(this, j, null), null), 3, null);
    }
    ...
    public final class ClickTextContextMenuDataProvider implements TextContextMenuDataProvider {
        ...
        public long mo1416positiontuRUvjQ(LayoutCoordinates layoutCoordinates) {
            LayoutCoordinates localCoordinates = TextContextMenuGestureNode.this.getLocalCoordinates();
            if (localCoordinates != null) {
                return layoutCoordinates.mo5963localPositionOfR5De75A(localCoordinates, this.localClickOffset);
            }
        ...
        public Rect contentBounds(LayoutCoordinates layoutCoordinates) {
            return RectKt.m4333Recttz77jQw(mo1416positiontuRUvjQ(layoutCoordinates), Size.Companion.m4371getZeroNHjbRc());
        }
