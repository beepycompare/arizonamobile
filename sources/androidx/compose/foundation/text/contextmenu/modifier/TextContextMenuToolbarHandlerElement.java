...
public final class TextContextMenuToolbarHandlerElement extends ModifierNodeElement<TextContextMenuToolbarHandlerNode> {
    ...
    public void update(TextContextMenuToolbarHandlerNode textContextMenuToolbarHandlerNode) {
        textContextMenuToolbarHandlerNode.getRequester().setToolbarHandlerNode$foundation_release(null);
        textContextMenuToolbarHandlerNode.setRequester(this.requester);
        textContextMenuToolbarHandlerNode.getRequester().setToolbarHandlerNode$foundation_release(textContextMenuToolbarHandlerNode);
