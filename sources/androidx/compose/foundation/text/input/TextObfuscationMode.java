...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1740constructorimpl(0);
    private static final int RevealLastTyped = m1740constructorimpl(1);
    private static final int Hidden = m1740constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1739boximpl(int i) {
        return new TextObfuscationMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1740constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1741equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1745unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1742equalsimpl0(int i, int i2) {
        return i == i2;
    }
