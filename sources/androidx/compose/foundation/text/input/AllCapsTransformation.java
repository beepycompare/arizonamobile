...
final class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.Companion.m6927getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, (int) WebSocketProtocol.PAYLOAD_SHORT, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i = 0; i < changes.getChangeCount(); i++) {
            long mo1433getRangejx7JFs = changes.mo1433getRangejx7JFs(i);
            changes.mo1432getOriginalRangejx7JFs(i);
            if (!TextRange.m6707getCollapsedimpl(mo1433getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m6711getMinimpl(mo1433getRangejx7JFs), TextRange.m6710getMaximpl(mo1433getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m6720substringFDrldGo(textFieldBuffer.asCharSequence(), mo1433getRangejx7JFs), this.locale));
            }
        }
    }
