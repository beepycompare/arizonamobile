...
final class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.Companion.m7672getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, (int) WebSocketProtocol.PAYLOAD_SHORT, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i = 0; i < changes.getChangeCount(); i++) {
            long mo1444getRangejx7JFs = changes.mo1444getRangejx7JFs(i);
            changes.mo1443getOriginalRangejx7JFs(i);
            if (!TextRange.m7452getCollapsedimpl(mo1444getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m7456getMinimpl(mo1444getRangejx7JFs), TextRange.m7455getMaximpl(mo1444getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m7465substringFDrldGo(textFieldBuffer.asCharSequence(), mo1444getRangejx7JFs), this.locale));
            }
        }
    }
