...
final class AllCapsTransformation implements InputTransformation {
    private final KeyboardOptions keyboardOptions = new KeyboardOptions(KeyboardCapitalization.Companion.m7918getCharactersIUNYP9k(), (Boolean) null, 0, 0, (PlatformImeOptions) null, (Boolean) null, (LocaleList) null, (int) WebSocketProtocol.PAYLOAD_SHORT, (DefaultConstructorMarker) null);
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        for (int i = 0; i < changes.getChangeCount(); i++) {
            long mo1534getRangejx7JFs = changes.mo1534getRangejx7JFs(i);
            changes.mo1533getOriginalRangejx7JFs(i);
            if (!TextRange.m7695getCollapsedimpl(mo1534getRangejx7JFs)) {
                textFieldBuffer.replace(TextRange.m7699getMinimpl(mo1534getRangejx7JFs), TextRange.m7698getMaximpl(mo1534getRangejx7JFs), StringKt.toUpperCase(TextRangeKt.m7708substringFDrldGo(textFieldBuffer.asCharSequence(), mo1534getRangejx7JFs), this.locale));
            }
        }
    }
