...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1602adjustHandwritingDeleteGestureRange72CqOWE(long j, CharSequence charSequence) {
        int m7701getStartimpl = TextRange.m7701getStartimpl(j);
        int m7696getEndimpl = TextRange.m7696getEndimpl(j);
        int codePointBefore = m7701getStartimpl > 0 ? Character.codePointBefore(charSequence, m7701getStartimpl) : 10;
        int codePointAt = m7696getEndimpl < charSequence.length() ? Character.codePointAt(charSequence, m7696getEndimpl) : 10;
        if (isWhitespaceExceptNewline(codePointBefore) && (isWhitespace(codePointAt) || isPunctuation(codePointAt))) {
            do {
                m7701getStartimpl -= Character.charCount(codePointBefore);
                if (m7701getStartimpl == 0) {
                    break;
                }
                codePointBefore = Character.codePointBefore(charSequence, m7701getStartimpl);
            } while (isWhitespaceExceptNewline(codePointBefore));
            return TextRangeKt.TextRange(m7701getStartimpl, m7696getEndimpl);
        } else if (isWhitespaceExceptNewline(codePointAt)) {
            if (isWhitespace(codePointBefore) || isPunctuation(codePointBefore)) {
                do {
                    m7696getEndimpl += Character.charCount(codePointAt);
                    if (m7696getEndimpl == charSequence.length()) {
                        break;
                    }
                    codePointAt = Character.codePointAt(charSequence, m7696getEndimpl);
    ...
    public static final long toOffset(PointF pointF) {
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(pointF.x) << 32) | (Float.floatToRawIntBits(pointF.y) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRect-OH9lIzo  reason: not valid java name */
    public static final long m1611getRangeForScreenRectOH9lIzo(TextLayoutState textLayoutState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        return m1609getRangeForScreenRectO048IG0(layoutResult != null ? layoutResult.getMultiParagraph() : null, rect, textLayoutState.getTextLayoutNodeCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0  reason: not valid java name */
    public static final long m1613getRangeForScreenRectsO048IG0(TextLayoutState textLayoutState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1611getRangeForScreenRectOH9lIzo = m1611getRangeForScreenRectOH9lIzo(textLayoutState, rect, i, textInclusionStrategy);
        if (TextRange.m7695getCollapsedimpl(m1611getRangeForScreenRectOH9lIzo)) {
            return TextRange.Companion.m7706getZerod9O1mEE();
        }
        long m1611getRangeForScreenRectOH9lIzo2 = m1611getRangeForScreenRectOH9lIzo(textLayoutState, rect2, i, textInclusionStrategy);
        return TextRange.m7695getCollapsedimpl(m1611getRangeForScreenRectOH9lIzo2) ? TextRange.Companion.m7706getZerod9O1mEE() : m1603enclosurepWDy79M(m1611getRangeForScreenRectOH9lIzo, m1611getRangeForScreenRectOH9lIzo2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRect-OH9lIzo  reason: not valid java name */
    public static final long m1610getRangeForScreenRectOH9lIzo(LegacyTextFieldState legacyTextFieldState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult value;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        return m1609getRangeForScreenRectO048IG0((layoutResult == null || (value = layoutResult.getValue()) == null) ? null : value.getMultiParagraph(), rect, legacyTextFieldState.getLayoutCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0  reason: not valid java name */
    public static final long m1612getRangeForScreenRectsO048IG0(LegacyTextFieldState legacyTextFieldState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1610getRangeForScreenRectOH9lIzo = m1610getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect, i, textInclusionStrategy);
        if (TextRange.m7695getCollapsedimpl(m1610getRangeForScreenRectOH9lIzo)) {
            return TextRange.Companion.m7706getZerod9O1mEE();
        }
        long m1610getRangeForScreenRectOH9lIzo2 = m1610getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect2, i, textInclusionStrategy);
        return TextRange.m7695getCollapsedimpl(m1610getRangeForScreenRectOH9lIzo2) ? TextRange.Companion.m7706getZerod9O1mEE() : m1603enclosurepWDy79M(m1610getRangeForScreenRectOH9lIzo, m1610getRangeForScreenRectOH9lIzo2);
    }
    ...
    public static final int m1606getOffsetForHandwritingGestured4ec7I(TextLayoutState textLayoutState, long j, ViewConfiguration viewConfiguration) {
        MultiParagraph multiParagraph;
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null || (multiParagraph = layoutResult.getMultiParagraph()) == null) {
            return -1;
        }
        return m1607getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, textLayoutState.getTextLayoutNodeCoordinates(), viewConfiguration);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getOffsetForHandwritingGesture-d-4ec7I  reason: not valid java name */
    public static final int m1605getOffsetForHandwritingGestured4ec7I(LegacyTextFieldState legacyTextFieldState, long j, ViewConfiguration viewConfiguration) {
        TextLayoutResult value;
        MultiParagraph multiParagraph;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        ...
        return m1607getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, legacyTextFieldState.getLayoutCoordinates(), viewConfiguration);
    }
    ...
    private static final long m1609getRangeForScreenRectO048IG0(MultiParagraph multiParagraph, Rect rect, LayoutCoordinates layoutCoordinates, int i, TextInclusionStrategy textInclusionStrategy) {
        if (multiParagraph == null || layoutCoordinates == null) {
            return TextRange.Companion.m7706getZerod9O1mEE();
        }
        return multiParagraph.m7536getRangeForRect86BmAI(rect.m5216translatek4lQ0M(layoutCoordinates.mo6889screenToLocalMKHz9U(Offset.Companion.m5195getZeroF1C5BW0())), i, textInclusionStrategy);
    }

    /* renamed from: getOffsetForHandwritingGesture-ubNVwUQ  reason: not valid java name */
    private static final int m1607getOffsetForHandwritingGestureubNVwUQ(MultiParagraph multiParagraph, long j, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long mo6889screenToLocalMKHz9U;
        int m1604getLineForHandwritingGestured4ec7I;
        if (layoutCoordinates == null || (m1604getLineForHandwritingGestured4ec7I = m1604getLineForHandwritingGestured4ec7I(multiParagraph, (mo6889screenToLocalMKHz9U = layoutCoordinates.mo6889screenToLocalMKHz9U(j)), viewConfiguration)) == -1) {
            return -1;
        }
        return multiParagraph.m7535getOffsetForPositionk4lQ0M(Offset.m5173copydBAh8RU$default(mo6889screenToLocalMKHz9U, 0.0f, (multiParagraph.getLineTop(m1604getLineForHandwritingGestured4ec7I) + multiParagraph.getLineBottom(m1604getLineForHandwritingGestured4ec7I)) / 2.0f, 1, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForRemoveSpaceGesture-5iVPX68  reason: not valid java name */
    public static final long m1608getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult textLayoutResult, long j, long j2, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        if (textLayoutResult == null || layoutCoordinates == null) {
            return TextRange.Companion.m7706getZerod9O1mEE();
        }
        long mo6889screenToLocalMKHz9U = layoutCoordinates.mo6889screenToLocalMKHz9U(j);
        long mo6889screenToLocalMKHz9U2 = layoutCoordinates.mo6889screenToLocalMKHz9U(j2);
        int m1604getLineForHandwritingGestured4ec7I = m1604getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo6889screenToLocalMKHz9U, viewConfiguration);
        int m1604getLineForHandwritingGestured4ec7I2 = m1604getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo6889screenToLocalMKHz9U2, viewConfiguration);
        if (m1604getLineForHandwritingGestured4ec7I != -1) {
            if (m1604getLineForHandwritingGestured4ec7I2 != -1) {
                m1604getLineForHandwritingGestured4ec7I = Math.min(m1604getLineForHandwritingGestured4ec7I, m1604getLineForHandwritingGestured4ec7I2);
            }
            m1604getLineForHandwritingGestured4ec7I2 = m1604getLineForHandwritingGestured4ec7I;
        } else if (m1604getLineForHandwritingGestured4ec7I2 == -1) {
            return TextRange.Companion.m7706getZerod9O1mEE();
        }
        float lineTop = (textLayoutResult.getLineTop(m1604getLineForHandwritingGestured4ec7I2) + textLayoutResult.getLineBottom(m1604getLineForHandwritingGestured4ec7I2)) / 2;
        int i = (int) (mo6889screenToLocalMKHz9U >> 32);
        int i2 = (int) (mo6889screenToLocalMKHz9U2 >> 32);
        return textLayoutResult.getMultiParagraph().m7536getRangeForRect86BmAI(new Rect(Math.min(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop - 0.1f, Math.max(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop + 0.1f), TextGranularity.Companion.m7662getCharacterDRrd7Zo(), TextInclusionStrategy.Companion.getAnyOverlap());
    }

    /* renamed from: getLineForHandwritingGesture-d-4ec7I  reason: not valid java name */
    private static final int m1604getLineForHandwritingGestured4ec7I(MultiParagraph multiParagraph, long j, ViewConfiguration viewConfiguration) {
    ...
    private static final long m1603enclosurepWDy79M(long j, long j2) {
        return TextRangeKt.TextRange(Math.min(TextRange.m7701getStartimpl(j), TextRange.m7701getStartimpl(j)), Math.max(TextRange.m7696getEndimpl(j2), TextRange.m7696getEndimpl(j2)));
    }
}
