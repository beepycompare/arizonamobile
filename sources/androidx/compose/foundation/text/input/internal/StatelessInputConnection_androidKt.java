...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m7606getMinimpl(textFieldCharSequence.m1724getSelectiond9O1mEE());
        extractedText.selectionEnd = TextRange.m7605getMaximpl(textFieldCharSequence.m1724getSelectiond9O1mEE());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int m393getKeyboardkB6V9T0 = TransferableContent.Source.Companion.m393getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, m393getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
