...
public final class TextFieldCoreModifierKt {
    private static final float DefaultCursorThickness = Dp.m6684constructorimpl(2);

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean isSpecified(Brush brush) {
        return ((brush instanceof SolidColor) && ((SolidColor) brush).m4414getValue0d7_KjU() == 16) ? false : true;
    }
    ...
    public static final Rect getCursorRectInScroller(Density density, Rect rect, boolean z, int i) {
        float left;
        float left2;
        int mo383roundToPx0680j_4 = density.mo383roundToPx0680j_4(DefaultCursorThickness);
        if (z) {
        ...
        return Rect.copy$default(rect, f, 0.0f, left2 + mo383roundToPx0680j_4, 0.0f, 10, null);
    }
