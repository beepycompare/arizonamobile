...
public final class TextLayoutState {
    ...
    public TextLayoutState() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m8158boximpl(Dp.m8160constructorimpl(0.0f)), null, 2, null);
    ...
    public final float m1880getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m8174unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4  reason: not valid java name */
    public final void m1884setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1883layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver resolver, long j) {
        TextLayoutResult m1872layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1872layoutWithNewMeasureInputshBUhpc(density, layoutDirection, resolver, j);
        ...
        return m1872layoutWithNewMeasureInputshBUhpc;
    }
    ...
    public static /* synthetic */ int m1878getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1881getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m1881getOffsetForPosition3MmeM6k(long j, boolean z) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (z) {
            j = m1879coercedInVisibleBoundsOfInputTextMKHz9U$foundation(j);
        }
        return layoutResult.m7578getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1886fromDecorationToTextLayoutUv8p0NA(this, j));
    }

    /* renamed from: isPositionOnText-k-4lQ0M  reason: not valid java name */
    public final boolean m1882isPositionOnTextk4lQ0M(long j) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long m1886fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1886fromDecorationToTextLayoutUv8p0NA(this, m1879coercedInVisibleBoundsOfInputTextMKHz9U$foundation(j));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & m1886fromDecorationToTextLayoutUv8p0NA)));
        int i = (int) (m1886fromDecorationToTextLayoutUv8p0NA >> 32);
    ...
    */
    public final long m1879coercedInVisibleBoundsOfInputTextMKHz9U$foundation(long j) {
        Rect zero;
        ...
        zero = Rect.Companion.getZero();
        return TextLayoutStateKt.m1885coerceIn3MmeM6k(j, zero);
    }
}
