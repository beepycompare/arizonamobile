...
public final class TextLayoutState {
    ...
    public final float m1584getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m8010unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4  reason: not valid java name */
    public final void m1588setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1587layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver resolver, long j) {
        TextLayoutResult m1575layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1575layoutWithNewMeasureInputshBUhpc(density, layoutDirection, resolver, j);
        ...
        return m1575layoutWithNewMeasureInputshBUhpc;
    }
    ...
    public static /* synthetic */ int m1582getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1585getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m1585getOffsetForPosition3MmeM6k(long j, boolean z) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (z) {
            j = m1583coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j);
        }
        return layoutResult.m7428getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1590fromDecorationToTextLayoutUv8p0NA(this, j));
    }

    /* renamed from: isPositionOnText-k-4lQ0M  reason: not valid java name */
    public final boolean m1586isPositionOnTextk4lQ0M(long j) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long m1590fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1590fromDecorationToTextLayoutUv8p0NA(this, m1583coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(j));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & m1590fromDecorationToTextLayoutUv8p0NA)));
        int i = (int) (m1590fromDecorationToTextLayoutUv8p0NA >> 32);
    ...
    */
    public final long m1583coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long j) {
        Rect zero;
        ...
        zero = Rect.Companion.getZero();
        return TextLayoutStateKt.m1589coerceIn3MmeM6k(j, zero);
    }
}
