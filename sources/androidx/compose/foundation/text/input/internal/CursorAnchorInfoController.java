...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m5592constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m5601resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo6834transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m5215setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1761buildvxqZcH0(this.builder, visualText, visualText.m1724getSelectiond9O1mEE(), visualText.m1723getCompositionMzsxiRA(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m5140translatek4lQ0M(textLayoutNodeCoordinates.mo6827localPositionOfR5De75A(coreNodeCoordinates, Offset.Companion.m5119getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m5140translatek4lQ0M(textLayoutNodeCoordinates.mo6827localPositionOfR5De75A(decoratorNodeCoordinates, Offset.Companion.m5119getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
