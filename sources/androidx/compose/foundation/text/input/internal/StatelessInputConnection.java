...
public final class StatelessInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int i) {
        String obj = TextRange.m7602getCollapsedimpl(getText().m1724getSelectiond9O1mEE()) ? null : TextFieldCharSequenceKt.getSelectedText(getText()).toString();
    ...
    public int getCursorCapsMode(int i) {
        ...
        return TextUtils.getCapsMode(getText(), TextRange.m7606getMinimpl(getText().m1724getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        this.session.mo1753onImeActionKlQnJC8(m7789getDefaulteUduSuo);
        return true;
    }
