...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m7451getCollapsedimpl(this.textFieldValue.m7708getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m7455getMinimpl(this.textFieldValue.m7708getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (z) {
            ...
            this.eventCallback.mo1528onImeActionKlQnJC8(m7639getDefaulteUduSuo);
            return true;
        }
        return z;
    }
