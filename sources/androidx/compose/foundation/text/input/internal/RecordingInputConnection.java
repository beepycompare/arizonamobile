...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m6720getCollapsedimpl(this.textFieldValue.m6977getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m6724getMinimpl(this.textFieldValue.m6977getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (z) {
            ...
            this.eventCallback.mo1528onImeActionKlQnJC8(m6908getDefaulteUduSuo);
            return true;
        }
        return z;
    }
