...
public final class TextFieldKeyEventHandler_androidKt {
    ...
    public static final boolean m1870isFromSoftKeyboardZmokQxo(KeyEvent keyEvent) {
        return (keyEvent.getFlags() & 2) == 2;
    }

    /* renamed from: isKeyCode-YhN2O0w  reason: not valid java name */
    private static final boolean m1871isKeyCodeYhN2O0w(KeyEvent keyEvent, int i) {
