...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static /* synthetic */ CursorAnchorInfo m1762buildvxqZcH0$default(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4, int i, Object obj) {
        if ((i & 128) != 0) {
            z = true;
        }
        if ((i & 256) != 0) {
        ...
        return m1761buildvxqZcH0(builder, charSequence, j, textRange, textLayoutResult, matrix, rect, rect2, z, z2, z3, z4);
    }

    /* renamed from: build-vxqZcH0  reason: not valid java name */
    public static final CursorAnchorInfo m1761buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int m7606getMinimpl = TextRange.m7606getMinimpl(j);
        builder.setSelectionRange(m7606getMinimpl, TextRange.m7605getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, m7606getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int m7606getMinimpl2 = textRange != null ? TextRange.m7606getMinimpl(textRange.m7612unboximpl()) : -1;
            int m7605getMaximpl = textRange != null ? TextRange.m7605getMaximpl(textRange.m7612unboximpl()) : -1;
            if (m7606getMinimpl2 >= 0 && m7606getMinimpl2 < m7605getMaximpl) {
                builder.setComposingText(m7606getMinimpl2, charSequence.subSequence(m7606getMinimpl2, m7605getMaximpl));
                addCharacterBounds(builder, m7606getMinimpl2, m7605getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    private static final CursorAnchorInfo.Builder setInsertionMarker(CursorAnchorInfo.Builder builder, int i, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        float coerceIn = RangesKt.coerceIn(cursorRect.getLeft(), 0.0f, (int) (textLayoutResult.m7579getSizeYbymL2g() >> 32));
    ...
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder builder, int i, int i2, TextLayoutResult textLayoutResult, Rect rect) {
        ...
        textLayoutResult.getMultiParagraph().m7468fillBoundingBoxes8ffj60Q(TextRangeKt.TextRange(i, i2), fArr, 0);
