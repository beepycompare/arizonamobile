...
public final class TextFieldLayoutStateCache implements State<TextLayoutResult>, StateObject {
    ...
    public final void updateNonMeasureInputs(TransformedTextFieldState transformedTextFieldState, TextStyle textStyle, boolean z, boolean z2, KeyboardOptions keyboardOptions) {
        setNonMeasureInputs(new NonMeasureInputs(transformedTextFieldState, textStyle, z, z2, KeyboardType.m6935equalsimpl0(keyboardOptions.m1275getKeyboardTypePjHm6EE(), KeyboardType.Companion.m6955getPhonePjHm6EE())));
    }

    /* renamed from: layoutWithNewMeasureInputs--hBUhpc  reason: not valid java name */
    public final TextLayoutResult m1564layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver resolver, long j) {
    ...
    private final TextLayoutResult getOrComputeLayout(NonMeasureInputs nonMeasureInputs, MeasureInputs measureInputs) {
        ...
        if (layoutResult != null && (visualText = cacheRecord.getVisualText()) != null && StringsKt.contentEquals(visualText, visualText2) && Intrinsics.areEqual(cacheRecord.getAnnotations(), mergeNullableLists) && Intrinsics.areEqual(cacheRecord.m1565getCompositionMzsxiRA(), visualText2.m1435getCompositionMzsxiRA()) && cacheRecord.getSingleLine() == nonMeasureInputs.getSingleLine() && cacheRecord.getSoftWrap() == nonMeasureInputs.getSoftWrap() && cacheRecord.getLayoutDirection() == measureInputs.getLayoutDirection() && cacheRecord.getDensityValue() == measureInputs.getDensity().getDensity() && cacheRecord.getFontScale() == measureInputs.getDensity().getFontScale() && Constraints.m7197equalsimpl0(cacheRecord.m1566getConstraintsmsEJaDk(), measureInputs.m1569getConstraintsmsEJaDk()) && Intrinsics.areEqual(cacheRecord.getFontFamilyResolver(), measureInputs.getFontFamilyResolver()) && !layoutResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts()) {
            ...
            if (hasSameLayoutAffectingAttributes) {
                return TextLayoutResult.m6681copyO0kMr_c$default(layoutResult, new TextLayoutInput(layoutResult.getLayoutInput().getText(), nonMeasureInputs.getTextStyle(), layoutResult.getLayoutInput().getPlaceholders(), layoutResult.getLayoutInput().getMaxLines(), layoutResult.getLayoutInput().getSoftWrap(), layoutResult.getLayoutInput().m6680getOverflowgIe3tQ8(), layoutResult.getLayoutInput().getDensity(), layoutResult.getLayoutInput().getLayoutDirection(), layoutResult.getLayoutInput().getFontFamilyResolver(), layoutResult.getLayoutInput().m6679getConstraintsmsEJaDk(), (DefaultConstructorMarker) null), 0L, 2, null);
            }
        }
        ...
        if (!Intrinsics.areEqual(computeLayout, layoutResult)) {
            ...
            if (!current.getReadOnly()) {
                ...
                synchronized (SnapshotKt.getLock()) {
                    ...
                    cacheRecord3.m1567setCompositionOEnZFl4(visualText2.m1435getCompositionMzsxiRA());
                    ...
                    cacheRecord3.m1568setConstraintsBRTryo0(measureInputs.m1569getConstraintsmsEJaDk());
    ...
    public static final class CacheRecord extends StateRecord {
        ...
        public final TextRange m1565getCompositionMzsxiRA() {
            return this.composition;
        }

        /* renamed from: setComposition-OEnZFl4  reason: not valid java name */
        public final void m1567setCompositionOEnZFl4(TextRange textRange) {
        ...
        public final long m1566getConstraintsmsEJaDk() {
            return this.constraints;
        }

        /* renamed from: setConstraints-BRTryo0  reason: not valid java name */
        public final void m1568setConstraintsBRTryo0(long j) {
            this.constraints = j;
        }
    ...
    public static final class MeasureInputs {
        ...
        /* renamed from: getConstraints-msEJaDk  reason: not valid java name */
        public final long m1569getConstraintsmsEJaDk() {
            return this.constraints;
        }
        ...
        public String toString() {
            return "MeasureInputs(density=" + this.density + ", densityValue=" + this.densityValue + ", fontScale=" + this.fontScale + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m7209toStringimpl(this.constraints)) + ')';
        }
