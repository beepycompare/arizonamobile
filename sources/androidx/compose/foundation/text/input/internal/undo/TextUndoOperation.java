...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m7608getStartimpl(textUndoOperation.m1955getPreSelectiond9O1mEE())), Integer.valueOf(TextRange.m7603getEndimpl(textUndoOperation.m1955getPreSelectiond9O1mEE())), Integer.valueOf(TextRange.m7608getStartimpl(textUndoOperation.m1954getPostSelectiond9O1mEE())), Integer.valueOf(TextRange.m7603getEndimpl(textUndoOperation.m1954getPostSelectiond9O1mEE())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final long m1955getPreSelectiond9O1mEE() {
        return this.preSelection;
    }

    /* renamed from: getPostSelection-d9O1mEE  reason: not valid java name */
    public final long m1954getPostSelectiond9O1mEE() {
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m7602getCollapsedimpl(this.postSelection)) {
            boolean m7602getCollapsedimpl = TextRange.m7602getCollapsedimpl(this.preSelection);
            long j = this.preSelection;
            if (m7602getCollapsedimpl) {
                if (TextRange.m7608getStartimpl(j) > TextRange.m7608getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            } else if (TextRange.m7608getStartimpl(j) == TextRange.m7608getStartimpl(this.postSelection) && TextRange.m7608getStartimpl(this.preSelection) == this.index) {
