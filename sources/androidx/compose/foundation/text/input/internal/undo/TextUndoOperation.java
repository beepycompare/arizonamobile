...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m6147getStartimpl(textUndoOperation.m1402getPreSelectiond9O1mEE())), Integer.valueOf(TextRange.m6142getEndimpl(textUndoOperation.m1402getPreSelectiond9O1mEE())), Integer.valueOf(TextRange.m6147getStartimpl(textUndoOperation.m1401getPostSelectiond9O1mEE())), Integer.valueOf(TextRange.m6142getEndimpl(textUndoOperation.m1401getPostSelectiond9O1mEE())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final long m1402getPreSelectiond9O1mEE() {
        return this.preSelection;
    }

    /* renamed from: getPostSelection-d9O1mEE  reason: not valid java name */
    public final long m1401getPostSelectiond9O1mEE() {
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m6141getCollapsedimpl(this.postSelection)) {
            if (TextRange.m6141getCollapsedimpl(this.preSelection)) {
                if (TextRange.m6147getStartimpl(this.preSelection) > TextRange.m6147getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            } else if (TextRange.m6147getStartimpl(this.preSelection) == TextRange.m6147getStartimpl(this.postSelection) && TextRange.m6147getStartimpl(this.preSelection) == this.index) {
