...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer$foundation, TextRange.m7608getStartimpl(textUndoOperation.m1955getPreSelectiond9O1mEE()), TextRange.m7603getEndimpl(textUndoOperation.m1955getPreSelectiond9O1mEE()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation(), TextFieldBuffer.m1713toTextFieldCharSequencewFTz33Y$foundation$default(textFieldState.getMainBuffer$foundation(), 0L, null, null, null, 15, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer$foundation, TextRange.m7608getStartimpl(textUndoOperation.m1954getPostSelectiond9O1mEE()), TextRange.m7603getEndimpl(textUndoOperation.m1954getPostSelectiond9O1mEE()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation(), TextFieldBuffer.m1713toTextFieldCharSequencewFTz33Y$foundation$default(textFieldState.getMainBuffer$foundation(), 0L, null, null, null, 15, null), true);
    }
}
