...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer$foundation_release, TextRange.m6713getStartimpl(textUndoOperation.m1662getPreSelectiond9O1mEE()), TextRange.m6708getEndimpl(textUndoOperation.m1662getPreSelectiond9O1mEE()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), TextFieldBuffer.m1425toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldState.getMainBuffer$foundation_release(), 0L, null, null, null, 15, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer$foundation_release, TextRange.m6713getStartimpl(textUndoOperation.m1661getPostSelectiond9O1mEE()), TextRange.m6708getEndimpl(textUndoOperation.m1661getPostSelectiond9O1mEE()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation_release(), TextFieldBuffer.m1425toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldState.getMainBuffer$foundation_release(), 0L, null, null, null, 15, null), true);
    }
}
