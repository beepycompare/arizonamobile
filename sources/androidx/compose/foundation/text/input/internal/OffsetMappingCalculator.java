...
public final class OffsetMappingCalculator {
    ...
    private int[] ops = OpArray.m1843constructorimpl(10);
    private int opsSize;
    ...
    public final void recordEditOperation(int i, int i2, int i3) {
        ...
        if (max >= 2 || max != i3) {
            ...
            if (i4 > OpArray.m1850getSizeimpl(this.ops)) {
                this.ops = OpArray.m1845copyOfpSmdads(this.ops, Math.max(i4 * 2, OpArray.m1850getSizeimpl(this.ops) * 2));
            }
            OpArray.m1852setimpl(this.ops, this.opsSize, min, max, i3);
            this.opsSize = i4;
        }
    }

    /* renamed from: mapFromSource--jx7JFs  reason: not valid java name */
    public final long m1841mapFromSourcejx7JFs(int i) {
        return m1838mapfzxv0v0(i, true);
    }

    /* renamed from: mapFromDest--jx7JFs  reason: not valid java name */
    public final long m1840mapFromDestjx7JFs(int i) {
        return m1838mapfzxv0v0(i, false);
    }

    /* renamed from: map-fzxv0v0  reason: not valid java name */
    private final long m1838mapfzxv0v0(int i, boolean z) {
        int i2;
        int i3;
        int[] iArr = this.ops;
        int i4 = this.opsSize;
        if (i4 >= 0) {
            if (z) {
                ...
                for (int i5 = 0; i5 < i4; i5++) {
                    ...
                    int i8 = iArr[i6 + 1];
                    int i9 = iArr[i6 + 2];
                    long m1839mapStepC6uMEY = m1839mapStepC6uMEY(i3, i7, i8, i9, z);
                    long m1839mapStepC6uMEY2 = m1839mapStepC6uMEY(i, i7, i8, i9, z);
                    i3 = Math.min(TextRange.m7608getStartimpl(m1839mapStepC6uMEY), TextRange.m7608getStartimpl(m1839mapStepC6uMEY2));
                    i = Math.max(TextRange.m7603getEndimpl(m1839mapStepC6uMEY), TextRange.m7603getEndimpl(m1839mapStepC6uMEY2));
                }
            } else {
                int i10 = i4 - 1;
                i3 = i;
                while (-1 < i10) {
                    ...
                    boolean z2 = z;
                    long m1839mapStepC6uMEY3 = offsetMappingCalculator.m1839mapStepC6uMEY(i3, i12, i13, i14, z2);
                    long m1839mapStepC6uMEY4 = offsetMappingCalculator.m1839mapStepC6uMEY(i, i12, i13, i14, z2);
                    i3 = Math.min(TextRange.m7608getStartimpl(m1839mapStepC6uMEY3), TextRange.m7608getStartimpl(m1839mapStepC6uMEY4));
                    i = Math.max(TextRange.m7603getEndimpl(m1839mapStepC6uMEY3), TextRange.m7603getEndimpl(m1839mapStepC6uMEY4));
                    i10--;
    ...
    private final long m1839mapStepC6uMEY(int i, int i2, int i3, int i4, boolean z) {
        int i5 = z ? i3 : i4;
        if (z) {
            i3 = i4;
        }
