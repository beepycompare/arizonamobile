...
public final class TextFieldMagnifierNodeImpl28$restartAnimationJob$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            if (snapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$restartAnimationJob$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Object obj2, Continuation continuation) {
                    return m1635emit3MmeM6k(((Offset) obj2).m5046unboximpl(), continuation);
                }

                /* renamed from: emit-3MmeM6k  reason: not valid java name */
                public final Object m1635emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    Animatable animatable;
                    Animatable animatable2;
                    Animatable animatable3;
                    animatable = TextFieldMagnifierNodeImpl28.this.animatable;
                    if ((((Offset) animatable.getValue()).m5046unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats && (j & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        animatable3 = TextFieldMagnifierNodeImpl28.this.animatable;
                        if (Float.intBitsToFloat((int) (((Offset) animatable3.getValue()).m5046unboximpl() & 4294967295L)) != Float.intBitsToFloat((int) (j & 4294967295L))) {
                    ...
                    Object snapTo = animatable2.snapTo(Offset.m5025boximpl(j), continuation);
                ...
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            this.label = 1;
                            if (Animatable.animateTo$default(animatable, Offset.m5025boximpl(this.$targetValue), SelectionMagnifierKt.getMagnifierSpringSpec(), null, null, this, 12, null) == coroutine_suspended) {
    ...
    public static final Offset invokeSuspend$lambda$0(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28) {
        ...
        long m1633getMagnifierSizeYbymL2g;
        ...
        m1633getMagnifierSizeYbymL2g = textFieldMagnifierNodeImpl28.m1633getMagnifierSizeYbymL2g();
        return Offset.m5025boximpl(TextFieldMagnifierKt.m1631calculateSelectionMagnifierCenterAndroidhUlJWOE(transformedTextFieldState, textFieldSelectionState, textLayoutState, m1633getMagnifierSizeYbymL2g));
    }
}
