...
public final class TextFieldSelectionState {
    ...
    public TextFieldSelectionState(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, Density density, boolean z, boolean z2, boolean z3, boolean z4, ToolbarRequester toolbarRequester, CoroutineScope coroutineScope, PlatformSelectionBehaviors platformSelectionBehaviors, Clipboard clipboard) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(Offset.Companion.m5118getUnspecifiedF1C5BW0()), null, 2, null);
        this.startTextLayoutPositionInWindow$delegate = mutableStateOf$default2;
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5092boximpl(Offset.Companion.m5118getUnspecifiedF1C5BW0()), null, 2, null);
        ...
        this.derivedVisibleContentBounds$delegate = SnapshotStateKt.derivedStateOf(new Function0() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState$$ExternalSyntheticLambda4
    ...
    private final long m1936getStartTextLayoutPositionInWindowF1C5BW0() {
        return ((Offset) this.startTextLayoutPositionInWindow$delegate.getValue()).m5113unboximpl();
    }

    /* renamed from: setStartTextLayoutPositionInWindow-k-4lQ0M  reason: not valid java name */
    private final void m1939setStartTextLayoutPositionInWindowk4lQ0M(long j) {
        this.startTextLayoutPositionInWindow$delegate.setValue(Offset.m5092boximpl(j));
    }

    /* renamed from: getCurrentTextLayoutPositionInWindow-F1C5BW0  reason: not valid java name */
    private final long m1933getCurrentTextLayoutPositionInWindowF1C5BW0() {
        LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
        return textLayoutCoordinates != null ? LayoutCoordinatesKt.positionInWindow(textLayoutCoordinates) : Offset.Companion.m5118getUnspecifiedF1C5BW0();
    }

    /* renamed from: getRawHandleDragPosition-F1C5BW0  reason: not valid java name */
    private final long m1935getRawHandleDragPositionF1C5BW0() {
        return ((Offset) this.rawHandleDragPosition$delegate.getValue()).m5113unboximpl();
    }

    /* renamed from: setRawHandleDragPosition-k-4lQ0M  reason: not valid java name */
    private final void m1938setRawHandleDragPositionk4lQ0M(long j) {
        this.rawHandleDragPosition$delegate.setValue(Offset.m5092boximpl(j));
    }

    /* renamed from: getHandleDragPosition-F1C5BW0  reason: not valid java name */
    public final long m1941getHandleDragPositionF1C5BW0() {
        if ((m1935getRawHandleDragPositionF1C5BW0() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            return Offset.Companion.m5118getUnspecifiedF1C5BW0();
        }
        if ((m1936getStartTextLayoutPositionInWindowF1C5BW0() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            return TextLayoutStateKt.m1886fromDecorationToTextLayoutUv8p0NA(this.textLayoutState, m1935getRawHandleDragPositionF1C5BW0());
        }
        return Offset.m5108plusMKHz9U(m1935getRawHandleDragPositionF1C5BW0(), Offset.m5107minusMKHz9U(m1936getStartTextLayoutPositionInWindowF1C5BW0(), m1933getCurrentTextLayoutPositionInWindowF1C5BW0()));
    }
    ...
    public final TextFieldHandleState getCursorHandleState$foundation(boolean z) {
        ...
        if (!showCursorHandle || !z2 || !TextRange.m7602getCollapsedimpl(visualText.m1724getSelectiond9O1mEE()) || !visualText.shouldShowSelection() || visualText.length() <= 0 || (draggingHandle != Handle.Cursor && !isCursorHandleInVisibleBounds())) {
            return TextFieldHandleState.Companion.getHidden();
        }
        return new TextFieldHandleState(true, z ? getCursorRect().m5130getBottomCenterF1C5BW0() : Offset.Companion.m5118getUnspecifiedF1C5BW0(), 0.0f, ResolvedTextDirection.Ltr, false, null);
    }
    ...
    private final boolean isCursorHandleInVisibleBounds() {
        ...
        try {
            long m5130getBottomCenterF1C5BW0 = getCursorRect().m5130getBottomCenterF1C5BW0();
            ...
            return SelectionManagerKt.m2080containsInclusiveUv8p0NA(visibleBounds, m5130getBottomCenterF1C5BW0);
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, makeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final Rect getFocusRect() {
        ...
        if (this.isFocused) {
            TextFieldCharSequence visualText = this.textFieldState.getVisualText();
            if (TextRange.m7602getCollapsedimpl(visualText.m1724getSelectiond9O1mEE())) {
    ...
    private final Rect calculateCursorRect(TextLayoutResult textLayoutResult, TextFieldCharSequence textFieldCharSequence) {
        float right;
        float rint;
        if (TextRange.m7602getCollapsedimpl(textFieldCharSequence.m1724getSelectiond9O1mEE())) {
            Rect cursorRect = textLayoutResult.getCursorRect(TextRange.m7608getStartimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()));
            float coerceAtLeast = RangesKt.coerceAtLeast((float) Math.floor(this.density.mo434toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness())), 1.0f);
            ...
            float coerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(right, ((int) (textLayoutResult.m7579getSizeYbymL2g() >> 32)) - f), f);
    ...
    private final Rect calculateSelectionRect(TextLayoutResult textLayoutResult, TextFieldCharSequence textFieldCharSequence) {
        ...
        int lineForOffset = textLayoutResult.getLineForOffset(TextRange.m7608getStartimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()));
        int lineForOffset2 = textLayoutResult.getLineForOffset(TextRange.m7603getEndimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()));
        if (lineForOffset == lineForOffset2) {
            float horizontalPosition = textLayoutResult.getHorizontalPosition(TextRange.m7608getStartimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()), true);
            float horizontalPosition2 = textLayoutResult.getHorizontalPosition(TextRange.m7603getEndimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()), true);
        ...
        return textLayoutResult.getPathForRange(TextRange.m7606getMinimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()), TextRange.m7605getMaximpl(textFieldCharSequence.m1724getSelectiond9O1mEE())).getBounds();
    }
    ...
    */
    ...
    public final boolean m1942placeCursorAtNearestOffsetk4lQ0M(long j) {
        int m7578getOffsetForPositionk4lQ0M;
        IndexTransformationType indexTransformationType;
        int m7608getStartimpl;
        SelectionWedgeAffinity selectionWedgeAffinity;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null || (m7578getOffsetForPositionk4lQ0M = layoutResult.m7578getOffsetForPositionk4lQ0M(j)) == -1) {
            return false;
        }
        TransformedTextFieldState transformedTextFieldState = this.textFieldState;
        long m1894mapFromTransformedjx7JFs = transformedTextFieldState.m1894mapFromTransformedjx7JFs(m7578getOffsetForPositionk4lQ0M);
        ...
        if (i == 1) {
            m7608getStartimpl = TextRange.m7608getStartimpl(m1894mapFromTransformedjx7JFs);
        } else if (i == 2) {
            m7608getStartimpl = TextRange.m7608getStartimpl(m1894mapFromTransformedjx7JFs);
        } else if (i == 3) {
            if (MathUtilsKt.m1830findClosestRect9KIMszo(j, layoutResult.getCursorRect(TextRange.m7608getStartimpl(m1897mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m7603getEndimpl(m1897mapToTransformedGEjPoXI))) < 0) {
            ...
            if (MathUtilsKt.m1830findClosestRect9KIMszo(j, layoutResult.getCursorRect(TextRange.m7608getStartimpl(m1897mapToTransformedGEjPoXI)), layoutResult.getCursorRect(TextRange.m7603getEndimpl(m1897mapToTransformedGEjPoXI))) < 0) {
                ...
                m7608getStartimpl = TextRange.m7603getEndimpl(m1894mapFromTransformedjx7JFs);
            }
        }
        long TextRange = TextRangeKt.TextRange(m7608getStartimpl);
        if (TextRange.m7601equalsimpl0(TextRange, this.textFieldState.getUntransformedText().m1724getSelectiond9O1mEE()) && (selectionWedgeAffinity2 == null || Intrinsics.areEqual(selectionWedgeAffinity2, this.textFieldState.getSelectionWedgeAffinity()))) {
            return false;
        }
        this.textFieldState.m1900selectUntransformedCharsIn5zctL8(TextRange);
    ...
    */
        ...
        if (continuation instanceof TextFieldSelectionState$detectCursorHandleDragGestures$1) {
            ...
            if ((textFieldSelectionState$detectCursorHandleDragGestures$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    longRef3.element = Offset.Companion.m5118getUnspecifiedF1C5BW0();
                    final Ref.LongRef longRef4 = new Ref.LongRef();
                    longRef4.element = Offset.Companion.m5118getUnspecifiedF1C5BW0();
                    try {
    ...
    private static final void detectCursorHandleDragGestures$onDragStop(Ref.LongRef longRef, Ref.LongRef longRef2, TextFieldSelectionState textFieldSelectionState) {
        if ((longRef.element & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
            longRef.element = Offset.Companion.m5118getUnspecifiedF1C5BW0();
            longRef2.element = Offset.Companion.m5118getUnspecifiedF1C5BW0();
    ...
    public static final Unit detectCursorHandleDragGestures$lambda$0(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2, Offset offset) {
        longRef.element = SelectionHandlesKt.m2053getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.getCursorRect().m5130getBottomCenterF1C5BW0());
        ...
        textFieldSelectionState.m1943updateHandleDraggingUv8p0NA(Handle.Cursor, longRef.element);
        return Unit.INSTANCE;
    }
    ...
    public static final Unit detectCursorHandleDragGestures$lambda$3(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Ref.LongRef longRef2, PointerInputChange pointerInputChange, Offset offset) {
        longRef.element = Offset.m5108plusMKHz9U(longRef.element, offset.m5113unboximpl());
        textFieldSelectionState.m1943updateHandleDraggingUv8p0NA(Handle.Cursor, Offset.m5108plusMKHz9U(longRef2.element, longRef.element));
        if (textFieldSelectionState.m1942placeCursorAtNearestOffsetk4lQ0M(textFieldSelectionState.m1941getHandleDragPositionF1C5BW0())) {
            pointerInputChange.consume();
            HapticFeedback hapticFeedback = textFieldSelectionState.hapticFeedBack;
            if (hapticFeedback != null) {
                hapticFeedback.mo6117performHapticFeedbackCdsT49E(HapticFeedbackType.Companion.m6134getTextHandleMove5zf0vsI());
            }
        }
        return Unit.INSTANCE;
    }
    ...
    private final class TextFieldMouseSelectionObserver implements MouseSelectionObserver {
        ...
        private long dragBeginPosition = Offset.Companion.m5118getUnspecifiedF1C5BW0();
        private boolean isDoubleOrTripleClickOnly = true;
        private final Function0<Unit> requestFocus;

        @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
        /* renamed from: onExtendDrag-k-4lQ0M  reason: not valid java name */
        public boolean mo1948onExtendDragk4lQ0M(long j) {
            return true;
        }
        ...
        public boolean mo1949onStart9KIMszo(long j, SelectionAdjustment selectionAdjustment, int i) {
            ...
            this.dragBeginOffsetInText = TextRange.m7608getStartimpl(m1945updateSelection12glfjA(j, selectionAdjustment, layoutResult, true));
            return true;
        }

        @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
        /* renamed from: onDrag-3MmeM6k  reason: not valid java name */
        public boolean mo1946onDrag3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
            TextLayoutResult layoutResult = TextFieldSelectionState.this.getTextLayoutState$foundation().getLayoutResult();
            if (!TextFieldSelectionState.this.getEnabled() || layoutResult == null || TextFieldSelectionState.this.getTextFieldState$foundation().getVisualText().length() == 0) {
                return false;
            }
            if (TextRange.m7601equalsimpl0(TextFieldSelectionState.this.getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE(), m1945updateSelection12glfjA(j, selectionAdjustment, layoutResult, false))) {
                return true;
            }
        ...
        private final long m1945updateSelection12glfjA(long j, SelectionAdjustment selectionAdjustment, TextLayoutResult textLayoutResult, boolean z) {
            int length = textLayoutResult.getLayoutInput().getText().length();
            int i = this.dragBeginOffsetInText;
            if (i < 0 || i > length) {
                i = TextFieldSelectionState.this.getTextLayoutState$foundation().m1881getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
            }
            int m1881getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.getTextLayoutState$foundation().m1881getOffsetForPosition3MmeM6k(j, false);
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long m1944updateSelectionQkiN0lo$foundation = textFieldSelectionState.m1944updateSelectionQkiN0lo$foundation(textFieldSelectionState.getTextFieldState$foundation().getVisualText(), i, m1881getOffsetForPosition3MmeM6k, false, selectionAdjustment, false, z, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m7602getCollapsedimpl(m1944updateSelectionQkiN0lo$foundation)) {
                this.dragBeginOffsetInText = TextRange.m7608getStartimpl(m1944updateSelectionQkiN0lo$foundation);
            }
            if (TextRange.m7607getReversedimpl(m1944updateSelectionQkiN0lo$foundation)) {
                m1944updateSelectionQkiN0lo$foundation = TextFieldSelectionStateKt.m1950access$reverse5zctL8(m1944updateSelectionQkiN0lo$foundation);
            }
            TextFieldSelectionState.this.getTextFieldState$foundation().m1899selectCharsIn5zctL8(m1944updateSelectionQkiN0lo$foundation);
            TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            return m1944updateSelectionQkiN0lo$foundation;
        }
        ...
        public boolean mo1947onExtendk4lQ0M(long j) {
            TextLayoutResult layoutResult = TextFieldSelectionState.this.getTextLayoutState$foundation().getLayoutResult();
            if (!TextFieldSelectionState.this.getEnabled() || layoutResult == null || TextFieldSelectionState.this.getTextFieldState$foundation().getVisualText().length() == 0) {
                return false;
            }
            this.isDoubleOrTripleClickOnly = false;
            this.requestFocus.invoke();
            m1945updateSelection12glfjA(j, SelectionAdjustment.Companion.getNone(), layoutResult, false);
            return true;
        }
    }
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        private int dragBeginOffsetInText = -1;
        private long dragBeginPosition = Offset.Companion.m5118getUnspecifiedF1C5BW0();
        private long dragTotalDistance = Offset.Companion.m5119getZeroF1C5BW0();
        ...
        public void mo1641onDownk4lQ0M(long j) {
        }
        ...
        private final void onDragStop() {
            if ((this.dragBeginPosition & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                ...
                this.dragBeginOffsetInText = -1;
                this.dragBeginPosition = Offset.Companion.m5118getUnspecifiedF1C5BW0();
                this.dragTotalDistance = Offset.Companion.m5119getZeroF1C5BW0();
                TextFieldSelectionState.this.previousRawDragOffset = -1;
        ...
        public void mo1643onStart3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
            if (TextFieldSelectionState.this.getEnabled()) {
                TextFieldSelectionState.this.m1943updateHandleDraggingUv8p0NA(this.actingHandle, j);
                ...
                boolean m1882isPositionOnTextk4lQ0M = TextFieldSelectionState.this.getTextLayoutState$foundation().m1882isPositionOnTextk4lQ0M(j);
                TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
                if (!m1882isPositionOnTextk4lQ0M) {
                    int m1878getOffsetForPosition3MmeM6k$default = TextLayoutState.m1878getOffsetForPosition3MmeM6k$default(textFieldSelectionState.getTextLayoutState$foundation(), j, false, 2, null);
                    HapticFeedback hapticFeedBack = TextFieldSelectionState.this.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo6117performHapticFeedbackCdsT49E(HapticFeedbackType.Companion.m6130getLongPress5zf0vsI());
                    }
                    TextFieldSelectionState.this.getTextFieldState$foundation().placeCursorBeforeCharAt(m1878getOffsetForPosition3MmeM6k$default);
                    ...
                    int m1878getOffsetForPosition3MmeM6k$default2 = TextLayoutState.m1878getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.getTextLayoutState$foundation(), j, false, 2, null);
                    long m1940updateSelectionQkiN0lo$foundation$default = TextFieldSelectionState.m1940updateSelectionQkiN0lo$foundation$default(TextFieldSelectionState.this, new TextFieldCharSequence(TextFieldSelectionState.this.getTextFieldState$foundation().getVisualText(), TextRange.Companion.m7613getZerod9O1mEE(), null, null, null, null, 60, null), m1878getOffsetForPosition3MmeM6k$default2, m1878getOffsetForPosition3MmeM6k$default2, false, this.selectionAdjustmentMode, false, false, HapticFeedbackType.m6118boximpl(HapticFeedbackType.Companion.m6130getLongPress5zf0vsI()), 96, null);
                    TextFieldSelectionState.this.getTextFieldState$foundation().m1899selectCharsIn5zctL8(m1940updateSelectionQkiN0lo$foundation$default);
                    TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
                    this.dragBeginOffsetInText = TextRange.m7608getStartimpl(m1940updateSelectionQkiN0lo$foundation$default);
                }
            }
        }
        ...
        public void mo1642onDragk4lQ0M(long j) {
            int intValue;
            int m1881getOffsetForPosition3MmeM6k;
            ...
            long m5108plusMKHz9U = Offset.m5108plusMKHz9U(this.dragTotalDistance, j);
            this.dragTotalDistance = m5108plusMKHz9U;
            long m5108plusMKHz9U2 = Offset.m5108plusMKHz9U(this.dragBeginPosition, m5108plusMKHz9U);
            if (this.dragBeginOffsetInText < 0 && !TextFieldSelectionState.this.getTextLayoutState$foundation().m1882isPositionOnTextk4lQ0M(m5108plusMKHz9U2)) {
                intValue = TextLayoutState.m1878getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.getTextLayoutState$foundation(), this.dragBeginPosition, false, 2, null);
                m1881getOffsetForPosition3MmeM6k = TextLayoutState.m1878getOffsetForPosition3MmeM6k$default(TextFieldSelectionState.this.getTextLayoutState$foundation(), m5108plusMKHz9U2, false, 2, null);
                if (intValue == m1881getOffsetForPosition3MmeM6k) {
                ...
                if (ComposeFoundationFlags.isConcurrentTextFieldSelectionFixEnabled) {
                    ...
                    intValue = r3 != null ? r3.intValue() : TextFieldSelectionState.this.getTextLayoutState$foundation().m1881getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                } else {
                    Integer valueOf2 = Integer.valueOf(this.dragBeginOffsetInText);
                    r3 = valueOf2.intValue() >= 0 ? valueOf2 : null;
                    intValue = r3 != null ? r3.intValue() : TextFieldSelectionState.this.getTextLayoutState$foundation().m1881getOffsetForPosition3MmeM6k(this.dragBeginPosition, false);
                }
                m1881getOffsetForPosition3MmeM6k = TextFieldSelectionState.this.getTextLayoutState$foundation().m1881getOffsetForPosition3MmeM6k(m5108plusMKHz9U2, false);
                if (this.dragBeginOffsetInText < 0 && intValue == m1881getOffsetForPosition3MmeM6k) {
                    return;
                }
                selectionAdjustment = this.selectionAdjustmentMode;
                TextFieldSelectionState.this.updateTextToolbarState(TextToolbarState.Selection);
            ...
            int i = intValue;
            int i2 = m1881getOffsetForPosition3MmeM6k;
            SelectionAdjustment selectionAdjustment2 = selectionAdjustment;
            long m1724getSelectiond9O1mEE = TextFieldSelectionState.this.getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE();
            TextFieldSelectionState textFieldSelectionState = TextFieldSelectionState.this;
            long m1940updateSelectionQkiN0lo$foundation$default = TextFieldSelectionState.m1940updateSelectionQkiN0lo$foundation$default(textFieldSelectionState, textFieldSelectionState.getTextFieldState$foundation().getVisualText(), i, i2, false, selectionAdjustment2, false, false, HapticFeedbackType.m6118boximpl(HapticFeedbackType.Companion.m6134getTextHandleMove5zf0vsI()), 64, null);
            if (this.dragBeginOffsetInText == -1 && !TextRange.m7602getCollapsedimpl(m1940updateSelectionQkiN0lo$foundation$default)) {
                this.dragBeginOffsetInText = TextRange.m7608getStartimpl(m1940updateSelectionQkiN0lo$foundation$default);
            }
            if (TextRange.m7607getReversedimpl(m1940updateSelectionQkiN0lo$foundation$default)) {
                m1940updateSelectionQkiN0lo$foundation$default = TextFieldSelectionStateKt.m1950access$reverse5zctL8(m1940updateSelectionQkiN0lo$foundation$default);
            }
            if (!TextRange.m7601equalsimpl0(m1940updateSelectionQkiN0lo$foundation$default, m1724getSelectiond9O1mEE)) {
                if (TextRange.m7608getStartimpl(m1940updateSelectionQkiN0lo$foundation$default) != TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE) && TextRange.m7603getEndimpl(m1940updateSelectionQkiN0lo$foundation$default) == TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE)) {
                    handle = Handle.SelectionStart;
                } else if (TextRange.m7608getStartimpl(m1940updateSelectionQkiN0lo$foundation$default) == TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE) && TextRange.m7603getEndimpl(m1940updateSelectionQkiN0lo$foundation$default) != TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE)) {
                    handle = Handle.SelectionEnd;
                } else if ((TextRange.m7608getStartimpl(m1940updateSelectionQkiN0lo$foundation$default) + TextRange.m7603getEndimpl(m1940updateSelectionQkiN0lo$foundation$default)) / 2.0f > (TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE) + TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE)) / 2.0f) {
                    handle = Handle.SelectionEnd;
                } else {
                    handle = Handle.SelectionStart;
                }
            ...
            if (TextRange.m7602getCollapsedimpl(m1724getSelectiond9O1mEE) || !TextRange.m7602getCollapsedimpl(m1940updateSelectionQkiN0lo$foundation$default)) {
                TextFieldSelectionState.this.getTextFieldState$foundation().m1899selectCharsIn5zctL8(m1940updateSelectionQkiN0lo$foundation$default);
            }
            TextFieldSelectionState.this.m1943updateHandleDraggingUv8p0NA(this.actingHandle, m5108plusMKHz9U2);
        }
    }
    ...
    public final void maybeSuggestSelectionRange() {
        ...
        long m1724getSelectiond9O1mEE = this.textFieldState.getVisualText().m1724getSelectiond9O1mEE();
        if (text.length() <= 0 || TextRange.m7602getCollapsedimpl(m1724getSelectiond9O1mEE)) {
            return;
        }
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, CoroutineStart.UNDISPATCHED, new TextFieldSelectionState$maybeSuggestSelectionRange$1(platformSelectionBehaviors, text, m1724getSelectiond9O1mEE, this, null), 1, null);
    }
    ...
    */
        ...
        if (continuation instanceof TextFieldSelectionState$detectSelectionHandleDragGestures$1) {
            ...
            if ((textFieldSelectionState$detectSelectionHandleDragGestures$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    longRef3.element = Offset.Companion.m5118getUnspecifiedF1C5BW0();
                    final Ref.LongRef longRef4 = new Ref.LongRef();
                    longRef4.element = Offset.Companion.m5119getZeroF1C5BW0();
    ...
    public static final Unit detectSelectionHandleDragGestures$lambda$0(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, boolean z, Handle handle, Ref.LongRef longRef2, Offset offset) {
        longRef.element = SelectionHandlesKt.m2053getAdjustedCoordinatesk4lQ0M(textFieldSelectionState.m1934getHandlePositiontuRUvjQ(z));
        textFieldSelectionState.m1943updateHandleDraggingUv8p0NA(handle, longRef.element);
        longRef2.element = Offset.Companion.m5119getZeroF1C5BW0();
        textFieldSelectionState.previousRawDragOffset = -1;
        return Unit.INSTANCE;
    }
    ...
    public static final Unit detectSelectionHandleDragGestures$lambda$3(Ref.LongRef longRef, TextFieldSelectionState textFieldSelectionState, Handle handle, Ref.LongRef longRef2, boolean z, PointerInputChange pointerInputChange, Offset offset) {
        ...
        textFieldSelectionState.m1943updateHandleDraggingUv8p0NA(handle, Offset.m5108plusMKHz9U(longRef2.element, longRef.element));
        if (z) {
            m7608getStartimpl = layoutResult.m7578getOffsetForPositionk4lQ0M(textFieldSelectionState.m1941getHandleDragPositionF1C5BW0());
        } else {
            m7608getStartimpl = TextRange.m7608getStartimpl(textFieldSelectionState.textFieldState.getVisualText().m1724getSelectiond9O1mEE());
        }
        if (z) {
            m7578getOffsetForPositionk4lQ0M = TextRange.m7603getEndimpl(textFieldSelectionState.textFieldState.getVisualText().m1724getSelectiond9O1mEE());
        } else {
            m7578getOffsetForPositionk4lQ0M = layoutResult.m7578getOffsetForPositionk4lQ0M(textFieldSelectionState.m1941getHandleDragPositionF1C5BW0());
        }
        int i = m7578getOffsetForPositionk4lQ0M;
        long m1724getSelectiond9O1mEE = textFieldSelectionState.textFieldState.getVisualText().m1724getSelectiond9O1mEE();
        long m1940updateSelectionQkiN0lo$foundation$default = m1940updateSelectionQkiN0lo$foundation$default(textFieldSelectionState, textFieldSelectionState.textFieldState.getVisualText(), m7608getStartimpl, i, z, SelectionAdjustment.Companion.getCharacterWithWordAccelerate(), false, false, HapticFeedbackType.m6118boximpl(HapticFeedbackType.Companion.m6134getTextHandleMove5zf0vsI()), 96, null);
        if (TextRange.m7602getCollapsedimpl(m1724getSelectiond9O1mEE) || !TextRange.m7602getCollapsedimpl(m1940updateSelectionQkiN0lo$foundation$default)) {
            textFieldSelectionState.textFieldState.m1899selectCharsIn5zctL8(m1940updateSelectionQkiN0lo$foundation$default);
        }
        return Unit.INSTANCE;
    }
    ...
    public static final Rect derivedVisibleContentBounds_delegate$lambda$0(TextFieldSelectionState textFieldSelectionState) {
        ...
        boolean m7602getCollapsedimpl = TextRange.m7602getCollapsedimpl(textFieldSelectionState.textFieldState.getVisualText().m1724getSelectiond9O1mEE());
        if ((!(m7602getCollapsedimpl && textFieldSelectionState.getTextToolbarState() == TextToolbarState.Cursor) && (m7602getCollapsedimpl || textFieldSelectionState.getTextToolbarState() != TextToolbarState.Selection)) || textFieldSelectionState.getDraggingHandle() != null || !textFieldSelectionState.isInTouchMode() || (textLayoutCoordinates = textFieldSelectionState.getTextLayoutCoordinates()) == null) {
            return null;
        }
        Rect visibleBounds = SelectionManagerKt.visibleBounds(textLayoutCoordinates);
        Rect m5143Recttz77jQw = RectKt.m5143Recttz77jQw(textLayoutCoordinates.mo6829localToRootMKHz9U(visibleBounds.m5138getTopLeftF1C5BW0()), visibleBounds.m5136getSizeNHjbRc());
        Rect contentRect = textFieldSelectionState.getContentRect();
        if (contentRect.overlaps(m5143Recttz77jQw)) {
            return contentRect.intersect(m5143Recttz77jQw);
        }
        return null;
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textLayoutCoordinates != null) {
            ...
            if (TextRange.m7602getCollapsedimpl(visualText.m1724getSelectiond9O1mEE())) {
                ...
                return RectKt.m5143Recttz77jQw(textLayoutCoordinates.mo6829localToRootMKHz9U(cursorRect.m5138getTopLeftF1C5BW0()), cursorRect.m5136getSizeNHjbRc());
            }
            long mo6829localToRootMKHz9U = textLayoutCoordinates.mo6829localToRootMKHz9U(m1934getHandlePositiontuRUvjQ(true));
            long mo6829localToRootMKHz9U2 = textLayoutCoordinates.mo6829localToRootMKHz9U(m1934getHandlePositiontuRUvjQ(false));
            TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
            if (layoutResult == null) {
                return Rect.Companion.getZero();
            }
            float intBitsToFloat = Float.intBitsToFloat((int) (textLayoutCoordinates.mo6829localToRootMKHz9U(Offset.m5095constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(layoutResult.getCursorRect(TextRange.m7608getStartimpl(visualText.m1724getSelectiond9O1mEE())).getTop()) & 4294967295L))) & 4294967295L));
            float intBitsToFloat2 = Float.intBitsToFloat((int) (textLayoutCoordinates.mo6829localToRootMKHz9U(Offset.m5095constructorimpl((Float.floatToRawIntBits(layoutResult.getCursorRect(TextRange.m7603getEndimpl(visualText.m1724getSelectiond9O1mEE())).getTop()) & 4294967295L) | (Float.floatToRawIntBits(0.0f) << 32))) & 4294967295L));
            int i = (int) (mo6829localToRootMKHz9U >> 32);
            int i2 = (int) (mo6829localToRootMKHz9U2 >> 32);
            return new Rect(Math.min(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), Math.min(intBitsToFloat, intBitsToFloat2), Math.max(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), Math.max(Float.intBitsToFloat((int) (mo6829localToRootMKHz9U & 4294967295L)), Float.intBitsToFloat((int) (mo6829localToRootMKHz9U2 & 4294967295L))));
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0052, code lost:
        if (((r0 == null || (r0 = androidx.compose.foundation.text.selection.SelectionManagerKt.visibleBounds(r0)) == null) ? false : androidx.compose.foundation.text.selection.SelectionManagerKt.m2080containsInclusiveUv8p0NA(r0, r4)) != false) goto L23;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final TextFieldHandleState getSelectionHandleState$foundation(boolean z, boolean z2) {
        ...
        long m1724getSelectiond9O1mEE = this.textFieldState.getVisualText().m1724getSelectiond9O1mEE();
        if (TextRange.m7602getCollapsedimpl(m1724getSelectiond9O1mEE)) {
            return TextFieldHandleState.Companion.getHidden();
        }
        long m1934getHandlePositiontuRUvjQ = m1934getHandlePositiontuRUvjQ(z);
        if (getDirectDragGestureInitiator() == InputType.None) {
            if (getDraggingHandle() != handle) {
                LayoutCoordinates textLayoutCoordinates = getTextLayoutCoordinates();
            }
            if (this.textFieldState.getVisualText().shouldShowSelection()) {
                ResolvedTextDirection bidiRunDirection = layoutResult.getBidiRunDirection(z ? TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE) : Math.max(TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE) - 1, 0));
                boolean m7607getReversedimpl = TextRange.m7607getReversedimpl(m1724getSelectiond9O1mEE);
                if (z2) {
                    ...
                    if (textLayoutCoordinates2 != null && (visibleBounds = SelectionManagerKt.visibleBounds(textLayoutCoordinates2)) != null) {
                        m1934getHandlePositiontuRUvjQ = TextLayoutStateKt.m1885coerceIn3MmeM6k(m1934getHandlePositiontuRUvjQ, visibleBounds);
                    }
                } else {
                    m1934getHandlePositiontuRUvjQ = Offset.Companion.m5118getUnspecifiedF1C5BW0();
                }
                return new TextFieldHandleState(true, m1934getHandlePositiontuRUvjQ, TextLayoutHelperKt.getLineHeight(layoutResult, z ? TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE) : TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE)), bidiRunDirection, m7607getReversedimpl, null);
            }
            return TextFieldHandleState.Companion.getHidden();
        }
        return TextFieldHandleState.Companion.getHidden();
    ...
    public final long m1934getHandlePositiontuRUvjQ(boolean z) {
        int m7603getEndimpl;
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
        ...
        long m1724getSelectiond9O1mEE = this.textFieldState.getVisualText().m1724getSelectiond9O1mEE();
        if (z) {
            m7603getEndimpl = TextRange.m7608getStartimpl(m1724getSelectiond9O1mEE);
        } else {
            m7603getEndimpl = TextRange.m7603getEndimpl(m1724getSelectiond9O1mEE);
        }
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult, m7603getEndimpl, z, TextRange.m7607getReversedimpl(m1724getSelectiond9O1mEE));
    }

    /* renamed from: updateHandleDragging-Uv8p0NA  reason: not valid java name */
    public final void m1943updateHandleDraggingUv8p0NA(Handle handle, long j) {
        setDraggingHandle(handle);
        m1938setRawHandleDragPositionk4lQ0M(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void markStartContentVisibleOffset() {
        m1939setStartTextLayoutPositionInWindowk4lQ0M(m1933getCurrentTextLayoutPositionInWindowF1C5BW0());
    }

    public final void clearHandleDragging() {
        setDraggingHandle(null);
        m1938setRawHandleDragPositionk4lQ0M(Offset.Companion.m5118getUnspecifiedF1C5BW0());
        m1939setStartTextLayoutPositionInWindowk4lQ0M(Offset.Companion.m5118getUnspecifiedF1C5BW0());
    }

    public final boolean isCutAllowed() {
        return (TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) || !getEditable$foundation() || this.isPassword) ? false : true;
    }
    ...
    public final boolean isCopyAllowed() {
        return (TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) || this.isPassword) ? false : true;
    }
        ...
        if (continuation instanceof TextFieldSelectionState$paste$1) {
            ...
            if ((textFieldSelectionState$paste$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (clipEntry2 != null) {
                        TransferableContent onReceive = invoke.getReceiveContentListener().onReceive(new TransferableContent(clipEntry2, clipEntry2.getClipMetadata(), TransferableContent.Source.Companion.m391getClipboardkB6V9T0(), null, 8, null));
    ...
    */
    ...
    public final boolean canShowSelectAllMenuItem() {
        return TextRange.m7604getLengthimpl(this.textFieldState.getVisualText().m1724getSelectiond9O1mEE()) != this.textFieldState.getVisualText().length();
    }
    ...
    public final boolean canShowAutofillMenuItem() {
        return getEditable$foundation() && TextRange.m7602getCollapsedimpl(this.textFieldState.getVisualText().m1724getSelectiond9O1mEE());
    }
    ...
    public final void deselect() {
        if (!TextRange.m7602getCollapsedimpl(this.textFieldState.getVisualText().m1724getSelectiond9O1mEE())) {
    ...
    public static /* synthetic */ long m1940updateSelectionQkiN0lo$foundation$default(TextFieldSelectionState textFieldSelectionState, TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, HapticFeedbackType hapticFeedbackType, int i3, Object obj) {
        ...
        return textFieldSelectionState.m1944updateSelectionQkiN0lo$foundation(textFieldCharSequence, i, i2, z, selectionAdjustment, z2, z3, hapticFeedbackType);
    }

    /* renamed from: updateSelection-QkiN0lo$foundation  reason: not valid java name */
    public final long m1944updateSelectionQkiN0lo$foundation(TextFieldCharSequence textFieldCharSequence, int i, int i2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2, boolean z3, HapticFeedbackType hapticFeedbackType) {
        HapticFeedback hapticFeedback;
        TextRange m7596boximpl = TextRange.m7596boximpl(textFieldCharSequence.m1724getSelectiond9O1mEE());
        long m7612unboximpl = m7596boximpl.m7612unboximpl();
        if (z3 || (!z2 && TextRange.m7602getCollapsedimpl(m7612unboximpl))) {
            m7596boximpl = null;
        }
        long m1937getTextFieldSelectionqeG_v_k = m1937getTextFieldSelectionqeG_v_k(i, i2, m7596boximpl, z, selectionAdjustment);
        if (hapticFeedbackType != null && ((TextRange.m7606getMinimpl(m1937getTextFieldSelectionqeG_v_k) != TextRange.m7606getMinimpl(textFieldCharSequence.m1724getSelectiond9O1mEE()) || TextRange.m7605getMaximpl(m1937getTextFieldSelectionqeG_v_k) != TextRange.m7605getMaximpl(textFieldCharSequence.m1724getSelectiond9O1mEE())) && (hapticFeedback = this.hapticFeedBack) != null)) {
            hapticFeedback.mo6117performHapticFeedbackCdsT49E(hapticFeedbackType.m6124unboximpl());
        }
        return m1937getTextFieldSelectionqeG_v_k;
    }

    /* renamed from: getTextFieldSelection-qeG_v_k  reason: not valid java name */
    private final long m1937getTextFieldSelectionqeG_v_k(int i, int i2, TextRange textRange, boolean z, SelectionAdjustment selectionAdjustment) {
        TextLayoutResult layoutResult = this.textLayoutState.getLayoutResult();
        if (layoutResult == null) {
            return TextRange.Companion.m7613getZerod9O1mEE();
        }
        ...
        SelectionLayout m2056getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m2056getTextFieldSelectionLayoutRcvTLA(layoutResult, i, i2, this.previousRawDragOffset, textRange != null ? textRange.m7612unboximpl() : TextRange.Companion.m7613getZerod9O1mEE(), textRange == null, z);
        if (textRange != null && !m2056getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(this.previousSelectionLayout)) {
            return textRange.m7612unboximpl();
        }
        long m2047toTextRanged9O1mEE = selectionAdjustment.adjust(m2056getTextFieldSelectionLayoutRcvTLA).m2047toTextRanged9O1mEE();
        this.previousSelectionLayout = m2056getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = z ? i : i2;
        return m2047toTextRanged9O1mEE;
    }

    public final boolean canShowCutMenuItem() {
        return !TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) && getEditable$foundation() && !this.isPassword && ClipboardUtils_androidKt.isWriteSupported(this.clipboard);
    }

    public final AnnotatedString cutWithResult() {
        if (TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) || !getEditable$foundation() || this.isPassword) {
            return null;
        }
    ...
    public final boolean canShowCopyMenuItem() {
        return (TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) || this.isPassword || !ClipboardUtils_androidKt.isWriteSupported(this.clipboard)) ? false : true;
    }

    public final AnnotatedString copyWithResult$foundation(boolean z) {
        if (TextRange.m7602getCollapsedimpl(getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()) || this.isPassword) {
            return null;
        }
        AnnotatedString annotatedString = new AnnotatedString(TextFieldCharSequenceKt.getSelectedText(this.textFieldState.getVisualText()).toString(), null, 2, null);
        if (z) {
