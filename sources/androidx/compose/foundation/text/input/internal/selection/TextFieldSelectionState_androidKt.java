...
public final class TextFieldSelectionState_androidKt {
    ...
    public static final Unit contextMenuBuilder$lambda$1(State state, ContextMenuState contextMenuState, Function2 function2, TextFieldSelectionState textFieldSelectionState, ContextMenuScope contextMenuScope) {
        ...
        contextMenuBuilder$lambda$1$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Cut, MenuItemsAvailability.m1320getCanCutimpl(m1325unboximpl));
        contextMenuBuilder$lambda$1$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Copy, MenuItemsAvailability.m1319getCanCopyimpl(m1325unboximpl));
        contextMenuBuilder$lambda$1$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Paste, MenuItemsAvailability.m1321getCanPasteimpl(m1325unboximpl));
        contextMenuBuilder$lambda$1$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1322getCanSelectAllimpl(m1325unboximpl));
        if (Build.VERSION.SDK_INT >= 26) {
            contextMenuBuilder$lambda$1$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1318getCanAutofillimpl(m1325unboximpl));
        }
    ...
    public static final Unit addBasicTextFieldTextContextMenuComponents$lambda$10(final TextFieldSelectionState textFieldSelectionState, final CoroutineScope coroutineScope, TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context) {
        PlatformSelectionBehaviors_androidKt.m1743addPlatformTextContextMenuItems71BSaZU(textContextMenuBuilderScope, context, textFieldSelectionState.getEditable$foundation_release(), textFieldSelectionState.getTextFieldState$foundation_release().getVisualText().getText(), TextRange.m6701boximpl(textFieldSelectionState.getTextFieldState$foundation_release().getVisualText().m1436getSelectiond9O1mEE()), textFieldSelectionState.getPlatformSelectionBehaviors$foundation_release(), new Function1() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
