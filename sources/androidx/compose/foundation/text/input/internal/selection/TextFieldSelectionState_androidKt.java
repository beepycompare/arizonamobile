...
public final class TextFieldSelectionState_androidKt {
    ...
    public static final Unit addBasicTextFieldTextContextMenuComponents$lambda$0(final TextFieldSelectionState textFieldSelectionState, final CoroutineScope coroutineScope, TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context) {
        PlatformSelectionBehaviors_androidKt.m2045addPlatformTextContextMenuItems71BSaZU(textContextMenuBuilderScope, context, textFieldSelectionState.getEditable$foundation(), textFieldSelectionState.getTextFieldState$foundation().getVisualText().getText(), TextRange.m7596boximpl(textFieldSelectionState.getTextFieldState$foundation().getVisualText().m1724getSelectiond9O1mEE()), textFieldSelectionState.getPlatformSelectionBehaviors$foundation(), new Function1() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState_androidKt$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
