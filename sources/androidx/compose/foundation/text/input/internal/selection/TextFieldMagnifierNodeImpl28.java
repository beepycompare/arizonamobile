...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.animatable = new Animatable<>(Offset.m5092boximpl(TextFieldMagnifierKt.m1926calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1928getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m5092boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
    ...
    public final long m1928getMagnifierSizeYbymL2g() {
        return ((IntSize) this.magnifierSize$delegate.getValue()).m8335unboximpl();
    }

    /* renamed from: setMagnifierSize-ozmzZPI  reason: not valid java name */
    private final void m1929setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize$delegate.setValue(IntSize.m8323boximpl(j));
    }
    ...
    public static final Unit magnifierNode$lambda$1(TextFieldMagnifierNodeImpl28 textFieldMagnifierNodeImpl28, DpSize dpSize) {
        ...
        textFieldMagnifierNodeImpl28.m1929setMagnifierSizeozmzZPI(IntSize.m8326constructorimpl((density.mo428roundToPx0680j_4(DpSize.m8258getWidthD9Ej5fM(dpSize.m8266unboximpl())) << 32) | (density.mo428roundToPx0680j_4(DpSize.m8256getHeightD9Ej5fM(dpSize.m8266unboximpl())) & 4294967295L)));
