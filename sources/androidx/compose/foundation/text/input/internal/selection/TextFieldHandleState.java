...
public final class TextFieldHandleState {
    ...
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.Companion.m4308getUnspecifiedF1C5BW0(), 0.0f, ResolvedTextDirection.Ltr, false, null);
    ...
    public static /* synthetic */ TextFieldHandleState m1616copyYqVAtuI$default(TextFieldHandleState textFieldHandleState, boolean z, long j, float f, ResolvedTextDirection resolvedTextDirection, boolean z2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        boolean z3 = z2;
        float f2 = f;
        return textFieldHandleState.m1618copyYqVAtuI(z, j, f2, resolvedTextDirection, z3);
    }
    ...
    public final long m1617component2F1C5BW0() {
    ...
    public final TextFieldHandleState m1618copyYqVAtuI(boolean z, long j, float f, ResolvedTextDirection resolvedTextDirection, boolean z2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextFieldHandleState) {
            ...
            return this.visible == textFieldHandleState.visible && Offset.m4290equalsimpl0(this.position, textFieldHandleState.position) && Float.compare(this.lineHeight, textFieldHandleState.lineHeight) == 0 && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
        }
        return false;
    }

    public int hashCode() {
        return (((((((Boolean.hashCode(this.visible) * 31) + Offset.m4295hashCodeimpl(this.position)) * 31) + Float.hashCode(this.lineHeight)) * 31) + this.direction.hashCode()) * 31) + Boolean.hashCode(this.handlesCrossed);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m4301toStringimpl(this.position)) + ", lineHeight=" + this.lineHeight + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
    ...
    public final long m1619getPositionF1C5BW0() {
        return this.position;
    }
