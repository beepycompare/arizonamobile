...
public final class TextFieldSelectionStateKt {
    ...
    public static final Unit defaultDetectTextFieldTapGestures$lambda$0(Function0 function0, TextFieldSelectionState textFieldSelectionState, Function0 function02, Offset offset) {
        ...
        if (textFieldSelectionState.getEnabled() && textFieldSelectionState.isFocused()) {
            ...
            textFieldSelectionState.m1942placeCursorAtNearestOffsetk4lQ0M(TextLayoutStateKt.m1886fromDecorationToTextLayoutUv8p0NA(textFieldSelectionState.getTextLayoutState$foundation(), textFieldSelectionState.getTextLayoutState$foundation().m1879coercedInVisibleBoundsOfInputTextMKHz9U$foundation(offset.m5113unboximpl())));
        }
    ...
    public static final long m1951reverse5zctL8(long j) {
        return TextRangeKt.TextRange(TextRange.m7603getEndimpl(j), TextRange.m7608getStartimpl(j));
    }
    ...
    public static final Unit contextMenuBuilder$lambda$0(State state, ContextMenuState contextMenuState, Function2 function2, TextFieldSelectionState textFieldSelectionState, ContextMenuScope contextMenuScope) {
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Cut, MenuItemsAvailability.m1622getCanCutimpl(m1627unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Copy, MenuItemsAvailability.m1621getCanCopyimpl(m1627unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Paste, MenuItemsAvailability.m1623getCanPasteimpl(m1627unboximpl));
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1624getCanSelectAllimpl(m1627unboximpl));
        if (PlatformUtils_androidKt.isAutofillAvailable()) {
            contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, function2, textFieldSelectionState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1620getCanAutofillimpl(m1627unboximpl));
        }
        return Unit.INSTANCE;
    }
