...
public final class SelectionMovementDeletionContext {
    ...
    public SelectionMovementDeletionContext(TransformedTextFieldState transformedTextFieldState, TextLayoutResult textLayoutResult, boolean z, float f, TextFieldPreparedSelectionState textFieldPreparedSelectionState) {
        ...
        try {
            ...
            this.selection = visualText.m1724getSelectiond9O1mEE();
    ...
    public final long m1919getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m1920setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m7603getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m7603getEndimpl(this.selection));
    }
    ...
    public final SelectionMovementDeletionContext moveCursorUpByLine() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtLeast(jumpByLinesOffset, 0), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
            }
            if (m1908component2impl != null) {
                setWedgeAffinity(m1908component2impl);
            }
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorDownByLine() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtMost(jumpByLinesOffset, this.text.length()), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m7603getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m7603getEndimpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long m7580getWordBoundaryjx7JFs = textLayoutResult.m7580getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m7603getEndimpl(m7580getWordBoundaryjx7JFs) > i) {
                return TextRange.m7603getEndimpl(m7580getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long m7580getWordBoundaryjx7JFs = textLayoutResult.m7580getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m7608getStartimpl(m7580getWordBoundaryjx7JFs) < i) {
                return TextRange.m7608getStartimpl(m7580getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m7606getMinimpl(selectionMovementDeletionContext.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m7605getMaximpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int m7603getEndimpl = TextRange.m7603getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(m7603getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(m7603getEndimpl) + i;
        if (lineForOffset < 0) {
        ...
        return textLayoutResult.m7578getOffsetForPositionk4lQ0M(Offset.m5095constructorimpl((Float.floatToRawIntBits(cachedX) << 32) | (Float.floatToRawIntBits(lineBottom) & 4294967295L)));
    }

    private final int jumpByPagesOffset(int i) {
        int m7603getEndimpl = TextRange.m7603getEndimpl(this.initialValue.m1724getSelectiond9O1mEE());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return m7603getEndimpl;
        }
        Rect translate = this.textLayoutResult.getCursorRect(m7603getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * i);
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        if (i2 > 0) {
            return textLayoutResult.m7578getOffsetForPositionk4lQ0M(translate.m5138getTopLeftF1C5BW0());
        }
        return textLayoutResult.m7578getOffsetForPositionk4lQ0M(translate.m5131getBottomLeftF1C5BW0());
    }
    ...
    /* compiled from: TextPreparedSelection.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Landroidx/compose/foundation/text/input/internal/selection/SelectionMovementDeletionContext$Companion;", "", "<init>", "()V", "NoCharacterFound", "", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes.dex */
    ...
    public final SelectionMovementDeletionContext deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m7603getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext collapseLeftOr(Function1<? super SelectionMovementDeletionContext, Unit> function1) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m7602getCollapsedimpl(this.selection)) {
                function1.invoke(this);
                return this;
            }
            boolean isLtr = isLtr();
            ...
            if (isLtr) {
                this.selection = TextRangeKt.TextRange(TextRange.m7606getMinimpl(j));
                return this;
            }
            this.selection = TextRangeKt.TextRange(TextRange.m7605getMaximpl(j));
        }
        return this;
    }
    ...
    private final SelectionMovementDeletionContext moveCursorTo(boolean z, Function0<Integer> function0) {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(function0.invoke().intValue(), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    static /* synthetic */ SelectionMovementDeletionContext moveCursorTo$default(SelectionMovementDeletionContext selectionMovementDeletionContext, boolean z, Function0 function0, int i, Object obj) {
        ...
        if (selectionMovementDeletionContext.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(selectionMovementDeletionContext.m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(((Number) function0.invoke()).intValue(), m7603getEndimpl, selectionMovementDeletionContext.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(selectionMovementDeletionContext.m1919getSelectiond9O1mEE())) {
                selectionMovementDeletionContext.m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
            }
            if (m1908component2impl != null) {
                selectionMovementDeletionContext.setWedgeAffinity(m1908component2impl);
            }
        }
        return selectionMovementDeletionContext;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByCodePointOrEmoji() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.text, TextRange.m7603getEndimpl(this.selection), -1), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByChar() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m7603getEndimpl(this.selection)), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByChar() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m7603getEndimpl(this.selection)), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToHome() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(0, m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToEnd() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(this.text.length(), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByWord() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getNextWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByWord() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getPrevWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            int findParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m7606getMinimpl(this.selection));
            if (findParagraphStart == TextRange.m7606getMinimpl(this.selection) && findParagraphStart != 0) {
                findParagraphStart = StringHelpersKt.findParagraphStart(this.text, findParagraphStart - 1);
            }
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(findParagraphStart, m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m7605getMaximpl(this.selection));
            if (findParagraphEnd == TextRange.m7605getMaximpl(this.selection) && findParagraphEnd != this.text.length()) {
                findParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, findParagraphEnd + 1);
            }
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(findParagraphEnd, m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineStart() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineStartByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineEnd() {
        ...
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineEndByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorUpByPage() {
        if (this.text.length() > 0) {
            int m7603getEndimpl = TextRange.m7603getEndimpl(m1919getSelectiond9O1mEE());
            long calculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(jumpByPagesOffset(-1), m7603getEndimpl, this.state);
            int m1907component1impl = CursorAndWedgeAffinity.m1907component1impl(calculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity m1908component2impl = CursorAndWedgeAffinity.m1908component2impl(calculateNextCursorPositionAndWedgeAffinity);
            if (m1907component1impl != m7603getEndimpl || !TextRange.m7602getCollapsedimpl(m1919getSelectiond9O1mEE())) {
                m1920setSelection5zctL8(TextRangeKt.TextRange(m1907component1impl));
    ...
    public final SelectionMovementDeletionContext selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m7608getStartimpl(this.initialValue.m1724getSelectiond9O1mEE()), TextRange.m7603getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext deleteMovement() {
        if (this.text.length() > 0) {
            boolean m7602getCollapsedimpl = TextRange.m7602getCollapsedimpl(this.initialValue.m1724getSelectiond9O1mEE());
            TransformedTextFieldState transformedTextFieldState = this.state;
            if (!m7602getCollapsedimpl) {
                transformedTextFieldState.deleteSelectedText();
            } else {
                TransformedTextFieldState.m1891replaceTextM8tDOmk$default(transformedTextFieldState, "", TextRangeKt.TextRange(TextRange.m7608getStartimpl(this.initialValue.m1724getSelectiond9O1mEE()), TextRange.m7603getEndimpl(this.selection)), null, !this.isFromSoftKeyboard, 4, null);
            }
            this.selection = this.state.getVisualText().m1724getSelectiond9O1mEE();
