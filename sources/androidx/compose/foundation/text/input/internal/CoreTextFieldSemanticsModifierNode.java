...
public final class CoreTextFieldSemanticsModifierNode extends DelegatingNode implements SemanticsModifierNode {
    ...
    public void applySemantics(final SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m7399setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, this.value.m7858getSelectiond9O1mEE());
        SemanticsPropertiesKt.setContentDataType(semanticsPropertyReceiver, ContentDataType.Companion.getText());
        FillableData createFromText = FillableData_androidKt.createFromText(FillableData.Companion, this.value.getAnnotatedString());
        ...
        int m7806getKeyboardTypePjHm6EE = this.imeOptions.m7806getKeyboardTypePjHm6EE();
        if (KeyboardType.m7829equalsimpl0(m7806getKeyboardTypePjHm6EE, KeyboardType.Companion.m7845getEmailPjHm6EE())) {
            SemanticsPropertiesKt.setContentType(semanticsPropertyReceiver, ContentType.Companion.getEmailAddress());
        } else if (KeyboardType.m7829equalsimpl0(m7806getKeyboardTypePjHm6EE, KeyboardType.Companion.m7848getPasswordPjHm6EE()) || KeyboardType.m7829equalsimpl0(m7806getKeyboardTypePjHm6EE, KeyboardType.Companion.m7847getNumberPasswordPjHm6EE())) {
        ...
        SemanticsPropertiesKt.m7394onImeAction9UiTYpY$default(semanticsPropertyReceiver, this.imeOptions.m7805getImeActioneUduSuo(), null, new Function0() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$$ExternalSyntheticLambda11
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (!TextRange.m7602getCollapsedimpl(this.value.m7858getSelectiond9O1mEE()) && !this.isPassword) {
    ...
    public static final boolean applySemantics$lambda$4(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode, SemanticsPropertyReceiver semanticsPropertyReceiver, AnnotatedString annotatedString) {
        ...
        if (inputSession != null) {
            TextFieldDelegate.Companion.onEditCommand$foundation(CollectionsKt.listOf((Object[]) new EditCommand[]{new FinishComposingTextCommand(), new CommitTextCommand(annotatedString, 1)}), coreTextFieldSemanticsModifierNode.state.getProcessor(), coreTextFieldSemanticsModifierNode.state.getOnValueChange(), inputSession);
        } else {
            coreTextFieldSemanticsModifierNode.state.getOnValueChange().invoke(new TextFieldValue(StringsKt.replaceRange((CharSequence) coreTextFieldSemanticsModifierNode.value.getText(), TextRange.m7608getStartimpl(coreTextFieldSemanticsModifierNode.value.m7858getSelectiond9O1mEE()), TextRange.m7603getEndimpl(coreTextFieldSemanticsModifierNode.value.m7858getSelectiond9O1mEE()), (CharSequence) annotatedString).toString(), TextRangeKt.TextRange(TextRange.m7608getStartimpl(coreTextFieldSemanticsModifierNode.value.m7858getSelectiond9O1mEE()) + annotatedString.length()), (TextRange) null, 4, (DefaultConstructorMarker) null));
        }
        return true;
    }
    ...
    public static final boolean applySemantics$lambda$5(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode, int i, int i2, boolean z) {
        ...
        if (coreTextFieldSemanticsModifierNode.enabled) {
            if (i == TextRange.m7608getStartimpl(coreTextFieldSemanticsModifierNode.value.m7858getSelectiond9O1mEE()) && i2 == TextRange.m7603getEndimpl(coreTextFieldSemanticsModifierNode.value.m7858getSelectiond9O1mEE())) {
                return false;
            }
    ...
    public static final boolean applySemantics$lambda$6(CoreTextFieldSemanticsModifierNode coreTextFieldSemanticsModifierNode) {
        coreTextFieldSemanticsModifierNode.state.getOnImeActionPerformed().invoke(ImeAction.m7773boximpl(coreTextFieldSemanticsModifierNode.imeOptions.m7805getImeActioneUduSuo()));
        return true;
    }
    ...
    public final void updateNodeSemantics(TransformedText transformedText, TextFieldValue textFieldValue, LegacyTextFieldState legacyTextFieldState, boolean z, boolean z2, boolean z3, OffsetMapping offsetMapping, TextFieldSelectionManager textFieldSelectionManager, ImeOptions imeOptions, FocusRequester focusRequester) {
        ...
        this.imeOptions = imeOptions;
        this.focusRequester = focusRequester;
        if (z2 != z4 || z5 != z6 || !Intrinsics.areEqual(imeOptions, imeOptions2) || z3 != z7 || !TextRange.m7602getCollapsedimpl(textFieldValue.m7858getSelectiond9O1mEE())) {
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        if (Intrinsics.areEqual(textFieldSelectionManager, textFieldSelectionManager2)) {
            return;
        }
        textFieldSelectionManager.setRequestAutofillAction$foundation(new Function0() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    private final void handleTextUpdateFromSemantics(LegacyTextFieldState legacyTextFieldState, String str, boolean z, boolean z2) {
        if (z || !z2) {
            return;
        }
        androidx.compose.ui.text.input.TextInputSession inputSession = legacyTextFieldState.getInputSession();
        if (inputSession != null) {
            TextFieldDelegate.Companion.onEditCommand$foundation(CollectionsKt.listOf((Object[]) new EditCommand[]{new DeleteAllCommand(), new CommitTextCommand(str, 1)}), legacyTextFieldState.getProcessor(), legacyTextFieldState.getOnValueChange(), inputSession);
        } else {
