...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        String str2 = str;
        this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(str2, TextRangeKt.m7464coerceIn8ffj60Q(j, 0, str.length()), null, null, null, null, 60, null), null, null, null, 14, null);
    ...
    */
    ...
    public final long m1449getSelectiond9O1mEE() {
        return getValue$foundation_release().m1447getSelectiond9O1mEE();
    }

    /* renamed from: getComposition-MzsxiRA */
    public final TextRange m1448getCompositionMzsxiRA() {
        return getValue$foundation_release().m1446getCompositionMzsxiRA();
    }
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m7461toStringimpl(m1449getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer textFieldBuffer) {
        ...
        boolean m7451equalsimpl0 = TextRange.m7451equalsimpl0(textFieldBuffer.m1439getSelectiond9O1mEE(), this.mainBuffer.m1439getSelectiond9O1mEE());
        boolean z2 = !m7451equalsimpl0;
        if (!z && m7451equalsimpl0) {
            textFieldBuffer.setCanCallAddStyle$foundation_release(true);
        }
        if (z) {
            textFieldBuffer2 = textFieldBuffer;
            recordEditForUndo(getValue$foundation_release(), TextFieldBuffer.m1436toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldBuffer2, 0L, null, null, null, 15, null), textFieldBuffer2.getChanges(), TextFieldEditUndoBehavior.NeverMerge);
        } else {
            textFieldBuffer2 = textFieldBuffer;
        }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super TextFieldBuffer, Unit> function1) {
        getMainBuffer$foundation_release().getChangeTracker$foundation_release().clearChanges();
        function1.invoke(getMainBuffer$foundation_release());
        updateValueAndNotifyListeners(getValue$foundation_release(), TextFieldBuffer.m1436toTextFieldCharSequencewFTz33Y$foundation_release$default(getMainBuffer$foundation_release(), 0L, null, null, null, 15, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean z, TextFieldEditUndoBehavior textFieldEditUndoBehavior) {
        List m1452finalizeComposingAnnotationsitr0ztk;
        List m1452finalizeComposingAnnotationsitr0ztk2;
        TextFieldCharSequence value$foundation_release = getValue$foundation_release();
        if (this.mainBuffer.getChangeTracker$foundation_release().getChangeCount() == 0 && TextRange.m7451equalsimpl0(value$foundation_release.m1447getSelectiond9O1mEE(), this.mainBuffer.m1439getSelectiond9O1mEE())) {
            if (Intrinsics.areEqual(value$foundation_release.m1446getCompositionMzsxiRA(), this.mainBuffer.m1437getCompositionMzsxiRA$foundation_release()) && Intrinsics.areEqual(value$foundation_release.getHighlight(), this.mainBuffer.getHighlight$foundation_release()) && Intrinsics.areEqual(value$foundation_release.getComposingAnnotations(), this.mainBuffer.getComposingAnnotations$foundation_release())) {
                return;
            }
            TextFieldCharSequence value$foundation_release2 = getValue$foundation_release();
            long m1439getSelectiond9O1mEE = this.mainBuffer.m1439getSelectiond9O1mEE();
            TextRange m1437getCompositionMzsxiRA$foundation_release = this.mainBuffer.m1437getCompositionMzsxiRA$foundation_release();
            Pair<TextHighlightType, TextRange> highlight$foundation_release = this.mainBuffer.getHighlight$foundation_release();
            m1452finalizeComposingAnnotationsitr0ztk2 = TextFieldStateKt.m1452finalizeComposingAnnotationsitr0ztk(this.mainBuffer.m1437getCompositionMzsxiRA$foundation_release(), this.mainBuffer.getComposingAnnotations$foundation_release());
            updateValueAndNotifyListeners(value$foundation_release2, new TextFieldCharSequence(this.mainBuffer.toString(), m1439getSelectiond9O1mEE, m1437getCompositionMzsxiRA$foundation_release, highlight$foundation_release, m1452finalizeComposingAnnotationsitr0ztk2, null, 32, null), z);
            return;
        }
        boolean z2 = false;
        boolean z3 = this.mainBuffer.getChangeTracker$foundation_release().getChangeCount() != 0;
        long m1439getSelectiond9O1mEE2 = this.mainBuffer.m1439getSelectiond9O1mEE();
        TextRange m1437getCompositionMzsxiRA$foundation_release2 = this.mainBuffer.m1437getCompositionMzsxiRA$foundation_release();
        Pair<TextHighlightType, TextRange> highlight$foundation_release2 = this.mainBuffer.getHighlight$foundation_release();
        m1452finalizeComposingAnnotationsitr0ztk = TextFieldStateKt.m1452finalizeComposingAnnotationsitr0ztk(this.mainBuffer.m1437getCompositionMzsxiRA$foundation_release(), this.mainBuffer.getComposingAnnotations$foundation_release());
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), m1439getSelectiond9O1mEE2, m1437getCompositionMzsxiRA$foundation_release2, highlight$foundation_release2, m1452finalizeComposingAnnotationsitr0ztk, null, 32, null);
        ...
        boolean m7451equalsimpl0 = TextRange.m7451equalsimpl0(textFieldBuffer.m1439getSelectiond9O1mEE(), textFieldCharSequence.m1447getSelectiond9O1mEE());
        boolean z5 = !m7451equalsimpl0;
        if (!contentEquals || !m7451equalsimpl0) {
            syncMainBufferToTemporaryBuffer$foundation_release(textFieldBuffer, z4, z5);
        } else {
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1436toTextFieldCharSequencewFTz33Y$foundation_release$default(textFieldBuffer, 0L, textFieldCharSequence.m1446getCompositionMzsxiRA(), null, null, 13, null), z);
        }
    ...
    public final void updateValueAndNotifyListeners(TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            notifyImeListenerArr[i].onChange(textFieldCharSequence, textFieldCharSequence2, (!z || textFieldCharSequence.contentEquals(textFieldCharSequence2) || textFieldCharSequence.m1446getCompositionMzsxiRA() == null) ? false : true);
        }
    }
    ...
    public final void syncMainBufferToTemporaryBuffer$foundation_release(TextFieldBuffer textFieldBuffer, boolean z, boolean z2) {
        TextFieldCharSequence m1436toTextFieldCharSequencewFTz33Y$foundation_release$default = TextFieldBuffer.m1436toTextFieldCharSequencewFTz33Y$foundation_release$default(this.mainBuffer, 0L, null, null, null, 15, null);
        if (z) {
            this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(textFieldBuffer.toString(), textFieldBuffer.m1439getSelectiond9O1mEE(), null, null, null, null, 60, null), null, null, null, 14, null);
        } else if (z2) {
            this.mainBuffer.m1441setSelection5zctL8(TextRangeKt.TextRange(TextRange.m7458getStartimpl(textFieldBuffer.m1439getSelectiond9O1mEE()), TextRange.m7453getEndimpl(textFieldBuffer.m1439getSelectiond9O1mEE())));
        }
        if (z || z2 || !Intrinsics.areEqual(m1436toTextFieldCharSequencewFTz33Y$foundation_release$default.m1446getCompositionMzsxiRA(), textFieldBuffer.m1437getCompositionMzsxiRA$foundation_release())) {
            this.mainBuffer.commitComposition$foundation_release();
        }
        updateValueAndNotifyListeners(m1436toTextFieldCharSequencewFTz33Y$foundation_release$default, TextFieldBuffer.m1436toTextFieldCharSequencewFTz33Y$foundation_release$default(this.mainBuffer, 0L, null, null, null, 15, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m7458getStartimpl(textFieldState.m1449getSelectiond9O1mEE())), Integer.valueOf(TextRange.m7453getEndimpl(textFieldState.m1449getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager$foundation_release()));
        }
