...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m1357layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            if ((i & 8) != 0) {
                textLayoutResult = null;
            }
            return companion.m1360layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult);
        }

        @JvmStatic
        /* renamed from: layout-_EkL_-Y$foundation_release  reason: not valid java name */
        public final Triple<Integer, Integer, TextLayoutResult> m1360layout_EkL_Y$foundation_release(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
            TextLayoutResult m1345layoutNN6EwU = textDelegate.m1345layoutNN6EwU(j, layoutDirection, textLayoutResult);
            return new Triple<>(Integer.valueOf((int) (m1345layoutNN6EwU.m7429getSizeYbymL2g() >> 32)), Integer.valueOf((int) (m1345layoutNN6EwU.m7429getSizeYbymL2g() & 4294967295L)), m1345layoutNN6EwU);
        }

        @JvmStatic
        /* renamed from: draw-Q1vqE60$foundation_release  reason: not valid java name */
        public final void m1359drawQ1vqE60$foundation_release(Canvas canvas, TextFieldValue textFieldValue, long j, long j2, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint paint, long j3) {
            if (!TextRange.m7452getCollapsedimpl(j)) {
                paint.mo5157setColor8_81llA(j3);
                m1356drawHighlightLepunE(canvas, j, offsetMapping, textLayoutResult, paint);
            } else if (!TextRange.m7452getCollapsedimpl(j2)) {
                Color m5270boximpl = Color.m5270boximpl(textLayoutResult.getLayoutInput().getStyle().m7488getColor0d7_KjU());
                if (m5270boximpl.m5290unboximpl() == 16) {
                    m5270boximpl = null;
                }
                long m5290unboximpl = m5270boximpl != null ? m5270boximpl.m5290unboximpl() : Color.Companion.m5306getBlack0d7_KjU();
                paint.mo5157setColor8_81llA(Color.m5279copywmQWz5c$default(m5290unboximpl, Color.m5282getAlphaimpl(m5290unboximpl) * 0.2f, 0.0f, 0.0f, 0.0f, 14, null));
                m1356drawHighlightLepunE(canvas, j2, offsetMapping, textLayoutResult, paint);
            } else if (!TextRange.m7452getCollapsedimpl(textFieldValue.m7709getSelectiond9O1mEE())) {
                paint.mo5157setColor8_81llA(j3);
                m1356drawHighlightLepunE(canvas, textFieldValue.m7709getSelectiond9O1mEE(), offsetMapping, textLayoutResult, paint);
            }
            TextPainter.INSTANCE.paint(canvas, textLayoutResult);
        }

        /* renamed from: drawHighlight-Le-punE  reason: not valid java name */
        private final void m1356drawHighlightLepunE(Canvas canvas, long j, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint paint) {
            int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m7456getMinimpl(j));
            int originalToTransformed2 = offsetMapping.originalToTransformed(TextRange.m7455getMaximpl(j));
        ...
        @JvmStatic
        public final void notifyFocusedRect$foundation_release(TextFieldValue textFieldValue, final TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean z, OffsetMapping offsetMapping) {
            if (z) {
                textInputSession.notifyFocusedRect(TextFieldDelegateKt.focusedRectInRoot(textLayoutResult, layoutCoordinates, offsetMapping.originalToTransformed(TextRange.m7455getMaximpl(textFieldValue.m7709getSelectiond9O1mEE())), new Function0() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$$ExternalSyntheticLambda1
        ...
        public static final IntSize notifyFocusedRect$lambda$1(TextDelegate textDelegate) {
            return IntSize.m8159boximpl(TextFieldDelegateKt.computeSizeForDefaultText$default(textDelegate.getStyle(), textDelegate.getDensity(), textDelegate.getFontFamilyResolver(), null, 0, 24, null));
        }
        ...
        public final void updateTextLayoutResult$foundation_release(TextInputSession textInputSession, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResultProxy) {
            ...
            textInputSession.updateTextLayoutResult(textFieldValue, offsetMapping, textLayoutResultProxy.getValue(), new Function1<Matrix, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$updateTextLayoutResult$1$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                    m1362invoke58bKbWc(matrix.m5545unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-58bKbWc  reason: not valid java name */
                public final void m1362invoke58bKbWc(float[] fArr) {
                    if (LayoutCoordinates.this.isAttached()) {
                        LayoutCoordinatesKt.findRootCoordinates(LayoutCoordinates.this).mo6713transformFromEL8BTi8(LayoutCoordinates.this, fArr);
                    }
                }
        ...
        public final void m1361setCursorOffsetULxng0E$foundation_release(long j, TextLayoutResultProxy textLayoutResultProxy, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> function1) {
            function1.invoke(TextFieldValue.m7704copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(textLayoutResultProxy, j, false, 2, null))), (TextRange) null, 5, (Object) null));
        }
        ...
        public final TextInputSession restartInput$foundation_release(TextInputService textInputService, TextFieldValue textFieldValue, final EditProcessor editProcessor, ImeOptions imeOptions, final Function1<? super TextFieldValue, Unit> function1, Function1<? super ImeAction, Unit> function12) {
            ...
            objectRef.element = textInputService.startInput(textFieldValue, imeOptions, new Function1() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit restartInput$lambda$4;
                    restartInput$lambda$4 = TextFieldDelegate.Companion.restartInput$lambda$4(EditProcessor.this, function1, objectRef, (List) obj);
        ...
        public static final Unit restartInput$lambda$4(EditProcessor editProcessor, Function1 function1, Ref.ObjectRef objectRef, List list) {
            TextFieldDelegate.Companion.onEditCommand$foundation_release(list, editProcessor, function1, (TextInputSession) objectRef.element);
            return Unit.INSTANCE;
        }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> function1) {
            function1.invoke(TextFieldValue.m7704copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
            textInputSession.dispose();
        }

        /* renamed from: applyCompositionDecoration-72CqOWE  reason: not valid java name */
        public final TransformedText m1358applyCompositionDecoration72CqOWE(long j, TransformedText transformedText) {
            int originalToTransformed = transformedText.getOffsetMapping().originalToTransformed(TextRange.m7458getStartimpl(j));
            int originalToTransformed2 = transformedText.getOffsetMapping().originalToTransformed(TextRange.m7453getEndimpl(j));
