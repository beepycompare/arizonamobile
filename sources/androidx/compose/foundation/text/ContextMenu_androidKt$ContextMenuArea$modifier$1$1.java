...
final class ContextMenu_androidKt$ContextMenuArea$modifier$1$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x005c, code lost:
        if (r7.mo1746onShowContextMenuSbBc2M(r6.$selectionState.getTextFieldState$foundation_release().getVisualText().getText(), r6.$selectionState.getTextFieldState$foundation_release().getVisualText().m1447getSelectiond9O1mEE(), r6) == r0) goto L16;
     */
