...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m1678getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m1679getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k  reason: not valid java name */
    public final int m1679getOffsetForPosition3MmeM6k(long j, boolean z) {
        if (z) {
            j = m1677coercedInVisibleBoundsOfInputTextMKHz9U(j);
        }
        return this.value.m7578getOffsetForPositionk4lQ0M(m1681translateDecorationToInnerCoordinatesMKHz9U$foundation(j));
    }
    ...
    public final boolean m1680isPositionOnTextk4lQ0M(long j) {
        long m1681translateDecorationToInnerCoordinatesMKHz9U$foundation = m1681translateDecorationToInnerCoordinatesMKHz9U$foundation(m1677coercedInVisibleBoundsOfInputTextMKHz9U(j));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & m1681translateDecorationToInnerCoordinatesMKHz9U$foundation)));
        int i = (int) (m1681translateDecorationToInnerCoordinatesMKHz9U$foundation >> 32);
    ...
    public final long m1681translateDecorationToInnerCoordinatesMKHz9U$foundation(long j) {
        ...
        if (layoutCoordinates2 != null) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                ...
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates2.mo6827localPositionOfR5De75A(layoutCoordinates3, j);
                }
            }
        }
        return j;
    ...
    public final long m1682translateInnerToDecorationCoordinatesMKHz9U$foundation(long j) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 != null) {
            if (!layoutCoordinates2.isAttached()) {
            ...
            if (layoutCoordinates2 != null && (layoutCoordinates = this.decorationBoxCoordinates) != null) {
                LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
                if (layoutCoordinates3 != null) {
                    return layoutCoordinates3.mo6827localPositionOfR5De75A(layoutCoordinates2, j);
                }
            }
        }
        return j;
    ...
    */
    private final long m1677coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        long m1684coerceIn3MmeM6k;
        ...
        zero = Rect.Companion.getZero();
        m1684coerceIn3MmeM6k = TextLayoutResultProxyKt.m1684coerceIn3MmeM6k(j, zero);
        return m1684coerceIn3MmeM6k;
    }

    public final int getLineForVerticalPosition(float f) {
        return this.value.getLineForVerticalPosition(Float.intBitsToFloat((int) (m1681translateDecorationToInnerCoordinatesMKHz9U$foundation(m1677coercedInVisibleBoundsOfInputTextMKHz9U(Offset.m5095constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)))) & 4294967295L)));
    }
}
