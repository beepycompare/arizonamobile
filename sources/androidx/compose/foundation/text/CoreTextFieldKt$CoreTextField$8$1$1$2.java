...
public final class CoreTextFieldKt$CoreTextField$8$1$1$2 implements MeasurePolicy {
    ...
    public MeasureResult mo41measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        try {
            ...
            Triple<Integer, Integer, TextLayoutResult> m1651layout_EkL_Y$foundation = TextFieldDelegate.Companion.m1651layout_EkL_Y$foundation(this.$state.getTextDelegate(), j, measureScope.getLayoutDirection(), value);
            int intValue = m1651layout_EkL_Y$foundation.component1().intValue();
            int intValue2 = m1651layout_EkL_Y$foundation.component2().intValue();
            TextLayoutResult component3 = m1651layout_EkL_Y$foundation.component3();
            ...
            this.$state.m1611setMinHeightForSingleLineField0680j_4(this.$density.mo431toDpu2uoSUM(this.$maxLines == 1 ? TextDelegateKt.ceilToIntPx(component3.getLineBottom(0)) : 0));
