...
public final class TextDelegateKt {
    ...
    public static /* synthetic */ TextDelegate m1347updateTextDelegaterm0N8CA$default(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List list, int i4, Object obj) {
        if ((i4 & 32) != 0) {
            z = true;
        }
        if ((i4 & 64) != 0) {
        ...
        return m1346updateTextDelegaterm0N8CA(textDelegate, annotatedString, textStyle, density, resolver, z, i, i2, i3, list);
    }

    /* renamed from: updateTextDelegate-rm0N8CA */
    public static final TextDelegate m1346updateTextDelegaterm0N8CA(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List<AnnotatedString.Range<Placeholder>> list) {
        ...
        if (Intrinsics.areEqual(textDelegate.getText(), annotatedString) && Intrinsics.areEqual(textDelegate.getStyle(), textStyle)) {
            ...
            if (textDelegate.getSoftWrap() == z2) {
                i4 = i;
                if (TextOverflow.m7922equalsimpl0(textDelegate.m1344getOverflowgIe3tQ8(), i4)) {
                    i5 = i2;
