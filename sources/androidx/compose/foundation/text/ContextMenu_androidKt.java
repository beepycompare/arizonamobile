        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            if (ComposeFoundationFlags.isNewContextMenuEnabled) {
                ...
                if (rememberedValue3 == Composer.Companion.getEmpty()) {
                    rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MenuItemsAvailability.m1313boximpl(MenuItemsAvailability.Companion.m1326getNoneJKCFgKw()), null, 2, null);
    ...
    public static final void ContextMenuArea(final TextFieldSelectionState textFieldSelectionState, boolean z, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 147) != 146, i2 & 1)) {
            ...
            if (ComposeFoundationFlags.isNewContextMenuEnabled) {
                ...
                Object rememberedValue4 = startRestartGroup.rememberedValue();
                if (rememberedValue4 == Composer.Companion.getEmpty()) {
                    rememberedValue4 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MenuItemsAvailability.m1313boximpl(MenuItemsAvailability.Companion.m1326getNoneJKCFgKw()), null, 2, null);
                    startRestartGroup.updateRememberedValue(rememberedValue4);
                }
    ...
    public static final Object getContextMenuItemsAvailability(TextFieldSelectionState textFieldSelectionState, Continuation<? super MenuItemsAvailability> continuation) {
        ...
        if (continuation instanceof ContextMenu_androidKt$getContextMenuItemsAvailability$1) {
            ...
            if ((contextMenu_androidKt$getContextMenuItemsAvailability$1.label & Integer.MIN_VALUE) != 0) {
                ...
                return MenuItemsAvailability.m1313boximpl(MenuItemsAvailability.m1315constructorimpl(textFieldSelectionState.canCopy(), textFieldSelectionState.canPaste(), textFieldSelectionState.canCut(), textFieldSelectionState.canSelectAll(), textFieldSelectionState.canAutofill()));
            }
        }
