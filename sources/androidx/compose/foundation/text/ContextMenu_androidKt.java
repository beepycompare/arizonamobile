...
public final class ContextMenu_androidKt {
    ...
    public static final void textItem(TextContextMenuBuilderScope textContextMenuBuilderScope, Resources resources, TextContextMenuItems textContextMenuItems, boolean z, Function1<? super TextContextMenuSession, Unit> function1) {
        if (z) {
            TextContextMenuBuilderScope_androidKt.item(textContextMenuBuilderScope, textContextMenuItems.getKey(), resources.getString(textContextMenuItems.m1420getStringId9Hzcbyc()), textContextMenuItems.m1419getDrawableId3I4p1mQ(), function1);
        }
    }
}
