...
public final class MenuItemsAvailability {
    ...
    private static final int None = m1314constructorimpl(0);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MenuItemsAvailability m1313boximpl(int i) {
    ...
    public static boolean m1316equalsimpl(int i, Object obj) {
        return (obj instanceof MenuItemsAvailability) && i == ((MenuItemsAvailability) obj).m1325unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1317equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: getCanAutofill-impl  reason: not valid java name */
    public static final boolean m1318getCanAutofillimpl(int i) {
        return (i & 16) == 16;
    }

    /* renamed from: getCanCopy-impl  reason: not valid java name */
    public static final boolean m1319getCanCopyimpl(int i) {
        return (i & 1) == 1;
    }

    /* renamed from: getCanCut-impl  reason: not valid java name */
    public static final boolean m1320getCanCutimpl(int i) {
        return (i & 4) == 4;
    }

    /* renamed from: getCanPaste-impl  reason: not valid java name */
    public static final boolean m1321getCanPasteimpl(int i) {
        return (i & 2) == 2;
    }

    /* renamed from: getCanSelectAll-impl  reason: not valid java name */
    public static final boolean m1322getCanSelectAllimpl(int i) {
        return (i & 8) == 8;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1323hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1324toStringimpl(int i) {
    ...
    public int hashCode() {
        return m1323hashCodeimpl(this.value);
    }
    ...
    public final /* synthetic */ int m1325unboximpl() {
        return this.value;
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1315constructorimpl(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        return m1314constructorimpl((z ? 1 : 0) | (z2 ? 2 : 0) | (z3 ? 4 : 0) | (z4 ? 8 : 0) | (z5 ? 16 : 0));
    }
    ...
    public static final class Companion {
        ...
        public final int m1326getNoneJKCFgKw() {
