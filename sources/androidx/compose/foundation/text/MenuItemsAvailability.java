...
public final class MenuItemsAvailability {
    ...
    private static final int None = m1616constructorimpl(0);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MenuItemsAvailability m1615boximpl(int i) {
        return new MenuItemsAvailability(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1616constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1618equalsimpl(int i, Object obj) {
        return (obj instanceof MenuItemsAvailability) && i == ((MenuItemsAvailability) obj).m1627unboximpl();
    }
    ...
    public static final boolean m1620getCanAutofillimpl(int i) {
        return (i & 16) == 16;
    }

    /* renamed from: getCanCopy-impl  reason: not valid java name */
    public static final boolean m1621getCanCopyimpl(int i) {
        return (i & 1) == 1;
    }

    /* renamed from: getCanCut-impl  reason: not valid java name */
    public static final boolean m1622getCanCutimpl(int i) {
        return (i & 4) == 4;
    }

    /* renamed from: getCanPaste-impl  reason: not valid java name */
    public static final boolean m1623getCanPasteimpl(int i) {
        return (i & 2) == 2;
    }

    /* renamed from: getCanSelectAll-impl  reason: not valid java name */
    public static final boolean m1624getCanSelectAllimpl(int i) {
        return (i & 8) == 8;
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m1617constructorimpl(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        return m1616constructorimpl((z ? 1 : 0) | (z2 ? 2 : 0) | (z3 ? 4 : 0) | (z4 ? 8 : 0) | (z5 ? 16 : 0));
    }
    ...
    public static final class Companion {
        ...
        public final int m1628getNoneJKCFgKw() {
