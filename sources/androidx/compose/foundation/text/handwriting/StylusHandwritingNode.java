...
public class StylusHandwritingNode extends DelegatingNode implements PointerInputModifierNode, FocusEventModifierNode, FocusRequesterModifierNode {
        ...
        static final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
            ...
            */
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    while (true) {
                        ...
                        if (!pointerInputChange8.isConsumed()) {
                            pointerInputChange3 = pointerInputChange;
                            if (PointerId.m6664equalsimpl0(pointerInputChange8.m6682getIdJ3iCeTQ(), pointerInputChange3.m6682getIdJ3iCeTQ()) && pointerInputChange8.getPressed()) {
                                break;
                            }
                        } else {
                            pointerInputChange3 = pointerInputChange;
                    ...
                    if (pointerInputChange9 != null && pointerInputChange9.getUptimeMillis() - pointerInputChange3.getUptimeMillis() < awaitPointerEventScope2.getViewConfiguration().getLongPressTimeoutMillis() && !TapGestureDetector_androidKt.isDeepPress(pointerEvent)) {
                        if (Offset.m5101getDistanceimpl(Offset.m5107minusMKHz9U(pointerInputChange9.m6685getPositionF1C5BW0(), pointerInputChange3.m6685getPositionF1C5BW0())) > awaitPointerEventScope2.getViewConfiguration().getHandwritingSlop()) {
                    ...
                    while (true) {
                        ...
                        if (!pointerInputChange10.isConsumed() && PointerId.m6664equalsimpl0(pointerInputChange10.m6682getIdJ3iCeTQ(), pointerInputChange5.m6682getIdJ3iCeTQ()) && pointerInputChange10.getPressed()) {
                            break;
                        }
                        i4++;
                    }
                ...
                if (!PointerType.m6758equalsimpl0(pointerInputChange12.m6688getTypeT8wyACA(), PointerType.Companion.m6764getStylusT8wyACA()) && !PointerType.m6758equalsimpl0(pointerInputChange12.m6688getTypeT8wyACA(), PointerType.Companion.m6762getEraserT8wyACA())) {
                    return Unit.INSTANCE;
                }
                z3 = (Float.intBitsToFloat((int) (pointerInputChange12.m6685getPositionF1C5BW0() >> 32)) < 0.0f || Float.intBitsToFloat((int) (pointerInputChange12.m6685getPositionF1C5BW0() >> 32)) >= ((float) ((int) (awaitPointerEventScope.mo6570getSizeYbymL2g() >> 32))) || Float.intBitsToFloat((int) (pointerInputChange12.m6685getPositionF1C5BW0() & 4294967295L)) < 0.0f || Float.intBitsToFloat((int) (pointerInputChange12.m6685getPositionF1C5BW0() & 4294967295L)) >= ((float) ((int) (awaitPointerEventScope.mo6570getSizeYbymL2g() & 4294967295L)))) ? false : false;
    ...
    public long mo1710getTouchBoundsExpansionRZrCHBk() {
        return StylusHandwritingKt.getHandwritingBoundsExpansion().m7028roundToTouchBoundsExpansionTW6G1oQ(DelegatableNodeKt.requireDensity(this));
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY */
    public void mo257onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        this.suspendingPointerInputModifierNode.mo257onPointerEventH0pRuoY(pointerEvent, pointerEventPass, j);
    }
