...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final Unit CursorHandle_USBMPiE$lambda$2(OffsetProvider offsetProvider, Modifier modifier, long j, int i, int i2, Composer composer, int i3) {
        m1201CursorHandleUSBMPiE(offsetProvider, modifier, j, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
    ...
    */
    public static final void m1201CursorHandleUSBMPiE(final OffsetProvider offsetProvider, final Modifier modifier, final long j, Composer composer, final int i, final int i2) {
        int i3;
                ...
                AndroidSelectionHandles_androidKt.HandlePopup(offsetProvider, Alignment.Companion.getTopCenter(), ComposableLambdaKt.rememberComposableLambda(-1653527038, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
                    ...
                    public final void invoke(Composer composer2, int i5) {
                        ...
                        if (j != InlineClassHelperKt.UnspecifiedPackedFloats) {
                            ...
                            Modifier m880requiredSizeInqDBjuR0$default = SizeKt.m880requiredSizeInqDBjuR0$default(semantics$default, DpSize.m7349getWidthD9Ej5fM(j), DpSize.m7347getHeightD9Ej5fM(j), 0.0f, 0.0f, 12, null);
                            ...
                            Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer2, m880requiredSizeInqDBjuR0$default);
    ...
    public static final Unit CursorHandle_USBMPiE$lambda$1$lambda$0(OffsetProvider offsetProvider, SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SelectionHandlesKt.getSelectionHandleInfoKey(), new SelectionHandleInfo(Handle.Cursor, offsetProvider.mo1219provideF1C5BW0(), SelectionHandleAnchor.Middle, true, null));
        return Unit.INSTANCE;
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i, final int i2) {
        ...
        if (!startRestartGroup.shouldExecute((i3 & 3) != 2, i3 & 1)) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m886sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    static {
        float m7251constructorimpl = Dp.m7251constructorimpl(25);
        CursorHandleHeight = m7251constructorimpl;
        CursorHandleWidth = Dp.m7251constructorimpl(Dp.m7251constructorimpl(m7251constructorimpl * 2.0f) / 2.4142137f);
    }
}
