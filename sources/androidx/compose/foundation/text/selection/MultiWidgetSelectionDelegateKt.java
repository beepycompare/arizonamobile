...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m1586appendSelectableInfoParwq6A(SelectionLayoutBuilder selectionLayoutBuilder, TextLayoutResult textLayoutResult, long j, long j2, long j3) {
        Direction direction;
        ...
        int m1587getOffsetForPosition3MmeM6k;
        int previousAdjustedOffset;
        Selection.AnchorInfo start;
        Selection.AnchorInfo end;
        Rect rect = new Rect(0.0f, 0.0f, (int) (textLayoutResult.m6974getSizeYbymL2g() >> 32), (int) (textLayoutResult.m6974getSizeYbymL2g() & 4294967295L));
        Direction m1588getXDirection3MmeM6k = m1588getXDirection3MmeM6k(j, rect);
        Direction m1589getYDirection3MmeM6k = m1589getYDirection3MmeM6k(j, rect);
        if (selectionLayoutBuilder.isStartHandle()) {
            Selection previousSelection = selectionLayoutBuilder.getPreviousSelection();
            direction = m1589getYDirection3MmeM6k;
            direction2 = m1588getXDirection3MmeM6k;
            j4 = j3;
        ...
        if (isSelected(SelectionLayoutKt.resolve2dDirection(direction2, direction), direction6)) {
            ...
            if (selectionLayoutBuilder.isStartHandle()) {
                previousAdjustedOffset = m1587getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection3 = selectionLayoutBuilder.getPreviousSelection();
                m1587getOffsetForPosition3MmeM6k = (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) ? previousAdjustedOffset : getPreviousAdjustedOffset(end, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            } else {
                m1587getOffsetForPosition3MmeM6k = m1587getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = selectionLayoutBuilder.getPreviousSelection();
                previousAdjustedOffset = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? m1587getOffsetForPosition3MmeM6k : getPreviousAdjustedOffset(start, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            }
            selectionLayoutBuilder.appendInfo(j4, previousAdjustedOffset, direction5, appendSelectableInfo_Parwq6A$otherDirection, m1587getOffsetForPosition3MmeM6k, direction3, direction4, (9223372034707292159L & j2) == InlineClassHelperKt.UnspecifiedPackedFloats ? -1 : m1587getOffsetForPosition3MmeM6k(j2, textLayoutResult), textLayoutResult);
        }
    }
    ...
    private static final Direction m1588getXDirection3MmeM6k(long j, Rect rect) {
        int i = (int) (j >> 32);
    ...
    private static final Direction m1589getYDirection3MmeM6k(long j, Rect rect) {
    ...
    private static final int m1587getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        ...
        return textLayoutResult.m6973getOffsetForPositionk4lQ0M(j);
    }
}
