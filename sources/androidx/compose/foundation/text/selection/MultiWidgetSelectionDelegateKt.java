...
public final class MultiWidgetSelectionDelegateKt {
    ...
    public static final void m2031appendSelectableInfoParwq6A(SelectionLayoutBuilder selectionLayoutBuilder, TextLayoutResult textLayoutResult, long j, long j2, long j3) {
        Direction direction;
        ...
        int m2032getOffsetForPosition3MmeM6k;
        int previousAdjustedOffset;
        Selection.AnchorInfo start;
        Selection.AnchorInfo end;
        Rect rect = new Rect(0.0f, 0.0f, (int) (textLayoutResult.m7579getSizeYbymL2g() >> 32), (int) (textLayoutResult.m7579getSizeYbymL2g() & 4294967295L));
        Direction m2033getXDirection3MmeM6k = m2033getXDirection3MmeM6k(j, rect);
        Direction m2034getYDirection3MmeM6k = m2034getYDirection3MmeM6k(j, rect);
        if (selectionLayoutBuilder.isStartHandle()) {
            Selection previousSelection = selectionLayoutBuilder.getPreviousSelection();
            direction = m2034getYDirection3MmeM6k;
            direction2 = m2033getXDirection3MmeM6k;
            j4 = j3;
        ...
        if (isSelected(SelectionLayoutKt.resolve2dDirection(direction2, direction), direction6)) {
            ...
            if (selectionLayoutBuilder.isStartHandle()) {
                previousAdjustedOffset = m2032getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection3 = selectionLayoutBuilder.getPreviousSelection();
                m2032getOffsetForPosition3MmeM6k = (previousSelection3 == null || (end = previousSelection3.getEnd()) == null) ? previousAdjustedOffset : getPreviousAdjustedOffset(end, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            } else {
                m2032getOffsetForPosition3MmeM6k = m2032getOffsetForPosition3MmeM6k(j, textLayoutResult);
                Selection previousSelection4 = selectionLayoutBuilder.getPreviousSelection();
                previousAdjustedOffset = (previousSelection4 == null || (start = previousSelection4.getStart()) == null) ? m2032getOffsetForPosition3MmeM6k : getPreviousAdjustedOffset(start, selectionLayoutBuilder.getSelectableIdOrderingComparator(), j4, length);
            }
            selectionLayoutBuilder.appendInfo(j4, previousAdjustedOffset, direction5, appendSelectableInfo_Parwq6A$otherDirection, m2032getOffsetForPosition3MmeM6k, direction3, direction4, (9223372034707292159L & j2) == InlineClassHelperKt.UnspecifiedPackedFloats ? -1 : m2032getOffsetForPosition3MmeM6k(j2, textLayoutResult), textLayoutResult);
        }
    }
    ...
    private static final Direction m2033getXDirection3MmeM6k(long j, Rect rect) {
        int i = (int) (j >> 32);
    ...
    private static final Direction m2034getYDirection3MmeM6k(long j, Rect rect) {
    ...
    private static final int m2032getOffsetForPosition3MmeM6k(long j, TextLayoutResult textLayoutResult) {
        ...
        return textLayoutResult.m7578getOffsetForPositionk4lQ0M(j);
    }
}
