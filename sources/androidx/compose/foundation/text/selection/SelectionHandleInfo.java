...
public final class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m1464copyubNVwUQ$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m1466copyubNVwUQ(handle, j, selectionHandleAnchor, z);
    }
    ...
    public final long m1465component2F1C5BW0() {
    ...
    public final SelectionHandleInfo m1466copyubNVwUQ(Handle handle, long j, SelectionHandleAnchor selectionHandleAnchor, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectionHandleInfo) {
            ...
            return this.handle == selectionHandleInfo.handle && Offset.m3834equalsimpl0(this.position, selectionHandleInfo.position) && this.anchor == selectionHandleInfo.anchor && this.visible == selectionHandleInfo.visible;
        }
        return false;
    }

    public int hashCode() {
        return (((((this.handle.hashCode() * 31) + Offset.m3839hashCodeimpl(this.position)) * 31) + this.anchor.hashCode()) * 31) + Boolean.hashCode(this.visible);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m3845toStringimpl(this.position)) + ", anchor=" + this.anchor + ", visible=" + this.visible + ')';
    }
    ...
    public final long m1467getPositionF1C5BW0() {
        return this.position;
    }
