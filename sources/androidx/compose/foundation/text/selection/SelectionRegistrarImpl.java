...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    public static final int sort$lambda$0(LayoutCoordinates layoutCoordinates, Selectable selectable, Selectable selectable2) {
        ...
        if (layoutCoordinates2 != null) {
            m5119getZeroF1C5BW0 = layoutCoordinates.mo6827localPositionOfR5De75A(layoutCoordinates2, Offset.Companion.m5119getZeroF1C5BW0());
            float intBitsToFloat = Float.intBitsToFloat((int) (m5119getZeroF1C5BW0 >> 32)) + ((int) (layoutCoordinates2.mo6826getSizeYbymL2g() >> 32));
            float intBitsToFloat2 = Float.intBitsToFloat((int) (m5119getZeroF1C5BW0 & 4294967295L)) + ((int) (layoutCoordinates2.mo6826getSizeYbymL2g() & 4294967295L));
            m5119getZeroF1C5BW02 = Offset.m5095constructorimpl((Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
        } else {
            m5119getZeroF1C5BW0 = Offset.Companion.m5119getZeroF1C5BW0();
            m5119getZeroF1C5BW02 = Offset.Companion.m5119getZeroF1C5BW0();
        }
        long j = m5119getZeroF1C5BW0;
        long j2 = m5119getZeroF1C5BW02;
        if (layoutCoordinates3 != null) {
            m5119getZeroF1C5BW03 = layoutCoordinates.mo6827localPositionOfR5De75A(layoutCoordinates3, Offset.Companion.m5119getZeroF1C5BW0());
            float intBitsToFloat3 = Float.intBitsToFloat((int) (m5119getZeroF1C5BW03 >> 32)) + ((int) (layoutCoordinates3.mo6826getSizeYbymL2g() >> 32));
            float intBitsToFloat4 = Float.intBitsToFloat((int) (m5119getZeroF1C5BW03 & 4294967295L)) + ((int) (layoutCoordinates3.mo6826getSizeYbymL2g() & 4294967295L));
            m5119getZeroF1C5BW04 = Offset.m5095constructorimpl((Float.floatToRawIntBits(intBitsToFloat4) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat3) << 32));
        } else {
            m5119getZeroF1C5BW03 = Offset.Companion.m5119getZeroF1C5BW0();
            m5119getZeroF1C5BW04 = Offset.Companion.m5119getZeroF1C5BW0();
        }
        long j3 = m5119getZeroF1C5BW03;
        if (SelectionRegistrarImplKt.m2090inARowzwwh4xc(j, j2, j3, m5119getZeroF1C5BW04)) {
    ...
    public void mo2089notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment, boolean z) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(z), layoutCoordinates, Offset.m5092boximpl(j), selectionAdjustment);
        }
    }
    ...
    public boolean mo2088notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(z2), layoutCoordinates, Offset.m5092boximpl(j), Offset.m5092boximpl(j2), Boolean.valueOf(z), selectionAdjustment).booleanValue();
        }
        return true;
    }
