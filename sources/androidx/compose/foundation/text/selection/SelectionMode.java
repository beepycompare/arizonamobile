...
public abstract class SelectionMode {
    ...
    public static final SelectionMode Vertical = new SelectionMode("Vertical", 0) { // from class: androidx.compose.foundation.text.selection.SelectionMode.Vertical
        ...
        public int mo2086compare3MmeM6k$foundation(long j, Rect rect) {
    ...
    public abstract int mo2086compare3MmeM6k$foundation(long j, Rect rect);
    ...
    public final boolean m2087isSelected2x9bVx0$foundation(Rect rect, long j, long j2) {
        if (m2085containsInclusiveUv8p0NA(rect, j) || m2085containsInclusiveUv8p0NA(rect, j2)) {
            return true;
        }
        return (mo2086compare3MmeM6k$foundation(j, rect) > 0) ^ (mo2086compare3MmeM6k$foundation(j2, rect) > 0);
    }

    /* renamed from: containsInclusive-Uv8p0NA  reason: not valid java name */
    private final boolean m2085containsInclusiveUv8p0NA(Rect rect, long j) {
