    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (platformSelectionBehaviors$foundation_release != null) {
                this.label = 1;
                obj = platformSelectionBehaviors$foundation_release.mo1747suggestSelectionForLongPressOrDoubleClickpYaCww(this.$textInSelectable.element, this.$selectionInSelectable.element.m7462unboximpl(), this);
                ...
                if (textRange != null && !Intrinsics.areEqual(textRange, this.$selectionInSelectable.element) && (selectable = this.this$0.selectionRegistrar.getSelectableMap$foundation_release().get(this.$targetSelectableId.element)) != null && selectable.getText() == this.$textInSelectable.element) {
                    ...
                    Selection selection = new Selection(new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m7458getStartimpl(textRange.m7462unboximpl())), TextRange.m7458getStartimpl(textRange.m7462unboximpl()), this.$targetSelectableId.element), new Selection.AnchorInfo(SelectionHelpersKt.getTextDirectionForOffset(textLayoutResult, TextRange.m7453getEndimpl(textRange.m7462unboximpl())), TextRange.m7453getEndimpl(textRange.m7462unboximpl()), this.$targetSelectableId.element), false, 4, null);
