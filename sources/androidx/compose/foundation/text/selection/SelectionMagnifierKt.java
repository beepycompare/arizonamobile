...
public final class SelectionMagnifierKt {
    ...
    static {
        long m4285constructorimpl = Offset.m4285constructorimpl((Float.floatToRawIntBits(0.01f) << 32) | (Float.floatToRawIntBits(0.01f) & 4294967295L));
        OffsetDisplacementThreshold = m4285constructorimpl;
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m4282boximpl(m4285constructorimpl), 3, null);
    }
    ...
    public static final AnimationVector2D UnspecifiedSafeOffsetVectorConverter$lambda$0(Offset offset) {
        if ((offset.m4303unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
            Object animatable = new Animatable(Offset.m4282boximpl(rememberAnimatedMagnifierPosition$lambda$3(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m4282boximpl(OffsetDisplacementThreshold), null, 8, null);
