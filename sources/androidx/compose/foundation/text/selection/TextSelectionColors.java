...
public final class TextSelectionColors {
    ...
    public final long m1839getBackgroundColor0d7_KjU() {
        return this.backgroundColor;
    }

    /* renamed from: getHandleColor-0d7_KjU  reason: not valid java name */
    public final long m1840getHandleColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextSelectionColors) {
            ...
            return Color.m4538equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m4538equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
        }
        return false;
    }

    public int hashCode() {
        return (Color.m4544hashCodeimpl(this.handleColor) * 31) + Color.m4544hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m4545toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m4545toStringimpl(this.backgroundColor)) + ')';
    }
}
