...
public final class PlatformSelectionBehaviors_androidKt {
    ...
    public static final boolean m2046canReuseh5sm0ck(TextClassificationResult textClassificationResult, CharSequence charSequence, long j) {
        return TextRange.m7601equalsimpl0(j, textClassificationResult.m2094getSelectiond9O1mEE()) && Intrinsics.areEqual(charSequence, textClassificationResult.getText());
    }

    /* renamed from: addPlatformTextContextMenuItems-71BSaZU  reason: not valid java name */
    public static final void m2045addPlatformTextContextMenuItems71BSaZU(TextContextMenuBuilderScope textContextMenuBuilderScope, Context context, boolean z, CharSequence charSequence, TextRange textRange, PlatformSelectionBehaviors platformSelectionBehaviors, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        if (Build.VERSION.SDK_INT < 28 || charSequence == null || textRange == null || platformSelectionBehaviors == null || !(platformSelectionBehaviors instanceof PlatformSelectionBehaviorsImpl)) {
            ...
            ProcessText_androidKt.m1687addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.m7612unboximpl());
            return;
        }
        ((PlatformSelectionBehaviorsImpl) platformSelectionBehaviors).m2042addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation(textContextMenuBuilderScope, charSequence, textRange.m7612unboximpl(), function1);
        ProcessText_androidKt.m1687addProcessedTextContextMenuItemsUAq72N0(textContextMenuBuilderScope, context, z, charSequence, textRange.m7612unboximpl());
    }
}
