...
public final class MultiWidgetSelectionDelegate implements Selectable {
        ...
        synchronized (this.lock) {
            if (this._previousTextLayoutResult != textLayoutResult) {
                if (textLayoutResult.getDidOverflowHeight() && !textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                    int coerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition((int) (textLayoutResult.m7579getSizeYbymL2g() & 4294967295L)), textLayoutResult.getLineCount() - 1);
                    while (coerceAtMost >= 0 && textLayoutResult.getLineTop(coerceAtMost) >= ((int) (textLayoutResult.m7579getSizeYbymL2g() & 4294967295L))) {
                        coerceAtMost--;
                    }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder selectionLayoutBuilder) {
        ...
        long mo6827localPositionOfR5De75A = selectionLayoutBuilder.getContainerCoordinates().mo6827localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m5119getZeroF1C5BW0());
        long m5107minusMKHz9U2 = Offset.m5107minusMKHz9U(selectionLayoutBuilder.m2054getCurrentPositionF1C5BW0(), mo6827localPositionOfR5De75A);
        if ((selectionLayoutBuilder.m2055getPreviousHandlePositionF1C5BW0() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            m5107minusMKHz9U = Offset.Companion.m5118getUnspecifiedF1C5BW0();
        } else {
            m5107minusMKHz9U = Offset.m5107minusMKHz9U(selectionLayoutBuilder.m2055getPreviousHandlePositionF1C5BW0(), mo6827localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m2031appendSelectableInfoParwq6A(selectionLayoutBuilder, invoke, m5107minusMKHz9U2, m5107minusMKHz9U, getSelectableId());
    }
    ...
    public long mo2029getHandlePositiondBAh8RU(Selection selection, boolean z) {
        TextLayoutResult invoke;
    ...
    public long mo2030getRangeOfLineContainingjx7JFs(int i) {
        TextLayoutResult invoke = this.layoutResultCallback.invoke();
        if (invoke == null) {
