...
public final class MultiWidgetSelectionDelegate implements Selectable {
        ...
        synchronized (this.lock) {
            if (this._previousTextLayoutResult != textLayoutResult) {
                if (textLayoutResult.getDidOverflowHeight() && !textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                    int coerceAtMost = RangesKt.coerceAtMost(textLayoutResult.getLineForVerticalPosition((int) (textLayoutResult.m6684getSizeYbymL2g() & 4294967295L)), textLayoutResult.getLineCount() - 1);
                    while (coerceAtMost >= 0 && textLayoutResult.getLineTop(coerceAtMost) >= ((int) (textLayoutResult.m6684getSizeYbymL2g() & 4294967295L))) {
                        coerceAtMost--;
                    }
    ...
    public void appendSelectableInfoToBuilder(SelectionLayoutBuilder selectionLayoutBuilder) {
        ...
        long mo5963localPositionOfR5De75A = selectionLayoutBuilder.getContainerCoordinates().mo5963localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m4309getZeroF1C5BW0());
        long m4297minusMKHz9U2 = Offset.m4297minusMKHz9U(selectionLayoutBuilder.m1758getCurrentPositionF1C5BW0(), mo5963localPositionOfR5De75A);
        if ((selectionLayoutBuilder.m1759getPreviousHandlePositionF1C5BW0() & 9223372034707292159L) == InlineClassHelperKt.UnspecifiedPackedFloats) {
            m4297minusMKHz9U = Offset.Companion.m4308getUnspecifiedF1C5BW0();
        } else {
            m4297minusMKHz9U = Offset.m4297minusMKHz9U(selectionLayoutBuilder.m1759getPreviousHandlePositionF1C5BW0(), mo5963localPositionOfR5De75A);
        }
        MultiWidgetSelectionDelegateKt.m1731appendSelectableInfoParwq6A(selectionLayoutBuilder, invoke, m4297minusMKHz9U2, m4297minusMKHz9U, getSelectableId());
    }
    ...
    public long mo1729getHandlePositiondBAh8RU(Selection selection, boolean z) {
        TextLayoutResult invoke;
    ...
    public long mo1730getRangeOfLineContainingjx7JFs(int i) {
        TextLayoutResult invoke = this.layoutResultCallback.invoke();
        if (invoke == null) {
