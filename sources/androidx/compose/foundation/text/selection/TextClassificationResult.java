...
public final class TextClassificationResult {
    ...
    public static /* synthetic */ TextClassificationResult m2091copySbBc2M$default(TextClassificationResult textClassificationResult, CharSequence charSequence, long j, TextClassification textClassification, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textClassificationResult.m2093copySbBc2M(charSequence, j, textClassification);
    }
    ...
    public final long m2092component2d9O1mEE() {
    ...
    public final TextClassificationResult m2093copySbBc2M(CharSequence charSequence, long j, TextClassification textClassification) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextClassificationResult) {
            ...
            return Intrinsics.areEqual(this.text, textClassificationResult.text) && TextRange.m7601equalsimpl0(this.selection, textClassificationResult.selection) && Intrinsics.areEqual(this.textClassification, textClassificationResult.textClassification);
        }
        return false;
    }

    public int hashCode() {
        return (((this.text.hashCode() * 31) + TextRange.m7609hashCodeimpl(this.selection)) * 31) + this.textClassification.hashCode();
    }

    public String toString() {
        return "TextClassificationResult(text=" + ((Object) this.text) + ", selection=" + ((Object) TextRange.m7611toStringimpl(this.selection)) + ", textClassification=" + this.textClassification + ')';
    }
    ...
    public final long m2094getSelectiond9O1mEE() {
        return this.selection;
    }
