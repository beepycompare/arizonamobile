...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.Companion.m5052getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo1350onStartk4lQ0M(long j) {
                ...
                long m1830updateSelection8UEBfa8;
                if (TextFieldSelectionManager.this.getEnabled() && TextFieldSelectionManager.this.getDraggingHandle() == null) {
                    ...
                    if (state$foundation_release == null || (layoutResult2 = state$foundation_release.getLayoutResult()) == null || !layoutResult2.m1389isPositionOnTextk4lQ0M(j)) {
                        j2 = j;
                        ...
                        if (state$foundation_release2 != null && (layoutResult = state$foundation_release2.getLayoutResult()) != null) {
                            ...
                            int transformedToOriginal = textFieldSelectionManager.getOffsetMapping$foundation_release().transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(layoutResult, j2, false, 2, null));
                            m1826createTextFieldValueFDrldGo = textFieldSelectionManager.m1826createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal));
                            ...
                            textFieldSelectionManager.getOnValueChange$foundation_release().invoke(m1826createTextFieldValueFDrldGo);
                            textFieldSelectionManager.m1838setLatestSelectionOEnZFl4$foundation_release(TextRange.m7446boximpl(m1826createTextFieldValueFDrldGo.m7709getSelectiond9O1mEE()));
                        }
                        ...
                        m1830updateSelection8UEBfa8 = textFieldSelectionManager2.m1830updateSelection8UEBfa8(TextFieldValue.m7704copy3r_uNRQ$default(textFieldSelectionManager2.getValue$foundation_release(), (AnnotatedString) null, TextRange.Companion.m7463getZerod9O1mEE(), (TextRange) null, 5, (Object) null), j, true, false, SelectionAdjustment.Companion.getWord(), true);
                        j2 = j;
                        TextFieldSelectionManager.this.dragBeginSelection = TextRange.m7446boximpl(m1830updateSelection8UEBfa8);
                    }
                    ...
                    textFieldSelectionManager3.m1829setCurrentDragPosition_kEHs6E(Offset.m5025boximpl(j3));
                    TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m5052getZeroF1C5BW0();
                }
            }
            ...
            */
            public void mo1349onDragk4lQ0M(long j) {
                ...
                long j5;
                int m1388getOffsetForPosition3MmeM6k;
                ...
                textFieldSelectionManager2.dragTotalDistance = Offset.m5041plusMKHz9U(j2, j);
                LegacyTextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release != null && (layoutResult = state$foundation_release.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager3 = TextFieldSelectionManager.this;
                    j3 = textFieldSelectionManager3.dragBeginPosition;
                    j4 = textFieldSelectionManager3.dragTotalDistance;
                    textFieldSelectionManager3.m1829setCurrentDragPosition_kEHs6E(Offset.m5025boximpl(Offset.m5041plusMKHz9U(j3, j4)));
                    textRange = textFieldSelectionManager3.dragBeginSelection;
                    if (textRange == null) {
                        Offset m1832getCurrentDragPosition_m7T9E = textFieldSelectionManager3.m1832getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E);
                        if (!layoutResult.m1389isPositionOnTextk4lQ0M(m1832getCurrentDragPosition_m7T9E.m5046unboximpl())) {
                            ...
                            int transformedToOriginal = offsetMapping$foundation_release.transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(layoutResult, j6, false, 2, null));
                            OffsetMapping offsetMapping$foundation_release2 = textFieldSelectionManager3.getOffsetMapping$foundation_release();
                            Offset m1832getCurrentDragPosition_m7T9E2 = textFieldSelectionManager3.m1832getCurrentDragPosition_m7T9E();
                            Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E2);
                            if (transformedToOriginal == offsetMapping$foundation_release2.transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(layoutResult, m1832getCurrentDragPosition_m7T9E2.m5046unboximpl(), false, 2, null))) {
                            ...
                            Offset m1832getCurrentDragPosition_m7T9E3 = textFieldSelectionManager3.m1832getCurrentDragPosition_m7T9E();
                            Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E3);
                            textFieldSelectionManager = textFieldSelectionManager3;
                            m1830updateSelection8UEBfa8 = textFieldSelectionManager.m1830updateSelection8UEBfa8(value$foundation_release, m1832getCurrentDragPosition_m7T9E3.m5046unboximpl(), false, false, selectionAdjustment, true);
                            textRange4 = textFieldSelectionManager.dragBeginSelection;
                            if (!TextRange.m7450equalsimpl(m1830updateSelection8UEBfa8, textRange4)) {
                                this.isLongPressSelectionOnly = false;
                            }
                        }
                    }
                    ...
                    if (textRange2 != null) {
                        m1388getOffsetForPosition3MmeM6k = TextRange.m7458getStartimpl(textRange2.m7462unboximpl());
                    } else {
                        j5 = textFieldSelectionManager.dragBeginPosition;
                        m1388getOffsetForPosition3MmeM6k = layoutResult.m1388getOffsetForPosition3MmeM6k(j5, false);
                    }
                    Offset m1832getCurrentDragPosition_m7T9E4 = textFieldSelectionManager.m1832getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E4);
                    int m1388getOffsetForPosition3MmeM6k2 = layoutResult.m1388getOffsetForPosition3MmeM6k(m1832getCurrentDragPosition_m7T9E4.m5046unboximpl(), false);
                    textRange3 = textFieldSelectionManager.dragBeginSelection;
                    if (textRange3 == null && m1388getOffsetForPosition3MmeM6k == m1388getOffsetForPosition3MmeM6k2) {
                        return;
                    }
                    TextFieldValue value$foundation_release2 = textFieldSelectionManager.getValue$foundation_release();
                    Offset m1832getCurrentDragPosition_m7T9E5 = textFieldSelectionManager.m1832getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E5);
                    m1830updateSelection8UEBfa8 = textFieldSelectionManager.m1830updateSelection8UEBfa8(value$foundation_release2, m1832getCurrentDragPosition_m7T9E5.m5046unboximpl(), false, false, SelectionAdjustment.Companion.getWord(), true);
                    textRange4 = textFieldSelectionManager.dragBeginSelection;
                    if (!TextRange.m7450equalsimpl(m1830updateSelection8UEBfa8, textRange4)) {
                    }
                }
            ...
            private final void onEnd() {
                ...
                TextFieldSelectionManager.this.m1829setCurrentDragPosition_kEHs6E(null);
                boolean z = true;
                TextFieldSelectionManager.this.updateFloatingToolbar(true);
                boolean m7452getCollapsedimpl = TextRange.m7452getCollapsedimpl(TextFieldSelectionManager.this.getValue$foundation_release().m7709getSelectiond9O1mEE());
                TextFieldSelectionManager.this.setHandleState(m7452getCollapsedimpl ? HandleState.Cursor : HandleState.Selection);
                LegacyTextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release != null) {
                    state$foundation_release.setShowSelectionHandleStart(!m7452getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(TextFieldSelectionManager.this, true));
                }
                LegacyTextFieldState state$foundation_release2 = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release2 != null) {
                    state$foundation_release2.setShowSelectionHandleEnd(!m7452getCollapsedimpl && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(TextFieldSelectionManager.this, false));
                }
                ...
                if (state$foundation_release3 != null) {
                    if (!m7452getCollapsedimpl || !TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(TextFieldSelectionManager.this, true)) {
                        z = false;
                    }
                ...
                if (this.isLongPressSelectionOnly) {
                    ...
                    textFieldSelectionManager.m1828maybeSuggestSelectionOEnZFl4(textRange);
                }
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo1662onStart9KIMszo(long j, SelectionAdjustment selectionAdjustment, int i) {
                ...
                if (i >= 2) {
                    ...
                    this.initialSelection = TextRange.m7446boximpl(updateMouseSelection);
                }
                return true;
            }
            ...
            public boolean mo1659onDrag3MmeM6k(long j, SelectionAdjustment selectionAdjustment) {
                LegacyTextFieldState state$foundation_release;
                if (!TextFieldSelectionManager.this.getEnabled() || TextFieldSelectionManager.this.getValue$foundation_release().getText().length() == 0 || (state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release()) == null || state$foundation_release.getLayoutResult() == null) {
                    return false;
                }
            ...
            public final long updateMouseSelection(TextFieldValue textFieldValue, long j, boolean z, SelectionAdjustment selectionAdjustment) {
                long m1830updateSelection8UEBfa8;
                m1830updateSelection8UEBfa8 = TextFieldSelectionManager.this.m1830updateSelection8UEBfa8(textFieldValue, j, z, false, selectionAdjustment, false);
                if (!TextRange.m7450equalsimpl(m1830updateSelection8UEBfa8, this.initialSelection)) {
                    this.isDoubleOrTripleClickSelectionOnly = false;
                }
                TextFieldSelectionManager.this.setHandleState(TextRange.m7452getCollapsedimpl(m1830updateSelection8UEBfa8) ? HandleState.Cursor : HandleState.Selection);
                return m1830updateSelection8UEBfa8;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            public void onDragDone() {
                if (this.isDoubleOrTripleClickSelectionOnly) {
                    TextFieldSelectionManager.this.m1828maybeSuggestSelectionOEnZFl4(this.initialSelection);
                }
            }
        };
    }
    ...
    public final void setValue$foundation_release(TextFieldValue textFieldValue) {
        ...
        this.latestSelection = TextRange.m7446boximpl(textFieldValue.m7709getSelectiond9O1mEE());
    }
    ...
    public final void m1829setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition$delegate.setValue(offset);
    }

    /* renamed from: getCurrentDragPosition-_m7T9-E  reason: not valid java name */
    public final Offset m1832getCurrentDragPosition_m7T9E() {
        return (Offset) this.currentDragPosition$delegate.getValue();
    }

    /* renamed from: getLatestSelection-MzsxiRA$foundation_release  reason: not valid java name */
    public final TextRange m1835getLatestSelectionMzsxiRA$foundation_release() {
        return this.latestSelection;
    }

    /* renamed from: setLatestSelection-OEnZFl4$foundation_release  reason: not valid java name */
    public final void m1838setLatestSelectionOEnZFl4$foundation_release(TextRange textRange) {
    ...
    public final void m1828maybeSuggestSelectionOEnZFl4(TextRange textRange) {
        ...
        long TextRange = TextRangeKt.TextRange(offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(textRange.m7462unboximpl())), offsetMapping.originalToTransformed(TextRange.m7453getEndimpl(textRange.m7462unboximpl())));
        if (text.length() <= 0 || TextRange.m7452getCollapsedimpl(TextRange) || (coroutineScope = this.coroutineScope) == null) {
            return;
        }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean z) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo1348onDownk4lQ0M(long j) {
                ...
                long m1768getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1768getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m1834getHandlePositiontuRUvjQ$foundation_release(z));
                LegacyTextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release == null || (layoutResult = state$foundation_release.getLayoutResult()) == null) {
                    return;
                }
                long m1391translateInnerToDecorationCoordinatesMKHz9U$foundation_release = layoutResult.m1391translateInnerToDecorationCoordinatesMKHz9U$foundation_release(m1768getAdjustedCoordinatesk4lQ0M);
                TextFieldSelectionManager.this.dragBeginPosition = m1391translateInnerToDecorationCoordinatesMKHz9U$foundation_release;
                TextFieldSelectionManager.this.m1829setCurrentDragPosition_kEHs6E(Offset.m5025boximpl(m1391translateInnerToDecorationCoordinatesMKHz9U$foundation_release));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.Companion.m5052getZeroF1C5BW0();
                TextFieldSelectionManager.this.previousRawDragOffset = -1;
                LegacyTextFieldState state$foundation_release2 = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release2 != null) {
            ...
            public void mo1349onDragk4lQ0M(long j) {
                ...
                textFieldSelectionManager.dragTotalDistance = Offset.m5041plusMKHz9U(j2, j);
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j3 = textFieldSelectionManager2.dragBeginPosition;
                j4 = TextFieldSelectionManager.this.dragTotalDistance;
                textFieldSelectionManager2.m1829setCurrentDragPosition_kEHs6E(Offset.m5025boximpl(Offset.m5041plusMKHz9U(j3, j4)));
                TextFieldSelectionManager textFieldSelectionManager3 = TextFieldSelectionManager.this;
                TextFieldValue value$foundation_release = textFieldSelectionManager3.getValue$foundation_release();
                Offset m1832getCurrentDragPosition_m7T9E = TextFieldSelectionManager.this.m1832getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E);
                textFieldSelectionManager3.m1830updateSelection8UEBfa8(value$foundation_release, m1832getCurrentDragPosition_m7T9E.m5046unboximpl(), false, z, SelectionAdjustment.Companion.getCharacterWithWordAccelerate(), true);
                TextFieldSelectionManager.this.updateFloatingToolbar(false);
            }
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo1350onStartk4lQ0M(long j) {
                TextLayoutResultProxy layoutResult;
                long m1768getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m1768getAdjustedCoordinatesk4lQ0M(TextFieldSelectionManager.this.m1834getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState state$foundation_release = TextFieldSelectionManager.this.getState$foundation_release();
                if (state$foundation_release == null || (layoutResult = state$foundation_release.getLayoutResult()) == null) {
                    return;
                }
            ...
            public void mo1349onDragk4lQ0M(long j) {
                ...
                Offset m1832getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m1832getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(m1832getCurrentDragPosition_m7T9E);
                int transformedToOriginal = offsetMapping$foundation_release.transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(layoutResult, m1832getCurrentDragPosition_m7T9E.m5046unboximpl(), false, 2, null));
                long TextRange = TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal);
                if (TextRange.m7451equalsimpl0(TextRange, textFieldSelectionManager2.getValue$foundation_release().m7709getSelectiond9O1mEE())) {
                    return;
                }
                ...
                m1826createTextFieldValueFDrldGo = textFieldSelectionManager2.m1826createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), TextRange);
                onValueChange$foundation_release.invoke(m1826createTextFieldValueFDrldGo);
                textFieldSelectionManager2.m1838setLatestSelectionOEnZFl4$foundation_release(TextRange.m7446boximpl(TextRange));
            }
    ...
    public static /* synthetic */ void m1827deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m1831deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release  reason: not valid java name */
    public final void m1831deselect_kEHs6E$foundation_release(Offset offset) {
        int m7455getMaximpl;
        if (!TextRange.m7452getCollapsedimpl(getValue$foundation_release().m7709getSelectiond9O1mEE())) {
            LegacyTextFieldState legacyTextFieldState = this.state;
            ...
            if (offset != null && layoutResult != null) {
                m7455getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m1387getOffsetForPosition3MmeM6k$default(layoutResult, offset.m5046unboximpl(), false, 2, null));
            } else {
                m7455getMaximpl = TextRange.m7455getMaximpl(getValue$foundation_release().m7709getSelectiond9O1mEE());
            }
            TextFieldValue m7704copy3r_uNRQ$default = TextFieldValue.m7704copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(m7455getMaximpl), (TextRange) null, 5, (Object) null);
            this.onValueChange.invoke(m7704copy3r_uNRQ$default);
            this.latestSelection = TextRange.m7446boximpl(m7704copy3r_uNRQ$default.m7709getSelectiond9O1mEE());
        }
    ...
    public final void m1839setSelectionPreviewHighlight5zctL8$foundation_release(long j) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1294setSelectionPreviewHighlightRange5zctL8(j);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1291setDeletionPreviewHighlightRange5zctL8(TextRange.Companion.m7463getZerod9O1mEE());
        }
        if (TextRange.m7452getCollapsedimpl(j)) {
            return;
        }
    ...
    public final void m1837setDeletionPreviewHighlight5zctL8$foundation_release(long j) {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1291setDeletionPreviewHighlightRange5zctL8(j);
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1294setSelectionPreviewHighlightRange5zctL8(TextRange.Companion.m7463getZerod9O1mEE());
        }
        if (TextRange.m7452getCollapsedimpl(j)) {
            return;
        }
    ...
    public final void clearPreviewHighlight$foundation_release() {
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState != null) {
            legacyTextFieldState.m1291setDeletionPreviewHighlightRange5zctL8(TextRange.Companion.m7463getZerod9O1mEE());
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
            legacyTextFieldState2.m1294setSelectionPreviewHighlightRange5zctL8(TextRange.Companion.m7463getZerod9O1mEE());
    ...
    private final boolean getHasSelection() {
        return !TextRange.m7452getCollapsedimpl(getValue$foundation_release().m7709getSelectiond9O1mEE());
    }
    ...
    */
            ...
            if ((textFieldSelectionManager$notifyPlatformSelectionBehaviorsOnShowContextMenu$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (transformedText$foundation_release != null && (text = transformedText$foundation_release.getText()) != null && (textRange = this.latestSelection) != null) {
                        long m7462unboximpl = textRange.m7462unboximpl();
                        PlatformSelectionBehaviors platformSelectionBehaviors = this.platformSelectionBehaviors;
                        if (platformSelectionBehaviors != null) {
                            long TextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(m7462unboximpl)), this.offsetMapping.originalToTransformed(TextRange.m7453getEndimpl(m7462unboximpl)));
                            textFieldSelectionManager$notifyPlatformSelectionBehaviorsOnShowContextMenu$1.label = 1;
                            if (platformSelectionBehaviors.mo1746onShowContextMenuSbBc2M(text, TextRange, textFieldSelectionManager$notifyPlatformSelectionBehaviorsOnShowContextMenu$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        }
                    }
    ...
    public final boolean canSelectAll$foundation_release() {
        return TextRange.m7454getLengthimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()) != getValue$foundation_release().getText().length();
    }

    public final boolean canAutofill$foundation_release() {
        return getEditable() && TextRange.m7452getCollapsedimpl(getValue$foundation_release().m7709getSelectiond9O1mEE());
    }
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue m1826createTextFieldValueFDrldGo = m1826createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(m1826createTextFieldValueFDrldGo);
        this.latestSelection = TextRange.m7446boximpl(m1826createTextFieldValueFDrldGo.m7709getSelectiond9O1mEE());
        this.oldValue = TextFieldValue.m7704copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, m1826createTextFieldValueFDrldGo.m7709getSelectiond9O1mEE(), (TextRange) null, 5, (Object) null);
    ...
    public final long m1834getHandlePositiontuRUvjQ$foundation_release(boolean z) {
        TextLayoutResultProxy layoutResult;
        ...
        if (Intrinsics.areEqual(transformedText$foundation_release.getText(), value.getLayoutInput().getText().getText())) {
            long m7709getSelectiond9O1mEE = getValue$foundation_release().m7709getSelectiond9O1mEE();
            return TextSelectionDelegateKt.getSelectionHandleCoordinates(value, this.offsetMapping.originalToTransformed(z ? TextRange.m7458getStartimpl(m7709getSelectiond9O1mEE) : TextRange.m7453getEndimpl(m7709getSelectiond9O1mEE)), z, TextRange.m7457getReversedimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()));
        }
        return Offset.Companion.m5051getUnspecifiedF1C5BW0();
    }
    ...
    public final float getHandleLineHeight$foundation_release(boolean z) {
        TextLayoutResultProxy layoutResult;
        TextLayoutResult value;
        int m7458getStartimpl = z ? TextRange.m7458getStartimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()) : TextRange.m7453getEndimpl(getValue$foundation_release().m7709getSelectiond9O1mEE());
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState == null || (layoutResult = legacyTextFieldState.getLayoutResult()) == null || (value = layoutResult.getValue()) == null) {
            return 0.0f;
        }
        return TextLayoutHelperKt.getLineHeight(value, m7458getStartimpl);
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release  reason: not valid java name */
    public final long m1833getCursorPositiontuRUvjQ$foundation_release(Density density) {
        int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()));
        LegacyTextFieldState legacyTextFieldState = this.state;
        TextLayoutResultProxy layoutResult = legacyTextFieldState != null ? legacyTextFieldState.getLayoutResult() : null;
        ...
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(cursorRect.getLeft() + (density.mo430toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness()) / 2)) << 32) | (Float.floatToRawIntBits(cursorRect.getBottom()) & 4294967295L));
    }
    ...
    public final void m1836selectWordAtPositionIfNotAlreadySelectedk4lQ0M(long j) {
        TextLayoutResultProxy layoutResult;
        LegacyTextFieldState legacyTextFieldState = this.state;
        if (legacyTextFieldState == null || (layoutResult = legacyTextFieldState.getLayoutResult()) == null || TextLayoutHelperKt.m1385isPositionInsideSelectionuaM50fQ(layoutResult.getValue(), layoutResult.m1390translateDecorationToInnerCoordinatesMKHz9U$foundation_release(j), TextRange.m7446boximpl(getValue$foundation_release().m7709getSelectiond9O1mEE()))) {
            return;
        }
        m1830updateSelection8UEBfa8(getValue$foundation_release(), j, true, false, SelectionAdjustment.Companion.getWord(), false);
    }
    ...
    public final Rect getContentRect() {
        ...
        if (legacyTextFieldState != null) {
            ...
            if (legacyTextFieldState != null) {
                int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()));
                int originalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m7453getEndimpl(getValue$foundation_release().m7709getSelectiond9O1mEE()));
                LegacyTextFieldState legacyTextFieldState2 = this.state;
                long m5052getZeroF1C5BW0 = (legacyTextFieldState2 == null || (layoutCoordinates4 = legacyTextFieldState2.getLayoutCoordinates()) == null) ? Offset.Companion.m5052getZeroF1C5BW0() : layoutCoordinates4.mo6709localToRootMKHz9U(m1834getHandlePositiontuRUvjQ$foundation_release(true));
                LegacyTextFieldState legacyTextFieldState3 = this.state;
                long m5052getZeroF1C5BW02 = (legacyTextFieldState3 == null || (layoutCoordinates3 = legacyTextFieldState3.getLayoutCoordinates()) == null) ? Offset.Companion.m5052getZeroF1C5BW0() : layoutCoordinates3.mo6709localToRootMKHz9U(m1834getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (legacyTextFieldState5 != null && (layoutCoordinates = legacyTextFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    f2 = Float.intBitsToFloat((int) (layoutCoordinates.mo6709localToRootMKHz9U(Offset.m5028constructorimpl((Float.floatToRawIntBits(0.0f) << c) | (Float.floatToRawIntBits((layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(originalToTransformed2)) == null) ? 0.0f : cursorRect.getTop()) & j))) & j));
                }
                int i = (int) (m5052getZeroF1C5BW0 >> c);
                int i2 = (int) (m5052getZeroF1C5BW02 >> c);
                return new Rect(Math.min(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), Math.min(f, f2), Math.max(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), Math.max(Float.intBitsToFloat((int) (m5052getZeroF1C5BW0 & j)), Float.intBitsToFloat((int) (m5052getZeroF1C5BW02 & j))) + (Dp.m7996constructorimpl(25) * legacyTextFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final long m1830updateSelection8UEBfa8(TextFieldValue textFieldValue, long j, boolean z, boolean z2, SelectionAdjustment selectionAdjustment, boolean z3) {
        TextLayoutResultProxy layoutResult;
        int i;
        HapticFeedback hapticFeedback;
        LegacyTextFieldState legacyTextFieldState = this.state;
        ...
        long TextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m7458getStartimpl(textFieldValue.m7709getSelectiond9O1mEE())), this.offsetMapping.originalToTransformed(TextRange.m7453getEndimpl(textFieldValue.m7709getSelectiond9O1mEE())));
        boolean z4 = false;
        int m1388getOffsetForPosition3MmeM6k = layoutResult.m1388getOffsetForPosition3MmeM6k(j, false);
        int m7458getStartimpl = (z2 || z) ? m1388getOffsetForPosition3MmeM6k : TextRange.m7458getStartimpl(TextRange);
        int m7453getEndimpl = (!z2 || z) ? m1388getOffsetForPosition3MmeM6k : TextRange.m7453getEndimpl(TextRange);
        SelectionLayout selectionLayout = this.previousSelectionLayout;
        if (z || selectionLayout == null || (i = this.previousRawDragOffset) == -1) {
            i = -1;
        }
        SelectionLayout m1772getTextFieldSelectionLayoutRcvTLA = SelectionLayoutKt.m1772getTextFieldSelectionLayoutRcvTLA(layoutResult.getValue(), m7458getStartimpl, m7453getEndimpl, i, TextRange, z, z2);
        if (!m1772getTextFieldSelectionLayoutRcvTLA.shouldRecomputeSelection(selectionLayout)) {
            return textFieldValue.m7709getSelectiond9O1mEE();
        }
        this.previousSelectionLayout = m1772getTextFieldSelectionLayoutRcvTLA;
        this.previousRawDragOffset = m1388getOffsetForPosition3MmeM6k;
        Selection adjust = selectionAdjustment.adjust(m1772getTextFieldSelectionLayoutRcvTLA);
        ...
        if (TextRange.m7451equalsimpl0(TextRange2, textFieldValue.m7709getSelectiond9O1mEE())) {
            return textFieldValue.m7709getSelectiond9O1mEE();
        }
        boolean z5 = TextRange.m7457getReversedimpl(TextRange2) != TextRange.m7457getReversedimpl(textFieldValue.m7709getSelectiond9O1mEE()) && TextRange.m7451equalsimpl0(TextRangeKt.TextRange(TextRange.m7453getEndimpl(TextRange2), TextRange.m7458getStartimpl(TextRange2)), textFieldValue.m7709getSelectiond9O1mEE());
        boolean z6 = TextRange.m7452getCollapsedimpl(TextRange2) && TextRange.m7452getCollapsedimpl(textFieldValue.m7709getSelectiond9O1mEE());
        if (z3 && textFieldValue.getText().length() > 0 && !z5 && !z6 && (hapticFeedback = this.hapticFeedBack) != null) {
            hapticFeedback.mo6054performHapticFeedbackCdsT49E(HapticFeedbackType.Companion.m6071getTextHandleMove5zf0vsI());
        }
        this.onValueChange.invoke(m1826createTextFieldValueFDrldGo(textFieldValue.getAnnotatedString(), TextRange2));
        this.latestSelection = TextRange.m7446boximpl(TextRange2);
        if (!z3) {
            updateFloatingToolbar(!TextRange.m7452getCollapsedimpl(TextRange2));
        }
        LegacyTextFieldState legacyTextFieldState2 = this.state;
        if (legacyTextFieldState2 != null) {
        ...
        if (legacyTextFieldState3 != null) {
            legacyTextFieldState3.setShowSelectionHandleStart(!TextRange.m7452getCollapsedimpl(TextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true));
        }
        LegacyTextFieldState legacyTextFieldState4 = this.state;
        if (legacyTextFieldState4 != null) {
            legacyTextFieldState4.setShowSelectionHandleEnd(!TextRange.m7452getCollapsedimpl(TextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, false));
        }
        LegacyTextFieldState legacyTextFieldState5 = this.state;
        if (legacyTextFieldState5 != null) {
            if (TextRange.m7452getCollapsedimpl(TextRange2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(this, true)) {
                z4 = true;
            }
    ...
    public final TextFieldValue m1826createTextFieldValueFDrldGo(AnnotatedString annotatedString, long j) {
