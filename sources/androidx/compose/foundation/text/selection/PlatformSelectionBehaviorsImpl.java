...
public final class PlatformSelectionBehaviorsImpl implements PlatformSelectionBehaviors {
    ...
    public Object mo1736suggestSelectionForLongPressOrDoubleClickpYaCww(CharSequence charSequence, long j, Continuation<? super TextRange> continuation) {
        if (charSequence.length() == 0 || TextRange.m6707getCollapsedimpl(j)) {
            return null;
        }
    ...
    public Object mo1735onShowContextMenuSbBc2M(CharSequence charSequence, long j, Continuation<? super Unit> continuation) {
        if (charSequence.length() == 0 || TextRange.m6707getCollapsedimpl(j)) {
    ...
    */
    public final Object m1738classifyTextM8tDOmk(CharSequence charSequence, long j, TextClassifier textClassifier, Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof PlatformSelectionBehaviorsImpl$classifyText$1) {
                ...
                if ((platformSelectionBehaviorsImpl$classifyText$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (textClassificationResult != null) {
                        m1744canReuseh5sm0ck = PlatformSelectionBehaviors_androidKt.m1744canReuseh5sm0ck(textClassificationResult, charSequence2, j2);
                        if (m1744canReuseh5sm0ck) {
                            return Unit.INSTANCE;
                        }
                    }
                    Unit unit2 = Unit.INSTANCE;
                    mutex.unlock(null);
                    classifyText = textClassifier2.classifyText(new TextClassification.Request.Builder(charSequence2, TextRange.m6711getMinimpl(j2), TextRange.m6710getMaximpl(j2)).setDefaultLocales(getAndroidLocalList()).build());
                    mutex2 = this.mutex;
    ...
    public final void m1739addSmartSelectionTextContextMenuItemsYmzfRxQ$foundation_release(TextContextMenuBuilderScope textContextMenuBuilderScope, CharSequence charSequence, long j, Function1<? super TextContextMenuBuilderScope, Unit> function1) {
        TextClassification m1740tryGetTextClassificationFDrldGo = m1740tryGetTextClassificationFDrldGo(charSequence, j);
        if (m1740tryGetTextClassificationFDrldGo == null) {
            function1.invoke(textContextMenuBuilderScope);
            return;
        }
        if (!m1740tryGetTextClassificationFDrldGo.getActions().isEmpty()) {
            TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, m1740tryGetTextClassificationFDrldGo, 0);
        } else if (TextClassifierHelperMethods.INSTANCE.hasLegacyAssistItem$foundation_release(m1740tryGetTextClassificationFDrldGo)) {
            TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, m1740tryGetTextClassificationFDrldGo, -1);
        }
        function1.invoke(textContextMenuBuilderScope);
        List<RemoteAction> actions = m1740tryGetTextClassificationFDrldGo.getActions();
        int size = actions.size();
        for (int i = 0; i < size; i++) {
            actions.get(i);
            if (i > 0) {
                TextContextMenuBuilderScope_androidKt.textClassificationItem(textContextMenuBuilderScope, this.AssistantItemKey, m1740tryGetTextClassificationFDrldGo, i);
            }
        }
    }

    /* renamed from: tryGetTextClassification-FDrldGo  reason: not valid java name */
    public final TextClassification m1740tryGetTextClassificationFDrldGo(CharSequence charSequence, long j) {
        ...
        if (Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
            ...
            if (textClassificationResult != null) {
                m1744canReuseh5sm0ck = PlatformSelectionBehaviors_androidKt.m1744canReuseh5sm0ck(textClassificationResult, charSequence, j);
                if (m1744canReuseh5sm0ck) {
