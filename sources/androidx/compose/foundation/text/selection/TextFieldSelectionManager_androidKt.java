...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final Unit addBasicTextFieldTextContextMenuComponents$lambda$8(final TextFieldSelectionManager textFieldSelectionManager, final CoroutineScope coroutineScope, TextContextMenuBuilderScope textContextMenuBuilderScope, final Context context) {
        ...
        TextRange m1835getLatestSelectionMzsxiRA$foundation_release = textFieldSelectionManager.m1835getLatestSelectionMzsxiRA$foundation_release();
        if (m1835getLatestSelectionMzsxiRA$foundation_release != null) {
            long m7462unboximpl = m1835getLatestSelectionMzsxiRA$foundation_release.m7462unboximpl();
            OffsetMapping offsetMapping$foundation_release = textFieldSelectionManager.getOffsetMapping$foundation_release();
            textRange = TextRange.m7446boximpl(TextRangeKt.TextRange(offsetMapping$foundation_release.originalToTransformed(TextRange.m7458getStartimpl(m7462unboximpl)), offsetMapping$foundation_release.originalToTransformed(TextRange.m7453getEndimpl(m7462unboximpl))));
        }
    ...
    public static final Unit contextMenuBuilder$lambda$15(State state, final TextFieldSelectionManager textFieldSelectionManager, ContextMenuState contextMenuState, ContextMenuScope contextMenuScope) {
        ...
        contextMenuBuilder$lambda$15$textFieldItem$9(contextMenuScope, contextMenuState, TextContextMenuItems.Cut, MenuItemsAvailability.m1331getCanCutimpl(m1336unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        contextMenuBuilder$lambda$15$textFieldItem$9(contextMenuScope, contextMenuState, TextContextMenuItems.Copy, MenuItemsAvailability.m1330getCanCopyimpl(m1336unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        contextMenuBuilder$lambda$15$textFieldItem$9(contextMenuScope, contextMenuState, TextContextMenuItems.Paste, MenuItemsAvailability.m1332getCanPasteimpl(m1336unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        contextMenuBuilder$lambda$15$textFieldItem$9(contextMenuScope, contextMenuState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1333getCanSelectAllimpl(m1336unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda6
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            contextMenuBuilder$lambda$15$textFieldItem$9(contextMenuScope, contextMenuState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1329getCanAutofillimpl(m1336unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$$ExternalSyntheticLambda7
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
