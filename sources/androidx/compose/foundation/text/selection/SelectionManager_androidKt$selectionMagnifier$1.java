        ...
        if (changedInstance || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$1$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m3826boximpl(m1507invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0  reason: not valid java name */
                public final long m1507invokeF1C5BW0() {
                    long invoke$lambda$1;
                    SelectionManager selectionManager2 = SelectionManager.this;
                    invoke$lambda$1 = SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$1(mutableState);
                    return SelectionManagerKt.m1503calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager2, invoke$lambda$1);
                }
            };
        ...
        if (changed || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = (Function1) new Function1<Function0<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1
                ...
                public final Modifier invoke2(final Function0<Offset> function02) {
                    ...
                    return Magnifier_androidKt.m318magnifierjPUL71Q$default(Modifier.Companion, new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public /* bridge */ /* synthetic */ Offset invoke(Density density3) {
                            return Offset.m3826boximpl(m1508invoketuRUvjQ(density3));
                        }

                        /* renamed from: invoke-tuRUvjQ  reason: not valid java name */
                        public final long m1508invoketuRUvjQ(Density density3) {
                        ...
                        public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                            m1509invokeEaSLcWc(dpSize.m6790unboximpl());
                            return Unit.INSTANCE;
                        }

                        /* renamed from: invoke-EaSLcWc  reason: not valid java name */
                        public final void m1509invokeEaSLcWc(long j) {
                            ...
                            SelectionManager_androidKt$selectionMagnifier$1.invoke$lambda$2(mutableState3, IntSize.m6850constructorimpl((density3.mo383roundToPx0680j_4(DpSize.m6780getHeightD9Ej5fM(j)) & 4294967295L) | (mo383roundToPx0680j_4 << 32)));
                        }
