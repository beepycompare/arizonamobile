...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m1735getOriginalSelectiond9O1mEE() {
    ...
    public final long m1736getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m1737setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCodePointOrEmojiStartIndex() {
        return StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.annotatedString.getText(), TextRange.m7453getEndimpl(this.selection), -1);
    }

    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m7453getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m7453getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            ...
            if (TextRange.m7453getEndimpl(m7430getWordBoundaryjx7JFs) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m7453getEndimpl(m7430getWordBoundaryjx7JFs));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            ...
            if (TextRange.m7458getStartimpl(m7430getWordBoundaryjx7JFs) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m7458getStartimpl(m7430getWordBoundaryjx7JFs));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m7428getOffsetForPositionk4lQ0M(Offset.m5028constructorimpl((Float.floatToRawIntBits(f.floatValue()) << 32) | (Float.floatToRawIntBits(lineBottom) & 4294967295L))));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7453getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7456getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m7455getMaximpl(this.selection));
    }
    ...
    public final T deselect() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            setCursor(TextRange.m7453getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> function1) {
        ...
        if (getText$foundation_release().length() > 0) {
            if (TextRange.m7452getCollapsedimpl(this.selection)) {
                ...
                setCursor(TextRange.m7456getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m7455getMaximpl(this.selection));
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    ...
    public final T moveCursorPrevByParagraph() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            int findParagraphStart = StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m7456getMinimpl(this.selection));
    ...
    public final T moveCursorNextByParagraph() {
        getState().resetCachedX();
        if (getText$foundation_release().length() > 0) {
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m7455getMaximpl(this.selection));
            if (findParagraphEnd == TextRange.m7455getMaximpl(this.selection) && findParagraphEnd != getText$foundation_release().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m7458getStartimpl(this.originalSelection), TextRange.m7453getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
