...
public final class SelectionAdjustmentKt {
    public static final /* synthetic */ Selection access$adjustToBoundaries(SelectionLayout selectionLayout, BoundaryFunction boundaryFunction) {
        return adjustToBoundaries(selectionLayout, boundaryFunction);
    }
    ...
    public static final Selection.AnchorInfo updateSelectionBoundary(final SelectionLayout selectionLayout, final SelectableInfo selectableInfo, Selection.AnchorInfo anchorInfo) {
        ...
        long m7580getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m7580getWordBoundaryjx7JFs(offset);
        if (!isExpanding(selectableInfo, rawStartHandleOffset, selectionLayout.isStartHandle())) {
            return selectableInfo.anchorForOffset(rawStartHandleOffset);
        }
        if (offset == TextRange.m7608getStartimpl(m7580getWordBoundaryjx7JFs) || offset == TextRange.m7603getEndimpl(m7580getWordBoundaryjx7JFs)) {
            return updateSelectionBoundary$lambda$3(lazy2);
        }
        return selectableInfo.anchorForOffset(rawStartHandleOffset);
    }
    ...
    public static final int updateSelectionBoundary$lambda$1(Lazy<Integer> lazy) {
    ...
    public static final Selection.AnchorInfo snapToWordBoundary(SelectableInfo selectableInfo, int i, int i2, int i3, boolean z, boolean z2) {
        int lineStart;
        int lineEnd$default;
        long m7580getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m7580getWordBoundaryjx7JFs(i2);
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m7608getStartimpl(m7580getWordBoundaryjx7JFs)) == i) {
            lineStart = TextRange.m7608getStartimpl(m7580getWordBoundaryjx7JFs);
        ...
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m7603getEndimpl(m7580getWordBoundaryjx7JFs)) == i) {
            lineEnd$default = TextRange.m7603getEndimpl(m7580getWordBoundaryjx7JFs);
        } else if (i >= selectableInfo.getTextLayoutResult().getLineCount()) {
    ...
    private static final Selection.AnchorInfo anchorOnBoundary(SelectableInfo selectableInfo, boolean z, boolean z2, int i, BoundaryFunction boundaryFunction) {
        ...
        long mo2028getBoundaryfzxv0v0 = boundaryFunction.mo2028getBoundaryfzxv0v0(selectableInfo, rawStartHandleOffset);
        return selectableInfo.anchorForOffset(z ^ z2 ? TextRange.m7608getStartimpl(mo2028getBoundaryfzxv0v0) : TextRange.m7603getEndimpl(mo2028getBoundaryfzxv0v0));
    }
