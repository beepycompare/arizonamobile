...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(final boolean z, final ResolvedTextDirection resolvedTextDirection, final TextFieldSelectionManager textFieldSelectionManager, Composer composer, final int i) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 147) != 146, i2 & 1)) {
            ...
            if (changedInstance || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = new OffsetProvider() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$TextFieldSelectionHandle$1$1
                    ...
                    public final long mo1489provideF1C5BW0() {
                        return TextFieldSelectionManager.this.m2107getHandlePositiontuRUvjQ$foundation(z);
                    }
                };
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            boolean m7607getReversedimpl = TextRange.m7607getReversedimpl(textFieldSelectionManager.getValue$foundation().m7858getSelectiond9O1mEE());
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            AndroidSelectionHandles_androidKt.m2024SelectionHandlewLIcFTc(offsetProvider, z, resolvedTextDirection, m7607getReversedimpl, 0L, handleLineHeight$foundation, SuspendingPointerInputFilterKt.pointerInput(companion, textDragObserver, (PointerInputEventHandler) rememberedValue3), startRestartGroup, (i2 << 3) & 1008, 16);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final boolean isSelectionHandleInVisibleBoundDefault(TextFieldSelectionManager textFieldSelectionManager, boolean z) {
        ...
        return SelectionManagerKt.m2080containsInclusiveUv8p0NA(visibleBounds, textFieldSelectionManager.m2107getHandlePositiontuRUvjQ$foundation(z));
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c  reason: not valid java name */
    public static final long m2116calculateSelectionMagnifierCenterAndroidO0kMr_c(TextFieldSelectionManager textFieldSelectionManager, long j) {
        int m7608getStartimpl;
        TextLayoutResultProxy layoutResult;
        TextDelegate textDelegate;
        AnnotatedString text;
        Offset m2105getCurrentDragPosition_m7T9E = textFieldSelectionManager.m2105getCurrentDragPosition_m7T9E();
        if (m2105getCurrentDragPosition_m7T9E == null) {
            return Offset.Companion.m5118getUnspecifiedF1C5BW0();
        }
        long m5113unboximpl = m2105getCurrentDragPosition_m7T9E.m5113unboximpl();
        ...
        if (i == 1 || i == 2) {
            m7608getStartimpl = TextRange.m7608getStartimpl(textFieldSelectionManager.getValue$foundation().m7858getSelectiond9O1mEE());
        } else if (i != 3) {
            throw new NoWhenBranchMatchedException();
        } else {
            m7608getStartimpl = TextRange.m7603getEndimpl(textFieldSelectionManager.getValue$foundation().m7858getSelectiond9O1mEE());
        }
        LegacyTextFieldState state$foundation = textFieldSelectionManager.getState$foundation();
        ...
        int coerceIn = RangesKt.coerceIn(textFieldSelectionManager.getOffsetMapping$foundation().originalToTransformed(m7608getStartimpl), 0, text.length());
        float intBitsToFloat = Float.intBitsToFloat((int) (layoutResult.m1681translateDecorationToInnerCoordinatesMKHz9U$foundation(m5113unboximpl) >> 32));
        ...
        if (!IntSize.m8329equalsimpl0(j, IntSize.Companion.m8336getZeroYbymL2g()) && Math.abs(intBitsToFloat - coerceIn2) > ((int) (j >> 32)) / 2) {
            return Offset.Companion.m5118getUnspecifiedF1C5BW0();
        }
        float lineTop = value.getLineTop(lineForOffset);
        return Offset.m5095constructorimpl((Float.floatToRawIntBits(coerceIn2) << 32) | (Float.floatToRawIntBits(((value.getLineBottom(lineForOffset) - lineTop) / 2.0f) + lineTop) & 4294967295L));
    }
    ...
    public static final Unit contextMenuBuilder$lambda$0(State state, final TextFieldSelectionManager textFieldSelectionManager, ContextMenuState contextMenuState, ContextMenuScope contextMenuScope) {
        int m1627unboximpl = ((MenuItemsAvailability) state.getValue()).m1627unboximpl();
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Cut, MenuItemsAvailability.m1622getCanCutimpl(m1627unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda2
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Copy, MenuItemsAvailability.m1621getCanCopyimpl(m1627unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Paste, MenuItemsAvailability.m1623getCanPasteimpl(m1627unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.SelectAll, MenuItemsAvailability.m1624getCanSelectAllimpl(m1627unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        if (PlatformUtils_androidKt.isAutofillAvailable()) {
            contextMenuBuilder$lambda$0$textFieldItem(contextMenuScope, contextMenuState, TextContextMenuItems.Autofill, MenuItemsAvailability.m1620getCanAutofillimpl(m1627unboximpl), new Function0() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManagerKt$$ExternalSyntheticLambda6
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
