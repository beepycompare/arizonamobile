...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m305basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m389getImmediatelyZbEOnfQ();
        }
        if ((i5 & 4) != 0) {
            i3 = MarqueeDefaults.INSTANCE.getRepeatDelayMillis();
        }
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m385equalsimpl0(i2, MarqueeAnimationMode.Companion.m389getImmediatelyZbEOnfQ()) ? i3 : 0;
        }
        if ((i5 & 16) != 0) {
            marqueeSpacing = MarqueeDefaults.INSTANCE.getSpacing();
        }
        if ((i5 & 32) != 0) {
            f = MarqueeDefaults.INSTANCE.m391getVelocityD9Ej5fM();
        }
        return m304basicMarquee1Mj1MLw(modifier, i, i2, i3, i4, marqueeSpacing, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m304basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public static final AnimationSpec<Float> m306createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo464toPx0680j_4(f2)), f, i3);
        long m222constructorimpl$default = StartOffset.m222constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m185infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m222constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m187repeatable91I0pcU$default(i, velocityBasedTween, null, m222constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m302MarqueeSpacing0680j_4(final float f) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$0(float f, Density density, int i, int i2) {
        return density.mo458roundToPx0680j_4(f);
    }
}
