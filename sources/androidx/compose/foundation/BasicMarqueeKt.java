...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m263basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m346getImmediatelyZbEOnfQ();
        }
        if ((i5 & 4) != 0) {
            i3 = MarqueeDefaults.INSTANCE.getRepeatDelayMillis();
        }
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m342equalsimpl0(i2, MarqueeAnimationMode.Companion.m346getImmediatelyZbEOnfQ()) ? i3 : 0;
        }
        if ((i5 & 16) != 0) {
            marqueeSpacing = MarqueeDefaults.INSTANCE.getSpacing();
        }
        if ((i5 & 32) != 0) {
            f = MarqueeDefaults.INSTANCE.m348getVelocityD9Ej5fM();
        }
        return m262basicMarquee1Mj1MLw(modifier, i, i2, i3, i4, marqueeSpacing, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m262basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public static final AnimationSpec<Float> m264createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo419toPx0680j_4(f2)), f, i3);
        long m186constructorimpl$default = StartOffset.m186constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m151infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m186constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m153repeatable91I0pcU$default(i, velocityBasedTween, null, m186constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m260MarqueeSpacing0680j_4(final float f) {
    ...
    public static final int MarqueeSpacing_0680j_4$lambda$1(float f, Density density, int i, int i2) {
        return density.mo413roundToPx0680j_4(f);
    }
}
