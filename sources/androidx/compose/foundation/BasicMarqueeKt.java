...
public final class BasicMarqueeKt {
    ...
    public static /* synthetic */ Modifier m294basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = MarqueeDefaults.INSTANCE.getIterations();
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.Companion.m365getImmediatelyZbEOnfQ();
        }
        if ((i5 & 4) != 0) {
            i3 = MarqueeDefaults.INSTANCE.getRepeatDelayMillis();
        }
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m361equalsimpl0(i2, MarqueeAnimationMode.Companion.m365getImmediatelyZbEOnfQ()) ? i3 : 0;
        }
        if ((i5 & 16) != 0) {
            marqueeSpacing = MarqueeDefaults.INSTANCE.getSpacing();
        }
        if ((i5 & 32) != 0) {
            f = MarqueeDefaults.INSTANCE.m367getVelocityD9Ej5fM();
        }
        return m293basicMarquee1Mj1MLw(modifier, i, i2, i3, i4, marqueeSpacing, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw  reason: not valid java name */
    public static final Modifier m293basicMarquee1Mj1MLw(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public static final AnimationSpec<Float> m295createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo434toPx0680j_4(f2)), f, i3);
        long m228constructorimpl$default = StartOffset.m228constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m196infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m228constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m198repeatable91I0pcU$default(i, velocityBasedTween, null, m228constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m291MarqueeSpacing0680j_4(final float f) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$$ExternalSyntheticLambda0
            ...
            public final int calculateSpacing(Density density, int i, int i2) {
                ...
                mo428roundToPx0680j_4 = density.mo428roundToPx0680j_4(f);
                return mo428roundToPx0680j_4;
            }
        };
    }
}
