...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode toggleableNode) {
        toggleableNode.m1361updateO2vRcR0(this.value, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onValueChange);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m7375hashCodeimpl(role.m7377unboximpl()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
