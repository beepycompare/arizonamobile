...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode toggleableNode) {
        toggleableNode.m1013updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m5908hashCodeimpl(role.m5910unboximpl()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
