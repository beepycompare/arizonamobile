...
final class SelectableNode extends ClickableNode {
    ...
    public final void m1094updateO2vRcR0(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z2, boolean z3, Role role, Function0<Unit> function0) {
        if (this.selected != z) {
            this.selected = z;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m314updateO2vRcR0(mutableInteractionSource, indicationNodeFactory, z2, z3, (String) null, role, function0);
    }
