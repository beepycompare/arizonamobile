...
public final class SelectableKt {
    ...
    public static /* synthetic */ Modifier m1162selectableXHw0xAI$default(Modifier modifier, boolean z, boolean z2, Role role, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        if ((i & 4) != 0) {
        ...
        return m1161selectableXHw0xAI(modifier, z, z2, role, function0);
    }

    /* renamed from: selectable-oSLSa3U$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1164selectableoSLSa3U$default(Modifier modifier, boolean z, boolean z2, Role role, MutableInteractionSource mutableInteractionSource, Function0 function0, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = true;
        }
        return m1163selectableoSLSa3U(modifier, z, z2, (i & 4) != 0 ? null : role, (i & 8) != 0 ? null : mutableInteractionSource, function0);
    }

    /* renamed from: selectable-oSLSa3U  reason: not valid java name */
    public static final Modifier m1163selectableoSLSa3U(Modifier modifier, final boolean z, final boolean z2, final Role role, final MutableInteractionSource mutableInteractionSource, final Function0<Unit> function0) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable-oSLSa3U$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                Modifier m1159selectableO2vRcR0 = SelectableKt.m1159selectableO2vRcR0(Modifier.Companion, z, mutableInteractionSource2, indication, z2, role, function0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceGroup();
                return m1159selectableO2vRcR0;
            }
        });
    }

    /* renamed from: selectable-O2vRcR0$default  reason: not valid java name */
    public static /* synthetic */ Modifier m1160selectableO2vRcR0$default(Modifier modifier, boolean z, MutableInteractionSource mutableInteractionSource, Indication indication, boolean z2, Role role, Function0 function0, int i, Object obj) {
        if ((i & 8) != 0) {
            z2 = true;
        }
        boolean z3 = z2;
        ...
        return m1159selectableO2vRcR0(modifier, z, mutableInteractionSource, indication, z3, role, function0);
    }
    ...
    public static final /* synthetic */ Modifier m1161selectableXHw0xAI(Modifier modifier, final boolean z, final boolean z2, final Role role, final Function0 function0) {
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.selection.SelectableKt$selectable-XHw0xAI$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                Modifier m1159selectableO2vRcR0 = SelectableKt.m1159selectableO2vRcR0(Modifier.Companion, z, mutableInteractionSource, indication, z2, role, function0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceGroup();
    ...
    public static final Modifier m1159selectableO2vRcR0(Modifier modifier, final boolean z, MutableInteractionSource mutableInteractionSource, final Indication indication, final boolean z2, final Role role, final Function0<Unit> function0) {
