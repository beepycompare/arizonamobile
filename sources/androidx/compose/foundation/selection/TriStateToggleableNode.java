...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m1179updateO2vRcR0(ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, boolean z2, Role role, Function0<Unit> function0) {
        if (this.state != toggleableState) {
            this.state = toggleableState;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m313updateO2vRcR0(mutableInteractionSource, indicationNodeFactory, z, z2, (String) null, role, function0);
    }
