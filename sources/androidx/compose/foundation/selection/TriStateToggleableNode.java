...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m1014updateQzZPfjk(ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, Role role, Function0<Unit> function0) {
        if (this.state != toggleableState) {
            this.state = toggleableState;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m293updateQzZPfjk(mutableInteractionSource, indicationNodeFactory, z, (String) null, role, function0);
    }
