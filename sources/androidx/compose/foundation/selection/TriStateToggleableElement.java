...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public void update(TriStateToggleableNode triStateToggleableNode) {
        triStateToggleableNode.m1179updateO2vRcR0(this.state, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m6458hashCodeimpl(role.m6460unboximpl()) : 0)) * 31) + this.onClick.hashCode();
    }
}
