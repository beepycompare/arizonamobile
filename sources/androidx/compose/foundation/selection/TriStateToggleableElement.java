...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public void update(TriStateToggleableNode triStateToggleableNode) {
        triStateToggleableNode.m1014updateQzZPfjk(this.state, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode3 + (role != null ? Role.m5908hashCodeimpl(role.m5910unboximpl()) : 0)) * 31) + this.onClick.hashCode();
    }
}
