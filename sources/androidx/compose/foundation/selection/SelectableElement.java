...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public void update(SelectableNode selectableNode) {
        selectableNode.m1348updateO2vRcR0(this.selected, this.interactionSource, this.indicationNodeFactory, this.useLocalIndication, this.enabled, this.role, this.onClick);
    }
