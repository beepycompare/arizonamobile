...
public final class AnchoredDraggableNode<T> extends DragGestureNode {
    ...
    */
    ...
    public final long m450toOffsettuRUvjQ(float f) {
    ...
    public final long m451toVelocityadjELrA(float f) {
        float f2 = this.orientation == Orientation.Horizontal ? f : 0.0f;
        if (this.orientation != Orientation.Vertical) {
            f = 0.0f;
        }
    ...
    public final float m448toFloatTH1AsA0(long j) {
        return this.orientation == Orientation.Vertical ? Velocity.m8399getYimpl(j) : Velocity.m8398getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-k-4lQ0M  reason: not valid java name */
    public final float m449toFloatk4lQ0M(long j) {
        return Float.intBitsToFloat((int) (this.orientation == Orientation.Vertical ? j & 4294967295L : j >> 32));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-AH228Gc  reason: not valid java name */
    public final long m446reverseIfNeededAH228Gc(long j) {
        return Velocity.m8404timesadjELrA(j, isReverseDirection() ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U  reason: not valid java name */
    public final long m447reverseIfNeededMKHz9U(long j) {
        return Offset.m5110timestuRUvjQ(j, isReverseDirection() ? -1.0f : 1.0f);
    }
}
