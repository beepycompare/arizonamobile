...
public final class TransformableNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode {
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public static final class C00081 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                */
                ...
                @DebugMetadata(c = "androidx.compose.foundation.gestures.TransformableNode$pointerInputNode$1$1$1$1", f = "Transformable.kt", i = {0}, l = {DownloaderService.STATUS_PENDING}, m = "invokeSuspend", n = {"$this$transform"}, s = {"L$0"}, v = 1)
                        ...
                        if (i == 0) {
                            ...
                            if (!(this.$event.element instanceof TransformEvent.TransformStopped)) {
                                ...
                                if (transformDelta != null) {
                                    transformScope.mo478transformByWithCentroidIEwrmTk(transformDelta.m644getCentroidF1C5BW0(), transformDelta.getZoomChange(), transformDelta.m645getPanChangeF1C5BW0(), transformDelta.getRotationChange());
                                }
            ...
            public static final class AnonymousClass2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    try {
                        ...
                        channel = this.this$0.channel;
                        channel.mo9005trySendJP2dKIU(TransformEvent.TransformStopped.INSTANCE);
                    }
                }
            }
        }
    ...
    public void mo257onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        ...
        if (pointerInputModifierNode != null) {
            pointerInputModifierNode.mo257onPointerEventH0pRuoY(pointerEvent, pointerEventPass, j);
        }
    }
