...
public final class TransformGestureDetectorKt$detectTransformGestures$2 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x013b, code lost:
        if (androidx.compose.ui.geometry.Offset.m5032equalsimpl0(r7, androidx.compose.ui.geometry.Offset.Companion.m5051getZeroF1C5BW0()) == false) goto L57;
     */
    /* JADX WARN: Multi-variable type inference failed */
            ...
            if (i6 == 2) {
                ...
                if (i3) {
                    ...
                    if (i == 0) {
                        ...
                        j = Offset.m5040plusMKHz9U(j, calculatePan);
                        ...
                        float m5033getDistanceimpl = Offset.m5033getDistanceimpl(j);
                        if (abs > f5 || abs2 > f5 || m5033getDistanceimpl > f5) {
                    ...
                    if (i != 0) {
                        ...
                        this.$onGesture.invoke(Offset.m5024boximpl(calculateCentroid), Offset.m5024boximpl(calculatePan), Boxing.boxFloat(calculateZoom), Boxing.boxFloat(calculateRotation));
