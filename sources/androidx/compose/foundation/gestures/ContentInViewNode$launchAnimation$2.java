...
public final class ContentInViewNode$launchAnimation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
        ...
        public static final Unit invokeSuspend$lambda$1(ContentInViewNode contentInViewNode, UpdatableAnimationState updatableAnimationState, Job job, NestedScrollScope nestedScrollScope, float f) {
            ...
            float m594toFloatk4lQ0M = f2 * scrollingLogic.m594toFloatk4lQ0M(scrollingLogic.m592reverseIfNeededMKHz9U(nestedScrollScope.mo534scrollByOzD1aCk(scrollingLogic.m592reverseIfNeededMKHz9U(scrollingLogic.m595toOffsettuRUvjQ(f2 * f)), NestedScrollSource.Companion.m6463getUserInputWNlRxjI())));
            if (Math.abs(m594toFloatk4lQ0M) < Math.abs(f)) {
                JobKt__JobKt.cancel$default(job, "Scroll animation cancelled because scroll was not consumed (" + m594toFloatk4lQ0M + " < " + f + ')', null, 2, null);
            }
            return Unit.INSTANCE;
        }
        ...
        public static final Unit invokeSuspend$lambda$4(ContentInViewNode contentInViewNode, UpdatableAnimationState updatableAnimationState, BringIntoViewSpec bringIntoViewSpec) {
            ...
            boolean m467isMaxVisibleO0kMr_c$default;
            ...
            while (true) {
                ...
                if (invoke == null) {
                    contentInViewNode2 = contentInViewNode;
                    m467isMaxVisibleO0kMr_c$default = true;
                } else {
                    contentInViewNode2 = contentInViewNode;
                    m467isMaxVisibleO0kMr_c$default = ContentInViewNode.m467isMaxVisibleO0kMr_c$default(contentInViewNode2, invoke, 0L, 1, null);
                }
                if (!m467isMaxVisibleO0kMr_c$default) {
                    break;
                }
                Unit unit = Unit.INSTANCE;
                Result.Companion companion = Result.Companion;
                ((ContentInViewNode.Request) bringIntoViewRequestPriorityQueue.requests.removeAt(bringIntoViewRequestPriorityQueue.requests.getSize() - 1)).getContinuation().resumeWith(Result.m9901constructorimpl(unit));
                contentInViewNode = contentInViewNode2;
            }
            z2 = contentInViewNode2.trackingFocusedChild;
            if (z2) {
                focusedChildBounds = contentInViewNode2.getFocusedChildBounds();
                if (focusedChildBounds == null || !ContentInViewNode.m467isMaxVisibleO0kMr_c$default(contentInViewNode2, focusedChildBounds, 0L, 1, null)) {
                    z = false;
                }
                if (z) {
