...
public abstract class DragGestureNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    private long nodeOffset = Offset.Companion.m4309getZeroF1C5BW0();
    ...
    public abstract void mo438onDragStartedk4lQ0M(long j);

    /* renamed from: onDragStopped-TH1AsA0 */
    public abstract void mo439onDragStoppedTH1AsA0(long j);
    ...
    public void onDetach() {
        ...
        this.nodeOffset = Offset.Companion.m4309getZeroF1C5BW0();
    }
            ...
            if ((dragGestureNode$processDragStart$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i == 2) {
                        ...
                        mo438onDragStartedk4lQ0M(dragStarted.m466getStartPointF1C5BW0());
        ...
        if (continuation instanceof DragGestureNode$processDragStop$1) {
            ...
            if ((dragGestureNode$processDragStop$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    mo439onDragStoppedTH1AsA0(dragStopped.m467getVelocity9UxMQ8M());
                    return Unit.INSTANCE;
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                } else {
        ...
        if (continuation instanceof DragGestureNode$processDragCancel$1) {
            ...
            if ((dragGestureNode$processDragCancel$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    mo439onDragStoppedTH1AsA0(Velocity.Companion.m7500getZero9UxMQ8M());
                    return Unit.INSTANCE;
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                } else {
