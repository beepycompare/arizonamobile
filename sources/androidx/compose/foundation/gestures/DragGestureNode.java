...
public abstract class DragGestureNode extends DelegatingNode implements PointerInputModifierNode, IndirectPointerInputModifierNode, CompositionLocalConsumerModifierNode, GestureConnection {
    ...
    public abstract void mo452onDragStartedk4lQ0M(long j);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void initializeGestureCoordination() {
    ...
    public boolean isInterested(PointerInputChange pointerInputChange) {
        ...
        if (ComposeFoundationFlags.isNestedDraggablesTouchConflictFixEnabled && !PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            return !Offset.m5100equalsimpl0(requireTouchSlopDetector.m638getPostSlopOffsetqto3Fdw(positionChange, touchSlop, false), Offset.Companion.m5118getUnspecifiedF1C5BW0()) && requireTouchSlopDetector.m639isDeltaAtAngleOfInterestk4lQ0M(positionChange);
        }
        return false;
    }
            ...
            if ((dragGestureNode$processDragStart$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (i == 2) {
                        ...
                        mo452onDragStartedk4lQ0M(dragStarted.m488getStartPointF1C5BW0());
    ...
    */
        ...
        if (continuation instanceof DragGestureNode$processDragCancel$1) {
            ...
            if ((dragGestureNode$processDragCancel$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    onDragStopped(new DragEvent.DragStopped(Velocity.Companion.m8409getZero9UxMQ8M(), false, null));
                    return Unit.INSTANCE;
                } else if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                } else {
    ...
    static /* synthetic */ void m513moveToAwaitTouchSlopStateaWI9W7U$default(DragGestureNode dragGestureNode, PointerInputChange pointerInputChange, long j, long j2, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        dragGestureNode.m512moveToAwaitTouchSlopStateaWI9W7U(pointerInputChange, j, j3, z);
    }

    /* renamed from: moveToAwaitTouchSlopState-aWI9W7U  reason: not valid java name */
    private final void m512moveToAwaitTouchSlopStateaWI9W7U(PointerInputChange pointerInputChange, long j, long j2, boolean z) {
        ...
        awaitTouchSlopState.m484setPointerId0FcD4WY(j);
        TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
        if (touchSlopDetector == null) {
            this.touchSlopDetector = new TouchSlopDetector(this.orientationLock, 0L, 2, null);
        } else {
    ...
    private final void m514moveToDraggingState0FcD4WY(long j) {
        DragDetectionState.Dragging draggingState = getDraggingState();
        draggingState.m486setPointerId0FcD4WY(j);
    ...
    private final void m511moveToAwaitGesturePickupStaternUCldI(PointerInputChange pointerInputChange, long j, TouchSlopDetector touchSlopDetector) {
        ...
        awaitGesturePickupState.m482setPointerId0FcD4WY(j);
        ...
        if (!pointerEvent.getChanges().isEmpty() && TapGestureDetectorKt.isChangedToDown$default(pointerEvent, false, false, 2, null)) {
            ...
            if (pointerEventPass == PointerEventPass.Main) {
                if (awaitTouchSlop == DragDetectionState.AwaitDown.AwaitTouchSlop.Yes) {
                    m513moveToAwaitTouchSlopStateaWI9W7U$default(this, pointerInputChange, pointerInputChange.m6682getIdJ3iCeTQ(), 0L, false, 12, null);
                } else if (awaitDown.getConsumedOnInitial()) {
                    m516sendDragStart0AR0LA0(pointerInputChange, pointerInputChange, Offset.Companion.m5119getZeroF1C5BW0());
                    m515sendDragEventUv8p0NA(pointerInputChange, Offset.Companion.m5119getZeroF1C5BW0());
                    m514moveToDraggingState0FcD4WY(pointerInputChange.m6682getIdJ3iCeTQ());
                }
            }
        }
    }
    ...
    private final void processAwaitTouchSlop(PointerEvent pointerEvent, PointerEventPass pointerEventPass, DragDetectionState.AwaitTouchSlop awaitTouchSlop) {
        ...
        while (true) {
            ...
            if (PointerId.m6664equalsimpl0(pointerInputChange2.m6682getIdJ3iCeTQ(), awaitTouchSlop.m483getPointerIdJ3iCeTQ())) {
                break;
            }
            i++;
        }
        ...
        if (pointerInputChange4 == null) {
            ...
            awaitTouchSlop.m484setPointerId0FcD4WY(pointerInputChange4.m6682getIdJ3iCeTQ());
        }
        if (pointerEventPass == PointerEventPass.Main) {
            if (!pointerInputChange4.isConsumed()) {
                if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange4)) {
                    ...
                    if (pointerInputChange6 == null) {
                        ...
                        awaitTouchSlop.m484setPointerId0FcD4WY(pointerInputChange6.m6682getIdJ3iCeTQ());
                    }
                } else {
                    long m635getPostSlopOffsetqto3Fdw$default = TouchSlopDetector.m635getPostSlopOffsetqto3Fdw$default(requireTouchSlopDetector(), PointerEventKt.positionChangeIgnoreConsumed(pointerInputChange4), DragGestureDetectorKt.m509pointerSlopE8SPZFQ((ViewConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalViewConfiguration()), pointerInputChange4.m6688getTypeT8wyACA()), false, 4, null);
                    if (ComposeFoundationFlags.isNestedDraggablesTouchConflictFixEnabled) {
                        if ((9223372034707292159L & m635getPostSlopOffsetqto3Fdw$default) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                            ...
                            if (!isInterested && z) {
                                ...
                                m516sendDragStart0AR0LA0(initialDown, pointerInputChange4, m635getPostSlopOffsetqto3Fdw$default);
                                m515sendDragEventUv8p0NA(pointerInputChange4, m635getPostSlopOffsetqto3Fdw$default);
                                m514moveToDraggingState0FcD4WY(pointerInputChange4.m6682getIdJ3iCeTQ());
                            }
                        } else {
                            awaitTouchSlop.setVerifyConsumptionInFinalPass(true);
                        }
                    } else if ((9223372034707292159L & m635getPostSlopOffsetqto3Fdw$default) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        pointerInputChange4.consume();
                        PointerInputChange initialDown2 = awaitTouchSlop.getInitialDown();
                        Intrinsics.checkNotNull(initialDown2);
                        m516sendDragStart0AR0LA0(initialDown2, pointerInputChange4, m635getPostSlopOffsetqto3Fdw$default);
                        m515sendDragEventUv8p0NA(pointerInputChange4, m635getPostSlopOffsetqto3Fdw$default);
                        m514moveToDraggingState0FcD4WY(pointerInputChange4.m6682getIdJ3iCeTQ());
                    } else {
                        awaitTouchSlop.setVerifyConsumptionInFinalPass(true);
                ...
                long m483getPointerIdJ3iCeTQ = awaitTouchSlop.m483getPointerIdJ3iCeTQ();
                TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
                if (touchSlopDetector != null) {
                    m511moveToAwaitGesturePickupStaternUCldI(initialDown3, m483getPointerIdJ3iCeTQ, touchSlopDetector);
                } else {
        ...
        if (pointerEventPass == PointerEventPass.Final && awaitTouchSlop.getVerifyConsumptionInFinalPass()) {
            if (pointerInputChange4.isConsumed()) {
                PointerInputChange initialDown4 = awaitTouchSlop.getInitialDown();
                if (initialDown4 == null) {
                    throw new IllegalArgumentException("AwaitTouchSlop.initialDown was not initialized".toString());
                }
                long m483getPointerIdJ3iCeTQ2 = awaitTouchSlop.m483getPointerIdJ3iCeTQ();
                TouchSlopDetector touchSlopDetector2 = this.touchSlopDetector;
                if (touchSlopDetector2 != null) {
                    m511moveToAwaitGesturePickupStaternUCldI(initialDown4, m483getPointerIdJ3iCeTQ2, touchSlopDetector2);
                    return;
                }
                throw new IllegalArgumentException("AwaitTouchSlop.touchSlopDetector was not initialized".toString());
            }
    ...
    private final void processAwaitGesturePickup(PointerEvent pointerEvent, PointerEventPass pointerEventPass, DragDetectionState.AwaitGesturePickup awaitGesturePickup) {
        ...
        while (true) {
            if (i >= size2) {
                ...
                if (z) {
                    long m6685getPositionF1C5BW0 = ((PointerInputChange) CollectionsKt.first((List<? extends Object>) pointerEvent.getChanges())).m6685getPositionF1C5BW0();
                    PointerInputChange initialDown = awaitGesturePickup.getInitialDown();
                    Intrinsics.checkNotNull(initialDown);
                    long m5107minusMKHz9U = Offset.m5107minusMKHz9U(m6685getPositionF1C5BW0, initialDown.m6685getPositionF1C5BW0());
                    PointerInputChange initialDown2 = awaitGesturePickup.getInitialDown();
                    if (initialDown2 != null) {
                        m513moveToAwaitTouchSlopStateaWI9W7U$default(this, initialDown2, awaitGesturePickup.m481getPointerIdJ3iCeTQ(), m5107minusMKHz9U, false, 8, null);
                        return;
                    }
    ...
    private final void processDraggingState(PointerEvent pointerEvent, PointerEventPass pointerEventPass, DragDetectionState.Dragging dragging) {
        ...
        long m485getPointerIdJ3iCeTQ = dragging.m485getPointerIdJ3iCeTQ();
        List<PointerInputChange> changes = pointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        int i2 = 0;
        while (true) {
            ...
            if (PointerId.m6664equalsimpl0(pointerInputChange2.m6682getIdJ3iCeTQ(), m485getPointerIdJ3iCeTQ)) {
                break;
            }
            i2++;
        }
        ...
        if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange3)) {
            ...
            dragging.m486setPointerId0FcD4WY(pointerInputChange5.m6682getIdJ3iCeTQ());
        } else if (pointerInputChange3.isConsumed()) {
            sendDragCancelled();
        } else if (Offset.m5101getDistanceimpl(PointerEventKt.positionChangeIgnoreConsumed(pointerInputChange3)) == 0.0f) {
        } else {
            m515sendDragEventUv8p0NA(pointerInputChange3, PointerEventKt.positionChange(pointerInputChange3));
            pointerInputChange3.consume();
        }
    }

    /* renamed from: sendDragStart-0AR0LA0  reason: not valid java name */
    private final void m516sendDragStart0AR0LA0(PointerInputChange pointerInputChange, PointerInputChange pointerInputChange2, long j) {
        if (this.velocityTracker == null) {
            this.velocityTracker = new VelocityTracker();
        }
        VelocityTrackerKt.addPointerInputChange(requireVelocityTracker(), pointerInputChange);
        long m5107minusMKHz9U = Offset.m5107minusMKHz9U(pointerInputChange2.m6685getPositionF1C5BW0(), j);
        this.nodeOffset = Offset.Companion.m5119getZeroF1C5BW0();
        if (this.canDrag.invoke(PointerType.m6755boximpl(pointerInputChange.m6688getTypeT8wyACA())).booleanValue()) {
            if (!this.isListeningForEvents) {
                if (this.channel == null) {
                    this.channel = ChannelKt.Channel$default(Integer.MAX_VALUE, null, null, 6, null);
                }
    ...
    private final void m515sendDragEventUv8p0NA(PointerInputChange pointerInputChange, long j) {
