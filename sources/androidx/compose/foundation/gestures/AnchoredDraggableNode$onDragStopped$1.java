...
final class AnchoredDraggableNode$onDragStopped$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0067, code lost:
        if (r1.mo265applyToFlingBMRW4eQ(r3, new androidx.compose.foundation.gestures.AnchoredDraggableNode$onDragStopped$1.AnonymousClass1(r7.this$0, null), r7) == r0) goto L17;
     */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    public final Object invokeSuspend(Object obj) {
        long m446reverseIfNeededAH228Gc;
        float m448toFloatTH1AsA0;
        OverscrollEffect overscrollEffect;
        OverscrollEffect overscrollEffect2;
        long m451toVelocityadjELrA;
        Object fling;
        ...
        m446reverseIfNeededAH228Gc = anchoredDraggableNode.m446reverseIfNeededAH228Gc(this.$event.m489getVelocity9UxMQ8M());
        m448toFloatTH1AsA0 = anchoredDraggableNode.m448toFloatTH1AsA0(m446reverseIfNeededAH228Gc);
        ...
        if (overscrollEffect == null) {
            this.label = 1;
            fling = anchoredDraggableNode2.fling(m448toFloatTH1AsA0, this);
        } else {
            overscrollEffect2 = ((AnchoredDraggableNode) anchoredDraggableNode2).overscrollEffect;
            Intrinsics.checkNotNull(overscrollEffect2);
            m451toVelocityadjELrA = this.this$0.m451toVelocityadjELrA(m448toFloatTH1AsA0);
            this.label = 2;
        }
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<Velocity, Continuation<? super Velocity>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            ...
            anonymousClass1.J$0 = ((Velocity) obj).m8407unboximpl();
            return anonymousClass1;
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Velocity> continuation) {
            return m454invokesFctU(velocity.m8407unboximpl(), continuation);
        }

        /* renamed from: invoke-sF-c-tU  reason: not valid java name */
        public final Object m454invokesFctU(long j, Continuation<? super Velocity> continuation) {
            return ((AnonymousClass1) create(Velocity.m8389boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                long j2 = this.J$0;
                AnchoredDraggableNode<T> anchoredDraggableNode = this.this$0;
                m448toFloatTH1AsA0 = anchoredDraggableNode.m448toFloatTH1AsA0(j2);
                this.J$0 = j2;
                this.label = 1;
                obj = anchoredDraggableNode.fling(m448toFloatTH1AsA0, this);
            ...
            if (requireOffset >= anchoredDraggableState3.getAnchors().maxPosition() || requireOffset <= minPosition) {
                j = this.this$0.m451toVelocityadjELrA(floatValue);
            }
