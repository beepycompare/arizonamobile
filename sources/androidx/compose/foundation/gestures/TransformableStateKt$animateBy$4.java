...
public final class TransformableStateKt$animateBy$4 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public TransformableStateKt$animateBy$4(Ref.ObjectRef<AnimationData> objectRef, AnimationData animationData, DelegatingAnimationSpec delegatingAnimationSpec, long j, Continuation<? super TransformableStateKt$animateBy$4> continuation) {
        ...
        if (i == 0) {
            ...
            if (SuspendAnimationKt.animateTo$default(AnimationState$default, animationData3, delegatingAnimationSpec, false, new Function1() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animateBy$4$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj2) {
                    return TransformableStateKt$animateBy$4.invokeSuspend$lambda$0(Ref.ObjectRef.this, transformScope, j, (AnimationScope) obj2);
                }
    ...
    public static final Unit invokeSuspend$lambda$0(Ref.ObjectRef objectRef, TransformScope transformScope, long j, AnimationScope animationScope) {
        transformScope.mo478transformByWithCentroidIEwrmTk(j, ((AnimationData) objectRef.element).getZoom() == 0.0f ? 1.0f : ((AnimationData) animationScope.getValue()).getZoom() / ((AnimationData) objectRef.element).getZoom(), Offset.m5107minusMKHz9U(((AnimationData) animationScope.getValue()).m459getOffsetF1C5BW0(), ((AnimationData) objectRef.element).m459getOffsetF1C5BW0()), ((AnimationData) animationScope.getValue()).getDegrees() - ((AnimationData) objectRef.element).getDegrees());
