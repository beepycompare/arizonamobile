...
public final class TrackpadScrollingLogic extends NonTouchScrollingLogic {
        ...
        if (pointerInputChange != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (m642canConsumeDeltaUv8p0NA(getScrollingLogic(), m5095constructorimpl)) {
                    z = ChannelResult.m11473isSuccessimpl(this.channel.mo9057trySendJP2dKIU(new TrackpadScrollDelta(m5095constructorimpl, historicalChange.getUptimeMillis(), false, null))) || z;
                }
            }
            ...
            if (m642canConsumeDeltaUv8p0NA(getScrollingLogic(), m5095constructorimpl2) || m6625equalsimpl0) {
                if (ChannelResult.m11473isSuccessimpl(this.channel.mo9057trySendJP2dKIU(new TrackpadScrollDelta(m5095constructorimpl2, pointerInputChange.getUptimeMillis(), m6625equalsimpl0, null))) || z) {
                    z = true;
                }
            }
    ...
    public static final TrackpadScrollDelta sumOrNull$lambda$0(Channel channel) {
        return (TrackpadScrollDelta) ChannelResult.m11468getOrNullimpl(channel.mo11457tryReceivePtdJZtk());
    }
