...
public final class AndroidConfig implements ScrollConfig {
    ...
    public final float getVerticalScrollFactor$foundation(Density density) {
        ...
        return density.mo434toPx0680j_4(Dp.m8160constructorimpl(64.0f));
    }
    ...
    public long mo455calculateMouseWheelScroll8xgXZGE(Density density, PointerEvent pointerEvent, long j) {
        ...
        for (int i = 0; i < size; i++) {
            m5092boximpl = Offset.m5092boximpl(Offset.m5108plusMKHz9U(m5092boximpl.m5113unboximpl(), changes.get(i).m6687getScrollDeltaF1C5BW0()));
        }
        long m5113unboximpl = m5092boximpl.m5113unboximpl();
        return Offset.m5095constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (m5113unboximpl >> 32)) * f2) << 32) | (Float.floatToRawIntBits(Float.intBitsToFloat((int) (m5113unboximpl & 4294967295L)) * f) & 4294967295L));
    }
}
