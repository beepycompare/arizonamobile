...
public final class DraggableKt {
    ...
    public static final float m464toFloat3MmeM6k(long j, Orientation orientation) {
        return Float.intBitsToFloat((int) (orientation == Orientation.Vertical ? j & 4294967295L : j >> 32));
    }

    /* renamed from: toFloat-sF-c-tU */
    public static final float m465toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m6923getYimpl(j) : Velocity.m6922getXimpl(j);
    }

    /* renamed from: toValidVelocity-TH1AsA0 */
    public static final long m466toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m6922getXimpl(j)) ? 0.0f : Velocity.m6922getXimpl(j), Float.isNaN(Velocity.m6923getYimpl(j)) ? 0.0f : Velocity.m6923getYimpl(j));
    }
}
