...
public final class MouseWheelScrollingLogic {
    ...
    public final void m527onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        if (pointerEventPass == PointerEventPass.Main && PointerEventType.m6519equalsimpl0(pointerEvent.m6512getType7fucELk(), PointerEventType.Companion.m6528getScroll7fucELk())) {
            ...
            if (m526onMouseWheelO0kMr_c(pointerEvent, j)) {
    ...
    public static final class MouseWheelScrollDelta {
        ...
        public static /* synthetic */ MouseWheelScrollDelta m528copy9KIMszo$default(MouseWheelScrollDelta mouseWheelScrollDelta, long j, long j2, boolean z, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return mouseWheelScrollDelta.m530copy9KIMszo(j3, j4, z);
        }

        /* renamed from: component1-F1C5BW0  reason: not valid java name */
        public final long m529component1F1C5BW0() {
            return this.value;
        }
        ...
        public final MouseWheelScrollDelta m530copy9KIMszo(long j, long j2, boolean z) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof MouseWheelScrollDelta) {
                ...
                return Offset.m5033equalsimpl0(this.value, mouseWheelScrollDelta.value) && this.timeMillis == mouseWheelScrollDelta.timeMillis && this.shouldApplyImmediately == mouseWheelScrollDelta.shouldApplyImmediately;
            }
            return false;
        }

        public int hashCode() {
            return (((Offset.m5038hashCodeimpl(this.value) * 31) + Long.hashCode(this.timeMillis)) * 31) + Boolean.hashCode(this.shouldApplyImmediately);
        }

        public String toString() {
            return "MouseWheelScrollDelta(value=" + ((Object) Offset.m5044toStringimpl(this.value)) + ", timeMillis=" + this.timeMillis + ", shouldApplyImmediately=" + this.shouldApplyImmediately + ')';
        }
        ...
        public final long m531getValueF1C5BW0() {
            return this.value;
        }
        ...
        public final MouseWheelScrollDelta plus(MouseWheelScrollDelta mouseWheelScrollDelta) {
            return new MouseWheelScrollDelta(Offset.m5041plusMKHz9U(this.value, mouseWheelScrollDelta.value), Math.max(this.timeMillis, mouseWheelScrollDelta.timeMillis), this.shouldApplyImmediately, null);
        }
    }
    ...
    */
    ...
    private final boolean m526onMouseWheelO0kMr_c(PointerEvent pointerEvent, long j) {
        long mo458calculateMouseWheelScroll8xgXZGE = this.mouseWheelScrollConfig.mo458calculateMouseWheelScroll8xgXZGE(this.density, pointerEvent, j);
        if (m525canConsumeDeltaUv8p0NA(this.scrollingLogic, mo458calculateMouseWheelScroll8xgXZGE)) {
            return ChannelResult.m11442isSuccessimpl(this.channel.mo8879trySendJP2dKIU(new MouseWheelScrollDelta(mo458calculateMouseWheelScroll8xgXZGE, ((PointerInputChange) CollectionsKt.first((List<? extends Object>) pointerEvent.getChanges())).getUptimeMillis(), !this.mouseWheelScrollConfig.isSmoothScrollingEnabled() || this.mouseWheelScrollConfig.isPreciseWheelScroll(pointerEvent), null)));
        }
    ...
    public static final MouseWheelScrollDelta sumOrNull$lambda$4(Channel channel) {
        return (MouseWheelScrollDelta) ChannelResult.m11437getOrNullimpl(channel.mo11425tryReceivePtdJZtk());
    }
    ...
    private final boolean m525canConsumeDeltaUv8p0NA(ScrollingLogic scrollingLogic, long j) {
        float m594toFloatk4lQ0M = scrollingLogic.m594toFloatk4lQ0M(scrollingLogic.m592reverseIfNeededMKHz9U(j));
        if (m594toFloatk4lQ0M == 0.0f) {
            return false;
        }
        if (m594toFloatk4lQ0M > 0.0f) {
    ...
    public final void trackVelocity(MouseWheelScrollDelta mouseWheelScrollDelta) {
        this.velocityTracker.m532addDeltaUv8p0NA(mouseWheelScrollDelta.getTimeMillis(), mouseWheelScrollDelta.m531getValueF1C5BW0());
    }
    ...
    */
    public final Object dispatchMouseWheelScroll(ScrollingLogic scrollingLogic, MouseWheelScrollDelta mouseWheelScrollDelta, float f, float f2, Continuation<? super Unit> continuation) {
        ...
        long m533calculateVelocity9UxMQ8M;
        if (continuation instanceof MouseWheelScrollingLogic$dispatchMouseWheelScroll$1) {
            ...
            if ((mouseWheelScrollingLogic$dispatchMouseWheelScroll$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    floatRef2.element = scrollingLogic.m594toFloatk4lQ0M(scrollingLogic.m592reverseIfNeededMKHz9U(((MouseWheelScrollDelta) objectRef.element).m531getValueF1C5BW0()));
                ...
                m533calculateVelocity9UxMQ8M = this.velocityTracker.m533calculateVelocity9UxMQ8M();
                if (Velocity.m8233equalsimpl0(m533calculateVelocity9UxMQ8M, Velocity.Companion.m8245getZero9UxMQ8M())) {
                    m533calculateVelocity9UxMQ8M = scrollingLogic2.m596toVelocityadjELrA(scrollingLogic2.reverseIfNeeded(Math.signum(floatRef.element)) * Math.min(Math.abs(floatRef.element) / 100, f3) * 1000);
                }
                Function2<Velocity, Continuation<? super Unit>, Object> function2 = this.onScrollStopped;
                Velocity m8225boximpl = Velocity.m8225boximpl(m533calculateVelocity9UxMQ8M);
        ...
        Velocity m8225boximpl2 = Velocity.m8225boximpl(m533calculateVelocity9UxMQ8M);
    ...
    */
        ...
        if (continuation instanceof MouseWheelScrollingLogic$dispatchMouseWheelScroll$waitNextScrollDelta$1) {
            ...
            if ((mouseWheelScrollingLogic$dispatchMouseWheelScroll$waitNextScrollDelta$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (mouseWheelScrollDelta != null) {
                    objectRef4.element = MouseWheelScrollDelta.m528copy9KIMszo$default(mouseWheelScrollDelta, 0L, 0L, objectRef4.element.getShouldApplyImmediately(), 3, null);
                    floatRef2.element = scrollingLogic2.m594toFloatk4lQ0M(scrollingLogic2.m592reverseIfNeededMKHz9U(objectRef4.element.m531getValueF1C5BW0()));
    ...
    public final float dispatchMouseWheelScroll(NestedScrollScope nestedScrollScope, float f) {
        ...
        return scrollingLogic.m594toFloatk4lQ0M(scrollingLogic.m592reverseIfNeededMKHz9U(nestedScrollScope.mo534scrollByOzD1aCk(scrollingLogic.m595toOffsettuRUvjQ(scrollingLogic.reverseIfNeeded(f)), NestedScrollSource.Companion.m6463getUserInputWNlRxjI())));
    }
}
