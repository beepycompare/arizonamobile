...
public final class TransformableKt {
    ...
    */
    public static final Object awaitCtrlMouseScrollOrNull(AwaitPointerEventScope awaitPointerEventScope, ScrollConfig scrollConfig, Continuation<? super Offset> continuation) {
        ...
        if (continuation instanceof TransformableKt$awaitCtrlMouseScrollOrNull$1) {
            ...
            if ((transformableKt$awaitCtrlMouseScrollOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (PointerEvent_androidKt.m6536isCtrlPressed5xRPYO0(pointerEvent.m6510getKeyboardModifiersk7X9c1A()) || !PointerEventType.m6518equalsimpl0(pointerEvent.m6511getType7fucELk(), PointerEventType.Companion.m6527getScroll7fucELk())) {
                    return null;
                }
                long mo457calculateMouseWheelScroll8xgXZGE = scrollConfig.mo457calculateMouseWheelScroll8xgXZGE(awaitPointerEventScope, pointerEvent, awaitPointerEventScope.mo6478getSizeYbymL2g());
                if (Offset.m5032equalsimpl0(mo457calculateMouseWheelScroll8xgXZGE, Offset.Companion.m5051getZeroF1C5BW0())) {
                    return null;
                }
                ...
                return Offset.m5024boximpl(mo457calculateMouseWheelScroll8xgXZGE);
            }
        }
        ...
        if (PointerEvent_androidKt.m6536isCtrlPressed5xRPYO0(pointerEvent.m6510getKeyboardModifiersk7X9c1A())) {
        }
        return null;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x020d, code lost:
        if (r13.invoke(androidx.compose.ui.geometry.Offset.m5024boximpl(r9)).booleanValue() != false) goto L63;
     */
        ...
        if (continuation instanceof TransformableKt$detectZoom$1) {
            ...
            if ((transformableKt$detectZoom$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    transformableKt$detectZoom$14.J$0 = m5051getZeroF1C5BW0;
                    ...
                    if (i5 != 0) {
                        ...
                        if (i3 == 0) {
                            ...
                            long m5040plusMKHz9U = Offset.m5040plusMKHz9U(j, calculatePan);
                            int i14 = i3;
                        ...
                        if (i6 == 0) {
                            ...
                            if (f17 != 0.0f) {
                                ...
                                transformableKt$detectZoom$12 = transformableKt$detectZoom$14;
                                if (!Offset.m5032equalsimpl0(calculatePan, Offset.Companion.m5051getZeroF1C5BW0())) {
                                }
