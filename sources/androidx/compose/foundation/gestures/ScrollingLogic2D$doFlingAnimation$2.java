        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic2D$doFlingAnimation$2$flingScope$1
                ...
                public float scrollBy(float f) {
                    ...
                    if (!Offset.m5100equalsimpl0(doFlingAnimation_QWom1Mo$toDecomposedOffset, Offset.Companion.m5119getZeroF1C5BW0())) {
                        function0 = ScrollingLogic2D.this.isScrollableNodeAttached;
                        if (!((Boolean) function0.invoke()).booleanValue()) {
                            throw new FlingCancellationException();
                        }
                    }
                    doFlingAnimation_QWom1Mo$toMagnitudeFloat = ScrollingLogic2D.doFlingAnimation_QWom1Mo$toMagnitudeFloat(nestedScrollScope.mo561scrollByWithOverscrollOzD1aCk(doFlingAnimation_QWom1Mo$toDecomposedOffset, NestedScrollSource.Companion.m6553getSideEffectWNlRxjI()));
            ...
            m597getMagnitudeTH1AsA0 = Scrollable2DKt.m597getMagnitudeTH1AsA0(j3);
            this.L$0 = longRef2;
            this.J$0 = j3;
            this.label = 1;
            obj = flingBehavior.performFling(scrollScope, m597getMagnitudeTH1AsA0, this);
