...
public final class Scrollable2DKt {
    private static final Scroll2DScope NoOpScrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.Scrollable2DKt$NoOpScrollScope$1
        ...
        public long mo463scrollByMKHz9U(long j) {
            return j;
        }
    };
    ...
    */
    public static final Object m560semanticsScrollByd4ec7I(ScrollingLogic2D scrollingLogic2D, long j, Continuation<? super Offset> continuation) {
    ...
    public static final float m559getMagnitudeTH1AsA0(long j) {
        double d = 2;
        return (float) Math.sqrt(((float) Math.pow(Velocity.m7489getXimpl(j), d)) + ((float) Math.pow(Velocity.m7490getYimpl(j), d)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getAngle-TH1AsA0  reason: not valid java name */
    public static final float m558getAngleTH1AsA0(long j) {
        return (float) Math.atan2(Velocity.m7490getYimpl(j), Velocity.m7489getXimpl(j));
    }
}
