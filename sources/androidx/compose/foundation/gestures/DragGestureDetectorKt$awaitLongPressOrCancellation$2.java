    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            for (int i5 = 0; i5 < size3; i5++) {
                ...
                if (pointerInputChange2.isConsumed() || PointerEventKt.m6621isOutOfBoundsjwHxaWs(pointerInputChange2, awaitPointerEventScope.mo6570getSizeYbymL2g(), awaitPointerEventScope.mo6569getExtendedTouchPaddingNHjbRc())) {
                    break;
                }
            }
            ...
            if (awaitPointerEvent != coroutine_suspended) {
                ...
                if (!DragGestureDetectorKt.m508isPointerUpDmW0f2w(pointerEvent, this.$currentDown.element.m6682getIdJ3iCeTQ())) {
                }
                awaitPointerEventScope = awaitPointerEventScope2;
                obj3 = null;
                z = true;
            ...
            if (!DragGestureDetectorKt.m508isPointerUpDmW0f2w(pointerEvent, this.$currentDown.element.m6682getIdJ3iCeTQ())) {
                ...
                while (true) {
                    ...
                    if (PointerId.m6664equalsimpl0(((PointerInputChange) t).m6682getIdJ3iCeTQ(), objectRef2.element.m6682getIdJ3iCeTQ())) {
                        break;
                    }
                    i7++;
