...
final class AnimationDataConverter implements TwoWayConverter<AnimationData, AnimationVector4D> {
    ...
    public static final AnimationVector4D _get_convertToVector_$lambda$0(AnimationData animationData) {
        return new AnimationVector4D(animationData.getZoom(), Float.intBitsToFloat((int) (animationData.m459getOffsetF1C5BW0() >> 32)), Float.intBitsToFloat((int) (animationData.m459getOffsetF1C5BW0() & 4294967295L)), animationData.getDegrees());
    }
    ...
    public static final AnimationData _get_convertFromVector_$lambda$0(AnimationVector4D animationVector4D) {
        ...
        return new AnimationData(v1, Offset.m5095constructorimpl((Float.floatToRawIntBits(v3) & 4294967295L) | (Float.floatToRawIntBits(v2) << 32)), animationVector4D.getV4(), null);
    }
}
