...
public final class AnimationData {
    ...
    public static /* synthetic */ AnimationData m459copyd4ec7I$default(AnimationData animationData, float f, long j, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return animationData.m461copyd4ec7I(f, j, f2);
    }
    ...
    public final long m460component2F1C5BW0() {
        return this.offset;
    }
    ...
    public final AnimationData m461copyd4ec7I(float f, long j, float f2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AnimationData) {
            ...
            return Float.compare(this.zoom, animationData.zoom) == 0 && Offset.m5033equalsimpl0(this.offset, animationData.offset) && Float.compare(this.degrees, animationData.degrees) == 0;
        }
        return false;
    }

    public int hashCode() {
        return (((Float.hashCode(this.zoom) * 31) + Offset.m5038hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.degrees);
    }

    public String toString() {
        return "AnimationData(zoom=" + this.zoom + ", offset=" + ((Object) Offset.m5044toStringimpl(this.offset)) + ", degrees=" + this.degrees + ')';
    }
    ...
    public final long m462getOffsetF1C5BW0() {
        return this.offset;
    }
