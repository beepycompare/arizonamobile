...
public final class ScrollingLogic2D implements ScrollLogic {
    ...
    public ScrollingLogic2D(Scrollable2DState scrollable2DState, OverscrollEffect overscrollEffect, FlingBehavior flingBehavior, NestedScrollDispatcher nestedScrollDispatcher, Function0<Boolean> function0) {
        ...
        this.nestedScrollScope = new NestedScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic2D$nestedScrollScope$1
            ...
            public long mo560scrollByOzD1aCk(long j, int i) {
                ...
                long m628performScroll3eAAhYA;
                scroll2DScope2 = ScrollingLogic2D.this.outerStateScope;
                m628performScroll3eAAhYA = ScrollingLogic2D.this.m628performScroll3eAAhYA(scroll2DScope2, j, i);
                return m628performScroll3eAAhYA;
            }
            ...
            public long mo561scrollByWithOverscrollOzD1aCk(long j, int i) {
                ...
                if (overscrollEffect2 == null || !ScrollingLogic2D.this.m631shouldDispatchOverscrollk4lQ0M(j)) {
                    scroll2DScope2 = ScrollingLogic2D.this.outerStateScope;
                    m628performScroll3eAAhYA = ScrollingLogic2D.this.m628performScroll3eAAhYA(scroll2DScope2, j, i);
                    return m628performScroll3eAAhYA;
                }
                ...
                return overscrollEffect2.mo266applyToScrollRhakbz0(j, i2, function1);
            }
        };
        this.performScrollForOverscroll = new Function1() { // from class: androidx.compose.foundation.gestures.ScrollingLogic2D$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                Offset m5092boximpl;
                m5092boximpl = Offset.m5092boximpl(r0.m628performScroll3eAAhYA(r0.outerStateScope, ((Offset) obj).m5113unboximpl(), ScrollingLogic2D.this.latestScrollSource));
                return m5092boximpl;
            }
        };
    }
    ...
    public final long m628performScroll3eAAhYA(Scroll2DScope scroll2DScope, long j, int i) {
        ...
        long mo476scrollByMKHz9U = scroll2DScope.mo476scrollByMKHz9U(m5107minusMKHz9U);
        return Offset.m5108plusMKHz9U(Offset.m5108plusMKHz9U(m6538dispatchPreScrollOzD1aCk, mo476scrollByMKHz9U), this.nestedScrollDispatcher.m6536dispatchPostScrollDzOQY0M(mo476scrollByMKHz9U, Offset.m5107minusMKHz9U(m5107minusMKHz9U, mo476scrollByMKHz9U), i));
    }

    /* renamed from: shouldDispatchOverscroll-k-4lQ0M  reason: not valid java name */
    public final boolean m631shouldDispatchOverscrollk4lQ0M(long j) {
        return this.scrollableState.mo474canScrollk4lQ0M(j);
    }

    /* renamed from: shouldDispatchOverscroll-TH1AsA0  reason: not valid java name */
    public final boolean m630shouldDispatchOverscrollTH1AsA0(long j) {
        Scrollable2DState scrollable2DState = this.scrollableState;
        float m8398getXimpl = Velocity.m8398getXimpl(j);
        return scrollable2DState.mo474canScrollk4lQ0M(Offset.m5095constructorimpl((Float.floatToRawIntBits(Velocity.m8399getYimpl(j)) & 4294967295L) | (Float.floatToRawIntBits(m8398getXimpl) << 32)));
    }
    ...
    public long mo592performRawScrollMKHz9U(long j) {
        ...
        return m627dispatchRawDeltaMKHz9U(j);
    }

    /* renamed from: dispatchRawDelta-MK-Hz9U  reason: not valid java name */
    private final long m627dispatchRawDeltaMKHz9U(long j) {
        return this.scrollableState.mo475dispatchRawDeltaMKHz9U(j);
    }

    /* renamed from: onScrollStopped-sF-c-tU  reason: not valid java name */
    public final Object m629onScrollStoppedsFctU(long j, Continuation<? super Unit> continuation) {
        ...
        if (overscrollEffect != null && m630shouldDispatchOverscrollTH1AsA0(j)) {
            Object mo265applyToFlingBMRW4eQ = overscrollEffect.mo265applyToFlingBMRW4eQ(j, scrollingLogic2D$onScrollStopped$performFling$1, continuation);
            return mo265applyToFlingBMRW4eQ == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? mo265applyToFlingBMRW4eQ : Unit.INSTANCE;
        }
        Object invoke = scrollingLogic2D$onScrollStopped$performFling$1.invoke(Velocity.m8389boximpl(j), continuation);
    ...
    */
    ...
    public static final long doFlingAnimation_QWom1Mo$toDecomposedOffset(float f, long j) {
        float m596getAngleTH1AsA0;
        float m596getAngleTH1AsA02;
        float m596getAngleTH1AsA03;
        m596getAngleTH1AsA0 = Scrollable2DKt.m596getAngleTH1AsA0(j);
        if (!Float.isNaN(m596getAngleTH1AsA0)) {
            m596getAngleTH1AsA02 = Scrollable2DKt.m596getAngleTH1AsA0(j);
            float abs = Math.abs(((float) Math.cos(m596getAngleTH1AsA02)) * f) * Math.signum(Velocity.m8398getXimpl(j));
            m596getAngleTH1AsA03 = Scrollable2DKt.m596getAngleTH1AsA0(j);
            return Offset.m5095constructorimpl((Float.floatToRawIntBits(abs) << 32) | (Float.floatToRawIntBits(Math.abs(((float) Math.sin(m596getAngleTH1AsA03)) * f) * Math.signum(Velocity.m8399getYimpl(j))) & 4294967295L));
        }
        return Offset.m5095constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
    }
    ...
    public static final long doFlingAnimation_QWom1Mo$toDecomposedVelocity(float f, long j) {
        ...
        if (!Float.isNaN(m596getAngleTH1AsA0)) {
            ...
            float abs = Math.abs(((float) Math.cos(m596getAngleTH1AsA02)) * f) * Math.signum(Velocity.m8398getXimpl(j));
            m596getAngleTH1AsA03 = Scrollable2DKt.m596getAngleTH1AsA0(j);
            return VelocityKt.Velocity(abs, Math.abs(((float) Math.sin(m596getAngleTH1AsA03)) * f) * Math.signum(Velocity.m8399getYimpl(j)));
        }
