...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        float m589toFloatTH1AsA0;
        Ref.LongRef longRef;
        ScrollingLogic scrollingLogic2;
        long j;
        long m590updateQWom1Mo;
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float f) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m594toFloatk4lQ0M(nestedScrollScope.mo535scrollByWithOverscrollOzD1aCk(scrollingLogic4.m592reverseIfNeededMKHz9U(scrollingLogic4.m595toOffsettuRUvjQ(f)), NestedScrollSource.Companion.m6462getSideEffectWNlRxjI())));
                }
            };
            ...
            m589toFloatTH1AsA0 = scrollingLogic.m589toFloatTH1AsA0(j2);
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(m589toFloatTH1AsA0);
        ...
        m590updateQWom1Mo = scrollingLogic.m590updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
        longRef.element = m590updateQWom1Mo;
