...
public final class DraggableNode extends DragGestureNode {
    ...
    public void onDragStopped(DragEvent.DragStopped dragStopped) {
        ...
        if (isAttached()) {
            ...
            BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, CoroutineStart.UNDISPATCHED, new DraggableNode$onDragStopped$1(this, dragStopped, null), 1, null);
        }
    }
    ...
    public final void update(DraggableState draggableState, Function1<? super PointerType, Boolean> function1, Orientation orientation, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> function3, Function3<? super CoroutineScope, ? super Float, ? super Continuation<? super Unit>, ? extends Object> function32, boolean z3) {
        boolean z4;
        boolean z5 = true;
    ...
    public final long m525reverseIfNeededAH228Gc(long j) {
        return Velocity.m8404timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U  reason: not valid java name */
    public final long m526reverseIfNeededMKHz9U(long j) {
        return Offset.m5110timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}
