        ...
        if (i == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode$drag$2.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    long m471reverseIfNeededMKHz9U;
                    Orientation orientation;
                    float m464toFloat3MmeM6k;
                    DragScope dragScope2 = DragScope.this;
                    m471reverseIfNeededMKHz9U = draggableNode.m471reverseIfNeededMKHz9U(dragDelta.m426getDeltaF1C5BW0());
                    orientation = draggableNode.orientation;
                    m464toFloat3MmeM6k = DraggableKt.m464toFloat3MmeM6k(m471reverseIfNeededMKHz9U, orientation);
                    dragScope2.dragBy(m464toFloat3MmeM6k);
                }
            };
            this.label = 1;
