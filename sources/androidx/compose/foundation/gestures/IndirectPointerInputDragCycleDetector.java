...
public final class IndirectPointerInputDragCycleDetector {
    ...
    private long previousPositionOnScreen = Offset.Companion.m5118getUnspecifiedF1C5BW0();
    ...
    private long nodeOffset = Offset.Companion.m5119getZeroF1C5BW0();
    ...
    static /* synthetic */ void m529moveToAwaitTouchSlopStateaWI9W7U$default(IndirectPointerInputDragCycleDetector indirectPointerInputDragCycleDetector, IndirectPointerInputChange indirectPointerInputChange, long j, long j2, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        indirectPointerInputDragCycleDetector.m528moveToAwaitTouchSlopStateaWI9W7U(indirectPointerInputChange, j, j3, z);
    }

    /* renamed from: moveToAwaitTouchSlopState-aWI9W7U  reason: not valid java name */
    private final void m528moveToAwaitTouchSlopStateaWI9W7U(IndirectPointerInputChange indirectPointerInputChange, long j, long j2, boolean z) {
        ...
        awaitTouchSlopState.m537setPointerId0FcD4WY(j);
        TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
        if (touchSlopDetector == null) {
            ...
            if (touchSlopDetector2 != null) {
                touchSlopDetector2.m641resetk4lQ0M(j2);
            }
        }
    ...
    private final void m530moveToDraggingState0FcD4WY(long j) {
        DragDetectionState.Dragging draggingState = getDraggingState();
        draggingState.m539setPointerId0FcD4WY(j);
    ...
    private final void m527moveToAwaitGesturePickupStaternUCldI(IndirectPointerInputChange indirectPointerInputChange, long j, TouchSlopDetector touchSlopDetector) {
        ...
        awaitGesturePickupState.m535setPointerId0FcD4WY(j);
    ...
    private final void processInitialDownState(IndirectPointerEvent indirectPointerEvent, PointerEventPass pointerEventPass, DragDetectionState.AwaitDown awaitDown) {
        ...
        if (pointerEventPass == PointerEventPass.Main) {
            if (awaitTouchSlop == DragDetectionState.AwaitDown.AwaitTouchSlop.Yes) {
                m529moveToAwaitTouchSlopStateaWI9W7U$default(this, indirectPointerInputChange, indirectPointerInputChange.m6189getIdJ3iCeTQ(), 0L, false, 12, null);
            } else if (awaitDown.getConsumedOnInitial()) {
                m532sendDragStart3f7A7Is(indirectPointerInputChange, indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()), Offset.Companion.m5119getZeroF1C5BW0());
                m531sendDragEventEu1f8Dk(indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()), Offset.Companion.m5119getZeroF1C5BW0());
                m530moveToDraggingState0FcD4WY(indirectPointerInputChange.m6189getIdJ3iCeTQ());
            }
        }
    }
    ...
    private final void processAwaitTouchSlop(IndirectPointerEvent indirectPointerEvent, PointerEventPass pointerEventPass, DragDetectionState.AwaitTouchSlop awaitTouchSlop) {
        ...
        long m546positionChangeIgnoreConsumed_bfSUIo;
        ...
        while (true) {
            ...
            if (PointerId.m6664equalsimpl0(indirectPointerInputChange2.m6189getIdJ3iCeTQ(), awaitTouchSlop.m536getPointerIdJ3iCeTQ())) {
                break;
            }
            i++;
        }
        ...
        if (indirectPointerInputChange4 == null) {
            ...
            awaitTouchSlop.m537setPointerId0FcD4WY(indirectPointerInputChange4.m6189getIdJ3iCeTQ());
        }
            ...
            if (!indirectPointerInputChange5.isConsumed()) {
                ...
                if (changedToUpIgnoreConsumed) {
                    ...
                    if (indirectPointerInputChange7 == null) {
                        ...
                        awaitTouchSlop.m537setPointerId0FcD4WY(indirectPointerInputChange7.m6189getIdJ3iCeTQ());
                    }
                } else {
                    float m509pointerSlopE8SPZFQ = DragGestureDetectorKt.m509pointerSlopE8SPZFQ((ViewConfiguration) CompositionLocalConsumerModifierNodeKt.currentValueOf(this.node, CompositionLocalsKt.getLocalViewConfiguration()), PointerType.Companion.m6765getTouchT8wyACA());
                    TouchSlopDetector requireTouchSlopDetector = requireTouchSlopDetector();
                    m546positionChangeIgnoreConsumed_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m546positionChangeIgnoreConsumed_bfSUIo(indirectPointerInputChange5, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
                    long m635getPostSlopOffsetqto3Fdw$default = TouchSlopDetector.m635getPostSlopOffsetqto3Fdw$default(requireTouchSlopDetector, m546positionChangeIgnoreConsumed_bfSUIo, m509pointerSlopE8SPZFQ, false, 4, null);
                    if ((9223372034707292159L & m635getPostSlopOffsetqto3Fdw$default) != InlineClassHelperKt.UnspecifiedPackedFloats) {
                        ...
                        m532sendDragStart3f7A7Is(initialDown, indirectPointerInputChange5, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()), m635getPostSlopOffsetqto3Fdw$default);
                        m531sendDragEventEu1f8Dk(indirectPointerInputChange5, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()), m635getPostSlopOffsetqto3Fdw$default);
                        m530moveToDraggingState0FcD4WY(indirectPointerInputChange5.m6189getIdJ3iCeTQ());
                    } else {
                ...
                long m536getPointerIdJ3iCeTQ = awaitTouchSlop.m536getPointerIdJ3iCeTQ();
                TouchSlopDetector touchSlopDetector = this.touchSlopDetector;
                if (touchSlopDetector != null) {
                    m527moveToAwaitGesturePickupStaternUCldI(initialDown2, m536getPointerIdJ3iCeTQ, touchSlopDetector);
                } else {
        ...
        if (pointerEventPass == PointerEventPass.Final && awaitTouchSlop.getVerifyConsumptionInFinalPass()) {
            if (indirectPointerInputChange5.isConsumed()) {
                ...
                long m536getPointerIdJ3iCeTQ2 = awaitTouchSlop.m536getPointerIdJ3iCeTQ();
                TouchSlopDetector touchSlopDetector2 = this.touchSlopDetector;
                if (touchSlopDetector2 != null) {
                    m527moveToAwaitGesturePickupStaternUCldI(initialDown3, m536getPointerIdJ3iCeTQ2, touchSlopDetector2);
                    return;
                }
                throw new IllegalArgumentException("AwaitTouchSlop.touchSlopDetector was not initialized".toString());
            }
    ...
    private final void processAwaitGesturePickup(IndirectPointerEvent indirectPointerEvent, PointerEventPass pointerEventPass, DragDetectionState.AwaitGesturePickup awaitGesturePickup) {
        boolean z;
        long m549primaryAxisPosition_bfSUIo;
        long m549primaryAxisPosition_bfSUIo2;
        ...
        while (true) {
            if (i >= size2) {
                ...
                if (z) {
                    m549primaryAxisPosition_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m549primaryAxisPosition_bfSUIo((IndirectPointerInputChange) CollectionsKt.first((List<? extends Object>) indirectPointerEvent.getChanges()), this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
                    IndirectPointerInputChange initialDown = awaitGesturePickup.getInitialDown();
                    Intrinsics.checkNotNull(initialDown);
                    m549primaryAxisPosition_bfSUIo2 = IndirectPointerInputDragCycleDetectorKt.m549primaryAxisPosition_bfSUIo(initialDown, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
                    long m5107minusMKHz9U = Offset.m5107minusMKHz9U(m549primaryAxisPosition_bfSUIo, m549primaryAxisPosition_bfSUIo2);
                    IndirectPointerInputChange initialDown2 = awaitGesturePickup.getInitialDown();
                    if (initialDown2 != null) {
                        m529moveToAwaitTouchSlopStateaWI9W7U$default(this, initialDown2, awaitGesturePickup.m534getPointerIdJ3iCeTQ(), m5107minusMKHz9U, false, 8, null);
                        return;
                    }
    ...
    private final void processDraggingState(IndirectPointerEvent indirectPointerEvent, PointerEventPass pointerEventPass, DragDetectionState.Dragging dragging) {
        ...
        boolean changedToUpIgnoreConsumed;
        long m546positionChangeIgnoreConsumed_bfSUIo;
        long m545positionChange_bfSUIo;
        boolean changedToUpIgnoreConsumed2;
        if (pointerEventPass != PointerEventPass.Main) {
            return;
        }
        long m538getPointerIdJ3iCeTQ = dragging.m538getPointerIdJ3iCeTQ();
        List<IndirectPointerInputChange> changes = indirectPointerEvent.getChanges();
        int size = changes.size();
        int i = 0;
        int i2 = 0;
        while (true) {
            ...
            if (PointerId.m6664equalsimpl0(indirectPointerInputChange2.m6189getIdJ3iCeTQ(), m538getPointerIdJ3iCeTQ)) {
                break;
            }
            i2++;
        }
        ...
        if (changedToUpIgnoreConsumed) {
            ...
            if (indirectPointerInputChange5 == null) {
                if (!indirectPointerInputChange3.isConsumed()) {
                    ...
                    if (changedToUpIgnoreConsumed2) {
                        m533sendDragStoppedk92h6UU(indirectPointerInputChange3, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
                        moveToAwaitDownState();
                        return;
                    }
                }
            ...
            dragging.m539setPointerId0FcD4WY(indirectPointerInputChange5.m6189getIdJ3iCeTQ());
        } else if (!indirectPointerInputChange3.isConsumed()) {
            m546positionChangeIgnoreConsumed_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m546positionChangeIgnoreConsumed_bfSUIo(indirectPointerInputChange3, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
            if (Offset.m5101getDistanceimpl(m546positionChangeIgnoreConsumed_bfSUIo) == 0.0f) {
                return;
            }
            m545positionChange_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m545positionChange_bfSUIo(indirectPointerInputChange3, this.node.getOrientationLock(), IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()));
            m531sendDragEventEu1f8Dk(indirectPointerInputChange3, IndirectPointerEventPrimaryDirectionalMotionAxis.m6168boximpl(indirectPointerEvent.mo6164getPrimaryDirectionalMotionAxisnZO2Niw()), m545positionChange_bfSUIo);
    ...
    private final void m532sendDragStart3f7A7Is(IndirectPointerInputChange indirectPointerInputChange, IndirectPointerInputChange indirectPointerInputChange2, IndirectPointerEventPrimaryDirectionalMotionAxis indirectPointerEventPrimaryDirectionalMotionAxis, long j) {
        long m549primaryAxisPosition_bfSUIo;
        if (this.velocityTracker == null) {
            this.velocityTracker = new VelocityTracker();
        }
        this.nodeOffset = Offset.Companion.m5119getZeroF1C5BW0();
        IndirectPointerInputDragCycleDetectorKt.m544addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), indirectPointerInputChange, this.node.getOrientationLock(), indirectPointerEventPrimaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        m549primaryAxisPosition_bfSUIo = IndirectPointerInputDragCycleDetectorKt.m549primaryAxisPosition_bfSUIo(indirectPointerInputChange2, this.node.getOrientationLock(), indirectPointerEventPrimaryDirectionalMotionAxis);
        long m5107minusMKHz9U = Offset.m5107minusMKHz9U(m549primaryAxisPosition_bfSUIo, j);
        if (this.node.getCanDrag().invoke(PointerType.m6755boximpl(PointerType.Companion.m6765getTouchT8wyACA())).booleanValue()) {
            this.previousPositionOnScreen = LayoutCoordinatesKt.positionOnScreen(DelegatableNodeKt.requireLayoutCoordinates(this.node));
            this.node.onDragEvent(new DragEvent.DragStarted(m5107minusMKHz9U, null));
        }
        this.offsetSmoother.reset();
    }

    /* renamed from: sendDragEvent-Eu1f8Dk  reason: not valid java name */
    private final void m531sendDragEventEu1f8Dk(IndirectPointerInputChange indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis indirectPointerEventPrimaryDirectionalMotionAxis, long j) {
        long positionOnScreen = LayoutCoordinatesKt.positionOnScreen(DelegatableNodeKt.requireLayoutCoordinates(this.node));
        if (!Offset.m5100equalsimpl0(this.previousPositionOnScreen, Offset.Companion.m5118getUnspecifiedF1C5BW0()) && !Offset.m5100equalsimpl0(positionOnScreen, this.previousPositionOnScreen)) {
            this.nodeOffset = Offset.m5108plusMKHz9U(this.nodeOffset, Offset.m5107minusMKHz9U(positionOnScreen, this.previousPositionOnScreen));
        }
        ...
        if (Math.abs(DraggableKt.m519toFloat3MmeM6k(j, orientationLock)) > 2.0f) {
            IndirectPointerInputDragCycleDetectorKt.m544addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), indirectPointerInputChange, this.node.getOrientationLock(), indirectPointerEventPrimaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
            this.node.onDragEvent(new DragEvent.DragDelta(this.offsetSmoother.m562smoothEventPositionMKHz9U(j), true, null));
        }
    }

    /* renamed from: sendDragStopped-k92h6UU  reason: not valid java name */
    private final void m533sendDragStoppedk92h6UU(IndirectPointerInputChange indirectPointerInputChange, IndirectPointerEventPrimaryDirectionalMotionAxis indirectPointerEventPrimaryDirectionalMotionAxis) {
        IndirectPointerInputDragCycleDetectorKt.m544addIndirectPointerInputChangeQf4Zb88(requireVelocityTracker(), indirectPointerInputChange, this.node.getOrientationLock(), indirectPointerEventPrimaryDirectionalMotionAxis, this.touchSmooth, this.nodeOffset);
        ...
        this.node.onDragEvent(new DragEvent.DragStopped(DraggableKt.m521toValidVelocityTH1AsA0(m6793calculateVelocityAH228Gc), true, null));
    }
    ...
    public static abstract class DragDetectionState {
        ...
        public static final class AwaitTouchSlop extends DragDetectionState {
            ...
            public /* synthetic */ AwaitTouchSlop(IndirectPointerInputChange indirectPointerInputChange, long j, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m6662constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? false : z, null);
            }

            /* renamed from: getPointerId-J3iCeTQ  reason: not valid java name */
            public final long m536getPointerIdJ3iCeTQ() {
        ...
        public static final class AwaitGesturePickup extends DragDetectionState {
            ...
            public /* synthetic */ AwaitGesturePickup(IndirectPointerInputChange indirectPointerInputChange, long j, TouchSlopDetector touchSlopDetector, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? null : indirectPointerInputChange, (i & 2) != 0 ? PointerId.m6662constructorimpl(Long.MAX_VALUE) : j, (i & 4) != 0 ? null : touchSlopDetector, null);
            }

            /* renamed from: getPointerId-J3iCeTQ  reason: not valid java name */
            public final long m534getPointerIdJ3iCeTQ() {
                return this.pointerId;
            }
        ...
        public static final class Dragging extends DragDetectionState {
            ...
            public /* synthetic */ Dragging(long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? PointerId.m6662constructorimpl(Long.MAX_VALUE) : j, null);
            }

            /* renamed from: getPointerId-J3iCeTQ  reason: not valid java name */
            public final long m538getPointerIdJ3iCeTQ() {
                return this.pointerId;
            }

            /* renamed from: setPointerId-0FcD4WY  reason: not valid java name */
            public final void m539setPointerId0FcD4WY(long j) {
                this.pointerId = j;
            }
        }
    }
