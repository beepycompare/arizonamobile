...
public final class DragGestureNode$initializePointerInputNode$1 implements PointerInputEventHandler {
    ...
    public final Object invoke(final PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        ...
        if (ComposeFoundationFlags.isAdjustPointerInputChangeOffsetForVelocityTrackerEnabled) {
            m4309getZeroF1C5BW0 = LayoutCoordinatesKt.positionOnScreen(DelegatableNodeKt.requireLayoutCoordinates(this.this$0));
        } else {
            m4309getZeroF1C5BW0 = Offset.Companion.m4309getZeroF1C5BW0();
        }
        longRef.element = m4309getZeroF1C5BW0;
    ...
    public static final Unit invoke$lambda$0(DragGestureNode dragGestureNode, VelocityTracker velocityTracker, PointerInputChange pointerInputChange, PointerInputChange pointerInputChange2, Offset offset) {
        ...
        Channel channel;
        Channel channel2;
        dragGestureNode.nodeOffset = Offset.Companion.m4309getZeroF1C5BW0();
        if (dragGestureNode.getCanDrag().invoke(pointerInputChange).booleanValue()) {
            ...
            if (channel != null) {
                ChannelResult.m10591boximpl(channel.mo8125trySendJP2dKIU(new DragEvent.DragStarted(m4297minusMKHz9U, null)));
            }
        }
    ...
    public static final Unit invoke$lambda$1(VelocityTracker velocityTracker, PointerInputScope pointerInputScope, DragGestureNode dragGestureNode, PointerInputChange pointerInputChange) {
        Channel channel;
        long m506toValidVelocityTH1AsA0;
        VelocityTrackerKt.addPointerInputChange(velocityTracker, pointerInputChange);
        float maximumFlingVelocity = pointerInputScope.getViewConfiguration().getMaximumFlingVelocity();
        long m5925calculateVelocityAH228Gc = velocityTracker.m5925calculateVelocityAH228Gc(VelocityKt.Velocity(maximumFlingVelocity, maximumFlingVelocity));
        velocityTracker.resetTracking();
        channel = dragGestureNode.channel;
        if (channel != null) {
            m506toValidVelocityTH1AsA0 = DraggableKt.m506toValidVelocityTH1AsA0(m5925calculateVelocityAH228Gc);
            ChannelResult.m10591boximpl(channel.mo8125trySendJP2dKIU(new DragEvent.DragStopped(m506toValidVelocityTH1AsA0, null)));
        }
        return Unit.INSTANCE;
    }
    ...
    public static final Unit invoke$lambda$2(DragGestureNode dragGestureNode) {
        ...
        channel = dragGestureNode.channel;
        if (channel != null) {
            ChannelResult.m10591boximpl(channel.mo8125trySendJP2dKIU(DragEvent.DragCancelled.INSTANCE));
        }
        return Unit.INSTANCE;
    }
    ...
    public static final Unit invoke$lambda$4(DragGestureNode dragGestureNode, Ref.LongRef longRef, VelocityTracker velocityTracker, PointerInputChange pointerInputChange, Offset offset) {
        ...
        if (ComposeFoundationFlags.isAdjustPointerInputChangeOffsetForVelocityTrackerEnabled) {
            ...
            if (!Offset.m4290equalsimpl0(positionOnScreen, longRef.element)) {
                long m4297minusMKHz9U = Offset.m4297minusMKHz9U(positionOnScreen, longRef.element);
                j2 = dragGestureNode.nodeOffset;
                dragGestureNode.nodeOffset = Offset.m4298plusMKHz9U(j2, m4297minusMKHz9U);
            }
        ...
        channel = dragGestureNode.channel;
        if (channel != null) {
            ChannelResult.m10591boximpl(channel.mo8125trySendJP2dKIU(new DragEvent.DragDelta(offset.m4303unboximpl(), null)));
        }
        return Unit.INSTANCE;
    }
