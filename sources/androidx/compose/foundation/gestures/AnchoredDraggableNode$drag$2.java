...
@DebugMetadata(c = "androidx.compose.foundation.gestures.AnchoredDraggableNode$drag$2", f = "AnchoredDraggable.kt", i = {}, l = {Constants.STATUS_PRECONDITION_FAILED}, m = "invokeSuspend", n = {}, s = {}, v = 1)
...
final class AnchoredDraggableNode$drag$2<T> extends SuspendLambda implements Function3<AnchoredDragScope, DraggableAnchors<T>, Continuation<? super Unit>, Object> {
    ...
    public static final Unit invokeSuspend$lambda$0(final AnchoredDraggableNode anchoredDraggableNode, final AnchoredDragScope anchoredDragScope, DragEvent.DragDelta dragDelta) {
        long m447reverseIfNeededMKHz9U;
        float m449toFloatk4lQ0M;
        OverscrollEffect overscrollEffect;
        OverscrollEffect overscrollEffect2;
        long m450toOffsettuRUvjQ;
        AnchoredDraggableState anchoredDraggableState;
        m447reverseIfNeededMKHz9U = anchoredDraggableNode.m447reverseIfNeededMKHz9U(dragDelta.m487getDeltaF1C5BW0());
        m449toFloatk4lQ0M = anchoredDraggableNode.m449toFloatk4lQ0M(m447reverseIfNeededMKHz9U);
        overscrollEffect = anchoredDraggableNode.overscrollEffect;
        if (overscrollEffect == null) {
            anchoredDraggableState = anchoredDraggableNode.state;
            AnchoredDragScope.dragTo$default(anchoredDragScope, anchoredDraggableState.newOffsetForDelta$foundation(m449toFloatk4lQ0M), 0.0f, 2, null);
        } else {
            overscrollEffect2 = anchoredDraggableNode.overscrollEffect;
            Intrinsics.checkNotNull(overscrollEffect2);
            m450toOffsettuRUvjQ = anchoredDraggableNode.m450toOffsettuRUvjQ(m449toFloatk4lQ0M);
            Offset.m5092boximpl(overscrollEffect2.mo266applyToScrollRhakbz0(m450toOffsettuRUvjQ, NestedScrollSource.Companion.m6554getUserInputWNlRxjI(), new Function1() { // from class: androidx.compose.foundation.gestures.AnchoredDraggableNode$drag$2$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
    ...
    public static final Offset invokeSuspend$lambda$0$0(AnchoredDraggableNode anchoredDraggableNode, AnchoredDragScope anchoredDragScope, Offset offset) {
        ...
        long m450toOffsettuRUvjQ;
        anchoredDraggableState = anchoredDraggableNode.state;
        m449toFloatk4lQ0M = anchoredDraggableNode.m449toFloatk4lQ0M(offset.m5113unboximpl());
        float newOffsetForDelta$foundation = anchoredDraggableState.newOffsetForDelta$foundation(m449toFloatk4lQ0M);
        anchoredDraggableState2 = anchoredDraggableNode.state;
        m450toOffsettuRUvjQ = anchoredDraggableNode.m450toOffsettuRUvjQ(newOffsetForDelta$foundation - anchoredDraggableState2.requireOffset());
        AnchoredDragScope.dragTo$default(anchoredDragScope, newOffsetForDelta$foundation, 0.0f, 2, null);
        return Offset.m5092boximpl(m450toOffsettuRUvjQ);
    }
}
