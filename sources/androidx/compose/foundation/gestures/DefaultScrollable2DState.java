...
final class DefaultScrollable2DState implements Scrollable2DState {
    ...
    private final Scroll2DScope scrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.DefaultScrollable2DState$scrollScope$1
        ...
        public long mo463scrollByMKHz9U(long j) {
            ...
            return DefaultScrollable2DState.this.getOnDelta().invoke(Offset.m4282boximpl(j)).m4303unboximpl();
        }
    };
    ...
    public boolean mo461canScrollk4lQ0M(long j) {
        return true;
    }
    ...
    public long mo462dispatchRawDeltaMKHz9U(long j) {
        return this.onDelta.invoke(Offset.m4282boximpl(j)).m4303unboximpl();
    }
