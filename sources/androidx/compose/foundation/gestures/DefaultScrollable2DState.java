...
final class DefaultScrollable2DState implements Scrollable2DState {
    ...
    private final Scroll2DScope scrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.DefaultScrollable2DState$scrollScope$1
        ...
        public long mo476scrollByMKHz9U(long j) {
            ...
            return DefaultScrollable2DState.this.getOnDelta().invoke(Offset.m5092boximpl(j)).m5113unboximpl();
        }
    };
    ...
    public boolean mo474canScrollk4lQ0M(long j) {
        return true;
    }
    ...
    public long mo475dispatchRawDeltaMKHz9U(long j) {
        return this.onDelta.invoke(Offset.m5092boximpl(j)).m5113unboximpl();
    }
