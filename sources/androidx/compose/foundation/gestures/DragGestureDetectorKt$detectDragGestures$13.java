...
public final class DragGestureDetectorKt$detectDragGestures$13 extends RestrictedSuspendLambda implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:169:0x04d2, code lost:
        if (androidx.compose.foundation.gestures.DragGestureDetectorKt.m489isPointerUpDmW0f2w(r10.getCurrentEvent(), r2) != false) goto L17;
     */
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Path cross not found for [B:187:0x0537, B:198:0x0565], limit reached: 224 */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:173:0x04fd -> B:175:0x0500). Please submit an issue!!! */
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            ...
            case 2:
                ...
                this.$overSlop.element = Offset.Companion.m4309getZeroF1C5BW0();
                if (!booleanValue) {
                    ...
                    if (pointerInputChange != null) {
                        this.$onDragStart.invoke(pointerInputChange2, pointerInputChange, Offset.m4282boximpl(this.$overSlop.element));
                        this.$onDrag.invoke(pointerInputChange, Offset.m4282boximpl(this.$overSlop.element));
                        m5824getIdJ3iCeTQ2 = pointerInputChange.m5824getIdJ3iCeTQ();
                ...
                m5824getIdJ3iCeTQ = pointerInputChange2.m5824getIdJ3iCeTQ();
                int m5829getTypeT8wyACA = pointerInputChange2.m5829getTypeT8wyACA();
                ...
                j2 = 9223372034707292159L;
                if (DragGestureDetectorKt.m489isPointerUpDmW0f2w(awaitPointerEventScope2.getCurrentEvent(), m5824getIdJ3iCeTQ)) {
                    ...
                    if (pointerInputChange != null && !pointerInputChange.isConsumed()) {
                        ...
                        m5824getIdJ3iCeTQ = pointerInputChange2.m5824getIdJ3iCeTQ();
                        int m5829getTypeT8wyACA2 = pointerInputChange2.m5829getTypeT8wyACA();
                        Orientation orientation22 = this.$orientationLock;
                        longRef2 = this.$overSlop;
                        long m4309getZeroF1C5BW02 = Offset.Companion.m4309getZeroF1C5BW0();
                        j2 = 9223372034707292159L;
                        if (DragGestureDetectorKt.m489isPointerUpDmW0f2w(awaitPointerEventScope2.getCurrentEvent(), m5824getIdJ3iCeTQ)) {
                            f = DragGestureDetectorKt.m490pointerSlopE8SPZFQ(awaitPointerEventScope2.getViewConfiguration(), m5829getTypeT8wyACA2);
                            longRef = new Ref.LongRef();
                            longRef.element = m5824getIdJ3iCeTQ;
                            touchSlopDetector = new TouchSlopDetector(orientation22, m4309getZeroF1C5BW02, defaultConstructorMarker);
            ...
            case 3:
                ...
                while (true) {
                    if (i4 < size2) {
                        ...
                        if (!PointerId.m5808equalsimpl0(pointerInputChange3.m5824getIdJ3iCeTQ(), longRef.element)) {
                            i4++;
                ...
                if (pointerInputChange15 != null && !pointerInputChange15.isConsumed()) {
                    if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange15)) {
                        long m599addPointerInputChangedBAh8RU = touchSlopDetector.m599addPointerInputChangedBAh8RU(pointerInputChange15, f);
                        if ((m599addPointerInputChangedBAh8RU & j2) == j) {
                            this.L$0 = awaitPointerEventScope3;
                            this.L$1 = pointerInputChange2;
                            awaitPointerEventScope2 = awaitPointerEventScope4;
                            this.L$2 = awaitPointerEventScope2;
                            ...
                            longRef2.element = m599addPointerInputChangedBAh8RU;
                            if (pointerInputChange15.isConsumed()) {
                                ...
                                if (pointerInputChange != null) {
                                    ...
                                    defaultConstructorMarker = null;
                                    m5824getIdJ3iCeTQ = pointerInputChange2.m5824getIdJ3iCeTQ();
                                    int m5829getTypeT8wyACA22 = pointerInputChange2.m5829getTypeT8wyACA();
                                    Orientation orientation222 = this.$orientationLock;
                                    longRef2 = this.$overSlop;
                                    long m4309getZeroF1C5BW022 = Offset.Companion.m4309getZeroF1C5BW0();
                                    j2 = 9223372034707292159L;
                                    if (DragGestureDetectorKt.m489isPointerUpDmW0f2w(awaitPointerEventScope2.getCurrentEvent(), m5824getIdJ3iCeTQ)) {
                                    }
                                    break;
                        ...
                        if (pointerInputChange16 != null) {
                            longRef.element = pointerInputChange16.m5824getIdJ3iCeTQ();
                        }
                    }
                    awaitPointerEventScope2 = awaitPointerEventScope4;
                    i2 = 0;
            ...
            case 5:
                ...
                for (int i8 = 0; i8 < size6; i8++) {
                    if (changes7.get(i8).getPressed()) {
                        ...
                        long m4297minusMKHz9U = Offset.m4297minusMKHz9U(pointerInputChange17 != null ? pointerInputChange17.m5826getPositionF1C5BW0() : Offset.Companion.m4309getZeroF1C5BW0(), pointerInputChange7.m5826getPositionF1C5BW0());
                        long m5824getIdJ3iCeTQ3 = pointerInputChange7.m5824getIdJ3iCeTQ();
                        int m5829getTypeT8wyACA3 = pointerInputChange7.m5829getTypeT8wyACA();
                        Orientation orientation3 = this.$orientationLock;
                        longRef3 = this.$overSlop;
                        if (DragGestureDetectorKt.m489isPointerUpDmW0f2w(awaitPointerEventScope6.getCurrentEvent(), m5824getIdJ3iCeTQ3)) {
                        ...
                        f2 = DragGestureDetectorKt.m490pointerSlopE8SPZFQ(awaitPointerEventScope6.getViewConfiguration(), m5829getTypeT8wyACA3);
                        longRef4 = new Ref.LongRef();
                        longRef4.element = m5824getIdJ3iCeTQ3;
                        pointerEventPass2 = null;
                        touchSlopDetector2 = new TouchSlopDetector(orientation3, m4297minusMKHz9U, null);
            ...
            case 6:
                ...
                while (true) {
                    if (i9 < size7) {
                        ...
                        int i10 = size7;
                        if (!PointerId.m5808equalsimpl0(pointerInputChange8.m5824getIdJ3iCeTQ(), longRef4.element)) {
                            i9++;
                            changes8 = list;
                            size7 = i10;
                        }
                ...
                if (pointerInputChange18 != null && !pointerInputChange18.isConsumed()) {
                    if (PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange18)) {
                        ...
                        if (pointerInputChange19 != null) {
                            longRef4.element = pointerInputChange19.m5824getIdJ3iCeTQ();
                        }
                    } else if ((touchSlopDetector2.m599addPointerInputChangedBAh8RU(pointerInputChange18, f2) & j2) != j) {
            ...
            case 8:
                ...
                while (true) {
                    if (i12 < size9) {
                        ...
                        if (!PointerId.m5808equalsimpl0(pointerInputChange12.m5824getIdJ3iCeTQ(), longRef6.element)) {
                            i12++;
                        }
                    } else {
                ...
                if (pointerInputChange20 == null) {
                    ...
                    if ((orientation4 != null ? Float.intBitsToFloat((int) (orientation4 == Orientation.Vertical ? positionChangeIgnoreConsumed & 4294967295L : positionChangeIgnoreConsumed >> 32)) : Offset.m4291getDistanceimpl(positionChangeIgnoreConsumed)) == 0.0f) {
                        z = true;
                        break;
                    } else {
                        z = false;
                    ...
                    if (pointerInputChange22 != null) {
                        longRef6.element = pointerInputChange22.m5824getIdJ3iCeTQ();
                ...
                if (pointerInputChange13 != null && !pointerInputChange13.isConsumed()) {
                    ...
                    function22.invoke(pointerInputChange13, Offset.m4282boximpl(PointerEventKt.positionChange(pointerInputChange13)));
                    pointerInputChange13.consume();
                    m5824getIdJ3iCeTQ2 = pointerInputChange13.m5824getIdJ3iCeTQ();
                    orientation = orientation4;
                    function2 = function22;
                    awaitPointerEventScope2 = awaitPointerEventScope10;
                    Ref.LongRef longRef7 = new Ref.LongRef();
                    longRef7.element = m5824getIdJ3iCeTQ2;
                    longRef6 = longRef7;
