...
@DebugMetadata(c = "androidx.compose.foundation.gestures.NonTouchScrollingLogicKt$untilNull$1", f = "NonTouchScrollingLogic.kt", i = {0}, l = {TsExtractor.TS_STREAM_TYPE_DVBSUBS}, m = "invokeSuspend", n = {"$this$sequence"}, s = {"L$0"}, v = 1)
...
final class NonTouchScrollingLogicKt$untilNull$1<E> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    public NonTouchScrollingLogicKt$untilNull$1(Function0<? extends E> function0, Continuation<? super NonTouchScrollingLogicKt$untilNull$1> continuation) {
