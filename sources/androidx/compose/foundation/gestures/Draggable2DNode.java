...
public final class Draggable2DNode extends DragGestureNode {
    ...
    public void mo452onDragStartedk4lQ0M(long j) {
        this.onDragStarted.invoke(Offset.m5092boximpl(j));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    public void onDragStopped(DragEvent.DragStopped dragStopped) {
        this.onDragStopped.invoke(Velocity.m8389boximpl(dragStopped.m489getVelocity9UxMQ8M()));
    }
    ...
    private final long m517reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m5095constructorimpl(j ^ (-9223372034707292160L)) : j;
    }
}
