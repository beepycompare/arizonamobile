...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m8160constructorimpl(400.0f);
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final float m682calculateFinalOffsetFhqu1e0(int i, float f, float f2) {
        if (!FinalSnappingItem.m675equalsimpl0(i, FinalSnappingItem.Companion.m679getClosestItembbeMdSM())) {
            if (!FinalSnappingItem.m675equalsimpl0(i, FinalSnappingItem.Companion.m680getNextItembbeMdSM())) {
                if (!FinalSnappingItem.m675equalsimpl0(i, FinalSnappingItem.Companion.m681getPreviousItembbeMdSM())) {
                    f = 0.0f;
                }
            }
            f = f2;
