...
public final class LazyListSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyListState lazyListState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyListSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1
            ...
            public float calculateSnapOffset(float f) {
                ...
                return SnapFlingBehaviorKt.m638calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem(LazyListState.this.getDensity$foundation_release(), f), f2, f3);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyListLayoutInfo lazyListLayoutInfo) {
        return (int) (lazyListLayoutInfo.getOrientation() == Orientation.Vertical ? lazyListLayoutInfo.mo963getViewportSizeYbymL2g() & 4294967295L : lazyListLayoutInfo.mo963getViewportSizeYbymL2g() >> 32);
    }

    public static final int calculateFinalSnappingItem(Density density, float f) {
        if (Math.abs(f) < density.mo430toPx0680j_4(SnapFlingBehaviorKt.getMinFlingVelocityDp())) {
            return FinalSnappingItem.Companion.m633getClosestItembbeMdSM();
        }
        return f > 0.0f ? FinalSnappingItem.Companion.m634getNextItembbeMdSM() : FinalSnappingItem.Companion.m635getPreviousItembbeMdSM();
    }
}
