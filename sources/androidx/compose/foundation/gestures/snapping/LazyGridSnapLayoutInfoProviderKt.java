...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyGridState lazyGridState, final SnapPosition snapPosition) {
        return new SnapLayoutInfoProvider() { // from class: androidx.compose.foundation.gestures.snapping.LazyGridSnapLayoutInfoProviderKt$SnapLayoutInfoProvider$1
            ...
            public float calculateSnapOffset(float f) {
                ...
                return SnapFlingBehaviorKt.m682calculateFinalOffsetFhqu1e0(LazyListSnapLayoutInfoProviderKt.calculateFinalSnappingItem(LazyGridState.this.getDensity$foundation(), f), f2, f3);
            }
        };
    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        long mo1209getViewportSizeYbymL2g;
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            mo1209getViewportSizeYbymL2g = lazyGridLayoutInfo.mo1209getViewportSizeYbymL2g() & 4294967295L;
        } else {
            mo1209getViewportSizeYbymL2g = lazyGridLayoutInfo.mo1209getViewportSizeYbymL2g() >> 32;
        }
        return (int) mo1209getViewportSizeYbymL2g;
    }

    public static final int sizeOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        long mo1205getSizeYbymL2g;
        if (orientation == Orientation.Vertical) {
            mo1205getSizeYbymL2g = lazyGridItemInfo.mo1205getSizeYbymL2g() & 4294967295L;
        } else {
            mo1205getSizeYbymL2g = lazyGridItemInfo.mo1205getSizeYbymL2g() >> 32;
        }
        return (int) mo1205getSizeYbymL2g;
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return IntOffset.m8289getYimpl(lazyGridItemInfo.mo1204getOffsetnOccac());
        }
        return IntOffset.m8288getXimpl(lazyGridItemInfo.mo1204getOffsetnOccac());
    }
}
