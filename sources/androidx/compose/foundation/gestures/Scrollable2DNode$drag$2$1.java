...
@DebugMetadata(c = "androidx.compose.foundation.gestures.Scrollable2DNode$drag$2$1", f = "Scrollable2D.kt", i = {}, l = {DownloaderService.STATUS_WAITING_TO_RETRY}, m = "invokeSuspend", n = {}, s = {})
...
final class Scrollable2DNode$drag$2$1 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public static final Unit invokeSuspend$lambda$0(NestedScrollScope nestedScrollScope, DragEvent.DragDelta dragDelta) {
        nestedScrollScope.mo535scrollByWithOverscrollOzD1aCk(dragDelta.m476getDeltaF1C5BW0(), NestedScrollSource.Companion.m6463getUserInputWNlRxjI());
        return Unit.INSTANCE;
    }
}
