...
public final class MagnifierElement extends ModifierNodeElement<MagnifierNode> {
    ...
    public void update(MagnifierNode magnifierNode) {
        magnifierNode.m344update5F03MCQ(this.sourceCenter, this.magnifierCenter, this.zoom, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, this.onSizeChanged, this.platformMagnifierFactory);
    }
