...
public final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, SemanticsModifierNode {
    ...
    public final long m289getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public final void m290setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m5349equalsimpl0(this.color, Color.Companion.m5384getUnspecified0d7_KjU())) {
            DrawScope.m5916drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m5915drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m5349equalsimpl0(this.color, Color.Companion.m5384getUnspecified0d7_KjU())) {
            OutlineKt.m5621drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m5619drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        Outline outline;
        if (Size.m5168equalsimpl0(contentDrawScope.mo5922getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
        ...
        this.lastSize = contentDrawScope.mo5922getSizeNHjbRc();
    ...
    public static final Unit getOutline$lambda$0(BackgroundNode backgroundNode, ContentDrawScope contentDrawScope) {
        backgroundNode.tmpOutline = backgroundNode.shape.mo344createOutlinePq9zytI(contentDrawScope.mo5922getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
