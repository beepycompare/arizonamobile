...
final class BorderCache {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x003c, code lost:
        if (androidx.compose.ui.graphics.ImageBitmapConfig.m4763equalsimpl(r9, r1 != null ? androidx.compose.ui.graphics.ImageBitmapConfig.m4761boximpl(r1.mo4402getConfig_sVssgQ()) : null) != false) goto L27;
     */
    /* renamed from: drawBorderCache-EMwLDEs  reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final ImageBitmap m266drawBorderCacheEMwLDEs(CacheDrawScope cacheDrawScope, long j, int i, Function1<? super DrawScope, Unit> function1) {
        int i2;
        ImageBitmap imageBitmap = this.imageBitmap;
        Canvas canvas = this.canvas;
        ImageBitmapConfig m4761boximpl = imageBitmap != null ? ImageBitmapConfig.m4761boximpl(imageBitmap.mo4402getConfig_sVssgQ()) : null;
        boolean z = false;
        ...
        z = true;
        if (imageBitmap == null || canvas == null || Float.intBitsToFloat((int) (cacheDrawScope.m4077getSizeNHjbRc() >> 32)) > imageBitmap.getWidth() || Float.intBitsToFloat((int) (cacheDrawScope.m4077getSizeNHjbRc() & 4294967295L)) > imageBitmap.getHeight() || !z) {
            imageBitmap = ImageBitmapKt.m4774ImageBitmapx__hDU$default((int) (j >> 32), (int) (j & 4294967295L), i2, false, null, 24, null);
            this.imageBitmap = imageBitmap;
