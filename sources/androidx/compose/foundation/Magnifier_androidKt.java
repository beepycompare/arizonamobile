...
public final class Magnifier_androidKt {
    ...
    public static /* synthetic */ Modifier m336magnifierUpNRX3w$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, long j, float f2, float f3, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
        ...
        if ((i & 16) != 0) {
            j = DpSize.Companion.m7358getUnspecifiedMYxV2XQ();
        }
        if ((i & 32) != 0) {
        ...
        return m335magnifierUpNRX3w(modifier, function1, function12, function13, f, j, f2, f3, z);
    }

    /* renamed from: magnifier-UpNRX3w  reason: not valid java name */
    public static final Modifier m335magnifierUpNRX3w(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, long j, float f2, float f3, boolean z) {
        return m338magnifierjPUL71Q$default(modifier, function1, function12, function13, f, false, j, f2, f3, z, null, 512, null);
    }

    /* renamed from: magnifier-jPUL71Q$default  reason: not valid java name */
    public static /* synthetic */ Modifier m338magnifierjPUL71Q$default(Modifier modifier, Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, Object obj) {
        if ((i & 2) != 0) {
            function12 = null;
        }
        if ((i & 4) != 0) {
        ...
        return m337magnifierjPUL71Q(modifier, function1, function12, function13, f, z, j, f2, f3, z2, platformMagnifierFactory);
    }

    /* renamed from: magnifier-jPUL71Q  reason: not valid java name */
    public static final Modifier m337magnifierjPUL71Q(Modifier modifier, Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
