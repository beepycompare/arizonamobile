...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m333checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m8210getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
