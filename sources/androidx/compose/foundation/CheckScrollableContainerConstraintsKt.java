...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m300checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m7948getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
