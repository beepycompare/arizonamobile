...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m315checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m8112getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
