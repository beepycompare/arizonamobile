...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m299checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m7947getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
