...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m289checkScrollableContainerConstraintsK40F9xA(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            if (Constraints.m7203getMaxHeightimpl(j) != Integer.MAX_VALUE) {
                return;
            }
        ...
        if (Constraints.m7204getMaxWidthimpl(j) != Integer.MAX_VALUE) {
            return;
        }
