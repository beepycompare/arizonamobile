...
final class VerticalScrollableClipShape implements Shape {
    ...
    public Outline mo344createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(-mo428roundToPx0680j_4, 0.0f, Float.intBitsToFloat((int) (j >> 32)) + mo428roundToPx0680j_4, Float.intBitsToFloat((int) (j & 4294967295L))));
    }
}
