...
public final class LazyGridState implements ScrollableState {
    ...
    public final LazyGridPrefetchStrategy getPrefetchStrategy$foundation_release() {
    ...
    */
    ...
    public final void applyMeasureResult$foundation_release(LazyGridMeasureResult lazyGridMeasureResult, boolean z, boolean z2) {
        this.prefetchState.setIdealNestedPrefetchCount$foundation_release(lazyGridMeasureResult.getVisibleItemsInfo().size());
    ...
    public static final class Companion {
        ...
        public final Saver<LazyGridState, ?> saver$foundation_release(final LazyLayoutCacheWindow lazyLayoutCacheWindow) {
