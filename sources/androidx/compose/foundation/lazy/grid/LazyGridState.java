...
public final class LazyGridState implements ScrollableState {
    ...
    public final MutableState<Unit> m1217getPlacementScopeInvalidatorzYiylxw$foundation() {
    ...
    public final MutableState<Unit> m1216getMeasurementScopeInvalidatorzYiylxw$foundation() {
    ...
    */
    ...
    public final void applyMeasureResult$foundation(LazyGridMeasureResult lazyGridMeasureResult, boolean z, boolean z2) {
        ...
        if (!z && this.hasLookaheadOccurred) {
            ...
            try {
                if (this._lazyLayoutScrollDeltaBetweenPasses.isActive$foundation() && lazyGridMeasureResult.getFirstVisibleLineScrollOffset() == this.scrollPosition.getScrollOffset() && (firstVisibleLine = lazyGridMeasureResult.getFirstVisibleLine()) != null && (items = firstVisibleLine.getItems()) != null && (lazyGridMeasuredItem = (LazyGridMeasuredItem) ArraysKt.firstOrNull(items)) != null && lazyGridMeasuredItem.getIndex() == this.scrollPosition.getIndex()) {
