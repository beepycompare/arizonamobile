...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1012childConstraintsJhjzzOo$foundation_release(int i, int i2) {
        int i3;
        if (i2 == 1) {
        ...
        if (this.isVertical) {
            return Constraints.Companion.m7961fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.Companion.m7960fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int m987getCurrentLineSpanimpl = GridItemSpan.m987getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m990unboximpl());
            LazyGridMeasuredItem m1011getAndMeasurem8Kt_7k = this.measuredItemProvider.m1011getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i4, m1012childConstraintsJhjzzOo$foundation_release(i3, m987getCurrentLineSpanimpl), i3, m987getCurrentLineSpanimpl, i2);
            i3 += m987getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = m1011getAndMeasurem8Kt_7k;
        }
