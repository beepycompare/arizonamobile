...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1215childConstraintsJhjzzOo$foundation(int i, int i2) {
        int i3;
        ...
        if (this.isVertical) {
            return Constraints.Companion.m8125fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.Companion.m8124fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int m1195getCurrentLineSpanimpl = GridItemSpan.m1195getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m1198unboximpl());
            LazyGridMeasuredItem m1214getAndMeasurem8Kt_7k = this.measuredItemProvider.m1214getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i4, m1215childConstraintsJhjzzOo$foundation(i3, m1195getCurrentLineSpanimpl), i3, m1195getCurrentLineSpanimpl, i2);
            i3 += m1195getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = m1214getAndMeasurem8Kt_7k;
        }
