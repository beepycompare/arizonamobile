...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m1191boximpl(long j) {
        return new GridItemSpan(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1192constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1193equalsimpl(long j, Object obj) {
        return (obj instanceof GridItemSpan) && j == ((GridItemSpan) obj).m1198unboximpl();
    }
    ...
    public static final int m1195getCurrentLineSpanimpl(long j) {
        return (int) j;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1196hashCodeimpl(long j) {
    ...
    public boolean equals(Object obj) {
        return m1193equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m1196hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m1197toStringimpl(this.packedValue);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1198unboximpl() {
