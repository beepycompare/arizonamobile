...
public final class LazyGridLayoutInfoKt {
        ...
        while (i < visibleItemsInfo.size()) {
            ...
            if (visibleLinesAverageMainAxisSize$lineOf == -1) {
                ...
                while (i < visibleItemsInfo.size() && visibleLinesAverageMainAxisSize$lineOf(z, lazyGridLayoutInfo, i) == visibleLinesAverageMainAxisSize$lineOf) {
                    if (z) {
                        mo1002getSizeYbymL2g = visibleItemsInfo.get(i).mo1002getSizeYbymL2g() & 4294967295L;
                    } else {
                        mo1002getSizeYbymL2g = visibleItemsInfo.get(i).mo1002getSizeYbymL2g() >> 32;
                    }
                    i4 = Math.max(i4, (int) mo1002getSizeYbymL2g);
                    i++;
                }
                i2 += i4;
                i3++;
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        return (int) (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical ? lazyGridLayoutInfo.mo1006getViewportSizeYbymL2g() & 4294967295L : lazyGridLayoutInfo.mo1006getViewportSizeYbymL2g() >> 32);
    }
}
