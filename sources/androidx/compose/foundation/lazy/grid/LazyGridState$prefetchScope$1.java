        ...
        try {
            ...
            if (lazyGridMeasureResult2 != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    long m7210unboximpl = pair.getSecond().m7210unboximpl();
                    z = lazyGridState.executeRequestsInHighPriorityMode;
                    arrayList.add(prefetchState$foundation_release.m1050schedulePrecompositionAndPremeasure_EkL_Y$foundation_release(intValue, m7210unboximpl, z, new Function1() { // from class: androidx.compose.foundation.lazy.grid.LazyGridState$prefetchScope$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            Unit scheduleLinePrefetch$lambda$4$lambda$3$lambda$2$lambda$1;
                            scheduleLinePrefetch$lambda$4$lambda$3$lambda$2$lambda$1 = LazyGridState$prefetchScope$1.scheduleLinePrefetch$lambda$4$lambda$3$lambda$2$lambda$1(arrayList2, intRef, invoke, function1, i, lazyGridMeasureResult2, (LazyLayoutPrefetchState.PrefetchResultScope) obj);
    ...
    public static final Unit scheduleLinePrefetch$lambda$4$lambda$3$lambda$2$lambda$1(List list, Ref.IntRef intRef, List list2, Function1 function1, int i, LazyGridMeasureResult lazyGridMeasureResult, LazyLayoutPrefetchState.PrefetchResultScope prefetchResultScope) {
        ...
        for (int i3 = 0; i3 < placeablesCount; i3++) {
            if (lazyGridMeasureResult.getOrientation() == Orientation.Vertical) {
                mo1052getSizeYEO4UFw = prefetchResultScope.mo1052getSizeYEO4UFw(i3) & 4294967295L;
            } else {
                mo1052getSizeYEO4UFw = prefetchResultScope.mo1052getSizeYEO4UFw(i3) >> 32;
            }
            i2 += (int) mo1052getSizeYEO4UFw;
        }
        if (list != null) {
