...
public interface LazyGridPrefetchScope {
    ...
    default List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int i, Function1<? super LazyGridPrefetchResultScope, Unit> function1) {
        return scheduleLinePrefetch(i);
    }
}
