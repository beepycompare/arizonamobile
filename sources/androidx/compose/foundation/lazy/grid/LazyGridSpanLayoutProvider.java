...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(GridItemSpan.m972boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    */
        ...
        if (bucketSize % getBucketSize() == 0) {
            ...
            if (2 <= i9 && i9 < bucketSize2) {
                ...
                while (i3 < this.slotsPerLine && i10 < getTotalSize()) {
                    ...
                    i10++;
                    arrayList.add(GridItemSpan.m972boximpl(LazyGridSpanKt.GridItemSpan(firstItemKnownSpan)));
    ...
    public final int getLineIndexOfItem(final int i) {
        ...
        int binarySearch$default = CollectionsKt.binarySearch$default(this.buckets, 0, 0, new Function1() { // from class: androidx.compose.foundation.lazy.grid.LazyGridSpanLayoutProvider$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                ...
                lineIndexOfItem$lambda$8 = LazyGridSpanLayoutProvider.getLineIndexOfItem$lambda$8(i, (LazyGridSpanLayoutProvider.Bucket) obj);
    ...
    public final int spanOf(int i, int i2) {
        ...
        return GridItemSpan.m976getCurrentLineSpanimpl(interval.getValue().getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(i - interval.getStartIndex())).m979unboximpl());
    }
