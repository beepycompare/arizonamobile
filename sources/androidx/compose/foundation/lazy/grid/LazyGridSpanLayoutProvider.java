...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(GridItemSpan.m1191boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    */
    public final LineConfiguration getLineConfiguration(int i) {
        ...
        int i5;
        int i6;
        if (!this.gridContent.getHasCustomSpans$foundation()) {
        ...
        if (bucketSize % getBucketSize() == 0) {
            ...
            if (2 <= i9 && i9 < bucketSize2) {
                ...
                while (i3 < this.slotsPerLine && i10 < getTotalSize()) {
                    ...
                    i10++;
                    arrayList.add(GridItemSpan.m1191boximpl(LazyGridSpanKt.GridItemSpan(firstItemKnownSpan)));
    ...
    public final int spanOf(int i, int i2) {
        ...
        return GridItemSpan.m1195getCurrentLineSpanimpl(interval.getValue().getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(i - interval.getStartIndex())).m1198unboximpl());
    }
