...
public final class LazyGridScrollScopeKt$LazyLayoutScrollScope$1 implements LazyLayoutScrollScope, ScrollScope {
    ...
    public void snapToItem(int i, int i2) {
        this.$state.snapToItemIndexInternal$foundation(i, i2, true);
    }
    ...
    public int calculateDistanceTo(int i, int i2) {
        ...
        if (i > getLastVisibleItemIndex() || firstVisibleItemIndex > i) {
            ...
            r2 = (LazyGridLayoutInfoKt.visibleLinesAverageMainAxisSize(layoutInfo) * (((i - getFirstVisibleItemIndex()) + ((slotsPerLine$foundation - 1) * ((i < getFirstVisibleItemIndex() ? 1 : 0) != 0 ? -1 : 1))) / slotsPerLine$foundation)) - getFirstVisibleItemScrollOffset();
        } else {
            ...
            if (layoutInfo.getOrientation() == Orientation.Vertical) {
                if (lazyGridItemInfo2 != null) {
                    num = Integer.valueOf(IntOffset.m8289getYimpl(lazyGridItemInfo2.mo1204getOffsetnOccac()));
                }
            } else if (lazyGridItemInfo2 != null) {
                num = Integer.valueOf(IntOffset.m8288getXimpl(lazyGridItemInfo2.mo1204getOffsetnOccac()));
            }
            if (num != null) {
                r2 = num.intValue();
            }
