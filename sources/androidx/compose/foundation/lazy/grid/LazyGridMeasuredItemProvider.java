...
public abstract class LazyGridMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public abstract LazyGridMeasuredItem mo1208createItemO3s9Psw(int i, Object obj, Object obj2, int i2, int i3, List<? extends Placeable> list, long j, int i4, int i5);
    ...
    public LazyGridMeasuredItem mo1186getAndMeasurehBUhpc(int i, int i2, int i3, long j) {
        return m1214getAndMeasurem8Kt_7k(i, j, i2, i3, this.defaultMainAxisSpacing);
    }

    /* renamed from: getAndMeasure-m8Kt_7k  reason: not valid java name */
    public final LazyGridMeasuredItem m1214getAndMeasurem8Kt_7k(int i, long j, int i2, int i3, int i4) {
        int m8114getMinHeightimpl;
        Object key = this.itemProvider.getKey(i);
        Object contentType = this.itemProvider.getContentType(i);
        List<Placeable> list = m1248getPlaceables3p2s80s(this.measureScope, i, j);
        if (Constraints.m8111getHasFixedWidthimpl(j)) {
            m8114getMinHeightimpl = Constraints.m8115getMinWidthimpl(j);
        } else {
        ...
        return mo1208createItemO3s9Psw(i, key, contentType, m8114getMinHeightimpl, i4, list, j, i2, i3);
    }
