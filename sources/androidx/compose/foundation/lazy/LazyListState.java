...
public final class LazyListState implements ScrollableState {
    ...
    public final boolean getSkipItemPlacementAnimation$foundation() {
    ...
    public final MutableState<Unit> m1189getMeasurementScopeInvalidatorzYiylxw$foundation() {
    ...
    */
    ...
    public final MutableState<Unit> m1190getPlacementScopeInvalidatorzYiylxw$foundation() {
            ...
            if (continuation instanceof LazyListState$animateScrollToItem$1) {
                ...
                if ((lazyListState$animateScrollToItem$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i3 != 0) {
                        ...
                        if (ScrollableState.scroll$default(this, null, new LazyListState$animateScrollToItem$2(this, i, i2, null), lazyListState$animateScrollToItem$12, 1, null) == coroutine_suspended) {
