...
public abstract class LazyStaggeredGridMeasureProvider extends LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1293createItempitSLOA(int i, int i2, int i3, Object obj, Object obj2, List<? extends Placeable> list, long j);
    ...
    private final long m1299childConstraintsJhjzzOo(int i, int i2) {
        int i3;
        ...
        if (this.isVertical) {
            return Constraints.Companion.m8125fixedWidthOenEA2s(i3);
        }
        return Constraints.Companion.m8124fixedHeightOenEA2s(i3);
    }

    /* renamed from: getAndMeasure-jy6DScQ  reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1300getAndMeasurejy6DScQ(int i, long j) {
        ...
        long m1299childConstraintsJhjzzOo = m1299childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return mo1293createItempitSLOA(i, coerceAtMost, coerceAtMost2, key, contentType, m1248getPlaceables3p2s80s(this.measureScope, i, m1299childConstraintsJhjzzOo), m1299childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc  reason: avoid collision after fix types in other method */
    public LazyStaggeredGridMeasuredItem mo1186getAndMeasurehBUhpc(int i, int i2, int i3, long j) {
        return mo1293createItempitSLOA(i, i2, i3, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), m1248getPlaceables3p2s80s(this.measureScope, i, j), j);
    }
