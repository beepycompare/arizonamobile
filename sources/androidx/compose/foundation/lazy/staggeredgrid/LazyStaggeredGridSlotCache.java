...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1081invoke0kLqBqw(Density density, long j) {
        if (this.cachedSizes != null && Constraints.m7197equalsimpl0(this.cachedConstraints, j) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m7191boximpl(j));
