...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1278invoke0kLqBqw(Density density, long j) {
        if (this.cachedSizes != null && Constraints.m8106equalsimpl0(this.cachedConstraints, j) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m8100boximpl(j));
