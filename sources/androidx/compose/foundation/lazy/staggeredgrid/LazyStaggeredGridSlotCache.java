...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo938invoke0kLqBqw(Density density, long j) {
        if (this.cachedSizes != null && Constraints.m6630equalsimpl0(this.cachedConstraints, j) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m6624boximpl(j));
