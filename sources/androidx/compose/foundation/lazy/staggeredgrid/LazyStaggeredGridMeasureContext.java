...
public final class LazyStaggeredGridMeasureContext {
    ...
    public final int m1290getLaneInfoSZVOQXA(long j) {
        int i = (int) (j >> 32);
    ...
    public final boolean m1292isFullSpanSZVOQXA(long j) {
    ...
    private LazyStaggeredGridMeasureContext(LazyStaggeredGridState lazyStaggeredGridState, List<Integer> list, final LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, final LazyStaggeredGridSlots lazyStaggeredGridSlots, long j, final boolean z, final LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j2, int i2, int i3, boolean z2, int i4, CoroutineScope coroutineScope, boolean z3, boolean z4, List<? extends LazyStaggeredGridItemInfo> list2, GraphicsContext graphicsContext) {
        ...
        this.measuredItemProvider = new LazyStaggeredGridMeasureProvider(z, lazyStaggeredGridItemProvider, lazyLayoutMeasureScope, lazyStaggeredGridSlots) { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasureContext$measuredItemProvider$1
            ...
            public LazyStaggeredGridMeasuredItem mo1293createItempitSLOA(int i5, int i6, int i7, Object obj, Object obj2, List<? extends Placeable> list3, long j3) {
                return new LazyStaggeredGridMeasuredItem(i5, obj, list3, LazyStaggeredGridMeasureContext.this.isVertical(), LazyStaggeredGridMeasureContext.this.getMainAxisSpacing(), i6, i7, LazyStaggeredGridMeasureContext.this.getBeforeContentPadding(), LazyStaggeredGridMeasureContext.this.getAfterContentPadding(), obj2, LazyStaggeredGridMeasureContext.this.getState().getItemAnimator$foundation(), j3, null);
            }
        };
        this.laneInfo = lazyStaggeredGridState.getLaneInfo$foundation();
    ...
    public final long m1288getConstraintsmsEJaDk() {
    ...
    public final long m1289getContentOffsetnOccac() {
    ...
    public final long m1291getSpanRangelOCCd4c(LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, int i, int i2) {
        boolean isFullSpan = lazyStaggeredGridItemProvider.getSpanProvider().isFullSpan(i);
        int i3 = isFullSpan ? this.laneCount : 1;
        if (isFullSpan) {
            i2 = 0;
        }
        return SpanRange.m1307constructorimpl(i2, i3);
    }
}
