...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final LazyLayoutMeasurePolicy m1298rememberStaggeredGridMeasurePolicyqKj4JfE(final LazyStaggeredGridState lazyStaggeredGridState, final Function0<? extends LazyStaggeredGridItemProvider> function0, final PaddingValues paddingValues, final boolean z, final Orientation orientation, final float f, float f2, final CoroutineScope coroutineScope, final LazyGridStaggeredGridSlotsProvider lazyGridStaggeredGridSlotsProvider, final GraphicsContext graphicsContext, Composer composer, int i) {
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new LazyLayoutMeasurePolicy() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final MeasureResult mo1174measure0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    float beforePadding;
                    float afterPadding;
                    float startPadding;
                    long m8282constructorimpl;
                    ObservableScopeInvalidator.m1258attachToScopeimpl(LazyStaggeredGridState.this.m1304getMeasurementScopeInvalidatorzYiylxw$foundation());
                    boolean z2 = LazyStaggeredGridState.this.getHasLookaheadOccurred$foundation() || lazyLayoutMeasureScope.isLookingAhead();
                    CheckScrollableContainerConstraintsKt.m315checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots mo1278invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo1278invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo428roundToPx0680j_4(beforePadding);
                    ...
                    int i3 = lazyLayoutMeasureScope.mo428roundToPx0680j_4(afterPadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo428roundToPx0680j_4(startPadding);
                    int m8112getMaxHeightimpl = ((z3 ? Constraints.m8112getMaxHeightimpl(j) : Constraints.m8113getMaxWidthimpl(j)) - i2) - i3;
                    if (z3) {
                        m8282constructorimpl = IntOffset.m8282constructorimpl((i2 & 4294967295L) | (i4 << 32));
                    } else {
                        m8282constructorimpl = IntOffset.m8282constructorimpl((i2 << 32) | (i4 & 4294967295L));
                    }
                    long j2 = m8282constructorimpl;
                    PaddingValues paddingValues2 = paddingValues;
                    int i5 = lazyLayoutMeasureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    int i6 = lazyLayoutMeasureScope.mo428roundToPx0680j_4(Dp.m8160constructorimpl(paddingValues3.mo1002calculateTopPaddingD9Ej5fM() + paddingValues3.mo999calculateBottomPaddingD9Ej5fM()));
                    LazyStaggeredGridMeasureResult m1297measureStaggeredGridC6celF4 = LazyStaggeredGridMeasureKt.m1297measureStaggeredGridC6celF4(lazyLayoutMeasureScope, LazyStaggeredGridState.this, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, LazyStaggeredGridState.this.getPinnedItems$foundation(), LazyStaggeredGridState.this.getBeyondBoundsInfo$foundation()), invoke, mo1278invoke0kLqBqw, Constraints.m8103copyZbe2FdA$default(j, ConstraintsKt.m8130constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m8129constrainHeightK40F9xA(j, i6), 0, 10, null), z3, z, j2, m8112getMaxHeightimpl, lazyLayoutMeasureScope.mo428roundToPx0680j_4(f), i2, i3, coroutineScope, z2, lazyLayoutMeasureScope.isLookingAhead(), LazyStaggeredGridState.this.getApproachLayoutInfo$foundation(), graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation$default(LazyStaggeredGridState.this, m1297measureStaggeredGridC6celF4, lazyLayoutMeasureScope.isLookingAhead(), false, 4, null);
                    return m1297measureStaggeredGridC6celF4;
                }
            };
    ...
    public static final float startPadding(PaddingValues paddingValues, Orientation orientation, LayoutDirection layoutDirection) {
        ...
        if (i != 1) {
            ...
            return paddingValues.mo1002calculateTopPaddingD9Ej5fM();
        }
    ...
    public static final float beforePadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i == 1) {
            return z ? paddingValues.mo999calculateBottomPaddingD9Ej5fM() : paddingValues.mo1002calculateTopPaddingD9Ej5fM();
        } else if (i == 2) {
            if (z) {
    ...
    public static final float afterPadding(PaddingValues paddingValues, Orientation orientation, boolean z, LayoutDirection layoutDirection) {
        int i = WhenMappings.$EnumSwitchMapping$0[orientation.ordinal()];
        if (i == 1) {
            return z ? paddingValues.mo1002calculateTopPaddingD9Ej5fM() : paddingValues.mo999calculateBottomPaddingD9Ej5fM();
        } else if (i == 2) {
            if (z) {
                return PaddingKt.calculateStartPadding(paddingValues, layoutDirection);
            }
