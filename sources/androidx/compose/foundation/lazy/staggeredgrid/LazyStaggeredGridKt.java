...
public final class LazyStaggeredGridKt {
    ...
    public static final Unit LazyStaggeredGrid_w41Enmo$lambda$0(LazyStaggeredGridState lazyStaggeredGridState, Orientation orientation, LazyGridStaggeredGridSlotsProvider lazyGridStaggeredGridSlotsProvider, Modifier modifier, PaddingValues paddingValues, boolean z, FlingBehavior flingBehavior, boolean z2, OverscrollEffect overscrollEffect, float f, float f2, Function1 function1, int i, int i2, int i3, Composer composer, int i4) {
        m1286LazyStaggeredGridw41Enmo(lazyStaggeredGridState, orientation, lazyGridStaggeredGridSlotsProvider, modifier, paddingValues, z, flingBehavior, z2, overscrollEffect, f, f2, function1, composer, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
                ...
                if (i8 != 0) {
                    ...
                    if (!startRestartGroup.shouldExecute((i14 & 306783379) == 306783378 || (i13 & 19) != 18, i14 & 1)) {
                        ...
                        if ((i & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                            ...
                            if ((i3 & 64) != 0) {
                                m8160constructorimpl = f;
                                m8160constructorimpl2 = f2;
                                i15 = i14 & (-3670017);
                            } else {
                                m8160constructorimpl = f;
                                m8160constructorimpl2 = f2;
                            ...
                            PaddingValues m1043PaddingValues0680j_4 = i5 != 0 ? PaddingKt.m1043PaddingValues0680j_4(Dp.m8160constructorimpl(0.0f)) : obj2;
                            ...
                            z6 = i7 == 0 ? z3 : true;
                            m8160constructorimpl = i9 != 0 ? Dp.m8160constructorimpl(0.0f) : f;
                            m8160constructorimpl2 = i11 != 0 ? Dp.m8160constructorimpl(0.0f) : f2;
                        ...
                        int i21 = i15;
                        boolean z9 = z7;
                        float f5 = m8160constructorimpl;
                        float f6 = m8160constructorimpl2;
                        LazyLayoutMeasurePolicy m1298rememberStaggeredGridMeasurePolicyqKj4JfE = LazyStaggeredGridMeasurePolicyKt.m1298rememberStaggeredGridMeasurePolicyqKj4JfE(lazyStaggeredGridState, rememberStaggeredGridItemProviderLambda, paddingValues3, z9, orientation, f5, f6, (CoroutineScope) rememberedValue, lazyGridStaggeredGridSlotsProvider, (GraphicsContext) consume, startRestartGroup, ((i15 << 18) & 234881024) | i20);
