...
public final class LazyLayoutPrefetchState {
    ...
    /* compiled from: LazyLayoutPrefetchState.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bv\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\b\u0010\u0004\u001a\u00020\u0003H&\u0082\u0001\u0002\u0005\u0006ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0007À\u0006\u0001"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutPrefetchState$PrefetchHandle;", "", FacebookDialog.COMPLETION_GESTURE_CANCEL, "", "markAsUrgent", "Landroidx/compose/foundation/lazy/layout/DummyHandle;", "Landroidx/compose/foundation/lazy/layout/PrefetchHandleProvider$HandleAndRequestImpl;", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes.dex */
    ...
    public interface PrefetchResultScope {
        ...
        long mo1256getSizeYEO4UFw(int i);
    }
    ...
    public static /* synthetic */ PrefetchHandle m1251schedulePrecompositionAndPremeasureVKLhPVY$default(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, Function1 function1, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            function1 = null;
        }
        return lazyLayoutPrefetchState.m1253schedulePrecompositionAndPremeasureVKLhPVY(i, j, function1);
    }

    /* renamed from: schedulePrecompositionAndPremeasure-VKLhPVY  reason: not valid java name */
    public final PrefetchHandle m1253schedulePrecompositionAndPremeasureVKLhPVY(int i, long j, Function1<? super PrefetchResultScope, Unit> function1) {
        return m1254schedulePrecompositionAndPremeasure_EkL_Y$foundation(i, j, true, function1);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation$default  reason: not valid java name */
    public static /* synthetic */ PrefetchHandle m1252schedulePrecompositionAndPremeasure_EkL_Y$foundation$default(LazyLayoutPrefetchState lazyLayoutPrefetchState, int i, long j, boolean z, Function1 function1, int i2, Object obj) {
        Function1<? super PrefetchResultScope, Unit> function12 = function1;
        if ((i2 & 8) != 0) {
            function12 = null;
        }
        return lazyLayoutPrefetchState.m1254schedulePrecompositionAndPremeasure_EkL_Y$foundation(i, j, z, function12);
    }

    /* renamed from: schedulePrecompositionAndPremeasure-_EkL_-Y$foundation  reason: not valid java name */
    public final PrefetchHandle m1254schedulePrecompositionAndPremeasure_EkL_Y$foundation(int i, long j, boolean z, Function1<? super PrefetchResultScope, Unit> function1) {
        PrefetchHandle m1269schedulePremeasurem8Kt_7k;
        PrefetchHandleProvider prefetchHandleProvider = this.prefetchHandleProvider;
        return (prefetchHandleProvider == null || (m1269schedulePremeasurem8Kt_7k = prefetchHandleProvider.m1269schedulePremeasurem8Kt_7k(i, j, this.prefetchMetrics, z, function1)) == null) ? DummyHandle.INSTANCE : m1269schedulePremeasurem8Kt_7k;
    }
    ...
    private final class NestedPrefetchScopeImpl implements NestedPrefetchScope {
        ...
        public void mo1255schedulePrecompositionAndPremeasure0kLqBqw(int i, long j) {
            PrefetchHandleProvider prefetchHandleProvider$foundation = LazyLayoutPrefetchState.this.getPrefetchHandleProvider$foundation();
            if (prefetchHandleProvider$foundation == null) {
                return;
            }
            this._requests.add(prefetchHandleProvider$foundation.m1268createNestedPrefetchRequestVKLhPVY(i, j, LazyLayoutPrefetchState.this.prefetchMetrics));
        }
    }
}
