...
public final class LazyLayoutPinnedItemList implements List<PinnedItem>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m1134removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m1135removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final void pin$foundation(PinnedItem pinnedItem) {
        this.items.add(pinnedItem);
    }

    public final void release$foundation(PinnedItem pinnedItem) {
