...
public final class LazyLayoutItemContentFactory$CachedItemContent$createContentLambda$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (i2 != -1) {
            ...
            composer2 = composer;
            LazyLayoutItemContentFactoryKt.m1046SkippableItemJVlU9Rs(invoke, StableValue.m1086constructorimpl(saveableStateHolder), i2, StableValue.m1086constructorimpl(this.this$1.getKey()), composer2, 0);
