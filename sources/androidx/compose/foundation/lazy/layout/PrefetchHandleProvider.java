...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1269schedulePremeasurem8Kt_7k(int i, long j, PrefetchMetrics prefetchMetrics, boolean z, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    public final PrefetchRequest m1268createNestedPrefetchRequestVKLhPVY(int i, long j, PrefetchMetrics prefetchMetrics) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    public final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest, LazyLayoutPrefetchState.PrefetchResultScope {
        ...
        public HandleAndRequestImpl(int i, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.startTime = TimeSource.Monotonic.INSTANCE.m11316markNowz9LOYto();
        }
        ...
        private HandleAndRequestImpl(PrefetchHandleProvider prefetchHandleProvider, int i, long j, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.premeasureConstraints = Constraints.m8100boximpl(j);
        }
        ...
        public long mo1256getSizeYEO4UFw(int i) {
            SubcomposeLayoutState.PrecomposedSlotHandle precomposedSlotHandle = this.precomposeHandle;
            return precomposedSlotHandle != null ? precomposedSlotHandle.mo6845getSizeYEO4UFw(i) : IntSize.Companion.m8336getZeroYbymL2g();
        }
        ...
        private final void updateElapsedAndAvailableTime() {
            long m11316markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m11316markNowz9LOYto();
            long m11212getInWholeNanosecondsimpl = Duration.m11212getInWholeNanosecondsimpl(TimeSource.Monotonic.ValueTimeMark.m11327minus6eNON_k(m11316markNowz9LOYto, this.startTime));
            this.elapsedTimeNanos = m11212getInWholeNanosecondsimpl;
            long j = this.availableTimeNanos - m11212getInWholeNanosecondsimpl;
            this.availableTimeNanos = j;
            this.startTime = m11316markNowz9LOYto;
            AndroidTrace_androidKt.traceValue("compose:lazy:prefetch:available_time_nanos", j);
        }
            ...
            if (!this.isCanceled) {
                ...
                if (index >= 0 && index < itemCount) {
                    ...
                    if (!this.isMeasured && constraints != null) {
                        ...
                        try {
                            m1270performMeasureBRTryo0(constraints.m8119unboximpl());
        ...
        private final void m1270performMeasureBRTryo0(long j) {
            if (this.isCanceled) {
            ...
            if (precomposedSlotHandle != null) {
                ...
                for (int i = 0; i < placeablesCount; i++) {
                    precomposedSlotHandle.mo6846premeasure0kLqBqw(i, j);
                }
                return;
            }
