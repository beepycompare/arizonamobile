...
public final class LazyLayoutItemAnimation {
    ...
    private static final long NotInitialized = IntOffset.m8282constructorimpl(9223372034707292159L);
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.Companion.m8299getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m8279boximpl(IntOffset.Companion.m8299getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.Companion), null, null, 12, null);
        ...
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m8279boximpl(IntOffset.Companion.m8299getZeronOccac()), null, 2, null);
    ...
    public final long m1235getRawOffsetnOccac() {
        return this.rawOffset;
    }

    /* renamed from: setRawOffset--gyyYBs  reason: not valid java name */
    public final void m1238setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }

    /* renamed from: getFinalOffset-nOcc-ac  reason: not valid java name */
    public final long m1232getFinalOffsetnOccac() {
        return this.finalOffset;
    }

    /* renamed from: setFinalOffset--gyyYBs  reason: not valid java name */
    public final void m1236setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m1230setPlacementDeltagyyYBs(long j) {
        this.placementDelta$delegate.setValue(IntOffset.m8279boximpl(j));
    }

    /* renamed from: getPlacementDelta-nOcc-ac  reason: not valid java name */
    public final long m1234getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta$delegate.getValue()).m8297unboximpl();
    }
    ...
    public final long m1233getLookaheadOffsetnOccac() {
        return this.lookaheadOffset;
    }

    /* renamed from: setLookaheadOffset--gyyYBs  reason: not valid java name */
    public final void m1237setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso  reason: not valid java name */
    public final void m1231animatePlacementDeltaar5cAso(long j, boolean z) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long m8291minusqkQi6aY = IntOffset.m8291minusqkQi6aY(m1234getPlacementDeltanOccac(), j);
        m1230setPlacementDeltagyyYBs(m8291minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = z;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, m8291minusqkQi6aY, null), 3, null);
    }
    ...
    public final void release() {
        ...
        m1230setPlacementDeltagyyYBs(IntOffset.Companion.m8299getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m1239getNotInitializednOccac() {
