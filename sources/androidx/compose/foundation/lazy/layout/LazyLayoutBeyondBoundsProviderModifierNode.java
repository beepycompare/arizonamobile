...
public final class LazyLayoutBeyondBoundsProviderModifierNode extends Modifier.Node implements LayoutModifierNode, BeyondBoundsLayoutProviderModifierNode, BeyondBoundsLayout {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$$ExternalSyntheticLambda0
    ...
    public <T> T mo1226layouto7g1Pn8(final int i, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> function1) {
        ...
        boolean m1224isForward4vf7U8o = m1224isForward4vf7U8o(i);
        LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsState = this.state;
        if (m1224isForward4vf7U8o) {
        ...
        T t = null;
        int i2 = 0;
        while (t == null && m1223hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, i) && i2 < coerceAtMost) {
            this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
            objectRef.element = (T) m1222addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, i);
            i2++;
            ...
            t = function1.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    boolean m1223hasMoreContentFR3nfPY;
                    m1223hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsProviderModifierNode.this.m1223hasMoreContentFR3nfPY(objectRef.element, i);
                    return m1223hasMoreContentFR3nfPY;
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1224isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6807getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6806getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6805getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6808getBelowhoxUOeE())) {
            return !this.reverseLayout;
        } else if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6809getLefthoxUOeE())) {
            ...
            return this.reverseLayout;
        } else if (!BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6810getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1222addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        int start = interval.getStart();
        int end = interval.getEnd();
        if (m1224isForward4vf7U8o(i)) {
            end++;
        } else {
            start--;
        }
    ...
    public final boolean m1223hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m1225isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        return m1224isForward4vf7U8o(i) ? interval.getEnd() < this.state.getItemCount() - 1 : interval.getStart() > 0;
    }

    /* renamed from: isOppositeToOrientation-4vf7U8o  reason: not valid java name */
    private final boolean m1225isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6805getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6808getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        } else if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6809getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6810getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        } else if (BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6807getBeforehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m6801equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.Companion.m6806getAfterhoxUOeE())) {
            return false;
        } else {
            LazyLayoutBeyondBoundsModifierLocalKt.access$unsupportedDirection();
            throw new KotlinNothingValueException();
