...
final class DpLazyLayoutCacheWindow implements LazyLayoutCacheWindow {
    ...
    public final float m1219getAheadD9Ej5fM() {
        return this.ahead;
    }

    /* renamed from: getBehind-D9Ej5fM  reason: not valid java name */
    public final float m1220getBehindD9Ej5fM() {
        return this.behind;
    }
    ...
    public int calculateAheadWindow(Density density, int i) {
        return density.mo428roundToPx0680j_4(this.ahead);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutCacheWindow
    public int calculateBehindWindow(Density density, int i) {
        return density.mo428roundToPx0680j_4(this.behind);
    }

    public int hashCode() {
        return (Dp.m8166hashCodeimpl(this.ahead) * 31) + Dp.m8166hashCodeimpl(this.behind);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DpLazyLayoutCacheWindow) {
            ...
            if (Dp.m8165equalsimpl0(dpLazyLayoutCacheWindow.ahead, this.ahead) && Dp.m8165equalsimpl0(dpLazyLayoutCacheWindow.behind, this.behind)) {
                return true;
            }
        }
        return false;
