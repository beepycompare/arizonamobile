...
public abstract class LazyLayoutMeasuredItemProvider<T extends LazyLayoutMeasuredItem> {
    ...
    public abstract T mo974getAndMeasurehBUhpc(int i, int i2, int i3, long j);

    /* renamed from: getPlaceables-3p2s80s  reason: not valid java name */
    public final List<Placeable> m1053getPlaceables3p2s80s(LazyLayoutMeasureScope lazyLayoutMeasureScope, int i, long j) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(compose.get(i2).mo6698measureBRTryo0(j));
        }
