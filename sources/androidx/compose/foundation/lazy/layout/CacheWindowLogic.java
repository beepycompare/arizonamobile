            ...
            while (true) {
                ...
                if ((((~j7) << c) & j7 & j) != j) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((j7 & j3) < j2 && i <= (i3 = iArr2[(i8 << 3) + i10]) && i3 <= i2) {
            ...
            if ((((~j8) << c) & j8 & j) != j) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((j8 & j3) < j2) {
                        ...
                        List<LazyLayoutPrefetchState.PrefetchHandle> remove = this.prefetchWindowHandles.remove(i14);
                        if (remove != null) {
                            int size = remove.size();
                            for (int i15 = 0; i15 < size; i15++) {
                                remove.get(i15).cancel();
                            }
                        }
                        this.windowCache.remove(i14);
                    }
                    j8 >>= 8;
                }
                if (i12 != 8) {
