...
public final class LazyListState$prefetchScope$1 implements LazyListPrefetchScope {
    ...
    public LazyLayoutPrefetchState.PrefetchHandle schedulePrefetch(final int i, final Function1<? super LazyListPrefetchResultScope, Unit> function1) {
        ...
        try {
            ...
            long m1180getChildConstraintsmsEJaDk = lazyListMeasureResult.m1180getChildConstraintsmsEJaDk();
            z = this.this$0.executeRequestsInHighPriorityMode;
            return prefetchState$foundation.m1254schedulePrecompositionAndPremeasure_EkL_Y$foundation(i, m1180getChildConstraintsmsEJaDk, z, new Function1() { // from class: androidx.compose.foundation.lazy.LazyListState$prefetchScope$1$$ExternalSyntheticLambda0
        ...
        if (function1 != null) {
            ...
            for (int i3 = 0; i3 < placeablesCount; i3++) {
                if (lazyListMeasureResult.getOrientation() == Orientation.Vertical) {
                    mo1256getSizeYEO4UFw = prefetchResultScope.mo1256getSizeYEO4UFw(i3) & 4294967295L;
                } else {
                    mo1256getSizeYEO4UFw = prefetchResultScope.mo1256getSizeYEO4UFw(i3) >> 32;
                }
                i2 += (int) mo1256getSizeYEO4UFw;
            }
