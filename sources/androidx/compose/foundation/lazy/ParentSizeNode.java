...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int m8115getMinWidthimpl = round != Integer.MAX_VALUE ? round : Constraints.m8115getMinWidthimpl(j);
        int m8114getMinHeightimpl = round2 != Integer.MAX_VALUE ? round2 : Constraints.m8114getMinHeightimpl(j);
        if (round == Integer.MAX_VALUE) {
            round = Constraints.m8113getMaxWidthimpl(j);
        }
        if (round2 == Integer.MAX_VALUE) {
            round2 = Constraints.m8112getMaxHeightimpl(j);
        }
        final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(ConstraintsKt.Constraints(m8115getMinWidthimpl, round, m8114getMinHeightimpl, round2));
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$$ExternalSyntheticLambda0
