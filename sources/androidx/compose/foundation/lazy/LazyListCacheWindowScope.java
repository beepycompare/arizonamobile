...
public final class LazyListCacheWindowScope implements CacheWindowScope {
    ...
    public int getMainAxisExtraSpaceStart() {
        return Math.abs(RangesKt.coerceAtMost(((LazyListItemInfo) CollectionsKt.first((List<? extends Object>) getLayoutInfo().getVisibleItemsInfo())).getOffset() + getLayoutInfo().getBeforeContentPadding(), 0));
    }

    @Override // androidx.compose.foundation.lazy.layout.CacheWindowScope
    public int getMainAxisExtraSpaceEnd() {
        LazyListItemInfo lazyListItemInfo = (LazyListItemInfo) CollectionsKt.last((List<? extends Object>) getLayoutInfo().getVisibleItemsInfo());
    ...
    public int getFirstVisibleLineIndex() {
        return ((LazyListItemInfo) CollectionsKt.first((List<? extends Object>) getLayoutInfo().getVisibleItemsInfo())).getIndex();
    }

    @Override // androidx.compose.foundation.lazy.layout.CacheWindowScope
    public int getLastVisibleLineIndex() {
        return ((LazyListItemInfo) CollectionsKt.last((List<? extends Object>) getLayoutInfo().getVisibleItemsInfo())).getIndex();
    }
    ...
    public int getVisibleItemSize(int i) {
        return getLayoutInfo().getVisibleItemsInfo().get(i).getSize();
    }

    @Override // androidx.compose.foundation.lazy.layout.CacheWindowScope
    public int getVisibleItemLine(int i) {
        return getLayoutInfo().getVisibleItemsInfo().get(i).getIndex();
    }

    @Override // androidx.compose.foundation.lazy.layout.CacheWindowScope
    public Object getVisibleLineKey(int i) {
        return getLayoutInfo().getVisibleItemsInfo().get(i).getKey();
    }
