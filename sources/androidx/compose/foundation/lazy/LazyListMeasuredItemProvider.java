...
public abstract class LazyListMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo950createItemX9ElhV4(int i, Object obj, Object obj2, List<? extends Placeable> list, long j);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m7204getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m7203getMaxHeightimpl(j), 5, null);
    }

    /* renamed from: getChildConstraints-msEJaDk  reason: not valid java name */
    public final long m965getChildConstraintsmsEJaDk() {
    ...
    public LazyListMeasuredItem mo963getAndMeasurehBUhpc(int i, int i2, int i3, long j) {
        return m964getAndMeasure0kLqBqw(i, j);
    }

    /* renamed from: getAndMeasure-0kLqBqw$default  reason: not valid java name */
    public static /* synthetic */ LazyListMeasuredItem m962getAndMeasure0kLqBqw$default(LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i, long j, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                j = lazyListMeasuredItemProvider.childConstraints;
            }
            return lazyListMeasuredItemProvider.m964getAndMeasure0kLqBqw(i, j);
        }
    ...
    public final LazyListMeasuredItem m964getAndMeasure0kLqBqw(int i, long j) {
        return mo950createItemX9ElhV4(i, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), m1042getPlaceables3p2s80s(this.measureScope, i, j), j);
    }
