...
public final class BorderStroke {
    ...
    public final float m331getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BorderStroke) {
            ...
            return Dp.m8263equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
        }
        return false;
    }

    public int hashCode() {
        return (Dp.m8264hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m8269toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }

    /* renamed from: copy-D5KLDUw$default  reason: not valid java name */
    public static /* synthetic */ BorderStroke m329copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderStroke.m330copyD5KLDUw(f, brush);
    }

    /* renamed from: copy-D5KLDUw  reason: not valid java name */
    public final BorderStroke m330copyD5KLDUw(float f, Brush brush) {
