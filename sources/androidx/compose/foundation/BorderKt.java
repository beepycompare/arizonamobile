...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m260borderziNgDLE(modifier, borderStroke.m273getWidthD9Ej5fM(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m259borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m258borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m258borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m260borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m260borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m261drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m3853getZeroF1C5BW0 = z ? Offset.Companion.m3853getZeroF1C5BW0() : j;
        final long m3698getSizeNHjbRc = z ? cacheDrawScope.m3698getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m4633drawRectAsUm42w$default(contentDrawScope, Brush.this, m3853getZeroF1C5BW0, m3698getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo3970opN5in7k0(path, Path, PathOperation.Companion.m4371getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m262shrinkKibmq7A(roundRect.m3887getTopLeftCornerRadiuskKHJgLs(), f), m262shrinkKibmq7A(roundRect.m3888getTopRightCornerRadiuskKHJgLs(), f), m262shrinkKibmq7A(roundRect.m3886getBottomRightCornerRadiuskKHJgLs(), f), m262shrinkKibmq7A(roundRect.m3885getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m262shrinkKibmq7A(long j, float f) {
        return CornerRadius.m3791constructorimpl((Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (j >> 32)) - f)) << 32) | (Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (j & 4294967295L)) - f)) & 4294967295L));
    }
}
