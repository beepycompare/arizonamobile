...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m271borderziNgDLE(modifier, borderStroke.m286getWidthD9Ej5fM(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m270borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m269borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m269borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m271borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m271borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m272drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m4309getZeroF1C5BW0 = z ? Offset.Companion.m4309getZeroF1C5BW0() : j;
        final long m4077getSizeNHjbRc = z ? cacheDrawScope.m4077getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1() { // from class: androidx.compose.foundation.BorderKt$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                ...
                drawRectBorder_NsqcLGU$lambda$1 = BorderKt.drawRectBorder_NsqcLGU$lambda$1(Brush.this, m4309getZeroF1C5BW0, m4077getSizeNHjbRc, stroke, (ContentDrawScope) obj);
    ...
    public static final Unit drawRectBorder_NsqcLGU$lambda$1(Brush brush, long j, long j2, DrawStyle drawStyle, ContentDrawScope contentDrawScope) {
        contentDrawScope.drawContent();
        DrawScope.m5109drawRectAsUm42w$default(contentDrawScope, brush, j, j2, 0.0f, drawStyle, null, 0, 104, null);
        return Unit.INSTANCE;
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo4427opN5in7k0(path, Path, PathOperation.Companion.m4841getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m273shrinkKibmq7A(roundRect.m4343getTopLeftCornerRadiuskKHJgLs(), f), m273shrinkKibmq7A(roundRect.m4344getTopRightCornerRadiuskKHJgLs(), f), m273shrinkKibmq7A(roundRect.m4342getBottomRightCornerRadiuskKHJgLs(), f), m273shrinkKibmq7A(roundRect.m4341getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m273shrinkKibmq7A(long j, float f) {
        return CornerRadius.m4247constructorimpl((Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (j >> 32)) - f)) << 32) | (Float.floatToRawIntBits(Math.max(0.0f, Float.intBitsToFloat((int) (j & 4294967295L)) - f)) & 4294967295L));
    }
}
