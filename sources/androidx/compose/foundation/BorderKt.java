...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m301borderziNgDLE(modifier, borderStroke.m313getWidthD9Ej5fM(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default  reason: not valid java name */
    public static /* synthetic */ Modifier m300borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m299borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU  reason: not valid java name */
    public static final Modifier m299borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m301borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE  reason: not valid java name */
    public static final Modifier m301borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m302drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m5119getZeroF1C5BW0 = z ? Offset.Companion.m5119getZeroF1C5BW0() : j;
        final long m4883getSizeNHjbRc = z ? cacheDrawScope.m4883getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1() { // from class: androidx.compose.foundation.BorderKt$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return BorderKt.drawRectBorder_NsqcLGU$lambda$0(Brush.this, m5119getZeroF1C5BW0, m4883getSizeNHjbRc, stroke, (ContentDrawScope) obj);
            }
        });
    }
    ...
    public static final Unit drawRectBorder_NsqcLGU$lambda$0(Brush brush, long j, long j2, DrawStyle drawStyle, ContentDrawScope contentDrawScope) {
        contentDrawScope.drawContent();
        DrawScope.m5915drawRectAsUm42w$default(contentDrawScope, brush, j, j2, 0.0f, drawStyle, null, 0, 104, null);
        return Unit.INSTANCE;
    }
    ...
    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m303shrinkKibmq7A(roundRect.m5153getTopLeftCornerRadiuskKHJgLs(), f), m303shrinkKibmq7A(roundRect.m5154getTopRightCornerRadiuskKHJgLs(), f), m303shrinkKibmq7A(roundRect.m5152getBottomRightCornerRadiuskKHJgLs(), f), m303shrinkKibmq7A(roundRect.m5151getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A  reason: not valid java name */
    public static final long m303shrinkKibmq7A(long j, float f) {
