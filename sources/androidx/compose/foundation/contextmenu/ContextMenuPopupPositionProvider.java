...
public final class ContextMenuPopupPositionProvider implements PopupPositionProvider {
    ...
    public long mo358calculatePositionllwVHH4(IntRect intRect, long j, LayoutDirection layoutDirection, long j2) {
        return IntOffset.m6806constructorimpl((ContextMenuPopupPositionProvider_androidKt.alignPopupAxis(intRect.getLeft() + IntOffset.m6812getXimpl(this.localPosition), (int) (j2 >> 32), (int) (j >> 32), layoutDirection == LayoutDirection.Ltr) << 32) | (ContextMenuPopupPositionProvider_androidKt.alignPopupAxis$default(intRect.getTop() + IntOffset.m6813getYimpl(this.localPosition), (int) (j2 & 4294967295L), (int) (j & 4294967295L), false, 8, null) & 4294967295L));
    }
}
