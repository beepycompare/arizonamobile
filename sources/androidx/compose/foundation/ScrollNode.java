...
public final class ScrollNode extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo6818measureBRTryo0 = measurable.mo6818measureBRTryo0(Constraints.m8103copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m8113getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m8112getMaxHeightimpl(j), 5, null));
        int coerceAtMost = RangesKt.coerceAtMost(mo6818measureBRTryo0.getWidth(), Constraints.m8113getMaxWidthimpl(j));
        int coerceAtMost2 = RangesKt.coerceAtMost(mo6818measureBRTryo0.getHeight(), Constraints.m8112getMaxHeightimpl(j));
        final int height = mo6818measureBRTryo0.getHeight() - coerceAtMost2;
        int width = mo6818measureBRTryo0.getWidth() - coerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        this.state.setMaxValue$foundation(height);
        this.state.setViewportSize$foundation(this.isVertical ? coerceAtMost2 : coerceAtMost);
        this.state.setContentSize$foundation(this.isVertical ? mo6818measureBRTryo0.getHeight() : mo6818measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, coerceAtMost, coerceAtMost2, null, new Function1() { // from class: androidx.compose.foundation.ScrollNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ScrollNode.measure_3p2s80s$lambda$0(ScrollNode.this, height, mo6818measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
