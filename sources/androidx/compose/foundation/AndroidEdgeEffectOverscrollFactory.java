...
public final class AndroidEdgeEffectOverscrollFactory implements OverscrollFactory {
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(getClass(), obj != null ? obj.getClass() : null)) {
            ...
            return Intrinsics.areEqual(this.context, androidEdgeEffectOverscrollFactory.context) && Intrinsics.areEqual(this.density, androidEdgeEffectOverscrollFactory.density) && Color.m4538equalsimpl0(this.glowColor, androidEdgeEffectOverscrollFactory.glowColor) && Intrinsics.areEqual(this.glowDrawPadding, androidEdgeEffectOverscrollFactory.glowDrawPadding);
        }
        return false;
    }
    ...
    @Override // androidx.compose.foundation.OverscrollFactory
    public int hashCode() {
        return (((((this.context.hashCode() * 31) + this.density.hashCode()) * 31) + Color.m4544hashCodeimpl(this.glowColor)) * 31) + this.glowDrawPadding.hashCode();
    }
}
