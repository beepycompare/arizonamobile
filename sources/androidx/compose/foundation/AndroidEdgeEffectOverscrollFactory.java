...
public final class AndroidEdgeEffectOverscrollFactory implements OverscrollFactory {
    ...
    @Override // androidx.compose.foundation.OverscrollFactory
    public int hashCode() {
        return (((((this.context.hashCode() * 31) + this.density.hashCode()) * 31) + Color.m4556hashCodeimpl(this.glowColor)) * 31) + this.glowDrawPadding.hashCode();
    }
}
