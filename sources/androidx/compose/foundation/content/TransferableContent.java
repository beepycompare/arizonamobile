...
public final class TransferableContent {
    ...
    public final int m383getSourcekB6V9T0() {
        return this.source;
    }
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m385constructorimpl(0);
        private static final int DragAndDrop = m385constructorimpl(1);
        private static final int Clipboard = m385constructorimpl(2);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Source m384boximpl(int i) {
            return new Source(i);
        }
        ...
        public static boolean m386equalsimpl(int i, Object obj) {
            return (obj instanceof Source) && i == ((Source) obj).m390unboximpl();
        }
        ...
        public static String m389toStringimpl(int i) {
            return m387equalsimpl0(i, Keyboard) ? "Source.Keyboard" : m387equalsimpl0(i, DragAndDrop) ? "Source.DragAndDrop" : m387equalsimpl0(i, Clipboard) ? "Source.Clipboard" : "Invalid (" + i + ')';
        }
    }
}
