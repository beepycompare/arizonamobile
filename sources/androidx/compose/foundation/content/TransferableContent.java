...
public final class TransferableContent {
    ...
    public final int m340getSourcekB6V9T0() {
        return this.source;
    }
    ...
    public static final class Source {
        ...
        private static final int Keyboard = m342constructorimpl(0);
        private static final int DragAndDrop = m342constructorimpl(1);
        private static final int Clipboard = m342constructorimpl(2);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Source m341boximpl(int i) {
            return new Source(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static int m342constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m343equalsimpl(int i, Object obj) {
            return (obj instanceof Source) && i == ((Source) obj).m347unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m344equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        public boolean equals(Object obj) {
            return m343equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m345hashCodeimpl(this.value);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m347unboximpl() {
            return this.value;
        }
        ...
        public static String m346toStringimpl(int i) {
            return m344equalsimpl0(i, Keyboard) ? "Source.Keyboard" : m344equalsimpl0(i, DragAndDrop) ? "Source.DragAndDrop" : m344equalsimpl0(i, Clipboard) ? "Source.Clipboard" : "Invalid (" + i + ')';
        }
    }
}
