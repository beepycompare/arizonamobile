    ...
    public static final TransferableContent consume(TransferableContent transferableContent, Function1<? super ClipData.Item, Boolean> function1) {
        ...
        if (clipData.getItemCount() == 1) {
            ...
            if (arrayList.size() != clipData.getItemCount()) {
                ...
                return new TransferableContent(AndroidClipboardManager_androidKt.toClipEntry(clipData2), AndroidClipboardManager_androidKt.toClipMetadata(clipDescription), transferableContent.m374getSourcekB6V9T0(), transferableContent.getPlatformTransferableContent(), null);
            }
        }
