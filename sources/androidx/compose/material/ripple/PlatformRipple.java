...
public final class PlatformRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1678rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i) {
