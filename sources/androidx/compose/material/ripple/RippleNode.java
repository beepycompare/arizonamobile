...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2122addRipple12SF9DM(PressInteraction.Press press, long j, float f);
    ...
    public final long m2135getRippleSizeNHjbRc() {
    ...
    public void mo423onRemeasuredozmzZPI(long j) {
        ...
        this.rippleSize = IntSizeKt.m8343toSizeozmzZPI(j);
        if (Float.isNaN(this.radius)) {
            mo434toPx0680j_4 = RippleAnimationKt.m2127getRippleEndRadiuscSwnlzA(requireDensity, this.bounded, this.rippleSize);
        } else {
            mo434toPx0680j_4 = requireDensity.mo434toPx0680j_4(this.radius);
        }
        this.targetRadius = mo434toPx0680j_4;
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m2139drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2134getRippleColor0d7_KjU());
        }
