...
public interface RippleTheme {
    ...
    long mo1846defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1860defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m4589luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m4574getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m1859defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (z) {
                if (ColorKt.m4589luminance8_81llA(j) > 0.5d) {
