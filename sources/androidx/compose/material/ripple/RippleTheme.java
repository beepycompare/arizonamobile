...
public interface RippleTheme {
    ...
    long mo1941defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1955defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m5476luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m5461getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m1954defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (z) {
                if (ColorKt.m5476luminance8_81llA(j) > 0.5d) {
