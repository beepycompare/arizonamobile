...
public interface RippleTheme {
    ...
    long mo1855defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1869defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m5332luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m5317getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m1868defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (z) {
                if (ColorKt.m5332luminance8_81llA(j) > 0.5d) {
