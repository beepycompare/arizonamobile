...
public final class RippleKt {
    ...
    public static final DelegatableNode m1950createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m1956createPlatformRippleNodeTDGSqEk(interactionSource, z, f, colorProducer, function0);
    }
    ...
    public static final Indication m1951rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m5414boximpl(j), composer, (i >> 6) & 14);
