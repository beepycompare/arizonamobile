...
public final class RippleKt {
    ...
    public static final DelegatableNode m1548createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m1554createPlatformRippleNodeTDGSqEk(interactionSource, z, f, colorProducer, function0);
    }
    ...
    public static final Indication m1549rememberRipple9IZ8Weo(boolean z, float f, long j, Composer composer, int i, int i2) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4068boximpl(j), composer, (i >> 6) & 14);
