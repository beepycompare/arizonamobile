...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1540defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1553defaultRippleColor5vOe2sY = RippleTheme.Companion.m1553defaultRippleColor5vOe2sY(Color.Companion.m4104getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1553defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1552defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1552defaultRippleAlphaDxMtmZc(Color.Companion.m4104getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1552defaultRippleAlphaDxMtmZc;
    }
}
