...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1941defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1955defaultRippleColor5vOe2sY = RippleTheme.Companion.m1955defaultRippleColor5vOe2sY(Color.Companion.m5450getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1955defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1954defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1954defaultRippleAlphaDxMtmZc(Color.Companion.m5450getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1954defaultRippleAlphaDxMtmZc;
    }
}
