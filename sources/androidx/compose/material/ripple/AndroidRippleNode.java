...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo2122addRipple12SF9DM(PressInteraction.Press press, long j, float f) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m2129addRippleKOepWvA(press, getBounded(), j, MathKt.roundToInt(f), m2134getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0() { // from class: androidx.compose.material.ripple.AndroidRippleNode$$ExternalSyntheticLambda0
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m2130setRipplePropertiesbiQXAtU(m2135getRippleSizeNHjbRc(), MathKt.roundToInt(getTargetRadius()), m2134getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
