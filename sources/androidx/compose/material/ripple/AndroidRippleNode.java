...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo1851addRipple12SF9DM(PressInteraction.Press press, long j, float f) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m1859addRippleKOepWvA(press, getBounded(), j, MathKt.roundToInt(f), m1865getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0() { // from class: androidx.compose.material.ripple.AndroidRippleNode$$ExternalSyntheticLambda0
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m1860setRipplePropertiesbiQXAtU(m1866getRippleSizeNHjbRc(), MathKt.roundToInt(getTargetRadius()), m1865getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
