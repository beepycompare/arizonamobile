...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int i;
        this.rippleSize = contentDrawScope.mo5128getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1858getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo5128getSizeNHjbRc()));
        } else {
        ...
        if (rippleHostView != null) {
            rippleHostView.m1862setRipplePropertiesbiQXAtU(contentDrawScope.mo5128getSizeNHjbRc(), this.rippleRadius, m4559unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press press, CoroutineScope coroutineScope) {
        ...
        rippleHostView.m1861addRippleKOepWvA(press, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4559unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
