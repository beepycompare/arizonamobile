...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int i;
        this.rippleSize = contentDrawScope.mo5116getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m1848getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo5116getSizeNHjbRc()));
        } else {
            i = contentDrawScope.mo413roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        ...
        if (rippleHostView != null) {
            rippleHostView.m1852setRipplePropertiesbiQXAtU(contentDrawScope.mo5116getSizeNHjbRc(), this.rippleRadius, m4547unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press press, CoroutineScope coroutineScope) {
        ...
        rippleHostView.m1851addRippleKOepWvA(press, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4547unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
