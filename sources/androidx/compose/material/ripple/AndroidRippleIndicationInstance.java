...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    private AndroidRippleIndicationInstance(boolean z, float f, State<Color> state, State<RippleAlpha> state2, ViewGroup viewGroup) {
        ...
        this.rippleSize = Size.Companion.m5181getZeroNHjbRc();
        this.rippleRadius = -1;
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int i;
        this.rippleSize = contentDrawScope.mo5922getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            i = MathKt.roundToInt(RippleAnimationKt.m2127getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo5922getSizeNHjbRc()));
        } else {
            i = contentDrawScope.mo428roundToPx0680j_4(this.radius);
        }
        this.rippleRadius = i;
        ...
        if (rippleHostView != null) {
            rippleHostView.m2130setRipplePropertiesbiQXAtU(contentDrawScope.mo5922getSizeNHjbRc(), this.rippleRadius, m5358unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press press, CoroutineScope coroutineScope) {
        ...
        rippleHostView.m2129addRippleKOepWvA(press, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m5358unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
