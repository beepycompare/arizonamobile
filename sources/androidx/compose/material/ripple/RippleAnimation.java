...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m2126draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m2128getRippleStartRadiusuvyYCjk(drawScope.mo5922getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m5092boximpl(drawScope.mo5921getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m5092boximpl(OffsetKt.Offset(Size.m5172getWidthimpl(drawScope.mo5922getSizeNHjbRc()) / 2.0f, Size.m5169getHeightimpl(drawScope.mo5922getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m5103getXimpl = Offset.m5103getXimpl(offset.m5113unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m5103getXimpl, Offset.m5103getXimpl(offset2.m5113unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m5104getYimpl = Offset.m5104getYimpl(offset3.m5113unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m5104getYimpl, Offset.m5104getYimpl(offset4.m5113unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long m5347copywmQWz5c$default = Color.m5347copywmQWz5c$default(j, Color.m5350getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m5903drawCircleVaOC9Bg$default(drawScope, m5347copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float m5172getWidthimpl = Size.m5172getWidthimpl(drawScope.mo5922getSizeNHjbRc());
        float m5169getHeightimpl = Size.m5169getHeightimpl(drawScope.mo5922getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo5846clipRectN_I0leg(0.0f, 0.0f, m5172getWidthimpl, m5169getHeightimpl, m5337getIntersectrtfAjoo);
            DrawScope.m5903drawCircleVaOC9Bg$default(drawScope, m5347copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, 120, null);
        } finally {
