...
public final class CacheDrawScope implements Density {
    ...
    public final long m4820getSizeNHjbRc() {
        return this.cacheParams.mo4818getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m4819recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m8178toIntSizeuvyYCjk(cacheDrawScope.m4820getSizeNHjbRc());
        }
        cacheDrawScope.m4821recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* renamed from: record-TdoYBX4  reason: not valid java name */
    public final void m4821recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, long j, final Function1<? super ContentDrawScope, Unit> function1) {
        ...
        contentDrawScope.mo5860recordJVtK1S4(graphicsLayer, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1$1
