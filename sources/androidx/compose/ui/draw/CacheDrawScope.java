...
public final class CacheDrawScope implements Density {
    ...
    public final long m4819getSizeNHjbRc() {
        return this.cacheParams.mo4817getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m4818recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m8177toIntSizeuvyYCjk(cacheDrawScope.m4819getSizeNHjbRc());
        }
        cacheDrawScope.m4820recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* renamed from: record-TdoYBX4  reason: not valid java name */
    public final void m4820recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, long j, final Function1<? super ContentDrawScope, Unit> function1) {
        ...
        contentDrawScope.mo5859recordJVtK1S4(graphicsLayer, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1$1
