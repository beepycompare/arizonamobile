...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m4948shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            z = Dp.m8159compareTo0680j_4(f, Dp.m8160constructorimpl(0.0f)) > 0;
        }
        return m4947shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m4947shadowziNgDLE(Modifier modifier, float f, Shape shape, boolean z) {
        return m4945shadows4CzXII(modifier, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default  reason: not valid java name */
    public static /* synthetic */ Modifier m4946shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        Shape rectangleShape = (i & 2) != 0 ? RectangleShapeKt.getRectangleShape() : shape;
        if ((i & 4) != 0) {
            z2 = Dp.m8159compareTo0680j_4(f, Dp.m8160constructorimpl(0.0f)) > 0;
        } else {
            z2 = z;
        }
        return m4945shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }
    ...
    public static final void resetShadow(ShadowScope shadowScope) {
        ...
        shadowScope.mo4867setOffsetk4lQ0M(Offset.Companion.m5119getZeroF1C5BW0());
        shadowScope.mo4866setColor8_81llA(Color.Companion.m5374getBlack0d7_KjU());
        shadowScope.setBrush(null);
        shadowScope.setAlpha(1.0f);
        shadowScope.mo4865setBlendModes9anfk8(BlendMode.Companion.m5288getSrcOver0nO6VwU());
    }

    /* renamed from: shadow-s4CzXII  reason: not valid java name */
    public static final Modifier m4945shadows4CzXII(Modifier modifier, float f, Shape shape, boolean z, long j, long j2) {
        return (Dp.m8159compareTo0680j_4(f, Dp.m8160constructorimpl(0.0f)) > 0 || z) ? modifier.then(new ShadowGraphicsLayerElement(f, shape, z, j, j2, null)) : modifier;
    }
}
