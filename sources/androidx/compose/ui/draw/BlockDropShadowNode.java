...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof BlockDropShadowNode)) {
            ...
            return getAlpha() == blockDropShadowNode.getAlpha() && Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) && this.block == blockDropShadowNode.block && getRadius() == blockDropShadowNode.getRadius() && getSpread() == blockDropShadowNode.getSpread() && Offset.m5100equalsimpl0(mo4864getOffsetF1C5BW0(), blockDropShadowNode.mo4864getOffsetF1C5BW0()) && Color.m5349equalsimpl0(mo4863getColor0d7_KjU(), blockDropShadowNode.mo4863getColor0d7_KjU()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m5257equalsimpl0(mo4862getBlendMode0nO6VwU(), blockDropShadowNode.mo4862getBlendMode0nO6VwU());
        }
        return false;
    }
