...
public final class BlockDropShadowNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode, DropShadowScope {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof BlockDropShadowNode)) {
            ...
            return getAlpha() == blockDropShadowNode.getAlpha() && Intrinsics.areEqual(this.shape, blockDropShadowNode.shape) && this.block == blockDropShadowNode.block && getRadius() == blockDropShadowNode.getRadius() && getSpread() == blockDropShadowNode.getSpread() && Offset.m4524equalsimpl0(mo4288getOffsetF1C5BW0(), blockDropShadowNode.mo4288getOffsetF1C5BW0()) && Color.m4773equalsimpl0(mo4287getColor0d7_KjU(), blockDropShadowNode.mo4287getColor0d7_KjU()) && Intrinsics.areEqual(getBrush(), blockDropShadowNode.getBrush()) && BlendMode.m4681equalsimpl0(mo4286getBlendMode0nO6VwU(), blockDropShadowNode.mo4286getBlendMode0nO6VwU());
        }
        return false;
    }
