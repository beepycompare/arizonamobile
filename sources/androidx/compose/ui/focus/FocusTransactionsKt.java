...
public final class FocusTransactionsKt {
    ...
    public static final boolean performRequestFocus(FocusTargetNode focusTargetNode) {
        ...
        int i3 = 0;
        if (activeFocusTargetNode != null || m4959requestOwnerFocusEtdf9zw$default(focusTargetNode, null, null, 3, null)) {
            int i4 = 1024;
            int i5 = 16;
            ...
            int m6989constructorimpl2 = NodeKind.m6989constructorimpl(i4);
            ...
            while (requireLayoutNode2 != null) {
                if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m6989constructorimpl2) != 0) {
                    while (parent$ui_release2 != null) {
                        if ((parent$ui_release2.getKindSet$ui_release() & m6989constructorimpl2) != 0) {
                            ...
                            while (focusTargetNode8 != null) {
                                ...
                                } else if ((focusTargetNode8.getKindSet$ui_release() & m6989constructorimpl2) != 0 && (focusTargetNode8 instanceof DelegatingNode)) {
            ...
            if (ComposeUiFlags.isViewFocusFixEnabled && DelegatableNodeKt.requireLayoutNode(focusTargetNode7).getInteropView() == null) {
                m4958requestOwnerFocusEtdf9zw(focusTargetNode, FocusDirection.m4912boximpl(FocusDirection.Companion.m4923getNextdhqQ8s()), null);
                return true;
            }
            return true;
        }
    ...
    static /* synthetic */ boolean m4959requestOwnerFocusEtdf9zw$default(FocusTargetNode focusTargetNode, FocusDirection focusDirection, Rect rect, int i, Object obj) {
        if ((i & 1) != 0) {
            focusDirection = null;
        }
        if ((i & 2) != 0) {
        ...
        return m4958requestOwnerFocusEtdf9zw(focusTargetNode, focusDirection, rect);
    }

    /* renamed from: requestOwnerFocus-Etdf9zw  reason: not valid java name */
    private static final boolean m4958requestOwnerFocusEtdf9zw(FocusTargetNode focusTargetNode, FocusDirection focusDirection, Rect rect) {
        return DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().mo4935requestOwnerFocus7o62pno(focusDirection, rect);
    }
    ...
    public static final CustomDestinationResult m4957performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        FocusTargetNode focusTargetNode2;
        NodeChain nodes$ui_release;
                    ...
                    while (parent$ui_release != null) {
                        if ((parent$ui_release.getKindSet$ui_release() & m6989constructorimpl) != 0) {
                            ...
                            while (focusTargetNode2 != null) {
                                ...
                                if ((focusTargetNode2.getKindSet$ui_release() & m6989constructorimpl) != 0 && (focusTargetNode2 instanceof DelegatingNode)) {
                                    int i3 = 0;
            ...
            if (i4 != 1) {
                if (i4 != 2) {
                    if (i4 != 3) {
                        ...
                        CustomDestinationResult m4957performCustomRequestFocusMxy_nc0 = m4957performCustomRequestFocusMxy_nc0(focusTargetNode4, i);
                        CustomDestinationResult customDestinationResult = m4957performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? m4957performCustomRequestFocusMxy_nc0 : null;
                        return customDestinationResult == null ? m4955performCustomEnterMxy_nc0(focusTargetNode4, i) : customDestinationResult;
                    }
                    return m4957performCustomRequestFocusMxy_nc0(focusTargetNode4, i);
                }
                return CustomDestinationResult.Cancelled;
            }
            return m4955performCustomEnterMxy_nc0(focusTargetNode4, i);
        }
        return m4954performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
    }

    /* renamed from: performCustomClearFocus-Mxy_nc0  reason: not valid java name */
    public static final CustomDestinationResult m4954performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                return CustomDestinationResult.Cancelled;
            ...
            if (i2 == 3) {
                CustomDestinationResult m4954performCustomClearFocusMxy_nc0 = m4954performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i);
                if (m4954performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    m4954performCustomClearFocusMxy_nc0 = null;
                }
                return m4954performCustomClearFocusMxy_nc0 == null ? m4956performCustomExitMxy_nc0(focusTargetNode, i) : m4954performCustomClearFocusMxy_nc0;
            } else if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
        }
    ...
    private static final CustomDestinationResult m4955performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            ...
            try {
                ...
                if (cancelIndicatingFocusBoundaryScope.isCanceled()) {
                    ...
                    return FocusRequester.m4943requestFocus3ESFkO8$default(cancel, 0, 1, null) ? CustomDestinationResult.Redirected : CustomDestinationResult.RedirectCancelled;
                    ...
                    return FocusRequester.m4943requestFocus3ESFkO8$default(redirect$ui_release, 0, 1, null) ? CustomDestinationResult.Redirected : CustomDestinationResult.RedirectCancelled;
                }
            } finally {
    ...
    private static final CustomDestinationResult m4956performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
