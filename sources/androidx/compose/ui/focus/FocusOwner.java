...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo4994clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i);
    ...
    boolean mo4995dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w */
    boolean mo4996dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> function0);
    ...
    Boolean mo4997focusSearchULY8qGw(int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1);
    ...
    boolean mo4998moveFocusaToIllA(int i, boolean z);

    void releaseFocus();

    /* renamed from: requestOwnerFocus-7o62pno */
    boolean mo4999requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect rect);

    /* renamed from: resetFocus-3ESFkO8 */
    boolean mo5000resetFocus3ESFkO8(int i);
    ...
    boolean mo5001takeFocusaToIllA(int i, Rect rect);

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: dispatchKeyEvent-YhN2O0w$default */
    static /* synthetic */ boolean m4993dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
            ...
            return focusOwner.mo4996dispatchKeyEventYhN2O0w(keyEvent, function0);
        }
