...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo4200clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i);
    ...
    boolean mo4201dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w */
    boolean mo4202dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> function0);
    ...
    Boolean mo4203focusSearchULY8qGw(int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1);
    ...
    boolean mo4204requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect rect);
    ...
    boolean mo4205takeFocusaToIllA(int i, Rect rect);

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: dispatchKeyEvent-YhN2O0w$default */
    static /* synthetic */ boolean m4199dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
            ...
            return focusOwner.mo4202dispatchKeyEventYhN2O0w(keyEvent, function0);
        }
