...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo4188clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i);
    ...
    boolean mo4189dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w */
    boolean mo4190dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> function0);
    ...
    Boolean mo4191focusSearchULY8qGw(int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1);
    ...
    boolean mo4192requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect rect);
    ...
    boolean mo4193takeFocusaToIllA(int i, Rect rect);

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: dispatchKeyEvent-YhN2O0w$default */
    static /* synthetic */ boolean m4187dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
            ...
            return focusOwner.mo4190dispatchKeyEventYhN2O0w(keyEvent, function0);
        }
