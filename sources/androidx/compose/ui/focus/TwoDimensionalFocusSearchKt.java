...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m4243twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m4239findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 != 4) {
            ...
            return Boolean.valueOf(m4242searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        ...
        if (i3 == 1) {
            Boolean m4243twoDimensionalFocusSearchsMXa3k8 = m4243twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (Intrinsics.areEqual((Object) m4243twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                if (rect == null) {
                    rect = FocusTraversalKt.focusRect(activeNode(activeChild));
                }
                return Boolean.valueOf(m4240generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
            return m4243twoDimensionalFocusSearchsMXa3k8;
        } else if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m4240generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m4242searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4167searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m4242searchChildren4C6V_qg;
                if (FocusTargetNode.this == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    m4242searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m4242searchChildren4C6V_qg(focusTargetNode, rect, i, function1);
                    Boolean valueOf = Boolean.valueOf(m4242searchChildren4C6V_qg);
    ...
    private static final FocusTargetNode m4238findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect translate;
        ...
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4182getRightdhqQ8s())) {
            translate = rect.translate(-((rect.getRight() - rect.getLeft()) + 1), 0.0f);
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4183getUpdhqQ8s())) {
            translate = rect.translate(0.0f, (rect.getBottom() - rect.getTop()) + 1);
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4176getDowndhqQ8s())) {
            translate = rect.translate(0.0f, -((rect.getBottom() - rect.getTop()) + 1));
        } else {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                ...
                if (m4241isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    */
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float bottom;
        float top2;
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4179getLeftdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4182getRightdhqQ8s())) {
            ...
            top2 = rect.getTop();
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4183getUpdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4176getDowndhqQ8s())) {
    ...
    public static final boolean m4241isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m4237beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
                return !m4237beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
            }
            return true;
        }
        return false;
    ...
    */
    ...
    private static final boolean m4237beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4179getLeftdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4182getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m4239findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        Rect rect;
        ...
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4177getEnterdhqQ8s())) {
            i = FocusDirection.Companion.m4182getRightdhqQ8s();
        }
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4182getRightdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4176getDowndhqQ8s())) {
            rect = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4179getLeftdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4183getUpdhqQ8s())) {
            rect = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            throw new IllegalStateException(InvalidFocusDirection.toString());
        }
        FocusTargetNode m4238findBestCandidate4WY_MpI = m4238findBestCandidate4WY_MpI(mutableVector, rect, i);
        if (m4238findBestCandidate4WY_MpI != null) {
            return function1.invoke(m4238findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m4242searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode m4238findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector.getSize() != 0 && (m4238findBestCandidate4WY_MpI = m4238findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (m4238findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(m4238findBestCandidate4WY_MpI).booleanValue();
            }
            if (m4240generateAndSearchChildren4C6V_qg(m4238findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(m4238findBestCandidate4WY_MpI);
        }
        return false;
    }
