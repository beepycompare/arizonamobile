    ...
    public static final boolean requestFocus(FocusRequesterModifierNode focusRequesterModifierNode) {
        ...
        while (node != null) {
            if (node instanceof FocusTargetNode) {
                ...
                return focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() ? FocusTargetModifierNode.m4944requestFocus3ESFkO8$default(focusTargetNode, 0, 1, null) : TwoDimensionalFocusSearchKt.m4981findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.Companion.m4919getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                    @Override // kotlin.jvm.functions.Function1
                    public final Boolean invoke(FocusTargetNode focusTargetNode2) {
                        return Boolean.valueOf(FocusTargetModifierNode.m4944requestFocus3ESFkO8$default(focusTargetNode2, 0, 1, null));
                    }
                });
            }
                    ...
                    if (node2 == null) {
                        ...
                        while (node2 != null) {
                            if (node2 instanceof FocusTargetNode) {
                                ...
                                return focusTargetNode2.fetchFocusProperties$ui_release().getCanFocus() ? FocusTargetModifierNode.m4944requestFocus3ESFkO8$default(focusTargetNode2, 0, 1, null) : TwoDimensionalFocusSearchKt.m4981findChildCorrespondingToFocusEnterOMvw8(focusTargetNode2, FocusDirection.Companion.m4919getEnterdhqQ8s(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusRequesterModifierNodeKt$requestFocus$1$1
                                    @Override // kotlin.jvm.functions.Function1
                                    public final Boolean invoke(FocusTargetNode focusTargetNode22) {
                                        return Boolean.valueOf(FocusTargetModifierNode.m4944requestFocus3ESFkO8$default(focusTargetNode22, 0, 1, null));
                                    }
                                });
                            }
