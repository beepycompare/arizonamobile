...
public interface FocusTargetModifierNode extends DelegatableNode {
    ...
    int mo5011getFocusabilityLCbbffg();
    ...
    boolean mo5012requestFocus3ESFkO8(int i);

    /* renamed from: setFocusability-josRg5g  reason: not valid java name */
    void mo5013setFocusabilityjosRg5g(int i);

    /* renamed from: requestFocus-3ESFkO8$default  reason: not valid java name */
    static /* synthetic */ boolean m5010requestFocus3ESFkO8$default(FocusTargetModifierNode focusTargetModifierNode, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 1) != 0) {
                i = FocusDirection.Companion.m4983getEnterdhqQ8s();
            }
            return focusTargetModifierNode.mo5012requestFocus3ESFkO8(i);
        }
