...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    private FocusTargetNode rootFocusNode = new FocusTargetNode(Focusability.Companion.m4240getNeverLCbbffg(), null, null, 6, null);
    ...
    public boolean mo4204requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect rect) {
        return this.platformFocusOwner.mo4247requestOwnerFocus7o62pno(focusDirection, rect);
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: takeFocus-aToIllA */
    public boolean mo4205takeFocusaToIllA(final int i, Rect rect) {
        Boolean mo4203focusSearchULY8qGw = mo4203focusSearchULY8qGw(i, rect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$takeFocus$1
        ...
        if (mo4203focusSearchULY8qGw != null) {
            return mo4203focusSearchULY8qGw.booleanValue();
        }
        return false;
    }
    ...
    public void clearFocus(boolean z) {
        mo4200clearFocusI7lrPNg(z, true, true, FocusDirection.Companion.m4190getExitdhqQ8s());
    }

    @Override // androidx.compose.ui.focus.FocusOwner
    /* renamed from: clearFocus-I7lrPNg */
    public boolean mo4200clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i) {
        boolean clearFocus;
        if (!z) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m4223performCustomClearFocusMxy_nc0(this.rootFocusNode, i).ordinal()];
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                clearFocus = false;
            } else if (i2 != 4) {
    ...
    public boolean mo4198moveFocus3ESFkO8(final int i) {
        if (ComposeUiFlags.isViewFocusFixEnabled && this.platformFocusOwner.mo4246moveFocusInChildren3ESFkO8(i)) {
            return true;
        }
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = false;
        FocusTargetNode activeFocusTargetNode = getActiveFocusTargetNode();
        Boolean mo4203focusSearchULY8qGw = mo4203focusSearchULY8qGw(i, this.platformFocusOwner.getEmbeddedViewFocusRect(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$focusSearchSuccess$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                objectRef.element = Boolean.valueOf(focusTargetNode.mo4216requestFocus3ESFkO8(i));
                return objectRef.element;
            }
        });
        if (!Intrinsics.areEqual((Object) mo4203focusSearchULY8qGw, (Object) true) || activeFocusTargetNode == getActiveFocusTargetNode()) {
            if (mo4203focusSearchULY8qGw != null && objectRef.element != 0) {
                if (mo4203focusSearchULY8qGw.booleanValue() && ((Boolean) objectRef.element).booleanValue()) {
                    return true;
                }
                if (FocusOwnerImplKt.m4209is1dFocusSearch3ESFkO8(i)) {
                    return mo4200clearFocusI7lrPNg(false, true, false, i) && mo4205takeFocusaToIllA(i, null);
                } else if (!ComposeUiFlags.isViewFocusFixEnabled && this.platformFocusOwner.mo4246moveFocusInChildren3ESFkO8(i)) {
                    return true;
                }
            }
            return false;
    ...
    public Boolean mo4203focusSearchULY8qGw(int i, Rect rect, final Function1<? super FocusTargetNode, Boolean> function1) {
        final FocusTargetNode findFocusTargetNode = findFocusTargetNode();
        if (findFocusTargetNode != null) {
            FocusRequester m4229customFocusSearchOMvw8 = FocusTraversalKt.m4229customFocusSearchOMvw8(findFocusTargetNode, i, this.owner.getLayoutDirection());
            if (Intrinsics.areEqual(m4229customFocusSearchOMvw8, FocusRequester.Companion.getCancel())) {
                return null;
            }
            if (Intrinsics.areEqual(m4229customFocusSearchOMvw8, FocusRequester.Companion.getRedirect$ui_release())) {
                ...
                return null;
            } else if (!Intrinsics.areEqual(m4229customFocusSearchOMvw8, FocusRequester.Companion.getDefault())) {
                return Boolean.valueOf(m4229customFocusSearchOMvw8.findFocusTargetNode$ui_release(function1));
            }
        } else {
            findFocusTargetNode = null;
        }
        return FocusTraversalKt.m4230focusSearch0X8WOeE(this.rootFocusNode, i, this.owner.getLayoutDirection(), rect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$focusSearch$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public boolean mo4202dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> function0) {
        Modifier.Node node;
        Modifier.Node node2;
        NodeChain nodes$ui_release;
        Modifier.Node node3;
        ...
        try {
            if (this.focusInvalidationManager.hasPendingInvalidation()) {
                ...
                return false;
            } else if (m4208validateKeyEventZmokQxo(keyEvent)) {
                ...
                if (findFocusTargetNode == null || (node2 = lastLocalKeyInputNode(findFocusTargetNode)) == null) {
                    if (findFocusTargetNode != null) {
                        ...
                        int m6258constructorimpl = NodeKind.m6258constructorimpl(8192);
                        if (!focusTargetNode.getNode().isAttached()) {
                            InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
                        }
                                ...
                                while (node4 != null) {
                                    if ((node4.getKindSet$ui_release() & m6258constructorimpl) != 0) {
                                        ...
                                        while (node3 != null) {
                                            ...
                                            if ((node3.getKindSet$ui_release() & m6258constructorimpl) != 0 && (node3 instanceof DelegatingNode)) {
                                                int i = 0;
                    ...
                    int m6258constructorimpl2 = NodeKind.m6258constructorimpl(8192);
                    ...
                    loop14: while (true) {
                        ...
                        if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m6258constructorimpl2) != 0) {
                            while (parent$ui_release != null) {
                                if ((parent$ui_release.getKindSet$ui_release() & m6258constructorimpl2) != 0) {
                                    ...
                                    while (node != null) {
                                        ...
                                        if ((node.getKindSet$ui_release() & m6258constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
                                            int i2 = 0;
                ...
                if (node2 != null) {
                    ...
                    int m6258constructorimpl3 = NodeKind.m6258constructorimpl(8192);
                    ...
                    while (requireLayoutNode3 != null) {
                        if ((requireLayoutNode3.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m6258constructorimpl3) != 0) {
                            while (parent$ui_release2 != null) {
                                if ((parent$ui_release2.getKindSet$ui_release() & m6258constructorimpl3) != 0) {
                                    ...
                                    while (node6 != null) {
                                        if (node6 instanceof KeyInputModifierNode) {
                                            ...
                                            arrayList.add(node6);
                                        } else if ((node6.getKindSet$ui_release() & m6258constructorimpl3) != 0 && (node6 instanceof DelegatingNode)) {
                                            int i3 = 0;
                                            for (Modifier.Node delegate$ui_release3 = ((DelegatingNode) node6).getDelegate$ui_release(); delegate$ui_release3 != null; delegate$ui_release3 = delegate$ui_release3.getChild$ui_release()) {
                                                if ((delegate$ui_release3.getKindSet$ui_release() & m6258constructorimpl3) != 0) {
                                                    i3++;
                                                    if (i3 == 1) {
                    ...
                    while (objectRef2.element != 0) {
                        ...
                        } else if ((((Modifier.Node) objectRef2.element).getKindSet$ui_release() & m6258constructorimpl3) != 0 && (objectRef2.element instanceof DelegatingNode)) {
                            int i5 = 0;
                            for (?? r4 = ((DelegatingNode) objectRef2.element).getDelegate$ui_release(); r4 != 0; r4 = r4.getChild$ui_release()) {
                                if ((r4.getKindSet$ui_release() & m6258constructorimpl3) != 0) {
                                    i5++;
                                    if (i5 == 1) {
                    ...
                    while (objectRef4.element != 0) {
                        ...
                        } else if ((((Modifier.Node) objectRef4.element).getKindSet$ui_release() & m6258constructorimpl3) != 0 && (objectRef4.element instanceof DelegatingNode)) {
                            int i6 = 0;
                            for (?? r42 = ((DelegatingNode) objectRef4.element).getDelegate$ui_release(); r42 != 0; r42 = r42.getChild$ui_release()) {
                                if ((r42.getKindSet$ui_release() & m6258constructorimpl3) != 0) {
                                    i6++;
                                    if (i6 == 1) {
    ...
    public boolean mo4201dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            ...
            int m6258constructorimpl = NodeKind.m6258constructorimpl(131072);
            if (!focusTargetNode.getNode().isAttached()) {
                InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
            }
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int m6258constructorimpl2 = NodeKind.m6258constructorimpl(131072);
                        ...
                        if ((parent$ui_release.getKindSet$ui_release() & m6258constructorimpl2) != 0) {
                            ...
                            while (node3 != null) {
                                if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                                    ...
                                    arrayList.add(node3);
                                } else if ((node3.getKindSet$ui_release() & m6258constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                                    int i3 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i4 = i - 1;
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i)).mo5383onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i4 < 0) {
                        break;
            ...
            while (node4 != null) {
                if (node4 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node4).mo5383onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node4.getKindSet$ui_release() & m6258constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                    int i5 = 0;
                    for (Modifier.Node delegate$ui_release3 = ((DelegatingNode) node4).getDelegate$ui_release(); delegate$ui_release3 != null; delegate$ui_release3 = delegate$ui_release3.getChild$ui_release()) {
                        if ((delegate$ui_release3.getKindSet$ui_release() & m6258constructorimpl2) != 0) {
                            i5++;
                            if (i5 == 1) {
            ...
            while (node5 != null) {
                if (node5 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node5).mo5382onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node5.getKindSet$ui_release() & m6258constructorimpl2) != 0 && (node5 instanceof DelegatingNode)) {
                    int i6 = 0;
                    for (Modifier.Node delegate$ui_release4 = ((DelegatingNode) node5).getDelegate$ui_release(); delegate$ui_release4 != null; delegate$ui_release4 = delegate$ui_release4.getChild$ui_release()) {
                        if ((delegate$ui_release4.getKindSet$ui_release() & m6258constructorimpl2) != 0) {
                            i6++;
                            if (i6 == 1) {
            ...
            if (arrayList != null) {
                ...
                for (int i7 = 0; i7 < size; i7++) {
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i7)).mo5382onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent rotaryScrollEvent, Function0<Boolean> function0) {
        ...
        if (findFocusTargetNode != null) {
            FocusTargetNode focusTargetNode = findFocusTargetNode;
            int m6258constructorimpl = NodeKind.m6258constructorimpl(16384);
            if (!focusTargetNode.getNode().isAttached()) {
                InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
            }
            Modifier.Node node2 = focusTargetNode.getNode();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int m6258constructorimpl2 = NodeKind.m6258constructorimpl(16384);
    ...
    public boolean dispatchIndirectTouchEvent(IndirectTouchEvent indirectTouchEvent, Function0<Boolean> function0) {
        ...
        if (findFocusTargetNode != null) {
            FocusTargetNode focusTargetNode = findFocusTargetNode;
            int m6258constructorimpl = NodeKind.m6258constructorimpl(2097152);
            if (!focusTargetNode.getNode().isAttached()) {
                InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
            }
            Modifier.Node node2 = focusTargetNode.getNode();
        ...
        if (indirectTouchInputModifierNode != null) {
            ...
            int m6258constructorimpl2 = NodeKind.m6258constructorimpl(2097152);
    ...
    private final boolean m4208validateKeyEventZmokQxo(KeyEvent keyEvent) {
        long m5695getKeyZmokQxo = KeyEvent_androidKt.m5695getKeyZmokQxo(keyEvent);
        int m5696getTypeZmokQxo = KeyEvent_androidKt.m5696getTypeZmokQxo(keyEvent);
        if (KeyEventType.m5688equalsimpl0(m5696getTypeZmokQxo, KeyEventType.Companion.m5692getKeyDownCS__XNY())) {
            MutableLongSet mutableLongSet = this.keysCurrentlyDown;
            if (mutableLongSet == null) {
                mutableLongSet = new MutableLongSet(3);
                this.keysCurrentlyDown = mutableLongSet;
            }
            mutableLongSet.plusAssign(m5695getKeyZmokQxo);
        } else if (KeyEventType.m5688equalsimpl0(m5696getTypeZmokQxo, KeyEventType.Companion.m5693getKeyUpCS__XNY())) {
            MutableLongSet mutableLongSet2 = this.keysCurrentlyDown;
            if (mutableLongSet2 == null || !mutableLongSet2.contains(m5695getKeyZmokQxo)) {
                return false;
            }
            MutableLongSet mutableLongSet3 = this.keysCurrentlyDown;
            if (mutableLongSet3 != null) {
                mutableLongSet3.remove(m5695getKeyZmokQxo);
            }
        }
        return true;
    }
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m4207traverseAncestorsIncludingSelfQFhIj7k(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function0<Unit> function0, Function1<? super T, Unit> function12) {
        int i2;
        int i3;
        NodeChain nodes$ui_release;
    ...
    private final /* synthetic */ <T> T m4206nearestAncestorIncludingSelf64DMado(DelegatableNode delegatableNode, int i) {
        NodeChain nodes$ui_release;
        if (!delegatableNode.getNode().isAttached()) {
            InlineClassHelperKt.throwIllegalStateException("visitAncestors called on an unattached node");
        }
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int m6258constructorimpl = NodeKind.m6258constructorimpl(1024) | NodeKind.m6258constructorimpl(8192);
        if (!delegatableNode.getNode().isAttached()) {
        ...
        if ((node.getAggregateChildKindSet$ui_release() & m6258constructorimpl) != 0) {
            for (Modifier.Node child$ui_release = node.getChild$ui_release(); child$ui_release != null; child$ui_release = child$ui_release.getChild$ui_release()) {
                if ((child$ui_release.getKindSet$ui_release() & m6258constructorimpl) != 0) {
                    if ((NodeKind.m6258constructorimpl(1024) & child$ui_release.getKindSet$ui_release()) != 0) {
                        return node2;
                    }
