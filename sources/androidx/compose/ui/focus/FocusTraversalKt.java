...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4960customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4924getPreviousdhqQ8s())) {
        ...
        } else if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4920getEnterdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4921getExitdhqQ8s())) {
    ...
    public static final Boolean m4961focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int m4925getRightdhqQ8s;
        if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4923getNextdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4924getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m4975oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4922getLeftdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4925getRightdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4926getUpdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4919getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m4986twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4920getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m4925getRightdhqQ8s = FocusDirection.Companion.m4925getRightdhqQ8s();
            } else if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            } else {
                m4925getRightdhqQ8s = FocusDirection.Companion.m4922getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (findActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m4986twoDimensionalFocusSearchsMXa3k8(findActiveFocusNode, m4925getRightdhqQ8s, rect, function1);
            }
            return null;
        } else if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4921getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m4917toStringimpl(i))).toString());
        }
    }
