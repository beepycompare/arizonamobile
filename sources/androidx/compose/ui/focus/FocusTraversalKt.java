...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m4217customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4177getEnterdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4178getExitdhqQ8s())) {
    ...
    public static final Boolean m4218focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int m4182getRightdhqQ8s;
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4180getNextdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4181getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m4232oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4179getLeftdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4182getRightdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4183getUpdhqQ8s()) || FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4176getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m4243twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4177getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m4182getRightdhqQ8s = FocusDirection.Companion.m4182getRightdhqQ8s();
            } else if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            } else {
                m4182getRightdhqQ8s = FocusDirection.Companion.m4179getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (findActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m4243twoDimensionalFocusSearchsMXa3k8(findActiveFocusNode, m4182getRightdhqQ8s, rect, function1);
            }
            return null;
        } else if (FocusDirection.m4172equalsimpl0(i, FocusDirection.Companion.m4178getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m4174toStringimpl(i))).toString());
        }
    }
