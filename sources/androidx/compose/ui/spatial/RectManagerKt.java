...
public final class RectManagerKt {
    ...
    public static final boolean m7406isSetgyyYBs(long j) {
        return !IntOffset.m8287equalsimpl0(j, IntOffset.Companion.m8298getMaxnOccac());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: analyzeComponents-58bKbWc  reason: not valid java name */
    public static final int m7405analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
