...
public final class RectManagerKt {
    ...
    public static final boolean m6487isSetgyyYBs(long j) {
        return !IntOffset.m7378equalsimpl0(j, IntOffset.Companion.m7389getMaxnOccac());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: analyzeComponents-58bKbWc  reason: not valid java name */
    public static final int m6486analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
