...
public final class RectList {
    ...
    public final void insertBasedOnParentOffset(int i, int i2, int i3, int i4, int i5, int i6, boolean z, boolean z2, boolean z3) {
        int i7 = i & 33554431;
        long[] jArr = this.items;
        for (int i8 = this.itemsSize - 3; i8 >= 0; i8 -= 3) {
            if ((((int) jArr[i8 + 2]) & 33554431) == i2) {
                long j = jArr[i8];
                int i9 = ((int) (j >> 32)) + i3;
                int i10 = ((int) j) + i4;
                insert(i7, i9, i10, i9 + i5, i10 + i6, i2, z, z2, z3, i8);
                return;
            }
        }
    }
    ...
    public final void forEachGesturableIntersection(int i, int i2, int i3, int i4, Function1<? super Integer, Unit> function1) {
        long j = (i << 32) | (i2 & 4294967295L);
        long j2 = (i3 << 32) | (i4 & 4294967295L);
        long[] jArr = this.items;
        int i5 = this.itemsSize;
    ...
    public final String debugString() {
        ...
        for (int i2 = 0; i2 < jArr.length - 2 && i2 < i; i2 += 3) {
            ...
            long j2 = jArr[i2 + 1];
            long j3 = jArr[i2 + 2];
            sb.append("id=" + (((int) j3) & 33554431) + ", rect=[" + ((int) (j >> 32)) + AbstractJsonLexerKt.COMMA + ((int) j) + AbstractJsonLexerKt.COMMA + ((int) (j2 >> 32)) + AbstractJsonLexerKt.COMMA + ((int) j2) + "], parent=" + (33554431 & ((int) (j3 >> 25))) + ", lastChildOffset=" + (((int) (j3 >> 50)) & 1023) + ", updated=" + (((int) (j3 >> 60)) & 1) + ", focusable=" + (((int) (j3 >> 61)) & 1) + ", gesturable=" + (((int) (j3 >> 62)) & 1)).append('\n');
        }
        return sb.toString();
    }
