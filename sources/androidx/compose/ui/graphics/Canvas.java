...
public interface Canvas {
    ...
    void mo5273clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo5274clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc */
    void mo5275concat58bKbWc(float[] fArr);
    ...
    void mo5276drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo5277drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo5278drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo5279drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo5280drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo5281drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo5282drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m5402clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m5399clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m5397clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m5399clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    default void m5399clipRectmtrdDE(Rect rect, int i) {
        mo5274clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m5396clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5274clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
    static /* synthetic */ void m5395clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5273clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m5398drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long j5;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m8397getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m8397getZeronOccac() : j;
        if ((i & 4) != 0) {
            j5 = IntSize.m8424constructorimpl((imageBitmap.getHeight() & 4294967295L) | (imageBitmap.getWidth() << 32));
        } else {
            j5 = j2;
        }
        canvas.mo5278drawImageRectHPBpro0(imageBitmap, m8397getZeronOccac, j5, (i & 8) != 0 ? IntOffset.Companion.m8397getZeronOccac() : j3, (i & 16) != 0 ? j5 : j4, paint);
    }
}
