...
public interface Canvas {
    ...
    void mo5197clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo5198clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: concat-58bKbWc */
    void mo5199concat58bKbWc(float[] fArr);
    ...
    void mo5200drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo5201drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo5202drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo5203drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo5204drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo5205drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo5206drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m5326clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m5323clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m5321clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m5323clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
    default void m5323clipRectmtrdDE(Rect rect, int i) {
        mo5198clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m5320clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5198clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
    static /* synthetic */ void m5319clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5197clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m5322drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        long j5;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long m8299getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m8299getZeronOccac() : j;
        if ((i & 4) != 0) {
            j5 = IntSize.m8326constructorimpl((imageBitmap.getHeight() & 4294967295L) | (imageBitmap.getWidth() << 32));
        } else {
            j5 = j2;
        }
        canvas.mo5202drawImageRectHPBpro0(imageBitmap, m8299getZeronOccac, j5, (i & 8) != 0 ? IntOffset.Companion.m8299getZeronOccac() : j3, (i & 16) != 0 ? j5 : j4, paint);
    }
}
