...
public final class ImageVectorKt {
    ...
    public static /* synthetic */ ImageVector.Builder m6018pathR_LF3I$default(ImageVector.Builder builder, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1 function1, int i4, Object obj) {
    ...
    public static final ImageVector.Builder m6017pathR_LF3I(ImageVector.Builder builder, String str, Brush brush, float f, Brush brush2, float f2, float f3, int i, int i2, float f4, int i3, Function1<? super PathBuilder, Unit> function1) {
        ImageVector.Builder m6016addPathoIyEayM;
        PathBuilder pathBuilder = new PathBuilder();
        function1.invoke(pathBuilder);
