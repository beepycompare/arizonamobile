...
public final class PathComponent extends VNode {
    ...
    public final int m6083getPathFillTypeRgk1Os() {
        return this.pathFillType;
    }

    /* renamed from: setPathFillType-oQ8Xj4U  reason: not valid java name */
    public final void m6086setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo5238setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final int m6084getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: setStrokeLineCap-BeK7IIE  reason: not valid java name */
    public final void m6087setStrokeLineCapBeK7IIE(int i) {
    ...
    public final int m6085getStrokeLineJoinLxFBmk8() {
        return this.strokeLineJoin;
    }

    /* renamed from: setStrokeLineJoin-Ww9F2mQ  reason: not valid java name */
    public final void m6088setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int mo5236getFillTypeRgk1Os = this.renderPath.mo5236getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo5238setFillTypeoQ8Xj4U(mo5236getFillTypeRgk1Os);
        }
        ...
        if (f3 > f4) {
            ...
            Path.m5632addPathUv8p0NA$default(this.renderPath, tmpPath, 0L, 2, null);
            tmpPath.reset();
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m5911drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m5911drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
