...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.Companion.m5003getArgb8888_sVssgQ();
    ...
    public final void m5496drawCachedImageFqjB98A(int i, long j, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> function1) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmap = this.mCachedImage;
        Canvas canvas = this.cachedCanvas;
        if (imageBitmap == null || canvas == null || ((int) (j >> 32)) > imageBitmap.getWidth() || ((int) (j & 4294967295L)) > imageBitmap.getHeight() || !ImageBitmapConfig.m4998equalsimpl0(this.config, i)) {
            imageBitmap = ImageBitmapKt.m5008ImageBitmapx__hDU$default((int) (j >> 32), (int) (4294967295L & j), i, false, null, 24, null);
    ...
    public final void drawInto(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        DrawScope.m5329drawImageAZ2fEMs$default(drawScope, imageBitmap, 0L, this.size, 0L, 0L, f, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m5340drawRectnJ9OG0$default(drawScope, Color.Companion.m4798getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m4685getClear0nO6VwU(), 62, null);
    }
}
