...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m5146getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m5157getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.Companion.m4710getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m4807getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.Companion.m5069getNonZeroRgk1Os();
    ...
    public static final boolean m5520rgbEqualOWjLjI(long j, long j2) {
        return Color.m4778getRedimpl(j) == Color.m4778getRedimpl(j2) && Color.m4777getGreenimpl(j) == Color.m4777getGreenimpl(j2) && Color.m4775getBlueimpl(j) == Color.m4775getBlueimpl(j2);
    }

    /* renamed from: toOpaque-8_81llA  reason: not valid java name */
    public static final long m5521toOpaque8_81llA(long j) {
        return Color.m4774getAlphaimpl(j) == 1.0f ? j : Color.m4771copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m4681equalsimpl0(blendModeColorFilter.m4714getBlendMode0nO6VwU(), BlendMode.Companion.m4710getSrcIn0nO6VwU()) || BlendMode.m4681equalsimpl0(blendModeColorFilter.m4714getBlendMode0nO6VwU(), BlendMode.Companion.m4712getSrcOver0nO6VwU());
    }
}
