...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m5800getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m5811getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.Companion.m5362getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m5459getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.Companion.m5723getNonZeroRgk1Os();
    ...
    public static final boolean m6179rgbEqualOWjLjI(long j, long j2) {
        return Color.m5430getRedimpl(j) == Color.m5430getRedimpl(j2) && Color.m5429getGreenimpl(j) == Color.m5429getGreenimpl(j2) && Color.m5427getBlueimpl(j) == Color.m5427getBlueimpl(j2);
    }

    /* renamed from: toOpaque-8_81llA  reason: not valid java name */
    public static final long m6180toOpaque8_81llA(long j) {
        return Color.m5426getAlphaimpl(j) == 1.0f ? j : Color.m5423copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m5333equalsimpl0(blendModeColorFilter.m5366getBlendMode0nO6VwU(), BlendMode.Companion.m5362getSrcIn0nO6VwU()) || BlendMode.m5333equalsimpl0(blendModeColorFilter.m5366getBlendMode0nO6VwU(), BlendMode.Companion.m5364getSrcOver0nO6VwU());
    }
}
