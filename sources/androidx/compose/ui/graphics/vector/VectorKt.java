...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m5722getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m5733getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.Companion.m5286getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m5383getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.Companion.m5645getNonZeroRgk1Os();
    ...
    public static final boolean m6096rgbEqualOWjLjI(long j, long j2) {
        return Color.m5354getRedimpl(j) == Color.m5354getRedimpl(j2) && Color.m5353getGreenimpl(j) == Color.m5353getGreenimpl(j2) && Color.m5351getBlueimpl(j) == Color.m5351getBlueimpl(j2);
    }

    /* renamed from: toOpaque-8_81llA  reason: not valid java name */
    public static final long m6097toOpaque8_81llA(long j) {
        return Color.m5350getAlphaimpl(j) == 1.0f ? j : Color.m5347copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m5257equalsimpl0(blendModeColorFilter.m5290getBlendMode0nO6VwU(), BlendMode.Companion.m5286getSrcIn0nO6VwU()) || BlendMode.m5257equalsimpl0(blendModeColorFilter.m5290getBlendMode0nO6VwU(), BlendMode.Companion.m5288getSrcOver0nO6VwU());
    }
}
