...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m5650getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m5661getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.Companion.m5219getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m5315getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.Companion.m5575getNonZeroRgk1Os();
    ...
    public static final boolean m6033rgbEqualOWjLjI(long j, long j2) {
        return Color.m5286getRedimpl(j) == Color.m5286getRedimpl(j2) && Color.m5285getGreenimpl(j) == Color.m5285getGreenimpl(j2) && Color.m5283getBlueimpl(j) == Color.m5283getBlueimpl(j2);
    }

    /* renamed from: toOpaque-8_81llA  reason: not valid java name */
    public static final long m6034toOpaque8_81llA(long j) {
        return Color.m5282getAlphaimpl(j) == 1.0f ? j : Color.m5279copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m5190equalsimpl0(blendModeColorFilter.m5223getBlendMode0nO6VwU(), BlendMode.Companion.m5219getSrcIn0nO6VwU()) || BlendMode.m5190equalsimpl0(blendModeColorFilter.m5223getBlendMode0nO6VwU(), BlendMode.Companion.m5221getSrcOver0nO6VwU());
    }
}
