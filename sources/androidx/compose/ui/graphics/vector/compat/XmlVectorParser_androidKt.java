...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5538getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m5146getButtKaPHkGw();
        }
        return m5537getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m5537getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m5148getSquareKaPHkGw();
            }
            return StrokeCap.Companion.m5147getRoundKaPHkGw();
        }
        return StrokeCap.Companion.m5146getButtKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default  reason: not valid java name */
    static /* synthetic */ int m5540getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m5157getMiterLxFBmk8();
        }
        return m5539getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m5539getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m5156getBevelLxFBmk8();
            }
            return StrokeJoin.Companion.m5158getRoundLxFBmk8();
        }
        return StrokeJoin.Companion.m5157getMiterLxFBmk8();
    }
        ...
        if (namedFloat > 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type == 2) {
                    m4808getUnspecified0d7_KjU = Color.Companion.m4808getUnspecified0d7_KjU();
                } else {
                    ...
                    if (namedColorStateList != null) {
                        m4808getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                    } else {
                        m4808getUnspecified0d7_KjU = Color.Companion.m4808getUnspecified0d7_KjU();
                    }
                }
            ...
            long j = m4808getUnspecified0d7_KjU;
            ...
            if (i == -1) {
                m4710getSrcIn0nO6VwU = BlendMode.Companion.m4710getSrcIn0nO6VwU();
            } else if (i == 3) {
                m4710getSrcIn0nO6VwU = BlendMode.Companion.m4712getSrcOver0nO6VwU();
            } else if (i == 5) {
                m4710getSrcIn0nO6VwU = BlendMode.Companion.m4710getSrcIn0nO6VwU();
            } else if (i == 9) {
                m4710getSrcIn0nO6VwU = BlendMode.Companion.m4709getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m4710getSrcIn0nO6VwU = BlendMode.Companion.m4701getModulate0nO6VwU();
                        break;
                    case 15:
                        m4710getSrcIn0nO6VwU = BlendMode.Companion.m4706getScreen0nO6VwU();
                        break;
                    case 16:
                        m4710getSrcIn0nO6VwU = BlendMode.Companion.m4704getPlus0nO6VwU();
                        break;
                    default:
                        m4710getSrcIn0nO6VwU = BlendMode.Companion.m4710getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m4710getSrcIn0nO6VwU;
            float m7555constructorimpl = Dp.m7555constructorimpl(dimension / resources.getDisplayMetrics().density);
            float m7555constructorimpl2 = Dp.m7555constructorimpl(dimension2 / resources.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m7555constructorimpl, m7555constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
        }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m5537getStrokeLineCapCSYIeUk = m5537getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m5146getButtKaPHkGw());
        int m5539getStrokeLineJoinkLtJ_vA = m5539getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m5157getMiterLxFBmk8());
        ...
        obtainAttributes.recycle();
        builder.m5504addPathoIyEayM(list, namedInt == 0 ? PathFillType.Companion.m5069getNonZeroRgk1Os() : PathFillType.Companion.m5068getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, m5537getStrokeLineCapCSYIeUk, m5539getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
