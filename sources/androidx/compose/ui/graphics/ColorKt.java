...
public final class ColorKt {
    ...
    */
    public static final long Color(float f, float f2, float f3, float f4, ColorSpace colorSpace) {
        ...
        if (colorSpace.isSrgb()) {
            ...
            return Color.m5344constructorimpl(ULong.m10100constructorimpl(ULong.m10100constructorimpl(i13 | ((int) ((((f3 >= 0.0f ? f3 : 0.0f) <= 1.0f ? f5 : 1.0f) * 255.0f) + 0.5f))) << 32));
        }
        ...
        if (i15 == 255) {
            ...
            if (i >= 31) {
                ...
                if ((floatToRawIntBits & 4096) != 0) {
                                ...
                                if (i8 == 255) {
                                    ...
                                    if (i23 >= 31) {
                                        ...
                                        if ((floatToRawIntBits3 & 4096) != 0) {
                                            ...
                                            return Color.m5344constructorimpl(ULong.m10100constructorimpl((id$ui_graphics & 63) | ((s & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s2 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((WebSocketProtocol.PAYLOAD_SHORT_MAX & ((short) i10)) << 16) | ((((int) ((((f4 >= 0.0f ? f4 : 0.0f) <= 1.0f ? f5 : 1.0f) * 1023.0f) + 0.5f)) & 1023) << 6)));
                                        }
                                        i9 = i24;
                                        r8 = i23;
                                    } else if (i23 >= -10) {
                    ...
                    return Color.m5344constructorimpl(ULong.m10100constructorimpl((id$ui_graphics & 63) | ((s & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s22 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((WebSocketProtocol.PAYLOAD_SHORT_MAX & ((short) i10)) << 16) | ((((int) ((((f4 >= 0.0f ? f4 : 0.0f) <= 1.0f ? f5 : 1.0f) * 1023.0f) + 0.5f)) & 1023) << 6)));
                }
                i2 = i17;
            } else if (i >= -10) {
        ...
        return Color.m5344constructorimpl(ULong.m10100constructorimpl((id$ui_graphics & 63) | ((s3 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s222 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((WebSocketProtocol.PAYLOAD_SHORT_MAX & ((short) i10)) << 16) | ((((int) ((((f4 >= 0.0f ? f4 : 0.0f) <= 1.0f ? f5 : 1.0f) * 1023.0f) + 0.5f)) & 1023) << 6)));
    }
    ...
    */
    public static final long UncheckedColor(float f, float f2, float f3, float f4, ColorSpace colorSpace) {
        ...
        int i9;
        if (colorSpace.isSrgb()) {
            return Color.m5344constructorimpl(ULong.m10100constructorimpl(ULong.m10100constructorimpl((((((int) ((f4 * 255.0f) + 0.5f)) << 24) | (((int) ((f * 255.0f) + 0.5f)) << 16)) | (((int) ((f2 * 255.0f) + 0.5f)) << 8)) | ((int) ((255.0f * f3) + 0.5f))) << 32));
        }
        ...
        if (i11 == 255) {
            ...
            if (i >= 31) {
                ...
                if ((floatToRawIntBits & 4096) != 0) {
                                    ...
                                    if (i21 < 31) {
                                        if (i21 > 0) {
                                            ...
                                            if ((floatToRawIntBits3 & 4096) != 0) {
                                                ...
                                                return Color.m5344constructorimpl(ULong.m10100constructorimpl(((((short) i9) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 16) | ((s & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s2 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((((int) ((Math.max(0.0f, Math.min(f4, 1.0f)) * 1023.0f) + 0.5f)) & 1023) << 6) | (colorSpace.getId$ui_graphics() & 63)));
                                            }
                                            i13 = i21;
                                        } else if (i21 >= -10) {
                    ...
                    return Color.m5344constructorimpl(ULong.m10100constructorimpl(((((short) i9) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 16) | ((s & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s22 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((((int) ((Math.max(0.0f, Math.min(f4, 1.0f)) * 1023.0f) + 0.5f)) & 1023) << 6) | (colorSpace.getId$ui_graphics() & 63)));
                }
                i2 = i15;
            } else if (i >= -10) {
        ...
        return Color.m5344constructorimpl(ULong.m10100constructorimpl(((((short) i9) & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 16) | ((s3 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | ((s222 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 32) | ((((int) ((Math.max(0.0f, Math.min(f4, 1.0f)) * 1023.0f) + 0.5f)) & 1023) << 6) | (colorSpace.getId$ui_graphics() & 63)));
    }

    public static final long Color(int i) {
        return Color.m5344constructorimpl(ULong.m10100constructorimpl(ULong.m10100constructorimpl(i) << 32));
    }

    public static final long Color(long j) {
        return Color.m5344constructorimpl(ULong.m10100constructorimpl(j << 32));
    }
    ...
    public static final int m5402toArgb8_81llA(long j) {
        return (int) ULong.m10100constructorimpl(Color.m5345convertvNxB06k(j, ColorSpaces.INSTANCE.getSrgb()) >>> 32);
    }
