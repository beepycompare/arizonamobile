...
public final class AndroidPath implements Path {
    ...
    public int mo5312getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m5722getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m5723getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void mo5314setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m5718equalsimpl0(i, PathFillType.Companion.m5722getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect, Path.Direction direction) {
        ...
        fArr[0] = Float.intBitsToFloat((int) (roundRect.m5229getTopLeftCornerRadiuskKHJgLs() >> 32));
        fArr[1] = Float.intBitsToFloat((int) (roundRect.m5229getTopLeftCornerRadiuskKHJgLs() & 4294967295L));
        fArr[2] = Float.intBitsToFloat((int) (roundRect.m5230getTopRightCornerRadiuskKHJgLs() >> 32));
        fArr[3] = Float.intBitsToFloat((int) (roundRect.m5230getTopRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[4] = Float.intBitsToFloat((int) (roundRect.m5228getBottomRightCornerRadiuskKHJgLs() >> 32));
        fArr[5] = Float.intBitsToFloat((int) (roundRect.m5228getBottomRightCornerRadiuskKHJgLs() & 4294967295L));
        fArr[6] = Float.intBitsToFloat((int) (roundRect.m5227getBottomLeftCornerRadiuskKHJgLs() >> 32));
        fArr[7] = Float.intBitsToFloat((int) (roundRect.m5227getBottomLeftCornerRadiuskKHJgLs() & 4294967295L));
        android.graphics.Path path = this.internalPath;
        RectF rectF2 = this.rectF;
        Intrinsics.checkNotNull(rectF2);
    ...
    public void mo5311addPathUv8p0NA(Path path, long j) {
    ...
    public void mo5316translatek4lQ0M(long j) {
    ...
    public void mo5315transform58bKbWc(float[] fArr) {
    ...
    public boolean mo5313opN5in7k0(Path path, Path path2, int i) {
        Path.Op op;
        if (PathOperation.m5728equalsimpl0(i, PathOperation.Companion.m5732getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m5728equalsimpl0(i, PathOperation.Companion.m5733getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m5728equalsimpl0(i, PathOperation.Companion.m5734getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m5728equalsimpl0(i, PathOperation.Companion.m5735getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
