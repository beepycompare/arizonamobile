...
public final class AndroidColor_androidKt {
    ...
    public static final long m5144toColorLong8_81llA(long j) {
        int compare;
        long j2 = 63 & j;
        compare = Long.compare(ULong.m10083constructorimpl(j2) ^ Long.MIN_VALUE, 16 ^ Long.MIN_VALUE);
        return compare < 0 ? j : ULong.m10083constructorimpl(ULong.m10083constructorimpl(j & ULong.m10083constructorimpl(-64L)) | ULong.m10083constructorimpl(ULong.m10083constructorimpl(j2) - 1));
    }
    ...
    public static final long fromColorLong(Color.Companion companion, long j) {
        ...
        return Color.m5276constructorimpl(ULong.m10083constructorimpl(j));
    }
}
