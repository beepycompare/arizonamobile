...
public final class PaintingStyle {
    ...
    private static final int Fill = m5701constructorimpl(0);
    private static final int Stroke = m5701constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m5700boximpl(int i) {
    ...
    public static boolean m5702equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m5706unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5707getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m5708getStrokeTiuSbCo() {
    ...
    public static String m5705toStringimpl(int i) {
        return m5703equalsimpl0(i, Fill) ? "Fill" : m5703equalsimpl0(i, Stroke) ? "Stroke" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
