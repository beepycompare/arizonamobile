...
public final class PaintingStyle {
    ...
    private static final int Fill = m5047constructorimpl(0);
    private static final int Stroke = m5047constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m5046boximpl(int i) {
    ...
    public static boolean m5048equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).m5052unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5053getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo  reason: not valid java name */
        public final int m5054getStrokeTiuSbCo() {
    ...
    public static String m5051toStringimpl(int i) {
        return m5049equalsimpl0(i, Fill) ? "Fill" : m5049equalsimpl0(i, Stroke) ? "Stroke" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
