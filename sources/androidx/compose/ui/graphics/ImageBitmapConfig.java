...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m4996constructorimpl(0);
    private static final int Alpha8 = m4996constructorimpl(1);
    private static final int Rgb565 = m4996constructorimpl(2);
    private static final int F16 = m4996constructorimpl(3);
    private static final int Gpu = m4996constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m4995boximpl(int i) {
    ...
    public static boolean m4997equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m5001unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5003getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ  reason: not valid java name */
        public final int m5002getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ  reason: not valid java name */
        public final int m5006getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ  reason: not valid java name */
        public final int m5004getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ  reason: not valid java name */
        public final int m5005getGpu_sVssgQ() {
    ...
    public static String m5000toStringimpl(int i) {
        return m4998equalsimpl0(i, Argb8888) ? "Argb8888" : m4998equalsimpl0(i, Alpha8) ? "Alpha8" : m4998equalsimpl0(i, Rgb565) ? "Rgb565" : m4998equalsimpl0(i, F16) ? "F16" : m4998equalsimpl0(i, Gpu) ? "Gpu" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
