...
public final class RadialGradient extends ShaderBrush implements Interpolatable {
    ...
    public final long m5094getCenterF1C5BW0$ui_graphics() {
        return this.center;
    }
    ...
    public /* synthetic */ RadialGradient(List list, List list2, long j, float f, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, f, (i2 & 16) != 0 ? TileMode.Companion.m5167getClamp3opZhB0() : i, null);
    }

    /* renamed from: getTileMode-3opZhB0$ui_graphics  reason: not valid java name */
    public final int m5095getTileMode3opZhB0$ui_graphics() {
    ...
    public Shader mo4741createShaderuvyYCjk(long j) {
        ...
        if ((9223372034707292159L & j2) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            long m4606getCenteruvyYCjk = SizeKt.m4606getCenteruvyYCjk(j);
            intBitsToFloat = Float.intBitsToFloat((int) (m4606getCenteruvyYCjk >> 32));
            intBitsToFloat2 = Float.intBitsToFloat((int) (m4606getCenteruvyYCjk & 4294967295L));
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RadialGradient) {
            ...
            return Intrinsics.areEqual(this.colors, radialGradient.colors) && Intrinsics.areEqual(this.stops, radialGradient.stops) && Offset.m4524equalsimpl0(this.center, radialGradient.center) && this.radius == radialGradient.radius && TileMode.m5163equalsimpl0(this.tileMode, radialGradient.tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m4529hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m5164hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? "center=" + ((Object) Offset.m4535toStringimpl(this.center)) + ", " : "") + ((Float.floatToRawIntBits(this.radius) & Integer.MAX_VALUE) < 2139095040 ? "radius=" + this.radius + ", " : "") + "tileMode=" + ((Object) TileMode.m5165toStringimpl(this.tileMode)) + ')';
    }
    ...
    public Object lerp(Object obj, float f) {
        ...
        if (obj instanceof RadialGradient) {
            RadialGradient radialGradient = (RadialGradient) obj;
            return new RadialGradient(BrushKt.lerpColorList(this.colors, radialGradient.colors, f), BrushKt.lerpNullableFloatList(this.stops, radialGradient.stops, f), OffsetKt.m4550lerpWko1d7g(this.center, radialGradient.center, f), MathHelpersKt.lerp(this.radius, radialGradient.radius, f), f < 0.5f ? this.tileMode : radialGradient.tileMode, null);
        }
        return null;
    }
}
