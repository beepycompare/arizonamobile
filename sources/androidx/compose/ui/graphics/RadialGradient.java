...
public final class RadialGradient extends ShaderBrush implements Interpolatable {
    ...
    public final long m5670getCenterF1C5BW0$ui_graphics() {
        return this.center;
    }
    ...
    public /* synthetic */ RadialGradient(List list, List list2, long j, float f, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, f, (i2 & 16) != 0 ? TileMode.Companion.m5743getClamp3opZhB0() : i, null);
    }

    /* renamed from: getTileMode-3opZhB0$ui_graphics  reason: not valid java name */
    public final int m5671getTileMode3opZhB0$ui_graphics() {
    ...
    public long mo5294getIntrinsicSizeNHjbRc() {
        if ((Float.floatToRawIntBits(this.radius) & Integer.MAX_VALUE) < 2139095040) {
            float f = this.radius;
            return Size.m5163constructorimpl((Float.floatToRawIntBits(f * 2.0f) << 32) | (Float.floatToRawIntBits(f * 2.0f) & 4294967295L));
        }
    ...
    public Shader mo5317createShaderuvyYCjk(long j) {
        ...
        if ((9223372034707292159L & j2) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            long m5182getCenteruvyYCjk = SizeKt.m5182getCenteruvyYCjk(j);
            intBitsToFloat = Float.intBitsToFloat((int) (m5182getCenteruvyYCjk >> 32));
            intBitsToFloat2 = Float.intBitsToFloat((int) (m5182getCenteruvyYCjk & 4294967295L));
        } else {
        ...
        long m5095constructorimpl = Offset.m5095constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (4294967295L & Float.floatToRawIntBits(intBitsToFloat2)));
        float f = this.radius;
        if (f == Float.POSITIVE_INFINITY) {
            f = Size.m5171getMinDimensionimpl(j) / 2.0f;
        }
        return ShaderKt.m5684RadialGradientShader8uybcMk(m5095constructorimpl, f, list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RadialGradient) {
            ...
            return Intrinsics.areEqual(this.colors, radialGradient.colors) && Intrinsics.areEqual(this.stops, radialGradient.stops) && Offset.m5100equalsimpl0(this.center, radialGradient.center) && this.radius == radialGradient.radius && TileMode.m5739equalsimpl0(this.tileMode, radialGradient.tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m5105hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m5740hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? "center=" + ((Object) Offset.m5111toStringimpl(this.center)) + ", " : "") + ((Float.floatToRawIntBits(this.radius) & Integer.MAX_VALUE) < 2139095040 ? "radius=" + this.radius + ", " : "") + "tileMode=" + ((Object) TileMode.m5741toStringimpl(this.tileMode)) + ')';
    }
    ...
    public Object lerp(Object obj, float f) {
        ...
        if (obj instanceof SolidColor) {
            ...
            for (int i = 0; i < size; i++) {
                list.get(i).m5358unboximpl();
                arrayList.add(Color.m5338boximpl(((SolidColor) obj).m5704getValue0d7_KjU()));
            }
            obj = new RadialGradient(arrayList, this.stops, this.center, this.radius, this.tileMode, null);
        }
        if (obj instanceof RadialGradient) {
            RadialGradient radialGradient = (RadialGradient) obj;
            return new RadialGradient(BrushKt.lerpColorList(this.colors, radialGradient.colors, f), BrushKt.lerpNullableFloatList(this.stops, radialGradient.stops, f), OffsetKt.m5126lerpWko1d7g(this.center, radialGradient.center, f), MathHelpersKt.lerp(this.radius, radialGradient.radius, f), f < 0.5f ? this.tileMode : radialGradient.tileMode, null);
        }
        return null;
    }
}
