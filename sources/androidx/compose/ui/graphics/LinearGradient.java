...
public final class LinearGradient extends ShaderBrush implements Interpolatable {
    ...
    public final long m5012getStartF1C5BW0$ui_graphics() {
        return this.start;
    }

    /* renamed from: getEnd-F1C5BW0$ui_graphics  reason: not valid java name */
    public final long m5011getEndF1C5BW0$ui_graphics() {
        return this.end;
    }
    ...
    public /* synthetic */ LinearGradient(List list, List list2, long j, long j2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, j2, (i2 & 16) != 0 ? TileMode.Companion.m5167getClamp3opZhB0() : i, null);
    }

    /* renamed from: getTileMode-3opZhB0$ui_graphics  reason: not valid java name */
    public final int m5013getTileMode3opZhB0$ui_graphics() {
    ...
    public Shader mo4741createShaderuvyYCjk(long j) {
        ...
        return ShaderKt.m5106LinearGradientShaderVjE6UOU(Offset.m4519constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L)), Offset.m4519constructorimpl((Float.floatToRawIntBits(intBitsToFloat4) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat3) << 32)), list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LinearGradient) {
            ...
            return Intrinsics.areEqual(this.colors, linearGradient.colors) && Intrinsics.areEqual(this.stops, linearGradient.stops) && Offset.m4524equalsimpl0(this.start, linearGradient.start) && Offset.m4524equalsimpl0(this.end, linearGradient.end) && TileMode.m5163equalsimpl0(this.tileMode, linearGradient.tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m4529hashCodeimpl(this.start)) * 31) + Offset.m4529hashCodeimpl(this.end)) * 31) + TileMode.m5164hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "LinearGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + (((((this.start & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "start=" + ((Object) Offset.m4535toStringimpl(this.start)) + ", " : "") + ((((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (this.end & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "end=" + ((Object) Offset.m4535toStringimpl(this.end)) + ", " : "") + "tileMode=" + ((Object) TileMode.m5165toStringimpl(this.tileMode)) + ')';
    }

    @Override // androidx.compose.ui.graphics.Interpolatable
    public Object lerp(Object obj, float f) {
        LinearGradient solidColor = obj == null ? new SolidColor(Color.Companion.m4807getTransparent0d7_KjU(), null) : obj;
        if (solidColor instanceof SolidColor) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList.add(Color.m4762boximpl(((SolidColor) solidColor).m5128getValue0d7_KjU()));
            }
