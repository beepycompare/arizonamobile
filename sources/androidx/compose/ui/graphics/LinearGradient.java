...
public final class LinearGradient extends ShaderBrush implements Interpolatable {
    ...
    public final long m5588getStartF1C5BW0$ui_graphics() {
        return this.start;
    }

    /* renamed from: getEnd-F1C5BW0$ui_graphics  reason: not valid java name */
    public final long m5587getEndF1C5BW0$ui_graphics() {
        return this.end;
    }
    ...
    public /* synthetic */ LinearGradient(List list, List list2, long j, long j2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, j2, (i2 & 16) != 0 ? TileMode.Companion.m5743getClamp3opZhB0() : i, null);
    }

    /* renamed from: getTileMode-3opZhB0$ui_graphics  reason: not valid java name */
    public final int m5589getTileMode3opZhB0$ui_graphics() {
    ...
    public long mo5294getIntrinsicSizeNHjbRc() {
        ...
        return Size.m5163constructorimpl((Float.floatToRawIntBits(abs) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
    }
    ...
    public Shader mo5317createShaderuvyYCjk(long j) {
        ...
        return ShaderKt.m5682LinearGradientShaderVjE6UOU(Offset.m5095constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat2) & 4294967295L)), Offset.m5095constructorimpl((Float.floatToRawIntBits(intBitsToFloat4) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat3) << 32)), list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LinearGradient) {
            ...
            return Intrinsics.areEqual(this.colors, linearGradient.colors) && Intrinsics.areEqual(this.stops, linearGradient.stops) && Offset.m5100equalsimpl0(this.start, linearGradient.start) && Offset.m5100equalsimpl0(this.end, linearGradient.end) && TileMode.m5739equalsimpl0(this.tileMode, linearGradient.tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m5105hashCodeimpl(this.start)) * 31) + Offset.m5105hashCodeimpl(this.end)) * 31) + TileMode.m5740hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "LinearGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + (((((this.start & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "start=" + ((Object) Offset.m5111toStringimpl(this.start)) + ", " : "") + ((((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (this.end & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "end=" + ((Object) Offset.m5111toStringimpl(this.end)) + ", " : "") + "tileMode=" + ((Object) TileMode.m5741toStringimpl(this.tileMode)) + ')';
    }

    @Override // androidx.compose.ui.graphics.Interpolatable
    public Object lerp(Object obj, float f) {
        LinearGradient solidColor = obj == null ? new SolidColor(Color.Companion.m5383getTransparent0d7_KjU(), null) : obj;
        if (solidColor instanceof SolidColor) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList.add(Color.m5338boximpl(((SolidColor) solidColor).m5704getValue0d7_KjU()));
            }
        ...
        if (solidColor instanceof LinearGradient) {
            ...
            return new LinearGradient(BrushKt.lerpColorList(this.colors, linearGradient.colors, f), BrushKt.lerpNullableFloatList(this.stops, linearGradient.stops, f), BrushKt.m5316lerpSafeWko1d7g(this.start, linearGradient.start, f), BrushKt.m5316lerpSafeWko1d7g(this.end, linearGradient.end, f), f < 0.5f ? this.tileMode : linearGradient.tileMode, null);
        }
        return null;
    }
}
