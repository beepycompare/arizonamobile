...
public final class LinearGradient extends ShaderBrush {
    ...
    public /* synthetic */ LinearGradient(List list, List list2, long j, long j2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, j2, (i2 & 16) != 0 ? TileMode.Companion.m4927getClamp3opZhB0() : i, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LinearGradient) {
            ...
            return Intrinsics.areEqual(this.colors, linearGradient.colors) && Intrinsics.areEqual(this.stops, linearGradient.stops) && Offset.m4290equalsimpl0(this.start, linearGradient.start) && Offset.m4290equalsimpl0(this.end, linearGradient.end) && TileMode.m4923equalsimpl0(this.tileMode, linearGradient.tileMode);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m4295hashCodeimpl(this.start)) * 31) + Offset.m4295hashCodeimpl(this.end)) * 31) + TileMode.m4924hashCodeimpl(this.tileMode);
    }

    public String toString() {
        return "LinearGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + (((((this.start & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "start=" + ((Object) Offset.m4301toStringimpl(this.start)) + ", " : "") + ((((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (this.end & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 ? "end=" + ((Object) Offset.m4301toStringimpl(this.end)) + ", " : "") + "tileMode=" + ((Object) TileMode.m4925toStringimpl(this.tileMode)) + ')';
    }
}
