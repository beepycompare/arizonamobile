...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        this.renderCreator.mo6050obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo5922getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m6071drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo5922getSizeNHjbRc(), this.shadow.m6066getColor0d7_KjU(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.m6065getBlendMode0nO6VwU());
    }
