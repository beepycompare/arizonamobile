...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        this.renderCreator.mo6133obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo6005getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m6154drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo6005getSizeNHjbRc(), this.shadow.m6149getColor0d7_KjU(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.m6148getBlendMode0nO6VwU());
    }
