...
public final class InnerShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        this.renderCreator.mo5474obtainInnerShadowRenderereZhPAX0(this.shape, drawScope.mo5346getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow).m5495drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo5346getSizeNHjbRc(), this.shadow.m5490getColor0d7_KjU(), this.shadow.getBrush(), RangesKt.coerceIn(this.alpha * this.shadow.getAlpha(), 0.0f, 1.0f), this.shadow.m5489getBlendMode0nO6VwU());
    }
