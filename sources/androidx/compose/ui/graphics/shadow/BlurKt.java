...
public final class BlurKt {
    ...
    public static /* synthetic */ Paint m6140configureShadowFoewPVk$default(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            j = Color.Companion.m5450getBlack0d7_KjU();
        }
        long j2 = j;
        if ((i3 & 2) != 0) {
            i = BlendMode.Companion.m5364getSrcOver0nO6VwU();
        }
        int i4 = i;
        if ((i3 & 4) != 0) {
            blurMaskFilter = null;
        ...
        if ((i3 & 8) != 0) {
            i2 = PaintingStyle.Companion.m5707getFillTiuSbCo();
        }
        return m6139configureShadowFoewPVk(paint, j2, i4, blurMaskFilter2, i2);
    }

    /* renamed from: configureShadow-FoewPVk  reason: not valid java name */
    public static final Paint m6139configureShadowFoewPVk(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2) {
        paint.mo5300setColor8_81llA(j);
        paint.mo5299setBlendModes9anfk8(i);
        paint.mo5304setStylek9PVt8s(i2);
