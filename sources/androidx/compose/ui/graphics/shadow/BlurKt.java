...
public final class BlurKt {
    ...
    public static /* synthetic */ Paint m5251configureShadowFoewPVk$default(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            j = Color.Companion.m4563getBlack0d7_KjU();
        }
        long j2 = j;
        if ((i3 & 2) != 0) {
            i = BlendMode.Companion.m4478getSrcOver0nO6VwU();
        }
        int i4 = i;
        if ((i3 & 4) != 0) {
            blurMaskFilter = null;
        ...
        if ((i3 & 8) != 0) {
            i2 = PaintingStyle.Companion.m4816getFillTiuSbCo();
        }
        return m5250configureShadowFoewPVk(paint, j2, i4, blurMaskFilter2, i2);
    }

    /* renamed from: configureShadow-FoewPVk  reason: not valid java name */
    public static final Paint m5250configureShadowFoewPVk(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2) {
        paint.mo4414setColor8_81llA(j);
        paint.mo4413setBlendModes9anfk8(i);
        paint.mo4418setStylek9PVt8s(i2);
