...
public final class Shadow {
    ...
    private Shadow(float f, float f2, long j, long j2, Brush brush, float f3, int i) {
        ...
        if (brush instanceof SolidColor) {
            this.color = ((SolidColor) brush).m5782getValue0d7_KjU();
            this.brush = null;
        } else {
            this.color = j2;
            this.brush = brush;
    ...
    public final float m6151getRadiusD9Ej5fM() {
        return this.radius;
    }

    /* renamed from: getSpread-D9Ej5fM  reason: not valid java name */
    public final float m6152getSpreadD9Ej5fM() {
        return this.spread;
    }

    /* renamed from: getOffset-RKDOV3M  reason: not valid java name */
    public final long m6150getOffsetRKDOV3M() {
        return this.offset;
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m6148getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m6149getColor0d7_KjU() {
        return this.color;
    }
    ...
    private Shadow(float f, Brush brush, float f2, long j, float f3, int i) {
        this(f, f2, j, Color.Companion.m5450getBlack0d7_KjU(), brush, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ Shadow(float f, long j, float f2, long j2, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, (i2 & 2) != 0 ? Color.Companion.m5450getBlack0d7_KjU() : j, (i2 & 4) != 0 ? Dp.m8258constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.Companion.m8329getZeroRKDOV3M() : j2, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.Companion.m6007getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }

    private Shadow(float f, long j, float f2, long j2, float f3, int i) {
        this(f, f2, j2, j != 16 ? j : Color.Companion.m5450getBlack0d7_KjU(), (Brush) null, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Shadow) {
            ...
            return Dp.m8263equalsimpl0(this.radius, shadow.radius) && Dp.m8263equalsimpl0(this.spread, shadow.spread) && DpOffset.m8318equalsimpl0(this.offset, shadow.offset) && this.alpha == shadow.alpha && BlendMode.m5333equalsimpl0(this.blendMode, shadow.blendMode) && Color.m5425equalsimpl0(this.color, shadow.color) && Intrinsics.areEqual(this.brush, shadow.brush);
        }
        return false;
    }

    public int hashCode() {
        int m8264hashCodeimpl = ((((((((((Dp.m8264hashCodeimpl(this.radius) * 31) + Dp.m8264hashCodeimpl(this.spread)) * 31) + DpOffset.m8323hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.alpha)) * 31) + BlendMode.m5334hashCodeimpl(this.blendMode)) * 31) + Color.m5431hashCodeimpl(this.color)) * 31;
        Brush brush = this.brush;
        return m8264hashCodeimpl + (brush != null ? brush.hashCode() : 0);
    }

    public String toString() {
        return "Shadow(radius=" + ((Object) Dp.m8269toStringimpl(this.radius)) + ", spread=" + ((Object) Dp.m8269toStringimpl(this.spread)) + ", offset=" + ((Object) DpOffset.m8326toStringimpl(this.offset)) + ", alpha=" + this.alpha + ", blendMode=" + ((Object) BlendMode.m5335toStringimpl(this.blendMode)) + ", color=" + ((Object) Color.m5432toStringimpl(this.color)) + ", brush=" + this.brush + ')';
    }

    public final Shadow copyWithoutOffset$ui_graphics() {
        return new Shadow(this.radius, this.spread, DpOffset.Companion.m8329getZeroRKDOV3M(), this.color, this.brush, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }

    public final Shadow transparentCopy$ui_graphics() {
        return new Shadow(this.radius, Color.Companion.m5459getTransparent0d7_KjU(), this.spread, this.offset, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ Shadow(float f, Brush brush, float f2, long j, float f3, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, brush, (i2 & 4) != 0 ? Dp.m8258constructorimpl(0) : f2, (i2 & 8) != 0 ? DpOffset.Companion.m8329getZeroRKDOV3M() : j, (i2 & 16) != 0 ? 1.0f : f3, (i2 & 32) != 0 ? DrawScope.Companion.m6007getDefaultBlendMode0nO6VwU() : i, (DefaultConstructorMarker) null);
    }
}
