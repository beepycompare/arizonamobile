...
public final class Shadow {
    ...
    private Shadow(float f, float f2, long j, long j2, Brush brush, float f3, int i) {
        ...
        if (brush instanceof SolidColor) {
            this.color = ((SolidColor) brush).m5128getValue0d7_KjU();
            this.brush = null;
        } else {
            this.color = j2;
            this.brush = brush;
    ...
    public final float m5492getRadiusD9Ej5fM() {
        return this.radius;
    }

    /* renamed from: getSpread-D9Ej5fM  reason: not valid java name */
    public final float m5493getSpreadD9Ej5fM() {
        return this.spread;
    }

    /* renamed from: getOffset-RKDOV3M  reason: not valid java name */
    public final long m5491getOffsetRKDOV3M() {
        return this.offset;
    }
    ...
    public final long m5490getColor0d7_KjU() {
        return this.color;
    }
    ...
    private Shadow(float f, Brush brush, float f2, long j, float f3, int i) {
        this(f, f2, j, Color.Companion.m4798getBlack0d7_KjU(), brush, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    private Shadow(float f, long j, float f2, long j2, float f3, int i) {
        this(f, f2, j2, j != 16 ? j : Color.Companion.m4798getBlack0d7_KjU(), (Brush) null, f3, i, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Shadow) {
            ...
            return Dp.m7560equalsimpl0(this.radius, shadow.radius) && Dp.m7560equalsimpl0(this.spread, shadow.spread) && DpOffset.m7615equalsimpl0(this.offset, shadow.offset) && this.alpha == shadow.alpha && BlendMode.m4681equalsimpl0(this.blendMode, shadow.blendMode) && Color.m4773equalsimpl0(this.color, shadow.color) && Intrinsics.areEqual(this.brush, shadow.brush);
        }
        return false;
    }

    public int hashCode() {
        int m7561hashCodeimpl = ((((((((((Dp.m7561hashCodeimpl(this.radius) * 31) + Dp.m7561hashCodeimpl(this.spread)) * 31) + DpOffset.m7620hashCodeimpl(this.offset)) * 31) + Float.hashCode(this.alpha)) * 31) + BlendMode.m4682hashCodeimpl(this.blendMode)) * 31) + Color.m4779hashCodeimpl(this.color)) * 31;
        Brush brush = this.brush;
        return m7561hashCodeimpl + (brush != null ? brush.hashCode() : 0);
    }

    public String toString() {
        return "Shadow(radius=" + ((Object) Dp.m7566toStringimpl(this.radius)) + ", spread=" + ((Object) Dp.m7566toStringimpl(this.spread)) + ", offset=" + ((Object) DpOffset.m7623toStringimpl(this.offset)) + ", alpha=" + this.alpha + ", blendMode=" + ((Object) BlendMode.m4683toStringimpl(this.blendMode)) + ", color=" + ((Object) Color.m4780toStringimpl(this.color)) + ", brush=" + this.brush + ')';
    }

    public final Shadow copyWithoutOffset$ui_graphics() {
        return new Shadow(this.radius, this.spread, DpOffset.Companion.m7626getZeroRKDOV3M(), this.color, this.brush, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }

    public final Shadow transparentCopy$ui_graphics() {
        return new Shadow(this.radius, Color.Companion.m4807getTransparent0d7_KjU(), this.spread, this.offset, this.alpha, this.blendMode, (DefaultConstructorMarker) null);
    }
