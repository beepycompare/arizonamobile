...
public interface DropShadowRendererProvider {
    ...
    DropShadowRenderer mo5986obtainDropShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow);
    ...
    public static final class Companion {
        ...
        private static final DropShadowRendererProvider Default = new DropShadowRendererProvider() { // from class: androidx.compose.ui.graphics.shadow.DropShadowRendererProvider$Companion$Default$1
            ...
            /* renamed from: obtainDropShadowRenderer-eZhPAX0 */
            public final DropShadowRenderer mo5986obtainDropShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow) {
                return new DropShadowRenderer(shadow, shape.mo332createOutlinePq9zytI(j, layoutDirection, density));
            }
        };
