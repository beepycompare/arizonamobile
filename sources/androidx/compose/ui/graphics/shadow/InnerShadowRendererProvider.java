...
public interface InnerShadowRendererProvider {
    ...
    InnerShadowRenderer mo5987obtainInnerShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow);
    ...
    public static final class Companion {
        ...
        private static final InnerShadowRendererProvider Default = new InnerShadowRendererProvider() { // from class: androidx.compose.ui.graphics.shadow.InnerShadowRendererProvider$Companion$Default$1
            ...
            /* renamed from: obtainInnerShadowRenderer-eZhPAX0 */
            public final InnerShadowRenderer mo5987obtainInnerShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow) {
                return new InnerShadowRenderer(shadow, shape.mo332createOutlinePq9zytI(j, layoutDirection, density));
            }
        };
