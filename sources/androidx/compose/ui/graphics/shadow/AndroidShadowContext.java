...
public final class AndroidShadowContext implements PlatformShadowContext, DropShadowRendererProvider, InnerShadowRendererProvider {
    ...
    public static final class ShadowKey {
        ...
        public static /* synthetic */ ShadowKey m6051copyeZhPAX0$default(ShadowKey shadowKey, Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return shadowKey.m6053copyeZhPAX0(shape, j, layoutDirection2, f, shadow2);
        }
        ...
        public final long m6052component2NHjbRc() {
            return this.size;
        }
        ...
        public final ShadowKey m6053copyeZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof ShadowKey) {
                ...
                return Intrinsics.areEqual(this.shape, shadowKey.shape) && Size.m5168equalsimpl0(this.size, shadowKey.size) && this.layoutDirection == shadowKey.layoutDirection && Float.compare(this.density, shadowKey.density) == 0 && Intrinsics.areEqual(this.shadow, shadowKey.shadow);
            }
            return false;
        }

        public int hashCode() {
            int hashCode = ((((((this.shape.hashCode() * 31) + Size.m5173hashCodeimpl(this.size)) * 31) + this.layoutDirection.hashCode()) * 31) + Float.hashCode(this.density)) * 31;
            Shadow shadow = this.shadow;
            return hashCode + (shadow == null ? 0 : shadow.hashCode());
        }

        public String toString() {
            return "ShadowKey(shape=" + this.shape + ", size=" + ((Object) Size.m5176toStringimpl(this.size)) + ", layoutDirection=" + this.layoutDirection + ", density=" + this.density + ", shadow=" + this.shadow + ')';
        }
        ...
        public /* synthetic */ ShadowKey(Shape shape, long j, LayoutDirection layoutDirection, float f, Shadow shadow, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? RectangleShapeKt.getRectangleShape() : shape, (i & 2) != 0 ? Size.Companion.m5181getZeroNHjbRc() : j, (i & 4) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 8) != 0 ? 1.0f : f, (i & 16) != 0 ? null : shadow, null);
        }
        ...
        public final long m6054getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk  reason: not valid java name */
        public final void m6055setSizeuvyYCjk(long j) {
            this.size = j;
        }
    ...
    public DropShadowRenderer mo6049obtainDropShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow) {
        DropShadowRenderer dropShadowRenderer;
        synchronized (this) {
            ShadowKey obtainShadowKey = obtainShadowKey();
            obtainShadowKey.setShape(shape);
            obtainShadowKey.m6055setSizeuvyYCjk(j);
            ...
            if (dropShadowRenderer == null) {
                DropShadowRenderer dropShadowRenderer2 = new DropShadowRenderer(shadow, shape.mo344createOutlinePq9zytI(j, layoutDirection, density));
                obtainDropShadowCache().set(ShadowKey.m6051copyeZhPAX0$default(obtainShadowKey, null, 0L, null, 0.0f, null, 31, null), dropShadowRenderer2);
    ...
    public InnerShadowRenderer mo6050obtainInnerShadowRenderereZhPAX0(Shape shape, long j, LayoutDirection layoutDirection, Density density, Shadow shadow) {
        ...
        synchronized (this) {
            ...
            if (innerShadowRenderer == null) {
                InnerShadowRenderer innerShadowRenderer2 = new InnerShadowRenderer(shadow, shape.mo344createOutlinePq9zytI(j, layoutDirection, density));
                obtainInnerShadowCache().set(ShadowKey.m6051copyeZhPAX0$default(obtainShadowKey, null, 0L, null, 0.0f, null, 31, null), innerShadowRenderer2);
