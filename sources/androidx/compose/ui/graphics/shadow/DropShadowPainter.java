...
public final class DropShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DropShadowRenderer mo6049obtainDropShadowRenderereZhPAX0 = this.renderCreator.mo6049obtainDropShadowRenderereZhPAX0(this.shape, drawScope.mo5922getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow);
        float f = drawScope.mo434toPx0680j_4(DpOffset.m8221getXD9Ej5fM(this.shadow.m6067getOffsetRKDOV3M()));
        float f2 = drawScope.mo434toPx0680j_4(DpOffset.m8223getYD9Ej5fM(this.shadow.m6067getOffsetRKDOV3M()));
        drawScope.getDrawContext().getTransform().translate(f, f2);
        try {
            mo6049obtainDropShadowRenderereZhPAX0.m6071drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo5922getSizeNHjbRc(), mo6049obtainDropShadowRenderereZhPAX0.getShadow().m6066getColor0d7_KjU(), mo6049obtainDropShadowRenderereZhPAX0.getShadow().getBrush(), RangesKt.coerceIn(this.alpha * mo6049obtainDropShadowRenderereZhPAX0.getShadow().getAlpha(), 0.0f, 1.0f), mo6049obtainDropShadowRenderereZhPAX0.getShadow().m6065getBlendMode0nO6VwU());
        } finally {
            drawScope.getDrawContext().getTransform().translate(-f, -f2);
        }
    }
