...
public final class DropShadowRenderer extends ShadowRenderer {
    ...
    protected void mo5484buildShadow_SMYjrA(DrawScope drawScope, long j, long j2, Path path) {
        ...
        ImageBitmap m5483createOuterShadowBitmapD_oqF2M;
    ...
    private final Brush obtainCompositeBrush(ImageBitmap imageBitmap, Brush brush) {
        ...
        if (compositeShaderBrush == null || !Intrinsics.areEqual(compositeShaderBrush.getSrcBrush(), brush)) {
            ...
            ShaderBrush ShaderBrush = BrushKt.ShaderBrush(ShaderKt.m5105ImageShaderF49vj9s$default(imageBitmap, 0, 0, 6, null));
            if (brush instanceof ShaderBrush) {
                brush = BrushKt.ShaderBrush(((ShaderBrush) brush).mo4741createShaderuvyYCjk(Size.m4587constructorimpl((Float.floatToRawIntBits(imageBitmap.getWidth()) << 32) | (Float.floatToRawIntBits(imageBitmap.getHeight()) & 4294967295L))));
            }
            Brush m4729composite7EN7VTw = companion.m4729composite7EN7VTw(ShaderBrush, brush, BlendMode.Companion.m4710getSrcIn0nO6VwU());
            Intrinsics.checkNotNull(m4729composite7EN7VTw, "null cannot be cast to non-null type androidx.compose.ui.graphics.CompositeShaderBrush");
            compositeShaderBrush = (CompositeShaderBrush) m4729composite7EN7VTw;
    ...
    protected void mo5485onDrawShadowMLmccfk(DrawScope drawScope, long j, long j2, Path path, float f, ColorFilter colorFilter, Brush brush, int i) {
        ...
        if (imageBitmap != null) {
            float f2 = -(drawScope.mo405toPx0680j_4(this.shadow.m5492getRadiusD9Ej5fM()) + drawScope.mo405toPx0680j_4(this.shadow.m5493getSpreadD9Ej5fM()));
            if (brush != null && colorFilter == null) {
                ...
                try {
                    DrawScope.m5339drawRectAsUm42w$default(drawScope, obtainCompositeBrush, 0L, Size.m4587constructorimpl((Float.floatToRawIntBits(imageBitmap.getHeight()) & 4294967295L) | (Float.floatToRawIntBits(imageBitmap.getWidth()) << 32)), f, null, null, i, 50, null);
                    return;
                } finally {
                    float f3 = -f2;
    ...
    private final ImageBitmap m5482createOuterShadowBitmapCqks5Fs(long j, Path path, float f, float f2) {
        ...
        BlurKt.m5481configureShadowFoewPVk$default(this.paint, 0L, 0, f > 0.0f ? Blur_androidKt.BlurFilter(f) : null, 0, 11, null);
