...
public final class DropShadowRenderer extends ShadowRenderer {
    ...
    protected void mo6143buildShadow_SMYjrA(DrawScope drawScope, long j, long j2, Path path) {
        ...
        ImageBitmap m6142createOuterShadowBitmapD_oqF2M;
        ...
        if (path != null) {
            ...
            m6142createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m6141createOuterShadowBitmapCqks5Fs(j, path, f, f2);
        } else {
            dropShadowRenderer = this;
            m6142createOuterShadowBitmapD_oqF2M = dropShadowRenderer.m6142createOuterShadowBitmapD_oqF2M(j, f, f2, j2);
        }
        dropShadowRenderer.shadowBitmap = m6142createOuterShadowBitmapD_oqF2M;
    }
    ...
    private final Brush obtainCompositeBrush(ImageBitmap imageBitmap, Brush brush) {
        ...
        if (compositeShaderBrush == null || !Intrinsics.areEqual(compositeShaderBrush.getSrcBrush(), brush)) {
            ...
            ShaderBrush ShaderBrush = BrushKt.ShaderBrush(ShaderKt.m5759ImageShaderF49vj9s$default(imageBitmap, 0, 0, 6, null));
            if (brush instanceof ShaderBrush) {
                brush = BrushKt.ShaderBrush(((ShaderBrush) brush).mo5393createShaderuvyYCjk(Size.m5239constructorimpl((Float.floatToRawIntBits(imageBitmap.getWidth()) << 32) | (Float.floatToRawIntBits(imageBitmap.getHeight()) & 4294967295L))));
            }
            Brush m5381composite7EN7VTw = companion.m5381composite7EN7VTw(ShaderBrush, brush, BlendMode.Companion.m5362getSrcIn0nO6VwU());
            Intrinsics.checkNotNull(m5381composite7EN7VTw, "null cannot be cast to non-null type androidx.compose.ui.graphics.CompositeShaderBrush");
            compositeShaderBrush = (CompositeShaderBrush) m5381composite7EN7VTw;
    ...
    protected void mo6144onDrawShadowMLmccfk(DrawScope drawScope, long j, long j2, Path path, float f, ColorFilter colorFilter, Brush brush, int i) {
        ...
        if (imageBitmap != null) {
            float f2 = -(drawScope.mo464toPx0680j_4(this.shadow.m6151getRadiusD9Ej5fM()) + drawScope.mo464toPx0680j_4(this.shadow.m6152getSpreadD9Ej5fM()));
            if (brush != null && colorFilter == null) {
                ...
                try {
                    DrawScope.m5998drawRectAsUm42w$default(drawScope, obtainCompositeBrush, 0L, Size.m5239constructorimpl((Float.floatToRawIntBits(imageBitmap.getHeight()) & 4294967295L) | (Float.floatToRawIntBits(imageBitmap.getWidth()) << 32)), f, null, null, i, 50, null);
                    return;
                } finally {
                    float f3 = -f2;
            ...
            DrawScope.m5989drawImagegbVJVH8$default(drawScope, imageBitmap, Offset.m5171constructorimpl((4294967295L & Float.floatToRawIntBits(f2)) | (Float.floatToRawIntBits(f2) << 32)), f, null, colorFilter, i, 8, null);
        }
    }

    /* renamed from: createOuterShadowBitmap-Cqks5Fs  reason: not valid java name */
    private final ImageBitmap m6141createOuterShadowBitmapCqks5Fs(long j, Path path, float f, float f2) {
        float f3 = 2;
        float f4 = (f * f3) + (f3 * f2);
        ImageBitmap m5662ImageBitmapx__hDU$default = ImageBitmapKt.m5662ImageBitmapx__hDU$default((int) Math.ceil(Float.intBitsToFloat((int) (j >> 32)) + f4), (int) Math.ceil(Float.intBitsToFloat((int) (j & 4294967295L)) + f4), ImageBitmapConfig.Companion.m5656getAlpha8_sVssgQ(), false, null, 24, null);
        Canvas Canvas = CanvasKt.Canvas(m5662ImageBitmapx__hDU$default);
        if (f2 > 0.0f) {
            float f5 = f + f2;
            Canvas.translate(f5, f5);
            Canvas.drawPath(path, this.paint);
            Paint m6140configureShadowFoewPVk$default = BlurKt.m6140configureShadowFoewPVk$default(this.paint, 0L, 0, f > 0.0f ? Blur_androidKt.BlurFilter(f) : null, PaintingStyle.Companion.m5708getStrokeTiuSbCo(), 3, null);
            m6140configureShadowFoewPVk$default.setStrokeWidth(2.0f * f2);
            Unit unit = Unit.INSTANCE;
            Canvas.drawPath(path, m6140configureShadowFoewPVk$default);
            return m5662ImageBitmapx__hDU$default;
        }
        BlurKt.m6140configureShadowFoewPVk$default(this.paint, 0L, 0, f > 0.0f ? Blur_androidKt.BlurFilter(f) : null, 0, 11, null);
    ...
    private final ImageBitmap m6142createOuterShadowBitmapD_oqF2M(long j, float f, float f2, long j2) {
        float f3 = 2;
        float f4 = (f * f3) + (f3 * f2);
        float intBitsToFloat = Float.intBitsToFloat((int) (j >> 32)) + f4;
        float intBitsToFloat2 = Float.intBitsToFloat((int) (j & 4294967295L)) + f4;
        ImageBitmap m5662ImageBitmapx__hDU$default = ImageBitmapKt.m5662ImageBitmapx__hDU$default((int) Math.ceil(intBitsToFloat), (int) Math.ceil(intBitsToFloat2), ImageBitmapConfig.Companion.m5656getAlpha8_sVssgQ(), false, null, 24, null);
        CanvasKt.Canvas(m5662ImageBitmapx__hDU$default).drawRoundRect(f, f, intBitsToFloat - f, intBitsToFloat2 - f, Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat((int) (j2 & 4294967295L)), BlurKt.m6140configureShadowFoewPVk$default(this.paint, 0L, 0, f > 0.0f ? Blur_androidKt.BlurFilter(f) : null, 0, 11, null));
        return m5662ImageBitmapx__hDU$default;
    }
}
