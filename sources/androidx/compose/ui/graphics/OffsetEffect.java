...
public final class OffsetEffect extends RenderEffect {
    ...
    protected android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m4860createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OffsetEffect) {
            ...
            return Intrinsics.areEqual(this.renderEffect, offsetEffect.renderEffect) && Offset.m4290equalsimpl0(this.offset, offsetEffect.offset);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((renderEffect != null ? renderEffect.hashCode() : 0) * 31) + Offset.m4295hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + ((Object) Offset.m4301toStringimpl(this.offset)) + ')';
    }
}
