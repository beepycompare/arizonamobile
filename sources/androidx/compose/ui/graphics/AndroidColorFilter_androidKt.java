...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4634actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m4716BlendModeColorFilterxETnrds(j, i);
        }
        return new PorterDuffColorFilter(ColorKt.m4826toArgb8_81llA(j), AndroidBlendMode_androidKt.m4620toPorterDuffModes9anfk8(i));
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final android.graphics.ColorFilter m4632actualColorMatrixColorFilterjHGOpc(float[] fArr) {
        return new android.graphics.ColorMatrixColorFilter(fArr);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final android.graphics.ColorFilter m4633actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m4826toArgb8_81llA(j), ColorKt.m4826toArgb8_81llA(j2));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4851getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
