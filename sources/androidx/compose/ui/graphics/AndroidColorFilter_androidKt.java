...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4400actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m4482BlendModeColorFilterxETnrds(j, i);
        }
        return new PorterDuffColorFilter(ColorKt.m4591toArgb8_81llA(j), AndroidBlendMode_androidKt.m4386toPorterDuffModes9anfk8(i));
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final android.graphics.ColorFilter m4398actualColorMatrixColorFilterjHGOpc(float[] fArr) {
        return new android.graphics.ColorMatrixColorFilter(fArr);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final android.graphics.ColorFilter m4399actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m4591toArgb8_81llA(j), ColorKt.m4591toArgb8_81llA(j2));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4616getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
