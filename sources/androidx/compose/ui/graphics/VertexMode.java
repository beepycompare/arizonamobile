...
public final class VertexMode {
    ...
    private static final int Triangles = m5842constructorimpl(0);
    private static final int TriangleStrip = m5842constructorimpl(1);
    private static final int TriangleFan = m5842constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ VertexMode m5841boximpl(int i) {
    ...
    public static boolean m5843equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).m5847unboximpl();
    }
    ...
    public static String m5846toStringimpl(int i) {
        return m5844equalsimpl0(i, Triangles) ? "Triangles" : m5844equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m5844equalsimpl0(i, TriangleFan) ? "TriangleFan" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
