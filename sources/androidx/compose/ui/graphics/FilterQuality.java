...
public final class FilterQuality {
    ...
    private static final int None = m4631constructorimpl(0);
    private static final int Low = m4631constructorimpl(1);
    private static final int Medium = m4631constructorimpl(2);
    private static final int High = m4631constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FilterQuality m4630boximpl(int i) {
    ...
    public static boolean m4632equalsimpl(int i, Object obj) {
        return (obj instanceof FilterQuality) && i == ((FilterQuality) obj).m4636unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4640getNonefv9h1I() {
            return FilterQuality.None;
        }

        /* renamed from: getLow-f-v9h1I  reason: not valid java name */
        public final int m4638getLowfv9h1I() {
            return FilterQuality.Low;
        }

        /* renamed from: getMedium-f-v9h1I  reason: not valid java name */
        public final int m4639getMediumfv9h1I() {
            return FilterQuality.Medium;
        }

        /* renamed from: getHigh-f-v9h1I  reason: not valid java name */
        public final int m4637getHighfv9h1I() {
    ...
    public static String m4635toStringimpl(int i) {
        return m4633equalsimpl0(i, None) ? "None" : m4633equalsimpl0(i, Low) ? "Low" : m4633equalsimpl0(i, Medium) ? "Medium" : m4633equalsimpl0(i, High) ? "High" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
