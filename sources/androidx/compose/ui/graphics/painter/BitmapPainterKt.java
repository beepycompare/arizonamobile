...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m5982BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 4) != 0) {
            ...
            j2 = IntSize.m8162constructorimpl((imageBitmap.getHeight() & 4294967295L) | (width << 32));
        }
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m5381getLowfv9h1I();
        }
        return m5981BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m5981BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j, j2, null);
        bitmapPainter.m5980setFilterQualityvDHp3xo$ui_graphics_release(i);
