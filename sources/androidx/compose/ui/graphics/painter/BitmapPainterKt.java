...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m6045BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
        ...
        if ((i2 & 4) != 0) {
            ...
            j2 = IntSize.m8326constructorimpl((imageBitmap.getHeight() & 4294967295L) | (width << 32));
        }
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m5448getLowfv9h1I();
        }
        return m6044BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m6044BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        BitmapPainter bitmapPainter = new BitmapPainter(imageBitmap, j, j2, null);
        bitmapPainter.m6043setFilterQualityvDHp3xo$ui_graphics(i);
