...
public final class ClipOp {
    ...
    private static final int Difference = m5406constructorimpl(0);
    private static final int Intersect = m5406constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ClipOp m5405boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static boolean m5407equalsimpl(int i, Object obj) {
        return (obj instanceof ClipOp) && i == ((ClipOp) obj).m5411unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m5407equalsimpl(this.value, obj);
    }
    ...
    public static String m5410toStringimpl(int i) {
        return m5408equalsimpl0(i, Difference) ? "Difference" : m5408equalsimpl0(i, Intersect) ? "Intersect" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
