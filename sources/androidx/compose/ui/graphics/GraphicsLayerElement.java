...
final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m5574copycp5nf6A$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, Object obj) {
        ...
        return graphicsLayerElement.m5580copycp5nf6A(f21, f12, f13, f14, f15, f16, f17, f18, f19, f20, j4, shape2, z2, renderEffect2, j5, j6, i4, i6, colorFilter2);
    }
    ...
    public final long m5575component11SzJe1aQ() {
    ...
    public final long m5576component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m5577component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m5578component17NrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: component18-0nO6VwU  reason: not valid java name */
    public final int m5579component180nO6VwU() {
    ...
    public final GraphicsLayerElement m5580copycp5nf6A(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m5836hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31;
        RenderEffect renderEffect = this.renderEffect;
        int hashCode2 = (((((((((hashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m5431hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m5431hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m5512hashCodeimpl(this.compositingStrategy)) * 31) + BlendMode.m5334hashCodeimpl(this.blendMode)) * 31;
    ...
    public String toString() {
        ...
        sb.append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append((Object) TransformOrigin.m5837toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append((Object) Color.m5432toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append((Object) Color.m5432toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append((Object) CompositingStrategy.m5513toStringimpl(this.compositingStrategy)).append(", blendMode=").append((Object) BlendMode.m5335toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(')');
        return sb.toString();
    }
    ...
    public final long m5585getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m5581getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }
    ...
    public final int m5583getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m5582getBlendMode0nO6VwU() {
        return this.blendMode;
    }
    ...
    public void update(SimpleGraphicsLayerModifier simpleGraphicsLayerModifier) {
        ...
        simpleGraphicsLayerModifier.m5781setTransformOrigin__ExYCQ(this.transformOrigin);
        ...
        simpleGraphicsLayerModifier.m5777setAmbientShadowColor8_81llA(this.ambientShadowColor);
        simpleGraphicsLayerModifier.m5780setSpotShadowColor8_81llA(this.spotShadowColor);
        simpleGraphicsLayerModifier.m5779setCompositingStrategyaDBOjCE(this.compositingStrategy);
        simpleGraphicsLayerModifier.m5778setBlendModes9anfk8(this.blendMode);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m5826boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m5414boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m5414boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m5508boximpl(this.compositingStrategy));
        inspectorInfo.getProperties().set("blendMode", BlendMode.m5330boximpl(this.blendMode));
