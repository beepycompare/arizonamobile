...
final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m4686copycp5nf6A$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, Object obj) {
        ...
        return graphicsLayerElement.m4692copycp5nf6A(f21, f12, f13, f14, f15, f16, f17, f18, f19, f20, j4, shape2, z2, renderEffect2, j5, j6, i4, i6, colorFilter2);
    }
    ...
    public final long m4687component11SzJe1aQ() {
    ...
    public final long m4688component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m4689component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m4690component17NrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: component18-0nO6VwU  reason: not valid java name */
    public final int m4691component180nO6VwU() {
    ...
    public final GraphicsLayerElement m4692copycp5nf6A(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m4942hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31;
        RenderEffect renderEffect = this.renderEffect;
        int hashCode2 = (((((((((hashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + Color.m4544hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m4544hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m4624hashCodeimpl(this.compositingStrategy)) * 31) + BlendMode.m4448hashCodeimpl(this.blendMode)) * 31;
    ...
    public final long m4697getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m4693getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m4696getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m4695getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4694getBlendMode0nO6VwU() {
        return this.blendMode;
    }
    ...
    public void update(SimpleGraphicsLayerModifier simpleGraphicsLayerModifier) {
        ...
        simpleGraphicsLayerModifier.m4888setTransformOrigin__ExYCQ(this.transformOrigin);
        ...
        simpleGraphicsLayerModifier.m4884setAmbientShadowColor8_81llA(this.ambientShadowColor);
        simpleGraphicsLayerModifier.m4887setSpotShadowColor8_81llA(this.spotShadowColor);
        simpleGraphicsLayerModifier.m4886setCompositingStrategyaDBOjCE(this.compositingStrategy);
        simpleGraphicsLayerModifier.m4885setBlendModes9anfk8(this.blendMode);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m4932boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m4527boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m4527boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m4620boximpl(this.compositingStrategy));
        inspectorInfo.getProperties().set("blendMode", BlendMode.m4444boximpl(this.blendMode));
