...
public final class SolidColor extends Brush implements Interpolatable {
    ...
    public final long m5128getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo4717applyToPq9zytI(long j, Paint paint, float f) {
        paint.setAlpha(1.0f);
        int i = (f > 1.0f ? 1 : (f == 1.0f ? 0 : -1));
        long j2 = this.value;
        if (i != 0) {
            j2 = Color.m4771copywmQWz5c$default(j2, Color.m4774getAlphaimpl(j2) * f, 0.0f, 0.0f, 0.0f, 14, null);
        }
        paint.mo4648setColor8_81llA(j2);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m4773equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m4780toStringimpl(this.value)) + ')';
    }
    ...
    public Object lerp(Object obj, float f) {
        ...
        if (obj instanceof SolidColor) {
            return new SolidColor(ColorKt.m4823lerpjxsXWHM(this.value, ((SolidColor) obj).value, f), null);
        }
        return null;
    }
}
