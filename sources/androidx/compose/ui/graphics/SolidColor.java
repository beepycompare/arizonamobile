...
public final class SolidColor extends Brush {
    ...
    public final long m5632getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo5226applyToPq9zytI(long j, Paint paint, float f) {
        long m5279copywmQWz5c$default;
        paint.setAlpha(1.0f);
        if (f != 1.0f) {
            long j2 = this.value;
            m5279copywmQWz5c$default = Color.m5279copywmQWz5c$default(j2, Color.m5282getAlphaimpl(j2) * f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m5279copywmQWz5c$default = this.value;
        }
        paint.mo5157setColor8_81llA(m5279copywmQWz5c$default);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m5281equalsimpl0(this.value, ((SolidColor) obj).value);
    }

    public int hashCode() {
        return Color.m5287hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m5288toStringimpl(this.value)) + ')';
    }
}
