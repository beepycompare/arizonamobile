...
public final class SolidColor extends Brush implements Interpolatable {
    ...
    public final long m5782getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo5369applyToPq9zytI(long j, Paint paint, float f) {
        long m5423copywmQWz5c$default;
        paint.setAlpha(1.0f);
        if (f != 1.0f) {
            long j2 = this.value;
            m5423copywmQWz5c$default = Color.m5423copywmQWz5c$default(j2, Color.m5426getAlphaimpl(j2) * f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m5423copywmQWz5c$default = this.value;
        }
        paint.mo5300setColor8_81llA(m5423copywmQWz5c$default);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m5425equalsimpl0(this.value, ((SolidColor) obj).value);
    }

    public int hashCode() {
        return Color.m5431hashCodeimpl(this.value);
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m5432toStringimpl(this.value)) + ')';
    }
    ...
    public Object lerp(Object obj, float f) {
        ...
        if (obj instanceof SolidColor) {
            return new SolidColor(ColorKt.m5475lerpjxsXWHM(this.value, ((SolidColor) obj).value, f), null);
        }
        return null;
    }
}
