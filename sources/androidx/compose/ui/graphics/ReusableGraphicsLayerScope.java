...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m5437getAutoNrFUSI();
    private long size = Size.Companion.m5180getUnspecifiedNHjbRc();
    ...
    public long mo5539getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setAmbientShadowColor-8_81llA */
    public void mo5545setAmbientShadowColor8_81llA(long j) {
        if (Color.m5349equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public long mo5543getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo5548setSpotShadowColor8_81llA(long j) {
        if (Color.m5349equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public long mo5544getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo5549setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5755equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public int mo5541getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo5547setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m5433equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public long mo5542getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public void m5676setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public int mo5540getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo5546setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo5545setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo5548setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo5549setTransformOrigin__ExYCQ(TransformOrigin.Companion.m5761getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo5546setBlendModes9anfk8(BlendMode.Companion.m5288getSrcOver0nO6VwU());
        mo5547setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m5437getAutoNrFUSI());
        m5676setSizeuvyYCjk(Size.Companion.m5180getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo344createOutlinePq9zytI(mo5542getSizeNHjbRc(), this.layoutDirection, this.graphicsDensity);
    }
}
