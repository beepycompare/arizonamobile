...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m5370getAutoNrFUSI();
    private long size = Size.Companion.m5113getUnspecifiedNHjbRc();
    ...
    public long mo5472getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setAmbientShadowColor-8_81llA */
    public void mo5478setAmbientShadowColor8_81llA(long j) {
        if (Color.m5281equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public long mo5476getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo5481setSpotShadowColor8_81llA(long j) {
        if (Color.m5281equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public long mo5477getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo5482setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5682equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public int mo5474getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo5480setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m5366equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public long mo5475getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public void m5604setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public int mo5473getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo5479setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo5478setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo5481setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo5482setTransformOrigin__ExYCQ(TransformOrigin.Companion.m5688getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo5479setBlendModes9anfk8(BlendMode.Companion.m5221getSrcOver0nO6VwU());
        mo5480setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m5370getAutoNrFUSI());
        m5604setSizeuvyYCjk(Size.Companion.m5113getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo332createOutlinePq9zytI(mo5475getSizeNHjbRc(), this.layoutDirection, this.graphicsDensity);
    }
}
