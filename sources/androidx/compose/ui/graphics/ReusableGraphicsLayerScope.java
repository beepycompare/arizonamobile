...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m5515getAutoNrFUSI();
    private long size = Size.Companion.m5256getUnspecifiedNHjbRc();
    ...
    public long mo5617getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setAmbientShadowColor-8_81llA */
    public void mo5623setAmbientShadowColor8_81llA(long j) {
        if (Color.m5425equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public long mo5621getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo5626setSpotShadowColor8_81llA(long j) {
        if (Color.m5425equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public long mo5622getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo5627setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5833equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public int mo5619getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo5625setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m5511equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public long mo5620getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public void m5754setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public int mo5618getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo5624setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo5623setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo5626setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo5627setTransformOrigin__ExYCQ(TransformOrigin.Companion.m5839getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo5624setBlendModes9anfk8(BlendMode.Companion.m5364getSrcOver0nO6VwU());
        mo5625setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m5515getAutoNrFUSI());
        m5754setSizeuvyYCjk(Size.Companion.m5256getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo365createOutlinePq9zytI(mo5620getSizeNHjbRc(), this.layoutDirection, this.graphicsDensity);
    }
}
