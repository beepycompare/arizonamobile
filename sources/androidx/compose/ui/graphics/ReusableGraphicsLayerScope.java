...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m4861getAutoNrFUSI();
    private long size = Size.Companion.m4604getUnspecifiedNHjbRc();
    ...
    public long mo4963getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setAmbientShadowColor-8_81llA */
    public void mo4969setAmbientShadowColor8_81llA(long j) {
        if (Color.m4773equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public long mo4967getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo4972setSpotShadowColor8_81llA(long j) {
        if (Color.m4773equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public long mo4968getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo4973setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m5179equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public int mo4965getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo4971setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4857equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public long mo4966getSizeNHjbRc() {
        return this.size;
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public void m5100setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public int mo4964getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo4970setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo4969setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4972setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4973setTransformOrigin__ExYCQ(TransformOrigin.Companion.m5185getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo4970setBlendModes9anfk8(BlendMode.Companion.m4712getSrcOver0nO6VwU());
        mo4971setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m4861getAutoNrFUSI());
        m5100setSizeuvyYCjk(Size.Companion.m4604getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo320createOutlinePq9zytI(mo4966getSizeNHjbRc(), this.layoutDirection, this.graphicsDensity);
    }
}
