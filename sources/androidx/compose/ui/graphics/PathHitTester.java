...
public final class PathHitTester {
    ...
    public final boolean m5576containsk4lQ0M(long j) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m5062containsk4lQ0M(j)) {
            ...
            if (PathFillType.m5570equalsimpl0(this.path.mo5169getFillTypeRgk1Os(), PathFillType.Companion.m5574getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
