...
public final class PathHitTester {
    ...
    public final boolean m4833containsk4lQ0M(long j) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m4319containsk4lQ0M(j)) {
            ...
            if (PathFillType.m4827equalsimpl0(this.path.mo4426getFillTypeRgk1Os(), PathFillType.Companion.m4831getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
