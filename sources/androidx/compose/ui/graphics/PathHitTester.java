...
public final class PathHitTester {
    ...
    public final boolean m5724containsk4lQ0M(long j) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m5205containsk4lQ0M(j)) {
            ...
            if (PathFillType.m5718equalsimpl0(this.path.mo5312getFillTypeRgk1Os(), PathFillType.Companion.m5722getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
