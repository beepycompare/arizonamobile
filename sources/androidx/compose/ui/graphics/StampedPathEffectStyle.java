...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m4416constructorimpl(0);
    private static final int Rotate = m4416constructorimpl(1);
    private static final int Morph = m4416constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m4415boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4416constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4417equalsimpl(int i, Object obj) {
        return (obj instanceof StampedPathEffectStyle) && i == ((StampedPathEffectStyle) obj).m4421unboximpl();
    }
    ...
    public static String m4420toStringimpl(int i) {
        return m4418equalsimpl0(i, Translate) ? "Translate" : m4418equalsimpl0(i, Rotate) ? "Rotate" : m4418equalsimpl0(i, Morph) ? "Morph" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
