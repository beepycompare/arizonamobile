...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo5275concat58bKbWc(float[] fArr) {
        if (MatrixKt.m5695isIdentity58bKbWc(fArr)) {
            return;
        }
        android.graphics.Matrix matrix = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m5291setFromEL8BTi8(matrix, fArr);
        this.internalCanvas.concat(matrix);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    public void mo5274clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.internalCanvas.clipRect(f, f2, f3, f4, m5283toRegionOp7u2Bmg(i));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void mo5273clipPathmtrdDE(Path path, int i) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m5283toRegionOp7u2Bmg(i));
            return;
        }
    ...
    public final Region.Op m5283toRegionOp7u2Bmg(int i) {
        return ClipOp.m5408equalsimpl0(i, ClipOp.Companion.m5412getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void mo5279drawLineWko1d7g(long j, long j2, Paint paint) {
    ...
    public void mo5276drawCircle9KIMszo(long j, float f, Paint paint) {
    ...
    public void mo5277drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint) {
    ...
    public void mo5278drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint) {
        ...
        rect.left = IntOffset.m8386getXimpl(j);
        rect.top = IntOffset.m8387getYimpl(j);
        rect.right = IntOffset.m8386getXimpl(j) + ((int) (j2 >> 32));
        rect.bottom = IntOffset.m8387getYimpl(j) + ((int) (j2 & 4294967295L));
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        Intrinsics.checkNotNull(rect2);
        rect2.left = IntOffset.m8386getXimpl(j3);
        rect2.top = IntOffset.m8387getYimpl(j3);
        rect2.right = IntOffset.m8386getXimpl(j3) + ((int) (j4 >> 32));
        rect2.bottom = IntOffset.m8387getYimpl(j3) + ((int) (j4 & 4294967295L));
    ...
    public void mo5280drawPointsO7TthRY(int i, List<Offset> list, Paint paint) {
        if (PointMode.m5741equalsimpl0(i, PointMode.Companion.m5745getLinesr_lszbg())) {
            drawLines(list, paint, 2);
        } else if (PointMode.m5741equalsimpl0(i, PointMode.Companion.m5747getPolygonr_lszbg())) {
            drawLines(list, paint, 1);
        } else if (PointMode.m5741equalsimpl0(i, PointMode.Companion.m5746getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> list, Paint paint, int i) {
        if (list.size() >= 2) {
            ...
            while (i2 < list.size() - 1) {
                long m5189unboximpl = list.get(i2).m5189unboximpl();
                long m5189unboximpl2 = list.get(i2 + 1).m5189unboximpl();
                this.internalCanvas.drawLine(Float.intBitsToFloat((int) (m5189unboximpl >> 32)), Float.intBitsToFloat((int) (m5189unboximpl & 4294967295L)), Float.intBitsToFloat((int) (m5189unboximpl2 >> 32)), Float.intBitsToFloat((int) (m5189unboximpl2 & 4294967295L)), asFrameworkPaint);
                i2 += i;
            }
        }
    }
    ...
    public void mo5281drawRawPointsO7TthRY(int i, float[] fArr, Paint paint) {
        if (fArr.length % 2 != 0) {
    ...
    public void mo5282drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m5328toAndroidVertexModeJOOmi9M(vertices.m5851getVertexModec2xauaI()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.asFrameworkPaint());
    }

    private final void drawPoints(List<Offset> list, Paint paint) {
        int size = list.size();
        for (int i = 0; i < size; i++) {
            long m5189unboximpl = list.get(i).m5189unboximpl();
            this.internalCanvas.drawPoint(Float.intBitsToFloat((int) (m5189unboximpl >> 32)), Float.intBitsToFloat((int) (m5189unboximpl & 4294967295L)), paint.asFrameworkPaint());
        }
    }
}
