...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo4623concat58bKbWc(float[] fArr) {
        if (MatrixKt.m5041isIdentity58bKbWc(fArr)) {
            return;
        }
    ...
    public void mo4622clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.internalCanvas.clipRect(f, f2, f3, f4, m4631toRegionOp7u2Bmg(i));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void mo4621clipPathmtrdDE(Path path, int i) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m4631toRegionOp7u2Bmg(i));
            return;
        }
    ...
    public final Region.Op m4631toRegionOp7u2Bmg(int i) {
        return ClipOp.m4756equalsimpl0(i, ClipOp.Companion.m4760getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void mo4627drawLineWko1d7g(long j, long j2, Paint paint) {
    ...
    public void mo4624drawCircle9KIMszo(long j, float f, Paint paint) {
    ...
    public void mo4625drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint) {
    ...
    public void mo4626drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint) {
        ...
        rect.left = IntOffset.m7683getXimpl(j);
        rect.top = IntOffset.m7684getYimpl(j);
        rect.right = IntOffset.m7683getXimpl(j) + ((int) (j2 >> 32));
        rect.bottom = IntOffset.m7684getYimpl(j) + ((int) (j2 & 4294967295L));
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        Intrinsics.checkNotNull(rect2);
        rect2.left = IntOffset.m7683getXimpl(j3);
        rect2.top = IntOffset.m7684getYimpl(j3);
        rect2.right = IntOffset.m7683getXimpl(j3) + ((int) (j4 >> 32));
        rect2.bottom = IntOffset.m7684getYimpl(j3) + ((int) (j4 & 4294967295L));
    ...
    public void mo4628drawPointsO7TthRY(int i, List<Offset> list, Paint paint) {
        if (PointMode.m5087equalsimpl0(i, PointMode.Companion.m5091getLinesr_lszbg())) {
            drawLines(list, paint, 2);
        } else if (PointMode.m5087equalsimpl0(i, PointMode.Companion.m5093getPolygonr_lszbg())) {
            drawLines(list, paint, 1);
        } else if (PointMode.m5087equalsimpl0(i, PointMode.Companion.m5092getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> list, Paint paint, int i) {
        if (list.size() >= 2) {
            ...
            while (i2 < list.size() - 1) {
                long m4537unboximpl = list.get(i2).m4537unboximpl();
                long m4537unboximpl2 = list.get(i2 + 1).m4537unboximpl();
                this.internalCanvas.drawLine(Float.intBitsToFloat((int) (m4537unboximpl >> 32)), Float.intBitsToFloat((int) (m4537unboximpl & 4294967295L)), Float.intBitsToFloat((int) (m4537unboximpl2 >> 32)), Float.intBitsToFloat((int) (m4537unboximpl2 & 4294967295L)), asFrameworkPaint);
                i2 += i;
            }
        }
    }
    ...
    public void mo4629drawRawPointsO7TthRY(int i, float[] fArr, Paint paint) {
        if (fArr.length % 2 != 0) {
    ...
    public void mo4630drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m4676toAndroidVertexModeJOOmi9M(vertices.m5197getVertexModec2xauaI()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.asFrameworkPaint());
    }

    private final void drawPoints(List<Offset> list, Paint paint) {
        int size = list.size();
        for (int i = 0; i < size; i++) {
            long m4537unboximpl = list.get(i).m4537unboximpl();
            this.internalCanvas.drawPoint(Float.intBitsToFloat((int) (m4537unboximpl >> 32)), Float.intBitsToFloat((int) (m4537unboximpl & 4294967295L)), paint.asFrameworkPaint());
        }
    }
}
