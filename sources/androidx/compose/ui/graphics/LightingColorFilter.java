...
public final class LightingColorFilter extends ColorFilter {
    ...
    public final long m4305getAdd0d7_KjU() {
        return this.add;
    }

    /* renamed from: getMultiply-0d7_KjU  reason: not valid java name */
    public final long m4306getMultiply0d7_KjU() {
    ...
    private LightingColorFilter(long j, long j2) {
        this(j, j2, AndroidColorFilter_androidKt.m3943actualLightingColorFilterOWjLjI(j, j2), null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LightingColorFilter) {
            ...
            return Color.m4079equalsimpl0(this.multiply, lightingColorFilter.multiply) && Color.m4079equalsimpl0(this.add, lightingColorFilter.add);
        }
        return false;
    }

    public int hashCode() {
        return (Color.m4085hashCodeimpl(this.multiply) * 31) + Color.m4085hashCodeimpl(this.add);
    }

    public String toString() {
        return "LightingColorFilter(multiply=" + ((Object) Color.m4086toStringimpl(this.multiply)) + ", add=" + ((Object) Color.m4086toStringimpl(this.add)) + ')';
    }
}
