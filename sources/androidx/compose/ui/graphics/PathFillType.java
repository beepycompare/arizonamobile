...
public final class PathFillType {
    ...
    private static final int NonZero = m5716constructorimpl(0);
    private static final int EvenOdd = m5716constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathFillType m5715boximpl(int i) {
    ...
    public static boolean m5717equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).m5721unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5723getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os  reason: not valid java name */
        public final int m5722getEvenOddRgk1Os() {
    ...
    public static String m5720toStringimpl(int i) {
        return m5718equalsimpl0(i, NonZero) ? "NonZero" : m5718equalsimpl0(i, EvenOdd) ? "EvenOdd" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
