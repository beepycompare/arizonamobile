...
public final class SweepGradient extends ShaderBrush implements Interpolatable {
    ...
    public final long m5813getCenterF1C5BW0$ui_graphics() {
        return this.center;
    }
    ...
    public Shader mo5393createShaderuvyYCjk(long j) {
        ...
        if ((9223372034707292159L & j2) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            m5171constructorimpl = SizeKt.m5258getCenteruvyYCjk(j);
        } else {
            ...
            m5171constructorimpl = Offset.m5171constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
        }
        return ShaderKt.m5764SweepGradientShader9KIMszo(m5171constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SweepGradient) {
            ...
            return Offset.m5176equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
        }
        return false;
    }

    public int hashCode() {
        int m5181hashCodeimpl = ((Offset.m5181hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m5181hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? "center=" + ((Object) Offset.m5187toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
    ...
    public Object lerp(Object obj, float f) {
        ...
        if (obj instanceof SweepGradient) {
            SweepGradient sweepGradient = (SweepGradient) obj;
            return new SweepGradient(OffsetKt.m5202lerpWko1d7g(this.center, sweepGradient.center, f), BrushKt.lerpColorList(this.colors, sweepGradient.colors, f), BrushKt.lerpNullableFloatList(this.stops, sweepGradient.stops, f), null);
        }
        return null;
    }
}
