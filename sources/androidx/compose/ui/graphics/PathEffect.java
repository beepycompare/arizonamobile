...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m5060stampedPathEffect7aD1DOk(Path path, float f, float f2, int i) {
            return AndroidPathEffect_androidKt.m4665actualStampedPathEffect7aD1DOk(path, f, f2, i);
        }
    }
}
