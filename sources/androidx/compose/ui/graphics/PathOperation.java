...
public final class PathOperation {
    ...
    private static final int Difference = m5726constructorimpl(0);
    private static final int Intersect = m5726constructorimpl(1);
    private static final int Union = m5726constructorimpl(2);
    private static final int Xor = m5726constructorimpl(3);
    private static final int ReverseDifference = m5726constructorimpl(4);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathOperation m5725boximpl(int i) {
    ...
    public static boolean m5727equalsimpl(int i, Object obj) {
        return (obj instanceof PathOperation) && i == ((PathOperation) obj).m5731unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5732getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c  reason: not valid java name */
        public final int m5733getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c  reason: not valid java name */
        public final int m5735getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c  reason: not valid java name */
        public final int m5736getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c  reason: not valid java name */
        public final int m5734getReverseDifferenceb3I0S0c() {
    ...
    public static String m5730toStringimpl(int i) {
        return m5728equalsimpl0(i, Difference) ? "Difference" : m5728equalsimpl0(i, Intersect) ? "Intersect" : m5728equalsimpl0(i, Union) ? "Union" : m5728equalsimpl0(i, Xor) ? "Xor" : m5728equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
