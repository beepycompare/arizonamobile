...
public final class StrokeJoin {
    ...
    private static final int Miter = m5726constructorimpl(0);
    private static final int Round = m5726constructorimpl(1);
    private static final int Bevel = m5726constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m5725boximpl(int i) {
    ...
    public static boolean m5727equalsimpl(int i, Object obj) {
        return (obj instanceof StrokeJoin) && i == ((StrokeJoin) obj).m5731unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m5733getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8  reason: not valid java name */
        public final int m5734getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8  reason: not valid java name */
        public final int m5732getBevelLxFBmk8() {
    ...
    public static String m5730toStringimpl(int i) {
        return m5728equalsimpl0(i, Miter) ? "Miter" : m5728equalsimpl0(i, Round) ? "Round" : m5728equalsimpl0(i, Bevel) ? "Bevel" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
