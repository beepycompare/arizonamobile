...
public final class BrushKt {
    public static final ShaderBrush toShaderBrush(Brush brush) {
        ...
        if (brush instanceof SolidColor) {
            ...
            Brush m5236verticalGradient8A3gB4$default = Brush.Companion.m5236verticalGradient8A3gB4$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m5270boximpl(solidColor.m5632getValue0d7_KjU()), Color.m5270boximpl(solidColor.m5632getValue0d7_KjU())}), 0.0f, 0.0f, 0, 14, (Object) null);
            Intrinsics.checkNotNull(m5236verticalGradient8A3gB4$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.ShaderBrush");
            return (ShaderBrush) m5236verticalGradient8A3gB4$default;
        }
