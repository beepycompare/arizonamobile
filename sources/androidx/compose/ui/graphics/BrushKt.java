...
public final class BrushKt {
    public static final ShaderBrush toShaderBrush(Brush brush) {
        ...
        if (brush instanceof SolidColor) {
            ...
            Brush m5379verticalGradient8A3gB4$default = Brush.Companion.m5379verticalGradient8A3gB4$default(Brush.Companion, CollectionsKt.listOf((Object[]) new Color[]{Color.m5414boximpl(solidColor.m5782getValue0d7_KjU()), Color.m5414boximpl(solidColor.m5782getValue0d7_KjU())}), 0.0f, 0.0f, 0, 14, (Object) null);
            Intrinsics.checkNotNull(m5379verticalGradient8A3gB4$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.ShaderBrush");
            return (ShaderBrush) m5379verticalGradient8A3gB4$default;
        }
    ...
    public static final List<Color> lerpColorList(List<Color> list, List<Color> list2, float f) {
        ...
        for (int i = 0; i < max; i++) {
            arrayList.add(Color.m5414boximpl(ColorKt.m5475lerpjxsXWHM(list.get(Math.min(i, list.size() - 1)).m5434unboximpl(), list2.get(Math.min(i, list2.size() - 1)).m5434unboximpl(), f)));
        }
        return arrayList;
    }
    ...
    public static final long m5392lerpSafeWko1d7g(long j, long j2, float f) {
        if (((((j & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) ^ androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0 && (((androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase ^ (j2 & androidx.compose.ui.geometry.InlineClassHelperKt.DualFloatInfinityBase)) - androidx.compose.ui.geometry.InlineClassHelperKt.Uint64Low32) & (-9223372034707292160L)) == 0) {
            return OffsetKt.m5202lerpWko1d7g(j, j2, f);
        }
        return f < 0.5f ? j : j2;
    }
