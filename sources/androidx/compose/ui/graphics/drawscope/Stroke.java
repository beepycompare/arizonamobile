...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.Companion.m4919getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.Companion.m4930getMiterLxFBmk8();
    ...
    public final int m5197getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m5198getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m5199getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m5200getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Stroke) {
            ...
            return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4915equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4925equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4916hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4926hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4917toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m4927toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
