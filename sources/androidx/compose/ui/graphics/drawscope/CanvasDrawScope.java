...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo5779getSizeNHjbRc() {
            return CanvasDrawScope.this.getDrawParams().m5777getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk  reason: not valid java name */
        public void mo5780setSizeuvyYCjk(long j) {
            CanvasDrawScope.this.getDrawParams().m5778setSizeuvyYCjk(j);
        }
    ...
    public void mo5762drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.drawParams.getCanvas().mo5135drawLineWko1d7g(j, j2, m5752configureStrokePaintho4zsrM$default(this, brush, f, 4.0f, i, StrokeJoin.Companion.m5660getMiterLxFBmk8(), pathEffect, f2, colorFilter, i2, 0, 512, null));
    }
    ...
    public void mo5763drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.drawParams.getCanvas().mo5135drawLineWko1d7g(j2, j3, m5750configureStrokePaintQ_0CZUI$default(this, j, f, 4.0f, i, StrokeJoin.Companion.m5660getMiterLxFBmk8(), pathEffect, f2, colorFilter, i2, 0, 512, null));
    }
    ...
    public void mo5770drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        ...
        this.drawParams.getCanvas().drawRect(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), m5748configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5771drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        ...
        this.drawParams.getCanvas().drawRect(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), m5746configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5761drawImagegbVJVH8(ImageBitmap imageBitmap, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo5133drawImaged4ec7I(imageBitmap, j, m5748configurePaintswdJneE$default(this, null, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public /* synthetic */ void mo5759drawImage9jGpkUE(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo5134drawImageRectHPBpro0(imageBitmap, j, j2, j3, j4, m5748configurePaintswdJneE$default(this, null, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5760drawImageAZ2fEMs(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2) {
        this.drawParams.getCanvas().mo5134drawImageRectHPBpro0(imageBitmap, j, j2, j3, j4, m5747configurePaintswdJneE(null, drawStyle, f, colorFilter, i, i2));
    }
    ...
    public void mo5757drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo5132drawCircle9KIMszo(j, f, m5748configurePaintswdJneE$default(this, brush, drawStyle, f2, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5758drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo5132drawCircle9KIMszo(j2, f, m5746configurePaint2qPWKa0$default(this, j, drawStyle, f2, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5764drawOvalAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j >> 32);
        int i3 = (int) (j & 4294967295L);
        this.drawParams.getCanvas().drawOval(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), m5748configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5765drawOvalnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j2 >> 32);
        int i3 = (int) (j2 & 4294967295L);
        this.drawParams.getCanvas().drawOval(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), m5746configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5755drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j >> 32);
        int i3 = (int) (j & 4294967295L);
        this.drawParams.getCanvas().drawArc(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), f, f2, z, m5748configurePaintswdJneE$default(this, brush, drawStyle, f3, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5756drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j2 >> 32);
        int i3 = (int) (j2 & 4294967295L);
        this.drawParams.getCanvas().drawArc(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), f, f2, z, m5746configurePaint2qPWKa0$default(this, j, drawStyle, f3, colorFilter, i, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPath-LG529CI  reason: not valid java name */
    public void mo5767drawPathLG529CI(Path path, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().drawPath(path, m5746configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5766drawPathGBMwjPU(Path path, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().drawPath(path, m5748configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5768drawPointsF8ZwMP8(List<Offset> list, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.drawParams.getCanvas().mo5136drawPointsO7TthRY(i, list, m5750configureStrokePaintQ_0CZUI$default(this, j, f, 4.0f, i2, StrokeJoin.Companion.m5660getMiterLxFBmk8(), pathEffect, f2, colorFilter, i3, 0, 512, null));
    }
    ...
    public void mo5769drawPointsGsft0Ws(List<Offset> list, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.drawParams.getCanvas().mo5136drawPointsO7TthRY(i, list, m5752configureStrokePaintho4zsrM$default(this, brush, f, 4.0f, i2, StrokeJoin.Companion.m5660getMiterLxFBmk8(), pathEffect, f2, colorFilter, i3, 0, 512, null));
    }

    /* renamed from: draw-yzxVdVo  reason: not valid java name */
    public final void m5754drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long j, Function1<? super DrawScope, Unit> function1) {
    ...
    private final Paint obtainFillPaint() {
        ...
        if (paint == null) {
            ...
            Paint.mo5160setStylek9PVt8s(PaintingStyle.Companion.m5558getFillTiuSbCo());
    ...
    private final Paint obtainStrokePaint() {
        ...
        if (paint == null) {
            Paint Paint = AndroidPaint_androidKt.Paint();
            Paint.mo5160setStylek9PVt8s(PaintingStyle.Companion.m5559getStrokeTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (!StrokeCap.m5645equalsimpl0(obtainStrokePaint.mo5152getStrokeCapKaPHkGw(), stroke.m5927getCapKaPHkGw())) {
            obtainStrokePaint.mo5158setStrokeCapBeK7IIE(stroke.m5927getCapKaPHkGw());
        }
        if (obtainStrokePaint.getStrokeMiterLimit() != stroke.getMiter()) {
            obtainStrokePaint.setStrokeMiterLimit(stroke.getMiter());
        }
        if (!StrokeJoin.m5655equalsimpl0(obtainStrokePaint.mo5153getStrokeJoinLxFBmk8(), stroke.m5928getJoinLxFBmk8())) {
            obtainStrokePaint.mo5159setStrokeJoinWw9F2mQ(stroke.m5928getJoinLxFBmk8());
        }
    ...
    static /* synthetic */ Paint m5748configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            i2 = DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m5747configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i2);
    }

    /* renamed from: configurePaint-swdJneE  reason: not valid java name */
    private final Paint m5747configurePaintswdJneE(Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2) {
        Paint selectPaint = selectPaint(drawStyle);
        if (brush != null) {
            brush.mo5225applyToPq9zytI(mo5858getSizeNHjbRc(), selectPaint, f);
        } else {
            if (selectPaint.getShader() != null) {
                selectPaint.setShader(null);
            }
            if (!Color.m5280equalsimpl0(selectPaint.mo5150getColor0d7_KjU(), Color.Companion.m5305getBlack0d7_KjU())) {
                selectPaint.mo5156setColor8_81llA(Color.Companion.m5305getBlack0d7_KjU());
            }
        ...
        if (!BlendMode.m5189equalsimpl0(selectPaint.mo5149getBlendMode0nO6VwU(), i)) {
            selectPaint.mo5155setBlendModes9anfk8(i);
        }
        if (!FilterQuality.m5375equalsimpl0(selectPaint.mo5151getFilterQualityfv9h1I(), i2)) {
            selectPaint.mo5157setFilterQualityvDHp3xo(i2);
        }
        return selectPaint;
    }

    /* renamed from: configurePaint-2qPWKa0$default  reason: not valid java name */
    static /* synthetic */ Paint m5746configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        return canvasDrawScope.m5745configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, (i3 & 32) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i2);
    }

    /* renamed from: configurePaint-2qPWKa0  reason: not valid java name */
    private final Paint m5745configurePaint2qPWKa0(long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2) {
        Paint selectPaint = selectPaint(drawStyle);
        long m5753modulate5vOe2sY = m5753modulate5vOe2sY(j, f);
        if (!Color.m5280equalsimpl0(selectPaint.mo5150getColor0d7_KjU(), m5753modulate5vOe2sY)) {
            selectPaint.mo5156setColor8_81llA(m5753modulate5vOe2sY);
        }
        if (selectPaint.getShader() != null) {
            selectPaint.setShader(null);
        }
    ...
    static /* synthetic */ Paint m5750configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5749configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-Q_0CZUI  reason: not valid java name */
    private final Paint m5749configureStrokePaintQ_0CZUI(long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4) {
        Paint obtainStrokePaint = obtainStrokePaint();
        long m5753modulate5vOe2sY = m5753modulate5vOe2sY(j, f3);
        if (!Color.m5280equalsimpl0(obtainStrokePaint.mo5150getColor0d7_KjU(), m5753modulate5vOe2sY)) {
            obtainStrokePaint.mo5156setColor8_81llA(m5753modulate5vOe2sY);
        }
        ...
        if (!BlendMode.m5189equalsimpl0(obtainStrokePaint.mo5149getBlendMode0nO6VwU(), i3)) {
            obtainStrokePaint.mo5155setBlendModes9anfk8(i3);
        }
        ...
        if (!StrokeCap.m5645equalsimpl0(obtainStrokePaint.mo5152getStrokeCapKaPHkGw(), i)) {
            obtainStrokePaint.mo5158setStrokeCapBeK7IIE(i);
        }
        if (!StrokeJoin.m5655equalsimpl0(obtainStrokePaint.mo5153getStrokeJoinLxFBmk8(), i2)) {
            obtainStrokePaint.mo5159setStrokeJoinWw9F2mQ(i2);
        }
        if (!Intrinsics.areEqual(obtainStrokePaint.getPathEffect(), pathEffect)) {
            obtainStrokePaint.setPathEffect(pathEffect);
        }
        if (!FilterQuality.m5375equalsimpl0(obtainStrokePaint.mo5151getFilterQualityfv9h1I(), i4)) {
            obtainStrokePaint.mo5157setFilterQualityvDHp3xo(i4);
        }
        return obtainStrokePaint;
    }

    /* renamed from: configureStrokePaint-ho4zsrM$default  reason: not valid java name */
    static /* synthetic */ Paint m5752configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5751configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.Companion.m5861getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-ho4zsrM  reason: not valid java name */
    private final Paint m5751configureStrokePaintho4zsrM(Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4) {
        Paint obtainStrokePaint = obtainStrokePaint();
        if (brush != null) {
            brush.mo5225applyToPq9zytI(mo5858getSizeNHjbRc(), obtainStrokePaint, f3);
    ...
    private final long m5753modulate5vOe2sY(long j, float f) {
        return f == 1.0f ? j : Color.m5278copywmQWz5c$default(j, Color.m5281getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final class DrawParams {
        ...
        public static /* synthetic */ DrawParams m5774copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m5776copyUg5Nnss(density, layoutDirection, canvas2, j);
        }
        ...
        public final long m5775component4NHjbRc() {
            return this.size;
        }

        /* renamed from: copy-Ug5Nnss  reason: not valid java name */
        public final DrawParams m5776copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof DrawParams) {
                ...
                return Intrinsics.areEqual(this.density, drawParams.density) && this.layoutDirection == drawParams.layoutDirection && Intrinsics.areEqual(this.canvas, drawParams.canvas) && Size.m5100equalsimpl0(this.size, drawParams.size);
            }
            return false;
        }

        public int hashCode() {
            return (((((this.density.hashCode() * 31) + this.layoutDirection.hashCode()) * 31) + this.canvas.hashCode()) * 31) + Size.m5105hashCodeimpl(this.size);
        }

        public String toString() {
            return "DrawParams(density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", canvas=" + this.canvas + ", size=" + ((Object) Size.m5108toStringimpl(this.size)) + ')';
        }
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, EmptyCanvas emptyCanvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? DrawContextKt.getDefaultDensity() : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? EmptyCanvas.INSTANCE : emptyCanvas, (i & 8) != 0 ? Size.Companion.m5113getZeroNHjbRc() : j, null);
        }
        ...
        /* renamed from: getSize-NH-jbRc  reason: not valid java name */
        public final long m5777getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk  reason: not valid java name */
        public final void m5778setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
