...
public final class CanvasDrawScope implements DrawScope {
    ...
    private final DrawContext drawContext = new DrawContext() { // from class: androidx.compose.ui.graphics.drawscope.CanvasDrawScope$drawContext$1
        ...
        public long mo5267getSizeNHjbRc() {
            return CanvasDrawScope.this.getDrawParams().m5265getSizeNHjbRc();
        }

        @Override // androidx.compose.ui.graphics.drawscope.DrawContext
        /* renamed from: setSize-uvyYCjk  reason: not valid java name */
        public void mo5268setSizeuvyYCjk(long j) {
            CanvasDrawScope.this.getDrawParams().m5266setSizeuvyYCjk(j);
        }
    ...
    public void mo5250drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.drawParams.getCanvas().mo4627drawLineWko1d7g(j, j2, m5240configureStrokePaintho4zsrM$default(this, brush, f, 4.0f, i, StrokeJoin.Companion.m5157getMiterLxFBmk8(), pathEffect, f2, colorFilter, i2, 0, 512, null));
    }
    ...
    public void mo5251drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.drawParams.getCanvas().mo4627drawLineWko1d7g(j2, j3, m5238configureStrokePaintQ_0CZUI$default(this, j, f, 4.0f, i, StrokeJoin.Companion.m5157getMiterLxFBmk8(), pathEffect, f2, colorFilter, i2, 0, 512, null));
    }
    ...
    public void mo5258drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        ...
        this.drawParams.getCanvas().drawRect(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), m5236configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5259drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        ...
        this.drawParams.getCanvas().drawRect(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), m5234configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5249drawImagegbVJVH8(ImageBitmap imageBitmap, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo4625drawImaged4ec7I(imageBitmap, j, m5236configurePaintswdJneE$default(this, null, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public /* synthetic */ void mo5247drawImage9jGpkUE(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo4626drawImageRectHPBpro0(imageBitmap, j, j2, j3, j4, m5236configurePaintswdJneE$default(this, null, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5248drawImageAZ2fEMs(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2) {
        this.drawParams.getCanvas().mo4626drawImageRectHPBpro0(imageBitmap, j, j2, j3, j4, m5235configurePaintswdJneE(null, drawStyle, f, colorFilter, i, i2));
    }
    ...
    public void mo5245drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo4624drawCircle9KIMszo(j, f, m5236configurePaintswdJneE$default(this, brush, drawStyle, f2, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5246drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().mo4624drawCircle9KIMszo(j2, f, m5234configurePaint2qPWKa0$default(this, j, drawStyle, f2, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5252drawOvalAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j >> 32);
        int i3 = (int) (j & 4294967295L);
        this.drawParams.getCanvas().drawOval(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), m5236configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5253drawOvalnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j2 >> 32);
        int i3 = (int) (j2 & 4294967295L);
        this.drawParams.getCanvas().drawOval(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), m5234configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5243drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j >> 32);
        int i3 = (int) (j & 4294967295L);
        this.drawParams.getCanvas().drawArc(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j2 & 4294967295L)), f, f2, z, m5236configurePaintswdJneE$default(this, brush, drawStyle, f3, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5244drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        int i2 = (int) (j2 >> 32);
        int i3 = (int) (j2 & 4294967295L);
        this.drawParams.getCanvas().drawArc(Float.intBitsToFloat(i2), Float.intBitsToFloat(i3), Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j3 >> 32)), Float.intBitsToFloat(i3) + Float.intBitsToFloat((int) (j3 & 4294967295L)), f, f2, z, m5234configurePaint2qPWKa0$default(this, j, drawStyle, f3, colorFilter, i, 0, 32, null));
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawPath-LG529CI  reason: not valid java name */
    public void mo5255drawPathLG529CI(Path path, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().drawPath(path, m5234configurePaint2qPWKa0$default(this, j, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5254drawPathGBMwjPU(Path path, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.drawParams.getCanvas().drawPath(path, m5236configurePaintswdJneE$default(this, brush, drawStyle, f, colorFilter, i, 0, 32, null));
    }
    ...
    public void mo5256drawPointsF8ZwMP8(List<Offset> list, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.drawParams.getCanvas().mo4628drawPointsO7TthRY(i, list, m5238configureStrokePaintQ_0CZUI$default(this, j, f, 4.0f, i2, StrokeJoin.Companion.m5157getMiterLxFBmk8(), pathEffect, f2, colorFilter, i3, 0, 512, null));
    }
    ...
    public void mo5257drawPointsGsft0Ws(List<Offset> list, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.drawParams.getCanvas().mo4628drawPointsO7TthRY(i, list, m5240configureStrokePaintho4zsrM$default(this, brush, f, 4.0f, i2, StrokeJoin.Companion.m5157getMiterLxFBmk8(), pathEffect, f2, colorFilter, i3, 0, 512, null));
    }

    /* renamed from: draw-yzxVdVo  reason: not valid java name */
    public final void m5242drawyzxVdVo(Density density, LayoutDirection layoutDirection, Canvas canvas, long j, Function1<? super DrawScope, Unit> function1) {
    ...
    private final Paint obtainFillPaint() {
        ...
        if (paint == null) {
            ...
            Paint.mo4652setStylek9PVt8s(PaintingStyle.Companion.m5053getFillTiuSbCo());
    ...
    private final Paint selectPaint(DrawStyle drawStyle) {
        ...
        if (!StrokeCap.m5142equalsimpl0(obtainStrokePaint.mo4644getStrokeCapKaPHkGw(), stroke.m5415getCapKaPHkGw())) {
            obtainStrokePaint.mo4650setStrokeCapBeK7IIE(stroke.m5415getCapKaPHkGw());
        }
        if (obtainStrokePaint.getStrokeMiterLimit() != stroke.getMiter()) {
            obtainStrokePaint.setStrokeMiterLimit(stroke.getMiter());
        }
        if (!StrokeJoin.m5152equalsimpl0(obtainStrokePaint.mo4645getStrokeJoinLxFBmk8(), stroke.m5416getJoinLxFBmk8())) {
            obtainStrokePaint.mo4651setStrokeJoinWw9F2mQ(stroke.m5416getJoinLxFBmk8());
        }
    ...
    static /* synthetic */ Paint m5236configurePaintswdJneE$default(CanvasDrawScope canvasDrawScope, Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        if ((i3 & 32) != 0) {
            i2 = DrawScope.Companion.m5349getDefaultFilterQualityfv9h1I();
        }
        return canvasDrawScope.m5235configurePaintswdJneE(brush, drawStyle, f, colorFilter, i, i2);
    }

    /* renamed from: configurePaint-swdJneE  reason: not valid java name */
    private final Paint m5235configurePaintswdJneE(Brush brush, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2) {
        Paint selectPaint = selectPaint(drawStyle);
        if (brush != null) {
            brush.mo4717applyToPq9zytI(mo5346getSizeNHjbRc(), selectPaint, f);
        } else {
            if (selectPaint.getShader() != null) {
                selectPaint.setShader(null);
            }
            if (!Color.m4773equalsimpl0(selectPaint.mo4642getColor0d7_KjU(), Color.Companion.m4798getBlack0d7_KjU())) {
                selectPaint.mo4648setColor8_81llA(Color.Companion.m4798getBlack0d7_KjU());
            }
        ...
        if (!BlendMode.m4681equalsimpl0(selectPaint.mo4641getBlendMode0nO6VwU(), i)) {
            selectPaint.mo4647setBlendModes9anfk8(i);
        }
        if (!FilterQuality.m4867equalsimpl0(selectPaint.mo4643getFilterQualityfv9h1I(), i2)) {
            selectPaint.mo4649setFilterQualityvDHp3xo(i2);
        }
        return selectPaint;
    }

    /* renamed from: configurePaint-2qPWKa0$default  reason: not valid java name */
    static /* synthetic */ Paint m5234configurePaint2qPWKa0$default(CanvasDrawScope canvasDrawScope, long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2, int i3, Object obj) {
        return canvasDrawScope.m5233configurePaint2qPWKa0(j, drawStyle, f, colorFilter, i, (i3 & 32) != 0 ? DrawScope.Companion.m5349getDefaultFilterQualityfv9h1I() : i2);
    }

    /* renamed from: configurePaint-2qPWKa0  reason: not valid java name */
    private final Paint m5233configurePaint2qPWKa0(long j, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i, int i2) {
        Paint selectPaint = selectPaint(drawStyle);
        long m5241modulate5vOe2sY = m5241modulate5vOe2sY(j, f);
        if (!Color.m4773equalsimpl0(selectPaint.mo4642getColor0d7_KjU(), m5241modulate5vOe2sY)) {
            selectPaint.mo4648setColor8_81llA(m5241modulate5vOe2sY);
        }
        if (selectPaint.getShader() != null) {
            selectPaint.setShader(null);
        }
    ...
    static /* synthetic */ Paint m5238configureStrokePaintQ_0CZUI$default(CanvasDrawScope canvasDrawScope, long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5237configureStrokePaintQ_0CZUI(j, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.Companion.m5349getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-Q_0CZUI  reason: not valid java name */
    private final Paint m5237configureStrokePaintQ_0CZUI(long j, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4) {
        Paint obtainStrokePaint = obtainStrokePaint();
        long m5241modulate5vOe2sY = m5241modulate5vOe2sY(j, f3);
        if (!Color.m4773equalsimpl0(obtainStrokePaint.mo4642getColor0d7_KjU(), m5241modulate5vOe2sY)) {
            obtainStrokePaint.mo4648setColor8_81llA(m5241modulate5vOe2sY);
        }
        ...
        if (!BlendMode.m4681equalsimpl0(obtainStrokePaint.mo4641getBlendMode0nO6VwU(), i3)) {
            obtainStrokePaint.mo4647setBlendModes9anfk8(i3);
        }
        ...
        if (!StrokeCap.m5142equalsimpl0(obtainStrokePaint.mo4644getStrokeCapKaPHkGw(), i)) {
            obtainStrokePaint.mo4650setStrokeCapBeK7IIE(i);
        }
        if (!StrokeJoin.m5152equalsimpl0(obtainStrokePaint.mo4645getStrokeJoinLxFBmk8(), i2)) {
            obtainStrokePaint.mo4651setStrokeJoinWw9F2mQ(i2);
        }
        if (!Intrinsics.areEqual(obtainStrokePaint.getPathEffect(), pathEffect)) {
            obtainStrokePaint.setPathEffect(pathEffect);
        }
        if (!FilterQuality.m4867equalsimpl0(obtainStrokePaint.mo4643getFilterQualityfv9h1I(), i4)) {
            obtainStrokePaint.mo4649setFilterQualityvDHp3xo(i4);
        }
        return obtainStrokePaint;
    }

    /* renamed from: configureStrokePaint-ho4zsrM$default  reason: not valid java name */
    static /* synthetic */ Paint m5240configureStrokePaintho4zsrM$default(CanvasDrawScope canvasDrawScope, Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4, int i5, Object obj) {
        return canvasDrawScope.m5239configureStrokePaintho4zsrM(brush, f, f2, i, i2, pathEffect, f3, colorFilter, i3, (i5 & 512) != 0 ? DrawScope.Companion.m5349getDefaultFilterQualityfv9h1I() : i4);
    }

    /* renamed from: configureStrokePaint-ho4zsrM  reason: not valid java name */
    private final Paint m5239configureStrokePaintho4zsrM(Brush brush, float f, float f2, int i, int i2, PathEffect pathEffect, float f3, ColorFilter colorFilter, int i3, int i4) {
        Paint obtainStrokePaint = obtainStrokePaint();
        if (brush != null) {
            brush.mo4717applyToPq9zytI(mo5346getSizeNHjbRc(), obtainStrokePaint, f3);
    ...
    private final long m5241modulate5vOe2sY(long j, float f) {
        return f == 1.0f ? j : Color.m4771copywmQWz5c$default(j, Color.m4774getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final class DrawParams {
        ...
        public static /* synthetic */ DrawParams m5262copyUg5Nnss$default(DrawParams drawParams, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return drawParams.m5264copyUg5Nnss(density, layoutDirection, canvas2, j);
        }
        ...
        public final long m5263component4NHjbRc() {
            return this.size;
        }

        /* renamed from: copy-Ug5Nnss  reason: not valid java name */
        public final DrawParams m5264copyUg5Nnss(Density density, LayoutDirection layoutDirection, Canvas canvas, long j) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof DrawParams) {
                ...
                return Intrinsics.areEqual(this.density, drawParams.density) && this.layoutDirection == drawParams.layoutDirection && Intrinsics.areEqual(this.canvas, drawParams.canvas) && Size.m4592equalsimpl0(this.size, drawParams.size);
            }
            return false;
        }

        public int hashCode() {
            return (((((this.density.hashCode() * 31) + this.layoutDirection.hashCode()) * 31) + this.canvas.hashCode()) * 31) + Size.m4597hashCodeimpl(this.size);
        }

        public String toString() {
            return "DrawParams(density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", canvas=" + this.canvas + ", size=" + ((Object) Size.m4600toStringimpl(this.size)) + ')';
        }
        ...
        public /* synthetic */ DrawParams(Density density, LayoutDirection layoutDirection, EmptyCanvas emptyCanvas, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
            this((i & 1) != 0 ? DrawContextKt.getDefaultDensity() : density, (i & 2) != 0 ? LayoutDirection.Ltr : layoutDirection, (i & 4) != 0 ? EmptyCanvas.INSTANCE : emptyCanvas, (i & 8) != 0 ? Size.Companion.m4605getZeroNHjbRc() : j, null);
        }
        ...
        /* renamed from: getSize-NH-jbRc  reason: not valid java name */
        public final long m5265getSizeNHjbRc() {
            return this.size;
        }

        /* renamed from: setSize-uvyYCjk  reason: not valid java name */
        public final void m5266setSizeuvyYCjk(long j) {
            this.size = j;
        }
    }
}
