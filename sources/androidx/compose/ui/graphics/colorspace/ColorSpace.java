...
public abstract class ColorSpace {
    ...
    public final long m5211getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m5203getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float f, float f2, float f3) {
        float[] fArr = new float[ColorModel.m5203getComponentCountimpl(this.model)];
        fArr[0] = f;
        fArr[1] = f2;
        fArr[2] = f3;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m5205toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m5202equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m5204hashCodeimpl(this.model)) * 31) + this.id;
    }

    /* compiled from: ColorSpace.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0080T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/ColorSpace$Companion;", "", "<init>", "()V", "MinId", "", "MaxId", "ui-graphics"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: classes.dex */
