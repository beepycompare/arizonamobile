...
public final class ColorSpaceKt {
    ...
    private static final Connector m5718createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.Companion.identity$ui_graphics_release(colorSpace);
        }
        if (ColorModel.m5705equalsimpl0(colorSpace.m5714getModelxdoWZVw(), ColorModel.Companion.m5712getRgbxdoWZVw()) && ColorModel.m5705equalsimpl0(colorSpace2.m5714getModelxdoWZVw(), ColorModel.Companion.m5712getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m5717connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m5734getPerceptualuksYyKA();
        }
        return m5716connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m5716connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m5718createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m5718createConnectorYBCOT_4(colorSpace, colorSpace2, i);
