...
public final class ColorSpaceKt {
    ...
    private static final Connector m5869createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.Companion.identity$ui_graphics(colorSpace);
        }
        if (ColorModel.m5856equalsimpl0(colorSpace.m5865getModelxdoWZVw(), ColorModel.Companion.m5863getRgbxdoWZVw()) && ColorModel.m5856equalsimpl0(colorSpace2.m5865getModelxdoWZVw(), ColorModel.Companion.m5863getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m5868connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m5884getPerceptualuksYyKA();
        }
        return m5867connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m5867connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics | id$ui_graphics2) < 0) {
            return m5869createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m5869createConnectorYBCOT_4(colorSpace, colorSpace2, i);
