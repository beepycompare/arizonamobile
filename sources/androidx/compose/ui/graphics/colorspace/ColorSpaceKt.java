...
public final class ColorSpaceKt {
    ...
    private static final Connector m4975createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.Companion.identity$ui_graphics_release(colorSpace);
        }
        if (ColorModel.m4962equalsimpl0(colorSpace.m4971getModelxdoWZVw(), ColorModel.Companion.m4969getRgbxdoWZVw()) && ColorModel.m4962equalsimpl0(colorSpace2.m4971getModelxdoWZVw(), ColorModel.Companion.m4969getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m4974connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m4991getPerceptualuksYyKA();
        }
        return m4973connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m4973connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m4975createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m4975createConnectorYBCOT_4(colorSpace, colorSpace2, i);
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m4962equalsimpl0(colorSpace.m4971getModelxdoWZVw(), ColorModel.Companion.m4969getRgbxdoWZVw())) {
            Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
