...
public final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo4973setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.m5122getTransformOriginSzJe1aQ());
                ...
                graphicsLayerScope.mo4969setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m5118getAmbientShadowColor0d7_KjU());
                graphicsLayerScope.mo4972setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m5121getSpotShadowColor0d7_KjU());
                graphicsLayerScope.mo4971setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.m5120getCompositingStrategyNrFUSI());
                graphicsLayerScope.mo4970setBlendModes9anfk8(SimpleGraphicsLayerModifier.this.m5119getBlendMode0nO6VwU());
    ...
    public final long m5122getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    /* renamed from: setTransformOrigin-__ExYCQ  reason: not valid java name */
    public final void m5127setTransformOrigin__ExYCQ(long j) {
        this.transformOrigin = j;
    }
    ...
    public final long m5118getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: setAmbientShadowColor-8_81llA  reason: not valid java name */
    public final void m5123setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m5121getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: setSpotShadowColor-8_81llA  reason: not valid java name */
    public final void m5126setSpotShadowColor8_81llA(long j) {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, ColorFilter colorFilter, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, f2, f3, f4, f5, f6, f7, f8, f9, f10, j, shape, z, renderEffect, j2, j3, (i3 & 65536) != 0 ? CompositingStrategy.Companion.m4861getAutoNrFUSI() : i, (i3 & 131072) != 0 ? BlendMode.Companion.m4712getSrcOver0nO6VwU() : i2, (i3 & 262144) != 0 ? null : colorFilter, null);
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m5120getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m5125setCompositingStrategyaDBOjCE(int i) {
        this.compositingStrategy = i;
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m5119getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public final void m5124setBlendModes9anfk8(int i) {
        this.blendMode = i;
    }
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6216measureBRTryo0.getWidth(), mo6216measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
