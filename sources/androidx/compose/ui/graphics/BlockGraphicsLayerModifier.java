...
public final class BlockGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo69measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (ComposeUiFlags.isGraphicsLayerShapeSemanticsEnabled) {
            NodeCoordinator m6990requireCoordinator64DMado = DelegatableNodeKt.m6990requireCoordinator64DMado(this, NodeKind.m7135constructorimpl(2));
            if (!m6990requireCoordinator64DMado.getWasLayerBlockInvoked$ui()) {
                ...
                reusableGraphicsLayerScope3.setGraphicsDensity$ui(m6990requireCoordinator64DMado.getLayoutNode().getDensity());
                reusableGraphicsLayerScope3.m5676setSizeuvyYCjk(IntSizeKt.m8343toSizeozmzZPI(m6990requireCoordinator64DMado.mo6826getSizeYbymL2g()));
                ...
                lastShape$ui = m6990requireCoordinator64DMado.getLastShape$ui();
                lastClip$ui = m6990requireCoordinator64DMado.getLastClip$ui();
            }
            if (lastClip$ui) {
