...
public final class BlockGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo82measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo6875measureBRTryo0.getWidth(), mo6875measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        if (ComposeUiFlags.isGraphicsLayerShapeSemanticsEnabled) {
            NodeCoordinator m7046requireCoordinator64DMado = DelegatableNodeKt.m7046requireCoordinator64DMado(this, NodeKind.m7195constructorimpl(2));
            if (!m7046requireCoordinator64DMado.getWasLayerBlockInvoked$ui()) {
                ...
                reusableGraphicsLayerScope3.setGraphicsDensity$ui(m7046requireCoordinator64DMado.getLayoutNode().getDensity());
                reusableGraphicsLayerScope3.m5754setSizeuvyYCjk(IntSizeKt.m8441toSizeozmzZPI(m7046requireCoordinator64DMado.mo6883getSizeYbymL2g()));
                ...
                Shape lastShape$ui = m7046requireCoordinator64DMado.getLastShape$ui();
                lastClip$ui = m7046requireCoordinator64DMado.getLastClip$ui();
                shape = lastShape$ui;
            }
            if (lastClip$ui) {
