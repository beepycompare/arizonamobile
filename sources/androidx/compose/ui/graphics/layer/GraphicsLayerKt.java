...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer graphicsLayer, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            long m5095constructorimpl = Offset.m5095constructorimpl((Float.floatToRawIntBits(left) << 32) | (Float.floatToRawIntBits(top) & 4294967295L));
            ...
            graphicsLayer.m6021setRectOutlinetz77jQw(m5095constructorimpl, Size.m5163constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(right) << 32)));
            ...
            long m5095constructorimpl2 = Offset.m5095constructorimpl((Float.floatToRawIntBits(left2) << 32) | (Float.floatToRawIntBits(top2) & 4294967295L));
            float width = roundRect.getWidth();
            float height = roundRect.getHeight();
            graphicsLayer.m6022setRoundRectOutlineTNW_H78(m5095constructorimpl2, Size.m5163constructorimpl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), Float.intBitsToFloat((int) (roundRect.m5151getBottomLeftCornerRadiuskKHJgLs() >> 32)));
        }
    }
