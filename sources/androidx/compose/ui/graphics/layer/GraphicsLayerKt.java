...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer graphicsLayer, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            long m4519constructorimpl = Offset.m4519constructorimpl((Float.floatToRawIntBits(left) << 32) | (Float.floatToRawIntBits(top) & 4294967295L));
            ...
            graphicsLayer.m5445setRectOutlinetz77jQw(m4519constructorimpl, Size.m4587constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(right) << 32)));
            ...
            long m4519constructorimpl2 = Offset.m4519constructorimpl((Float.floatToRawIntBits(left2) << 32) | (Float.floatToRawIntBits(top2) & 4294967295L));
            float width = roundRect.getWidth();
            float height = roundRect.getHeight();
            graphicsLayer.m5446setRoundRectOutlineTNW_H78(m4519constructorimpl2, Size.m4587constructorimpl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), Float.intBitsToFloat((int) (roundRect.m4575getBottomLeftCornerRadiuskKHJgLs() >> 32)));
        }
    }
