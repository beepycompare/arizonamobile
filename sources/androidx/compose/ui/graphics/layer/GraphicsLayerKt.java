...
public final class GraphicsLayerKt {
    ...
    public static final void setOutline(GraphicsLayer graphicsLayer, Outline outline) {
        if (outline instanceof Outline.Rectangle) {
            ...
            long m5028constructorimpl = Offset.m5028constructorimpl((Float.floatToRawIntBits(left) << 32) | (Float.floatToRawIntBits(top) & 4294967295L));
            ...
            graphicsLayer.m5958setRectOutlinetz77jQw(m5028constructorimpl, Size.m5096constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(right) << 32)));
            ...
            long m5028constructorimpl2 = Offset.m5028constructorimpl((Float.floatToRawIntBits(left2) << 32) | (Float.floatToRawIntBits(top2) & 4294967295L));
            float width = roundRect.getWidth();
            float height = roundRect.getHeight();
            graphicsLayer.m5959setRoundRectOutlineTNW_H78(m5028constructorimpl2, Size.m5096constructorimpl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), Float.intBitsToFloat((int) (roundRect.m5084getBottomLeftCornerRadiuskKHJgLs() >> 32)));
        }
    }
