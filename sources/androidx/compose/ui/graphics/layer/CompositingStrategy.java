...
public final class CompositingStrategy {
    ...
    private static final int Auto = m5996constructorimpl(0);
    private static final int Offscreen = m5996constructorimpl(1);
    private static final int ModulateAlpha = m5996constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m5995boximpl(int i) {
    ...
    public static boolean m5997equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).m6001unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m5998equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m5997equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5999hashCodeimpl(this.value);
    }

    public String toString() {
        return m6000toStringimpl(this.value);
    }
