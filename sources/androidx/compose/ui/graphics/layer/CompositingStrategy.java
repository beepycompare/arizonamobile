...
public final class CompositingStrategy {
    ...
    private static final int Auto = m4714constructorimpl(0);
    private static final int Offscreen = m4714constructorimpl(1);
    private static final int ModulateAlpha = m4714constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CompositingStrategy m4713boximpl(int i) {
    ...
    public static boolean m4715equalsimpl(int i, Object obj) {
        return (obj instanceof CompositingStrategy) && i == ((CompositingStrategy) obj).m4719unboximpl();
    }
