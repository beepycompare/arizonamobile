...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.Companion.m5181getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m6038applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.Companion.m6002getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo6031setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m5195toAndroidBlendModes9anfk8(i));
    ...
    public void mo6030setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m5402toArgb8_81llA(j));
    }
    ...
    public void mo6036setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m5402toArgb8_81llA(j));
    }
    ...
    private final void m6038applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        ...
        boolean m5998equalsimpl0 = CompositingStrategy.m5998equalsimpl0(i, CompositingStrategy.Companion.m6003getModulateAlphake2Ky5w());
    ...
    private final void updateLayerProperties() {
        ...
        if (requiresCompositingLayer) {
            m6038applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.Companion.m6004getOffscreenke2Ky5w());
        } else {
            m6038applyCompositingStrategyZ1X6vPc(renderNode, mo6027getCompositingStrategyke2Ky5w());
        }
    }
    ...
    public void mo6035setPositionH0pRuoY(int i, int i2, long j) {
        ...
        this.size = IntSizeKt.m8343toSizeozmzZPI(j);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        try {
            ...
            drawContext.mo5844setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5998equalsimpl0(mo6027getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m6004getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m5257equalsimpl0(mo6026getBlendMode0nO6VwU(), BlendMode.Companion.m5288getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
}
