...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.Companion.m4605getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m5462applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.Companion.m5426getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5455setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m4619toAndroidBlendModes9anfk8(i));
    ...
    public void mo5458setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
        int i = ((9223372034707292159L & j) > InlineClassHelperKt.UnspecifiedPackedFloats ? 1 : ((9223372034707292159L & j) == InlineClassHelperKt.UnspecifiedPackedFloats ? 0 : -1));
    ...
    public void mo5454setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4826toArgb8_81llA(j));
    }
    ...
    public void mo5460setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4826toArgb8_81llA(j));
    }
    ...
    private final void m5462applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        ...
        boolean m5422equalsimpl0 = CompositingStrategy.m5422equalsimpl0(i, CompositingStrategy.Companion.m5427getModulateAlphake2Ky5w());
    ...
    private final void updateLayerProperties() {
        ...
        if (requiresCompositingLayer) {
            m5462applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.Companion.m5428getOffscreenke2Ky5w());
        } else {
            m5462applyCompositingStrategyZ1X6vPc(renderNode, mo5451getCompositingStrategyke2Ky5w());
        }
    }
    ...
    public void mo5459setPositionH0pRuoY(int i, int i2, long j) {
        ...
        this.size = IntSizeKt.m7738toSizeozmzZPI(j);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        try {
            ...
            drawContext.mo5268setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5422equalsimpl0(mo5451getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m5428getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4681equalsimpl0(mo5450getBlendMode0nO6VwU(), BlendMode.Companion.m4712getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
}
