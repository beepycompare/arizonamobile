        ...
        if (continuation instanceof LayerSnapshotV22$toBitmap$1) {
            ...
            if ((layerSnapshotV22$toBitmap$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    long m6096getSizeYbymL2g = graphicsLayer.m6096getSizeYbymL2g();
                    Looper myLooper = Looper.myLooper();
                    if (myLooper == null) {
                        myLooper = Looper.getMainLooper();
                    }
                    ImageReader newInstance = ImageReader.newInstance((int) (m6096getSizeYbymL2g >> 32), (int) (m6096getSizeYbymL2g & 4294967295L), 1, 1);
                    try {
                        ...
                        imageReader2.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.compose.ui.graphics.layer.LayerSnapshotV22$toBitmap$2$image$1$1
                            ...
                            public final void onImageAvailable(ImageReader imageReader3) {
                                ...
                                cancellableContinuationImpl2.resumeWith(Result.m10215constructorimpl(imageReader3.acquireLatestImage()));
                            }
                        ...
                        lockCanvas.drawColor(ColorKt.m5478toArgb8_81llA(Color.Companion.m5450getBlack0d7_KjU()), PorterDuff.Mode.CLEAR);
