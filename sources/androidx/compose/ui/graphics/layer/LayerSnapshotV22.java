        ...
        if (continuation instanceof LayerSnapshotV22$toBitmap$1) {
            ...
            if ((layerSnapshotV22$toBitmap$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    long m5437getSizeYbymL2g = graphicsLayer.m5437getSizeYbymL2g();
                    Looper myLooper = Looper.myLooper();
                    if (myLooper == null) {
                        myLooper = Looper.getMainLooper();
                    }
                    ImageReader newInstance = ImageReader.newInstance((int) (m5437getSizeYbymL2g >> 32), (int) (m5437getSizeYbymL2g & 4294967295L), 1, 1);
                    try {
                        ...
                        imageReader2.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.compose.ui.graphics.layer.LayerSnapshotV22$toBitmap$2$image$1$1
                            ...
                            public final void onImageAvailable(ImageReader imageReader3) {
                                ...
                                cancellableContinuationImpl2.resumeWith(Result.m9183constructorimpl(imageReader3.acquireLatestImage()));
                            }
                        ...
                        lockCanvas.drawColor(ColorKt.m4826toArgb8_81llA(Color.Companion.m4798getBlack0d7_KjU()), PorterDuff.Mode.CLEAR);
