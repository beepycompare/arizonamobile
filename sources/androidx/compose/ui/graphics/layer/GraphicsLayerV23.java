...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.Companion.m8172getZeroYbymL2g();
        ...
        create.setClipToBounds(false);
        m5974applyCompositingStrategyWpw9cng(CompositingStrategy.Companion.m5939getAutoke2Ky5w());
    ...
    private final void m5974applyCompositingStrategyWpw9cng(int i) {
    ...
    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m5935equalsimpl0(mo5964getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m5941getOffscreenke2Ky5w()) && BlendMode.m5190equalsimpl0(mo5963getBlendMode0nO6VwU(), BlendMode.Companion.m5221getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5974applyCompositingStrategyWpw9cng(CompositingStrategy.Companion.m5941getOffscreenke2Ky5w());
        } else {
            m5974applyCompositingStrategyWpw9cng(mo5964getCompositingStrategyke2Ky5w());
        }
    }
    ...
    public void mo5967setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m5334toArgb8_81llA(j));
        }
    }
    ...
    public void mo5973setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m5334toArgb8_81llA(j));
        }
    }
