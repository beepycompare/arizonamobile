...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.Companion.m8171getZeroYbymL2g();
        ...
        create.setClipToBounds(false);
        m5973applyCompositingStrategyWpw9cng(CompositingStrategy.Companion.m5938getAutoke2Ky5w());
    ...
    private final void m5973applyCompositingStrategyWpw9cng(int i) {
    ...
    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m5934equalsimpl0(mo5963getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m5940getOffscreenke2Ky5w()) && BlendMode.m5189equalsimpl0(mo5962getBlendMode0nO6VwU(), BlendMode.Companion.m5220getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5973applyCompositingStrategyWpw9cng(CompositingStrategy.Companion.m5940getOffscreenke2Ky5w());
        } else {
            m5973applyCompositingStrategyWpw9cng(mo5963getCompositingStrategyke2Ky5w());
        }
    }
    ...
    public void mo5966setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m5333toArgb8_81llA(j));
        }
    }
    ...
    public void mo5972setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m5333toArgb8_81llA(j));
        }
    }
