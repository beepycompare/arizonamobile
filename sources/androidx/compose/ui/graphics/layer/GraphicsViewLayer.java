...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.Companion.m5119getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m6039applyCompositingLayerWpw9cng(int i) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6039applyCompositingLayerWpw9cng(CompositingStrategy.Companion.m6004getOffscreenke2Ky5w());
        } else {
            m6039applyCompositingLayerWpw9cng(mo6027getCompositingStrategyke2Ky5w());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5998equalsimpl0(mo6027getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m6004getOffscreenke2Ky5w()) || requiresLayerPaint();
    }
    ...
    public void mo6030setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m5402toArgb8_81llA(j));
        }
    }
    ...
    public void mo6036setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m5402toArgb8_81llA(j));
        }
    }
    ...
    private final void recordDrawingOperations() {
        try {
            ...
            ViewLayer viewLayer = this.viewLayer;
            drawChildContainer.drawChild$ui_graphics(canvasHolder.getAndroidCanvas(), viewLayer, viewLayer.getDrawingTime());
