...
public final class AndroidPathMeasure implements PathMeasure {
    ...
    public long mo5243getPositiontuRUvjQ(float f) {
        ...
        if (this.internalPathMeasure.getPosTan(f, this.positionArray, this.tangentArray)) {
            ...
            return Offset.m5095constructorimpl((Float.floatToRawIntBits(fArr2[1]) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
        }
    ...
    public long mo5244getTangenttuRUvjQ(float f) {
        if (this.positionArray == null) {
            this.positionArray = new float[2];
        }
        if (this.tangentArray == null) {
