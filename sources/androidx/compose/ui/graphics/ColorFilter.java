...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m4578tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m4476getSrcIn0nO6VwU();
            }
            return companion.m4581tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m4581tintxETnrds(long j, int i) {
            return new BlendModeColorFilter(j, i, (DefaultConstructorMarker) null);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m4579colorMatrixjHGOpc(float[] fArr) {
            return new ColorMatrixColorFilter(fArr, (DefaultConstructorMarker) null);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m4580lightingOWjLjI(long j, long j2) {
