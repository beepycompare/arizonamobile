...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m4590tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m4488getSrcIn0nO6VwU();
            }
            return companion.m4593tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m4593tintxETnrds(long j, int i) {
            return new BlendModeColorFilter(j, i, (DefaultConstructorMarker) null);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m4591colorMatrixjHGOpc(float[] fArr) {
            return new ColorMatrixColorFilter(fArr, (DefaultConstructorMarker) null);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m4592lightingOWjLjI(long j, long j2) {
