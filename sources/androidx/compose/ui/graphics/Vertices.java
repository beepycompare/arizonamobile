...
public final class Vertices {
    ...
    public final int m4481getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m4132toArgb8_81llA(list.get(i).m4088unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m3847unboximpl = list.get(i / 2).m3847unboximpl();
            if (i % 2 == 0) {
                intBitsToFloat = Float.intBitsToFloat((int) (m3847unboximpl >> 32));
            } else {
                intBitsToFloat = Float.intBitsToFloat((int) (m3847unboximpl & 4294967295L));
            }
