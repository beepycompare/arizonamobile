...
public final class Vertices {
    ...
    public final int m5773getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m5402toArgb8_81llA(list.get(i).m5358unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m5113unboximpl = list.get(i / 2).m5113unboximpl();
            if (i % 2 == 0) {
                intBitsToFloat = Float.intBitsToFloat((int) (m5113unboximpl >> 32));
            } else {
                intBitsToFloat = Float.intBitsToFloat((int) (m5113unboximpl & 4294967295L));
            }
