...
public final class Vertices {
    ...
    public final int m5197getVertexModec2xauaI() {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i = 0; i < size; i++) {
            iArr[i] = ColorKt.m4826toArgb8_81llA(list.get(i).m4782unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m4537unboximpl = list.get(i / 2).m4537unboximpl();
            if (i % 2 == 0) {
                intBitsToFloat = Float.intBitsToFloat((int) (m4537unboximpl >> 32));
            } else {
                intBitsToFloat = Float.intBitsToFloat((int) (m4537unboximpl & 4294967295L));
            }
