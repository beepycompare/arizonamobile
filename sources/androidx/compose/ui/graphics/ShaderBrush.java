...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo5393createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m5256getUnspecifiedNHjbRc();
    }

    /* renamed from: getTransform-3i98HWw  reason: not valid java name */
    public final float[] m5755getTransform3i98HWw() {
        return this.transform;
    }

    /* renamed from: setTransform-Q8lPUPs  reason: not valid java name */
    public final void m5756setTransformQ8lPUPs(float[] fArr) {
        this.transform = fArr;
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader != null) {
            transformShader.m5840transformQ8lPUPs(fArr);
        }
    }
    ...
    public final void mo5369applyToPq9zytI(long j, Paint paint, float f) {
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader == null || !Size.m5244equalsimpl0(this.createdSize, j)) {
            if (Size.m5250isEmptyimpl(j)) {
                ...
                transformShader.setShader(mo5393createShaderuvyYCjk(j));
                this.internalTransformShader = transformShader;
                this.createdSize = j;
            }
        }
        if (!Color.m5425equalsimpl0(paint.mo5294getColor0d7_KjU(), Color.Companion.m5450getBlack0d7_KjU())) {
            paint.mo5300setColor8_81llA(Color.Companion.m5450getBlack0d7_KjU());
        }
