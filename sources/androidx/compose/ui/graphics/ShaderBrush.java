...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo4741createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m4604getUnspecifiedNHjbRc();
    }

    /* renamed from: getTransform-3i98HWw  reason: not valid java name */
    public final float[] m5101getTransform3i98HWw() {
        return this.transform;
    }

    /* renamed from: setTransform-Q8lPUPs  reason: not valid java name */
    public final void m5102setTransformQ8lPUPs(float[] fArr) {
        this.transform = fArr;
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader != null) {
            transformShader.m5186transformQ8lPUPs(fArr);
        }
    }
    ...
    public final void mo4717applyToPq9zytI(long j, Paint paint, float f) {
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader == null || !Size.m4592equalsimpl0(this.createdSize, j)) {
            if (Size.m4598isEmptyimpl(j)) {
                ...
                transformShader.setShader(mo4741createShaderuvyYCjk(j));
                this.internalTransformShader = transformShader;
                this.createdSize = j;
            }
        }
        if (!Color.m4773equalsimpl0(paint.mo4642getColor0d7_KjU(), Color.Companion.m4798getBlack0d7_KjU())) {
            paint.mo4648setColor8_81llA(Color.Companion.m4798getBlack0d7_KjU());
        }
