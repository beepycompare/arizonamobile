...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo5317createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m5180getUnspecifiedNHjbRc();
    }

    /* renamed from: getTransform-3i98HWw  reason: not valid java name */
    public final float[] m5677getTransform3i98HWw() {
        return this.transform;
    }

    /* renamed from: setTransform-Q8lPUPs  reason: not valid java name */
    public final void m5678setTransformQ8lPUPs(float[] fArr) {
        this.transform = fArr;
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader != null) {
            transformShader.m5762transformQ8lPUPs(fArr);
        }
    }
    ...
    public final void mo5293applyToPq9zytI(long j, Paint paint, float f) {
        TransformShader transformShader = this.internalTransformShader;
        if (transformShader == null || !Size.m5168equalsimpl0(this.createdSize, j)) {
            if (Size.m5174isEmptyimpl(j)) {
                ...
                transformShader.setShader(mo5317createShaderuvyYCjk(j));
                this.internalTransformShader = transformShader;
                this.createdSize = j;
            }
        }
        if (!Color.m5349equalsimpl0(paint.mo5218getColor0d7_KjU(), Color.Companion.m5374getBlack0d7_KjU())) {
            paint.mo5224setColor8_81llA(Color.Companion.m5374getBlack0d7_KjU());
        }
