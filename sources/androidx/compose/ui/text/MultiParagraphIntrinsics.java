...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, Density density, FontFamily.Resolver resolver) {
        ...
        while (i < size) {
            ...
            arrayList2.add(new ParagraphIntrinsicInfo(ParagraphIntrinsicsKt.ParagraphIntrinsics(text, merge, annotations$ui_text, density, resolver, localPlaceholders), range.getStart(), range.getEnd()));
            i++;
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle paragraphStyle, ParagraphStyle paragraphStyle2) {
        return !TextDirection.m8051equalsimpl0(paragraphStyle.m7515getTextDirections_7Xco(), TextDirection.Companion.m8060getUnspecifieds_7Xco()) ? paragraphStyle : ParagraphStyle.m7497copyykzQM6k$default(paragraphStyle, 0, paragraphStyle2.m7515getTextDirections_7Xco(), 0L, null, null, null, 0, 0, null, 509, null);
    }
}
