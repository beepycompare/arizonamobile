...
public final class DeprecatedBridgeFontResourceLoader implements Font.ResourceLoader {
    ...
    public Object load(Font font) {
        return FontFamily.Resolver.m7541resolveDPcqOEQ$default(this.fontFamilyResolver, FontKt.toFontFamily(font), font.getWeight(), font.mo7522getStyle_LCdwA(), 0, 8, null).getValue();
    }
