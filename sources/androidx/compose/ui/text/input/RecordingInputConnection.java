...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m7602getCollapsedimpl(this.mTextFieldValue.m7858getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m7606getMinimpl(this.mTextFieldValue.m7858getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (z) {
            ...
            this.eventCallback.mo7808onImeActionKlQnJC8(m7789getDefaulteUduSuo);
            return true;
        }
        return z;
    }
