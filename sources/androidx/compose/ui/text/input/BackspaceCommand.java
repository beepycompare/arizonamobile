...
public final class BackspaceCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer editingBuffer) {
        if (editingBuffer.hasComposition$ui_text()) {
            ...
            editingBuffer.delete$ui_text(JvmCharHelpers_androidKt.findPrecedingBreak(editingBuffer.toString(), editingBuffer.getCursor$ui_text()), editingBuffer.getCursor$ui_text());
        }
    }
