...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    public TextInputServiceAndroid(View view, MatrixPositionCalculator matrixPositionCalculator, InputMethodManager inputMethodManager, Executor executor) {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public final void m7859invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m7859invokeKlQnJC8(imeAction.m7779unboximpl());
                return Unit.INSTANCE;
            }
        };
        this.state = new TextFieldValue("", TextRange.Companion.m7613getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public final InputConnection createInputConnection(EditorInfo editorInfo) {
        if (this.editorHasFocus) {
            ...
            RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
                ...
                public void mo7808onImeActionKlQnJC8(int i) {
                    Function1 function1;
                    function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                    function1.invoke(ImeAction.m7773boximpl(i));
                }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$stopInput$2
            /* renamed from: invoke-KlQnJC8  reason: not valid java name */
            public final void m7860invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m7860invokeKlQnJC8(imeAction.m7779unboximpl());
                return Unit.INSTANCE;
            }
        };
    ...
    public void updateState(TextFieldValue textFieldValue, TextFieldValue textFieldValue2) {
        boolean z = (TextRange.m7601equalsimpl0(this.state.m7858getSelectiond9O1mEE(), textFieldValue2.m7858getSelectiond9O1mEE()) && Intrinsics.areEqual(this.state.m7857getCompositionMzsxiRA(), textFieldValue2.m7857getCompositionMzsxiRA())) ? false : true;
        ...
        if (Intrinsics.areEqual(textFieldValue, textFieldValue2)) {
            if (z) {
                ...
                int m7606getMinimpl = TextRange.m7606getMinimpl(textFieldValue2.m7858getSelectiond9O1mEE());
                int m7605getMaximpl = TextRange.m7605getMaximpl(textFieldValue2.m7858getSelectiond9O1mEE());
                TextRange m7857getCompositionMzsxiRA = this.state.m7857getCompositionMzsxiRA();
                int m7606getMinimpl2 = m7857getCompositionMzsxiRA != null ? TextRange.m7606getMinimpl(m7857getCompositionMzsxiRA.m7612unboximpl()) : -1;
                TextRange m7857getCompositionMzsxiRA2 = this.state.m7857getCompositionMzsxiRA();
                inputMethodManager.updateSelection(m7606getMinimpl, m7605getMaximpl, m7606getMinimpl2, m7857getCompositionMzsxiRA2 != null ? TextRange.m7605getMaximpl(m7857getCompositionMzsxiRA2.m7612unboximpl()) : -1);
            }
        } else if (textFieldValue != null && (!Intrinsics.areEqual(textFieldValue.getText(), textFieldValue2.getText()) || (TextRange.m7601equalsimpl0(textFieldValue.m7858getSelectiond9O1mEE(), textFieldValue2.m7858getSelectiond9O1mEE()) && !Intrinsics.areEqual(textFieldValue.m7857getCompositionMzsxiRA(), textFieldValue2.m7857getCompositionMzsxiRA())))) {
            restartInputImmediately();
        } else {
