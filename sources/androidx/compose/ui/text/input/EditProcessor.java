...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m7613getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m7858getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue textFieldValue, TextInputSession textInputSession) {
        boolean areEqual = Intrinsics.areEqual(textFieldValue.m7857getCompositionMzsxiRA(), this.mBuffer.m7770getCompositionMzsxiRA$ui_text());
        boolean z = true;
        boolean z2 = false;
        if (!Intrinsics.areEqual(this.mBufferState.getAnnotatedString().getText(), textFieldValue.getAnnotatedString().getText())) {
            this.mBuffer = new EditingBuffer(textFieldValue.getAnnotatedString(), textFieldValue.m7858getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
        } else if (TextRange.m7601equalsimpl0(this.mBufferState.m7858getSelectiond9O1mEE(), textFieldValue.m7858getSelectiond9O1mEE())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text(TextRange.m7606getMinimpl(textFieldValue.m7858getSelectiond9O1mEE()), TextRange.m7605getMaximpl(textFieldValue.m7858getSelectiond9O1mEE()));
            z2 = true;
            z = false;
        }
        if (textFieldValue.m7857getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text();
        } else if (!TextRange.m7602getCollapsedimpl(textFieldValue.m7857getCompositionMzsxiRA().m7612unboximpl())) {
            this.mBuffer.setComposition$ui_text(TextRange.m7606getMinimpl(textFieldValue.m7857getCompositionMzsxiRA().m7612unboximpl()), TextRange.m7605getMaximpl(textFieldValue.m7857getCompositionMzsxiRA().m7612unboximpl()));
        }
        if (z || (!z2 && !areEqual)) {
            this.mBuffer.commitComposition$ui_text();
            textFieldValue = TextFieldValue.m7853copy3r_uNRQ$default(textFieldValue, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> list, final EditCommand editCommand) {
        ...
        sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text() + ", composition=" + this.mBuffer.m7770getCompositionMzsxiRA$ui_text() + ", selection=" + ((Object) TextRange.m7611toStringimpl(this.mBuffer.m7771getSelectiond9O1mEE$ui_text())) + "):").append('\n');
    ...
    public final TextFieldValue apply(List<? extends EditCommand> list) {
        ...
        try {
            ...
            long m7771getSelectiond9O1mEE$ui_text = this.mBuffer.m7771getSelectiond9O1mEE$ui_text();
            TextRange m7596boximpl = TextRange.m7596boximpl(m7771getSelectiond9O1mEE$ui_text);
            m7596boximpl.m7612unboximpl();
            TextRange textRange = TextRange.m7607getReversedimpl(this.mBufferState.m7858getSelectiond9O1mEE()) ? null : m7596boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text, textRange != null ? textRange.m7612unboximpl() : TextRangeKt.TextRange(TextRange.m7605getMaximpl(m7771getSelectiond9O1mEE$ui_text), TextRange.m7606getMinimpl(m7771getSelectiond9O1mEE$ui_text)), this.mBuffer.m7770getCompositionMzsxiRA$ui_text(), (DefaultConstructorMarker) null);
            this.mBufferState = textFieldValue;
