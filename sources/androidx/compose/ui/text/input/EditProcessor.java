...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.Companion.m6718getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    private EditingBuffer mBuffer = new EditingBuffer(this.mBufferState.getAnnotatedString(), this.mBufferState.m6964getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue textFieldValue, TextInputSession textInputSession) {
        boolean areEqual = Intrinsics.areEqual(textFieldValue.m6963getCompositionMzsxiRA(), this.mBuffer.m6876getCompositionMzsxiRA$ui_text());
        boolean z = true;
        boolean z2 = false;
        if (!Intrinsics.areEqual(this.mBufferState.getAnnotatedString().getText(), textFieldValue.getAnnotatedString().getText())) {
            this.mBuffer = new EditingBuffer(textFieldValue.getAnnotatedString(), textFieldValue.m6964getSelectiond9O1mEE(), (DefaultConstructorMarker) null);
        } else if (TextRange.m6706equalsimpl0(this.mBufferState.m6964getSelectiond9O1mEE(), textFieldValue.m6964getSelectiond9O1mEE())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text(TextRange.m6711getMinimpl(textFieldValue.m6964getSelectiond9O1mEE()), TextRange.m6710getMaximpl(textFieldValue.m6964getSelectiond9O1mEE()));
            z2 = true;
            z = false;
        }
        if (textFieldValue.m6963getCompositionMzsxiRA() == null) {
            this.mBuffer.commitComposition$ui_text();
        } else if (!TextRange.m6707getCollapsedimpl(textFieldValue.m6963getCompositionMzsxiRA().m6717unboximpl())) {
            this.mBuffer.setComposition$ui_text(TextRange.m6711getMinimpl(textFieldValue.m6963getCompositionMzsxiRA().m6717unboximpl()), TextRange.m6710getMaximpl(textFieldValue.m6963getCompositionMzsxiRA().m6717unboximpl()));
        }
        if (z || (!z2 && !areEqual)) {
            this.mBuffer.commitComposition$ui_text();
            textFieldValue = TextFieldValue.m6959copy3r_uNRQ$default(textFieldValue, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> list, final EditCommand editCommand) {
        ...
        StringBuilder append = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text() + ", composition=" + this.mBuffer.m6876getCompositionMzsxiRA$ui_text() + ", selection=" + ((Object) TextRange.m6716toStringimpl(this.mBuffer.m6877getSelectiond9O1mEE$ui_text())) + "):");
    ...
    public final TextFieldValue apply(List<? extends EditCommand> list) {
        ...
        try {
            ...
            long m6877getSelectiond9O1mEE$ui_text = this.mBuffer.m6877getSelectiond9O1mEE$ui_text();
            TextRange m6701boximpl = TextRange.m6701boximpl(m6877getSelectiond9O1mEE$ui_text);
            m6701boximpl.m6717unboximpl();
            TextRange textRange = TextRange.m6712getReversedimpl(this.mBufferState.m6964getSelectiond9O1mEE()) ? null : m6701boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text, textRange != null ? textRange.m6717unboximpl() : TextRangeKt.TextRange(TextRange.m6710getMaximpl(m6877getSelectiond9O1mEE$ui_text), TextRange.m6711getMinimpl(m6877getSelectiond9O1mEE$ui_text)), this.mBuffer.m6876getCompositionMzsxiRA$ui_text(), (DefaultConstructorMarker) null);
            this.mBufferState = textFieldValue;
