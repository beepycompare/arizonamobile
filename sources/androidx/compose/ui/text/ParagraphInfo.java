...
public final class ParagraphInfo {
    ...
    public final Rect toGlobal(Rect rect) {
        return rect.m3874translatek4lQ0M(Offset.m3829constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(this.top) & 4294967295L)));
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo3973translatek4lQ0M(Offset.m3829constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(this.top) & 4294967295L)));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default  reason: not valid java name */
    public static /* synthetic */ long m6011toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6012toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0  reason: not valid java name */
    public final long m6012toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m6140equalsimpl0(j, TextRange.Companion.m6152getZerod9O1mEE())) {
            return TextRange.Companion.m6152getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6147getStartimpl(j)), toGlobalIndex(TextRange.m6142getEndimpl(j)));
    }

    /* renamed from: toLocal-MK-Hz9U  reason: not valid java name */
    public final long m6013toLocalMKHz9U(long j) {
        float intBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        return Offset.m3829constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L)) - this.top) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
    }
}
