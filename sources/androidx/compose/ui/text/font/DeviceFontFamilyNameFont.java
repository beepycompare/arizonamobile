...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String str, FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m6252getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, settings, null);
        this.familyName = str;
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        return PlatformTypefaces_androidKt.PlatformTypefaces().mo6288optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), mo6212getStyle_LCdwA(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeviceFontFamilyNameFont) {
            ...
            return DeviceFontFamilyName.m6225equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m6259equalsimpl0(mo6212getStyle_LCdwA(), deviceFontFamilyNameFont.mo6212getStyle_LCdwA()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
        }
        return false;
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m6226hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m6260hashCodeimpl(mo6212getStyle_LCdwA())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m6227toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m6261toStringimpl(mo6212getStyle_LCdwA())) + ')';
    }
}
