                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            ...
                            try {
                                ...
                                m8500constructorimpl = Result.m8500constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.Companion;
                                m8500constructorimpl = Result.m8500constructorimpl(ResultKt.createFailure(th));
                            }
                            Object obj3 = Result.m8506isFailureimpl(m8500constructorimpl) ? null : m8500constructorimpl;
