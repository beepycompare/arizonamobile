...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m7672getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m7720equalsimpl0(i, FontStyle.Companion.m7726getItalic_LCdwA()));
    }
}
