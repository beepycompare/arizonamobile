...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6211getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m6259equalsimpl0(i, FontStyle.Companion.m6265getItalic_LCdwA()));
    }
}
