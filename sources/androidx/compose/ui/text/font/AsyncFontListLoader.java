                    ...
                    if (i != 0) {
                        ...
                        if (i2 < size) {
                            try {
                                ...
                                if (FontLoadingStrategy.m7802equalsimpl0(font3.mo7759getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m7806getAsyncPKNRLFQ())) {
                                    ...
                                    if (runCached != coroutine_suspended) {
                                        ...
                                        if (obj == null) {
                                            setValue(FontSynthesis_androidKt.m7837synthesizeTypefaceFxwP2eA(this.typefaceRequest.m7863getFontSynthesisGVVA2EU(), obj, font, this.typefaceRequest.getFontWeight(), this.typefaceRequest.m7862getFontStyle_LCdwA()));
