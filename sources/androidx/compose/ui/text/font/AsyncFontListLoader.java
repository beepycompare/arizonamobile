                    ...
                    if (i != 0) {
                        ...
                        if (i2 < size) {
                            try {
                                ...
                                if (FontLoadingStrategy.m7707equalsimpl0(font3.mo7665getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m7711getAsyncPKNRLFQ())) {
                                    ...
                                    if (runCached != coroutine_suspended) {
                                        ...
                                        if (obj == null) {
                                            setValue(FontSynthesis_androidKt.m7742synthesizeTypefaceFxwP2eA(this.typefaceRequest.m7767getFontSynthesisGVVA2EU(), obj, font, this.typefaceRequest.getFontWeight(), this.typefaceRequest.m7766getFontStyle_LCdwA()));
