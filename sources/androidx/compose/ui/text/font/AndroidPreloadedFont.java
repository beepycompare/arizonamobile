...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int mo6778getStyle_LCdwA() {
        return this.style;
    }

    private AndroidPreloadedFont(FontWeight fontWeight, int i, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m6818getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, null);
