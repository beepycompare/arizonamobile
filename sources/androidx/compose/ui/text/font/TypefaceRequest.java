...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m7858copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i4 = i;
        return typefaceRequest.m7861copye1PVR60(fontFamily, fontWeight, i4, i2, obj3);
    }
    ...
    public final int m7859component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m7860component4GVVA2EU() {
    ...
    public final TypefaceRequest m7861copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj) {
    ...
    public int hashCode() {
        ...
        int hashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m7816hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m7827hashCodeimpl(this.fontSynthesis)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return hashCode + (obj != null ? obj.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m7817toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m7830toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m7862getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m7863getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
