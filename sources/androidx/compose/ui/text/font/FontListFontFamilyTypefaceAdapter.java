...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        if (fontFamily instanceof FontListFontFamily) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (FontLoadingStrategy.m7707equalsimpl0(font.mo7665getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m7711getAsyncPKNRLFQ())) {
                    arrayList.add(TuplesKt.to(font.getWeight(), FontStyle.m7717boximpl(font.mo7673getStyle_LCdwA())));
                }
            }
            ...
            for (int i3 = 0; i3 < size3; i3++) {
                ...
                int m7723unboximpl = ((FontStyle) pair.component2()).m7723unboximpl();
                List list = (List) FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m7716matchFontRetOiIg(fonts, fontWeight, m7723unboximpl), new TypefaceRequest(fontFamily, fontWeight, m7723unboximpl, FontSynthesis.Companion.m7737getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$$ExternalSyntheticLambda0
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        if (typefaceRequest.getFontFamily() instanceof FontListFontFamily) {
            Pair access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.access$firstImmediatelyAvailable(fontMatcher.m7716matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m7766getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, function12);
