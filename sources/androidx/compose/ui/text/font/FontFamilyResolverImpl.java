...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public static final Object createDefaultTypeface$lambda$0(FontFamilyResolverImpl fontFamilyResolverImpl, TypefaceRequest typefaceRequest) {
        return fontFamilyResolverImpl.resolve(TypefaceRequest.m6868copye1PVR60$default(typefaceRequest, null, null, 0, 0, null, 30, null)).getValue();
    }
    ...
    */
        ...
        if (continuation instanceof FontFamilyResolverImpl$preload$1) {
            ...
            if ((fontFamilyResolverImpl$preload$1.label & Integer.MIN_VALUE) != 0) {
                ...
                for (i2 = 0; i2 < size; i2++) {
                    ...
                    arrayList.add(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(font.getWeight()), this.platformResolveInterceptor.m6852interceptFontStyleT2F_aPo(font.mo6778getStyle_LCdwA()), FontSynthesis.Companion.m6843getAllGVVA2EU(), this.platformFontLoader.getCacheKey(), null));
                }
    ...
    public State<Object> mo6798resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m6852interceptFontStyleT2F_aPo(i), this.platformResolveInterceptor.m6853interceptFontSynthesisMscr08Y(i2), this.platformFontLoader.getCacheKey(), null));
    }
