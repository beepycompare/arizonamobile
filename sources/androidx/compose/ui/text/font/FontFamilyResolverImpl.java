...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFontFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$$ExternalSyntheticLambda2
            ...
            public final Object invoke(Object obj) {
                Object value;
                value = FontFamilyResolverImpl.this.resolve(TypefaceRequest.m7762copye1PVR60$default((TypefaceRequest) obj, null, null, 0, 0, null, 30, null)).getValue();
                return value;
            }
        };
    }
    ...
    */
        ...
        if (continuation instanceof FontFamilyResolverImpl$preload$1) {
            ...
            if ((fontFamilyResolverImpl$preload$1.label & Integer.MIN_VALUE) != 0) {
                ...
                for (i2 = 0; i2 < size; i2++) {
                    ...
                    arrayList.add(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(font.getWeight()), this.platformResolveInterceptor.m7746interceptFontStyleT2F_aPo(font.mo7673getStyle_LCdwA()), FontSynthesis.Companion.m7737getAllGVVA2EU(), this.platformFontLoader.getCacheKey(), null));
                }
    ...
    public State<Object> mo7693resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m7746interceptFontStyleT2F_aPo(i), this.platformResolveInterceptor.m7747interceptFontSynthesisMscr08Y(i2), this.platformFontLoader.getCacheKey(), null));
    }
