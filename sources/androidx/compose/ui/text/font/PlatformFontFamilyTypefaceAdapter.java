...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        android.graphics.Typeface mo7143createDefaultFO1MlWM;
        FontFamily fontFamily = typefaceRequest.getFontFamily();
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            mo7143createDefaultFO1MlWM = this.platformTypefaceResolver.mo7143createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m7161getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            mo7143createDefaultFO1MlWM = this.platformTypefaceResolver.mo7144createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m7161getFontStyle_LCdwA());
            ...
            mo7143createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo7256getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m7161getFontStyle_LCdwA(), typefaceRequest.m7162getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(mo7143createDefaultFO1MlWM, false, 2, null);
    }
}
