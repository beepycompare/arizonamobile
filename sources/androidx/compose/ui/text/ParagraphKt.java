...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String str, TextStyle textStyle, float f, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z) {
        ...
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7264ActualParagraphXGqx6AY(str, textStyle, list, list2, i, z ? companion.m7491getEllipsisgIe3tQ8() : companion.m7490getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, null), density, resolver);
    }
    ...
    public static final /* synthetic */ Paragraph m6880ParagraphUdtVg6A(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, List list2, int i, boolean z) {
        TextOverflow.Companion companion = TextOverflow.Companion;
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7264ActualParagraphXGqx6AY(str, textStyle, list, list2, i, z ? companion.m7491getEllipsisgIe3tQ8() : companion.m7490getClipgIe3tQ8(), j, density, resolver);
    }

    /* renamed from: Paragraph-Ul8oQg4  reason: not valid java name */
    public static final Paragraph m6882ParagraphUl8oQg4(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, int i2) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7264ActualParagraphXGqx6AY(str, textStyle, list, list2, i, i2, j, density, resolver);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, float f) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7263ActualParagraph4FmOz70(paragraphIntrinsics, i, z ? TextOverflow.Companion.m7491getEllipsisgIe3tQ8() : TextOverflow.Companion.m7490getClipgIe3tQ8(), ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, null));
    }

    /* renamed from: Paragraph-_EkL_-Y$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m6885Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m6884Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }
    ...
    public static final /* synthetic */ Paragraph m6884Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7263ActualParagraph4FmOz70(paragraphIntrinsics, i, z ? TextOverflow.Companion.m7491getEllipsisgIe3tQ8() : TextOverflow.Companion.m7490getClipgIe3tQ8(), j);
    }

    /* renamed from: Paragraph-czeN-Hc$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m6887ParagraphczeNHc$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i3 & 8) != 0) {
            i2 = TextOverflow.Companion.m7490getClipgIe3tQ8();
        }
        return m6886ParagraphczeNHc(paragraphIntrinsics, j, i, i2);
    }

    /* renamed from: Paragraph-czeN-Hc  reason: not valid java name */
    public static final Paragraph m6886ParagraphczeNHc(ParagraphIntrinsics paragraphIntrinsics, long j, int i, int i2) {
        return androidx.compose.ui.text.platform.AndroidParagraph_androidKt.m7263ActualParagraph4FmOz70(paragraphIntrinsics, i, i2, j);
    }
