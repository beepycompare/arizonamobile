...
public final class TextPainterKt {
    ...
    public static final void m7437drawTextJFhB2K4(DrawScope drawScope, TextMeasurer textMeasurer, AnnotatedString annotatedString, long j, TextStyle textStyle, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> list, long j2, int i3) {
        TextLayoutResult m7432measurexDpz5zY$default = TextMeasurer.m7432measurexDpz5zY$default(textMeasurer, annotatedString, textStyle, i, z, i2, list, m7445textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1536, null);
        ...
        try {
            ...
            clip(transform, m7432measurexDpz5zY$default);
            m7432measurexDpz5zY$default.getMultiParagraph().m7302paintLG529CI(drawScope.getDrawContext().getCanvas(), (r14 & 2) != 0 ? Color.Companion.m5316getUnspecified0d7_KjU() : 0L, (r14 & 4) != 0 ? null : null, (r14 & 8) != 0 ? null : null, (r14 & 16) == 0 ? null : null, (r14 & 32) != 0 ? DrawScope.Companion.m5861getDefaultBlendMode0nO6VwU() : i3);
        } finally {
    ...
    public static final void m7441drawTextTPWCCtM(DrawScope drawScope, TextMeasurer textMeasurer, String str, long j, TextStyle textStyle, int i, boolean z, int i2, long j2, int i3) {
        TextLayoutResult m7432measurexDpz5zY$default = TextMeasurer.m7432measurexDpz5zY$default(textMeasurer, new AnnotatedString(str, null, 2, null), textStyle, i, z, i2, null, m7445textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1568, null);
        DrawContext drawContext = drawScope.getDrawContext();
        long mo5780getSizeNHjbRc = drawContext.mo5780getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m7443drawTextd8rzKo(DrawScope drawScope, TextLayoutResult textLayoutResult, long j, long j2, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        float alpha;
        int i2;
        Shadow shadow2;
        ...
        try {
            ...
            if (brush != null && j == 16) {
                ...
                multiParagraph.m7304painthn5TExg(canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, i2);
            } else {
                MultiParagraph multiParagraph3 = textLayoutResult.getMultiParagraph();
                Canvas canvas3 = drawScope.getDrawContext().getCanvas();
                if (j == 16) {
                    j = textLayoutResult.getLayoutInput().getStyle().m7488getColor0d7_KjU();
                }
                multiParagraph3.m7302paintLG529CI(canvas3, TextDrawStyleKt.m7900modulateDxMtmZc(j, f), shadow3, textDecoration3, drawStyle3, i);
            }
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5781setSizeuvyYCjk(mo5780getSizeNHjbRc);
    ...
    public static final void m7439drawTextLVfH_YU(DrawScope drawScope, TextLayoutResult textLayoutResult, Brush brush, long j, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        ...
        try {
            ...
            clip(transform, textLayoutResult);
            textLayoutResult.getMultiParagraph().m7304painthn5TExg(drawScope.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5781setSizeuvyYCjk(mo5780getSizeNHjbRc);
        }
    ...
    private static final void clip(DrawTransform drawTransform, TextLayoutResult textLayoutResult) {
        if (!textLayoutResult.getHasVisualOverflow() || TextOverflow.m7922equalsimpl0(textLayoutResult.getLayoutInput().m7425getOverflowgIe3tQ8(), TextOverflow.Companion.m7935getVisiblegIe3tQ8())) {
            return;
        }
        DrawTransform.m5916clipRectN_I0leg$default(drawTransform, 0.0f, 0.0f, (int) (textLayoutResult.m7429getSizeYbymL2g() >> 32), (int) (textLayoutResult.m7429getSizeYbymL2g() & 4294967295L), 0, 16, null);
    }

    /* renamed from: textLayoutConstraints-v_w8tDc  reason: not valid java name */
    private static final long m7445textLayoutConstraintsv_w8tDc(DrawScope drawScope, long j, long j2) {
        int round;
        int i;
        int round2;
        ...
        if (i2 == 0 || Float.isNaN(Float.intBitsToFloat((int) (j >> 32)))) {
            round = Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() >> 32)) - Float.intBitsToFloat((int) (j2 >> 32))));
            i = 0;
        } else {
        ...
        if (i2 == 0 || Float.isNaN(Float.intBitsToFloat((int) (j & 4294967295L)))) {
            round2 = Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo5859getSizeNHjbRc() & 4294967295L)) - Float.intBitsToFloat((int) (j2 & 4294967295L))));
        } else {
