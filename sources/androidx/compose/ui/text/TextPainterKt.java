...
public final class TextPainterKt {
    ...
    public static final void m7680drawTextJFhB2K4(DrawScope drawScope, TextMeasurer textMeasurer, AnnotatedString annotatedString, long j, TextStyle textStyle, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> list, long j2, int i3) {
        TextLayoutResult m7675measurexDpz5zY$default = TextMeasurer.m7675measurexDpz5zY$default(textMeasurer, annotatedString, textStyle, i, z, i2, list, m7688textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1536, null);
        ...
        try {
            ...
            clip(transform, m7675measurexDpz5zY$default);
            m7675measurexDpz5zY$default.getMultiParagraph().m7538paintLG529CI(drawScope.getDrawContext().getCanvas(), (r14 & 2) != 0 ? Color.Companion.m5460getUnspecified0d7_KjU() : 0L, (r14 & 4) != 0 ? null : null, (r14 & 8) != 0 ? null : null, (r14 & 16) == 0 ? null : null, (r14 & 32) != 0 ? DrawScope.Companion.m6007getDefaultBlendMode0nO6VwU() : i3);
        } finally {
    ...
    public static final void m7684drawTextTPWCCtM(DrawScope drawScope, TextMeasurer textMeasurer, String str, long j, TextStyle textStyle, int i, boolean z, int i2, long j2, int i3) {
        TextLayoutResult m7675measurexDpz5zY$default = TextMeasurer.m7675measurexDpz5zY$default(textMeasurer, new AnnotatedString(str, null, 2, null), textStyle, i, z, i2, null, m7688textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1568, null);
        DrawContext drawContext = drawScope.getDrawContext();
        long mo5926getSizeNHjbRc = drawContext.mo5926getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m7686drawTextd8rzKo(DrawScope drawScope, TextLayoutResult textLayoutResult, long j, long j2, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        float alpha;
        int i2;
        Shadow shadow2;
        ...
        try {
            ...
            if (brush != null && j == 16) {
                ...
                multiParagraph.m7540painthn5TExg(canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, i2);
            } else {
                MultiParagraph multiParagraph3 = textLayoutResult.getMultiParagraph();
                Canvas canvas3 = drawScope.getDrawContext().getCanvas();
                if (j == 16) {
                    j = textLayoutResult.getLayoutInput().getStyle().m7731getColor0d7_KjU();
                }
                multiParagraph3.m7538paintLG529CI(canvas3, TextDrawStyleKt.m8162modulateDxMtmZc(j, f), shadow3, textDecoration3, drawStyle3, i);
            }
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5927setSizeuvyYCjk(mo5926getSizeNHjbRc);
    ...
    public static final void m7682drawTextLVfH_YU(DrawScope drawScope, TextLayoutResult textLayoutResult, Brush brush, long j, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        ...
        try {
            ...
            clip(transform, textLayoutResult);
            textLayoutResult.getMultiParagraph().m7540painthn5TExg(drawScope.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo5927setSizeuvyYCjk(mo5926getSizeNHjbRc);
        }
    ...
    private static final void clip(DrawTransform drawTransform, TextLayoutResult textLayoutResult) {
        if (!textLayoutResult.getHasVisualOverflow() || TextOverflow.m8184equalsimpl0(textLayoutResult.getLayoutInput().m7668getOverflowgIe3tQ8(), TextOverflow.Companion.m8197getVisiblegIe3tQ8())) {
            return;
        }
        DrawTransform.m6062clipRectN_I0leg$default(drawTransform, 0.0f, 0.0f, (int) (textLayoutResult.m7672getSizeYbymL2g() >> 32), (int) (textLayoutResult.m7672getSizeYbymL2g() & 4294967295L), 0, 16, null);
    }

    /* renamed from: textLayoutConstraints-v_w8tDc  reason: not valid java name */
    private static final long m7688textLayoutConstraintsv_w8tDc(DrawScope drawScope, long j, long j2) {
        int coerceAtLeast;
        int i;
        int coerceAtLeast2;
        ...
        if (i2 == 0 || Float.isNaN(Float.intBitsToFloat((int) (j >> 32)))) {
            coerceAtLeast = RangesKt.coerceAtLeast(Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo6005getSizeNHjbRc() >> 32)) - Float.intBitsToFloat((int) (j2 >> 32)))), 0);
            i = 0;
        } else {
        ...
        if (i2 == 0 || Float.isNaN(Float.intBitsToFloat((int) (j & 4294967295L)))) {
            coerceAtLeast2 = RangesKt.coerceAtLeast(Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo6005getSizeNHjbRc() & 4294967295L)) - Float.intBitsToFloat((int) (j2 & 4294967295L)))), 0);
        } else {
            i3 = Math.round((float) Math.ceil(Float.intBitsToFloat((int) (j & 4294967295L))));
            coerceAtLeast2 = i3;
        }
        return ConstraintsKt.Constraints(i, coerceAtLeast, i3, coerceAtLeast2);
    }
}
