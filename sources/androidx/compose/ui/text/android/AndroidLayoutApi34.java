...
public final class AndroidLayoutApi34 {
    ...
    public final int[] getRangeForRect$ui_text(TextLayout textLayout, RectF rectF, int i, final Function2<? super RectF, ? super RectF, Boolean> function2) {
        SegmentFinder segmentFinder;
        if (i == 1) {
            segmentFinder = Api34SegmentFinder.INSTANCE.toAndroidSegmentFinder$ui_text(new WordSegmentFinder(textLayout.getText(), textLayout.getWordIterator()));
        } else {
