    ...
    public TextLayout(CharSequence charSequence, float f, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f2, float f3, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            if (lineHeightSpans == null || (lineHeightStyleSpan2 = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightSpans)) == null) {
                ...
                z4 = (lineHeightStyleSpan2.getTrimFirstLineTop() && LineHeightStyle.Mode.m8011equalsimpl0(lineHeightStyleSpan2.m7664getModelzQqcRY(), LineHeightStyle.Mode.Companion.m8017getTightlzQqcRY())) ? z3 : i10;
            }
            boolean z7 = (lineHeightSpans == null || (lineHeightStyleSpan = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightSpans)) == null || !lineHeightStyleSpan.getTrimLastLineBottom() || !LineHeightStyle.Mode.m8011equalsimpl0(lineHeightStyleSpan.m7664getModelzQqcRY(), LineHeightStyle.Mode.Companion.m8017getTightlzQqcRY())) ? i10 : z3;
            if (!z4 || !z7) {
                verticalPaddings = TextLayout_androidKt.getVerticalPaddings(this);
                VerticalPaddings = TextLayout_androidKt.VerticalPaddings(z4 ? i10 : VerticalPaddings.m7660getTopPaddingimpl(verticalPaddings), z7 ? i10 : VerticalPaddings.m7659getBottomPaddingimpl(verticalPaddings));
            } else {
            ...
            this.topPadding = Math.max(VerticalPaddings.m7660getTopPaddingimpl(VerticalPaddings), VerticalPaddings.m7660getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m7659getBottomPaddingimpl(VerticalPaddings), VerticalPaddings.m7659getBottomPaddingimpl(lineHeightPaddings));
    ...
    */
    ...
    public final int[] getRangeForRect(RectF rectF, int i, Function2<? super RectF, ? super RectF, Boolean> function2) {
        if (Build.VERSION.SDK_INT >= 34) {
            return AndroidLayoutApi34.INSTANCE.getRangeForRect$ui_text(this, rectF, i, function2);
        }
