...
public final class ParagraphStyle implements AnnotatedString.Annotation {
    ...
    public static /* synthetic */ void m6597getHyphensEaSxIns$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* renamed from: getLineBreak-LgCVezo$annotations  reason: not valid java name */
    public static /* synthetic */ void m6598getLineBreakLgCVezo$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* renamed from: getTextAlign-buA522U$annotations  reason: not valid java name */
    public static /* synthetic */ void m6599getTextAlignbuA522U$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* renamed from: getTextDirection-mmuk1to$annotations  reason: not valid java name */
    public static /* synthetic */ void m6600getTextDirectionmmuk1to$annotations() {
    }
    ...
    private ParagraphStyle(int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion) {
        ...
        if (TextUnit.m7458getValueimpl(j) >= 0.0f) {
            return;
        }
        InlineClassHelperKt.throwIllegalStateException("lineHeight can't be negative (" + TextUnit.m7458getValueimpl(j) + ')');
    }
    ...
    public /* synthetic */ ParagraphStyle(int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this((i5 & 1) != 0 ? TextAlign.Companion.m7154getUnspecifiede0LSkKk() : i, (i5 & 2) != 0 ? TextDirection.Companion.m7167getUnspecifieds_7Xco() : i2, (i5 & 4) != 0 ? TextUnit.Companion.m7469getUnspecifiedXSAIIZE() : j, (i5 & 8) != 0 ? null : textIndent, (i5 & 16) != 0 ? null : platformParagraphStyle, (i5 & 32) != 0 ? null : lineHeightStyle, (i5 & 64) != 0 ? LineBreak.Companion.m7069getUnspecifiedrAG3T2k() : i3, (i5 & 128) != 0 ? Hyphens.Companion.m7048getUnspecifiedvmbZdU8() : i4, (i5 & 256) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }

    /* renamed from: getTextAlign-e0LSkKk  reason: not valid java name */
    public final int m6612getTextAligne0LSkKk() {
        return this.textAlign;
    }

    /* renamed from: getTextDirection-s_7X-co  reason: not valid java name */
    public final int m6614getTextDirections_7Xco() {
        return this.textDirection;
    }

    /* renamed from: getLineHeight-XSAIIZE  reason: not valid java name */
    public final long m6610getLineHeightXSAIIZE() {
    ...
    public final int m6609getLineBreakrAG3T2k() {
        return this.lineBreak;
    }

    /* renamed from: getHyphens-vmbZdU8  reason: not valid java name */
    public final int m6607getHyphensvmbZdU8() {
        return this.hyphens;
    }
    ...
    public final TextAlign m6611getTextAlignbuA522U() {
        return TextAlign.m7141boximpl(this.textAlign);
    }

    /* renamed from: getTextDirection-mmuk1to  reason: not valid java name */
    public final TextDirection m6613getTextDirectionmmuk1to() {
        return TextDirection.m7155boximpl(this.textDirection);
    }

    /* renamed from: getHyphens-EaSxIns  reason: not valid java name */
    public final Hyphens m6606getHyphensEaSxIns() {
        return Hyphens.m7039boximpl(this.hyphens);
    }

    /* renamed from: getLineBreak-LgCVezo  reason: not valid java name */
    public final LineBreak m6608getLineBreakLgCVezo() {
        return LineBreak.m7049boximpl(this.lineBreak);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m7469getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) != 0 ? null : hyphens, (i & 256) == 0 ? textMotion : null, (DefaultConstructorMarker) null);
    }
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        this(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak != null ? lineBreak.m7061unboximpl() : LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7045unboximpl() : Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), textMotion, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m7469getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, null);
    }

    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent) {
        this(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, (PlatformParagraphStyle) null, (LineHeightStyle) null, LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m7469getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, null);
    }
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle) {
        this(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : textAlign, (i & 2) != 0 ? null : textDirection, (i & 4) != 0 ? TextUnit.Companion.m7469getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : textIndent, (i & 16) != 0 ? null : platformParagraphStyle, (i & 32) != 0 ? null : lineHeightStyle, (i & 64) != 0 ? null : lineBreak, (i & 128) == 0 ? hyphens : null, (DefaultConstructorMarker) null);
    }
    ...
    private ParagraphStyle(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        this(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak != null ? lineBreak.m7061unboximpl() : LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7045unboximpl() : Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ ParagraphStyle m6592copyElsmlbk$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7141boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
            textDirection = TextDirection.m7155boximpl(paragraphStyle.textDirection);
        }
        if ((i & 4) != 0) {
        ...
        return paragraphStyle.m6601copyElsmlbk(textAlign, textDirection, j, textIndent2);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6601copyElsmlbk(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, this.platformStyle, this.lineHeightStyle, this.lineBreak, this.hyphens, this.textMotion, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-xPh5V4g$default  reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6595copyxPh5V4g$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7141boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
        ...
        TextIndent textIndent2 = textIndent;
        long j2 = j;
        return paragraphStyle.m6604copyxPh5V4g(textAlign, textDirection, j2, textIndent2, platformParagraphStyle, lineHeightStyle2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "ParagraphStyle copy constructors that do not take new stable parameters like LineHeightStyle, LineBreak, Hyphens are deprecated. Please use the new stable copy constructor.")
    /* renamed from: copy-xPh5V4g  reason: not valid java name */
    public final /* synthetic */ ParagraphStyle m6604copyxPh5V4g(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, this.lineBreak, this.hyphens, this.textMotion, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-ciSxzs0$default  reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6594copyciSxzs0$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7141boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 64) != 0) {
            lineBreak = LineBreak.m7049boximpl(paragraphStyle.lineBreak);
        }
        if ((i & 128) != 0) {
            hyphens = Hyphens.m7039boximpl(paragraphStyle.hyphens);
        }
        Hyphens hyphens2 = hyphens;
        LineHeightStyle lineHeightStyle2 = lineHeightStyle;
        TextIndent textIndent2 = textIndent;
        long j2 = j;
        return paragraphStyle.m6603copyciSxzs0(textAlign, textDirection, j2, textIndent2, platformParagraphStyle, lineHeightStyle2, lineBreak, hyphens2);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6603copyciSxzs0(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak != null ? lineBreak.m7061unboximpl() : LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7045unboximpl() : Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), this.textMotion, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-NH1kkwU$default  reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6593copyNH1kkwU$default(ParagraphStyle paragraphStyle, TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, Object obj) {
        if ((i & 1) != 0) {
            textAlign = TextAlign.m7141boximpl(paragraphStyle.textAlign);
        }
        if ((i & 2) != 0) {
        ...
        long j2 = j;
        return paragraphStyle.m6602copyNH1kkwU(textAlign, textDirection, j2, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak, hyphens2, textMotion2);
    }
    ...
    public final /* synthetic */ ParagraphStyle m6602copyNH1kkwU(TextAlign textAlign, TextDirection textDirection, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        return new ParagraphStyle(textAlign != null ? textAlign.m7147unboximpl() : TextAlign.Companion.m7154getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m7161unboximpl() : TextDirection.Companion.m7167getUnspecifieds_7Xco(), j, textIndent, platformParagraphStyle, lineHeightStyle, lineBreak != null ? lineBreak.m7061unboximpl() : LineBreak.Companion.m7069getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m7045unboximpl() : Hyphens.Companion.m7048getUnspecifiedvmbZdU8(), textMotion, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-ykzQM6k$default  reason: not valid java name */
    public static /* synthetic */ ParagraphStyle m6596copyykzQM6k$default(ParagraphStyle paragraphStyle, int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        TextMotion textMotion2 = textMotion;
        long j2 = j;
        return paragraphStyle.m6605copyykzQM6k(i, i2, j2, textIndent, platformParagraphStyle, lineHeightStyle, i3, i6, textMotion2);
    }

    /* renamed from: copy-ykzQM6k  reason: not valid java name */
    public final ParagraphStyle m6605copyykzQM6k(int i, int i2, long j, TextIndent textIndent, PlatformParagraphStyle platformParagraphStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ParagraphStyle) {
            ...
            return TextAlign.m7144equalsimpl0(this.textAlign, paragraphStyle.textAlign) && TextDirection.m7158equalsimpl0(this.textDirection, paragraphStyle.textDirection) && TextUnit.m7455equalsimpl0(this.lineHeight, paragraphStyle.lineHeight) && Intrinsics.areEqual(this.textIndent, paragraphStyle.textIndent) && Intrinsics.areEqual(this.platformStyle, paragraphStyle.platformStyle) && Intrinsics.areEqual(this.lineHeightStyle, paragraphStyle.lineHeightStyle) && LineBreak.m7055equalsimpl0(this.lineBreak, paragraphStyle.lineBreak) && Hyphens.m7042equalsimpl0(this.hyphens, paragraphStyle.hyphens) && Intrinsics.areEqual(this.textMotion, paragraphStyle.textMotion);
        }
        return false;
    }

    public int hashCode() {
        int m7145hashCodeimpl = ((((TextAlign.m7145hashCodeimpl(this.textAlign) * 31) + TextDirection.m7159hashCodeimpl(this.textDirection)) * 31) + TextUnit.m7459hashCodeimpl(this.lineHeight)) * 31;
        TextIndent textIndent = this.textIndent;
        int hashCode = (m7145hashCodeimpl + (textIndent != null ? textIndent.hashCode() : 0)) * 31;
        PlatformParagraphStyle platformParagraphStyle = this.platformStyle;
        int hashCode2 = (hashCode + (platformParagraphStyle != null ? platformParagraphStyle.hashCode() : 0)) * 31;
        LineHeightStyle lineHeightStyle = this.lineHeightStyle;
        int hashCode3 = (((((hashCode2 + (lineHeightStyle != null ? lineHeightStyle.hashCode() : 0)) * 31) + LineBreak.m7059hashCodeimpl(this.lineBreak)) * 31) + Hyphens.m7043hashCodeimpl(this.hyphens)) * 31;
        TextMotion textMotion = this.textMotion;
        return hashCode3 + (textMotion != null ? textMotion.hashCode() : 0);
    }

    public String toString() {
        return "ParagraphStyle(textAlign=" + ((Object) TextAlign.m7146toStringimpl(this.textAlign)) + ", textDirection=" + ((Object) TextDirection.m7160toStringimpl(this.textDirection)) + ", lineHeight=" + ((Object) TextUnit.m7465toStringimpl(this.lineHeight)) + ", textIndent=" + this.textIndent + ", platformStyle=" + this.platformStyle + ", lineHeightStyle=" + this.lineHeightStyle + ", lineBreak=" + ((Object) LineBreak.m7060toStringimpl(this.lineBreak)) + ", hyphens=" + ((Object) Hyphens.m7044toStringimpl(this.hyphens)) + ", textMotion=" + this.textMotion + ')';
    }
}
