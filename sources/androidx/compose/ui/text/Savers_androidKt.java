...
public final class Savers_androidKt {
    ...
    public static final Object PlatformParagraphStyleSaver$lambda$0(SaverScope saverScope, PlatformParagraphStyle platformParagraphStyle) {
        return CollectionsKt.arrayListOf(SaversKt.save(Boolean.valueOf(platformParagraphStyle.getIncludeFontPadding())), SaversKt.save(EmojiSupportMatch.m7285boximpl(platformParagraphStyle.m7367getEmojiSupportMatch_3YsG6Y())));
    }
    ...
    public static final PlatformParagraphStyle PlatformParagraphStyleSaver$lambda$1(Object obj) {
        ...
        return new PlatformParagraphStyle(emojiSupportMatch.m7291unboximpl(), booleanValue, (DefaultConstructorMarker) null);
    }
    ...
    public static final Object LineBreakSaver$lambda$2(SaverScope saverScope, LineBreak lineBreak) {
        return Integer.valueOf(lineBreak.m7793unboximpl());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final LineBreak LineBreakSaver$lambda$3(Object obj) {
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlin.Int");
        return LineBreak.m7781boximpl(LineBreak.m7782constructorimpl(((Integer) obj).intValue()));
    }
    ...
    public static final Object TextMotionSaver$lambda$4(SaverScope saverScope, TextMotion textMotion) {
        return CollectionsKt.arrayListOf(SaversKt.save(TextMotion.Linearity.m7909boximpl(textMotion.m7908getLinearity4e0Vf04$ui_text())), SaversKt.save(Boolean.valueOf(textMotion.getSubpixelTextPositioning$ui_text())));
    }
    ...
    public static final TextMotion TextMotionSaver$lambda$5(Object obj) {
        ...
        int m7915unboximpl = linearity.m7915unboximpl();
        Object obj3 = list.get(1);
        Boolean bool = obj3 != null ? (Boolean) obj3 : null;
        Intrinsics.checkNotNull(bool);
        return new TextMotion(m7915unboximpl, bool.booleanValue(), null);
    }
}
