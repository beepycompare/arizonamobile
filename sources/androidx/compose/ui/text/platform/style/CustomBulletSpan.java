...
public final class CustomBulletSpan implements LeadingMarginSpan {
    ...
    public void drawLeadingMargin(final Canvas canvas, final Paint paint, int i, final int i2, int i3, int i4, int i5, CharSequence charSequence, int i6, int i7, boolean z, Layout layout) {
        ...
        final long m5239constructorimpl = Size.m5239constructorimpl((Float.floatToRawIntBits(f3) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
        BulletSpan_androidKt.m7992setBrushAndDrawyzxVdVo(paint, this.brush, this.alpha, m5239constructorimpl, new Function0() { // from class: androidx.compose.ui.text.platform.style.CustomBulletSpan$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit drawLeadingMargin$lambda$0$0;
                drawLeadingMargin$lambda$0$0 = CustomBulletSpan.drawLeadingMargin$lambda$0$0(CustomBulletSpan.this, m5239constructorimpl, i2, canvas, paint, coerceAtLeast, f);
    ...
    public static final Unit drawLeadingMargin$lambda$0$0(CustomBulletSpan customBulletSpan, long j, int i, Canvas canvas, Paint paint, int i2, float f) {
        BulletSpan_androidKt.draw(customBulletSpan.shape.mo365createOutlinePq9zytI(j, i > 0 ? LayoutDirection.Ltr : LayoutDirection.Rtl, customBulletSpan.density), canvas, paint, i2, f, i);
