    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
                ...
                textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m7897toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).m5992getJoinLxFBmk8()));
                textPaint.setStrokeCap(DrawStyleSpan_androidKt.m7896toAndroidCapBeK7IIE(((Stroke) this.drawStyle).m5991getCapKaPHkGw()));
