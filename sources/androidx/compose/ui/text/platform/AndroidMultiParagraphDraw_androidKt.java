...
public final class AndroidMultiParagraphDraw_androidKt {
    ...
    public static final void m7715drawMultiParagraph7AXcY_I(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        canvas.save();
        if (multiParagraph.getParagraphInfoList$ui_text().size() <= 1) {
            m7717drawParagraphs7AXcY_I(multiParagraph, canvas, brush, f, shadow, textDecoration, drawStyle, i);
            ...
            Shader mo5248createShaderuvyYCjk = ((ShaderBrush) brush).mo5248createShaderuvyYCjk(Size.m5095constructorimpl((Float.floatToRawIntBits(f2) << 32) | (Float.floatToRawIntBits(f3) & 4294967295L)));
            Matrix matrix = new Matrix();
            mo5248createShaderuvyYCjk.getLocalMatrix(matrix);
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                paragraphInfo2.getParagraph().mo7256painthn5TExg(canvas, BrushKt.ShaderBrush(mo5248createShaderuvyYCjk), f, shadow, textDecoration, drawStyle, i);
                ...
                mo5248createShaderuvyYCjk.setLocalMatrix(matrix);
            }
        }
        canvas.restore();
    }
    ...
    public static /* synthetic */ void m7716drawMultiParagraph7AXcY_I$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f = Float.NaN;
        }
        m7715drawMultiParagraph7AXcY_I(multiParagraph, canvas, brush, f, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? BlendMode.Companion.m5220getSrcOver0nO6VwU() : i);
    }

    /* renamed from: drawParagraphs-7AXcY_I  reason: not valid java name */
    private static final void m7717drawParagraphs7AXcY_I(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        List<ParagraphInfo> paragraphInfoList$ui_text = multiParagraph.getParagraphInfoList$ui_text();
        int size = paragraphInfoList$ui_text.size();
        for (int i2 = 0; i2 < size; i2++) {
            ParagraphInfo paragraphInfo = paragraphInfoList$ui_text.get(i2);
            paragraphInfo.getParagraph().mo7256painthn5TExg(canvas, brush, f, shadow, textDecoration, drawStyle, i);
