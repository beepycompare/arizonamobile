...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m6975resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m6974resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-HklW4sA  reason: not valid java name */
    public static final int m6974resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale locale;
        if (TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7150getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7151getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7152getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7153getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7149getContents_7Xco()) || TextDirection.m7145equalsimpl0(i, TextDirection.Companion.m7154getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        EmojiSupportMatch m6540boximpl = (platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m6540boximpl(paragraphStyle.m6622getEmojiSupportMatch_3YsG6Y());
        return !(m6540boximpl == null ? false : EmojiSupportMatch.m6543equalsimpl0(m6540boximpl.m6546unboximpl(), EmojiSupportMatch.Companion.m6549getNone_3YsG6Y()));
    }
}
