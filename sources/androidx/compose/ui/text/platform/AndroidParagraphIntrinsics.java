...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m7866resolveTextDirectionHeuristicsHklW4sA(textStyle.m7651getTextDirections_7Xco(), textStyle.getLocaleList());
    ...
    public static final Typeface _init_$lambda$0(AndroidParagraphIntrinsics androidParagraphIntrinsics, FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
        State<Object> mo7693resolveDPcqOEQ = androidParagraphIntrinsics.fontFamilyResolver.mo7693resolveDPcqOEQ(fontFamily, fontWeight, fontStyle.m7723unboximpl(), fontSynthesis.m7736unboximpl());
        if (!(mo7693resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
            TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(mo7693resolveDPcqOEQ, androidParagraphIntrinsics.resolvedTypefaces);
        ...
        Object value = ((TypefaceResult.Immutable) mo7693resolveDPcqOEQ).getValue();
