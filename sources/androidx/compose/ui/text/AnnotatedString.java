...
public final class AnnotatedString implements CharSequence {
    ...
    */
    ...
    public final AnnotatedString m7443subSequence5zctL8(long j) {
        return subSequence(TextRange.m7606getMinimpl(j), TextRange.m7605getMaximpl(j));
    }
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addStringAnnotation(String str, String str2, int i, int i2) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m7556boximpl(StringAnnotation.m7557constructorimpl(str2)), i, i2, str));
        }
        ...
        public final void m7445addBulletr9BaKPg(Bullet bullet, long j, int i, int i2) {
        ...
        public static /* synthetic */ Object m7444withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.Companion.m7452getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.Companion.getDefault();
            }
            return builder.m7446withBulletListo2QH7mI(j, bullet, function1);
        }

        /* renamed from: withBulletList-o2QH7mI  reason: not valid java name */
        public final <R> R m7446withBulletListo2QH7mI(long j, Bullet bullet, Function1<? super BulletScope, ? extends R> function1) {
            long j2;
            Pair pair = (Pair) CollectionsKt.lastOrNull((List<? extends Object>) this.bulletScope.getBulletListSettingStack$ui_text());
            if (pair != null) {
                long m8363unboximpl = ((TextUnit) pair.getFirst()).m8363unboximpl();
                if (!TextUnitType.m8382equalsimpl0(TextUnit.m8353getTypeUIouoOA(m8363unboximpl), TextUnit.m8353getTypeUIouoOA(j))) {
                    InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m8361toStringimpl(m8363unboximpl)) + " and previous is " + ((Object) TextUnit.m8361toStringimpl(j)));
                }
                long m8353getTypeUIouoOA = TextUnit.m8353getTypeUIouoOA(j);
                j2 = TextUnitType.m8382equalsimpl0(m8353getTypeUIouoOA, TextUnitType.Companion.m8387getSpUIouoOA()) ? TextUnitKt.getSp(TextUnit.m8354getValueimpl(j) + TextUnit.m8354getValueimpl(m8363unboximpl)) : TextUnitType.m8382equalsimpl0(m8353getTypeUIouoOA, TextUnitType.Companion.m8386getEmUIouoOA()) ? TextUnitKt.getEm(TextUnit.m8354getValueimpl(j) + TextUnit.m8354getValueimpl(m8363unboximpl)) : j;
            } else {
                j2 = j;
            }
            ...
            this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m8344boximpl(j2), bullet));
            try {
        ...
        public final <R> R withBulletListItem(BulletScope bulletScope, Bullet bullet, Function1<? super Builder, ? extends R> function1) {
            ...
            long m8363unboximpl = pair != null ? ((TextUnit) pair.getFirst()).m8363unboximpl() : Bullet.Companion.m7452getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
            } else if (pair == null || (bullet2 = (Bullet) pair.getSecond()) == null) {
                bullet2 = Bullet.Companion.getDefault();
            }
            int pushStyle = bulletScope.getBuilder$ui_text().pushStyle(new ParagraphStyle(0, 0, 0L, new TextIndent(m8363unboximpl, m8363unboximpl, null), (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, (int) TypedValues.PositionType.TYPE_PERCENT_WIDTH, (DefaultConstructorMarker) null));
        ...
        public final int pushStringAnnotation(String str, String str2) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m7556boximpl(StringAnnotation.m7557constructorimpl(str2)), this.text.length(), 0, str, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
