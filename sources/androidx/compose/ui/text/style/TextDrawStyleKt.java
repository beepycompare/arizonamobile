...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m7901from8_81llA(ColorKt.m5331lerpjxsXWHM(textForegroundStyle.mo7766getColor0d7_KjU(), textForegroundStyle2.mo7766getColor0d7_KjU(), f));
        }
        if (z && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m7900modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m5279copywmQWz5c$default(j, Color.m5282getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
