...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> consumer) {
        ...
        long m8317getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m8317getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(boundsInRoot)), new Point(IntOffset.m8288getXimpl(m8317getTopLeftnOccac), IntOffset.m8289getYimpl(m8317getTopLeftnOccac)), composeScrollCaptureCallback);
