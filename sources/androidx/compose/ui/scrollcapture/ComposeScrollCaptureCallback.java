...
public final class ComposeScrollCaptureCallback implements ScrollCaptureCallback {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0072, code lost:
        if (r5.scrollRangeToCenter(r10, r2, r0) == r1) goto L30;
     */
    ...
    */
        ...
        if (continuation instanceof ComposeScrollCaptureCallback$onScrollCaptureImageRequest$2) {
            ...
            if ((composeScrollCaptureCallback$onScrollCaptureImageRequest$2.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    top = i5;
                    intRect = (IntRect) composeScrollCaptureCallback$onScrollCaptureImageRequest$2.L$1;
                    bottom = i4;
    ...
    private final void drawDebugBackground(Canvas canvas) {
        canvas.drawColor(ColorKt.m5402toArgb8_81llA(Color.Companion.m5372hslJlNiLsg$default(Color.Companion, 360.0f * Random.Default.nextFloat(), 0.75f, 0.5f, 1.0f, null, 16, null)));
    }
