...
final class BringIntoViewNode extends Modifier.Node {
    ...
    private final Function1<Rect, Unit> requester = new Function1<Rect, Unit>() { // from class: androidx.compose.ui.viewinterop.BringIntoViewNode$requester$1
        ...
        public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (BringIntoViewModifierNodeKt.bringIntoView(this.this$0, new Function0<Rect>() { // from class: androidx.compose.ui.viewinterop.BringIntoViewNode.requester.1.1.1
                        {
                            super(0);
                        }
        ...
        public final void invoke2(Rect rect) {
            if (BringIntoViewNode.this.isAttached()) {
    ...
    public final void update(Function1<? super Function1<? super Rect, Unit>, Unit> function1) {
        this.onRequesterReady = function1;
        if (isAttached()) {
            function1.invoke(this.requester);
        }
    }
}
