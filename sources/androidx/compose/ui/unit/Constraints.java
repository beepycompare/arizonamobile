...
public final class Constraints {
    ...
    public static final /* synthetic */ Constraints m8100boximpl(long j) {
        return new Constraints(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m8101constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m8105equalsimpl(long j, Object obj) {
        return (obj instanceof Constraints) && j == ((Constraints) obj).m8119unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m8106equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: getFocusIndex-impl  reason: not valid java name */
    private static final int m8107getFocusIndeximpl(long j) {
        return (int) (j & 3);
    }

    /* renamed from: getHasBoundedHeight-impl  reason: not valid java name */
    public static final boolean m8108getHasBoundedHeightimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m8109getHasBoundedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final boolean m8110getHasFixedHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
        int i3 = (1 << (18 - i2)) - 1;
    ...
    public static final boolean m8111getHasFixedWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m8112getMaxHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m8113getMaxWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static final int m8114getMinHeightimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public static final int m8115getMinWidthimpl(long j) {
        int i = (int) (3 & j);
    ...
    public static int m8116hashCodeimpl(long j) {
    ...
    public static final boolean m8117isZeroimpl(long j) {
        int i = (int) (3 & j);
        int i2 = ((i & 1) << 1) + (((i & 2) >> 1) * 3);
    ...
    public boolean equals(Object obj) {
        return m8105equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m8116hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m8119unboximpl() {
        return this.value;
    }
    ...
    public static /* synthetic */ long m8103copyZbe2FdA$default(long j, int i, int i2, int i3, int i4, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = m8115getMinWidthimpl(j);
        }
        int i6 = i;
        if ((i5 & 2) != 0) {
            i2 = m8113getMaxWidthimpl(j);
        }
        int i7 = i2;
        if ((i5 & 4) != 0) {
            i3 = m8114getMinHeightimpl(j);
        }
        int i8 = i3;
        if ((i5 & 8) != 0) {
            i4 = m8112getMaxHeightimpl(j);
        }
        return m8102copyZbe2FdA(j, i6, i7, i8, i4);
    }

    /* renamed from: copy-Zbe2FdA  reason: not valid java name */
    public static final long m8102copyZbe2FdA(long j, int i, int i2, int i3, int i4) {
    ...
    public static final long m8104copyMaxDimensionsmsEJaDk(long j) {
        return m8101constructorimpl(j & ConstraintsKt.MaxDimensionsAndFocusMask);
    }

    public String toString() {
        return m8118toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m8118toStringimpl(long j) {
        int m8113getMaxWidthimpl = m8113getMaxWidthimpl(j);
        String str = "Infinity";
        String valueOf = m8113getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(m8113getMaxWidthimpl);
        int m8112getMaxHeightimpl = m8112getMaxHeightimpl(j);
        if (m8112getMaxHeightimpl != Integer.MAX_VALUE) {
            str = String.valueOf(m8112getMaxHeightimpl);
        }
        return "Constraints(minWidth = " + m8115getMinWidthimpl(j) + ", maxWidth = " + valueOf + ", minHeight = " + m8114getMinHeightimpl(j) + ", maxHeight = " + str + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m8123fixedJhjzzOo(int i, int i2) {
            if (!((i2 >= 0) & (i >= 0))) {
        ...
        public final long m8125fixedWidthOenEA2s(int i) {
            if (!(i >= 0)) {
        ...
        public final long m8124fixedHeightOenEA2s(int i) {
            if (!(i >= 0)) {
        ...
        public static /* synthetic */ long m8120restrictConstraintsxF2OJ5Q$default(Companion companion, int i, int i2, int i3, int i4, boolean z, int i5, Object obj) {
            if ((i5 & 16) != 0) {
                z = true;
            }
            return companion.m8126restrictConstraintsxF2OJ5Q(i, i2, i3, i4, z);
        }
        ...
        public final long m8126restrictConstraintsxF2OJ5Q(int i, int i2, int i3, int i4, boolean z) {
            if (z) {
                return m8122fitPrioritizingWidthZbe2FdA(i, i2, i3, i4);
            }
            return m8121fitPrioritizingHeightZbe2FdA(i, i2, i3, i4);
        }

        /* renamed from: fitPrioritizingWidth-Zbe2FdA  reason: not valid java name */
        public final long m8122fitPrioritizingWidthZbe2FdA(int i, int i2, int i3, int i4) {
            int i5 = 262142;
        ...
        public final long m8121fitPrioritizingHeightZbe2FdA(int i, int i2, int i3, int i4) {
            int i5 = 262142;
