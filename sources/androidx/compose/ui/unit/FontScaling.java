...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m8272toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.mo436toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m8271toDpGaN1DYA(FontScaling fontScaling, long j) {
            return FontScaling.super.mo429toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do */
    default long mo436toSp0xMU5do(float f) {
    ...
    default float mo429toDpGaN1DYA(long j) {
        if (!TextUnitType.m8382equalsimpl0(TextUnit.m8353getTypeUIouoOA(j), TextUnitType.Companion.m8387getSpUIouoOA())) {
            InlineClassHelperKt.throwIllegalStateException("Only Sp can convert to Px");
        }
        if (!FontScaleConverterFactory.INSTANCE.isNonLinearFontScalingActive(getFontScale())) {
            return Dp.m8160constructorimpl(TextUnit.m8354getValueimpl(j) * getFontScale());
        }
        FontScaleConverter forScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        return forScale == null ? Dp.m8160constructorimpl(TextUnit.m8354getValueimpl(j) * getFontScale()) : Dp.m8160constructorimpl(forScale.convertSpToDp(TextUnit.m8354getValueimpl(j)));
    }
}
