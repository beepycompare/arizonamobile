...
public interface FontScalingLinear {
    ...
    public static final class DefaultImpls {
        ...
        public static long m8278toSp0xMU5do(FontScalingLinear fontScalingLinear, float f) {
            return FontScalingLinear.super.m8276toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m8277toDpGaN1DYA(FontScalingLinear fontScalingLinear, long j) {
            return FontScalingLinear.super.m8275toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    default long m8276toSp0xMU5do(float f) {
        return TextUnitKt.getSp(f / getFontScale());
    }

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    default float m8275toDpGaN1DYA(long j) {
