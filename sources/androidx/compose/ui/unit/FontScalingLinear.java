...
public interface FontScalingLinear {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6802toSp0xMU5do(FontScalingLinear fontScalingLinear, float f) {
            return FontScalingLinear.super.m6800toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m6801toDpGaN1DYA(FontScalingLinear fontScalingLinear, long j) {
            return FontScalingLinear.super.m6799toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    default long m6800toSp0xMU5do(float f) {
        return TextUnitKt.getSp(f / getFontScale());
    }

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    default float m6799toDpGaN1DYA(long j) {
