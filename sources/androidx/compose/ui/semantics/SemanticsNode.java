...
public final class SemanticsNode {
    ...
    public final long m7391getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        return findCoordinatorToGetBounds$ui != null ? findCoordinatorToGetBounds$ui.mo6826getSizeYbymL2g() : IntSize.Companion.m8336getZeroYbymL2g();
    }
    ...
    public final long m7388getPositionInRootF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (findCoordinatorToGetBounds$ui != null) {
            if (!findCoordinatorToGetBounds$ui.isAttached()) {
                findCoordinatorToGetBounds$ui = null;
    ...
    public final long m7389getPositionInWindowF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (findCoordinatorToGetBounds$ui != null) {
            if (!findCoordinatorToGetBounds$ui.isAttached()) {
                findCoordinatorToGetBounds$ui = null;
    ...
    public final long m7390getPositionOnScreenF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui = findCoordinatorToGetBounds$ui();
        if (findCoordinatorToGetBounds$ui != null) {
            if (!findCoordinatorToGetBounds$ui.isAttached()) {
                findCoordinatorToGetBounds$ui = null;
    ...
    private final Rect boundsInImportantForBoundsAncestor(LayoutCoordinates layoutCoordinates) {
        ...
        NodeCoordinator m6990requireCoordinator64DMado = semanticsModifierNode != null ? DelegatableNodeKt.m6990requireCoordinator64DMado(semanticsModifierNode, NodeKind.m7135constructorimpl(8)) : null;
        if (m6990requireCoordinator64DMado == null) {
            return parent.boundsInImportantForBoundsAncestor(layoutCoordinates);
        }
        return LayoutCoordinates.localBoundingBoxOf$default(m6990requireCoordinator64DMado, layoutCoordinates, false, 2, null);
    }
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode layoutNode, List<SemanticsNode> list, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode2.isAttached() && (z || !layoutNode2.isDeactivated())) {
                if (layoutNode2.getNodes$ui().m7095hasH91voCI$ui(NodeKind.m7135constructorimpl(8))) {
        ...
        if (layoutNode == null) {
            ...
            while (true) {
                if (layoutNode == null) {
                    layoutNode = null;
                    break;
                } else if (layoutNode.getNodes$ui().m7095hasH91voCI$ui(NodeKind.m7135constructorimpl(8))) {
                    break;
                } else {
                    layoutNode = layoutNode.getParent$ui();
                }
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui() {
        NodeCoordinator m6990requireCoordinator64DMado;
        if (!isFake$ui()) {
            SemanticsModifierNode findSemanticsModifierNodeToGetBounds = findSemanticsModifierNodeToGetBounds();
            return (findSemanticsModifierNodeToGetBounds == null || (m6990requireCoordinator64DMado = DelegatableNodeKt.m6990requireCoordinator64DMado(findSemanticsModifierNodeToGetBounds, NodeKind.m7135constructorimpl(8))) == null) ? this.layoutNode.getInnerCoordinator$ui() : m6990requireCoordinator64DMado;
        }
        SemanticsNode parent = getParent();
        if (parent != null) {
    ...
    private final SemanticsModifierNode findSemanticsModifierNodeToGetBounds() {
        ...
        int m7135constructorimpl2 = NodeKind.m7135constructorimpl(8);
        if ((nodes$ui2.getAggregateChildKindSet() & m7135constructorimpl2) != 0) {
            loop3: for (Modifier.Node head$ui2 = nodes$ui2.getHead$ui(); head$ui2 != null; head$ui2 = head$ui2.getChild$ui()) {
                if ((head$ui2.getKindSet$ui() & m7135constructorimpl2) != 0) {
                    node = head$ui2;
                    ...
                    while (node != null) {
                        ...
                        } else if ((node.getKindSet$ui() & m7135constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
                            int i2 = 0;
                ...
                if ((head$ui2.getAggregateChildKindSet$ui() & m7135constructorimpl2) == 0) {
                    break;
                }
            }
        }
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (access$getRole != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && !list.isEmpty()) {
            list.add(m7387fakeSemanticsNodeypyhhiA(access$getRole, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    SemanticsPropertiesKt.m7397setRolekuIjeqM(semanticsPropertyReceiver, Role.this.m7377unboximpl());
                }
            }));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && !list.isEmpty() && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                list.add(0, m7387fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
                    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private final SemanticsNode m7387fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> function1) {
