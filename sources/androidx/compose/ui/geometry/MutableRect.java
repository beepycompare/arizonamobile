...
public final class MutableRect {
    ...
    public final long m5162getTopLeftF1C5BW0() {
        float f = this.left;
        float f2 = this.top;
    ...
    public final long m5161getTopCenterF1C5BW0() {
    ...
    public final long m5163getTopRightF1C5BW0() {
        float f = this.right;
        float f2 = this.top;
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5158getCenterLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m5157getCenterF1C5BW0() {
    ...
    public final long m5159getCenterRightF1C5BW0() {
        float f = this.right;
        float bottom = this.top + ((getBottom() - getTop()) / 2.0f);
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5155getBottomLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m5154getBottomCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float f = this.bottom;
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(f) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final long m5156getBottomRightF1C5BW0() {
        float f = this.right;
        float f2 = this.bottom;
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5160getSizeNHjbRc() {
    ...
    public final void m5164translatek4lQ0M(long j) {
    ...
    public final boolean m5153containsk4lQ0M(long j) {
