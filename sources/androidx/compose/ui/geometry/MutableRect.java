...
public final class MutableRect {
    ...
    public final long m5019getTopLeftF1C5BW0() {
        float f = this.left;
        float f2 = this.top;
    ...
    public final long m5018getTopCenterF1C5BW0() {
    ...
    public final long m5020getTopRightF1C5BW0() {
        float f = this.right;
        float f2 = this.top;
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5015getCenterLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m5014getCenterF1C5BW0() {
    ...
    public final long m5016getCenterRightF1C5BW0() {
        float f = this.right;
        float bottom = this.top + ((getBottom() - getTop()) / 2.0f);
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5012getBottomLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m5011getBottomCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float f = this.bottom;
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(f) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final long m5013getBottomRightF1C5BW0() {
        float f = this.right;
        float f2 = this.bottom;
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m5017getSizeNHjbRc() {
    ...
    public final void m5021translatek4lQ0M(long j) {
    ...
    public final boolean m5010containsk4lQ0M(long j) {
