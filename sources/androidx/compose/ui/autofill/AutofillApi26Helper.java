...
public final class AutofillApi26Helper {
    ...
    public final AutofillValue getAutofillTextValue(String str) {
        ...
        trimToSafeLength = AutofillUtils_androidKt.trimToSafeLength(str);
        return AutofillValue.forText(trimToSafeLength);
    }
