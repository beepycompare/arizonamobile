...
public final class FrameRateCategory {
    ...
    private static final float Default = m4018constructorimpl(Float.NaN);
    private static final float Normal = m4018constructorimpl(-3.0f);
    private static final float High = m4018constructorimpl(-4.0f);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ FrameRateCategory m4017boximpl(float f) {
        return new FrameRateCategory(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static float m4018constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4019equalsimpl(float f, Object obj) {
        return (obj instanceof FrameRateCategory) && Float.compare(f, ((FrameRateCategory) obj).m4023unboximpl()) == 0;
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4020equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4021hashCodeimpl(float f) {
    ...
    public final /* synthetic */ float m4023unboximpl() {
        return this.value;
    }
    ...
    public static String m4022toStringimpl(float f) {
        if (f == -3.0f) {
            return "Normal";
        }
        if (f == -4.0f) {
