...
public final class IndirectPointerEventPrimaryDirectionalMotionAxis {
    ...
    private static final int X = m6169constructorimpl(1);
    private static final int Y = m6169constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ IndirectPointerEventPrimaryDirectionalMotionAxis m6168boximpl(int i) {
    ...
    public static boolean m6170equalsimpl(int i, Object obj) {
        return (obj instanceof IndirectPointerEventPrimaryDirectionalMotionAxis) && i == ((IndirectPointerEventPrimaryDirectionalMotionAxis) obj).m6174unboximpl();
    }
