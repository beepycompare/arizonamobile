...
final class IndirectTouchInputElement extends ModifierNodeElement<IndirectTouchInputNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(IndirectTouchInputNode indirectTouchInputNode) {
        indirectTouchInputNode.setOnEvent(this.onIndirectTouchEvent);
        indirectTouchInputNode.setOnPreEvent(this.onPreIndirectTouchEvent);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IndirectTouchInputElement) {
            IndirectTouchInputElement indirectTouchInputElement = (IndirectTouchInputElement) obj;
