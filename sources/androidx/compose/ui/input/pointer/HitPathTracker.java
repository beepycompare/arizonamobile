...
public final class HitPathTracker {
    ...
    public static /* synthetic */ void m6587addHitPathQJqDSyo$default(HitPathTracker hitPathTracker, long j, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = false;
        }
        hitPathTracker.m6588addHitPathQJqDSyo(j, list, z);
    }

    /* renamed from: addHitPath-QJqDSyo  reason: not valid java name */
    public final void m6588addHitPathQJqDSyo(long j, List<? extends Modifier.Node> list, boolean z) {
        Node node;
