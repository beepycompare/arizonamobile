...
final class MotionEventHelper {
    ...
    public final long m6675toRawOffsetdBAh8RU(MotionEvent motionEvent, int i) {
        float rawX = motionEvent.getRawX(i);
        return Offset.m5171constructorimpl((Float.floatToRawIntBits(motionEvent.getRawY(i)) & 4294967295L) | (Float.floatToRawIntBits(rawX) << 32));
    }
}
