...
public final class Node extends NodeParent {
        ...
        if (this.modifierNode.isAttached()) {
            ...
            while (i5 < size) {
                ...
                if (this.pointerIds.contains(keyAt)) {
                    boolean z6 = z5;
                    int i6 = i5;
                    long m6686getPreviousPositionF1C5BW0 = valueAt.m6686getPreviousPositionF1C5BW0();
                    z4 = z6;
                    long m6685getPositionF1C5BW0 = valueAt.m6685getPositionF1C5BW0();
                    if ((((m6686getPreviousPositionF1C5BW0 & 9223372034707292159L) + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0 && (((m6685getPositionF1C5BW0 & 9223372034707292159L) + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0) {
                        ...
                        while (i7 < size2) {
                            ...
                            if ((((m6586getPositionF1C5BW0 & 9223372034707292159L) + InlineClassHelperKt.DualLoadedSignificand) & (-9223372034707292160L)) == 0) {
                                long uptimeMillis = historicalChange.getUptimeMillis();
                                i3 = i6;
                                LayoutCoordinates layoutCoordinates3 = this.coordinates;
                                Intrinsics.checkNotNull(layoutCoordinates3);
                                arrayList.add(new HistoricalChange(uptimeMillis, layoutCoordinates3.mo6827localPositionOfR5De75A(layoutCoordinates, m6586getPositionF1C5BW0), historicalChange.getScaleFactor(), historicalChange.m6585getPanOffsetF1C5BW0(), historicalChange.m6584getOriginalEventPositionF1C5BW0$ui(), (DefaultConstructorMarker) null));
                            } else {
                                i3 = i6;
                            }
                            i7 = i9 + 1;
                        ...
                        long mo6827localPositionOfR5De75A = layoutCoordinates4.mo6827localPositionOfR5De75A(layoutCoordinates, m6686getPreviousPositionF1C5BW0);
                        LayoutCoordinates layoutCoordinates5 = this.coordinates;
                        Intrinsics.checkNotNull(layoutCoordinates5);
                        longSparseArray2.put(keyAt, PointerInputChange.m6671copyOHpmEuE$default(valueAt, 0L, 0L, layoutCoordinates5.mo6827localPositionOfR5De75A(layoutCoordinates, m6685getPositionF1C5BW0), false, 0L, mo6827localPositionOfR5De75A, false, 0, arrayList, 0L, 731, null));
                    } else {
                        z3 = buildCache;
                        i = size;
                        i2 = i6;
            ...
            while (true) {
                ...
                if (-1 >= size3) {
                    break;
                } else if (!longSparseArray.containsKey(this.pointerIds.m6788get_I2yYro(size3))) {
            ...
            while (true) {
                ...
                if (internalPointerEvent.m6590activeHoverEvent0FcD4WY(pointerInputChange2.m6682getIdJ3iCeTQ())) {
            ...
            if (pointerInputChange3 != null) {
                if (!z) {
                    ...
                    if (!this.isIn && (pointerInputChange3.getPressed() || pointerInputChange3.getPreviousPressed())) {
                        ...
                        this.isIn = !PointerEventKt.m6620isOutOfBoundsO0kMr_c(pointerInputChange3, layoutCoordinates2.mo6826getSizeYbymL2g());
                    }
                }
                if (this.isIn != this.wasIn && (PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6631getMove7fucELk()) || PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6629getEnter7fucELk()) || PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6630getExit7fucELk()))) {
                    if (this.isIn) {
                        m6630getExit7fucELk = PointerEventType.Companion.m6629getEnter7fucELk();
                    } else {
                        m6630getExit7fucELk = PointerEventType.Companion.m6630getExit7fucELk();
                    }
                    pointerEvent.m6619setTypeEhbLWgg$ui(m6630getExit7fucELk);
                } else if (PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6629getEnter7fucELk()) && this.wasIn && !this.hasExited) {
                    pointerEvent.m6619setTypeEhbLWgg$ui(PointerEventType.Companion.m6631getMove7fucELk());
                } else if (PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6630getExit7fucELk()) && this.isIn && pointerInputChange3.getPressed()) {
                    pointerEvent.m6619setTypeEhbLWgg$ui(PointerEventType.Companion.m6631getMove7fucELk());
                }
            } else {
                z2 = false;
            }
            boolean z9 = (z7 || !PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6631getMove7fucELk()) || hasPositionChanged(this.pointerEvent, pointerEvent)) ? z8 : z2;
    ...
    private final boolean hasPositionChanged(PointerEvent pointerEvent, PointerEvent pointerEvent2) {
        ...
        for (int i = 0; i < size; i++) {
            if (!Offset.m5100equalsimpl0(pointerEvent.getChanges().get(i).m6685getPositionF1C5BW0(), pointerEvent2.getChanges().get(i).m6685getPositionF1C5BW0())) {
                return true;
            }
        }
        return false;
    ...
    private final boolean dispatchIfNeeded(Function0<Unit> function0) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.isAttached()) {
            NodeCoordinator coordinator$ui = this.modifierNode.getCoordinator$ui();
            if ((coordinator$ui == null || (layoutNode = coordinator$ui.getLayoutNode()) == null) ? false : layoutNode.isPlaced()) {
                function0.invoke();
                return true;
            }
            return false;
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            boolean m6590activeHoverEvent0FcD4WY = internalPointerEvent.m6590activeHoverEvent0FcD4WY(pointerInputChange.m6682getIdJ3iCeTQ());
            boolean z = this.isIn;
            if ((!pressed && !m6590activeHoverEvent0FcD4WY) || (!pressed && !z)) {
                this.pointerIds.remove(pointerInputChange.m6682getIdJ3iCeTQ());
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6630getExit7fucELk());
    }
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> longSparseArray, LayoutCoordinates layoutCoordinates, InternalPointerEvent internalPointerEvent, boolean z) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.isAttached()) {
            ...
            if ((coordinator$ui == null || (layoutNode = coordinator$ui.getLayoutNode()) == null) ? false : layoutNode.isPlaced()) {
                ...
                long mo6826getSizeYbymL2g = layoutCoordinates2.mo6826getSizeYbymL2g();
                Modifier.Node node = this.modifierNode;
                int m7135constructorimpl = NodeKind.m7135constructorimpl(16);
                MutableVector mutableVector = null;
                while (node != null) {
                    if (node instanceof PointerInputModifierNode) {
                        ((PointerInputModifierNode) node).mo257onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Initial, mo6826getSizeYbymL2g);
                    } else if ((node.getKindSet$ui() & m7135constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                        int i = 0;
                        for (Modifier.Node delegate$ui = ((DelegatingNode) node).getDelegate$ui(); delegate$ui != null; delegate$ui = delegate$ui.getChild$ui()) {
                            if ((delegate$ui.getKindSet$ui() & m7135constructorimpl) != 0) {
                ...
                if (this.modifierNode.isAttached()) {
                    ...
                    int m7135constructorimpl2 = NodeKind.m7135constructorimpl(16);
                    MutableVector mutableVector2 = null;
                    while (node2 != null) {
                        if (node2 instanceof PointerInputModifierNode) {
                            ((PointerInputModifierNode) node2).mo257onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Main, mo6826getSizeYbymL2g);
                        } else if ((node2.getKindSet$ui() & m7135constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                            int i3 = 0;
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.isAttached()) {
            ...
            if ((coordinator$ui == null || (layoutNode = coordinator$ui.getLayoutNode()) == null) ? false : layoutNode.isPlaced()) {
                ...
                while (node != null) {
                    if (node instanceof PointerInputModifierNode) {
                        ((PointerInputModifierNode) node).mo257onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, mo6826getSizeYbymL2g);
                    } else if ((node.getKindSet$ui() & m7135constructorimpl) != 0 && (node instanceof DelegatingNode)) {
                        int i = 0;
                        for (Modifier.Node delegate$ui = ((DelegatingNode) node).getDelegate$ui(); delegate$ui != null; delegate$ui = delegate$ui.getChild$ui()) {
                            if ((delegate$ui.getKindSet$ui() & m7135constructorimpl) != 0) {
