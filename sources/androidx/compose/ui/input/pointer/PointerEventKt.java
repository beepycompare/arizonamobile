...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        return !Offset.m5100equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m5119getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        return !Offset.m5100equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m5119getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        return (z || !pointerInputChange.isConsumed()) ? Offset.m5107minusMKHz9U(pointerInputChange.m6685getPositionF1C5BW0(), pointerInputChange.m6686getPreviousPositionF1C5BW0()) : Offset.Companion.m5119getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        if (Offset.m5100equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m5119getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m6620isOutOfBoundsO0kMr_c(PointerInputChange pointerInputChange, long j) {
        long m6685getPositionF1C5BW0 = pointerInputChange.m6685getPositionF1C5BW0();
        float intBitsToFloat = Float.intBitsToFloat((int) (m6685getPositionF1C5BW0 >> 32));
        float intBitsToFloat2 = Float.intBitsToFloat((int) (m6685getPositionF1C5BW0 & 4294967295L));
        int i = (int) (j >> 32);
    ...
    public static final boolean m6621isOutOfBoundsjwHxaWs(PointerInputChange pointerInputChange, long j, long j2) {
        boolean m6758equalsimpl0 = PointerType.m6758equalsimpl0(pointerInputChange.m6688getTypeT8wyACA(), PointerType.Companion.m6765getTouchT8wyACA());
        long m6685getPositionF1C5BW0 = pointerInputChange.m6685getPositionF1C5BW0();
        float intBitsToFloat = Float.intBitsToFloat((int) (m6685getPositionF1C5BW0 >> 32));
        float intBitsToFloat2 = Float.intBitsToFloat((int) (m6685getPositionF1C5BW0 & 4294967295L));
        float intBitsToFloat3 = Float.intBitsToFloat((int) (j2 >> 32));
        float f = m6758equalsimpl0 ? 1.0f : 0.0f;
