...
public abstract class HoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public abstract boolean mo6589isRelevantPointerTypeuerMTgs(int i);
    ...
    public void mo257onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        if (pointerEventPass == PointerEventPass.Main) {
            ...
            for (int i = 0; i < size; i++) {
                if (mo6589isRelevantPointerTypeuerMTgs(changes.get(i).m6688getTypeT8wyACA())) {
                    if (PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6629getEnter7fucELk())) {
                        onEnter();
                        return;
                    } else if (PointerEventType.m6625equalsimpl0(pointerEvent.m6618getType7fucELk(), PointerEventType.Companion.m6630getExit7fucELk())) {
                        onExit();
                        return;
                    } else {
                        return;
    ...
    public long mo1710getTouchBoundsExpansionRZrCHBk() {
        ...
        return dpTouchBoundsExpansion != null ? dpTouchBoundsExpansion.m7028roundToTouchBoundsExpansionTW6G1oQ(DelegatableNodeKt.requireDensity(this)) : TouchBoundsExpansion.Companion.m7236getNoneRZrCHBk();
    }
