...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui(float f, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        return Float.intBitsToFloat((int) (layoutCoordinates2.mo6884localPositionOfR5De75A(layoutCoordinates, Offset.m5171constructorimpl((Float.floatToRawIntBits(((int) (layoutCoordinates.mo6883getSizeYbymL2g() & 4294967295L)) / 2.0f) & 4294967295L) | (Float.floatToRawIntBits(f) << 32))) >> 32));
    }
    ...
    public static final class Companion {
        ...
        public final VerticalRuler maxOf(final VerticalRuler... verticalRulerArr) {
            return derived(new Function2<Placeable.PlacementScope, Float, Float>() { // from class: androidx.compose.ui.layout.VerticalRuler$Companion$maxOf$1
                ...
                public final Float invoke(Placeable.PlacementScope placementScope, float f) {
                    return Float.valueOf(RulerKt.access$mergeRulerValues(placementScope, true, verticalRulerArr, f));
                }
            });
        }
        ...
        public final VerticalRuler minOf(final VerticalRuler... verticalRulerArr) {
            return derived(new Function2<Placeable.PlacementScope, Float, Float>() { // from class: androidx.compose.ui.layout.VerticalRuler$Companion$minOf$1
                ...
                public final Float invoke(Placeable.PlacementScope placementScope, float f) {
                    return Float.valueOf(RulerKt.access$mergeRulerValues(placementScope, false, verticalRulerArr, f));
                }
            });
        }

        public final VerticalRuler derived(Function2<? super Placeable.PlacementScope, ? super Float, Float> function2) {
            return new VerticalRuler(function2, null);
        }
    }
}
