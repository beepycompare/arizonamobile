...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float f, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        return Float.intBitsToFloat((int) (layoutCoordinates2.mo5963localPositionOfR5De75A(layoutCoordinates, Offset.m4285constructorimpl((Float.floatToRawIntBits(((int) (layoutCoordinates.mo5962getSizeYbymL2g() & 4294967295L)) / 2.0f) & 4294967295L) | (Float.floatToRawIntBits(f) << 32))) >> 32));
    }
