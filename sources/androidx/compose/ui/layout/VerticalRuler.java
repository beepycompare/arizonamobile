...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float f, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        return Float.intBitsToFloat((int) (layoutCoordinates2.mo5447localPositionOfR5De75A(layoutCoordinates, Offset.m3829constructorimpl((Float.floatToRawIntBits(((int) (layoutCoordinates.mo5446getSizeYbymL2g() & 4294967295L)) / 2.0f) & 4294967295L) | (Float.floatToRawIntBits(f) << 32))) >> 32));
    }
}
