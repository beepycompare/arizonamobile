...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui(float f, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        return Float.intBitsToFloat((int) (layoutCoordinates2.mo6225localPositionOfR5De75A(layoutCoordinates, Offset.m4519constructorimpl((Float.floatToRawIntBits(((int) (layoutCoordinates.mo6224getSizeYbymL2g() & 4294967295L)) / 2.0f) & 4294967295L) | (Float.floatToRawIntBits(f) << 32))) >> 32));
    }
