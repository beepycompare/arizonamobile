...
final class ApproachLayoutModifierNodeImpl extends Modifier.Node implements ApproachLayoutModifierNode {
    ...
    public boolean mo75isMeasurementApproachInProgressozmzZPI(long j) {
        return this.isMeasurementApproachInProgress.invoke(IntSize.m8323boximpl(j)).booleanValue();
    }
    ...
    public MeasureResult mo74approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        return this.measureBlock.invoke(approachMeasureScope, measurable, Constraints.m8100boximpl(j));
    }
}
