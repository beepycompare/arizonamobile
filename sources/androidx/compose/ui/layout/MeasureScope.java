...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m6862roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo427roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4 */
        public static int m6863roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo428roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA */
        public static float m6864toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo429toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM */
        public static float m6865toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo430toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM */
        public static float m6866toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo431toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM */
        public static long m6867toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo432toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o */
        public static float m6868toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo433toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4 */
        public static float m6869toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo434toPx0680j_4(f);
        }
        ...
        public static long m6870toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo435toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do */
        public static long m6871toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo436toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4 */
        public static long m6872toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo437toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4 */
        public static long m6873toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo438toSpkPz2Gy4(i);
        }
