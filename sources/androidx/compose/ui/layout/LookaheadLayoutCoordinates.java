...
public final class LookaheadLayoutCoordinates implements LayoutCoordinates {
    ...
    public long mo6224getSizeYbymL2g() {
        LookaheadDelegate lookaheadDelegate = this.lookaheadDelegate;
        return IntSize.m7721constructorimpl((lookaheadDelegate.getWidth() << 32) | (lookaheadDelegate.getHeight() & 4294967295L));
    }
    ...
    private final long m6245getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m4531minusMKHz9U(mo6225localPositionOfR5De75A(rootLookaheadDelegate.getCoordinates(), Offset.Companion.m4543getZeroF1C5BW0()), getCoordinator().mo6225localPositionOfR5De75A(rootLookaheadDelegate.getCoordinator(), Offset.Companion.m4543getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo6230screenToLocalMKHz9U(long j) {
        return Offset.m4532plusMKHz9U(getCoordinator().mo6230screenToLocalMKHz9U(j), m6245getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToScreen-MK-Hz9U */
    public long mo6228localToScreenMKHz9U(long j) {
        return getCoordinator().mo6228localToScreenMKHz9U(Offset.m4532plusMKHz9U(j, m6245getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo6233windowToLocalMKHz9U(long j) {
        return Offset.m4532plusMKHz9U(getCoordinator().mo6233windowToLocalMKHz9U(j), m6245getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo6229localToWindowMKHz9U(long j) {
        return getCoordinator().mo6229localToWindowMKHz9U(Offset.m4532plusMKHz9U(j, m6245getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo6227localToRootMKHz9U(long j) {
        return getCoordinator().mo6227localToRootMKHz9U(Offset.m4532plusMKHz9U(j, m6245getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo6226localPositionOfS_NoaFU(LayoutCoordinates layoutCoordinates, long j, boolean z) {
        if (layoutCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            if (lookaheadDelegate2 != null) {
                long m7686minusqkQi6aY = IntOffset.m7686minusqkQi6aY(IntOffset.m7687plusqkQi6aY(lookaheadDelegate.m6475positionIniSbpLlY$ui(lookaheadDelegate2, !z), IntOffsetKt.m7700roundk4lQ0M(j)), this.lookaheadDelegate.m6475positionIniSbpLlY$ui(lookaheadDelegate2, !z));
                return Offset.m4519constructorimpl((Float.floatToRawIntBits(IntOffset.m7683getXimpl(m7686minusqkQi6aY)) << 32) | (Float.floatToRawIntBits(IntOffset.m7684getYimpl(m7686minusqkQi6aY)) & 4294967295L));
            }
            ...
            return wrappedBy$ui.mo6226localPositionOfS_NoaFU(wrappedBy$ui2, m4519constructorimpl, z);
        }
        LookaheadDelegate rootLookaheadDelegate3 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        long mo6226localPositionOfS_NoaFU = mo6226localPositionOfS_NoaFU(rootLookaheadDelegate3.getLookaheadLayoutCoordinates(), j, z);
        long mo6464getPositionnOccac = rootLookaheadDelegate3.mo6464getPositionnOccac();
        long m4531minusMKHz9U = Offset.m4531minusMKHz9U(mo6226localPositionOfS_NoaFU, Offset.m4519constructorimpl((4294967295L & Float.floatToRawIntBits(IntOffset.m7684getYimpl(mo6464getPositionnOccac))) | (Float.floatToRawIntBits(IntOffset.m7683getXimpl(mo6464getPositionnOccac)) << 32)));
        ...
        return Offset.m4532plusMKHz9U(m4531minusMKHz9U, parentCoordinates.mo6226localPositionOfS_NoaFU(layoutCoordinates, Offset.Companion.m4543getZeroF1C5BW0(), z));
    }
    ...
    public void mo6231transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, float[] fArr) {
        getCoordinator().mo6231transformFromEL8BTi8(layoutCoordinates, fArr);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: transformToScreen-58bKbWc */
    public void mo6232transformToScreen58bKbWc(float[] fArr) {
        getCoordinator().mo6232transformToScreen58bKbWc(fArr);
    }
