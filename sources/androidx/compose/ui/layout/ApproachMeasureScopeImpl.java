...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int mo427roundToPxR2X_6o(long j) {
        return this.coordinator.mo427roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo428roundToPx0680j_4(float f) {
        return this.coordinator.mo428roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo429toDpGaN1DYA(long j) {
        return this.coordinator.mo429toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo430toDpu2uoSUM(float f) {
        return this.coordinator.mo430toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo431toDpu2uoSUM(int i) {
        return this.coordinator.mo431toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo432toDpSizekrfVVM(long j) {
        return this.coordinator.mo432toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo433toPxR2X_6o(long j) {
        return this.coordinator.mo433toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo434toPx0680j_4(float f) {
        return this.coordinator.mo434toPx0680j_4(f);
    }
    ...
    public long mo435toSizeXkaWNTQ(long j) {
        return this.coordinator.mo435toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo436toSp0xMU5do(float f) {
        return this.coordinator.mo436toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo437toSpkPz2Gy4(float f) {
        return this.coordinator.mo437toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo438toSpkPz2Gy4(int i) {
        return this.coordinator.mo438toSpkPz2Gy4(i);
    }
    ...
    public long mo6795getLookaheadConstraintsmsEJaDk() {
        Constraints m7038getLookaheadConstraintsDWUhwKw$ui = this.coordinator.m7038getLookaheadConstraintsDWUhwKw$ui();
        if (m7038getLookaheadConstraintsDWUhwKw$ui == null) {
        ...
        return m7038getLookaheadConstraintsDWUhwKw$ui.m8119unboximpl();
    }

    @Override // androidx.compose.ui.layout.ApproachIntrinsicMeasureScope
    /* renamed from: getLookaheadSize-YbymL2g */
    public long mo6796getLookaheadSizeYbymL2g() {
        ...
        return IntSize.m8326constructorimpl((measureResult$ui.getWidth() << 32) | (measureResult$ui.getHeight() & 4294967295L));
    }
        ...
        if (lookaheadRoot$ui != null) {
            if (lookaheadRoot$ui.isVirtualLookaheadRoot$ui()) {
                ...
                if (parent$ui == null || (outerCoordinator$ui = parent$ui.getInnerCoordinator$ui()) == null) {
                    outerCoordinator$ui = lookaheadRoot$ui.getChildren$ui().get(0).getOuterCoordinator$ui();
                }
