...
public interface BeyondBoundsLayout {
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m5948constructorimpl(1);
        private static final int After = m5948constructorimpl(2);
        private static final int Left = m5948constructorimpl(3);
        private static final int Right = m5948constructorimpl(4);
        private static final int Above = m5948constructorimpl(5);
        private static final int Below = m5948constructorimpl(6);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m5947boximpl(int i) {
            return new LayoutDirection(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static int m5948constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m5949equalsimpl(int i, Object obj) {
            return (obj instanceof LayoutDirection) && i == ((LayoutDirection) obj).m5953unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m5950equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m5951hashCodeimpl(int i) {
            return Integer.hashCode(i);
        }

        public boolean equals(Object obj) {
            return m5949equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m5951hashCodeimpl(this.value);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m5953unboximpl() {
            return this.value;
        }
        ...
        public static final class Companion {
            ...
            public final int m5956getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE  reason: not valid java name */
            public final int m5955getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE  reason: not valid java name */
            public final int m5958getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE  reason: not valid java name */
            public final int m5959getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE  reason: not valid java name */
            public final int m5954getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE  reason: not valid java name */
            public final int m5957getBelowhoxUOeE() {
        ...
        public String toString() {
            return m5952toStringimpl(this.value);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m5952toStringimpl(int i) {
            return m5950equalsimpl0(i, Before) ? "Before" : m5950equalsimpl0(i, After) ? "After" : m5950equalsimpl0(i, Left) ? "Left" : m5950equalsimpl0(i, Right) ? "Right" : m5950equalsimpl0(i, Above) ? "Above" : m5950equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
