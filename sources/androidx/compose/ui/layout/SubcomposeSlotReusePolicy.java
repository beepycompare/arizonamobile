...
public interface SubcomposeSlotReusePolicy {
    ...
    public static final class SlotIdsSet implements Collection<Object>, KMappedMarker {
        ...
        public final boolean retainAll(Collection<?> collection) {
            return this.set.retainAll((Collection<? extends Object>) collection);
        }
        ...
        public final void fastForEach(Function1<Object, Unit> function1) {
            MutableOrderedScatterSet<Object> set = getSet();
            Object[] objArr = set.elements;
            long[] jArr = set.nodes;
            for (int i = set.tail; i != Integer.MAX_VALUE; i = (int) ((jArr[i] >> 31) & SieveCacheKt.NodeLinkMask)) {
                function1.invoke(objArr[i]);
            }
        }
    }
