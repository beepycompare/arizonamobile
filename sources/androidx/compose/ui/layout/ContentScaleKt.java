...
public final class ContentScaleKt {
    ...
    public static final float m6815computeFillMaxDimensioniLBOSCw(long j, long j2) {
    ...
    public static final float m6816computeFillMinDimensioniLBOSCw(long j, long j2) {
    ...
    private static final float m6817computeFillWidthiLBOSCw(long j, long j2) {
        return Float.intBitsToFloat((int) (j2 >> 32)) / Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: computeFillHeight-iLBOSCw  reason: not valid java name */
    private static final float m6814computeFillHeightiLBOSCw(long j, long j2) {
