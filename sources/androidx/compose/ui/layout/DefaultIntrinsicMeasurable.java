...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo5438measureBRTryo0(long j) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m6632getHasBoundedHeightimpl(j) ? Constraints.m6636getMaxHeightimpl(j) : 32767);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m6633getHasBoundedWidthimpl(j) ? Constraints.m6637getMaxWidthimpl(j) : 32767, minIntrinsicHeight);
    }
