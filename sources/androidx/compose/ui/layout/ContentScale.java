...
public interface ContentScale {
    ...
    long mo5947computeScaleFactorH7hwNQA(long j, long j2);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo5947computeScaleFactorH7hwNQA(long j, long j2) {
                float m5951computeFillMaxDimensioniLBOSCw;
                m5951computeFillMaxDimensioniLBOSCw = ContentScaleKt.m5951computeFillMaxDimensioniLBOSCw(j, j2);
                return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(m5951computeFillMaxDimensioniLBOSCw) << 32) | (4294967295L & Float.floatToRawIntBits(m5951computeFillMaxDimensioniLBOSCw)));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5947computeScaleFactorH7hwNQA(long j, long j2) {
                float m5952computeFillMinDimensioniLBOSCw;
                m5952computeFillMinDimensioniLBOSCw = ContentScaleKt.m5952computeFillMinDimensioniLBOSCw(j, j2);
                return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(m5952computeFillMinDimensioniLBOSCw) << 32) | (4294967295L & Float.floatToRawIntBits(m5952computeFillMinDimensioniLBOSCw)));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo5947computeScaleFactorH7hwNQA(long j, long j2) {
                ...
                return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (Float.floatToRawIntBits(intBitsToFloat) & 4294967295L));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo5947computeScaleFactorH7hwNQA(long j, long j2) {
                ...
                if (Float.intBitsToFloat((int) (j >> 32)) > Float.intBitsToFloat((int) (j2 >> 32)) || Float.intBitsToFloat((int) (j & 4294967295L)) > Float.intBitsToFloat((int) (j2 & 4294967295L))) {
                    m5952computeFillMinDimensioniLBOSCw = ContentScaleKt.m5952computeFillMinDimensioniLBOSCw(j, j2);
                    return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(m5952computeFillMinDimensioniLBOSCw) << 32) | (Float.floatToRawIntBits(m5952computeFillMinDimensioniLBOSCw) & 4294967295L));
                }
                return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(1.0f) << 32) | (Float.floatToRawIntBits(1.0f) & 4294967295L));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo5947computeScaleFactorH7hwNQA(long j, long j2) {
                return ScaleFactor.m6038constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j2 >> 32)) / Float.intBitsToFloat((int) (j >> 32))) << 32) | (Float.floatToRawIntBits(Float.intBitsToFloat((int) (j2 & 4294967295L)) / Float.intBitsToFloat((int) (j & 4294967295L))) & 4294967295L));
            }
        };
