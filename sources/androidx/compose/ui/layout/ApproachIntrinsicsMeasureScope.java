...
public final class ApproachIntrinsicsMeasureScope implements ApproachMeasureScope, ApproachIntrinsicMeasureScope {
    ...
    public long mo6675getLookaheadConstraintsmsEJaDk() {
        return this.$$delegate_0.mo6675getLookaheadConstraintsmsEJaDk();
    }

    @Override // androidx.compose.ui.layout.ApproachIntrinsicMeasureScope
    /* renamed from: getLookaheadSize-YbymL2g */
    public long mo6676getLookaheadSizeYbymL2g() {
        return this.$$delegate_0.mo6676getLookaheadSizeYbymL2g();
    }
    ...
    public MeasureResult layout(final int i, final int i2, final Map<AlignmentLine, Integer> map, final Function1<? super RulerScope, Unit> function1, Function1<? super Placeable.PlacementScope, Unit> function12) {
        boolean z = false;
        if (i < 0) {
            i = 0;
        }
