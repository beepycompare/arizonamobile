...
final class FocusSorter {
    ...
    public final void sort(View[] viewArr, ViewGroup viewGroup, boolean z) {
        ...
        ArraysKt.sortWith(viewArr, topsComparator);
        Rect rect2 = rectByView.get(viewArr[0]);
        Intrinsics.checkNotNull(rect2);
        int i3 = rect2.bottom;
        rtlMult = z ? -1 : 1;
        int i4 = 0;
        for (int i5 = 0; i5 < length; i5++) {
            Rect rect3 = rectByView.get(viewArr[i5]);
            Intrinsics.checkNotNull(rect3);
            Rect rect4 = rect3;
            if (rect4.top >= i3) {
                if (i5 - i4 > 1) {
                    ArraysKt.sortWith(viewArr, sidesComparator, i4, i5);
                }
                i3 = rect4.bottom;
                i4 = i5;
            } else {
        ...
        if (length - i4 > 1) {
            ArraysKt.sortWith(viewArr, sidesComparator, i4, length);
        }
        lastPoolIndex = 0;
        rectByView.clear();
    }
