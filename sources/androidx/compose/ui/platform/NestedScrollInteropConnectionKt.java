...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final int m6443toViewTypeGyEprt8(int i) {
        return !NestedScrollSource.m5720equalsimpl0(i, NestedScrollSource.Companion.m5732getUserInputWNlRxjI()) ? 1 : 0;
    }

    /* renamed from: scrollAxes-sF-c-tU  reason: not valid java name */
    private static final int m6441scrollAxessFctU(long j, float f) {
        int i = Math.abs(Velocity.m7502getXimpl(j)) >= f ? 1 : 0;
        return Math.abs(Velocity.m7503getYimpl(j)) >= f ? i | 2 : i;
    }
    ...
    public static final long m6442toOffsetUv8p0NA(int[] iArr, long j) {
        float coerceAtLeast;
        ...
        return Offset.m4297constructorimpl((Float.floatToRawIntBits(coerceAtLeast) << 32) | (Float.floatToRawIntBits(coerceAtLeast2) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getScrollAxes-k-4lQ0M  reason: not valid java name */
    public static final int m6440getScrollAxesk4lQ0M(long j) {
