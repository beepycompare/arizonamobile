...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final int m6430toViewTypeGyEprt8(int i) {
        return !NestedScrollSource.m5707equalsimpl0(i, NestedScrollSource.Companion.m5719getUserInputWNlRxjI()) ? 1 : 0;
    }

    /* renamed from: scrollAxes-sF-c-tU  reason: not valid java name */
    private static final int m6428scrollAxessFctU(long j, float f) {
        int i = Math.abs(Velocity.m7489getXimpl(j)) >= f ? 1 : 0;
        return Math.abs(Velocity.m7490getYimpl(j)) >= f ? i | 2 : i;
    }
    ...
    public static final long m6429toOffsetUv8p0NA(int[] iArr, long j) {
        float coerceAtLeast;
        ...
        return Offset.m4285constructorimpl((Float.floatToRawIntBits(coerceAtLeast) << 32) | (Float.floatToRawIntBits(coerceAtLeast2) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getScrollAxes-k-4lQ0M  reason: not valid java name */
    public static final int m6427getScrollAxesk4lQ0M(long j) {
