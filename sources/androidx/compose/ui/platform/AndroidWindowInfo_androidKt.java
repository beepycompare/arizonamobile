...
public final class AndroidWindowInfo_androidKt {
    ...
    public static final long calculateWindowSize(AndroidComposeView androidComposeView) {
        ...
        if (findActivity != null) {
            ...
            return IntSize.m8161constructorimpl((currentWindowBounds.height() & 4294967295L) | (width << 32));
        }
        Configuration configuration = context.getResources().getConfiguration();
        float f = context.getResources().getDisplayMetrics().density;
        int round = Math.round(configuration.screenWidthDp * f);
        return IntSize.m8161constructorimpl((Math.round(configuration.screenHeightDp * f) & 4294967295L) | (round << 32));
    }
