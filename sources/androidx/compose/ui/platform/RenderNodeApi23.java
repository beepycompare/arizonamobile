...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m5437getAutoNrFUSI();
    ...
    public int mo7296getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo7298setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo5223setBlendModes9anfk8(i);
    ...
    public int mo7297getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo7299setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        ...
        if (requiresCompositingLayer) {
            m7352applyCompositingStrategyQu9p0E8(renderNode, CompositingStrategy.Companion.m5439getOffscreenNrFUSI());
        } else {
            m7352applyCompositingStrategyQu9p0E8(renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5433equalsimpl0(mo7297getCompositingStrategyNrFUSI(), CompositingStrategy.Companion.m5439getOffscreenNrFUSI()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m5257equalsimpl0(mo7296getBlendMode0nO6VwU(), BlendMode.Companion.m5288getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    private final void m7352applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        if (CompositingStrategy.m5433equalsimpl0(i, CompositingStrategy.Companion.m5439getOffscreenNrFUSI())) {
            renderNode.setLayerType(2);
            Paint paint = this.layerPaint;
            renderNode.setLayerPaint(paint != null ? AndroidPaint_androidKt.getNativePaint(paint) : null);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m5433equalsimpl0(i, CompositingStrategy.Companion.m5438getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui() {
        return CompositingStrategy.m5433equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m5439getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> function1) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m5319clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
