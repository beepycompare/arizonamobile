...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m4167getAutoNrFUSI();
    ...
    public int mo5837getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo5838setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4163equalsimpl0(i, CompositingStrategy.Companion.m4169getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4163equalsimpl0(i, CompositingStrategy.Companion.m4168getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4163equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m4169getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> function1) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m4049clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
