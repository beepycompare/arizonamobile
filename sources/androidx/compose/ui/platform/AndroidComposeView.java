...
public final class AndroidComposeView extends ViewGroup implements Owner, PlatformFocusOwner, ViewRootForTest, MatrixPositionCalculator, DefaultLifecycleObserver, OutOfFrameExecutor {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = Offset.Companion.m5051getUnspecifiedF1C5BW0();
        ...
        Modifier onKeyEvent = KeyInputModifierKt.onKeyEvent(Modifier.Companion, new Function1<KeyEvent, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m7101invokeZmokQxo(keyEvent.m6415unboximpl());
            }

            /* renamed from: invoke-ZmokQxo  reason: not valid java name */
            public final Boolean m7101invokeZmokQxo(android.view.KeyEvent keyEvent) {
                View findNextNonChildView;
                final FocusDirection m4928toFocusDirectionZmokQxo = FocusInteropUtils_androidKt.m4928toFocusDirectionZmokQxo(keyEvent);
                if (m4928toFocusDirectionZmokQxo == null || !KeyEventType.m6419equalsimpl0(KeyEvent_androidKt.m6427getTypeZmokQxo(keyEvent), KeyEventType.Companion.m6423getKeyDownCS__XNY())) {
                    return false;
                }
                Integer m4927toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4927toAndroidFocusDirection3ESFkO8(m4928toFocusDirectionZmokQxo.m4918unboximpl());
                if (ComposeUiFlags.isViewFocusFixEnabled && AndroidComposeView.this.hasFocus() && m4927toAndroidFocusDirection3ESFkO8 != null && AndroidComposeView.this.mo4977moveFocusInChildren3ESFkO8(m4928toFocusDirectionZmokQxo.m4918unboximpl())) {
                    return true;
                }
                Rect embeddedViewFocusRect = AndroidComposeView.this.getEmbeddedViewFocusRect();
                Boolean mo4934focusSearchULY8qGw = AndroidComposeView.this.getFocusOwner().mo4934focusSearchULY8qGw(m4928toFocusDirectionZmokQxo.m4918unboximpl(), embeddedViewFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    {
                        super(1);
                    }
                    ...
                    public final Boolean invoke(FocusTargetNode focusTargetNode) {
                        return Boolean.valueOf(focusTargetNode.mo4947requestFocus3ESFkO8(FocusDirection.this.m4918unboximpl()));
                    }
                });
                if (mo4934focusSearchULY8qGw != null ? mo4934focusSearchULY8qGw.booleanValue() : true) {
                    return true;
                }
                if (!FocusOwnerImplKt.m4940is1dFocusSearch3ESFkO8(m4928toFocusDirectionZmokQxo.m4918unboximpl())) {
                    return false;
                }
                if (m4927toAndroidFocusDirection3ESFkO8 != null) {
                    findNextNonChildView = AndroidComposeView.this.findNextNonChildView(m4927toAndroidFocusDirection3ESFkO8.intValue());
                    ...
                    if (findNextNonChildView != null) {
                        ...
                        if (FocusInteropUtils_androidKt.requestInteropFocus(findNextNonChildView, m4927toAndroidFocusDirection3ESFkO8, androidRect)) {
                            return true;
                        }
                    }
                }
                if (!AndroidComposeView.this.getFocusOwner().mo4931clearFocusI7lrPNg(false, true, false, m4928toFocusDirectionZmokQxo.m4918unboximpl())) {
                    return true;
                }
                Boolean mo4934focusSearchULY8qGw2 = AndroidComposeView.this.getFocusOwner().mo4934focusSearchULY8qGw(m4928toFocusDirectionZmokQxo.m4918unboximpl(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                    {
                        super(1);
                    }
                ...
                return Boolean.valueOf(mo4934focusSearchULY8qGw2 != null ? mo4934focusSearchULY8qGw2.booleanValue() : true);
            }
        });
        ...
        this.globalPosition = IntOffset.m8118constructorimpl((j & 4294967295L) | (j << 32));
        this.tmpPositionArray = new int[]{0, 0};
        float[] m5522constructorimpl$default = Matrix.m5522constructorimpl$default(null, 1, null);
        this.tmpMatrix = m5522constructorimpl$default;
        this.viewToWindowMatrix = Matrix.m5522constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m5522constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.Companion.m5050getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m4773constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.Companion.m6096getTouchaOaMEAU() : InputMode.Companion.m6095getKeyboardaOaMEAU(), new Function1<InputMode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(InputMode inputMode) {
                return m7099invokeiuPiT84(inputMode.m6094unboximpl());
            }

            /* renamed from: invoke-iuPiT84  reason: not valid java name */
            public final Boolean m7099invokeiuPiT84(int i) {
                boolean requestFocusFromTouch;
                if (InputMode.m6091equalsimpl0(i, InputMode.Companion.m6096getTouchaOaMEAU())) {
                    requestFocusFromTouch = AndroidComposeView.this.isInTouchMode();
                } else {
                    requestFocusFromTouch = InputMode.m6091equalsimpl0(i, InputMode.Companion.m6095getKeyboardaOaMEAU()) ? AndroidComposeView.this.isInTouchMode() ? AndroidComposeView.this.requestFocusFromTouch() : true : false;
                }
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(m5522constructorimpl$default, null) : new CalculateMatrixToWindowApi29();
        ...
        while (mutableVector.getSize() != 0) {
            ...
            if ((node2.getAggregateChildKindSet$ui_release() & m6989constructorimpl) != 0) {
                for (Modifier.Node node3 = node2; node3 != null; node3 = node3.getChild$ui_release()) {
                    if ((node3.getKindSet$ui_release() & m6989constructorimpl) != 0) {
                        ...
                        while (node4 != null) {
                            ...
                            } else if ((node4.getKindSet$ui_release() & m6989constructorimpl) != 0 && (node4 instanceof DelegatingNode)) {
                                int i = 0;
    ...
    public boolean mo4977moveFocusInChildren3ESFkO8(int i) {
        AndroidViewsHandler androidViewsHandler;
        View findNextFocusFromRect;
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4920getEnterdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4921getExitdhqQ8s())) {
                return false;
            }
            Integer m4927toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4927toAndroidFocusDirection3ESFkO8(i);
            if (m4927toAndroidFocusDirection3ESFkO8 == null) {
                throw new IllegalStateException("Invalid focus direction".toString());
            }
            int intValue = m4927toAndroidFocusDirection3ESFkO8.intValue();
            ...
            return false;
        } else if (FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4920getEnterdhqQ8s()) || FocusDirection.m4915equalsimpl0(i, FocusDirection.Companion.m4921getExitdhqQ8s()) || !hasFocus() || (androidViewsHandler = this._androidViewsHandler) == null) {
            return false;
        } else {
            Integer m4927toAndroidFocusDirection3ESFkO82 = FocusInteropUtils_androidKt.m4927toAndroidFocusDirection3ESFkO8(i);
            if (m4927toAndroidFocusDirection3ESFkO82 == null) {
                throw new IllegalStateException("Invalid focus direction".toString());
            }
            int intValue2 = m4927toAndroidFocusDirection3ESFkO82.intValue();
            ...
            if (!FocusOwnerImplKt.m4940is1dFocusSearch3ESFkO8(i) || !androidViewsHandler.hasFocus()) {
    ...
    public static final void touchModeChangeListener$lambda$8(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m6099setInputModeiuPiT84(z ? InputMode.Companion.m6096getTouchaOaMEAU() : InputMode.Companion.m6095getKeyboardaOaMEAU());
    }
    ...
    */
        ...
        if (continuation instanceof AndroidComposeView$textInputSession$1) {
            ...
            if ((androidComposeView$textInputSession$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (SessionMutex.m4780withSessionCancellingPreviousimpl(this.textInputSessionMutex, new Function1<CoroutineScope, AndroidPlatformTextInputSession>() { // from class: androidx.compose.ui.platform.AndroidComposeView$textInputSession$2
                        /* JADX INFO: Access modifiers changed from: package-private */
                        {
                            super(1);
                        }
    ...
    public static final void sendHoverExitEvent$lambda$10(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m7096sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public void getFocusedRect(android.graphics.Rect rect) {
        ...
        } else if (!Intrinsics.areEqual((Object) getFocusOwner().mo4934focusSearchULY8qGw(FocusDirection.Companion.m4919getDowndhqQ8s(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$getFocusedRect$1
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                return true;
            }
    ...
    public View focusSearch(View view, int i) {
        ...
        int m4918unboximpl = focusDirection != null ? focusDirection.m4918unboximpl() : FocusDirection.Companion.m4919getDowndhqQ8s();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        if (getFocusOwner().mo4934focusSearchULY8qGw(m4918unboximpl, calculateBoundingRectRelativeTo, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$searchResult$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            if (objectRef.element == 0) {
                ...
                if (FocusOwnerImplKt.m4940is1dFocusSearch3ESFkO8(m4918unboximpl)) {
                    return super.focusSearch(view, i);
                }
                AndroidComposeView androidComposeView = this;
                if (TwoDimensionalFocusSearchKt.m4984isBetterCandidateI7lrPNg(FocusTraversalKt.focusRect((FocusTargetNode) objectRef.element), FocusInteropUtils_androidKt.calculateBoundingRectRelativeTo(findNextFocus, androidComposeView), calculateBoundingRectRelativeTo, m4918unboximpl)) {
    ...
    public boolean requestFocus(int i, android.graphics.Rect rect) {
        ...
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            ...
            FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(i);
            final int m4918unboximpl = focusDirection != null ? focusDirection.m4918unboximpl() : FocusDirection.Companion.m4920getEnterdhqQ8s();
            return Intrinsics.areEqual((Object) getFocusOwner().mo4934focusSearchULY8qGw(m4918unboximpl, rect != null ? RectHelper_androidKt.toComposeRect(rect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return Boolean.valueOf(focusTargetNode.mo4947requestFocus3ESFkO8(m4918unboximpl));
                }
            }), (Object) true);
        } else if (isFocused()) {
            return true;
            ...
            final int m4918unboximpl2 = focusDirection2 != null ? focusDirection2.m4918unboximpl() : FocusDirection.Companion.m4920getEnterdhqQ8s();
            if (hasFocus() && mo4977moveFocusInChildren3ESFkO8(m4918unboximpl2)) {
                return true;
            }
            final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
            Boolean mo4934focusSearchULY8qGw = getFocusOwner().mo4934focusSearchULY8qGw(m4918unboximpl2, rect != null ? RectHelper_androidKt.toComposeRect(rect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$focusSearchResult$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    ...
                    return Boolean.valueOf(focusTargetNode.mo4947requestFocus3ESFkO8(m4918unboximpl2));
                }
            });
            if (mo4934focusSearchULY8qGw == null) {
                return false;
            }
            if (mo4934focusSearchULY8qGw.booleanValue()) {
                return true;
            }
            if (booleanRef.element) {
                return false;
            }
            if ((rect != null && !hasFocus() && Intrinsics.areEqual((Object) getFocusOwner().mo4934focusSearchULY8qGw(m4918unboximpl2, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$altFocus$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
    ...
    public boolean mo4978requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect rect) {
        Integer m4927toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (m4927toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m4927toAndroidFocusDirection3ESFkO8(focusDirection.m4918unboximpl())) == null) ? TsExtractor.TS_STREAM_TYPE_HDMV_DTS : m4927toAndroidFocusDirection3ESFkO8.intValue(), rect != null ? RectHelper_androidKt.toAndroidRect(rect) : null);
    }
    ...
    public boolean mo7053sendKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        return getFocusOwner().mo4932dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m4930dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }
    ...
    public boolean dispatchKeyEvent(final android.view.KeyEvent keyEvent) {
        if (isFocused()) {
            this._windowInfo.m7153setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m6632constructorimpl(keyEvent.getMetaState()));
            return FocusOwner.m4930dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m6410constructorimpl(keyEvent), null, 2, null) || super.dispatchKeyEvent(keyEvent);
        }
        return getFocusOwner().mo4933dispatchKeyEventYhN2O0w(KeyEvent.m6410constructorimpl(keyEvent), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$dispatchKeyEvent$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent keyEvent) {
        return (isFocused() && getFocusOwner().mo4932dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m6410constructorimpl(keyEvent))) || super.dispatchKeyEventPreIme(keyEvent);
    }
    ...
    public final boolean m7097startDrag12SF9DM(DragAndDropTransferData dragAndDropTransferData, long j, Function1<? super DrawScope, Unit> function1) {
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                while (true) {
                    if (parent$ui_release == null) {
                        ...
                        break;
                    } else if (parent$ui_release.getNodes$ui_release().m6950hasH91voCI$ui_release(NodeKind.m6989constructorimpl(8))) {
                        break;
                    } else {
    ...
    public void mo7052measureAndLayout0kLqBqw(LayoutNode layoutNode, long j) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m6937measureAndLayout0kLqBqw(layoutNode, j);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        try {
            ...
            long m7093convertMeasureSpecI7RO_PI = m7093convertMeasureSpecI7RO_PI(i);
            long m7093convertMeasureSpecI7RO_PI2 = m7093convertMeasureSpecI7RO_PI(i2);
            long m7957fitPrioritizingHeightZbe2FdA = Constraints.Companion.m7957fitPrioritizingHeightZbe2FdA((int) ULong.m10080constructorimpl(m7093convertMeasureSpecI7RO_PI >>> 32), (int) ULong.m10080constructorimpl(m7093convertMeasureSpecI7RO_PI & 4294967295L), (int) ULong.m10080constructorimpl(m7093convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m10080constructorimpl(4294967295L & m7093convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean z = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m7936boximpl(m7957fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    z = Constraints.m7942equalsimpl0(constraints.m7955unboximpl(), m7957fitPrioritizingHeightZbe2FdA);
                }
                if (!z) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m6938updateRootConstraintsBRTryo0(m7957fitPrioritizingHeightZbe2FdA);
    ...
    private final int m7091component1VKZWuLQ(long j) {
        return (int) ULong.m10080constructorimpl(j >>> 32);
    }

    /* renamed from: component2-VKZWuLQ  reason: not valid java name */
    private final int m7092component2VKZWuLQ(long j) {
        return (int) ULong.m10080constructorimpl(j & 4294967295L);
    }

    /* renamed from: pack-ZIaKswc  reason: not valid java name */
    private final long m7095packZIaKswc(int i, int i2) {
        return ULong.m10080constructorimpl(ULong.m10080constructorimpl(i2) | ULong.m10080constructorimpl(ULong.m10080constructorimpl(i) << 32));
    }

    /* renamed from: convertMeasureSpec-I7RO_PI  reason: not valid java name */
    private final long m7093convertMeasureSpecI7RO_PI(int i) {
        int mode = View.MeasureSpec.getMode(i);
        int size = View.MeasureSpec.getSize(i);
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode == 1073741824) {
                    return m7095packZIaKswc(size, size);
                }
                throw new IllegalStateException();
            }
            return m7095packZIaKswc(0, Integer.MAX_VALUE);
        }
        return m7095packZIaKswc(0, size);
    }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        boolean z = false;
        int i = iArr[0];
        if (m8124getXimpl != i || m8125getYimpl != iArr[1] || this.lastMatrixRecalculationAnimationTime < 0) {
            this.globalPosition = IntOffset.m8118constructorimpl((i << 32) | (iArr[1] & 4294967295L));
            if (m8124getXimpl != Integer.MAX_VALUE && m8125getYimpl != Integer.MAX_VALUE) {
        ...
        getRectManager().m7228updateOffsetsgTq6Wqs(this.globalPosition, IntOffsetKt.m8141roundk4lQ0M(this.windowPosition), this.viewToWindowMatrix, view.getWidth(), view.getHeight());
    ...
    protected void onAttachedToWindow() {
        ...
        this._windowInfo.setOnInitializeContainerSize(new Function0<IntSize>() { // from class: androidx.compose.ui.platform.AndroidComposeView$onAttachedToWindow$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke() {
                return IntSize.m8159boximpl(m7102invokeYbymL2g());
            }

            /* renamed from: invoke-YbymL2g  reason: not valid java name */
            public final long m7102invokeYbymL2g() {
        ...
        this._inputModeManager.m6099setInputModeiuPiT84(isInTouchMode() ? InputMode.Companion.m6096getTouchaOaMEAU() : InputMode.Companion.m6095getKeyboardaOaMEAU());
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return (m7094handleMotionEvent8iAsVTc(motionEvent) & 1) != 0;
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int m7094handleMotionEvent8iAsVTc = m7094handleMotionEvent8iAsVTc(motionEvent);
        if ((m7094handleMotionEvent8iAsVTc & 2) != 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return (m7094handleMotionEvent8iAsVTc & 1) != 0;
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final int m7094handleMotionEvent8iAsVTc(MotionEvent motionEvent) {
        ...
        try {
            ...
            try {
                    ...
                    try {
                        if (hasChangedDevices(motionEvent, motionEvent5)) {
                            if (isDevicePressEvent(motionEvent5)) {
                                ...
                                int m7096sendMotionEvent8iAsVTc = m7096sendMotionEvent8iAsVTc(motionEvent);
                                Trace.endSection();
                                androidComposeView.forceUseMatrixCache = false;
                                return m7096sendMotionEvent8iAsVTc;
                            }
                        }
                    } catch (Throwable th) {
                        th = th;
                ...
                androidComposeView.previousMotionEvent = MotionEvent.obtainNoHistory(motionEvent);
                int m7096sendMotionEvent8iAsVTc2 = m7096sendMotionEvent8iAsVTc(motionEvent);
                Trace.endSection();
                androidComposeView.forceUseMatrixCache = false;
                return m7096sendMotionEvent8iAsVTc2;
            } catch (Throwable th2) {
                th = th2;
            }
        } catch (Throwable th3) {
    ...
    private final int m7096sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m7153setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m6632constructorimpl(motionEvent.getMetaState()));
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (convertToPointerInputEvent$ui_release != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m6586getPositionF1C5BW0();
            }
            int m6591processBIzXfog = this.pointerInputEventProcessor.m6591processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, isInBounds(motionEvent));
            convertToPointerInputEvent$ui_release.setMotionEvent(null);
            int actionMasked = motionEvent.getActionMasked();
            if ((actionMasked == 0 || actionMasked == 5) && (m6591processBIzXfog & 1) == 0) {
                this.motionEventAdapter.endStream(motionEvent.getPointerId(motionEvent.getActionIndex()));
                return m6591processBIzXfog;
            }
            return m6591processBIzXfog;
        }
        this.pointerInputEventProcessor.processCancel();
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int i, long j, boolean z) {
        ...
        while (i5 < pointerCount) {
            ...
            long mo6650localToScreenMKHz9U = mo6650localToScreenMKHz9U(Offset.m5028constructorimpl((Float.floatToRawIntBits(pointerCoords.y) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)));
            pointerCoords.x = Float.intBitsToFloat((int) (mo6650localToScreenMKHz9U >> 32));
            pointerCoords.y = Float.intBitsToFloat((int) (mo6650localToScreenMKHz9U & 4294967295L));
            i5++;
        }
        ...
        this.pointerInputEventProcessor.m6591processBIzXfog(convertToPointerInputEvent$ui_release, androidComposeView, true);
        obtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int i) {
        return this.composeAccessibilityDelegate.m7107canScroll0AR0LA0$ui_release(false, i, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int i) {
        return this.composeAccessibilityDelegate.m7107canScroll0AR0LA0$ui_release(true, i, this.lastDownPointerPosition);
    }
    ...
    public long mo6650localToScreenMKHz9U(long j) {
        recalculateWindowPosition();
        long m5528mapMKHz9U = Matrix.m5528mapMKHz9U(this.viewToWindowMatrix, j);
        return Offset.m5028constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (m5528mapMKHz9U & 4294967295L)) + Float.intBitsToFloat((int) (this.windowPosition & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits(Float.intBitsToFloat((int) (m5528mapMKHz9U >> 32)) + Float.intBitsToFloat((int) (this.windowPosition >> 32))) << 32));
    }

    @Override // androidx.compose.ui.input.pointer.MatrixPositionCalculator
    /* renamed from: localToScreen-58bKbWc */
    public void mo6499localToScreen58bKbWc(float[] fArr) {
        recalculateWindowPosition();
        Matrix.m5541timesAssign58bKbWc(fArr, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m7109access$preTranslatecG2Xzmc(fArr, Float.intBitsToFloat((int) (this.windowPosition >> 32)), Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* renamed from: screenToLocal-MK-Hz9U */
    public long mo6651screenToLocalMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m5528mapMKHz9U(this.windowToViewMatrix, Offset.m5028constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (j >> 32)) - Float.intBitsToFloat((int) (this.windowPosition >> 32))) << 32) | (4294967295L & Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L)) - Float.intBitsToFloat((int) (this.windowPosition & 4294967295L))))));
    }
    ...
    private final void recalculateWindowPosition() {
        ...
        if (currentAnimationTimeMillis != this.lastMatrixRecalculationAnimationTime) {
            ...
            this.windowPosition = Offset.m5028constructorimpl((Float.floatToRawIntBits(iArr[0] - iArr2[0]) << 32) | (Float.floatToRawIntBits(iArr[1] - iArr2[1]) & 4294967295L));
        }
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX();
        float y = motionEvent.getY();
        long m5528mapMKHz9U = Matrix.m5528mapMKHz9U(fArr, Offset.m5028constructorimpl((Float.floatToRawIntBits(y) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)));
        this.windowPosition = Offset.m5028constructorimpl((Float.floatToRawIntBits(motionEvent.getRawX() - Float.intBitsToFloat((int) (m5528mapMKHz9U >> 32))) << 32) | (Float.floatToRawIntBits(motionEvent.getRawY() - Float.intBitsToFloat((int) (m5528mapMKHz9U & 4294967295L))) & 4294967295L));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo7113calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m7145invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    private final void updateWindowMetrics() {
        ...
        if (access$get_containerSize$p != null) {
            access$get_containerSize$p.setValue(IntSize.m8159boximpl(AndroidWindowInfo_androidKt.calculateWindowSize(this)));
        }
    }

    @Override // android.view.View
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m4777getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo7049calculateLocalPositionMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m5528mapMKHz9U(this.windowToViewMatrix, j);
    }

    @Override // androidx.compose.ui.node.Owner
    /* renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo7050calculatePositionInWindowMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m5528mapMKHz9U(this.viewToWindowMatrix, j);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent motionEvent) {
        ...
        if (!isBadMotionEvent(motionEvent) && isAttachedToWindow()) {
            ...
            if ((m7094handleMotionEvent8iAsVTc(motionEvent) & 1) != 0) {
                return true;
            }
        }
        return false;
    ...
    public void mo7051dispatchOnScrollChangedk4lQ0M(long j) {
