...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                if (decodeByte != 2) {
                    if (decodeByte != 3) {
                        if (decodeByte != 4) {
                            if (decodeByte != 5) {
                                        ...
                                        if (decodeByte != 8) {
                                            if (decodeByte != 9) {
                                                if (decodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m7161setBackground8_81llA(m7120decodeColor0d7_KjU());
                                                }
                                            } else if (dataAvailable() < 8) {
                                                break;
                                            } else {
                                            ...
                                            mutableSpanStyle.m7162setBaselineShift_isdbwI(BaselineShift.m7752boximpl(m7118decodeBaselineShifty9eOQZs()));
                                        }
                                    } else if (dataAvailable() < 5) {
                                        break;
                                    } else {
                                        mutableSpanStyle.m7167setLetterSpacingR2X_6o(m7123decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m7166setFontSynthesistDdu0R4(FontSynthesis.m7579boximpl(m7122decodeFontSynthesisGVVA2EU()));
                            }
                        } else if (dataAvailable() < 1) {
                            break;
                        } else {
                            mutableSpanStyle.m7165setFontStylemLjRB2g(FontStyle.m7568boximpl(m7121decodeFontStyle_LCdwA()));
                        }
                    } else if (dataAvailable() < 4) {
                        break;
                    } else {
                    ...
                    mutableSpanStyle.m7164setFontSizeR2X_6o(m7123decodeTextUnitXSAIIZE());
                }
            } else if (dataAvailable() < 8) {
                break;
            } else {
                mutableSpanStyle.m7163setColor8_81llA(m7120decodeColor0d7_KjU());
            }
        }
    ...
    public final long m7120decodeColor0d7_KjU() {
        return AndroidColor_androidKt.fromColorLong(Color.Companion, this.parcel.readLong());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m7123decodeTextUnitXSAIIZE() {
        long m8224getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m8224getUnspecifiedUIouoOA = TextUnitType.Companion.m8223getSpUIouoOA();
        } else if (decodeByte == 2) {
            m8224getUnspecifiedUIouoOA = TextUnitType.Companion.m8222getEmUIouoOA();
        } else {
            m8224getUnspecifiedUIouoOA = TextUnitType.Companion.m8224getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m8218equalsimpl0(m8224getUnspecifiedUIouoOA, TextUnitType.Companion.m8224getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m8201getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m8202TextUnitanM5pPY(decodeFloat(), m8224getUnspecifiedUIouoOA);
    }
    ...
    public final int m7121decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.Companion.m7578getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.Companion.m7577getItalic_LCdwA();
        }
        return FontStyle.Companion.m7578getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m7122decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.Companion.m7589getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.Companion.m7588getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.Companion.m7590getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.Companion.m7591getWeightGVVA2EU();
        }
        return FontSynthesis.Companion.m7589getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m7118decodeBaselineShifty9eOQZs() {
        return BaselineShift.m7753constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long m7120decodeColor0d7_KjU = m7120decodeColor0d7_KjU();
        float decodeFloat = decodeFloat();
        float decodeFloat2 = decodeFloat();
        return new Shadow(m7120decodeColor0d7_KjU, Offset.m5028constructorimpl((Float.floatToRawIntBits(decodeFloat2) & 4294967295L) | (Float.floatToRawIntBits(decodeFloat) << 32)), decodeFloat(), null);
    }
    ...
    private final long m7119decodeULongsVKNKU() {
        return ULong.m10083constructorimpl(this.parcel.readLong());
    }
