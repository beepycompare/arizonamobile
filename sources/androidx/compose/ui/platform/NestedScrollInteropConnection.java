...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo1150onPreScrollOzD1aCk(long j, int i) {
        int m7345getScrollAxesk4lQ0M;
        int m7348toViewTypeGyEprt8;
        int m7348toViewTypeGyEprt82;
        long m7347toOffsetmoWRBKg;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m7345getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m7345getScrollAxesk4lQ0M(j);
        m7348toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m7348toViewTypeGyEprt8(i);
        if (nestedScrollingChildHelper.startNestedScroll(m7345getScrollAxesk4lQ0M, m7348toViewTypeGyEprt8)) {
            ...
            m7348toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m7348toViewTypeGyEprt8(i);
            nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m7348toViewTypeGyEprt82);
            m7347toOffsetmoWRBKg = NestedScrollInteropConnectionKt.m7347toOffsetmoWRBKg(composeToViewOffset, composeToViewOffset2, this.consumedScrollCache, j);
            return m7347toOffsetmoWRBKg;
        }
    ...
    public long mo603onPostScrollDzOQY0M(long j, long j2, int i) {
        ...
        long m7347toOffsetmoWRBKg;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m7345getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m7345getScrollAxesk4lQ0M(j2);
        m7348toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m7348toViewTypeGyEprt8(i);
        if (nestedScrollingChildHelper.startNestedScroll(m7345getScrollAxesk4lQ0M, m7348toViewTypeGyEprt8)) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            int composeToViewOffset = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (j2 >> 32)));
            int composeToViewOffset2 = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (j2 & 4294967295L)));
            NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
            int composeToViewOffset3 = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (j >> 32)));
            int composeToViewOffset4 = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (j & 4294967295L)));
            m7348toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m7348toViewTypeGyEprt8(i);
            nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset3, composeToViewOffset4, composeToViewOffset, composeToViewOffset2, null, m7348toViewTypeGyEprt82, this.consumedScrollCache);
            m7347toOffsetmoWRBKg = NestedScrollInteropConnectionKt.m7347toOffsetmoWRBKg(composeToViewOffset, composeToViewOffset2, this.consumedScrollCache, j2);
            return m7347toOffsetmoWRBKg;
        }
        return Offset.Companion.m5119getZeroF1C5BW0();
    }
    ...
    public Object mo1149onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        ...
        float viewVelocity4;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8398getXimpl(j));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8399getYimpl(j));
        if (!nestedScrollingChildHelper.dispatchNestedPreFling(viewVelocity, viewVelocity2)) {
            NestedScrollingChildHelper nestedScrollingChildHelper2 = this.nestedScrollChildHelper;
            viewVelocity3 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8398getXimpl(j));
            viewVelocity4 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8399getYimpl(j));
            if (!nestedScrollingChildHelper2.dispatchNestedFling(viewVelocity3, viewVelocity4, true)) {
                j = Velocity.Companion.m8409getZero9UxMQ8M();
            }
        }
        return Velocity.m8389boximpl(j);
    }
