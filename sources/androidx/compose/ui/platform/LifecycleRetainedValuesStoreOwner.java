...
public final class LifecycleRetainedValuesStoreOwner extends ViewModel {
    ...
    public final RetainedValuesStoreEntry getOrCreateRetainedValuesStoreEntry(int i) {
        ...
        MutableObjectList<RetainedValuesStoreEntry> mutableObjectList = mutableIntObjectMap.get(i);
        ...
        RetainedValuesStoreEntry retainedValuesStoreEntry2 = retainedValuesStoreEntry;
        if (retainedValuesStoreEntry2 == null) {
            retainedValuesStoreEntry2 = new RetainedValuesStoreEntry();
            mutableObjectList2.add(retainedValuesStoreEntry2);
        }
        retainedValuesStoreEntry2.setInUse(true);
        return retainedValuesStoreEntry2;
    }
