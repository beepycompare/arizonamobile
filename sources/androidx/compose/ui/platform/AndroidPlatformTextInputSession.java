...
public final class AndroidPlatformTextInputSession implements PlatformTextInputSessionScope, CoroutineScope {
    ...
    private final AtomicReference<SessionMutex.Session<T>> methodSessionMutex = SessionMutex.m4772constructorimpl();
    ...
    public final boolean isReadyForConnection() {
        InputMethodSession inputMethodSession = (InputMethodSession) SessionMutex.m4776getCurrentSessionimpl(this.methodSessionMutex);
        ...
        if (continuation instanceof AndroidPlatformTextInputSession$startInputMethod$1) {
            ...
            if ((androidPlatformTextInputSession$startInputMethod$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (SessionMutex.m4779withSessionCancellingPreviousimpl(this.methodSessionMutex, new Function1<CoroutineScope, InputMethodSession>() { // from class: androidx.compose.ui.platform.AndroidPlatformTextInputSession$startInputMethod$2
