...
public final class EncodeHelper {
    ...
    public final void encode(SpanStyle spanStyle) {
        ...
        if (m6946getFontStyle4Lr2A7w != null) {
            ...
            encode((byte) 4);
            m6709encodenzbMABs(m7118unboximpl);
        }
        ...
        if (m6947getFontSynthesisZQGJjVo != null) {
            ...
            encode((byte) 5);
            m6706encode6p3vJLY(m7131unboximpl);
        }
        ...
        if (!TextUnit.m7746equalsimpl0(spanStyle.m6948getLetterSpacingXSAIIZE(), TextUnit.Companion.m7760getUnspecifiedXSAIIZE())) {
            encode((byte) 7);
            m6704encodeR2X_6o(spanStyle.m6948getLetterSpacingXSAIIZE());
        }
        ...
        if (m6943getBaselineShift5SSeXJ0 != null) {
            ...
            encode((byte) 8);
            m6705encode4Dl_Bck(m7301unboximpl);
        }
        ...
        if (!Color.m4773equalsimpl0(spanStyle.m6942getBackground0d7_KjU(), Color.Companion.m4808getUnspecified0d7_KjU())) {
            encode((byte) 10);
            m6707encode8_81llA(spanStyle.m6942getBackground0d7_KjU());
        }
    ...
    public final void m6707encode8_81llA(long j) {
        m6708encodeVKZWuLQ(ULong.m9381constructorimpl(AndroidColor_androidKt.m4635toColorLong8_81llA(j)));
    }

    /* renamed from: encode--R2X_6o  reason: not valid java name */
    public final void m6704encodeR2X_6o(long j) {
    ...
    public final void m6709encodenzbMABs(int i) {
        byte b = 0;
    ...
    public final void m6706encode6p3vJLY(int i) {
        byte b = 0;
    ...
    public final void m6705encode4Dl_Bck(float f) {
        encode(f);
    }
    ...
    public final void encode(Shadow shadow) {
        m6707encode8_81llA(shadow.m5116getColor0d7_KjU());
    ...
    public final void m6708encodeVKZWuLQ(long j) {
