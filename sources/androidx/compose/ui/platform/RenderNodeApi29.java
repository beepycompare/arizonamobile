...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m5437getAutoNrFUSI();
    ...
    private final void updateLayerProperties() {
        ...
        if (requiresCompositingLayer) {
            m7353applyCompositingStrategyQu9p0E8(renderNode, CompositingStrategy.Companion.m5439getOffscreenNrFUSI());
        } else {
            m7353applyCompositingStrategyQu9p0E8(renderNode, this.internalCompositingStrategy);
        }
    }
    ...
    private final void m7353applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
