...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m4639getAutoNrFUSI();
    ...
    public int mo6393getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setBlendMode-s9anfk8 */
    public void mo6395setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo4425setBlendModes9anfk8(i);
    ...
    public int mo6394getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo6396setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6448applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.Companion.m4641getOffscreenNrFUSI());
        } else {
            m6448applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m4635equalsimpl0(mo6394getCompositingStrategyNrFUSI(), CompositingStrategy.Companion.m4641getOffscreenNrFUSI()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4459equalsimpl0(mo6393getBlendMode0nO6VwU(), BlendMode.Companion.m4490getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    private final void m6448applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        if (CompositingStrategy.m4635equalsimpl0(i, CompositingStrategy.Companion.m4641getOffscreenNrFUSI())) {
            Paint paint = this.layerPaint;
            renderNode.setUseCompositingLayer(true, paint != null ? paint.asFrameworkPaint() : null);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m4635equalsimpl0(i, CompositingStrategy.Companion.m4640getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1<? super Canvas, Unit> function1) {
        ...
        if (path != null) {
            androidCanvas.save();
            Canvas.m4520clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
