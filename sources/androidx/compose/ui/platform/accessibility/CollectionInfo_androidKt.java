    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() <= 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayList.add(Offset.m5025boximpl(Offset.m5028constructorimpl((Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m5066getCenterF1C5BW0() >> 32)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m5066getCenterF1C5BW0() >> 32)))) << 32) | (Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m5066getCenterF1C5BW0() & 4294967295L)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m5066getCenterF1C5BW0() & 4294967295L)))) & 4294967295L))));
                semanticsNode = semanticsNode2;
            }
            list2 = arrayList;
        }
        if (list2.size() == 1) {
            m5046unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) list2)).m5046unboximpl();
        } else {
            if (list2.isEmpty()) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m5025boximpl(Offset.m5041plusMKHz9U(((Offset) first).m5046unboximpl(), ((Offset) list2.get(i2)).m5046unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            m5046unboximpl = ((Offset) first).m5046unboximpl();
        }
        return Float.intBitsToFloat((int) (4294967295L & m5046unboximpl)) < Float.intBitsToFloat((int) (m5046unboximpl >> 32));
    }
