...
public final class DeviceRenderNodeData {
    ...
    public static /* synthetic */ DeviceRenderNodeData m7360copyqCc9W8c$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10, int i11, Object obj) {
        ...
        return deviceRenderNodeData.m7363copyqCc9W8c(j3, i13, i14, i15, i16, i17, i18, f13, f14, f15, f16, f17, i19, i20, f18, f19, f20, f21, f22, f23, z3, z4, f24, renderEffect2, i21, colorFilter2, i12);
    }
    ...
    public final int m7361component250nO6VwU() {
    ...
    public final int m7362component27NrFUSI() {
    ...
    public final DeviceRenderNodeData m7363copyqCc9W8c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10) {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((hashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + BlendMode.m5334hashCodeimpl(this.blendMode)) * 31;
        ColorFilter colorFilter = this.colorFilter;
        return ((hashCode2 + (colorFilter != null ? colorFilter.hashCode() : 0)) * 31) + CompositingStrategy.m5512hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", blendMode=").append((Object) BlendMode.m5335toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(", compositingStrategy=").append((Object) CompositingStrategy.m5513toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m7364getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public final void m7366setBlendModes9anfk8(int i) {
        this.blendMode = i;
    }
    ...
    public final int m7365getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m7367setCompositingStrategyaDBOjCE(int i) {
