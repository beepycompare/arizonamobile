...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo4771alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        long m8326constructorimpl = IntSize.m8326constructorimpl(((((int) (j2 >> 32)) - ((int) (j >> 32))) << 32) | ((((int) (j2 & 4294967295L)) - ((int) (j & 4294967295L))) & 4294967295L));
        int round = Math.round((((int) (m8326constructorimpl >> 32)) / 2.0f) * (this.horizontalBias + 1.0f));
        return IntOffset.m8282constructorimpl((Math.round((((int) (m8326constructorimpl & 4294967295L)) / 2.0f) * (1.0f + this.verticalBias)) & 4294967295L) | (round << 32));
    }
}
