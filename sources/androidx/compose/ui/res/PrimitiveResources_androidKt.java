...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        float m6684constructorimpl = Dp.m6684constructorimpl(Resources_androidKt.resources(composer, 0).getDimension(i) / ((Density) consume).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m6684constructorimpl;
    }
}
