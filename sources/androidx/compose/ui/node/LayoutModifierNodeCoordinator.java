...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet$ui() & NodeKind.m7135constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet$ui() & NodeKind.m7135constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final Constraints m7038getLookaheadConstraintsDWUhwKw$ui() {
        return this.lookaheadConstraints;
    }

    /* renamed from: setLookaheadConstraints-_Sx5XlM$ui  reason: not valid java name */
    public final void m7039setLookaheadConstraints_Sx5XlM$ui(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo6818measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m7068access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, j);
            layoutModifierNodeCoordinator.m7039setLookaheadConstraints_Sx5XlM$ui(Constraints.m8100boximpl(j));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo69measure3p2s80s(this, lookaheadDelegate, j));
    ...
    */
    public Placeable mo6818measureBRTryo0(long j) {
        final MeasureResult mo69measure3p2s80s;
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            boolean z = false;
            approachMeasureScopeImpl.setApproachMeasureRequired$ui(approachNode.mo75isMeasurementApproachInProgressozmzZPI(approachMeasureScopeImpl.mo6796getLookaheadSizeYbymL2g()) || !Constraints.m8105equalsimpl(j, m7038getLookaheadConstraintsDWUhwKw$ui()));
            ...
            mo69measure3p2s80s = approachNode.mo74approachMeasure3p2s80s(approachMeasureScopeImpl, getWrappedNonNull(), j);
            getWrappedNonNull().setForceMeasureWithLookaheadConstraints$ui(false);
            int width = mo69measure3p2s80s.getWidth();
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            if (width == lookaheadDelegate.getWidth()) {
                int height = mo69measure3p2s80s.getHeight();
            ...
            if (!approachMeasureScopeImpl.getApproachMeasureRequired$ui()) {
                long mo6826getSizeYbymL2g = getWrappedNonNull().mo6826getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                if (IntSize.m8328equalsimpl(mo6826getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m8323boximpl(lookaheadDelegate3.m7071getSizeYbymL2g$ui()) : null) && !z) {
                    mo69measure3p2s80s = new MeasureResult(this) { // from class: androidx.compose.ui.node.LayoutModifierNodeCoordinator$measure$1$1$1$1
        ...
        mo69measure3p2s80s = getLayoutModifierNode().mo69measure3p2s80s(this, getWrappedNonNull(), j);
        setMeasureResult$ui(mo69measure3p2s80s);
    ...
    public void mo6881placeAtf8xVGno(long j, float f, GraphicsLayer graphicsLayer) {
        super.mo6881placeAtf8xVGno(j, f, graphicsLayer);
        onAfterPlaceAt();
    }
    ...
    public void mo6819placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        super.mo6819placeAtf8xVGno(j, f, function1);
        onAfterPlaceAt();
    }
    ...
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired$ui()) {
                long j = mo6826getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m8328equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m8323boximpl(lookaheadDelegate2.m7071getSizeYbymL2g$ui()) : null)) {
                    long mo6826getSizeYbymL2g = wrappedNonNull.mo6826getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = wrappedNonNull.getLookaheadDelegate();
                    if (IntSize.m8328equalsimpl(mo6826getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m8323boximpl(lookaheadDelegate3.m7071getSizeYbymL2g$ui()) : null)) {
                        z = true;
    ...
    public void performDraw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        if (IntSize.m8329equalsimpl0(mo6826getSizeYbymL2g(), wrapped$ui.mo6826getSizeYbymL2g()) && IntOffset.m8287equalsimpl0(wrapped$ui.mo7063getPositionnOccac(), IntOffset.Companion.m8299getZeronOccac())) {
            return;
        }
    ...
    static {
        ...
        Paint.mo5224setColor8_81llA(Color.Companion.m5375getBlue0d7_KjU());
