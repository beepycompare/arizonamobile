    ...
    */
    ...
    public final void propagateCoordinator(Modifier.Node node, NodeCoordinator nodeCoordinator) {
        for (Modifier.Node parent$ui = node.getParent$ui(); parent$ui != null; parent$ui = parent$ui.getParent$ui()) {
            if (parent$ui == this.sentinelHead) {
                ...
                return;
            } else if ((NodeKind.m7135constructorimpl(2) & parent$ui.getKindSet$ui()) != 0) {
                return;
            } else {
    ...
    public final class Differ implements DiffCallback {
        ...
        public void remove(int i, int i2) {
            ...
            if ((NodeKind.m7135constructorimpl(2) & child$ui.getKindSet$ui()) != 0) {
                NodeCoordinator coordinator$ui = child$ui.getCoordinator$ui();
                Intrinsics.checkNotNull(coordinator$ui);
    ...
    public final boolean m7095hasH91voCI$ui(int i) {
    ...
    public final /* synthetic */ <T> T m7094firstFromHeadaLcG6gQ$ui(int i, Function1<? super T, Boolean> function1) {
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node head$ui = getHead$ui(); head$ui != null; head$ui = head$ui.getChild$ui()) {
                if ((head$ui.getKindSet$ui() & i) != 0) {
                    Object obj = head$ui;
    ...
    public final /* synthetic */ <T> void m7097headToTailaLcG6gQ$ui(int i, Function1<? super T, Unit> function1) {
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node head$ui = getHead$ui(); head$ui != null; head$ui = head$ui.getChild$ui()) {
                if ((head$ui.getKindSet$ui() & i) != 0) {
    ...
    public final /* synthetic */ <T> void m7099tailToHeadaLcG6gQ$ui(int i, Function1<? super T, Unit> function1) {
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node tail$ui = getTail$ui(); tail$ui != null; tail$ui = tail$ui.getParent$ui()) {
                if ((tail$ui.getKindSet$ui() & i) != 0) {
    ...
    public final /* synthetic */ <T> T m7098tailH91voCI$ui(int i) {
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node tail$ui = getTail$ui(); tail$ui != null; tail$ui = tail$ui.getParent$ui()) {
                if ((tail$ui.getKindSet$ui() & i) != 0) {
                    T t = (T) tail$ui;
    ...
    public final /* synthetic */ <T> T m7096headH91voCI$ui(int i) {
        if ((getAggregateChildKindSet() & i) != 0) {
            for (Modifier.Node head$ui = getHead$ui(); head$ui != null; head$ui = head$ui.getChild$ui()) {
                if ((head$ui.getKindSet$ui() & i) != 0) {
                    T t = (T) head$ui;
