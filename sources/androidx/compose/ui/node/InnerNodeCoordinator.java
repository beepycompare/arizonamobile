...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo6818measureBRTryo0(long j) {
            ...
            LookaheadDelegate.m7068access$setMeasurementConstraintsBRTryo0(lookaheadDelegateImpl, j);
    ...
    public Placeable mo6818measureBRTryo0(long j) {
        if (getForceMeasureWithLookaheadConstraints$ui()) {
            ...
            j = lookaheadDelegate.m7070getConstraintsmsEJaDk$ui();
        }
    ...
    public void mo7036hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z) {
        ...
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (!m7129withinLayerBoundsk4lQ0M(j)) {
                if (PointerType.m6758equalsimpl0(i, PointerType.Companion.m6765getTouchT8wyACA()) && (Float.floatToRawIntBits(m7117distanceInMinimumTouchTargettz77jQw(j, m7120getMinimumTouchTargetSizeNHjbRc())) & Integer.MAX_VALUE) < 2139095040) {
                    z = false;
                }
            }
            z2 = true;
        ...
        if (z2) {
            ...
            while (size >= 0) {
                ...
                if (layoutNode.isPlaced()) {
                    ...
                    hitTestSource2.mo7130childHitTestqzLsGqo(layoutNode, j, hitTestResult, i, z);
                    boolean hasHit = hitTestResult.hasHit();
                    if (ComposeUiFlags.isSkipNonImportantSemanticsNodesHitTestEnabled) {
                        if (hasHit && !hitTestSource2.shareWithSiblings(hitTestResult, layoutNode)) {
                            break;
                        }
                    } else if (!hasHit) {
                        continue;
    ...
    static {
        ...
        Paint.mo5224setColor8_81llA(Color.Companion.m5382getRed0d7_KjU());
