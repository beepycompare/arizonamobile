...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m7032removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m7033removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long m7031findBestHitDistancefn2tFes = m7031findBestHitDistancefn2tFes();
        return DistanceAndFlags.m7012getDistanceimpl(m7031findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m7015isInLayerimpl(m7031findBestHitDistancefn2tFes) && !DistanceAndFlags.m7014isInExpandedBoundsimpl(m7031findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f, boolean z) {
        ...
        return DistanceAndFlags.m7008compareTo9YPOF3E(m7031findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(f, z, false, 4, null)) > 0;
    }

    /* renamed from: findBestHitDistance-fn2tFes */
    private final long m7031findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long m7009constructorimpl = DistanceAndFlags.m7009constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m7008compareTo9YPOF3E(m7009constructorimpl, DistanceAndFlags$default) < 0) {
                    DistanceAndFlags$default = m7009constructorimpl;
                }
                if ((DistanceAndFlags.m7012getDistanceimpl(DistanceAndFlags$default) < 0.0f && DistanceAndFlags.m7015isInLayerimpl(DistanceAndFlags$default)) || i == lastIndex) {
                    break;
                }
                i++;
            }
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean z, Function0<Unit> function0) {
        ...
        if (DistanceAndFlags.m7014isInExpandedBoundsimpl(m7031findBestHitDistancefn2tFes)) {
            ...
            function0.invoke();
            this.hitDepth = i3;
            if (DistanceAndFlags.m7012getDistanceimpl(m7031findBestHitDistancefn2tFes()) < 0.0f) {
                removeNodesInRange(i2 + 1, this.hitDepth + 1);
            }
            this.hitDepth = i2;
        } else if (DistanceAndFlags.m7012getDistanceimpl(m7031findBestHitDistancefn2tFes) > 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float f, boolean z, Function0<Unit> function0) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            function0.invoke();
            this.hitDepth = i;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m7014isInExpandedBoundsimpl(m7031findBestHitDistancefn2tFes())) {
        ...
        function0.invoke();
        this.hitDepth = i3;
        long m7031findBestHitDistancefn2tFes2 = m7031findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m7008compareTo9YPOF3E(m7031findBestHitDistancefn2tFes, m7031findBestHitDistancefn2tFes2) > 0) {
            int i4 = i2 + 1;
            boolean m7014isInExpandedBoundsimpl = DistanceAndFlags.m7014isInExpandedBoundsimpl(m7031findBestHitDistancefn2tFes2);
            int i5 = this.hitDepth;
            removeNodesInRange(i4, m7014isInExpandedBoundsimpl ? i5 + 2 : i5 + 1);
        } else {
            removeNodesInRange(this.hitDepth + 1, size());
        }
        this.hitDepth = i2;
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* renamed from: removeFirst */
        public /* bridge */ /* synthetic */ Object m7034removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* renamed from: removeLast */
        public /* bridge */ /* synthetic */ Object m7035removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
