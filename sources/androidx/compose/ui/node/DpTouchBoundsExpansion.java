...
public final class DpTouchBoundsExpansion {
    ...
    public static /* synthetic */ DpTouchBoundsExpansion m7018copylDy3nrA$default(DpTouchBoundsExpansion dpTouchBoundsExpansion, float f, float f2, float f3, float f4, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        boolean z2 = z;
        float f5 = f3;
        return dpTouchBoundsExpansion.m7023copylDy3nrA(f, f2, f5, f4, z2);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m7019component1D9Ej5fM() {
        return this.start;
    }

    /* renamed from: component2-D9Ej5fM  reason: not valid java name */
    public final float m7020component2D9Ej5fM() {
        return this.top;
    }

    /* renamed from: component3-D9Ej5fM  reason: not valid java name */
    public final float m7021component3D9Ej5fM() {
        return this.end;
    }

    /* renamed from: component4-D9Ej5fM  reason: not valid java name */
    public final float m7022component4D9Ej5fM() {
        return this.bottom;
    }
    ...
    public final DpTouchBoundsExpansion m7023copylDy3nrA(float f, float f2, float f3, float f4, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DpTouchBoundsExpansion) {
            ...
            return Dp.m8165equalsimpl0(this.start, dpTouchBoundsExpansion.start) && Dp.m8165equalsimpl0(this.top, dpTouchBoundsExpansion.top) && Dp.m8165equalsimpl0(this.end, dpTouchBoundsExpansion.end) && Dp.m8165equalsimpl0(this.bottom, dpTouchBoundsExpansion.bottom) && this.isLayoutDirectionAware == dpTouchBoundsExpansion.isLayoutDirectionAware;
        }
        return false;
    }

    public int hashCode() {
        return (((((((Dp.m8166hashCodeimpl(this.start) * 31) + Dp.m8166hashCodeimpl(this.top)) * 31) + Dp.m8166hashCodeimpl(this.end)) * 31) + Dp.m8166hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.isLayoutDirectionAware);
    }

    public String toString() {
        return "DpTouchBoundsExpansion(start=" + ((Object) Dp.m8171toStringimpl(this.start)) + ", top=" + ((Object) Dp.m8171toStringimpl(this.top)) + ", end=" + ((Object) Dp.m8171toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m8171toStringimpl(this.bottom)) + ", isLayoutDirectionAware=" + this.isLayoutDirectionAware + ')';
    }
    ...
    public final float m7026getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m7027getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m7025getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: getBottom-D9Ej5fM  reason: not valid java name */
    public final float m7024getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public final long m7028roundToTouchBoundsExpansionTW6G1oQ(Density density) {
        return TouchBoundsExpansion.m7223constructorimpl(TouchBoundsExpansion.Companion.pack$ui(density.mo428roundToPx0680j_4(this.start), density.mo428roundToPx0680j_4(this.top), density.mo428roundToPx0680j_4(this.end), density.mo428roundToPx0680j_4(this.bottom), this.isLayoutDirectionAware));
    }

    /* compiled from: TouchBoundsExpansion.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J5\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u00072\b\b\u0002\u0010\b\u001a\u00020\u00072\b\b\u0002\u0010\t\u001a\u00020\u00072\b\b\u0002\u0010\n\u001a\u00020\u0007¢\u0006\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"Landroidx/compose/ui/node/DpTouchBoundsExpansion$Companion;", "", "<init>", "()V", "Absolute", "Landroidx/compose/ui/node/DpTouchBoundsExpansion;", TtmlNode.LEFT, "Landroidx/compose/ui/unit/Dp;", "top", TtmlNode.RIGHT, "bottom", "Absolute-a9UjIt4", "(FFFF)Landroidx/compose/ui/node/DpTouchBoundsExpansion;", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final DpTouchBoundsExpansion m7030Absolutea9UjIt4(float f, float f2, float f3, float f4) {
            return new DpTouchBoundsExpansion(f, f2, f3, f4, false, null);
        }

        /* renamed from: Absolute-a9UjIt4$default  reason: not valid java name */
        public static /* synthetic */ DpTouchBoundsExpansion m7029Absolutea9UjIt4$default(Companion companion, float f, float f2, float f3, float f4, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return companion.m7030Absolutea9UjIt4(f, f2, f3, f4);
        }
    }
}
