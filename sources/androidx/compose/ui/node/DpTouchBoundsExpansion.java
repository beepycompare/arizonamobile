...
public final class DpTouchBoundsExpansion {
    ...
    public static /* synthetic */ DpTouchBoundsExpansion m6415copylDy3nrA$default(DpTouchBoundsExpansion dpTouchBoundsExpansion, float f, float f2, float f3, float f4, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        boolean z2 = z;
        float f5 = f3;
        return dpTouchBoundsExpansion.m6420copylDy3nrA(f, f2, f5, f4, z2);
    }

    /* renamed from: component1-D9Ej5fM  reason: not valid java name */
    public final float m6416component1D9Ej5fM() {
        return this.start;
    }

    /* renamed from: component2-D9Ej5fM  reason: not valid java name */
    public final float m6417component2D9Ej5fM() {
        return this.top;
    }

    /* renamed from: component3-D9Ej5fM  reason: not valid java name */
    public final float m6418component3D9Ej5fM() {
        return this.end;
    }

    /* renamed from: component4-D9Ej5fM  reason: not valid java name */
    public final float m6419component4D9Ej5fM() {
        return this.bottom;
    }
    ...
    public final DpTouchBoundsExpansion m6420copylDy3nrA(float f, float f2, float f3, float f4, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DpTouchBoundsExpansion) {
            ...
            return Dp.m7560equalsimpl0(this.start, dpTouchBoundsExpansion.start) && Dp.m7560equalsimpl0(this.top, dpTouchBoundsExpansion.top) && Dp.m7560equalsimpl0(this.end, dpTouchBoundsExpansion.end) && Dp.m7560equalsimpl0(this.bottom, dpTouchBoundsExpansion.bottom) && this.isLayoutDirectionAware == dpTouchBoundsExpansion.isLayoutDirectionAware;
        }
        return false;
    }

    public int hashCode() {
        return (((((((Dp.m7561hashCodeimpl(this.start) * 31) + Dp.m7561hashCodeimpl(this.top)) * 31) + Dp.m7561hashCodeimpl(this.end)) * 31) + Dp.m7561hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.isLayoutDirectionAware);
    }

    public String toString() {
        return "DpTouchBoundsExpansion(start=" + ((Object) Dp.m7566toStringimpl(this.start)) + ", top=" + ((Object) Dp.m7566toStringimpl(this.top)) + ", end=" + ((Object) Dp.m7566toStringimpl(this.end)) + ", bottom=" + ((Object) Dp.m7566toStringimpl(this.bottom)) + ", isLayoutDirectionAware=" + this.isLayoutDirectionAware + ')';
    }
    ...
    public final float m6423getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m6424getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m6422getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: getBottom-D9Ej5fM  reason: not valid java name */
    public final float m6421getBottomD9Ej5fM() {
        return this.bottom;
    }
    ...
    public final long m6425roundToTouchBoundsExpansionTW6G1oQ(Density density) {
        return TouchBoundsExpansion.m6623constructorimpl(TouchBoundsExpansion.Companion.pack$ui(density.mo399roundToPx0680j_4(this.start), density.mo399roundToPx0680j_4(this.top), density.mo399roundToPx0680j_4(this.end), density.mo399roundToPx0680j_4(this.bottom), this.isLayoutDirectionAware));
    }
    ...
    public static final class Companion {
        ...
        public final DpTouchBoundsExpansion m6427Absolutea9UjIt4(float f, float f2, float f3, float f4) {
