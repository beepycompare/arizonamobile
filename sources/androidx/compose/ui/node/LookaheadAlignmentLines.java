...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    protected long mo6972calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long mo7063getPositionnOccac = lookaheadDelegate.mo7063getPositionnOccac();
        return Offset.m5108plusMKHz9U(Offset.m5095constructorimpl((Float.floatToRawIntBits(IntOffset.m8289getYimpl(mo7063getPositionnOccac)) & 4294967295L) | (Float.floatToRawIntBits(IntOffset.m8288getXimpl(mo7063getPositionnOccac)) << 32)), j);
    }
}
