...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    protected long mo5545calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long mo5633getPositionnOccac = lookaheadDelegate.mo5633getPositionnOccac();
        return Offset.m3842plusMKHz9U(Offset.m3829constructorimpl((Float.floatToRawIntBits(IntOffset.m6812getXimpl(mo5633getPositionnOccac)) << 32) | (Float.floatToRawIntBits(IntOffset.m6813getYimpl(mo5633getPositionnOccac)) & 4294967295L)), j);
    }
}
