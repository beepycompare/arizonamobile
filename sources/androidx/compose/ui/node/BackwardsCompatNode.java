...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m6989constructorimpl(32) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet$ui_release() & NodeKind.m6989constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean z) {
        ...
        if ((NodeKind.m6989constructorimpl(4) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m6989constructorimpl(2) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
        ...
        if ((NodeKind.m6989constructorimpl(128) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$3
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m6843requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m6989constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m6989constructorimpl(256) & backwardsCompatNode.getKindSet$ui_release()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.access$isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if ((NodeKind.m6989constructorimpl(16) & backwardsCompatNode.getKindSet$ui_release()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator$ui_release());
        }
        if ((NodeKind.m6989constructorimpl(8) & backwardsCompatNode.getKindSet$ui_release()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo4818getSizeNHjbRc() {
        return IntSizeKt.m8179toSizeozmzZPI(DelegatableNodeKt.m6843requireCoordinator64DMado(this, NodeKind.m6989constructorimpl(128)).mo6706getSizeYbymL2g());
    }
    ...
    public MeasureResult mo81measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo749measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public void mo238onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo6593onPointerEventH0pRuoY(pointerEvent, pointerEventPass, j);
    }
    ...
    public void mo419onRemeasuredozmzZPI(long j) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m6753onRemeasuredozmzZPI(j);
        }
    }
