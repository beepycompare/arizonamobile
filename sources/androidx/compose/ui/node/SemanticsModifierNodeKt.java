...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        if (node.getNode().isAttached()) {
            if (!z) {
                return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5560requireCoordinator64DMado(node, NodeKind.m5700constructorimpl(8)));
            }
            return DelegatableNodeKt.m5560requireCoordinator64DMado(node, NodeKind.m5700constructorimpl(8)).touchBoundsInRoot();
        }
