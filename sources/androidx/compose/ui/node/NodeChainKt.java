...
public final class NodeChainKt {
    ...
    public static final /* synthetic */ MutableVector access$fillVector(Modifier modifier, MutableVector mutableVector, MutableVector mutableVector2) {
        return fillVector(modifier, mutableVector, mutableVector2);
    }
    ...
    public static final MutableVector<Modifier.Element> fillVector(Modifier modifier, final MutableVector<Modifier.Element> mutableVector, MutableVector<Modifier> mutableVector2) {
        ...
        while (mutableVector2.getSize() != 0) {
            ...
            if (removeAt instanceof CombinedModifier) {
                ...
                mutableVector2.add(combinedModifier.getInner$ui());
                mutableVector2.add(combinedModifier.getOuter$ui());
