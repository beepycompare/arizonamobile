...
public final class MyersDiffKt {
    ...
    private static final IntStack calculateDiff(int i, int i2, DiffCallback diffCallback) {
        ...
        int i4 = (i3 * 2) + 1;
        int[] m6829constructorimpl = CenteredArray.m6829constructorimpl(new int[i4]);
        int[] m6829constructorimpl2 = CenteredArray.m6829constructorimpl(new int[i4]);
        int[] m7056constructorimpl = Snake.m7056constructorimpl(new int[5]);
        while (intStack2.isNotEmpty()) {
            int pop = intStack2.pop();
            int pop2 = intStack2.pop();
            int pop3 = intStack2.pop();
            int pop4 = intStack2.pop();
            int[] iArr = m7056constructorimpl;
            if (m6948midPointq5eDKzI(pop4, pop3, pop2, pop, diffCallback, m6829constructorimpl, m6829constructorimpl2, m7056constructorimpl)) {
                char c2 = c;
                if (Math.min(iArr[2] - iArr[0], iArr[3] - iArr[c]) > 0) {
                    Snake.m7054addDiagonalToStackimpl(iArr, intStack);
                }
                intStack2.pushRange(pop4, iArr[0], pop2, iArr[c2]);
                intStack2.pushRange(iArr[2], pop3, iArr[3], pop);
                m7056constructorimpl = iArr;
                c = c2;
            } else {
                m7056constructorimpl = iArr;
            }
    ...
    private static final boolean m6948midPointq5eDKzI(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int[] iArr3) {
        int i5 = i2 - i;
        int i6 = i4 - i3;
        if (i5 >= 1 && i6 >= 1) {
            int i7 = ((i5 + i6) + 1) / 2;
            int[] iArr4 = iArr;
            CenteredArray.m6835setimpl(iArr4, 1, i);
            int[] iArr5 = iArr2;
            CenteredArray.m6835setimpl(iArr5, 1, i2);
            int i8 = 0;
            while (i8 < i7) {
                if (m6947forward4l5_RBY(i, i2, i3, i4, diffCallback, iArr4, iArr5, i8, iArr3) || m6946backward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i8, iArr3)) {
                    return true;
                }
                i8++;
                iArr4 = iArr;
    ...
    private static final boolean m6947forward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m6832getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        int i11 = i10;
        while (i11 <= i5) {
            if (i11 == i10 || (i11 != i5 && CenteredArray.m6832getimpl(iArr, i11 + 1) > CenteredArray.m6832getimpl(iArr, i11 - 1))) {
                m6832getimpl = CenteredArray.m6832getimpl(iArr, i11 + 1);
                i6 = m6832getimpl;
            } else {
                m6832getimpl = CenteredArray.m6832getimpl(iArr, i11 - 1);
                i6 = m6832getimpl + 1;
            ...
            int i12 = (i3 + (i6 - i)) - i11;
            int i13 = i12 - ((i5 != 0 ? i9 : 0) & (i6 == m6832getimpl ? i9 : 0));
            while (i6 < i2 && i12 < i4) {
            ...
            CenteredArray.m6835setimpl(iArr, i11, i6);
            if (z) {
                int i14 = i8 - i11;
                i7 = i9;
                i7 = i7;
                if (i14 >= i10 + 1) {
                    i7 = i7;
                    if (i14 <= i5 - 1) {
                        if (CenteredArray.m6832getimpl(iArr2, i14) <= i6) {
                            fillSnake(m6832getimpl, i13, i6, i12, false, iArr3);
                            return i7;
                        }
                        i11 += 2;
                        i9 = i7;
    ...
    private static final boolean m6946backward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m6832getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m6832getimpl(iArr2, i10 + 1) < CenteredArray.m6832getimpl(iArr2, i10 - 1))) {
                m6832getimpl = CenteredArray.m6832getimpl(iArr2, i10 + 1);
                i6 = m6832getimpl;
            } else {
                m6832getimpl = CenteredArray.m6832getimpl(iArr2, i10 - 1);
                i6 = m6832getimpl - 1;
            ...
            int i12 = ((i5 != 0 ? 1 : 0) & (i6 == m6832getimpl ? 1 : 0)) + i11;
            while (i6 > i && i11 > i3) {
            ...
            CenteredArray.m6835setimpl(iArr2, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 && i7 <= i5) {
                if (CenteredArray.m6832getimpl(iArr, i7) >= i6) {
                    fillSnake(i6, i11, m6832getimpl, i12, true, iArr3);
                    return true;
                }
            }
        }
