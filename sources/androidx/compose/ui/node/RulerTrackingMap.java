...
public final class RulerTrackingMap {
    ...
    public final float getOrDefault(Ruler ruler, float f) {
        ...
        return indexOf < 0 ? f : this.values[indexOf];
    }
    ...
    public final void notifyChanged(boolean z, LookaheadCapablePlaceable lookaheadCapablePlaceable, MutableScatterMap<Ruler, MutableScatterSet<WeakReference<LayoutNode>>> mutableScatterMap) {
        char c;
        char c2;
        long j;
        long j2;
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (b == 3) {
                ...
                MutableScatterSet<WeakReference<LayoutNode>> remove = mutableScatterMap.remove(ruler2);
                if (remove != null) {
                ...
                if ((((~j3) << c6) & j3 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i10 < i9) {
                        if ((j3 & 255) < 128) {
                            c4 = c;
                            c5 = c6;
                            (parent == null ? lookaheadCapablePlaceable : parent).invalidateChildrenOfDefiningRuler$ui_release((Ruler) objArr[(i8 << 3) + i10]);
                        } else {
                            c4 = c;
                            c5 = c6;
                        }
