...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo5013drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5013drawArcillE91I(brush, f, f2, z, j, j2, f3, drawStyle, colorFilter, i);
    }
    ...
    public void mo5014drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5014drawArcyD3GUKo(j, f, f2, z, j2, j3, f3, drawStyle, colorFilter, i);
    }
    ...
    public void mo5015drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5015drawCircleV9BoPsw(brush, f, j, f2, drawStyle, colorFilter, i);
    }
    ...
    public void mo5016drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5016drawCircleVaOC9Bg(j, f, j2, f2, drawStyle, colorFilter, i);
    }
    ...
    public /* synthetic */ void mo5017drawImage9jGpkUE(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5017drawImage9jGpkUE(imageBitmap, j, j2, j3, j4, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5018drawImageAZ2fEMs(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2) {
        this.canvasDrawScope.mo5018drawImageAZ2fEMs(imageBitmap, j, j2, j3, j4, f, drawStyle, colorFilter, i, i2);
    }
    ...
    public void mo5019drawImagegbVJVH8(ImageBitmap imageBitmap, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5019drawImagegbVJVH8(imageBitmap, j, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5020drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo5020drawLine1RTmtNc(brush, j, j2, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo5021drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo5021drawLineNGM6Ib0(j, j2, j3, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo5026drawPointsF8ZwMP8(List<Offset> list, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.canvasDrawScope.mo5026drawPointsF8ZwMP8(list, i, j, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo5027drawPointsGsft0Ws(List<Offset> list, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.canvasDrawScope.mo5027drawPointsGsft0Ws(list, i, brush, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo5028drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5028drawRectAsUm42w(brush, j, j2, f, drawStyle, colorFilter, i);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRect-n-J9OG0 */
    public void mo5029drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5029drawRectnJ9OG0(j, j2, j3, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5030drawRoundRectZuiqVtQ(Brush brush, long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5030drawRoundRectZuiqVtQ(brush, j, j2, j3, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5031drawRoundRectuAw5IA(long j, long j2, long j3, long j4, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5031drawRoundRectuAw5IA(j, j2, j3, j4, drawStyle, f, colorFilter, i);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo5115getCenterF1C5BW0() {
        return this.canvasDrawScope.mo5115getCenterF1C5BW0();
    }
    ...
    public long mo5116getSizeNHjbRc() {
        return this.canvasDrawScope.mo5116getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo412roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo412roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo413roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo413roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo414toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo414toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo415toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo415toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo416toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo416toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo417toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo417toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo418toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo418toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo419toPx0680j_4(float f) {
        return this.canvasDrawScope.mo419toPx0680j_4(f);
    }
    ...
    public long mo420toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo420toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo421toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo421toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo422toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo422toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo423toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo423toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (drawModifierNode != null) {
            ...
            if (nextDrawNode == null) {
                NodeCoordinator m6099requireCoordinator64DMado = DelegatableNodeKt.m6099requireCoordinator64DMado(drawModifierNode2, NodeKind.m6245constructorimpl(4));
                if (m6099requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                    m6099requireCoordinator64DMado = m6099requireCoordinator64DMado.getWrapped$ui_release();
                    Intrinsics.checkNotNull(m6099requireCoordinator64DMado);
                }
                m6099requireCoordinator64DMado.performDraw(canvas, getDrawContext().getGraphicsLayer());
                return;
            }
            ...
            while (nextDrawNode != null) {
                ...
                } else if ((nextDrawNode.getKindSet$ui_release() & m6245constructorimpl) != 0 && (nextDrawNode instanceof DelegatingNode)) {
                    int i = 0;
    ...
    public void mo5117recordJVtK1S4(GraphicsLayer graphicsLayer, long j, final Function1<? super DrawScope, Unit> function1) {
        final DrawModifierNode drawModifierNode = this.drawNode;
        graphicsLayer.m5210recordmLhObY(this, getLayoutDirection(), j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.node.LayoutNodeDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    ...
                    mo5037getSizeNHjbRc = drawScope.getDrawContext().mo5037getSizeNHjbRc();
                    ...
                    mo5037getSizeNHjbRc2 = layoutNodeDrawScope.getDrawContext().mo5037getSizeNHjbRc();
                ...
                try {
                    ...
                    r2.setCanvas(canvas);
                    r2.mo5038setSizeuvyYCjk(mo5037getSizeNHjbRc);
                    ...
                    drawContext.mo5038setSizeuvyYCjk(mo5037getSizeNHjbRc2);
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator m6099requireCoordinator64DMado = DelegatableNodeKt.m6099requireCoordinator64DMado(drawModifierNode, NodeKind.m6245constructorimpl(4));
        m6099requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m6168drawDirecteZhPAX0$ui_release(canvas, IntSizeKt.m7434toSizeozmzZPI(m6099requireCoordinator64DMado.mo5962getSizeYbymL2g()), m6099requireCoordinator64DMado, drawModifierNode, graphicsLayer);
    }

    /* renamed from: drawDirect-eZhPAX0$ui_release  reason: not valid java name */
    public final void m6168drawDirecteZhPAX0$ui_release(Canvas canvas, long j, NodeCoordinator nodeCoordinator, DrawModifierNode drawModifierNode, GraphicsLayer graphicsLayer) {
    ...
    public final void m6167draweZhPAX0$ui_release(Canvas canvas, long j, NodeCoordinator nodeCoordinator, Modifier.Node node, GraphicsLayer graphicsLayer) {
        int m6245constructorimpl = NodeKind.m6245constructorimpl(4);
        Modifier.Node node2 = node;
        MutableVector mutableVector = null;
        while (node2 != null) {
            if (node2 instanceof DrawModifierNode) {
                m6168drawDirecteZhPAX0$ui_release(canvas, j, nodeCoordinator, (DrawModifierNode) node2, graphicsLayer);
