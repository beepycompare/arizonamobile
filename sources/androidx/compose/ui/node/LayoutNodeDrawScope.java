...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo5819drawArcillE91I(Brush brush, float f, float f2, boolean z, long j, long j2, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5819drawArcillE91I(brush, f, f2, z, j, j2, f3, drawStyle, colorFilter, i);
    }
    ...
    public void mo5820drawArcyD3GUKo(long j, float f, float f2, boolean z, long j2, long j3, float f3, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5820drawArcyD3GUKo(j, f, f2, z, j2, j3, f3, drawStyle, colorFilter, i);
    }
    ...
    public void mo5821drawCircleV9BoPsw(Brush brush, float f, long j, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5821drawCircleV9BoPsw(brush, f, j, f2, drawStyle, colorFilter, i);
    }
    ...
    public void mo5822drawCircleVaOC9Bg(long j, float f, long j2, float f2, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5822drawCircleVaOC9Bg(j, f, j2, f2, drawStyle, colorFilter, i);
    }
    ...
    public /* synthetic */ void mo5823drawImage9jGpkUE(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5823drawImage9jGpkUE(imageBitmap, j, j2, j3, j4, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5824drawImageAZ2fEMs(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2) {
        this.canvasDrawScope.mo5824drawImageAZ2fEMs(imageBitmap, j, j2, j3, j4, f, drawStyle, colorFilter, i, i2);
    }
    ...
    public void mo5825drawImagegbVJVH8(ImageBitmap imageBitmap, long j, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5825drawImagegbVJVH8(imageBitmap, j, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5826drawLine1RTmtNc(Brush brush, long j, long j2, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo5826drawLine1RTmtNc(brush, j, j2, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo5827drawLineNGM6Ib0(long j, long j2, long j3, float f, int i, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i2) {
        this.canvasDrawScope.mo5827drawLineNGM6Ib0(j, j2, j3, f, i, pathEffect, f2, colorFilter, i2);
    }
    ...
    public void mo5832drawPointsF8ZwMP8(List<Offset> list, int i, long j, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.canvasDrawScope.mo5832drawPointsF8ZwMP8(list, i, j, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo5833drawPointsGsft0Ws(List<Offset> list, int i, Brush brush, float f, int i2, PathEffect pathEffect, float f2, ColorFilter colorFilter, int i3) {
        this.canvasDrawScope.mo5833drawPointsGsft0Ws(list, i, brush, f, i2, pathEffect, f2, colorFilter, i3);
    }
    ...
    public void mo5834drawRectAsUm42w(Brush brush, long j, long j2, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5834drawRectAsUm42w(brush, j, j2, f, drawStyle, colorFilter, i);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: drawRect-n-J9OG0 */
    public void mo5835drawRectnJ9OG0(long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5835drawRectnJ9OG0(j, j2, j3, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5836drawRoundRectZuiqVtQ(Brush brush, long j, long j2, long j3, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5836drawRoundRectZuiqVtQ(brush, j, j2, j3, f, drawStyle, colorFilter, i);
    }
    ...
    public void mo5837drawRoundRectuAw5IA(long j, long j2, long j3, long j4, DrawStyle drawStyle, float f, ColorFilter colorFilter, int i) {
        this.canvasDrawScope.mo5837drawRoundRectuAw5IA(j, j2, j3, j4, drawStyle, f, colorFilter, i);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo5921getCenterF1C5BW0() {
        return this.canvasDrawScope.mo5921getCenterF1C5BW0();
    }
    ...
    public long mo5922getSizeNHjbRc() {
        return this.canvasDrawScope.mo5922getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo427roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo427roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo428roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo428roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo429toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo429toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo430toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo430toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo431toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo431toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo432toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo432toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo433toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo433toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo434toPx0680j_4(float f) {
        return this.canvasDrawScope.mo434toPx0680j_4(f);
    }
    ...
    public long mo435toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo435toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo436toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo436toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo437toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo437toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo438toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo438toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (drawModifierNode != null) {
            ...
            if (nextDrawNode == null) {
                NodeCoordinator m6990requireCoordinator64DMado = DelegatableNodeKt.m6990requireCoordinator64DMado(drawModifierNode2, NodeKind.m7135constructorimpl(4));
                if (m6990requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                    m6990requireCoordinator64DMado = m6990requireCoordinator64DMado.getWrapped$ui();
                    Intrinsics.checkNotNull(m6990requireCoordinator64DMado);
                }
                m6990requireCoordinator64DMado.performDraw(canvas, getDrawContext().getGraphicsLayer());
                return;
            }
            ...
            while (nextDrawNode != null) {
                ...
                } else if ((nextDrawNode.getKindSet$ui() & m7135constructorimpl) != 0 && (nextDrawNode instanceof DelegatingNode)) {
                    int i = 0;
    ...
    public void mo5923recordJVtK1S4(GraphicsLayer graphicsLayer, long j, final Function1<? super DrawScope, Unit> function1) {
        final DrawModifierNode drawModifierNode = this.drawNode;
        graphicsLayer.m6016recordmLhObY(this, getLayoutDirection(), j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.node.LayoutNodeDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    ...
                    mo5843getSizeNHjbRc = drawScope.getDrawContext().mo5843getSizeNHjbRc();
                    ...
                    mo5843getSizeNHjbRc2 = layoutNodeDrawScope.getDrawContext().mo5843getSizeNHjbRc();
                ...
                try {
                    ...
                    r2.setCanvas(canvas);
                    r2.mo5844setSizeuvyYCjk(mo5843getSizeNHjbRc);
                    ...
                    drawContext.mo5844setSizeuvyYCjk(mo5843getSizeNHjbRc2);
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator m6990requireCoordinator64DMado = DelegatableNodeKt.m6990requireCoordinator64DMado(drawModifierNode, NodeKind.m7135constructorimpl(4));
        m6990requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui().m7057drawDirecteZhPAX0$ui(canvas, IntSizeKt.m8343toSizeozmzZPI(m6990requireCoordinator64DMado.mo6826getSizeYbymL2g()), m6990requireCoordinator64DMado, drawModifierNode, graphicsLayer);
    }

    /* renamed from: drawDirect-eZhPAX0$ui  reason: not valid java name */
    public final void m7057drawDirecteZhPAX0$ui(Canvas canvas, long j, NodeCoordinator nodeCoordinator, DrawModifierNode drawModifierNode, GraphicsLayer graphicsLayer) {
    ...
    public final void m7056draweZhPAX0$ui(Canvas canvas, long j, NodeCoordinator nodeCoordinator, Modifier.Node node, GraphicsLayer graphicsLayer) {
        int m7135constructorimpl = NodeKind.m7135constructorimpl(4);
        Modifier.Node node2 = node;
        MutableVector mutableVector = null;
        while (node2 != null) {
            if (node2 instanceof DrawModifierNode) {
                m7057drawDirecteZhPAX0$ui(canvas, j, nodeCoordinator, (DrawModifierNode) node2, graphicsLayer);
