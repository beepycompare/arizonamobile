...
public abstract class AlignmentLines {
    ...
    protected abstract long mo6972calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        float f = i;
        long m5095constructorimpl = Offset.m5095constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
        while (true) {
            m5095constructorimpl = mo6972calculatePositionInParentR5De75A(nodeCoordinator, m5095constructorimpl);
            ...
            if (Intrinsics.areEqual(nodeCoordinator, this.alignmentLinesOwner.getInnerCoordinator())) {
                ...
                m5095constructorimpl = Offset.m5095constructorimpl((Float.floatToRawIntBits(positionFor) << 32) | (Float.floatToRawIntBits(positionFor) & 4294967295L));
            }
        }
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            intBitsToFloat = Float.intBitsToFloat((int) (m5095constructorimpl & 4294967295L));
        } else {
            intBitsToFloat = Float.intBitsToFloat((int) (m5095constructorimpl >> 32));
        }
