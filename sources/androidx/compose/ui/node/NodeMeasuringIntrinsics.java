...
public final class NodeMeasuringIntrinsics {
    ...
    public interface ApproachMeasureBlock {
        ...
        MeasureResult mo6797measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);
    }
    ...
    public interface MeasureBlock {
        /* renamed from: measure-3p2s80s */
        MeasureResult mo7037measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return measureBlock.mo7037measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i, 7, null)).getWidth();
    }
    ...
    public final int minHeight$ui(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return measureBlock.mo7037measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i, 0, 0, 13, null)).getHeight();
    }
    ...
    public final int maxWidth$ui(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return measureBlock.mo7037measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, i, 7, null)).getWidth();
    }
    ...
    public final int maxHeight$ui(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return measureBlock.mo7037measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, i, 0, 0, 13, null)).getHeight();
    }
        ...
        public Placeable mo6818measureBRTryo0(long j) {
            ...
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                ...
                if (intrinsicMinMax == intrinsicMinMax2) {
                    minIntrinsicWidth = intrinsicMeasurable.maxIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j));
                } else {
                    minIntrinsicWidth = intrinsicMeasurable.minIntrinsicWidth(Constraints.m8112getMaxHeightimpl(j));
                }
                return new EmptyPlaceable(minIntrinsicWidth, Constraints.m8108getHasBoundedHeightimpl(j) ? Constraints.m8112getMaxHeightimpl(j) : 32767);
            }
            ...
            if (intrinsicMinMax == intrinsicMinMax3) {
                minIntrinsicHeight = intrinsicMeasurable2.maxIntrinsicHeight(Constraints.m8113getMaxWidthimpl(j));
            } else {
                minIntrinsicHeight = intrinsicMeasurable2.minIntrinsicHeight(Constraints.m8113getMaxWidthimpl(j));
            }
            return new EmptyPlaceable(Constraints.m8109getHasBoundedWidthimpl(j) ? Constraints.m8113getMaxWidthimpl(j) : 32767, minIntrinsicHeight);
        }
