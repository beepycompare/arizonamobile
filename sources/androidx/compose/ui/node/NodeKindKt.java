...
public final class NodeKindKt {
    ...
    public static final boolean m7143contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m7145or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    */
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m7135constructorimpl2 = NodeKind.m7135constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(64);
        }
        if (!(node instanceof OnPlacedNode)) {
            if (!(node instanceof LayoutAwareModifierNode)) {
                if (node instanceof MeasuredSizeAwareModifierNode) {
                    m7135constructorimpl = NodeKind.m7135constructorimpl(128);
                }
                if (node instanceof GlobalPositionAwareModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(256);
                }
                if (node instanceof ApproachLayoutModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(512);
                }
                if (node instanceof FocusTargetNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(1024);
                }
                if (node instanceof FocusPropertiesModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(2048);
                }
                if (node instanceof FocusEventModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(4096);
                }
                if (node instanceof KeyInputModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(8192);
                }
                if (node instanceof RotaryInputModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(16384);
                }
                if (node instanceof CompositionLocalConsumerModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(32768);
                }
                if (node instanceof SoftKeyboardInterceptionModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(131072);
                }
                if (node instanceof TraversableNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(262144);
                }
                if (node instanceof BringIntoViewModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(524288);
                }
                if (node instanceof UnplacedAwareModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(1048576);
                }
                if (node instanceof IndirectPointerInputModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(2097152);
                }
                if (node instanceof BeyondBoundsLayoutProviderModifierNode) {
                    m7135constructorimpl2 |= NodeKind.m7135constructorimpl(8388608);
                }
                mutableObjectIntMap.set(classKeyForObject, m7135constructorimpl2);
                return m7135constructorimpl2;
            }
            m7135constructorimpl2 |= NodeKind.m7135constructorimpl(128);
            m7135constructorimpl = NodeKind.m7135constructorimpl(4194304);
        } else {
            m7135constructorimpl = NodeKind.m7135constructorimpl(4194304);
        }
        m7135constructorimpl2 |= m7135constructorimpl;
        if (node instanceof GlobalPositionAwareModifierNode) {
        }
        if (node instanceof ApproachLayoutModifierNode) {
        }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m7135constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m6990requireCoordinator64DMado(node, NodeKind.m7135constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m7135constructorimpl(128) & i) != 0 && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui();
            }
            if ((NodeKind.m7135constructorimpl(4194304) & i) != 0 && i2 != 2) {
                LayoutNode.requestRelayout$ui$default(DelegatableNodeKt.requireLayoutNode(node), false, 1, null);
            }
            if ((NodeKind.m7135constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                if (i2 == 1) {
            ...
            if ((NodeKind.m7135constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m7135constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).setSemanticsInvalidated$ui(true);
            }
            if ((NodeKind.m7135constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m7135constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((NodeKind.m7135constructorimpl(4096) & i) != 0 && (node instanceof FocusEventModifierNode)) {
                FocusEventModifierNodeKt.invalidateFocusEvent((FocusEventModifierNode) node);
            }
            if ((i & NodeKind.m7135constructorimpl(2097152)) != 0 && (node instanceof IndirectPointerInputModifierNode) && i2 == 2) {
    ...
    public static final boolean m7144getIncludeSelfInTraversalH91voCI(int i) {
        return ((NodeKind.m7135constructorimpl(128) & i) != 0) | ((i & NodeKind.m7135constructorimpl(4194304)) != 0);
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        int m7135constructorimpl = NodeKind.m7135constructorimpl(1);
        if (element instanceof LayoutModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(2);
        }
        if (element instanceof DrawModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(4);
        }
        if (element instanceof SemanticsModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(8);
        }
        if (element instanceof PointerInputModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(16);
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(32);
        }
        if (element instanceof FocusEventModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(4096);
        }
        if (element instanceof FocusOrderModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(2048);
        }
        if (element instanceof OnGloballyPositionedModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(256);
        }
        if (element instanceof ParentDataModifier) {
            m7135constructorimpl |= NodeKind.m7135constructorimpl(64);
        }
        ...
        return element instanceof BringIntoViewModifierNode ? NodeKind.m7135constructorimpl(524288) | m7135constructorimpl : m7135constructorimpl;
    }
}
