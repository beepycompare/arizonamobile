...
public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            lookaheadDelegate.mo6818measureBRTryo0(j);
        }
    };
        ...
        public final void invoke2() {
            ...
            if (!LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(layoutNode)) {
                ...
                if (!layoutNodeLayoutDelegate.getDetachedFromParentLookaheadPlacement$ui()) {
                    ...
                    Placeable.PlacementScope.m6884place70tqf50$default(placementScope, lookaheadDelegate2, j, 0.0f, 2, null);
                }
            }
            outerCoordinator = LookaheadPassDelegate.this.getOuterCoordinator();
            ...
            Placeable.PlacementScope.m6884place70tqf50$default(placementScope, lookaheadDelegate22, j, 0.0f, 2, null);
        }
    };
    ...
    public final Constraints m7077getLastConstraintsDWUhwKw() {
    ...
    */
    ...
    public final void m7078performMeasureBRTryo0$ui(long j) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean m7079remeasureBRTryo0(long j) {
        boolean z;
        LookaheadDelegate lookaheadDelegate;
        LayoutNode layoutNode = getLayoutNode();
        try {
            ...
            if (!getLayoutNode().getCanMultiMeasure$ui() && (parent$ui == null || !parent$ui.getCanMultiMeasure$ui())) {
                ...
                long j2 = !this.measuredOnce ? m6879getMeasuredSizeYbymL2g() : IntSize.m8326constructorimpl(-9223372034707292160L);
                ...
                this.layoutNodeLayoutDelegate.m7060performLookaheadMeasureBRTryo0$ui(j);
                m6882setMeasuredSizeozmzZPI(IntSize.m8326constructorimpl((lookaheadDelegate.getWidth() << 32) | (lookaheadDelegate.getHeight() & 4294967295L)));
    ...
    public void mo6819placeAtf8xVGno(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
        m7076placeSelfMLgxB_4(j, f, function1, null);
    }
    ...
    public void mo6881placeAtf8xVGno(long j, float f, GraphicsLayer graphicsLayer) {
        m7076placeSelfMLgxB_4(j, f, null, graphicsLayer);
    }
    ...
    private final void m7076placeSelfMLgxB_4(long j, float f, Function1<? super GraphicsLayerScope, Unit> function1, GraphicsLayer graphicsLayer) {
        LayoutNode layoutNode = getLayoutNode();
        try {
            LayoutNode parent$ui = getLayoutNode().getParent$ui();
            ...
            if (!getLayoutPending() && isPlaced$ui()) {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m7073placeSelfApparentToRealOffsetgyyYBs$ui(j);
                onNodePlaced$ui();
            } else {
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui() && layoutNode.getMeasuredByParentInLookahead$ui() == LayoutNode.UsageByParent.InMeasureBlock) {
                ...
                Intrinsics.checkNotNull(lookaheadPassDelegate$ui);
                Constraints m7059getLastLookaheadConstraintsDWUhwKw = layoutNode.getLayoutDelegate$ui().m7059getLastLookaheadConstraintsDWUhwKw();
                Intrinsics.checkNotNull(m7059getLastLookaheadConstraintsDWUhwKw);
                if (lookaheadPassDelegate$ui.m7079remeasureBRTryo0(m7059getLastLookaheadConstraintsDWUhwKw.m8119unboximpl())) {
                    LayoutNode.requestLookaheadRemeasure$ui$default(getLayoutNode(), false, false, false, 7, null);
                }
            }
        }
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                lookaheadPassDelegate.m7076placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
