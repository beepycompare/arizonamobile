...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m7058getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m7087getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw  reason: not valid java name */
    public final Constraints m7059getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            return lookaheadPassDelegate.m7077getLastConstraintsDWUhwKw();
        }
        return null;
    }
    ...
    public final void m7060performLookaheadMeasureBRTryo0$ui(long j) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m7078performMeasureBRTryo0$ui(j);
        }
    }
