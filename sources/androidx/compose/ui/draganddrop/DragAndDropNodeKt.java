...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m4055containsUv8p0NA(DragAndDropNode dragAndDropNode, long j) {
        if (dragAndDropNode.getNode().isAttached()) {
            ...
            if (coordinates.isAttached()) {
                ...
                float m4049getSizeYbymL2g$ui_release = ((int) (dragAndDropNode.m4049getSizeYbymL2g$ui_release() >> 32)) + intBitsToFloat;
                float m4049getSizeYbymL2g$ui_release2 = ((int) (dragAndDropNode.m4049getSizeYbymL2g$ui_release() & 4294967295L)) + intBitsToFloat2;
                float intBitsToFloat3 = Float.intBitsToFloat((int) (j >> 32));
                if (intBitsToFloat <= intBitsToFloat3 && intBitsToFloat3 <= m4049getSizeYbymL2g$ui_release) {
                    float intBitsToFloat4 = Float.intBitsToFloat((int) (j & 4294967295L));
                    if (intBitsToFloat2 <= intBitsToFloat4 && intBitsToFloat4 <= m4049getSizeYbymL2g$ui_release2) {
                        return true;
                    }
                }
                return false;
