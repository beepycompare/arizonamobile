...
public final class DragAndDropNodeKt {
    ...
    public static final boolean m4861containsUv8p0NA(DragAndDropNode dragAndDropNode, long j) {
        if (dragAndDropNode.getNode().isAttached()) {
            ...
            if (coordinates.isAttached()) {
                ...
                float m4855getSizeYbymL2g$ui = ((int) (dragAndDropNode.m4855getSizeYbymL2g$ui() >> 32)) + intBitsToFloat;
                float m4855getSizeYbymL2g$ui2 = ((int) (dragAndDropNode.m4855getSizeYbymL2g$ui() & 4294967295L)) + intBitsToFloat2;
                float intBitsToFloat3 = Float.intBitsToFloat((int) (j >> 32));
                if (intBitsToFloat <= intBitsToFloat3 && intBitsToFloat3 <= m4855getSizeYbymL2g$ui) {
                    float intBitsToFloat4 = Float.intBitsToFloat((int) (j & 4294967295L));
                    if (intBitsToFloat2 <= intBitsToFloat4 && intBitsToFloat4 <= m4855getSizeYbymL2g$ui2) {
                        return true;
                    }
                }
                return false;
