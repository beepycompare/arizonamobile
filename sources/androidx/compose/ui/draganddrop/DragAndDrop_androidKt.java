...
public final class DragAndDrop_androidKt {
    ...
    public static final long getPositionInRoot(DragAndDropEvent dragAndDropEvent) {
        return Offset.m3829constructorimpl((Float.floatToRawIntBits(dragAndDropEvent.getDragEvent$ui_release().getX()) << 32) | (Float.floatToRawIntBits(dragAndDropEvent.getDragEvent$ui_release().getY()) & 4294967295L));
    }
}
