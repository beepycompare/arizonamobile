...
public abstract class ObjectIntMap<K> {
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i, CharSequence truncated, Function2<? super K, ? super Integer, ? extends CharSequence> transform) {
        long[] jArr;
        long[] jArr2;
        int i2;
        Intrinsics.checkNotNullParameter(separator, "separator");
