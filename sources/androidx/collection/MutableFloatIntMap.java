...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final void adjustStorage$collection() {
        int compare;
        if (this._capacity > 8) {
            compare = Long.compare(ULong.m10378constructorimpl(ULong.m10378constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m10378constructorimpl(ULong.m10378constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
    ...
    public final void dropDeletes$collection() {
        ...
        while (i7 != i2) {
            ...
            if (j4 != 128 && j4 == 254) {
                int hashCode = Float.hashCode(fArr[i7]) * ScatterMapKt.MurmurHashC1;
                ...
                if (((findFirstAvailableSlot - i11) & i2) / 8 == ((i7 - i11) & i2) / 8) {
                    ...
                    if (((j5 >> i14) & 255) == 128) {
                        ...
                        fArr[findFirstAvailableSlot] = fArr[i7];
                        fArr[i7] = 0.0f;
    ...
    public final void resizeStorage$collection(int i) {
        ...
        while (i4 < i2) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                int findFirstAvailableSlot = mutableFloatIntMap.findFirstAvailableSlot(i5 >>> 7);
                long j = i5 & 127;
