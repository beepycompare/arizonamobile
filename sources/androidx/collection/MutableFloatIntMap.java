...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final void adjustStorage$collection() {
        int compare;
        if (this._capacity > 8) {
            compare = Long.compare(ULong.m10394constructorimpl(ULong.m10394constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m10394constructorimpl(ULong.m10394constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
