...
public final class SieveCache<K, V> {
    ...
    public final void adjustStorage$collection() {
        int compare;
        if (this._capacity > 8) {
            compare = Long.compare(ULong.m10378constructorimpl(ULong.m10378constructorimpl(getCount()) * 32) ^ Long.MIN_VALUE, ULong.m10378constructorimpl(ULong.m10378constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
