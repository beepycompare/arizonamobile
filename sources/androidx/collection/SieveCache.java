...
public final class SieveCache<K, V> {
    ...
    public final void adjustStorage$collection() {
        int compare;
        if (this._capacity > 8) {
            compare = Long.compare(ULong.m10081constructorimpl(ULong.m10081constructorimpl(getCount()) * 32) ^ Long.MIN_VALUE, ULong.m10081constructorimpl(ULong.m10081constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE);
            if (compare <= 0) {
