    ...
    public static final <T> Constructor<T> findMatchingConstructor(Class<T> modelClass, List<? extends Class<?>> signature) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            if (Intrinsics.areEqual(signature, list)) {
                Intrinsics.checkNotNull(constructor2, "null cannot be cast to non-null type java.lang.reflect.Constructor<T of androidx.lifecycle.SavedStateViewModelFactory_androidKt.findMatchingConstructor>");
                return constructor2;
