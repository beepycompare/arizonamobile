...
public class NotificationCompat {
    ...
    public static final class Metric {
        ...
        public Metric(MetricValue metricValue, CharSequence charSequence, int i) {
            ...
            Preconditions.checkArgument(!UByte$$ExternalSyntheticBackport0.m9994m(safeCharSequenceToString), "Metric label is required");
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m8647clone() {
    ...
    static boolean isSilent(Notification notification) {
        ...
        } else if (GROUP_KEY_SILENT.equals(notification.getGroup())) {
            return true;
        } else {
