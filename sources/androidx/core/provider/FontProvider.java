...
public class FontProvider {
    ...
    protected static String[] getSelectionArgs(FontRequest fontRequest) {
        ...
        return (variationSettings == null || UByte$$ExternalSyntheticBackport0.m9993m(variationSettings)) ? new String[]{fontRequest.getQuery()} : new String[]{fontRequest.getQuery(), VARIABLE_FONT_QUERY_PARAM};
    }
