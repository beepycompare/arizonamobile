...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> list) {
        ...
        if (list != null) {
            SavedStateWriter.m8522putLongArrayimpl(m8500constructorimpl, key, CollectionsKt.toLongArray(list));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8456getLongArrayimpl(m8414constructorimpl, key));
    }
}
