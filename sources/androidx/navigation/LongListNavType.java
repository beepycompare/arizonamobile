...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> list) {
        ...
        if (list != null) {
            SavedStateWriter.m7687putLongArrayimpl(m7665constructorimpl, key, CollectionsKt.toLongArray(list));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7621getLongArrayimpl(m7579constructorimpl, key));
    }
}
