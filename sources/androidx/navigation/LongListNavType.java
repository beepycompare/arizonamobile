...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> list) {
        ...
        if (list != null) {
            SavedStateWriter.m9131putLongArrayimpl(m9109constructorimpl, key, CollectionsKt.toLongArray(list));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m9065getLongArrayimpl(m9023constructorimpl, key));
    }
}
