...
public final class NavAction {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NavAction) {
            ...
            if (this.destinationId == navAction.destinationId && Intrinsics.areEqual(this.navOptions, navAction.navOptions)) {
                ...
                return (bundle == null || bundle2 == null || !SavedStateReader.m8904contentDeepEqualsimpl(SavedStateReader.m8902constructorimpl(bundle), bundle2)) ? false : true;
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        Bundle bundle = this.defaultArguments;
        return bundle != null ? (hashCode2 * 31) + SavedStateReader.m8905contentDeepHashCodeimpl(SavedStateReader.m8902constructorimpl(bundle)) : hashCode2;
    }
