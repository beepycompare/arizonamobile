...
public final class LongNavType extends NavType<Long> {
    ...
    public void put(Bundle bundle, String key, long j) {
        ...
        SavedStateWriter.m9009putLongimpl(SavedStateWriter.m8988constructorimpl(bundle), key, j);
    }
    ...
    public Long get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Long.valueOf(SavedStateReader.m8943getLongimpl(SavedStateReader.m8902constructorimpl(bundle), key));
    }
}
