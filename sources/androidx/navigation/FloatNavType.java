...
public final class FloatNavType extends NavType<Float> {
    ...
    public void put(Bundle bundle, String key, float f) {
        ...
        SavedStateWriter.m9295putFloatimpl(SavedStateWriter.m9280constructorimpl(bundle), key, f);
    }
    ...
    public Float get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Float.valueOf(SavedStateReader.m9221getFloatimpl(SavedStateReader.m9194constructorimpl(bundle), key));
    }
}
