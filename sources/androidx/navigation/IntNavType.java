...
public final class IntNavType extends NavType<Integer> {
    ...
    public void put(Bundle bundle, String key, int i) {
        ...
        SavedStateWriter.m9297putIntimpl(SavedStateWriter.m9280constructorimpl(bundle), key, i);
    }
    ...
    public Integer get(Bundle bundle, String key) {
        Intrinsics.checkNotNullParameter(bundle, "bundle");
        Intrinsics.checkNotNullParameter(key, "key");
        return Integer.valueOf(SavedStateReader.m9225getIntimpl(SavedStateReader.m9194constructorimpl(bundle), key));
    }
}
