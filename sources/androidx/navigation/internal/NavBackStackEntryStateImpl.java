...
public final class NavBackStackEntryStateImpl {
    ...
    public NavBackStackEntryStateImpl(Bundle state) {
        ...
        this.id = SavedStateReader.m8232getStringimpl(SavedStateReader.m8161constructorimpl(state), KEY_ID);
        this.destinationId = SavedStateReader.m8192getIntimpl(SavedStateReader.m8161constructorimpl(state), KEY_DESTINATION_ID);
        this.args = SavedStateReader.m8218getSavedStateimpl(SavedStateReader.m8161constructorimpl(state), KEY_ARGS);
        this.savedState = SavedStateReader.m8218getSavedStateimpl(SavedStateReader.m8161constructorimpl(state), KEY_SAVED_STATE);
    }
    ...
    public final Bundle writeToState$navigation_runtime_release() {
        ...
        SavedStateWriter.m8280putStringimpl(m8247constructorimpl, KEY_ID, this.id);
        SavedStateWriter.m8264putIntimpl(m8247constructorimpl, KEY_DESTINATION_ID, this.destinationId);
        ...
        SavedStateWriter.m8274putSavedStateimpl(m8247constructorimpl, KEY_ARGS, bundle);
        SavedStateWriter.m8274putSavedStateimpl(m8247constructorimpl, KEY_SAVED_STATE, this.savedState);
        return bundleOf;
    }
}
