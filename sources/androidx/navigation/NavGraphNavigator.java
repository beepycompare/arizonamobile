...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    private final void navigate(NavBackStackEntry navBackStackEntry, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if (startDestinationRoute != null) {
            if (!Intrinsics.areEqual(startDestinationRoute, navDestination.getRoute())) {
                ...
                if (matchingArgs != null && !SavedStateReader.m8239isEmptyimpl(SavedStateReader.m8161constructorimpl(matchingArgs))) {
                    ...
                    SavedStateWriter.m8251putAllimpl(m8247constructorimpl, matchingArgs);
    ...
    public static final boolean navigate$lambda$6(Ref.ObjectRef objectRef, String key) {
        ...
        return objectRef.element == 0 || !SavedStateReader.m8162containsimpl(SavedStateReader.m8161constructorimpl((Bundle) objectRef.element), key);
    }
