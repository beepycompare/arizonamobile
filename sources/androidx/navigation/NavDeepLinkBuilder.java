...
public final class NavDeepLinkBuilder {
    ...
    public final PendingIntent createPendingIntent() {
        ...
        int m9078contentDeepHashCodeimpl = bundle != null ? SavedStateReader.m9078contentDeepHashCodeimpl(SavedStateReader.m9075constructorimpl(bundle)) : 0;
        for (DeepLinkDestination deepLinkDestination : this.destinations) {
            m9078contentDeepHashCodeimpl = (m9078contentDeepHashCodeimpl * 31) + deepLinkDestination.getDestinationId();
            Bundle arguments = deepLinkDestination.getArguments();
            Integer valueOf = arguments != null ? Integer.valueOf(SavedStateReader.m9078contentDeepHashCodeimpl(SavedStateReader.m9075constructorimpl(arguments))) : null;
            if (valueOf != null) {
                m9078contentDeepHashCodeimpl = (m9078contentDeepHashCodeimpl * 31) + valueOf.intValue();
            }
        }
        PendingIntent pendingIntent = createTaskStackBuilder().getPendingIntent(m9078contentDeepHashCodeimpl, 201326592);
