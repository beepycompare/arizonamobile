...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> list) {
        ...
        if (list != null) {
            SavedStateWriter.m9287putBooleanArrayimpl(m9280constructorimpl, key, CollectionsKt.toBooleanArray(list));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m9204getBooleanArrayimpl(m9194constructorimpl, key));
    }
}
