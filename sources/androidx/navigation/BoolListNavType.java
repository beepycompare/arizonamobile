...
public final class BoolListNavType extends CollectionNavType<List<? extends Boolean>> {
    ...
    public void put(Bundle bundle, String key, List<Boolean> list) {
        ...
        if (list != null) {
            SavedStateWriter.m8256putBooleanArrayimpl(m8249constructorimpl, key, CollectionsKt.toBooleanArray(list));
        } else {
    ...
    public List<Boolean> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m8173getBooleanArrayimpl(m8163constructorimpl, key));
    }
}
