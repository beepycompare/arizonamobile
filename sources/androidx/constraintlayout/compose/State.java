...
public final class State extends androidx.constraintlayout.core.state.State {
    ...
    public final long m8462getRootIncomingConstraintsmsEJaDk() {
        return this.rootIncomingConstraints;
    }

    /* renamed from: setRootIncomingConstraints-BRTryo0  reason: not valid java name */
    public final void m8463setRootIncomingConstraintsBRTryo0(long j) {
    ...
    public int convertDimension(Object obj) {
        if (obj instanceof Dp) {
            return this.density.mo423roundToPx0680j_4(((Dp) obj).m8009unboximpl());
        }
