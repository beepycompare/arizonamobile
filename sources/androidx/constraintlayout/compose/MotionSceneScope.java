...
public final class MotionSceneScope {
    ...
    public final void m8439customColormxwnekA(ConstrainScope constrainScope, String str, long j) {
        if (!constrainScope.getContainerObject$constraintlayout_compose_release().has(SchedulerSupport.CUSTOM)) {
            constrainScope.getContainerObject$constraintlayout_compose_release().put(SchedulerSupport.CUSTOM, new CLObject(new char[0]));
        }
        CLObject objectOrNull = constrainScope.getContainerObject$constraintlayout_compose_release().getObjectOrNull(SchedulerSupport.CUSTOM);
        ...
        objectOrNull.putString(str, m8438toJsonHexString8_81llA(j));
    }
    ...
    public final void m8441customDistancewH6b6FI(ConstrainScope constrainScope, String str, float f) {
        customFloat(constrainScope, str, f);
    }

    /* renamed from: customFontSize-kncR6DU  reason: not valid java name */
    public final void m8443customFontSizekncR6DU(ConstrainScope constrainScope, String str, long j) {
        customFloat(constrainScope, str, TextUnit.m8190getValueimpl(j));
    }
    ...
    /* renamed from: customColor-mxwnekA  reason: not valid java name */
    public final void m8440customColormxwnekA(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, m8438toJsonHexString8_81llA(j));
    }
    ...
    /* renamed from: customDistance-wH6b6FI  reason: not valid java name */
    public final void m8442customDistancewH6b6FI(KeyAttributeScope keyAttributeScope, String str, float f) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(f));
    }

    /* renamed from: customFontSize-kncR6DU  reason: not valid java name */
    public final void m8444customFontSizekncR6DU(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(TextUnit.m8190getValueimpl(j)));
    }

    /* renamed from: toJsonHexString-8_81llA  reason: not valid java name */
    private final String m8438toJsonHexString8_81llA(long j) {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String format = String.format("#%08X", Arrays.copyOf(new Object[]{Integer.valueOf(ColorKt.m5334toArgb8_81llA(j))}, 1));
