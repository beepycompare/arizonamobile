...
public final class MotionSceneScope {
    ...
    public final void m8603customColormxwnekA(ConstrainScope constrainScope, String str, long j) {
        if (!constrainScope.getContainerObject$constraintlayout_compose_release().has(SchedulerSupport.CUSTOM)) {
            constrainScope.getContainerObject$constraintlayout_compose_release().put(SchedulerSupport.CUSTOM, new CLObject(new char[0]));
        }
        CLObject objectOrNull = constrainScope.getContainerObject$constraintlayout_compose_release().getObjectOrNull(SchedulerSupport.CUSTOM);
        ...
        objectOrNull.putString(str, m8602toJsonHexString8_81llA(j));
    }
    ...
    public final void m8605customDistancewH6b6FI(ConstrainScope constrainScope, String str, float f) {
        customFloat(constrainScope, str, f);
    }

    /* renamed from: customFontSize-kncR6DU  reason: not valid java name */
    public final void m8607customFontSizekncR6DU(ConstrainScope constrainScope, String str, long j) {
        customFloat(constrainScope, str, TextUnit.m8354getValueimpl(j));
    }
    ...
    /* renamed from: customColor-mxwnekA  reason: not valid java name */
    public final void m8604customColormxwnekA(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, m8602toJsonHexString8_81llA(j));
    }
    ...
    /* renamed from: customDistance-wH6b6FI  reason: not valid java name */
    public final void m8606customDistancewH6b6FI(KeyAttributeScope keyAttributeScope, String str, float f) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(f));
    }

    /* renamed from: customFontSize-kncR6DU  reason: not valid java name */
    public final void m8608customFontSizekncR6DU(KeyAttributeScope keyAttributeScope, String str, long j) {
        keyAttributeScope.getCustomPropertiesValue$constraintlayout_compose_release().put(str, Float.valueOf(TextUnit.m8354getValueimpl(j)));
    }

    /* renamed from: toJsonHexString-8_81llA  reason: not valid java name */
    private final String m8602toJsonHexString8_81llA(long j) {
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
        String format = String.format("#%08X", Arrays.copyOf(new Object[]{Integer.valueOf(ColorKt.m5402toArgb8_81llA(j))}, 1));
