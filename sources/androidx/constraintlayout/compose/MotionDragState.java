...
public final class MotionDragState {
    ...
    public static /* synthetic */ MotionDragState m8566copydhPbTwU$default(MotionDragState motionDragState, boolean z, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return motionDragState.m8569copydhPbTwU(z, j, j2);
    }
    ...
    public final long m8567component2F1C5BW0() {
        return this.dragAmount;
    }

    /* renamed from: component3-9UxMQ8M  reason: not valid java name */
    public final long m8568component39UxMQ8M() {
        return this.velocity;
    }

    /* renamed from: copy-dhPbTwU  reason: not valid java name */
    public final MotionDragState m8569copydhPbTwU(boolean z, long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MotionDragState) {
            ...
            return this.isDragging == motionDragState.isDragging && Offset.m5100equalsimpl0(this.dragAmount, motionDragState.dragAmount) && Velocity.m8397equalsimpl0(this.velocity, motionDragState.velocity);
        }
        return false;
    }

    public int hashCode() {
        return (((Boolean.hashCode(this.isDragging) * 31) + Offset.m5105hashCodeimpl(this.dragAmount)) * 31) + Velocity.m8400hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MotionDragState(isDragging=" + this.isDragging + ", dragAmount=" + ((Object) Offset.m5111toStringimpl(this.dragAmount)) + ", velocity=" + ((Object) Velocity.m8405toStringimpl(this.velocity)) + ')';
    }
    ...
    public final long m8570getDragAmountF1C5BW0() {
        return this.dragAmount;
    }

    /* renamed from: getVelocity-9UxMQ8M  reason: not valid java name */
    public final long m8571getVelocity9UxMQ8M() {
        return this.velocity;
    }
    ...
    public static final class Companion {
        ...
        public final MotionDragState m8572onDragk4lQ0M(long j) {
            return new MotionDragState(true, j, Velocity.Companion.m8409getZero9UxMQ8M(), null);
        }

        /* renamed from: onDragEnd-TH1AsA0  reason: not valid java name */
        public final MotionDragState m8573onDragEndTH1AsA0(long j) {
            return new MotionDragState(false, Offset.Companion.m5118getUnspecifiedF1C5BW0(), j, null);
        }
    }
}
