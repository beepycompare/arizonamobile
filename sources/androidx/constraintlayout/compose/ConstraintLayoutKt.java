...
public final class ConstraintLayoutKt {
    ...
    public static final void ConstraintLayout(ConstraintSet constraintSet, Modifier modifier, int i, AnimationSpec<Float> animationSpec, Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i2, int i3) {
        ...
        if (obj != null) {
            ...
            ConstraintSet m8322ConstraintLayout$lambda17 = m8322ConstraintLayout$lambda17(mutableState);
            ConstraintSet m8324ConstraintLayout$lambda20 = m8324ConstraintLayout$lambda20(mutableState2);
            ...
            Ref ref2 = (Ref) obj4;
            ComposerKt.sourceInformationMarkerEnd(composer);
            MotionLayoutKt.MotionLayoutCore(m8322ConstraintLayout$lambda17, m8324ConstraintLayout$lambda20, null, floatValue, null, 257, DebugFlags.m8343getShowBoundsimpl(m8350getNonebfy_xzQ), DebugFlags.m8345getShowPathsimpl(m8350getNonebfy_xzQ), DebugFlags.m8344getShowKeyPositionsimpl(m8350getNonebfy_xzQ), companion, mutableState3, ref2, defaultInvalidationStrategy, ComposableLambdaKt.rememberComposableLambda(284503157, true, new ConstraintLayoutKt$ConstraintLayout$$inlined$MotionLayoutT3LJ6Qw$1(mutableState3, defaultInvalidationStrategy, ref2, function2, i2), composer, 54), composer, 24576 | ((i5 << 18) & 1879048192), (Ref.$stable << 3) | 3078);
            ComposerKt.sourceInformationMarkerEnd(composer);
            composer.endReplaceGroup();
        } else {
    ...
    public static final ConstraintSet m8322ConstraintLayout$lambda17(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }

    /* renamed from: ConstraintLayout$lambda-20 */
    public static final ConstraintSet m8324ConstraintLayout$lambda20(MutableState<ConstraintSet> mutableState) {
        return mutableState.getValue();
    }
    ...
    public static final Dimension.MaxCoercible m8330atLeast3ABfNKs(Dimension.Coercible coercible, float f) {
        Intrinsics.checkNotNull(coercible, "null cannot be cast to non-null type androidx.constraintlayout.compose.DimensionDescription");
        DimensionDescription dimensionDescription = (DimensionDescription) coercible;
        dimensionDescription.getMin$constraintlayout_compose_release().m8353update0680j_4(f);
        return dimensionDescription;
    }

    /* renamed from: atMost-3ABfNKs */
    public static final Dimension.MinCoercible m8333atMost3ABfNKs(Dimension.Coercible coercible, float f) {
        Intrinsics.checkNotNull(coercible, "null cannot be cast to non-null type androidx.constraintlayout.compose.DimensionDescription");
        DimensionDescription dimensionDescription = (DimensionDescription) coercible;
        dimensionDescription.getMax$constraintlayout_compose_release().m8353update0680j_4(f);
        return dimensionDescription;
    }
    ...
    public static final Dimension m8332atLeastWrapContent3ABfNKs(Dimension.MinCoercible minCoercible, float f) {
    ...
    /* renamed from: atLeast-3ABfNKs */
    public static final Dimension m8331atLeast3ABfNKs(Dimension.MinCoercible minCoercible, float f) {
        Intrinsics.checkNotNull(minCoercible, "null cannot be cast to non-null type androidx.constraintlayout.compose.DimensionDescription");
        DimensionDescription dimensionDescription = (DimensionDescription) minCoercible;
        dimensionDescription.getMin$constraintlayout_compose_release().m8353update0680j_4(f);
        return dimensionDescription;
    ...
    /* renamed from: atMost-3ABfNKs */
    public static final Dimension m8334atMost3ABfNKs(Dimension.MaxCoercible maxCoercible, float f) {
    ...
    public static /* synthetic */ void m8336placeWithFrameTransformKtjjmr4$default(Placeable.PlacementScope placementScope, Placeable placeable, WidgetFrame widgetFrame, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = IntOffset.Companion.m8134getZeronOccac();
        }
        m8335placeWithFrameTransformKtjjmr4(placementScope, placeable, widgetFrame, j);
    }

    /* renamed from: placeWithFrameTransform-Ktjjmr4 */
    public static final void m8335placeWithFrameTransformKtjjmr4(Placeable.PlacementScope placementScope, Placeable placeable, final WidgetFrame widgetFrame, long j) {
        if (widgetFrame.visibility == 8) {
            return;
        }
        if (widgetFrame.isDefaultTransform()) {
            Placeable.PlacementScope.m6762place70tqf50$default(placementScope, placeable, IntOffsetKt.IntOffset(widgetFrame.left - IntOffset.m8123getXimpl(j), widgetFrame.top - IntOffset.m8124getYimpl(j)), 0.0f, 2, null);
            return;
        }
        placementScope.placeWithLayer(placeable, widgetFrame.left - IntOffset.m8123getXimpl(j), widgetFrame.top - IntOffset.m8124getYimpl(j), Float.isNaN(widgetFrame.translationZ) ? 0.0f : widgetFrame.translationZ, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.constraintlayout.compose.ConstraintLayoutKt$placeWithFrameTransform$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                if (!Float.isNaN(WidgetFrame.this.pivotX) || !Float.isNaN(WidgetFrame.this.pivotY)) {
                    graphicsLayerScope.mo5481setTransformOrigin__ExYCQ(TransformOriginKt.TransformOrigin(Float.isNaN(WidgetFrame.this.pivotX) ? 0.5f : WidgetFrame.this.pivotX, Float.isNaN(WidgetFrame.this.pivotY) ? 0.5f : WidgetFrame.this.pivotY));
                }
