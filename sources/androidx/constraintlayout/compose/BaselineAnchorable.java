...
public interface BaselineAnchorable {
    ...
    void mo8257linkToVpY3zN4(ConstraintLayoutBaseScope.BaselineAnchor baselineAnchor, float f, float f2);

    /* renamed from: linkTo-VpY3zN4  reason: not valid java name */
    void mo8258linkToVpY3zN4(ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2);
    ...
    static /* synthetic */ void m8255linkToVpY3zN4$default(BaselineAnchorable baselineAnchorable, ConstraintLayoutBaseScope.BaselineAnchor baselineAnchor, float f, float f2, int i, Object obj) {
        if (obj != null) {
        ...
        baselineAnchorable.mo8257linkToVpY3zN4(baselineAnchor, f, f2);
    }

    /* renamed from: linkTo-VpY3zN4$default  reason: not valid java name */
    static /* synthetic */ void m8256linkToVpY3zN4$default(BaselineAnchorable baselineAnchorable, ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: linkTo-VpY3zN4");
        }
        if ((i & 2) != 0) {
        ...
        baselineAnchorable.mo8258linkToVpY3zN4(horizontalAnchor, f, f2);
    }
}
