    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            i = i3;
            coroutineScope = coroutineScope3;
            obj2 = this.$dragChannel.mo10584tryReceivePtdJZtk();
            if (ChannelResult.m10601isSuccessimpl(obj2)) {
            }
            if (JobKt.isActive(coroutineScope.getCoroutineContext())) {
            }
        } else if (i4 != 2) {
            if (i4 == 3) {
                ...
                obj2 = this.$dragChannel.mo10584tryReceivePtdJZtk();
                if (ChannelResult.m10601isSuccessimpl(obj2)) {
                    motionDragState = (MotionDragState) ChannelResult.m10597getOrThrowimpl(obj2);
