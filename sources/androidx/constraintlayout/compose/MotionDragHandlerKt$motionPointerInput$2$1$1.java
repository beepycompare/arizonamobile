    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            i = i3;
            coroutineScope = coroutineScope3;
            obj2 = this.$dragChannel.mo11440tryReceivePtdJZtk();
            if (ChannelResult.m11456isSuccessimpl(obj2)) {
            }
            if (JobKt.isActive(coroutineScope.getCoroutineContext())) {
            }
        } else if (i4 != 2) {
            if (i4 == 3) {
                ...
                obj2 = this.$dragChannel.mo11440tryReceivePtdJZtk();
                if (ChannelResult.m11456isSuccessimpl(obj2)) {
                    motionDragState = (MotionDragState) ChannelResult.m11452getOrThrowimpl(obj2);
                ...
                if (JobKt.isActive(coroutineScope.getCoroutineContext())) {
                    if (i != 0 && this.$swipeHandler.pendingProgressWhileTouchUp()) {
                        ...
                        if (isDragging != 0) {
                            ...
                            this.I$0 = i2;
                            this.label = 3;
                            if (transitionHandler.m8630onTouchUpsFctU(motionDragState2.m8571getVelocity9UxMQ8M(), this) != coroutine_suspended) {
                                i5 = i2;
                                i2 = i5;
                                coroutineScope = coroutineScope2;
                                i = i2;
                            ...
                            transitionHandler.m8631updateProgressOnDragk4lQ0M(motionDragState2.m8570getDragAmountF1C5BW0());
                            coroutineScope = coroutineScope2;
                            i = i2;
                            motionDragState = null;
                            obj2 = this.$dragChannel.mo11440tryReceivePtdJZtk();
