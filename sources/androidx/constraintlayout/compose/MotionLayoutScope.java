...
public final class MotionLayoutScope {
    ...
    public final class CustomProperties {
        ...
        public final long m7689colorvNxB06k(String str) {
            return MotionLayoutScope.this.measurer.m7704getCustomColorXeAY9LY(this.id, str, MotionLayoutScope.this.motionProgress.getFloatValue());
        }

        /* renamed from: float  reason: not valid java name */
        public final float m7691float(String str) {
        ...
        public final int m7693int(String str) {
        ...
        public final float m7690distanceu2uoSUM(String str) {
            return Dp.m7264constructorimpl(MotionLayoutScope.this.measurer.getCustomFloat(this.id, str, MotionLayoutScope.this.motionProgress.getFloatValue()));
        }

        /* renamed from: fontSize-kPz2Gy4  reason: not valid java name */
        public final long m7692fontSizekPz2Gy4(String str) {
    ...
    public final class MotionProperties {
        ...
        /* renamed from: color-vNxB06k  reason: not valid java name */
        public final long m7694colorvNxB06k(String str) {
            return MotionLayoutScope.this.measurer.m7704getCustomColorXeAY9LY(this.myId, str, MotionLayoutScope.this.motionProgress.getFloatValue());
        }

        /* renamed from: float  reason: not valid java name */
        public final float m7696float(String str) {
            return MotionLayoutScope.this.measurer.getCustomFloat(this.myId, str, MotionLayoutScope.this.motionProgress.getFloatValue());
        }

        /* renamed from: int  reason: not valid java name */
        public final int m7698int(String str) {
        ...
        /* renamed from: distance-u2uoSUM  reason: not valid java name */
        public final float m7695distanceu2uoSUM(String str) {
            return Dp.m7264constructorimpl(MotionLayoutScope.this.measurer.getCustomFloat(this.myId, str, MotionLayoutScope.this.motionProgress.getFloatValue()));
        }

        /* renamed from: fontSize-kPz2Gy4  reason: not valid java name */
        public final long m7697fontSizekPz2Gy4(String str) {
    ...
    public final long m7686motionColorWaAFU9c(String str, String str2) {
        return this.measurer.m7704getCustomColorXeAY9LY(str, str2, this.motionProgress.getFloatValue());
    }
    ...
    public final float m7687motionDistancechRvn1I(String str, String str2) {
        return Dp.m7264constructorimpl(this.measurer.getCustomFloat(str, str2, this.motionProgress.getFloatValue()));
    }
    ...
    public final long m7688motionFontSize5XXgJZs(String str, String str2) {
    ...
    public final long m7683customColorWaAFU9c(String str, String str2) {
        return this.measurer.m7704getCustomColorXeAY9LY(str, str2, this.motionProgress.getFloatValue());
    }
    ...
    public final float m7684customDistancechRvn1I(String str, String str2) {
        return Dp.m7264constructorimpl(this.measurer.getCustomFloat(str, str2, this.motionProgress.getFloatValue()));
    }

    /* renamed from: customFontSize-5XXgJZs  reason: not valid java name */
    public final long m7685customFontSize5XXgJZs(String str, String str2) {
        return TextUnitKt.getSp(this.measurer.getCustomFloat(str, str2, this.motionProgress.getFloatValue()));
    }
