...
public final class MotionCarouselKt {
    ...
    */
    public static final void MotionCarousel(final MotionScene motionScene, final int i, final int i2, String str, String str2, String str3, boolean z, final Function1<? super MotionCarouselScope, Unit> function1, Composer composer, final int i3, final int i4) {
        ...
        Modifier m7725carouselSwipeablepPrIpRY;
        ...
        if (i12 != 0) {
            ...
            if (i7 == 0) {
                ...
                if (i8 != 0) {
                    ...
                    if ((4793491 & i10) == 4793490 || !startRestartGroup.getSkipping()) {
                        ...
                        if (MotionCarousel$lambda$7(mutableIntState) != 0) {
                            ...
                            m7725carouselSwipeablepPrIpRY = CarouselSwipeableKt.m7725carouselSwipeablepPrIpRY(BackgroundKt.m257backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.Companion.m4574getWhite0d7_KjU(), null, 2, null), carouselSwipeableState, map, Orientation.Horizontal, (r26 & 8) != 0, (r26 & 16) != 0 ? false : true, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? CarouselSwipeableKt$carouselSwipeable$1.INSTANCE : new Function2<String, String, ThresholdConfig>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$3
                                @Override // kotlin.jvm.functions.Function2
                                public final ThresholdConfig invoke(String str13, String str14) {
                                    return new FractionalThreshold(0.3f);
                                }
                            }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m7730getVelocityThresholdD9Ej5fM() : 0.0f);
                            ...
                            if (rememberedValue5 == Composer.Companion.getEmpty()) {
                                rememberedValue5 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$4$1
                                    ...
                                    public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                        m7652invokeozmzZPI(intSize.m7426unboximpl());
                                        return Unit.INSTANCE;
                                    }

                                    /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                                    public final void m7652invokeozmzZPI(long j) {
                                        MutableFloatState.this.setFloatValue(IntSize.m7422getWidthimpl(j));
                                    }
                                };
                                startRestartGroup.updateRememberedValue(rememberedValue5);
                            }
                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                            Modifier onSizeChanged = OnRemeasuredModifierKt.onSizeChanged(m7725carouselSwipeablepPrIpRY, (Function1) rememberedValue5);
                            ...
                            String str13 = str8;
                            boolean z4 = z3;
                            MotionLayoutKt.m7668MotionLayoutCoreSehEMGo(motionScene2, f2, str12, 257, m7606getNonebfy_xzQ, onSizeChanged, mutableState4, ref3, defaultInvalidationStrategy, ComposableLambdaKt.rememberComposableLambda(-23317463, true, function3, startRestartGroup, 54), startRestartGroup, 806879232 | (i10 & 14) | (Ref.$stable << 21));
                            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                        ...
                        m7725carouselSwipeablepPrIpRY = CarouselSwipeableKt.m7725carouselSwipeablepPrIpRY(BackgroundKt.m257backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.Companion.m4574getWhite0d7_KjU(), null, 2, null), carouselSwipeableState, map2, Orientation.Horizontal, (r26 & 8) != 0, (r26 & 16) != 0 ? false : true, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? CarouselSwipeableKt$carouselSwipeable$1.INSTANCE : new Function2<String, String, ThresholdConfig>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$3
                            @Override // kotlin.jvm.functions.Function2
                            public final ThresholdConfig invoke(String str132, String str14) {
                                return new FractionalThreshold(0.3f);
                            }
                        }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map2.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m7730getVelocityThresholdD9Ej5fM() : 0.0f);
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1162113093, "CC(remember):MotionCarousel.kt#9igjgp");
                        rememberedValue5 = startRestartGroup.rememberedValue();
                        if (rememberedValue5 == Composer.Companion.getEmpty()) {
                        }
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        Modifier onSizeChanged2 = OnRemeasuredModifierKt.onSizeChanged(m7725carouselSwipeablepPrIpRY, (Function1) rememberedValue5);
                        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -808697931, "CC(MotionLayout)P(4,6,3,7,1:androidx.constraintlayout.compose.DebugFlags,5,2)255@11054L53,256@11136L93,261@11391L627,277@12024L412:MotionLayout.kt#fysre8");
                        int m7606getNonebfy_xzQ2 = DebugFlags.Companion.m7606getNonebfy_xzQ();
                        ...
                        String str132 = str8;
                        boolean z42 = z3;
                        MotionLayoutKt.m7668MotionLayoutCoreSehEMGo(motionScene2, f2, str122, 257, m7606getNonebfy_xzQ2, onSizeChanged2, mutableState42, ref32, defaultInvalidationStrategy2, ComposableLambdaKt.rememberComposableLambda(-23317463, true, function32, startRestartGroup, 54), startRestartGroup, 806879232 | (i10 & 14) | (Ref.$stable << 21));
                        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                        if (ComposerKt.isTraceInProgress()) {
                        }
                        z2 = z42;
                ...
                m7725carouselSwipeablepPrIpRY = CarouselSwipeableKt.m7725carouselSwipeablepPrIpRY(BackgroundKt.m257backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.Companion.m4574getWhite0d7_KjU(), null, 2, null), carouselSwipeableState, map22, Orientation.Horizontal, (r26 & 8) != 0, (r26 & 16) != 0 ? false : true, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? CarouselSwipeableKt$carouselSwipeable$1.INSTANCE : new Function2<String, String, ThresholdConfig>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$3
                    @Override // kotlin.jvm.functions.Function2
                    public final ThresholdConfig invoke(String str1322, String str142) {
                        return new FractionalThreshold(0.3f);
                    }
                }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map22.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m7730getVelocityThresholdD9Ej5fM() : 0.0f);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1162113093, "CC(remember):MotionCarousel.kt#9igjgp");
                rememberedValue5 = startRestartGroup.rememberedValue();
                if (rememberedValue5 == Composer.Companion.getEmpty()) {
                }
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                Modifier onSizeChanged22 = OnRemeasuredModifierKt.onSizeChanged(m7725carouselSwipeablepPrIpRY, (Function1) rememberedValue5);
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, -808697931, "CC(MotionLayout)P(4,6,3,7,1:androidx.constraintlayout.compose.DebugFlags,5,2)255@11054L53,256@11136L93,261@11391L627,277@12024L412:MotionLayout.kt#fysre8");
                int m7606getNonebfy_xzQ22 = DebugFlags.Companion.m7606getNonebfy_xzQ();
            ...
            m7725carouselSwipeablepPrIpRY = CarouselSwipeableKt.m7725carouselSwipeablepPrIpRY(BackgroundKt.m257backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.Companion.m4574getWhite0d7_KjU(), null, 2, null), carouselSwipeableState, map222, Orientation.Horizontal, (r26 & 8) != 0, (r26 & 16) != 0 ? false : true, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? CarouselSwipeableKt$carouselSwipeable$1.INSTANCE : new Function2<String, String, ThresholdConfig>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$3
                @Override // kotlin.jvm.functions.Function2
                public final ThresholdConfig invoke(String str13222, String str142) {
                    return new FractionalThreshold(0.3f);
                }
            }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map222.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m7730getVelocityThresholdD9Ej5fM() : 0.0f);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1162113093, "CC(remember):MotionCarousel.kt#9igjgp");
            rememberedValue5 = startRestartGroup.rememberedValue();
            if (rememberedValue5 == Composer.Companion.getEmpty()) {
            }
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            Modifier onSizeChanged222 = OnRemeasuredModifierKt.onSizeChanged(m7725carouselSwipeablepPrIpRY, (Function1) rememberedValue5);
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -808697931, "CC(MotionLayout)P(4,6,3,7,1:androidx.constraintlayout.compose.DebugFlags,5,2)255@11054L53,256@11136L93,261@11391L627,277@12024L412:MotionLayout.kt#fysre8");
            int m7606getNonebfy_xzQ222 = DebugFlags.Companion.m7606getNonebfy_xzQ();
            ...
            String str13222 = str8;
            boolean z4222 = z3;
            MotionLayoutKt.m7668MotionLayoutCoreSehEMGo(motionScene2, f2, str12222, 257, m7606getNonebfy_xzQ222, onSizeChanged222, mutableState4222, ref3222, defaultInvalidationStrategy222, ComposableLambdaKt.rememberComposableLambda(-23317463, true, function3222, startRestartGroup, 54), startRestartGroup, 806879232 | (i10 & 14) | (Ref.$stable << 21));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            if (ComposerKt.isTraceInProgress()) {
            }
            z2 = z4222;
        ...
        m7725carouselSwipeablepPrIpRY = CarouselSwipeableKt.m7725carouselSwipeablepPrIpRY(BackgroundKt.m257backgroundbw27NRU$default(SizeKt.fillMaxSize$default(Modifier.Companion, 0.0f, 1, null), Color.Companion.m4574getWhite0d7_KjU(), null, 2, null), carouselSwipeableState, map2222, Orientation.Horizontal, (r26 & 8) != 0, (r26 & 16) != 0 ? false : true, (r26 & 32) != 0 ? null : null, (r26 & 64) != 0 ? CarouselSwipeableKt$carouselSwipeable$1.INSTANCE : new Function2<String, String, ThresholdConfig>() { // from class: androidx.constraintlayout.compose.MotionCarouselKt$MotionCarousel$3
            @Override // kotlin.jvm.functions.Function2
            public final ThresholdConfig invoke(String str132222, String str142) {
                return new FractionalThreshold(0.3f);
            }
        }, (r26 & 128) != 0 ? SwipeableDefaults.resistanceConfig$default(SwipeableDefaults.INSTANCE, map2222.keySet(), 0.0f, 0.0f, 6, null) : null, (r26 & 256) != 0 ? SwipeableDefaults.INSTANCE.m7730getVelocityThresholdD9Ej5fM() : 0.0f);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, 1162113093, "CC(remember):MotionCarousel.kt#9igjgp");
        rememberedValue5 = startRestartGroup.rememberedValue();
        if (rememberedValue5 == Composer.Companion.getEmpty()) {
        }
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        Modifier onSizeChanged2222 = OnRemeasuredModifierKt.onSizeChanged(m7725carouselSwipeablepPrIpRY, (Function1) rememberedValue5);
        ComposerKt.sourceInformationMarkerStart(startRestartGroup, -808697931, "CC(MotionLayout)P(4,6,3,7,1:androidx.constraintlayout.compose.DebugFlags,5,2)255@11054L53,256@11136L93,261@11391L627,277@12024L412:MotionLayout.kt#fysre8");
        int m7606getNonebfy_xzQ2222 = DebugFlags.Companion.m7606getNonebfy_xzQ();
        ...
        String str132222 = str8;
        boolean z42222 = z3;
        MotionLayoutKt.m7668MotionLayoutCoreSehEMGo(motionScene2, f2, str122222, 257, m7606getNonebfy_xzQ2222, onSizeChanged2222, mutableState42222, ref32222, defaultInvalidationStrategy2222, ComposableLambdaKt.rememberComposableLambda(-23317463, true, function32222, startRestartGroup, 54), startRestartGroup, 806879232 | (i10 & 14) | (Ref.$stable << 21));
        ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        if (ComposerKt.isTraceInProgress()) {
        }
        z2 = z42222;
    ...
    public static final void ItemHolder(final int i, final String str, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i2) {
        ...
        if ((i3 & 1171) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            if (z) {
                float f = 20;
                layoutId$default = BorderKt.m269borderxT4_qwU(ClipKt.clip(layoutId$default, RoundedCornerShapeKt.m1197RoundedCornerShape0680j_4(Dp.m7251constructorimpl(f))), Dp.m7251constructorimpl(2), ColorKt.Color(0, 0, 0, 60), RoundedCornerShapeKt.m1197RoundedCornerShape0680j_4(Dp.m7251constructorimpl(f)));
            }
