        ...
        if (i == 0) {
            ...
            detectDragGesturesWhenNeeded = MotionDragHandlerKt.detectDragGesturesWhenNeeded(pointerInputScope, new Function1<Offset, Boolean>() { // from class: androidx.constraintlayout.compose.MotionDragHandlerKt$motionPointerInput$2$2$1.1
                ...
                public /* bridge */ /* synthetic */ Boolean invoke(Offset offset) {
                    return m7654invokek4lQ0M(offset.m4303unboximpl());
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final Boolean m7654invokek4lQ0M(long j) {
                    return Boolean.valueOf(TransitionHandler.this.m7720onAcceptFirstDownForOnSwipek4lQ0M(j));
                }
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m7655invokek4lQ0M(offset.m4303unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M  reason: not valid java name */
                public final void m7655invokek4lQ0M(long j) {
                ...
                public final void invoke2() {
                    channel.mo8127trySendJP2dKIU(MotionDragState.Companion.m7664onDragEndTH1AsA0(velocityTracker.m5924calculateVelocity9UxMQ8M()));
                }
                ...
                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    channel2.mo8127trySendJP2dKIU(MotionDragState.Companion.m7664onDragEndTH1AsA0(velocityTracker.m5924calculateVelocity9UxMQ8M()));
                }
                ...
                public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                    m7656invokeUv8p0NA(pointerInputChange, offset.m4303unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
                public final void m7656invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    VelocityTrackerKt.addPointerInputChange(VelocityTracker.this, pointerInputChange);
                    channel3.mo8127trySendJP2dKIU(MotionDragState.Companion.m7663onDragk4lQ0M(j));
                }
            }, this);
