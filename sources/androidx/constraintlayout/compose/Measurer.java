...
public class Measurer implements BasicMeasure.Measurer, DesignInfoProvider {
    ...
    public void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
        ...
        boolean z2 = true;
        obtainConstraints(measure.horizontalBehavior, measure.horizontalDimension, constraintWidget.mMatchConstraintDefaultWidth, measure.measureStrategy, (numArr != null ? numArr[1].intValue() : 0) == constraintWidget.getHeight(), constraintWidget.isResolvedHorizontally(), Constraints.m8113getMaxWidthimpl(this.state.m8627getRootIncomingConstraintsmsEJaDk()), this.widthConstraintsHolder);
        obtainConstraints(measure.verticalBehavior, measure.verticalDimension, constraintWidget.mMatchConstraintDefaultHeight, measure.measureStrategy, (numArr != null ? numArr[0].intValue() : 0) == constraintWidget.getWidth(), constraintWidget.isResolvedVertically(), Constraints.m8112getMaxHeightimpl(this.state.m8627getRootIncomingConstraintsmsEJaDk()), this.heightConstraintsHolder);
        ...
        if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || measure.horizontalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultWidth != 0 || measure.verticalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultHeight != 0) {
            long m8555measureWidgetyQShABA = m8555measureWidgetyQShABA(constraintWidget, Constraints);
            constraintWidget.setMeasureRequested(false);
            Integer valueOf = Integer.valueOf(IntIntPair.m28getFirstimpl(m8555measureWidgetyQShABA));
            ...
            Integer valueOf4 = Integer.valueOf(IntIntPair.m29getSecondimpl(m8555measureWidgetyQShABA));
            ...
            if (intValue != IntIntPair.m28getFirstimpl(m8555measureWidgetyQShABA)) {
                Constraints = ConstraintsKt.Constraints(intValue, intValue, Constraints.m8114getMinHeightimpl(Constraints), Constraints.m8112getMaxHeightimpl(Constraints));
                z = true;
            } else {
                z = false;
            }
            if (intValue2 != IntIntPair.m29getSecondimpl(m8555measureWidgetyQShABA)) {
                Constraints = ConstraintsKt.Constraints(Constraints.m8115getMinWidthimpl(Constraints), Constraints.m8113getMaxWidthimpl(Constraints), intValue2, intValue2);
                z = true;
            }
            if (z) {
                m8555measureWidgetyQShABA(constraintWidget, Constraints);
                constraintWidget.setMeasureRequested(false);
            }
        }
    ...
    public final long m8557performMeasure2eBlSMk(long j, LayoutDirection layoutDirection, ConstraintSet constraintSet, List<? extends Measurable> list, int i) {
        androidx.constraintlayout.core.state.Dimension min;
        androidx.constraintlayout.core.state.Dimension min2;
        if (list.isEmpty()) {
            return IntSizeKt.IntSize(Constraints.m8115getMinWidthimpl(j), Constraints.m8114getMinHeightimpl(j));
        }
        ...
        if (isDirty) {
            ...
            ConstraintLayoutKt.buildMapping(state3, list);
        }
        m8556applyRootSizeBRTryo0(j);
    ...
    protected final void m8556applyRootSizeBRTryo0(long j) {
        this.root.setWidth(Constraints.m8113getMaxWidthimpl(j));
        this.root.setHeight(Constraints.m8112getMaxHeightimpl(j));
        this.forcedScaleFactor = Float.NaN;
        LayoutInformationReceiver layoutInformationReceiver = this.layoutInformationReceiver;
    ...
    public final void performLayout(Placeable.PlacementScope placementScope, List<? extends Measurable> list) {
        ...
        while (true) {
            ...
            if (!this.frameCache.containsKey(measurable2)) {
                placementScope2 = placementScope;
                ConstraintLayoutKt.m8501placeWithFrameTransformKtjjmr4$default(placementScope2, measurable2.mo6818measureBRTryo0(Constraints.Companion.m8123fixedJhjzzOo(placeable.getWidth(), placeable.getHeight())), widgetFrame, 0L, 4, null);
            } else {
                placementScope2 = placementScope;
                ConstraintLayoutKt.m8501placeWithFrameTransformKtjjmr4$default(placementScope2, placeable, widgetFrame, 0L, 4, null);
            }
            i++;
            placementScope = placementScope2;
        }
    ...
    private final long m8555measureWidgetyQShABA(ConstraintWidget constraintWidget, long j) {
        int i;
        Object companionWidget = constraintWidget.getCompanionWidget();
        String str = constraintWidget.stringId;
        int i2 = 0;
        if (constraintWidget instanceof VirtualLayout) {
            if (Constraints.m8111getHasFixedWidthimpl(j)) {
                ...
                i = Constraints.m8109getHasBoundedWidthimpl(j) ? Integer.MIN_VALUE : 0;
            }
            if (Constraints.m8110getHasFixedHeightimpl(j)) {
                i2 = 1073741824;
            } else if (Constraints.m8108getHasBoundedHeightimpl(j)) {
                i2 = Integer.MIN_VALUE;
            }
            VirtualLayout virtualLayout = (VirtualLayout) constraintWidget;
            virtualLayout.measure(i, Constraints.m8113getMaxWidthimpl(j), i2, Constraints.m8112getMaxHeightimpl(j));
            return IntIntPair.m24constructorimpl(virtualLayout.getMeasuredWidth(), virtualLayout.getMeasuredHeight());
        } else if (companionWidget instanceof Measurable) {
            Placeable mo6818measureBRTryo0 = ((Measurable) companionWidget).mo6818measureBRTryo0(j);
            this.placeables.put(companionWidget, mo6818measureBRTryo0);
            return IntIntPair.m24constructorimpl(mo6818measureBRTryo0.getWidth(), mo6818measureBRTryo0.getHeight());
        } else {
    ...
    public final void drawDebugBounds(DrawScope drawScope, float f) {
        ...
        float m5172getWidthimpl = (Size.m5172getWidthimpl(drawScope.mo5922getSizeNHjbRc()) - layoutCurrentWidth) / 2.0f;
        float m5169getHeightimpl = (Size.m5169getHeightimpl(drawScope.mo5922getSizeNHjbRc()) - layoutCurrentHeight) / 2.0f;
        long m5385getWhite0d7_KjU = Color.Companion.m5385getWhite0d7_KjU();
        float f2 = m5172getWidthimpl + layoutCurrentWidth;
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5385getWhite0d7_KjU, OffsetKt.Offset(m5172getWidthimpl, m5169getHeightimpl), OffsetKt.Offset(f2, m5169getHeightimpl), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        float f3 = m5169getHeightimpl + layoutCurrentHeight;
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5385getWhite0d7_KjU, OffsetKt.Offset(f2, m5169getHeightimpl), OffsetKt.Offset(f2, f3), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5385getWhite0d7_KjU, OffsetKt.Offset(f2, f3), OffsetKt.Offset(m5172getWidthimpl, f3), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5385getWhite0d7_KjU, OffsetKt.Offset(m5172getWidthimpl, f3), OffsetKt.Offset(m5172getWidthimpl, m5169getHeightimpl), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        float f4 = m5172getWidthimpl + 1.0f;
        float f5 = m5169getHeightimpl + 1.0f;
        long m5374getBlack0d7_KjU = Color.Companion.m5374getBlack0d7_KjU();
        float f6 = f4 + layoutCurrentWidth;
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5374getBlack0d7_KjU, OffsetKt.Offset(f4, f5), OffsetKt.Offset(f6, f5), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        float f7 = layoutCurrentHeight + f5;
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5374getBlack0d7_KjU, OffsetKt.Offset(f6, f5), OffsetKt.Offset(f6, f7), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5374getBlack0d7_KjU, OffsetKt.Offset(f6, f7), OffsetKt.Offset(f4, f7), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        DrawScope.m5908drawLineNGM6Ib0$default(drawScope, m5374getBlack0d7_KjU, OffsetKt.Offset(f4, f7), OffsetKt.Offset(f4, f5), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
    }

    /* renamed from: getColor-wrIjXm8$default  reason: not valid java name */
    static /* synthetic */ long m8554getColorwrIjXm8$default(Measurer measurer, String str, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Color.Companion.m5374getBlack0d7_KjU();
            }
            return measurer.m8553getColorwrIjXm8(str, j);
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getColor-wrIjXm8");
    }

    /* renamed from: getColor-wrIjXm8  reason: not valid java name */
    private final long m8553getColorwrIjXm8(String str, long j) {
                        ...
                        switch (type.hashCode()) {
                            case -1377687758:
                                ...
                                if (type.equals("button")) {
                                    ...
                                    BasicTextKt.m1502BasicTextVhcvRP8(str != null ? str : "text", PaddingKt.m1050padding3ABfNKs(BackgroundKt.m288backgroundbw27NRU$default(ClipKt.clip(LayoutIdKt.layoutId(Modifier.Companion, id), RoundedCornerShapeKt.RoundedCornerShape(20)), m8553getColorwrIjXm8(designElement.getParams().get(TtmlNode.ATTR_TTS_BACKGROUND_COLOR), Color.Companion.m5380getLightGray0d7_KjU()), null, 2, null), Dp.m8160constructorimpl(8.0f)), getTextStyle(designElement.getParams()), (Function1) null, 0, false, 0, 0, (ColorProducer) null, startRestartGroup, 0, (int) TypedValues.PositionType.TYPE_PERCENT_HEIGHT);
                                    startRestartGroup.endReplaceGroup();
                                    break;
                                }
                            ...
                            case 97739:
                                ...
                                if (type.equals("box")) {
                                    ...
                                    Modifier m288backgroundbw27NRU$default = BackgroundKt.m288backgroundbw27NRU$default(LayoutIdKt.layoutId(Modifier.Companion, id), m8553getColorwrIjXm8(designElement.getParams().get(TtmlNode.ATTR_TTS_BACKGROUND_COLOR), Color.Companion.m5380getLightGray0d7_KjU()), null, 2, null);
                                    ...
                                    BasicTextKt.m1502BasicTextVhcvRP8(str4, PaddingKt.m1050padding3ABfNKs(Modifier.Companion, Dp.m8160constructorimpl(8.0f)), getTextStyle(designElement.getParams()), (Function1) null, 0, false, 0, 0, (ColorProducer) null, startRestartGroup, 48, (int) TypedValues.PositionType.TYPE_PERCENT_HEIGHT);
                                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                            ...
                            case 3556653:
                                if (type.equals("text")) {
                                    ...
                                    i8 = i9;
                                    i4 = i10;
                                    BasicTextKt.m1502BasicTextVhcvRP8(str5 != null ? str5 : "text", LayoutIdKt.layoutId(Modifier.Companion, id), getTextStyle(designElement.getParams()), (Function1) null, 0, false, 0, 0, (ColorProducer) null, startRestartGroup, 0, (int) TypedValues.PositionType.TYPE_PERCENT_HEIGHT);
                                    startRestartGroup.endReplaceGroup();
                                    i5 = i6;
                                    i3 = i8;
                                    break;
