...
public class Measurer implements BasicMeasure.Measurer, DesignInfoProvider {
    ...
    public void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
        ...
        boolean z2 = true;
        obtainConstraints(measure.horizontalBehavior, measure.horizontalDimension, constraintWidget.mMatchConstraintDefaultWidth, measure.measureStrategy, (numArr != null ? numArr[1].intValue() : 0) == constraintWidget.getHeight(), constraintWidget.isResolvedHorizontally(), Constraints.m7508getMaxWidthimpl(this.state.m8022getRootIncomingConstraintsmsEJaDk()), this.widthConstraintsHolder);
        obtainConstraints(measure.verticalBehavior, measure.verticalDimension, constraintWidget.mMatchConstraintDefaultHeight, measure.measureStrategy, (numArr != null ? numArr[0].intValue() : 0) == constraintWidget.getWidth(), constraintWidget.isResolvedVertically(), Constraints.m7507getMaxHeightimpl(this.state.m8022getRootIncomingConstraintsmsEJaDk()), this.heightConstraintsHolder);
        ...
        if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || measure.horizontalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultWidth != 0 || measure.verticalBehavior != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultHeight != 0) {
            long m7950measureWidgetyQShABA = m7950measureWidgetyQShABA(constraintWidget, Constraints);
            constraintWidget.setMeasureRequested(false);
            Integer valueOf = Integer.valueOf(IntIntPair.m28getFirstimpl(m7950measureWidgetyQShABA));
            ...
            Integer valueOf4 = Integer.valueOf(IntIntPair.m29getSecondimpl(m7950measureWidgetyQShABA));
            ...
            if (intValue != IntIntPair.m28getFirstimpl(m7950measureWidgetyQShABA)) {
                Constraints = ConstraintsKt.Constraints(intValue, intValue, Constraints.m7509getMinHeightimpl(Constraints), Constraints.m7507getMaxHeightimpl(Constraints));
                z = true;
            } else {
                z = false;
            }
            if (intValue2 != IntIntPair.m29getSecondimpl(m7950measureWidgetyQShABA)) {
                Constraints = ConstraintsKt.Constraints(Constraints.m7510getMinWidthimpl(Constraints), Constraints.m7508getMaxWidthimpl(Constraints), intValue2, intValue2);
                z = true;
            }
            if (z) {
                m7950measureWidgetyQShABA(constraintWidget, Constraints);
                constraintWidget.setMeasureRequested(false);
            }
        }
    ...
    public final long m7952performMeasure2eBlSMk(long j, LayoutDirection layoutDirection, ConstraintSet constraintSet, List<? extends Measurable> list, int i) {
        androidx.constraintlayout.core.state.Dimension min;
        androidx.constraintlayout.core.state.Dimension min2;
        if (list.isEmpty()) {
            return IntSizeKt.IntSize(Constraints.m7510getMinWidthimpl(j), Constraints.m7509getMinHeightimpl(j));
        }
        ...
        this.state.m8023setRootIncomingConstraintsBRTryo0(j);
    ...
    protected final void m7951applyRootSizeBRTryo0(long j) {
        this.root.setWidth(Constraints.m7508getMaxWidthimpl(j));
        this.root.setHeight(Constraints.m7507getMaxHeightimpl(j));
        this.forcedScaleFactor = Float.NaN;
        LayoutInformationReceiver layoutInformationReceiver = this.layoutInformationReceiver;
    ...
    public final void performLayout(Placeable.PlacementScope placementScope, List<? extends Measurable> list) {
        ...
        while (true) {
            ...
            if (!this.frameCache.containsKey(measurable2)) {
                placementScope2 = placementScope;
                ConstraintLayoutKt.m7896placeWithFrameTransformKtjjmr4$default(placementScope2, measurable2.mo6216measureBRTryo0(Constraints.Companion.m7518fixedJhjzzOo(placeable.getWidth(), placeable.getHeight())), widgetFrame, 0L, 4, null);
            } else {
                placementScope2 = placementScope;
                ConstraintLayoutKt.m7896placeWithFrameTransformKtjjmr4$default(placementScope2, placeable, widgetFrame, 0L, 4, null);
            }
            i++;
            placementScope = placementScope2;
        }
    ...
    private final long m7950measureWidgetyQShABA(ConstraintWidget constraintWidget, long j) {
        int i;
        Object companionWidget = constraintWidget.getCompanionWidget();
        String str = constraintWidget.stringId;
        int i2 = 0;
        if (constraintWidget instanceof VirtualLayout) {
            if (Constraints.m7506getHasFixedWidthimpl(j)) {
                ...
                i = Constraints.m7504getHasBoundedWidthimpl(j) ? Integer.MIN_VALUE : 0;
            }
            if (Constraints.m7505getHasFixedHeightimpl(j)) {
                i2 = 1073741824;
            } else if (Constraints.m7503getHasBoundedHeightimpl(j)) {
                i2 = Integer.MIN_VALUE;
            }
            VirtualLayout virtualLayout = (VirtualLayout) constraintWidget;
            virtualLayout.measure(i, Constraints.m7508getMaxWidthimpl(j), i2, Constraints.m7507getMaxHeightimpl(j));
            ...
            Placeable mo6216measureBRTryo0 = ((Measurable) companionWidget).mo6216measureBRTryo0(j);
            this.placeables.put(companionWidget, mo6216measureBRTryo0);
            return IntIntPair.m24constructorimpl(mo6216measureBRTryo0.getWidth(), mo6216measureBRTryo0.getHeight());
        } else {
    ...
    public final void drawDebugBounds(DrawScope drawScope, float f) {
        ...
        float m4596getWidthimpl = (Size.m4596getWidthimpl(drawScope.mo5346getSizeNHjbRc()) - layoutCurrentWidth) / 2.0f;
        float m4593getHeightimpl = (Size.m4593getHeightimpl(drawScope.mo5346getSizeNHjbRc()) - layoutCurrentHeight) / 2.0f;
        long m4809getWhite0d7_KjU = Color.Companion.m4809getWhite0d7_KjU();
        float f2 = m4596getWidthimpl + layoutCurrentWidth;
        DrawScope.m5332drawLineNGM6Ib0$default(drawScope, m4809getWhite0d7_KjU, OffsetKt.Offset(m4596getWidthimpl, m4593getHeightimpl), OffsetKt.Offset(f2, m4593getHeightimpl), 0.0f, 0, null, 0.0f, null, 0, TypedValues.PositionType.TYPE_PERCENT_HEIGHT, null);
        float f3 = m4593getHeightimpl + layoutCurrentHeight;
    ...
    static /* synthetic */ long m7949getColorwrIjXm8$default(Measurer measurer, String str, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Color.Companion.m4798getBlack0d7_KjU();
            }
            return measurer.m7948getColorwrIjXm8(str, j);
        }
        throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: getColor-wrIjXm8");
    }

    /* renamed from: getColor-wrIjXm8  reason: not valid java name */
    private final long m7948getColorwrIjXm8(String str, long j) {
    ...
    private final TextStyle getTextStyle(HashMap<String, String> hashMap) {
        ...
        long m7760getUnspecifiedXSAIIZE = TextUnit.Companion.m7760getUnspecifiedXSAIIZE();
        if (str != null) {
            m7760getUnspecifiedXSAIIZE = TextUnitKt.getSp(Float.parseFloat(str));
        }
        return new TextStyle(m7949getColorwrIjXm8$default(this, hashMap.get("color"), 0L, 2, null), m7760getUnspecifiedXSAIIZE, (FontWeight) null, (FontStyle) null, (FontSynthesis) null, (FontFamily) null, (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (DrawStyle) null, 0, 0, 0L, (TextIndent) null, (PlatformTextStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 16777212, (DefaultConstructorMarker) null);
    }
                        ...
                        switch (type.hashCode()) {
                            ...
                            case 97739:
                                ...
                                if (type.equals("box")) {
                                    ...
                                    Modifier m264backgroundbw27NRU$default = BackgroundKt.m264backgroundbw27NRU$default(LayoutIdKt.layoutId(Modifier.Companion, id), m7948getColorwrIjXm8(designElement.getParams().get(TtmlNode.ATTR_TTS_BACKGROUND_COLOR), Color.Companion.m4804getLightGray0d7_KjU()), null, 2, null);
                            ...
                            case 3556653:
                                if (type.equals("text")) {
                                    ...
                                    i8 = i9;
                                    i4 = i10;
                                    BasicTextKt.m1157BasicTextVhcvRP8(str5 != null ? str5 : "text", LayoutIdKt.layoutId(Modifier.Companion, id), getTextStyle(designElement.getParams()), (Function1) null, 0, false, 0, 0, (ColorProducer) null, startRestartGroup, 0, (int) TypedValues.PositionType.TYPE_PERCENT_HEIGHT);
                                    startRestartGroup.endReplaceGroup();
                                    i5 = i6;
                                    i3 = i8;
                                    break;
