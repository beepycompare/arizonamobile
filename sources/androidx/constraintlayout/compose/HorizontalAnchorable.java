...
public interface HorizontalAnchorable {
    ...
    void mo7521linkToVpY3zN4(ConstraintLayoutBaseScope.BaselineAnchor baselineAnchor, float f, float f2);

    /* renamed from: linkTo-VpY3zN4 */
    void mo7522linkToVpY3zN4(ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2);
    ...
    static /* synthetic */ void m7639linkToVpY3zN4$default(HorizontalAnchorable horizontalAnchorable, ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2, int i, Object obj) {
        if (obj != null) {
        ...
        horizontalAnchorable.mo7522linkToVpY3zN4(horizontalAnchor, f, f2);
    }

    /* renamed from: linkTo-VpY3zN4$default  reason: not valid java name */
    static /* synthetic */ void m7638linkToVpY3zN4$default(HorizontalAnchorable horizontalAnchorable, ConstraintLayoutBaseScope.BaselineAnchor baselineAnchor, float f, float f2, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: linkTo-VpY3zN4");
        }
        if ((i & 2) != 0) {
        ...
        horizontalAnchorable.mo7521linkToVpY3zN4(baselineAnchor, f, f2);
    }
}
