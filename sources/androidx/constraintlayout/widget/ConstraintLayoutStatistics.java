...
public class ConstraintLayoutStatistics {
    ...
    /* renamed from: clone */
    public ConstraintLayoutStatistics m8481clone() {
    ...
    private void log(String str) {
        ...
        Log.v(str, "CL Perf: --------  Performance .(" + stackTraceElement.getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTraceElement.getLineNumber() + ")  ------ ");
