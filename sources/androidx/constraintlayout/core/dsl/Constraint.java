    ...
    public class Anchor {
        ...
        public void build(StringBuilder sb) {
            if (this.mConnection != null) {
                sb.append(this.mSide.toString().toLowerCase()).append(StringUtils.PROCESS_POSTFIX_DELIMITER).append(this).append(",\n");
            }
        }
        ...
        public String toString() {
            ...
            if (this.mMargin != 0) {
                sb.append(StringUtils.COMMA).append(this.mMargin);
            }
            if (this.mGoneMargin != Integer.MIN_VALUE) {
                if (this.mMargin == 0) {
                    sb.append(",0,").append(this.mGoneMargin);
                } else {
                    sb.append(StringUtils.COMMA).append(this.mGoneMargin);
                }
            }
            sb.append("]");
            return sb.toString();
    ...
    public String toString() {
        ...
        if (this.mCircleConstraint != null && (!Float.isNaN(this.mCircleAngle) || this.mCircleRadius != Integer.MIN_VALUE)) {
            ...
            if (!Float.isNaN(this.mCircleAngle)) {
                sb.append(StringUtils.COMMA).append(this.mCircleAngle);
            }
            if (this.mCircleRadius != Integer.MIN_VALUE) {
                if (Float.isNaN(this.mCircleAngle)) {
                    sb.append(",0,").append(this.mCircleRadius);
                } else {
                    sb.append(StringUtils.COMMA).append(this.mCircleRadius);
                }
            }
            sb.append("],\n");
        }
