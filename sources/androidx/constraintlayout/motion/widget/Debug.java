...
public class Debug {
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str3 = str3 + " ";
            Log.v(str, str2 + str3 + (".(" + stackTrace[i2].getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3);
        }
    }
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            StackTraceElement stackTraceElement = stackTrace[i2];
            str2 = str2 + " ";
            System.out.println(str + str2 + (".(" + stackTrace[i2].getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
