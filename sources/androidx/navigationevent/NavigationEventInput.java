...
public abstract class NavigationEventInput {
    ...
    public final void doOnHasEnabledHandlersChanged$navigationevent(boolean z) {
        onHasEnabledHandlersChanged(z);
    }
