...
public final class NavigationEventDispatcher {
    ...
    public final void addHandler(NavigationEventHandler<?> handler, int i) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        checkInvariants();
        if (this.handlers.add(handler)) {
            this.sharedProcessor.addHandler(this, handler, i);
        }
    }
    ...
    public final void addInput(NavigationEventInput input, int i) {
        Intrinsics.checkNotNullParameter(input, "input");
        checkInvariants();
        if (i != 1 && i != 0) {
        ...
        if (this.inputs.add(input)) {
            this.sharedProcessor.addInput(this, input, i);
        }
    }
    ...
    public final void dispatchOnStarted$navigationevent(NavigationEventInput input, int i, NavigationEvent navigationEvent) {
        Intrinsics.checkNotNullParameter(input, "input");
        checkInvariants();
        if (isEnabled()) {
            this.sharedProcessor.dispatchOnStarted(input, i, navigationEvent);
        }
    }

    public final void dispatchOnProgressed$navigationevent(NavigationEventInput input, int i, NavigationEvent event) {
        Intrinsics.checkNotNullParameter(input, "input");
        Intrinsics.checkNotNullParameter(event, "event");
        checkInvariants();
        if (isEnabled()) {
            this.sharedProcessor.dispatchOnProgressed(input, i, event);
        }
    }

    public final void dispatchOnCompleted$navigationevent(NavigationEventInput input, int i) {
        Intrinsics.checkNotNullParameter(input, "input");
        checkInvariants();
        if (isEnabled()) {
            this.sharedProcessor.dispatchOnCompleted(input, i, this.onBackCompletedFallback);
        }
    }

    public final void dispatchOnCancelled$navigationevent(NavigationEventInput input, int i) {
        Intrinsics.checkNotNullParameter(input, "input");
        checkInvariants();
        if (isEnabled()) {
            this.sharedProcessor.dispatchOnCancelled(input, i);
        }
    }
    ...
    /* compiled from: NavigationEventDispatcher.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0007"}, d2 = {"Landroidx/navigationevent/NavigationEventDispatcher$Companion;", "", "<init>", "()V", "PRIORITY_OVERLAY", "", "PRIORITY_DEFAULT", "navigationevent"}, k = 1, mv = {2, 0, 0}, xi = 48)
    /* loaded from: classes3.dex */
