...
public final class FragmentViewModelLazyKt$viewModels$3 extends Lambda implements Function0<CreationExtras> {
    ...
    public final CreationExtras invoke() {
        ViewModelStoreOwner m7809viewModels$lambda0;
        CreationExtras defaultViewModelCreationExtras;
        m7809viewModels$lambda0 = FragmentViewModelLazyKt.m7809viewModels$lambda0(this.$owner$delegate);
        HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = m7809viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) m7809viewModels$lambda0 : null;
