...
public final class OnBackPressedCallbackInfo extends NavigationEventInfo {
    ...
    public final OnBackPressedCallback component1() {
    ...
    public final OnBackPressedCallbackInfo copy(OnBackPressedCallback callback, LifecycleOwner lifecycleOwner) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        return new OnBackPressedCallbackInfo(callback, lifecycleOwner);
    }
