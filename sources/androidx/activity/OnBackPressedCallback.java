...
public abstract class OnBackPressedCallback {
    ...
    public final void remove() {
        ...
        while (it.hasNext()) {
            UByte$$ExternalSyntheticBackport0.m9969m((Object) it.next());
        }
