...
public final class WifiLockManager {
        ...
        if (shouldAcquireWifilock(z, z2)) {
            this.wifiLockHandler.post(new Runnable() { // from class: androidx.media3.common.util.WifiLockManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WifiLockManager.this.m8832xfd5ac0b8(z, z2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m8832xfd5ac0b8(boolean z, boolean z2) {
    ...
    public /* synthetic */ void m8833x97fb8339(AtomicBoolean atomicBoolean) {
    ...
    public /* synthetic */ void m8834x329c45ba(AtomicBoolean atomicBoolean, boolean z, boolean z2) {
    ...
    public static final class WifiLockManagerInternal {
        ...
        public void forceReleaseWifiLock(final AtomicBoolean atomicBoolean) {
            if (atomicBoolean.get()) {
                new Thread(new Runnable() { // from class: androidx.media3.common.util.WifiLockManager$WifiLockManagerInternal$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiLockManager.WifiLockManagerInternal.this.m8835xd91cfc11(atomicBoolean);
                    }
        ...
        public synchronized void m8835xd91cfc11(AtomicBoolean atomicBoolean) {
