...
public final class WakeLockManager {
        ...
        if (shouldAcquireWakelock(z, z2)) {
            this.wakeLockHandler.post(new Runnable() { // from class: androidx.media3.common.util.WakeLockManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WakeLockManager.this.m8828xe56dff98(z, z2);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m8828xe56dff98(boolean z, boolean z2) {
    ...
    public /* synthetic */ void m8829x800ec219(AtomicBoolean atomicBoolean) {
    ...
    public /* synthetic */ void m8830x1aaf849a(AtomicBoolean atomicBoolean, boolean z, boolean z2) {
    ...
    public static final class WakeLockManagerInternal {
        ...
        public synchronized void updateWakeLock(boolean z, boolean z2) {
            ...
            boolean shouldAcquireWakelock = WakeLockManager.shouldAcquireWakelock(z, z2);
        ...
        public void forceReleaseWakeLock(final AtomicBoolean atomicBoolean) {
            if (atomicBoolean.get()) {
                new Thread(new Runnable() { // from class: androidx.media3.common.util.WakeLockManager$WakeLockManagerInternal$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WakeLockManager.WakeLockManagerInternal.this.m8831x41613802(atomicBoolean);
                    }
        ...
        public synchronized void m8831x41613802(AtomicBoolean atomicBoolean) {
