...
final class Sonic {
    ...
    public void queueEndOfStream() {
        ...
        float f = this.speed;
        float f2 = this.pitch;
        int i4 = this.outputFrameCount + ((int) (((((((i3 - i) / (f / f2)) + this.remainingInputToCopyFrameCount) + this.accumulatedSpeedAdjustmentError) + this.pitchFrameCount) / (this.rate * f2)) + 0.5d));
