...
public final class DefaultAudioSink implements AudioSink {
    ...
    static /* synthetic */ boolean access$3000() {
        return hasPendingAudioOutputReleases();
    }
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            try {
                AudioProcessor.AudioFormat configure = audioProcessingPipeline.configure(new AudioProcessor.AudioFormat(format));
                Format build = format.buildUpon().setPcmEncoding(configure.encoding).setSampleRate(configure.sampleRate).setChannelCount(configure.channelCount).build();
                i3 = Util.getPcmFrameSize(configure.encoding, configure.channelCount);
                i2 = pcmFrameSize;
                format2 = build;
        ...
        try {
            ...
            Configuration configuration = new Configuration(format, format2, i2, i3, outputConfig, audioProcessingPipeline2);
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (!this.inputBuffer.hasRemaining()) {
            ...
            return true;
        } else if (this.audioOutput.isStalled()) {
    ...
    */
    private void drainOutputBuffer(long j) throws AudioSink.WriteException {
        ...
        try {
            boolean write = this.audioOutput.write(this.outputBuffer, this.inputBufferAccessUnitCount, j);
            ...
            if (this.audioOutput.isOffloadedPlayback()) {
                ...
                if (this.playing && (listener2 = this.listener) != null && !write && !this.isWaitingForOffloadEndOfStreamHandled) {
            ...
            if (e.isRecoverable) {
                ...
                AudioSink.WriteException writeException = new AudioSink.WriteException(e.errorCode, this.configuration.inputFormat, r3);
            ...
            r3 = false;
            AudioSink.WriteException writeException2 = new AudioSink.WriteException(e.errorCode, this.configuration.inputFormat, r3);
            listener = this.listener;
            if (listener != null) {
            }
            if (!e.isRecoverable) {
    ...
    public void setVirtualDeviceId(int i) {
        int resolveDefaultVirtualDeviceIds = resolveDefaultVirtualDeviceIds(i);
        if (this.virtualDeviceId == resolveDefaultVirtualDeviceIds) {
            return;
        }
        this.virtualDeviceId = resolveDefaultVirtualDeviceIds;
        reconfigureAndFlush();
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    static int getFramesPerEncodedSample(int r2, java.nio.ByteBuffer r3) {
        /*
            r0 = 20
            if (r2 == r0) goto L61
            r0 = 30
    ...
    private ByteBuffer maybeRampUpVolume(ByteBuffer byteBuffer) {
        if (this.configuration.isPcm()) {
            int durationUsToSampleCount = (int) Util.durationUsToSampleCount(Util.msToUs(20L), this.configuration.outputConfig.sampleRate);
            long writtenFrames = getWrittenFrames();
            if (writtenFrames < durationUsToSampleCount) {
                return PcmAudioUtil.rampUpVolume(byteBuffer, this.configuration.outputConfig.encoding, this.configuration.outputPcmFrameSize, (int) writtenFrames, durationUsToSampleCount);
            }
        }
        return byteBuffer;
    }
    ...
    public static final class PendingExceptionHolder<T extends Exception> {
        ...
        public void throwExceptionIfDeadlineIsReached(T t) throws Exception {
            ...
            if (this.throwDeadlineMs == C.TIME_UNSET && !DefaultAudioSink.access$3000()) {
        ...
        public boolean shouldWaitBeforeRetry() {
            ...
            return DefaultAudioSink.access$3000() || SystemClock.elapsedRealtime() < this.earliestNextRetryTimeMs;
        }
