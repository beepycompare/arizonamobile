...
public final class MediaPeriodQueue {
    ...
    */
    ...
    private void notifyQueueUpdate() {
        ...
        this.analyticsCollectorHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.MediaPeriodQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                MediaPeriodQueue.this.m8857x6b40a91a(builder, mediaPeriodId);
            }
        });
    }
    ...
    public /* synthetic */ void m8857x6b40a91a(ImmutableList.Builder builder, MediaSource.MediaPeriodId mediaPeriodId) {
