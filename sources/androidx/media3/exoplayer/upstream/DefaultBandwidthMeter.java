...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            hashMap.put(2, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(3, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(4, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(5, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(10, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(9, Long.valueOf((long) C.TIME_UNSET));
            hashMap.put(7, Long.valueOf((long) C.TIME_UNSET));
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x004e, code lost:
        if (r10.totalBytesTransferred >= android.support.v4.media.session.PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED) goto L17;
     */
    @Override // androidx.media3.datasource.TransferListener
    /*
