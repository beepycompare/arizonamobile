...
public final class StreamVolumeManager {
    ...
    public StreamVolumeManager(Context context, Listener listener, final int i, Looper looper, Looper looper2, Clock clock) {
        ...
        backgroundThreadStateHandler.runInBackground(new Runnable() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda5
            ...
            public final void run() {
                StreamVolumeManager.this.m7912lambda$new$0$androidxmedia3exoplayerStreamVolumeManager(i);
            }
        });
    }
    ...
    public /* synthetic */ void m7912lambda$new$0$androidxmedia3exoplayerStreamVolumeManager(int i) {
    ...
    public void setStreamType(final int i) {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda10
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7916xb3c607b2(i, (StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7916xb3c607b2(int i, StreamVolumeState streamVolumeState) {
    ...
    public void setVolume(final int i, final int i2) {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda8
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7917lambda$setVolume$4$androidxmedia3exoplayerStreamVolumeManager(i, i2, (StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7917lambda$setVolume$4$androidxmedia3exoplayerStreamVolumeManager(int i, int i2, StreamVolumeState streamVolumeState) {
    ...
    public void increaseVolume(final int i) {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda3
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7911x1af3b470(i, (StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7911x1af3b470(int i, StreamVolumeState streamVolumeState) {
    ...
    public void decreaseVolume(final int i) {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda6
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7910x928d2e4e(i, (StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7910x928d2e4e(int i, StreamVolumeState streamVolumeState) {
    ...
    public void setMuted(final boolean z, final int i) {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda12
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7915lambda$setMuted$9$androidxmedia3exoplayerStreamVolumeManager(z, (StreamVolumeManager.StreamVolumeState) obj);
            }
        }, new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda13
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7914lambda$setMuted$10$androidxmedia3exoplayerStreamVolumeManager(z, i, (StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7915lambda$setMuted$9$androidxmedia3exoplayerStreamVolumeManager(boolean z, StreamVolumeState streamVolumeState) {
    ...
    public /* synthetic */ StreamVolumeState m7914lambda$setMuted$10$androidxmedia3exoplayerStreamVolumeManager(boolean z, int i, StreamVolumeState streamVolumeState) {
    ...
    public void release() {
        this.stateHandler.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.StreamVolumeManager$$ExternalSyntheticLambda1
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return StreamVolumeManager.this.m7913lambda$release$12$androidxmedia3exoplayerStreamVolumeManager((StreamVolumeManager.StreamVolumeState) obj);
            }
        });
    }
    ...
    public /* synthetic */ StreamVolumeState m7913lambda$release$12$androidxmedia3exoplayerStreamVolumeManager(StreamVolumeState streamVolumeState) {
    ...
    public final class VolumeChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            StreamVolumeManager.this.stateHandler.runInBackground(new Runnable() { // from class: androidx.media3.exoplayer.StreamVolumeManager$VolumeChangeReceiver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    StreamVolumeManager.VolumeChangeReceiver.this.m7918x433070e5();
                }
            });
        }
        ...
        public /* synthetic */ void m7918x433070e5() {
