...
public final class WifiLockManager {
    ...
    public void setEnabled(final boolean z) {
        ...
        this.wifiLockHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.WifiLockManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WifiLockManager.this.m7355lambda$setEnabled$0$androidxmedia3exoplayerWifiLockManager(z, z2);
            }
        });
    }
    ...
    public /* synthetic */ void m7355lambda$setEnabled$0$androidxmedia3exoplayerWifiLockManager(boolean z, boolean z2) {
    ...
    public void setStayAwake(final boolean z) {
        ...
        if (this.enabled) {
            this.wifiLockHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.WifiLockManager$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    WifiLockManager.this.m7356lambda$setStayAwake$1$androidxmedia3exoplayerWifiLockManager(z);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m7356lambda$setStayAwake$1$androidxmedia3exoplayerWifiLockManager(boolean z) {
