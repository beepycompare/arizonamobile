...
public final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(ExoPlayer.Builder builder, Player player) {
        ...
        Clock clock;
        try {
            Log.i(TAG, "Init " + Integer.toHexString(System.identityHashCode(this)) + " [AndroidXMedia3/1.7.1] [" + Util.DEVICE_DEBUG_INFO + "]");
            ...
            this.listeners = new ListenerSet<>(looper2, clock2, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda16
                ...
                public final void invoke(Object obj, FlagSet flagSet) {
                    ExoPlayerImpl.this.m7315lambda$new$0$androidxmedia3exoplayerExoPlayerImpl((Player.Listener) obj, flagSet);
                }
            });
            ...
            ExoPlayerImplInternal.PlaybackInfoUpdateListener playbackInfoUpdateListener = new ExoPlayerImplInternal.PlaybackInfoUpdateListener() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda17
                ...
                public final void onPlaybackInfoUpdate(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
                    ExoPlayerImpl.this.m7317lambda$new$2$androidxmedia3exoplayerExoPlayerImpl(playbackInfoUpdate);
                }
            };
            ...
            backgroundThreadStateHandler.runInBackground(new Runnable() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda19
                ...
                public final void run() {
                    ExoPlayerImpl.this.m7318lambda$new$3$androidxmedia3exoplayerExoPlayerImpl();
                }
            });
    ...
    public /* synthetic */ void m7315lambda$new$0$androidxmedia3exoplayerExoPlayerImpl(Player.Listener listener, FlagSet flagSet) {
    ...
    public /* synthetic */ void m7317lambda$new$2$androidxmedia3exoplayerExoPlayerImpl(final ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        this.playbackInfoUpdateHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                ExoPlayerImpl.this.m7316lambda$new$1$androidxmedia3exoplayerExoPlayerImpl(playbackInfoUpdate);
            }
        });
    }
    ...
    public /* synthetic */ void m7318lambda$new$3$androidxmedia3exoplayerExoPlayerImpl() {
    ...
    @Override // androidx.media3.common.Player
    public void release() {
        Log.i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [AndroidXMedia3/1.7.1] [" + Util.DEVICE_DEBUG_INFO + "] [" + MediaLibraryInfo.registeredModules() + "]");
        verifyApplicationThread();
    ...
    public void setPlaylistMetadata(MediaMetadata mediaMetadata) {
        ...
        this.listeners.sendEvent(15, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda14
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
                ExoPlayerImpl.this.m7320xd48e5d09((Player.Listener) obj);
            }
        });
    }
    ...
    public /* synthetic */ void m7320xd48e5d09(Player.Listener listener) {
    ...
    public void setAudioSessionId(final int i) {
        ...
        this.audioSessionIdState.updateStateAsync(new Function() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda8
            ...
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return ExoPlayerImpl.this.m7319x6cd39d73(i, (Integer) obj);
            }
        });
    }
    ...
    public /* synthetic */ Integer m7319x6cd39d73(int i, Integer num) {
        if (i == 0) {
    ...
    public void m7316lambda$new$1$androidxmedia3exoplayerExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
    ...
    private void updateAvailableCommands() {
        ...
        this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$$ExternalSyntheticLambda25
            @Override // androidx.media3.common.util.ListenerSet.Event
            public final void invoke(Object obj) {
                ExoPlayerImpl.this.m7321xb3c7aa6e((Player.Listener) obj);
            }
        });
    }
    ...
    public /* synthetic */ void m7321xb3c7aa6e(Player.Listener listener) {
    ...
    public final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, SphericalGLSurfaceView.VideoSurfaceListener, AudioBecomingNoisyManager.EventListener, StreamVolumeManager.Listener, ExoPlayer.AudioOffloadListener {
        ...
        public void onMetadata(final Metadata metadata) {
            ...
            if (!buildUpdatedMediaMetadata.equals(ExoPlayerImpl.this.mediaMetadata)) {
                ...
                ExoPlayerImpl.this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: androidx.media3.exoplayer.ExoPlayerImpl$ComponentListener$$ExternalSyntheticLambda1
                    @Override // androidx.media3.common.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        ExoPlayerImpl.ComponentListener.this.m7322xb185137((Player.Listener) obj);
                    }
                });
            }
        ...
        public /* synthetic */ void m7322xb185137(Player.Listener listener) {
