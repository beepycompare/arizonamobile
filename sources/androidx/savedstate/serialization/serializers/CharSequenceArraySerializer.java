...
public final class CharSequenceArraySerializer implements KSerializer<CharSequence[]> {
    ...
    public void serialize(Encoder encoder, CharSequence[] value) {
        ...
        SavedStateWriter.m9275putCharSequenceArrayimpl(SavedStateWriter.m9264constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), value);
    }
    ...
    public CharSequence[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9196getCharSequenceArrayimpl(SavedStateReader.m9178constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate());
    }
}
