...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public void serialize(Encoder encoder, CharSequence value) {
        ...
        SavedStateWriter.m7676putCharSequenceimpl(SavedStateWriter.m7666constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public CharSequence deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7597getCharSequenceimpl(SavedStateReader.m7580constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
