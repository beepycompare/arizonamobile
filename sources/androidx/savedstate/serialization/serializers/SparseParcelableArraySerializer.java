...
public final class SparseParcelableArraySerializer implements KSerializer<SparseArray<Parcelable>> {
    ...
    public void serialize(Encoder encoder, SparseArray<Parcelable> value) {
        ...
        SavedStateWriter.m9024putSparseParcelableArrayimpl(SavedStateWriter.m8992constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public SparseArray<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8974getSparseParcelableArrayimpl(SavedStateReader.m8906constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
