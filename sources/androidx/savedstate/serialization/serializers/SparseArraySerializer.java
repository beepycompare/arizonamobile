...
public final class SparseArraySerializer<T> implements KSerializer<SparseArray<T>> {
    ...
    public static final class SparseArraySurrogate<T> {
        ...
        @JvmStatic
        public static final /* synthetic */ void write$Self$savedstate(SparseArraySurrogate sparseArraySurrogate, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor, KSerializer kSerializer) {
