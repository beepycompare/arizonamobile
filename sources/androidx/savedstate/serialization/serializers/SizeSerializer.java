...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m8279putSizeimpl(SavedStateWriter.m8249constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public Size deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8226getSizeimpl(SavedStateReader.m8163constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
