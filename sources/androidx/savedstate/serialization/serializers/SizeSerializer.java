...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m7711putSizeimpl(SavedStateWriter.m7681constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public Size deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7658getSizeimpl(SavedStateReader.m7595constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
