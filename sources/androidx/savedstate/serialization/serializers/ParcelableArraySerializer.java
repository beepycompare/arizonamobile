...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public void serialize(Encoder encoder, Parcelable[] value) {
        ...
        SavedStateWriter.m9289putParcelableArrayimpl(SavedStateWriter.m9264constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), value);
    }
    ...
    public Parcelable[] deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9226getParcelableArrayimpl(SavedStateReader.m9178constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
