...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m9307putCharSequenceListimpl(SavedStateWriter.m9295constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9229getCharSequenceListimpl(SavedStateReader.m9209constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate());
    }
}
