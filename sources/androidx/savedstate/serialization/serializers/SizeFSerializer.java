...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m9311putSizeFimpl(SavedStateWriter.m9280constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9258getSizeFimpl(SavedStateReader.m9194constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate());
    }
}
