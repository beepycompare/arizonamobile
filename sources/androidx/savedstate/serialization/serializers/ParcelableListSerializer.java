...
public final class ParcelableListSerializer implements KSerializer<List<? extends Parcelable>> {
    ...
    public void serialize(Encoder encoder, List<? extends Parcelable> value) {
        ...
        SavedStateWriter.m7707putParcelableListimpl(SavedStateWriter.m7681constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public List<Parcelable> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7647getParcelableListimpl(SavedStateReader.m7595constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
    }
}
