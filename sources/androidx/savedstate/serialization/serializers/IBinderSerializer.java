...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m8252putBinderimpl(SavedStateWriter.m8247constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
    ...
    public IBinder deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m8168getBinderimpl(SavedStateReader.m8161constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
}
