...
public final class SavedStateDecoder extends AbstractDecoder {
    ...
    public CompositeDecoder beginStructure(SerialDescriptor descriptor) {
        ...
        return new SavedStateDecoder(SavedStateReader.m9235getSavedStateimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key), this.configuration);
    }
    ...
    */
    public int decodeElementIndex(SerialDescriptor descriptor) {
        ...
        if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.LIST.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.MAP.INSTANCE)) {
            m9258sizeimpl = SavedStateReader.m9258sizeimpl(SavedStateReader.m9178constructorimpl(this.savedState));
        } else {
            m9258sizeimpl = descriptor.getElementsCount();
        }
        while (true) {
            int i = this.index;
            if (i >= m9258sizeimpl) {
            ...
            if (!descriptor.isElementOptional(this.index) || SavedStateReader.m9179containsimpl(SavedStateReader.m9178constructorimpl(this.savedState), elementName)) {
                break;
            }
            this.index++;
        }
    ...
    public boolean decodeBoolean() {
        return SavedStateReader.m9187getBooleanimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public byte decodeByte() {
        return (byte) SavedStateReader.m9209getIntimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public short decodeShort() {
        return (short) SavedStateReader.m9209getIntimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public int decodeInt() {
        return SavedStateReader.m9209getIntimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public long decodeLong() {
        return SavedStateReader.m9219getLongimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public float decodeFloat() {
        return SavedStateReader.m9205getFloatimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public double decodeDouble() {
        return SavedStateReader.m9201getDoubleimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public char decodeChar() {
        return SavedStateReader.m9191getCharimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public String decodeString() {
        return SavedStateReader.m9249getStringimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }
    ...
    public boolean decodeNotNullMark() {
        return !SavedStateReader.m9257isNullimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
    }
    ...
    public <T> T decodeSerializableValue(DeserializationStrategy<? extends T> deserializer) {
        ...
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getIntListDescriptor())) {
            return (T) SavedStateReader.m9212getIntListimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getStringListDescriptor())) {
            return (T) SavedStateReader.m9252getStringListimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getBooleanArrayDescriptor())) {
            return (T) SavedStateReader.m9188getBooleanArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getCharArrayDescriptor())) {
            return (T) SavedStateReader.m9192getCharArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getDoubleArrayDescriptor())) {
            return (T) SavedStateReader.m9202getDoubleArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getFloatArrayDescriptor())) {
            return (T) SavedStateReader.m9206getFloatArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getIntArrayDescriptor())) {
            return (T) SavedStateReader.m9210getIntArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getLongArrayDescriptor())) {
            return (T) SavedStateReader.m9220getLongArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
        if (Intrinsics.areEqual(descriptor, SavedStateCodecUtilsKt.getStringArrayDescriptor())) {
            return (T) SavedStateReader.m9250getStringArrayimpl(SavedStateReader.m9178constructorimpl(this.savedState), this.key);
        }
