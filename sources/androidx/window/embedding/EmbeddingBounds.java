...
public final class EmbeddingBounds {
    ...
    private final FoldingFeature getOnlyFoldingFeatureOrNull(WindowLayoutInfo windowLayoutInfo) {
        ...
        for (Object obj : windowLayoutInfo.getDisplayFeatures()) {
    ...
    public final int getWidthInPixel$window_release(Bounds parentContainerBounds, WindowLayoutInfo windowLayoutInfo) {
        ...
        if (shouldUseFallbackDimensionForWidth$window_release(windowLayoutInfo)) {
            dimension = Dimension.Companion.ratio(0.5f);
        } else {
        ...
        if (dimension instanceof Dimension.Pixel) {
            return Math.min(width, ((Dimension.Pixel) dimension).getValue$window_release());
        }
    ...
    public final int getHeightInPixel$window_release(Bounds parentContainerBounds, WindowLayoutInfo windowLayoutInfo) {
        ...
        if (dimension instanceof Dimension.Pixel) {
            return Math.min(height, ((Dimension.Pixel) dimension).getValue$window_release());
        }
        if (Intrinsics.areEqual(dimension, Dimension.DIMENSION_HINGE)) {
            FoldingFeature onlyFoldingFeatureOrNull = getOnlyFoldingFeatureOrNull(windowLayoutInfo);
            Intrinsics.checkNotNull(onlyFoldingFeatureOrNull);
    ...
    public static final class Alignment {
        ...
        /* compiled from: EmbeddingBounds.kt */
        @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0010\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Landroidx/window/embedding/EmbeddingBounds$Alignment$Companion;", "", "<init>", "()V", "ALIGN_LEFT", "Landroidx/window/embedding/EmbeddingBounds$Alignment;", "ALIGN_TOP", "ALIGN_RIGHT", "ALIGN_BOTTOM", "window_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
        /* loaded from: classes3.dex */
    ...
    public static final class Companion {
        ...
        public final Bounds translateEmbeddingBounds$window_release(EmbeddingBounds embeddingBounds, Bounds parentContainerBounds, WindowLayoutInfo windowLayoutInfo) {
            ...
            if (Intrinsics.areEqual(alignment, Alignment.ALIGN_LEFT)) {
                return EmbeddingBounds.Companion.offset(bounds, 0, (height2 - heightInPixel$window_release) / 2);
            }
            if (Intrinsics.areEqual(alignment, Alignment.ALIGN_BOTTOM)) {
                return EmbeddingBounds.Companion.offset(bounds, (width2 - widthInPixel$window_release) / 2, height2 - heightInPixel$window_release);
            }
            if (Intrinsics.areEqual(alignment, Alignment.ALIGN_RIGHT)) {
                return EmbeddingBounds.Companion.offset(bounds, width2 - widthInPixel$window_release, (height2 - heightInPixel$window_release) / 2);
            }
