...
public final class ParentContainerInfo {
    ...
    public final ParentContainerInfo copy(Bounds windowBounds, WindowLayoutInfo windowLayoutInfo, Configuration configuration, float f) {
        Intrinsics.checkNotNullParameter(windowBounds, "windowBounds");
        Intrinsics.checkNotNullParameter(windowLayoutInfo, "windowLayoutInfo");
        Intrinsics.checkNotNullParameter(configuration, "configuration");
        return new ParentContainerInfo(windowBounds, windowLayoutInfo, configuration, f);
    }
