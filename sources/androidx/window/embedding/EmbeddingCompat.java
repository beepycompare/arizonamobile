...
public final class EmbeddingCompat implements EmbeddingInterfaceCompat {
    ...
    public void setEmbeddingCallback(final EmbeddingInterfaceCompat.EmbeddingCallbackInterface embeddingCallback) {
        ...
        } else if (5 > extensionVersion || extensionVersion > Integer.MAX_VALUE) {
        } else {
            registerSplitInfoCallback(embeddingCallback);
            this.embeddingExtension.registerActivityStackCallback(new DefaultDownloaderFactory$$ExternalSyntheticLambda0(), new ActivityStackConsumer(embeddingCallback, this.adapter));
        }
    }
    ...
    public void finishActivityStacks(Set<ActivityStack> activityStacks) {
        ...
        for (ActivityStack activityStack : activityStacks) {
            linkedHashSet.add(activityStack.getToken$window_release());
        }
    ...
    public void setEmbeddingConfiguration(EmbeddingConfiguration embeddingConfig) {
        ...
        if (this.windowSdkExtensions.getExtensionVersion() >= 8) {
            try {
                this.embeddingExtension.setAutoSaveEmbeddingState(embeddingConfig.isAutoSaveEmbeddingState());
            } catch (Throwable th) {
