...
public class OverlayControllerImpl {
    ...
    public final OverlayAttributes calculateOverlayAttributes$window_release(String tag, OverlayAttributes overlayAttributes, androidx.window.layout.WindowMetrics windowMetrics, Configuration configuration, androidx.window.layout.WindowLayoutInfo windowLayoutInfo) {
        ...
        if (overlayAttributesCalculator$window_release != null) {
            str = tag;
            OverlayAttributes invoke = overlayAttributesCalculator$window_release.invoke(new OverlayAttributesCalculatorParams(windowMetrics, configuration, windowLayoutInfo, str, overlayAttributes2));
            if (invoke != null) {
                overlayAttributes2 = invoke;
            }
        } else {
            str = tag;
        }
        this.overlayTagToCurrentAttributesMap.put(str, overlayAttributes2);
    ...
    public static final void addOverlayInfoCallback$lambda$11$lambda$10(String str, OverlayControllerImpl overlayControllerImpl, Consumer consumer, List activityStacks) {
        ...
        if (arrayList2.isEmpty()) {
            ...
            overlayInfo = overlayControllerImpl.toOverlayInfo((androidx.window.extensions.embedding.ActivityStack) CollectionsKt.first((List<? extends Object>) arrayList2));
        }
