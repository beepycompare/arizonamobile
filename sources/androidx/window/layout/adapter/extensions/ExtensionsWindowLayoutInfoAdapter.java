...
public final class ExtensionsWindowLayoutInfoAdapter {
    ...
    public final WindowLayoutInfo translate$window_release(Context context, androidx.window.extensions.layout.WindowLayoutInfo info) {
        ...
        WindowMetricsCalculatorCompat windowMetricsCalculatorCompat = new WindowMetricsCalculatorCompat(null, 1, null);
    ...
    public final List<SupportedPosture> translate$window_release(SupportedWindowFeatures features) {
        ...
        List<DisplayFoldFeature> list = displayFoldFeatures;
        if (!(list instanceof Collection) || !list.isEmpty()) {
            for (DisplayFoldFeature displayFoldFeature : list) {
                if (displayFoldFeature.hasProperties(new int[]{1})) {
