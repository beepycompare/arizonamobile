...
public final class Request {
    ...
    */
    ...
    public final HttpUrl m12102deprecated_url() {
        return this.url;
    }
    ...
    public final String m12101deprecated_method() {
        return this.method;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "headers", imports = {}))
    /* renamed from: -deprecated_headers  reason: not valid java name */
    public final Headers m12100deprecated_headers() {
        return this.headers;
    }
    ...
    public final RequestBody m12098deprecated_body() {
        return this.body;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "cacheControl", imports = {}))
    /* renamed from: -deprecated_cacheControl  reason: not valid java name */
    public final CacheControl m12099deprecated_cacheControl() {
        return cacheControl();
    }
