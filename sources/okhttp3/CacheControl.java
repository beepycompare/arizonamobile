...
public final class CacheControl {
    ...
    public static final class Builder {
        ...
        public final Builder m10255maxAgeLRDsOJo(long j) {
            long m9844getInWholeSecondsimpl = Duration.m9844getInWholeSecondsimpl(j);
            if (m9844getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("maxAge < 0: " + m9844getInWholeSecondsimpl).toString());
            }
            this.maxAgeSeconds = _CacheControlCommonKt.commonClampToInt(m9844getInWholeSecondsimpl);
            return this;
        }

        /* renamed from: maxStale-LRDsOJo  reason: not valid java name */
        public final Builder m10256maxStaleLRDsOJo(long j) {
            long m9844getInWholeSecondsimpl = Duration.m9844getInWholeSecondsimpl(j);
            if (m9844getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("maxStale < 0: " + m9844getInWholeSecondsimpl).toString());
            }
            this.maxStaleSeconds = _CacheControlCommonKt.commonClampToInt(m9844getInWholeSecondsimpl);
            return this;
        }

        /* renamed from: minFresh-LRDsOJo  reason: not valid java name */
        public final Builder m10257minFreshLRDsOJo(long j) {
            long m9844getInWholeSecondsimpl = Duration.m9844getInWholeSecondsimpl(j);
            if (m9844getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("minFresh < 0: " + m9844getInWholeSecondsimpl).toString());
            }
            this.minFreshSeconds = _CacheControlCommonKt.commonClampToInt(m9844getInWholeSecondsimpl);
            return this;
        }
