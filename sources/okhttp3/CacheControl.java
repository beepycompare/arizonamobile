...
public final class CacheControl {
    ...
    public final boolean m11679deprecated_noCache() {
        return this.noCache;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "noStore", imports = {}))
    /* renamed from: -deprecated_noStore  reason: not valid java name */
    public final boolean m11680deprecated_noStore() {
        return this.noStore;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "maxAgeSeconds", imports = {}))
    /* renamed from: -deprecated_maxAgeSeconds  reason: not valid java name */
    public final int m11675deprecated_maxAgeSeconds() {
        return this.maxAgeSeconds;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "sMaxAgeSeconds", imports = {}))
    /* renamed from: -deprecated_sMaxAgeSeconds  reason: not valid java name */
    public final int m11683deprecated_sMaxAgeSeconds() {
        return this.sMaxAgeSeconds;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "mustRevalidate", imports = {}))
    /* renamed from: -deprecated_mustRevalidate  reason: not valid java name */
    public final boolean m11678deprecated_mustRevalidate() {
        return this.mustRevalidate;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "maxStaleSeconds", imports = {}))
    /* renamed from: -deprecated_maxStaleSeconds  reason: not valid java name */
    public final int m11676deprecated_maxStaleSeconds() {
        return this.maxStaleSeconds;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "minFreshSeconds", imports = {}))
    /* renamed from: -deprecated_minFreshSeconds  reason: not valid java name */
    public final int m11677deprecated_minFreshSeconds() {
        return this.minFreshSeconds;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "onlyIfCached", imports = {}))
    /* renamed from: -deprecated_onlyIfCached  reason: not valid java name */
    public final boolean m11682deprecated_onlyIfCached() {
        return this.onlyIfCached;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "noTransform", imports = {}))
    /* renamed from: -deprecated_noTransform  reason: not valid java name */
    public final boolean m11681deprecated_noTransform() {
        return this.noTransform;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "immutable", imports = {}))
    /* renamed from: -deprecated_immutable  reason: not valid java name */
    public final boolean m11674deprecated_immutable() {
        return this.immutable;
    }
    ...
    public static final class Builder {
        ...
        public final Builder m11684maxAgeLRDsOJo(long j) {
            long m11273getInWholeSecondsimpl = Duration.m11273getInWholeSecondsimpl(j);
            if (m11273getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("maxAge < 0: " + m11273getInWholeSecondsimpl).toString());
            }
            this.maxAgeSeconds = _CacheControlCommonKt.commonClampToInt(m11273getInWholeSecondsimpl);
            return this;
        }

        /* renamed from: maxStale-LRDsOJo  reason: not valid java name */
        public final Builder m11685maxStaleLRDsOJo(long j) {
            long m11273getInWholeSecondsimpl = Duration.m11273getInWholeSecondsimpl(j);
            if (m11273getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("maxStale < 0: " + m11273getInWholeSecondsimpl).toString());
            }
            this.maxStaleSeconds = _CacheControlCommonKt.commonClampToInt(m11273getInWholeSecondsimpl);
            return this;
        }

        /* renamed from: minFresh-LRDsOJo  reason: not valid java name */
        public final Builder m11686minFreshLRDsOJo(long j) {
            long m11273getInWholeSecondsimpl = Duration.m11273getInWholeSecondsimpl(j);
            if (m11273getInWholeSecondsimpl < 0) {
                throw new IllegalArgumentException(("minFresh < 0: " + m11273getInWholeSecondsimpl).toString());
            }
            this.minFreshSeconds = _CacheControlCommonKt.commonClampToInt(m11273getInWholeSecondsimpl);
            return this;
        }
