...
public final class MultipartBody extends RequestBody {
    ...
    public final MediaType m10936deprecated_type() {
        return this.type;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "boundary", imports = {}))
    /* renamed from: -deprecated_boundary  reason: not valid java name */
    public final String m10933deprecated_boundary() {
        return boundary();
    }
    ...
    public final List<Part> m10934deprecated_parts() {
        return this.parts;
    }
    ...
    public static final class Part {
        ...
        public final Headers m10938deprecated_headers() {
            return this.headers;
        }
        ...
        public final RequestBody m10937deprecated_body() {
            return this.body;
        }
