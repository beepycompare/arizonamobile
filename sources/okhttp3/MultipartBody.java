...
public final class MultipartBody extends RequestBody {
    ...
    public final MediaType m10968deprecated_type() {
        return this.type;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "boundary", imports = {}))
    /* renamed from: -deprecated_boundary  reason: not valid java name */
    public final String m10965deprecated_boundary() {
        return boundary();
    }
    ...
    public final List<Part> m10966deprecated_parts() {
        return this.parts;
    }
    ...
    public static final class Part {
        ...
        public final Headers m10970deprecated_headers() {
            return this.headers;
        }
        ...
        public final RequestBody m10969deprecated_body() {
            return this.body;
        }
