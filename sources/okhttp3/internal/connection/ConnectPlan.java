...
public final class ConnectPlan implements RoutePlanner.Plan, ExchangeCodec.Carrier {
    ...
    public RoutePlanner.ConnectResult mo11813connectTcp() {
        Socket socket;
        Socket socket2;
    ...
    */
    public RoutePlanner.ConnectResult mo11814connectTlsEtc() {
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        RealConnection realConnection = new RealConnection(taskRunner, realConnectionPool, route, socket, socket4, handshake, protocol, bufferedSocket3, this.pingIntervalMillis, this.connectionPool.getConnectionListener$okhttp());
    ...
    public final RoutePlanner.ConnectResult connectTunnel$okhttp() throws IOException {
        ...
        this.call.getEventListener$okhttp().connectFailed(this.call, getRoute().socketAddress(), getRoute().proxy(), null, protocolException2);
        this.connectionPool.getConnectionListener$okhttp().connectFailed(getRoute(), this.call, protocolException2);
    ...
    private final Request createTunnel() throws IOException {
        ...
        while (true) {
            ...
            bufferedSocket2.getSource().timeout().timeout(this.readTimeoutMillis, TimeUnit.MILLISECONDS);
            BufferedSocket bufferedSocket3 = this.socket;
            if (bufferedSocket3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("socket");
                bufferedSocket3 = null;
            }
            bufferedSocket3.getSink().timeout().timeout(this.writeTimeoutMillis, TimeUnit.MILLISECONDS);
    ...
    public RealConnection mo11810handleSuccess() {
        ...
        realConnection.getConnectionListener$okhttp().connectEnd(realConnection2, getRoute(), this.call);
        ...
        this.call.getEventListener$okhttp().connectionAcquired(this.call, realConnection2);
        realConnection.getConnectionListener$okhttp().connectionAcquired(realConnection2, this.call);
        return realConnection;
    }

    @Override // okhttp3.internal.connection.RoutePlanner.Plan, okhttp3.internal.http.ExchangeCodec.Carrier
    /* renamed from: cancel */
    public void mo11809cancel() {
        this.canceled = true;
        Socket socket = this.rawSocket;
        if (socket != null) {
            _UtilJvmKt.closeQuietly(socket);
    ...
    @Override // okhttp3.internal.connection.RoutePlanner.Plan
    /* renamed from: retry */
    public RoutePlanner.Plan mo11811retry() {
