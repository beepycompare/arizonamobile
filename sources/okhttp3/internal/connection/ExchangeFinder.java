...
public final class ExchangeFinder {
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        try {
            try {
                return findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !Intrinsics.areEqual(chain.getRequest$okhttp().method(), UtilsKt.HTTP_METHOD_GET)).newCodec$okhttp(client, chain);
            } catch (IOException e) {
                e = e;
