...
public final class FailedPlan implements RoutePlanner.Plan {
    ...
    public /* bridge */ /* synthetic */ RealConnection mo10968handleSuccess() {
    ...
    public RoutePlanner.ConnectResult mo10971connectTcp() {
        return this.result;
    }

    @Override // okhttp3.internal.connection.RoutePlanner.Plan
    /* renamed from: connectTlsEtc */
    public RoutePlanner.ConnectResult mo10972connectTlsEtc() {
        return this.result;
    }
