...
public final class ZipFileSystem extends FileSystem {
    ...
    public FileMetadata metadataOrNull(Path path) {
        ...
        if (zipEntry2.getOffset() != -1) {
            ...
            try {
                BufferedSource buffer = Okio.buffer(openReadOnly.source(zipEntry2.getOffset()));
                readLocalHeader = ZipFilesKt.readLocalHeader(buffer, zipEntry2);
                if (buffer != null) {
                    try {
                        buffer.close();
                    } catch (Throwable th2) {
        ...
        return new FileMetadata(!zipEntry2.isDirectory(), zipEntry2.isDirectory(), null, zipEntry2.isDirectory() ? null : Long.valueOf(zipEntry2.getSize()), zipEntry2.getCreatedAtMillis$okio(), zipEntry2.getLastModifiedAtMillis$okio(), zipEntry2.getLastAccessedAtMillis$okio(), null, 128, null);
    }
