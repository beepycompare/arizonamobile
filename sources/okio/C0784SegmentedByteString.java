...
public final class C0784SegmentedByteString extends ByteString {
    ...
    public C0784SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0784SegmentedByteString c0784SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0784SegmentedByteString, i2);
        if (i < 0) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0784SegmentedByteString;
            }
