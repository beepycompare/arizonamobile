...
public final class C0793SegmentedByteString extends ByteString {
    ...
    public C0793SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0793SegmentedByteString c0793SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0793SegmentedByteString, i2);
        if (i < 0) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0793SegmentedByteString;
            }
