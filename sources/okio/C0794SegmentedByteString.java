...
public final class C0794SegmentedByteString extends ByteString {
    ...
    public C0794SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0794SegmentedByteString c0794SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0794SegmentedByteString, i2);
        if (i < 0) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0794SegmentedByteString;
            }
