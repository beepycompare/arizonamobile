...
public final class C0787SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int i, int i2) {
        C0787SegmentedByteString c0787SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0787SegmentedByteString, i2);
        if (i < 0) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0787SegmentedByteString;
            }
