...
public abstract class FileSystem implements Closeable {
    ...
    public static /* synthetic */ Object m12130write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
            }
    ...
    public final <T> T m12131read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m12132write(Path file, boolean z, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
