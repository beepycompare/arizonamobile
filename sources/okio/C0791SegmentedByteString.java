...
public final class C0791SegmentedByteString extends ByteString {
    ...
    public C0791SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int i, int i2) {
        C0791SegmentedByteString c0791SegmentedByteString = this;
        int resolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0791SegmentedByteString, i2);
        if (i < 0) {
        ...
        if (resolveDefaultParameter <= size()) {
            ...
            if (i == 0 && resolveDefaultParameter == size()) {
                return c0791SegmentedByteString;
            }
